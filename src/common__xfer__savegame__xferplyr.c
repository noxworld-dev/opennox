...
int  nox_xxx_savePlayerMB_41C8F0(char* a1, unsigned int a2) {
	...
	if (nox_common_gameFlags_check_40A5C0(4096))
		*getMemU8Ptr(0x8531A0, 45629) = sub_465DF0();
	else
		*getMemU8Ptr(0x8531A0, 45629) = 0;
	if (nox_xxx_mapSavePlayerDataMB_41A230((char*)getMemAt(0x8531A0, 44356))) {
