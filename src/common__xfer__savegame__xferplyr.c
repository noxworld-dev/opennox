...
int nox_xxx_savePlayerMB_41C8F0(char* a1, unsigned int a2) {
	...
	if (!nox_common_gameFlags_check_40A5C0(1) &&
		a2 < 216) { // TODO: limit was *getMemIntPtr(0x587000, 55984) == 700, see #304
	...
	if (nox_xxx_mapSavePlayerDataMB_41A230((char*)getMemAt(0x85B3FC, 10984))) {
		v9 = nox_strman_loadString_40F1D0("CharacterSaved", 0, "C:\\NoxPost\\src\\common\\Xfer\\SaveGame\\XferPlyr.c",
										  3420);
		nox_gui_console_Printf_450C00(NOX_CONSOLE_BLUE, v9);
		v10 = nox_strman_loadString_40F1D0("CharacterSaved", 0, "C:\\NoxPost\\src\\common\\Xfer\\SaveGame\\XferPlyr.c",
										   3421);
