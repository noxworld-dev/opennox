...
int  sub_48D560(unsigned __int16 a1) {
	...
	v1 = nox_common_listGetXxxSafe_425890(getMemIntPtr(0x5D4594, 1197340));
	if (!v1)
		return 0;
	while (v1[2] != a1) {
...
int sub_48D660() {
	...
	if (dword_5d4594_1197352) {
		do {
			...
			if (!v2) {
				v2 = nox_common_listGetXxxSafe_425890(getMemIntPtr(0x5D4594, 1197340));
				if (v2 == v1)
					v2 = 0;
			}
...
int sub_48D740() {
	...
	nox_common_listClear_425760(getMemAt(0x5D4594, 1197340));
	result = 0;
	dword_5d4594_1197352 = 0;
...
void sub_48D760() {
	...
	v0 = nox_common_listGetXxxSafe_425890(getMemIntPtr(0x5D4594, 1197340));
	if (v0) {
		do {
...
int* sub_48D7B0() {
	...
	for (result = nox_common_listGetXxxSafe_425890(getMemIntPtr(0x5D4594, 1197340)); result; result = nox_common_listGetXxxSafe_4258A0(result))
		;
	return result;
}
	...
	if (*getMemU32Ptr(0x5D4594, 1197368)) {
		...
		LABEL_27:
			if (nox_frame_xxx_2598000 > *(int*)(v2 + 640)) {
				...
				nox_alloc_class_free_obj(*(unsigned int**)&nox_alloc_chat_1197364, (_QWORD*)v2);
			}
			v2 = v25;
			if (!v25) {
				v2 = *getMemU32Ptr(0x5D4594, 1197368);
...
void  sub_48E8E0(int a1) {
	...
	if (v1) {
		...
		nox_alloc_class_free_obj(*(unsigned int**)&nox_alloc_chat_1197364, (_QWORD*)v1);
	}
}

//----- (0048E940) --------------------------------------------------------
void sub_48E940() {
	nox_alloc_class_yyy_4144D0(*(_DWORD**)&nox_alloc_chat_1197364);
	*getMemU32Ptr(0x5D4594, 1197368) = 0;
}
...
unsigned __int8*  nox_xxx_netCliUpdateStream2_494C30(unsigned __int8* a1, int a2, int* a3) {
	...
	if (v4 == 0xFFu) {
		...
		if (v24 != -1) {
			sub_57BA10((int)getMemAt(0x5D4594, 8 * v24 + 1198020), v6, v9, nox_frame_xxx_2598000 + 60);
			v26[1] = v24;
			v26[0] = -91;
			*(_WORD*)&v26[2] = v6;
			*(_WORD*)&v26[4] = v8;
...
LABEL_9:
	...
	*getMemU32Ptr(0x5D4594, v3 + 1201448) = nox_frame_xxx_2598000;
...
int sub_495430() {
	...
	for (i = nox_win_height / 4 / 36; v1 != dword_5d4594_1203836; v1 = (v1 + 1) % 100) {
		if (dword_5d4594_1203832 > i)
			break;
		if ((unsigned int)(nox_frame_xxx_2598000 - *getMemU32Ptr(0x5D4594, 24 * v0 + 1201448)) <= 0x5A) {
...
//----- (004959B0) --------------------------------------------------------
void sub_4959B0() {
	nox_alloc_class_yyy_4144D0(*(_DWORD**)&nox_alloc_friendList_1203860);
...
void  sub_495A20(int a1) {
	...
	if (dword_5d4594_1203864) {
		...
		nox_alloc_class_free_obj(*(unsigned int**)&nox_alloc_friendList_1203860, (_QWORD*)v1);
	}
}
...
//----- (0049A630) --------------------------------------------------------
void sub_49A630() {
	nox_alloc_class_yyy_4144D0(*(_DWORD**)&nox_alloc_healthChange_1301772);
...
void  sub_49A880(int a1) {
	...
	nox_alloc_class_free_obj(*(unsigned int**)&nox_alloc_healthChange_1301772, (_QWORD*)a1);
}
...
void sub_49AEE0() {
	...
	nox_alloc_class_yyy_4144D0(*(_DWORD**)&nox_alloc_pixelSpan_1301844);
}
...
int  sub_49B1A0(int a1) {
	...
	if (a1) {
		do {
			v2 = *(_DWORD*)(result + 8);
			nox_alloc_class_free_obj(*(unsigned int**)&nox_alloc_pixelSpan_1301844, (_QWORD*)result);
			result = v2;
		} while (v2);
	}
	return result;
...
int sub_49BA70() {
	...
	if (dword_5d4594_1303468) {
		do {
			...
			if (*(_DWORD*)(result + 356) > nox_frame_xxx_2598000)
				break;
...
int*  sub_49FFA0(int a1) {
	...
	if (!*getMemU32Ptr(0x5D4594, 1305808))
		nox_common_listClear_425760(getMemAt(0x5D4594, 1305796));
	result = nox_common_listGetXxxSafe_425890(getMemIntPtr(0x5D4594, 1305796));
	v2 = result;
	if (result) {
		do {
...
int  nox_wol_servers_addResult_4A0030(const void* a1) {
	...
	case 0: // by name (asc)
		...
		v3 = nox_common_listGetXxxSafe_425890(getMemIntPtr(0x5D4594, 1305796));
		if (!v3) {
...
int  sub_4A0330(int* a1) {
	...
	v1 = 0;
	for (i = nox_common_listGetXxxSafe_425890(getMemIntPtr(0x5D4594, 1305796)); i; i = nox_common_listGetXxxSafe_4258A0(i)) {
		if (i == a1)
			break;
		++v1;
	}
...
int* sub_4A0390() {
	...
	nox_common_listClear_425760(&v4);
	...
	if (v0)
		*v0 = &v4;
	nox_common_listClear_425760(getMemAt(0x5D4594, 1305796));
	v1 = nox_common_listGetXxxSafe_425890(&v4);
	if (v1) {
		do {
			v2 = nox_common_listGetXxxSafe_4258A0(v1);
...
int  sub_4A0410(const char* a1, __int16 a2) {
	...
	v2 = nox_common_listGetXxxSafe_425890(getMemIntPtr(0x5D4594, 1305796));
	if (!v2)
		return 1;
...
int*  sub_4A04F0(char* a1) {
	...
	v1 = nox_common_listGetXxxSafe_425890(getMemIntPtr(0x5D4594, 1305796));
	if (!v1)
		return 0;
...
int  nox_gui_parseColor_4A0570(unsigned int* out, char* buf) {
	...
	int g = atoi(strtok(0, " \t\n\r"));
	int b = atoi(strtok(0, " \t\n\r"));
	*out = nox_color_rgb_4344A0(r, g, b);
	return 1;
}
...
nox_window*  nox_new_window_from_file(const char* name, int (*fnc)(int, int, int, int)) {
	...
	while (nox_fs_fscan_str(f, sbuf) != -1) {
		if (!strcmp(sbuf, "ENABLEDCOLOR")) {
			...
			if (!nox_gui_parseColorTo_4A05E0(getMemIntPtr(0x5D4594, 1307268), f, sbuf))
				break;
		} else if (!strcmp(sbuf, "HILITECOLOR")) {
			if (!nox_gui_parseColorTo_4A05E0(getMemIntPtr(0x5D4594, 1307276), f, sbuf))
				break;
		} else if (!strcmp(sbuf, "SELECTEDCOLOR")) {
			if (!nox_gui_parseColorTo_4A05E0(getMemIntPtr(0x5D4594, 1307280), f, sbuf))
				break;
		} else if (!strcmp(sbuf, "TEXTCOLOR")) {
			if (!nox_gui_parseColorTo_4A05E0(getMemIntPtr(0x5D4594, 1307284), f, sbuf))
				break;
		} else if (!strcmp(sbuf, "BACKGROUNDCOLOR")) {
			if (!nox_gui_parseColorTo_4A05E0(getMemIntPtr(0x5D4594, 1307272), f, sbuf))
				break;
