...
int __cdecl sub_48D560(unsigned __int16 a1) {
	...
	v1 = sub_425890(getMemIntPtr(0x5D4594, 1197340));
	if (!v1)
		return 0;
	while (v1[2] != a1) {
		v1 = sub_4258A0(v1);
		...
		if (!result) {
			...
			if (result) {
				...
				*((_QWORD*)v2 + 2) = sub_416BB0();
				...
				result = (_DWORD*)sub_425790(getMemIntPtr(0x5D4594, 1197340), v2);
			}
		}
	}
	return result;
...
int sub_48D660() {
	...
	if (dword_5d4594_1197352) {
		do {
			...
			v2 = sub_4258A0(v1);
			if (!v2) {
				v2 = sub_425890(getMemIntPtr(0x5D4594, 1197340));
				if (v2 == v1)
					v2 = 0;
			}
...
_DWORD* sub_48D760() {
	...
	v0 = sub_425890(getMemIntPtr(0x5D4594, 1197340));
	if (v0) {
		do {
			v1 = sub_4258A0(v0);
...
int* sub_48D7B0() {
	...
	for (result = sub_425890(getMemIntPtr(0x5D4594, 1197340)); result; result = sub_4258A0(result))
		;
	return result;
}
...
int sub_495430() {
	...
	for (i = nox_win_height / 4 / 36; v1 != dword_5d4594_1203836; v1 = (v1 + 1) % 100) {
		...
		if ((unsigned int)(*getMemU32Ptr(0x5D4594, 2598000) - *getMemU32Ptr(0x5D4594, 24 * v0 + 1201448)) <= 0x5A) {
			sub_495500(getMemIntPtr(0x5D4594, 24 * v1 + 1201428));
			v0 = dword_5d4594_1203840;
			...
			if (v9) {
				...
				if (v10 != 255) {
					...
					if (getMemByte(0x5D4594, 12332 * v11 + 2692780) & 1) {
						if (v12 & 0x40) {
							if ((*getMemIntPtr(0x5D4594, 1217444) - v69 - 11) * (*getMemIntPtr(0x5D4594, 1217444) - v69 - 11) +
		...
		do {
			...
			case 6u:
				...
				*(_DWORD*)(v34 + 132) = 1;
				...
				v86.field_8 =
					(double)(*(int*)(v34 + 12) + *getMemIntPtr(0x587000, 8 * *(unsigned __int8*)(v34 + 299) + 196184));
				v86.field_C =
					(double)(*(int*)(v34 + 16) + *getMemIntPtr(0x587000, 8 * *(unsigned __int8*)(v34 + 299) + 196188));
		...
		if (v55) {
			...
			if (*getMemU32Ptr(0x5D4594, 4 * v53 + 1213348) != *getMemU32Ptr(0x5D4594, 4 * v54 + 1213348)) {
				...
				LABEL_83:
					...
					if (*getMemIntPtr(0x5D4594, 8 * v53 + 1203880) - v61 >= 0)
...
void __cdecl sub_4974B0(int a1) {
	...
	if (!(*(_BYTE*)(a1 + 116) & 4)) {
		...
		*(_DWORD*)(v2 + 20) = a1;
		...
		v4 =
			(double)(int)(*getMemU32Ptr(0x5D4594, 1217444) - *getMemIntPtr(0x587000, v3 + 196184) / 2 - *(_DWORD*)(a1 + 12));
		v15 = dword_5d4594_1217448 - *getMemIntPtr(0x587000, v3 + 196188) / 2 - *(_DWORD*)(a1 + 16);
		...
		*(_DWORD*)(v2 + 40) = v5;
		...
		v8 = sub_4CA8B0(*(_DWORD*)(v1 + 16) + *getMemIntPtr(0x587000, 8 * *(unsigned __int8*)(v1 + 299) + 196188) -
							dword_5d4594_1217448,
						*(_DWORD*)(v1 + 12) + *getMemIntPtr(0x587000, 8 * *(unsigned __int8*)(v1 + 299) + 196184) -
...
int __cdecl sub_4977C0(int a1) {
	...
	result = (unsigned __int8)sub_497B80(v38, getMemIntPtr(0x5D4594, 1217444)) - 1;
	switch (result) {
	case 0:
		v35 = (v38[5] + v38[1]) * 0.5;
...
int __cdecl sub_4984B0_drawable(int a1) {
	...
	if ((signed char)*(_BYTE*)(a1 + 112) >= 0) {
		...
		v5 = *getMemIntPtr(0x587000, v4 + 196184);
		v6 = v3 + v5 / 2;
		v42 = v3 + v5 / 2;
		v43 = *(_DWORD*)(a1 + 16) + *getMemIntPtr(0x587000, v4 + 196188) / 2;
	}
...
BOOL __cdecl sub_4992B0(int a1, int a2) {
	...
	if (*(int*)&dword_5d4594_1217464 > 0) {
		...
		do {
			v4 = *getMemIntPtr(0x5D4594, v3 + 1203876);
			v5 = *getMemIntPtr(0x5D4594, v3 + 1203880);
			v6 = *getMemIntPtr(0x5D4594, 8 * v8 + 1203880);
			if (v6 > a2) {
				if (v5 > a2)
					goto LABEL_11;
			} else if (a2 < v5) {
			...
			if (a2 < v6) {
			LABEL_8:
				if (a1 >= *getMemIntPtr(0x5D4594, 8 * v8 + 1203876) +
							  (a2 - v6) * (v4 - *getMemIntPtr(0x5D4594, 8 * v8 + 1203876)) / (v5 - v6)) {
					result = v7;
				} else {
					result = !v7;
					v7 = !v7;
...
_DWORD* __cdecl sub_499880(__int16* a1) {
	...
	for (i = 0; i < 256; i += 6) {
		result = (_DWORD*)sub_45A360_drawable(*getMemIntPtr(0x5D4594, 1217508), *a1, a1[1]);
		v3 = result;
		if (result) {
			v4 = 8 * (__int16)i;
			*((_WORD*)v3 + 254) = i;
...
void sub_49AEE0() {
	...
	if (dword_5d4594_1301824 > 0) {
		...
		if (dword_5d4594_1301812 > *getMemIntPtr(0x5D4594, 1301804))
...
int sub_49BA70() {
	...
	if (dword_5d4594_1303468) {
		do {
			...
			if (*(_DWORD*)(result + 356) > *getMemIntPtr(0x5D4594, 2598000))
				break;
...
void __cdecl sub_49D370(int a1, int a2, int a3, int a4) {
	...
	v16 = (*getMemU32Ptr(0x5D4594, 3804364) & (unsigned int)v4) >> getMemByte(0x5D4594, 3804364 + 12);
	v15 = (*getMemU32Ptr(0x5D4594, 3804364 + 4) & (unsigned int)v4) >> getMemByte(0x5D4594, 3804364 + 16);
	v14 = ((unsigned __int8)ptr_5D4594_3799572->data[61] & getMemByte(0x5D4594, 3804364 + 8)) << getMemByte(0x5D4594, 3804364 + 20);
	result = a4 - 1;
	if (a4) {
		v7 = a3;
		v8 = 4 * a2;
				...
				while (1) {
					...
					*(v10 - 1) =
						*(_WORD*)(dword_5d4594_3804664 +
								  2 * (unsigned __int8)((((unsigned __int8)v12 & v5) << getMemByte(0x5D4594, 3804364 + 20)) +
														((v14 - (unsigned __int8)(((unsigned __int8)v12 & v5)
																				  << getMemByte(0x5D4594, 3804364 + 20))) >>
														 1))) |
						*(_WORD*)(dword_5d4594_3804656 +
								  2 * (unsigned __int8)(((unsigned __int16)(*getMemU16Ptr(0x5D4594, 3804364 + 4) & v12) >>
...
int __cdecl sub_49D540(int a1, int a2, int a3, int a4)
{
    ...
    v4 = _m_psrlw(_m_pand(v18, *(__m64*) getMemAt(0x5D4594, 3804364 + 32)), *(__m64*) getMemAt(0x5D4594, 3804364 + 80));
    v5 = _m_psrlw(_m_pand(v18, *(__m64*) getMemAt(0x5D4594, 3804364 + 40)), *(__m64*) getMemAt(0x5D4594, 3804364 + 88));
    v6 = _m_psllw(_m_pand(v18, *(__m64*) getMemAt(0x5D4594, 3804364 + 48)), *(__m64*) getMemAt(0x5D4594, 3804364 + 96));
...
LABEL_2:
    while (1)
    {
        ...
        while (1)
        {
            v12 = _m_psrlw(_m_pand((__m64)v11->m64_u64, *(__m64*) getMemAt(0x5D4594, 3804364 + 32)), *(__m64*) getMemAt(0x5D4594, 3804364 + 80));
            v13 = _m_psrlw(_m_pand((__m64)v11->m64_u64, *(__m64*) getMemAt(0x5D4594, 3804364 + 40)), *(__m64*) getMemAt(0x5D4594, 3804364 + 88));
            v14 = _m_psllw(_m_pand((__m64)v11->m64_u64, *(__m64*) getMemAt(0x5D4594, 3804364 + 48)), *(__m64*) getMemAt(0x5D4594, 3804364 + 96));
            v15 = _m_por(
                _m_por(
                    _m_pand(
                        _m_psllw(_m_paddw(v12, _m_psrlwi(_m_psubw(v4, v12), 1u)), *(__m64*) getMemAt(0x5D4594, 3804364 + 80)),
                        *(__m64*) getMemAt(0x5D4594, 3804364 + 32)),
                    _m_pand(
                        _m_psllw(_m_paddw(v13, _m_psrlwi(_m_psubw(v5, v13), 1u)), *(__m64*) getMemAt(0x5D4594, 3804364 + 88)),
                        *(__m64*) getMemAt(0x5D4594, 3804364 + 40))),
                _m_psrlw(_m_paddw(v14, _m_psrlwi(_m_psubw(v6, v14), 1u)), *(__m64*) getMemAt(0x5D4594, 3804364 + 96)));
            v16 = v9 < 4;
            v9 -= 4;
            if (v16)
                break;
...
__int16 __cdecl sub_49D6F0(int a1, int a2, unsigned int a3, int a4) {
	...
	if (a4 > 0) {
		LOWORD(v4) = a2;
		v5 = &nox_pixbuffer_rows_3798784[a2];
		v6 = *getMemU32Ptr(0x5D4594, 3804364 + 24);
		v7 = 2 * a1;
		v8 = a3 & 1;
...
void __cdecl sub_49D770(int a1, int a2, unsigned int a3, int a4)
{
    ...
    if (a4 > 0 && (int)a3 > 0)
    {
        ...
        v5 = *(__m64*) getMemAt(0x5D4594, 3804364 + 152);
        v6 = _mm_cvtsi64_si32(*(__m64*) getMemAt(0x5D4594, 3804364 + 152));
        v7 = 2 * a1;
        v8 = a3 >> 1;
        if (a3 & 1)
        {
...
int __cdecl sub_49D8E0(int a1, int a2, int a3, int a4) {
	...
	do {
		...
		do {
			...
			v8 = (unsigned __int16)(*getMemU16Ptr(0x5D4594, 3804364) & *v6) >> getMemByte(0x5D4594, 3804364 + 12);
			...
			v9 = (*getMemU32Ptr(0x5D4594, 3804364 + 4) & v7) >> getMemByte(0x5D4594, 3804364 + 16);
			...
			v10 = (*getMemU32Ptr(0x5D4594, 3804364 + 8) & v7) << getMemByte(0x5D4594, 3804364 + 20);
                ...
                _m_por(
                    _m_pand(
                        _m_psllw(
                            _m_paddusb(
                                _m_psrlw(
                                    _m_pand((__m64)v11->m64_u64, *(__m64*) getMemAt(0x5D4594, 3804364 + 32)),
                                    *(__m64*) getMemAt(0x5D4594, 3804364 + 80)),
                                v5),
                            *(__m64*) getMemAt(0x5D4594, 3804364 + 80)),
                        *(__m64*) getMemAt(0x5D4594, 3804364 + 32)),
                    _m_pand(
                        _m_psllw(
                            _m_paddusb(
                                _m_psrlw(
                                    _m_pand((__m64)v11->m64_u64, *(__m64*) getMemAt(0x5D4594, 3804364 + 40)),
                                    *(__m64*) getMemAt(0x5D4594, 3804364 + 88)),
                                v6),
                            *(__m64*) getMemAt(0x5D4594, 3804364 + 88)),
                        *(__m64*) getMemAt(0x5D4594, 3804364 + 40))),
                _m_psrlw(
                    _m_paddusb(
                        _m_psllw(
                            _m_pand((__m64)v11->m64_u64, *(__m64*) getMemAt(0x5D4594, 3804364 + 48)),
                            *(__m64*) getMemAt(0x5D4594, 3804364 + 96)),
                        v7),
                    *(__m64*) getMemAt(0x5D4594, 3804364 + 96)));
            v13 = v9 < 4;
            v9 -= 4;
...
int __cdecl sub_49DBB0(int a1, int a2, int a3, int a4) {
	...
	do {
		...
		v6 = (_WORD*)(a1 + a1 + v5);
		do {
			v7 = ((unsigned __int16)(*getMemU16Ptr(0x5D4594, 3804364 + 4) & *v6) >> getMemByte(0x5D4594, 3804364 + 16)) -
				 (unsigned __int64)*(unsigned int*)&obj_5D4594_3800716.data[55];
			v8 = ((unsigned __int16)(*getMemU16Ptr(0x5D4594, 3804364 + 8) & *v6) << getMemByte(0x5D4594, 3804364 + 20)) -
			...
			result =
				...
				*(_DWORD*)(dword_5d4594_3804672 +
						   2 * (~((__PAIR64__(*getMemUintPtr(0x5D4594, 3804364 + 12),
											  (unsigned __int16)(*getMemU16Ptr(0x5D4594, 3804364) & *v6) >>
												  getMemByte(0x5D4594, 3804364 + 12)) -
								   __PAIR64__(*getMemUintPtr(0x5D4594, 3804364 + 12),
											  *(unsigned int*)&obj_5D4594_3800716.data[54])) >>
								  32) &
								(((unsigned __int16)(*getMemU16Ptr(0x5D4594, 3804364) & *v6) >> getMemByte(0x5D4594, 3804364 + 12)) -
...
int4* __cdecl sub_49E060(int a1, int a2, int a3, int a4, int a5) {
	...
	v9 = a1;
	v31 = (unsigned __int16)(*getMemU16Ptr(0x5D4594, 3804364) & a1) >> getMemByte(0x5D4594, 3804364 + 12);
	v32 = (unsigned __int16)(*getMemU16Ptr(0x5D4594, 3804364 + 4) & a1) >> getMemByte(0x5D4594, 3804364 + 16);
	v33 = (unsigned __int16)(*getMemU16Ptr(0x5D4594, 3804364 + 8) & a1) << getMemByte(0x5D4594, 3804364 + 20);
	result = v8;
	v10 = (int)v8 - 1;
	if (result) {
		v11 = 2 * v6;
					...
					if (*v38[0] == v9 || *v13 == v9 || *v38[2] == v9 || *v38[3] == v9 || *v14 == v9 || *v38[5] == v9 ||
						*v38[6] == v9 || *v15 == v9 || *v38[8] == v9) {
						...
						do {
							...
							++v16;
							v21 = *v19;
							v17 += v20 * ((*getMemU32Ptr(0x5D4594, 3804364) & v21) >> getMemByte(0x5D4594, 3804364 + 12));
							v18 += v20 * ((*getMemU32Ptr(0x5D4594, 3804364 + 4) & v21) >> getMemByte(0x5D4594, 3804364 + 16));
							v49 += v20 * ((*getMemU32Ptr(0x5D4594, 3804364 + 8) & v21) << getMemByte(0x5D4594, 3804364 + 20));
						} while (v16 < 9);
						v22 = v17 / 12;
						v23 = v18 / 12;
						v24 = v49 / 12;
		...
		if (result) {
			if (!ptr_5D4594_3799572->data[0] || sub_49F990(&v29, &v30, &v28, &v27)) {
				v16 = (unsigned __int16)(*getMemU16Ptr(0x5D4594, 3804364) & *(_WORD*)(&obj_5D4594_3800716.data[61])) >>
					  getMemByte(0x5D4594, 3804364 + 12);
				v17 = (unsigned __int16)(*getMemU16Ptr(0x5D4594, 3804364 + 4) & *(_WORD*)(&obj_5D4594_3800716.data[61])) >>
					  getMemByte(0x5D4594, 3804364 + 16);
				v18 = (unsigned __int16)(*getMemU16Ptr(0x5D4594, 3804364 + 8) & *(_WORD*)(&obj_5D4594_3800716.data[61]))
					  << getMemByte(0x5D4594, 3804364 + 20);
				v2 = nox_pixbuffer_rows_3798784;
				v3 = v28 - v29;
				v4 = 2;
						...
						*v14 =
							*(_WORD*)(dword_5d4594_3804656 +
									  2 * (unsigned __int8)(((unsigned __int16)(*(_WORD*)(&obj_5D4594_3800716
																							   .data[259]) *
																				(v17 -
																				 ((unsigned __int16)(*getMemU16Ptr(0x5D4594, 3804364 + 4) &
																									 v15) >>
																				  getMemByte(0x5D4594, 3804364 + 16)))) >>
															 8) +
															((unsigned __int16)(*getMemU16Ptr(0x5D4594, 3804364 + 4) & v15) >>
															 getMemByte(0x5D4594, 3804364 + 16)))) |
							*(_WORD*)(dword_5d4594_3804672 +
									  2 * (unsigned __int8)(((unsigned __int16)(*(_WORD*)(&obj_5D4594_3800716
																							   .data[259]) *
							...
							*(_WORD*)(dword_5d4594_3804664 +
									  2 * (unsigned __int8)(((unsigned __int16)(*(_WORD*)(&obj_5D4594_3800716
																							   .data[259]) *
																				(v18 -
																				 ((unsigned __int16)(*getMemU16Ptr(0x5D4594, 3804364 + 8) &
																									 v15)
																				  << getMemByte(0x5D4594, 3804364 + 20)))) >>
															 8) +
															((unsigned __int16)(*getMemU16Ptr(0x5D4594, 3804364 + 8) & v15)
															 << getMemByte(0x5D4594, 3804364 + 20))));
						v11 = v22-- < 1;
						if (v11)
							break;
									  ...
									  2 * (unsigned __int8)(((unsigned __int16)(*(_WORD*)(&obj_5D4594_3800716
																				...
																				(v17 -
																				 ((unsigned __int16)(*getMemU16Ptr(0x5D4594, 3804364 + 4) &
																				  ...
																				  getMemByte(0x5D4594, 3804364 + 16)))) >>
															 8) +
															((unsigned __int16)(*getMemU16Ptr(0x5D4594, 3804364 + 4) & v10) >>
															 getMemByte(0x5D4594, 3804364 + 16)))) |
							*(_WORD*)(dword_5d4594_3804672 +
									  2 * (unsigned __int8)(((unsigned __int16)(*(_WORD*)(&obj_5D4594_3800716
																							   .data[259]) *
									  ...
									  2 * (unsigned __int8)(((unsigned __int16)(*(_WORD*)(&obj_5D4594_3800716
																				...
																				(v18 -
																				 ((unsigned __int16)(*getMemU16Ptr(0x5D4594, 3804364 + 8) &
																				  ...
																				  << getMemByte(0x5D4594, 3804364 + 20)))) >>
															 8) +
															((unsigned __int16)(*getMemU16Ptr(0x5D4594, 3804364 + 8) & v10)
															 << getMemByte(0x5D4594, 3804364 + 20))));
						v11 = v20-- < 1;
						if (v11)
							break;
...
__int16 __cdecl sub_49F210(int a1, int a2, int a3)
{
    ...
    if (!v20)
    {
        ...
        v12 = _m_psrlw(_m_pand(v11, *(__m64*) getMemAt(0x5D4594, 3804364 + 40)), *(__m64*) getMemAt(0x5D4594, 3804364 + 88));
        v13 = _m_psllw(_m_pand(v11, *(__m64*) getMemAt(0x5D4594, 3804364 + 48)), *(__m64*) getMemAt(0x5D4594, 3804364 + 96));
        v14 = (__m64*)(*(_DWORD*)(*(_DWORD*)& nox_pixbuffer_rows_3798784 + 4 * a2) + 2 * v4);
        v15 = _m_psrlw(_m_pand(v11, *(__m64*) getMemAt(0x5D4594, 3804364 + 32)), *(__m64*) getMemAt(0x5D4594, 3804364 + 80));
        while (1)
        {
            v16 = _m_psrlw(_m_pand((__m64)v14->m64_u64, *(__m64*) getMemAt(0x5D4594, 3804364 + 32)), *(__m64*) getMemAt(0x5D4594, 3804364 + 80));
            v17 = _m_psrlw(_m_pand((__m64)v14->m64_u64, *(__m64*) getMemAt(0x5D4594, 3804364 + 40)), *(__m64*) getMemAt(0x5D4594, 3804364 + 88));
            v18 = _m_psllw(_m_pand((__m64)v14->m64_u64, *(__m64*) getMemAt(0x5D4594, 3804364 + 48)), *(__m64*) getMemAt(0x5D4594, 3804364 + 96));
            v19 = _m_por(
                _m_por(
                    _m_pand(
                        _m_psllw(_m_paddw(v16, _m_psrlwi(_m_psubw(v15, v16), 1u)), *(__m64*) getMemAt(0x5D4594, 3804364 + 80)),
                        *(__m64*) getMemAt(0x5D4594, 3804364 + 32)),
                    _m_pand(
                        _m_psllw(_m_paddw(v17, _m_psrlwi(_m_psubw(v12, v17), 1u)), *(__m64*) getMemAt(0x5D4594, 3804364 + 88)),
                        *(__m64*) getMemAt(0x5D4594, 3804364 + 40))),
                _m_psrlw(_m_paddw(v18, _m_psrlwi(_m_psubw(v13, v18), 1u)), *(__m64*) getMemAt(0x5D4594, 3804364 + 96)));
            v20 = v9 < 4;
            v9 -= 4;
            if (v20)
                break;
...
int __cdecl sub_49F5B0(_DWORD* a1, _DWORD* a2, int a3) {
	...
	if (*getMemIntPtr(0x5D4594, 3798692) <= 0)
		return 0;
		...
		if (sub_43AF70()) {
			...
			if (*getMemU32Ptr(0x587000, 4 * a1 + 166016) > 0) {
				...
				do {
					...
					v4 += 16;
					++v7;
				} while (v7 < *getMemIntPtr(0x587000, 4 * a1 + 166016));
			}
		} else {
...
int* __cdecl sub_49FFA0(int a1) {
	...
	result = sub_425890(getMemIntPtr(0x5D4594, 1305796));
	v2 = result;
	if (result) {
		do {
			v3 = sub_4258A0(v2);
...
int __cdecl sub_4A0030(const void* a1) {
	...
	case 0:
		...
		v3 = sub_425890(getMemIntPtr(0x5D4594, 1305796));
		if (!v3)
			goto LABEL_6;
		do {
...
int __cdecl sub_4A0330(int* a1) {
	...
	v1 = 0;
	for (i = sub_425890(getMemIntPtr(0x5D4594, 1305796)); i; i = sub_4258A0(i)) {
		if (i == a1)
			break;
		++v1;
	}
...
int __cdecl sub_4A0410(const char* a1, __int16 a2) {
	...
	v2 = sub_425890(getMemIntPtr(0x5D4594, 1305796));
	if (!v2)
		return 1;
...
int* __cdecl sub_4A04F0(char* a1) {
	...
	v1 = sub_425890(getMemIntPtr(0x5D4594, 1305796));
	if (!v1)
		return 0;
...
nox_window* __cdecl nox_new_window_from_file(const char* name, int (*a2)(int, int, int, int)) {
	...
	while (fscanf(f, "%s", getMemAt(0x5D4594, 1306948)) != -1 && strcmp((const char*)getMemAt(0x5D4594, 1306948), "END")) {
		if (!strcmp((const char*)getMemAt(0x5D4594, 1306948), "ENABLEDCOLOR")) {
			v3 = sub_4A05E0(getMemIntPtr(0x5D4594, 1307264), f, (char*)getMemAt(0x5D4594, 1306948));
			if (!v3)
				break;
		} else {
			if (!strcmp((const char*)getMemAt(0x5D4594, 1306948), "DISABLEDCOLOR")) {
				v3 = sub_4A05E0(getMemIntPtr(0x5D4594, 1307268), f, (char*)getMemAt(0x5D4594, 1306948));
				if (!v3)
					break;
			}
			if (!strcmp((const char*)getMemAt(0x5D4594, 1306948), "HILITECOLOR")) {
				v3 = sub_4A05E0(getMemIntPtr(0x5D4594, 1307276), f, (char*)getMemAt(0x5D4594, 1306948));
				if (!v3)
					break;
			}
			if (!strcmp((const char*)getMemAt(0x5D4594, 1306948), "SELECTEDCOLOR")) {
				v3 = sub_4A05E0(getMemIntPtr(0x5D4594, 1307280), f, (char*)getMemAt(0x5D4594, 1306948));
				if (!v3)
					break;
			}
			if (!strcmp((const char*)getMemAt(0x5D4594, 1306948), "TEXTCOLOR")) {
				v3 = sub_4A05E0(getMemIntPtr(0x5D4594, 1307284), f, (char*)getMemAt(0x5D4594, 1306948));
				if (!v3)
					break;
			}
			if (!strcmp((const char*)getMemAt(0x5D4594, 1306948), "BACKGROUNDCOLOR")) {
				v3 = sub_4A05E0(getMemIntPtr(0x5D4594, 1307272), f, (char*)getMemAt(0x5D4594, 1306948));
				if (!v3)
					break;
			}
...
BOOL __cdecl sub_4A1780(int a1, FILE* a2, char* a3) {
	...
	while (fscanf(a2, "%s", a3) != -1 && strcmp(a3, "END")) {
		if (!strcmp(a3, "ENABLEDCOLOR")) {
			v3 = (_DWORD*)sub_4A05E0(getMemIntPtr(0x5D4594, 1307264), a2, a3);
		LABEL_14:
			if (!v3)
				return 0;
		} else {
			if (!strcmp(a3, "DISABLEDCOLOR")) {
				v3 = (_DWORD*)sub_4A05E0(getMemIntPtr(0x5D4594, 1307268), a2, a3);
				goto LABEL_14;
			}
			if (!strcmp(a3, "HILITECOLOR")) {
				v3 = (_DWORD*)sub_4A05E0(getMemIntPtr(0x5D4594, 1307276), a2, a3);
				goto LABEL_14;
			}
			if (!strcmp(a3, "SELECTEDCOLOR")) {
				v3 = (_DWORD*)sub_4A05E0(getMemIntPtr(0x5D4594, 1307280), a2, a3);
				goto LABEL_14;
			}
			if (!strcmp(a3, "TEXTCOLOR")) {
				v3 = (_DWORD*)sub_4A05E0(getMemIntPtr(0x5D4594, 1307284), a2, a3);
				goto LABEL_14;
			}
			if (!strcmp(a3, "WINDOW")) {
