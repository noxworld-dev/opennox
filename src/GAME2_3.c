...
int nox_video_initLineDrawingFuncs_49E3F0() {
	if (!dword_5d4594_3801780) {
		...
		*getMemU32Ptr(0x85B3FC, 1148996) = sub_49EFC0;
		*getMemU32Ptr(0x85B3FC, 1149000) = sub_49ED80;
	...
	*getMemU32Ptr(0x85B3FC, 1148996) = sub_49F010;
	*getMemU32Ptr(0x85B3FC, 1149000) = sub_49ED80;
	return 1;
}
...
//----- (0049E4F0) --------------------------------------------------------
int  sub_49E4F0(int a1) { return (*(int(**)(_DWORD, _DWORD)) getMemAt(0x85B3FC, 1149000))(a1, 0); }
...
//----- (0049EFA0) --------------------------------------------------------
int  sub_49EFA0(int a1, int a2) { return (*(int(**)(_DWORD, _DWORD)) getMemAt(0x85B3FC, 1148996))(a1, a2); }
...
BOOL sub_49F4A0() {
	...
	*getMemU32Ptr(0x85B3FC, 1148988) = 0;
...
int  nox_client_drawAddPoint_49F500(int a1, int a2) {
	if (*getMemU32Ptr(0x85B3FC, 1148988) >= *(int*)&dword_5d4594_1305724) {
	...
	*(_DWORD*)(dword_5d4594_3798696 + 8 * *getMemU32Ptr(0x85B3FC, 1148988) + 4) = a2;
	return ++*getMemU32Ptr(0x85B3FC, 1148988);
}
...
int  nox_xxx_rasterPointRel_49F570(int a1, int a2) {
	...
	result = *getMemU32Ptr(0x85B3FC, 1148988);
	if (*getMemU32Ptr(0x85B3FC, 1148988))
		result = nox_client_drawAddPoint_49F500(
			a1 + *(_DWORD*)(dword_5d4594_3798696 + 8 * *getMemU32Ptr(0x85B3FC, 1148988) - 8),
			a2 + *(_DWORD*)(dword_5d4594_3798696 + 8 * *getMemU32Ptr(0x85B3FC, 1148988) - 4));
	return result;
}
...
int  sub_49F5B0(_DWORD* a1, _DWORD* a2, int a3) {
	...
	if (*getMemIntPtr(0x85B3FC, 1148988) <= 0)
		return 0;
	v3 = --*getMemU32Ptr(0x85B3FC, 1148988);
	if (a1)
		*a1 = *(_DWORD*)(dword_5d4594_3798696 + 8 * v3);
	if (a2)
		*a2 = *(_DWORD*)(dword_5d4594_3798696 + 8 * *getMemU32Ptr(0x85B3FC, 1148988) + 4);
	if (a3)
		++*getMemU32Ptr(0x85B3FC, 1148988);
	return 1;
}
