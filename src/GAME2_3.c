...
int sub_48D000() {
	...
	*(_DWORD*)&byte_5D4594[1197320] = sub_46B0C0(*(_DWORD**)&dword_5d4594_1197312, 4321);
	...
	*(_DWORD*)&byte_5D4594[1301836] = a1;
	if (*(_DWORD*)(dword_5d4594_1301848 + 4 * a1)) {
		...
		if (*(_DWORD*)&byte_5D4594[1301832]) {
			if (*(_DWORD*)&byte_5D4594[1301832] != dword_5d4594_1301800) {
		...
		if (result) {
			*result = a2;
			result[1] = a3;
			result[2] = 0;
			*(_DWORD*)(dword_5d4594_1301848 + 4 * *(_DWORD*)&byte_5D4594[1301836]) = result;
		}
	}
	return result;
}
