...
uint32_t*  nox_xxx_updDrawAddRndSpark_4CDFA0(int a1, uint32_t* a2) {
	...
	if ((int)a2 > 0) {
		...
		do {
			result =
				(uint32_t*)nox_xxx_spriteLoadAdd_45A360_drawable(*getMemIntPtr(0x5D4594, 1523008), *(uint32_t*)(a1 + 12), *(uint32_t*)(a1 + 16));
			v4 = result;
			if (result) {
				result[108] = *(uint32_t*)(a1 + 12) << 12;
				result[109] = *(uint32_t*)(a1 + 16) << 12;
				*((uint8_t*)result + 299) = nox_common_randomIntMinMax_415FF0(0, 255, "C:\\NoxPost\\src\\Client\\Drawable\\Update\\dball.c", 37);
				...
				*((uint16_t*)v4 + 52) = 22;
				*((uint8_t*)v4 + 296) = nox_common_randomIntMinMax_415FF0(0, 4, "C:\\NoxPost\\src\\Client\\Drawable\\Update\\dball.c", 49);
