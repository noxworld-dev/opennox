...
func (s *Server) CinemaPlayers(enable bool) {
	...
	for it := s.FirstServerObject(); it != nil; it = next {
		...
		if it.OwnerC() != nil {
			...
			nox_xxx_spellCancelDurSpell4FEB10(spell.SPELL_WALL, it)
			nox_xxx_spellCancelDurSpell4FEB10(spell.SPELL_MANA_BOMB, it)
			nox_xxx_spellCancelDurSpell4FEB10(spell.SPELL_LIGHTNING, it)
			nox_xxx_spellCancelDurSpell4FEB10(spell.SPELL_CHAIN_LIGHTNING, it)
			nox_xxx_spellCancelDurSpell4FEB10(spell.SPELL_DRAIN_MANA, it)
			nox_xxx_spellCancelDurSpell4FEB10(spell.SPELL_FORCE_OF_NATURE, it)
			nox_xxx_spellCancelDurSpell4FEB10(spell.SPELL_GREATER_HEAL, it)
			nox_xxx_spellCancelDurSpell4FEB10(spell.SPELL_CHANNEL_LIFE, it)
			nox_xxx_spellCancelDurSpell4FEB10(spell.SPELL_CHARM, it)
			nox_xxx_spellCancelDurSpell4FEB10(spell.SPELL_BLINK, it)
			nox_xxx_spellCancelDurSpell4FEB10(spell.SPELL_SWAP, it)
			nox_xxx_spellCancelDurSpell4FEB10(spell.SPELL_TURN_UNDEAD, it)
			nox_xxx_spellCancelDurSpell4FEB10(spell.SPELL_PLASMA, it)
			nox_xxx_spellCancelDurSpell4FEB10(spell.SPELL_SUMMON_BAT, it)
		}
	}
}
