...
int sub_430F00_screenshot() {
	...
	if (!file) {
		v2 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 80968), 0, "C:\\NoxPost\\src\\Client\\Io\\Win95\\Video.c", 375);
	...
	v8 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 81068), 0, "C:\\NoxPost\\src\\Client\\Io\\Win95\\Video.c", 399);
	sub_4517A0(v8, path);
	return fclose(file);
}
