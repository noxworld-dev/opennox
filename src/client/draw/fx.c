	...
	if (a2 > 0) {
		do {
			...
			if (v7) {
				...
				*(_DWORD*)(v8 + 448) =
					*getMemU32Ptr(0x5D4594, 2598000) + sub_415FF0(a4, 64, "C:\\NoxPost\\src\\client\\Draw\\Fx.c", 233);
...
int __cdecl sub_499710(int a1, int a2, __int16 a3, int a4) {
	...
	do {
		...
		if (v4) {
			...
			*(_DWORD*)(v5 + 448) =
				*getMemU32Ptr(0x5D4594, 2598000) + sub_415FF0(5, 20, "C:\\NoxPost\\src\\client\\Draw\\Fx.c", 274);
