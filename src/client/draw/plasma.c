...
int __cdecl sub_4BA230(int a1, int a2, int a3, int a4, int a5) {
	...
	v5 = 0;
	if (!*(_DWORD*)getMemAt(0x5D4594, 1316404)) {
		*(_DWORD*)getMemAt(0x5D4594, 1313828) = sub_4344A0(40, 180, 255);
		*(_DWORD*)getMemAt(0x5D4594, 1313832) = sub_4344A0(255, 255, 255);
		*(_DWORD*)getMemAt(0x5D4594, 1313836) = sub_4344A0(40, 180, 255);
		*(_DWORD*)getMemAt(0x5D4594, 1313844) = 8;
		*(_DWORD*)getMemAt(0x5D4594, 1313852) = 8;
		*(_DWORD*)getMemAt(0x5D4594, 1313856) = 0;
		*(_DWORD*)getMemAt(0x5D4594, 1313860) = 0;
		*getMemAt( 0x5D4594, 1313840) = 16;
		*getMemAt( 0x5D4594, 1313842) = 16;
		*(_DWORD*)getMemAt(0x5D4594, 1313848) = 12;
		*getMemAt( 0x5D4594, 1313841) = 24;
		v6 = getMemAt(0x5D4594, 1313900);
		*(_DWORD*)getMemAt(0x5D4594, 1313864) = 0;
		do {
			v7 = 30;
			do {
				*((_DWORD*)v6 - 1) = 0;
		...
		*(_DWORD*)getMemAt(0x5D4594, 1316404) = 1;
	}
	...
	for (i = 0; i < 3; ++i) {
		...
		do {
			v11 = 28 * (30 * i + v10);
			v12 = *(_DWORD*)getMemAt(0x5D4594, v11 + 1313900) + *(_DWORD*)getMemAt(0x5D4594, v11 + 1313896);
			*(_DWORD*)getMemAt(0x5D4594, v11 + 1313896) = v12;
			if (v12 < 256) {
				if (v12 >= 0)
					goto LABEL_14;
				v13 = v12 + 255;
			...
			*(_DWORD*)getMemAt(0x5D4594, v11 + 1313896) = v13;
		LABEL_14:
			if (!v10)
				*(_DWORD*)getMemAt(0x5D4594, 840 * i + 1313896) = a1;
			v14 = *(_DWORD*)getMemAt(0x5D4594, v11 + 1313904) + *(_DWORD*)getMemAt(0x5D4594, v11 + 1313900);
			*(_DWORD*)getMemAt(0x5D4594, v11 + 1313900) = v14;
			if (i == 1) {
				if (v14 <= 10) {
					if (v14 < -10)
						*(_DWORD*)getMemAt(0x5D4594, 28 * v10 + 1314740) = -10;
				} else {
					*(_DWORD*)getMemAt(0x5D4594, 28 * v10 + 1314740) = 10;
				}
			} else if (v14 <= 25) {
				if (v14 < -25)
					*(_DWORD*)getMemAt(0x5D4594, v11 + 1313900) = -25;
			} else {
				*(_DWORD*)getMemAt(0x5D4594, v11 + 1313900) = 25;
			}
			v15 = *(_DWORD*)getMemAt(0x5D4594, v11 + 1313908) - 1;
			*(_DWORD*)getMemAt(0x5D4594, v11 + 1313908) = v15;
			if (v15 <= 0) {
				*(_DWORD*)getMemAt(0x5D4594, v11 + 1313908) =
					sub_415FF0(10, 90, "C:\\NoxPost\\src\\client\\Draw\\Plasma.c", 378);
				*(_DWORD*)getMemAt(0x5D4594, v11 + 1313904) =
					sub_415FF0(4, 8, "C:\\NoxPost\\src\\client\\Draw\\Plasma.c", 382);
				if (sub_415FF0(0, 1, "C:\\NoxPost\\src\\client\\Draw\\Plasma.c", 385))
					*(_DWORD*)getMemAt(0x5D4594, v11 + 1313904) = -*(_DWORD*)getMemAt(0x5D4594, v11 + 1313904);
				if (i == 1) {
					*(_DWORD*)getMemAt(0x5D4594, 28 * v10 + 1314732) =
						sub_415FF0(40, 50, "C:\\NoxPost\\src\\client\\Draw\\Plasma.c", 392);
				} else {
					*(_DWORD*)getMemAt(0x5D4594, v11 + 1313892) =
					...
					if (v10 < 4 && sub_415FF0(0, 100, "C:\\NoxPost\\src\\client\\Draw\\Plasma.c", 402) > 90) {
						...
						*(_DWORD*)getMemAt(0x5D4594, v11 + 1313908) *= 2;
					}
				}
			}
			result = dword_5d4594_1316408;
	...
	for (j = 0; j < 3; ++j) {
		if (result > 0) {
			...
			do {
				...
				sub_4BE800(*(_DWORD*)getMemAt(0x5D4594, 4 * j + 1313828));
				sub_4BE810(1, *(_DWORD*)getMemAt(0x5D4594, 4 * j + 1313828), *(_DWORD*)getMemAt(0x5D4594, 4 * j + 1313844),
...
char __cdecl sub_4BA8B0(int* a1, int* a2, int* a3) {
	...
	v3 = *a3;
	v4 = sub_437250();
	if (!*(_DWORD*)getMemAt(0x5D4594, 1316416))
		*(_DWORD*)getMemAt(0x5D4594, 1316416) = sub_44CFC0((CHAR*)getMemAt(0x587000, 178156));
	v6 = 28 * (dword_5d4594_1316412 + 30 * v3);
	v5 = dword_5d4594_1316412 + 1;
	*(_DWORD*)getMemAt(0x5D4594, v6 + 1313884) = *a1;
	*(_DWORD*)getMemAt(0x5D4594, v6 + 1313888) = a1[1];
	*(_DWORD*)getMemAt(0x5D4594, v6 + 1313912) = *a2;
	*(_DWORD*)getMemAt(0x5D4594, v6 + 1313916) = a2[1];
