...
int __cdecl nox_thing_blue_rain_draw(int a1, nox_drawable* dr) {
	...
	if (nox_common_gameFlags_check_40A5C0(0x200000))
		return 1;
	if (!*(_DWORD*)getMemAt(0x5D4594, 1313716))
		*(_DWORD*)getMemAt(0x5D4594, 1313716) = sub_44CFC0((CHAR*)getMemAt(0x587000, 176640));
	v3 = a2;
	v9 = 2;
	do {
		...
		if (v7) {
			...
			*(_DWORD*)(v7 + 440) = 0;
			*(_DWORD*)(v7 + 448) =
				*(_DWORD*)getMemAt(0x5D4594, 2598000) + sub_415FF0(90, 120, "C:\\NoxPost\\src\\client\\Draw\\PartRain.c", 63);
...
int __cdecl nox_thing_levelup_draw(int a1, nox_drawable* dr) {
	...
	v2 = *(_DWORD*)getMemAt(0x5D4594, 1313708);
	if (!*(_DWORD*)getMemAt(0x5D4594, 1313708)) {
		v2 = sub_44CFC0((CHAR*)getMemAt(0x587000, 176492));
		*(_DWORD*)getMemAt(0x5D4594, 1313708) = v2;
	}
...
int __cdecl nox_thing_oblivion_up_draw(int a1, nox_drawable* dr) {
	...
	v2 = *(_DWORD*)getMemAt(0x5D4594, 1313712);
	if (!*(_DWORD*)getMemAt(0x5D4594, 1313712)) {
		v2 = sub_44CFC0((CHAR*)getMemAt(0x587000, 176628));
		*(_DWORD*)getMemAt(0x5D4594, 1313712) = v2;
	}
	nox_thing_falling_sparks_draw_4B7740(v2, a1, dr);
	return 1;
}
