...
int __cdecl nox_thing_blue_rain_draw(int a1, nox_drawable* dr) {
	...
	if (!*getMemU32Ptr(0x5D4594, 1313716))
		*getMemU32Ptr(0x5D4594, 1313716) = sub_44CFC0((CHAR*)getMemAt(0x587000, 176640));
	v3 = a2;
	v9 = 2;
	do {
		...
		if (v7) {
			...
			*(_DWORD*)(v7 + 440) = 0;
			*(_DWORD*)(v7 + 448) =
				*getMemU32Ptr(0x5D4594, 2598000) + sub_415FF0(90, 120, "C:\\NoxPost\\src\\client\\Draw\\PartRain.c", 63);
