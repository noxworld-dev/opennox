...
int __cdecl sub_4CD450(_DWORD* a1, int a2) {
	...
	if (nox_common_randomIntMinMax_415FF0(0, 100, "C:\\NoxPost\\src\\client\\Drawable\\Update\\healup.c", 20) < 50) {
		if (*(_BYTE*)(a2 + 432)) {
			...
			if (!v8 || !v10)
				return 1;
			v2 = v10[3] + nox_common_randomIntMinMax_415FF0(-20, 20, "C:\\NoxPost\\src\\client\\Drawable\\Update\\healup.c", 61);
			v3 = v12[4] + nox_common_randomIntMinMax_415FF0(-20, 20, "C:\\NoxPost\\src\\client\\Drawable\\Update\\healup.c", 62);
			v4 = v8[4];
			v22 = v8[3];
		} else {
			if (a2 == -432)
		...
		if (v19) {
			...
			*(_WORD*)(v19 + 434) = v23;
			*(_BYTE*)(v19 + 443) = v20;
			*(_BYTE*)(v19 + 444) = nox_common_randomIntMinMax_415FF0(3, 10, "C:\\NoxPost\\src\\client\\Drawable\\Update\\healup.c", 99);
		}
	}
	return 1;
}
