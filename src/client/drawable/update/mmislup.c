...
int __cdecl sub_4CD9E0(int a1, _DWORD* a2) {
	...
	if (*(_DWORD*)&byte_587000[190108] > 0) {
		while (1) {
			...
			v5 = v2[9];
			v6 =
			    v3 * sub_415FF0(0, 100, "C:\\NoxPost\\src\\Client\\Drawable\\Update\\mmislup.c", 40) / 100 +
			    v4;
			v8 = (v15 * sub_415FF0(0, 100, "C:\\NoxPost\\src\\Client\\Drawable\\Update\\mmislup.c", 41)) /
				 100 +
			     v5;
			...
			if (v9) {
				...
				*(_DWORD*)(v9 + 436) = v8 << 12;
				*(_BYTE*)(v9 + 299) =
				    sub_415FF0(0, 255, "C:\\NoxPost\\src\\Client\\Drawable\\Update\\mmislup.c", 52);
				*(_DWORD*)(v10 + 440) = 0;
				*(_DWORD*)(v10 + 448) =
				...
				*(_WORD*)(v10 + 104) = 20;
				*(_BYTE*)(v10 + 296) =
				    sub_415FF0(0, 6, "C:\\NoxPost\\src\\Client\\Drawable\\Update\\mmislup.c", 65);
