...
char* sub_446970_wol_chat() {
	...
	if (!*(_DWORD*)&byte_5D4594[829568]) {
		...
		if (*(_DWORD*)&byte_587000[108852]) {
			...
			do {
				*(_DWORD*)v2 = loadString_sub_40F1D0(
...
const char* __cdecl sub_446AE0_wol_chat(int a1) {
	...
	if (result) {
		...
		if (sub_41F9E0((int)v3)) {
			result = (const char*)loadString_sub_40F1D0(
			    (char*)&byte_587000[110384], 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolchat.c", 293);
			if (result)
...
int __cdecl sub_4474C0_wol_chat(int a1, int a2) {
	...
	if (a1) {
		v2 = loadString_sub_40F1D0((char*)&byte_587000[110672], 0,
					   "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolchat.c", 1277);
		nox_swprintf((wchar_t*)&byte_5D4594[827176], v2, a2, a1);
	} else {
		v3 = loadString_sub_40F1D0((char*)&byte_587000[110728], 0,
					   "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolchat.c", 1281);
		...
		*(_DWORD*)&byte_5D4594[829520] = result;
		if (result) {
			...
			*(_DWORD*)&byte_5D4594[829532] = loadString_sub_40F1D0(
			    (char*)&byte_587000[110980], 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolchat.c", 1416);
			...
			if (**(_BYTE**)&byte_587000[108828]) {
				...
				do {
					v3 = loadString_sub_40F1D0(
					    *v1, 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolchat.c", 1446);
					*((_DWORD*)v2 - 1) = v3;
					nox_wcslen(v3);
			...
			*(_DWORD*)&byte_5D4594[829516] = sub_46B0C0(*(_DWORD**)&dword_5d4594_829480, 1919);
			...
			sub_46B280(*(int*)&byte_5D4594[829508], *(int*)&dword_5d4594_829492);
			...
			*(_DWORD*)&byte_5D4594[829516] = sub_46B0C0(*(_DWORD**)&dword_5d4594_829480, 1925);
			...
			sub_4B5700(*(int*)&byte_5D4594[829508], 0, 0, (int)v6, (int)v7, (int)v7);
			sub_46B280(*(int*)&byte_5D4594[829508], *(int*)&dword_5d4594_829488);
