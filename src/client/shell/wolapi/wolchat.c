...
char* sub_446970_wol_chat() {
	...
	if (!*getMemU32Ptr(0x5D4594, 829568)) {
		...
		if (*getMemU32Ptr(0x587000, 108852)) {
			...
			do {
				*(_DWORD*)v2 = nox_xxx_loadString_40F1D0(*((char**)v2 + 1), 0,
...
int __cdecl sub_446A20_wol_chat(wchar_t* a1) {
	...
	sub_41F140(a1);
	sub_44A400();
	v3 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 110256), 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolchat.c",
							   212);
	v1 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 110324), 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolchat.c",
							   211);
...
const char* __cdecl sub_446AE0_wol_chat(int a1) {
	...
	if (result) {
		...
		if (sub_41F9E0((int)v3)) {
			result = (const char*)nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 110384), 0,
...
void __cdecl sub_446F80_wol_chat(wchar_t* a1) {
	...
	v8 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 110480), 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolchat.c",
							   1076);
	if (v8)
		sub_447310(0, (int)v8);
}
...
void __cdecl sub_447090_wol_chat(wchar_t* a1) {
	...
	v8 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 110540), 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolchat.c",
							   1123);
	if (v8)
		sub_447310(0, (int)v8);
}
...
int sub_447470_wol_chat() {
	...
	v0 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 110616), 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolchat.c",
							   1261);
	result = sub_41EC00();
	if (result) {
...
int __cdecl sub_4474C0_wol_chat(int a1, int a2) {
	...
	if (a1) {
		v2 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 110672), 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolchat.c",
								   1277);
		nox_swprintf((wchar_t*)getMemAt(0x5D4594, 827176), v2, a2, a1);
	} else {
		v3 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 110728), 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolchat.c",
								   1281);
...
int __cdecl sub_447540_wol_chat(int a1) {
	...
	v1 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 110792), 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolchat.c",
							   1296);
...
int sub_447590_wol_chat() {
	...
	v0 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 110848), 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolchat.c",
							   1310);
	result = sub_41EC00();
	if (result) {
		nox_swprintf((wchar_t*)getMemAt(0x5D4594, 827176), v0, result);
...
int sub_447620_wol_chat() {
	...
	if (dword_5d4594_829480) {
		...
		if (nox_wnd_xxx_829520) {
			...
			*getMemU32Ptr(0x5D4594, 829528) = nox_xxx_loadString_40F1D0(
				(char*)getMemAt(0x587000, 110916), 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolchat.c", 1415);
			dword_5d4594_829532 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 110980), 0,
														"C:\\NoxPost\\src\\client\\shell\\WolApi\\wolchat.c", 1416);
			*getMemU32Ptr(0x5D4594, 829536) = getMemAt(0x587000, 110992);
			*getMemU32Ptr(0x5D4594, 829540) = nox_xxx_loadString_40F1D0(
			...
			*getMemU32Ptr(0x5D4594, 829548) = nox_xxx_loadString_40F1D0(
				(char*)getMemAt(0x587000, 111120), 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolchat.c", 1420);
			*getMemU32Ptr(0x5D4594, 829552) = nox_xxx_loadString_40F1D0(
			...
			*getMemU32Ptr(0x5D4594, 829560) = nox_xxx_loadString_40F1D0(
				(char*)getMemAt(0x587000, 111264), 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolchat.c", 1423);
			*getMemU32Ptr(0x5D4594, 829564) = nox_xxx_loadString_40F1D0(
				(char*)getMemAt(0x587000, 111328), 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolchat.c", 1424);
			*getMemU32Ptr(0x5D4594, 829524) = nox_xxx_loadString_40F1D0(
			...
			if (**(_BYTE**)getMemAt(0x587000, 108828)) {
				...
				do {
					v3 = nox_xxx_loadString_40F1D0(*v1, 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolchat.c", 1446);
					*((_DWORD*)v2 - 1) = v3;
					nox_wcslen(v3);
			...
			sub_41FFF0();
			dword_5d4594_829508 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_829480, 1917);
			dword_5d4594_829512 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_829480, 1918);
			dword_5d4594_829516 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_829480, 1919);
			...
			*(_DWORD*)(*(_DWORD*)(dword_5d4594_829508 + 400) + 12) = 46;
			dword_5d4594_829508 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_829480, 1920);
			dword_5d4594_829512 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_829480, 1921);
			dword_5d4594_829516 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_829480, 1922);
			...
			*(_DWORD*)(*(_DWORD*)(dword_5d4594_829508 + 400) + 8) = 16;
			*(_DWORD*)(*(_DWORD*)(dword_5d4594_829508 + 400) + 12) = 46;
			dword_5d4594_829508 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_829480, 1923);
			dword_5d4594_829512 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_829480, 1924);
			dword_5d4594_829516 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_829480, 1925);
