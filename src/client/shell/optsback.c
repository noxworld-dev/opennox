	...
	if (a2 == 21 && a3 == 1) {
		...
		if (!sub_44A4A0()) {
			if (sub_43BE10() == 10000) {
				...
				v6 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 168540), 0,
										   "C:\\NoxPost\\src\\client\\shell\\OptsBack.c", 65);
				v5 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 168608), 0,
	...
	if (a2 == 16389) {
		...
		if (sub_43BE30() != 2 && sub_43BE30() != 3 || sub_4D6F30()) {
			...
			if (v3) {
				if (v3 == 1) {
					if (sub_43BE10() == 100) {
						v6 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 168732), 0,
												   "C:\\NoxPost\\src\\client\\shell\\OptsBack.c", 142);
						v4 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 168800), 0,
												   "C:\\NoxPost\\src\\client\\shell\\OptsBack.c", 141);
						sub_449A10(*(int*)&dword_5d4594_1307292, (int)v4, (int)v6, 56, sub_4A19D0, 0);
					} else {
						if (sub_4D6F30())
							sub_4D6F90(2);
						if (sub_43BE10() == 700)
