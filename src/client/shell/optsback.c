	...
	if (a2 == 21 && a3 == 1) {
		...
		if (!sub_44A4A0()) {
			if (sub_43BE10() == 10000) {
				...
				v6 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 168540), 0,
										   "C:\\NoxPost\\src\\client\\shell\\OptsBack.c", 65);
				v5 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 168608), 0,
...
int __cdecl sub_4A19F0(char* a1) {
	...
	v1 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1307292, 152);
	v2 = nox_xxx_loadString_40F1D0(a1, 0, "C:\\NoxPost\\src\\client\\shell\\OptsBack.c", 171);
	...
	if (a2 == 16389) {
		...
		if (sub_43BE30() != 2 && sub_43BE30() != 3 || sub_4D6F30()) {
			...
			if (v3) {
				if (v3 == 1) {
					if (sub_43BE10() == 100) {
						v6 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 168732), 0,
												   "C:\\NoxPost\\src\\client\\shell\\OptsBack.c", 142);
						v4 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 168800), 0,
