	...
	if (a2 != 16389) {
		...
		if (v4) {
			...
			*(_DWORD*)(dword_5d4594_1309708 + 52) = sub_4379F0;
			...
			if (!sub_41D440()) {
				v7 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 172696), 0,
										   "C:\\NoxPost\\src\\client\\shell\\ArnaMain.c", 100);
				v5 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 172756), 0,
										   "C:\\NoxPost\\src\\client\\shell\\ArnaMain.c", 100);
			...
			if (sub_40D5B0((int)&a2) && a2 < 0x10009) {
				sub_41D4C0();
				v8 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 172804), 0,
										   "C:\\NoxPost\\src\\client\\shell\\ArnaMain.c", 111);
				v6 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 172864), 0,
										   "C:\\NoxPost\\src\\client\\shell\\ArnaMain.c", 111);
