...
int __cdecl sub_4C9BF0(int a1) {
	...
	case 1u:
		...
		v10 = loadString_sub_40F1D0((char*)&byte_587000[186124], 0,
	...
	case 3u:
		...
		if (!v13)
			return 6;
		v51 = (int)(v13 + 4704);
		v14 = loadString_sub_40F1D0((char*)&byte_587000[186320], 0,
					    "C:\\NoxPost\\src\\client\\Network\\inform.c", 147);
	...
	case 4u:
		...
		if (!v15)
			return 6;
		v52 = (int)(v15 + 4704);
		v16 = loadString_sub_40F1D0((char*)&byte_587000[186384], 0,
	...
	case 5u:
		...
		v19 = loadString_sub_40F1D0((char*)&byte_587000[186524], 0,
	...
	case 6u:
		...
		v21 = loadString_sub_40F1D0((char*)&byte_587000[186592], 0,
	...
	case 7u:
		...
		if (v22) {
			...
			v23 = loadString_sub_40F1D0((char*)&byte_587000[186660], 0,
	...
	case 8u:
		...
		v17 = loadString_sub_40F1D0((char*)&byte_587000[186456], 0,
	...
	case 9u:
		...
		if (!v39) {
			if (v38) {
				v41 = loadString_sub_40F1D0((char*)&byte_587000[187308], 0,
		...
		if (!v38)
			return 10;
		v46 = (int)(v39 + 4704);
		v40 = loadString_sub_40F1D0((char*)&byte_587000[187240], 0,
					    "C:\\NoxPost\\src\\client\\Network\\inform.c", 365);
	...
	case 0xAu:
		...
		if (v35) {
			if (!v34)
				return 10;
			v61 = v35;
			v36 = loadString_sub_40F1D0((char*)&byte_587000[187108], 0,
			...
			if (!v34)
				return 10;
			v37 = loadString_sub_40F1D0((char*)&byte_587000[187176], 0,
						    "C:\\NoxPost\\src\\client\\Network\\inform.c", 343);
	...
	case 0xBu:
		...
		if (v31) {
			if (v30) {
				v60 = v31;
				v32 = loadString_sub_40F1D0((char*)&byte_587000[186984], 0,
			...
			v33 = loadString_sub_40F1D0((char*)&byte_587000[187048], 0,
						    "C:\\NoxPost\\src\\client\\Network\\inform.c", 312);
		...
		return 10;
	case 0xCu:
		v11 = loadString_sub_40F1D0((char*)&byte_587000[186192], 0,
					    "C:\\NoxPost\\src\\client\\Network\\inform.c", 128);
		sub_445490(v11);
		if (!*(_DWORD*)(a1 + 2))
			return 6;
		v12 = loadString_sub_40F1D0((char*)&byte_587000[186260], 0,
					    "C:\\NoxPost\\src\\client\\Network\\inform.c", 132);
		sub_445490(v12);
		return 6;
	case 0xDu:
		switch (*(_DWORD*)(a1 + 2)) {
		case 0:
			v2 = loadString_sub_40F1D0((char*)&byte_587000[185600], 0,
						   "C:\\NoxPost\\src\\client\\Network\\inform.c", 27);
			sub_445490(v2);
			result = 6;
			break;
		case 1:
			v3 = loadString_sub_40F1D0((char*)&byte_587000[185668], 0,
						   "C:\\NoxPost\\src\\client\\Network\\inform.c", 31);
			sub_445490(v3);
			result = 6;
			break;
		case 2:
			v4 = loadString_sub_40F1D0((char*)&byte_587000[185736], 0,
						   "C:\\NoxPost\\src\\client\\Network\\inform.c", 35);
			sub_445490(v4);
			result = 6;
			break;
		case 3:
			v5 = loadString_sub_40F1D0((char*)&byte_587000[185804], 0,
						   "C:\\NoxPost\\src\\client\\Network\\inform.c", 39);
			sub_445490(v5);
			result = 6;
			break;
		default:
	...
	case 0xFu:
		...
		if (sub_4356B0() != 3)
			goto LABEL_57;
		if (*(_BYTE*)(a1 + 2)) {
			v47 = loadString_sub_40F1D0((char*)(a1 + 3), 0, "C:\\NoxPost\\src\\client\\Network\\inform.c",
						    397);
			v43 = loadString_sub_40F1D0((char*)&byte_587000[187420], 0,
						    "C:\\NoxPost\\src\\client\\Network\\inform.c", 396);
			nox_swprintf(v63, v43, v47);
			sub_445490(v63);
			result = v42 + 3;
		} else {
			v44 = loadString_sub_40F1D0((char*)(a1 + 3), 0, "C:\\NoxPost\\src\\client\\Network\\inform.c",
						    402);
			sub_445490(v44);
		LABEL_57:
			result = v42 + 3;
	...
	case 0x10u:
		...
		v9 = loadString_sub_40F1D0((char*)&byte_587000[186064], 0,
					   "C:\\NoxPost\\src\\client\\Network\\inform.c", 105);
		nox_swprintf(v62, v9, v49);
		sub_445490(v62);
		return 6;
	case 0x11u:
		v45 = loadString_sub_40F1D0((char*)&byte_587000[185864], 0,
					    "C:\\NoxPost\\src\\client\\Network\\inform.c", 51);
		v6 = loadString_sub_40F1D0((char*)&byte_587000[185932], 0,
					   "C:\\NoxPost\\src\\client\\Network\\inform.c", 50);
	...
	case 0x12u:
		...
		if (!v24)
			return 6;
		v57 = (int)(v24 + 4704);
		v25 = loadString_sub_40F1D0((char*)&byte_587000[186724], 0,
					    "C:\\NoxPost\\src\\client\\Network\\inform.c", 247);
	...
	case 0x13u:
		...
		if (v26) {
			v58 = (int)(v26 + 4704);
			v27 = loadString_sub_40F1D0((char*)&byte_587000[186788], 0,
	...
	case 0x14u:
		...
		if (!v7)
			return 6;
		v48 = (int)(v7 + 4704);
		v8 = loadString_sub_40F1D0((char*)&byte_587000[185992], 0,
	...
	case 0x15u:
		v59 = *(_DWORD*)(a1 + 2);
		v28 = loadString_sub_40F1D0((char*)&byte_587000[186856], 0,
					    "C:\\NoxPost\\src\\client\\Network\\inform.c", 281);
		nox_swprintf(v62, v28, v59);
		v29 = loadString_sub_40F1D0((char*)&byte_587000[186928], 0,
					    "C:\\NoxPost\\src\\client\\Network\\inform.c", 282);
