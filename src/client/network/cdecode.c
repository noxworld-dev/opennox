...
int __cdecl sub_48EA70(int a1, unsigned int a2, int a3) {
	...
	while (1) {
		...
		case 0x2Au:
			v9 = 1;
			if (v7 == 40) {
				*(_DWORD*)getMemAt(0x5D4594, 2598000) = *(_DWORD*)(v3 + 1);
				*(_DWORD*)getMemAt(0x5D4594, 1200800) = *(_DWORD*)getMemAt(0x5D4594, 2598000);
				v364 = *(_DWORD*)getMemAt(0x5D4594, 2598000);
				*(_DWORD*)getMemAt(0x5D4594, 1200808) = *(unsigned __int16*)getMemAt(0x5D4594, 2598000) >> 14;
				...
				if ((unsigned __int16)v14 < (unsigned int)(*(_DWORD*)getMemAt(0x5D4594, 1200800) + sub_43C790()))
					*(_DWORD*)getMemAt(0x5D4594, 2598000) = v14;
				v3 += 5;
				break;
			}
			v373 = v3;
			if (*(_DWORD*)getMemAt(0x5D4594, 2618908) && *(_BYTE*)(*(_DWORD*)getMemAt(0x5D4594, 2618908) + 3680) & 0x40)
				return 1;
			v10 = *(_DWORD*)getMemAt(0x5D4594, 2598000);
			v11 = *(_WORD*)(v3 + 1);
			v12 = v11 + (*(_DWORD*)getMemAt(0x5D4594, 2598000) & 0xFFFF0000);
			v13 = v11 >> 14;
			if (v13 != *(_DWORD*)getMemAt(0x5D4594, 1200808)) {
				if (v13 == ((getMemByte(0x5D4594, 1200808) + 1) & 3)) {
					*(_DWORD*)getMemAt(0x5D4594, 1200808) = v13;
					if (!v13)
						v12 += 0x10000;
				} else {
					v9 = 0;
			...
			if (v12 < *(int*)getMemAt(0x5D4594, 2598000))
				v9 = 0;
			if (!nox_common_gameFlags_check_40A5C0(1) && v9 == 1) {
				*(_DWORD*)getMemAt(0x5D4594, 2598000) = v12;
				*(_DWORD*)getMemAt(0x5D4594, 1200800) = v12;
			}
			v364 = v12;
			if (!nox_common_gameFlags_check_40A5C0(1) && !v9) {
				--dword_5d4594_2618900;
				++*(_DWORD*)getMemAt(0x5D4594, 2649824);
				return 1;
			}
			if (*(_DWORD*)getMemAt(0x5D4594, 2598000) > (unsigned int)(v10 + 1))
				dword_5d4594_2618900 += *(_DWORD*)getMemAt(0x5D4594, 2598000) - v10;
			sub_43C650();
			v3 += 3;
			break;
		case 0x2Bu:
			...
			if (*(_DWORD*)(v3 + 37) > *(int*)&dword_5d4594_1200804) {
				...
				sub_40A4D0(0x800000);
				dword_5d4594_1200804 = *(_DWORD*)getMemAt(0x5D4594, 2598000);
				sub_43C720(0);
				sub_49C7A0();
				sub_4597E0(0);
				sub_44A400();
		...
		case 0x2Cu:
			...
			*(_DWORD*)getMemAt(0x5D4594, 2616328) = v42;
			v43 = sub_416F60(v42);
			if (v43) {
				*((_DWORD*)v43 + 517) = *(_DWORD*)(v3 + 3);
				*(_DWORD*)getMemAt(0x5D4594, 2618908) = v43;
			}
			if (!nox_common_gameFlags_check_40A5C0(1))
			...
			*(_DWORD*)getMemAt(0x5D4594, 2649824) = 0;
		...
		case 0x2Du:
			...
			if (v211) {
				...
				sub_455920((int)v212);
				v213 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 159072), 0,
											 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 4661);
				nox_swprintf(v399, v213, v212);
				if (sub_4356B0() == 3)
					sub_445490(v399);
				if (v210 == *(_DWORD*)getMemAt(0x5D4594, 2616328) && nox_wcscmp((const wchar_t*)getMemAt(0x5D4594, 2661908), v212))
		...
		case 0x2Eu:
			if (nox_client_isConnected_43C700()) {
				...
				if (v216) {
					...
					v217 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 159128), 0,
					...
					*((_DWORD*)v216 + 523) = 0;
					...
					v220 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 159180), 0,
		...
		case 0x2Fu:
			...
			if (nox_client_isConnected_43C700()) {
				...
				if ((_DWORD)v5) {
					k = *(_DWORD*)getMemAt(0x5D4594, 2598000);
					*(_DWORD*)(v5 + 288) = *(_DWORD*)getMemAt(0x5D4594, 2598000);
				}
			}
			v3 += 9;
			break;
				...
				if ((_DWORD)v5) {
					...
					*(_BYTE*)(v3 + 9) = v30;
					if (*(_DWORD*)(v29 + 276) != v30) {
						*(_DWORD*)(v29 + 316) = *(_DWORD*)getMemAt(0x5D4594, 2598000);
						HIDWORD(v5) = *(unsigned __int8*)(v3 + 9);
						*(_DWORD*)(v29 + 276) = HIDWORD(v5);
					}
				}
				k = *(_DWORD*)getMemAt(0x5D4594, 2616328);
				if (*(unsigned __int16*)(v3 + 1) == *(_DWORD*)getMemAt(0x5D4594, 2616328) && sub_416120(9u))
		...
		case 0x32u:
			...
			if (v51 == *(_DWORD*)getMemAt(0x5D4594, 2614252)) {
				v3 += 3;
				break;
			}
		...
		case 0x33u:
			...
			*(_DWORD*)(v5 + 488) = 1;
			if (nox_client_fadeObjects_80836) {
				if ((_DWORD)v5 != *(_DWORD*)getMemAt(0x5D4594, 2614252))
					sub_49B950((_DWORD*)v5, *(int*)getMemAt(0x5D4594, 2649704));
		...
		case 0x45u:
			...
			if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_NET_DEBUG))
				sub_578B70(*(unsigned __int16*)(v3 + 1));
			if (v97 != *(_DWORD*)getMemAt(0x5D4594, 2616328))
				goto LABEL_1163;
		...
		case 0x47u:
			if (!nox_client_isConnected_43C700())
				goto LABEL_966;
			sub_470D20(*(unsigned __int8*)(v3 + 1), *(int*)getMemAt(0x587000, 157092));
			v3 += 2;
			break;
		case 0x48u:
			v98 = sub_578B30(*(_WORD*)(v3 + 1));
			v99 = *(_DWORD*)getMemAt(0x5D4594, 2618908);
			v100 = v98;
			if (nox_client_isConnected_43C700()) {
				if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_NET_DEBUG))
					sub_578B70(*(unsigned __int16*)(v3 + 1));
				if (v100 == *(_DWORD*)getMemAt(0x5D4594, 2616328)) {
			...
			if (nox_client_isConnected_43C700()) {
				...
				if (v127) {
					if (!nox_common_gameFlags_check_40A5C0(1)) {
						...
						*((_DWORD*)v127 + 536) = *(_DWORD*)getMemAt(0x5D4594, 2598000);
					}
					if (nox_common_gameFlags_check_40A5C0(1024)) {
						k = *(_DWORD*)(v3 + 7);
						if (k >= *((unsigned __int16*)v126 + 27)) {
							v128 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 157264), 0,
		...
		case 0x55u:
			...
			if (nox_client_isConnected_43C700()) {
				...
				if (v142) {
					if (!nox_common_gameFlags_check_40A5C0(1) &&
						*(_DWORD*)getMemAt(0x5D4594, 2598000) > *((_DWORD*)v142 + 540)) {
						HIWORD(v5) = 0;
						*((_DWORD*)v142 + 538) = *(unsigned __int16*)(v3 + 3);
						WORD2(v5) = *(_WORD*)(v3 + 5);
						*((_DWORD*)v142 + 539) = WORD2(v5);
						*((_DWORD*)v142 + 540) = *(_DWORD*)getMemAt(0x5D4594, 2598000);
					}
					k = *((_DWORD*)v142 + 539) - 1;
					if (*((_DWORD*)v142 + 538) == k) {
						v143 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 157316), 0,
		...
		case 0x56u:
			...
			if (!nox_common_getEngineFlag(NOX_ENGINE_FLAG_DISABLE_GRAPHICS_RENDERING))
				sub_470510();
			v145 = sub_418C80(*(int*)getMemAt(0x5D4594, 2616328));
			if (v145 && sub_419180((int)v145, *(_BYTE*)(v3 + 1))) {
				v146 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 157372), 0,
											 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 3776);
				nox_swprintf(v400, v146);
				v147 = 0;
			} else {
				v148 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 157420), 0,
											 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 3781);
				nox_swprintf(v400, v148, v144);
				v149 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 157472), 0,
		...
		case 0x57u:
			...
			v393[0] = 0;
			if (*(_BYTE*)(v3 + 3) == 1) {
				v173 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 158612), 0,
			...
			if (!nox_common_getEngineFlag(NOX_ENGINE_FLAG_DISABLE_GRAPHICS_RENDERING))
				sub_470510();
			v174 = sub_418C80(*(int*)getMemAt(0x5D4594, 2616328));
			if (v172) {
				v175 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 158672), 0,
				...
				v177 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 158724), 0,
		...
		case 0x58u:
			...
			v391[0] = 0;
			if (*(_BYTE*)(v3 + 3) == 1) {
				v151 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 157524), 0,
			...
			if (!nox_common_gameFlags_check_40A5C0(1024)) {
				if (*(_WORD*)(v3 + 1)) {
					...
					if (!*(_BYTE*)(v3 + 3))
						sub_4947E0((int)v154);
					if (v153 != *(_DWORD*)getMemAt(0x5D4594, 2616328)) {
						v159 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 157884), 0,
					...
					if (!v154[2252]) {
						v314 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 157932), 0,
													 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 3905);
						nox_swprintf(v389, v314);
						goto LABEL_558;
					}
					v155 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 157988), 0,
												 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 3907);
				} else {
					v155 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 157836), 0,
			...
			if (!*(_WORD*)(v3 + 1)) {
				v155 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 157584), 0,
											 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 3847);
				goto LABEL_557;
			}
			v156 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 157632), 0, "C:\\NoxPost\\src\\Client\\Network\\cdecode.c",
										 3852);
			nox_swprintf(v389, v156);
			if (v153 == *(_DWORD*)getMemAt(0x5D4594, 2616328)) {
				v334 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 157684), 0,
											 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 3855);
				v157 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 157732), 0,
											 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 3855);
			...
			if (v154) {
				v158 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 157784), 0,
		...
		case 0x59u:
			...
			v394[0] = 0;
			if (*(_BYTE*)(v3 + 3) == 1) {
				v161 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 158048), 0,
			...
			if (!nox_common_getEngineFlag(NOX_ENGINE_FLAG_DISABLE_GRAPHICS_RENDERING))
				sub_470510();
			v162 = sub_418C80(*(int*)getMemAt(0x5D4594, 2616328));
			if (nox_common_gameFlags_check_40A5C0(1024)) {
				if (!v160) {
					v163 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 158108), 0,
												 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 3964);
					nox_swprintf(v390, v163);
					v164 = 0;
					goto LABEL_585;
				}
				v165 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 158156), 0,
											 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 3969);
				nox_swprintf(v390, v165);
				if (v162 && sub_419180((int)v162, v160[57])) {
					v335 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 158208), 0,
												 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 3973);
					v166 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 158260), 0,
												 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 3973);
					nox_swprintf(v388, v166, v335);
					nox_wcscat(v390, v388);
					v164 = 0;
				} else {
					v336 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 158312), 0,
												 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 3980);
					v167 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 158360), 0,
												 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 3980);
				...
				if (!v160) {
					v168 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 158412), 0,
				...
				if (v162 && sub_419180((int)v162, v160[57])) {
					v169 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 158460), 0,
												 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 4006);
					nox_swprintf(v390, v169);
					v164 = 0;
				} else {
					v170 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 158516), 0,
												 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 4011);
					nox_swprintf(v388, v170, v160);
					v171 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 158564), 0,
		...
		case 0x5Au:
			...
			*(_DWORD*)(v134 + 124) = HIDWORD(v5);
			if (v134 == *(_DWORD*)getMemAt(0x5D4594, 2614252))
				sub_467410(*(_DWORD*)(v3 + 3));
			if (v135 != 1 || sub_4356C0(v134, 15) || v134 == *(_DWORD*)getMemAt(0x5D4594, 2614252) && sub_467430() & 8)
				goto LABEL_1149;
		...
		case 0x5Bu:
			if (nox_client_isConnected_43C700()) {
				...
				if (v130 == 1 && !(sub_467430() & 8) && *(_DWORD*)getMemAt(0x5D4594, 2614252) &&
					!sub_4356C0(*(int*)getMemAt(0x5D4594, 2614252), 15)) {
					nox_thing* v131 = nox_get_thing(*(_DWORD*)(*(_DWORD*)getMemAt(0x5D4594, 2614252) + 108));
					sub_484D70_light_intensity(*(_DWORD*)getMemAt(0x5D4594, 2614252) + 136, v131->light_intensity);
				}
			}
			v3 += 2;
			break;
		case 0x5Cu:
			...
			if ((_DWORD)v5) {
				sub_484BE0((_DWORD*)(v5 + 136), *(unsigned __int8*)(v3 + 3), *(unsigned __int8*)(v3 + 4),
		...
		case 0x65u:
			...
			break;
		case 0x66u:
			if (nox_client_isConnected_43C700() && *(_DWORD*)getMemAt(0x5D4594, 2614252)) {
				HIDWORD(v5) = *(_DWORD*)(v3 + 1);
				*(_DWORD*)(*(_DWORD*)getMemAt(0x5D4594, 2614252) + 120) = HIDWORD(v5);
			}
			v3 += 5;
			break;
		case 0x67u:
		...
		case 0x68u:
			...
			if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_NET_DEBUG))
				sub_578B70(*(unsigned __int16*)(v3 + 1));
			if (v83 == *(_DWORD*)getMemAt(0x5D4594, 2616328)) {
				LOBYTE(k) = *(_BYTE*)(v3 + 7);
		...
		case 0x6Au:
			...
			if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_DISABLE_GRAPHICS_RENDERING) ||
				(HIDWORD(v5) = *(unsigned __int16*)(v3 + 1), WORD2(v5) != *(_DWORD*)getMemAt(0x5D4594, 2616328))) {
			LABEL_1070:
				v3 += 7;
			} else {
				if (v119[3680] & 1) {
		...
		case 0x7Eu:
			if (nox_client_isConnected_43C700()) {
				sub_4B7C40(*(_WORD*)(v3 + 5), (unsigned __int16*)(v3 + 1), *(_WORD*)(v3 + 7), *(_BYTE*)(v3 + 9),
						   *(_WORD*)(v3 + 10));
				v3 += 12;
			} else {
			LABEL_1130:
		...
		case 0x81u:
			if (!nox_client_isConnected_43C700())
				goto LABEL_797;
			sub_499610(*(int*)&dword_5d4594_1200776, 50, 1000, 30, *(__int16*)(v3 + 1), *(__int16*)(v3 + 3));
			v3 += 5;
			break;
		case 0x82u:
			if (!nox_client_isConnected_43C700())
				goto LABEL_797;
			sub_499610(*(int*)getMemAt(0x5D4594, 1200780), 25, 500, 25, *(__int16*)(v3 + 1), *(__int16*)(v3 + 3));
			v3 += 5;
			break;
		case 0x83u:
			if (!nox_client_isConnected_43C700())
				goto LABEL_797;
			sub_499610(*(int*)getMemAt(0x5D4594, 1200784), 25, 500, 25, *(__int16*)(v3 + 1), *(__int16*)(v3 + 3));
			v3 += 5;
			break;
		case 0x84u:
			if (nox_client_isConnected_43C700())
				sub_499610(*(int*)&dword_5d4594_1200796, 25, 500, 25, *(__int16*)(v3 + 1), *(__int16*)(v3 + 3));
		LABEL_797:
			v3 += 5;
			break;
		case 0x85u:
		...
		case 0xA3u:
			if (nox_client_isConnected_43C700()) {
				...
				switch (v8) {
				case 133:
					v257 = *(_DWORD*)getMemAt(0x5D4594, 1200872);
					if (!*(_DWORD*)getMemAt(0x5D4594, 1200872)) {
						v257 = sub_44CFC0((CHAR*)getMemAt(0x587000, 160152));
						*(_DWORD*)getMemAt(0x5D4594, 1200872) = v257;
					}
					v258 = *(__int16*)(v3 + 3);
					goto LABEL_858;
				case 134:
					v257 = *(_DWORD*)getMemAt(0x5D4594, 1200876);
					if (!*(_DWORD*)getMemAt(0x5D4594, 1200876)) {
						v257 = sub_44CFC0((CHAR*)getMemAt(0x587000, 160164));
						*(_DWORD*)getMemAt(0x5D4594, 1200876) = v257;
					}
					v258 = *(__int16*)(v3 + 3);
					goto LABEL_858;
				case 135:
					v257 = *(_DWORD*)getMemAt(0x5D4594, 1200880);
					if (!*(_DWORD*)getMemAt(0x5D4594, 1200880)) {
						v257 = sub_44CFC0((CHAR*)getMemAt(0x587000, 160180));
						*(_DWORD*)getMemAt(0x5D4594, 1200880) = v257;
					}
					v258 = *(__int16*)(v3 + 3);
					goto LABEL_858;
				case 136:
					v257 = *(_DWORD*)getMemAt(0x5D4594, 1200884);
					if (!*(_DWORD*)getMemAt(0x5D4594, 1200884)) {
						v257 = sub_44CFC0((CHAR*)getMemAt(0x587000, 160200));
						*(_DWORD*)getMemAt(0x5D4594, 1200884) = v257;
					}
					v258 = *(__int16*)(v3 + 3);
					goto LABEL_858;
				case 137:
					v257 = *(_DWORD*)getMemAt(0x5D4594, 1200888);
					if (!*(_DWORD*)getMemAt(0x5D4594, 1200888)) {
						v257 = sub_44CFC0((CHAR*)getMemAt(0x587000, 160216));
						*(_DWORD*)getMemAt(0x5D4594, 1200888) = v257;
					}
					goto LABEL_857;
				case 138:
					if (!*(_DWORD*)getMemAt(0x5D4594, 1200900)) {
						*(_DWORD*)getMemAt(0x5D4594, 1200900) = sub_44CFC0((CHAR*)getMemAt(0x587000, 160244));
						*(_DWORD*)getMemAt(0x5D4594, 1200896) = sub_44CFC0((CHAR*)getMemAt(0x587000, 160252));
					}
					v259 = sub_45A360_drawable(*(int*)getMemAt(0x5D4594, 1200900), *(__int16*)(v3 + 1), *(__int16*)(v3 + 3));
					if (v259) {
						*(_WORD*)(v259 + 104) = 20;
					...
					do {
						v341 = *(__int16*)(v3 + 3) +
							   sub_415FF0(-15, 15, "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 5711);
						v261 = sub_415FF0(-15, 15, "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 5710);
						v262 = sub_45A360_drawable(*(int*)getMemAt(0x5D4594, 1200896), *(__int16*)(v3 + 1) + v261, v341);
						if (v262) {
							*(_WORD*)(v262 + 104) =
								sub_415FF0(5, 25, "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 5712);
					...
					goto LABEL_868;
				case 139:
					v257 = *(_DWORD*)getMemAt(0x5D4594, 1200892);
					if (!*(_DWORD*)getMemAt(0x5D4594, 1200892)) {
						v257 = sub_44CFC0((CHAR*)getMemAt(0x587000, 160232));
						*(_DWORD*)getMemAt(0x5D4594, 1200892) = v257;
					}
				LABEL_857:
					v258 = *(__int16*)(v3 + 3) + 2;
				LABEL_858:
					...
					break;
				case 163:
					v340 = sub_419D40(getMemAt(0x587000, 159972));
					...
					for (i = v252 >> 2;; v253 = i) {
						...
						LODWORD(v5) = sub_45A360_drawable(
							*(int*)getMemAt(0x5D4594, 1200784),
							*(__int16*)(v3 + 1) + v254 * *(int*)getMemAt(0x587000, 8 * v255 + 192088) / 16,
							*(__int16*)(v3 + 3) + v254 * *(int*)getMemAt(0x587000, 8 * v255 + 192092) / 16);
						v256 = v5;
						if ((_DWORD)v5) {
							...
							*(_DWORD*)(v256 + 444) = *(_DWORD*)getMemAt(0x5D4594, 2598000);
							*(_WORD*)(v256 + 104) = 0;
							*(_BYTE*)(v256 + 296) =
								sub_415FF0(4, 10, "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 5568);
		...
		LABEL_735:
			...
			break;
		case 0x93u:
			if (!*(_DWORD*)getMemAt(0x5D4594, 1200852)) {
				*(_DWORD*)getMemAt(0x5D4594, 1200852) = sub_44CFC0((CHAR*)getMemAt(0x587000, 159532));
				*(_DWORD*)getMemAt(0x5D4594, 1200856) = sub_44CFC0((CHAR*)getMemAt(0x587000, 159540));
				*(_DWORD*)getMemAt(0x5D4594, 1197380) = sub_44CFC0((CHAR*)getMemAt(0x587000, 159556));
			}
			if (!nox_client_isConnected_43C700())
				goto LABEL_916;
			v378.field_0 = *(__int16*)(v3 + 1);
			v378.field_4 = *(__int16*)(v3 + 3);
			sub_49A150(&v378, *(int*)getMemAt(0x5D4594, 1200852), *(_BYTE*)(v3 + 5));
			v235 = *(_DWORD*)getMemAt(0x5D4594, 1197380);
			if (*(_BYTE*)(v3 + 5) <= 0xAAu)
				v235 = *(_DWORD*)getMemAt(0x5D4594, 1200856);
						...
						if (v245) {
							...
							if (v245 != -432) {
								...
								*(_BYTE*)(v362 + 299) = v247;
								...
								v246[4] = *(_DWORD*)getMemAt(0x5D4594, 2598000) +
										  sub_415FF0(20, 40, "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 5399);
								v246[3] = *(_DWORD*)getMemAt(0x5D4594, 2598000);
							}
							v248 = sub_415FF0(15, 30, "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 5405);
							v249 = v362;
							*(_WORD*)(v362 + 104) = v248;
							*(_BYTE*)(v249 + 296) =
								sub_415FF0(-4, 4, "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 5406);
			...
			if (nox_client_isConnected_43C700()) {
				...
				if (sub_415FF0(0, 100, "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 4987) < 25) {
					if (*(_DWORD*)getMemAt(0x5D4594, 2614252)) {
						v225 = *(unsigned __int16*)(v3 + 5) - *(_DWORD*)(*(_DWORD*)getMemAt(0x5D4594, 2614252) + 12);
						v226 = nox_double2int(
							sqrt((double)(v225 * v225 + (*(unsigned __int16*)(v3 + 7) -
														 *(_DWORD*)(*(_DWORD*)getMemAt(0x5D4594, 2614252) + 16)) *
					...
					if ((_DWORD)v5) {
						...
						if ((_DWORD)v5 != (_DWORD)-432) {
							...
							*(_BYTE*)(v362 + 299) = v233;
							...
							v232[4] = *(_DWORD*)getMemAt(0x5D4594, 2598000) +
									  sub_415FF0(5, 20, "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 5030);
							v232[3] = *(_DWORD*)getMemAt(0x5D4594, 2598000);
						}
						v234 = v362;
						*(_WORD*)(v362 + 104) = 22;
		...
		case 0x96u:
			if (nox_client_isConnected_43C700()) {
				if (!*(_DWORD*)getMemAt(0x5D4594, 1200860))
					*(_DWORD*)getMemAt(0x5D4594, 1200860) = sub_44CFC0((CHAR*)getMemAt(0x587000, 159568));
				v239 = 5;
				do {
					LODWORD(v5) =
						sub_45A360_drawable(*(int*)getMemAt(0x5D4594, 1200860), *(__int16*)(v3 + 1), *(__int16*)(v3 + 3));
					v240 = v5;
					if ((_DWORD)v5) {
						if ((_DWORD)v5 != (_DWORD)-432) {
							*(_DWORD*)(v5 + 432) = *(_DWORD*)(v5 + 12) << 12;
							*(_DWORD*)(v5 + 436) = *(_DWORD*)(v5 + 16) << 12;
							*(_BYTE*)(v5 + 299) =
								sub_415FF0(0, 255, "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 5338);
							*(_DWORD*)(v240 + 440) =
								sub_415FF0(1333, 4000, "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 5341);
							*(_DWORD*)(v240 + 448) =
								*(_DWORD*)getMemAt(0x5D4594, 2598000) +
								sub_415FF0(5, 20, "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 5344);
							*(_DWORD*)(v240 + 444) = *(_DWORD*)getMemAt(0x5D4594, 2598000);
						}
						*(_WORD*)(v240 + 104) = 20;
		...
		case 0x97u:
			...
			break;
		case 0x98u:
			if (!*(_DWORD*)getMemAt(0x5D4594, 1200844))
				*(_DWORD*)getMemAt(0x5D4594, 1200844) = sub_44CFC0((CHAR*)getMemAt(0x587000, 159192));
			if (nox_client_isConnected_43C700()) {
				LODWORD(v5) =
					sub_45A360_drawable(*(int*)getMemAt(0x5D4594, 1200844),
		...
		case 0x9Fu:
			...
			if (nox_client_isConnected_43C700()) {
				...
				if ((_DWORD)v5) {
					LODWORD(v5) = v5 + 432;
					*(_DWORD*)v5 = *(_DWORD*)getMemAt(0x5D4594, 2598000);
					i = *(char*)(v3 + 4);
					*(float*)(v5 + 8) = (double)i;
		...
		case 0xA1u:
			if (!nox_client_isConnected_43C700())
				goto LABEL_916;
			if (!*(_DWORD*)getMemAt(0x5D4594, 1200864)) {
				*(_DWORD*)getMemAt(0x5D4594, 1200864) = sub_44CFC0((CHAR*)getMemAt(0x587000, 159940));
				*(_DWORD*)getMemAt(0x5D4594, 1200868) = sub_44CFC0((CHAR*)getMemAt(0x587000, 159956));
			}
			v251 = *(__int16*)(v3 + 1);
			v339 = *(__int16*)(v3 + 3);
			if (*(_BYTE*)(v3 + 5) == 1) {
				LODWORD(v5) = sub_45A360_drawable(*(int*)getMemAt(0x5D4594, 1200864), v251 + 15, v339);
				if ((_DWORD)v5) {
					sub_45A110_drawable((_DWORD*)v5);
					v3 += 6;
					break;
				...
				LODWORD(v5) = sub_45A360_drawable(*(int*)getMemAt(0x5D4594, 1200868), v251 - 3, v339);
			LABEL_829:
				if ((_DWORD)v5) {
					sub_45A110_drawable((_DWORD*)v5);
					v3 += 6;
		...
		case 0xA2u:
			if (nox_client_isConnected_43C700()) {
				if (!*(_DWORD*)getMemAt(0x5D4594, 1200848))
					*(_DWORD*)getMemAt(0x5D4594, 1200848) = sub_44CFC0((CHAR*)getMemAt(0x587000, 159204));
				...
				if (v222 + 1 > 0) {
					do {
						...
						sub_499490(*(int*)getMemAt(0x5D4594, 1200848), (_WORD*)(v3 + 1), v224, v318, v323, 0);
						--v223;
					} while (v223);
				}
			}
		...
		case 0xA8u:
			...
			if (v200 & 8) {
				...
				if (v200 & 1) {
					v203 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 158812), 0,
				...
				if (v200 & 1) {
					v204 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 158892), 0,
			...
			if (*(_BYTE*)(v3 + 3) & 0x10) {
				if (sub_4356B0() == 3) {
					...
					v205 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 158964), 0,
												 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 4536);
					sub_449A10(0, (int)v205, (int)getMemAt(0x5D4594, 1200068), 33, 0, 0);
				...
				if (sub_4356B0() == 3) {
					...
					if (v206) {
						if (!sub_57A160((int)v206)) {
							sub_450C00(0xFu, (wchar_t*)getMemAt(0x587000, 158984), v207 + 4704, getMemAt(0x5D4594, 1197384));
							sub_48D880(v3, (wchar_t*)getMemAt(0x5D4594, 1197384));
							k = v202 * *(unsigned __int8*)(v3 + 8);
							v3 += k + 11;
							break;
						}
						...
						if ((_DWORD)v5) {
							...
							sub_450C00(6u, (wchar_t*)getMemAt(0x587000, 159000), v208, v322, getMemAt(0x5D4594, 1197384));
						}
					}
				}
			} else if (sub_4356B0() == 3) {
				sub_445490((wchar_t*)getMemAt(0x5D4594, 1197384));
				k = v202 * *(unsigned __int8*)(v3 + 8);
				v3 += k + 11;
				break;
			}
		...
		case 0xB0u:
			if (!nox_common_gameFlags_check_40A5C0(1)) {
				...
				if (memcmp(getMemAt(0x5D4594, 1200732), (const void*)(v3 + 17), 0x14u))
					dword_5d4594_1200768 = 1;
				if (*(_DWORD*)getMemAt(0x5D4594, 1200752) != *(_DWORD*)(v3 + 37) ||
				...
				if (!sub_459DA0()) {
					...
					if (nox_common_gameFlags_check_40A5C0(128)) {
						if (dword_5d4594_1200832) {
							v330 = *(_DWORD*)getMemAt(0x5D4594, 2618908) + 4704;
							v41 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 157212), 0,
		...
		case 0xB4u:
			...
			if (nox_client_isConnected_43C700()) {
				...
				if ((_DWORD)v5) {
					...
					*(_DWORD*)(v26 + 288) = *(_DWORD*)getMemAt(0x5D4594, 2598000);
				}
			}
			v3 += 4;
			break;
		case 0xB5u:
			if (nox_client_isConnected_43C700() &&
				...
				*(_DWORD*)(v5 + 316) = *(_DWORD*)getMemAt(0x5D4594, 2598000);
		...
		case 0xBDu:
			if (nox_client_isConnected_43C700()) {
				if (*(_BYTE*)(v3 + 1) == 1)
					v290 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 160420), 0,
												 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 6351);
				else
					v290 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 160472), 0,
		...
		case 0xC3u:
			...
			if (*(_WORD*)(v3 + 3) || *(_WORD*)(v3 + 1)) {
				v27 = sub_48E970(*(unsigned __int16*)(v3 + 3), *(unsigned __int16*)(v3 + 1),
								 *(unsigned __int16*)(v3 + 5), *(unsigned __int16*)(v3 + 7));
				if (v27) {
					v27[72] = *(_DWORD*)getMemAt(0x5D4594, 2598000);
					...
					*((_BYTE*)v27 + 297) = v28;
					...
					if (v27[69] != *(unsigned __int8*)(v3 + 11)) {
						v27[79] = *(_DWORD*)getMemAt(0x5D4594, 2598000);
						k = *(unsigned __int8*)(v3 + 11);
						v27[69] = k;
					}
				}
				HIDWORD(v5) = *(unsigned __int16*)(v3 + 1);
				if (WORD2(v5) == *(_DWORD*)getMemAt(0x5D4594, 2616328) && sub_416120(8u))
					sub_435600(*(unsigned __int16*)(v3 + 5), *(unsigned __int16*)(v3 + 7));
				v3 += 12;
			} else {
				sub_435600(*(unsigned __int16*)(v3 + 5), *(unsigned __int16*)(v3 + 7));
		...
		case 0xC4u:
			...
			case 0u:
				...
				if (!(*(_BYTE*)(v3 + 14) & 1))
					goto LABEL_888;
				v273 = sub_418C80(*(int*)getMemAt(0x5D4594, 2616328));
				if (!v273)
					goto LABEL_888;
				if (nox_common_gameFlags_check_40A5C0(1)) {
					sub_4191D0(v272[57], (int)v273, 1, *(int*)getMemAt(0x5D4594, 2616328), 1);
			...
			if (*(_BYTE*)(v3 + 1) == 3) {
				if (nox_client_isConnected_43C700()) {
					sub_479D30((wchar_t*)(v3 + 34), *(_DWORD*)(v3 + 98), (char*)(v3 + 2), (const char*)(v3 + 102),
							   *(_BYTE*)(v3 + 134));
					if (*(_DWORD*)getMemAt(0x5D4594, 2618908))
						sub_4174F0(*(int*)getMemAt(0x5D4594, 2618908), 512);
				}
				v3 += 135;
				...
				if (nox_client_isConnected_43C700()) {
					sub_47A1F0();
					if (*(_DWORD*)getMemAt(0x5D4594, 2618908))
						sub_417530(*(int*)getMemAt(0x5D4594, 2618908), 512);
				}
			LABEL_966:
				v3 += 2;
			}
		...
		case 0xD3u:
			if (!nox_client_isConnected_43C700())
				goto LABEL_112;
			if ((unsigned int)(*(_DWORD*)getMemAt(0x5D4594, 2598000) - *(_DWORD*)(v3 + 9)) >= 0x1E) {
				v359 = -44;
			...
			break;
		case 0xD5u:
			v296 = *(_DWORD*)getMemAt(0x5D4594, 2618908);
			switch (*(_BYTE*)(v3 + 1)) {
			case 1:
				if (nox_client_isConnected_43C700()) {
					if (v296)
		...
		case 0xDDu:
			...
			if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_NET_DEBUG))
				sub_578B70(*(unsigned __int16*)(v3 + 1));
			if (v91 == *(_DWORD*)getMemAt(0x5D4594, 2616328)) {
		...
		case 0xDEu:
			...
			if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_NET_DEBUG))
				sub_578B70(*(unsigned __int16*)(v3 + 1));
			if (v95 != *(_DWORD*)getMemAt(0x5D4594, 2616328))
				goto LABEL_948;
		...
		case 0xE8u:
			if (nox_client_isConnected_43C700()) {
				...
				v111 = (_DWORD*)v5;
				if ((_DWORD)v5) {
					if ((_DWORD)v5 == *(_DWORD*)getMemAt(0x5D4594, 2618908)) {
						sub_4BFE40();
						sub_478000();
					}
		...
		case 0xE9u:
			if (nox_client_isConnected_43C700()) {
				if (nox_common_gameFlags_check_40A5C0(0x2000)) {
					...
					if ((unsigned __int16)k == *(_DWORD*)getMemAt(0x5D4594, 2616328))
		...
		case 0xF0u:
			...
			case 4u:
				if (nox_client_isConnected_43C700()) {
					...
					if (WORD2(v5) == *(_DWORD*)getMemAt(0x5D4594, 2616328))
			...
			case 0xFu:
				...
				break;
			case 0x10u:
				if (!*(_DWORD*)getMemAt(0x5D4594, 1200904))
					*(_DWORD*)getMemAt(0x5D4594, 1200904) = sub_44CFC0((CHAR*)getMemAt(0x587000, 160484));
				if (nox_client_isConnected_43C700()) {
					v301 = sub_45A360_drawable(*(int*)getMemAt(0x5D4594, 1200904), *(unsigned __int16*)(v3 + 6),
			...
			case 0x18u:
				...
				break;
			case 0x19u:
				if (!*(_DWORD*)getMemAt(0x5D4594, 1200908)) {
					*(_DWORD*)getMemAt(0x5D4594, 1200908) = sub_44CFC0((CHAR*)getMemAt(0x587000, 160496));
					*(_DWORD*)getMemAt(0x5D4594, 1200912) = sub_44CFC0((CHAR*)getMemAt(0x587000, 160508));
				}
				v302 = (_DWORD*)sub_45A360_drawable(*(int*)getMemAt(0x5D4594, 1200912), *(__int16*)(v3 + 2),
													*(__int16*)(v3 + 4));
				if (v302)
				...
				if (nox_client_isConnected_43C700()) {
					...
					sub_49A150(&v380, *(int*)getMemAt(0x5D4594, 1200908), *(_BYTE*)(v3 + 6));
				}
				goto LABEL_1149;
			case 0x1Au:
				if (nox_client_isConnected_43C700())
					sub_499610(*(int*)getMemAt(0x5D4594, 1200788), 25, 500, 25, *(__int16*)(v3 + 2), *(__int16*)(v3 + 4));
				v3 += 6;
				break;
			case 0x1Cu:
				if (nox_client_isConnected_43C700())
			...
			case 0x1Eu:
				...
				if (nox_client_isConnected_43C700() && v303) {
					if (v303 == *(char**)getMemAt(0x5D4594, 2618908)) {
						...
						v304 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 160560), 0,
													 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 8112);
						nox_swprintf(v405, v304, v348);
					} else {
						v349 = sub_424930(*(unsigned __int8*)(v3 + 2));
						v305 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 160624), 0,
			...
			case 0x1Fu:
				...
				if (v306 == *(char**)getMemAt(0x5D4594, 2618908)) {
					...
					v307 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 160696), 0,
												 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 8145);
					nox_swprintf(v403, v307, v350);
				} else {
					v351 = sub_427240(*(unsigned __int8*)(v3 + 2));
					v308 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 160760), 0,
			...
			case 0x20u:
				...
				if (v309 == *(char**)getMemAt(0x5D4594, 2618908)) {
					...
					v310 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 160832), 0,
												 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 8178);
					nox_swprintf(v404, v310, v352);
				} else {
					v353 = sub_425260(*(unsigned __int8*)(v3 + 2));
					v311 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 160896), 0,
			...
			case 0x21u:
				if (nox_client_isConnected_43C700()) {
					...
					v354 = loadString_sub_40F1D0((char*)v383[*(unsigned __int8*)(v3 + 51)], 0,
												 "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 8217);
					v312 =
						loadString_sub_40F1D0((char*)(v3 + 2), 0, "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 8216);
