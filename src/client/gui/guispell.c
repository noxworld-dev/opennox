...
int __cdecl nox_xxx_spellPutInBox_45DEB0(int* a1, int a2, int a3, int a4) {
	...
	if (v4 >= 0) {
		...
		if (nox_xxx_spellMayTrap_424BF0(a2)) {
			...
			v5 =
				nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 133772), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c", 504);
		} else {
			v5 =
				nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 133712), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c", 496);
		}
...
void nox_xxx_clientUseTrap_45E040() {
	...
	v0 = *(_DWORD***)getMemAt(0x5D4594, 1048144);
	v1 = *(_DWORD**)getMemAt(0x5D4594, 1048144);
	v2 = 0;
	for (i = 0; i < 3; ++i) {
		if (*v1)
			break;
...
int nox_xxx_quickBarCreate_45E190() {
	...
	*getMemU32Ptr(0x587000, 133668) = nox_win_height;
	...
	do {
		v2 -= 60;
		nox_xxx_quickBarInitWindow_4601F0((int)v4, v1, v2, 5, 0, nox_xxx_quickBarWnd_45EF50, nox_xxx_quickBarWarriorDraw_45FDE0);
	...
	if (*(_BYTE*)(*getMemU32Ptr(0x5D4594, 2618908) + 2251)) {
		...
		nox_window_set_all_funcs(*(_DWORD**)&dword_5d4594_1049520, nox_xxx_quickbarTrapButtonProc_45F7A0, nox_xxx_quickbarDrawFn_460000, 0);
	...
	if (*(_BYTE*)(*getMemU32Ptr(0x5D4594, 2618908) + 2251)) {
		if (*(_BYTE*)(*getMemU32Ptr(0x5D4594, 2618908) + 2251) == 1) {
			if ((!*getMemU32Ptr(0x5D4594, 2618908) || !*(_DWORD*)(*getMemU32Ptr(0x5D4594, 2618908) + 3832)) &&
				...
				v15 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 134012), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c",
											1805);
				nox_xxx_wndWddSetTooltip_46B000((wchar_t*)(dword_5d4594_1049520 + 36), v15);
				nox_xxx_wnd_46AD60(*(int*)&dword_5d4594_1049520, 8);
				v16 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 134068), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c",
											1808);
				nox_xxx_wndWddSetTooltip_46B000((wchar_t*)(dword_5d4594_1049500 + 36), v16);
				nox_xxx_wnd_46AD60(*(int*)&dword_5d4594_1049500, 8);
			}
		} else if (*(_BYTE*)(*getMemU32Ptr(0x5D4594, 2618908) + 2251) == 2) {
			if ((!*getMemU32Ptr(0x5D4594, 2618908) || !*(_DWORD*)(*getMemU32Ptr(0x5D4594, 2618908) + 3832)) &&
				(!nox_common_gameFlags_check_40A5C0(0x2000) || nox_common_gameFlags_check_40A5C0(4096) ||
				 sub_4D6F50() || sub_4D6F70())) {
				...
				v9 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 134216), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c",
										   1838);
				nox_xxx_wndWddSetTooltip_46B000((wchar_t*)(dword_5d4594_1049520 + 36), v9);
				nox_xxx_wnd_46AD60(*(int*)&dword_5d4594_1049520, 8);
				v10 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 134276), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c",
											1841);
	...
	if (*(_BYTE*)(*getMemU32Ptr(0x5D4594, 2618908) + 2251)) {
		nox_xxx_quickBarInitWindow_4601F0((int)getMemAt(0x5D4594, 1047940), dword_5d4594_1047548 + 122, dword_5d4594_1047552 - 17, 3, 21, nox_xxx_quickBarWnd_45EF50,
				   nox_xxx_quickBarWarriorDraw_45FDE0);
		...
		*getMemU32Ptr(0x5D4594, 1048192) = v22;
		...
		v26 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 134432), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c", 1883);
		...
		*((_DWORD*)v24 + 92) = 3;
		...
		v29 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 134512), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c", 1892);
		...
		*(_DWORD*)(dword_5d4594_1049508 + 368) = 5;
		nox_window_set_all_funcs(*(_DWORD**)&dword_5d4594_1049508, nox_xxx_quickbar_45F8D0, nox_xxx_quickbarTrapUpDownDraw_45F6F0, 0);
	} else {
		dword_5d4594_1049508 = nox_window_new(0, 1032, dword_5d4594_1047548 - 1, dword_5d4594_1047552 + 26, 61, 48, 0);
		nox_xxx_wndSetOffsetMB_46AE40(*(int*)&dword_5d4594_1049508, 1, -26);
	...
	*getMemU32Ptr(0x5D4594, 1049528) = nox_window_new(*(int*)&dword_5d4594_1049524, 1064, 1, 2, 28, 28, 0);
	...
	v36 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 134692), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c", 1931);
	...
	if (*(_BYTE*)(*getMemU32Ptr(0x5D4594, 2618908) + 2251)) {
		...
		*((_DWORD*)v37 + 92) = 0;
		v39 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 134772), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c", 1943);
		...
		*((_DWORD*)v40 + 92) = 1;
		v42 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 134856), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c", 1953);
		...
		*((_DWORD*)v43 + 92) = 2;
		v45 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 134940), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c", 1963);
	...
	while (1) {
		...
		for (i = v52;; v52 = i) {
			...
			if (*(_BYTE*)(*getMemU32Ptr(0x5D4594, 2618908) + 2251)) {
				...
				*(_DWORD*)&v72[strlen(v72)] = *getMemU32Ptr(0x587000, 134996);
...
int nox_xxx_quickbarButtonBook_45F3F0() {
	...
	if (sub_45CFC0())
		v0 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 135064), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c", 901);
	else
		v0 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 135124), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c", 905);
...
int __cdecl sub_45F480(int a1) {
	...
	if (sub_45F500(*(unsigned __int16*)(a1 + 368),
		...
		v1 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 135180), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c", 941);
	} else {
		v1 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 135236), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c", 945);
	}
...
int __cdecl nox_xxx_quickbarDraw_45FAC0(_DWORD* a1) {
	...
	v2 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 135348), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c", 1299);
...
int __cdecl nox_xxx_quickBarDrawFn_45FBD0(int yTop) {
	...
	v8 = *(_DWORD*)(v6 + 8 * v2);
	if (v8) {
		if (*getMemU32Ptr(0x5D4594, 2598000) <= 0xAu || v2 != *getMemU32Ptr(0x587000, 133484) ||
			(unsigned int)(*getMemU32Ptr(0x5D4594, 2598000) - *getMemU32Ptr(0x5D4594, 1049540)) >= 0xA) {
		...
		if (*getMemU32Ptr(0x5D4594, 24 * *v7 + 1047776)) {
			...
			v17 = yTop + v5 + 2;
			v15 = xLeft + 6;
			v11 = (__int16*)nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 135396), 0,
			...
			v17 = yTop + v5 + 2;
			v15 = xLeft + 6;
			v11 = (__int16*)nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 135444), 0,
...
int __cdecl nox_xxx_quickBarWarriorDraw_45FDE0(int yTop) {
	...
	if (v4[2 * v2]) {
		...
		if (v9) {
			...
			v16 = xLeft + 6;
			v12 = (__int16*)nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 135492), 0,
...
int sub_460070() {
	...
	if (*getMemU32Ptr(0x5D4594, 2618908)) {
		if (*(_BYTE*)(*getMemU32Ptr(0x5D4594, 2618908) + 2251) == 1) {
			...
			v7 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 135572), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c",
									   1544);
			nox_xxx_wndWddSetTooltip_46B000((wchar_t*)(dword_5d4594_1049520 + 36), v7);
			nox_xxx_wnd_46AD60(*(int*)&dword_5d4594_1049520, 8);
			v8 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 135628), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c",
									   1547);
			...
			result = *(unsigned __int8*)(*getMemU32Ptr(0x5D4594, 2618908) + 2251) - 2;
			if (*(_BYTE*)(*getMemU32Ptr(0x5D4594, 2618908) + 2251) == 2) {
				...
				v3 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 135728), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c",
										   1559);
				nox_xxx_wndWddSetTooltip_46B000((wchar_t*)(dword_5d4594_1049520 + 36), v3);
				nox_xxx_wnd_46AD60(*(int*)&dword_5d4594_1049520, 8);
				v4 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 135788), 0, "C:\\NoxPost\\src\\Client\\Gui\\guispell.c",
										   1562);
