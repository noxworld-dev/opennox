...
int sub_45E190() {
	...
	*getMemU32Ptr(0x5D4594, 1049684) = sub_43F360((char*)getMemAt(0x587000, 133840));
	...
	*getMemU32Ptr(0x587000, 133668) = nox_win_height;
	...
	if (*(_BYTE*)(*getMemU32Ptr(0x5D4594, 2618908) + 2251)) {
		...
		sub_46AE60(*getMemIntPtr(0x5D4594, 1048148), (int)v21);
		sub_46AE40(*getMemIntPtr(0x5D4594, 1048148), -40, -20);
	...
	*getMemU32Ptr(0x5D4594, 1049528) = nox_window_new(*(int*)&dword_5d4594_1049524, 1064, 1, 2, 28, 28, 0);
	...
	sub_46B000((wchar_t*)(*getMemU32Ptr(0x5D4594, 1049528) + 36), v36);
	if (*(_BYTE*)(*getMemU32Ptr(0x5D4594, 2618908) + 2251)) {
...
int __cdecl sub_45F9B0(_DWORD* a1) {
	...
	if (!*getMemU32Ptr(0x5D4594, 1049476)) {
		...
		a1 = &v3[sub_43F320(*getMemIntPtr(0x5D4594, 1049684)) + 1];
		v6 += (v7 - v8) / 2;
...
int __cdecl sub_45FBD0(int yTop) {
	...
	if (v8) {
		...
		if (*getMemU32Ptr(0x5D4594, 24 * *v7 + 1047776)) {
			...
			LABEL_19:
				v13 = 24 * *v7;
				if (*getMemU32Ptr(0x5D4594, v13 + 1047776) || !*getMemU32Ptr(0x5D4594, v13 + 1047772) || sub_4372B0()) {
					v14 = sub_4252D0(*v7);
...
int __cdecl sub_45FDE0(int yTop) {
	...
	if (v4[2 * v2]) {
		...
		if (!sub_424B70(v4[2 * v2]) || sub_4372B0() || sub_4356C0(*getMemIntPtr(0x5D4594, 2614252), 29)) {
