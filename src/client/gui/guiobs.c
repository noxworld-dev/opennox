...
int __cdecl sub_48C9F0(int* a1) {
	...
	if (*(_DWORD*)getMemAt(0x5D4594, 2618908)) {
		v2 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 156384), 0, "C:\\NoxPost\\src\\client\\Gui\\guiobs.c", 41);
...
//----- (0048C980) --------------------------------------------------------
int sub_48C980() {
	*(_DWORD*)getMemAt(0x5D4594, 1193716) = sub_42F970("ObserverIcon");
	dword_5d4594_1193712 = nox_window_new(0, 136, nox_win_width - 50, nox_win_height / 2 - 100, 50, 50, 0);
	sub_46AE60(*(int*)&dword_5d4594_1193712, *(int*)getMemAt(0x5D4594, 1193716));
