...
__int16 __cdecl nox_xxx_mapGenClientText_4A9D00(unsigned __int8* a1) {
	...
	*getMemU32Ptr(0x5D4594, 1309668) = *(unsigned __int16*)(a1 + 1);
	...
	switch (*v1) {
	case 0x9Bu:
		v5 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 172368), 0, "C:\\NoxPost\\src\\client\\Gui\\guigen.c", 89);
		goto LABEL_8;
	case 0x9Cu:
		v5 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 172416), 0, "C:\\NoxPost\\src\\client\\Gui\\guigen.c", 92);
		goto LABEL_8;
	case 0x9Du:
		v5 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 172464), 0, "C:\\NoxPost\\src\\client\\Gui\\guigen.c", 95);
	LABEL_8:
