...
int __cdecl sub_479D30(wchar_t* a1, int a2, char* a3, const char* a4, char a5) {
	...
	v5 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1123524, 3901);
	v6 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1123524, 3910);
	sub_445C20();
	...
	v7 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1123524, 3905);
	nox_xxx_wndSetIcon_46AE60((int)v7, (int)v17);
	nox_window_call_field_94((int)v6, 16385, (int)getMemAt(0x5D4594, 1107056), 0);
	v8 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1123524, 3908);
	if (a5 & 1) {
		nox_xxx_wnd_46ABB0((int)v8, 1);
		nox_window_set_hidden((int)v8, 0);
		v8[5] = 5;
		v9 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1123524, 3909);
		...
		v12 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1123524, 3909);
	...
	v10[5] = 95;
	v13 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1123524, 3907);
...
wchar_t* __cdecl sub_47A020(char* a1) {
	...
	*(_DWORD*)v13 = *getMemU32Ptr(0x587000, 153644);
	...
	v1 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1123524, 3901);
	v2 = (int)v1;
	v3 = 0;
	v12 = (__int16*)v1[8];
	v11 = 0;
	...
	if (result) {
		while (1) {
			if (!v3)
				v3 = result;
			v6 = nox_wcslen(v3);
			nox_xxx_drawGetStringSize_43F840(*(_DWORD*)(v2 + 236), v3, (int*)&a1, 0, 0);
			v7 = v6;
			if ((int)a1 > v9) {
				while (1) {
					v6 = v7;
