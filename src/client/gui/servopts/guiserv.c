		...
		if (*(_DWORD*)&byte_587000[129664]) {
			...
			do {
				*((_DWORD*)v1 + 1) = loadString_sub_40F1D0(
				    result, 0, "C:\\NoxPost\\src\\client\\Gui\\ServOpts\\guiserv.c", 212);
...
int sub_457500() {
	...
	if (!sub_446360()) {
		...
		dword_5d4594_1046492 =
		    nox_new_window_from_file(*(const char**)&byte_587000[4 * v1 + 129760], sub_4585D0);
		sub_43FE20(100);
		sub_46A9B0(*(_DWORD**)&dword_5d4594_1046492,
...
int __cdecl sub_457AA0(int a1, _BYTE* a2) {
	...
	if (*a2 & 4)
		v2 = loadString_sub_40F1D0((char*)&byte_587000[130372], 0,
					   "C:\\NoxPost\\src\\client\\Gui\\ServOpts\\guiserv.c", 446);
	else
		v2 = loadString_sub_40F1D0((char*)&byte_587000[130436], 0,
					   "C:\\NoxPost\\src\\client\\Gui\\ServOpts\\guiserv.c", 450);
	sub_4776B0(v2);
	return 1;
}
...
int __cdecl sub_457B00(int a1, _BYTE* a2) {
	...
	if (*a2 & 4)
		v2 = loadString_sub_40F1D0((char*)&byte_587000[130500], 0,
					   "C:\\NoxPost\\src\\client\\Gui\\ServOpts\\guiserv.c", 465);
	else
		v2 = loadString_sub_40F1D0((char*)&byte_587000[130564], 0,
					   "C:\\NoxPost\\src\\client\\Gui\\ServOpts\\guiserv.c", 469);
	sub_4776B0(v2);
	return 1;
}
...
int sub_457FE0() {
	...
	if (nox_common_gameFlags_check_40A5C0(0x4000)) {
		v5 = loadString_sub_40F1D0((char*)&byte_587000[130636], 0,
					   "C:\\NoxPost\\src\\client\\Gui\\ServOpts\\guiserv.c", 380);
		v1 = loadString_sub_40F1D0((char*)&byte_587000[130708], 0,
		...
		v6 = loadString_sub_40F1D0((char*)&byte_587000[130788], 0,
					   "C:\\NoxPost\\src\\client\\Gui\\ServOpts\\guiserv.c", 385);
		v2 = loadString_sub_40F1D0((char*)&byte_587000[130856], 0,
					   "C:\\NoxPost\\src\\client\\Gui\\ServOpts\\guiserv.c", 384);
		nox_swprintf((wchar_t*)&byte_5D4594[1045700], L"%s %s", v2, v6);
	} else {
		v3 = loadString_sub_40F1D0((char*)&byte_587000[130936], 0,
					   "C:\\NoxPost\\src\\client\\Gui\\ServOpts\\guiserv.c", 389);
...
int __cdecl sub_4580E0(int a1) {
	...
	if (nox_common_gameFlags_check_40A5C0(128)) {
		v2 = loadString_sub_40F1D0((char*)&byte_587000[131060], 0,
					   "C:\\NoxPost\\src\\client\\Gui\\ServOpts\\guiserv.c", 739);
	...
	if (nox_common_gameFlags_check_40A5C0(1))
		v5 = loadString_sub_40F1D0((char*)&byte_587000[131180], 0,
					   "C:\\NoxPost\\src\\client\\Gui\\ServOpts\\guiserv.c", 748);
	else
		v5 = loadString_sub_40F1D0((char*)&byte_587000[131240], 0,
					   "C:\\NoxPost\\src\\client\\Gui\\ServOpts\\guiserv.c", 752);
					...
					if (v31 >= 0 && v31 < *(__int16*)(*(_DWORD*)(a3 + 32) + 44)) {
						...
						*((_WORD*)v29 + 26) |= sub_459650(v32);
						if (v33 != (*((_WORD*)v29 + 26) & 0x17F0))
							sub_458230(*((unsigned __int16*)v29 + 26),
								   (char*)&byte_5D4594[1046556], 1);
	...
	if (a2 == 16391) {
		...
		case 10145:
			...
			if (nox_common_gameFlags_check_40A5C0(128) && (v20 = *((_WORD*)v18 + 26), v20 & 0x60)) {
				...
				if (!v21) {
					v38 = loadString_sub_40F1D0(
					    (char*)&byte_587000[131472], 0,
					    "C:\\NoxPost\\src\\client\\Gui\\ServOpts\\guiserv.c", 1371);
					v23 = loadString_sub_40F1D0(
					    (char*)&byte_587000[131536], 0,
...
int sub_459CD0() {
	...
	if (dword_5d4594_1046492) {
		if (sub_40A740() || nox_common_gameFlags_check_40A5C0(0x8000))
			...
			v1 = sub_417DD0();
		v4 = v1;
		v2 = loadString_sub_40F1D0((char*)&byte_587000[132012], 0,
					   "C:\\NoxPost\\src\\client\\Gui\\ServOpts\\guiserv.c", 2071);
