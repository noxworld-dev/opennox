	...
	if (!result) {
		if (!sub_4372B0() || (result = nox_common_gameFlags_check_40A5C0(2048)) == 0) {
			if (!*(_DWORD*)&byte_5D4594[2618908] ||
				...
				v2 = loadString_sub_40F1D0((char*)&byte_587000[132176], 0,
							   "C:\\NoxPost\\src\\Client\\Gui\\guibook.c", 377);
				sub_445490(v2);
	...
	if (dword_5d4594_1046868 == 1) {
		...
		if (v16) {
			...
			if (v17) {
				...
				v18 = 38;
				v21 = loadString_sub_40F1D0((char*)&byte_587000[132476], 0,
							    "C:\\NoxPost\\src\\Client\\Gui\\guibook.c", 989);
				nox_wcscat(v71, v21);
				v20 = 0;
			}
		} else {
			v18 = 38;
			v22 = loadString_sub_40F1D0((char*)&byte_587000[132432], 0,
						    "C:\\NoxPost\\src\\Client\\Gui\\guibook.c", 983);
			nox_wcscat(v71, v22);
			v20 = 19;
		}
		...
		v23 = v14 + v3 + 2;
		v24 = (unsigned __int16*)sub_427240(
		...
		if (!*(_BYTE*)(dword_5d4594_1047516 + 2251)) {
			...
			v36 = (unsigned __int16*)sub_4252F0(
			    *(_DWORD*)&byte_5D4594[4 * dword_5d4594_1046932 + 1046960]);
			v29 = v36;
			v30 = v67 + 52;
			if (!v36)
		...
		v39 = (unsigned __int16*)sub_424930(
		    *(_DWORD*)&byte_5D4594[4 * dword_5d4594_1046932 + 1046960]);
		...
		v45 = loadString_sub_40F1D0((char*)&byte_587000[132564], 0, "C:\\NoxPost\\src\\Client\\Gui\\guibook.c",
					    1115);
		nox_swprintf(v71, L"%s ", v45);
		if (v44) {
			_itow(v44, WideCharStr, 10);
			nox_wcscat(v71, WideCharStr);
		} else if (sub_424A50(*(_DWORD*)&byte_5D4594[4 * dword_5d4594_1046932 + 1046960],
				      0x800000)) {
			nox_wcscat(v71, L"0");
		} else {
			nox_wcscat(v71, L"*");
		...
		v47 = v46 + v3 + 2;
		if (v38 & 0x100) {
			v48 = loadString_sub_40F1D0((char*)&byte_587000[132628], 0,
						    "C:\\NoxPost\\src\\Client\\Gui\\guibook.c", 1173);
			sub_43F840(0, v48, &v65, 0, 0);
			sub_43FAF0(0, v48, (108 - v65) / 2 + v66 + 24, v47, 128, 0);
			v47 += v3;
		}
		if (v38 & 4) {
			v49 = loadString_sub_40F1D0((char*)&byte_587000[132680], 0,
						    "C:\\NoxPost\\src\\Client\\Gui\\guibook.c", 1181);
			sub_43F840(0, v49, &v65, 0, 0);
			sub_43FAF0(0, v49, (108 - v65) / 2 + v66 + 24, v47, 128, 0);
			v47 += v3;
		}
		if (v38 & 8) {
			v50 = loadString_sub_40F1D0((char*)&byte_587000[132732], 0,
						    "C:\\NoxPost\\src\\Client\\Gui\\guibook.c", 1189);
			sub_43F840(0, v50, &v65, 0, 0);
			sub_43FAF0(0, v50, (108 - v65) / 2 + v66 + 24, v47, 128, 0);
			v47 += v3;
		}
		if (v38 & 0x20) {
			v51 = loadString_sub_40F1D0((char*)&byte_587000[132784], 0,
						    "C:\\NoxPost\\src\\Client\\Gui\\guibook.c", 1197);
			sub_43F840(0, v51, &v65, 0, 0);
			sub_43FAF0(0, v51, (108 - v65) / 2 + v66 + 24, v47, 128, 0);
			v47 += v3;
		}
		v64 = *(_DWORD*)(dword_5d4594_1047516 +
				 4 * *(_DWORD*)&byte_5D4594[4 * dword_5d4594_1046932 + 1046960] + 3696);
		...
		v53 = (unsigned __int16*)sub_424A30(
		    *(_DWORD*)&byte_5D4594[4 * dword_5d4594_1046932 + 1046960]);
		v29 = v53;
		v30 = v67 + 52;
		if (v53) {
...
int __cdecl sub_45CF00(_DWORD* a1) {
	...
	if (*a1 == 1310) {
		...
		v4 = loadString_sub_40F1D0((char*)&byte_587000[133300], 0, "C:\\NoxPost\\src\\Client\\Gui\\guibook.c",
					   1644);
		sub_4776B0(v4);
	} else if (*a1 == 1320) {
		v1 = loadString_sub_40F1D0((char*)&byte_587000[133352], 0, "C:\\NoxPost\\src\\Client\\Gui\\guibook.c",
					   1649);
		sub_4776B0(v1);
		return 1;
	}
