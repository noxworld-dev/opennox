...
int sub_4C1D80() {
	...
	*getMemU32Ptr(0x5D4594, 1321028) = sub_42F970("CreatureCageEscortButton");
	...
	sub_46AE60(*(int*)&dword_5d4594_1321040, *(int*)getMemAt(0x5D4594, 1321028));
...
int __cdecl sub_4C27F0(_DWORD* a1) {
	...
	if (dword_5d4594_1321204 || (result = 1, a1[8] != 1)) {
		...
		if (dword_5d4594_1321204) {
			...
			v7 = a1[8];
			if (v7 != 4 && v7 != 5) {
				sub_4C2A00(v11 + v4, v10 + 3, *(int*)getMemAt(0x5D4594, 2650684), *(int*)getMemAt(0x5D4594, 2650656), (__int16*)v2);
				return 1;
			}
			v9 = (__int16*)v2;
			if (!sub_4C2E00()) {
