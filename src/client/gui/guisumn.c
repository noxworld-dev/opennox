...
int sub_4C1D80() {
	...
	*getMemU32Ptr(0x5D4594, 1321028) = sub_42F970("CreatureCageEscortButton");
	...
	sub_46AE60(*(int*)&dword_5d4594_1321040, *getMemIntPtr(0x5D4594, 1321028));
...
int __cdecl sub_4C27F0(_DWORD* a1) {
	...
	if (!dword_5d4594_1321208)
		dword_5d4594_1321208 = sub_4E3AA0((CHAR*)getMemAt(0x587000, 184840));
	if (dword_5d4594_1321204 || (result = 1, a1[8] != 1)) {
		v2 = loadString_sub_40F1D0(*(char**)getMemAt(0x587000, 4 * a1[8] + 184344), 0,
		...
		if (dword_5d4594_1321204) {
			if (sub_4C2DD0(*(int*)&dword_5d4594_1321204)) {
				sub_4C2A00(v11 + v4, v10 + 3, *getMemIntPtr(0x5D4594, 2523948), *getMemIntPtr(0x5D4594, 2650656), (__int16*)v2);
				return 1;
			}
			v5 = a1[8];
			if (v5 != 4 && v5 != 5) {
			...
			v7 = a1[8];
			if (v7 != 4 && v7 != 5) {
				sub_4C2A00(v11 + v4, v10 + 3, *getMemIntPtr(0x5D4594, 2650684), *getMemIntPtr(0x5D4594, 2650656), (__int16*)v2);
				return 1;
			}
			v9 = (__int16*)v2;
			if (!sub_4C2E00()) {
				sub_4C2A00(v11 + v4, v10 + 3, *getMemIntPtr(0x5D4594, 2650660), *getMemIntPtr(0x5D4594, 2650656), (__int16*)v2);
				return 1;
			}
...
int sub_4C2CE0() {
	...
	case 3:
		...
		break;
	case 4:
		v2 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 184932), 0, "C:\\NoxPost\\src\\Client\\Gui\\guisumn.c", 782);
		sub_4776B0(v2);
		return 1;
	case 5:
		v0 = loadString_sub_40F1D0((char*)getMemAt(0x587000, 185028), 0, "C:\\NoxPost\\src\\Client\\Gui\\guisumn.c", 788);
		sub_4776B0(v0);
		return 1;
	}
	return 1;
