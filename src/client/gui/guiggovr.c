...
int __cdecl sub_49B4B0(unsigned __int16* a1) {
	...
	v11 = a1[1];
	v1 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 163344), 0, "C:\\NoxPost\\src\\client\\Gui\\GUIGGOvr.c", 178);
	nox_swprintf((wchar_t*)getMemAt(0x5D4594, 1302172), v1, v11);
	v12 = a1[2];
	v2 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 163416), 0, "C:\\NoxPost\\src\\client\\Gui\\GUIGGOvr.c", 181);
	nox_swprintf((wchar_t*)getMemAt(0x5D4594, 1301916), v2, v12);
	v13 = a1[3];
	v3 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 163484), 0, "C:\\NoxPost\\src\\client\\Gui\\GUIGGOvr.c", 183);
	...
	if (dword_5d4594_1303452) {
		...
		if (!result) {
			...
			if (*getMemU32Ptr(0x5D4594, 2618908) && *(_BYTE*)(*getMemU32Ptr(0x5D4594, 2618908) + 2064) == 31) {
				...
				v2 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 163544), 0, "C:\\NoxPost\\src\\client\\Gui\\GUIGGOvr.c",
										   265);
