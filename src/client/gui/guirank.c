        ...
        if (byte_5D4594[1090117] && (v9 == 2 || v9 == 4 || v9 == 5))
        {
            ...
            if ((_BYTE)a2)
            {
                do
                {
                    ...
                    if (v32 == 16)
                        sub_46F8F0(1, v36);
                    if (nox_common_gameFlags_check_40A5C0(1024) && v34 > 0 && *(int*)& byte_5D4594[80 * v32 + 1084196] >= v34)
                        v15 = 1;
                    v17 = 80 * v32;
...
char sub_46FC50()
{
    ...
    if (sub_40A220() && (!nox_common_gameFlags_check_40A5C0(1) || sub_40A300() || (v0 = nox_common_gameFlags_getVal_40A5B0(), sub_40A180(v0))))
    {
        if (!nox_common_gameFlags_check_40A5C0(1) || sub_40A300() || (v1 = nox_common_gameFlags_getVal_40A5B0(), LOBYTE(v2) = sub_40A180(v1), (_BYTE)v2))
        {
