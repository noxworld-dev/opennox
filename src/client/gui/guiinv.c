...
int __cdecl sub_461660(int a1, int a2, const void* a3) {
	...
	if (a2 != dword_5d4594_1062560 && a2 != *(_DWORD*)&byte_5D4594[1049728] && a2 != *(_DWORD*)&byte_5D4594[1049724] &&
		...
		if (v3) {
			...
			if (!sub_4617C0(a1, a2, a3, &a4)) {
				v4 = loadString_sub_40F1D0((char*)&byte_587000[136456], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c",
										   682);
				sub_445490(v4);
				return 0;
			}
			v6 = a4.field_0;
			v7 = a4.field_4;
			if (*(_BYTE*)(*(_DWORD*)&byte_5D4594[148 * (a4.field_4 + 14 * a4.field_0 + 7 * a4.field_0) + 1050020] +
						  112) &
				0x10) {
				sub_472310();
				v7 = a4.field_4;
					...
					*((_DWORD*)v9 + 1) = a1;
					...
					if (sub_461930() && !dword_5d4594_1062480) {
						if ((v13 = *(_DWORD*)v9, v14 = *(_DWORD*)(*(_DWORD*)v9 + 112), v14 & 0x1000000) &&
							...
							if (!v15 || (unsigned __int8)(1 << *(_BYTE*)(*(_DWORD*)&byte_5D4594[2618908] + 2251)) &
											*((_BYTE*)v15 + 62)) {
								sub_461550((int)v9);
								*((_DWORD*)v9 + 34) = 1;
							}
...
LABEL_14:
	...
	if (nox_common_gameFlags_check_40A5C0(2048)) {
		if (*(_WORD*)(dword_5d4594_1063116 + 294)) {
			...
			v56 = (int)v71;
			v11 =
				loadString_sub_40F1D0((char*)&byte_587000[137028], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2575);
			nox_swprintf(v75, v11, v56, v63);
		} else {
			v12 =
				loadString_sub_40F1D0((char*)&byte_587000[137084], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2583);
			nox_wcscpy(v75, v12);
		}
	} else {
		...
		case 0:
			v13 =
				loadString_sub_40F1D0((char*)&byte_587000[137228], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2595);
			goto LABEL_30;
		case 1:
			v52 =
				loadString_sub_40F1D0((char*)&byte_587000[137292], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2599);
			nox_swprintf(v75, v52);
			break;
		case 2:
			v53 =
				loadString_sub_40F1D0((char*)&byte_587000[137356], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2603);
			nox_swprintf(v75, v53);
			break;
		case 3:
			v13 =
				loadString_sub_40F1D0((char*)&byte_587000[137420], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2607);
		LABEL_30:
			nox_swprintf(v75, v13);
			break;
		case 4:
			v51 =
				loadString_sub_40F1D0((char*)&byte_587000[137156], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2591);
	...
	LABEL_51:
		...
		if (v33 & 0xC) {
			v34 =
				loadString_sub_40F1D0((char*)&byte_587000[137688], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2770);
			nox_swprintf(v75, v34);
		} else if (!(v33 & 2) || v2) {
			v58 = v70;
			v55 =
				loadString_sub_40F1D0((char*)&byte_587000[137812], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2776);
			nox_swprintf(v75, v55, v58);
		} else {
			v57 = v70;
			v54 =
				loadString_sub_40F1D0((char*)&byte_587000[137744], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2773);
		...
		if (v72 > 0.0) {
			...
			v61 = v72;
			v37 =
				loadString_sub_40F1D0((char*)&byte_587000[138000], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2801);
		...
		if (v71 > 0.0) {
			...
			v62 = v71;
			v38 =
				loadString_sub_40F1D0((char*)&byte_587000[138060], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2811);
	...
	if (v39 & 0x13001000) {
		...
		if (v40) {
			...
			if (v44 && *(_DWORD*)(v44 + 16)) {
				v45 = loadString_sub_40F1D0((char*)&byte_587000[138236], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c",
											2851);
			...
			v41 =
				loadString_sub_40F1D0((char*)&byte_587000[138120], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2835);
			nox_swprintf(v75, v41);
			nox_window_call_field_94((int)v10, 16397, (int)v75, -1);
			v42 =
				loadString_sub_40F1D0((char*)&byte_587000[138184], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2837);
...
int* __cdecl sub_463880(int* a1) {
	...
	if (*(_DWORD*)&byte_5D4594[2618908]) {
		...
		if (nox_common_gameFlags_check_40A5C0(2048)) {
			...
			v14 =
				loadString_sub_40F1D0((char*)&byte_587000[138448], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 1886);
		...
		if (*(_BYTE*)(v4 + 2251)) {
			...
			v20 =
				loadString_sub_40F1D0((char*)&byte_587000[138604], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 1941);
			...
			v43 = *(_DWORD*)(v4 + 2243);
			v21 =
				loadString_sub_40F1D0((char*)&byte_587000[138652], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 1952);
...
BOOL __cdecl sub_4649B0(int a1, int a2, int a3) {
	...
	if (result) {
		...
		if (!v5) {
			...
			*(_DWORD*)v4 = v6;
			if (!v6) {
				v7 = loadString_sub_40F1D0((char*)&byte_587000[139200], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c",
										   898);
				sub_445490(v7);
				return 0;
			}
	...
	LABEL_53:
		...
		if (dword_5d4594_1049864 == 4) {
			...
			if (v28) {
				...
				v29 = loadString_sub_40F1D0((char*)&byte_587000[139256], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c",
											3858);
			} else {
				v29 = loadString_sub_40F1D0((char*)&byte_587000[139308], 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c",
											3869);
			}
			sub_445490(v29);
			goto LABEL_64;
			...
			if (!sub_4C12C0()) {
				if (*(_DWORD*)(*(_DWORD*)&byte_5D4594[1049848] + 112) & 0x3001000) {
					...
					if (*(_DWORD*)&byte_5D4594[v35 + 1050156]) {
						sub_461550(0);
						*(_DWORD*)&byte_5D4594[148 * (dword_5d4594_1049800 + 14 * dword_5d4594_1049796 +
		...
		if (v36 && !byte_5D4594[1049870]) {
			if (!dword_5d4594_1049856) {
				...
				sub_4649B0(*(int*)&byte_5D4594[1049848], *(int*)&dword_5d4594_1049796, *(int*)&dword_5d4594_1049800);
			}
			goto LABEL_121;
		}
		...
		if (v38 == dword_5d4594_1062560 || v38 == *(_DWORD*)&byte_5D4594[1049728] ||
			v38 == *(_DWORD*)&byte_5D4594[1049724] || v38 == dword_5d4594_1062556 || v38 == dword_5d4594_1062564) {
			sub_4649B0(*(int*)&byte_5D4594[1049848], *(int*)&dword_5d4594_1049796, *(int*)&dword_5d4594_1049800);
			goto LABEL_121;
		}
		...
		if (dword_5d4594_1049856) {
			...
			if (byte_5D4594[v39 + 1050160] && (v40 = *(_DWORD**)&byte_5D4594[v39 + 1050020]) != 0 &&
				((v41 = v40[28], v41 & 0x2000000) && *(_DWORD*)(*(_DWORD*)&byte_5D4594[1049848] + 112) & 0x2000000 &&
		...
		if (byte_5D4594[148 * (dword_5d4594_1049800 + 14 * dword_5d4594_1049796 + 7 * dword_5d4594_1049796) +
						1050160]) {
			v55 = dword_5d4594_1049800;
			v54 = dword_5d4594_1049796;
		LABEL_120:
		...
		if (!sub_4649B0(*(int*)&byte_5D4594[1049848], *(int*)&dword_5d4594_1049804, *(int*)&dword_5d4594_1049808)) {
		LABEL_80:
			sub_4649B0(*(int*)&byte_5D4594[1049848], *(int*)&dword_5d4594_1049796, *(int*)&dword_5d4594_1049800);
			goto LABEL_121;
		}
		...
		if (v1) {
			...
			*(_DWORD*)(*(_DWORD*)&byte_5D4594[1049848] + 128) =
			...
			qmemcpy((void*)(*(_DWORD*)&byte_5D4594[1049848] + 432),
					(const void*)(*(_DWORD*)&byte_5D4594[148 * (dword_5d4594_1049800 + 14 * dword_5d4594_1049796 +
																7 * dword_5d4594_1049796) +
														 1050020] +
								  432),
					0x18u);
			*(_WORD*)(*(_DWORD*)&byte_5D4594[1049848] + 292) =
				*(_WORD*)(*(_DWORD*)&byte_5D4594[148 * (dword_5d4594_1049800 + 14 * dword_5d4594_1049796 +
														7 * dword_5d4594_1049796) +
												 1050020] +
						  292);
			*(_WORD*)(*(_DWORD*)&byte_5D4594[1049848] + 294) =
			...
			v3[1] = 0;
			v3[0] =
				(int*)&byte_5D4594[148 * (dword_5d4594_1049800 + 14 * dword_5d4594_1049796 + 7 * dword_5d4594_1049796) +
								   1050020];
...
int sub_4671E0() {
	...
	if (v1) {
		nox_sprintf(v5, "experience:%s%d", *(_DWORD*)&byte_587000[4 * *(unsigned __int8*)(v1 + 2251) + 29456], result);
