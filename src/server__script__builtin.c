...
int  sub_512E80(int a1) {
	...
	if (*(int*)&dword_5d4594_1599628 < 1024) {
		*getMemU32Ptr(0x973CE0, 27232 + 4 * dword_5d4594_1599628) = a1;
...
int nox_script_intToString_512EA0() {
	...
	v0 = nox_script_pop();
	_itoa(v0, (char*)getMemAt(0x973CE0, 22848), 10);
	v1 = nox_script_addString_512E40((char*)getMemAt(0x973CE0, 22848));
	nox_script_push(v1);
	return 0;
}
...
int nox_script_floatToString_512ED0() {
	...
	v0 = nox_script_popf();
	nox_sprintf((char*)getMemAt(0x973CE0, 22848), "%f", v0, v0);
	v1 = nox_script_addString_512E40((char*)getMemAt(0x973CE0, 22848));
	nox_script_push(v1);
	return 0;
}
