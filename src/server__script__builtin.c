...
void* nox_script_builtin[] = {
	...
	&nox_script_builtin_515200, // 135
	&nox_script_builtin_515220, // 136
...
int nox_script_callBuiltin_508B70(int i, int fi) {
	...
	nox_script_builtin_buf_xxx[0] = 0; // TODO: was = getMemByte(0x5D4594, 1599672);
	dword_5d4594_3821640 = 0;
	dword_5d4594_3821636 = 0;
	return res;
}
