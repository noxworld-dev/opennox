...
int nox_xxx_guiDrawRank_46E870() {
	...
	*(_DWORD*)&v49[68] = *getMemU32Ptr(0x8531A0, 34312);
...
wchar_t* sub_46F030() {
	...
	for (i = 0; i < 12; i += 4) {
		result = nox_strman_loadString_40F1D0(*(char**)getMemAt(0x587000, 145676 + i), 0, "C:\\NoxPost\\src\\client\\Gui\\guirank.c",
									   167);
	...
	if (dword_587000_145664 || nox_frame_xxx_2598000 >
		...
		*getMemU32Ptr(0x5D4594, 1090124) = nox_frame_xxx_2598000;
			...
			if ((_BYTE)a2) {
				do {
					...
					if (dword_5d4594_1090120 != 5 || *getMemU32Ptr(0x5D4594, 1084196 + 80 * v32) > 0)
						sub_46DC30(*getMemU32Ptr(0x5D4594, 1090084 + 4 * v16), v40, (wchar_t*)getMemAt(0x587000, 146632),
								   *getMemU32Ptr(0x5D4594, 1084196 + 80 * v32));
					else
						sub_46DC30(*getMemU32Ptr(0x5D4594, 1090084 + 4 * v16), v40, (wchar_t*)getMemAt(0x587000, 146640));
					...
					if (dword_5d4594_1090120 == 5) {
						...
						if (v20)
							sub_46DC30(*getMemU32Ptr(0x5D4594, 1090068 + 4 * v16), v40, (wchar_t*)getMemAt(0x587000, 146656),
									   v20 + 2096);
					} else {
		...
		case 5:
			switch (v9) {
			case 2:
				v22 = nox_strman_loadString_40F1D0("TeamPlayerRank", 0, "C:\\NoxPost\\src\\client\\Gui\\guirank.c",
											1475);
				break;
			case 4:
				v22 = nox_strman_loadString_40F1D0("Top3", 0, "C:\\NoxPost\\src\\client\\Gui\\guirank.c",
											1479);
				break;
			case 5:
				v22 = nox_strman_loadString_40F1D0("WolRank", 0, "C:\\NoxPost\\src\\client\\Gui\\guirank.c",
											1483);
				break;
			case 1:
		...
		case 3:
			...
			v22 =
				nox_strman_loadString_40F1D0("Teams", 0, "C:\\NoxPost\\src\\client\\Gui\\guirank.c", 1519);
			if (!nox_common_gameFlags_check_40A5C0(1) || !nox_common_getEngineFlag(NOX_ENGINE_FLAG_DISABLE_GRAPHICS_RENDERING)) {
				v30 = getMemByte(0x5D4594, 1090116);
				v26 = nox_strman_loadString_40F1D0("yourteamrank", 0, "C:\\NoxPost\\src\\client\\Gui\\guirank.c",
											1525);
