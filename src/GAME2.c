...
_DWORD* sub_44E560() {
	...
	*getMemU32Ptr(0x5D4594, 831288) = (nox_win_height - NOX_DEFAULT_HEIGHT) / 2;
	...
	if (result) {
		...
		*(_DWORD*)(dword_5d4594_831236 + 56) = *getMemU32Ptr(0x8531A0, 34324);
...
int  sub_4571A0(int a1, int a2) {
	...
	if (dword_5d4594_1045684) {
		...
		if (result != -1) {
			...
			result = *(_DWORD*)(v3 + 24);
			*(_DWORD*)(result + 524 * v4 + 516) = **(_DWORD**)getMemAt(0x8531A0, 33504 + 4 * v5);
		}
	}
	return result;
}
...
int __thiscall sub_460940(void* this) {
	...
	v2 = this;
	if (!*getMemU32Ptr(0x8531A0, 1186968) && sub_461450() == 1) {
		sub_461400();
		sub_461440(0);
	}
	if (*getMemU32Ptr(0x8531A0, 2576))
