		...
		case 3:
			if (!*(_DWORD*)&byte_587000[122848] || !*(_DWORD*)&byte_5D4594[830972] ||
			    *(_DWORD*)&byte_5D4594[830872] != *(_DWORD*)&byte_5D4594[830972] ||
			    !*(_DWORD*)&byte_5D4594[831088] || AIL_stream_status(*(_DWORD*)&byte_5D4594[831088]) == 2) {
				*(_DWORD*)&byte_5D4594[830864] = 4;
				sub_486350((int)&byte_5D4594[830876], 0);
			}
			break;
		case 4:
			if (!*(_DWORD*)&byte_5D4594[831088] || AIL_stream_status(*(_DWORD*)&byte_5D4594[831088]) == 2 ||
...
//----- (00450B70) --------------------------------------------------------
int sub_450B70() { return nox_window_call_field_94(*(int*)&byte_5D4594[833720], 16399, 0, 0); }
...
int sub_450C70() {
	...
	*(_DWORD*)&byte_5D4594[833712] = nox_window_new(0, 56, 0, 0, nox_win_width - 1, nox_win_height / 2, 0);
	...
	*(_WORD*)&v4[198] = 0;
	*(_DWORD*)&v4[8] = 32;
	*(_DWORD*)&byte_5D4594[833720] =
	    sub_4A4310(*(int*)&byte_5D4594[833712], 1152, 0, 0, *(int*)&byte_5D4594[833704],
	...
	*(_DWORD*)&v4[8] = 128;
	*(_DWORD*)&byte_5D4594[833716] =
	    sub_488500(*(int*)&byte_5D4594[833712], 16393, 0, *(_DWORD*)&byte_5D4594[833708] - 20,
...
//----- (00451410) --------------------------------------------------------
int sub_451410() { return ((unsigned __int8)~sub_46ADA0(*(int*)&byte_5D4594[833712]) >> 4) & 1; }
...
char __cdecl sub_455A50(char a1) {
	...
	*(_DWORD*)(*(_DWORD*)&byte_5D4594[1045604] + 24) =
	    *(_DWORD*)(*(_DWORD*)&byte_5D4594[1045604] + 8) + *(_DWORD*)(*(_DWORD*)&byte_5D4594[1045604] + 16);
	...
	if (byte_5D4594[1045628] <= 8u) {
		if (byte_5D4594[1045628] <= 4u) {
			...
			*(_DWORD*)(*(_DWORD*)&byte_5D4594[1045604] + 20) =
			    cur_h - *(int*)(*(_DWORD*)&byte_5D4594[1045604] + 12) / 2;
		}
	} else {
		*(_DWORD*)(*(_DWORD*)&byte_5D4594[1045604] + 20) =
		    cur_h - *(_DWORD*)(*(_DWORD*)&byte_5D4594[1045604] + 12);
	}
	*(_DWORD*)(*(_DWORD*)&byte_5D4594[1045604] + 28) =
	    *(_DWORD*)(*(_DWORD*)&byte_5D4594[1045604] + 12) + *(_DWORD*)(*(_DWORD*)&byte_5D4594[1045604] + 20);
...
int __cdecl sub_4593B0(int a1) {
	...
	if (a1) {
		if (a1 == 1) {
			...
			*(_DWORD*)&byte_5D4594[1046528] = sub_4541D0(*(int*)&dword_5d4594_1046492);
	...
	if (*(_DWORD*)&byte_5D4594[1046868] == 1) {
		for (i = sub_427300(); i; i = sub_427320(i)) {
			if (nox_common_gameFlags_check_40A5C0(0x2000) && !nox_common_gameFlags_check_40A5C0(4096) ||
			    *(_DWORD*)(*(_DWORD*)&byte_5D4594[1047516] + 4 * i + 4244)) {
				if (sub_4D70C0(i)) {
		...
		for (j = sub_424AD0(); j; j = sub_424AF0(j)) {
			if (j != 34 && !sub_57AEA0(a1, j) &&
			     ...
			     *(_DWORD*)(*(_DWORD*)&byte_5D4594[1047516] + 4 * j + 3696))) {
		...
		for (k = sub_425330(); k; k = sub_425350(k)) {
			if (nox_common_gameFlags_check_40A5C0(0x2000) && !nox_common_gameFlags_check_40A5C0(4096) ||
			    *(_DWORD*)(*(_DWORD*)&byte_5D4594[1047516] + 4 * k + 3696)) {
		...
		*(_DWORD*)&byte_587000[132136] = 2 * v5 * *(_DWORD*)&byte_5D4594[1046936] + v9;
		...
		if (!v11 && !*(_DWORD*)&byte_5D4594[1046868]) {
			*(_DWORD*)&byte_5D4594[1047528] =
			    *(_DWORD*)&byte_5D4594[4 * *(_DWORD*)&byte_587000[132136] + 1046960];
...
int sub_45B9D0() {
	...
	*(_DWORD*)&byte_5D4594[1046948] = nox_window_new(nox_win_unk1, 136, 233, 138, 20, 20, 0);
	...
	*(_DWORD*)&byte_5D4594[1046952] = nox_window_new(nox_win_unk1, 8, 63, 19, 30, 30, 0);
...
int __cdecl sub_45CB30(_DWORD* a1) {
	...
	if (*(_DWORD*)&byte_5D4594[1046868]) {
		if (*(_DWORD*)&byte_5D4594[1046868] != 1 || *(_BYTE*)(*(_DWORD*)&byte_5D4594[1047516] + 2251) != 2 ||
...
_DWORD* __cdecl sub_45D550(_DWORD* a1) {
	...
	result = a1;
	if (a1)
		result = (_DWORD*)nox_client_wndGetPosition_46AA60(*(_DWORD**)&byte_5D4594[1046952], a1, a1 + 1);
	return result;
}
	...
	if (*(_DWORD*)&byte_5D4594[2618908]) {
		if (!sub_4372B0()) {
			if (*(_BYTE*)(*(_DWORD*)&byte_5D4594[2618908] + 2251)) {
				sub_45DB20((char*)(*(_DWORD*)(*(_DWORD*)&byte_587000[133480] + 204) + 8 * a1), 1,
					   *(_BYTE*)(*(_DWORD*)(*(_DWORD*)&byte_587000[133480] + 204) + 8 * a1 + 4) &
					       1);
				sub_45DAD0(a1);
			} else {
...
int __cdecl sub_45E110(int a1) {
	...
	if (a1 >= 0 && a1 < 5 && !*(_DWORD*)&byte_5D4594[1049476] && !*(_DWORD*)&byte_5D4594[1049496]) {
		...
		*(_DWORD*)(*(_DWORD*)&byte_587000[133480] + 204) =
		    *(_DWORD*)&byte_587000[133480] + 40 * *(unsigned __int8*)(*(_DWORD*)&byte_587000[133480] + 200);
		if (*(_DWORD*)&byte_5D4594[2618908])
			sub_452D80(798, 100);
...
//----- (0045E180) --------------------------------------------------------
int sub_45E180() { return *(unsigned __int8*)(*(_DWORD*)&byte_587000[133480] + 200); }
...
int __cdecl sub_45EF50(int a1, int a2, unsigned int a3) {
	...
	if (!*(_DWORD*)&byte_5D4594[2614252] || (*(_BYTE*)(*(_DWORD*)&byte_5D4594[2614252] + 120) & 2) != 2) {
		...
		switch (a2) {
		case 5:
			if (!*v9 || *(_DWORD*)&byte_5D4594[1047928] || *(_DWORD*)&byte_5D4594[1047932] ||
			    sub_57AF20() ||
...
int __cdecl sub_45F6F0(_DWORD* a1) {
	...
	if (*(int*)&byte_5D4594[1049700] <= 0 || *(int*)&byte_5D4594[1049704] != v2) {
		...
		if (!--*(_DWORD*)&byte_5D4594[1049700] && *(_DWORD*)&byte_5D4594[1049704] <= 2)
			*(_DWORD*)(*(_DWORD*)&byte_5D4594[1049508] + 60) =
			    *(_DWORD*)(*(_DWORD*)&byte_5D4594[1049508] + 76);
	}
	v6 = sub_45CFC0();
...
int sub_460000() {
	...
	if (v1 >= 0) {
		if (v1 <= 0) {
			...
			sub_46A9B0(*(_DWORD**)&byte_5D4594[1049504], *(_DWORD*)(*(_DWORD*)&byte_5D4594[1049504] + 16),
				   v0 - 1);
			result = 1;
		}
	} else {
