...
int nox_xxx_unused_45A750() {
	...
	v1 = nox_drawable_head_unk1;
	v10 = *getMemU32Ptr(0x84EB20, 15968);
	if (v1) {
		do {
			if (v1[28] & 0x300000) {
				v2 = v1[8];
...
int  sub_45A840(_DWORD* a1) {
	...
	if (nox_xxx_spriteTestBuf_4356C0((int)a1, 23)) {
		...
		result = 1;
	} else if (nox_xxx_spriteTestBuf_4356C0((int)a1, 15) || a1 == *(_DWORD**)getMemAt(0x84EB20, 15968) && sub_467430() & 8) {
...
int sub_45AB40() {
	...
	for (i = result; result; i = result) {
		if (*(_DWORD*)(i + 492))
			sub_45A9B0(i, *getMemIntPtr(0x84EB20, 15968));
		result = sub_45A0A0(i);
	}
	return result;
}
...
int  nox_xxx_bookWndProc_45B070(int a1, int a2) {
	...
	if (*getMemU32Ptr(0x84EB20, 15968) && !sub_478030() && !sub_47A260() &&
		(*(_BYTE*)(*getMemU32Ptr(0x84EB20, 15968) + 120) & 2) == 2) {
		return 1;
	}
	if (a2 != 5)
		return 0;
...
int  nox_xxx_bookChildWndProcMB_45B360(_DWORD* a1, unsigned int a2) {
	...
	v2 = 0;
	if (dword_5d4594_1047520 == 1 || *getMemU32Ptr(0x84EB20, 15968) && !sub_478030() && !sub_47A260() &&
										 (*(_BYTE*)(*getMemU32Ptr(0x84EB20, 15968) + 120) & 2) == 2) {
		return 1;
	}
	if (a2 != 5) {
...
int  nox_xxx_bookListWndProc_45B5F0(int a1, unsigned int a2, unsigned int a3) {
	...
	switch (a2) {
	case 5u:
		if (*getMemU32Ptr(0x84EB20, 15968) && (*(_BYTE*)(*getMemU32Ptr(0x84EB20, 15968) + 120) & 2) == 2)
			return 1;
