...
uint32_t*  nox_thing_falling_sparks_draw_4B7740(int a1, int a2, nox_drawable* dr) {
	...
	v4 = 2;
	do {
		a2a.field_0 = v3->field_0 + nox_common_randomIntMinMax_415FF0(-15, 15, "C:\\NoxPost\\src\\client\\Draw\\LvUpDraw.c", 35);
		v5 = *(uint32_t*)(a3 + 16) + nox_common_randomIntMinMax_415FF0(-15, 15, "C:\\NoxPost\\src\\client\\Draw\\LvUpDraw.c", 36);
		a2a.field_4 = v5;
