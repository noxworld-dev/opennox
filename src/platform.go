...
func nox_ticks_xxx_416D40() {
	...
	*memmap.PtrUint32(0x5D4594, 371772) = memmap.Uint32(0x5D4594, 2598000)
	resetEngineFlag(NOX_ENGINE_FLAG_32)
}

//export sub_416D70
func sub_416D70() C.bool {
	v2 := float64(int(memmap.Uint32(0x5D4594, 2598000))-int(memmap.Uint32(0x5D4594, 371772))) * float64(memmap.Float32(0x587000, 54424))
...
func nox_ticks_maybe_sleep_416DD0() {
	v1 := float64(int(memmap.Uint32(0x5D4594, 2598000))-int(memmap.Uint32(0x5D4594, 371772))) * float64(memmap.Float32(0x587000, 54428))
