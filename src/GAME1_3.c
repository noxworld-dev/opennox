...
int sub_43CF70() {
	...
	if (!dword_5d4594_815708) {
		...
		result = *getMemU32Ptr(0x8529A0, 4624);
		if (*getMemU32Ptr(0x8529A0, 4624)) {
			nox_xxx_netNeedTimestampStatus_4174F0(*getMemIntPtr(0x8529A0, 4624), 64);
			v2 = 41;
...
_DWORD*  nox_xxx_gui_43E1A0(int a1) {
	...
	if (a1) {
		...
		result[14] = *getMemU32Ptr(0x8529A0, 36372);
	} else {
...
__int16  sub_4408A0(_WORD* a1) {
	if (getMemByte(0x8529A0, 1184368) & 8)
		*a1 ^= 0x5555u;
	return 63;
}
...
int nox_xxx_drawMessageLines_445530() {
	...
	for (i = dword_5d4594_825736;; v2 = i) {
		...
		if (*getMemU32Ptr(0x5D4594, 824440 + v5) < nox_frame_xxx_2598000)
			break;
		nox_xxx_drawSetTextColor_434390(*getMemIntPtr(0x8529A0, 36372));
...
void sub_446380() {
	...
	if (nox_common_gameFlags_check_40A5C0(0x2000) && !nox_common_gameFlags_check_40A5C0(4096) && !sub_4D6F30())
		sub_41CEE0((int)getMemAt(0x8529A0, 46400), 1);
	...
	*getMemU32Ptr(0x5D4594, 826040 + 4 * a1) = 0;
	...
	if (result) {
		*getMemU32Ptr(0x5D4594, 826040 + 4 * a1) = nox_fs_fsize(v2);
		...
		if (v3) {
			nox_binfile_fread2_40ADD0(v3, *getMemU32Ptr(0x5D4594, 826040 + 4 * a1), 1u, v2);
...
LPVOID  sub_446490(int a1) {
	...
	dword_5d4594_826036 = 0;
	*getMemU32Ptr(0x5D4594, 826040 + 4 * (_DWORD)a1) = 0;
	return result;
}
...
int  sub_446580(int a1) {
	...
	if (result) {
		free(*(LPVOID*)getMemAt(0x5D4594, 826056 + 4 * a1));
...
int  sub_446C10(int a1, int a2) {
	...
	if (a1 < *(__int16*)(v2 + 44)) {
		result = 131 * a1;
		if (a2)
			*(_DWORD*)(*(_DWORD*)(v2 + 24) + 524 * a1 + 516) = **(_DWORD**)getMemAt(0x8529A0, 35560);
		else
			*(_DWORD*)(*(_DWORD*)(v2 + 24) + 524 * a1 + 516) = **(_DWORD**)getMemAt(0x8529A0, 35608);
	}
	return result;
}
...
int  sub_448240(_DWORD* a1, _BYTE* a2) {
	...
	v2 = *(unsigned __int16**)getMemAt(0x587000, 108824 + 12 * a1[8]);
	...
	sub_4482D0((80 - v5) / 2 + v6 + 1, (int)a1, v3, *getMemIntPtr(0x8529A0, 36372), v2);
	return 1;
}
...
int  sub_448340(int a1, unsigned int a2) {
	...
	if (a2 > 5 && a2 <= 7) {
		sub_448380();
		(*(void(**)(int)) getMemAt(0x587000, 108832 + 12 * *(_DWORD*)(a1 + 32)))(*(int*)&dword_587000_109280);
		return 1;
	}
	return 0;
}
	...
	if (dword_5d4594_830224) {
		...
		*getMemU32Ptr(0x5D4594, 830240) = 0;
		if (nox_xxx_guiFontHeightMB_43F320(0) > 10)
			v6 = 2;
		result = nox_new_window_from_file(*(const char**)getMemAt(0x587000, 112976 + 4 * v6), nox_xxx_windowDlgProc_449CA0);
