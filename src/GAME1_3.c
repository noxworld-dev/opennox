...
char* sub_43B510() {
	...
	if (dword_587000_87404 == 1) {
		...
		HIWORD(v6) -= *getMemU16Ptr(0x587000, 8 * dword_587000_87412 + 87530);
		LOWORD(v6) = v0;
	}
...
//----- (0043BE10) --------------------------------------------------------
int sub_43BE10() { return *getMemU32Ptr(0x5D4594, 4 * getMemByte(0x5D4594, 815208) + 815140); }
...
//----- (0043BEB0) --------------------------------------------------------
void __cdecl nox_xxx_gameGetScreenBoundaries_43BEB0_get_video_mode(int* w, int* h, int* d) {
	if (w)
		*w = nox_win_width_1;
	if (h)
		*h = nox_win_height_1;
...
int sub_43C0A0() // switch game states
{
	...
	if (!getMemByte(0x5D4594, 815208))
		return 1;
	v0 = *getMemU32Ptr(0x5D4594, 4 * getMemByte(0x5D4594, 815208) + 815140);
	if (v0 > 0x258) {
		if (v0 > 0x76C) {
			if (v0 != 1915) {
				if (v0 != 10000)
...
void sub_43C1E0() {
	...
	if (getMemByte(0x5D4594, 815208)) {
		v0 = sub_43C520(*getMemU32Ptr(0x5D4594, 4 * getMemByte(0x5D4594, 815208) + 815140));
		v1 = v0;
		if (v0) {
			((int (*)(void))v0[12])();
			v1[13] = sub_43C0A0;
...
_DWORD* sub_43C220() {
	...
	if (getMemByte(0x5D4594, 815208)) {
		result = sub_43C520(*getMemU32Ptr(0x5D4594, 4 * getMemByte(0x5D4594, 815208) + 815140));
		v1 = result;
		if (result) {
...
int sub_43C260() {
	...
	if (getMemByte(0x5D4594, 815208)) {
		...
		for (; *getMemU32Ptr(0x5D4594, 4 * getMemByte(0x5D4594, 815208) + 815140) != 1700; result = getMemByte(0x5D4594, 815208))
			sub_43BDC0();
	}
	return result;
}
...
int sub_43C2F0() {
	...
	if (getMemByte(0x5D4594, 815208)) {
		...
		for (; *getMemU32Ptr(0x5D4594, 4 * getMemByte(0x5D4594, 815208) + 815140) != 100; result = getMemByte(0x5D4594, 815208))
			sub_43BDC0();
	}
	return result;
}
...
nox_wnd_xxx* nox_wnd_sub_43C5B0(_DWORD* a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9) {
	...
	if (!p)
		return 0;
	nox_wnd_nox_xxx_wndDraw_46A9B0(a1, a4, a5);
	p->field_4 = a2;
	p->field_5 = a3;
	p->field_8 = a6;
	p->field_1 = a1;
...
int sub_43C650() {
	...
	if (*getMemU64Ptr(0x5D4594, 815740)) {
		...
		*getMemU32Ptr(0x5D4594, 8 * *getMemU32Ptr(0x5D4594, 815756) + 815220) = v0 - *getMemU32Ptr(0x5D4594, 815740);
		*getMemU32Ptr(0x5D4594, 8 * v1 + 815224) = HIDWORD(v0) - v2;
	} else {
...
//----- (0043C720) --------------------------------------------------------
int __cdecl nox_xxx_gameSetCliConnected_43C720(int a1) {
	int result; // eax
	bool v2;    // zf
...
//----- (0043C750) --------------------------------------------------------
int nox_xxx_netGet_43C750() { return *(_DWORD*)getMemAt(0x5D4594, 815700); }
...
//----- (0043C7B0) --------------------------------------------------------
int __cdecl nox_xxx_netAddNetStruct4Host_43C7B0(char* cp, int hostshort, int a3, signed int* a4) {
	int v4;      // eax
	int v5;      // eax
...
//----- (0043C860) --------------------------------------------------------
int __cdecl nox_xxx_netHandleCliPacket_43C860(int a1, unsigned __int8* a2, int a3) {
	unsigned __int8 v3; // cl
	int v4;             // ecx
...
//----- (0043C8F0) --------------------------------------------------------
int __cdecl nox_xxx_clientSendInput_43C8F0(int a1, int a2, int a3) {
	int v3;     // ebx
	char* v4;   // edi
	int result; // eax
	int v6;     // eax
...
int sub_43CF70() {
	...
	if (!dword_5d4594_815708) {
		...
		result = *getMemU32Ptr(0x5D4594, 2618908);
		if (*getMemU32Ptr(0x5D4594, 2618908)) {
			nox_xxx_netNeedTimestampStatus_4174F0(*getMemIntPtr(0x5D4594, 2618908), 64);
			v2 = 41;
...
//----- (0043CFD0) --------------------------------------------------------
BOOL sub_43CFD0() { return nox_xxx_servNetInitialPackets_552A80(*(unsigned int*)getMemAt(0x5D4594, 815700), 1) != -1; }
...
int sub_43D440() {
	...
	v0 = getMemIntPtr(0x5D4594, 20 * *getMemU32Ptr(0x5D4594, 816352) + 816108);
...
//----- (0043D6C0) --------------------------------------------------------
int __cdecl nox_xxx_musicStartPlay_43D6C0(int* a1) {
	const char* v1;     // edi
	...
	*getMemU32Ptr(0x587000, 93160) = 0;
	...
	if (!strchr(v8, 46)) {
		...
		v3 = &v8[strlen(v8)];
		*(_DWORD*)v3 = *getMemU32Ptr(0x587000, 93180);
		v3[4] = v2;
	}
	...
	if (!v4) {
		...
		*getMemU32Ptr(0x587000, 93160) = 1;
		...
		v6 = strlen(&v8[40]) + 1;
		if (v6 != 1 && v8[v6 + 38] != 92)
			*(_WORD*)&v8[strlen(&v8[40]) + 40] = *getMemU16Ptr(0x587000, 93188);
		strcat(&v8[40], v8);
...
void __cdecl sub_43D9E0(int4* a1) {
	...
	v1 = (int4*)getMemAt(0x5D4594, 20 * (*getMemU32Ptr(0x5D4594, 816352) ^ 1) + 816108);
	v2 = a1->field_4;
	if (v2 <= 100) {
		if (v2 < 0)
			a1->field_4 = 0;
...
int sub_43DA80() {
	...
	if (*(int*)&dword_5d4594_816368 < 6) {
		sub_43DD10(getMemIntPtr(0x5D4594, 16 * (dword_5d4594_816368 + 6 * dword_5d4594_816372) + 815772));
		++dword_5d4594_816368;
		result = 1;
	} else {
...
int sub_43DB60() {
	...
	if (*(int*)&dword_5d4594_816372 < 3) {
		...
		dword_5d4594_816368 = 0;
		*getMemU32Ptr(0x5D4594, 4 * dword_5d4594_816372 + 816076) = v2;
		result = v1 + 1;
...
void sub_43DBA0() {
	...
	if (dword_5d4594_816372 > 0) {
		...
		dword_5d4594_816368 = *getMemU32Ptr(0x5D4594, 4 * v1 + 816076);
		sub_43DAD0();
	} else {
		dword_5d4594_816372 = 0;
	}
...
int sub_43DC80() {
	...
	if (dword_587000_93156 && dword_5d4594_816340) {
		while (1) {
			v0 = getMemAt(0x5D4594, 20 * *getMemU32Ptr(0x5D4594, 816352) + 816108);
			if (*(_DWORD*)v0) {
				if (*((_DWORD*)v0 + 4))
					break;
			}
...
int __cdecl sub_43DD10(int* a1) {
	...
	v1 = getMemAt(0x5D4594, 20 * *getMemU32Ptr(0x5D4594, 816352) + 816108);
	*a1 = *getMemU32Ptr(0x5D4594, 20 * *getMemU32Ptr(0x5D4594, 816352) + 816108);
	a1[1] = *((_DWORD*)v1 + 1);
	a1[2] = *((_DWORD*)v1 + 2);
	a1[3] = *((_DWORD*)v1 + 3);
	result = dword_5d4594_816364;
...
//----- (0043E1A0) --------------------------------------------------------
_DWORD* __cdecl nox_xxx_gui_43E1A0(int a1) {
	_DWORD* result; // eax

	if (a1) {
		result = nox_window_new(0, 552, 0, 0, nox_win_width, nox_win_height, 0);
		dword_5d4594_816412 = result;
		result[14] = *getMemU32Ptr(0x5D4594, 2650656);
	} else {
		result = *(_DWORD**)&dword_5d4594_816412;
		if (dword_5d4594_816412) {
			result = (_DWORD*)nox_xxx_windowDestroyMB_46C4E0(*(_DWORD**)&dword_5d4594_816412);
	...
	do {
		...
		LABEL_18:
			if (*(_DWORD*)&v2[v0 + 4] && !*(_DWORD*)&v2[v0 + 8]) {
				*(_DWORD*)(v0 + dword_5d4594_816488 + 8) = nox_xxx_FontLoadFile_43F3B0(*(char**)&v2[v0 + 4]);
				v2 = *(unsigned __int8**)&dword_5d4594_816488;
			}
		}
		v0 += 12;
...
//----- (0043F320) --------------------------------------------------------
int __cdecl nox_xxx_guiFontHeightMB_43F320(int a1) {
	int v1;     // ecx
	int result; // eax
...
//----- (0043F340) --------------------------------------------------------
int __cdecl nox_xxx_Font_43F340(int* a1) {
	int* v1;    // ecx
	int result; // eax
...
//----- (0043F360) --------------------------------------------------------
int __cdecl nox_xxx_guiFontPtrByName_43F360(char* a1) {
	int v1;         // edi
	int v2;         // esi
	const char* v3; // eax
...
//----- (0043F3B0) --------------------------------------------------------
_DWORD* __cdecl nox_xxx_FontLoadFile_43F3B0(char* a1) {
	_DWORD* v1;              // ebx
	FILE* v3;                // ebp
	char* v4;                // eax
	...
	if (v3) {
		...
		if (v1) {
			...
			*getMemU32Ptr(0x5D4594, 4 * v11 + 816464) = v1;
...
int __cdecl sub_43F620(LPVOID lpMem) {
	...
	*getMemU32Ptr(0x5D4594, 4 * v1 + 816464) = 0;
...
//----- (0043F6E0) --------------------------------------------------------
int __cdecl nox_xxx_drawString_43F6E0(int a1, __int16* a2, int a3, int a4) {
	int result; // eax
...
//----- (0043F840) --------------------------------------------------------
int __cdecl nox_xxx_drawGetStringSize_43F840(int a1, unsigned __int16* a2, int* a3, _DWORD* a4, int a5) {
	unsigned __int16 v5;  // cx
	...
	if ((a1 || (a1 = dword_5d4594_816492) != 0) && a2) {
		...
		for (i = 0; v6; ++v9) {
			...
			default:
			LABEL_10:
				v10 = (unsigned __int8*)nox_xxx_FontGetChar_43FE30(a1, v6);
				if (v10 || (v10 = (unsigned __int8*)nox_xxx_FontGetChar_43FE30(a1, 0x3Fu)) != 0) {
					v11 = *v10;
...
int __cdecl sub_43F9E0(int a1, unsigned __int16* a2, int a3) {
	...
	for (i = a2 + 1; v6; ++i) {
		if (v6 == 9) {
			...
			v8 = (unsigned __int8*)nox_xxx_FontGetChar_43FE30(v3, v6);
			if (v8 || (v8 = (unsigned __int8*)nox_xxx_FontGetChar_43FE30(v3, 0x3Fu)) != 0)
...
//----- (0043FA80) --------------------------------------------------------
int __cdecl nox_xxx_bookGetStringSize_43FA80(int a1, unsigned __int16* a2, int* a3, _DWORD* a4, int a5) {
	int result; // eax
...
//----- (0043FAF0) --------------------------------------------------------
int __cdecl nox_xxx_drawString_43FAF0(int a1, _WORD* a2, int a3, int a4, int a5, int a6) {
	int v7;     // ebx
	int v8;     // ecx
	_WORD* v9;  // edi
	int v10;    // eax
...
//----- (0043FD80) --------------------------------------------------------
int __cdecl nox_xxx_bookDrawString_43FA80_43FD80(int a1, _WORD* a2, int a3, int a4, int a5, int a6) {
	int result; // eax
...
//----- (0043FE30) --------------------------------------------------------
int __cdecl nox_xxx_FontGetChar_43FE30(int a1, unsigned __int16 a2) {
	int v2;     // edx
	int result; // eax
	int v4;     // esi
...
//----- (0043FE90) --------------------------------------------------------
int __cdecl nox_xxx_StringDraw_43FE90(int a1, __int16 a2, int xLeft, int yTop) {
	int v4;              // edx
	int v5;              // ebp
	int v7;              // edi
	unsigned __int8* v8; // eax
	...
	if (!v8) {
		v9 = sub_4408A0(&yTop);
		a2 = v9;
		v8 = (unsigned __int8*)nox_xxx_FontGetChar_43FE30(a1, v9);
		if (!v8)
			return xLeft;
	}
	v10 = *(_DWORD*)(a1 + 8);
...
int __cdecl sub_440360(int a1, int a2, int xLeft, int yTop) {
	...
	if (!v5) {
		...
		a2 = v6;
		v5 = (unsigned __int8*)nox_xxx_FontGetChar_43FE30(a1, v6);
		if (!v5)
			return xLeft;
	}
	v7 = *(_DWORD*)(a1 + 8);
...
//----- (004407F0) --------------------------------------------------------
int __cdecl nox_xxx_guiDrawString_4407F0(int a1, __int16* a2, int a3, int a4) {
	__int16 v4;  // cx
	__int16* v5; // esi
	int result;  // eax
...
//----- (00440840) --------------------------------------------------------
void __cdecl nox_xxx_Font_440840(LPVOID lpMem) {
	if (*((_DWORD*)lpMem + 4))
		free(*((LPVOID*)lpMem + 4));
	if (*((_DWORD*)lpMem + 6))
		free(*((LPVOID*)lpMem + 6));
...
//----- (00440870) --------------------------------------------------------
int __cdecl nox_xxx_fontLoad_440870(int a1) {
	int result;           // eax
	int v2;               // edx
...
int __cdecl nox_xxx_netServerCmd_440950(char a1, wchar_t* a2) {
	...
	v3[0] = -69;
	v3[1] = a1;
	*(_WORD*)&v3[2] = *getMemU16Ptr(0x5D4594, 2616328);
	v3[4] = 0;
	*(_WORD*)&v3[5] = 0;
	if (a2) {
...
void __cdecl sub_4417E0(wchar_t* a1, const char* a2) {
	...
	if (a2) {
		...
		v3 = &v4[strlen(v4)];
		*(_DWORD*)v3 = *getMemU32Ptr(0x587000, 103292);
		v3[4] = v2;
...
int nox_xxx_drawMessageLines_445530() {
	...
	for (i = dword_5d4594_825736;; v2 = i) {
		...
		do {
			nox_xxx_drawString_43F6E0(0, (__int16*)v6, v9 + *(_DWORD*)v8, v1 + *((_DWORD*)v8 + 1));
			v8 += 8;
		...
		nox_xxx_drawString_43F6E0(0, (__int16*)v6, v7 / 2, v1);
...
//----- (004456E0) --------------------------------------------------------
int __cdecl nox_xxx_guiChatMode_4456E0(int* a1) {
	int* v1; // esi
	int v2;  // edx
...
//----- (00445730) --------------------------------------------------------
int __cdecl nox_xxx_guiChatShowHide_445730(int a1) { return nox_window_set_hidden(*(int*)&dword_5d4594_825744, a1); }

//----- (00445750) --------------------------------------------------------
BOOL sub_445750() { return dword_5d4594_825744 && !wndIsShown_nox_xxx_wndIsShown_46ACC0(*(int*)&dword_5d4594_825744); }

//----- (00445770) --------------------------------------------------------
int sub_445770() {
	int result; // eax

	result = nox_xxx_windowDestroyMB_46C4E0(*(_DWORD**)&dword_5d4594_825744);
...
//----- (00445BC0) --------------------------------------------------------
int __cdecl nox_xxx_wndDrawQuiteMenu_445BC0(_DWORD* a1) {
...
_DWORD* sub_445FF0() {
	...
	for (i = 9001; i <= 9006; ++i) {
		...
		if (result)
			result[26] = *getMemU32Ptr(0x5D4594, 2614256);
	}
	return result;
}
...
LPVOID __cdecl sub_446490(void* a1) {
	...
	dword_5d4594_826036 = 0;
	*getMemU32Ptr(0x5D4594, 4 * (_DWORD)a1 + 826040) = 0;
	return result;
}

//----- (004464D0) --------------------------------------------------------
LPVOID __cdecl sub_4464D0(int a1, _DWORD* a2) {
	*a2 = *getMemU32Ptr(0x5D4594, 4 * a1 + 826040);
	return *(LPVOID*)&dword_5d4594_826036;
}

//----- (004464F0) --------------------------------------------------------
int __cdecl sub_4464F0(int a1, _DWORD* a2) {
	if (!*getMemU32Ptr(0x5D4594, 4 * a1 + 826056))
		return 0;
	*a2 = *getMemU32Ptr(0x5D4594, 4 * a1 + 826048);
	return *getMemU32Ptr(0x5D4594, 4 * a1 + 826056);
}
...
void __cdecl sub_446520(int a1, const void* a2, int a3) {
	...
	if (a2) {
		if (a3 > 0) {
			v3 = calloc(a3, 1u);
			*getMemU32Ptr(0x5D4594, 4 * a1 + 826056) = v3;
			memcpy(v3, a2, a3);
			*getMemU32Ptr(0x5D4594, 4 * a1 + 826048) = a3;
			*getMemU32Ptr(0x5D4594, 4 * a1 + 826064) = 1;
		}
	}
}
...
int __cdecl sub_446580(int a1) {
	...
	result = *getMemU32Ptr(0x5D4594, 4 * a1 + 826056);
	if (result) {
		free(*(LPVOID*)getMemAt(0x5D4594, 4 * a1 + 826056));
		*getMemU32Ptr(0x5D4594, 4 * a1 + 826056) = 0;
		*getMemU32Ptr(0x5D4594, 4 * a1 + 826048) = 0;
		*getMemU32Ptr(0x5D4594, 4 * a1 + 826064) = 0;
	}
	return result;
}
...
int nox_xxx_guiMotdLoad_4465C0() {
	...
	v4 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_826028, 4204);
	v5 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_826028, 4205);
	v8 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_826028, 4206);
	*(_DWORD*)(v4[100] + 8) = 16;
	*(_DWORD*)(v4[100] + 12) = 10;
...
//----- (00446730) --------------------------------------------------------
_BYTE* __cdecl nox_xxx_motdAddSomeTextMB_446730(_BYTE* a1) {
	_BYTE* result;   // eax
...
//----- (00446940) --------------------------------------------------------
int __cdecl sub_446940(int a1) { return *getMemU32Ptr(0x5D4594, 4 * a1 + 826064); }

//----- (00446950) --------------------------------------------------------
BOOL sub_446950() { return dword_5d4594_826028 && !(nox_xxx_wndGetFlags_46ADA0(*(int*)&dword_5d4594_826028) & 0x10); }
...
wchar_t* __cdecl sub_4469D0(int a1) {
	...
	nox_swprintf((wchar_t*)getMemAt(0x5D4594, 827140), L"%s %d",
				 *getMemU32Ptr(0x587000, 8 * (a1 % *getMemU32Ptr(0x5D4594, 826092)) + 108848),
...
wchar_t* __cdecl sub_446CC0(int a1) {
	...
	if (result == (wchar_t*)7) {
		...
		result = (wchar_t*)nox_window_call_field_94(*getMemIntPtr(0x5D4594, 829496), 16385, (int)getMemAt(0x5D4594, 829224), 0);
	}
	return result;
}
...
int __cdecl sub_447CC0(int a1, unsigned int a2, int* a3, int a4) {
	...
	if (a2 == 16387) {
		if (!nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_829480, a4))
			return 0;
		return 0;
	}
	if (a2 == 23)
...
int __cdecl sub_448240(_DWORD* a1, _BYTE* a2) {
	...
	sub_4482D0((80 - v5) / 2 + v6 + 1, (int)a1, v3, *getMemIntPtr(0x5D4594, 2650656), v2);
	return 1;
}
...
int __cdecl sub_4482D0(int a1, int a2, int a3, int a4, _WORD* a5) {
	...
	do {
		nox_xxx_drawString_43FAF0(0, a5, a1 + *(_DWORD*)v5, a2 + *((_DWORD*)v5 + 1), 320, 0);
		v5 += 8;
...
//----- (00448380) --------------------------------------------------------
void sub_448380() {
	nox_xxx_windowDestroyMB_46C4E0(*(_DWORD**)&dword_5d4594_829504);
...
int sub_448450() {
	...
	if (result) {
		sub_446970_wol_chat();
		v1 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_829480, 1905);
...
int sub_448490() {
	...
	if (dword_5d4594_829480) {
		result = nox_xxx_windowDestroyMB_46C4E0(*(_DWORD**)&dword_5d4594_829480);
...
int sub_449280() {
	...
	if (result) {
		...
		*(_DWORD*)(dword_5d4594_830104 + 24) =
		...
		dword_5d4594_830192 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830104, 1991);
		dword_5d4594_830196 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830104, 1992);
		dword_5d4594_830200 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830104, 1993);
		v1 = sub_41FF60();
...
int __cdecl sub_4493D0(int a1, int a2, int* a3, int a4) {
	...
	case 1995:
		...
		nox_xxx_windowDestroyMB_46C4E0(*(_DWORD**)&dword_5d4594_830104);
		sub_447600();
...
int nox_xxx_guiServerListLoad_449530() {
	...
	if (result) {
		*(_DWORD*)(result + 56) = *getMemU32Ptr(0x5D4594, 2650656);
		...
		v3 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830108, 1961);
		v4 = sub_4200F0();
		...
		v8 = sub_4200F0();
		if (sub_4207A0(v8) <= 0) {
			v9 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830108, 1962);
			nox_xxx_wnd_46ABB0((int)v9, 0);
		} else {
			nox_window_call_field_94((int)v3, 16403, 0, 0);
		}
		v10 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830108, 1964);
		v11 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830108, 1965);
		v12 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830108, 1966);
		v13 = (_DWORD*)v3[8];
		v19 = (int)v12;
...
//----- (00449A10) --------------------------------------------------------
_DWORD* __cdecl nox_xxx_dialogMsgBoxCreate_449A10(int a1, int a2, int a3, int a4, void (*a5)(void), void (*a6)(void)) {
	int v6;         // esi
	_DWORD* result; // eax
	_DWORD* v8;     // eax
	_DWORD* v9;     // eax
	...
	if (dword_5d4594_830224) {
		...
		*getMemU32Ptr(0x5D4594, 830240) = 0;
		if (nox_xxx_guiFontHeightMB_43F320(0) > 10)
			v6 = 2;
		result = nox_new_window_from_file(*(const char**)getMemAt(0x587000, 4 * v6 + 112976), nox_xxx_windowDlgProc_449CA0);
		dword_5d4594_830224 = result;
		if (result) {
			nox_xxx_wndSetWindowProc_46B300((int)result, sub_449BE0);
			v8 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830224, 4003);
			nox_xxx_wndSetWindowProc_46B300((int)v8, sub_449C30);
			v9 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830224, 4008);
			...
			if (result)
				result = (_DWORD*)nox_xxx_wndClearCaptureMain_46ADE0((int)result);
		}
	}
	return result;
}
...
int __cdecl sub_449C30(_DWORD* a1, int a2, int a3, int a4) {
	...
	if (a2 == 21 && a3 == 28) {
		v4 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830224, 4001);
		v5 = (int)v4;
		if (v4[1] & 8) {
...
//----- (00449CA0) --------------------------------------------------------
int __cdecl nox_xxx_windowDlgProc_449CA0(int a1, int a2, int* a3, int a4) {
	int result; // eax
	int v5;     // eax
...
int __cdecl sub_449E30(int a1) {
	...
	v1 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830224, 4004);
	return nox_window_call_field_94((int)v1, 16385, a1, -1);
}
...
int __cdecl sub_449E60(char a1) {
	...
	if (a1 >= 0)
		v1 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830224, 4003);
	else
		v1 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830224, 4008);
...
int __cdecl sub_44A0B0(int a1) {
	...
	if (a1 & 1) {
		v1 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830224, 4001);
		nox_window_set_hidden((int)v1, 0);
	}
	if (a1 & 2) {
		v2 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830224, 4002);
		nox_window_set_hidden((int)v2, 0);
	}
	if (a1 & 0x100) {
		v3 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830224, 4009);
		nox_window_set_hidden((int)v3, 0);
	}
	if (a1 & 0x200) {
		v4 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830224, 4010);
		nox_window_set_hidden((int)v4, 0);
	}
	if (a1 & 8) {
		v5 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830224, 4007);
		nox_window_set_hidden((int)v5, 0);
	}
	if (a1 & 0x10) {
		v6 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830224, 4006);
		nox_window_set_hidden((int)v6, 0);
	}
	if (a1 & 4) {
		v7 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830224, 4003);
		nox_window_set_hidden((int)v7, 0);
	}
	if ((a1 & 0x80u) != 0) {
		v8 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830224, 4008);
...
//----- (0044A340) --------------------------------------------------------
int __cdecl sub_44A340(int a1, int a2) { return nox_wnd_nox_xxx_wndDraw_46A9B0(*(_DWORD**)&dword_5d4594_830224, a1, a2); }
...
int sub_44A4E0() {
	...
	if (!sub_44A4A0())
		return 0;
	v0 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830224, 4002);
...
int __cdecl sub_44AB30(int a1, unsigned int a2, int* a3, int a4) {
	...
	if (a2 != 16387)
		return 0;
	result = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_830248, a4);
	if (!result)
		return result;
		...
		*(_DWORD*)((char*)a1 + v13 + 4) = v5;
		...
		if (v3 > 0) {
			do {
				...
				*(_DWORD*)(*(_DWORD*)((char*)a1 + v13 + 4) + 4 * ++v6 - 4) = nox_xxx_readImgMB_42FAA0(v8, v16, v17);
			} while (v6 < v3);
			v4 = v14;
		}
		v4 += 4;
...
//----- (0044BA60) --------------------------------------------------------
int __cdecl nox_xxx_parse_Armor_44BA60(const char* a1) {
	int v1;          // ebp
	const char** v2; // edi
