...
//----- (0043C750) --------------------------------------------------------
int sub_43C750() { return *(_DWORD*)&byte_5D4594[815700]; }
...
//----- (0043CFD0) --------------------------------------------------------
BOOL sub_43CFD0() { return sub_552A80(*(unsigned int*)&byte_5D4594[815700], 1) != -1; }
...
int sub_43DA80() {
	...
	if (*(int*)&byte_5D4594[816368] < 6) {
		sub_43DD10(
		    (int*)&byte_5D4594[16 * (*(_DWORD*)&byte_5D4594[816368] + 6 * *(_DWORD*)&byte_5D4594[816372]) +
				       815772]);
...
void sub_43DAD0() {
	if (*(_DWORD*)&byte_5D4594[816368] > 0)
		sub_43D9E0(
		    (int4*)&byte_5D4594[16 * (--*(_DWORD*)&byte_5D4594[816368] + 6 * *(_DWORD*)&byte_5D4594[816372]) +
					815772]);
	*(_DWORD*)&byte_5D4594[816368] = 0;
}
...
//----- (0043DB20) --------------------------------------------------------
int sub_43DB20() { return *(_DWORD*)&byte_5D4594[816368]; }
...
//----- (00445730) --------------------------------------------------------
int __cdecl sub_445730(int a1) { return nox_window_set_hidden(*(int*)&byte_5D4594[825744], a1); }

//----- (00445750) --------------------------------------------------------
BOOL sub_445750() { return *(_DWORD*)&byte_5D4594[825744] && !wndIsShown_sub_46ACC0(*(int*)&byte_5D4594[825744]); }
...
//----- (00446030) --------------------------------------------------------
BOOL sub_446030() { return *(_DWORD*)&byte_5D4594[825768] != 0; }
...
//----- (00446060) --------------------------------------------------------
void sub_446060() { *(_DWORD*)&byte_5D4594[825768] = 0; }
...
//----- (00446090) --------------------------------------------------------
BOOL sub_446090() { return *(_DWORD*)&byte_5D4594[825752] == 0; }
...
//----- (00446950) --------------------------------------------------------
BOOL sub_446950() { return *(_DWORD*)&byte_5D4594[826028] && !(sub_46ADA0(*(int*)&byte_5D4594[826028]) & 0x10); }
...
//----- (00446C70) --------------------------------------------------------
int sub_446C70() { return nox_window_call_field_94(*(int*)&byte_5D4594[829488], 16404, 0, 0); }

//----- (00446C90) --------------------------------------------------------
BOOL sub_446C90() { return *(int*)nox_window_call_field_94(*(int*)&byte_5D4594[829488], 16404, 0, 0) != -1; }
			...
			if (*(_DWORD*)&byte_5D4594[829544]) {
				if (a2) {
					...
					result = (const wchar_t*)nox_window_call_field_94(
					    *(int*)&byte_5D4594[829492], 16397, (int)&byte_5D4594[827176],
					    (a3 != 0) + 6);
				}
			}
		}
			...
			if (*(_DWORD*)&byte_5D4594[829556]) {
				...
				if (*(_DWORD*)&byte_5D4594[829560]) {
					if (a2) {
						...
						nox_swprintf((wchar_t*)&byte_5D4594[827176], result, a1, a2);
						result = (const wchar_t*)nox_window_call_field_94(
						    *(int*)&byte_5D4594[829492], 16397, (int)&byte_5D4594[827176], 13);
					}
				}
			}
		}
	...
	if (*(_DWORD*)&byte_5D4594[829492]) {
		if (*(_DWORD*)&byte_5D4594[829536]) {
			...
			if (a2) {
				...
				result = nox_window_call_field_94(*(int*)&byte_5D4594[829492], 16397,
			...
			if (*(_DWORD*)&byte_5D4594[829544]) {
				if (a2) {
					...
					if (a1)
						...
						nox_swprintf((wchar_t*)&byte_5D4594[827176], L"%S", a2);
					nox_window_call_field_94(*(int*)&byte_5D4594[829492], 16397,
...
//----- (004475E0) --------------------------------------------------------
int sub_4475E0() { return nox_window_call_field_94(*(int*)&byte_5D4594[829488], 16399, 0, 0); }
	...
	if (a2 > 0x4006) {
		...
		case 0x4007u:
			...
			case 1913:
				...
				nox_window_call_field_94(*(int*)&byte_5D4594[829500], 16414, (int)&byte_5D4594[829580],
							 0);
				break;
			case 1914:
				sub_449530();
...
//----- (00448550) --------------------------------------------------------
int __cdecl sub_448550(int a1) { return nox_window_call_field_94(*(int*)&byte_5D4594[829484], 16398, a1, 0); }
	...
	*(_DWORD*)&byte_5D4594[830104] = result;
	if (result) {
		...
		*(_DWORD*)(*(_DWORD*)&byte_5D4594[830104] + 16) =
		    (nox_win_width - *(_DWORD*)(*(_DWORD*)&byte_5D4594[830104] + 8)) / 2;
		*(_DWORD*)(*(_DWORD*)&byte_5D4594[830104] + 24) =
		    *(_DWORD*)(*(_DWORD*)&byte_5D4594[830104] + 8) + *(_DWORD*)(*(_DWORD*)&byte_5D4594[830104] + 16);
	...
	if (*(_DWORD*)&byte_5D4594[830224]) {
		...
		*(_DWORD*)&byte_5D4594[830224] = result;
		if (result) {
			...
			sub_46A9B0(*(_DWORD**)&byte_5D4594[830224],
...
void __cdecl sub_449EA0(int a1) {
	...
	if (a1 & 0x40)
		sub_430A70_set_mouse_bounds(
		    *(_DWORD*)(*(_DWORD*)&byte_5D4594[830224] + 16), *(_DWORD*)(*(_DWORD*)&byte_5D4594[830224] + 24),
		    *(_DWORD*)(*(_DWORD*)&byte_5D4594[830224] + 20), *(_DWORD*)(*(_DWORD*)&byte_5D4594[830224] + 28));
	else
		sub_430A70_set_mouse_bounds(0, nox_win_width - 1, 0, nox_win_height - 1);
...
int __cdecl sub_44A0B0(int a1) {
	...
	if (a1 & 0x40)
		sub_430A70_set_mouse_bounds(
		    *(_DWORD*)(*(_DWORD*)&byte_5D4594[830224] + 16), *(_DWORD*)(*(_DWORD*)&byte_5D4594[830224] + 20),
		    *(_DWORD*)(*(_DWORD*)&byte_5D4594[830224] + 24), *(_DWORD*)(*(_DWORD*)&byte_5D4594[830224] + 28));
	else
		sub_430A70_set_mouse_bounds(0, nox_win_width - 1, 0, nox_win_height - 1);
...
//----- (0044A340) --------------------------------------------------------
int __cdecl sub_44A340(int a1, int a2) { return sub_46A9B0(*(_DWORD**)&byte_5D4594[830224], a1, a2); }
...
//----- (0044A4A0) --------------------------------------------------------
BOOL sub_44A4A0() { return *(_DWORD*)&byte_5D4594[830224] != 0; }
...
int __cdecl sub_44AB30(int a1, unsigned int a2, int* a3, int a4) {
	...
	if (a2 > 0x4005) {
			...
			if (a2 == 16400) {
				...
				if (v6 == 1708 && a4 >= 0 && a4 < 128) {
					...
					if (v18) {
						...
						nox_window_call_field_94(*(int*)&byte_5D4594[830256], 16414, (int)File,
									 0);
					}
					if (v17) {
						nox_swprintf(File, L"%S", v17);
						nox_window_call_field_94(*(int*)&byte_5D4594[830260], 16414, (int)File,
									 0);
						if (v17) {
							if (*v17) {
		...
		*(_DWORD*)&byte_5D4594[830276] =
		    (unsigned __int8)(*(_BYTE*)(*(_DWORD*)&byte_5D4594[830252] + 36) & 4) >> 2;
		sub_41E300(2);
		v15 = sub_41E2F0();
		sub_41DA70(v15, 0);
		sub_4207F0(2);
