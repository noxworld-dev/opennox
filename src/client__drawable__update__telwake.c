...
int  nox_xxx_updDrawTeleportWake_4CD8D0(int a1, int a2) {
	...
	v2 = *(uint32_t*)(a2 + 12) + nox_common_randomIntMinMax_415FF0(-5, 5, "C:\\NoxPost\\src\\client\\Drawable\\Update\\telwake.c", 32);
	...
	if (v4) {
		...
		*(uint8_t*)(v4 + 299) = nox_common_randomIntMinMax_415FF0(0, 255, "C:\\NoxPost\\src\\client\\Drawable\\Update\\telwake.c", 43);
		*(uint32_t*)(v5 + 440) = nox_common_randomIntMinMax_415FF0(1, 100, "C:\\NoxPost\\src\\client\\Drawable\\Update\\telwake.c", 46);
		...
		*(uint16_t*)(v5 + 104) = 0;
		*(uint8_t*)(v5 + 296) = nox_common_randomIntMinMax_415FF0(3, 8, "C:\\NoxPost\\src\\client\\Drawable\\Update\\telwake.c", 55);
