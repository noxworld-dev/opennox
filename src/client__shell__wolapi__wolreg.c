	...
	if (*a1) {
		if ((unsigned char)v14 < 0x31u || (unsigned char)v14 > 0x39u) {
			if (strlen(a2) == 8) {
				...
				v23 = nox_strman_loadString_40F1D0("TryAgain", 0,
			...
			v22 = nox_strman_loadString_40F1D0("TryAgain", 0,
		...
		v21 = nox_strman_loadString_40F1D0("TryAgain", 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolreg.c",
									142);
		v15 = nox_strman_loadString_40F1D0("ErrNoNick", 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolreg.c",
									141);
		...
		if (getMemByte(0x5D4594, 1064196)) {
			...
			*a3 = nox_wcstol(v9, 0, 10);
			if ((int)*a1 < 1 || (int)*a1 > 12 || (int)*a2 < 1 || (int)*a2 > 31) {
				v17 = nox_strman_loadString_40F1D0("TryAgain", 0,
											"C:\\NoxPost\\src\\client\\shell\\WolApi\\wolreg.c", 228);
				v14 = nox_strman_loadString_40F1D0("ErrAge", 0,
			...
			v16 = nox_strman_loadString_40F1D0("TryAgain", 0,
										"C:\\NoxPost\\src\\client\\shell\\WolApi\\wolreg.c", 216);
			v12 = nox_strman_loadString_40F1D0("ErrEmail", 0,
										"C:\\NoxPost\\src\\client\\shell\\WolApi\\wolreg.c", 215);
			nox_swprintf(a4, L"%s %s", v12, v16);
			result = 0;
		}
	} else {
		v18 = nox_strman_loadString_40F1D0("TryAgain", 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolreg.c",
									209);
		v15 = nox_strman_loadString_40F1D0("ErrAge", 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolreg.c",
									208);
...
int sub_468F30_wol_reg() {
	...
	v0 =
		nox_strman_loadString_40F1D0("Wolreg.c:ErrNoConsent", 0, "C:\\NoxPost\\src\\client\\shell\\WolApi\\wolreg.c", 472);
	sub_468840(v0);
