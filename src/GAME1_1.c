		...
		if (!result) {
			if (a1) {
				...
				if (*(int*)(a1 + 4648) == -1) {
					...
					*getMemU8Ptr( 0x5D4594, v5 + 600144) = *(_BYTE*)(a1 + 2251);
					*(_DWORD*)(a1 + 4648) = v13;
				} else {
					v13 = *(_DWORD*)(a1 + 4648);
				}
				if (v3) {
					if (*(int*)(v3 + 4648) == -1) {
						...
						*getMemU8Ptr( 0x5D4594, v10 + 600144) = *(_BYTE*)(v3 + 2251);
						*(_DWORD*)(v3 + 4648) = v8;
					} else {
						v12 = *(_DWORD*)(v3 + 4648);
					}
...
int __cdecl sub_425E90(int a1, char a2) {
	...
	if (result) {
		...
		if (!result) {
			...
			if (result != -1) {
				result *= 32;
				*getMemU8Ptr( 0x5D4594, result + 600145) = a2;
			}
		}
	}
	return result;
...
int __cdecl sub_425ED0(int a1, char a2) {
	...
	if (result) {
		...
		if (!result) {
			...
			if (result != -1) {
				result *= 32;
				*getMemU8Ptr( 0x5D4594, result + 600152) = a2;
			}
		}
	}
	return result;
		...
		if (!result) {
			...
			if (a1) {
				...
				if (result == -1) {
					...
					if (*(_BYTE*)(v2 + 2064) == 31) {
						...
						*getMemU32Ptr(0x5D4594, v6 + 600136) = htonl(v8);
						if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_DISABLE_GRAPHICS_RENDERING)) {
							*getMemU8Ptr( 0x5D4594, v6 + 600152) = 0;
							goto LABEL_18;
						}
						v9 = *(_DWORD*)(v2 + 3680);
						if (v9 & 1 && !(v9 & 0x20)) {
					...
					*getMemU8Ptr( 0x5D4594, v6 + 600152) = 1;
				LABEL_18:
					*getMemU32Ptr(0x5D4594, v6 + 600140) = *(_DWORD*)(v2 + 2068);
					*getMemU8Ptr( 0x5D4594, v6 + 600144) = *(_BYTE*)(v2 + 2251);
					*getMemU32Ptr(0x5D4594, v6 + 600148) = time(0);
					result = v12;
					*getMemU8Ptr( 0x5D4594, v6 + 600145) = 1;
					*(_DWORD*)(v2 + 4648) = v12;
					return result;
				}
			}
