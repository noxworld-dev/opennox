	...
	for (i = sub_425A50(); i; i = sub_425A60(i)) {
		...
		if (v5) {
			...
			for (j = nox_xxx_getFirstPlayerUnit_4DA7C0(); j; j = nox_xxx_getNextPlayerUnit_4DA7F0(j)) {
				...
				if (v7[515] != *getMemU32Ptr(0x85319C, 0) ||
...
int sub_41C080(int a1) {
	...
	*(uint8_t*)((unsigned short)v4 + v2 + 4760) = 0;
	if ((short)a1 < 2 || (*getMemU32Ptr(0x973F18, 3872) ? (result = sub_500B70()) : (result = sub_500A60()), result)) {
		...
		do {
			...
			case 2:
				...
				if (v3) {
					...
					v0 = sub_40DC90(v3 + 16, v3 + 370, v3 + 403, (int)getMemAt(0x5D4594, 527996),
									(int)getMemAt(0x5D4594, 527732), (int)getMemAt(0x587000, 58684));
					sub_41E300(4);
				} else {
					sub_41E300(5);
					sub_40DC70();
...
void* nox_xxx_spellGetAbilityIcon_425310(int a1, int a2) {
	return *getMemU32Ptr(0x5D4594, 599140 + 4 * (a1 + a2 + 12 * a1));
}
