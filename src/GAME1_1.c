			...
			for (j = nox_xxx_getFirstPlayerUnit_4DA7C0(); j; j = nox_xxx_getNextPlayerUnit_4DA7F0(j)) {
				...
				if (v7[515] != *getMemU32Ptr(0x8529A0, 2044) || !nox_common_getEngineFlag(NOX_ENGINE_FLAG_DISABLE_GRAPHICS_RENDERING)) {
					...
					if (!(v8 & 1) || v8 & 0x20) {
						...
						if (v9) {
							if (v9 == i[8])
								nox_xxx_createAtImpl_4191D0(*(_BYTE*)(i[9] + 57), j + 48, 1, *(_DWORD*)(j + 36), 0);
						}
					}
				}
			}
...
char* sub_418A10() {
	...
	while (*((_DWORD*)result + 15)) {
		result = nox_xxx_TeamNext_418B60((int)result);
		if (!result)
			return nox_xxx_teamCreate_4186D0(0);
	}
	return result;
...
int  sub_418BC0(int a1) {
	...
	for (i = nox_common_playerInfoGetFirst_416EA0(); i; i = nox_common_playerInfoGetNext_416EE0((int)i)) {
		v4 = nox_xxx_objGetTeamByNetCode_418C80(*((_DWORD*)i + 515));
		if (v4) {
			if (nox_xxx_teamCompare2_419180((int)v4, *(_BYTE*)(a1 + 57)))
				++v1;
		}
	}
	return v1;
...
void  sub_418D80(int a1) {
	...
	if (a1 && sub_418BC0(a1) > 0) {
		...
		for (i = nox_common_playerInfoGetFirst_416EA0(); i; i = nox_common_playerInfoGetNext_416EE0((int)i)) {
			v3 = nox_xxx_objGetTeamByNetCode_418C80(*((_DWORD*)i + 515));
			v4 = (int)v3;
			if (v3) {
	...
	if (a1 && a2) {
		if (*(_DWORD*)(a1 + 44) == a2) {
			*(_DWORD*)(a1 + 44) = *(_DWORD*)a2;
			...
			result = (_DWORD*)nox_xxx_teamCheckSmth_418C60(a1);
			if (!result)
				return result;
			while (*result != a2) {
		...
		*(_BYTE*)(a2 + 4) = 0;
		...
		if (result) {
			while (v3 + 12 != (_DWORD*)a2) {
				result = (_DWORD*)nox_xxx_getNextPlayerUnit_4DA7F0((int)v3);
				v3 = result;
				if (!result)
					return result;
			}
...
void  sub_418F20(wchar_t* a1, int a2) {
	...
	if (a1 && nox_xxx_clientGetTeamColor_418AB0(*((unsigned __int8*)a1 + 57))) {
		nox_wcscpy(v6, a1);
...
int  sub_419030(int a1) {
	...
	if (a1) {
		LOWORD(a1) = 1988;
		sub_456FA0();
		result = nox_xxx_netSendPacket1_4E5390(159, (int)&a1, 2, 0, 1);
	}
	return result;
}
...
int  nox_xxx_teamCompare2_419180(int a1, unsigned __int8 a2) {
	...
	if (!v2)
		return 0;
	v3 = (_DWORD*)nox_xxx_teamCheckSmth_418C60((int)v2);
	if (!v3)
		return 0;
	while (v3 != (_DWORD*)a1) {
		v3 = sub_418C70(v3);
...
void  nox_xxx_netChangeTeamMb_419570(int a1, int a2) {
	...
	if (a1) {
		v2 = nox_xxx_clientGetTeamColor_418AB0(*(unsigned __int8*)(a1 + 4));
		if (v2) {
...
int  sub_4196D0(int a1, int a2, int a3, int a4) {
	...
	if (!a1 || !a2 || !nox_xxx_teamCompare2_419180(a1, *(_BYTE*)(a1 + 4)))
		return 0;
	...
	v5 = nox_xxx_clientGetTeamColor_418AB0(*(unsigned __int8*)(a1 + 4));
	--*((_DWORD*)v5 + 12);
...
int  sub_4199C0(int a1) {
	...
	if (!v1)
		return 0;
	while (*(_BYTE*)(v1 + 52) != *(_BYTE*)(a1 + 57) || !nox_xxx_unitIsCrown_4E7BE0(v1)) {
...
//----- (00419A90) --------------------------------------------------------
__int16  nox_float2int16(float a1) { return (int)a1; }

//----- (00419AB0) --------------------------------------------------------
__int16  nox_float2int16_abs(float a1) { return (int)fabs(a1); }

//----- (00419AD0) --------------------------------------------------------
char  nox_float2int8(float a1) { return (int)a1; }
...
int nox_xxx_parseGamedataBin_419B30() {
	...
	if (result) {
		result = nox_binfile_open_408CC0("gamedata.bin", 0);
		v1 = (FILE*)result;
		if (result) {
			result = nox_binfile_cryptSet_408D40(result, 8);
			if (result) {
				while (1) {
					if (!nox_xxx_parseString_409470(v1, v8)) {
					LABEL_25:
					...
					if (_strcmpi("SOLO", v8)) {
						if (_strcmpi("ARENA", v8)) {
						LABEL_15:
							if (nox_xxx_parseString_409470(v1, v9) == -1)
								goto LABEL_25;
							nox_xxx_parseRead_4093E0(v1, v11, 1024);
							v2 = 0;
							v3 = strtok(v11, " ,\r\n\t");
							if (v3) {
								v4 = v10;
...
//----- (00419EE0) --------------------------------------------------------
BOOL  sub_419EE0(char a1) { return (*getMemU32Ptr(0x5D4594, 527716) & (1 << a1)) != 0; }
...
int  sub_419F10(const char* a1, const char* a2) {
	...
	v4 = nox_fs_root();
	nox_sprintf((char*)getMemAt(0x8529A0, 46404), "%s\\Save\\%s", v4, v6);
	strcpy((char*)getMemAt(0x8529A0, 47428), a2);
	GetLocalTime((LPSYSTEMTIME)getMemAt(0x8529A0, 47588));
	result = nox_common_gameFlags_check_40A5C0(0x2000);
	if (result) {
		result = *getMemU32Ptr(0x8529A0, 46400);
		LOBYTE(result) = getMemByte(0x8529A0, 46400) & 0xFE | 2;
		*getMemU32Ptr(0x8529A0, 46400) = result;
	} else {
		*getMemU32Ptr(0x8529A0, 46400) = *getMemU32Ptr(0x8529A0, 46400) & 0xFFFFFFFD | 1;
	}
	return result;
}
...
int  sub_41A000(char* a1, nox_savegame_xxx* sv) {
	...
	while (1) {
		...
		if (v10 == 1) {
			memcpy(v12, getMemAt(0x8529A0, 46400), sizeof(v12));
			v3 = 0;
			v13 = *getMemU16Ptr(0x8529A0, 47676);
			if (*getMemU32Ptr(0x587000, 55936)) {
				...
				if (!(*(int(**)(_DWORD)) getMemAt(0x587000, 55956))(0)) {
					nox_xxx_cryptClose_4269F0();
					return 0;
				}
			}
			LABEL_10:
			memcpy(sv, getMemAt(0x8529A0, 46400), sizeof(nox_savegame_xxx));
			memcpy(getMemAt(0x8529A0, 46400), v12, 0x4FCu);
			*getMemU16Ptr(0x8529A0, 47676) = v13;
		} else {
			sub_426AA0(v11);
		}
	}
...
int  nox_xxx_mapSavePlayerDataMB_41A230(char* a1) {
	...
	v1 = a1;
	result = nox_xxx_cryptOpen_426910(a1, 2, 27);
	if (result) {
		if (sub_45D9B0())
			sub_45D870();
		if ((char*)getMemAt(0x8529A0, 46404) != v1) { // FIXME: strcpy overlap
			strcpy((char*)getMemAt(0x8529A0, 46404), v1);
		}
		if (*getMemU32Ptr(0x587000, 55936)) {
...
int  nox_xxx_plrLoad_41A480(char* a1) {
	...
	if (result) {
		...
		nox_xxx_cryptClose_4269F0();
		result = 1;
		strcpy((char*)getMemAt(0x8529A0, 46404), v7);
	}
	return result;
}
		...
		if (v4) {
			if (*(_BYTE*)(v4 + 2064) != 31) {
				if (nox_common_gameFlags_check_40A5C0(4096)) {
					if (v13 != 4) {
						nox_xxx_playerCallDisconnect_4DEAB0(*(unsigned __int8*)(v4 + 2064), 1);
						return 0;
					}
				} else if (v13 != 4) {
					goto LABEL_20;
...
LABEL_20:
	...
	if ((unsigned __int8)v14 >= 0x19u)
		return 0;
	nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)v2, 2 * (unsigned __int8)v14);
	*(_WORD*)(v2 + 2 * (unsigned __int8)v14) = 0;
	if (v3)
		nox_wcscpy((wchar_t*)(*(_DWORD*)(v3 + 276) + 4704), (const wchar_t*)v2);
	if (*getMemU32Ptr(0x8529A0, 1189016) == 1 && v3) {
		v6 = nox_wcslen((const wchar_t*)v2);
		v7 = nox_xxx_protectionStringCRCLen_56FAE0((int*)v2, 2 * v6);
		nox_xxx_playerUpdateNetBuffs_56F7D0(*(_DWORD*)(*(_DWORD*)(v3 + 276) + 4628), v7);
	}
	nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 50), 4u);
	nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 54), 4u);
	if (*getMemU32Ptr(0x8529A0, 1189016) == 1 && v3) {
		sub_56F780(*(_DWORD*)(*(_DWORD*)(v3 + 276) + 4624), *(_DWORD*)(v2 + 54));
		sub_56F780(*(_DWORD*)(*(_DWORD*)(v3 + 276) + 4620), *(_DWORD*)(v2 + 50));
	}
	nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 58), 4u);
	nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 62), 4u);
	nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 66), 1u);
	if (*getMemU32Ptr(0x8529A0, 1189016) == 1 && v3)
		sub_56F820(*(_DWORD*)(*(_DWORD*)(v3 + 276) + 4616), *(_BYTE*)(v2 + 66));
	nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 67), 1u);
	nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 68), 3u);
	nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 71), 3u);
	nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 74), 3u);
	nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 77), 3u);
	nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 80), 3u);
	if ((__int16)a2 >= 2) {
		nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 83), 1u);
		nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 84), 1u);
		nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 85), 1u);
		nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 86), 1u);
		nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 87), 1u);
	}
	v8 = a1;
	...
	nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 88), 1u);
	if ((__int16)a2 >= 3) {
		v13 = 0;
		if (v3)
			v13 = *(_DWORD*)(v3 + 320);
	...
	if ((__int16)a2 >= 4) {
		...
		nox_xxx_fileReadWrite_426AC0_file3_fread(&a1, 4u);
		if (*getMemU32Ptr(0x8529A0, 1189016) == 1) {
			if (!v11 || (*(_DWORD*)(v11 + 4696) = a1, *getMemU32Ptr(0x8529A0, 1189016) == 1)) {
				if (v3)
	...
	if (result) {
		...
		if ((_BYTE)a1) {
			...
			*getMemU32Ptr(0x5D4594, 527700) = *(unsigned __int16*)(v2 + 4);
			...
			if (*getMemU32Ptr(0x8529A0, 1189016) == 1)
				nox_xxx_setSomePoisonData_4EEA90(v1, (unsigned __int8)v8);
			nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v1 + 541), 1u);
			nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v1 + 542), 2u);
			nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v1 + 28), 4u);
			if (*getMemU32Ptr(0x8529A0, 1189016) == 1) {
				sub_56F8C0(*(_DWORD*)(*(_DWORD*)(v2 + 276) + 4604), *(float*)(v1 + 28));
				sub_4D81A0(v1);
			}
			if ((__int16)v7 >= 2) {
				nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v1 + 124), 2u);
				if (*getMemU32Ptr(0x8529A0, 1189016) == 1)
...
BOOL  sub_41AC30(_DWORD* a1) {
	...
	if (*getMemU32Ptr(0x8529A0, 1189016)) {
		...
		if (k > 0) {
			do {
				...
				if (!v24)
					return 0;
				if (!((int(*)(_DWORD*, _DWORD))v24[176])(v24, 0))
					return 0;
				v25[14] = 1161297920;
				v25[15] = 1161297920;
				if (nox_common_gameFlags_check_40A5C0(4096)) {
		...
		if (v37) {
			...
			if (v29) {
				...
				nox_xxx_netSendSecondaryWeapon_4D9670(*(unsigned __int8*)(*(_DWORD*)(v40 + 276) + 2064), v29, 0);
			}
		}
	LABEL_99:
		if ((__int16)v42 >= 2) {
			...
			if (v37) {
				...
				if (v30) {
					...
					nox_xxx_netMsgLastQuiver_4D96B0(*(unsigned __int8*)(*(_DWORD*)(v40 + 276) + 2064), v30);
				}
			}
		}
	LABEL_106:
		...
		if (v15) {
			while (1) {
				if (!nox_common_gameFlags_check_40A5C0(4096) || sub_41B3E0(v15)) {
					...
					v16 = (_BYTE*)nox_xxx_getUnitName_4E39D0(v15);
					nox_xxx_fileReadWrite_426AC0_file3_fread(v16, v34);
					if (!(*(int(**)(int, _DWORD))(v15 + 704))(v15, 0))
						return 0;
				}
				v15 = *(_DWORD*)(v15 + 496);
				if (!v15)
				...
				if (v8) {
					...
					if (v8 > 0) {
						...
						while (1) {
							...
							v14 = (_BYTE*)nox_xxx_getUnitName_4E39D0(v13);
							nox_xxx_fileReadWrite_426AC0_file3_fread(v14, v33);
							if (!(*(int(**)(int, _DWORD))(v13 + 704))(v13, 0))
								return 0;
							++v10;
							++v11;
							if (v10 >= v45) {
	...
	for (m = v1[126]; m; m = *(_DWORD*)(m + 496)) {
		if (*(_DWORD*)(m + 16) & 0x100)
			nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(m + 44), 4u);
	}
	v19 = sub_4678B0();
	v37 = v19;
	if (!v19) {
...
LABEL_109:
	...
	if ((__int16)v42 < 3)
		*(_BYTE*)(v40 + 244) = 0;
		...
		nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v40 + 244), 1u);
	if (*getMemU32Ptr(0x8529A0, 1189016) == 1 && nox_common_gameFlags_check_40A5C0(4096))
		*v32 = 0;
LABEL_115:
	if (nox_common_gameFlags_check_40A5C0(4096) && !sub_4F2C30((int)v1))
		return 0;
	nox_xxx_netMsgInventoryLoaded_4D96E0(*(unsigned __int8*)(*(_DWORD*)(v40 + 276) + 2064));
	return 1;
}
		...
		if ((unsigned __int8)v13 > 0u) {
			while (1) {
				...
				if ((int)(unsigned __int8)v14 >= 256)
					break;
				nox_xxx_fileReadWrite_426AC0_file3_fread(v16, (unsigned __int8)v14);
		...
		if ((_BYTE)v20) {
			while (1) {
				...
				if ((int)(unsigned __int8)v21 >= 256)
					break;
				nox_xxx_fileReadWrite_426AC0_file3_fread(v24, (unsigned __int8)v21);
				v12 = (__int16)v22 < 2;
				v23 = 3;
...
BOOL  nox_xxx_guiEnchantment_41B9C0(_DWORD* a1) {
	...
	if ((__int16)v18 > 5)
		return 0;
	if (*getMemU32Ptr(0x8529A0, 1189016) == 1 && nox_common_gameFlags_check_40A5C0(2048)) {
	...
	if (v16) {
		...
		if (*getMemU32Ptr(0x8529A0, 1189016)) {
			...
			if ((_BYTE)v22) {
				do {
					nox_xxx_fileReadWrite_426AC0_file3_fread(&v20, 1u);
					nox_xxx_fileReadWrite_426AC0_file3_fread(v27, (unsigned __int8)v20);
			...
			for (i = sub_424D00(); i != -1; i = sub_424D20(i)) {
				if (nox_xxx_testUnitBuffs_4FF350((int)a1, i)) {
					...
					nox_xxx_fileReadWrite_426AC0_file3_fread(&v20, 1u);
					nox_xxx_fileReadWrite_426AC0_file3_fread(v3, (unsigned __int8)v20);
					nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)a1 + 2 * i + 344, 2u);
		...
		if ((__int16)v18 >= 5 && !*(_BYTE*)(*(_DWORD*)(v19 + 276) + 2251)) {
			...
			nox_xxx_fileReadWrite_426AC0_file3_fread(&v14, 1u);
			if (*getMemU32Ptr(0x8529A0, 1189016) == 1 && v14 == 1)
				sub_4FC670(1);
			...
			nox_xxx_fileReadWrite_426AC0_file3_fread(&v23, 4u);
			if (*getMemU32Ptr(0x8529A0, 1189016) == 1 && v15 == 1) {
...
BOOL  sub_41BEC0(int a1) {
	...
	if (*getMemU32Ptr(0x8529A0, 1189016) != 1) {
		if ((unsigned __int16)v8 > 0u) {
			...
			for (; v6; v6 = *(_DWORD*)(v6 + 68)) {
				...
				nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)v6, (unsigned __int8)v9);
				nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v6 + 72), 2u);
			}
		}
		return 1;
	}
	...
	do {
		nox_xxx_fileReadWrite_426AC0_file3_fread(&v9, 1u);
		nox_xxx_fileReadWrite_426AC0_file3_fread(v12, (unsigned __int8)v9);
...
int  sub_41C080(int a1) {
	...
	nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 4760), 2 * (unsigned __int16)v4);
	*(_BYTE*)((unsigned __int16)v4 + v2 + 4760) = 0;
	if ((__int16)a1 < 2 ||
		(*getMemU32Ptr(0x8529A0, 1189016) ? (result = sub_500B70()) : (result = sub_500A60()), result)) {
...
int  sub_41C280(void* a1) {
	...
	if (result) {
		if ((__int16)v4 >= 2) {
			...
			nox_xxx_fileReadWrite_426AC0_file3_fread(&a1, 1u);
			if (*getMemU32Ptr(0x8529A0, 1189016) == 1)
				nox_xxx_clientUpdateButtonRow_45E110((unsigned __int8)a1);
...
int nox_xxx_parseFileInfoData_41C3B0(int a1) {
	...
	if ((__int16)v5 > 12)
		return 0;
	if (nox_common_gameFlags_check_40A5C0(0x2000)) {
		*getMemU32Ptr(0x8529A0, 46400) &= 0xFFFFFFFE;
		if (nox_common_gameFlags_check_40A5C0(4096) || sub_4D6F50() || sub_4D6F70()) {
			v2 = *getMemU32Ptr(0x8529A0, 46400);
			LOBYTE(v2) = getMemByte(0x8529A0, 46400) | 4;
			*getMemU32Ptr(0x8529A0, 46400) = v2;
		} else {
			v1 = *getMemU32Ptr(0x8529A0, 46400);
			LOBYTE(v1) = getMemByte(0x8529A0, 46400) | 2;
			*getMemU32Ptr(0x8529A0, 46400) = v1;
		}
	} else {
		*getMemU32Ptr(0x8529A0, 46400) = *getMemU32Ptr(0x8529A0, 46400) & 0xFFFFFFF9 | 1;
	}
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 46400), 4u);
	if (*getMemU32Ptr(0x8529A0, 1189016)) {
		nox_xxx_fileReadWrite_426AC0_file3_fread(&v4, 2u);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 46404), (__int16)v4);
		*getMemU8Ptr(0x8529A0, 46404 + (__int16)v4) = 0;
		nox_xxx_fileReadWrite_426AC0_file3_fread(&v3, 1u);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47428), (unsigned __int8)v3);
		*getMemU8Ptr(0x8529A0, 47428 + (unsigned __int8)v3) = 0;
	} else {
		v4 = strlen((const char*)getMemAt(0x8529A0, 46404));
		nox_xxx_fileReadWrite_426AC0_file3_fread(&v4, 2u);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 46404), (__int16)v4);
		LOBYTE(v3) = strlen((const char*)getMemAt(0x8529A0, 47428));
		nox_xxx_fileReadWrite_426AC0_file3_fread(&v3, 1u);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47428), (unsigned __int8)v3);
	}
	GetLocalTime((LPSYSTEMTIME)getMemAt(0x8529A0, 47588));
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47588), 2u);
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47590), 2u);
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47592), 2u);
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47594), 2u);
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47596), 2u);
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47598), 2u);
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47600), 2u);
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47602), 2u);
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47607), 3u);
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47604), 3u);
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47610), 3u);
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47613), 3u);
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47616), 3u);
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47619), 1u);
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47620), 1u);
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47621), 1u);
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47622), 1u);
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47623), 1u);
	if (*getMemU32Ptr(0x8529A0, 1189016)) {
		nox_xxx_fileReadWrite_426AC0_file3_fread(&v3, 1u);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47624), 2 * (unsigned __int8)v3);
		*getMemU16Ptr(0x8529A0, 47624 + 2 * (unsigned __int8)v3) = 0;
	} else {
		LOBYTE(v3) = nox_wcslen((const wchar_t*)getMemAt(0x8529A0, 47624));
		nox_xxx_fileReadWrite_426AC0_file3_fread(&v3, 1u);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47624), 2 * (unsigned __int8)v3);
	}
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47674), 1u);
	*getMemU8Ptr(0x8529A0, 47675) = 0;
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47675), 1u);
	if (!*getMemU32Ptr(0x8529A0, 1189016))
		*getMemU8Ptr(0x8529A0, 47676) = sub_467590();
	nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47676), 1u);
	if ((__int16)v5 >= 11) {
		strcpy((char*)getMemAt(0x8529A0, 47556), nox_xxx_mapGetMapName_409B40());
		LOBYTE(v3) = strlen((const char*)getMemAt(0x8529A0, 47556));
		nox_xxx_fileReadWrite_426AC0_file3_fread(&v3, 1u);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47556), (unsigned __int8)v3);
		*getMemU8Ptr(0x8529A0, 47556 + (unsigned __int8)v3) = 0;
	}
	if ((__int16)v5 < 12)
		*getMemU8Ptr(0x8529A0, 47677) = 0;
	else
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8529A0, 47677), 1u);
	return 1;
}
...
int sub_41C780(int a1) {
	...
	if ((__int16)v5 > 11)
		return 0;
	if ((__int16)v5 < 11 || (v3 = !nox_common_gameFlags_check_40A5C0(0x2000), nox_xxx_fileReadWrite_426AC0_file3_fread(&v3, 1u), v3)) {
		if (*getMemU32Ptr(0x8529A0, 1189016)) {
			v6.field_0 = 0;
			v6.field_4 = 0;
			v6.field_8 = 0;
		...
		if (*getMemU32Ptr(0x8529A0, 1189016) == 1 && !nox_common_gameFlags_check_40A5C0(0x2000)) {
			sub_43D9E0(&v6);
			sub_43DB30(v4);
		}
	}
...
int  nox_xxx_unused_41CE30(char* a1, wchar_t* a2) {
	...
	v5 = (*(int(**)(int, int)) getMemAt(0x587000, 55824 + 12 * v2))(0, (int)a2);
	nox_xxx_cryptClose_4269F0();
	return v5;
}
...
int  sub_41CEE0(int a1, int a2) {
	...
	memcpy(getMemAt(0x8529A0, 46400), (const void*)a1, sizeof(nox_savegame_xxx));
	result = nox_xxx_cryptOpen_426910((char*)getMemAt(0x8529A0, 46404), 0, 27);
	if (result) {
		v3 = a2;
		if (!a2)
			a1 = 1;
...
int  sub_41D090(char* a1) {
	...
	if (result) {
		while (1) {
			...
			if (!a1)
				break;
			nox_xxx_fileCryptReadCrcMB_426C20(&v3, 4u);
			if (a1 == (char*)10) {
				sub_41D110(&v2);
				break;
			}
...
void sub_41D5E0() {
	...
	result = (unsigned __int8*)nox_common_playerInfoFromNum_417090(31);
	v1 = result;
	if (result) {
		result = *(unsigned __int8**)&dword_5d4594_2660032;
		if (dword_5d4594_2660032) {
			*((_DWORD*)v1 + 517) = dword_5d4594_2660032;
			nox_swprintf((wchar_t*)v1 + 1036, L"%S", getMemAt(0x8529A0, 45815));
...
int  sub_41DA10(int a1) {
	...
	v1 = *(_WORD**)getMemAt(0x587000, 58132 + 16 * a1);
	if (v1) {
		result = 0;
		memset(v1, 0, 0x2Cu);
		v1[22] = 0;
...
int sub_41DB90() {
	...
	v0 = 1;
	v1 = *getMemU32Ptr(0x587000, 58136 + 16 * sub_41E2F0());
	if (v1) {
		v5 = v1;
		do {
			v2 = sub_41E2F0();
...
int  sub_41DCC0(int a1) {
	...
	v1 = *(unsigned __int16**)getMemAt(0x587000, 58132 + 16 * a1);
	if (!v1)
		return a1;
	v2 = *getMemU32Ptr(0x587000, 58136 + 16 * a1);
	if (v2 <= 0)
		return a1;
	v3 = v2 - 1;
	v4 = *v1;
	*getMemU32Ptr(0x587000, 58136 + 16 * a1) = v3;
	if (v3)
...
int sub_41E210() {
	...
	case 9:
	case 11:
		if (*getMemU32Ptr(0x587000, 58140 + 16 * sub_41E2F0())) {
			v0 = sub_41E2F0();
			v4 = *getMemU32Ptr(0x5D4594, 527992);
			v1 = 16 * v0;
			v2 = sub_41E2F0();
			(*(void(**)(_DWORD, int)) getMemAt(0x587000, 58140 + v1))(*getMemU32Ptr(0x587000, 58132 + 16 * v2), v4);
		}
		*getMemU32Ptr(0x5D4594, 527992) = sub_41E2F0();
		result = 1;
		break;
	...
	if (*a1) {
		do {
			if ((unsigned __int8)*v1 < 0x80u)
				*getMemU8Ptr(0x5D4594, 528804 + v2++) = *v1;
			v3 = *++v1;
		} while (v3);
	}
	*getMemU8Ptr(0x5D4594, 528804 + v2) = 0;
...
//----- (0041F440) --------------------------------------------------------
void  sub_41F440(int a1, char a2, int a3) { sub_448570((const char*)(*(_DWORD*)a1 + 36), a2, a3); }
...
//----- (0041F9E0) --------------------------------------------------------
BOOL  sub_41F9E0(int a1) { return strcmp((const char*)getMemAt(0x5D4594, 534756), (const char*)(a1 + 36)) == 0; }
...
int  sub_41FA80(const char* a1) {
	...
	if (!a1 || strlen(a1) >= 0xA || *(int*)&dword_587000_60044 == -1)
		return 0;
	result = 1;
	strcpy((char*)getMemAt(0x5D4594, 531660 + 24 * dword_587000_60044), a1);
	return result;
}
...
int  sub_41FAE0(const char* a1) {
	...
	if (*a1) {
		if (a1 && strlen(a1) < 0xA && *(int*)&dword_587000_60044 != -1) {
			strcpy((char*)getMemAt(0x5D4594, 531670 + 24 * dword_587000_60044), a1);
			v1 = 1;
		}
		result = v1;
	} else {
		v2 = 24 * dword_587000_60044;
		*getMemU8Ptr(0x5D4594, 531670 + v2) = 0;
		*getMemU32Ptr(0x5D4594, 531680 + v2) = 0;
		result = 1;
	}
	return result;
}
...
//----- (0041FB60) --------------------------------------------------------
int sub_41FB60() { return *getMemU32Ptr(0x5D4594, 531680 + 24 * dword_587000_60044); }
...
int  sub_41FB70(int a1) {
	...
	*getMemU32Ptr(0x5D4594, 531680 + 24 * dword_587000_60044) = a1;
	return result;
}
...
int  sub_41FB90(int a1, _DWORD* a2, _DWORD* a3) {
	...
	if (a1 < 0 || a1 >= 128) {
		...
		*a2 = getMemAt(0x5D4594, 531660 + 24 * a1);
		*a3 = getMemAt(0x5D4594, 531670 + 24 * a1);
		result = 1;
	}
	return result;
}
...
int sub_41FC50() {
	...
	result = 0;
	if (*(int*)&dword_587000_60044 != -1) {
		result = sub_40D9C0(dword_587000_60044 + 1, (int)getMemAt(0x5D4594, 531660 + 24 * dword_587000_60044),
							(int)getMemAt(0x5D4594, 531670 + 24 * dword_587000_60044),
							*getMemU32Ptr(0x5D4594, 531680 + 24 * dword_587000_60044) == 0);
		if (result)
			result = sub_41FCF0();
	}
	return result;
...
int nox_xxx_officialStringCmp_41FDE0() {
	...
	memset(getMemAt(0x8529A0, 45728), 0, 0x6Cu);
...
void  sub_4207F0(int a1) {
	...
	if (a1 < 7) {
		v1 = *(void (**)(void)) getMemAt(0x587000, 60280 + 8 * *getMemU32Ptr(0x8529A0, 45708));
		if (v1)
			v1();
		v2 = *(void (**)(void)) getMemAt(0x587000, 60284 + 8 * a1);
		*getMemU32Ptr(0x8529A0, 45708) = a1;
		if (v2)
			v2();
	}
}
...
char*  nox_xxx_polygon_420CD0(_DWORD* a1) {
	...
	if (v1 >= *(int*)&nox_xxx_polygonNextAngle_587000_60356)
		return 0;
	for (i = getMemAt(0x5D4594, 535856 + 16 * v1); !*(_DWORD*)i; i += 16) {
		if (++v1 >= *(int*)&nox_xxx_polygonNextAngle_587000_60356)
			return 0;
	}
...
int  sub_420EF0(_DWORD* a1) {
	...
	if (nox_xxx_polygonNextIdx_587000_60352 > 1u) {
		...
		LABEL_12:
			++v1;
			v2 += 140;
		} while (v1 < *(int*)&nox_xxx_polygonNextIdx_587000_60352);
	}
	v5 = 0;
	if ((int)*getMemU16Ptr(0x5D4594, 588072) > 0) {
		...
		--*getMemU16Ptr(0x5D4594, 588072);
		memcpy(getMemAt(0x5D4594, 534820 + 4 * v5), getMemAt(0x5D4594, 534824 + 4 * v5),
...
char*  sub_4210E0(int a1) {
	...
	if (v1 >= *(int*)&nox_xxx_polygonNextIdx_587000_60352)
		return 0;
	for (i = getMemAt(0x5D4594, 552312 + 140 * v1); !*(_DWORD*)i; i += 140) {
		if (++v1 >= *(int*)&nox_xxx_polygonNextIdx_587000_60352)
			return 0;
	}
...
int  sub_4212C0(int a1) {
	...
	if (*(_WORD*)(a1 + 128)) {
		do {
			...
			LABEL_16:
				v8 = 0;
				v9 = getMemAt(0x5D4594, 535844 + 16 * *(_DWORD*)(*(_DWORD*)(v1 + 108) + 4 * v2));
				if ((int)*getMemU16Ptr(0x5D4594, 588072) > 0) {
		...
		if (v0) {
			...
			*((_WORD*)v0 + 64) = *getMemU16Ptr(0x5D4594, 588072);
			if (*getMemU16Ptr(0x5D4594, 588072)) {
				do {
					*(_DWORD*)(*((_DWORD*)v0 + 27) + 4 * v1) = *getMemU32Ptr(0x5D4594, 534820 + 4 * v1);
					++v1;
				} while (v1 < *getMemU16Ptr(0x5D4594, 588072));
			}
			v2 = getMemAt(0x5D4594, 535844 + 16 * **((_DWORD**)v0 + 27));
			...
			*((_DWORD*)v0 + 25) = v3;
			if (!v5) {
				do {
					v6 = getMemAt(0x5D4594, 535844 + 16 * *(_DWORD*)(*((_DWORD*)v0 + 27) + 4 * v4));
...
int  nox_xxx_polygon_421660(int* a1, int a2) {
	...
	for (v12.field_4 = v8; v10 <= v9; ++v10) {
		v11 = getMemAt(0x5D4594, 535844 + 16 * *(_DWORD*)(*(_DWORD*)(a2 + 108) + 4 * (v10 % (int)v9)));
		if (v10 & 1) {
...
int  sub_421880(int a1, int a2, float a3) {
	...
	v3 = getMemAt(0x5D4594, 535844 + 16 * **(_DWORD**)(a2 + 108));
	...
	if ((int)(unsigned __int16)v6 < 1)
		return 0;
	while (1) {
		v7 = getMemAt(0x5D4594, 535844 + 16 * *(_DWORD*)(*(_DWORD*)(a2 + 108) + 4 * (v5 % v6)));
		if (v5 & 1) {
	...
	if (*getMemU16Ptr(0x5D4594, 588072)) {
		...
		if (*getMemU16Ptr(0x5D4594, 588072)) {
			...
			do {
				...
				v2 = 0;
				if (nox_xxx_polygonNextIdx_587000_60352 <= 1u) {
					sub_420EE0((int)getMemAt(0x5D4594, 535844 + 16 * *(_DWORD*)v7));
				} else {
				...
				if (v6 != -559023410) {
					...
					if (!((1 << *(_BYTE*)(v1 + 2064)) & *((_DWORD*)v4 + 34)) && v4[132] & 1 &&
						...
						for (i = nox_xxx_getFirstPlayerUnit_4DA7C0(); i; i = nox_xxx_getNextPlayerUnit_4DA7F0(i)) {
							if (i != a1)
								nox_xxx_netInformTextMsg_4DA0F0(*(unsigned __int8*)(*(_DWORD*)(*(_DWORD*)(i + 748) + 276) + 2064), 20,
										   (int*)(a1 + 36));
						}
						v9 = *((_DWORD*)v4 + 33);
						LOBYTE(v9) = v9 & 0xFE;
				...
				while (1) {
					...
					if (((_BYTE)v42 + (_BYTE)v43) & 1) {
						...
						if (nox_common_gameFlags_check_40A5C0(0x400000)) {
							v54 = (_BYTE*)*nox_xxx_tileAllocTileInCoordList_5040A0(v56, v58, COERCE_FLOAT(1));
						} else {
						...
						v53 = 23 * v51 / 46;
						if (nox_common_gameFlags_check_40A5C0(0x400000)) {
							v54 = (_BYTE*)*nox_xxx_tileAllocTileInCoordList_5040A0(v52, 23 * v51 / 46, COERCE_FLOAT(2));
						} else {
			...
			for (k = v59; (_WORD)v59 != (_WORD)-1; k = v59) {
				...
				if (v47 < 0) {
					*(_BYTE*)(&ptr_5D4594_2650668[v48][v49].field_0) |= 0x1;
					nox_xxx_tileReadOne_422A40(v62, (_BYTE*)(&ptr_5D4594_2650668[v48][v49].field_1));
				}
				if (v47 & 0x80) {
					*(_BYTE*)(&ptr_5D4594_2650668[v48][v49].field_0) |= 0x2;
					nox_xxx_tileReadOne_422A40(v62, (_BYTE*)(&ptr_5D4594_2650668[v48][v49].field_6));
				}
				nox_xxx_fileReadWrite_426AC0_file3_fread(&v59, 2u);
			}
		}
			...
			if (!(((_BYTE)v33 + v35) & 1)) {
				if (v33 & 1) {
					...
					LABEL_70:
						...
						if (nox_xxx_wallMath_427F30(&v69, (_DWORD*)a1)) {
							LOBYTE(v40) = 0;
							HIBYTE(v40) = v65;
							v68 = v33 | v40;
...
unsigned __int8  nox_xxx_tileReadOne_422A40(int a1, _BYTE* a2) {
	...
	*((_DWORD*)v2 + 3) = (unsigned __int8)a2;
	for (LOBYTE(v15) = 0; v6; v6 = *(_DWORD*)(v6 + 16))
		LOBYTE(v15) = v15 + 1;
	nox_xxx_fileReadWrite_426AC0_file3_fread(&v15, 1u);
	result = getMemByte(0x8529A0, 1189016);
	if (*getMemU32Ptr(0x8529A0, 1189016)) {
		result = v15;
		v10 = 0;
		v11 = (_BYTE)v15 == 0;
			...
			do {
				if (v26 <= v27) {
					do {
						...
						nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(&obj->field_0), 1);
						if (obj->field_0 & 0x1) {
							...
							for (m = obj->field_5; m; m = *(_DWORD*)(m + 16)) {
								nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)m, 16);
							}
						}
						if (obj->field_0 & 0x2) {
							...
							for (ii = obj->field_10; ii; ii = *(_DWORD*)(ii + 16)) {
								nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)ii, 16);
							}
						}
						++v26;
					} while (v26 <= v27);
	...
	LABEL_61:
		...
		while (1) {
			if (!(((_BYTE)v35 + (_BYTE)v37) & 1)) {
				...
				if (nox_xxx_wallMath_427F30(&v82, (_DWORD*)a2)) {
					LOBYTE(a1) = 1;
					nox_xxx_fileReadWrite_426AC0_file3_fread(&a1, 1u);
					nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)v40, 0x10u);
					LOBYTE(v75) = 0;
					...
					for (kk = *(_DWORD*)(v40 + 16); kk; kk = *(_DWORD*)(kk + 16))
						nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)kk, 0x10u);
					goto LABEL_76;
				}
			}
		LABEL_75:
		...
		if (v77 < v77 + v79) {
			...
			do {
				...
				if (v57 < v56 + v57) {
					do {
						v59 = a2;
						nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(a2 + (_DWORD)(ptr_5D4594_2650668[v58])), 1u);
		...
		if (v44 < v47 + v44) {
			...
			do {
				...
				if ((_BYTE)a1) {
					...
					nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)v52, 0x10u);
					nox_xxx_fileReadWrite_426AC0_file3_fread(&v75, 1u);
					if ((_BYTE)v75) {
						v67 = 0;
						v68 = (int*)v52;
...
int  nox_xxx_effectFloatValueLoad_4235C0(const char* a1, char* a2, obj_412ae0_t* a3) {
	float v4 = nox_xxx_effectLoadFloat_423730_parse_float();
...
int  nox_xxx_effectDwordValueLoad_423780(const char* a1, char* a2, obj_412ae0_t* a3) {
	int v3 = nox_xxx_effectLoadDword_4238F0_parse_int();
...
int  sub_4240F0(int a1, const char* a2, int a3) {
	...
	*(_DWORD*)(*getMemU32Ptr(0x587000, 64708 + 8 * v4) + a1) = a3;
	return 1;
}
...
char  sub_424CB0(int a1) {
	...
	do {
		if (nox_xxx_testUnitBuffs_4FF350(a1, *(_DWORD*)v3))
			++v1;
		++v2;
		v3 += 4;
...
//----- (00425230) --------------------------------------------------------
int  sub_425230(int a1, int a2) { return *getMemU32Ptr(0x5D4594, 599172 + 4 * (a1 + a2 + 12 * a1)); }

//----- (00425250) --------------------------------------------------------
char*  nox_xxx_abilityGetName_425250(int a1) { return *(char**)getMemAt(0x587000, 69736 + 4 * a1); }

//----- (00425260) --------------------------------------------------------
int  nox_xxx_abilityGetName_0_425260(int a1) {
	int result; // eax

	if (a1 > 0 && a1 < 6 && *getMemU32Ptr(0x5D4594, 599156 + 52 * a1))
		result = *getMemU32Ptr(0x5D4594, 599132 + 52 * a1);
	else
		result = 0;
	return result;
}
...
//----- (004252D0) --------------------------------------------------------
int  nox_xxx_abilityCooldown_4252D0(int a1) { return *getMemU32Ptr(0x5D4594, 599160 + 52 * a1); }
...
int  nox_xxx_bookNextKnownAbil_425350(int a1) {
	...
	if (a1 + 1 >= 6)
		return 0;
	v2 = getMemAt(0x5D4594, 599156 + 52 * result);
	while (!*(_DWORD*)v2) {
		v2 += 52;
		++result;
...
int  sub_425380(int a1) {
	...
	if (a1 - 1 <= 0)
		return 0;
	for (i = getMemAt(0x5D4594, 599156 + 52 * result); !*(_DWORD*)i; i -= 52) {
		if (--result <= 0)
			return 0;
	}
	return result;
...
//----- (004253B0) --------------------------------------------------------
int  sub_4253B0(int a1) { return *getMemU32Ptr(0x5D4594, 599156 + 52 * a1); }

//----- (004253D0) --------------------------------------------------------
int  sub_4253D0(int a1) { return *getMemU32Ptr(0x5D4594, 599152 + 52 * a1); }
...
int  sub_4253F0(int a1) {
	...
	result = a1;
	*getMemU32Ptr(0x5D4594, 599152 + 52 * a1) = 1;
	return result;
}
...
int  sub_425410(int a1) {
	...
	result = a1;
	*getMemU32Ptr(0x5D4594, 599152 + 52 * a1) = 0;
	return result;
}

//----- (00425430) --------------------------------------------------------
BOOL  sub_425430(int a1, int a2) { return (a2 & *getMemU32Ptr(0x5D4594, 599168 + 52 * a1)) != 0; }

//----- (00425450) --------------------------------------------------------
int  sub_425450(int a1) { return *getMemU32Ptr(0x5D4594, 599168 + 52 * a1); }

//----- (00425470) --------------------------------------------------------
int  sub_425470(int a1) { return *getMemU32Ptr(0x5D4594, 599164 + 52 * a1); }
		...
		if (!result) {
			if (a1) {
				...
				if (*(int*)(a1 + 4648) == -1) {
					...
					*getMemU32Ptr(0x5D4594, 600140 + v5) = *(_DWORD*)(a1 + 2068);
					*getMemU8Ptr(0x5D4594, 600144 + v5) = *(_BYTE*)(a1 + 2251);
					*(_DWORD*)(a1 + 4648) = v13;
				} else {
					v13 = *(_DWORD*)(a1 + 4648);
				}
				if (v3) {
					if (*(int*)(v3 + 4648) == -1) {
						...
						v10 = 32 * v8;
						*getMemU32Ptr(0x5D4594, 600140 + v10) = *(_DWORD*)(v3 + 2068);
						*getMemU8Ptr(0x5D4594, 600144 + v10) = *(_BYTE*)(v3 + 2251);
						*(_DWORD*)(v3 + 4648) = v8;
					} else {
						v12 = *(_DWORD*)(v3 + 4648);
					}
	...
	if (result) {
		...
		if (!result) {
			...
			if (a1) {
				...
				LABEL_18:
					*getMemU32Ptr(0x5D4594, 600140 + v6) = *(_DWORD*)(v2 + 2068);
					*getMemU8Ptr(0x5D4594, 600144 + v6) = *(_BYTE*)(v2 + 2251);
...
int  nox_xxx_cryptOpen_426910(char* a1, int a2, int a3) {
	...
	*getMemU32Ptr(0x8529A0, 1189016) = a2;
	*getMemU32Ptr(0x5D4594, 740000) = a3 == -1;
	dword_5d4594_739996 = -1;
	if (a2 == 1) {
		v3 = 0;
	} else if (a2 == 2) {
		*getMemU32Ptr(0x8529A0, 1189016) = 0;
		v3 = 2;
	} else {
		v3 = 1;
	}
...
int  sub_426BD0(unsigned __int8* a1, int a2) {
	...
	if (nox_file_3) {
		...
		for (i = a2; i; dword_5d4594_739996 = v3) {
			v6 = *v4++;
			result = *getMemU32Ptr(0x581450, 7288 + 4 * (v6 ^ (unsigned __int8)v3));
			v3 = result ^ (v3 >> 8);
			--i;
		}
...
int  nox_xxx_unused_427350(int a1) {
	...
	if (a1 - 1 <= 0)
		return 0;
	for (i = getMemAt(0x5D4594, 740080 + 28 * result); !*(_DWORD*)i; i -= 28) {
		if (--result <= 0)
			return 0;
	}
	return result;
...
//----- (00427380) --------------------------------------------------------
BOOL  nox_xxx_unused_427380(int a1) { return *getMemU32Ptr(0x5D4594, 740080 + 28 * a1) != 0; }

//----- (004273A0) --------------------------------------------------------
int  sub_4273A0(int a1) { return *getMemU32Ptr(0x5D4594, 740096 + 28 * a1); }
...
int  sub_4273E0(int a1) {
	...
	result = a1;
	*getMemU32Ptr(0x5D4594, 740096 + 28 * a1) = 0;
	return result;
}
...
//----- (00427460) --------------------------------------------------------
unsigned __int8  nox_xxx_guideGetUnitSize_427460(int a1) { return getMemByte(0x5D4594, 740100 + 28 * a1); }
...
void  nox_xxx_comJournalEntryAdd_427500(int a1, char* a2, __int16 a3) {
	...
	if (v4) {
		if (*(_BYTE*)(v3 + 2064) == 31)
			...
			nox_xxx_netSendJournalAdd_4D9440(*(unsigned __int8*)(v3 + 2064), (int)v4);
	}
}
...
void  nox_xxx_comJournalEntryRemove_427630(int a1, const char* a2) {
	...
	if (nox_xxx_journalEntryRemove_427590(v2, a2)) {
		if (*(_BYTE*)(v2 + 2064) == 31)
			...
			nox_xxx_netSendJournalRemove_4D94A0(*(unsigned __int8*)(v2 + 2064), a2);
	}
}
...
int  nox_xxx_comJournalEntryUpdate_427720(int a1, const char* a2, __int16 a3) {
	...
	if (result) {
		if (*(_BYTE*)(v3 + 2064) != 31)
			result = nox_xxx_netSendJournalUpdate_4D9500(*(unsigned __int8*)(v3 + 2064), result);
	}
	return result;
}
