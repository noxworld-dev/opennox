...
//----- (0041FB60) --------------------------------------------------------
int sub_41FB60() { return *(_DWORD*)&byte_5D4594[24 * *(_DWORD*)&byte_587000[60044] + 531680]; }
...
//----- (0041FC40) --------------------------------------------------------
int sub_41FC40() { return *(_DWORD*)&byte_587000[60044]; }
...
int sub_41FC50() {
	...
	result = 0;
	if (*(int*)&byte_587000[60044] != -1) {
		result = sub_40D9C0(*(_DWORD*)&byte_587000[60044] + 1,
