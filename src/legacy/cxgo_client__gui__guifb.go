...
func sub_456140(a1 uint8) {
	...
	*memmap.PtrUint8(0x5D4594, 1045644) = a1
	...
	switch a1 {
	case 0:
		*(*uint32)(unsafe.Add(v2, 24)) = nox_xxx_gLoadImg_42F970(internCStr("BallAtHome"))
	...
	case 1:
		*(*uint32)(unsafe.Add(v2, 24)) = nox_xxx_gLoadImg_42F970(internCStr("BallAway"))
	...
	case 2:
		*(*uint32)(unsafe.Add(v2, 24)) = nox_xxx_gLoadImg_42F970(internCStr("BallRed"))
	...
	case 4:
		*(*uint32)(unsafe.Add(v2, 24)) = nox_xxx_gLoadImg_42F970(internCStr("BallBlue"))
