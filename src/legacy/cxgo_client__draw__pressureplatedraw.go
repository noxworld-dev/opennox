...
func nox_thing_pressure_plate_draw(vp *noxrender.Viewport, dr *nox_drawable) int {
	...
	v18 = int32(*(*uint32)(unsafe.Pointer(uintptr(v2 + 12))) + uint32(v5) + uint32(int32(v13)))
	v6 = int32(*(*uint32)(unsafe.Pointer(uintptr(v2 + 16))) + uint32(v4) + uint32(int32(*(*float32)(unsafe.Pointer(uintptr(v2 + 68))))))
	v19 = int32(*(*uint32)(unsafe.Pointer(uintptr(v2 + 12))) + uint32(v5) + uint32(int32(*(*float32)(unsafe.Pointer(uintptr(v2 + 88))))))
	v7 = int32(*(*uint32)(unsafe.Pointer(uintptr(v2 + 16))) + uint32(v20) + uint32(int32(*(*float32)(unsafe.Pointer(uintptr(v2 + 92))))))
	v16 = int32(*(*uint32)(unsafe.Pointer(uintptr(v2 + 12))) + uint32(v5) + uint32(int32(*(*float32)(unsafe.Pointer(uintptr(v2 + 72))))))
	v17 = int32(*(*uint32)(unsafe.Pointer(uintptr(v2 + 16))) + uint32(v20) + uint32(int32(*(*float32)(unsafe.Pointer(uintptr(v2 + 76))))))
	v14 = int32(*(*uint32)(unsafe.Pointer(uintptr(v2 + 12))) + uint32(v5) + uint32(int32(*(*float32)(unsafe.Pointer(uintptr(v2 + 80))))))
	v8 = int32(*(*float32)(unsafe.Pointer(uintptr(v2 + 84))))
	v9 = v20
