...
func nox_thing_harpoon_rope_draw(vp *noxrender.Viewport, dr *nox_drawable) int {
	...
	if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 432))) == 0 {
		...
		a1a.field_0 = *a1 + int32(*(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 437))) - v2
		v5 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*5))
		v6 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*1))
		a1a.field_4 = int32(v4) - v5 + v6 - 20
		v7 = int32(*(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 441))) - v2
		v8 = int32(*(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 443))) - v5
		a2a.field_0 = v3 + v7
