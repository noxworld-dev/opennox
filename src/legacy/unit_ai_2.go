...
func sub_50B520() {
	if (gameFrame() - dword_5d4594_2386172) < 15 {
		return
	}
...
func nox_xxx_appendWorkPath_50C990(path []types.Pointf, ind int32) int32 {
	var (
		v3 int32
		v4 int32
	)
...
func sub_50C320(obj *server.Object, node *aiVisitNode, start *types.Pointf) {
	...
	if start != nil {
		...
		if node.Flags12&0x2 != 0 && sub_50AEA0(node, &out, &netCode) != 0 {
	...
	for it := node.Field4; it != nil; it, prev, ni = it.Field4, it, ni+1 {
		...
		if it.Flags12&0x2 != 0 {
			...
			if sub_50AEA0(it, &out, &netCode) != 0 {
				...
				if int32(ud.Field543_0) < 8 {
					if dx*dx+dy*dy > 4761 {
						...
						var pp float4
						pp.field_0 = float32(int32(it.X0)*23 + 11)
						pp.field_4 = float32(int32(it.Y2)*23 + 11)
						pp.field_8 = float32(int32(prev.X0)*23 + 11)
						pp.field_C = float32(int32(prev.Y2)*23 + 11)
						if nox_xxx_mapTraceRay_535250(&pp, nil, nil, 1) == 0 {
							ud.Field535[ud.Field543_0] = netCode
							ud.Field543_0++
						}
					}
	...
	for i := int32(0); i < dword_5d4594_2386180/2; i++ {
...
func nox_xxx_pathFind_50BA00(far bool, obj *server.Object, a3 *types.Pointf, a4 *types.Pointf, fnc func(obj *server.Object, x, y int32) int32, a6 int32) {
	var (
		v30 *server.Object
		v33 *aiVisitNode
		v36 int32
	...
	v63 := bool2int32(nox_xxx_pathfind_preCheckWalls2_50B8A0(obj, a2a.X, a2a.Y) == 0)
	v61 := false
		...
		for {
			...
			if far {
				...
				if v63 == 0 && !v61 && x1 == x00 && y1 == y00 {
					dword_5d4594_1599712 = 0
					sub_50C320(obj, vn3, a4)
					return
				}
			}
			ioff := nox_common_randomInt_415FA0(0, 7)
			...
			for i := 0; i < 8; i++ {
				...
				if x2 == x00 && y2 == y00 {
					v76.field_0 = float32(int32(vn3.X0)*23 + 11)
					v76.field_4 = float32(int32(vn3.Y2)*23 + 11)
					v76.field_8 = a4.X
					v76.field_C = a4.Y
					if nox_xxx_mapTraceObstacles_50B580(obj, &v76) != 0 {
						if obj.ObjFlags&0x4000 != 0 {
							...
							if nox_xxx_mapTraceRay_535250(&v76, nil, nil, 1) != 0 {
								v30 = obj
								goto LABEL_32
							}
						}
				...
				if ii < 4 {
					...
					v60 = int8(int32(uint16(int16(^(int32(*(*uint16)(unsafe.Add(unsafe.Pointer(obj), 16)))>>8))))&0xD8 | 0x98)
					sub_57B4D0(obj)
					switch ii {
					case 4:
						v36 = int32(uint8(sub_57B500(int32(vn3.X0), int32(vn3.Y2)+1, v60)))
						if v36 != 1 && v36 != 6 && v36 != 10 && v36 != 9 && v36 != math.MaxUint8 {
							continue
						}
						*(*uint8)(unsafe.Pointer(&v37)) = uint8(sub_57B500(int32(vn3.X0)+1, int32(vn3.Y2), v60))
					...
					case 5:
						v39 = int32(uint8(sub_57B500(int32(vn3.X0)-1, int32(vn3.Y2), v60)))
						if v39 != 1 && v39 != 6 && v39 != 10 && v39 != 9 && v39 != math.MaxUint8 {
							continue
						}
						*(*uint8)(unsafe.Pointer(&v37)) = uint8(sub_57B500(int32(vn3.X0), int32(vn3.Y2)-1, v60))
						v37 = int32(uint8(int8(v37)))
						if int32(uint8(int8(v37))) == 1 || v37 == 4 || v37 == 7 {
							// nop
						} else {
					...
					case 6:
						v40 = int32(uint8(sub_57B500(int32(vn3.X0), int32(vn3.Y2)+1, v60)))
						if v40 != 0 && v40 != 5 && v40 != 9 && v40 != 8 && v40 != math.MaxUint8 {
							continue
						}
						v37 = int32(uint8(sub_57B500(int32(vn3.X0)-1, int32(vn3.Y2), v60)))
					...
					case 7:
						v41 = int32(uint8(sub_57B500(int32(vn3.X0)+1, int32(vn3.Y2), v60)))
						if v41 != 0 && v41 != 5 && v41 != 9 && v41 != 8 && v41 != math.MaxUint8 {
							continue
						}
						v42 = int32(uint8(sub_57B500(int32(vn3.X0), int32(vn3.Y2)-1, v60)))
						if v42 != 0 && v42 != 3 && v42 != 10 && v42 != 7 && v42 != math.MaxUint8 {
							continue
						}
					}
					v30 = obj
					if sub_50B950(obj, int32(vn3.X0), pp.Y+int32(vn3.Y2)) != 0 || sub_50B950(obj, pp.X+int32(vn3.X0), int32(vn3.Y2)) != 0 {
						continue
					}
				}
				if sub_50B870(v30, x2, y2) != 0 {
					continue
				}
				if x00 != x2 || y00 != y2 {
				...
				if v63 != 0 {
					v43 := nox_xxx_pathfind_preCheckWalls2_50B8A0(v30, x2, y2)
					if v43 != 0 {
						v64 = 1
					} else if sub_50B950(v30, int32(vn3.X0), int32(vn3.Y2)) == 0 && sub_50B950(v30, x2, y2) != 0 {
						continue
					}
				} else {
					v43 := nox_xxx_pathfind_preCheckWalls2_50B8A0(v30, x2, y2)
			...
			if sub_50AC20(vn3, &v68) != 0 {
				vn3.Flags12 |= 2
				v32 := nox_alloc_visitNode_2386184.NewObject()
				if v32 == nil {
					nox_ai_debug_printf_5341A0(internCStr("%d: %s(#%d), buildPath: Exhausted search storage\n"), gameFrame(), nox_xxx_getUnitName_4E39D0(obj), int32(obj.NetCode))
					dword_5d4594_1599712 = 1
					sub_50C320(obj, v67, nil)
					return
				}
				v32.X0 = v68[0]
				v32.Y2 = v68[1]
	...
	LABEL_40:
		...
		if v64 != 0 {
			...
			if vn2 != nil {
				for {
					v35 := v34.Field8
					if nox_xxx_pathfind_preCheckWalls2_50B8A0(obj, int32(v34.X0), int32(v34.Y2)) != 0 {
						v33 = v34
					} else if v33 != nil {
...
func sub_50AB50(x int32, y int32) aiMapIndexFlags {
...
func sub_50AC20(node *aiVisitNode, out *[2]uint16) int32 {
	x := int32(node.X0)
	y := int32(node.Y2)
	p := aiGetMapIndex(int(x), int(y))
	if (p.Flags8 & 0x3C) == 0 {
	...
	if p.Flags8&aiIndexHole != 0 {
		obj := Sub517B70byClass(pos, object.ClassHole)
		if obj == nil {
			return 0
		}
		if uintptr(obj.CollideData) == -8 {
			return 0
		}
		...
		obj := Sub517B70byClass(pos, object.ClassTransporter)
		if obj == nil {
			return 0
		}
		...
		obj := Sub517B70byClass(pos, object.ClassElevator)
		if obj == nil {
			return 0
		}
		...
		obj := Sub517B70byClass(pos, object.ClassElevatorShaft)
		if obj == nil {
			return 0
		}
		targ := *(**server.Object)(unsafe.Add(obj.UpdateData, 4))
...
func Sub517B70byClass(pos types.Pointf, filter object.Class) *server.Object {
	dword_5d4594_2386152 = nil
...
func sub_50AEA0(node *aiVisitNode, outPos *types.Pointf, outNetCode *uint32) int32 {
	x := int32(node.X0)
	y := int32(node.Y2)
	p := aiGetMapIndex(int(x), int(y))
	if (p.Flags8 & 0x3C) == 0 {
	...
	pos.X = float32(float64(x) * 23.0)
	pos.Y = float32(float64(y) * 23.0)
	obj := Sub517B70byClass(pos, filter)
...
func sub_50B8E0(obj *server.Object, x int32, y int32) uint32 {
	p := aiGetMapIndex(int(x), int(y))
...
func sub_50B950(obj *server.Object, x int32, y int32) int32 {
	p := aiGetMapIndex(int(x), int(y))
	if obj.ObjFlags&0x4000 != 0 {
		return int32(p.Flags8) & 0x10
	} else {
		return int32(p.Flags8) & 0x1
	}
}

func sub_50CB20(a1 *server.Object, a2 *types.Pointf) *server.Waypoint {
	dword_5d4594_2386160++
	var a2a Point32
	...
	for {
		...
		for v6 := v4; v6 != nil; v6 = v6.Field8 {
			v7 := int32(v6.X0)
			v8 := int32(v6.Y2)
			if int32(aiGetMapIndex(int(v7), int(v8)).Flags8)&0x40 != 0 && sub_50B870(a1, v7, v8) == 0 {
				var v18 types.Pointf
				v18.X = float32(float64(v7*23 + 11))
				v18.Y = float32(float64(v8*23 + 11))
				return sub_518740(&v18, 0x80)
			}
...
func sub_50B870(a1 *server.Object, x int32, y int32) int32 {
	return bool2int32(int32(sub_57B630(a1, x, y)) != -1)
}
func nox_xxx_pathfind_preCheckWalls2_50B8A0(obj *server.Object, x int32, y int32) int32 {
	if sub_50B950(obj, x, y) != 0 {
		return 0
	}
	return bool2int32(sub_50B8E0(obj, x, y) == 0)
}
func nox_xxx_pathfind_preCheckWalls_50C8D0(obj *server.Object, gpos *Point32) {
	if sub_50B870(obj, gpos.X, gpos.Y) != 0 {
...
func sub_50AFA0() {
	...
	for k := result; result != nil; k = result {
		...
		result = nox_xxx_waypointNext_579870(k)
	}
}
...
func nox_xxx_genPathToPoint_50B9A0(path []types.Pointf, u *server.Object, a4 *types.Pointf) int32 {
	u.UpdateDataMonster().Field543_0 = 0
	nox_xxx_pathFind_50BA00(false, u, &u.PosVec, a4, nil, 0)
	if dword_5d4594_2386180 > int32(len(path)) && dword_5d4594_1599712 == 0 {
		dword_5d4594_1599712 = 1
	}
	return nox_xxx_appendWorkPath_50C990(path, 0)
}

func nox_xxx_generateRetreatPath_50CA00(path []types.Pointf, u *server.Object, a4 *types.Pointf) int32 {
	u.UpdateDataMonster().Field543_0 = 0
	nox_xxx_pathFind_50BA00(true, u, &u.PosVec, a4, sub_50CA60, 6)
	if dword_5d4594_2386180 > int32(len(path)) && dword_5d4594_1599712 == 0 {
		dword_5d4594_1599712 = 1
	}
	return nox_xxx_appendWorkPath_50C990(path, 0)
...
func sub_50CA60(a4 *server.Object, a2 int32, a3 int32) int32 {
	var a1 types.Pointf
	dword_5d4594_1599708 := 0
	a1.X = float32(float64(a2)*23.0 + 11.5)
	a1.Y = float32(float64(a3)*23.0 + 11.5)
	nox_xxx_unitsGetInCircle_517F90(&a1, 100.0, func(it *server.Object, _ unsafe.Pointer) {
		if dword_5d4594_1599708 != 1 {
			if nox_xxx_unitIsEnemyTo_5330C0(a4, it) != 0 {
...
func nox_xxx_creatureSetDetailedPath_50D220(obj *server.Object, a2 *types.Pointf) {
	ud := obj.UpdateDataMonster()
	ud.Field67 = 0
	if (gameFrame() - ud.Field70) >= 10 {
		ud.Field68 = *a2
		ud.Field2 = uint32(nox_xxx_genPathToPoint_50B9A0(ud.Path[:], obj, a2))
...
func sub_50B810(obj *server.Object, pos *types.Pointf) int32 {
	x := int32(float64(pos.X) / 23)
	y := int32(float64(pos.Y) / 23)
