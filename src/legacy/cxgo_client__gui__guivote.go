...
func sub_48CB10(a1 int32) *uint32 {
	...
	defer free27()
	v25 = 0
	nox_window_call_field_94_fnc((*gui.Window)(dword_5d4594_1197316), 16399, 0, 0)
	nox_window_call_field_94_fnc((*gui.Window)(dword_5d4594_1197320), 16399, 0, 0)
	result = (*uint32)(a1)
	...
	case 4:
		...
		nox_window_set_hidden((*gui.Window)(dword_5d4594_1197316), 1)
		nox_window_set_hidden((*gui.Window)(dword_5d4594_1197320), 0)
		v3 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1197312)), 4301)))
		...
		nox_wcscat(&v27[0], v6)
		nox_window_call_field_94_fnc((*gui.Window)(dword_5d4594_1197320), 16397, uintptr(unsafe.Pointer(&v27[0])), 4)
		...
		nox_wcscat(&v27[0], v8)
		nox_window_call_field_94_fnc((*gui.Window)(dword_5d4594_1197320), 16397, uintptr(unsafe.Pointer(&v27[0])), 4)
		return (*uint32)(unsafe.Pointer(uintptr(nox_xxx_wndShowModalMB_46A8C0((*gui.Window)(dword_5d4594_1197312)))))
	case 2:
		nox_window_set_hidden((*gui.Window)(dword_5d4594_1197316), 1)
		nox_window_set_hidden((*gui.Window)(dword_5d4594_1197320), 0)
		v9 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1197312)), 4301)))
		...
		nox_window_call_field_94_fnc((*gui.Window)(dword_5d4594_1197320), 16397, uintptr(unsafe.Pointer(v11)), 4)
		v12 = nox_strman_loadString_40F1D0(internCStr("WindowDir:No"), nil, internCStr("C:\\NoxPost\\src\\client\\Gui\\GUIVote.c"), 498)
		nox_window_call_field_94_fnc((*gui.Window)(dword_5d4594_1197320), 16397, uintptr(unsafe.Pointer(v12)), 4)
		if dword_5d4594_1197332 == 1 {
			nox_window_call_field_94_fnc((*gui.Window)(dword_5d4594_1197320), 16403, 0, 0)
		} else {
			nox_window_call_field_94_fnc((*gui.Window)(dword_5d4594_1197320), 16403, 1, 0)
		}
		return (*uint32)(unsafe.Pointer(uintptr(nox_xxx_wndShowModalMB_46A8C0((*gui.Window)(dword_5d4594_1197312)))))
	case 0, 1, 3:
		nox_window_set_hidden((*gui.Window)(dword_5d4594_1197316), 0)
		nox_window_set_hidden((*gui.Window)(dword_5d4594_1197320), 1)
		v13 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1197312)), 4301)))
		...
		if int32(nox_xxx_getTeamCounter_417DD0()) != 0 {
			...
			if v16 != nil {
				for i = (*byte)(unsafe.Pointer(nox_common_playerInfoGetFirst_416EA0())); i != nil; i = (*byte)(unsafe.Pointer(nox_common_playerInfoGetNext_416EE0((*server.Player)(unsafe.Pointer(i))))) {
					if i != *(**byte)(memmap.PtrOff(0x8531A0, 2576)) {
						...
						if v18 != nil {
							if nox_xxx_teamCompare2_419180((*server.ObjectTeam)(unsafe.Pointer(v18)), *(*byte)(unsafe.Add(unsafe.Pointer(v16), 57))) != 0 {
								...
								if dword_5d4594_1197324 > 0 {
									...
									for {
										if nox_wcscmp(v20, (*wchar2_t)(unsafe.Add(unsafe.Pointer(i), unsafe.Sizeof(wchar2_t(0))*2352))) == 0 {
											nox_window_call_field_94_fnc((*gui.Window)(dword_5d4594_1197316), 16405, uintptr(v25), 0)
										}
										v19++
										v20 = (*wchar2_t)(unsafe.Add(unsafe.Pointer(v20), unsafe.Sizeof(wchar2_t(0))*28))
										if v19 >= dword_5d4594_1197324 {
											break
										}
									}
									v16 = v26
			...
			for j = (*byte)(unsafe.Pointer(nox_common_playerInfoGetFirst_416EA0())); j != nil; j = (*byte)(unsafe.Pointer(nox_common_playerInfoGetNext_416EE0((*server.Player)(unsafe.Pointer(j))))) {
				if j != *(**byte)(memmap.PtrOff(0x8531A0, 2576)) {
					nox_window_call_field_94_fnc((*gui.Window)(dword_5d4594_1197316), 16397, uintptr(unsafe.Add(unsafe.Pointer(j), 4704)), 4)
					v22 = 0
					if dword_5d4594_1197324 > 0 {
