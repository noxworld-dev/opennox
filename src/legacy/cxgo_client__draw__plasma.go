	...
	for j = 0; j < 3; j++ {
		if result > 0 {
			...
			for {
				...
				v28 = v37 * *memmap.PtrFloat32(0x587000, uintptr(uint32(v18*8)+194136))
				v20 = int32(v28)
				v21 = int32(*(*uint32)(unsafe.Pointer(v17)))
				a3a.X = v20
				v29 = v37 * *memmap.PtrFloat32(0x587000, uintptr(uint32(v21*8)+194140))
				v22 = int32(v29)
				v23 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer(v17), 4*4))))
				v24 = float64(v37 * *memmap.PtrFloat32(0x587000, uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer(v17), 4*7)))*8+194136)))
				a3a.Y = v22
				...
				a4a.X = v26
				v31 = v37 * *memmap.PtrFloat32(0x587000, uintptr(uint32(v27*8)+194140))
				a4a.Y = int32(v31)
...
func nox_thing_plasma_draw(vp *noxrender.Viewport, dr *client.Drawable) int {
	...
	if int32(*(*uint8)(unsafe.Add(a2, 432))) != 0 {
		if nox_xxx_netTestHighBit_578B70(*(*uint32)(unsafe.Add(a2, 437))) != 0 {
			v12 = nox_xxx_netClearHighBit_578B30(int16(uint16(*(*uint32)(unsafe.Add(a2, 437)))))
			v13 = (*uint32)(nox_xxx_netSpriteByCodeStatic_45A720(uint32(v12)).C())
		} else {
			v14 = nox_xxx_netClearHighBit_578B30(int16(uint16(*(*uint32)(unsafe.Add(a2, 437)))))
			v13 = (*uint32)(nox_xxx_netSpriteByCodeDynamic_45A6F0(uint32(v14)).C())
		}
		v15 = v13
		if nox_xxx_netTestHighBit_578B70(*(*uint32)(unsafe.Add(a2, 441))) != 0 {
			v16 = nox_xxx_netClearHighBit_578B30(int16(uint16(*(*uint32)(unsafe.Add(a2, 441)))))
			v17 = (*uint32)(nox_xxx_netSpriteByCodeStatic_45A720(uint32(v16)).C())
		} else {
			v18 = nox_xxx_netClearHighBit_578B30(int16(uint16(*(*uint32)(unsafe.Add(a2, 441)))))
			v17 = (*uint32)(nox_xxx_netSpriteByCodeDynamic_45A6F0(uint32(v18)).C())
		}
		v19 = v17
		if v15 != nil && v17 != nil {
		...
		v9 = *a1 + int32(*(*uint16)(unsafe.Add(v3, 437))) - v6
		a1 = (*int32)(unsafe.Pointer(uintptr(int32(v4) - v5 + v8 - 20)))
		v10 = (*int32)(unsafe.Pointer(uintptr(v7 + int32(*(*uint16)(unsafe.Add(v3, 441))) - v6)))
		v11 = (*int32)(unsafe.Pointer(uintptr(int32(*(*uint16)(unsafe.Add(v3, 443))) - v5 + v8 - 20)))
	}
