...
func sub_452010() int32 {
	...
	return int32(func() uint32 {
		p := memmap.PtrUint32(0x5D4594, 1045444)
		*p++
		return *p
	}())
}
...
func sub_453F70(a1 *DataZzz) {
	alloc.Memcpy(memmap.PtrOff(0x5D4594, 1045488), unsafe.Pointer(a1), 0x14)
}
func sub_453F90() *DataZzz {
	return (*DataZzz)(memmap.PtrOff(0x5D4594, 1045488))
}
func sub_453FA0(a1 unsafe.Pointer, a2 int32, a3 int32) {
	var (
		v3     bool
		v4     int8
		result int32
	...
	result = 1 << int32(v4)
	if a3 != 0 {
		*(*uint32)(unsafe.Add(a1, uintptr(int32(v6)*4))) |= uint32(result)
	} else {
		*(*uint32)(unsafe.Add(a1, uintptr(int32(v6)*4))) &^= uint32(result)
	}
}
...
func sub_456D60(a1 int32) *int32 {
	...
	v1 = (*int32)(unsafe.Pointer(nox_common_list_getFirstSafe_425890((*nox_list_item_t)(unsafe.Pointer(memmap.PtrInt32(0x5D4594, 1045652))))))
	if v1 != nil {
		for {
	...
	result = (*int32)(unsafe.Pointer(nox_common_list_getFirstSafe_425890((*nox_list_item_t)(unsafe.Pointer(memmap.PtrInt32(0x5D4594, 1045668))))))
	v4 = result
	if result != nil {
		for {
...
func sub_456E40(a1 int32, a2 int32) int32 {
	...
	v2 = (*int32)(unsafe.Pointer(nox_common_list_getFirstSafe_425890((*nox_list_item_t)(unsafe.Pointer(memmap.PtrInt32(0x5D4594, 1045652))))))
	v3 = 0
	if v2 == nil {
		return -1
	}
...
func sub_456F10(a1 *wchar2_t, a2 int32) int32 {
	...
	v2 = (*int32)(unsafe.Pointer(nox_common_list_getFirstSafe_425890((*nox_list_item_t)(unsafe.Pointer(memmap.PtrInt32(0x5D4594, 1045668))))))
	v3 = 0
	if v2 == nil {
		return -1
	}
...
func sub_456FA0() {
	if dword_5d4594_1045684 != nil {
		v1 := unsafe.Pointer(nox_common_list_getFirstSafe_425890((*nox_list_item_t)(unsafe.Pointer(memmap.PtrInt32(0x5D4594, 1045668)))))
		if v1 != nil {
			for {
...
func sub_4571A0(a1 int32, a2 int32) {
	if dword_5d4594_1045684 != nil {
		...
		if result != -1 {
			v5 := int32(3)
			if a2 != 0 {
				for i := unsafe.Pointer(nox_common_list_getFirstSafe_425890((*nox_list_item_t)(unsafe.Pointer(memmap.PtrInt32(0x5D4594, 1045668))))); i != nil; i = unsafe.Pointer(nox_common_list_getNextSafe_4258A0((*nox_list_item_t)(i))) {
...
func nox_xxx_guiServerOptionsHide_4597E0(a1 int32) {
	...
	if a1 != 0 {
		sub_57ADF0(memmap.PtrInt32(0x5D4594, 1045956))
...
func sub_459AA0(a1 *DataYyy) {
	...
	libc.StrNCpy((*byte)(unsafe.Add(unsafe.Pointer(a1), 9)), &v7[0], 15)
	a1.Field52 = uint16(int16(sub_459C10()))
	a1.Field24 = *sub_453F90()
	a1.Field44 = *(*uint32)(unsafe.Pointer(sub_453600()))
	a1.Field48 = uint32(sub_453610())
	v2 = (*wchar2_t)(unsafe.Pointer(nox_window_call_field_94_fnc(dword_5d4594_1046516, 16413, 0, 0)))
	if *v2 != 0 {
		a1.Field54 = uint16(int16(libc.WStrtol(v2, nil, 10)))
	}
	v3 = (*wchar2_t)(unsafe.Pointer(nox_window_call_field_94_fnc(dword_5d4594_1046520, 16413, 0, 0)))
	if *v3 != 0 {
		a1.Field56 = uint8(int8(libc.WStrtol(v3, nil, 10)))
	}
	a1.Field57 = uint8((nox_xxx_wndGetChildByID_46B0C0(dword_5d4594_1046492, 10122).DrawData().Field0 >> 2) & 1)
...
func sub_459C30() {
	...
	sub_453F70(&v0.Field24.Vals)
	sub_4535E0(&v0.Field44)
	sub_4535F0(int32(v0.Field48))
	if dword_5d4594_1046492 != nil {
		sub_459880(int32(uintptr(unsafe.Pointer(v0))))
		sub_4BDF70((*int32)(unsafe.Pointer(v0)))
		nox_client_guiserv_updateMapList_458230(int32(v0.Field52), &v0.Field0[0], false)
		sub_457460(unsafe.Pointer(v0))
		if false {
			sub_457FE0()
		}
		v2 := nox_xxx_wndGetChildByID_46B0C0(dword_5d4594_1046492, 10119)
		v3 := unsafe.Pointer(nox_xxx_guiServerOptionsGetGametypeName_4573C0(int16(v0.Field52)))
...
func nox_xxx_bookSetForward_45D200(a1 uint32, a2 int32, a3 *Point32) {
	...
	if a1 == 2 || a1 == 4 {
		v5 := int32(0)
		result := memmap.PtrInt32(0x5D4594, 1046960)
		for {
			if *result == a2 {
				break
			}
		...
		if nox_xxx_buttonHaveSpellInBarMB_4612D0(a2) != 1 {
			...
			if dword_5d4594_1046852 != -1 {
				...
				*memmap.PtrUint32(0x5D4594, 1046628) = 0
				obj_5d4594_1046620.X = *memmap.PtrFloat32(0x5D4594, 1046692) - *memmap.PtrFloat32(0x5D4594, 1046684)
				obj_5d4594_1046620.Y = *memmap.PtrFloat32(0x5D4594, 1046696) - *memmap.PtrFloat32(0x5D4594, 1046688)
...
func nox_xxx_bookSpellDrop_45DCA0(a1 int32, a2 int8, a3 int32, a4 int32, a5 unsafe.Pointer) int32 {
	...
	v14 = 137
	v13 = 0
	if !((wndIsShown_nox_xxx_wndIsShown_46ACC0((*gui.Window)(*memmap.PtrPtr(0x5D4594, 1048148))) != 0 || nox_xxx_spellPutInBox_45DEB0(memmap.PtrInt32(0x5D4594, 1047940), a1, a3, a4) == 0) && a5 != memmap.PtrOff(0x5D4594, 1047940)) {
...
func nox_xxx_quickbarTrapUpDownDraw_45F6F0(win *gui.Window, draw *gui.WindowData) int {
	...
	if *memmap.PtrInt32(0x5D4594, 1049700) <= 0 || *memmap.PtrInt32(0x5D4594, 1049704) != v2 {
		...
		if func() uint32 {
			p := memmap.PtrUint32(0x5D4594, 1049700)
			*p--
			return *p
			...
			if nox_xxx_checkKeybTimeout_4160F0(7, gameFPS()>>1) {
				...
				*memmap.PtrUint32(0x5D4594, 1049712) = 0
				...
				result = int32(func() uint32 {
					p := memmap.PtrUint32(0x5D4594, 1049712)
					*p++
					return *p
				}())
