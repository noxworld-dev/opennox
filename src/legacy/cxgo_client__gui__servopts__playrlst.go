...
func nox_xxx_guiServerPlayersLoad_456270(a1 *gui.Window) *gui.Window {
	...
	dword_5d4594_1045688 = nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1045684)), 10507)
	dword_5d4594_1045692 = nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1045684)), 10509)
	sub_46B120((*gui.Window)(unsafe.Pointer(dword_5d4594_1045684)), (*gui.Window)(a1))
	...
	v4 := nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1045684)), 10502)
	v14 := (*uint32)(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(v3), 4*8)))
	v13 := nox_xxx_gLoadImg_42F970(internCStr("UISlider"))
	v5 := nox_xxx_gLoadImg_42F970(internCStr("UISliderLit"))
	v6 := nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1045684)), 10517)
	v15 := nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1045684)), 10515)
	v11 := nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1045684)), 10516)
	...
	*(*uint32)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(v6), 4*100)), 12)) = 10
	sub_4B5700(unsafe.Pointer(v6), 0, 0, unsafe.Pointer(v13), unsafe.Pointer(v5), unsafe.Pointer(v5))
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(v14), 4*8)) = uint32(uintptr(unsafe.Pointer(v11)))
	v7 := (*uint32)(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(v4), 4*8)))
	v8 := nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1045684)), 10520)
	v16 := nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1045684)), 10518)
	v12 := nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1045684)), 10519)
	...
	*(*uint32)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(v8), 4*100)), 12)) = 10
	sub_4B5700(unsafe.Pointer(v8), 0, 0, unsafe.Pointer(v13), unsafe.Pointer(v5), unsafe.Pointer(v5))
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(v7), 4*8)) = uint32(uintptr(unsafe.Pointer(v12)))
	sub_456500()
	v9 := (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1045684)), 10504)))
...
func sub_4567C0(a1 *gui.Window, a2, a3, a4 uintptr) uintptr {
		...
		if nox_xxx_wndGetID_46B0A0((*gui.Window)(unsafe.Pointer(a3))) == 10502 {
			...
			if nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(a3)), 16404, 0, 0) < 0 {
				...
				if noxflags.HasGame(1) {
					nox_xxx_wnd_46ABB0((*gui.Window)(dword_5d4594_1045692), 1)
				}
				if noxflags.HasGame(128) || *memmap.PtrUint32(0x5D4594, 1045696) == 0 {
					nox_xxx_wnd_46ABB0((*gui.Window)(dword_5d4594_1045688), 1)
				} else {
					nox_xxx_wnd_46ABB0((*gui.Window)(dword_5d4594_1045688), 0)
				}
			}
	...
	if v4 > 10507 {
		if v4 == 10509 {
			...
			nox_xxx_dialogMsgBoxCreate_449A10((*gui.Window)(dword_5d4594_1045684), v27, v28, 163, nil, nil)
		}
		return 0
	}
	if v4 == 10507 {
		v24 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1045684)), 10502)))
	...
	if v4 == 4001 {
		v20 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1045684)), 10502)))
	...
	v5 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1045684)), 10502)))
	v6 = int32(nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(v5)), 16404, 0, 0))
	if v6 >= 0 {
		sub_456D00(v6, &v30[0])
		v29 = sub_418A40(&v30[0])
		if v29 != nil {
			v7 := nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1045684)), 10501)
	...
	v17 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1045684)), 10502)))
	nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(v17)), 16403, math.MaxUint32, 0)
	v18 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1045684)), 10501)))
...
func sub_457010(a1 unsafe.Pointer, a2 *wchar2_t) {
	...
	v2 := sub_4165B0()
	if dword_5d4594_1045684 != nil {
		v4 := (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1045684)), 10502)))
...
func sub_457230(a1 *wchar2_t) {
	...
	if dword_5d4594_1045684 != nil {
		...
		v4 := r2
		if r2 != nil {
			*(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*15)) = uint32(*(*byte)(unsafe.Add(unsafe.Pointer(r2), 57)))
			*(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*17)) = uint32(*(*byte)(unsafe.Add(unsafe.Pointer(r2), 56)))
			*((*uint8)(unsafe.Add(unsafe.Pointer(v3), 64))) = sub_457120(unsafe.Pointer(r2))
			...
			v6 := nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1045684)), 10502)
			nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(v6)), 16397, uintptr(unsafe.Pointer(&v8[0])), uintptr(*((*uint8)(unsafe.Add(unsafe.Pointer(v3), 64)))))
		}
	}
}
