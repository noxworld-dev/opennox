...
LABEL_2:
					...
					for {
						...
						if i <= 0 {
							...
							*(*uint32)(unsafe.Pointer(v29)) = 0
							v2 = v24 - 1
							v21 = (*int32)(unsafe.Add(unsafe.Pointer(v21), -int(4*(NOX_INVENTORY_ROW_COUNT*(unsafe.Sizeof(nox_inventory_cell_t{})/4)))))
	...
	LABEL_35:
		...
		v21 = (*int32)(unsafe.Add(unsafe.Pointer(v21), 4*(NOX_INVENTORY_ROW_COUNT*(unsafe.Sizeof(nox_inventory_cell_t{})/4))))
		if v2 >= 4 {
...
func sub_4624D0(a1 int32) int32 {
	...
	v4 = v3
	if v3 == nil {
		return nox_xxx_spriteDelete_45A4B0((*client.Drawable)(unsafe.Pointer(uintptr(v2))))
	}
...
func nox_xxx_cmdSayDo_46A4B0(a1 *wchar2_t, a2 int32) uint32 {
	...
	if v3 != result {
		...
		*(*uint16)(unsafe.Pointer(&v8[1])) = uint16(nox_player_netCode_85319C)
		...
		result = uint32(nox_netlist_addToMsgListCli_40EBC0(31, 0, (*uint8)(unsafe.Pointer(&v8[0])), v7*int32(v8[8])+11))
	}
	return result
}
...
func sub_46AF00(a1p unsafe.Pointer) *wchar2_t {
	...
	if v1&0x800 != 0 {
		return (*wchar2_t)(unsafe.Pointer(nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(a1))), 16386, 0, 0)))
	}
	if (v1 & 0x80) != 0 {
		return (*wchar2_t)(unsafe.Pointer(nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(a1))), 16413, 0, 0)))
	} else {
		return nil
	}
}
	...
	if int32(*memmap.PtrUint16(0x5D4594, uintptr(v2)+1090312)) != 0 {
		...
		if v3 != 0 {
			...
			*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(*memmap.PtrUint32(0x5D4594, uintptr(v2)+1090296))), 16)) = uint32(uintptr(unsafe.Pointer((*byte)(unsafe.Add(unsafe.Pointer(a1), 15)))))
			ccall.AsFunc[client.ObjectDrawFunc](*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(uintptr(*memmap.PtrUint32(0x5D4594, uintptr(v2)+1090296))), 300)))((*noxrender.Viewport)(memmap.PtrOff(0x5D4594, 1091908)), AsDrawableP(*memmap.PtrPtr(0x5D4594, uintptr(v2)+1090296)))
		}
		nox_xxx_drawSetTextColor_434390(int32(nox_color_white_2523948))
...
func nox_xxx_drawMinimap4Sprite_4725C0(a1 int32) {
	var result *int4
	result = (*int4)(unsafe.Pointer(uintptr(bool2int32(nox_client_drawable_testBuff_4356C0((*client.Drawable)(unsafe.Pointer(uintptr(*memmap.PtrInt32(0x852978, 8)))), 2)))))
	if result == nil {
		sub_437260()
...
func nox_xxx_cliDrawMinimap_472600(a1 int32, a2 int32) int32 {
	...
	for k = int32(uintptr(unsafe.Pointer(nox_xxx_cliFirstMinimapObj_459EB0()))); k != 0; k = nox_xxx_cliNextMinimapObj_459EC0(k) {
		...
		if v44 == *memmap.PtrInt32(0x5D4594, 1096304) {
			if nox_server_teamFirst_418B10() != nil || (func() int32 {
				...
				for !nox_client_drawable_testBuff_4356C0((*client.Drawable)(unsafe.Pointer(uintptr(v45))), 30) {
					v45 = int32(uintptr(unsafe.Pointer(sub_45A010((*client.Drawable)(unsafe.Pointer(uintptr(v45)))))))
					if v45 == 0 {
						goto LABEL_64
					}
				}
	...
	for l = int32(uintptr(unsafe.Pointer(nox_xxx_cliGetSpritePlayer_45A000()))); l != 0; l = int32(uintptr(unsafe.Pointer(sub_45A010((*client.Drawable)(unsafe.Pointer(uintptr(l))))))) {
		v60 = bool2int32(nox_client_drawable_testBuff_4356C0((*client.Drawable)(unsafe.Pointer(uintptr(l))), 30))
...
func nox_xxx_sprite_4757A0_drawable(dr *client.Drawable) int32 {
	var (
		a1     int32 = int32(uintptr(unsafe.Pointer(dr)))
		result int32
		v2     int32
