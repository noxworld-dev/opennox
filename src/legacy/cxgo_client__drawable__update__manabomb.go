...
func nox_xxx_updDrawManabombCharge_4CCAC0(vp *noxrender.Viewport, dr *client.Drawable) int {
	...
	for v19 := int32(20); v19 != 0; v19-- {
		...
		if v7 != 0 {
			...
			*(*uint32)(unsafe.Add(v7, 448)) = gameFrame() + uint32(nox_common_randomIntMinMax_415FF0(10, 30, internCStr("C:\\NoxPost\\src\\client\\Drawable\\Update\\ManaBomb.c"), 88))
			*(*uint32)(unsafe.Add(v7, 444)) = gameFrame()
			*(*uint16)(unsafe.Add(v7, 104)) = 0
			*(*uint8)(unsafe.Add(v7, 296)) = uint8(int8(nox_common_randomIntMinMax_415FF0(2, 8, internCStr("C:\\NoxPost\\src\\client\\Drawable\\Update\\ManaBomb.c"), 94)))
