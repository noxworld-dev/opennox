...
func init() {
	...
	server.RegisterObjectUpdate("PlayerUpdate", ccall.FuncAddr(nox_xxx_updatePlayer_4F8100), unsafe.Sizeof(server.PlayerUpdateData{}))
	_ = nox_xxx_updateProjectile_53AC10
	server.RegisterObjectUpdate("ProjectileUpdate", ccall.FuncAddr(nox_xxx_updateProjectile_53AC10), 0)
	server.RegisterObjectUpdate("SpellProjectileUpdate", ccall.FuncAddr(nox_xxx_spellFlyUpdate_53B940), unsafe.Sizeof(server.SpellProjectileUpdateData{}))
	server.RegisterObjectUpdate("AntiSpellProjectileUpdate", ccall.FuncAddr(nox_xxx_updateAntiSpellProj_53BB00), 28)
	server.RegisterObjectUpdate("DoorUpdate", ccall.FuncAddr(nox_xxx_updateDoor_53AC50), 52)
	server.RegisterObjectUpdate("SparkUpdate", ccall.FuncAddr(nox_xxx_updateSpark_53ADC0), 16)
	server.RegisterObjectUpdate("ProjectileTrailUpdate", ccall.FuncAddr(nox_xxx_updateProjTrail_53AEC0), 0)
	server.RegisterObjectUpdate("PushUpdate", ccall.FuncAddr(nox_xxx_updatePush_53B030), 12)
	server.RegisterObjectUpdate("TriggerUpdate", ccall.FuncAddr(nox_xxx_updateTrigger_53B1B0), 60)
	server.RegisterObjectUpdate("ToggleUpdate", ccall.FuncAddr(nox_xxx_updateToggle_53B060), 60)
	server.RegisterObjectUpdate("MonsterUpdate", ccall.FuncAddr(nox_xxx_unitUpdateMonster_50A5C0), unsafe.Sizeof(server.MonsterUpdateData{}))
	server.RegisterObjectUpdate("LoopAndDamageUpdate", ccall.FuncAddr(sub_53B300), 16)
	server.RegisterObjectUpdate("ElevatorUpdate", ccall.FuncAddr(nox_xxx_updateElevator_53B5D0), 20)
	server.RegisterObjectUpdate("ElevatorShaftUpdate", ccall.FuncAddr(nox_xxx_updateElevatorShaft_53B380), 16)
	server.RegisterObjectUpdate("PhantomPlayerUpdate", ccall.FuncAddr(nox_xxx_updatePhantomPlayer_53B860), 0)
	server.RegisterObjectUpdate("ObeliskUpdate", ccall.FuncAddr(nox_xxx_updateObelisk_53C580), 4)
	server.RegisterObjectUpdate("LifetimeUpdate", ccall.FuncAddr(nox_xxx_updateLifetime_53B8F0), 4)
	server.RegisterObjectUpdate("MagicMissileUpdate", ccall.FuncAddr(nox_xxx_updateMagicMissile_53BDA0), 28)
	server.RegisterObjectUpdate("PixieUpdate", ccall.FuncAddr(nox_xxx_updatePixie_53CD20), 28)
	server.RegisterObjectUpdate("SkullUpdate", ccall.FuncAddr(nox_xxx_updateShootingTrap_54F9A0), 52)
	server.RegisterObjectUpdate("PentagramUpdate", ccall.FuncAddr(nox_xxx_updateTeleportPentagram_53BEF0), 24)
	server.RegisterObjectUpdate("InvisiblePentagramUpdate", ccall.FuncAddr(nox_xxx_updateInvisiblePentagram_53C0C0), 24)
	server.RegisterObjectUpdate("SwitchUpdate", ccall.FuncAddr(nox_xxx_updateSwitch_53B320), 0)
	server.RegisterObjectUpdate("BlowUpdate", ccall.FuncAddr(nox_xxx_updateBlow_53C160), 0)
	server.RegisterObjectUpdate("MoverUpdate", ccall.FuncAddr(nox_xxx_unitUpdateMover_54F740), 36)
	server.RegisterObjectUpdate("BlackPowderBarrelUpdate", ccall.FuncAddr(nox_xxx_updateBlackPowderBarrel_53C9A0), 0)
	server.RegisterObjectUpdate("OneSecondDieUpdate", ccall.FuncAddr(nox_xxx_updateOneSecondDie_53CB60), 0)
	server.RegisterObjectUpdate("WaterBarrelUpdate", ccall.FuncAddr(nox_xxx_updateWaterBarrel_53CB90), 0)
	server.RegisterObjectUpdate("SelfDestructUpdate", ccall.FuncAddr(nox_xxx_updateSelfDestruct_53CC90), 0)
	server.RegisterObjectUpdate("BlackPowderBurnUpdate", ccall.FuncAddr(nox_xxx_updateBlackPowderBurn_53CCB0), 0)
	server.RegisterObjectUpdate("DeathBallUpdate", ccall.FuncAddr(nox_xxx_updateDeathBall_53D080), 0)
	server.RegisterObjectUpdate("DeathBallFragmentUpdate", ccall.FuncAddr(nox_xxx_updateDeathBallFragment_53D220), 0)
	server.RegisterObjectUpdate("MoonglowUpdate", ccall.FuncAddr(nox_xxx_updateMoonglow_53D270), 0)
	server.RegisterObjectUpdate("SentryGlobeUpdate", ccall.FuncAddr(nox_xxx_updateSentryGlobe_510E60), 12)
	server.RegisterObjectUpdate("TelekinesisUpdate", ccall.FuncAddr(nox_xxx_updateTelekinesis_53D330), 0)
	server.RegisterObjectUpdate("FistUpdate", ccall.FuncAddr(nox_xxx_updateFist_53D400), 4)
	server.RegisterObjectUpdate("MeteorShowerUpdate", ccall.FuncAddr(nox_xxx_updateMeteorShower_53D5A0), 4)
	server.RegisterObjectUpdate("MeteorUpdate", ccall.FuncAddr(nox_xxx_meteorExplode_53D6E0), 4)
	server.RegisterObjectUpdate("ToxicCloudUpdate", ccall.FuncAddr(nox_xxx_updateToxicCloud_53D850), 4)
	server.RegisterObjectUpdate("SmallToxicCloudUpdate", ccall.FuncAddr(nox_xxx_updateSmallToxicCloud_53D960), 4)
	server.RegisterObjectUpdate("ArachnaphobiaUpdate", ccall.FuncAddr(nox_xxx_updateArachnaphobia_53DA60), 0)
	server.RegisterObjectUpdate("ExpireUpdate", ccall.FuncAddr(nox_xxx_updateExpire_53DB00), 0)
	server.RegisterObjectUpdate("BreakUpdate", ccall.FuncAddr(nox_xxx_updateBreak_53DB30), 0)
	server.RegisterObjectUpdate("OpenUpdate", ccall.FuncAddr(nox_xxx_updateOpen_53DBB0), 0)
	server.RegisterObjectUpdate("BreakAndRemoveUpdate", ccall.FuncAddr(nox_xxx_updateBreakAndRemove_53DC30), 0)
	server.RegisterObjectUpdate("ChakramInMotionUpdate", ccall.FuncAddr(nox_xxx_updateChakramInMotion_53DCC0), 28)
	server.RegisterObjectUpdate("FlagUpdate", ccall.FuncAddr(nox_xxx_updateFlag_53DDF0), 12)
	server.RegisterObjectUpdate("TrapDoorUpdate", ccall.FuncAddr(nox_xxx_updateTrapDoor_53DE80), 0)
	server.RegisterObjectUpdate("BallUpdate", ccall.FuncAddr(nox_xxx_updateGameBall_53DF40), 32)
	server.RegisterObjectUpdate("CrownUpdate", ccall.FuncAddr(nox_xxx_updateCrown_53E1D0), 12)
	server.RegisterObjectUpdate("UndeadKillerUpdate", ccall.FuncAddr(nox_xxx_updateUndeadKiller_53E190), 0)
