...
func sub_4C09D0() int32 {
	...
	nox_xxx_wndWddSetTooltip_46B000((*gui.WindowData)(unsafe.Pointer((*wchar2_t)(unsafe.Add(unsafe.Pointer(v5), unsafe.Sizeof(wchar2_t(0))*18)))), v6)
	...
	nox_xxx_wndWddSetTooltip_46B000((*gui.WindowData)(unsafe.Pointer((*wchar2_t)(unsafe.Add(unsafe.Pointer(v9), unsafe.Sizeof(wchar2_t(0))*18)))), v10)
	...
	nox_xxx_wndWddSetTooltip_46B000((*gui.WindowData)(unsafe.Pointer((*wchar2_t)(unsafe.Add(unsafe.Pointer(v11), unsafe.Sizeof(wchar2_t(0))*18)))), v12)
	...
	nox_xxx_wndWddSetTooltip_46B000((*gui.WindowData)(unsafe.Pointer((*wchar2_t)(unsafe.Add(unsafe.Pointer(v13), unsafe.Sizeof(wchar2_t(0))*18)))), v14)
	...
	for {
		...
		v17 = 2
		for {
			*((*uint32)(unsafe.Add(unsafe.Pointer(v16), -int(4*1)))) = 0
	...
	for {
		...
		v20 = 2
		for {
			*((*uint32)(unsafe.Add(unsafe.Pointer(v19), -int(4*1)))) = 0
