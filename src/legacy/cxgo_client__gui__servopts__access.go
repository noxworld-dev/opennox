...
func sub_454740() {
	...
	if int32(v0.Field102) < 0 {
		v3.DrawData().Field0 |= 4
	}
	if v0.Field100&0x20 != 0 {
	...
	if int32(v9) != 0 {
		v10 = 0
		v11 := dword_5d4594_1045552.WidgetData
		if int32(v9)&1 != 0 {
	...
	nox_itow(int32(v0.MaxPlayers104), &WideCharStr[0], 10)
	nox_window_call_field_94_fnc((*gui.Window)(*memmap.PtrPtr(0x5D4594, 1045592)), 16414, uintptr(unsafe.Pointer(&WideCharStr[0])), 0)
	for it := nox_common_playerInfoGetFirst_416EA0(); it != nil; it = nox_common_playerInfoGetNext_416EE0(it) {
		if it.PlayerInd != 31 || !nox_common_getEngineFlag(NOX_ENGINE_FLAG_DISABLE_GRAPHICS_RENDERING) {
			sub_455920((*wchar2_t)(unsafe.Add(unsafe.Pointer(it), 4704)))
		}
	}
	sub_455800()
}
