...
func sub_454740() *int32 {
	...
	if int32(*(*int16)(unsafe.Add(unsafe.Pointer(v0), 105))) != -1 {
		...
		*(*uint32)(unsafe.Add(*memmap.PtrPtr(0x5D4594, 1045568), 36)) |= 4
		...
		nox_window_call_field_94_fnc((*gui.Window)(*(*unsafe.Pointer)(unsafe.Pointer(&dword_5d4594_1045584))), 16414, uintptr(unsafe.Pointer(&WideCharStr[0])), 0)
	}
	if int32(*(*int16)(unsafe.Add(unsafe.Pointer(v0), 107))) != -1 {
		...
		*(*uint32)(unsafe.Add(*memmap.PtrPtr(0x5D4594, 1045572), 36)) |= 4
		...
		nox_window_call_field_94_fnc((*gui.Window)(*(*unsafe.Pointer)(unsafe.Pointer(&dword_5d4594_1045588))), 16414, uintptr(unsafe.Pointer(&WideCharStr[0])), 0)
	}
	...
	if *(*byte)(unsafe.Add(unsafe.Pointer(v0), 100))&0x20 != 0 {
		nox_xxx_wnd_46ABB0((*gui.Window)(*(*unsafe.Pointer)(unsafe.Pointer(&dword_5d4594_1045556))), 1)
		*(*uint32)(unsafe.Add(*memmap.PtrPtr(0x5D4594, 1045524), 36)) |= 4
	}
	nox_window_call_field_94_fnc((*gui.Window)(*(*unsafe.Pointer)(unsafe.Pointer(&dword_5d4594_1045556))), 16414, uintptr(unsafe.Add(unsafe.Pointer(v0), 78)), 0)
	if sub_4D6F30() != 0 {
		nox_xxx_wnd_46ABB0((*gui.Window)(*(*unsafe.Pointer)(unsafe.Pointer(&dword_5d4594_1045520))), 0)
	} else {
		nox_xxx_wnd_46ABB0((*gui.Window)(*(*unsafe.Pointer)(unsafe.Pointer(&dword_5d4594_1045520))), 1)
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(v5), 4*9)) |= 4
	...
	nox_window_call_field_94_fnc((*gui.Window)(*(*unsafe.Pointer)(unsafe.Pointer(&dword_5d4594_1045552))), 16397, uintptr(unsafe.Pointer(v6)), math.MaxUint32)
	v7 = nox_strman_loadString_40F1D0(internCStr("WIZARD"), nil, internCStr("C:\\NoxPost\\src\\client\\Gui\\ServOpts\\access.c"), 243)
	nox_window_call_field_94_fnc((*gui.Window)(*(*unsafe.Pointer)(unsafe.Pointer(&dword_5d4594_1045552))), 16397, uintptr(unsafe.Pointer(v7)), math.MaxUint32)
	v8 = nox_strman_loadString_40F1D0(internCStr("CONJURER"), nil, internCStr("C:\\NoxPost\\src\\client\\Gui\\ServOpts\\access.c"), 244)
	nox_window_call_field_94_fnc((*gui.Window)(*(*unsafe.Pointer)(unsafe.Pointer(&dword_5d4594_1045552))), 16397, uintptr(unsafe.Pointer(v8)), math.MaxUint32)
	if *(*byte)(unsafe.Add(unsafe.Pointer(v0), 100))&0x10 != 0 {
	...
	if int32(v9) != 0 {
		...
		if int32(v9)&1 != 0 {
			**(**uint32)(unsafe.Add(unsafe.Pointer(uintptr(v11)), 48)) = 0
			v10 = 1
			*(*uint32)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(uintptr(v11)), 48)), 4)) = math.MaxUint32
		}
