...
func sub_452580(a1 *uint32) int32 {
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*44)) = uint32(result)
	if result != 0 {
		v4 = nox_common_randomIntMinMax_415FF0(int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 76)))), int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 80)))), internCStr("C:\\NoxPost\\src\\client\\Audio\\AudEvent.c"), 1482)
		...
		*(*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*44)) + 112))) = uint32(uintptr(unsafe.Pointer((*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*46)))))
		if int32(*(*uint8)(unsafe.Pointer(uintptr(v1 + 4))))&8 != 0 {
			v5 = nox_common_randomIntMinMax_415FF0(int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 68)))), int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 72)))), internCStr("C:\\NoxPost\\src\\client\\Audio\\AudEvent.c"), 1497)
			if v5 > 33 {
...
func sub_452770(a1 *uint32) int32 {
	...
	v2 = (*uint32)(unsafe.Pointer(uintptr(sub_451CF0((*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*38)))))))))
	...
	if (int32(*(*uint8)(unsafe.Pointer(uintptr(v4 + 4))))&8) == 0 || v2 != nil || *(*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*142)) != 0 {
		v5 = uint32(nox_common_randomIntMinMax_415FF0(int32(*(*uint32)(unsafe.Pointer(uintptr(v4 + 68)))), int32(*(*uint32)(unsafe.Pointer(uintptr(v4 + 72)))), internCStr("C:\\NoxPost\\src\\client\\Audio\\AudEvent.c"), 706))
		if v5 < 0x21 {
			sub_4BDB90(a1, v2)
			return 0
		}
