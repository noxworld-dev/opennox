...
func nox_xxx_mapGenClientText_4A9D00(a1 *uint8) int16 {
	...
	*memmap.PtrUint32(0x5D4594, 1309668) = uint32(*(*uint16)(unsafe.Add(unsafe.Pointer(a1), 1)))
	...
	nox_client_drawImageAt_47D2C0((*nox_video_bag_image_t)(unsafe.Pointer(uintptr(*memmap.PtrUint32(0x5D4594, uintptr((*memmap.PtrUint32(0x5D4594, 1309672)%4))*4+1309644)))), v4, v3)
	nox_client_drawImageAt_47D2C0((*nox_video_bag_image_t)(unsafe.Pointer(uintptr(*memmap.PtrUint32(0x5D4594, uintptr(*memmap.PtrUint32(0x5D4594, 1309672))*4+1309516)))), v4, v3)
	switch *v1 {
	case 0x9B:
