...
func sub_4CD150(a1 int32, a2 *uint32, a3 int32, a4 int32) {
	...
	*((*uint8)(unsafe.Pointer(&v4))) = *(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(a3)), 432))
	if int32(uint8(int8(v4))) == 0 {
		if a3 == -432 {
			return
		}
		if a4 != 0 {
			v5 = int32(*(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(a3)), 441))) + nox_common_randomIntMinMax_415FF0(-20, 20, internCStr("C:\\NoxPost\\src\\client\\Drawable\\Update\\charmup.c"), 28)
			v6 = nox_common_randomIntMinMax_415FF0(-20, 20, internCStr("C:\\NoxPost\\src\\client\\Drawable\\Update\\charmup.c"), 29)
			*(*uint16)(unsafe.Add(unsafe.Pointer(&v7), unsafe.Sizeof(uint16(0))*0)) = *(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(a3)), 437))
			v8 = int32(*(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(a3)), 443))) + v6
			*(*uint16)(unsafe.Add(unsafe.Pointer(&v9), unsafe.Sizeof(uint16(0))*0)) = *(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(a3)), 439))
		} else {
			v5 = int32(*(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(a3)), 437))) + nox_common_randomIntMinMax_415FF0(-20, 20, internCStr("C:\\NoxPost\\src\\client\\Drawable\\Update\\charmup.c"), 36)
			v10 = nox_common_randomIntMinMax_415FF0(-20, 20, internCStr("C:\\NoxPost\\src\\client\\Drawable\\Update\\charmup.c"), 37)
			*(*uint16)(unsafe.Add(unsafe.Pointer(&v7), unsafe.Sizeof(uint16(0))*0)) = *(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(a3)), 441))
			v8 = int32(*(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(a3)), 439))) + v10
			*(*uint16)(unsafe.Add(unsafe.Pointer(&v9), unsafe.Sizeof(uint16(0))*0)) = *(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(a3)), 443))
		}
	...
	if nox_xxx_netTestHighBit_578B70(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a3)), 437))) != 0 {
		v11 = nox_xxx_netClearHighBit_578B30(int16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a3)), 437)))))
		v12 = (*uint32)(nox_xxx_netSpriteByCodeStatic_45A720(v11).C())
	} else {
		v13 = nox_xxx_netClearHighBit_578B30(int16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a3)), 437)))))
		v12 = (*uint32)(nox_xxx_netSpriteByCodeDynamic_45A6F0(v13).C())
	}
	v14 = v12
	if nox_xxx_netTestHighBit_578B70(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a3)), 441))) != 0 {
		v15 = nox_xxx_netClearHighBit_578B30(int16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a3)), 441)))))
		v4 = int32(uintptr(unsafe.Pointer(nox_xxx_netSpriteByCodeStatic_45A720(v15))))
	} else {
		v16 = nox_xxx_netClearHighBit_578B30(int16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a3)), 441)))))
	...
	if a4 == 0 {
		...
		v7 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v17)), 12)))
		v8 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v14), 4*4)) + uint32(v19))
		v9 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v17)), 16)))
		*(*uint16)(unsafe.Add(unsafe.Pointer(&v25), unsafe.Sizeof(uint16(0))*0)) = uint16(int16(v9))
		goto LABEL_20
	}
	v5 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v4)), 12)) + uint32(nox_common_randomIntMinMax_415FF0(-20, 20, internCStr("C:\\NoxPost\\src\\client\\Drawable\\Update\\charmup.c"), 70)))
	...
	v8 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v17)), 16)) + uint32(v18))
	v25 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v14), 4*4)))
LABEL_20:
	v20 = int32(uint32(v5) + *a2 - *(*uint32)(unsafe.Add(unsafe.Pointer(a2), 4*4)))
	v27 = int32(*(*int16)(unsafe.Add(unsafe.Pointer(uintptr(a3)), 104)))
	...
	if v4 != 0 {
		...
		*(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(v22)), 432)) = uint16(int16(v7))
		*(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(v22)), 434)) = uint16(int16(v25))
		*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(v22)), 443)) = uint8(v23)
		...
		*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(v22)), 444)) = uint8(int8(v4))
	}
	return
}
