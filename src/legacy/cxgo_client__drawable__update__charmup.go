...
func sub_4CD150(a1 int32, a2 *uint32, a3 int32, a4 int32) {
	...
	*((*uint8)(unsafe.Pointer(&v4))) = *(*uint8)(unsafe.Add(a3, 432))
	if int32(uint8(int8(v4))) == 0 {
		if a3 == -432 {
			return
		}
		if a4 != 0 {
			v5 = int32(*(*uint16)(unsafe.Add(a3, 441))) + nox_common_randomIntMinMax_415FF0(-20, 20, internCStr("C:\\NoxPost\\src\\client\\Drawable\\Update\\charmup.c"), 28)
			v6 = nox_common_randomIntMinMax_415FF0(-20, 20, internCStr("C:\\NoxPost\\src\\client\\Drawable\\Update\\charmup.c"), 29)
			*(*uint16)(unsafe.Add(unsafe.Pointer(&v7), unsafe.Sizeof(uint16(0))*0)) = *(*uint16)(unsafe.Add(a3, 437))
			v8 = int32(*(*uint16)(unsafe.Add(a3, 443))) + v6
			*(*uint16)(unsafe.Add(unsafe.Pointer(&v9), unsafe.Sizeof(uint16(0))*0)) = *(*uint16)(unsafe.Add(a3, 439))
		} else {
			v5 = int32(*(*uint16)(unsafe.Add(a3, 437))) + nox_common_randomIntMinMax_415FF0(-20, 20, internCStr("C:\\NoxPost\\src\\client\\Drawable\\Update\\charmup.c"), 36)
			v10 = nox_common_randomIntMinMax_415FF0(-20, 20, internCStr("C:\\NoxPost\\src\\client\\Drawable\\Update\\charmup.c"), 37)
			*(*uint16)(unsafe.Add(unsafe.Pointer(&v7), unsafe.Sizeof(uint16(0))*0)) = *(*uint16)(unsafe.Add(a3, 441))
			v8 = int32(*(*uint16)(unsafe.Add(a3, 439))) + v10
			*(*uint16)(unsafe.Add(unsafe.Pointer(&v9), unsafe.Sizeof(uint16(0))*0)) = *(*uint16)(unsafe.Add(a3, 443))
		}
...
LABEL_20:
	...
	v27 = int32(*(*int16)(unsafe.Add(a3, 104)))
