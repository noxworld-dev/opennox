...
func nox_xxx_netOnPacketRecvServ_51BAD0_net_sdecode_switch(a1 int32, data *uint8, dsz int32, v8p *server.Player, unitp *server.Object, v10p unsafe.Pointer) int32 {
	...
	case 0x72:
		...
		v7 := *(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(uintptr(v85)), 276))
	...
	case 0xC9:
		...
		case 0xF:
			...
			if v68 != nil {
				v69 := *(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(uintptr(v85)), 280))
				if v69 != nil {
		...
		case 0x10:
			...
			v71 := *(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(uintptr(v85)), 280))
			if v71 != nil {
