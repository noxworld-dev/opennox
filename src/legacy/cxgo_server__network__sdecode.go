...
func nox_xxx_netOnPacketRecvServ_51BAD0_net_sdecode_switch(a1 int32, data *uint8, dsz int32, v8p *server.Player, unitp *server.Object, v10p unsafe.Pointer) int32 {
	...
	case 0x79:
		...
		if !noxflags.HasGame(128) && v34 != 0 {
			...
			if (v37 != 1 || !nox_xxx_spellHasFlags_424A50(*v36, 32) || *(*uint32)(unsafe.Add(v85, 288)) == 0 || nox_xxx_unitIsEnemyTo_5330C0((*server.Object)(unit), (*server.Object)(*(*unsafe.Pointer)(unsafe.Add(v85, 288)))) != 0 || noxflags.HasGame(4096)) && nox_xxx_spellByBookInsert_4FE340(unit, (*int32)(unsafe.Add(unsafe.Pointer(data), 1)), v37, 3, int32(*(*uint8)(unsafe.Add(unsafe.Pointer(data), 21)))) == 0 && v37 == 1 {
				v40 := 5
				for v40 != 0 {
					if *v36 != 0 {
	...
	case 0xC9:
		...
		case 0x17:
			...
			if v73 != nil {
				sub_510640_trade(unit, v73, int32(*((*uint16)(unsafe.Add(unsafe.Pointer(data), unsafe.Sizeof(uint16(0))*1)))), (*float32)(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(data), 4))))
			}
			return 5
		case 0x18:
