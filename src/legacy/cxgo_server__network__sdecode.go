...
func nox_xxx_netOnPacketRecvServ_51BAD0_net_sdecode_switch(a1 int32, data *uint8, dsz int32, v8p *server.Player, unitp *server.Object, v10p unsafe.Pointer) int32 {
	...
	case 0x78:
		...
		if (int32(*(*uint8)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(v85, 276)), 3680))) & 1) == 0 {
			if int32(*(*uint16)(unsafe.Add(unsafe.Pointer(data), 1))) != 0 {
				v32 := nox_server_getObjectFromNetCode_4ECCB0(uint32(v31))
				if v32 != nil {
	...
	case 0xE2:
		...
		if v61 != nil || (func() unsafe.Pointer {
			v61 = (*server.Object)(sub_510DE0(unit, v60))
			return v61
	...
	case 0xC9:
		...
		case 0xF:
			...
			v68 := nox_xxx_equipedItemByCode_4F7920(unit, v67)
			if v68 != nil {
				v69 := *(*unsafe.Pointer)(unsafe.Add(v85, 280))
				if v69 != nil {
					if nox_xxx_tradeP2PAddOffer2_50F820_trade((*server.TradeSession)(v69), unit, v68) == 1 {
						sub_4ED0C0(unit, v68)
					}
				}
			}
		...
		case 0x11:
			...
			if v66 != nil {
				nox_xxx_tradeAccept_50F5A0((*server.TradeSession)(v66), unit)
			}
			return 2
		case 0x12:
			if *(*int32)(unsafe.Add(unsafe.Pointer(v10), 4*70)) != 0 {
		...
		case 0x15:
			if nox_xxx_gameGet_4DB1B0() == 0 && (int32(*(*uint8)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(v10), 4*69)), 3680)))&3) == 0 {
				...
				v65 := nox_server_getObjectFromNetCode_4ECCB0(uint32(v64))
				if v65 != nil {
					if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(v65), 12)))&8 != 0 {
		...
		case 0x18:
			...
			if v74 != nil {
				sub_510BE0_trade(unit, v74, (*uint32)(unsafe.Pointer(uintptr(*((*uint16)(unsafe.Add(unsafe.Pointer(data), unsafe.Sizeof(uint16(0))*1)))))))
			}
			return 4
		case 0x19:
			v76 := *(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(v10), 4*70))
			if v76 != nil {
				sub_510D10(unit, v76, int32(*((*uint16)(unsafe.Add(unsafe.Pointer(data), unsafe.Sizeof(uint16(0))*1)))), uint32(*(*uint8)(unsafe.Add(unsafe.Pointer(data), 4))))
			}
			return 5
		case 0x1A:
			v75 := *(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(v10), 4*70))
			if v75 != nil {
				sub_510AE0(unit, v75, (*uint32)(unsafe.Pointer(uintptr(*((*uint16)(unsafe.Add(unsafe.Pointer(data), unsafe.Sizeof(uint16(0))*1)))))))
			}
			return 4
		case 0x1C:
			v77 := *(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(v10), 4*70))
			if v77 != nil {
				sub_5109C0_trade(unit, v77, (*uint32)(unsafe.Pointer(uintptr(*((*uint16)(unsafe.Add(unsafe.Pointer(data), unsafe.Sizeof(uint16(0))*1)))))))
			}
			return 4
		case 0x1E:
