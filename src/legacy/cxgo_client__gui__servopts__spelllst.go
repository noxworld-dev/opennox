...
func sub_453C00(a1 *gui.Window, a2, a3, a4 uintptr) uintptr {
	...
	case 1113, 1114:
		...
		return 0
	case 1115, 1116:
		v5 = (*int16)(dword_5d4594_1045480.WidgetData)
		v6 = 0
		v20 = sub_4165B0()
		if int32(*v5) > 0 {
			v7 = 0
	...
	case 1120, 1121, 1122, 1123, 1124, 1125, 1126, 1127, 1128, 1129, 1130, 1131, 1132, 1133:
		v11 = int32(dword_5d4594_1045480.WidgetData)
		v12 = (*wchar2_t)(unsafe.Add(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(v11, 24))+uint32((sub_4A4800((*nox_scrollListBox_data)(dword_5d4594_1045480.WidgetData))+v4-1120)*524))), 4))
		if v12 == nil {
			sub_459D50(1)
			nox_xxx_clientPlaySoundSpecial_452D80(766, 100)
			return 0
