...
func nox_xxx_itemGetName_4E77E0_obj_util(a1 int32) *wchar2_t {
	...
	if uint32(v1)&0x13001000 != 0 {
		...
		if uint32(v1)&0x11001000 != 0 {
			...
			v3 = (*uint32)(nox_xxx_equipClothFindDefByTT_413270(int32(*(*uint16)(unsafe.Add(a1, 4)))))
		}
		v4 = v3
		if v3 == nil {
			v12 = int32(uintptr(unsafe.Pointer(nox_xxx_getUnitName_4E39D0((*server.Object)(a1)))))
		...
		if v9 != 0 && *(*uint32)(unsafe.Add(v9, 8)) != 0 {
			nox_wcscat((*wchar2_t)(memmap.PtrOff(0x5D4594, 1565660)), internWStr(" "))
		...
		if v10 != 0 && *(*uint32)(unsafe.Add(v10, 12)) != 0 {
			nox_wcscat((*wchar2_t)(memmap.PtrOff(0x5D4594, 1565660)), internWStr(" "))
