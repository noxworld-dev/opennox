...
func nox_xxx_guiSummonCreatureLoad_4C1D80() int32 {
	...
	*memmap.PtrUint32(0x5D4594, 1321000) = 4294967151
	...
	nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1321032)))), sub_4C2BD0, sub_4C24A0, nil)
	...
	nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1321036)))), nox_xxx_wndSummonProc_4C2B10, nox_xxx_guiDrawSummonBox_4C1FE0, sub_4C2C20)
	...
	*memmap.PtrUint32(0x5D4594, 1320996) = uint32(uintptr(unsafe.Pointer(nox_xxx_gLoadImg_42F970(internCStr("CreatureCageBottom")))))
	...
	nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(v3)), sub_4C2BE0, sub_4C24A0, nil)
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*11)) = uint32(v5)
	nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1321040)))), nox_xxx_wndSummonBigButtonProc_4C24B0, nil, sub_4C2CE0)
...
LABEL_16:
	...
	nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1321044)))), nil, sub_4C26F0, nil)
	...
	for i = 0; i < 6; i++ {
		if i != 2 {
			...
			nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(v10)), nox_xxx_clientOrderCreature_4C2A60, sub_4C27F0, nil)
