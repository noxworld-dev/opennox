...
func nox_xxx_guiSummonCreatureLoad_4C1D80() int32 {
	...
	*memmap.PtrUint32(0x5D4594, 1321000) = 4294967151
	...
	nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1321036)))), nox_xxx_wndSummonProc_4C2B10, nox_xxx_guiDrawSummonBox_4C1FE0, ccall.FuncAddr(sub_4C2C20))
