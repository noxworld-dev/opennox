...
func nox_xxx_guiSummonCreatureLoad_4C1D80() int32 {
	...
	*memmap.PtrUint32(0x5D4594, 1321000) = 4294967151
	...
	dword_5d4594_1321032 = nox_window_new(nil, 8, int(nox_win_width)-95, -145, 87, 115, nil)
	nox_window_set_all_funcs(dword_5d4594_1321032, sub_4C2BD0, sub_4C24A0, nil)
	dword_5d4594_1321036 = nox_window_new(dword_5d4594_1321032, 136, 5, 38, 76, 76, nil)
	...
	*memmap.PtrPtr(0x5D4594, 1320996) = nox_xxx_gLoadImg_42F970(internCStr("CreatureCageBottom"))
	v1 = nox_window_new((*gui.Window)(dword_5d4594_1321036), 160, 0, 0, 1, 1, nil)
	v2 = nox_xxx_gLoadImg_42F970(internCStr("CreatureCageTop"))
	...
	v3 = nox_window_new(dword_5d4594_1321032, 8, 19, 0, 48, 39, nil)
	nox_window_set_all_funcs((*gui.Window)(unsafe.Pointer(v3)), sub_4C2BE0, sub_4C24A0, nil)
	*memmap.PtrPtr(0x5D4594, 1321008) = nox_xxx_gLoadImg_42F970(internCStr("CreatureCageHuntButtonLit"))
	*memmap.PtrPtr(0x5D4594, 1321012) = nox_xxx_gLoadImg_42F970(internCStr("CreatureCageHuntButton"))
	*memmap.PtrPtr(0x5D4594, 1321016) = nox_xxx_gLoadImg_42F970(internCStr("CreatureCageGuardButtonLit"))
	*memmap.PtrPtr(0x5D4594, 1321020) = nox_xxx_gLoadImg_42F970(internCStr("CreatureCageGuardButton"))
	dword_5d4594_1321024 = nox_xxx_gLoadImg_42F970(internCStr("CreatureCageEscortButtonLit"))
	*memmap.PtrPtr(0x5D4594, 1321028) = nox_xxx_gLoadImg_42F970(internCStr("CreatureCageEscortButton"))
	v4 = nox_window_new(nil, 168, int(dword_5d4594_1320988+27), int(dword_5d4594_1320992+12), 34, 34, nil)
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*11)) = uint32(v5)
	nox_window_set_all_funcs(dword_5d4594_1321040, nox_xxx_wndSummonBigButtonProc_4C24B0, nil, sub_4C2CE0)
