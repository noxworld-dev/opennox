...
func sub_4EF2E0_exp_level(a1 unsafe.Pointer) {
	...
	if (nox_xxx_gameGet_4DB1B0() != 1 || sub_4DB1C0() == nil) && nox_xxx_gamedataGetFloatTable_419D70(internCStr("XPTable"), int32(*(*byte)(unsafe.Add(unsafe.Pointer(uintptr(v1)), 3684))+1)) <= float64(*(*float32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 28))) {
		*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(v1)), 3684))++
		...
		if noxflags.HasGame(2048) {
			...
			nox_xxx_aud_501960(902, (*server.Object)(unsafe.Pointer(uintptr(a1))), 2, int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 36))))
			v2 = nox_strman_loadString_40F1D0(internCStr("LevelUP"), nil, internCStr("C:\\NoxPost\\src\\Server\\GameMech\\explevel.c"), 253)
			nox_xxx_netSendLineMessage_4D9EB0((*server.Object)(unsafe.Pointer(uintptr(a1))), v2)
		}
	}
}
func nox_xxx_plyrGiveExp_4EF3A0_exp_level(a1 unsafe.Pointer, a2 float32) {
	...
	*(*float32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 28)) = a2 + *(*float32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 28))
	...
	nox_xxx_netSendLineMessage_4D9EB0((*server.Object)(unsafe.Pointer(uintptr(a1))), v3, uint32(int32(int64(a2))))
