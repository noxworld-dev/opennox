...
func sub_4CE200(a1 int32, a2 int32, a3 int32, a4 int32) int32 {
	...
	if a3 > 0 {
		for {
			...
			v7 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 12)) + uint32(v6**memmap.PtrInt32(0x587000, uintptr(v5*8)+192088)/16))
			v8 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 16)) + uint32(v6**memmap.PtrInt32(0x587000, uintptr(v5*8)+192092)/16))
			...
			v12 = v11
			if v11 != 0 {
				*(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(v11)), 104)) = 0
				nox_xxx_sprite_45A110_drawable((*client.Drawable)(unsafe.Pointer(uintptr(v11))))
				*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(v12)), 432)) = uint8(int8(nox_common_randomIntMinMax_415FF0(1, 3, internCStr("C:\\NoxPost\\src\\Client\\Drawable\\Update\\cloud.c"), 57)))
				*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v12)), 460)) = uint32(uintptr(ccall.FuncAddr(sub_4CE340)))
				v13 = nox_common_randomIntMinMax_415FF0(10, 32, internCStr("C:\\NoxPost\\src\\Client\\Drawable\\Update\\cloud.c"), 61)
				nox_xxx_spriteTransparentDecay_49B950((*client.Drawable)(unsafe.Pointer(uintptr(v12))), v13)
				nox_xxx_spriteToList_49BC80_drawable((*client.Drawable)(unsafe.Pointer(uintptr(v12))))
				nox_xxx_spriteToSightDestroyList_49BAB0_drawable((*client.Drawable)(unsafe.Pointer(uintptr(v12))))
			}
			result = func() int32 {
				p := &a3
				*p--
