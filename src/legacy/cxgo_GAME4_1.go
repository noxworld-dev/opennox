...
func nox_server_checkVictory_509A60() {
		...
		for i := int32(int32(uintptr(unsafe.Pointer(nox_xxx_getFirstPlayerUnit_4DA7C0())))); i != 0; i = int32(uintptr(unsafe.Pointer(nox_xxx_getNextPlayerUnit_4DA7F0((*server.Object)(unsafe.Pointer(uintptr(i))))))) {
			...
			if (int32(*(*uint8)(unsafe.Pointer(uintptr(v11 + 3680))))&1) == 0 && *(*uint32)(unsafe.Pointer(uintptr(v11 + 2140))) < uint32(v8) {
				if nox_xxx_servObjectHasTeam_419130(i+48) != 0 {
					var v0 *byte = (*byte)(unsafe.Pointer(nox_xxx_getTeamByID_418AB0(int32(*(*uint8)(unsafe.Pointer(uintptr(i + 52)))))))
					if v6 != nil {
						if v6 != v0 {
							return
						}
	...
	for v3 := (*byte)((*byte)(unsafe.Pointer(nox_server_teamFirst_418B10()))); v3 != nil; v3 = (*byte)(unsafe.Pointer(nox_server_teamNext_418B60((*nox_team_t)(unsafe.Pointer(v3))))) {
		if *((*int32)(unsafe.Add(unsafe.Pointer((*int32)(unsafe.Pointer(v3))), 4*13))) >= v2 {
			nox_xxx_setGameFlags_40A4D0(8)
			nox_xxx_netSendDMTeamWinner_4D8BF0(int32(uintptr(unsafe.Pointer(v3))), 0)
			return
		}
	}
	for v4 := int32(int32(uintptr(unsafe.Pointer(nox_xxx_getFirstPlayerUnit_4DA7C0())))); v4 != 0; v4 = int32(uintptr(unsafe.Pointer(nox_xxx_getNextPlayerUnit_4DA7F0((*server.Object)(unsafe.Pointer(uintptr(v4))))))) {
...
func sub_509CF0(a1 *byte, a2 int8, a3 int32) int32 {
	...
	for libc.StrCmp((*byte)(unsafe.Add(unsafe.Pointer((*byte)(unsafe.Pointer(v3))), 12)), a1) != 0 || int32(a2) == int32(*((*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(v3))), 28)))) && a3 == *(*int32)(unsafe.Add(unsafe.Pointer(v3), 4*6)) {
...
func sub_509FF0(a1 int32) int32 {
	var result int32
	result = a1
	if int32(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(a1))) + 16))))&0x20 != 0 {
...
func nox_xxx_monsterCallDieFn_50A3D0(a1 *uint32) int32 {
	...
	nox_xxx_monsterClearActionStack_50A3A0((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1)))))))
	nox_xxx_monsterPushAction_50A260_impl((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1)))))), 31)
	nox_xxx_monsterPushAction_50A260_impl((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1)))))), 30)
	...
	LABEL_13:
		...
		if v6 != 0 && int32(*(*uint8)(unsafe.Pointer(uintptr(v6 + 8))))&4 != 0 {
			...
			*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*3)) = uint32(v7)
			...
			nox_xxx_netUnmarkMinimapObj_417300(int32(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v8 + 276))) + 2064)))), (*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1)))))), 1)
		}
		v9 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*3)))
		*(*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(&v9))), 1)) &= 0xFE
			...
			if int32(v3) >= int32(*(*uint8)(unsafe.Add(unsafe.Pointer(v2), 10)))+1 {
				...
				*(*uint8)(unsafe.Add(unsafe.Pointer(v1), 481)) = func() uint8 {
				...
				if int32(v5) >= int32(v6) {
					if *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v2))), 4*3))) != 0 {
	...
	for {
		...
		case 0x11:
			...
			if v8 != 0 && nox_xxx_unitCanInteractWith_5370E0((*server.Object)(unsafe.Pointer(uintptr(a1))), (*server.Object)(unsafe.Pointer(uintptr(v8))), 0) != 0 {
				...
				*(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*1)) = *(*uint32)(unsafe.Pointer(uintptr(v9 + 56)))
				*(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*2)) = *(*uint32)(unsafe.Pointer(uintptr(v9 + 60)))
			}
		default:
		}
...
func nox_xxx_aiTestUnitDangerous_50B2C0(a1 int32) int32 {
	...
	if (result&0xC080) == 0 && (result&0x2000 != 0 || (int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 16))))&0x49) == 0) && (result&0x2008 != 0 || int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 16))))&2 != 0) {
		...
		for a1a = v7; v9 <= v8; a1a = v9 {
			...
			if v6 <= v19 {
				...
				for {
					...
					*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v10))), -int(4*1)))) = dword_5d4594_2386164
					...
					if v12&8 != 0 || int32(*(*uint8)(unsafe.Pointer(uintptr(v1 + 16))))&2 != 0 {
						...
						*(*uint16)(unsafe.Pointer(v10)) = uint16(v13)
						if (int32(*(*uint8)(unsafe.Pointer(uintptr(v1 + 16)))) & 0x10) == 0 {
		...
		if uint32(result)&0x10000 != 0 {
			alloc.Memcpy(unsafe.Pointer(uintptr(v1+172)), unsafe.Pointer(&v25[0]), 0x3C)
...
func nox_xxx_pathFind_50BA00(a1 int32, a2 int32, a3 *float32, a4 *float32, a5 func(int32, int32, int32) int32, a6 int32) unsafe.Pointer {
	...
	*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v11))), 4*1))) = 0
	*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v11))), 4*2))) = 0
	v14 = v11
	v66 = 0
		...
		for {
			...
			for i = 0; i < 8; i++ {
				...
				if v19 < 4 {
					...
					v60 = int8(int32(uint16(int16(^(int32(*(*uint16)(unsafe.Pointer(uintptr(a2 + 16))))>>8))))&0xD8 | 0x98)
			...
			LABEL_32:
				...
				*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v31))), 4*1))) = uint32(uintptr(unsafe.Pointer(v15)))
				*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v31))), 4*2))) = uint32(uintptr(unsafe.Pointer(v77)))
				v77 = v31
			}
			if sub_50AC20(int32(uintptr(unsafe.Pointer(v15))), (*uint16)(unsafe.Pointer(&v68[0]))) != 0 {
				...
				*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v32))), 4*1))) = uint32(uintptr(unsafe.Pointer(v15)))
				*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v32))), 4*2))) = uint32(uintptr(unsafe.Pointer(v77)))
				v77 = v32
			}
			v15 = (*uint16)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v15))), 4*2))))))
			if v15 != nil {
				continue
			}
			break
	...
	LABEL_40:
		...
		if v64 != 0 {
			...
			if v14 != nil {
				for {
					v35 = (*uint16)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v34))), 4*2))))))
					if nox_xxx_pathfind_preCheckWalls2_50B8A0(a2, int32(*v34), int32(*(*uint16)(unsafe.Add(unsafe.Pointer(v34), unsafe.Sizeof(uint16(0))*1)))) != 0 {
						...
						*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v33))), 4*2))) = *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v34))), 4*2)))
					} else {
						v14 = (*uint16)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v34))), 4*2))))))
					}
					v34 = v35
					if v35 == nil {
						break
		...
		if v65 != 0 {
			...
			if v14 != nil {
				for {
					v46 = (*uint16)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v45))), 4*2))))))
					if a5(a2, int32(*v45), int32(*(*uint16)(unsafe.Add(unsafe.Pointer(v45), unsafe.Sizeof(uint16(0))*1)))) != 0 {
						v33 = v45
					} else if v33 != nil {
						*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v33))), 4*2))) = *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v45))), 4*2)))
					} else {
						v14 = (*uint16)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v45))), 4*2))))))
					}
					v45 = v46
					if v46 == nil {
						break
...
func sub_50C320(a1 int32, a2 int32, a3 *uint32) int32 {
	...
	v6 = a3
	if a3 != nil {
		*(*uint32)(unsafe.Pointer(uintptr(int32(uintptr(dword_5d4594_2386176)) + 0))) = *a3
		*(*uint32)(unsafe.Pointer(uintptr(int32(uintptr(dword_5d4594_2386176)) + 4))) = *(*uint32)(unsafe.Add(unsafe.Pointer(v6), 4*1))
	} else if int32(*(*uint8)(unsafe.Pointer(uintptr(a2 + 12))))&2 != 0 && sub_50AEA0(a2, &v26, (*uint32)(unsafe.Pointer(&a1))) != 0 {
		*(*float32)(unsafe.Pointer(uintptr(int32(uintptr(dword_5d4594_2386176)) + 0))) = v26.field_0
		*(*float32)(unsafe.Pointer(uintptr(int32(uintptr(dword_5d4594_2386176)) + 4))) = v26.field_4
		...
		a2 = int32(*v4)
		*(*float32)(unsafe.Pointer(uintptr(int32(uintptr(dword_5d4594_2386176)) + 0))) = float32(float64(a2)*23.0 + 11.5)
		a2 = int32(*(*uint16)(unsafe.Add(unsafe.Pointer(v4), unsafe.Sizeof(uint16(0))*1)))
		*(*float32)(unsafe.Pointer(uintptr(int32(uintptr(dword_5d4594_2386176)) + 4))) = float32(float64(a2)*23.0 + 11.5)
	}
	v7 = (*uint16)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v4))), 4*1))))))
	v8 = 1
	if v7 != nil {
		for {
			...
			if (int32(v10) & 2) != 0 {
				if sub_50AEA0(int32(uintptr(unsafe.Pointer(v7))), &v26, (*uint32)(unsafe.Pointer(&a1))) == 0 {
					...
					*(*float32)(unsafe.Pointer(uintptr(int32(uintptr(dword_5d4594_2386176)) + v8*8 + 4))) = v26.field_4
			...
			if v9 <= 0 {
				if v9 < 0 {
					if v11 > 0 {
						...
						*(*float32)(unsafe.Pointer(uintptr(int32(uintptr(dword_5d4594_2386176)) + v8*8))) = float32(float64(a2)*23.0 + 23.0 - 2.3)
						...
						v20 = float64(a2)
						*(*float32)(unsafe.Pointer(uintptr(int32(uintptr(dword_5d4594_2386176)) + v8*8 + 4))) = float32(v20*23.0 + 2.3)
						goto LABEL_38
					}
					if v11 < 0 {
						a2 = int32(*v7)
						*(*float32)(unsafe.Pointer(uintptr(int32(uintptr(dword_5d4594_2386176)) + v8*8))) = float32(float64(a2)*23.0 + 23.0 - 2.3)
						a2 = int32(*(*uint16)(unsafe.Add(unsafe.Pointer(v7), unsafe.Sizeof(uint16(0))*1)))
						v18 = float64(a2)
						*(*float32)(unsafe.Pointer(uintptr(int32(uintptr(dword_5d4594_2386176)) + v8*8 + 4))) = float32(v18*23.0 + 23.0 - 2.3)
						goto LABEL_38
					}
					a2 = int32(*v7)
					*(*float32)(unsafe.Pointer(uintptr(int32(uintptr(dword_5d4594_2386176)) + v8*8))) = float32(float64(a2)*23.0 + 23.0 - 2.3)
					a2 = int32(*(*uint16)(unsafe.Add(unsafe.Pointer(v7), unsafe.Sizeof(uint16(0))*1)))
					v19 = float64(a2)
					*(*float32)(unsafe.Pointer(uintptr(int32(uintptr(dword_5d4594_2386176)) + v8*8 + 4))) = float32(v19*23.0 + 11.5)
					goto LABEL_38
				}
				if v11 > 0 {
					a2 = int32(*v7)
				...
				*(*float32)(unsafe.Pointer(uintptr(int32(uintptr(dword_5d4594_2386176)) + v8*8))) = float32(float64(a2)*23.0 + 2.3)
				a2 = int32(*(*uint16)(unsafe.Add(unsafe.Pointer(v7), unsafe.Sizeof(uint16(0))*1)))
				*(*float32)(unsafe.Pointer(uintptr(int32(uintptr(dword_5d4594_2386176)) + v8*8 + 4))) = float32(float64(a2)*23.0 + 2.3)
			}
		LABEL_38:
			v4 = v7
			v7 = (*uint16)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v7))), 4*1))))))
			v8++
			if v7 == nil {
				goto LABEL_39
			}
...
func sub_50CB20(a1 int32, a2 *float32) int32 {
	...
	*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v4))), 4*1))) = 0
	*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v4))), 4*2))) = 0
	...
	for {
		...
		for {
			...
			for {
				v10 = int32(uint32(*v6) + *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v9))), -int(4*1)))))
					...
					if sub_50B870(a1, v10, v16) == 0 {
						if sub_50C830(a1, v10, v11) != 0 {
							...
							if v12 != nil {
								...
								*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v12))), 4*1))) = uint32(uintptr(unsafe.Pointer(v6)))
								*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v12))), 4*2))) = uint32(uintptr(unsafe.Pointer(v19)))
								v19 = v12
							}
						}
					}
			...
			v6 = (*uint16)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v6))), 4*2))))))
			if v6 == nil {
				break
			}
		}
...
func nox_xxx_creatureSetDetailedPath_50D220(a1 int32, a2 int32) int32 {
	...
	*(*uint32)(unsafe.Pointer(uintptr(v3 + 268))) = 0
	if (gameFrame() - uint32(v4)) >= 0xA {
		...
		*(*uint32)(unsafe.Pointer(uintptr(v3 + 280))) = gameFrame()
	} else {
...
func sub_50D2A0(a1 int32, a2 int32) int32 {
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(v2), 4*93)) = *(*uint32)(unsafe.Pointer(uintptr(a2 + 4)))
...
func sub_50D2E0(a1 int32) int32 {
	...
	if v2 != 0 && *(*uint32)(unsafe.Pointer(uintptr(v1 + 8))) == 0 {
		...
		if int32(*(*uint8)(unsafe.Pointer(uintptr(v1 + 284)))) == 0 {
			...
			*(*uint32)(unsafe.Pointer(uintptr(v1 + v9*8 + 8))) = *(*uint32)(unsafe.Add(unsafe.Pointer(v8), 4*1))
		}
	}
	return bool2int32(nox_xxx_creatureActuallyMove_50D3B0((*float32)(unsafe.Pointer(uintptr(a1)))) != 0 && int32(*(*uint8)(unsafe.Pointer(uintptr(v1 + 284)))) == 2)
}
func nox_xxx_creatureActuallyMove_50D3B0(a1 *float32) int32 {
	...
	v1 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a1))), 4*187))))
	v2 = 0
...
func nox_xxx_creatureSetMovePath_50D5A0(a1 int32) int32 {
	...
	if v8 {
		if v9 == 0 {
			if *(*uint32)(unsafe.Pointer(uintptr(v1 + 296))) == 0 || (gameFrame()-*(*uint32)(unsafe.Pointer(uintptr(v1 + 280)))) > 0xA && (func() bool {
	...
	} else if v9 == 0 || (gameFrame()-*(*uint32)(unsafe.Pointer(uintptr(v1 + 280)))) > 0xA && (func() bool {
	...
	if dword_5d4594_2386212 != 0 {
		for {
			...
			for v3 != 0 {
				...
				if *(*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v4 + 276))) + 4792))) == 1 && *(*uint32)(unsafe.Pointer(uintptr(v4 + 312))) == 0 && nox_xxx_calcDistance_4E6C00((*server.Object)(unsafe.Pointer(uintptr(v3))), (*server.Object)(unsafe.Pointer(uintptr(*v0)))) < 700.0 {
					v2 = 0
				}
...
func sub_50D960() int32 {
	...
	if v0 != 0 {
		for {
			...
			*memmap.PtrUint32(0x5D4594, uintptr(int32(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v1 + 276))) + 2064))))*4)+2386232) = 0
					...
					for {
						if sub_428220((*float2)(unsafe.Pointer(uintptr(*v3+56))), &a2) != 0 {
							...
							if nox_xxx_mapTraceRay_535250(&v39, nil, nil, 69) != 0 {
								...
								*(*uint32)(unsafe.Add(unsafe.Pointer(v5), 4*2)) |= uint32(1 << int32(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v1 + 276))) + 2064)))))
								...
								*memmap.PtrUint32(0x5D4594, uintptr(v7*4)+2386232)++
								if *memmap.PtrUint32(0x5D4594, uintptr(int32(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v1 + 276))) + 2064))))*4)+2386232) > uint32(v35) {
									v36 = 1
								}
								*(*float32)(unsafe.Pointer((*uint32)(unsafe.Add(unsafe.Pointer(v5), 4*uintptr(int32(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v1 + 276))) + 2064))))+3))))) = float32(nox_xxx_calcDistance_4E6C00((*server.Object)(unsafe.Pointer(uintptr(*v3))), (*server.Object)(unsafe.Pointer(uintptr(v0)))))
							}
						}
				...
				if dword_5d4594_2386224 != 0 {
					for {
						...
						if *(*int32)(unsafe.Add(unsafe.Pointer(v26), 4*2))&(1<<v23) != 0 {
							...
							if v30 != 0 {
								*(*uint32)(unsafe.Pointer(uintptr(v30 + 144))) = uint32(*(*int32)(unsafe.Add(unsafe.Pointer(v26), 4*36)))
							}
							v31 = *(*int32)(unsafe.Add(unsafe.Pointer(v26), 4*36))
							if v31 != 0 {
								*(*uint32)(unsafe.Pointer(uintptr(v31 + 140))) = uint32(*(*int32)(unsafe.Add(unsafe.Pointer(v26), 4*35)))
							} else {
		...
		*(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*548)) = uint32(a1)
		...
		if v6&0x2000 != 0 {
			...
			if v7 != nil {
				...
				*(*uint32)(unsafe.Pointer(uintptr(v8 + 28))) = *(*uint32)(unsafe.Add(unsafe.Pointer(a2), 4*14))
				*(*uint32)(unsafe.Pointer(uintptr(v8 + 32))) = *(*uint32)(unsafe.Add(unsafe.Pointer(a2), 4*15))
			...
			nox_xxx_inventoryPutImpl_4F3070((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a2)))))), (*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v7)))))), 1)
		}
	}
	return 1
}
			...
			if *(*uint32)(unsafe.Pointer(uintptr(v1 + 2196))) != 0 {
				...
				if v3 != 0 {
					for {
						...
						if uint32(*(*uint16)(unsafe.Pointer(uintptr(v3 + 4)))) == *memmap.PtrUint32(0x5D4594, 2386360) {
...
func nox_xxx_shopGetItemCost_50E3D0(a1 int32, a2 int32, a3 float32) int32 {
	...
	v4 = 0
	v27 = 0
	v31 = float32(float64(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a3))), 4*0))) + 32)))))
	...
	v7 = int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v3))), 4*0))) + 8))))
	if v7&0x100 != 0 {
		v8 = int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v3))), 4*0))) + 12))))
		if v8&1 != 0 {
			v9 = float64(uint16(int16(nox_xxx_spellPrice_424C40(int32(**(**uint8)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v3))), 4*0))) + 736))))))))
			v31 = float32(v9)
			goto LABEL_17
		}
		if v8&2 != 0 {
			var worth int32 = nox_objectTypeGetWorth(*(**byte)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v3))), 4*0))) + 736))))
			if worth >= 0 {
...
LABEL_17:
	if *(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v3))), 4*0))) + 8)))&0x13001000 != 0 {
		v11 = int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v3))), 4*0))) + 692))))
		v12 = 4
		for {
	...
	v14 = int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v3))), 4*0))) + 8))))
	v30 = v31
	if uint32(v14)&0x1000000 != 0 && int32(*(*uint8)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v3))), 4*0))) + 12))))&0x82 != 0 {
		...
		if *(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v3))), 4*0))) + 12)))&0x47F0000 != 0 {
			v20 = int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v3))), 4*0))) + 736))))
	...
	v21 = *(**uint16)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v3))), 4*0))) + 556)))
	...
	if v4 != 0 && a1 == 0 {
		...
		v23 = int32(*(*uint16)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v3))), 4*0))) + 4))))
		...
		if noxflags.HasGame(4096) {
			...
			if *memmap.PtrUint32(0x587000, 234816) != 0 {
				...
				for {
					...
					v9 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v7))), 4*1))))
					...
					if int32(*v33) != 0 {
						...
						for {
							...
							if int32(*v34) != 0 {
								for {
									{
										var v34p uint32 = *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v34))), -int(4*1))))
										...
										if v35 != nil {
											if *(*uint32)(unsafe.Add(unsafe.Pointer(v35), 4*2))&0x13001000 != 0 {
												v37 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v34))), 4*2))))
												v38 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v34))), 4*4))))
												*(*uint32)(unsafe.Pointer(&v44[4])) = *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v34))), 4*3)))
												*(*uint32)(unsafe.Pointer(&v44[0])) = uint32(v37)
												v39 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v34))), 4*5))))
											...
											if *(*unsafe.Pointer)(unsafe.Pointer(uintptr(v36 + 704))) == ccall.FuncAddr(nox_xxx_XFerSpellReward_4F5F30) {
												**(**uint8)(unsafe.Pointer(uintptr(v36 + 736))) = *(*uint8)(unsafe.Add(unsafe.Pointer(v34), 4))
											}
											if *(*unsafe.Pointer)(unsafe.Pointer(uintptr(v36 + 704))) == ccall.FuncAddr(Nox_xxx_XFerAbilityReward_4F6240) {
												**(**uint8)(unsafe.Pointer(uintptr(v36 + 736))) = *(*uint8)(unsafe.Add(unsafe.Pointer(v34), 4))
											}
											if *(*unsafe.Pointer)(unsafe.Pointer(uintptr(v36 + 704))) == ccall.FuncAddr(Nox_xxx_XFerFieldGuide_4F6390) {
...
func nox_xxx_addItemToShopSession_50EE00(a1 int32, a2 float32) *float32 {
	...
	if result != nil {
		*result = a2
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(result))), 4*1))) = uint32(nox_xxx_shopGetItemCost_50E3D0(1, a1, a2))
		...
		if *(*uint32)(unsafe.Pointer(uintptr(a1 + 20))) != 0 {
			if v4 <= uint32(sub_50EEC0(*(**uint32)(unsafe.Pointer(uintptr(a1 + 20))))) {
				...
				*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v3))), 4*3))) = uint32(v5)
				result = v3
			}
		} else {
...
func sub_50EEC0(a1 *uint32) int32 {
	...
	for {
		...
		v1 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v3))), 4*1))))
...
func sub_50F3A0(a1 *uint32) {
	...
	nox_xxx_playerAddGold_4FA590(int32(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*2))), int32(**(**uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*12)) + 692)))))
	...
	nox_xxx_playerAddGold_4FA590(int32(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*3))), int32(**(**uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*13)) + 692)))))
...
func sub_50F720(a1 int32, a2 *uint32) int32 {
	...
	*(*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(&a1))), 2)) = 0
	if v3 != 0 {
		...
		*(*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(&a1))), 2)) = uint8(int8(bool2int32(*(*uint32)(unsafe.Add(unsafe.Pointer(a2), 4*2)) != uint32(v2)) + 1))
	}
...
func nox_xxx_tradeP2PUpdStuff_50FA00(a1 int32, a2 *uint32) int32 {
	...
	if v2 == a1 {
		...
		*(*uint32)(unsafe.Pointer(&v7[2])) = **(**uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a2), 4*12)) + 692)))
		...
		*(*uint32)(unsafe.Pointer(&v7[2])) = **(**uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a2), 4*13)) + 692)))
		if int32(*(*uint8)(unsafe.Pointer(uintptr(v2 + 8))))&4 != 0 {
			*(*uint32)(unsafe.Pointer(&v7[6])) = 0
		} else {
			*(*uint32)(unsafe.Pointer(&v7[6])) = *(*uint32)(unsafe.Add(unsafe.Pointer(a2), 4*10)) - *(*uint32)(unsafe.Add(unsafe.Pointer(a2), 4*11))
		}
		*(*uint32)(unsafe.Pointer(&v7[10])) = **(**uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a2), 4*12)) + 692)))
	}
...
func sub_50FB90(a1 *uint32) *uint32 {
	...
	if uintptr(unsafe.Pointer(result)) != uintptr(4) || (int32(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*3)) + 8))))&4) != 4 {
		v3 = *(**int32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*12)) + 692)))
		if result != nil {
			nox_xxx_playerAddGold_4FA590(v1, *v3)
		}
		*v3 = 0
		v4 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*3)))
		v5 = *(**int32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*13)) + 692)))
		if int32(*(*uint8)(unsafe.Pointer(uintptr(v4 + 8))))&4 != 0 {
		...
		*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*11)) = uint32(uintptr(unsafe.Pointer(result)))
		if uint32(uintptr(unsafe.Pointer(result))) <= v8 {
			if uint32(uintptr(unsafe.Pointer(result))) < v8 {
				...
				if int32(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*3)) + 8))))&4 != 0 {
					...
					if v13 < v12 {
						...
						**(**uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*13)) + 692))) += v13
					...
					*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*11)) = v8
					result = *(**uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*13)) + 692)))
					*result += v12
				}
			}
		} else {
			v9 = uint32(uintptr(unsafe.Pointer(result))) - v8
			if int32(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*2)) + 8))))&4 != 0 {
				...
				if v10 < v9 {
					...
					**(**uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*12)) + 692))) += v10
					...
					**(**uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*12)) + 692))) += v9
...
func nox_xxx_tradeP2PAddOfferMB_50FE20(a1 int32, a2 int32) int32 {
	...
	if v7 != 0 {
		*(*uint32)(unsafe.Pointer(uintptr(v7 + 12))) = uint32(*(*int32)(unsafe.Add(unsafe.Pointer(v2), 4*3)))
	}
	v8 = *(*int32)(unsafe.Add(unsafe.Pointer(v2), 4*3))
	if v8 != 0 {
		*(*uint32)(unsafe.Pointer(uintptr(v8 + 8))) = uint32(*(*int32)(unsafe.Add(unsafe.Pointer(v2), 4*2)))
	}
	if *(*uint32)(unsafe.Pointer(uintptr(a1 + 8))) == uint32(v3) {
		if *(**int32)(unsafe.Pointer(uintptr(a1 + 32))) == v2 {
			*(*uint32)(unsafe.Pointer(uintptr(a1 + 32))) = uint32(*(*int32)(unsafe.Add(unsafe.Pointer(v2), 4*2)))
		}
	} else if *(**int32)(unsafe.Pointer(uintptr(a1 + 36))) == v2 {
		*(*uint32)(unsafe.Pointer(uintptr(a1 + 36))) = uint32(*(*int32)(unsafe.Add(unsafe.Pointer(v2), 4*2)))
	}
...
func sub_510000(a1 int32) {
	...
	nox_xxx_objectFreeMem_4E38A0((*server.Object)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(a1 + 48)))))))
	nox_xxx_objectFreeMem_4E38A0((*server.Object)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(a1 + 52)))))))
	sub_50F6B0(int32(*(*uint32)(unsafe.Pointer(uintptr(a1 + 32)))))
...
func sub_5103F0(a1 int32, a2 int32) int32 {
	...
	if uint32(*(*uint16)(unsafe.Pointer(uintptr(a1 + 4)))) == *(*uint32)(unsafe.Pointer(uintptr(a2))) {
		v3 = int32(*(*uint32)(unsafe.Pointer(uintptr(a1 + 8))))
		v2 = 1
		if uint32(v3)&0x13001000 != 0 {
			...
			if *(*uint32)(unsafe.Pointer(uintptr(a2 + 16))) != *(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*1)) {
				v2 = 0
			}
			if *(*uint32)(unsafe.Pointer(uintptr(a2 + 20))) != *(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*2)) {
				v2 = 0
			}
			if *(*uint32)(unsafe.Pointer(uintptr(a2 + 24))) != *(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*3)) {
				v2 = 0
			}
		}
		if v3&0x100 != 0 {
			...
			} else if libc.StrCmp(*(**byte)(unsafe.Pointer(uintptr(a1 + 736))), nox_xxx_getUnitNameByThingType_4E3A80(int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 8)))))) != 0 {
				v2 = 0
			}
		}
	}
...
func sub_510AE0(a1 *int32, a2 int32, a3 *uint32) *uint32 {
	...
	if v4 != 0 {
		...
		nox_xxx_unitSetHP_4E4560((*server.Object)(unsafe.Pointer(uintptr(v4))), *(*uint16)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v4 + 556))) + 4))))
		nox_xxx_itemReportHealth_4D87A0(int32(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v5 + 276))) + 2064)))), (*server.Object)(unsafe.Pointer(uintptr(v4))))
		v7 = int32(*(*uint32)(unsafe.Pointer(uintptr(v4 + 8))))
		if v7&0x1000 != 0 && *(*uint32)(unsafe.Pointer(uintptr(v4 + 12)))&0x47F0000 != 0 {
			v8 = int32(*(*uint32)(unsafe.Pointer(uintptr(v4 + 736))))
			if nox_xxx_rechargeItem_53C520(v4, 100) != 0 {
				nox_xxx_netReportCharges_4D82B0(int32(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v5 + 276))) + 2064)))), (*server.Object)(unsafe.Pointer(uintptr(v4))), int8(*(*uint8)(unsafe.Pointer(uintptr(v8 + 108)))), int8(*(*uint8)(unsafe.Pointer(uintptr(v8 + 109)))))
			}
		}
		sub_4D8870(int32(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v5 + 276))) + 2064)))), int32(uintptr(unsafe.Pointer(a1))))
		nox_xxx_aud_501960(803, (*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1)))))), 2, *(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*9)))
	}
	return result
}
func sub_510D10(a1 *int32, a2 int32, a3 int32, a4 uint32) {
	...
	if a4 != 0 {
		for {
			...
			sub_4ED0C0((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1)))))), (*server.Object)(unsafe.Pointer(uintptr(v7))))
...
func nox_xxx_sentryUpdateList_510FD0(a1 *uint32) *uint32 {
	...
	if *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*4)) < 0 {
		...
		if v2 != 0 {
			*(*uint32)(unsafe.Pointer(uintptr(v2 + 496))) = *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*124))
		} else {
			dword_5d4594_2386564 = *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*124))
		}
		v3 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*124)))
		if v3 != 0 {
			*(*uint32)(unsafe.Pointer(uintptr(v3 + 500))) = *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*125))
		}
	}
...
func nox_xxx_sentry_511020(it *server.Object, data unsafe.Pointer) {
	...
	if (v2&0x41) == 0 && ((v2&0x10) == 0 || noxflags.HasGame(4096) && int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 8))))&2 != 0 && (*(*uint32)(unsafe.Pointer(uintptr(a1 + 16)))&0x8000) != 0x8000) && *(*uint32)(unsafe.Pointer(uintptr(a1 + 556))) != 0 && nox_xxx_mathPointOnTheLine_57C8A0(*(**float4)(unsafe.Pointer(uintptr(a2 + 4))), (*float2)(unsafe.Pointer(uintptr(a1+56))), &a3) != 0 {
		...
		if float64(*(*float32)(unsafe.Pointer(uintptr(a1 + 176)))**(*float32)(unsafe.Pointer(uintptr(a1 + 176)))) > v3*v3+float64((*(*float32)(unsafe.Pointer(uintptr(a1 + 56)))-a3.field_0)*(*(*float32)(unsafe.Pointer(uintptr(a1 + 56)))-a3.field_0)) {
			...
			ccall.AsFunc[func(int32, int32, int32, int32, int32)](unsafe.Pointer(uintptr(a1+716)))(a1, v6, v7, 500, 16)
...
func nox_xxx_unitSetDecayTime_511660(a1p *server.Object, a2 int32) int32 {
	...
	if (uint32(result) & 0x10000) == 0 {
		if uint32(result)&0x400000 != 0 {
			nox_xxx_decay_5116F0((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1)))))))
		}
	...
	if dword_5d4594_2386576 != 0 {
		for {
			...
			if *(*uint32)(unsafe.Add(unsafe.Pointer(v0), 4*123)) != 0 {
				nox_xxx_decay_5116F0((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v0)))))))
			} else {
				...
				*(*uint32)(unsafe.Add(unsafe.Pointer(v0), 4*5)) = uint32(v2)
				nox_xxx_delayedDeleteObject_4E5CC0((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v0)))))))
			}
			v0 = v1
			if v1 == nil {
				break
...
func sub_5117F0(a1 *server.Object) int8 {
	...
	if (int32(*(*uint8)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1))) + 8)))) & 1) == 0 {
...
func nox_xxx_updateObjectsVelocity_5118A0(step float32) int32 {
	...
	for j = result; result != 0; j = result {
		if int32(*(*uint8)(unsafe.Pointer(uintptr(j + 16))))&2 != 0 || int32(*(*uint8)(unsafe.Pointer(uintptr(j + 8))))&2 != 0 && nox_xxx_checkMobAction_50A0D0((*server.Object)(unsafe.Pointer(uintptr(j))), 67) != 0 {
			...
			*(*float32)(unsafe.Pointer(uintptr(j + 84))) += (v13 - *(*float32)(unsafe.Pointer(uintptr(j + 84)))**(*float32)(unsafe.Pointer(uintptr(j + 112)))) * step
			...
			v8 = int8(uint8((*(*uint32)(unsafe.Pointer(uintptr(j + 16)))>>12)&4 | 0x41))
		LABEL_20:
...
func nox_xxx_script_511C50(a1 int32) *server.Object {
	...
	for int32(*(*uint8)(unsafe.Pointer(uintptr(*v1 + 16))))&0x20 != 0 || *(*uint32)(unsafe.Pointer(uintptr(*v1 + 44))) != uint32(a1) {
...
func sub_511DC0() int32 {
	...
	*memmap.PtrUint32(0x5D4594, 2386620) = *(*uint32)(unsafe.Pointer(uintptr(*memmap.PtrUint32(0x5D4594, 2386620) + 8)))
	return result
}
...
func nox_xxx_monsterLookAt_5125A0(obj *server.Object, a2 int32) *float32 {
	...
	if int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 8))))&2 != 0 {
		v3 = int32(*(*uint32)(unsafe.Pointer(uintptr(a1 + 16))))
		if (v3 & 0x8000) == 0 {
			v4 = float32(float64(*mem_getFloatPtr(0x587000, uint32(uintptr(unsafe.Pointer(result)))*8+194136))*10.0 + float64(*(*float32)(unsafe.Pointer(uintptr(a1 + 56)))))
		...
		if int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 8))))&2 != 0 {
			...
			if (v3 & 0x8000) == 0 {
				...
				if v4 != nil {
					...
					*(*int32)(unsafe.Add(unsafe.Pointer(v4), 4*2)) = int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 4))))
			...
			if int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 8))))&2 != 0 {
				if a1 != a2 {
					...
					if (v2 & 0x8000) == 0 {
						...
						if v3 != nil {
							*(*int32)(unsafe.Add(unsafe.Pointer(v3), 4*1)) = int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 56))))
							*(*int32)(unsafe.Add(unsafe.Pointer(v3), 4*2)) = int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 60))))
...
func nox_xxx_servParseMonsterDef_517170(a1 *FILE, a2 *byte) int32 {
	...
	LABEL_14:
		...
		switch *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v4))), 4*1))) {
		case 0:
		...
		for nox_strcmpi(&v10[0], (*byte)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(v8))+7)))) != 0 {
...
func sub_517870(a1p *server.Object) int16 {
	...
	if v1&0x200 != 0 {
		sub_5178E0(0, unsafe.Pointer(uintptr(a1+256)))
		...
		v1 = int32(*(*uint32)(unsafe.Pointer(uintptr(a1 + 16))))
		*(*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(&v1))), 1)) &= 0xFD
...
func nox_xxx_netSendPhantomPlrMb_5187E0(a1 int32, a2 int32) int32 {
	...
	*(*uint16)(unsafe.Pointer(&v10[7])) = uint16(int16(v6))
	if int32(*(*uint8)(unsafe.Pointer(uintptr(a2 + 8))))&1 != 0 && int32(*(*uint8)(unsafe.Pointer(uintptr(a2 + 12))))&0x30 != 0 {
...
func nox_xxx_netSendSimpleObj_5188A0(a1 int32, a2 int32) int32 {
	...
	if *(*uint32)(unsafe.Pointer(uintptr(a2 + 8)))&0x20000 != 0 {
		...
		if v2 != nil {
			...
			if (gameFrame() - *(*uint32)(unsafe.Pointer(uintptr(a2 + 536)))) > 2 {
				v4 = *v2
	...
	*(*uint16)(unsafe.Pointer(&v10[1])) = uint16(nox_xxx_netGetUnitCodeServ_578AC0((*server.Object)(unsafe.Pointer(uintptr(a2)))))
	v7 = int16(int32(*(*float32)(unsafe.Pointer(uintptr(a2 + 56)))))
...
func nox_xxx_netSendComplexObject_518960(a1 int32, a2 *uint32, a3 int32) int32 {
		...
		if v5 != nil {
			...
			if (gameFrame() - *(*uint32)(unsafe.Add(unsafe.Pointer(a2), 4*134))) > 2 {
				...
				if int32(v7) != int32(v8) {
					...
					*(*uint16)(unsafe.Pointer(uintptr(v6 + v3*2 + 412))) = *(*uint16)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*139)))))
				}
			}
		}
	}
	...
	*(*uint16)(unsafe.Pointer(&v18[1])) = uint16(nox_xxx_netGetUnitCodeServ_578AC0((*server.Object)(unsafe.Pointer(v4))))
	v10 = int16(int32(*((*float32)(unsafe.Add(unsafe.Pointer((*float32)(unsafe.Pointer(v4))), unsafe.Sizeof(float32(0))*14)))))
	...
	*(*uint16)(unsafe.Pointer(&v18[7])) = uint16(v12)
	...
	if int32(v14)&0x10 != 0 && int32(*(*uint8)(unsafe.Pointer(uintptr(v13 + 2094)))) != 0 && nox_common_randomInt_415FA0(0, 10) >= 8 {
		v18[9] = 14
...
func nox_xxx_netSpriteUpdate_518AE0(a1 int32, a2 int32, a3 *uint32) int32 {
	...
	*(*uint16)(unsafe.Pointer((*byte)(unsafe.Add(unsafe.Pointer((*byte)(unsafe.Pointer(&a3))), 1)))) = uint16(v4)
	if uint32(v5)&0x400000 != 0 && *(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*3))&0x18 != 0 {
		*(*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(&a3))), unsafe.Sizeof((*uint32)(nil))-1)) = *(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*187)))))
	...
	if uint32(uint16(int16(v7))) == *memmap.PtrUint32(0x5D4594, 2386972) {
		v8 = int8(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*187)) + 20))))
	...
	if uint32(v7) == *memmap.PtrUint32(0x5D4594, 2386980) {
		...
		*((*uint8)(unsafe.Pointer(&a3))) = 57
		*(*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(&a3))), unsafe.Sizeof((*uint32)(nil))-1)) = uint8(int8(int32(^(*(*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(&v9))), 4-1)))) & 1))
		return nox_netlist_addToMsgListCli_40EBC0(a2, 1, (*uint8)(unsafe.Pointer(&a3)), 4)
	}
	...
	if v5&0x4000 != 0 {
		v11 = *(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*187)) + 16)))
		*((*uint8)(unsafe.Pointer(&a3))) = 57
	...
	if (v5 & 0x80) != 0 {
		v15 = int8(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*187)) + 12))))
...
func nox_xxx_netPlayerObjSend_518C30(a1p *server.Object, a2p *server.Object, a3 int32, a4 int32) int32 {
		...
		if v8 != nil {
			if (gameFrame() - *(*uint32)(unsafe.Add(unsafe.Pointer(a2), 4*134))) > 2 {
				...
				if int32(v9) != int32(v10) {
					...
					*(*uint16)(unsafe.Pointer(uintptr(v6 + v7*2 + 12))) = *(*uint16)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v5), 4*139)))))
				}
			}
		}
	}
	...
	*(*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v23 + 276))) + uint32(int32(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v6 + 276))) + 2064))))*4) + 4452))) = gameFrame()
	...
	*(*uint16)(unsafe.Pointer(&v22[7])) = uint16(int16(int32(v15)))
	v22[9] = 0
	v22[11] = byte(int8(nox_common_mapPlrActionToStateId_4FA2B0((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v5)))))))))
	...
	if int32(*(*uint16)(unsafe.Pointer(uintptr(v6 + 160)))) != 0 && nox_common_randomInt_415FA0(0, 10) >= 8 {
		v22[11] = 50
		v22[10] = math.MaxUint8
	}
	...
	if int32(*(*uint8)(unsafe.Pointer(uintptr(v6 + 88)))) != 30 && *(*uint32)(unsafe.Pointer(uintptr(v6 + 164))) != 0 {
		...
		v18 = int32((gameFrame() - *(*uint32)(unsafe.Pointer(uintptr(v6 + 164)))) / (uint32(uintptr(unsafe.Pointer(a2))) + 1))
		if v18 >= a4 || (gameFrame()-*(*uint32)(unsafe.Pointer(uintptr(v6 + 164)))) >= 4 {
	...
	*((*uint8)(unsafe.Pointer(&a2))) = uint8(int8(int32(*((*uint8)(unsafe.Pointer(&a2a.field_0)))) + int32(*((*uint8)(unsafe.Pointer(&a2a.field_4))))*3 + 4))
	...
	if a3 != 0 {
		result = bool2int32(nox_netlist_addToMsgListSrv_40EF40(int32(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v23 + 276))) + 2064)))), (*uint8)(unsafe.Pointer(&v22[0])), 12))
	} else {
...
func nox_xxx_netSendObjects2Plr_519410(a1p *server.Object, a2p *server.Object) int8 {
	...
	*((*uint8)(unsafe.Pointer(&v4))) = *(*uint8)(unsafe.Pointer(uintptr(a2 + 16)))
	v5 = v3
	if (v4&0x20) == 0 && (*(*uint32)(unsafe.Pointer(uintptr(a2 + 8)))&0x40000000) == 0 {
		v6 = 1 << v3
		if a2 != a1 && uint32(v6)&*(*uint32)(unsafe.Pointer(uintptr(a2 + 140))) != 0 {
			nox_xxx_netFriendAddRemove_4D97A0(v3, (*uint32)(unsafe.Pointer(uintptr(a2))), bool2int32((uint32(v6)&*(*uint32)(unsafe.Pointer(uintptr(a2 + 144)))) != 0))
		...
		if uint32(v6)&*(*uint32)(unsafe.Pointer(uintptr(a2 + 152))) != 0 || int32(*(*uint8)(unsafe.Pointer(uintptr(a2 + 8))))&1 != 0 {
			...
			if (v7&0x800) == 0 || nox_xxx_unitHasThatParent_4EC4F0((*server.Object)(unsafe.Pointer(uintptr(a2))), (*server.Object)(unsafe.Pointer(uintptr(a1)))) != 0 || (func() int32 {
				...
				if uint32(v4)&0x20400000 != 0 || (func() int32 {
					...
					} else if *(*uint32)(unsafe.Pointer(uintptr(a2 + v5*4 + 560)))&0xFFF != 0 {
						*(*uint32)(unsafe.Pointer(uintptr(a2 + v5*4 + 560))) |= (*(*uint32)(unsafe.Pointer(uintptr(a2 + v5*4 + 560))) & 0xFFF) << 16
					}
...
func sub_519710(a1 unsafe.Pointer) int32 {
	var result int32
	result = sub_417270(int32(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(uint32(uintptr(a1)) + 276))) + 2064)))))
	if result != 0 {
		result = bool2int32(result > 60 || gameFrame()-*(*uint32)(unsafe.Pointer(uintptr(uint32(uintptr(a1)) + 268))) > uint32(60/result))
	}
	return result
}
	...
	*(*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(&v2))), unsafe.Sizeof(uint16(0))*1)) = 0
	for i = (*uint8)(memmap.PtrOff(0x587000, 249904)); ; i = (*uint8)(unsafe.Add(unsafe.Pointer(i), 16)) {
		*(*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(&v2))), unsafe.Sizeof(uint16(0))*0)) = *(*uint16)(unsafe.Pointer(uintptr(a1 + 4)))
		if *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), -int(4*1)))) == uint32(v2) {
			break
		}
		v4 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), 4*4))))
		v1++
		if v4 == 0 {
			return 0
		}
...
func sub_51A550() *byte {
	...
	if *memmap.PtrUint32(0x587000, 249904) != 0 {
		...
		for {
			*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v1))), 4*3))) = uint32(nox_xxx_getNameId_4E3AA0(result))
			*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v1))), 4*1))) = uint32(nox_xxx_getNameId_4E3AA0(*(**byte)(unsafe.Pointer(v1))))
			result = (*byte)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v1))), 4*6))))))
...
func nox_xxx_spawnHecubahQuest_51A5A0(a1 *int32) {
	...
	if v1 != nil {
		...
		if v3 != 0 {
			...
			v4 = int32(*(*uint16)(unsafe.Pointer(uintptr(int32(uintptr(nox_xxx_objectTypeByIndHealthData(int32(*((*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(v1))), unsafe.Sizeof(uint16(0))*2))))))) + 4))))
		}
		if float64(v16) < 1.0 {
			v16 = 1.0
		}
		...
		v17 = float32(v5)
		nox_xxx_unitSetHP_4E4560((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v1)))))), uint16(int16(int64(v5))))
		*(*uint16)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*139)) + 4))) = uint16(int16(int32(v17)))
		if int32(*(*uint16)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*139)))))) == 0 {
			nox_xxx_unitSetHP_4E4560((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v1)))))), 1)
		}
		...
		*(*uint32)(unsafe.Add(unsafe.Pointer(v2), 4*330)) = 1062836634
		nox_xxx_createAt_4DAA50((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v1)))))), nil, *(*float32)(unsafe.Pointer(a1)), *((*float32)(unsafe.Add(unsafe.Pointer((*float32)(unsafe.Pointer(a1))), unsafe.Sizeof(float32(0))*1))))
		...
		if v7 != nil {
			...
			if v9 != nil {
				nox_xxx_inventoryPutImpl_4F3070((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v1)))))), (*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v9)))))), 0)
			}
			...
			if v11 != nil {
				nox_xxx_inventoryPutImpl_4F3070((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v1)))))), (*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v11)))))), 0)
			}
			...
			if v13 != nil {
				nox_xxx_inventoryPutImpl_4F3070((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v1)))))), (*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v13)))))), 0)
			}
			...
			if v15 != nil {
				nox_xxx_inventoryPutImpl_4F3070((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v1)))))), (*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v15)))))), 0)
			}
			nox_xxx_objectFreeMem_4E38A0((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v7)))))))
		}
	}
}
func nox_xxx_spawnNecroQuest_51A7A0(a1 *int32) {
	...
	if v1 != nil {
		...
		v11 = float32(v5)
		nox_xxx_unitSetHP_4E4560((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v1)))))), uint16(int16(int64(v5))))
		*(*uint16)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*139)) + 4))) = uint16(int16(int32(v11)))
		if int32(*(*uint16)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*139)))))) == 0 {
			nox_xxx_unitSetHP_4E4560((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v1)))))), 1)
		}
		v6 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*139)))
		...
		*(*float32)(unsafe.Pointer(&v14)) = float32(v7)
		...
		if float64(*(*float32)(unsafe.Pointer(uintptr(v1 + 104)))) < -50.0 {
			...
			*(*uint32)(unsafe.Pointer(uintptr(v1 + 16))) &= 0xFFFBFFFF
			nox_xxx_unitMove_4E7010((*server.Object)(unsafe.Pointer(uintptr(v1))), (*float2)(unsafe.Pointer(uintptr(v1+164))))
		}
...
func sub_51D300(a1 int32, a2 int32, a3 int8) int32 {
	...
	if int32(v3) > 0 {
		...
		for {
			if *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v6))), -int(4*1)))) == uint32(a2) && int32(*v6) == int32(a3) {
				break
			}
			v4++
