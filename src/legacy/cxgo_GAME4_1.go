...
func sub_50D2A0(a1 *server.Object, a2 *types.Pointf) {
	v2 := a1.UpdateDataMonster()
	v2.Field92 = uint32(a2.X)
	v2.Field93 = uint32(a2.Y)
	result := sub_547F20(a1, a2)
	v2.Field74 = uint32(result)
	v2.Field91 = 0
}
func sub_50D2E0(a1 *server.Object) int32 {
	var (
		v1 int32
		v2 int32
		v3 int32
	...
	if !(v2 != 0 && *(*uint32)(unsafe.Add(v1, 8)) == 0) {
		return bool2int32(nox_xxx_creatureActuallyMove_50D3B0(a1) != 0 && int32(*(*uint8)(unsafe.Add(v1, 284))) == 2)
	}
	v3 = int32(*(*uint32)(unsafe.Add(v1, 364)))
	v4 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v1+v3*4)), 300)))
	v5 = float64(*(*float32)(unsafe.Add(v4, 8)) - a1.PosVec.X)
	v6 = float64(*(*float32)(unsafe.Add(v4, 12)) - a1.PosVec.Y)
	if v6*v6+v5*v5 < 64.0 {
		if v3 == v2-1 {
...
func nox_xxx_creatureActuallyMove_50D3B0(a1 *server.Object) int32 {
	var (
		v1  int32
		v2  int32
		v3  float32
	...
	for {
		...
		if nox_xxx_mapTraceRay_535250(&v23, nil, nil, -124) != 0 {
			v6 = float64(v23.field_8 - a1.PosVec.X)
			v7 = float64(v23.field_C - a1.PosVec.Y)
			v8 = v7*v7 + v6*v6
			if v8 > 64.0 {
...
func nox_xxx_creatureSetMovePath_50D5A0(a1 *server.Object) int32 {
	var (
		v2  float64
		v4  float64
		v6  float32
	...
	v2 = float64(*(*float32)(unsafe.Pointer(&act.Args[0])) - a1.PosVec.X)
	v3 := (*types.Pointf)(unsafe.Pointer(&act.Args[0]))
	v4 = float64(*(*float32)(unsafe.Pointer(&act.Args[1])) - a1.PosVec.Y)
	if math.Sqrt(v4*v4+v2*v2)+*memmap.PtrFloat64(0x581450, 10288) <= 8.0 {
		return 1
	}
	v6 = a1.PosVec.Y
	v14.field_0 = a1.PosVec.X
	v14.field_4 = v6
	v14.field_8 = v3.X
	v7 = int8(uint8((a1.ObjFlags >> 12) & 4))
	v14.field_C = v3.Y
	v8 = nox_xxx_mapTraceRay_535250(&v14, nil, nil, v7) == 0
	v9 = int32(ud.Field2)
	if v8 {
		if v9 == 0 {
			if ud.Field74 == 0 || (gameFrame()-ud.Field70) > 0xA && (func() bool {
				v12 = float64(ud.Field92 - v3.X)
				v13 = float64(ud.Field93 - v3.Y)
			...
			nox_xxx_creatureSetDetailedPath_50D220(a1, v3)
		}
	} else if v9 == 0 || (gameFrame()-ud.Field70) > 0xA && (func() bool {
		v10 = float64(ud.Field68.X - *v3)
		v11 = float64(ud.Field68.Y - v3.Y)
	...
	if ud.Field2 != 0 && nox_xxx_creatureActuallyMove_50D3B0(a1) != 0 {
		ud.Field2 = 0
		return 1
	}
	return 0
...
func sub_50D7E0() {
	nox_alloc_class_free_all(nox_alloc_spawn_2386216)
	dword_5d4594_2386212 = 0
	nox_alloc_class_free_all(nox_alloc_monsterList_2386220)
	dword_5d4594_2386224 = 0
	dword_5d4594_2386228 = 0
}
func sub_50D820() {
	nox_free_alloc_class(nox_alloc_spawn_2386216)
	nox_alloc_spawn_2386216 = nil
	dword_5d4594_2386212 = 0
	nox_free_alloc_class(nox_alloc_monsterList_2386220)
				...
				for {
					if sub_428220((*types.Pointf)(unsafe.Add(unsafe.Pointer(uintptr(*v3)), 56)), &a2) != 0 {
						...
						if nox_xxx_mapTraceRay_535250(&v39, nil, nil, 69) != 0 {
							v5 = sub_50DE60(*v3)
							if v5 == nil {
								v6 = (*uint32)(nox_alloc_class_new_obj_zero(nox_alloc_monsterList_2386220))
								v5 = v6
								if v6 == nil {
									break
								}
		...
		if dword_5d4594_2386224 != 0 {
			for {
				...
				if *(*int32)(unsafe.Add(unsafe.Pointer(v26), 4*2))&(1<<v23) != 0 {
					...
					nox_alloc_class_free_obj_first(nox_alloc_monsterList_2386220, unsafe.Pointer(v26))
...
func sub_50DE10() int32 {
	...
	if dword_5d4594_2386224 != 0 {
		for {
			...
			nox_alloc_class_free_obj_first(nox_alloc_monsterList_2386220, result)
			result = v1
			dword_5d4594_2386228--
			if v1 == 0 {
				break
...
func sub_50DE80(a1 *server.Object, a2 *float32) int32 {
	var (
		v2  int32
		v7  float32
		a2a float4
	...
	for {
		...
		v5 := v4.Player
		if v5.Field4792 != 0 {
			a2a.field_0 = float32(float64(v3.PosVec.X) - float64(v5.Field10) - 100.0)
			a2a.field_4 = float32(float64(v3.PosVec.Y) - float64(v4.Player.Field12) - 100.0)
			a2a.field_8 = float32(float64(v4.Player.Field10) + float64(v3.PosVec.X) + 100.0)
			a2a.field_C = float32(float64(v4.Player.Field12) + float64(v3.PosVec.Y) + 100.0)
			if sub_428220((*types.Pointf)(unsafe.Pointer(a2)), &a2a) != 0 {
				*memmap.PtrUint32(0x5D4594, 2386208) = 0
				nox_xxx_getUnitsInRect_517C10(&a2a, sub_50DFB0, unsafe.Pointer(v3))
...
func sub_50E030(a1, a2 *server.Object) int32 {
	var (
		v3  *uint32
		v6  int32
		v11 int32
	...
	v2 := a1.UpdateData
	v3 = (*uint32)(a2.UpdateData)
	if *(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*549)) != 0 {
		return 1
	}
	result := nox_alloc_class_new_obj_zero(nox_alloc_spawn_2386216)
	v5 := (*uint32)(result)
	if result == nil {
		return 0
	}
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*548)) = uint32(a1)
	...
	if v7 != nil {
		...
		*(*types.Pointf)(unsafe.Add(v8, 28)) = a2.PosVec
		v13 = (*uint32)(v8)
		v14 = 3
		for {
			if *v13 != 0 {
	...
	nox_xxx_inventoryPutImpl_4F3070(a2, v7, 1)
	return 1
}
...
func sub_50E140(a1 *server.Object) {
	if a1 != nil {
		v1 := a1.UpdateDataMonster()
		v2 := v1.Field548
		if v2 != nil {
			*(*uint8)(unsafe.Add(v2.UpdateData, 86))--
			v1.Field548 = nil
		}
		if v1.Field549 != 0 {
			sub_50E1B0(int32(v1.Field549))
			nox_alloc_class_free_obj_first(nox_alloc_spawn_2386216, unsafe.Pointer(v1.Field549))
			v1.Field549 = 0
		}
	}
}
...
func nox_xxx_tradeAccept_50F5A0(a1 *server.TradeSession, a2 *server.Object) {
	var (
		v4 int32
		v5 int32
		v6 int32
...
func sub_5108D0(a1 *server.Object, a2 unsafe.Pointer, a3 int32) *uint32 {
	var (
		v3     int32
		result *uint32
		v5     int32
...
func sub_510AE0(a1 *server.Object, a2 unsafe.Pointer, a3 *uint32) *uint32 {
	var (
		result *uint32
		v4     int32
		v5     int32
	...
	result = (*uint32)(unsafe.Pointer(uintptr(nox_xxx_playerGetGold_4FA6B0(a1))))
	v4 = a1.InvFirstItem
	v5 = a1.UpdateData
	if v4 == 0 {
		return result
	...
	nox_xxx_playerSubGold_4FA5D0(a1, v6)
	...
	sub_4D8870(int32(*(*uint8)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(v5, 276)), 2064))), a1)
	nox_xxx_aud_501960(803, a1, 2, int32(a1.NetCode))
	return result
}
func sub_510D10(a1 *server.Object, a2 unsafe.Pointer, a3 int32, a4 uint32) {
	var (
		result uint16
		v5     int32
		v6     int32
	...
	if a4 != 0 {
		for {
			...
			sub_4ED0C0(a1, (*server.Object)(v7))
...
func sub_510DE0(a1 *server.Object, a2 int32) unsafe.Pointer {
	var (
		v2 int32
		v3 *uint32
	)
	v2 = int32(*(*uint32)(unsafe.Add(a1.UpdateData, 280)))
	if v2 == 0 {
		return nil
	}
...
func nox_xxx_monsterLookAt_5125A0(obj *server.Object, a2 int32) *float32 {
	...
	v4 = float32(float64(*memmap.PtrFloat32(0x587000, uintptr(uint32(uintptr(unsafe.Pointer(result)))*8+194136)))*10.0 + float64(a1.PosVec.X))
	v5 = float32(float64(*memmap.PtrFloat32(0x587000, uintptr(uint32(uintptr(unsafe.Pointer(result)))*8+194140)))*10.0 + float64(a1.PosVec.Y))
...
func sub_517870(obj *server.Object) {
	if obj.ObjFlags&0x200 == 0 {
		return
	}
	sub_5178E0(0, &obj.ObjIndexBase)
	if obj.ObjClass&0x1 == 0 {
		for i := range obj.ObjIndex[:obj.ObjIndexCur] {
			sub_5178E0(1, &obj.ObjIndex[i])
		}
		obj.ObjIndexCur = 0
	}
	obj.ObjFlags = 0xFFFFFDFF
}
...
func nox_xxx_spawnHecubahQuest_51A5A0(a1 *int32) {
	...
	if v1 != nil {
		...
		if v3 != 0 {
			...
			v4 = int32(nox_xxx_objectTypeByIndHealthData(int32(v1.TypeInd)).Max)
		}
		if float64(v16) < 1.0 {
			v16 = 1.0
		}
...
func nox_xxx_spawnNecroQuest_51A7A0(a1 *int32) {
	...
	if v1 != nil {
		...
		if v3 != 0 {
			...
			v4 = int32(nox_xxx_objectTypeByIndHealthData(int32(*(*uint16)(unsafe.Add(unsafe.Pointer(v1), unsafe.Sizeof(uint16(0))*2)))).Max)
		}
		if float64(v10) < 1.0 {
			v10 = 1.0
		}
