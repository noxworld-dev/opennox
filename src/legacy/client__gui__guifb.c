	...
	*getMemU8Ptr(0x5D4594, 1045644) = a1;
	...
	case 0:
		*(uint32_t*)(v2 + 24) = nox_xxx_gLoadImg_42F970("BallAtHome");
		...
		nox_xxx_wndWddSetTooltip_46B000((wchar2_t*)v2, v3);
		break;
	case 1:
		*(uint32_t*)(v2 + 24) = nox_xxx_gLoadImg_42F970("BallAway");
		...
		nox_xxx_wndWddSetTooltip_46B000((wchar2_t*)v2, v4);
		break;
	case 2:
		*(uint32_t*)(v2 + 24) = nox_xxx_gLoadImg_42F970("BallRed");
		...
		nox_xxx_wndWddSetTooltip_46B000((wchar2_t*)v2, v5);
		break;
	case 4:
		*(uint32_t*)(v2 + 24) = nox_xxx_gLoadImg_42F970("BallBlue");
		...
		nox_xxx_wndWddSetTooltip_46B000((wchar2_t*)v2, v6);
		break;
	}
}
