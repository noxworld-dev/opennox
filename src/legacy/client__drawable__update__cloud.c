...
int sub_4CE200(int a1, int a2, int a3, int a4) {
	...
	if (a3 > 0) {
		do {
			...
			v9 =
				nox_common_randomIntMinMax_415FF0(0, 10, "C:\\NoxPost\\src\\Client\\Drawable\\Update\\cloud.c", 46) < 3;
			...
			if (v11) {
				...
				*(uint8_t*)(v12 + 432) =
					nox_common_randomIntMinMax_415FF0(1, 3, "C:\\NoxPost\\src\\Client\\Drawable\\Update\\cloud.c", 57);
				*(uint32_t*)(v12 + 460) = sub_4CE340;
				v13 = nox_common_randomIntMinMax_415FF0(10, 32, "C:\\NoxPost\\src\\Client\\Drawable\\Update\\cloud.c",
														61);
