...
func _nox_wcsicmp(string1 *wchar2_t, string2 *wchar2_t) int32 {
	...
	return unicode.ToLower(rune(*(*wchar2_t)(unsafe.Add(unsafe.Pointer(string1), unsafe.Sizeof(wchar2_t(0))*uintptr(i))))) - unicode.ToLower(rune(*(*wchar2_t)(unsafe.Add(unsafe.Pointer(string2), unsafe.Sizeof(wchar2_t(0))*uintptr(i)))))
}
func nox_strcmpi(string1 *byte, string2 *byte) int32 {
	...
	return unicode.ToLower(rune(*(*byte)(unsafe.Add(unsafe.Pointer(string1), i)))) - unicode.ToLower(rune(*(*byte)(unsafe.Add(unsafe.Pointer(string2), i))))
}
