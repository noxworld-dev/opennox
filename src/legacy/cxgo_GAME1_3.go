...
func Sub_43D440() {
	v0 := memmap.PtrInt32(0x5D4594, uintptr(*memmap.PtrUint32(0x5D4594, 816352))*20+816108)
	if dword_5d4594_816340 == 0 {
		return
	}
...
func sub_43DA80() int32 {
	...
	if dword_5d4594_816368 < 6 {
		sub_43DD10(memmap.PtrInt32(0x5D4594, uintptr(dword_5d4594_816368+dword_5d4594_816372*6)*16+815772))
		dword_5d4594_816368++
		result = 1
	} else {
...
func nox_xxx_drawMessageLines_445530() int32 {
	...
	for i = int32(dword_5d4594_825736); ; v2 = i {
		...
		v6 = memmap.PtrUint16(0x5D4594, uintptr(v5)+823804)
	...
	*memmap.PtrUint32(0x5D4594, uintptr(a1*4)+826040) = 0
	...
	if v2 != nil {
		...
		*(*byte)(unsafe.Add(v3, func() uint32 {
			p := memmap.PtrUint32(0x5D4594, uintptr(a1*4)+826040)
			x := *p
			*p++
			return x
		}())) = 0
