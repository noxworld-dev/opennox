...
func nox_thing_monster_gen_draw(vp *noxrender.Viewport, dr *nox_drawable) int {
	...
	case 0:
		v7 = v5 + v4 + 29
	case 2:
		v7 = int32((gameFrame() + *(*uint32)(unsafe.Pointer(uintptr(v2 + 128)))) / (uint32(*(*uint8)(unsafe.Pointer(uintptr(v5 + v4 + 29)))) + 1))
		if v7 >= v6 {
			v7 %= v6
		}
	case 4:
	...
	if (v13 & 0xC00) == 0 {
		...
		v15 = int32((gameFrame() + *(*uint32)(unsafe.Pointer(uintptr(v2 + 128)))) / (uint32(*(*uint8)(unsafe.Pointer(uintptr(v4 + 33)))) + 1))
		if v15 >= v14 {
			v15 %= v14
		}
		nox_xxx_drawObject_4C4770_draw((*int32)(unsafe.Pointer(a1)), (*nox_drawable)(unsafe.Pointer(uintptr(v2))), int32(*(*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v4 + 20))) + uint32(v15*4))))))
	}
