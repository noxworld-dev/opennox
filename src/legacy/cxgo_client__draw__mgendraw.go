...
func nox_thing_monster_gen_draw(vp *noxrender.Viewport, dr *client.Drawable) int {
	...
	case 0:
		v7 = v5 + v4 + 29
	case 2:
		v7 = int32((gameFrame() + *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 128))) / (uint32(*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(v5+v4)), 29))) + 1))
		if v7 >= v6 {
			v7 %= v6
		}
	case 4:
	...
	case 5:
		v7 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 308)))
	default:
		return 0
	}
	v8 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 280)))
	if v8&0x800 != 0 {
		v9 = *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 120)) & 0xDFFFFFFF
		v7 = v6 - 1
		*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 112)) &= 0xFFF7FFFF
		*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 120)) = v9
	}
	v10 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 432)))
	if v10 != 0 {
		...
		v11 = v10 - 1
		*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 432)) = uint32(v11)
		if v11 == 0 {
			v12 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 280)))
	...
	if (v13 & 0xC00) == 0 {
		...
		v15 = int32((gameFrame() + *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 128))) / (uint32(*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(v4)), 33))) + 1))
		if v15 >= v14 {
			v15 %= v14
		}
	...
	if v16&0x800 != 0 {
		v17 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 120)))
		*((*uint8)(unsafe.Pointer(&v17))) = uint8(int8(v17 | 1))
		*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 120)) = uint32(v17)
	}
	return 1
}
