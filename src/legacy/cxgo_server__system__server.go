	...
	if !noxflags.HasGame(0x2000) || noxflags.HasGame(4096) {
		...
		if result != nil {
			...
			if result != nil {
				...
				*memmap.PtrUint32(0x5D4594, 739400) = *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v5))), 4*10)))
		...
		for j = (*byte)(unsafe.Pointer(nox_common_playerInfoGetFirst_416EA0())); j != nil; j = (*byte)(unsafe.Pointer(nox_common_playerInfoGetNext_416EE0((*server.Player)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(j))))))))) {
			if *(*byte)(unsafe.Add(unsafe.Pointer(j), 2064)) != 31 {
				sub_425F10((*server.Player)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(j)))))))
			}
		}
		sub_426150()
...
func sub_4D2160() {
	...
	for i = result; result != nil; i = result {
		if *(*uint32)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), 4*19))) + 492))) == 0 && sub_418BC0(int32(uintptr(unsafe.Pointer(i)))) != 0 {
			for {
				...
				v4 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(j))), 4*514))))
				if v4 != 0 && nox_xxx_teamCompare2_419180(unsafe.Pointer(uintptr(v4+48)), uint8(*(*byte)(unsafe.Add(unsafe.Pointer(i), 57)))) != 0 {
					break
				}
			}
			...
			*(*uint32)(unsafe.Pointer(uintptr(v3 + 280))) = 0
			...
			if nox_xxx_playerSetState_4FA020((*server.Object)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(uintptr(i + 2056))))), 13) == 0 || !noxflags.HasGame(512) {
				*(*uint32)(unsafe.Pointer(uintptr(i + 4700))) = 0
				...
				nox_xxx_playerMakeDefItems_4EF7D0(int32(*(*uint32)(unsafe.Pointer(uintptr(i + 2056)))), bool2int32(v5 == 0), v6)
			}
			if int32(*(*uint8)(unsafe.Pointer(uintptr(i + 3680))))&0x20 != 0 {
				nox_xxx_playerLeaveObserver_0_4E6AA0((*server.Player)(unsafe.Pointer(uintptr(i))))
				nox_xxx_playerCameraUnlock_4E6040((*server.Object)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(i + 2056)))))))
			}
			*(*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(i + 2056))) + 136))) = gameFrame()
		}
...
func sub_4DBA30(a1 int32) {
	...
	v24 = result
	if result != nil {
		v4 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(result))), 4*514))))
		v25 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(result))), 4*514))))
		if v4 != 0 {
			...
			if a1 == 1 {
				...
				if v5 != 0 {
					for {
						...
						if uint32(*(*uint16)(unsafe.Pointer(uintptr(v5 + 4)))) == *memmap.PtrUint32(0x5D4594, 1563128) {
							nox_xxx_unitMove_4E7010((*server.Object)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v2))), 4*514)))))), (*float2)(unsafe.Pointer(uintptr(v5+56))))
							*(*uint32)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v2))), 4*514))) + 44))) = *(*uint32)(unsafe.Pointer(uintptr(v5 + 44)))
							*(*uint32)(unsafe.Pointer(uintptr(v5 + 44))) = 0
							...
							if v6&2 != 0 {
								...
								*(*uint32)(unsafe.Pointer(uintptr(v7 + 1216))) = uint32(sub_4ECF10(int32(*(*uint32)(unsafe.Pointer(uintptr(v7 + 1216))))))
								...
								if (v6&0x80) != 0 && *(*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v5 + 748))) + 12))) != *(*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v5 + 748))) + 4))) {
				...
				if dword_5d4594_1563096 != 0 {
					...
					if v16 != 0 {
						for {
							...
							if int32(*(*uint32)(unsafe.Pointer(uintptr(v16 + 16)))) >= 0 && nox_xxx_isUnit_4E5B50((*server.Object)(unsafe.Pointer(uintptr(v16)))) != 0 {
									...
									if v17&0x2000 != 0 {
										...
										if v18 != 0 {
											for {
												...
												if uint32(*(*uint16)(unsafe.Pointer(uintptr(v18 + 4)))) == *memmap.PtrUint32(0x5D4594, 1563132) {
			...
			for i = int32(*(*uint32)(unsafe.Pointer(uintptr(v4 + 516)))); i != v3; i = int32(*(*uint32)(unsafe.Pointer(uintptr(i + 512)))) {
				if int32(*(*uint8)(unsafe.Pointer(uintptr(i + 8))))&2 != 0 {
					...
					if (int32(*(*uint8)(unsafe.Pointer(uintptr(i + 12)))) & 0x80) != 0 {
	...
	for v0 := int32(int32(dword_5d4594_1568024)); v0 != 0; v0 = int32(*(*uint32)(unsafe.Pointer(uintptr(v0 + 52)))) {
		if *(*uint32)(unsafe.Pointer(uintptr(v0 + 24))) == 0 {
			...
			if v1 == 0 {
				...
				*(*uint32)(unsafe.Pointer(uintptr(v0 + 20))) = gameFrame() + gameFPS()*30
			} else {
				...
				if v3&2 != 0 {
				...
				} else if int32(*(*uint8)(unsafe.Pointer(uintptr(v1 + 16))))&0x20 != 0 {
					...
					*(*uint32)(unsafe.Pointer(uintptr(v0 + 4))) = 0
					...
					if *(*uint32)(unsafe.Pointer(uintptr(v1 + 492))) != 0 || nox_xxx_getUnitDefDd10_4E3BA0(int32(*(*uint16)(unsafe.Pointer(uintptr(v1 + 4))))) == 0 {
						...
						if gameFrame() > (gameFPS()*5 + *(*uint32)(unsafe.Pointer(uintptr(v10 + 128)))) {
							...
							if v12*v12+v11*v11 > 2500.0 {
								...
								nox_xxx_unitMove_4E7010((*server.Object)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v0 + 4)))))), (*float2)(unsafe.Pointer(uintptr(v0+8))))
								...
								} else if uint32(v14)&0x1000000 != 0 && nox_xxx_weaponInventoryEquipFlags_415820((*server.Object)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v0 + 4)))))))&0x82 != 0 {
								...
								if v17 != 0 {
									nox_xxx_unitSetHP_4E4560((*server.Object)(unsafe.Pointer(uintptr(v16))), *(*uint16)(unsafe.Pointer(uintptr(v17 + 4))))
								}
		...
		if gameFrame() < uint32(*(*int32)(unsafe.Pointer(uintptr(v0 + 20)))) || nox_xxx_getUnitDefDd10_4E3BA0(int32(*(*uint32)(unsafe.Pointer(uintptr(v0))))) == 0 {
			continue
		}
		...
		if v5 != nil {
			nox_xxx_createAt_4DAA50((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v5)))))), nil, *(*float32)(unsafe.Pointer(uintptr(v0 + 8))), *(*float32)(unsafe.Pointer(uintptr(v0 + 12))))
			nox_xxx_netSendPointFx_522FF0(-127, (*float2)(unsafe.Pointer(uintptr(v0+8))))
			...
			*(*uint16)(unsafe.Pointer(uintptr(v6 + 126))) = uint16(v7)
			if *(*uint32)(unsafe.Pointer(uintptr(v6 + 8)))&0x13001000 != 0 {
				nox_xxx_modifSetItemAttrs_4E4990((*server.Object)(unsafe.Pointer(uintptr(v6))), (*int32)(unsafe.Pointer(uintptr(v0+28))))
			}
			if *(*uint32)(unsafe.Pointer(uintptr(v6 + 8)))&0x1000000 != 0 && nox_xxx_weaponInventoryEquipFlags_415820((*server.Object)(unsafe.Pointer(uintptr(v6))))&0x82 != 0 {
		...
		if v9 != 0 {
			if int32(*(*uint8)(unsafe.Pointer(uintptr(v9 + 8))))&2 != 0 {
				nox_xxx_delayedDeleteObject_4E5CC0((*server.Object)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v0 + 4)))))))
			}
		}
	...
	if v0 != 0 {
		for {
			...
			if uint32(uint16(int16(v1))) == dword_5d4594_1568300 || uint32(v1) == *memmap.PtrUint32(0x5D4594, 1568304) {
				if int32(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v0 + 692))) + 216))))&0x80 != 0 {
					v7 = nox_server_rewardgen_activateMarker_4F0720(v0, uint32(v9))
					if v7 != nil {
						nox_xxx_createAt_4DAA50((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v7)))))), nil, *(*float32)(unsafe.Pointer(uintptr(v0 + 56))), *(*float32)(unsafe.Pointer(uintptr(v0 + 60))))
						if *(*uint32)(unsafe.Add(unsafe.Pointer(v7), 4*2))&0x1000000 != 0 {
							if *(*uint32)(unsafe.Add(unsafe.Pointer(v7), 4*3))&0xC != 0 {
								...
								if v8 != nil {
									...
									nox_xxx_createAt_4DAA50((*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v8)))))), nil, a3.field_0, a3.field_4)
								}
							}
						}
					}
				...
				if v2 != 0 {
					for {
						...
						if uint32(uint16(int16(v4))) == dword_5d4594_1568300 || uint32(v4) == *memmap.PtrUint32(0x5D4594, 1568304) {
							...
							if v5 != nil {
								nox_xxx_inventoryPutImpl_4F3070((*server.Object)(unsafe.Pointer(uintptr(v0))), (*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v5)))))), 0)
								if *(*uint32)(unsafe.Add(unsafe.Pointer(v5), 4*2))&0x1000000 != 0 {
									if *(*uint32)(unsafe.Add(unsafe.Pointer(v5), 4*3))&0xC != 0 {
										...
										if v6 != nil {
											nox_xxx_inventoryPutImpl_4F3070((*server.Object)(unsafe.Pointer(uintptr(v0))), (*server.Object)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v6)))))), 0)
										}
									}
								}
							}
...
func nox_xxx_playerSomeWallsUpdate_5003B0(obj *server.Object) int32 {
	...
	if dword_5d4594_1569756 > 0 {
		...
		for {
			...
			nox_xxx_netWallCreate_4FFE80(v1, v5, int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v4))), 4*1)))), int8(*(*uint8)(unsafe.Add(unsafe.Pointer(v4), 8))), int8(*(*uint8)(unsafe.Add(unsafe.Pointer(v4), 9))), int8(*(*uint8)(unsafe.Add(unsafe.Pointer(v4), 10))))
			v3++
							...
							if v12 <= v39 {
								...
								for {
									...
									*(*uint16)(unsafe.Pointer(v16)) = uint16(v18)
									if (int32(*(*uint8)(unsafe.Pointer(uintptr(i + 16)))) & 0x10) == 0 {
...
func sub_51A1F0(a1 int32) {
	...
	if v2 != 0 {
		...
		for {
			...
			v25 = v4
			if v5&0x20 != 0 && int32(*(*uint8)(unsafe.Pointer(uintptr(v2 + 12))))&1 != 0 {
				v21++
			} else if uint32(*(*uint16)(unsafe.Pointer(uintptr(v2 + 4)))) == *memmap.PtrUint32(0x5D4594, 2388668) {
				v23++
			}
		...
		if v21 > 1 {
			...
			if v11 != 0 {
				for {
					...
					if int32(*(*uint8)(unsafe.Pointer(uintptr(v11 + 8))))&0x20 != 0 && int32(*(*uint8)(unsafe.Pointer(uintptr(v11 + 12))))&1 != 0 {
						if v10 != v9 {
	...
	if v1 >= 5 {
		...
		if v1 == 5 || v1 >= v13 || v1&1 != 0 && nox_common_randomInt_415FA0(1, 100) >= 50 {
			...
			if v23 != 0 {
				...
				v15 = 0
				for i = int32(uintptr(unsafe.Pointer(nox_server_getFirstObject_4DA790()))); i != 0; i = int32(uintptr(unsafe.Pointer(nox_server_getNextObject_4DA7A0((*server.Object)(unsafe.Pointer(uintptr(i))))))) {
					if uint32(*(*uint16)(unsafe.Pointer(uintptr(i + 4)))) == *memmap.PtrUint32(0x5D4594, 2388668) && func() int32 {
						p := &v15
						*p++
						return *p
					}() == v14 {
					...
					if uint32(*(*uint16)(unsafe.Pointer(uintptr(i + 4)))) == *memmap.PtrUint32(0x5D4594, 2388672) && nox_common_randomInt_415FA0(1, 100) >= 50 {
	...
	if v17 != 0 {
		for {
			...
			if uint32(*(*uint16)(unsafe.Pointer(uintptr(v17 + 4)))) == *memmap.PtrUint32(0x5D4594, 2388668) {
				nox_xxx_delayedDeleteObject_4E5CC0((*server.Object)(unsafe.Pointer(uintptr(v17))))
			}
			if uint32(*(*uint16)(unsafe.Pointer(uintptr(v17 + 4)))) == *memmap.PtrUint32(0x5D4594, 2388672) {
				nox_xxx_delayedDeleteObject_4E5CC0((*server.Object)(unsafe.Pointer(uintptr(v17))))
			}
			v17 = v18
			if v18 == 0 {
	...
	if v32 != nil {
		...
		for ; v32 != nil; v32 = (*uint8)(unsafe.Pointer(uintptr(nox_xxx_wallSecretNext_410790((*int32)(unsafe.Pointer(v32)))))) {
			...
			case 1:
				...
				var v48 int32 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v32))), 4*6))) - 1)
				*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v32))), 4*6))) = uint32(v48)
				if v48 != 0 {
					v33 = 0
					break
				}
				var v49 int32 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v32))), 4*1))))
				*(*uint8)(unsafe.Add(unsafe.Pointer(v32), 21)) = 4
				var v50 int32 = v49 * 23
				var v51 int32 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v32))), 4*2))))
				var v52 float64 = float64(v50 + 11)
				var v53 int32 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v32))), 4*3))))
				var v64 float2
			...
			case 2:
				...
				*(*uint8)(unsafe.Add(unsafe.Pointer(v32), 22)) = uint8(v36)
				if int32(v36) == 0 {
					var v37 int32 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v32))), 4*4))))
					*(*uint8)(unsafe.Add(unsafe.Pointer(v32), 21)) = 1
					*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v32))), 4*6))) = gameFPS() * uint32(v37)
				}
				v33 = 1
			case 3:
				var (
				...
				if (int32(v38)&4) != 0 && int32(v38)&8 == 0 && !(func() bool {
					v39 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v32))), 4*6))) - 1)
					return (func() uint32 {
						p := ((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v32))), 4*6)))
						*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v32))), 4*6))) = uint32(v39)
						return *p
					}()) != 0
				}()) {
					var v40 int32 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v32))), 4*1))))
					*(*uint8)(unsafe.Add(unsafe.Pointer(v32), 21)) = 2
					var v41 int32 = v40 * 23
					var v42 int32 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v32))), 4*2))))
					var v43 float64 = float64(v41 + 11)
					var v44 int32 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v32))), 4*3))))
					var v63 float2
			...
			case 4:
				...
				*(*uint8)(unsafe.Add(unsafe.Pointer(v32), 22)) = uint8(v34)
				if int32(v34) == 23 {
					var v35 int32 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v32))), 4*4))))
					*(*uint8)(unsafe.Add(unsafe.Pointer(v32), 21)) = 3
					*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v32))), 4*6))) = gameFPS() * uint32(v35)
				}
				v33 = 1
			default:
			}
			if int32(v33) != 0 {
				var (
					v56 float64 = float64(int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v32))), 4*1)))*23)) + 11.5
					v65 float64 = float64(int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v32))), 4*2)))*23)) + 11.5
					v66 float4
				)
