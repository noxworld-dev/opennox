...
int sub_4CD690(uint32_t* a1, int a2) {
	...
	if (nox_common_randomIntMinMax_415FF0(0, 100, "C:\\NoxPost\\src\\client\\Drawable\\Update\\drainup.c", 20) < 50) {
		if (*(uint8_t*)(a2 + 432)) {
			...
			v2 = v10[3] + nox_common_randomIntMinMax_415FF0(
							  -20, 20, "C:\\NoxPost\\src\\client\\Drawable\\Update\\drainup.c", 61);
			v3 = v12[4] + nox_common_randomIntMinMax_415FF0(
							  -20, 20, "C:\\NoxPost\\src\\client\\Drawable\\Update\\drainup.c", 62);
			v4 = v8[4];
			v22 = v8[3];
		} else {
			if (a2 == -432) {
		...
		if (v19) {
			...
			*(uint8_t*)(v19 + 443) = v20;
			*(uint8_t*)(v19 + 444) =
				nox_common_randomIntMinMax_415FF0(3, 10, "C:\\NoxPost\\src\\client\\Drawable\\Update\\drainup.c", 100);
		}
	}
	return 1;
}
