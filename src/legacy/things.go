...
func Nox_thing_skip_spells_415100(f *binfile.MemFile) {
	nox_thing_skip_spells_415100((*binfile.MemFile)(f.C()))
}

func Nox_thing_read_ability_415320(f *binfile.MemFile) {
	nox_thing_read_ability_415320((*binfile.MemFile)(f.C()))
}

func Nox_thing_skip_AUD_414D40(f *binfile.MemFile) {
	nox_thing_skip_AUD_414D40((*binfile.MemFile)(f.C()))
}

func Nox_thing_skip_AVNT_452B00(f *binfile.MemFile) {
	nox_thing_skip_AVNT_452B00((*binfile.MemFile)(f.C()))
}

func Nox_thing_read_image_415240(f *binfile.MemFile) {
	nox_thing_read_image_415240((*binfile.MemFile)(f.C()))
}
...
func Nox_thing_read_floor_485B30(f *binfile.MemFile, buf []byte) int {
	...
	return int(nox_thing_read_floor_485B30((*binfile.MemFile)(f.C()), &buf[0]))
}
...
func Nox_thing_read_edge_485D40(f *binfile.MemFile, buf []byte) int {
	...
	return int(nox_thing_read_edge_485D40((*binfile.MemFile)(f.C()), &buf[0]))
}
...
func Nox_thing_read_WALL_414F60(f *binfile.MemFile, buf []byte) int {
	...
	return int(nox_thing_read_WALL_414F60((*binfile.MemFile)(f.C()), unsafe.Pointer(&buf[0])))
}

func Nox_thing_read_FLOR_414DB0(f *binfile.MemFile) int {
	return int(nox_thing_read_FLOR_414DB0((*binfile.MemFile)(f.C())))
}
...
func Nox_thing_read_EDGE_414E70(f *binfile.MemFile, buf []byte) int {
	...
	return int(nox_thing_read_EDGE_414E70((*binfile.MemFile)(f.C()), unsafe.Pointer(&buf[0])))
}
...
func Nox_thing_read_audio_415660(f *binfile.MemFile, buf []byte) int {
	...
	return int(nox_thing_read_audio_415660((*binfile.MemFile)(f.C()), &buf[0]))
}
...
func Nox_thing_read_AVNT_452890(f *binfile.MemFile, buf []byte) int {
	...
	return int(nox_thing_read_AVNT_452890((*binfile.MemFile)(f.C()), unsafe.Pointer(&buf[0])))
}
