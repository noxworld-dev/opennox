...
func sub_4CBD30() *byte {
	...
	for i = 0; i < int32(*(*int16)(unsafe.Add(v0, 44))); i++ {
		...
		v4 = (*wchar2_t)(unsafe.Pointer(nox_window_call_field_94_fnc(dword_5d4594_1522624, 16406, uintptr(i), 0)))
		v5 = nox_xxx_keybind_nameByTitle_42E960(v4)
		v6 = (*wchar2_t)(unsafe.Pointer(nox_window_call_field_94_fnc(dword_5d4594_1522628, 16406, uintptr(i), 0)))
...
func sub_4CBF60(win *gui.Window, a2, a3, a4 uintptr) uintptr {
	...
	if a2 > 0x4007 {
		if a2 == 16393 {
			...
			v8 = sub_4A4800(v7)
			nox_window_call_field_94_fnc(dword_5d4594_1522620, 16412, uintptr(v8), 0)
			nox_window_call_field_94_fnc(dword_5d4594_1522624, 16412, uintptr(v8), 0)
			nox_window_call_field_94_fnc(dword_5d4594_1522628, 16412, uintptr(v8), 0)
		} else if a2 == 16400 {
