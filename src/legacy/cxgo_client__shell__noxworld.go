...
func Nox_game_showGameSel_4379F0() int {
	...
	*memmap.PtrPtr(0x5D4594, 815008) = unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&nox_wol_wnd_world_814980)))), 10001))
