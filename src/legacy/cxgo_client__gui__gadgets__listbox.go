...
func nox_gui_newScrollListBox_4A4310(a1p *gui.Window, a2 nox_window_flags, a3, a4, a5, a6 int, a7 unsafe.Pointer, opts *nox_scrollListBox_data) *gui.Window {
	...
	v21 = 0
	if int32(opts.line_height) < nox_xxx_guiFontHeightMB_43F320(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(a7, 200))))) {
		opts.line_height = uint16(int16(nox_xxx_guiFontHeightMB_43F320(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(a7, 200)))))))
	}
	...
	*(*int16)(unsafe.Add(unsafe.Pointer(a8), unsafe.Sizeof(int16(0))*26)) = int16(a6)
	if v21 != 0 {
		*(*int16)(unsafe.Add(unsafe.Pointer(a8), unsafe.Sizeof(int16(0))*26)) -= int16(nox_xxx_guiFontHeightMB_43F320(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(a7, 200))))))
	}
