...
func nox_xxx_map_51E140() int32 {
	...
	*memmap.PtrUint32(0x5D4594, 2487256) = 256
	...
	nox_xxx_mapWall_426A80(memmap.PtrInt32(0x5D4594, 2487252))
		...
		*a2 = 0
		...
		if v6 != nil {
			for *(*byte)(unsafe.Add(unsafe.Pointer(v6), 2251)) != 2 {
				v6 = nox_common_playerInfoGetNext_416EE0((*server.Player)(unsafe.Pointer(v6)))
				if v6 == nil {
					return 1
				}
			}
		...
		*a2 = 0
		...
		if v7 != nil {
			for *(*byte)(unsafe.Add(unsafe.Pointer(v7), 2251)) != 0 {
				v7 = nox_common_playerInfoGetNext_416EE0((*server.Player)(unsafe.Pointer(v7)))
				if v7 == nil {
					return 1
				}
			}
...
func sub_520E60(a1 *Point32) unsafe.Pointer {
	v1 := int32(dword_5d4594_2487536 + int32(a1.X))
	v2 := int32(dword_5d4594_2487536 + int32(a1.Y))
	if v1 < 0 || v1 >= dword_5d4594_2487540 || v2 < 0 || v2 >= dword_5d4594_2487540 {
		return nil
	}
	return unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(dword_5d4594_2487532, uint32(v1*4))), uint32(v2*20))
}
func sub_520EA0(a1 int32) int32 {
	...
	dword_5d4594_2487540 = *(*int32)(unsafe.Add(a1, 68))*2 + 1
	dword_5d4594_2487536 = *(*int32)(unsafe.Add(a1, 68))
	dword_5d4594_2487532 = alloc.Calloc1(int(dword_5d4594_2487540), 4)
	if dword_5d4594_2487532 == nil {
		return 0
	}
	...
	if dword_5d4594_2487540 > 0 {
		for {
			*(*unsafe.Pointer)(unsafe.Add(dword_5d4594_2487532, uint32(v3*4))) = alloc.Calloc1(int(v2), 20)
			if *(*unsafe.Pointer)(unsafe.Add(dword_5d4594_2487532, uint32(v3*4))) == nil {
				return 0
			}
			v2 = dword_5d4594_2487540
			if func() int32 {
	...
	for {
		...
		if v2 > 0 {
			for {
				*(*int32)(unsafe.Add(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(dword_5d4594_2487532, uint32(v6*4)))+uint32(v5))), 4)) = int32(v6) - dword_5d4594_2487536
				v7 = int32(*(*uint32)(unsafe.Add(dword_5d4594_2487532, uint32(func() int32 {
					p := &v6
					x := *p
					*p++
					return x
				}()*4))))
				*(*int32)(unsafe.Add(unsafe.Pointer(uintptr(v7+v5)), 8)) = int32(v4) - dword_5d4594_2487536
				*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(dword_5d4594_2487532, +uint32(v6*4)-4))+uint32(v5))), 16)) = 0
				v2 = dword_5d4594_2487540
...
func sub_520F80() {
	for i := 0; i < int(dword_5d4594_2487540); i++ {
		alloc.FreePtr(*(*unsafe.Pointer)(unsafe.Add(dword_5d4594_2487532, uint32(i*4))))
	}
	alloc.FreePtr(dword_5d4594_2487532)
}
func sub_521100(a1 *mapgenRoom) int32 {
	var (
		result int32
		v2     int32
		v3     int32
	...
	nox_xxx_mapGenRoundFloatToPtr_520DF0((*types.Pointf)(unsafe.Add(unsafe.Pointer(a1), 20)), (*uint32)(unsafe.Pointer(&a2)))
	result = int32(a1.Field16)
	v2 = 0
	for a1a.Y = a2.Y; v2 < result; a1a.Y++ {
		...
		if a1.Field12 > 0 {
			for {
				v4 := sub_520E60(&a1a)
				if v4 != nil {
					*(*unsafe.Pointer)(unsafe.Add(v4, 16)) = unsafe.Pointer(a1)
				}
				v5 = int32(a1.Field12)
				v3++
				a1a.X++
...
func sub_521200(a1 *mapgenRoom) *mapgenRoom {
	var (
		v1  int32
		v2  int32
		v3  int32
	...
	nox_xxx_mapGenRoundFloatToPtr_520DF0(&a1.Field20, (*uint32)(unsafe.Pointer(&a2)))
	v1 = int32(a1.Field16)
	v2 = 0
	a1a.Y = a2.Y
	if v1 <= 0 {
			...
			for {
				...
				if v4 != nil {
					if *(*uint32)(unsafe.Add(v4, 16)) != 0 {
						return *(**mapgenRoom)(unsafe.Add(v4, 16))
					}
				}
				v5 = int32(a1.Field12)
				v3++
...
func sub_521290(a1 *Point32) *mapgenRoom {
	v1 := sub_520E60(a1)
	if v1 == nil {
		return nil
	}
	return *(**mapgenRoom)(unsafe.Add(v1, 16))
}
func sub_5212B0(a1 unsafe.Pointer, a2 *uint32) int32 {
	var (
		v2  *uint32
		v3  int32
		v4  int32
	...
	for {
		...
		v2 = (*uint32)(unsafe.Pointer(uintptr(sub_521200((*mapgenRoom)(a1)))))
		if v2 == nil {
			return 1
		}
		if func() int32 {
...
func nox_xxx_mapgenAllocBuffer_5213E0() int32 {
	dword_5d4594_2487556 = alloc.Calloc1(1, 0x2000)
	return bool2int32(dword_5d4594_2487556 != nil)
}
func nox_xxx_mapgenFreeBuffer_521400() {
	alloc.FreePtr(dword_5d4594_2487556)
}
func nox_xxx_mapGenGetTopRoom_521710() *mapgenRoom { return dword_5d4594_2487560 }
func sub_521720(a1 *mapgenRoom) *mapgenRoom {
	if a1 == nil {
		return nil
	}
	return a1.Field56
}
func nox_xxx_mapGenAddNewRoom_521730(a1 *mapgenRoom) int32 {
	a1.Field60 = nil
	a1.Field56 = dword_5d4594_2487560
	if dword_5d4594_2487560 != nil {
		dword_5d4594_2487560.Field60 = a1
	}
	dword_5d4594_2487560 = a1
	return sub_521100(a1)
}
func sub_521760(a1 *mapgenRoom) int32 {
	var (
		v1 int32
		v2 int32
	)
	v1 = int32(a1.Field60)
	if v1 != 0 {
		*(*uint32)(unsafe.Add(v1, 56)) = a1.Field56
	} else {
		dword_5d4594_2487560 = a1.Field56
	}
	v2 = int32(a1.Field56)
	if v2 != 0 {
		*(*uint32)(unsafe.Add(v2, 60)) = a1.Field60
	}
...
func sub_521820(a1 int32, a2 int32) int32 {
	...
	if result != 0 {
		result = bool2int32(sub_521200(a2) == nil)
	}
	return result
}
...
func sub_5218B0(a1 *mapgenRoom, a2 int32) int32 {
	...
	v2 = 0
	v3 = int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1), a2+216)))
	if v3 <= 0 {
		return 0
	}
	for i = (*uint32)(unsafe.Add(unsafe.Pointer(a1), a2*32+88)); *i == 0 || *(*uint32)(unsafe.Pointer(uintptr(*i))) != 1; i = (*uint32)(unsafe.Add(unsafe.Pointer(i), 4*1)) {
		if func() int32 {
			p := &v2
			*p++
			return *p
...
func sub_521900(a1 *mapgenRoom, a2 *mapgenRoom, a3 int32) int32 {
	if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1), a3+216))) >= 8 {
		return 0
	}
	i := int32(func() uint8 {
		p := (*uint8)(unsafe.Add(unsafe.Pointer(a1), a3+216))
		x := *p
		*p++
		return x
	}())
	*(**mapgenRoom)(unsafe.Add(unsafe.Pointer(a1), uintptr((i+a3*8)*4)+88)) = a2
	return 1
}

var _ = [1]struct{}{}[32-unsafe.Sizeof(mapgenRoomX{})]

type mapgenRoomX struct {
	Field0 [8]*mapgenRoom // 0, 0
}

var _ = [1]struct{}{}[376-unsafe.Sizeof(mapgenRoom{})]
...
type mapgenRoom struct {
	...
	Field12  uint32         // 3, 12
	Field16  uint32         // 4, 16
	Field20  types.Pointf   // 5, 20
	Field28  float32        // 7, 28
	Field32  float32        // 8, 32
	Field36  uint32         // 9, 36
	Field40  uint32         // 10, 40
	Field44  uint32         // 11, 44
	Field48  uint32         // 12, 48
	Field52  uint32         // 13, 52
	Field56  *mapgenRoom    // 14, 56
	Field60  *mapgenRoom    // 15, 60
	Field64  uint32         // 16, 64
	Field68  uint32         // 17, 68
	Field72  uint32         // 18, 72
	Field76  uint32         // 19, 76
	Field80  uint32         // 20, 80
	Field84  *mapgenRoom    // 21, 84
	Field88  [4]mapgenRoomX // 22, 88
	Field216 [4]byte        // 54, 216
...
func nox_xxx_mapGenMakeRoomStruct_521940(a1 int32, a2 int32) *mapgenRoom {
	p, _ := alloc.New(mapgenRoom{})
	if p == nil {
		return p
	}
	p.Field0 = 1
	p.Field12 = uint32(a1)
	p.Field16 = uint32(a2)
	p.Field28 = float32(float64(a1) * 32.526913)
	p.Field32 = float32(float64(a2) * 32.526913)
	return p
}
func nox_xxx_mapGenPrepareRoom_521990(a1 int32) *mapgenRoom {
	var (
		v1 int32
		v2 int32
		v3 int32
...
func sub_521A10(lpMem *mapgenRoom) {
	var (
		v1 *uint32
		v2 *uint32
	)
	v1 = (*uint32)(unsafe.Pointer(uintptr(lpMem.Field368)))
	if v1 != nil {
		for {
...
func nox_xxx_mapGenFreeTopRoom_521A40() *uint32 {
	...
	if dword_5d4594_2487560 != nil {
		for {
			...
			sub_521A10((*mapgenRoom)(unsafe.Pointer(result)))
			result = v1
			if v1 == nil {
				break
			}
		}
		dword_5d4594_2487560 = nil
	} else {
		dword_5d4594_2487560 = nil
	}
	return result
}
func sub_521A70(a1 *mapgenRoom, a2 *mapgenRoom, a3 int32) int32 {
	sub_521900(a1, a2, a3)
	v3 := sub_523960(a3)
...
func sub_521B00(a1 *mapgenRoom, a2 *mapgenRoom) float64 {
	return float64(nox_xxx_mapGenRandFunc_526AC0(0, int32(a1.Field12-a2.Field12)))*32.526913 + float64(a1.Field20.X)
}
func sub_521B30(a1 *mapgenRoom, a2 *mapgenRoom) float64 {
	return float64(nox_xxx_mapGenRandFunc_526AC0(0, int32(a1.Field16-a2.Field16)))*32.526913 + float64(a1.Field20.Y)
}
func sub_521B60(a1 *mapgenRoom, a2 *mapgenRoom) float64 {
	return float64(a2.Field20.X) - float64(nox_xxx_mapGenRandFunc_526AC0(0, int32(a1.Field12-a2.Field12)))*32.526913
}
func sub_521B90(a1 *mapgenRoom, a2 *mapgenRoom) float64 {
	return float64(a2.Field20.Y) - float64(nox_xxx_mapGenRandFunc_526AC0(0, int32(a1.Field16-a2.Field16)))*32.526913
}
func sub_521BC0(a1 *mapgenRoom, a2 *types.Pointf, a3 float32, a4 float32) {
	result := alloc.Calloc1(1, 0x1C)
	if result == nil {
		return
	}
	*(*float32)(result) = 0.0
	*(*types.Pointf)(unsafe.Add(result, unsafe.Sizeof(float32(0))*1)) = *a2
	*(*float32)(unsafe.Add(result, unsafe.Sizeof(float32(0))*3)) = a3 + a2.X
	*(*float32)(unsafe.Add(result, unsafe.Sizeof(float32(0))*4)) = a4 + a2.Y
	*(*float32)(unsafe.Add(result, unsafe.Sizeof(float32(0))*6)) = float32(a1.Field368)
	a1.Field368 = uint32(uintptr(unsafe.Pointer(result)))
}
...
func nox_xxx_mapGenMakeSpellbook_5220E0(a1 int32, a2 *byte) *uint32 {
	...
	v3 = nox_xxx_newObjectByTypeID_4E3810(internCStr("SpellBook"))
	if v3 == nil {
		return v3
	}
...
func nox_xxx_mapgen_522340(a1 int32, a2 *mapgenRoom) {
	var i *int32
	for i = *(**int32)(unsafe.Add(a2.Field372, 92)); i != nil; i = (*int32)(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(i), 4*5))) {
		nox_xxx_mapgen_522370(a1, a2, i)
	}
}
func nox_xxx_mapgen_522370(a1 int32, a2 *mapgenRoom, a3 *int32) {
	var (
		v3  *int32
		v4  int32
		v5  int32
...
func sub_522C80(a1 *types.Pointf) {
	if sub_51D1A0(a1) == nil {
		sub_51D120(a1)
	}
}
func sub_522CA0(a1 *mapgenRoom, a2 *types.Pointf) {
	var (
		v2 int32
		v3 int32
		v4 *float32
	)
	*((*uint8)(unsafe.Pointer(&v2))) = *(*uint8)(unsafe.Add(unsafe.Pointer(a1), 352))
	...
	if int32(uint8(int8(v2))) != 0 {
		...
		for {
			...
			if v3 >= int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1), 352))) {
				break
			}
		}
	}
	v5 := int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1), 352)))
	*(*float32)(unsafe.Add(unsafe.Pointer(a1), uintptr(v5*8)+224)) = a2.X
	*(*float32)(unsafe.Add(unsafe.Pointer(a1), uintptr(v5*8)+228)) = a2.Y
	*((*uint8)(unsafe.Pointer(&v2))) = uint8(int8(int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1), 352))) + 1))
	*(*uint8)(unsafe.Add(unsafe.Pointer(a1), 352)) = uint8(int8(v2))
}
func sub_522D30(a1 int32) {
	var (
		v6  **float32
		v7  int32
		v8  int32
	...
	for i := result; result != nil; i = result {
		...
		if *(*uint32)(unsafe.Pointer(i)) == 1 {
			for v4 := 0; v4 < 4; v4++ {
				...
				if i.Field216[v4] != 0 {
					for v5 := 0; v5 < int(i.Field216[v4]); v5++ {
						v3 := i.Field88[v4].Field0[v5]
						if nox_xxx_mapGenCheckRoomType_5238F0(v3) != 0 && sub_523920(int32(*(*uint32)(unsafe.Pointer(uintptr(v3))))) == v4 {
							sub_523CB0(v3, unsafe.Pointer(&v12))
							sub_522CA0(i, &v12)
							sub_523D30((*float32)(unsafe.Pointer(uintptr(v3))), &v11)
							sub_522C80(&v12)
							sub_522C80(&v11)
							sub_51D3F0(&v12, &v11)
		...
		result = (*float32)(unsafe.Pointer(uintptr(sub_521720(i))))
	}
}
...
func nox_xxx_servCode_523340(a1 *int4, a2 unsafe.Pointer, a3 int32) {
	var (
		v6  *server.Object
		v7  float32
		v8  float32
...
func nox_xxx_netSendShieldFx_523670(a1 *server.Object, a2 *float32) {
	...
	v5[0] = 128
	*(*uint16)(unsafe.Pointer(&v5[1])) = uint16(nox_xxx_netGetUnitCodeServ_578AC0(a1))
	if a2 != nil {
		v6.X = a1.PosVec.X - *a2
		v6.Y = a1.PosVec.Y - *(*float32)(unsafe.Add(unsafe.Pointer(a2), unsafe.Sizeof(float32(0))*1))
...
func nox_xxx_mapGenCheckRoomType_5238F0(a1 *mapgenRoom) int32 {
	v1 := a1.Field0
	return bool2int32(v1 == 2 || v1 == 3 || v1 == 4 || v1 == 5)
}
...
func sub_523A10(a1 unsafe.Pointer, a2 *mapgenRoom) int32 {
	var (
		v2  float64
		v3  int32
		v4  float64
	...
	switch *(*uint32)(a1) {
	case 2:
		if float64(*(*float32)(unsafe.Add(a1, 36))) < float64(a2.Field36) || float64(*(*float32)(unsafe.Add(a1, 44))) > float64(a2.Field44) {
			return 0
		}
		...
		if v3 > 1 {
			for {
				...
				*(*float32)(unsafe.Add(a1, 32)) = float32(v4)
				if v2+0.1 > float64(a2.Field48) || v5 <= 1 {
					break
				}
			}
			v19.Y = float32(v2)
		...
		return bool2int32(sub_521200((*mapgenRoom)(a1)) == nil)
	case 3:
		if float64(*(*float32)(unsafe.Add(a1, 36))) < float64(a2.Field36) || float64(*(*float32)(unsafe.Add(a1, 44))) > float64(a2.Field44) {
			return 0
		}
	...
	case 4:
		if float64(*(*float32)(unsafe.Add(a1, 40))) < float64(a2.Field40) || float64(*(*float32)(unsafe.Add(a1, 48))) > float64(a2.Field48) {
			return 0
		}
		...
		if v12 > 1 {
			for {
				...
				*(*float32)(unsafe.Add(a1, 28)) = float32(v13)
				if v13+float64(v19.X)-0.1 < float64(a2.Field36) || v14 <= 1 {
					break
				}
			}
		}
		...
		if v16 > 1 {
			for {
				...
				*(*float32)(unsafe.Add(a1, 28)) = float32(v17)
				if v15+0.1 > float64(a2.Field44) || v18 <= 1 {
					break
				}
			}
			v19.X = float32(v15)
	...
	for {
		...
		*(*float32)(unsafe.Add(a1, 32)) = float32(v9)
		if v9+float64(v19.Y)-0.1 < float64(a2.Field40) {
			break
		}
		if v10 <= 1 {
			nox_xxx_mapGenSetRoomPos_521880((*uint32)(a1), &v19)
...
func sub_523E30(a1 int32, a2 int32, a3 int32) *mapgenRoom {
	var p *mapgenRoom
	p, _ = alloc.New(mapgenRoom{})
	if p == nil {
		return p
	...
	p.Field28 = float32(float64(p.Field12) * 32.526913)
	p.Field32 = float32(float64(p.Field16) * 32.526913)
	return p
}
func nox_xxx_mapGenMakeHall_523EC0(a1 unsafe.Pointer, a2 int32, a3 int32) *mapgenRoom {
	v3 := nox_xxx_mapGenRandFunc2_526B00(int32(*(*uint32)(unsafe.Add(a1, 4))), int32(*(*uint32)(unsafe.Add(a1, 8))))
	return sub_523E30(a2, a3, v3)
}
func sub_524070(a1 unsafe.Pointer, a2 *mapgenRoom) {
	result := sub_524090(a2, (*int32)(unsafe.Add(a1, 184)))
	a2.Field372 = uint32(result)
}
func sub_524090(a1 *mapgenRoom, a2 *int32) int32 {
	var (
		v3 int32
		v4 int32
		v5 int32
...
func nox_xxx_mapGenDecorChkConstaint_5241C0(a1 int32, a2 *mapgenRoom) int32 {
	v2 := *(*uint8)(unsafe.Add(a1, 64))
	return bool2int32(int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a2), 364)))&int32(v2) != 0 || int32(v2) == 0)
}
...
func sub_524660(a1 float32, a2 float32) int32 {
	return bool2int32(math.Abs(float64(a1-a2)) < *memmap.PtrFloat64(0x581450, 10432))
}
...
func nox_xxx_gen_524E00(a1 int32, a2 *mapgenRoom) {
	var (
		v2  int32
		v3  *byte
		v4  float32
	...
	v2 = a2
	if (int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a2), 52))) & 2) == 0 {
		v3 = (*byte)(unsafe.Pointer(uintptr(sub_5244D0(int32(a2.Field372)))))
		nox_xxx_gen_524680(a1, a2, int32(uintptr(unsafe.Pointer(v3))))
		sub_526CA0(v3)
		v4 = float32(a2.Field40)
		v17.X = float32(a2.Field36)
		v17.Y = v4
		sub_526D50(8)
		sub_526E60(&v17.X)
		v15 = int32(a2.Field12 - 1)
		v17.X = float32(float64(v17.X) + 32.526913)
		sub_524500(&v17, v15)
		v5 = float32(a2.Field40)
		v17.X = float32(a2.Field44)
		v17.Y = v5
		sub_526D50(9)
		sub_526E60(&v17.X)
		v6 = float32(a2.Field48)
		v17.X = float32(a2.Field36)
		v17.Y = v6
		sub_526D50(7)
		sub_526E60(&v17.X)
		v14 = int32(a2.Field12 - 1)
		v17.X = float32(float64(v17.X) + 32.526913)
		sub_524500(&v17, v14)
		v7 = float32(a2.Field48)
		v17.X = float32(a2.Field44)
		v17.Y = v7
		sub_526D50(10)
		sub_526E60(&v17.X)
		v8 = float64(a2.Field40) + 32.526913
		v16 = int32(a2.Field16 - 1)
		v17.X = float32(a2.Field36)
		v17.Y = float32(v8)
		sub_524550((*int32)(unsafe.Pointer(&v17)), v16)
		v9 = float64(a2.Field40) + 32.526913
		v10 = int32(a2.Field16 - 1)
		v17.X = float32(a2.Field44)
		v17.Y = float32(v9)
		sub_524550((*int32)(unsafe.Pointer(&v17)), v10)
		sub_526C80(0)
		v11 = (*int32)(unsafe.Add(unsafe.Pointer(a2), 88))
		v12 = 0
		v18 = a2 + 88
		for {
			v13 = 0
...
func sub_5259F0(a1 *mapgenRoom, a2 *mapgenRoom, a3 float32) {
	nox_xxx_mapGenSetFlags_5235F0(-100)
	var v3 float64
	if a2 != nil {
		switch a2.Field0 {
		case 1:
			v3 = math.Sqrt(float64(a2.Field28*a2.Field28 + a2.Field32*a2.Field32))
		case 2, 3:
			v3 = float64(a2.Field32)
		case 4, 5:
			v3 = float64(a2.Field28)
		default:
			v3 = float64(a3)
		}
	}
	...
	if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1), 220))) != 1 || float64(v11) < float64(a1.Field356) {
		a1.Field356 = uint32(v11)
		*(*uint8)(unsafe.Add(unsafe.Pointer(a1), 220)) = 1
		for l := 0; l < 4; l++ {
			v5 := &a1.Field88[l]
			v7 := a1.Field216[l]
			if int32(v7) != 0 {
				for v8 := 0; v8 < int(v7); v8++ {
					if v5.Field0[v8] != nil {
						sub_5259F0(v5.Field0[v8], v4, v11)
					}
				}
			}
		}
...
func nox_xxx_mapGen_InPrefab1_525D20(a1 unsafe.Pointer) int32 {
	var (
		v1 int32
	)
	v1 = 0
	...
	for i := *(**uint32)(unsafe.Add(a1, 80)); i != nil; i = (*uint32)(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(i), 4*39))) {
		if *(*uint32)(unsafe.Add(unsafe.Pointer(i), 4*18)) != 0 {
			if v1 == 5 || nox_xxx_mapGenPrefabMkRoom_526100(a1, unsafe.Pointer(i)) == 0 {
				return 0
			}
	...
	for j := *(**uint32)(unsafe.Add(a1, 80)); j != nil; j = (*uint32)(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(j), 4*39))) {
		if *(*uint32)(unsafe.Add(unsafe.Pointer(j), 4*18)) == 0 {
			...
			if nox_xxx_mapGenPrefabMkRoom_526100(a1, unsafe.Pointer(j)) == 0 {
				return 0
			}
...
LABEL_10:
	...
	case 1:
		v14 = -v16
		*memmap.PtrFloat32(0x5D4594, 2487612) = float32(sub_526BC0(v14, v16))
		*memmap.PtrFloat32(0x5D4594, 2487616) = float32(sub_526BC0(v14, v16))
	case 2:
		v8 = float64(-v16)
		v15 = float32(v8)
		if nox_xxx_mapGenRandFunc_526AC0(0, 100) >= 50 {
			*memmap.PtrFloat32(0x5D4594, 2487612) = float32(v8)
			*memmap.PtrFloat32(0x5D4594, 2487616) = float32(sub_526BC0(v15, v16))
			dword_5d4594_2487620 = uint32(v16)
			dword_5d4594_2487624 = uint32(float32(sub_526BC0(v15, v16)))
		} else {
			*memmap.PtrFloat32(0x5D4594, 2487612) = float32(sub_526BC0(v15, v16))
			*memmap.PtrFloat32(0x5D4594, 2487616) = v15
	...
	case 3:
		...
		if v9 >= 25 {
			if v9 >= 50 {
				v12 = float64(-v16)
				if v9 >= 75 {
					*memmap.PtrFloat32(0x5D4594, 2487612) = float32(v12)
					*memmap.PtrFloat32(0x5D4594, 2487616) = float32(v12)
					...
					*memmap.PtrFloat32(0x5D4594, 2487612) = v16
					dword_5d4594_2487620 = uint32(v16)
					dword_5d4594_2487624 = uint32(v16)
				}
				...
				v11 = float64(-v16)
				*memmap.PtrFloat32(0x5D4594, 2487612) = float32(v11)
				dword_5d4594_2487632 = uint32(float32(v11))
				*memmap.PtrFloat32(0x5D4594, 2487616) = v16
				dword_5d4594_2487620 = uint32(v16)
				dword_5d4594_2487624 = uint32(v16)
			...
			v10 = float64(-v16)
			*memmap.PtrFloat32(0x5D4594, 2487612) = float32(v10)
			*memmap.PtrFloat32(0x5D4594, 2487616) = float32(v10)
	...
	case 4, 5:
		*memmap.PtrUint32(0x5D4594, 2487644) = 0
		v13 = float64(-v16)
		*memmap.PtrFloat32(0x5D4594, 2487612) = float32(v13)
		*memmap.PtrFloat32(0x5D4594, 2487616) = float32(v13)
		dword_5d4594_2487624 = uint32(float32(v13))
		dword_5d4594_2487628 = uint32(float32(v13))
		dword_5d4594_2487620 = uint32(v16)
		dword_5d4594_2487632 = uint32(v16)
		*memmap.PtrFloat32(0x5D4594, 2487636) = v16
		*memmap.PtrFloat32(0x5D4594, 2487640) = v16
		*memmap.PtrUint32(0x5D4594, 2487648) = 0
	default:
		return
	}
}
func nox_xxx_mapGenPrefabMkRoom_526100(a1 unsafe.Pointer, a2 unsafe.Pointer) int32 {
	var (
		result int32
		v4     int32
		v5     *uint32
	...
	*(*uint32)(unsafe.Add(a2, 148)) = uint32(uintptr(unsafe.Pointer(v3)))
	...
	if v5 != nil && sub_5212B0(*(*unsafe.Pointer)(unsafe.Add(a2, 148)), v5) == 0 {
		v4 = 0
	}
	if sub_5217A0(a1, int32(*(*uint32)(unsafe.Add(a2, 148)))) != 0 && v4 != 0 {
		nox_xxx_mapGenAddNewRoom_521730((*mapgenRoom)(unsafe.Pointer(*(**uint32)(unsafe.Add(a2, 148)))))
		v6 = 4
		*(*uint32)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(a2, 148)), 52)) |= 2
		...
		sub_521A10((*mapgenRoom)(*(*unsafe.Pointer)(unsafe.Add(a2, 148))))
...
func sub_526260(a1 int32, a2 *float32) int64 {
	...
	*a2 = *memmap.PtrFloat32(0x5D4594, uintptr(uint32(v2*8)+2487612))
	*(*float32)(unsafe.Add(unsafe.Pointer(a2), unsafe.Sizeof(float32(0))*1)) = *memmap.PtrFloat32(0x5D4594, uintptr(uint32(v2*8)+2487616))
...
func sub_5262F0(a1 int32, a2 unsafe.Pointer) int32 {
	var (
		v3     float64
		v4     int32
		v6     int32
	...
	*(*float32)(unsafe.Add(a2, 64)) = float32(sub_502EA0(v4))
	for i := sub_504980(); i != nil; i = sub_5049C0(i) {
		sub_503EC0(i, &v26.X)
...
func sub_528030(a1 *server.Object) {
	var (
		v5  int32
		v6  int32
		v7  uint32
	...
	v3 := a1.HealthData
	v4 := v2.Player
	v11 = int32(v4.PlayerInd)
	if int32(v2.Field2_1) == int32(v3.Cur) {
		v5 = int32(gameFrame())
		v7 = gameFPS()
	} else if cmath.Abs(int64(int32(v3.Cur)-int32(v2.Field2_1))) >= int64(int32(v3.Max)/10) || (func() bool {
		v5 = int32(gameFrame())
		v6 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v4), 2176)))
		v7 = gameFPS()
		return (gameFrame() - uint32(v6)) > uint32(int32(gameFPS())>>2)
	}()) {
		nox_xxx_netSendPlrHealthToTeam_4D86E0(v11)
		v8 := v2.Player
		v2.Field2_1 = v1.HealthData.Cur
		*(*uint32)(unsafe.Add(unsafe.Pointer(v8), 2176)) = gameFrame()
		v5 = int32(gameFrame())
		v7 = gameFPS()
	}
	result := int16(v2.ManaCur)
	if int32(v2.ManaPrev) == int32(result) {
		return
	}
	if !(cmath.Abs(int64(int32(v2.ManaCur)-int32(v2.ManaPrev))) >= int64(int32(v2.ManaMax)/10) || uint32(v5)-*(*uint32)(unsafe.Add(unsafe.Pointer(v2.Player), 2180)) > v7>>2) {
		return
	}
	nox_xxx_netReportMana_4D8930(v11, v1)
	v10 := v2.Player
	v2.ManaPrev = v2.ManaCur
	*(*uint32)(unsafe.Add(unsafe.Pointer(v10), 2180)) = gameFrame()
}
...
func nox_xxx_frameCounterSetCopyToNextFrame_5281D0() {
	*memmap.PtrUint32(0x5D4594, 2487684) = gameFrame() + 1
}
func nox_xxx_frameCounterSetCopy_5281E0() {
...
func nox_xxx_unitUpdateSightMB_5281F0(a1p *server.Object) {
	...
	if int32(*(*uint8)(unsafe.Add(v3, 1129))) != 0 {
		...
		for {
			if *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(*v6)), 16))&0x8020 != 0 || nox_xxx_unitCanSee_536FB0(v1, (*server.Object)(unsafe.Pointer(uintptr(*v6))), 0) == 0 || (func() bool {
				v7 = float64(v1.PosVec.X - *(*float32)(unsafe.Add(unsafe.Pointer(uintptr(*v6)), 56)))
				v8 = float64(v1.PosVec.Y - *(*float32)(unsafe.Add(unsafe.Pointer(uintptr(*v6)), 60)))
				v20 = float32((float64(v21) + 30.0) * (float64(v21) + 30.0))
				return v8*v8+v7*v7 > float64(v20)
			}()) || (func() bool {
				v9 = float64(v1.PosVec.X - v1.PrevPos.X)
				v10 = float64(v1.PosVec.Y - v1.PrevPos.Y)
				return v10*v10+v9*v9 > 1000.0
			}()) || v19 != 0 && nox_xxx_unitCanInteractWith_5370E0(v1, (*server.Object)(unsafe.Pointer(uintptr(*v6))), 0) == 0 {
	...
	if (*(*uint32)(unsafe.Add(v3, 1196)) == 0 || gameFrame()-*(*uint32)(unsafe.Add(v3, 1204)) > (gameFPS()*2)) && (*(*uint32)(unsafe.Add(v3, 1208)) <= gameFrame() || gameFrame() == *memmap.PtrUint32(0x5D4594, 2487684)) {
		nox_xxx_unitsGetInCircle_517F90((*types.Pointf)(unsafe.Add(unsafe.Pointer(v1), 56)), v21, nox_xxx_monsterUpdateSeenEnemies_5286D0, unsafe.Pointer(v1))
...
func nox_xxx_aiLostSight_528560(a1 *server.Object, a2 int32) {
	var (
		v5  int32
		v7  int32
		v10 int32
	...
	v2 := a1.UpdateData
	v3 := *(**server.Object)(unsafe.Add(unsafe.Pointer(uintptr(v2+a2*4)), 1132))
	v4 := unsafe.Add(v2, a2*4+1132)
	...
	nox_xxx_scriptCallByEventBlock_502490(unsafe.Add(v2, 1296), unsafe.Pointer(uintptr(*v4)), unsafe.Pointer(a1), 15)
	v6 := *(*unsafe.Pointer)(unsafe.Add(v2, 1196))
	if *v4 == v6 {
	...
	v8 := a2
	var r1 byte
	r1 = uint8(int8(int32(*(*uint8)(unsafe.Add(v2, 1129))) - 1))
	*(*uint8)(unsafe.Add(v2, 1129)) = r1
	if a2 >= int32(uint8(int8(r1))) {
		return
	}
	r2 := unsafe.Add(v2, a2*4+1132)
	for {
		v8++
		*(*uint32)(r2) = *(*uint32)(unsafe.Add(r2, 4))
		r2 = unsafe.Add(r2, 4)
			...
			if (*(*uint32)(unsafe.Add(a1, 16)) & 0x8020) == 0 {
				...
				if (v4&0x400 != 0 || nox_xxx_unitIsEnemyTo_5330C0((*server.Object)(a2), (*server.Object)(a1)) != 0) && sub_528950(a2, a1) == 0 {
					...
					if v5&0x100 != 0 || (func() bool {
						...
						v9 = float32(v7)
						v8 = memmap.PtrFloat32(0x587000, uintptr(uint32(int32(*(*int16)(unsafe.Add(a2, 124)))*8)+194136))
	...
	*(*uint8)(unsafe.Add(v4, 1129))++
	if gameFrame() > v15 {
		if nox_xxx_unitIsEnemyTo_5330C0((*server.Object)(v2), (*server.Object)(v11)) != 0 {
			if nox_xxx_unitIsZombie_534A40((*server.Object)(v2)) == 0 || (func() bool {
...
func sub_528910(a1 unsafe.Pointer, a2 int32) {
	var (
		result int32
		v3     int32
		v4     int32
	...
	nox_xxx_aiLostSight_528560((*server.Object)(a1), result)
}
...
func nox_xxx_netReportDestroyObject_5289D0(a1p *server.Object) {
	...
	for i = int32(uintptr(unsafe.Pointer(result))); result != nil; i = int32(uintptr(unsafe.Pointer(result))) {
		if uint32(1<<int32(*(*uint8)(unsafe.Add(i, 2064))))&a1.Field37 != 0 {
			*((*uint8)(unsafe.Pointer(&v4))) = uint8(int8((int32(uint8(a1.Field5)) >> 6) | 0x31))
			*(*uint16)(unsafe.Add(unsafe.Pointer(&v4), 1)) = uint16(nox_xxx_netGetUnitCodeServ_578AC0(a1))
		...
		if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1), 8)))&6 != 0 {
			nox_xxx_netFriendAddRemove_4D97A0(int32(*(*uint8)(unsafe.Add(i, 2064))), a1, 0)
		}
...
func nox_xxx_monsterCmdSend_528BD0(unit unsafe.Pointer, source unsafe.Pointer, command *byte, a4 int16) {
	...
	*(*uint16)(unsafe.Pointer(&v10[9])) = uint16(a4)
	...
	if source != nil {
		...
		result := nox_xxx_getFirstPlayerUnit_4DA7C0()
		for i := result; result != nil; i = result {
			nox_netlist_addToMsgListCli_40EBC0(int32(*(*uint8)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(i.UpdateData, 276)), 2064))), 1, &v10[0], int32(v10[8])+11)
			result = nox_xxx_getNextPlayerUnit_4DA7F0(i)
		}
	}
}
...
func nox_xxx_XFerMonster_528DB0(a1p *server.Object, data unsafe.Pointer) int {
	...
	result = int32(Nox_xxx_mapReadWriteObjData_4F4530(a1, int(int32(int16(v45)))))
	if result == 0 {
		return 0
	}
	if nox_crypt_IsReadOnly() == 0 {
		nox_xxx_xferIndexedDirection_509E20(int32(a1.Direction1), (*Point32)(unsafe.Pointer(&v52[0])))
	}
	...
	if nox_crypt_IsReadOnly() != 1 || (func() bool {
		...
		a1.Direction2 = server.Dir16(uint16(v15))
		a1.Direction1 = server.Dir16(uint16(v15))
		v14 = nox_crypt_IsReadOnly()
	...
	if int32(int16(v45)) >= 41 {
		result = nox_xxx_XFer_ActionData_529CE0(unsafe.Pointer(a1))
		if result == 0 {
			return 0
		}
	}
	...
	if int32(int16(v45)) >= 43 && int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1), 12)))&8 != 0 {
		*((*uint8)(unsafe.Pointer(&v44))) = 0
		v27 = int32(a1.InitData)
...
LABEL_137:
	...
	if int32(int16(v45)) >= 45 {
		v50 = int32(a1.ObjSubClass & 0x180)
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v50)), 4)
		a1.ObjSubClass |= uint32(v50)
	}
	if int32(int16(v45)) >= 49 {
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl(a1.HealthData, 2)
	}
	if int32(int16(v45)) >= 51 {
	...
	if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1), 12)))&0x20 != 0 && int32(int16(v45)) >= 54 {
		v28 = 0
		...
		*((*uint8)(unsafe.Pointer(&v46))) = 0
		for {
			...
			if nox_crypt_IsReadOnly() == 1 {
				nox_xxx_setNPCColor_4E4A90(a1, uint8(int8(v46)), unsafe.Pointer(v29))
			}
			v28++
	...
	if int32(int16(v45)) >= 55 && int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1), 12)))&0x20 != 0 {
	...
	if int32(int16(v45)) >= 63 && a1.ObjSubClass&0x80000 != 0 {
		nox_xxx_readNPCVoiceSet_52AD10(unsafe.Pointer(a1))
	}
	if int32(int16(v45)) >= 64 {
...
LABEL_171:
	if a1.Field34 != 0 {
		if nox_crypt_IsReadOnly() != 1 {
			a1.Field34 = uint32(v51)
			return 1
		}
		result = Nox_xxx_xfer_4F3E30(uint16(int16(v45)), a1, a1.Field34)
		if result == 0 {
			return 0
		}
	}
	if nox_crypt_IsReadOnly() == 1 {
		if noxflags.HasGame(0x200000) || nox_xxx_gameIsSwitchToSolo_4DB240() == 0 {
			nox_xxx_monsterOnSpawnSpellcaster_529BC0(unsafe.Pointer(a1))
		}
		if nox_crypt_IsReadOnly() == 1 {
			if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1), 8)))&2 != 0 {
				v31 = int32(a1.ObjSubClass)
				if v31&0x2000 != 0 {
					v32 = 0
					v33 = 0
					for j = unsafe.Pointer(nox_xxx_inventoryGetFirst_4E7980(a1)); j != nil; j = unsafe.Pointer(nox_xxx_inventoryGetNext_4E7990((*server.Object)(j))) {
					...
					if v32 == 0 && v33 != 0 {
						v38 = nox_xxx_newObjectByTypeID_4E3810(internCStr("Glyph"))
						...
						if v38 != nil {
							...
							*(*uint32)(unsafe.Add(v39, 28)) = a1.PosVec.X
							*(*uint32)(unsafe.Add(v39, 32)) = a1.PosVec.Y
						}
						nox_xxx_inventoryPutImpl_4F3070(a1, (*server.Object)(unsafe.Pointer(v38)), 1)
					}
				}
			}
		}
		...
		for {
			...
			*((*uint16)(unsafe.Add(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(uint16(0))*uintptr(v6)), unsafe.Sizeof(uint16(0))*172))) = uint16(int16(v14))
			if v6 == 26 && int32(int16(v13)) >= 2 {
				...
				v9 = sub_4FF2D0(51, (*server.Object)(unsafe.Pointer(a1)))
				if v9 != 0 {
	...
	for {
		if nox_xxx_testUnitBuffs_4FF350((*server.Object)(unsafe.Pointer(a1)), server.EnchantID(v1)) != 0 {
			...
			*((*uint8)(unsafe.Pointer(&v15))) = uint8(nox_xxx_buffGetPower_4FF570((*server.Object)(unsafe.Pointer(a1)), server.EnchantID(v1)))
			...
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v14)), 4)
			if v1 == 26 {
				v3 = sub_4FF2D0(51, (*server.Object)(unsafe.Pointer(a1)))
				if v3 != 0 {
...
func nox_xxx_XFerNPC_52ADE0(a1p *server.Object, data unsafe.Pointer) int {
	...
	result = int32(Nox_xxx_mapReadWriteObjData_4F4530((*server.Object)(a1), int(int32(int16(v44)))))
	if result == 0 {
		return 0
	}
	if nox_crypt_IsReadOnly() == 0 {
	...
	*((*uint8)(unsafe.Pointer(&v45))) = *(*uint8)(unsafe.Add(v35, 540))
	...
	if int32(uint8(int8(v45))) != 0 {
		nox_xxx_setSomePoisonData_4EEA90((*server.Object)(v35), int32(uint8(int8(v45))))
		if nox_crypt_IsReadOnly() == 1 {
			goto LABEL_149
		}
		goto LABEL_156
...
LABEL_156:
	if *(*uint32)(unsafe.Add(v35, 136)) == 0 || nox_crypt_IsReadOnly() != 1 || (func() int32 {
		result = Nox_xxx_xfer_4F3E30(uint16(int16(v44)), (*server.Object)(v35), *(*uint32)(unsafe.Add(v35, 136)))
		return result
	}()) != 0 {
		sub_52BA70(v35)
		if nox_crypt_IsReadOnly() == 1 {
...
func nox_xxx_castCounterSpell_52BBB0(a1 int32, a2, a3, a4 *server.Object) int32 {
	v10 := float32(nox_xxx_gamedataGetFloat_419D40(internCStr("CounterspellRange")))
	nox_xxx_getMissilesInCircle_518170(&a4.PosVec, v10, func(it *server.Object, data unsafe.Pointer) {
		nox_xxx_cspellRemoveSpell_52BC90(it)
	}, nil)
	for i := nox_xxx_spellCastedFirst_4FE930(); i != nil; i = nox_xxx_spellCastedNext_4FE940(i) {
		if nox_xxx_spellHasFlags_424A50(int32(i.Spell), 0x40000) && ((int32(*(*uint8)(unsafe.Add(unsafe.Pointer(i), 88)))&2) == 0 || i.Spell == 43) {
			v6 := float64(i.Pos.X - a4.PosVec.X)
			v7 := float64(i.Pos.Y - a4.PosVec.Y)
			if float64(v10*v10) >= v7*v7+v6*v6 {
				nox_xxx_spellCancelSpellDo_4FE9D0(i)
			}
		}
	}
	nox_xxx_unitsGetInCircle_517F90(&a4.PosVec, v10, sub_52BDB0, unsafe.Pointer(a4))
...
func nox_xxx_cspellRemoveSpell_52BC90(it *server.Object) {
	...
	if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1), 12)))&1 != 0 && (int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1), 16)))&0x20) == 0 {
		nox_xxx_netSendPointFx_522FF0(-121, (*types.Pointf)(unsafe.Add(unsafe.Pointer(a1), 56)))
		v1 = int32(a1.TypeInd)
		...
		if uint32(v1) == *memmap.PtrUint32(0x5D4594, 2487724) {
			nox_xxx_deathBallCreateFragments_52BD30(a1)
			nox_xxx_delayedDeleteObject_4E5CC0(a1)
			return
		}
		ccall.AsFunc[func(int32, uint32, uint32)](*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(a1), 696)))(a1, 0, 0)
...
func nox_xxx_deathBallCreateFragments_52BD30(obj *server.Object) {
	for i := 0; i < 3; i++ {
		fr := nox_xxx_newObjectByTypeID_4E3810(internCStr("DeathBallFragment"))
		if fr != nil {
			nox_xxx_createAt_4DAA50(fr, obj.ObjOwner, obj.PosVec.X, obj.PosVec.Y)
			fr.Direction1 = server.Dir16(nox_common_randomInt_415FA0(0, math.MaxUint8))
...
func sub_52BDB0(it *server.Object, data unsafe.Pointer) {
	...
	found := false
	if it != a2 && (it.ObjFlags&0x8020) == 0 {
		for i := 0; i < 32; i++ {
			if nox_xxx_testUnitBuffs_4FF350(it, server.EnchantID(i)) != 0 {
				if nox_xxx_unitGetBuffTimer_4FF550(it, server.EnchantID(i)) != 0 {
					if sp := nox_xxx_getEnchantSpell_424920(server.EnchantID(i)); sp != 0 {
						if nox_xxx_spellHasFlags_424A50(sp, 0x40000) {
							if !found {
								nox_xxx_netSendPointFx_522FF0(-121, (*types.Pointf)(unsafe.Add(unsafe.Pointer(it), 56)))
								found = true
							}
							nox_xxx_spellBuffOff_4FF5B0(it, server.EnchantID(i))
						}
					}
				}
			}
...
func nox_xxx_changeOwner_52BE40(a1, a2 *server.Object) {
	if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1), 8)))&1 != 0 && int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1), 12)))&2 != 0 {
		v2 := a1.UpdateDataMissile()
		if v2.SpellID == 115 {
			nox_xxx_cspellRemoveSpell_52BC90(a1)
		} else if v2.Target == a2 {
			v2.Target = v2.Owner
			*(*unsafe.Pointer)(unsafe.Pointer(v2)) = unsafe.Pointer(a2)
			Nox_xxx_unitClearOwner_4EC300(a1)
			nox_xxx_unitSetOwner_4EC290(a2, a1)
			a1.Field32 = gameFrame()
			nox_xxx_aud_501960(64, a2, 0, 0)
		}
	}
}
func sub_52BEB0(a1 int32, a2, a3, a4 *server.Object, a5 *server.SpellAcceptArg, a6 int) int32 {
	var (
		v4 int32
		v6 float32
	)
	v6 = float32(nox_xxx_gamedataGetFloat_419D40(internCStr("InversionRange")))
	nox_xxx_getMissilesInCircle_518170((*types.Pointf)(unsafe.Add(unsafe.Pointer(a4), 56)), v6, func(it *server.Object, data unsafe.Pointer) {
		nox_xxx_changeOwner_52BE40(it, (*server.Object)(data))
	}, a3)
...
func sub_52BF50(a1 int32, a2, a3, a4 *server.Object, a5 *server.SpellAcceptArg, a6 int) int32 {
	var result int32
	result = *a5
	if *a5 == 0 {
		return result
...
func nox_xxx_castPull_52BFA0(a1 int32, a2, a3, a4 *server.Object, a5 *server.SpellAcceptArg, a6 int32) int32 {
	var (
		v6 int32
		v8 float32
	)
	v8 = float32(-(nox_xxx_gamedataGetFloat_419D40(internCStr("PullPowerCoeff")) * float64(a6)))
	nox_xxx_mapPushUnitsAround_52E040(unsafe.Add(unsafe.Pointer(a4), 56), 600.0, 10.0, v8, nil, 0, 0)
	v6 = nox_xxx_spellGetAud44_424800(a1, 0)
	nox_xxx_aud_501960(v6, a3, 0, 0)
	return 1
}
func nox_xxx_castPush_52C000(a1 int32, a2, a3, a4 *server.Object, a5 *server.SpellAcceptArg, a6 int32) int32 {
	var (
		v6 int32
		v8 float32
	)
...
func nox_xxx_castFumble_52C060(a1 int32, a2, a3, a4 *server.Object, a5 *server.SpellAcceptArg, a6 int) int32 {
	var (
		result int32
		v6     int32
		v7     int32
...
func nox_xxx_castConfuse_52C1E0(a1 int32, a2, a3, a4 *server.Object, a5 *server.SpellAcceptArg, a6 int8) int32 {
	var (
		v7 int16
		v8 float32
	)
	...
	v7 = int16(int32(v8))
	nox_xxx_buffApplyTo_4FF380((*server.Object)(unsafe.Pointer(uintptr(a5.Obj))), 3, v7, a6)
	sub_4E7540(a3, (*server.Object)(unsafe.Pointer(uintptr(a5.Obj))))
	return 1
}
func nox_xxx_castStun_52C2C0(a1 int32, a2, a3, a4 *server.Object, a5 *server.SpellAcceptArg, a6 int8) int32 {
	var (
		v7  int16
		v8  int32
		v9  int16
	...
	if (v10 & 4) == 0 {
		if v10&2 != 0 && float64(*(*float32)(unsafe.Add(v8, 120))) > 15.0 {
			...
			sub_4E7540(a3, (*server.Object)(unsafe.Pointer(uintptr(*a5))))
			return 1
		}
...
func nox_xxx_castBurn_52C3E0(a1 int32, a2, a3, a4 *server.Object, a5 *server.SpellAcceptArg, a6 int) int32 {
	var (
		v5  int32
		v6  int32
		v7  *float32
	...
	if int32(a4.TypeInd) != v5 {
		v8 = a4.PosVec.X
		v9 = a5.Pos.X
		v18.field_4 = a4.PosVec.Y
		v18.field_0 = v8
		v10 = a5.Pos.Y
		v18.field_8 = v9
		v18.field_C = v10
		...
		if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a4), 8)))&4 == 0 {
			return 0
		}
		v11 = int32(a4.UpdateData)
		a5 = 2
...
LABEL_12:
	...
	if v14 != nil {
		nox_xxx_createAt_4DAA50((*server.Object)(unsafe.Pointer(v14)), a4, *v7, *(*float32)(unsafe.Add(unsafe.Pointer(v7), unsafe.Sizeof(float32(0))*1)))
...
func nox_xxx_useShock_52C5A0(a1 int32, a2, a3, a4 *server.Object, a5 *server.SpellAcceptArg, a6 int32) int32 {
	var (
		result int32
		v7     int32
		v8     int32
...
func nox_xxx_castPoison_52C720(a1 int32, a2, a3, a4 *server.Object, a5 *server.SpellAcceptArg, a6 int32) int32 {
	result := *(*unsafe.Pointer)(unsafe.Pointer(a5))
	if result != nil {
		nox_xxx_activatePoison_4EE7E0((*server.Object)(result), a6, a6)
		sub_4E7540(a3, (*server.Object)(unsafe.Pointer(uintptr(*a5))))
		return 1
	}
	return 0
}
func nox_xxx_castFireball_52C790(a1 int32, a2, a3, a4 *server.Object, a5 *server.SpellAcceptArg, a6 int32) int32 {
	var (
		v6  int32
		v7  *float32
		v8  int32
	...
	v6 = a6
	v7 = nox_xxx_newObjectByTypeID_4E3810(*(**byte)(memmap.PtrOff(0x587000, uintptr(a6*4)+258864)))
	if v7 == nil {
		return 1
	}
	v8 = a4
	v9 = float64(a4.Shape.Circle + a4.Shape.Circle)
	v10 = int32(a4.Direction1) * 8
	v21 = *memmap.PtrFloat32(0x587000, uintptr(uint32(v10)+194136))
	v20 = *memmap.PtrFloat32(0x587000, uintptr(uint32(v10)+194140))
...
func sub_52CA80(a1 int32, a2, a3, a4 *server.Object, a5 *server.SpellAcceptArg, a6 int) int32 {
	var (
		v4  int32
		v5  int32
		v6  *types.Pointf
	...
	if a4 != nil && int32(a4.TypeInd) == v4 {
		v5 = a3
		v6 = (*types.Pointf)(unsafe.Add(unsafe.Pointer(a4), 56))
	} else {
		v5 = a3
		v6 = (*types.Pointf)(unsafe.Add(unsafe.Pointer(a3), 56))
	}
	if int32(*(*uint8)(unsafe.Add(v5, 8)))&4 != 0 {
		...
		if v13 != 0 {
			...
			*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v7+v8*4)), 116)) = uint32(uintptr(unsafe.Pointer(v14)))
			...
			nox_xxx_createAt_4DAA50((*server.Object)(unsafe.Pointer(v14)), a3, v6.X, v6.Y)
		}
...
func sub_52CBD0(a1 int32, a2, a3, a4 *server.Object, a5 *server.SpellAcceptArg, a6 int) int32 {
	var (
		v4  int32
		v5  int32
		v6  int32
	...
	if a4 == nil || (func() bool {
		v5 = a4 + 56
		return int32(a4.TypeInd) != v4
	}()) {
		v5 = a3 + 56
	}
	if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a3), 8)))&4 != 0 {
		v6 = int32(a3.UpdateData)
		...
		if v7 != 0 {
			...
			*(*uint32)(unsafe.Pointer(uintptr(v6 + a1*4 - 68))) = uint32(uintptr(unsafe.Pointer(v8)))
			...
			v10 = *(*float32)(v5)
			v16 = 0
			nox_xxx_createAt_4DAA50((*server.Object)(unsafe.Pointer(v8)), a3, v10, v9)
		}
...
func sub_52CCD0(a1 int32, a2, a3, a4 *server.Object, a5 *server.SpellAcceptArg, a6 int) int32 {
	var (
		v4 float64
		v5 float64
		v6 float64
	...
	for {
		if nox_xxx_unitHasThatParent_4EC4F0(v3, a3) != 0 && libc.StrCmp(nox_xxx_getUnitName_4E39D0(v3), internCStr("Glyph")) == 0 {
			v4 = float64(a3.PosVec.X - v3.PosVec.X)
			v5 = float64(a3.PosVec.Y - v3.PosVec.Y)
			v6 = v5*v5 + v4*v4
			if v6 < float64(v9) {
				v9 = float32(v6)
				Tm = v3
...
func nox_xxx_castCurePoison_52CDB0(a1 int32, a2, a3, a4 *server.Object, a5 *server.SpellAcceptArg, a6 int32) int32 {
	var (
		result int32
		v7     int32
		v8     int16
...
func sub_52CE60(it *server.Object, data unsafe.Pointer) {
	...
	if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1), 8)))&0x80 != 0 {
		a1.ObjOwner = *memmap.PtrUint32(0x5D4594, 2487716)
		a1.Field34 = gameFrame() + gameFPS()*60
	}
}
func nox_xxx_castLock_52CE90(a1 int32, a2, a3, a4 *server.Object, a5 *server.SpellAcceptArg, a6 int) int32 {
	var (
		v5 int32
		v7 int32
		v8 int32
	...
	v9.field_0 = float32(float64(a3.PosVec.X) - 150.0)
	v9.field_4 = float32(float64(a3.PosVec.Y) - 150.0)
	v9.field_8 = float32(float64(a3.PosVec.X) + 150.0)
	v9.field_C = float32(float64(a3.PosVec.Y) + 150.0)
	dword_5d4594_2487708 = 0
	*memmap.PtrUint32(0x5D4594, 2487704) = 1287568416
	nox_xxx_getUnitsInRect_517C10(&v9, sub_52CF90, unsafe.Pointer(a4))
	if dword_5d4594_2487708 == 0 {
		return 0
	}
	v5 = int32(*(*uint32)(unsafe.Add(dword_5d4594_2487708, 508)))
	if v5 != 0 && v5 != a3 {
		nox_xxx_netPriMsgToPlayer_4DA2C0(a3, internCStr("ExecSpel.c:DoorAlreadyLocked"), 0)
		return 0
	}
...
func sub_52CF90(it *server.Object, data unsafe.Pointer) {
	...
	v2 = a1
	if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1), 8)))&0x80 != 0 {
		v3 = float64(*(*float32)(unsafe.Add(a2, 56)) - a1.PosVec.X)
		v4 = float64(*(*float32)(unsafe.Add(a2, 60)) - a1.PosVec.Y)
		v8 = float32(v4*v4 + v3*v3)
		if float64(v8) <= 22500.0 && float64(v8) < float64(*memmap.PtrFloat32(0x5D4594, 2487704)) {
			...
			if nox_xxx_mapTraceRay_535250(&v7, nil, nil, 0) != 0 {
				...
				*memmap.PtrFloat32(0x5D4594, 2487704) = float32(v4*v4 + v3*v3)
			}
		}
	}
}
...
func nox_xxx_castTelekinesis_52D330(a1 int32, a2, a3, a4 *server.Object, a5 *server.SpellAcceptArg, a6 int8) int32 {
	var (
		result int32
		v7     *uint32
		v8     int32
	...
	if int32(*(*uint8)(unsafe.Add(result, 8)))&4 != 0 {
		v7 = nox_xxx_newObjectByTypeID_4E3810(internCStr("TelekinesisHand"))
		if v7 != nil {
			...
			nox_xxx_spellCancelDurSpell_4FEB10(spell.SPELL_LIGHTNING, (*server.Object)(unsafe.Pointer(uintptr(*a5))))
			nox_xxx_spellCancelDurSpell_4FEB10(spell.SPELL_CHAIN_LIGHTNING, (*server.Object)(unsafe.Pointer(uintptr(*a5))))
			v9 = *a5
...
func nox_xxx_castFist_52D3C0(a1 int32, a2, a3, a4 *server.Object, a5 *server.SpellAcceptArg, a6 int32) int32 {
	var (
		v6     int32
		v7     *uint8
		v8     float32
	...
	if nox_xxx_mapTraceRay_535250(&v21, nil, nil, int8(func() int32 {
		...
		if v14 != nil {
			...
			*v16 = uint32(int32(v20))
			nox_xxx_createAt_4DAA50((*server.Object)(v15), a4, a5.Pos.X, a5.Pos.Y)
...
func nox_xxx_spellCastCleansingFlame_52D5C0(a1 int32, a2p, a3p, a4p *server.Object, a5p *server.SpellAcceptArg, a6 int32) int32 {
	var (
		a2 = a2p
		a3 = a3p
		a4 = a4p
	...
	if a2 != nil {
		v6 = int32(a2.Field129)
		if v6 != 0 {
			for {
				v7 = (*uint8)(memmap.PtrOff(0x5D4594, 2487760))
				for {
					if uint32(*(*uint16)(unsafe.Add(v6, 4))) == *(*uint32)(unsafe.Pointer(v7)) {
						nox_xxx_netPriMsgToPlayer_4DA2C0(a3, internCStr("plyrspel.c:TooManySpells"), 0)
						return 0
					}
					v7 = (*uint8)(unsafe.Add(unsafe.Pointer(v7), 4))
		...
		if v8 >= 1 {
			...
			if v9 != nil {
				...
				*((*uint16)(unsafe.Add(unsafe.Pointer(v9), unsafe.Sizeof(uint16(0))*62))) = uint16(v10)
				v12 = v11 + float64(a4.Shape.Circle) + 4.0
				v13 = int32(v10) * 8
				v21 = *memmap.PtrFloat32(0x587000, uintptr(uint32(v13)+194136))
				v22 = *memmap.PtrFloat32(0x587000, uintptr(uint32(v13)+194140))
				v14 = a4.PosVec.Y
				v15 = v12*float64(v21) + float64(a4.PosVec.X)
				v20.field_0 = a4.PosVec.X
				v20.field_4 = v14
				v20.field_8 = float32(v15)
				v20.field_C = float32(v12*float64(v22) + float64(a4.PosVec.Y))
				if nox_xxx_mapTraceRay_535250(&v20, nil, nil, 65) != 0 {
					nox_xxx_createAt_4DAA50((*server.Object)(unsafe.Pointer(v9)), a4, v20.field_8, v20.field_C)
					...
					*(*float32)(unsafe.Add(unsafe.Pointer(v9), unsafe.Sizeof(float32(0))*39)) = a4.PosVec.X
					*(*float32)(unsafe.Add(unsafe.Pointer(v9), unsafe.Sizeof(float32(0))*40)) = a4.PosVec.Y
...
func nox_xxx_castMeteorShower_52D8A0(a1 int32, a2, a3, a4 *server.Object, a5 *server.SpellAcceptArg, a6 int32) int32 {
	var (
		v6     int32
		v7     int32
		v8     float32
	...
	if nox_xxx_mapTraceRay_535250(&v19, nil, nil, int8(func() int32 {
		...
		if v14 != nil {
			...
			*v16 = uint32(int32(v18))
			nox_xxx_createAt_4DAA50((*server.Object)(v15), a3, *(*float32)(unsafe.Add(v6, 4)), *(*float32)(unsafe.Add(v6, 8)))
			v17 = nox_xxx_spellGetAud44_424800(a1, 0)
...
func nox_xxx_castToxicCloud_52DB60(a1 int32, a2, a3, a4p *server.Object, a5 *server.SpellAcceptArg, a6 int) int32 {
	var (
		v7  float32
		v8  float32
		v9  float32
	...
	v7 = a4p.PosVec.X
	v8 = a5.Pos.X
	v16.field_4 = a4p.PosVec.Y
	v16.field_0 = v7
	v9 = a5.Pos.Y
	v16.field_8 = v8
	v16.field_C = v9
	if int32(uint8(int8(nox_xxx_traceRay_5374B0(&v16)))) != 0 {
		v12 := nox_xxx_newObjectWithTypeInd_4E3450(*memmap.PtrInt32(0x5D4594, 2487808))
		if v12 != nil {
			v13 = (*uint32)(v12.UpdateData)
			nox_xxx_createAt_4DAA50(v12, a3, v6.Pos.X, v6.Pos.Y)
		...
		nox_xxx_aud_501960(v14, v12, 0, 0)
		return 1
	} else {
		if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(v5), 8)))&4 == 0 {
			return 0
		}
		v10 = int32(v5.UpdateData)
		var a4 int32 = 2
		nox_xxx_netInformTextMsg_4DA0F0(int32(*(*uint8)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(v10, 276)), 2064))), 0, &a4)
		return 0
	}
}
func nox_xxx_spellArachna_52DC80(a1 int32, a2, a3, a4p *server.Object, a5 *server.SpellAcceptArg, a6 int) int32 {
	var (
		v7  float32
		v8  float32
		v9  float32
	...
	v7 = a4p.PosVec.X
	v8 = a5.Pos.X
	v13.field_4 = a4p.PosVec.Y
	v13.field_0 = v7
	v9 = a5.Pos.Y
	v13.field_8 = v8
	v13.field_C = v9
	if nox_xxx_traceRay_5374B0(&v13) != 0 {
		v12 = (*uint32)(unsafe.Pointer(nox_xxx_newObjectWithTypeInd_4E3450(*memmap.PtrInt32(0x5D4594, 2487812))))
		if v12 != nil {
			nox_xxx_createAt_4DAA50((*server.Object)(unsafe.Pointer(v12)), a3, v6.Pos.X, v6.Pos.Y)
		}
		return 1
	} else {
		if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(v5), 8)))&4 == 0 {
...
func sub_52DD50(a1 int32, a2, a3, a4 *server.Object, a5 unsafe.Pointer, a6 int) int32 {
	var (
		v5  unsafe.Pointer
		v8  int16
		v9  int16
	...
	if int32(v8) == int32(nox_xxx_unitGetMaxHP_4EE7A0((*server.Object)(v6))) && uint32(a2) == *(*uint32)(a5) {
		v9 = int16(nox_xxx_spellManaCost_4249A0(a1, 1))
		sub_4FD030(a3, v9)
		return 1
	}
	v15 = float32(nox_xxx_gamedataGetFloat_419D40(internCStr("LesserHealAmount")))
	if a3 != nil && int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a3), 8)))&4 != 0 {
		v10 = int8(*(*uint8)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(a3.UpdateData, 276)), 2251)))
		switch v10 {
		case 0:
...
func nox_xxx_castEquake_52DE40(a1 int32, a2, a3, a4 *server.Object, a5 *server.SpellAcceptArg, a6 int32) int32 {
	var (
		v6  int32
		v7  int32
		v9  float32
	...
	*memmap.PtrUint32(0x5D4594, 2487700) = uint32(a6)
	...
	nox_xxx_unitsGetInCircle_517F90((*types.Pointf)(unsafe.Add(unsafe.Pointer(a4), 56)), v9, nox_xxx_equakeDamage_52DEC0, unsafe.Pointer(a4))
	v6 = nox_xxx_spellGetAud44_424800(a1, 0)
	nox_xxx_aud_501960(v6, a4, 0, 0)
	v10 = float32(nox_xxx_gamedataGetFloatTable_419D70(internCStr("EarthquakeJiggle"), a6-1))
	v7 = int32(v10)
	nox_xxx_earthquakeSend_4D9110((*types.Pointf)(unsafe.Add(unsafe.Pointer(a4), 56)), v7)
	return 1
}
func nox_xxx_equakeDamage_52DEC0(it *server.Object, data unsafe.Pointer) {
	...
	v2 := a2
	v3 := nox_xxx_findParentChainPlayer_4EC580((*server.Object)(a2))
	v4 := v3
	if a1 != a2 {
		v3 = int32(a1.ObjFlags)
		if (v3 & 0x4000) == 0 {
			*(*uint16)(unsafe.Add(unsafe.Pointer(&v3), unsafe.Sizeof(uint16(0))*0)) = uint16(nox_xxx_unitGetHP_4EE780(a1))
			if int32(uint16(int16(v3))) != 0 {
				v7 = float32(nox_xxx_calcDistance_4E6C00(a1, (*server.Object)(a2)))
				...
				*(*uint16)(unsafe.Add(unsafe.Pointer(&v3), unsafe.Sizeof(uint16(0))*0)) = uint16(int16(ccall.AsFunc[func(int32, int32, int32, uint32, int32) int32](*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(a1), 716)))(a1, v4, v2, uint32(int32(int64(v5))), 11)))
			}
		}
	}
}
...
func nox_xxx_unitPushAroundFn_52E0E0(it *server.Object, data unsafe.Pointer) {
	...
	v2 := a1
	if nox_xxx_isObjectMovable_52E020(unsafe.Pointer(a1)) != 0 {
		v3 = (**int32)(a2)
		v4 = *a2
		*(*uint32)(unsafe.Add(unsafe.Pointer(&v15.field_0), 4*0)) = uint32(**a2)
		...
		if nox_xxx_mapTraceRay_535250(&v15, nil, nil, 0) != 0 {
			v13 = a1.PosVec.X - *(*float32)(unsafe.Pointer(*a2))
			v8 = float64(a1.PosVec.Y - *((*float32)(unsafe.Add(unsafe.Pointer(*a2), unsafe.Sizeof(float32(0))*1))))
			v14 = float32(v8)
			v9 = math.Sqrt(v8*float64(v14)+float64(v13*v13)) + 0.1
			v16 = float32(v9)
			if v9 <= float64(*((*float32)(unsafe.Add(a2, unsafe.Sizeof(float32(0))*1)))) {
				if float64(v16) > float64(*((*float32)(unsafe.Add(a2, unsafe.Sizeof(float32(0))*2)))) {
					v17 = float32((1.0 - float64((v16-*((*float32)(unsafe.Add(a2, unsafe.Sizeof(float32(0))*2))))/(*((*float32)(unsafe.Add(a2, unsafe.Sizeof(float32(0))*1)))-*((*float32)(unsafe.Add(a2, unsafe.Sizeof(float32(0))*2)))))) * float64(*((*float32)(unsafe.Add(a2, unsafe.Sizeof(float32(0))*3)))))
				} else {
					v17 = *((*float32)(unsafe.Add(a2, unsafe.Sizeof(float32(0))*3)))
				}
				...
				if v11 != nil {
					(ccall.AsFunc[func(unsafe.Pointer, uint32, *int32)](v11))(unsafe.Pointer(v2), *(*uint32)(unsafe.Add(unsafe.Pointer(&v16), 4*0)), *(**int32)(unsafe.Add(unsafe.Pointer(v3), unsafe.Sizeof((*int32)(nil))*6)))
				}
				v12 = (int32(*(*uint8)(unsafe.Add(unsafe.Pointer(v2), 8))) & 1) == 0
				v2.ForceVec.X = v18*v13/v16 + v2.ForceVec.X
				v2.ForceVec.Y = v18*v14/v16 + v2.ForceVec.Y
				if v12 {
...
func Nox_xxx_spellDrainMana_52E210(sp *server.DurSpell) int32 {
	...
	v2 := sp.Caster16
	if v2 != nil {
		if nox_xxx_testUnitBuffs_4FF350(v2, 8) != 0 {
			return 1
		}
	} else if sp.Flag20 == 0 {
		return 1
	...
	if sp.Flag20 != 0 {
		...
		v19.Y = v4
		v5 := sub_52E610(&v19, v3)
		if v5 != nil {
			nox_xxx_playerManaSub_4EEBF0((*server.Object)(v5), 50)
			return 1
		}
		return 1
	}
	...
	v9 := sp.Caster16
	if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(v9), 8)))&2 != 0 {
		if sub_4FEA70(v9, (*types.Pointf)(unsafe.Add(unsafe.Pointer(sp), 28))) != 0 {
			return 1
		}
	}
	v10 := sp.Caster16
	v11 = float64(sp.Pos.X - v10.PosVec.X)
	if v11 < 0.0 {
		v11 = -v11
	}
	v19.X = float32(v11)
	v12 = float64(sp.Pos.Y - v10.PosVec.Y)
	if v12 < 0.0 {
		v12 = -v12
	}
	v19.Y = float32(v12)
	...
	v13 := sub_52E610(&sp.Caster16.PosVec, int32(sp.Caster16))
	sp.Target48 = (*server.Object)(v13)
	if v13 == nil {
		if sp.Field36 != 0 {
			nox_xxx_netStopRaySpell_4FEF90(*(*int32)(unsafe.Add(unsafe.Pointer(&a1), 4*0)), sp.Field36)
		}
		return 1
	}
	v21 = float32(sp.Field72)
	v22 = float32(nox_xxx_gamedataGetFloatTable_419D70(internCStr("ManaDrainCoeff"), int32(v1.Level-1)) + float64(v21))
	v14 = int32(COERCE_FLOAT(uint32(int32(v22))))
	v15 := v1.Target48
	v19.X = float32(v14)
	v16 = float64(v14)
	v17 = v1.Field36
	v1.Field72 = int32(float32(float64(v22) - v16))
	if v15 != v17 {
		if v17 != nil {
	...
	v18 = int32(v22)
	if sub_52E450(v1.Caster16, v1.Target48, v18) != 0 && (gameFrame()%(gameFPS()>>1)) == 0 {
		nox_xxx_aud_501960(int32(sound.SoundManaRecharge), v1.Caster16, 0, 0)
		nox_xxx_aud_501960(int32(sound.SoundDrainMana), v1.Target48, 0, 0)
	}
	v1.Field36 = v1.Target48
	return 0
}
func sub_52E450(to *server.Object, from *server.Object, a3 int32) int32 {
	var (
		v6  int32
		v7  int32
		v9  float64
	...
	if to.Class().Has(object.ClassPlayer) {
		ud := to.UpdateData
		if int32(uint16(nox_xxx_unitGetOldMana_4EEC80(to))) >= int32(*(*uint16)(unsafe.Add(ud, 8))) {
			return 0
		}
	}
	if from.Class().Has(object.ClassImmobile) && from.SubClass().AsOther().HasAny(object.OtherVisibleObelisk|object.OtherInvisibleObelisk) {
		ud := (*int32)(from.UpdateData)
		if nox_xxx_servObjectHasTeam_419130(from.TeamPtr()) != 0 && nox_xxx_servCompareTeams_419150(from.TeamPtr(), to.TeamPtr()) == 0 {
			return 0
		}
		v6 = a3
		if *ud <= a3 {
		...
		if !noxflags.HasGame(noxflags.GameModeQuest) {
			nox_xxx_unitNeedSync_4E44F0(from)
		}
		if v6 <= 0 {
			return 0
		}
	} else if from.Class().Has(object.ClassMonster) {
		if from.UpdateDataMonster().StatusFlags.Has(object.MonStatusCanCastSpells) {
			v6 = 1
			a3 = 1
		} else {
			v6 = a3
	...
	} else if from.Class().Has(object.ClassPlayer) {
		v6 = a3
		ud := from.UpdateDataPlayer()
		v7 = int32(ud.ManaCur)
		if int32(uint16(int16(v7))) <= a3 {
			v6 = int32(ud.ManaCur)
			a3 = int32(ud.ManaCur)
			nox_xxx_playerManaSub_4EEBF0(from, v7)
		} else {
			nox_xxx_playerManaSub_4EEBF0(from, a3)
		}
		if v6 <= 0 {
			return 0
		}
	...
	if !noxflags.HasGame(4096) || (int32(*(*uint8)(unsafe.Add(unsafe.Pointer(to), 8)))&4) == 0 {
		nox_xxx_playerManaAdd_4EEB80(to, int16(v6))
		return 1
	}
	switch to.UpdateDataPlayer().Player.PlayerClass() {
	case player.Warrior:
...
func sub_52E610(a1 *types.Pointf, a2 int32) unsafe.Pointer {
	*memmap.PtrUint32(0x5D4594, 2487828) = 0
	*memmap.PtrUint32(0x5D4594, 2487876) = 1287568416
	*memmap.PtrFloat32(0x5D4594, 2487836) = a1.X
	*memmap.PtrFloat32(0x5D4594, 2487840) = a1.Y
	v3 := float32(nox_xxx_gamedataGetFloat_419D40(internCStr("ManaDrainRange")))
	nox_xxx_unitsGetInCircle_517F90(a1, v3, sub_52E660, a2)
...
func sub_52E660(it *server.Object, data unsafe.Pointer) {
	...
	if a1 == a2 || sub_52E7C0(unsafe.Pointer(a1)) == 0 || a1.ObjFlags&0x8020 != 0 {
		return
	}
	v2 = int32(a1.ObjClass)
	if (v2 & 2) == 0 {
		if uint32(v2)&0x400000 != 0 && int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1), 12)))&0x18 != 0 {
			v4 = 1.0
		} else {
			if (v2 & 4) == 0 {
				return
			...
			if nox_xxx_unitsHaveSameTeam_4EC520(a1, (*server.Object)(a2)) != 0 || int32(*(*uint8)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(v5, 276)), 3680)))&1 != 0 {
				return
			}
			v4 = 0.5
		}
	...
	v3 = int32(a1.UpdateData)
	if a2 != nil && nox_xxx_unitIsEnemyTo_5330C0((*server.Object)(a2), a1) == 0 || int32(*(*uint8)(unsafe.Add(v3, 1440)))&0x20 == 0 {
		return
	}
	v4 = 1.0
LABEL_18:
	v6 = float64(*memmap.PtrFloat32(0x5D4594, 2487836) - a1.PosVec.X)
	v7 = float64(*memmap.PtrFloat32(0x5D4594, 2487840) - a1.PosVec.Y)
	v8 = v4 * (v7*v7 + v6*v6)
	if v8 < float64(*memmap.PtrFloat32(0x5D4594, 2487876)) {
		v9 = a1.PosVec.X
		v11.field_4 = *memmap.PtrFloat32(0x5D4594, 2487840)
		v11.field_0 = *memmap.PtrFloat32(0x5D4594, 2487836)
		v10 = a1.PosVec.Y
		v11.field_8 = v9
		v11.field_C = v10
		if nox_xxx_mapTraceRay_535250(&v11, nil, nil, 5) != 0 {
			*memmap.PtrPtr(0x5D4594, 2487828) = unsafe.Pointer(a1)
			v12 = float32(v8)
			*memmap.PtrFloat32(0x5D4594, 2487876) = v12
		}
	}
}
func sub_52E7C0(a1 unsafe.Pointer) int32 {
	...
	} else if v1&4 != 0 && int32(nox_xxx_unitGetOldMana_4EEC80((*server.Object)(a1))) != 0 {
		return 1
	}
	return 0
}
func Nox_xxx_spellEnergyBoltStop_52E820(sp *server.DurSpell) int32 {
	a1 := sp
	if a1.Caster16 != nil {
		nox_xxx_spellCancelDurSpell_4FEB10(spell.SPELL_CHAIN_LIGHTNING, a1.Caster16)
	}
	nox_xxx_netSendPointFx_522FF0(-126, (*types.Pointf)(unsafe.Add(unsafe.Pointer(a1), 28)))
	return 0
}
func Nox_xxx_spellEnergyBoltTick_52E850(sp *server.DurSpell) int32 {
	...
	} else if a1p.Flag20 == 0 {
		return 1
	}
	v31 = float32(nox_xxx_gamedataGetFloat_419D40(internCStr("LightningRange")))
	if v1.Flag20 == 0 {
		v9 := v1.Caster16
		if v9 != nil && int32(*(*uint8)(unsafe.Add(unsafe.Pointer(v9), 8)))&2 != 0 && sub_4FEA70(v9, (*types.Pointf)(unsafe.Add(unsafe.Pointer(v1), 28))) != 0 {
			return 1
		}
		if (gameFrame()-v1.Frame60) > 2 && sub_4E6BD0(v1.Caster16) != 0 {
			return 1
		}
		v10 := v1.Target48
		var v11 *server.Object
		if v10 != nil {
			if !((v10.ObjFlags&0x8020) == 0 && nox_server_testTwoPointsAndDirection_4E6E50((*types.Pointf)(unsafe.Add(unsafe.Pointer(v1.Caster16), 56)), int32(v1.Caster16.Direction1), (*types.Pointf)(unsafe.Add(unsafe.Pointer(v10), 56)))&1 != 0 && nox_xxx_calcDistance_4E6C00(v1.Target48, v1.Caster16) <= float64(v31) && nox_xxx_unitCanInteractWith_5370E0(v1.Caster16, v1.Target48, 0) != 0) {
				v1.Target48 = nil
			} else {
				goto LABEL_31
			}
		...
		if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(v11), 8)))&4 != 0 {
			v12 = int32(v11.UpdateData)
			v13 = int32(*(*uint32)(unsafe.Add(v12, 288)))
			if v13 != 0 {
				if nox_xxx_unitIsEnemyTo_5330C0(v11, (*server.Object)(*(*unsafe.Pointer)(unsafe.Add(v12, 288)))) != 0 && nox_xxx_calcDistance_4E6C00(v1.Caster16, (*server.Object)(v13)) <= float64(v31) {
					v1.Target48 = uint32(v13)
				}
			}
		}
		if v1.Target48 != nil {
		...
		*memmap.PtrUint32(0x5D4594, 2487832) = 0
		nox_xxx_energyBoltTarget_5d4594_2487880 = nil
		v14 = int32(v1.Caster16)
		*memmap.PtrFloat32(0x5D4594, 2487868) = *(*float32)(unsafe.Add(v14, 56))
		*memmap.PtrFloat32(0x5D4594, 2487872) = *(*float32)(unsafe.Add(v14, 60))
		dword_5d4594_2487884 = uint32(v31 * v31)
		nox_xxx_unitsGetInCircle_517F90((*types.Pointf)(unsafe.Add(unsafe.Pointer(v1.Caster16), 56)), v31, nox_xxx_spellEnergyBoltSetTarget_52EC60, unsafe.Pointer(v1.Caster16))
		v1.Target48 = nox_xxx_energyBoltTarget_5d4594_2487880
	LABEL_31:
		if v1.Target48 == nil {
			if v1.Field36 != 0 {
				nox_xxx_netStopRaySpell_4FEF90(v1, v1.Field36)
				v1.Field36 = 0
			}
			return 0
		}
	LABEL_32:
		v32 = float32(v1.Field72)
		v33 = float32(nox_xxx_gamedataGetFloatTable_419D70(internCStr("EnergyBoltDamage"), int32(v1.Level-1)) + float64(v32))
		v16 = v33
		v17 = int32(v33)
		v18 := v1.Target48
		v19 = float64(v17)
		v20 := v1.Field36
		v1.Field72 = int32(float32(float64(v33) - v19))
		if v18 != v20 {
			if v20 != nil {
		...
		v34 := v1.Target48
		v34.Damage.Get()(v1.Target48, v1.Caster16, nil, int(v16), 17)
		v22 := v1.Target48
		if v22.ObjFlags&0x8020 != 0 {
			nox_xxx_netSendPointFx_522FF0(-126, (*types.Pointf)(unsafe.Add(unsafe.Pointer(v22), 56)))
		}
		v23 := v1.Caster16
		v1.Field36 = v1.Target48
		if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(v23), 8)))&4 != 0 {
			nox_xxx_playerSetState_4FA020(v23, 10)
		}
		if (gameFrame() % (gameFPS() / 3)) == 0 {
			nox_xxx_aud_501960(32, v1.Caster16, 0, 0)
			nox_xxx_aud_501960(32, v1.Target48, 0, 0)
		}
		v28 = float32(nox_xxx_gamedataGetFloat_419D40(internCStr("LightningSearchTime")))
		v1.Frame68 = gameFrame() + uint32(int32(v28))
		v24 := v1.Caster16
		if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(v24), 8)))&4 != 0 {
			nox_xxx_playerSetState_4FA020(v24, 10)
			nox_xxx_playerManaSub_4EEBF0(v1.Caster16, 1)
			if int32(nox_xxx_unitGetOldMana_4EEC80(v1.Caster16)) == 0 {
				return 1
			}
		}
		v25 = int32(v1.Target48.ObjFlags)
		if (v25 & 0x8000) != 0 {
			result = 0
			v1.Frame68 = gameFrame() + 1
			return result
		}
		return 0
	}
	...
	v29.X = v1.Pos.X
	v29.Y = v1.Pos.Y
	*memmap.PtrFloat32(0x5D4594, 2487868) = v29.X
	*memmap.PtrFloat32(0x5D4594, 2487872) = v29.Y
	nox_xxx_energyBoltTarget_5d4594_2487880 = nil
	dword_5d4594_2487884 = uint32(v31 * v31)
	*memmap.PtrUint32(0x5D4594, 2487832) = 1
	nox_xxx_unitsGetInCircle_517F90(&v29, v31, nox_xxx_spellEnergyBoltSetTarget_52EC60, unsafe.Pointer(v1.Caster16))
	if nox_xxx_energyBoltTarget_5d4594_2487880 == nil {
		return 1
	}
	v6 := nox_xxx_energyBoltTarget_5d4594_2487880.Damage.Get()
	v27 = float32(nox_xxx_gamedataGetFloat_419D40(internCStr("EnergyBoltGlyphDamage")))
	v6(nox_xxx_energyBoltTarget_5d4594_2487880, v1.Obj12, nil, int(v27), 17)
	v8 = nox_xxx_spellGetAud44_424800(24, 0)
	nox_xxx_aud_501960(v8, nox_xxx_energyBoltTarget_5d4594_2487880, 0, 0)
	nox_xxx_netSendPointFx_522FF0(-126, (*types.Pointf)(unsafe.Add(unsafe.Pointer(nox_xxx_energyBoltTarget_5d4594_2487880), 56)))
	return 1
}
func nox_xxx_spellEnergyBoltSetTarget_52EC60(it *server.Object, data unsafe.Pointer) {
	target := it
	source := (*server.Object)(data)
	var (
		v2 int32
		v3 int32
		v4 float64
	...
	v2 = int32(target.ObjClass)
	if uint32(v2)&0x20006 != 0 {
		if (target.ObjFlags&0x8020) == 0 && target != source {
			if (v2&2) == 0 || (func() bool {
				v3 = int32(target.ObjSubClass)
				return (v3 & 0x8000) == 0
			}()) {
				if source == nil || nox_xxx_unitIsEnemyTo_5330C0(source, target) != 0 && (*memmap.PtrUint32(0x5D4594, 2487832) != 0 || nox_server_testTwoPointsAndDirection_4E6E50((*types.Pointf)(unsafe.Add(unsafe.Pointer(source), 56)), int32(source.Direction1), (*types.Pointf)(unsafe.Add(unsafe.Pointer(target), 56)))&1 != 0 && nox_xxx_unitCanInteractWith_5370E0(source, target, 0) != 0) {
					v4 = float64(target.PosVec.X - *memmap.PtrFloat32(0x5D4594, 2487868))
					v5 = float64(target.PosVec.Y - *memmap.PtrFloat32(0x5D4594, 2487872))
					v6 = v5*v5 + v4*v4
...
func Nox_xxx_firewalkTick_52ED40(sp *server.DurSpell) int32 {
	...
	if sp.Target48.ObjFlags&0x8020 != 0 {
		return 1
	}
	...
	if sp.Frame60 == sp.Frame64 {
		*(*float32)(unsafe.Pointer(&sp.Field72)) = sp.Target48.PosVec.X
		*(*float32)(unsafe.Pointer(&sp.Field76)) = sp.Target48.PosVec.Y
		sp.Field80 = uint32(sp.Field72)
		sp.Field84 = uint32(sp.Field76)
		sp.Frame64++
		return 0
	}
	v5 := sp.Target48
	dx := float64(v5.PosVec.X - *(*float32)(unsafe.Pointer(&sp.Field72)))
	dy := float64(v5.PosVec.Y - *(*float32)(unsafe.Pointer(&sp.Field76)))
	...
	if dist-float64(v5.Shape.Circle.R) <= 15.0 {
		return 0
	}
	var pos types.Pointf
	pos.X = *(*float32)(unsafe.Pointer(&sp.Field72))
	pos.Y = *(*float32)(unsafe.Pointer(&sp.Field76))
	for i := 0; i < 2; i++ {
		ind := nox_common_randomInt_415FA0(0, flameMax)
		v14 := nox_xxx_newObjectWithTypeInd_4E3450(int32(*memmap.PtrUint32(0x5D4594, uintptr(ind)*4+2487888)))
		if v14 != nil {
			nox_xxx_createAt_4DAA50(v14, nil, pos.X, pos.Y)
			nox_xxx_audCreate_501A30(46, &pos, 0, 0)
			nox_xxx_unitSetDecayTime_511660(v14, int32(gameFPS()*25))
		}
		ddx := pos.X - *(*float32)(unsafe.Pointer(&sp.Field80))
		ddy := pos.Y - *(*float32)(unsafe.Pointer(&sp.Field84))
		if float64(ddx) != 0.0 && float64(ddy) != 0.0 {
			pos.X = float32(float64(pos.X) - float64(ddx)*0.5)
			pos.Y = float32(float64(pos.Y) - float64(ddy)*0.5)
		}
	}
	sp.Field80 = uint32(sp.Field72)
	sp.Field84 = uint32(sp.Field76)
	sp.Field72 = int32(sp.Target48.PosVec.X)
	sp.Field76 = uintptr(sp.Target48.PosVec.Y)
	return 0
}
func Sub_52EF30(sp *server.DurSpell) int32 {
	...
	if a1.Flag20 != 0 {
		*(*uint16)(unsafe.Add(unsafe.Pointer(a1), 72)) = uint16(a1.Obj24.Direction1)
		v3 := a1.Obj24
		v4 = v3.PosVec.X
		v5 = v3.PosVec.Y
	} else {
		...
		if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(v1), 8)))&4 != 0 {
			v2 := *(*uint32)(unsafe.Add(v1.UpdateData, 104))
			if v2 != 0 {
		...
		v4 = v6.PosVec.X
		v5 = v6.PosVec.Y
		*(*uint16)(unsafe.Add(unsafe.Pointer(a1), 72)) = uint16(v6.Direction1)
	}
	v7 := nox_xxx_newObjectByTypeID_4E3810(internCStr("ForceOfNatureCharge"))
	v8 := v7
	if v7 != nil {
		nox_xxx_createAt_4DAA50(v7, nil, v4, v5)
		a1.Field76 = uintptr(unsafe.Pointer(v8))
	}
	return 0
}
func Sub_52EFD0(sp *server.DurSpell) int32 {
	...
	v1 := a1
	v2 := a1.Caster16
	if v2 != nil && nox_xxx_testUnitBuffs_4FF350(v2, 8) != 0 {
		return 1
	}
	if a1.Frame68-7 == gameFrame() && a1.Field76 != 0 {
		nox_xxx_delayedDeleteObject_4E5CC0((*server.Object)(unsafe.Pointer(uintptr(a1.Field76))))
		a1.Field76 = 0
	}
	if a1.Frame68-1 != gameFrame() {
		...
		if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(v11), 8)))&4 != 0 {
			nox_xxx_playerSetState_4FA020(v11, 10)
		}
		return 0
	}
	v4 := nox_xxx_newObjectByTypeID_4E3810(internCStr("DeathBall"))
	if v4 == nil {
		return 1
	}
	if a1.Flag20 != 0 {
		v5 = a1.Pos.X
		v6 = a1.Pos.Y
		v7 = int16(*(*uint16)(unsafe.Add(unsafe.Pointer(a1), 72)))
		v13 = a1.Pos.X
		v8 = 0.0
		v14 = a1.Pos.Y
	} else {
		...
		v5 = v9.PosVec.X
		v6 = v9.PosVec.Y
		v7 = int16(v9.Direction1)
		v13 = v9.PosVec.X
		v14 = v9.PosVec.Y
		switch v9.Shape.Kind {
		case 1:
			v8 = 4.0
		case 2:
			v8 = float64(v9.Shape.Circle.R) + 4.0
		case 3:
			if float64(v9.Shape.Box.W) <= float64(v9.Shape.Box.H) {
				v8 = float64(v9.Shape.Box.H) + 4.0
			} else {
				v8 = float64(v9.Shape.Box.W) + 4.0
			}
		default:
			v8 = 24.0
		}
	...
	v10 = int32(v7) * 8
	v15.field_4 = v6
	v16 = *memmap.PtrFloat32(0x587000, uintptr(uint32(v10)+194136))
	v12 = *memmap.PtrFloat32(0x587000, uintptr(uint32(v10)+194140))
	v15.field_0 = v5
	...
	nox_xxx_createAt_4DAA50(v4, v1.Caster16, v15.field_8, v15.field_C)
	if v1.Flag20 == 1 {
		v4.VelVec.X = 0.0
		v4.VelVec.Y = 0.0
	} else {
		v4.VelVec.X = v16 * v4.SpeedCur
		v4.VelVec.Y = v12 * v4.SpeedCur
	}
	v4.Direction1 = server.Dir16(uint16(v7))
	v4.Direction2 = server.Dir16(uint16(v7))
	nox_xxx_aud_501960(38, v1.Caster16, 0, 0)
	return 1
}
func Sub_52F1D0(sp *server.DurSpell) {
	a1 := sp
	if a1.Field76 != 0 {
		nox_xxx_delayedDeleteObject_4E5CC0((*server.Object)(unsafe.Pointer(a1.Field76)))
	}
	v1 := a1.Caster16
	if v1 == nil {
		return
	...
	v2 := v1.UpdateDataPlayer().Field26
	if v2 == nil {
		return
	}
	if v2.ObjSubClass&0x200000 != 0 {
		v3 := v2.UseData
		*(*uint32)(unsafe.Add(v3, 96)) &= 0xFFFFFFFB
	}
}
func Sub_52F220(sp *server.DurSpell) int32 {
	...
	v6 = int32(uintptr(unsafe.Pointer(nox_xxx_spellFlySearchTarget_540610((*types.Pointf)(unsafe.Add(unsafe.Pointer(a1), 4*13)), a1.Caster16, v5, 400.0, 1, (*server.Object)(v7)))))
	a1.Target48 = v6
	if v6 != 0 {
		result = nox_xxx_unitIsEnemyTo_5330C0(a1.Caster16, (*server.Object)(v6))
		if result == 0 {
			nox_xxx_netStartDurationRaySpell_4FF130(a1)
			result = 0
		}
	} else {
		nox_xxx_netPriMsgToPlayer_4DA2C0(a1.Caster16, internCStr("ExecDur.c:GreaterHealNoTarget"), 0)
		result = 1
	}
	return result
}
func Sub_52F2E0(sp *server.DurSpell) int32 {
	...
	v4 = int32(a1p.Caster16)
	if v4 != 0 && nox_xxx_testUnitBuffs_4FF350((*server.Object)(v4), 8) != 0 {
		return 1
	}
	if nox_xxx_unitCanInteractWith_5370E0(a1p.Caster16, a1p.Target48, 0) == 0 {
		return 1
	}
	if int32(nox_xxx_unitGetOldMana_4EEC80(a1p.Caster16)) == 0 {
		return 1
	}
	v5 = int32(a1p.Caster16)
	if int32(*(*uint8)(unsafe.Add(v5, 8)))&2 != 0 && sub_4FEA70(v5, (*types.Pointf)(unsafe.Add(unsafe.Pointer(a1p), 28))) != 0 {
		return 1
	}
	if sub_4E6BD0(a1p.Caster16) != 0 {
		return 1
	}
	v6 = nox_xxx_unitGetMaxHP_4EE7A0(a1p.Target48)
	if int32(v6) == int32(nox_xxx_unitGetHP_4EE780(a1p.Target48)) {
		return 1
	}
	v7 = int32(a1p.Caster16)
	v11 = a1p.Field72 + *memmap.PtrFloat32(0x587000, uintptr(a1p.Level*4+260360))
	...
	*(*float32)(unsafe.Add(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer(&v1), 4*0))))), 72)) = float32(float64(v11) - float64(int32(v11)))
	...
	nox_xxx_playerManaSub_4EEBF0((*server.Object)(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer(&v1), 4*0))))), 16))), 1)
	return 0
}
func Sub_52F460(sp *server.DurSpell) int32 {
	...
	if v2.ObjFlags&0x8020 != 0 {
		return 1
	}
	if a1p.Flag20 != 0 {
		nox_xxx_playerManaAdd_4EEB80(v2, 20)
		nox_xxx_unitDamageClear_4EE5E0(a1p.Target48, 20)
		return 1
	}
	v4 := a1p.Caster16
	if v4 != nil && nox_xxx_testUnitBuffs_4FF350(v4, 8) != 0 {
		return 1
	}
	v5 := a1p.Target48
	if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(v5), 8)))&2 != 0 && sub_4FEA70(v5, (*types.Pointf)(unsafe.Add(unsafe.Pointer(a1p), 28))) != 0 {
		return 1
	}
	v6 := nox_xxx_playerGetMaxMana_4EECB0(a1p.Target48)
	if int32(v6) == int32(nox_xxx_unitGetOldMana_4EEC80(a1p.Target48)) {
		return 1
	} else if int32(uint16(nox_xxx_unitGetHP_4EE780(a1p.Caster16))) <= 1 {
		return 1
	}
	if int32(nox_xxx_unitGetHP_4EE780(a1p.Caster16)) == 0 {
		return 0
	}
	v8 := float32(a1p.Field72)
	...
	sp.Field72 = int32(float32(float64(v9) - float64(int32(v9))))
	v7 := int16(int32(v9))
...
func Nox_xxx_castShield1_52F5A0(sp *server.DurSpell) int32 {
	...
	v3 = int32(v5)
	nox_xxx_buffApplyTo_4FF380(a1.Target48, 26, int16(v3), int8(uint8(a1.Level)))
	v4 = int32(a1.Level - 1)
...
func Sub_52F670(sp *server.DurSpell) {
	a1 := sp
	var result int32
	result = int32(a1.Target48)
	if result != 0 {
		nox_xxx_spellBuffOff_4FF5B0((*server.Object)(result), 26)
	}
}
func nox_xxx_unitShield_52F690(a1 *server.Object, a2 int32) {
	v2 := nox_xxx_spellCastedFirst_4FE930()
	if v2 != nil {
		for v2.Target48 != a1 || v2.Spell != 51 {
			v2 = nox_xxx_spellCastedNext_4FE940(v2)
			if v2 == nil {
		...
		v3 := v2.Target48
		if v3 != nil {
			if v3.ObjFlags&0x8020 != 0 {
				nox_xxx_spellCancelSpellDo_4FE9D0(v2)
			} else if int32(v2.Field72)-a2 > 0 {
				v2.Field72 -= a2
			} else {
				nox_xxx_spellCancelSpellDo_4FE9D0(v2)
			}
...
func nox_xxx_unitShieldReduceDamage_52F710(a1 *server.Object, a2 *int32, a3 int32, a4 unsafe.Pointer) {
	var (
		v4 int32
		v5 int32
	)
	if a1 != nil && a2 != nil {
		...
		v4 = *a2
		if int32(uint16(nox_xxx_unitGetHP_4EE780(a1))) > v4 {
			*a2 = v4 / 2
			if (v4 / 2) == 0 {
				*a2 = 1
			}
			...
			if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1), 8)))&4 != 0 && (func() bool {
				v5 = int32(a1.UpdateData)
				return int32(*(*uint8)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(v5, 276)), 2251))) == 0
			}()) && int32(*(*uint8)(unsafe.Add(v5, 88))) == 16 && a4 != nil && nox_server_testTwoPointsAndDirection_4E6E50((*types.Pointf)(unsafe.Add(unsafe.Pointer(a1), 56)), int32(a1.Direction1), (*types.Pointf)(unsafe.Add(a4, 72)))&1 != 0 {
				*a2 = 1
			} else {
				nox_xxx_unitSetHP_4E4560(a1, 2)
				*a2 = 0
			}
			nox_xxx_unitShield_52F690(a1, 999999)
			a1.Obj130 = (*server.Object)(a4)
			a1.Field131 = uint32(a3)
...
func Nox_xxx_onStartLightning_52F820(sp *server.DurSpell) int32 {
	...
	a1.Field76 = 0
	if a1.Caster16 != nil {
		nox_xxx_spellCancelDurSpell_4FEB10(spell.SPELL_LIGHTNING, a1.Caster16)
	}
	if a1.Flag20 == 0 {
	...
	nox_xxx_netSendPointFx_522FF0(-127, (*types.Pointf)(unsafe.Add(unsafe.Pointer(a1), 28)))
	return 0
}
