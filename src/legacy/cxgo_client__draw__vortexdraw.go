...
func nox_thing_vortex_draw(vp *noxrender.Viewport, dr *client.Drawable) int {
	...
	a2a.field_0 = int32(*(*uint32)(unsafe.Add(a2, 440)) + uint32(v3**memmap.PtrInt32(0x587000, uintptr(v2)+192088)/16))
	a2a.field_4 = int32(*(*uint32)(unsafe.Add(a2, 444)) + uint32(v3**memmap.PtrInt32(0x587000, uintptr(v2)+192092)/16))
	sub_4739E0((*uint32)(unsafe.Pointer(a1)), &a2a, &xLeft)
	v4 = xLeft.field_4 - int32(*(*int16)(unsafe.Add(a2, 104)))
	v5 = xLeft.field_0 <= *a1
	xLeft.field_4 -= int32(*(*int16)(unsafe.Add(a2, 104)))
	...
	a2a.field_0 = int32(*(*uint32)(unsafe.Add(a2, 440)) + uint32(v8)**memmap.PtrUint32(0x587000, uintptr(v7*8)+192088)/16)
	a2a.field_4 = int32(*(*uint32)(unsafe.Add(a2, 444)) + uint32(v8)**memmap.PtrUint32(0x587000, uintptr(v7*8)+192092)/16)
	sub_4739E0((*uint32)(unsafe.Pointer(a1)), &a2a, &xLeft)
	xLeft.field_4 -= int32(*(*int16)(unsafe.Add(a2, 104)))
	nox_client_drawAddPoint_49F500(xLeft.field_0, xLeft.field_4)
	if a2a.field_4 >= *(*int32)(unsafe.Add(a2, 444)) {
	...
	*(*uint16)(unsafe.Add(a2, 104)) += uint16(*(*uint8)(unsafe.Add(a2, 451)))
	sub_4739E0((*uint32)(unsafe.Pointer(a1)), (*int2)(unsafe.Add(a2, 12)), &a3)
