...
int sub_41A590(void* a1, int a2);
int sub_41AA30(void* a1, int a2);
int sub_41AC30(void* a1, int a2);
int sub_41B3B0();
int sub_41B3E0(int a1);
int nox_xxx_guiFieldbook_41B420(void* a1, int a2);
int nox_xxx_guiSpellbook_41B660(void* a1, int a2);
int nox_xxx_guiEnchantment_41B9C0(void* a1, int a2);
int sub_41BEC0(void* a1, int a2);
int sub_41C080(void* a1, int a2);
