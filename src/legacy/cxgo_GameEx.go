...
func playerInfoStructParser_0(a1p unsafe.Pointer) int8 {
	...
	*(*byte)(unsafe.Add(unsafe.Pointer(a1), 1)) = byte(nox_xxx_objGetTeamByNetCode_418C80(*((*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*515)))).ID)
...
func playerInfoStructParser_1(a1p unsafe.Pointer, a3 *int32) int8 {
	...
	for {
		...
		v4 = nox_common_playerInfoGetNext_416EE0((*server.Player)(a2))
