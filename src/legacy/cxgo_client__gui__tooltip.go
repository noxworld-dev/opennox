	...
	*memmap.PtrUint16(0x5D4594, 1317000) = 0
		...
		*((*uint8)(unsafe.Pointer(&a1))) = 243
		if v18&1 != 0 {
			...
			if v19 == 0 {
				...
				*(*uint16)(unsafe.Add(unsafe.Pointer(&a1), 1)) = uint16(nox_xxx_netGetUnitCodeCli_578B00(int32(uintptr(unsafe.Pointer(v1)))))
	...
	if v4 != nil {
		...
		if v7 == 0 || (uint32(*(*int32)(unsafe.Add(unsafe.Pointer(v1), 4*29)))&0x7800000) == 0 {
			...
			if v15 != 0 {
				v16 = *(**wchar2_t)(unsafe.Add(v15, 12))
				if v16 != nil {
					a1 = v16
				}
			}
