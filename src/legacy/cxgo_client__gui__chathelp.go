...
func nox_xxx_cliShowHelpGui_49C560() {
	...
	if result != nil {
		...
		nox_window_setPos_46A9B0(dword_5d4594_1305680, int32((int(nox_win_width)-dword_5d4594_1305680.SizeVal.X)/2), int32((int(nox_win_height)-dword_5d4594_1305680.SizeVal.Y)/2))
		var v4 *wchar2_t
		var v7 *byte
		var v2 *gui.Window
