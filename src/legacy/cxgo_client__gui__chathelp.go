...
func nox_xxx_cliShowHelpGui_49C560() {
	...
	if result != nil {
		...
		nox_xxx_wndShowModalMB_46A8C0((*gui.Window)(dword_5d4594_1305680))
		sub_46C690((*gui.Window)(dword_5d4594_1305680))
		nox_xxx_windowFocus_46B500((*gui.Window)(dword_5d4594_1305680))
		nox_window_setPos_46A9B0((*gui.Window)(unsafe.Pointer(dword_5d4594_1305680)), (nox_win_width-*(*int32)(unsafe.Add(dword_5d4594_1305680.C(), 8)))/2, (nox_win_height-*(*int32)(unsafe.Add(dword_5d4594_1305680.C(), 12)))/2)
		var v4 *wchar2_t
		var v7 *byte
		var v2 *gui.Window
		if noxflags.HasGame(1) {
			v2 = nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1305680)), 4102)
