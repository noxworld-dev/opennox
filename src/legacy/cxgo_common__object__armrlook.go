...
func nox_xxx_loadLook_415D50() **byte {
	...
	if *memmap.PtrUint32(0x5D4594, 371256) == 0 {
		...
		if *memmap.PtrUint32(0x587000, 35500) != 0 {
			...
			for {
				*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v1))), -int(4*1)))) = uint32(uintptr(unsafe.Pointer(nox_strman_loadString_40F1D0(*result, nil, internCStr("C:\\NoxPost\\src\\common\\Object\\ArmrLook.c"), 380))))
