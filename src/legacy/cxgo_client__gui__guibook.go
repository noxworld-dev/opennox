...
func nox_xxx_bookDrawList_45BD40(win *gui.Window, draw *gui.WindowData) int {
	...
	nox_gui_getWindowOffs_46AA20((*gui.Window)(a1), (*uint32)(unsafe.Pointer(&v66)), (*uint32)(unsafe.Pointer(&v67)))
	v1 = v66 - 24
	v2 = v67 - 76
	...
	if dword_5d4594_1046868 == 2 {
		nox_video_drawAnimatedImageOrCursorAt_4BE6D0(dword_5d4594_1046924, v1, v2)
		goto LABEL_75
	}
		...
		*(*uint32)(unsafe.Pointer(&WideCharStr[0])) = uint32(141/dword_5d4594_1046656 - 1)
		...
		if *(*uint32)(unsafe.Pointer(&WideCharStr[0]))*2 > 0 {
			for {
				...
				if int32(v8) >= int32(*memmap.PtrInt32(0x5D4594, 1047508))-dword_5d4594_1047512 {
					break
				}
				...
				nox_xxx_drawSetTextColor_434390(*memmap.PtrInt32(0x5D4594, 1046880))
				v9 = int8(*(*uint8)(unsafe.Add(dword_5d4594_1047516, 2251)))
				if dword_5d4594_1046868 == 1 {
					...
					v10 = nox_xxx_guiCreatureGetName_427240(int32(*memmap.PtrUint32(0x5D4594, uintptr(v8*4)+1046960)))
					nox_xxx_drawGetStringSize_43F840(nil, v10, &v65, nil, 128)
					v62 = v7
					v60 = v6 - v65/2
					v11 = nox_xxx_guiCreatureGetName_427240(int32(*memmap.PtrUint32(0x5D4594, uintptr(v8*4)+1046960)))
				} else if int32(v9) != 0 {
					...
					v62 = v7
					v60 = v6 - v65/2
					v11 = nox_xxx_spellTitle_424930(int32(*memmap.PtrUint32(0x5D4594, uintptr(v8*4)+1046960)))
				} else {
					...
					v62 = v7
					v60 = v6 - v65/2
					v11 = nox_xxx_abilityGetName_0_425260(int32(*memmap.PtrUint32(0x5D4594, uintptr(v8*4)+1046960)))
				}
				nox_xxx_drawString_43F6E0(nil, v11, v60, v62)
	...
	if dword_5d4594_1046868 == 1 {
		...
		if int32(*(*uint8)(unsafe.Add(dword_5d4594_1047516, 2251))) == 2 && (*(*uint32)(unsafe.Add(dword_5d4594_1047516, 4232)) != 0 || noxflags.HasGame(0x2000) && !noxflags.HasGame(4096)) {
...
func nox_xxx_bookDrawFn_45C7D0(win *gui.Window, draw *gui.WindowData) int {
	...
	if float64(dword_5d4594_1046636) > float64(*mem_getFloatPtr(0x5D4594, *memmap.PtrUint32(0x5D4594, 1046628)*8+1046692)) {
