	...
	for {
		...
		if v2 != 0 {
			for {
				...
				if (int32(*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(v3)), 3680)))&1) == 0 && (int32(*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(v3)), 2064))) != 31 || !nox_common_getEngineFlag(nox_engine_flag(NOX_ENGINE_FLAG_DISABLE_GRAPHICS_RENDERING))) {
					break
				}
...
func nox_xxx_gamePlayIsAnyPlayers_40A8A0() int32 {
	...
	for {
		...
		if v2 != 0 {
			for {
				if nox_xxx_teamCompare2_419180(unsafe.Add(unsafe.Pointer(uintptr(v2)), 48), uint8(*(*byte)(unsafe.Add(unsafe.Pointer(v1), 57)))) != 0 {
...
func sub_410390(a1 int32, a2 int32, a3 int32) *uint32 {
	...
	if v3 != nil || (func() bool {
		...
		v7[0] = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 12)))
...
func nox_xxx_cliPlayerRespawn_417680(a1 int32, a2 int8) {
	...
	if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 2251))) != 0 || noxflags.HasGame(2048) {
		...
		*(*uint8)(unsafe.Add(unsafe.Pointer(&a1), 4-1)) = math.MaxUint8
		if int32(a2)&1 != 0 {
			nox_xxx_clientEquipWeaponArmor_417AA0(82, int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 2060))), 1024, int32(uintptr(unsafe.Pointer(&a1))))
		}
	}
	*((*uint8)(unsafe.Pointer(&a1))) = math.MaxUint8
	...
	*(*uint16)(unsafe.Add(unsafe.Pointer(&a1), unsafe.Sizeof(uint16(0))*1)) = math.MaxUint16
	if int32(a2)&2 != 0 {
		nox_xxx_clientEquipWeaponArmor_417AA0(82, int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 2060))), 4, int32(uintptr(unsafe.Pointer(&a1))))
	}
	...
	*(*uint16)(unsafe.Add(unsafe.Pointer(&a1), unsafe.Sizeof(uint16(0))*1)) = math.MaxUint16
	if int32(a2)&4 != 0 {
		nox_xxx_clientEquipWeaponArmor_417AA0(82, int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 2060))), 1, int32(uintptr(unsafe.Pointer(&a1))))
	}
		...
		if noxflags.HasGame(2048) {
			if int32(a2)&8 != 0 {
				...
				*((*uint8)(unsafe.Pointer(&a1))) = *((*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(nox_xxx_modifGetDescById_413330(v16))), 4)))
				nox_xxx_clientEquipWeaponArmor_417AA0(80, int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 2060))), 0x8000, int32(uintptr(unsafe.Pointer(&a1))))
			}
			...
			*(*uint8)(unsafe.Add(unsafe.Pointer(&a1), 2)) = *((*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(nox_xxx_modifGetDescById_413330(v17))), 4)))
			nox_xxx_clientEquipWeaponArmor_417AA0(80, int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 2060))), 0x10000, int32(uintptr(unsafe.Pointer(&a1))))
		} else if int32(a2)&0x10 != 0 {
			nox_xxx_clientEquipWeaponArmor_417AA0(79, int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 2060))), 0x4000, int32(uintptr(unsafe.Pointer(&a1))))
		}
	}
	if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 2251))) == 0 {
		if noxflags.HasGame(2048) {
			...
			if int32(a2)&0x40 != 0 {
				nox_xxx_clientEquipWeaponArmor_417AA0(80, int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 2060))), 512, int32(uintptr(unsafe.Pointer(&a1))))
			}
			if int32(a2) < 0 {
				nox_xxx_clientEquipWeaponArmor_417AA0(79, int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 2060))), 0x1000000, int32(uintptr(unsafe.Pointer(&a1))))
			}
		}
	}
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(v7), 4*25)) = 0
	if a1 != 0 {
		for i = int32(uintptr(unsafe.Pointer(nox_xxx_getFirstPlayerUnit_4DA7C0()))); i != 0; i = int32(uintptr(unsafe.Pointer(nox_xxx_getNextPlayerUnit_4DA7F0((*server.Object)(unsafe.Pointer(uintptr(i))))))) {
			if *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(i)), 748)))), 276)))), 3628)) == uint32(a1) {
...
func nox_xxx_mapInfoSetKotr_4180D0() int32 {
	...
	for {
		...
		*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v4)), 748)))), 4)) = 0
		...
		if v8 != nil {
			*((*uint32)(unsafe.Add(unsafe.Pointer(v8), 4*19))) = uint32(v4)
			nox_xxx_netMarkMinimapForAll_4174B0(v4, 1)
		}
		v4 = v5
		if v5 == 0 {
...
func sub_4181F0(a1 int32) {
	...
	for {
		...
		if v5 != 0 && (*((*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*515))) != nox_player_netCode_85319C || !nox_common_getEngineFlag(nox_engine_flag(NOX_ENGINE_FLAG_DISABLE_GRAPHICS_RENDERING))) {
	...
	for {
		...
		if sub_40A740() != 0 {
			...
			if result != nil {
				...
				if result != nil {
					nox_xxx_createAtImpl_4191D0(uint8(*(*byte)(unsafe.Add(unsafe.Pointer(result), 57))), unsafe.Add(unsafe.Pointer(uintptr(v15)), 48), 1, int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v15)), 36))), 0)
				}
			}
		} else {
			v18 = sub_4189D0()
			nox_xxx_createAtImpl_4191D0(uint8(*(*byte)(unsafe.Add(unsafe.Pointer(v18), 57))), unsafe.Add(unsafe.Pointer(uintptr(v15)), 48), 1, int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v15)), 36))), 1)
		}
...
func sub_4184D0(a1p *nox_team_t) {
	...
	if a1 != nil {
		...
		*(*uint32)(unsafe.Pointer(&v3[10])) = *((*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*13)))
		v3[14] = 0
		v3[16] = byte(*((*uint8)(unsafe.Add(unsafe.Pointer(a1), 56))))
		v3[17] = byte(*((*uint8)(unsafe.Add(unsafe.Pointer(a1), 68))))
		...
		*((*uint16)(unsafe.Add(unsafe.Pointer(v2), unsafe.Sizeof(uint16(0))*8))) = *(*uint16)(unsafe.Pointer(&v3[16]))
		alloc.Memcpy(unsafe.Add(unsafe.Pointer(v2), 18), unsafe.Pointer(a1), uintptr(int32(uint8(v3[15]))*2))
...
func nox_xxx_wndGuiTeamCreate_4185B0() int32 {
	...
	for i = result; result != 0; i = result {
		if *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(i)), 8))&0x10000000 != 0 {
			v2 = (*byte)(unsafe.Pointer(nox_xxx_getTeamByID_418AB0(int32(*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(i)), 52))))))
			if v2 != nil {
				v3 = sub_4ECBD0(i)
				v4 = int8(v3)
				...
				*((*uint32)(unsafe.Add(unsafe.Pointer(v2), 4*18))) = uint32(i)
			}
		}
...
func nox_xxx_teamAssignFlags_418640() int32 {
	...
	for i = result; result != 0; i = result {
		if *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(i)), 8))&0x10000000 != 0 {
			...
			v3 = (*byte)(unsafe.Pointer(nox_xxx_getTeamByID_418AB0(int32(*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(i)), 52))))))
			if v3 != nil {
				*(*byte)(unsafe.Add(unsafe.Pointer(v3), 56)) = byte(v2)
				*((*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*18))) = uint32(i)
			}
		}
		result = int32(uintptr(unsafe.Pointer(nox_server_getNextObject_4DA7A0((*server.Object)(unsafe.Pointer(uintptr(i)))))))
	}
