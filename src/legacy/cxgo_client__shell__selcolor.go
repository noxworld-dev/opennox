...
func nox_game_showSelColor_4A5D00() int {
	...
	*(*byte)(unsafe.Add(unsafe.Pointer(v0), 67)) = 0
	...
	result = int32(uintptr(unsafe.Pointer(nox_gui_makeAnimation_43C5B0(dword_5d4594_1308084, 0, 0, 0, -440, 0, 20, 0, -40))))
	...
	if dword_587000_171388 != 0 {
		...
		nox_window_call_field_94_fnc(dword_5d4594_1308152, 16414, uintptr(unsafe.Pointer(v6)), 0)
	}
...
func sub_4A68C0() *wchar2_t {
	...
	v0 = (*wchar2_t)(unsafe.Pointer(nox_window_call_field_94_fnc(dword_5d4594_1308152, 16413, 0, 0)))
	if *v0 == 0 {
		v1 = nox_strman_loadString_40F1D0(internCStr("DefaultName"), nil, internCStr("C:\\NoxPost\\src\\client\\shell\\SelColor.c"), 225)
		nox_wcscpy(v0, v1)
	}
	nox_wcscpy((*uint16)(dword_5d4594_1307784), v0)
	if sub_4A6B50((*uint16)(dword_5d4594_1307784)) == 0 {
		v2 = nox_strman_loadString_40F1D0(internCStr("DefaultName"), nil, internCStr("C:\\NoxPost\\src\\client\\shell\\SelColor.c"), 232)
		nox_wcscpy((*uint16)(dword_5d4594_1307784), v2)
	}
	v3 = (*uint8)(memmap.PtrOff(0x5D4594, uintptr(((dword_5d4594_1308096.WidgetData>>16)+uint32(int32(uint16(dword_5d4594_1308096.WidgetData))*32)))*3+1307796))
	...
	*(*uint8)(unsafe.Add(dword_5d4594_1307784, 83)) = uint8(dword_5d4594_1308116.WidgetData >> 16)
	*(*uint8)(unsafe.Add(dword_5d4594_1307784, 84)) = uint8(dword_5d4594_1308120.WidgetData >> 16)
	*(*uint8)(unsafe.Add(dword_5d4594_1307784, 85)) = uint8(dword_5d4594_1308124.WidgetData >> 16)
	*(*uint8)(unsafe.Add(dword_5d4594_1307784, 86)) = uint8(dword_5d4594_1308128.WidgetData >> 16)
	result = (*uint16)(dword_5d4594_1307784)
	*(*uint8)(unsafe.Add(dword_5d4594_1307784, 87)) = uint8(dword_5d4594_1308132.WidgetData >> 16)
	return result
}
func sub_4A75C0() int32 {
	...
	*(*uint16)(unsafe.Pointer(&v25[1276])) = 0
	...
	v25[1276] = 1
	v25[1274] = byte(v3)
	v4 = (*uint8)(memmap.PtrOff(0x5D4594, uintptr(((dword_5d4594_1308096.WidgetData>>16)+uint32(int32(uint16(dword_5d4594_1308096.WidgetData))*32)))*3+1307796))
	*(*uint16)(unsafe.Pointer(&v25[1204])) = *(*uint16)(unsafe.Pointer(v4))
	...
	v25[1219] = byte(dword_5d4594_1308116.WidgetData >> 16)
	v25[1220] = byte(dword_5d4594_1308120.WidgetData >> 16)
	v25[1221] = byte(dword_5d4594_1308124.WidgetData >> 16)
	v25[1222] = byte(dword_5d4594_1308128.WidgetData >> 16)
	v25[1223] = byte(dword_5d4594_1308132.WidgetData >> 16)
	v13 = nox_fs_root()
