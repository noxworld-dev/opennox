...
func sub_457A10() {
	...
	v0 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10120)))
	v1 = v0
	var max int32 = 0
	var cnt int32 = 0
	for i := int32(0); i < nox_gui_gamemode_cnt; i++ {
		...
		cnt++
		var w int32 = 0
		nox_xxx_drawGetStringSize_43F840(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*59)))), p.title, &w, nil, 0)
		if w > max {
			max = w
		}
	}
	v3 = cnt * (nox_xxx_guiFontHeightMB_43F320(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v0), 4*59))))) + 1)
...
func sub_459C10() int32 {
	var v0 *wchar2_t
	v0 = (*wchar2_t)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10119)))
...
func nox_xxx_windowServerOptionsFillGametypeList_4596A0() {
	var v0 unsafe.Pointer = unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10120))
...
func nox_xxx_guiServerOptsLoad_457500() int32 {
	...
	if nox_gui_xxx_check_446360() == 0 {
		...
		nox_window_setPos_46A9B0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), int32(uint32(nox_win_width)-*(*uint32)(unsafe.Pointer(uintptr(dword_5d4594_1046492 + 8)))-10), 0)
		nox_xxx_wndSetWindowProc_46B300(*(**gui.Window)(unsafe.Pointer(&dword_5d4594_1046492)), nox_xxx_guiServerOptionsProc_458590)
		nox_xxx_wndSetDrawFn_46B340(*(**gui.Window)(unsafe.Pointer(&dword_5d4594_1046492)), nox_xxx_windowServerOptionsDrawProc_458500)
		dword_5d4594_1046512 = nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10101)
		dword_5d4594_1046496 = uint32(uintptr(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10114))))
		dword_5d4594_1046500 = uint32(uintptr(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10183))))
		dword_5d4594_1046504 = uint32(uintptr(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10197))))
		dword_5d4594_1046508 = uint32(uintptr(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10199))))
		dword_5d4594_1046524 = uint32(uintptr(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10150))))
		dword_5d4594_1046516 = uint32(uintptr(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10134))))
		dword_5d4594_1046520 = uint32(uintptr(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10135))))
		dword_5d4594_1046536 = uint32(uintptr(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10153))))
		v2 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10331)))
		nox_gui_winSetFunc96_46B070((*gui.Window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v2)))))), nox_xxx_options_457AA0)
		v3 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10333)))
		nox_gui_winSetFunc96_46B070((*gui.Window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v3)))))), nox_xxx_options_457B00)
		...
		nox_xxx_wndSetProc_46B2C0(*(**gui.Window)(unsafe.Pointer(&dword_5d4594_1046524)), nox_xxx_guiServerOptionsProcPre_4585D0)
		nox_xxx_wndSetProc_46B2C0(*(**gui.Window)(unsafe.Pointer(&dword_5d4594_1046532)), nox_xxx_guiServerOptionsProcPre_4585D0)
		nox_xxx_wndSetProc_46B2C0(*(**gui.Window)(unsafe.Pointer(&dword_5d4594_1046536)), nox_xxx_guiServerOptionsProcPre_4585D0)
		...
		*memmap.PtrUint32(0x5D4594, 1046352) = uint32(uintptr(unsafe.Pointer(nox_xxx_gLoadImg_42F970(internCStr("UITabs1")))))
		...
		v6 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046500)))), 10182)))
		v7 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046500)))), 10180)))
		v15 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046500)))), 10181)))
		...
		*(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*8)) = uint32(uintptr(unsafe.Pointer(v15)))
		v8 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10160)))
		*(*uint32)(unsafe.Add(unsafe.Pointer(v8), 4*9)) |= 4
		...
		if nox_common_gameFlags_check_40A5C0(1) {
			...
			v10 = (*wchar2_t)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10159)))
			...
			nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v10)))))), 16385, uintptr(unsafe.Pointer(v11)), math.MaxUint32)
			...
			sub_46ACE0(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)), 10145, 10146, 1)
		}
		if dword_587000_129656 != 0 {
...
func sub_457FE0() {
	...
	v0 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10210)))
	...
	nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v0)))))), 16385, uintptr(memmap.PtrOff(0x5D4594, 1045700)), math.MaxUint32)
}
func sub_4580E0(a1 int32) {
	...
	v6 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10121)))
	nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v6)))))), 16385, uintptr(memmap.PtrOff(0x5D4594, 1045968)), math.MaxUint32)
	v7 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10118)))
	nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v7)))))), 16385, uintptr(memmap.PtrOff(0x5D4594, 1046096)), math.MaxUint32)
	v8 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10117)))
	nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v8)))))), 16385, uintptr(memmap.PtrOff(0x5D4594, 1046224)), math.MaxUint32)
}
	...
	*memmap.PtrUint32(0x5D4594, 1046552) = uint32(mode)
	...
	for it := (*Nox_map_list_item)(nox_common_maplist_first_4D09B0()); it != nil; it = nox_common_maplist_next_4D09C0(it) {
		...
		*(*uint16)(unsafe.Pointer(&v20[56])) = *(*uint16)(unsafe.Pointer(&v19[56]))
		...
		nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046496))))), 16397, uintptr(unsafe.Pointer(&v21[0])), uintptr(v6))
		if nox_strcmpi(current, &it.Name[0]) == 0 {
			v18 = v17
			nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046496))))), 16403, uintptr(v17), 0)
			nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046496))))), 16412, uintptr(v17), 0)
		}
		v17++
	}
	if v18 < 0 {
		nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046496))))), 16403, 0, 0)
		nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046496))))), 16412, 0, 0)
	}
	if !a3 {
		return
	}
	var v11 *byte = sub_4165B0()
	var v12 int32 = int32(nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046496))))), 16404, 0, 0))
	if v12 < 0 {
		*v11 = 0
	} else {
		var v13 int32 = int32(nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046496))))), 16406, uintptr(v12), 0))
...
func nox_xxx_guiServerOptionsProcPre_4585D0(win *gui.Window, a2, a3, a4 uintptr) uintptr {
	...
	if a2 > 16391 {
		if a2 == 16400 {
			v28 = nox_xxx_wndGetID_46B0A0((*gui.Window)(unsafe.Pointer(uintptr(a3)))) - 10114
			if v28 != 0 {
				if v28 == 6 {
					v29 = sub_4165B0()
					v30 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10119)))
					v31 = int32(nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(a3))), 16404, 0, 0))
					if v31 >= 0 && v31 < int32(*(*int16)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(a3 + 32))) + 44)))) {
						v32 = (*wchar2_t)(unsafe.Pointer(uintptr(nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(a3))), 16406, uintptr(a4), 0))))
						nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v30)))))), 16385, uintptr(unsafe.Pointer(v32)), math.MaxUint32)
						v33 = int32(*((*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(v29))), unsafe.Sizeof(uint16(0))*26)))) & 0x17F0
						...
						*((*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(v29))), unsafe.Sizeof(uint16(0))*26))) |= uint16(int16(sub_459650(v32)))
						if v33 != (int32(*((*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(v29))), unsafe.Sizeof(uint16(0))*26)))) & 0x17F0) {
							nox_client_guiserv_updateMapList_458230(int32(*((*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(v29))), unsafe.Sizeof(uint16(0))*26)))), (*byte)(memmap.PtrOff(0x5D4594, 1046556)), true)
						}
						nox_window_set_hidden((*gui.Window)(unsafe.Pointer(uintptr(a3))), 1)
						nox_xxx_wndClearCaptureMain_46ADE0((*gui.Window)(unsafe.Pointer(uintptr(a3))))
			...
			} else if nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(a3))), 16404, 0, 0) >= 0 {
				v35 = int32(nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(a3))), 16406, uintptr(a4), 0))
				...
				libc.StrCpy(v37, v36)
				sub_57A1E0((*int32)(unsafe.Pointer(v37)), internCStr("user.rul"), nil, 7, int16(*((*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(v37))), unsafe.Sizeof(uint16(0))*26)))))
	...
	if a2 == 16391 {
		v9 = nox_xxx_wndGetID_46B0A0((*gui.Window)(unsafe.Pointer(uintptr(a3))))
		nox_xxx_clientPlaySoundSpecial_452D80(766, 100)
		switch v9 {
		case 10119:
			v26 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10120)))
			nox_window_set_hidden((*gui.Window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v26)))))), 0)
			nox_xxx_wndSetCaptureMain_46ADC0((*gui.Window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v26)))))))
			nox_xxx_wndShowModalMB_46A8C0((*gui.Window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v26)))))))
			nox_xxx_windowServerOptionsFillGametypeList_4596A0()
			return 1
		case 10122:
			v27 = bool2int32((int32(*(*uint8)(unsafe.Pointer(uintptr(a3 + 36)))) & 4) != 0)
			if !nox_common_gameFlags_check_40A5C0(49152) {
				nox_xxx_wnd_46ABB0((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046500))))), v27)
				nox_xxx_wnd_46ABB0((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046504))))), v27)
			}
			sub_459D50(1)
			return 1
		case 10141:
		...
		case 10145:
			...
			if nox_common_gameFlags_check_40A5C0(128) && (func() int32 {
				...
				if int32(v20) < 0 {
					...
					if v19 < 2 {
						...
						nox_xxx_dialogMsgBoxCreate_449A10((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046492))))), (*wchar2_t)(unsafe.Pointer(uintptr(int32(uintptr(memmap.PtrOff(0x5D4594, 1046560)))))), (*wchar2_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v22)))))), 56, ccall.FuncAddr(sub_459150), nil)
						sub_44A360(1)
						return 1
					}
				}
				if !v21 {
					...
					nox_xxx_dialogMsgBoxCreate_449A10((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046492))))), (*wchar2_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v23)))))), (*wchar2_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v38)))))), 33, nil, nil)
					sub_44A360(1)
					return 1
				}
			} else if nox_common_gameFlags_check_40A5C0(128) && nox_common_gameFlags_check_40A5C0(16) && nox_xxx_CheckGameplayFlags_417DA0(4) && v19 > 2 {
				...
				nox_xxx_dialogMsgBoxCreate_449A10((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046492))))), (*wchar2_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v24)))))), (*wchar2_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v39)))))), 33, nil, nil)
				sub_44A360(1)
				return 1
			}
			sub_459150()
		...
		case 10159:
			...
			sub_46B120((*gui.Window)(unsafe.Pointer(uintptr(a3))), nil)
			sub_46B120((*gui.Window)(unsafe.Pointer(uintptr(a3))), (*gui.Window)(unsafe.Pointer(uintptr(v11))))
			v12 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10196)))
			if nox_common_gameFlags_check_40A5C0(1) {
				nox_window_set_hidden((*gui.Window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v12)))))), 0)
				sub_46ACE0(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)), 10161, 10163, 0)
				sub_46AD20(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)), 10161, 10163, 1)
				sub_4593B0(0)
				v13 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10163)))
				*(*uint32)(unsafe.Add(unsafe.Pointer(v13), 4*9)) |= 4
				v14 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10161)))
				*(*uint32)(unsafe.Add(unsafe.Pointer(v14), 4*9)) &= 0xFFFFFFFB
				v15 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10162)))
				*(*uint32)(unsafe.Add(unsafe.Pointer(v15), 4*9)) &= 0xFFFFFFFB
				sub_46ACE0(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)), 10141, 10141, 1)
			} else {
				nox_window_set_hidden((*gui.Window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v12)))))), 1)
				dword_5d4594_1046532 = uint32(nox_xxx_guiServerPlayersLoad_456270(*(*int32)(unsafe.Pointer(&dword_5d4594_1046492))))
				sub_46ACE0(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)), 10141, 10141, 1)
			}
			nox_window_set_hidden((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046524))))), 1)
			return 1
		case 10160:
			v16 = int32(*(*uint32)(unsafe.Pointer(uintptr(a3 + 396))))
			sub_46B120((*gui.Window)(unsafe.Pointer(uintptr(a3))), nil)
			sub_46B120((*gui.Window)(unsafe.Pointer(uintptr(a3))), (*gui.Window)(unsafe.Pointer(uintptr(v16))))
			...
			sub_46ACE0(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)), 10161, 10163, 1)
			if nox_common_gameFlags_check_40A5C0(1) {
				sub_46ACE0(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)), 10141, 10141, 0)
			}
			v17 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10196)))
			nox_window_set_hidden((*gui.Window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v17)))))), 1)
			nox_window_set_hidden((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046524))))), 0)
			return 1
		case 10161:
			sub_4593B0(1)
			return 1
		...
		case 10330:
			if nox_xxx_CheckGameplayFlags_417DA0(4) {
				...
				sub_46AD20(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046508)), 10331, 10333, 1)
				return 1
			}
		case 10331:
			if nox_xxx_CheckGameplayFlags_417DA0(2) {
	...
	v4 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), int32(a4))))
	v5 = sub_4165B0()
	if v4 == nil {
		return 0
	}
	...
	v7 = int32(nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v4)))))), 16413, 0, 0))
	...
	if v8 > math.MaxUint8 {
		*((*uint8)(unsafe.Pointer(&v8))) = math.MaxUint8
		...
		nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v4)))))), 16414, uintptr(unsafe.Pointer(&WideCharStr[0])), math.MaxUint32)
	}
...
func sub_459880(a1 int32) int32 {
	...
	if int32(v1)&0x20 != 0 {
		if int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 57)))) == 0 && nox_common_gameFlags_check_40A5C0(1) {
			nox_xxx_wnd_46ABB0((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046516))))), 1)
			nox_xxx_wnd_46ABB0((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046520))))), 1)
		}
		...
		*((*uint8)(unsafe.Pointer(&v1))) = *(*uint8)(unsafe.Pointer(uintptr(a1 + 57)))
		if int32(v1)&0x400 != 0 {
			if int32(*((*uint8)(unsafe.Pointer(&v1)))) == 0 && nox_common_gameFlags_check_40A5C0(1) {
				nox_xxx_wnd_46ABB0((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046516))))), 1)
				nox_xxx_wnd_46ABB0((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046520))))), 1)
			}
			...
			if int32(*((*uint8)(unsafe.Pointer(&v1)))) == 0 && nox_common_gameFlags_check_40A5C0(1) && !nox_common_gameFlags_check_40A5C0(49152) {
				nox_xxx_wnd_46ABB0((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046516))))), 1)
				nox_xxx_wnd_46ABB0((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046520))))), 1)
			}
	...
	nox_wcscpy((*wchar2_t)(unsafe.Pointer(uintptr(dword_5d4594_1046516+108))), v2)
	sub_4580E0(a1)
	...
	if nox_common_gameFlags_check_40A5C0(1) && !nox_common_gameFlags_check_40A5C0(49152) {
		nox_xxx_wnd_46ABB0((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046500))))), bool2int32(int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 57)))) == 0))
		nox_xxx_wnd_46ABB0((*gui.Window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1046504))))), bool2int32(int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 57)))) == 0))
	}
...
func sub_459CD0() int32 {
	...
	if dword_5d4594_1046492 != 0 {
		...
		v3 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1046492)))), 10110)))
		result = int32(nox_window_call_field_94_fnc((*gui.Window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v3)))))), 16385, uintptr(memmap.PtrOff(0x5D4594, 1046364)), math.MaxUint32))
	}
	return result
}
