...
func nox_xxx_guiHealthManaInit_4714E0() int32 {
	...
	*memmap.PtrUint32(0x5D4594, 1091928) = 0
	...
	for {
		...
		*(*uint32)(unsafe.Pointer(v2)) = nox_xxx_gLoadImg_42F970(&v15[0])
	...
	dword_5d4594_1091364 = nox_window_new(dword_5d4594_1090276, 8, 6, 166, 28, 30, nil)
	...
	*memmap.PtrUint32(0x5D4594, 1091380) = dword_5d4594_1096276
	dword_5d4594_1090292 = nox_window_new(dword_5d4594_1090276, 8, 34, 166, 28, 30, nil)
	...
	*memmap.PtrUint32(0x5D4594, 1090308) = 0
	if int32(*(*uint8)(unsafe.Add(*memmap.PtrPtr(0x8531A0, 2576), 2251))) != 0 {
		dword_5d4594_1090828 = nox_window_new(dword_5d4594_1090276, 8, 62, 166, 28, 30, nil)
		...
		*memmap.PtrPtr(0x5D4594, 1091900) = nox_xxx_gLoadImg_42F970(internCStr("PoisonTube"))
		v8 = nox_window_new(dword_5d4594_1090276, 136, 0, 0, 91, 159, nil)
		v9 = nox_xxx_gLoadImg_42F970(internCStr("HealthManaTubes"))
		...
		*memmap.PtrPtr(0x5D4594, 1091900) = nox_xxx_gLoadImg_42F970(internCStr("WarriorPoisonTube"))
		v12 = nox_window_new(dword_5d4594_1090276, 136, 0, 0, 91, 159, nil)
		v13 = nox_xxx_gLoadImg_42F970(internCStr("WarriorHealthTube"))
