...
func nox_thing_npc_draw(vp *noxrender.Viewport, dr *client.Drawable) int {
	...
	if noxflags.HasGame(0x200000) {
		...
		if int32(*(*uint16)(unsafe.Add(v2, 40))) != 0 {
			nox_xxx_drawObject_4C4770_draw(a1, (*client.Drawable)(a2), int32(**(**uint32)(unsafe.Add(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(v2, 48))+uint32(int32(*(*uint8)(unsafe.Add(a2, 297)))*4))), 4))))
			return 1
		}
	} else {
		v4 = a2
		v30 = int32(*(*uint32)(unsafe.Add(a2, 128)))
		v36 = int32(*(*uint32)(unsafe.Add(*memmap.PtrPtr(0x852978, 8), 304)))
		v5 = (*int32)(unsafe.Pointer(nox_npc_by_id(v30)))
		v33 = v5
		if v36 != 0 && v5 != nil {
			if nox_client_drawable_testBuff_4356C0((*client.Drawable)(v4), 23) {
			...
			} else if nox_client_drawable_testBuff_4356C0((*client.Drawable)(v4), 25) {
				v10 = 0
				for {
					v11 = v10 + 1
			...
			v18 = nox_xxx_spriteNPCInfo_49A4B0((*uint32)(v4), *(*int32)(unsafe.Add(unsafe.Pointer(v5), 4*326)), *(*int32)(unsafe.Add(unsafe.Pointer(v5), 4*327)))
			v19 = v36 + v18*264 + 4
			if int32(*(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(v36+v18*264)), 44))) != 0 {
				v20 = sub_4BC5D0((*client.Drawable)(v4), v36+v18*264+4)
				if v20 < 0 {
					return 0
				}
				v21 = a1
				nox_xxx_drawObject_4C4770_draw(a1, (*client.Drawable)(v4), int32(*(*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(v19, 48))+uint32(int32(*(*uint8)(unsafe.Add(v4, 297)))*4))), 4)) + uint32(v20*4))))))
				v22 = int8(*(*uint8)(unsafe.Add(v4, 297)))
				if int32(v22) != 1 && int32(v22) != 0 && int32(v22) != 2 && int32(v22) != 3 && int32(v22) != 6 || *(*uint32)(unsafe.Add(v4, 276)) == 37 {
					sub_4B8960(v21, (*client.Drawable)(v4), *(*int32)(unsafe.Add(unsafe.Pointer(v33), 4*327)), (*uint32)(unsafe.Add(unsafe.Pointer(v33), 4*170)), v19, v20)
					sub_4B8D40(v21, (*client.Drawable)(v4), *(*int32)(unsafe.Add(unsafe.Pointer(v33), 4*326)), (*uint32)(unsafe.Add(unsafe.Pointer(v33), 4*8)), v19, v20)
				} else {
					sub_4B8D40(v21, (*client.Drawable)(v4), *(*int32)(unsafe.Add(unsafe.Pointer(v33), 4*326)), (*uint32)(unsafe.Add(unsafe.Pointer(v33), 4*8)), v19, v20)
					sub_4B8960(v21, (*client.Drawable)(v4), *(*int32)(unsafe.Add(unsafe.Pointer(v33), 4*327)), (*uint32)(unsafe.Add(unsafe.Pointer(v33), 4*170)), v19, v20)
				}
				...
				if nox_xxx_unitSpriteCheckAlly_4951F0(int32(*(*uint32)(unsafe.Add(v4, 128)))) != 0 {
					v33 = nil
					a1 = nil
					*((*uint8)(unsafe.Pointer(&a2))) = 0
					sub_495180(int32(*(*uint32)(unsafe.Add(v4, 128))), (*uint16)(unsafe.Pointer(&v33)), (*uint16)(unsafe.Pointer(&a1)), (*uint8)(unsafe.Pointer(&a2)))
