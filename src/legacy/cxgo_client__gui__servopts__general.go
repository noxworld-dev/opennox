...
func nox_xxx_gui_4AD320(a1 *gui.Window) *gui.Window {
	...
	v4 := (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0(dword_5d4594_1309812, 10306)))
	...
	if false {
		...
		v6 := (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0(dword_5d4594_1309812, 10317)))
		...
		v9 := (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0(dword_5d4594_1309812, 10319)))
		nox_window_set_hidden((*gui.Window)(unsafe.Pointer(v9)), 1)
	}
	if nox_common_getEngineFlag(NOX_ENGINE_FLAG_DISABLE_GRAPHICS_RENDERING) {
		v10 := (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0(dword_5d4594_1309812, 10304)))
...
func sub_4AD4B0() int32 {
	...
	v0 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0(dword_5d4594_1309812, 10317)))
	v1 = v0
...
func sub_4AD840() {
	if dword_5d4594_1309812 != nil {
		if nox_server_doPlayersAutoRespawn_40A5F0() != 0 {
			v1 := (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0(dword_5d4594_1309812, 10301)))
		...
		if nox_server_sendMotd_108752 != 0 {
			v2 := (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0(dword_5d4594_1309812, 10302)))
			*(*uint32)(unsafe.Add(unsafe.Pointer(v2), 4*9)) |= 4
		}
		if sub_4D0D70() != 0 {
			v3 := (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0(dword_5d4594_1309812, 10304)))
			*(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*9)) |= 4
		}
		if sub_409F40(2) != 0 {
			v4 := (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0(dword_5d4594_1309812, 10305)))
			*(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*9)) |= 4
		}
		if sub_409F40(0x2000) != 0 {
			v5 := (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0(dword_5d4594_1309812, 10306)))
			*(*uint32)(unsafe.Add(unsafe.Pointer(v5), 4*9)) |= 4
		}
		if false {
			v6 := (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0(dword_5d4594_1309812, 10316)))
			...
			v8 := (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0(dword_5d4594_1309812, 10312)))
