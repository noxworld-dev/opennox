...
func sub_49B4B0(a1 *uint16) int32 {
	...
	nox_window_set_hidden((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1303452))))), 0)
	...
	nox_window_setPos_46A9B0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1303452)))), nox_win_width/2-v15/2, nox_win_height/2-v14/2)
	...
	v4 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1303452)))), 10710)))
	sub_46AEE0(int32(uintptr(unsafe.Pointer(v4))), int32(uintptr(memmap.PtrOff(0x5D4594, 1302172))))
	v5 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1303452)))), 10705)))
	sub_46AEE0(int32(uintptr(unsafe.Pointer(v5))), int32(uintptr(memmap.PtrOff(0x5D4594, 1302940))))
	v6 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1303452)))), 10706)))
	sub_46AEE0(int32(uintptr(unsafe.Pointer(v6))), int32(uintptr(memmap.PtrOff(0x5D4594, 1302684))))
	v7 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1303452)))), 10707)))
	sub_46AEE0(int32(uintptr(unsafe.Pointer(v7))), int32(uintptr(memmap.PtrOff(0x5D4594, 1301916))))
	v8 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1303452)))), 10708)))
	sub_46AEE0(int32(uintptr(unsafe.Pointer(v8))), int32(uintptr(memmap.PtrOff(0x5D4594, 1302428))))
	v9 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1303452)))), 10711)))
...
func sub_49B6E0() int32 {
	...
	if dword_5d4594_1303452 != 0 {
		result = wndIsShown_nox_xxx_wndIsShown_46ACC0((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1303452))))))
		if result == 0 {
			...
			v3 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1303452)))), 10712)))
