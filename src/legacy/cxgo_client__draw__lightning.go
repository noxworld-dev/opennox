...
func nox_xxx_lightningProc2_4BAE60(a1 *Point32, a2 *Point32, a3 int32, a4 *int16, a5 int32, a6 int32, a7 int32) int32 {
	var (
		v7     *Point32
		v8     *Point32
		v9     int32
	...
	*(*uint16)(unsafe.Add(unsafe.Pointer(&v22), unsafe.Sizeof(uint16(0))*0)) = uint16(int16(a1.X))
	*(*uint16)(unsafe.Add(unsafe.Pointer(&v21), unsafe.Sizeof(uint16(0))*0)) = uint16(int16(v7.X))
	*(*uint16)(unsafe.Add(unsafe.Pointer(&v22), unsafe.Sizeof(uint16(0))*1)) = uint16(int16(v8.Y))
	*(*uint16)(unsafe.Add(unsafe.Pointer(&v21), unsafe.Sizeof(uint16(0))*1)) = uint16(int16(v7.Y))
	if a6 != 0 {
...
func nox_thing_lightning_draw(vp *noxrender.Viewport, dr *client.Drawable) int {
	...
	if int32(*(*uint8)(unsafe.Add(a2, 432))) == 0 {
		...
		v18.X = int32(*(*uint16)(unsafe.Add(a2, 437)))
		a1a.X = v18.X + v5 - v3
		v6 = *(*uint16)(unsafe.Add(a2, 441))
		v18.Y = int32(*(*uint16)(unsafe.Add(a2, 439)))
		a1a.Y = v19 - v4 + v18.Y - 20
		a3.X = int32(v6)
		a2a.X = v2 + int32(v6) - v3
		a3.Y = int32(*(*uint16)(unsafe.Add(a2, 443)))
		a2a.Y = a3.Y - v4 + v19 - 20
	} else {
		...
		v11 = *a1 - v10
		a1a.X = int32(uint32(*a1) + *(*uint32)(unsafe.Add(unsafe.Pointer(v8), 4*3)) - uint32(v10))
		v12 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*5))
		v13 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*1))
		a1a.Y = int32(uint32(v13) + *(*uint32)(unsafe.Add(unsafe.Pointer(v8), 4*4)) - uint32(v12) - 20)
		v18 = *(*Point32)(unsafe.Add(unsafe.Pointer(v8), 4*3))
		a2a.X = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v9), 4*3)) + uint32(v11))
		a2a.Y = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v9), 4*4)) - uint32(v12) + uint32(v13) - 20)
		a3 = *(*Point32)(unsafe.Add(unsafe.Pointer(v9), 4*3))
	}
...
func nox_thing_chain_lightning_bolt_draw(vp *noxrender.Viewport, dr *client.Drawable) int {
	a1 := (*int32)(vp.C())
	var (
		v2  uint16
		v3  int32
	...
	if int32(*(*uint8)(unsafe.Add(a2, 432))) == 0 {
		...
		*(*uint16)(unsafe.Add(unsafe.Pointer(&v7), unsafe.Sizeof(uint16(0))*0)) = *(*uint16)(unsafe.Add(a2, 439))
		a2a.X = v3 + int32(*(*uint16)(unsafe.Add(a2, 441))) - v4
		v19.Y = int32(uint16(int16(v7)))
		v8 = *(*uint16)(unsafe.Add(a2, 443))
		a1a.Y = v6 - v5 + int32(uint16(int16(v7))) - 20
		a3.X = int32(v8)
		a2a.Y = int32(v8) - v5 + v6 - 20
	} else {
		if nox_xxx_netTestHighBit_578B70(*(*uint32)(unsafe.Add(a2, 437))) != 0 {
		...
		v13 = *a1 - v12
		a1a.X = int32(uint32(*a1) + *(*uint32)(unsafe.Add(unsafe.Pointer(v10), 4*3)) - uint32(v12))
		v14 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*5))
		v15 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*1))
		a1a.Y = int32(uint32(v15) + *(*uint32)(unsafe.Add(unsafe.Pointer(v10), 4*4)) - uint32(v14) - 20)
		v19 = *(*Point32)(unsafe.Add(unsafe.Pointer(v10), 4*3))
		a2a.X = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v11), 4*3)) + uint32(v13))
		a2a.Y = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v11), 4*4)) - uint32(v14) + uint32(v15) - 20)
		a3 = *(*Point32)(unsafe.Add(unsafe.Pointer(v11), 4*3))
	}
	dword_5d4594_1316452 = *memmap.PtrUint32(0x5D4594, 1316428)
	dword_5d4594_1316436 = *memmap.PtrUint32(0x5D4594, 1316464)
	dword_5d4594_1316456 = *memmap.PtrUint32(0x5D4594, 1316424)
...
func nox_thing_energy_bolt_draw(vp *noxrender.Viewport, dr *client.Drawable) int {
	a1 := (*int32)(vp.C())
	var (
		v2  int32
		v3  bool
	...
	if v3 {
		...
		v20.X = int32(*(*uint16)(unsafe.Add(v2, 437)))
		a1a.X = v20.X + v7 - v5
		v8 = *(*uint16)(unsafe.Add(v2, 441))
		v20.Y = int32(*(*uint16)(unsafe.Add(v2, 439)))
		a1a.Y = v21 - v6 + v20.Y - 20
		a3.X = int32(v8)
		a2a.X = v4 + int32(v8) - v5
		a3.Y = int32(*(*uint16)(unsafe.Add(v2, 443)))
		a2a.Y = a3.Y - v6 + v21 - 20
	} else {
		...
		v14 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*5))
		v15 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*1))
		a1a.X = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v10), 4*3)) + uint32(*a1) - uint32(v13))
		a1a.Y = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v10), 4*4)) - uint32(v14) + uint32(v15) - 20)
		v20 = *(*Point32)(unsafe.Add(unsafe.Pointer(v10), 4*3))
		a2a.X = int32(uint32(v12) + *(*uint32)(unsafe.Add(unsafe.Pointer(v11), 4*3)) - uint32(v13))
		a2a.Y = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v11), 4*4)) - uint32(v14) + uint32(v15) - 20)
		a3 = *(*Point32)(unsafe.Add(unsafe.Pointer(v11), 4*3))
	}
...
func nox_thing_green_bolt_draw(vp *noxrender.Viewport, dr *client.Drawable) int {
	a1 := (*int32)(vp.C())
	var (
		v2  int32
		v3  int32
	...
	if int32(*(*uint8)(unsafe.Add(a2, 432))) != 0 {
		...
		a1a.X = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v11), 4*3)) + uint32(*a1) - uint32(v14))
		v15 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*5))
		v16 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*1))
		a1a.Y = int32(uint32(v16) + *(*uint32)(unsafe.Add(unsafe.Pointer(v11), 4*4)) - uint32(v15) - 20)
		v20 = *(*Point32)(unsafe.Add(unsafe.Pointer(v11), 4*3))
		a2a.X = int32(uint32(v13) + *(*uint32)(unsafe.Add(unsafe.Pointer(v12), 4*3)) - uint32(v14))
		a2a.Y = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v12), 4*4)) - uint32(v15) + uint32(v16) - 20)
		a3 = *(*Point32)(unsafe.Add(unsafe.Pointer(v12), 4*3))
	} else {
		...
		v8 = *a1
		v21 = *(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*1))
		v20.X = int32(*(*uint16)(unsafe.Add(a2, 437)))
		a1a.X = v20.X + v8 - v6
		v9 = *(*uint16)(unsafe.Add(a2, 441))
		v20.Y = int32(*(*uint16)(unsafe.Add(a2, 439)))
		a1a.Y = v21 - v7 + v20.Y - 20
		a3.X = int32(v9)
		a2a.X = v5 + int32(v9) - v6
		a3.Y = int32(*(*uint16)(unsafe.Add(a2, 443)))
		a2a.Y = a3.Y - v7 + v21 - 20
	}
