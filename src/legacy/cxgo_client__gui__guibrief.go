...
func sub_44E8E0(a1 int32, a2p *gui.WindowData) int32 {
	...
	nox_xxx_drawSetTextColor_434390(int32(nox_color_white_2523948))
	nox_xxx_drawString_43F6E0(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 200)))), (*wchar2_t)(unsafe.Pointer(&v57[0])), v2-v39/2, v38+v3-240)
	...
	nox_xxx_drawSetTextColor_434390(int32(nox_color_orange_2614256))
	nox_xxx_drawString_43F6E0(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 200)))), (*wchar2_t)(unsafe.Pointer(&v55[1])), v23, v24)
	if v47 != 0 {
		v37 = v47
	...
	v31 = v50 + (225-v38)*2
	nox_xxx_drawSetTextColor_434390(int32(nox_color_orange_2614256))
	nox_xxx_drawString_43F6E0(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 200)))), (*wchar2_t)(unsafe.Pointer(&v57[0])), v30, v31)
	...
	nox_xxx_drawGetStringSize_43F840(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 200)))), (*wchar2_t)(unsafe.Pointer(v34)), &v39, nil, 0)
	v35 = v22 - v39/2 + 320
	nox_xxx_drawSetTextColor_434390(v33)
	return nox_xxx_drawString_43F6E0(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 200)))), (*wchar2_t)(unsafe.Pointer(v34)), v35, v50+450)
}
func sub_44F0F0(a1 int32, a2p *gui.WindowData) int32 {
	...
	nox_xxx_drawString_43F6E0(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 200)))), (*wchar2_t)(unsafe.Pointer(&v14[0])), v2-v10/2, v3+(v11-80)*2+v11-80)
	if *memmap.PtrUint32(0x5D4594, 832464) != 0 {
		nox_xxx_drawGetStringSize_43F840(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 200)))), (*wchar2_t)(unsafe.Pointer(*(**uint16)(memmap.PtrOff(0x5D4594, 832464)))), &v10, &v11, 0)
	...
	nox_xxx_drawGetStringSize_43F840(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 200)))), (*wchar2_t)(unsafe.Pointer(v8)), &v10, nil, 0)
	v9 = v6 - v10/2 + 320
	nox_xxx_drawSetTextColor_434390(v12)
	return nox_xxx_drawString_43F6E0(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 200)))), (*wchar2_t)(unsafe.Pointer(v8)), v9, v7+462)
}
func sub_44F300(a1 int32, a2p *gui.WindowData) int32 {
	...
	nox_xxx_drawGetStringSize_43F840(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 200)))), (*wchar2_t)(unsafe.Pointer(v5)), &v31, nil, 0)
	...
	nox_xxx_drawString_43F6E0(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 200)))), (*wchar2_t)(unsafe.Pointer(v5)), int32(uintptr(unsafe.Pointer(v29)))+1, v4+19)
	nox_xxx_drawString_43F6E0(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 200)))), (*wchar2_t)(unsafe.Pointer(v5)), int32(uintptr(unsafe.Pointer(v32))), v4+21)
	nox_xxx_drawString_43F6E0(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 200)))), (*wchar2_t)(unsafe.Pointer(v5)), int32(uintptr(unsafe.Pointer(v33))), v4+21)
	nox_xxx_drawSetTextColor_434390(int32(nox_color_orange_2614256))
	nox_xxx_drawString_43F6E0(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 200)))), (*wchar2_t)(unsafe.Pointer(v5)), int32(uintptr(unsafe.Pointer(v29))), v4+20)
	v34.field_0 = v3 + 73
	v34.field_4 = v4 + 123
	...
	return nox_xxx_drawString_43F6E0(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 200)))), (*wchar2_t)(unsafe.Pointer(v25)), v34.field_0, v34.field_4)
}
