...
func sub_44E8E0(a1 int32, a2p *gui.WindowData) int32 {
	...
	for {
		...
		if *(*uint32)(unsafe.Pointer(v7)) != 0 {
			...
			nox_xxx_drawStringWrap_43FAF0(*(*unsafe.Pointer)(unsafe.Add(a2, 200)), v14, v10, v13, int32(dword_5d4594_832476), v38)
			...
			nox_xxx_drawStringWrap_43FAF0(*(*unsafe.Pointer)(unsafe.Add(a2, 200)), v16, v10, v15, int32(dword_5d4594_832476), v38)
			...
			nox_xxx_drawStringWrap_43FAF0(*(*unsafe.Pointer)(unsafe.Add(a2, 200)), v18, v10, v17, int32(dword_5d4594_832476), v38)
			...
			nox_xxx_drawStringWrap_43FAF0(*(*unsafe.Pointer)(unsafe.Add(a2, 200)), v20, v10, v19, int32(dword_5d4594_832476), v38)
