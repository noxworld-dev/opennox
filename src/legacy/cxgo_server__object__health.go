...
func nox_xxx_unitGiveXP_4EF270(a1 int32, a2 float32) float64 {
	...
	if float64(*(*float32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 28))) >= float64(a2) {
		return 0.0
	}
	v3 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 748)))
	v4 = float64((a2-*(*float32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 28)))**mem_getFloatPtr(0x587000, 206148)) + 1.0
	v5 = float32(v4)
	*(*float32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 28)) = float32(v4 + float64(*(*float32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 28))))
	sub_56FA40(int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v3)), 276)))), 4604))), v5)
	sub_4D81A0(a1)
...
func nox_xxx_soloMonsterKillReward_4EE500_obj_health(a1 int32) {
	...
	v6 = nox_xxx_unitGiveXP_4EF270(v4, *(*float32)(unsafe.Add(unsafe.Pointer(uintptr(v1)), 28)))
	if v6 > 0.0 {
