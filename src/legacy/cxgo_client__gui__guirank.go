...
func nox_xxx_guiDrawRank_46E870() int32 {
	...
	*(*uint32)(unsafe.Pointer(&v48[8])) = 1
	...
	v20 = v0 * 2
	for {
		v21 = (*uint32)(unsafe.Pointer(Nox_gui_newScrollListBox_4A4310(dword_5d4594_1090048, 1088, int(uint32(v17)*dword_5d4594_1090040), int(v18), int(dword_5d4594_1090040), int(dword_5d4594_1090044-uint32(v19)), (*gui.WindowData)(unsafe.Pointer(&v49[0])), (*nox_scrollListBox_data)(unsafe.Pointer(&v48[0])))))
		...
		*memmap.PtrPtr(0x5D4594, uintptr(v17*4)+1090052) = unsafe.Pointer(v21)
		v24 = (*uint32)(unsafe.Pointer(Nox_gui_newScrollListBox_4A4310((*gui.Window)(unsafe.Pointer(v21)), 1088, 0, int(v20), int(v22), int(v23), (*gui.WindowData)(unsafe.Pointer(&v49[0])), (*nox_scrollListBox_data)(unsafe.Pointer(&v48[0])))))
		v25 = int32(dword_5d4594_1090044)
		*memmap.PtrPtr(0x5D4594, uintptr(v17*4)+1090060) = unsafe.Pointer(v24)
		v26 = (*uint32)(unsafe.Pointer(Nox_gui_newScrollListBox_4A4310((*gui.Window)(*memmap.PtrPtr(0x5D4594, uintptr(v17*4)+1090052)), 1088, int(*memmap.PtrInt32(0x5D4594, 1084036)), int(v20), int(*memmap.PtrInt32(0x5D4594, 1084040)), int(v25-v19), (*gui.WindowData)(unsafe.Pointer(&v49[0])), (*nox_scrollListBox_data)(unsafe.Pointer(&v48[0])))))
		v27 = int32(dword_5d4594_1090044)
		*memmap.PtrPtr(0x5D4594, uintptr(v17*4)+1090068) = unsafe.Pointer(v26)
		*memmap.PtrPtr(0x5D4594, uintptr(v17*4)+1090076) = unsafe.Pointer(Nox_gui_newScrollListBox_4A4310((*gui.Window)(*memmap.PtrPtr(0x5D4594, uintptr(v17*4)+1090052)), 1088, int(*memmap.PtrUint32(0x5D4594, 1084036)+*memmap.PtrUint32(0x5D4594, 1084040)), int(v20), int(*memmap.PtrInt32(0x5D4594, 1084044)), int(v27-v19), (*gui.WindowData)(unsafe.Pointer(&v49[0])), (*nox_scrollListBox_data)(unsafe.Pointer(&v48[0]))))
		v28 = (*uint32)(unsafe.Pointer(Nox_gui_newScrollListBox_4A4310((*gui.Window)(*memmap.PtrPtr(0x5D4594, uintptr(v17*4)+1090052)), 1088, int(*memmap.PtrUint32(0x5D4594, 1084036)+*memmap.PtrUint32(0x5D4594, 1084040)+*memmap.PtrUint32(0x5D4594, 1084044)), int(v20), int(*memmap.PtrInt32(0x5D4594, 1084048)), int(dword_5d4594_1090044-uint32(v19)), (*gui.WindowData)(unsafe.Pointer(&v49[0])), (*nox_scrollListBox_data)(unsafe.Pointer(&v48[0])))))
		v29 = int32(dword_5d4594_1090044)
		*memmap.PtrPtr(0x5D4594, uintptr(v17*4)+1090084) = unsafe.Pointer(v28)
		*memmap.PtrPtr(0x5D4594, uintptr(v17*4)+1090092) = unsafe.Pointer(Nox_gui_newScrollListBox_4A4310((*gui.Window)(*memmap.PtrPtr(0x5D4594, uintptr(v17*4)+1090052)), 1088, int(*memmap.PtrUint32(0x5D4594, 1084036)+*memmap.PtrUint32(0x5D4594, 1084040)+*memmap.PtrUint32(0x5D4594, 1084048)+*memmap.PtrUint32(0x5D4594, 1084044)), int(v20), int(*memmap.PtrInt32(0x5D4594, 1084052)), int(v29-v19), (*gui.WindowData)(unsafe.Pointer(&v49[0])), (*nox_scrollListBox_data)(unsafe.Pointer(&v48[0]))))
