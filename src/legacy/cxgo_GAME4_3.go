...
func nox_xxx_mobActionMissileAtt_532610(obj *server.Object) {
	...
	if int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 12))))&0x10 != 0 {
		...
		v3 := *(*uint8)(unsafe.Pointer(uintptr(v2 + 483)))
		if int32(uint8(int8(v3))) != 0 {
					...
					if int32(uint8(int8(nox_server_testTwoPointsAndDirection_4E6E50((*float2)(unsafe.Pointer(uintptr(v2+56))), int32(*(*int16)(unsafe.Pointer(uintptr(v2 + 124)))), (*float2)(unsafe.Pointer(uintptr(a1+56)))))))&int32(*(*uint8)(unsafe.Pointer(uintptr(a2 + 32)))) != 0 {
						...
						if (v3&0x8040) == 0 && (*(*uint32)(unsafe.Pointer(uintptr(a2 + 24))) != 0 || (v3&8) == 0) {
							...
							if nox_xxx_mapTraceRay_535250(&v12, nil, nil, 5) != 0 {
								...
								a1p.Damage.Get()(a1p, *(**server.Object)(unsafe.Pointer(uintptr(a2 + 12))), *(**server.Object)(unsafe.Pointer(uintptr(a2 + 28))), int(float64(*(*float32)(unsafe.Pointer(uintptr(a2))))+0.5), object.DamageType(*(*uint8)(unsafe.Pointer(uintptr(a2 + 4)))))
								if noxflags.HasGame(2048) {
...
func nox_xxx_itemApplyAttackEffect_538840(a1 int32, a2 int32, a3 int32) int32 {
	...
	for {
		v5 = *v4
		if *v4 != 0 {
			v6 = ccall.AsFunc[func(int32, int32, int32, uint32, int32)](*(*unsafe.Pointer)(unsafe.Pointer(uintptr(v5 + 40))))
			if v6 != nil {
				v6(v5, v3, a2, 0, a3)
			}
		}
...
func nox_xxx_mobGenericDeath_544C40(obj *server.Object) {
	...
	result2 = ccall.AsFunc[func(int32) int32](*(*unsafe.Pointer)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v1 + 484))) + 228))))
	if result2 != nil {
		result2(a1)
	}
}
...
func nox_xxx_mobActionDead1_544D80(obj *server.Object) {
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*24)) = 0
	v2 = ccall.AsFunc[func(*uint32)](*(*unsafe.Pointer)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v1 + 484))) + 232))))
	if v2 != nil {
		v2(a1)
	}
	if nox_xxx_unitIsZombie_534A40(int32(uintptr(unsafe.Pointer(a1)))) != 0 {
