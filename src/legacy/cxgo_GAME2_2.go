...
func sub_478110() int32 {
	...
	*memmap.PtrT[noxrender.ImageHandle](0x5D4594, 1098400) = nox_xxx_gLoadImg_42F970(internCStr("ShopBase"))
	*memmap.PtrT[noxrender.ImageHandle](0x5D4594, 1098404) = nox_xxx_gLoadImg_42F970(internCStr("ShopTradeMode"))
	*memmap.PtrT[noxrender.ImageHandle](0x5D4594, 1098408) = nox_xxx_gLoadImg_42F970(internCStr("ShopIdentifyMode"))
	*memmap.PtrT[noxrender.ImageHandle](0x5D4594, 1098412) = nox_xxx_gLoadImg_42F970(internCStr("ShopRepairMode"))
	*memmap.PtrT[noxrender.ImageHandle](0x5D4594, 1098416) = nox_xxx_gLoadImg_42F970(internCStr("ShopRepairMode"))
	*memmap.PtrT[noxrender.ImageHandle](0x5D4594, 1098420) = nox_xxx_gLoadImg_42F970(internCStr("ShopExitMode"))
	*memmap.PtrT[noxrender.ImageHandle](0x5D4594, 1098424) = nox_xxx_gLoadImg_42F970(internCStr("ShopInventoryBar1"))
	*memmap.PtrT[noxrender.ImageHandle](0x5D4594, 1098428) = nox_xxx_gLoadImg_42F970(internCStr("ShopInventoryBar2"))
	*memmap.PtrT[noxrender.ImageHandle](0x5D4594, 1098432) = nox_xxx_gLoadImg_42F970(internCStr("ShopInventorySlider"))
	*memmap.PtrT[noxrender.ImageHandle](0x5D4594, 1098436) = nox_xxx_gLoadImg_42F970(internCStr("ShopInventorySliderSelected"))
	*memmap.PtrT[noxrender.ImageHandle](0x5D4594, 1098448) = nox_xxx_gLoadImg_42F970(internCStr("ShopInventoryUp"))
	*memmap.PtrT[noxrender.ImageHandle](0x5D4594, 1098452) = nox_xxx_gLoadImg_42F970(internCStr("ShopInventoryUpSelected"))
	*memmap.PtrT[noxrender.ImageHandle](0x5D4594, 1098440) = nox_xxx_gLoadImg_42F970(internCStr("ShopInventorydown"))
	*memmap.PtrT[noxrender.ImageHandle](0x5D4594, 1098444) = nox_xxx_gLoadImg_42F970(internCStr("ShopInventorydownSelected"))
	dword_5d4594_1098456 = nox_xxx_gLoadImg_42F970(internCStr("ShopTextBorder"))
	*memmap.PtrT[noxrender.ImageHandle](0x5D4594, 1098460) = nox_xxx_gLoadImg_42F970(internCStr("ShopkeeperPic"))
	*memmap.PtrT[noxrender.ImageHandle](0x5D4594, 1098464) = nox_xxx_gLoadImg_42F970(internCStr("ShopkeeperWarriorPic"))
	*memmap.PtrT[noxrender.ImageHandle](0x5D4594, 1098468) = nox_xxx_gLoadImg_42F970(internCStr("ShopkeeperConjurerPic"))
	*memmap.PtrT[noxrender.ImageHandle](0x5D4594, 1098472) = nox_xxx_gLoadImg_42F970(internCStr("ShopkeeperWizardPic"))
	*memmap.PtrT[noxrender.ImageHandle](0x5D4594, 1098476) = nox_xxx_gLoadImg_42F970(internCStr("ShopkeeperLandOfTheDeadPic"))
	*memmap.PtrT[noxrender.ImageHandle](0x5D4594, 1098480) = nox_xxx_gLoadImg_42F970(internCStr("ShopkeeperMagicShopPic"))
	dword_5d4594_1098580 = nox_xxx_wndGetChildByID_46B0C0(dword_5d4594_1098576, 3807)
	*memmap.PtrT[*gui.Window](0x5D4594, 1098584) = nox_xxx_wndGetChildByID_46B0C0(dword_5d4594_1098576, 3808)
	*memmap.PtrT[*gui.Window](0x5D4594, 1098588) = nox_xxx_wndGetChildByID_46B0C0(dword_5d4594_1098576, 3809)
