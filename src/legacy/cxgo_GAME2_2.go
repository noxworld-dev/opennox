...
func sub_4761B0(a1p *client.Drawable) int32 {
	...
	if *memmap.PtrUint32(0x852978, 8) == 0 {
		return int32(*(*uint32)(unsafe.Add(a1, 16)) + uint32(*memmap.PtrInt32(0x587000, uintptr(int32(*(*uint8)(unsafe.Add(a1, 299)))*8)+196188)/2))
	}
	result = int32(*(*uint32)(unsafe.Add(a1, 16)))
	v2 = int32(*(*uint8)(unsafe.Add(a1, 299))) * 8
	v3 = int32((*(*uint32)(unsafe.Add(*memmap.PtrPtr(0x852978, 8), 16))-uint32(result))*uint32(*memmap.PtrInt32(0x587000, uintptr(v2)+196184)) - (*(*uint32)(unsafe.Add(*memmap.PtrPtr(0x852978, 8), 12))-*(*uint32)(unsafe.Add(a1, 12)))*uint32(*memmap.PtrInt32(0x587000, uintptr(v2)+196188)))
	if *memmap.PtrInt32(0x587000, uintptr(v2)+196184) < 0 {
		v3 = int32((*(*uint32)(unsafe.Add(*memmap.PtrPtr(0x852978, 8), 12))-*(*uint32)(unsafe.Add(a1, 12)))*uint32(*memmap.PtrInt32(0x587000, uintptr(int32(*(*uint8)(unsafe.Add(a1, 299)))*8)+196188)) - (*(*uint32)(unsafe.Add(*memmap.PtrPtr(0x852978, 8), 16))-uint32(result))*uint32(*memmap.PtrInt32(0x587000, uintptr(int32(*(*uint8)(unsafe.Add(a1, 299)))*8)+196184)))
	}
	v4 = result + *memmap.PtrInt32(0x587000, uintptr(int32(*(*uint8)(unsafe.Add(a1, 299)))*8)+196188)
	if v3 >= 0 {
		if v4 <= result {
			result += *memmap.PtrInt32(0x587000, uintptr(int32(*(*uint8)(unsafe.Add(a1, 299)))*8)+196188)
		}
	} else if v4 > result {
		result += *memmap.PtrInt32(0x587000, uintptr(int32(*(*uint8)(unsafe.Add(a1, 299)))*8)+196188)
	}
...
func sub_476AE0(vp *noxrender.Viewport, dr *client.Drawable) {
	...
	result = int32(uintptr(nox_video_getImagePixdata_42FB30((*nox_video_bag_image_t)(v4))))
	if result != 0 {
		v33 = func(arg1 uint32, arg2 *uint8, arg3 int32) {
			sub_476D70((*uint32)(arg1), (*int32)(unsafe.Pointer(arg2)), uint32(arg3))
		}
		v5 = int32(*(*uint32)(result))
		v6 = int32(*(*uint32)(unsafe.Add(result, 4*1)))
		v27 = int32(*(*uint32)(unsafe.Add(result, 4*1)))
		v7 = int32(*(*uint32)(unsafe.Add(result, 4*2)) + *(*uint32)(unsafe.Add(unsafe.Pointer(v2), 4*3)) - uint32(*v2))
		v8 = (*byte)(unsafe.Add(result, 16))
		result = int32(*(*uint32)(unsafe.Add(result, 4*3)) + *(*uint32)(unsafe.Add(unsafe.Pointer(v2), 4*4)) - uint32(*(*int16)(unsafe.Add(unsafe.Pointer(v2), unsafe.Sizeof(int16(0))*53))) - uint32(*(*int16)(unsafe.Add(unsafe.Pointer(v2), unsafe.Sizeof(int16(0))*52))) - uint32(*(*uint8)(unsafe.Add(unsafe.Pointer(v2), 1))))
		v31 = v5
		if v7 < dword_5d4594_3798820 || uint32(v7+v5) >= uint32(dword_5d4594_3798820)+dword_5d4594_3798800 || (func() bool {
			v9 = int32(dword_5d4594_3798824)
			return result < dword_5d4594_3798824
		}()) || uint32(result+v6) >= uint32(dword_5d4594_3798824)+dword_5d4594_3798808 {
								...
								if v19 != 0 {
									if v19 == 1 {
										if v16 >= v11 || v16+uint32(v20) < v11 {
											...
											v33(uint32(uintptr(nox_video_tileBuf_ptr_3798796)), (*uint8)(v24), v21)
...
func nox_xxx_clientOnCursorHover_477050(it *client.Drawable, a2 unsafe.Pointer) {
	...
	v3 = int32(*(*uint32)(unsafe.Add(arg0, 120)))
	if (v3&0x8000) != 0 || nox_client_drawable_testBuff_4356C0((*client.Drawable)(arg0), 0) && !nox_client_drawable_testBuff_4356C0((*client.Drawable)(*memmap.PtrPtr(0x852978, 8)), 21) {
		return
	}
	v4 = int32(*(*uint32)(unsafe.Add(arg0, 112)))
	if (v4&2) != 0 && !(func() bool {
		v5 = int32(*(*uint32)(unsafe.Add(arg0, 116)))
		return (v5 & 0x4000) == 0
	}()) {
		return
	}
	if uint32(v4)&0x80400206 == 0 && *(*uint32)(unsafe.Add(arg0, 108)) != *memmap.PtrUint32(0x5D4594, 1096648) {
		return
	}
	if nox_xxx_client_4984B0_drawable((*client.Drawable)(arg0)) == 0 {
		return
	}
	if (int32(*(*uint8)(unsafe.Add(arg0, 112)))&4) != 0 && ((func() *byte {
		v6 = (*byte)(unsafe.Pointer(nox_common_playerInfoGetByID_417040(int32(*(*uint32)(unsafe.Add(arg0, 128))))))
		return v6
	}()) == nil || (*(*byte)(unsafe.Add(unsafe.Pointer(v6), 3680))&1) != 0) {
		return
	}
	v7 = int32(*(*uint32)(unsafe.Add(arg0, 112)))
	if (uint32(v7)&0x400000) != 0 && (int32(*(*uint8)(unsafe.Add(arg0, 116)))&0x80) == 0 || (v7&2) != 0 && *(*uint32)(unsafe.Add(arg0, 276)) == 10 {
		return
	}
	v23 = float32(float64(*(*int32)(unsafe.Add(arg0, 16))) - float64(*(*float32)(unsafe.Add(arg0, 100))) - float64(*(*int16)(unsafe.Add(arg0, 104))))
	v29 = int32(v23)
	v24 = float32(float64(*(*int32)(unsafe.Add(v2, 16))) - float64(*(*float32)(unsafe.Add(v2, 96))) - float64(*(*int16)(unsafe.Add(v2, 104))))
	v8 = COERCE_FLOAT(uint32(int32(v24)))
	a3.X = v8
	if *(*uint32)(unsafe.Add(v2, 44)) == 2 {
		v25 = *(*float32)(unsafe.Add(v2, 48)) * *(*float32)(unsafe.Add(v2, 48))
		*(*uint32)(unsafe.Add(unsafe.Pointer(&a3.X), 4*0)) = uint32(int32(v25))
		v17 = int32(*(*float32)(unsafe.Add(v2, 48)))
		v18 = int32(*(*uint32)(unsafe.Add(v2, 12)))
		v19 = int32(*(*uint32)(unsafe.Add(v2, 12)) - uint32(v17))
		v20 = v18 + int32(*(*float32)(unsafe.Add(v2, 48)))
		...
		if *(*uint32)(unsafe.Add(v2, 44)) != 3 {
			return
		}
		a1.X = float32(float64(*(*int32)(unsafe.Add(v2, 12))))
		...
		if nox_xxx_map_57B850(&a1, (*float32)(unsafe.Add(v2, 44)), &a3) != 0 || (func() int32 {
			a1.Y = float32(float64(v29))
			return nox_xxx_map_57B850(&a1, (*float32)(unsafe.Add(v2, 44)), &a3)
		}()) != 0 || (func() bool {
			v9 = int32(*(*uint32)(unsafe.Add(v2, 12)) + uint32(int32(*(*float32)(unsafe.Add(v2, 72)))))
			v10 = v29 + int32(*(*float32)(unsafe.Add(v2, 76)))
			v11 = int32((*(*uint32)(unsafe.Add(unsafe.Pointer(&v8), 4*0))) + uint32(int32(*(*float32)(unsafe.Add(v2, 76)))))
			return *(*uint32)(a2) > uint32(v9)
		}()) && *(*uint32)(a2) < uint32(*(*int32)(unsafe.Add(v2, 12))) && (func() bool {
			v12 = int32(*(*uint32)(unsafe.Add(a2, 4)))
			return v12 > v10
		}()) && v12 < v11 {
			goto LABEL_38
		}
		v13 = int32(*(*uint32)(unsafe.Add(v2, 12)) + uint32(int32(*(*float32)(unsafe.Add(v2, 80)))))
		v14 = v29 + int32(*(*float32)(unsafe.Add(v2, 84)))
		*(*uint32)(unsafe.Add(unsafe.Pointer(&v15), 4*0)) = (*(*uint32)(unsafe.Add(unsafe.Pointer(&v8), 4*0))) + uint32(int32(*(*float32)(unsafe.Add(v2, 84))))
		if *(*int32)(a2) < *(*int32)(unsafe.Add(v2, 12)) {
			return
		}
		if *(*int32)(a2) >= v13 {
			return
...
LABEL_38:
	v26 = float32(float64(*(*int16)(unsafe.Add(v2, 104))) + float64(*(*int32)(unsafe.Add(v2, 16))) + float64(*(*float32)(unsafe.Add(v2, 96))))
	v22 = int32(v26)
	if v22 > *memmap.PtrInt32(0x5D4594, 1096628) {
		*memmap.PtrUint32(0x5D4594, 1096628) = uint32(v22)
		dword_5d4594_1096640 = v2
	}
	if uint32(v2) != *memmap.PtrUint32(0x852978, 8) && v22 > dword_5d4594_1096636 && nox_xxx_client_57B400(v2) != 0 {
		if *memmap.PtrUint32(0x8531A0, 2576) != 0 && int32(*(*uint8)(unsafe.Add(*memmap.PtrPtr(0x8531A0, 2576), 2251))) == 1 && *(*uint32)(unsafe.Add(v2, 108)) == *memmap.PtrUint32(0x5D4594, 1096632) {
...
func nox_video_drawCursorSelectCircle2_477470(a1 *uint32, a2 int32, a3 int32) {
	...
	if a3 != 0 {
		if *(*uint32)(unsafe.Add(a3, 44)) == 2 {
			v4 = int32(*(*float32)(unsafe.Add(a3, 48)))
			v3 = v4 + 6
		} else {
			if *(*uint32)(unsafe.Add(a3, 44)) != 3 {
				v3 = 6
			} else {
				v7 = *(*float32)(unsafe.Add(a3, 60)) + *(*float32)(unsafe.Add(a3, 56))
				v4 = int32(v7) / 2
				v3 = v4 + 6
			}
		}
		v5 = int32(*a1 + *(*uint32)(unsafe.Add(a3, 12)) - *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*4)))
		v6 = int32(*(*uint32)(unsafe.Add(a3, 16)) + *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*1)) - *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*5)))
...
func sub_478110() int32 {
	...
	*memmap.PtrUint32(0x5D4594, 1098512) = 0
	...
	v2 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1098576)), 3806)))
	...
	sub_478F10()
	nox_window_get_size((*gui.Window)(dword_5d4594_1098576), &v8, &v7)
	nox_window_setPos_46A9B0((*gui.Window)(unsafe.Pointer(dword_5d4594_1098576)), nox_win_width-v8, nox_win_height-v7)
	nox_window_set_hidden((*gui.Window)(dword_5d4594_1098576), 1)
	nox_xxx_wnd_46ABB0((*gui.Window)(dword_5d4594_1098576), 0)
	...
	*memmap.PtrPtr(0x5D4594, 1098480) = unsafe.Pointer(nox_xxx_gLoadImg_42F970(internCStr("ShopkeeperMagicShopPic")))
	dword_5d4594_1098580 = uint32(uintptr(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1098576)), 3807))))
	*memmap.PtrPtr(0x5D4594, 1098584) = unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1098576)), 3808))
	*memmap.PtrPtr(0x5D4594, 1098588) = unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1098576)), 3809))
	v6 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1098576)), 3806)))
	...
	*(*uint32)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(dword_5d4594_1098580, 400)), 8)) = 16
	*(*uint32)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(dword_5d4594_1098580, 400)), 12)) = 12
	nox_xxx_wndSetOffsetMB_46AE40(int32(*(*uint32)(unsafe.Add(dword_5d4594_1098580, 400))), 0, -15)
	sub_4B5700(dword_5d4594_1098580, 0, 0, *memmap.PtrInt32(0x5D4594, 1098432), *memmap.PtrInt32(0x5D4594, 1098436), *memmap.PtrInt32(0x5D4594, 1098436))
	result = 1
	dword_5d4594_1098592 = *(*uint32)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(dword_5d4594_1098580, 32)), 4))
	return result
}
func sub_478480(win *gui.Window, a2, a3, a4 uintptr) uintptr {
	...
	case 3808:
		...
		nox_window_call_field_94_fnc((*gui.Window)(dword_5d4594_1098580), 16394, uintptr(dword_5d4594_1098592-uint32(v8)), 0)
		result = 0
	case 3809:
		...
		nox_window_call_field_94_fnc((*gui.Window)(dword_5d4594_1098580), 16394, uintptr(dword_5d4594_1098592-uint32(v7)), 0)
		result = 0
	default:
		return 0
	}
...
func sub_478650(win *gui.Window, a2, a3, a4 uintptr) uintptr {
	...
	if sub_45D9B0() == 0 {
		...
		case 19:
			if dword_5d4594_1098628 == 2 {
				nox_window_call_field_94_fnc((*gui.Window)(dword_5d4594_1098576), 16391, uintptr(*memmap.PtrInt32(0x5D4594, 1098584)), 0)
				return 1
			}
		case 20:
			if dword_5d4594_1098628 == 2 {
				nox_window_call_field_94_fnc((*gui.Window)(dword_5d4594_1098576), 16391, uintptr(*memmap.PtrInt32(0x5D4594, 1098588)), 0)
				return 1
			}
		default:
			return 0
...
func sub_478A70(a1 *int2) int32 {
	...
	if dword_5d4594_1098604 != 0 {
		result = nox_xxx_drawStringWrap_43FAF0(nil, dword_5d4594_1098604, v5+8, v6+8, v4-16, v3-16)
	}
	return result
}
...
func sub_478F80() int32 {
	...
	sub_478F10()
	sub_44D8F0()
	nox_xxx_windowDestroyMB_46C4E0((*gui.Window)(unsafe.Pointer(dword_5d4594_1098576)))
	result = 0
...
func nox_xxx_getShopPic_4790F0(a1 int32) *byte {
	...
	v1 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1098576)), 3805)))
...
func sub_479950() int32 {
	...
	if wndIsShown_nox_xxx_wndIsShown_46ACC0((*gui.Window)(dword_5d4594_1123524)) == 1 {
		return 0
	}
...
func sub_4799A0() int32 {
	...
	*memmap.PtrUint32(0x5D4594, 1107052) = nox_color_rgb_4344A0(240, 128, 64)
	...
	if result != 0 {
		nox_xxx_wndSetWindowProc_46B300((*gui.Window)(result), sub_479BE0)
		nox_xxx_wndSetDrawFn_46B340(dword_5d4594_1123524, sub_479CB0)
		nox_gui_winSetFunc96_46B070((*gui.Window)(dword_5d4594_1123524), sub_479D00)
		v1 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1123524)), 3904)))
		v2 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1123524)), 3903)))
		v10 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1123524)), 3902)))
		v3 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1123524)), 3901)))
		...
		*(*uint32)(unsafe.Add(unsafe.Pointer(v5), 4*8)) = uint32(uintptr(unsafe.Pointer(v10)))
		v7 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1123524)), 3906)))
		nox_xxx_wndSetDrawFn_46B340((*gui.Window)(unsafe.Pointer(v7)), sub_479C40)
		nox_xxx_wnd_46ABB0((*gui.Window)(dword_5d4594_1123524), 0)
		nox_window_set_hidden((*gui.Window)(dword_5d4594_1123524), 1)
...
func sub_479CB0(win *gui.Window, draw *gui.WindowData) int {
	...
	nox_client_wndGetPosition_46AA60((*gui.Window)(unsafe.Pointer(dword_5d4594_1123524)), (*uint32)(unsafe.Pointer(&v4)), (*uint32)(unsafe.Pointer(&v5)))
	nox_client_drawImageAt_47D2C0((*nox_video_bag_image_t)(v2), nox_win_width-NOX_DEFAULT_WIDTH, nox_win_height-NOX_DEFAULT_HEIGHT)
	return 1
}
...
func sub_479D10() int32 {
	var result int32
	nox_xxx_windowDestroyMB_46C4E0((*gui.Window)(unsafe.Pointer(dword_5d4594_1123524)))
	result = 0
...
func nox_xxx_edgeDraw_480EF0(a1 int32, a2 int32, a3 int32, a4 *int32, a5 *int32, a6 int32, a7 int32, a8 int32, a9 int32, a10 int32) *int32 {
	...
	v11 = int8(nox_video_bag_image_type((*nox_video_bag_image_t)(a1)))
	v45.field_4 = 0
	v45.field_0 = 0
	v46.field_4 = 0
	v46.field_0 = 0
	...
	result = (*int32)(nox_video_getImagePixdata_42FB30((*nox_video_bag_image_t)(a1)))
	if result == nil {
		return result
	}
	v12 = *result
	...
	v17 = v15 + a3
	v53 = v15 + a3
	if int32(uintptr(unsafe.Pointer(result))) > dword_5d4594_3807116 || v17 > dword_5d4594_3807152 {
		return result
	}
	if int32(uintptr(unsafe.Pointer(result))) < dword_5d4594_3807140 {
		if int32(uintptr(unsafe.Pointer(result)))+v12 < dword_5d4594_3807140 {
			return result
		}
		v10 = dword_5d4594_3807140 - int32(uintptr(unsafe.Pointer(result)))
		v40 = v12 - (dword_5d4594_3807140 - int32(uintptr(unsafe.Pointer(result))))
		result = dword_5d4594_3807140
	}
	if int32(uintptr(unsafe.Pointer(result)))+v40 > dword_5d4594_3807116 {
		v40 = dword_5d4594_3807116 - int32(uintptr(unsafe.Pointer(result)))
	}
...
func Nox_xxx_tileDraw_4815E0(a1 *uint32, a2 int32, _ int32) int8 {
	...
	v3 = int32(uintptr(nox_video_getImagePixdata_42FB30((*nox_video_bag_image_t)(a2))))
	v4 = (*byte)(v3)
	v14 = (*byte)(v3)
	if v3 != 0 {
...
func Nox_xxx_drawTexEdgesProbably_481900(a1 *uint32, a2 *uint32) int8 {
	...
	*memmap.PtrUint32(0x5D4594, uintptr(v4*4)+2523980) = 1
	...
	v9 = int32(uintptr(nox_video_getImagePixdata_42FB30((*nox_video_bag_image_t)(v6))))
	if v9 != 0 {
		v32 = *(*uint8)(v9)
		v25 = *(*uint8)(unsafe.Add(v9, 1))
		v10 = (*uint8)(unsafe.Add(v9, 2))
		v9 = int32(uintptr(nox_video_getImagePixdata_42FB30((*nox_video_bag_image_t)(v3))))
		v11 = v9
		if v9 != 0 {
...
func nox_xxx_tileDrawMB_481C20_A(vp *noxrender.Viewport, v3 int32) {
	...
	if v3 >= dword_5d4594_3798820+23 {
		...
		if uint32(v71) <= uint32(dword_5d4594_3798800)+dword_5d4594_3798820-46 || dword_5d4594_3798812+dword_5d4594_3798828-1 >= 128 {
			return
		}
	...
	if dword_5d4594_3798832 < dword_5d4594_3798832+dword_5d4594_3798816 {
		...
		for i := int32(dword_5d4594_3798832 * 44); ; v12 = i {
			*(*uint16)(unsafe.Add(unsafe.Pointer(&v13), unsafe.Sizeof(uint16(0))*1)) = *(*uint16)(unsafe.Add(unsafe.Pointer(&ptr_5D4594_2650668), unsafe.Sizeof(uint16(0))*1))
			...
			if int32(*(*uint8)(v14))&2 != 0 {
				*(*uint16)(unsafe.Add(unsafe.Pointer(&v13), unsafe.Sizeof(uint16(0))*0)) = *(*uint16)(unsafe.Add(v14, 24))
				v15 = int32(*(*uint16)(unsafe.Add(v14, 24)))
				v62 = int32(uintptr(unsafe.Pointer(*(**nox_video_bag_image_t)(unsafe.Add(unsafe.Pointer(nox_tile_defs_arr[v15].data_32), unsafe.Sizeof((*nox_video_bag_image_t)(nil))*uintptr(*(*uint32)(unsafe.Add(v14, 28))+uint32(nox_tile_defs_arr[v15].field_46)))))))
				v68.field_0 = v76
				v68.field_4 = v11 + 23
				...
				*memmap.PtrUint32(0x85B3FC, uintptr(v15*4+228)) = 1
				if *(*uint32)(unsafe.Add(v14, 40)) != 0 {
					nox_xxx_tileCallDrawEdges_481BF0(unsafe.Pointer(&v68), int32(*(*uint32)(unsafe.Add(v14, 40))))
				}
			}
			if int32(*(*uint8)(v14))&1 != 0 {
				*(*uint16)(unsafe.Add(unsafe.Pointer(&v13), unsafe.Sizeof(uint16(0))*0)) = *(*uint16)(unsafe.Add(v14, 4))
				v16 = int32(*(*uint16)(unsafe.Add(v14, 4)))
				v63 = int32(uintptr(unsafe.Pointer(*(**nox_video_bag_image_t)(unsafe.Add(unsafe.Pointer(nox_tile_defs_arr[v16].data_32), unsafe.Sizeof((*nox_video_bag_image_t)(nil))*uintptr(*(*uint32)(unsafe.Add(v14, 8))+uint32(nox_tile_defs_arr[v16].field_46)))))))
				v68.field_0 = v76 + 23
				v68.field_4 = v11
				func_587000_154940((*uint32)(unsafe.Pointer(&v68)), v63, v13)
				*memmap.PtrUint32(0x85B3FC, uintptr(v16*4+228)) = 1
				v17 = int32(*(*uint32)(unsafe.Add(v14, 20)))
				if v17 != 0 {
			...
			var v18 bool = func() uint32 {
				...
				*p++
				return *p
			}() < uint32(dword_5d4594_3798832)+dword_5d4594_3798816
			i += 44
			if !v18 {
				break
			}
		...
		for {
			...
			if int32(v29)&2 != 0 {
				*(*uint16)(unsafe.Add(unsafe.Pointer(&v27), unsafe.Sizeof(uint16(0))*0)) = *(*uint16)(unsafe.Add(v30, 24))
				...
				v64 = int32(uintptr(unsafe.Pointer(*(**nox_video_bag_image_t)(unsafe.Add(unsafe.Pointer(nox_tile_defs_arr[v31].data_32), unsafe.Sizeof((*nox_video_bag_image_t)(nil))*uintptr(*(*uint32)(unsafe.Add(v30, 28))+uint32(nox_tile_defs_arr[v31].field_46)))))))
				v68.field_0 = v26
				v68.field_4 = v76 + 23
				...
				*memmap.PtrUint32(0x85B3FC, uintptr(v31*4+228)) = 1
				if *(*uint32)(unsafe.Add(v30, 40)) != 0 {
					nox_xxx_tileCallDrawEdges_481BF0(unsafe.Pointer(&v68), int32(*(*uint32)(unsafe.Add(v30, 40))))
				}
			}
			if int32(*(*uint8)(v30))&1 != 0 {
				*(*uint16)(unsafe.Add(unsafe.Pointer(&v27), unsafe.Sizeof(uint16(0))*0)) = *(*uint16)(unsafe.Add(v30, 4))
				...
				v65 = int32(uintptr(unsafe.Pointer(*(**nox_video_bag_image_t)(unsafe.Add(unsafe.Pointer(nox_tile_defs_arr[v32].data_32), unsafe.Sizeof((*nox_video_bag_image_t)(nil))*uintptr(*(*uint32)(unsafe.Add(v30, 8))+uint32(nox_tile_defs_arr[v32].field_46)))))))
				v68.field_0 = v26 + 23
				v68.field_4 = v76
				func_587000_154940((*uint32)(unsafe.Pointer(&v68)), v65, v27)
				*memmap.PtrUint32(0x85B3FC, uintptr(v32*4+228)) = 1
				v33 = int32(*(*uint32)(unsafe.Add(v30, 20)))
				if v33 != 0 {
...
func nox_xxx_tileDrawImpl_4826A0(vp *noxrender.Viewport) int32 {
	...
	if dword_5d4594_3798816+result >= 128 {
		v4 = math.MaxInt8
					...
					if int32(v12) != 0 {
						if int32(v12)&2 != 0 {
							*(*uint16)(unsafe.Add(unsafe.Pointer(&v10), unsafe.Sizeof(uint16(0))*0)) = *(*uint16)(unsafe.Add(v13, 24))
							...
							v18 = int32(uintptr(unsafe.Pointer(*(**nox_video_bag_image_t)(unsafe.Add(unsafe.Pointer(nox_tile_defs_arr[v14].data_32), unsafe.Sizeof((*nox_video_bag_image_t)(nil))*uintptr(*(*uint32)(unsafe.Add(v13, 28))+uint32(nox_tile_defs_arr[v14].field_46)))))))
							v24.field_0 = v8
							v24.field_4 = v6 + 23
							...
							*memmap.PtrUint32(0x85B3FC, uintptr(v14*4+228)) = 1
							if *(*uint32)(unsafe.Add(v13, 40)) != 0 {
								nox_xxx_tileCallDrawEdges_481BF0(unsafe.Pointer(&v24), int32(*(*uint32)(unsafe.Add(v13, 40))))
							}
						}
						if int32(*(*uint8)(v13))&1 != 0 {
							*(*uint16)(unsafe.Add(unsafe.Pointer(&v10), unsafe.Sizeof(uint16(0))*0)) = *(*uint16)(unsafe.Add(v13, 4))
							...
							v19 = int32(uintptr(unsafe.Pointer(*(**nox_video_bag_image_t)(unsafe.Add(unsafe.Pointer(nox_tile_defs_arr[v15].data_32), unsafe.Sizeof((*nox_video_bag_image_t)(nil))*uintptr(*(*uint32)(unsafe.Add(v13, 8))+uint32(nox_tile_defs_arr[v15].field_46)))))))
							v24.field_0 = v8 + 23
							v24.field_4 = v6
							func_587000_154940((*uint32)(unsafe.Pointer(&v24)), v19, v10)
							*memmap.PtrUint32(0x85B3FC, uintptr(v15*4+228)) = 1
							v16 = int32(*(*uint32)(unsafe.Add(v13, 20)))
							if v16 != 0 {
...
func sub_4831C0(a1 int32, a2 int32) int16 {
	...
	*(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(v2+v46)), 46)) = *(*uint16)(unsafe.Add(a1, 2114))
	return result
}
...
func sub_486570(a1 unsafe.Pointer, a2 *uint32) int32 {
	...
	sub_4863B0(unsafe.Add(unsafe.Pointer(a1), 4*8))
	...
	return sub_4863B0(unsafe.Add(unsafe.Pointer(a1), 4*16))
}
...
func sub_486640(a1p unsafe.Pointer, a2 int32) int32 {
	...
	return int32(uint32(a2) * (*(*uint32)(unsafe.Add(a1, 36)) >> 16) / 100)
}
...
func sub_486E90(a1 int32) int32 {
	...
	v1 = int32(*(*uint32)(unsafe.Add(a1, 132)))
...
func sub_4870E0(a1 *int32) *int32 {
	var result *int32
	result = (*int32)(unsafe.Pointer(nox_common_list_getFirstSafe_425890((*nox_list_item_t)(unsafe.Pointer(dword_587000_155144)))))
...
func sub_4873C0(a3 unsafe.Pointer) {
	...
	if (((uint64(v9)) << 32) | uint64(v7)) >= (((uint64(v10)) << 32) | uint64(v8)) {
		...
		*(*uint32)(unsafe.Add(v1, 252)) = uint32(v16)
		v12 = int32(*(*uint32)(unsafe.Add(v1, 200)))
		if v12 != v1+200 {
			for {
				v13 = int32(*(*uint32)(v12))
				if int32(*(*uint8)(unsafe.Add(v12, 124)))&1 != 0 && *(*uint32)(unsafe.Add(v12, 288)) != 0 {
					if (func() int32 {
						sub_486520((*uint32)(unsafe.Add(v12, 16)))
						return v17
...
func sub_4877F0(a1 *unsafe.Pointer) unsafe.Pointer {
	if *a1 != nil {
		*a1 = unsafe.Pointer(nox_common_list_getNextSafe_4258A0((*nox_list_item_t)(unsafe.Pointer(*a1))))
	}
	return *a1
}
...
func nox_xxx_wndEditProc_487D70(a1p *gui.Window, a2, a3, a4 uintptr) uintptr {
	...
	case 17:
		...
		*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*9)) |= 2
		nox_window_call_field_94_fnc((*gui.Window)(v16), 16389, uintptr(unsafe.Pointer(a1)), 0)
		nox_xxx_windowFocus_46B500((*gui.Window)(unsafe.Pointer(a1)))
		return 1
	case 18:
		...
		if v13&0x100 != 0 {
			...
			*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*9)) = uint32(v14)
			nox_window_call_field_94_fnc((*gui.Window)(v17), 16390, uintptr(unsafe.Pointer(a1)), 0)
		}
		return 1
	case 21:
...
func nox_xxx_wndEditDrawNoImage_488160(win *gui.Window, draw *gui.WindowData) int {
	...
	v25 = *(**wchar2_t)(unsafe.Add(a2, 28))
	v23 = *(**wchar2_t)(unsafe.Add(a1, 32))
	v22 = 0
	v24 = 0
	*(*uint32)(unsafe.Add(unsafe.Pointer(v23), 4*261)) = 0
	...
	v29 = v5
	v7 = yTop + v6/2 - v5/2
	if ((*(*uint32)(unsafe.Add(a1, 4)) >> 13) & 1) == 1 {
		nox_draw_enableTextSmoothing_43F670(1)
	}
	if (*(*uint32)(unsafe.Add(a1, 4))>>3)&1 != 0 {
		if int32(*(*uint8)(a2))&2 != 0 {
			v25 = *(**wchar2_t)(unsafe.Add(a2, 36))
		}
	} else {
		v30 = int32(*(*uint32)(unsafe.Add(a2, 44)))
	}
	if int32(*(*uint16)(unsafe.Add(a2, 72))) != 0 {
		nox_xxx_drawGetStringSize_43F840(*(*unsafe.Pointer)(unsafe.Add(a2, 200)), (*wchar2_t)(unsafe.Add(a2, 72)), &v22, nil, 0)
		nox_xxx_drawSetTextColor_434390(int32(*(*uint32)(unsafe.Add(a2, 68))))
		nox_xxx_drawStringWrap_43FAF0(*(*unsafe.Pointer)(unsafe.Add(a2, 200)), (*wchar2_t)(unsafe.Add(a2, 72)), v4+2, v7, v21, 0)
		v4 += v22 + 6
		v21 += -6 - v22
	}
	v8 = v23
	...
	if int32(v9) > 0 && v21 > int32(v9) {
		v21 = int32(v9)
		v4 = int32(uint32(xLeft) + *(*uint32)(unsafe.Add(a1, 8)) - uint32(v9))
	}
	if uint32(v30) != 0x80000000 {
		nox_client_drawSetColor_434460(v30)
		nox_client_drawRectFilledOpaque_49CE30(v4+1, yTop+1, v21-2, int32(*(*uint32)(unsafe.Add(a1, 12))-2))
		v8 = v23
	}
	if uintptr(unsafe.Pointer(v25)) != uintptr(0x80000000) {
		nox_client_drawSetColor_434460(int32(uintptr(unsafe.Pointer(v25))))
		nox_client_drawBorderLines_49CC70(v4, yTop, v21, int32(*(*uint32)(unsafe.Add(a1, 12))))
		v8 = v23
	}
	if *(*uint32)(unsafe.Add(a2, 68)) != 0x80000000 {
		...
		nox_xxx_drawGetStringSize_43F840(*(*unsafe.Pointer)(unsafe.Add(a2, 200)), (*wchar2_t)(unsafe.Pointer(&v31[0])), &v22, nil, 0)
		v19 = int32(*(*uint32)(unsafe.Add(a2, 200)))
		...
		if ((*(*uint32)(unsafe.Add(v2, 4))>>14)&1) == 1 && v24+v22 > 0 && v21 >= 10 && v24+v22+10 > v21 {
			for {
		...
		nox_xxx_drawSetTextColor_434390(int32(*(*uint32)(unsafe.Add(a2, 68))))
		nox_xxx_drawStringWrap_43FAF0(*(*unsafe.Pointer)(unsafe.Add(a2, 200)), (*wchar2_t)(unsafe.Pointer(v26)), v4+5, v7, 0, 0)
		v15 = int32(nox_color_rgb_4344A0(192, 0, 192))
		nox_xxx_drawSetTextColor_434390(v15)
		nox_xxx_drawStringWrap_43FAF0(*(*unsafe.Pointer)(unsafe.Add(a2, 200)), v25, v4+v22+5, v7, 0, 0)
		v16 = v4 + v22 + v24 + 5
		if v2 == unsafe.Pointer(nox_xxx_wndGetFocus_46B4F0()) {
			...
			if !v17 {
				nox_client_drawSetColor_434460(int32(*(*uint32)(unsafe.Add(a2, 68))))
...
func nox_gui_newEntryField_488500(a1p *gui.Window, a2 nox_window_flags, a3, a4, a5, a6 int, a7 int32, a8 *wchar2_t) *gui.Window {
	...
	if int32(*(*uint8)(unsafe.Add(a7, 8)))&0x80 != 0 {
		v8 = (*uint32)(unsafe.Pointer(nox_window_new((*gui.Window)(a1), a2, a3, a4, a5, a6, nox_xxx_wndEditProcPre_488710)))
...
func nox_xxx_wndEditProcPre_488710(win *gui.Window, a2, p3, p4 uintptr) uintptr {
	...
	if a2 == 16413 {
		return uintptr(*(*uint32)(unsafe.Add(a1, 32)))
	}
	if a2 == 2 {
	...
	if a3 != nil {
		...
		v6 = int32(*(*uint32)(unsafe.Add(a1, 36)))
		*(*uint8)(unsafe.Pointer(&v6)) = uint8(int8(v6 | 6))
		*(*uint32)(unsafe.Add(a1, 36)) = uint32(v6)
	} else {
	...
	v7 = nox_xxx_wndGetID_46B0A0((*gui.Window)(a1))
	nox_window_call_field_94_fnc((*gui.Window)(*(*unsafe.Pointer)(unsafe.Add(a1, 52))), 16387, uintptr(unsafe.Pointer(a3)), uintptr(v7))
	return 1
}
func nox_xxx_wndEdit_488830(a1 int32) int32 {
	...
	if a1 != 0 {
		if int32(int8(*(*uint8)(unsafe.Add(a1, 4)))) >= 0 {
			result = nox_window_set_all_funcs((*gui.Window)(a1), nox_xxx_wndEditProc_487D70, nox_xxx_wndEditDrawNoImage_488160, nil)
		} else {
			result = nox_window_set_all_funcs((*gui.Window)(a1), nox_xxx_wndEditProc_487D70, nox_xxx_wndEditDrawWithImage_488870, nil)
		}
	}
	return result
}
func nox_xxx_wndEditDrawWithImage_488870(win *gui.Window, draw *gui.WindowData) int {
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(v22), 4*261)) = 0
	...
	if (*(*uint32)(unsafe.Add(a1, 4))>>3)&1 != 0 {
		...
		v7 = int32(*(*uint32)(unsafe.Add(a2, 48)))
	}
	if v7 != 0 {
		nox_client_drawImageAt_47D2C0((*nox_video_bag_image_t)(v7), xLeft, v21)
	}
	nox_xxx_drawSetTextColor_434390(int32(*(*uint32)(unsafe.Add(a2, 68))))
	if int32(*(*uint16)(unsafe.Add(a2, 72))) != 0 {
		nox_xxx_drawGetStringSize_43F840(*(*unsafe.Pointer)(unsafe.Add(a2, 200)), (*wchar2_t)(unsafe.Add(a2, 72)), &v17, nil, 0)
		nox_xxx_drawStringWrap_43FAF0(*(*unsafe.Pointer)(unsafe.Add(a2, 200)), (*wchar2_t)(unsafe.Add(a2, 72)), xLeft+2, v6, v3, 0)
		v3 += -6 - v17
		xLeft += v17 + 6
	}
	if *(*uint32)(unsafe.Add(a2, 68)) != 0x80000000 {
		...
		nox_xxx_drawGetStringSize_43F840(*(*unsafe.Pointer)(unsafe.Add(a2, 200)), (*wchar2_t)(unsafe.Pointer(&v24[0])), &v17, nil, 0)
		v20 = (*wchar2_t)(unsafe.Add(unsafe.Pointer(v22), unsafe.Sizeof(wchar2_t(0))*256))
		nox_xxx_drawGetStringSize_43F840(*(*unsafe.Pointer)(unsafe.Add(a2, 200)), (*wchar2_t)(unsafe.Add(unsafe.Pointer(v22), unsafe.Sizeof(wchar2_t(0))*256)), &v19, nil, 0)
		if ((*(*uint32)(unsafe.Add(v2, 4))>>14)&1) == 1 && v17+v19 > 0 && v17+v19+10 > v3 {
			for {
				v15 = int32(*(*uint32)(unsafe.Add(a2, 200)))
		...
		nox_xxx_drawSetTextColor_434390(int32(*(*uint32)(unsafe.Add(a2, 68))))
		nox_xxx_drawStringWrap_43FAF0(*(*unsafe.Pointer)(unsafe.Add(a2, 200)), (*wchar2_t)(unsafe.Pointer(v18)), xLeft+5, v6, v3, 0)
		v12 = int32(nox_color_rgb_4344A0(192, 0, 192))
		nox_xxx_drawSetTextColor_434390(v12)
		nox_xxx_drawStringWrap_43FAF0(*(*unsafe.Pointer)(unsafe.Add(a2, 200)), v20, v17+xLeft+5, v6, v3, 0)
		xLeft += v17 + v19 + 5
		if v2 == unsafe.Pointer(nox_xxx_wndGetFocus_46B4F0()) {
...
func nox_xxx_onChar_488BD0(a1 uint16) {
	...
	if dword_5d4594_1193348 != 0 {
		if dword_5d4594_1193352 != 0 {
			v2 = int32(*(*uint32)(unsafe.Add(dword_5d4594_1193352, 32)))
			if nox_strman_get_lang_code() == 6 || nox_strman_get_lang_code() == 8 {
...
func sub_489870() int32 {
	...
	if *memmap.PtrUint32(0x5D4594, uintptr(v0*4)+1193372) == 2 {
		*(*uint32)(unsafe.Pointer(v1)) = (nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10028).DrawData().Field0 >> 2) & 1
		v2 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10031)))
		...
		*(*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*1)) = (nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10029).DrawData().Field0 >> 2) & 1
		v4 = nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10030).DrawData().Field0
		*(*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*3)) = 0
		*(*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*2)) = (v4 >> 2) & 1
		if nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10015).DrawData().Field0&4 != 0 {
			...
			*(*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*3)) = uint32(v5)
			v6 = int8(*(*uint8)(unsafe.Pointer(&nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10016).DrawData().Field0)))
		...
		*(*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*5)) = (nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10014).DrawData().Field0 >> 2) & 1
		*(*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*10)) = (nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10018).DrawData().Field0 >> 2) & 1
	}
	return nox_window_set_hidden((*gui.Window)(dword_5d4594_1193380), 1)
}
func nox_xxx_checkSomeFlagsOnJoin_4899C0(srv *nox_gui_server_ent_t) int32 {
	...
	if v5 != 0 {
		if v5 == 1 {
			...
			if *(*uint32)(unsafe.Pointer(v4)) != 0 {
				v7 = *(*uint32)(unsafe.Add(a1, 96))
				if v7 > *(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*4)) && v7 != 9999 {
					return 0
				}
			}
			if *(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*1)) != 0 && int32(*(*uint8)(unsafe.Add(a1, 100)))&0x10 != 0 {
				return 0
			}
			if *(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*2)) != 0 && int32(*(*uint8)(unsafe.Add(a1, 100)))&0x20 != 0 {
				return 0
			}
			v9 = int8(*(*uint8)(unsafe.Add(a1, 102)))
			...
			if *(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*5)) != 0 {
				libc.StrCpy((*byte)(unsafe.Pointer(&v13[0])), (*byte)(unsafe.Add(a1, 111)))
				sub_57A1E0(&v13[0], nil, nil, 5, int16(*(*uint16)(unsafe.Add(a1, 163))))
				v10 = 0
				v14 = 0
				for uint32(v13[int32(v14)+6]) == *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(int32(v14)*4+v6)), 135)) {
					...
					if int32(v10) >= 5 {
						...
						for int32(*(*uint8)(unsafe.Add(unsafe.Pointer(&v13[11]), v15))) == int32(*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(int32(v15)+v6)), 155))) {
							...
							if int32(v11) >= 4 {
								if uint32(v13[12]) == *(*uint32)(unsafe.Add(v6, 159)) {
									goto LABEL_26
								}
								return 0
							}
		...
		LABEL_26:
			if *(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*10)) != 0 && *(*uint32)(unsafe.Add(v6, 48)) != NOX_CLIENT_VERS_CODE {
				return 0
			}
		}
		return 1
	}
	v12 = int8(*(*uint8)(unsafe.Add(a1, 100)))
	if int32(v12)&0x10 != 0 {
		return 0
	}
	if int32(v12)&0x20 != 0 {
	...
	return bool2int32(*(*uint32)(unsafe.Add(a1, 48)) == NOX_CLIENT_VERS_CODE)
}
func sub_489B80(a1 int32) *uint32 {
	...
	if result != nil {
		...
		sub_46B120((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), (*gui.Window)(a1))
		sub_46B120((*gui.Window)(unsafe.Pointer(dword_5d4594_1193384)), (*gui.Window)(dword_5d4594_1193380))
		nox_xxx_wndSetProc_46B2C0(dword_5d4594_1193384, nox_xxx_windowMplayFilterProc_489E70)
		if *(*uint32)(unsafe.Pointer(v3)) != 0 {
			v4 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10028)))
			*(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*9)) |= 4
		}
		nox_swprintf(&v13[0], internWStr("%d"), *(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*4)))
		v5 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10031)))
		...
		if *(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*1)) != 0 {
			v6 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10029)))
			*(*uint32)(unsafe.Add(unsafe.Pointer(v6), 4*9)) |= 4
		}
		if *(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*2)) != 0 {
			v7 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10030)))
			*(*uint32)(unsafe.Add(unsafe.Pointer(v7), 4*9)) |= 4
		}
		if *(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*3)) != 0 {
			v8 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10015)))
			*(*uint32)(unsafe.Add(unsafe.Pointer(v8), 4*9)) |= 4
		}
		if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(v3), 12)))&2 != 0 {
			v9 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10017)))
		} else {
			v9 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10016)))
		}
		v10 = v9
		*(*uint32)(unsafe.Add(unsafe.Pointer(v9), 4*9)) |= 4
		if *(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*5)) != 0 {
			v10 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10014)))
			*(*uint32)(unsafe.Add(unsafe.Pointer(v10), 4*9)) |= 4
		}
		if *(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*10)) != 0 {
			v10 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10018)))
			*(*uint32)(unsafe.Add(unsafe.Pointer(v10), 4*9)) |= 4
		}
		...
		if v11 != 0 {
			...
			if v12 != 0 {
				if v12 == 1 {
					v10 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10026)))
					sub_489DC0()
				}
			} else {
				v10 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10025)))
				nox_window_set_hidden((*gui.Window)(dword_5d4594_1193384), 1)
			}
		} else {
			v10 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10024)))
			nox_window_set_hidden((*gui.Window)(dword_5d4594_1193384), 1)
		}
		*(*uint32)(unsafe.Add(unsafe.Pointer(v10), 4*9)) |= 4
...
func sub_489DC0() {
	...
	nox_window_set_hidden((*gui.Window)(dword_5d4594_1193384), 0)
	if nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193384)), 10028).DrawData().Field0&4 != 0 {
		v0 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193384)), 10031)))
		nox_xxx_wnd_46ABB0((*gui.Window)(unsafe.Pointer(v0)), 1)
	} else {
		v1 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193384)), 10031)))
		nox_xxx_wnd_46ABB0((*gui.Window)(unsafe.Pointer(v1)), 0)
	}
	if nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193384)), 10015).DrawData().Field0&4 != 0 {
...
func nox_xxx_windowMplayFilterProc_489E70(win *gui.Window, a2, a3, p4 uintptr) uintptr {
	...
	case 10026:
		*memmap.PtrUint32(0x5D4594, uintptr(v3*4)+1193372) = 2
		...
		return 0
	case 10028:
		v6 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)), 10031)))
...
func sub_489FB0() int32 {
	...
	if dword_5d4594_1193380 != 0 {
		sub_489870()
		nox_xxx_wndClearCaptureMain_46ADE0((*gui.Window)(dword_5d4594_1193380))
		result = nox_xxx_windowDestroyMB_46C4E0((*gui.Window)(unsafe.Pointer(dword_5d4594_1193380)))
