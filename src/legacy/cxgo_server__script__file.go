...
func sub_543110(lpExistingFileName *byte, a2 *int32) int32 {
	...
	sub_542BF0(int32(dword_5d4594_3835312), *(*int32)(unsafe.Add(unsafe.Pointer(a2), 4*0)), *(*int32)(unsafe.Add(unsafe.Pointer(a2), 4*1)))
	...
	*((*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*2))) = uint32(v3)
	...
	for j = 0; v10 < v15; j = v10 {
		...
		v19[v12] = 0
		if v10 > 1 {
			sub_5435C0(unsafe.Pointer(&v19[0]), int32(dword_5d4594_3835312), *(*int32)(unsafe.Add(unsafe.Pointer(a2), 4*0)), *(*int32)(unsafe.Add(unsafe.Pointer(a2), 4*1)))
