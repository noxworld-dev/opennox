...
func sub_4B6770(a1 *int32, dr *client.Drawable, a3 int32, a4 int32) int {
	...
	var v18 int32
	v4 = a2
	v5 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 444)))
	v6 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 448)) - uint32(v5))
	v7 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 448)) - gameFrame())
	v16 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 448)) - uint32(v5))
	v18 = v7
	if v7 == v6 {
		v18 = func() int32 {
			p := &v7
	...
	if v7 > 0 {
		...
		v11 = int32(uint32(*a1) + *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v4)), 12)) - uint32(*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*4))))
		v12 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v4)), 16)) - uint32(*(*int16)(unsafe.Add(unsafe.Pointer(uintptr(v4)), 106))) - uint32(*(*int16)(unsafe.Add(unsafe.Pointer(uintptr(v4)), 104))) - uint32(*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*5))))
		xLeft.field_0 = v11
		v13 = v10 + v12
		xLeft.field_4 = v13
...
func nox_thing_pixie_draw(vp *noxrender.Viewport, dr *client.Drawable) int {
	...
	v3 = int16(*(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 104)))
	if v2 {
		if int32(v3) > 0 {
			v4 = int16(int32(v3) - 1)
			*(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 104)) = uint16(v4)
		}
	} else if int32(v3) < 35 {
		v4 = int16(int32(v3) + 1)
		*(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 104)) = uint16(v4)
	...
	v7 = int32(uint32(*a1) + *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 12)) - uint32(*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*4))))
	v8 = int32(uint32(v6) + *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 16)) - uint32(*(*int16)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 106))) - uint32(*(*int16)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 104))) - uint32(*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*5))))
	v15.field_0 = v7
	v15.field_4 = v8
	if v7-10 >= v5 && v8-10 >= v6 && v7+10 < *(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*2)) && v8+10 < *(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*3)) {
		...
		v9 = int32(uint32(*a1) + *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 32)) - uint32(*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*4))))
		v10 = int32(uint32(*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*1))) + *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 36)) - uint32(*(*int16)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 104))) - uint32(*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*5))))
		v11 = v15.field_0 - v9
		v12 = v15.field_4 - v10
...
func nox_thing_blue_rain_spark_draw(vp *noxrender.Viewport, dr *client.Drawable) int {
	...
	if result == 1 && int32(*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 296))) >= 5 {
		...
		v4 = int32(uintptr(unsafe.Pointer(nox_xxx_spriteLoadAdd_45A360_drawable(v3, int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 12))), int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 16)))))))
		v5 = v4
		if v4 != 0 {
			if v4 != -432 {
				*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v4)), 432)) = *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 12)) << 12
				*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v4)), 436)) = *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 16)) << 12
				*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(v4)), 299)) = uint8(int8(nox_common_randomIntMinMax_415FF0(0, math.MaxUint8, internCStr("C:\\NoxPost\\src\\Client\\Draw\\Glowdraw.c"), 605)))
				*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v5)), 440)) = uint32(nox_common_randomIntMinMax_415FF0(1, 1611, internCStr("C:\\NoxPost\\src\\Client\\Draw\\Glowdraw.c"), 608))
				*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v5)), 448)) = gameFrame() + uint32(nox_common_randomIntMinMax_415FF0(10, 96, internCStr("C:\\NoxPost\\src\\Client\\Draw\\Glowdraw.c"), 611))
				*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v5)), 444)) = gameFrame()
			}
			*(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(v5)), 104)) = uint16(int16(nox_common_randomIntMinMax_415FF0(5, 15, internCStr("C:\\NoxPost\\src\\Client\\Draw\\Glowdraw.c"), 618)))
			*(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(v5)), 106)) = 0
			*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(v5)), 296)) = uint8(int8(nox_common_randomIntMinMax_415FF0(0, 8, internCStr("C:\\NoxPost\\src\\Client\\Draw\\Glowdraw.c"), 620)))
...
func nox_thing_rain_orb_draw(vp *noxrender.Viewport, dr *client.Drawable) int {
	...
	if int32(v3) > 0 {
		...
		v15 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 16)))
		...
		v18 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 108)))
		xLeft.field_4 = v15 + v16 - int32(v3)
		if uint32(v18) != dword_5d4594_1313692 {
			v17 = int32(dword_5d4594_1313536)
		}
		sub_4B6720(&xLeft, v17, int32(*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 442))), 5)
		v19 = int32(*(*int16)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 104))) - int32(*(*int16)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 440)))
		...
		nox_client_drawLineFromPoints_49E4B0()
		*(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 440)) = *(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 104))
		*(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 104)) += uint16(*(*byte)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 296)))
		nox_client_drawSetColor_434460(*memmap.PtrInt32(0x5D4594, 1313592))
		nox_xxx_drawPointMB_499B70(xLeft.field_0, xLeft.field_4, int32(*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 442)))/3)
		result = 1
	} else {
