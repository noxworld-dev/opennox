...
func nox_thing_rain_orb_draw(vp *noxrender.Viewport, dr *client.Drawable) int {
	...
	if int32(v3) > 0 {
		...
		*(*uint16)(unsafe.Add(a2, 104)) += uint16(*(*byte)(unsafe.Add(a2, 296)))
		...
		v23[2] = int16(v4)
		v23[3] = v6
		v20 = float32(float64(*memmap.PtrFloat32(0x587000, uintptr(uint32(v7*8)+194136)))*150.0 + float64(*(*int32)(unsafe.Add(unsafe.Pointer(v2), 4*108))))
		v8 = int16(int32(v20))
		v9 = float64(*memmap.PtrFloat32(0x587000, uintptr(uint32(v7*8)+194140))) * 150.0
		v23[0] = v8
