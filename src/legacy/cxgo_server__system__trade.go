...
func sub_50F0F0(a1 unsafe.Pointer, a2 int32) int32 {
	...
	*(*uint16)(unsafe.Pointer(&v6[52])) = 0
	libc.StrCpy(&v6[54], (*byte)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 692)), 1684)))
	*(*uint16)(unsafe.Pointer(&v6[2])) = *(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 4))
	return nox_xxx_netSendPacket1_4E5390(int32(*(*uint8)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(uintptr(v3)), 748)), 276)), 2064))), unsafe.Pointer(&v6[0]), 86, nil, 1)
}
	...
	*(*uint16)(unsafe.Pointer(&v8[0])) = 3273
	...
	if a1 != v2 {
		if int32(*(*uint8)(unsafe.Add(v2, 8)))&4 != 0 {
			...
			return nox_xxx_netSendPacket1_4E5390(int32(*(*uint8)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(uintptr(v3)), 276)), 2064))), unsafe.Pointer(&v8[0]), 52, nil, 1)
		}
		...
		if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(v4)), 8)))&4 != 0 {
			nox_wcscpy((*wchar2_t)(unsafe.Pointer(&v8[2])), (*wchar2_t)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(uintptr(v4)), 748)), 276)), 4704)))
			return nox_xxx_netSendPacket1_4E5390(int32(*(*uint8)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(uintptr(v3)), 276)), 2064))), unsafe.Pointer(&v8[0]), 52, nil, 1)
		}
...
func nox_xxx_servSendShopItems_50F280(a1 int32, a2 int32) int32 {
	...
	result = a2
	for i = *(**uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 20)); i != nil; i = (*uint32)(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(i), 4*2))) {
...
func sub_50FAE0(a1 unsafe.Pointer, a2 unsafe.Pointer, a3 unsafe.Pointer, a4 int32, a5 int32) int32 {
	...
	*(*uint16)(unsafe.Pointer(&v11[5])) = uint16(v6)
	if uint32(v7)&0x13001000 != 0 {
		...
		for i = 0; i < 4; i++ {
			if *(*uint32)(unsafe.Pointer(uintptr(v8))) != 0 {
				v11[i+11] = *(*uint8)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Pointer(uintptr(v8))), 4))
			} else {
	...
	return nox_xxx_netSendPacket1_4E5390(int32(*(*uint8)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(uintptr(v5)), 276)), 2064))), unsafe.Pointer(&v11[0]), 15, nil, 1)
}
...
func sub_5104F0(a1 unsafe.Pointer, a2 int16) int32 {
	...
	*(*uint16)(unsafe.Pointer(&v4[2])) = uint16(a2)
	...
	v4[0] = 201
	v4[1] = 27
	return nox_xxx_netSendPacket0_4E5420(int32(*(*uint8)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 276)), 2064))), unsafe.Pointer(&v4[0]), 4, nil, 1)
}
...
func sub_5100C0_trade(a1 unsafe.Pointer, a2 *uint32, a3 int32) {
	...
	if result != nil {
		...
		if *(*uint32)(unsafe.Pointer(result)) != 0 {
			...
			sub_4D8870(int32(*(*uint8)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(uintptr(v18)), 276)), 2064))), v3)
		}
	}
}
func sub_510640_trade(a1 unsafe.Pointer, a2 unsafe.Pointer, a3 int32, a4 *float32) *float32 {
	...
	if a4 != nil {
		for {
			...
			sub_4D8870(int32(*(*uint8)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(uintptr(v20)), 276)), 2064))), v4)
	...
	if v4 != nil {
		...
		if nox_xxx_ItemIsDroppable_53EBF0(v4) == 1 {
			...
			*(*uint32)(unsafe.Pointer(&v8[4])) = uint32(nox_xxx_shopGetItemCost_50E3D0(0, a2, *(*float32)(unsafe.Pointer(&v4))))
			result = (*uint32)(unsafe.Pointer(uintptr(nox_xxx_netSendPacket0_4E5420(int32(*(*uint8)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(uintptr(v3)), 276)), 2064))), unsafe.Pointer(&v8[0]), 8, nil, 1))))
		}
	}
	return result
}
func sub_510BE0_trade(a1 *int32, a2 unsafe.Pointer, a3 *uint32) *uint32 {
	...
	if v5 != nil {
		...
		if nox_xxx_ItemIsDroppable_53EBF0(v5) == 1 {
			...
			sub_4D8870(int32(*(*uint8)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(uintptr(v4)), 276)), 2064))), unsafe.Pointer(a1))
