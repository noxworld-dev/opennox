...
func sub_56F1C0() int32 {
	...
	*memmap.PtrUint32(0x5D4594, 2516332) = uint32(result)
	return result
}
...
func nox_xxx_protectionCreateStructForInt_56F280(a1 int32, a2 int32) int32 {
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(v2), 4*1)) = uint32(a2)
	v4 = int32(uint32(a2) ^ dword_5d4594_2516348)
	*(*uint32)(unsafe.Add(unsafe.Pointer(v2), 4*1)) = uint32(a2) ^ dword_5d4594_2516348
...
func sub_56F2F0(a1 *uint32) int32 {
	...
	if int32(*memmap.PtrUint16(0x587000, 311204)) != 0 {
		for i = int16(nox_common_randomInt_415FA0(0, int32(*memmap.PtrUint16(0x587000, 311204))-1)); v1 != 0; v2++ {
			if int32(v2) == int32(i) {
				break
			}
			v1 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v1)), 8)))
		}
		*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*3)) = *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v1)), 12))
		if dword_5d4594_2516348 == 0 {
			nullsub_31(1)
		}
		*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*2)) = uint32(v1)
		*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v1)), 12)) = uint32(uintptr(unsafe.Pointer(a1)))
		v5 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*3)))
		if v5 != 0 {
			*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v5)), 8)) = uint32(uintptr(unsafe.Pointer(a1)))
...
func sub_56F510(a1 int32) int32 {
	...
	if v2 != 0 {
		*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 8)) = *(*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*2))
	} else {
		dword_5d4594_2516344 = *(*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*2))
	}
	v3 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*2)))
	if v3 != 0 {
		*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v3)), 12)) = *(*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*3))
	} else {
		dword_5d4594_2516352 = *(*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*3))
	}
...
func nox_xxx_protectData_56F5C0() int32 {
	...
	if dword_5d4594_2516344 != 0 {
		for {
			v10 = v3 ^ *v9
			v11 = v3 ^ *(*int32)(unsafe.Add(unsafe.Pointer(v9), 4*1))
			*v9 = v10
...
func sub_56F720(a1 *int32, a2 *int32) {
	...
	*a1 = *a2
	*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*1)) = *(*int32)(unsafe.Add(unsafe.Pointer(a2), 4*1))
	*a2 = v2
	*(*int32)(unsafe.Add(unsafe.Pointer(a2), 4*1)) = v3
...
func nox_xxx_playerApplyProtectionCRC_56FD50(a1 int32, a2p unsafe.Pointer, a3 int32) int32 {
	...
	if uint32(a1) >= 657757279 {
		...
		if v4 != nil {
			v5 = 1
			if a3 > 1 {
				v6 = (*int32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 4))
				for {
...
func nox_xxx_netGetUnitCodeCli_578B00(a1 int32) uint32 {
	...
	result = *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 128))
	if result >= 0x8000 {
		return 0
	}
	if *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 112))&0x20400000 != 0 {
...
func nox_xxx_packetDynamicUnitCode_578B40(a1 int32) int32 {
	...
	if (a1 & 0x8000) == 0x8000 {
		*(*uint8)(unsafe.Add(unsafe.Pointer(&result), 1)) &= math.MaxInt8
		...
		if v2 != nil {
			result = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 36)))
		} else {
			result = 0
		}
	}
...
func nox_xxx_waypointGetList_579860() unsafe.Pointer {
	return unsafe.Pointer(nox_xxx_waypointsHead_2523752)
}
func nox_xxx_waypointNext_579870(a1 int32) int32 {
	var result int32
	if a1 != 0 {
		result = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 484)))
	} else {
		result = 0
	}
	return result
...
func sub_579890() int32 {
	return int32(uintptr(dword_5d4594_2523756))
}
...
func nox_xxx_waypointNew_5798F0(a1 float32, a2 float32) *nox_waypoint_t {
	...
	*v2 = v3
	*((*float32)(unsafe.Add(unsafe.Pointer(v2), unsafe.Sizeof(float32(0))*2))) = a1
	*((*float32)(unsafe.Add(unsafe.Pointer(v2), unsafe.Sizeof(float32(0))*3))) = a2
...
func nox_xxx_waypointNewNotMap_579970(a1 int32, a2 float32, a3 float32) *float32 {
	...
	*(*float32)(unsafe.Add(unsafe.Pointer(result), unsafe.Sizeof(float32(0))*3)) = a3
	v4 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer(result), 4*120))) | 1)
...
func nox_xxx_waypoint_5799C0() *byte {
	...
	v0 = int32(uintptr(dword_5d4594_2523756))
	if dword_5d4594_2523756 != nil {
		for {
			v1 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v0)), 484)))
			*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v0)), 484)) = uint32(uintptr(unsafe.Pointer(nox_xxx_waypointsHead_2523752)))
			if nox_xxx_waypointsHead_2523752 != nil {
...
func sub_579AD0(a1 float32, a2 float32) *float32 {
	...
	v3 = 0
	for i = 100.0; v2 != 0; v2 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 484))) {
		v4 = float64(*(*float32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 8)) - a1)
		v5 = float64(*(*float32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 12)) - a2)
		v6 = v5*v5 + v4*v4
		if v6 < float64(i) {
			i = float32(v6)
			v3 = v2
...
func sub_579CA0() int32 {
	...
	for {
		...
		if int32(*((*uint8)(unsafe.Add(unsafe.Pointer(v1), 476)))) != 0 {
			v3 = (*int32)(unsafe.Pointer((*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*23))))
			v4 = (*int32)(unsafe.Pointer((*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*87))))
			for {
...
func sub_579D20() int32 {
	...
	v1 = (*uint32)(dword_5d4594_2523756)
	if dword_5d4594_2523756 != nil {
		for {
			v2 = *v1
			*v1 = v0
	...
	for {
		v4 = 0
		v9 = 0
		if int32(*((*uint8)(unsafe.Add(unsafe.Pointer(v3), 476)))) != 0 {
			v5 = (*int32)(unsafe.Pointer((*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*23))))
			v6 = (*int32)(unsafe.Pointer((*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*87))))
			for {
				...
				*v5 = v7
				...
				v4++
				v6 = (*int32)(unsafe.Add(unsafe.Pointer(v6), 4*1))
				if v4 >= int32(*((*uint8)(unsafe.Add(unsafe.Pointer(v3), 476)))) {
					break
				}
			}
		}
...
func sub_579E90(a1 int32) {
	*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 480)) |= 0x1000000
	*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 484)) = uint32(uintptr(dword_5d4594_2523756))
	if dword_5d4594_2523756 != nil {
		*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(dword_5d4594_2523756)), 488)) = uint32(a1)
	}
...
func nox_xxx_waypoint_579F00(a1 *uint32, a2 unsafe.Pointer) int32 {
	...
	if noxflags.HasGame(32) {
		if a2 != nil {
			...
			if v3 != nil {
				for (*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v3)), 8))&0x10000000) == 0 || nox_xxx_servCompareTeams_419150(unsafe.Add(a2, 48), unsafe.Add(v3, 48)) != 0 {
					v3 = unsafe.Pointer(nox_server_getNextObject_4DA7A0((*server.Object)(unsafe.Pointer(uintptr(v3)))))
					if v3 == nil {
						goto LABEL_9
					}
				}
...
LABEL_9:
	...
	for {
		...
		if noxflags.HasGame(32) {
			if v2 != nil {
				if a2 != nil {
					v7 = *(**float32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 748))
					v12.field_0 = *v7
	...
	*a1 = *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(v6)), 4*2)))
	*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*1)) = *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(v6)), 4*3)))
	return 1
}
func nox_xxx_playerCanTalkMB_57A160(a1 int32) int32 {
	var result int32
	if a1 != 0 && noxflags.HasGame(2) {
		result = int32((*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 3680)) >> 3) & 1)
	} else {
		result = 0
	}
	return result
...
func sub_57A1E0(a1 *int32, a2 *byte, a3 *int32, a4 int8, a5 int16) int8 {
	...
	*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*12)) = -1
	...
	result = int8(a5)
	if int32(a5)&0x40 != 0 {
		result = int8(sub_453FA0(int32(uintptr(unsafe.Pointer((*int32)(unsafe.Add(unsafe.Pointer(a1), 4*6))))), 132, 0))
	}
	return result
}
...
func sub_57A620(a1 uint8, a2 **wchar2_t, a3 int32, a4 int32) int32 {
	...
	if _nox_wcsicmp(*(**wchar2_t)(unsafe.Add(unsafe.Pointer(v4), unsafe.Sizeof((*wchar2_t)(nil))*1)), internWStr("spell")) != 0 {
		if _nox_wcsicmp(*(**wchar2_t)(unsafe.Add(unsafe.Pointer(v4), unsafe.Sizeof((*wchar2_t)(nil))*1)), internWStr("weapon")) != 0 {
			...
			*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a3)), 48)) = uint32(v15)
		} else {
			if int32(a1) != 4 {
				return 0
			}
...
func sub_57B630(a1 unsafe.Pointer, a2 int32, a3 int32) int8 {
	...
	if a2 >= 0 && a2 < 256 && (a3 >= 0 || a3 < 256) {
		...
		if v3 != 0 {
			v4 = int8(*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(v3)), 4)))
			if int32(v4)&0x10 != 0 {
				v5 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v3)), 28)))
				if v5 != 0 {
					v6 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v5)), 748)))
					v7 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v6)), 12)))
					if v7 == *(*int32)(unsafe.Add(unsafe.Pointer(uintptr(v6)), 4)) {
						...
						if v8 > 0 {
							if *memmap.PtrInt32(0x587000, uintptr(v7*8)+196188) > 0 {
								v11 = 1
								if *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v5)), 508)) != 0 {
									if nox_common_randomInt_415FA0(0, 100) >= 50 {
										return v11
									}
								} else if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(v6)), 1))) != 0 && nox_xxx_doorGetSomeKey_4E8910((*server.Object)(unsafe.Pointer(uintptr(a1))), (*server.Object)(unsafe.Pointer(uintptr(v5)))) == nil {
									return v11
								}
								return -1
							}
			...
			} else if (*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 16))&0x4000) == 0 || (int32(v4)&0x40) == 0 {
				if (int32(v4) & 4) == 0 {
					return int8(*(*uint8)(unsafe.Pointer(uintptr(v3))))
				}
				v13 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v3)), 28)))
				if (int32(*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(v13)), 20)))&2) == 0 && int32(*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(v13)), 22))) <= 0xB {
					return int8(*(*uint8)(unsafe.Pointer(uintptr(v3))))
				}
			}
		}
...
func nox_xxx_collideReflect_57B810(a1 *float32, a2 unsafe.Pointer) {
	...
	if float64(*(*float32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(float32(0))*1))**a1) <= 0.0 {
		...
		*(*float32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 4)) = *(*float32)(unsafe.Pointer(uintptr(a2)))
		*(*uint32)(unsafe.Pointer(uintptr(a2))) = uint32(v4)
	} else {
		*(*float32)(unsafe.Pointer(uintptr(a2))) = -*(*float32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 4))
...
func sub_57BA10(a1 int32, a2 int16, a3 int16, a4 int32) int32 {
	...
	*(*uint16)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 2)) = uint16(a3)
	*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 4)) = uint32(a4)
	return result
}
...
func nox_server_getNextMapGroup_57C090(a1 int32) int32 {
	var result int32
	if a1 != 0 {
		result = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 88)))
	} else {
		result = 0
	}
	return result
