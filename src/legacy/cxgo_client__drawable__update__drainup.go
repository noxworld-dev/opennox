...
func sub_4CD690(vp *noxrender.Viewport, dr *client.Drawable) int {
	...
	if int32(*(*uint8)(unsafe.Add(a2, 432))) != 0 {
		...
		v2 = int32(*(*uint16)(unsafe.Add(a2, 441))) + nox_common_randomIntMinMax_415FF0(-20, 20, internCStr("C:\\NoxPost\\src\\client\\Drawable\\Update\\drainup.c"), 31)
		v3 = int32(*(*uint16)(unsafe.Add(a2, 443))) + nox_common_randomIntMinMax_415FF0(-20, 20, internCStr("C:\\NoxPost\\src\\client\\Drawable\\Update\\drainup.c"), 32)
		*(*uint16)(unsafe.Add(unsafe.Pointer(&v22), unsafe.Sizeof(uint16(0))*0)) = *(*uint16)(unsafe.Add(a2, 437))
		*(*uint16)(unsafe.Add(unsafe.Pointer(&v4), unsafe.Sizeof(uint16(0))*0)) = *(*uint16)(unsafe.Add(a2, 439))
	}
	...
	v24 = int32(*(*int16)(unsafe.Add(a2, 104)))
	v17 = v2 + v15
	...
	*(*uint16)(unsafe.Add(v19, 432)) = uint16(int16(v22))
	*(*uint16)(unsafe.Add(v19, 434)) = uint16(v23)
	*(*uint8)(unsafe.Add(v19, 443)) = uint8(v20)
	*(*uint8)(unsafe.Add(v19, 444)) = uint8(int8(nox_common_randomIntMinMax_415FF0(3, 10, internCStr("C:\\NoxPost\\src\\client\\Drawable\\Update\\drainup.c"), 100)))
	return 1
}
