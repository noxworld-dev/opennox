...
func nox_xxx_mapgen_522AD0(a1 *float32, a2 int32) *float32 {
	...
	if v6 != nil {
		...
		switch *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 60)) {
		case 0:
			v13 = 3.0
			v7 = 2.0
			a2a.field_0--
...
func sub_527D50(a1 int32, a2 *byte) int32 {
	...
	libc.StrNCpy(*(**byte)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 700)), a2, 0x50)
	return 1
}
func nox_xxx_mapGenMakeExit_522A40(a1 int32) int32 {
	...
	for v2 := int32(sub_5259E0()); v2 != 0; v2 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v2)), 68))) {
		...
		var v3 int32 = 0
		var v4 int32 = a1 + 216
		for v3 < *(*int32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 472)) {
			var v5 *float32 = nox_xxx_mapgen_522AD0((*float32)(unsafe.Pointer(uintptr(v2))), v4)
			if v5 != nil {
				sub_527D50(int32(uintptr(unsafe.Pointer(v5))), (*byte)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 476)))
				return 1
			}
			v3++
			v4 += 64
...
func nox_xxx_mapGenFinishPopulate_5228B0_mapgen_populate(a1 int32) {
	...
	sub_5259D0()
	for i = sub_4D42C0(); i != 0; i = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(i)), 64))) {
		nox_xxx_mapGenSetFlags_5235F0(-99)
		if *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(i)), 372)) != 0 && (int32(*(*uint8)(unsafe.Add(unsafe.Pointer(uintptr(i)), 52)))&2) == 0 {
			nox_xxx_mapgen_522340(a1, i)
		}
		if *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a1)), 60)) != 0 {
			for j = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(i)), 368))); j != 0; j = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(j)), 24))) {
				...
				sub_5245A0(a1, (*float32)(unsafe.Add(unsafe.Pointer(uintptr(j)), 4)), int32(int64((float64(*(*float32)(unsafe.Add(unsafe.Pointer(uintptr(j)), 12))-*(*float32)(unsafe.Add(unsafe.Pointer(uintptr(j)), 4)))+0.5)*0.030743772)), int32(int64((float64(*(*float32)(unsafe.Add(unsafe.Pointer(uintptr(j)), 16))-*(*float32)(unsafe.Add(unsafe.Pointer(uintptr(j)), 8)))+0.5)*0.030743772)))
			}
		}
	}
