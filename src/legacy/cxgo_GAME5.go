...
func nox_xxx_mobActionRandomWalk_545020(obj *server.Object) {
	...
	v5 = int32(v2) * 8
	a1.ForceVec.X = float32(v4 * float64(*memmap.PtrFloat32(0x587000, uintptr(uint32(v5)+194136))))
	a1.ForceVec.Y = float32(v4 * float64(*memmap.PtrFloat32(0x587000, uintptr(uint32(v5)+194140))))
...
func sub_545090(a1 unsafe.Pointer) int32 {
	...
	v4.X = float32(float64(*memmap.PtrFloat32(0x587000, uintptr(uint32(v1*8)+194136)))*30.0 + float64(*(*float32)(unsafe.Add(a1, 56))))
	v4.Y = float32(float64(*memmap.PtrFloat32(0x587000, uintptr(uint32(v1*8)+194140)))*30.0 + float64(*(*float32)(unsafe.Add(a1, 60))))
...
func nox_xxx_mobActionConfuse_545140(obj *server.Object) {
	...
	if v1 != nil {
		*((*float32)(unsafe.Add(unsafe.Pointer(v1), unsafe.Sizeof(float32(0))*1))) = float32(float64(*memmap.PtrFloat32(0x587000, uintptr(uint32(int32(a1.Direction1)*8)+194136)))*10.0 + float64(a1.PosVec.X))
		v2 = float64(*memmap.PtrFloat32(0x587000, uintptr(uint32(int32(a1.Direction1)*8)+194140)))*10.0 + float64(a1.PosVec.Y)
...
func sub_545240(a1 unsafe.Pointer, a2 *float32) {
	...
	v6 = float64(v9.Y / v11)
	v9.Y = float32(v6)
	if v6*float64(*memmap.PtrFloat32(0x587000, uintptr(uint32(v5*8)+194136)))-float64(v9.X**memmap.PtrFloat32(0x587000, uintptr(uint32(v5*8)+194140))) >= 0.0 {
...
func sub_545340(obj *server.Object) {
	...
	v1 = memmap.PtrFloat32(0x587000, uintptr(uint32(int32(a1.Direction1)*8)+194136))
	...
	if float64(*memmap.PtrFloat32(0x587000, uintptr(uint32(v2*8)+194140))**v1-*(*float32)(unsafe.Add(unsafe.Pointer(v1), unsafe.Sizeof(float32(0))*1))*v3.X) >= 0.0 {
		a1.Direction2 += 8
	} else {
		a1.Direction2 -= 8
	}
...
func nox_xxx_mobActionRoam_5457E0(obj *server.Object) {
	...
	if sub_547EE0((*server.Waypoint)(*(*unsafe.Pointer)(unsafe.Add(v8, 4))), v22) == 0 {
	...
	if *(*uint32)(unsafe.Add(v8, 4)) == 0 {
		...
		*(*uint32)(unsafe.Add(v8, 4)) = uint32(v9)
		if v9 == 0 && *(*byte)(unsafe.Add(v8, 12)) == 128 {
			*(*unsafe.Pointer)(unsafe.Add(v8, 4)) = unsafe.Pointer(sub_50CB20((*server.Object)(unsafe.Pointer(v1)), (*float32)(unsafe.Add(unsafe.Pointer(v1), unsafe.Sizeof(float32(0))*14))))
		}
		if *(*uint32)(unsafe.Add(v8, 4)) == 0 {
	...
	if *(*uint32)(unsafe.Add(v2, 8)) == 0 {
		nox_xxx_creatureSetDetailedPath_50D220((*server.Object)(unsafe.Pointer(v1)), int32(*(*uint32)(unsafe.Add(v8, 4))+8))
	}
...
func sub_545B60(a1 unsafe.Pointer, a2 uint8) int32 {
	...
	for {
		...
		if v4 != nil {
			if sub_547EE0((*server.Waypoint)(v4), a2) != 0 {
				break
			}
		}
		if func() int32 {
...
func sub_545C60(a1 unsafe.Pointer, a2 int32, a3 uint8) int32 {
	...
	for {
		v6 = *v5
		if sub_547EE0((*server.Waypoint)(*(*unsafe.Pointer)(unsafe.Pointer(v5))), a3) != 0 {
			v7 = 0
...
LABEL_27:
	...
	for {
		...
		if v12 != nil {
			...
			if v13 != v14 && sub_547EE0((*server.Waypoint)(v12), a3) != 0 {
				break
			}
		}
		if func() int32 {
...
func sub_5466F0(a1p *server.Object) int32 {
	...
	if sub_534020(a1) != 0 || nox_xxx_tileNFromPoint_411160((*types.Pointf)(unsafe.Add(v1, 396))) != 6 {
		v2 = (*float32)(unsafe.Add(v1, 396))
		if sub_50B810(a1, (*float32)(unsafe.Add(v1, 396))) != 0 {
			v3 = a1.PosVec.X
			v4 = *v2
...
func nox_xxx_unitIsDangerous_547120(a1p *server.Object, a2p *server.Object) int16 {
	...
	if v2&0x2000 != 0 {
		v3 = sub_534020((*server.Object)(a2))
		if v3 == 0 {
		...
		if v3 != nil {
			if (gameFrame() & 0xF) == 0 {
				...
				if v3 != nil {
					...
					if v3b&0x90 != 0 {
						nox_xxx_useByNetCode_53F8E0((*server.Object)(a1), (*server.Object)(v36))
					}
				}
			}
		}
...
func sub_547F20(a1 *server.Object, a2 *types.Pointf) int32 {
	v2 := a1.UpdateDataMonster()
	v3 := sub_50CB20(a1, &a1.PosVec)
	v4 := sub_50CB20(a1, a2)
	if v3 != nil && v4 != nil && v3 != v4 {
		return nox_xxx_BuildWaypointPath_547F70(v3, v4, &v2.Field75, 16)
	} else {
		return 0
	}
}
func nox_xxx_BuildWaypointPath_547F70(a1, a2 *server.Waypoint, a3 *uint32, a4 int32) int32 {
	var (
		v5  int32
		v6  int32
		v7  *uint32
	...
	v4 := a1
	if sub_547EE0(a1, 0x80) != 0 && sub_547EE0(a2, 0x80) != 0 {
		dword_5d4594_2490504++
		a1.Field15 = 0
		a1.Field16 = 0
		a1.Field14 = dword_5d4594_2490504
		for {
			v14 = nil
			if v4 == nil {
				break
...
func sub_5488B0(a1 *int32, a2 *float32, a3 int32) {
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(&a1a.field_0), 4*0)) = uint32(*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*16)))
	...
	v7 = a2
	v25 = memmap.PtrInt32(0x587000, uintptr(uint32(v6*8)+192088))
...
func nox_xxx_strikeOgre_549220(obj *server.Object) int32 {
	...
	*memmap.PtrUint32(0x5D4594, 2491556) = 0
	v5 = float32(v2 + float64(*memmap.PtrFloat32(0x587000, 287328)))
...
func sub_549270(it *server.Object, data unsafe.Pointer) {
	...
	if a2 != a1 {
		...
		if v13-(a1.Shape.Circle+*(*float32)(unsafe.Add(v2, 176))) <= *(*float32)(unsafe.Add(v7, 112)) {
			v8 = memmap.PtrFloat32(0x587000, uint32(int32(*(*int16)(unsafe.Add(v2, 124)))*8)+194136)
...
func nox_xxx_monsterPickMeleeTarget_549440(a3 int32, a2 int32) unsafe.Pointer {
	...
	v3 = float64(*(*float32)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(v2, 484)), 112)) + *(*float32)(unsafe.Add(a3, 176)) + *memmap.PtrFloat32(0x587000, 287328))
	...
	if (*float32)(a2) != a1 && ((int32(uint8(*(*float32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(float32(0))*4))))&0x11) == 0 || int32(uint8(*(*float32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(float32(0))*2))))&6 != 0) {
		if int32(uint8(*(*float32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(float32(0))*2))))&6 != 0 || (func() int32 {
			...
			if nox_xxx_unitIsEnemyTo_5330C0((*server.Object)(a2), (*server.Object)(unsafe.Pointer(a1))) != 0 || *memmap.PtrUint32(0x5D4594, 2491568) != 0 {
				...
				v5 = memmap.PtrFloat32(0x587000, uint32(int32(*(*int16)(unsafe.Add(a2, 124)))*8)+194136)
				...
				if float64(v7/v8**(*float32)(unsafe.Add(unsafe.Pointer(v5), unsafe.Sizeof(float32(0))*1)))+v4/float64(v8)*float64(*v5) > 0.5 {
					...
					if v6 < float64(*memmap.PtrFloat32(0x5D4594, 2491572)) {
						*memmap.PtrFloat32(0x5D4594, 2491572) = float32(v6)
...
LABEL_10:
	...
	case 0:
		...
		if float64(v19) == 0.0 && float64(v20) == 0.0 {
			...
			v19 = *memmap.PtrFloat32(0x587000, uintptr(uint32(v8*8)+289928))
			v20 = *memmap.PtrFloat32(0x587000, uintptr(uint32(v8*8)+289932))
		}
				...
				if (a1.ObjClass&0x200) != 512 || (func() int32 {
					...
					if *((*uint32)(unsafe.Add(unsafe.Pointer(v2), 4*43))) == 2 {
						...
						if float64(*(*float32)(unsafe.Add(unsafe.Pointer(a2), unsafe.Sizeof(float32(0))*1))) > float64(v17) {
							...
							if v12 > float64(*memmap.PtrFloat32(0x5D4594, 2491600)) {
								*memmap.PtrFloat32(0x5D4594, 2491600) = float32(v12)
...
func sub_54BA60(a1 int32, a2 int32, a3 int32, a4 int32) int32 {
	...
	if *memmap.PtrInt32(0x5D4594, 2491608) > 0 {
		v6 = memmap.PtrInt32(0x5D4594, 2491612)
...
func nox_xxx_updateMonsterGenerator_54E930(obj *server.Object) {
	...
	stage := nox_game_getQuestStage_4E3CC0()
	ud := a1.UpdateDataMonsterGen()
	if dword_5d4594_2491716 == 0 {
		dword_5d4594_2491716 = int32(uint32(nox_xxx_gamedataGetFloat_419D40(internCStr("QuestHardcoreStage"))))
		*memmap.PtrInt32(0x5D4594, 2491720) = int32(nox_xxx_gamedataGetFloat_419D40(internCStr("QuestHardcoreSpawnRateIncrease")))
		*memmap.PtrFloat32(0x5D4594, 2491744) = float32(nox_xxx_gamedataGetFloat_419D40(internCStr("QuestHardcoreSpawnCap")))
		*memmap.PtrInt32(0x5D4594, 2491724) = int32(nox_xxx_gamedataGetFloat_419D40(internCStr("SpawnRateHighValue")))
		*memmap.PtrInt32(0x5D4594, 2491728) = int32(nox_xxx_gamedataGetFloat_419D40(internCStr("SpawnRateNormalValue")))
		*memmap.PtrInt32(0x5D4594, 2491732) = int32(nox_xxx_gamedataGetFloat_419D40(internCStr("SpawnRateLowValue")))
		*memmap.PtrInt32(0x5D4594, 2491736) = int32(nox_xxx_gamedataGetFloat_419D40(internCStr("SpawnRateVeryLowValue")))
		*memmap.PtrInt32(0x5D4594, 2491740) = int32(nox_xxx_gamedataGetFloat_419D40(internCStr("SpawnRateVeryVeryLowValue")))
	}
	if (a1.Field5 & 0x800) == 0 {
		if a1.ObjFlags&0x1000000 != 0 {
			if (a1.ObjFlags & 0x8020) == 0 {
				nox_xxx_unitNeedSync_4E44F0(a1)
				v5 := gameFrame() - ud.Frame88
				var v4c uint32
				switch *(*uint8)(unsafe.Add(unsafe.Pointer(ud), 80+stage)) {
				case 0:
					v4c = *memmap.PtrUint32(0x5D4594, 2491724)
				case 1:
					v4c = *memmap.PtrUint32(0x5D4594, 2491728)
				case 2:
					v4c = *memmap.PtrUint32(0x5D4594, 2491732)
				case 3:
					v4c = *memmap.PtrUint32(0x5D4594, 2491736)
				case 4:
					v4c = *memmap.PtrUint32(0x5D4594, 2491740)
				default:
					v4c = uint32(uintptr(unsafe.Pointer(a1)))
				}
				if stage >= dword_5d4594_2491716 {
					v6 := *memmap.PtrUint32(0x5D4594, 2491720) * uint32(stage-dword_5d4594_2491716+1)
					if v6 > v4c {
						v7 = 0
					} else {
						v7 = int32(v4c - v6)
					...
					*(*uint32)(unsafe.Add(unsafe.Pointer(&v22), 4*0)) = uint32(v7)
					if float64(v22)/v8 < float64(*memmap.PtrFloat32(0x5D4594, 2491744)) {
						v21 = float32(v8 * float64(*memmap.PtrFloat32(0x5D4594, 2491744)))
						v7 = int32(v21)
					}
					v4c = uint32(v7)
				}
				if v5 > v4c {
					if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(ud), 86))) < int32(*(*uint8)(unsafe.Add(unsafe.Pointer(ud), 87))) {
						if int32(uint8(gameFrame()))&8 != 0 {
							v9 = 0
							v10 = (*uint32)(unsafe.Add(unsafe.Pointer(ud), stage*16))
							for v11 := 0; v11 < 4; v11++ {
								if *v10 != 0 {
									v9++
								}
							...
							v12 := *(**server.Object)(unsafe.Add(unsafe.Pointer(ud), (nox_common_randomInt_415FA0(0, v9-1)+stage*4)*4))
							if nox_xxx_mobGeneratorPick_54EBA0(a1, &a2, v12) == 1 {
								nox_xxx_mobGeneratorSpawn_54F070(a1, unsafe.Pointer(&a2), v12)
								ud.Frame88 = gameFrame()
							}
						}
					}
				}
...
func nox_xxx_mobGeneratorPick_54EBA0(a1 *server.Object, a2 *types.Pointf, a4 *server.Object) int32 {
	var (
		v7  float32
		v8  float32
		v9  float32
	...
	v13 := 0
	v16 := a1.UpdateDataMonsterGen()
	v3 := nox_xxx_getFirstPlayerUnit_4DA7C0()
	if v3 == nil {
		return 0
	}
	for {
		v4 := v3.UpdateDataPlayer()
		if (uint32(v3.ObjFlags) & 0x8020) == 0 {
			v5 := v4.Player
			if (int32(*(*uint8)(unsafe.Add(unsafe.Pointer(v5), 3680))) & 1) == 0 {
				v6 := v16.Field92
				if v6&1 != 0 {
					if nox_xxx_calcDistance_4E6C00(a1, v3) <= 300.0 {
						return nox_xxx_mgenSetCreaturePos_54ED50(a1, a2, nil, a4)
					}
				} else {
					if (v6 & 2) == 0 {
						return 0
					}
					v14 = float32(math.Sqrt(float64(int32(v5.Field12)*int32(v5.Field12) + int32(v5.Field10)*int32(v5.Field10))))
					if nox_xxx_calcDistance_4E6C00(a1, v3) <= float64(v14) {
						v7 = a1.PosVec.X
						v8 = v3.PosVec.X
						a1a.field_4 = a1.PosVec.Y
						a1a.field_0 = v7
						v9 = v3.PosVec.Y
						a1a.field_8 = v8
						a1a.field_C = v9
						if nox_xxx_mapTraceRay_535250(&a1a, nil, nil, 69) != 0 {
							v18[v13] = int32(v4.Player.PlayerInd)
							v13++
						}
					}
				}
	...
	v10 := nox_common_randomInt_415FA0(0, int32(v13-1))
	v11 := nox_common_playerInfoFromNum_417090(v18[v10])
	return nox_xxx_mgenSetCreaturePos_54ED50(a1, a2, v11.PlayerUnit, a4)
}
func nox_xxx_mgenSetCreaturePos_54ED50(a1 *server.Object, a2 *types.Pointf, a3 *server.Object, a4 *server.Object) int32 {
	var (
		v4  int32
		v5  int8
		v6  float32
	...
	if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1.UpdateDataMonsterGen()), 92)))&2 != 0 && a3 != nil {
		a1a.X = a3.PosVec.X - a1.PosVec.X
		a1a.Y = a3.PosVec.Y - a1.PosVec.Y
		...
		a1a.X = float32(float64(a1a.X)*45.0 + float64(a1.PosVec.X))
		a1a.Y = float32(float64(a1a.Y)*45.0 + float64(a1.PosVec.Y))
		if sub_54EF00(&a1a.X) == 0 {
			v10.field_8 = a1a.X
			v10.field_0 = a1.PosVec.X
			v4 = int32(a4.ObjFlags)
			v10.field_C = a1a.Y
			v5 = 1
			v10.field_4 = a1.PosVec.Y
			if v4&0x4000 != 0 {
				v5 = 5
			}
			if nox_xxx_mapTraceRay_535250(&v10, nil, nil, v5) != 0 && nox_xxx_mapTileAllowTeleport_411A90(&a1a) == 0 {
				...
				a2.X = a1a.X
				a2.Y = v6
				a1a.X = a3.PosVec.X - a1a.X
				a1a.Y = a3.PosVec.Y - a1a.Y
				v7 = int16(nox_xxx_math_509ED0(&a1a))
				a4.Direction1 = server.Dir16(uint16(v7))
				a4.Direction2 = server.Dir16(uint16(v7))
				return 1
			}
		}
	}
	if sub_54EF90(45.0, a1+56, a2, a4) == 1 {
		if a3 == nil {
			return 1
		}
		v10.field_0 = a3.PosVec.X - a1.PosVec.X
		v10.field_4 = a3.PosVec.Y - a1.PosVec.Y
...
func sub_54EF90(a1 float32, a2 *types.Pointf, a3 *types.Pointf, a4 *server.Object) int32 {
	v4 := a2
	var v12 float4
	v12.field_0 = a2.X
	v12.field_4 = a2.Y
	...
	v6 := int8(1)
	if a4.ObjFlags&0x4000 != 0 {
		v6 = 5
	}
	for i := 0; i < 32; i++ {
		v9 := float64(v13) + 1.8849558
		v13 = int32(float32(v9))
		v12.field_8 = float32(math.Cos(v9)*float64(a1) + float64(v4.X))
		v12.field_C = float32(math.Sin(float64(v13))*float64(a1) + float64(v4.Y))
...
func nox_xxx_mobGeneratorSpawn_54F070(a1 *server.Object, a2 unsafe.Pointer, a3 *server.Object) {
	var (
		v11 int32
		v12 float32
		v13 int32
	...
	if sub_50DE80(a1, (*float32)(a2)) == 0 {
		return
	}
	v5 := nox_xxx_newObjectWithTypeInd_4E3450(int32(a3.TypeInd))
	if v5 == nil {
		return
	}
	v6 := v5.UpdateDataMonster()
	v23 := v6
	nox_xxx_unitCreatureCopyUC_54F2B0(a3, v5)
	v7 := v6.MonsterDef
	if v7 != nil {
		v15 = float32(sub_4E40F0() * float64(v7.HealthQuest72))
		v5.HealthData.Cur = uint16(int16(int32(v15)))
		v16 = float32(sub_4E40F0() * float64(v7.HealthQuest72))
	} else {
		v8 := nox_xxx_objectTypeByIndHealthData(int32(v5.TypeInd))
		v17 = float32(sub_4E40F0() * float64(v8.Cur))
		v5.HealthData.Cur = uint16(int16(int32(v17)))
		v16 = float32(sub_4E40F0() * float64(v8.Max))
	}
	v5.HealthData.Max = uint16(int16(int32(v16)))
	v10 := v5.HealthData
	if v10.Cur == 0 {
		v10.Cur = 1
	}
	...
	if uint32(v5.TypeInd) == *memmap.PtrUint32(0x5D4594, 2491712) {
		v23.Field376 = 0
	}
	if sub_50E030(v3, v5) != 0 {
		nox_xxx_createAt_4DAA50(v5, nil, *(*float32)(a2), *(*float32)(unsafe.Add(a2, 4)))
		nox_xxx_scriptCallByEventBlock_502490(unsafe.Add(unsafe.Pointer(v20), 64), unsafe.Pointer(v5), unsafe.Pointer(v3), 2)
		v11 = int32(v3.PosVec.X)
		v12 = v3.PosVec.Y
		v22.field_0 = v11
		v13 = int32(v12)
		v14 = float64(*(*float32)(a2) - v3.PosVec.X)
		v22.field_4 = v13 - 50
		a1a.X = float32(v14)
		a1a.Y = *(*float32)(unsafe.Add(a2, 4)) - v3.PosVec.Y
		nox_xxx_utilNormalizeVector_509F20(&a1a)
		...
		nox_xxx_aud_501960(1002, v5, 0, 0)
	} else {
		nox_xxx_objectFreeMem_4E38A0(v5)
	}
}
func nox_xxx_unitCreatureCopyUC_54F2B0(a1, a2 *server.Object) {
	v2 := a1
	*a2.UpdateDataMonster() = *a1.UpdateDataMonster()
	if int32(*(*uint8)(unsafe.Add(unsafe.Pointer(a1), 12)))&0x10 != 0 {
		v3 := nox_xxx_inventoryGetFirst_4E7980(a1)
		if v3 != nil {
			for {
				v4 := nox_xxx_newObjectWithTypeInd_4E3450(int32(v3.TypeInd))
				v5 := v4
				if v4 != nil {
					if v4.ObjClass&0x13001000 != 0 {
						nox_xxx_modifSetItemAttrs_4E4990(v4, (*int32)(v3.InitData))
					}
					nox_xxx_inventoryPutImpl_4F3070(a2, v5, 0)
					if v3.ObjFlags&0x100 != 0 {
						if v5.ObjClass&0x1001000 != 0 {
							nox_xxx_NPCEquipWeapon_53A2C0(a2, v5)
						} else if v5.ObjClass&0x2000000 != 0 {
							nox_xxx_NPCEquipArmor_53E520(unsafe.Pointer(a2), v5)
						}
					}
				}
...
func nox_xxx_createArrowTrapProjectile_54FA80(a1 int32, a2 int32) {
	...
	v10 = float32(v2*float64(*memmap.PtrFloat32(0x587000, uintptr(uint32(v3)+194136))) + float64(*(*float32)(unsafe.Add(a1, 56))))
	v11 = float32(v2*float64(*memmap.PtrFloat32(0x587000, uintptr(uint32(v3)+194140))) + float64(*(*float32)(unsafe.Add(a1, 60))))
	...
	if v4 != 0 {
		...
		*(*float32)(unsafe.Add(v5, 80)) = *memmap.PtrFloat32(0x587000, uint32(int32(*(*int16)(unsafe.Add(a1, 124)))*8)+194136) * *(*float32)(unsafe.Add(v5, 544))
		*(*float32)(unsafe.Add(v5, 84)) = *memmap.PtrFloat32(0x587000, uint32(int32(*(*int16)(unsafe.Add(a1, 124)))*8)+194140) * *(*float32)(unsafe.Add(v5, 544))
...
func nox_xxx_collisionCheckCircleCircle_550D00(a1 unsafe.Pointer, a2 unsafe.Pointer) {
	...
	if float64(v18.X) == 0.0 && float64(v18.Y) == 0.0 {
		...
		v18.X = *memmap.PtrFloat32(0x587000, uintptr(uint32(v4*8)+292784))
		v18.Y = *memmap.PtrFloat32(0x587000, uintptr(uint32(v4*8)+292788))
	}
...
func sub_551250(a1 unsafe.Pointer, a2 *float32, a3 int32) {
	...
	a1a.field_8 = float32(float64(*memmap.PtrFloat32(0x587000, uintptr(uint32(v9*8)+194136)))*32.0 + v6)
	a1a.field_C = float32(float64(*memmap.PtrFloat32(0x587000, uintptr(uint32(v9*8)+194140)))*32.0 + float64(v29.Y))
