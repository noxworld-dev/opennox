...
func nox_thing_falling_sparks_draw_4B7740(a1 int32, a2 int32, dr *client.Drawable) *uint32 {
	...
	v3 = (*int2)(unsafe.Add(unsafe.Pointer(uintptr(a3)), 12))
	v4 = 2
	for {
		a2a.field_0 = v3.field_0 + nox_common_randomIntMinMax_415FF0(-15, 15, internCStr("C:\\NoxPost\\src\\client\\Draw\\LvUpDraw.c"), 35)
		v5 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a3)), 16)) + uint32(nox_common_randomIntMinMax_415FF0(-15, 15, internCStr("C:\\NoxPost\\src\\client\\Draw\\LvUpDraw.c"), 36)))
		a2a.field_4 = v5
		v6 = int32(uint32(v5) - *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(a2)), 20)))
