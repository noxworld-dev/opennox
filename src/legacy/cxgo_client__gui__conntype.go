...
func sub_49C820() int32 {
	...
	sub_49C910()
	nox_window_setPos_46A9B0(dword_5d4594_1305684, nox_win_width/2-*(*int32)(unsafe.Add(dword_5d4594_1305684, 8))/2, nox_win_height/2-*(*int32)(unsafe.Add(dword_5d4594_1305684, 12))/2)
