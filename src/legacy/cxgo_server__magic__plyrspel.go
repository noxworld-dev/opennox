...
func nox_xxx_spellGrantToPlayer_4FB550(a1p *server.Object, a2 int32, a3 int32, a4 int32, a5 int32) int32 {
	...
	if noxflags.HasGame(4096) && (a2 == 34 || a2 == 134 || a2 == 45 || a2 == 46 || a2 == 47 || a2 == 48 || a2 == 49 || a2 == 117 || a2 == 118 || a2 == 119 || a2 == 120 || a2 == 121 || a2 == 122 || a2 == 123 || a2 == 124 || a2 == 125 || a2 == 19) && *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(v7, 276))+uint32(a2*4))), 3696)) != 0 {
		v8 = nox_strman_loadString_40F1D0(internCStr("MaxSpellLevel"), nil, internCStr("C:\\NoxPost\\src\\Server\\Magic\\plyrspel.c"), 386)
		nox_xxx_netSendLineMessage_4D9EB0((*server.Object)(a1), v8)
		return 0
	}
	*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(v7, 276))+uint32(a2*4))), 3696))++
	v9 = (*uint32)(unsafe.Add(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(v7, 276))+uint32(a2*4))), 3696))
	if *v9 > 5 {
		*v9 = 5
	}
	if noxflags.HasGame(4096) {
		v10 = int32(*(*uint32)(unsafe.Add(v7, 276)))
		if *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v10+a2*4)), 3696)) > 3 {
			*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v10+a2*4)), 3696)) = 3
		}
	}
	if a5 != 0 {
		*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(v7, 276))+uint32(a2*4))), 3696)) = uint32(a5)
	}
	nox_xxx_playerAwardSpellProtectionCRC_56FCE0(int32(*(*uint32)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(v7, 276)), 4636))), a2, int32(*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(v7, 276))+uint32(a2*4))), 3696))))
	var v20 int32 = 0
	...
	if v20 != 0 {
		...
		for v12 < 4244 {
			if nox_xxx_spellHasFlags_424A50(v11, v20) && nox_xxx_spellIsValid_424B50(v11) {
				if a5 != 0 {
					*(*uint32)(unsafe.Pointer(uintptr(uint32(v12) + *(*uint32)(unsafe.Add(v7, 276))))) = uint32(a5)
				} else {
					*(*uint32)(unsafe.Pointer(uintptr(uint32(v12) + *(*uint32)(unsafe.Add(v7, 276)))))++
				}
				v13 = (*uint32)(unsafe.Pointer(uintptr(uint32(v12) + *(*uint32)(unsafe.Add(v7, 276)))))
				if *v13 > 5 {
					*v13 = 5
				}
				if noxflags.HasGame(4096) {
					v14 = int32(*(*uint32)(unsafe.Add(v7, 276)))
					if *(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v14+v6*4)), 3696)) > 3 {
						*(*uint32)(unsafe.Add(unsafe.Pointer(uintptr(v14+v6*4)), 3696)) = 3
					}
				}
				nox_xxx_playerAwardSpellProtectionCRC_56FCE0(int32(*(*uint32)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(v7, 276)), 4636))), v6, int32(*(*uint32)(unsafe.Pointer(uintptr(uint32(v12) + *(*uint32)(unsafe.Add(v7, 276)))))))
			}
			v12 += 4
			v11++
		}
	...
	if a3 != 0 {
		v15 = 1
		nox_xxx_aud_501960(226, (*server.Object)(v5), 0, 0)
		if noxflags.HasGame(2048) && (v6 == 34 || nox_xxx_spellHasFlags_424A50(v6, 86016)) {
			v15 = 0
		}
		if !noxflags.HasGame(4096) || *(*uint32)(unsafe.Add(*(*unsafe.Pointer)(unsafe.Add(v7, 276)), 4792)) != 0 {
			if v15 != 0 {
