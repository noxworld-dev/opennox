...
func sub57DEA0(this *Common, a2 *uint16) int32 {
	var (
		v2 *uint16
		v3 int32
		i  int32
	...
	for i = 0; i < 274; i++ {
		...
		*((*uint16)(unsafe.Add(unsafe.Pointer(v2), -int(unsafe.Sizeof(uint16(0))*1)))) = *(*uint16)(unsafe.Add(this.field0, uint32(i*2)))
		v5 = (*int16)(unsafe.Add(this.field0, uint32(i*2)))
		v6 = *v5
		v3 += int32(v6)
		*v5 = int16(int32(v6) >> 1)
	}
...
func nxz_decompress(dec *Decoder, dst []byte, dstSz *int32, src []byte, srcSz *int32) int32 {
	var (
		dstPtr = &dst[0]
		srcPtr = &src[0]
		v8     int32
	...
	v5 := srcPtr
	srcEndPtr := (*byte)(unsafe.Add(unsafe.Pointer(srcPtr), *srcSz))
	v74 := dstPtr
	v73 := srcPtr
	v69 := srcEndPtr
	v72 = (*uint8)(unsafe.Add(unsafe.Pointer(dstPtr), *dstSz))
	dec.field148 = 0
	if uintptr(unsafe.Pointer(srcPtr)) >= uintptr(unsafe.Pointer(srcEndPtr)) {
		return 0
	}
	for {
		v8 = int32(dec.field148)
		if v8 < 4 {
			if uintptr(unsafe.Pointer(v5)) >= uintptr(unsafe.Pointer(srcEndPtr)) {
				v9 = -1
				dec.field148 = 0
				v63 = -1
				goto LABEL_9
		...
		v9 = int32(v11 >> 28)
	LABEL_9:
		v12 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(dec), 4*uintptr(v9*2+3))))
		if v12 == 0 {
			v13 = int32(*(*int16)(unsafe.Add(unsafe.Pointer(dec.field8.field132), *(*uint32)(unsafe.Add(unsafe.Pointer(dec), 4*uintptr(v9*2+4)))*2)))
			goto LABEL_18
		}
		...
		if v14 >= v12 {
			...
			v9 = v63
		} else if uintptr(unsafe.Pointer(v5)) < uintptr(unsafe.Pointer(srcEndPtr)) {
		...
		v17 = int32(uint32(v15) + *(*uint32)(unsafe.Add(unsafe.Pointer(dec), 4*uintptr(v9*2+4))))
		if v17 >= 274 {
			return 0
		}
		v13 = int32(*(*int16)(unsafe.Add(unsafe.Pointer(dec.field8.field132), uint32(v17*2))))
	LABEL_18:
		*(*uint16)(unsafe.Add(dec.field8.field0.field0, uint32(v13*2)))++
		if v13 < 256 {
			...
			*func() *uint8 {
			...
			dec.buf0[v18] = byte(int8(v13))
			goto LABEL_73
			return 0
		}
		if v13 == 272 {
			sub57DEA0(&dec.field8.field0, (*uint16)(unsafe.Pointer(&v75[0])))
			v19 = 0
			v20 = &v75[0]
			for {
				v21 = int16(*(*uint16)(unsafe.Pointer(v20)))
				v20 = (*byte)(unsafe.Add(unsafe.Pointer(v20), 4))
				*(*uint16)(unsafe.Add(unsafe.Pointer(dec.field8.field132), uint32(v19))) = uint16(v21)
				v19 += 2
				if v19 >= 548 {
					break
				}
			...
			v22 = 0
			v23 = (*uint32)(unsafe.Add(unsafe.Pointer(dec), 4*4))
			v70 = 0
			v66 = 16
			for {
				for i = 0; ; i++ {
					...
					if uintptr(unsafe.Pointer(v5)) >= uintptr(unsafe.Pointer(v69)) {
						break
					}
		...
		} else if uintptr(unsafe.Pointer(v5)) < uintptr(unsafe.Pointer(v69)) {
	...
	LABEL_55:
		...
		if v42 >= v37 {
			...
			dec.field144 |= uint32(int32(*v5) << (24 - v42))
			srcPtr = (*uint8)(unsafe.Add(unsafe.Pointer(v5), 1))
		...
		if v47 >= v46 {
			...
			if uint32(int32(uint16(int16(v48)))+v46) <= 0x10000 {
				v53 = uint32(v46)
				v52 = unsafe.Add(unsafe.Pointer(dec.buf0), uintptr(uint32(v50)))
			} else {
				v51 = int32(0x10000 - uint32(uint16(int16(v48))))
				memcpy(unsafe.Pointer(dstPtr), unsafe.Add(unsafe.Pointer(dec.buf0), uintptr(uint16(int16(v48)))), int(0x10000-uint32(uint16(int16(v48)))))
			...
			if uint32(v49+v47) <= 0x10000 {
				memcpy(unsafe.Pointer(dstPtr), unsafe.Add(unsafe.Pointer(dec.buf0), uintptr(uint32(v49))), int(v47))
			} else {
				memcpy(unsafe.Pointer(dstPtr), unsafe.Add(unsafe.Pointer(dec.buf0), uintptr(uint32(v49))), int(0x10000-uint32(v49)))
		...
		if uint32(v57+v47) <= 0x10000 {
			v61 = dstPtr
			v60 = uint32(v47)
			v59 = unsafe.Add(unsafe.Pointer(dec.buf0), uint32(v57))
		} else {
			v58 = int32(0x10000 - uint32(v57))
			memcpy(unsafe.Add(unsafe.Pointer(dec.buf0), uintptr(uint32(v57))), unsafe.Pointer(dstPtr), int(0x10000-uint32(v57)))
	...
	if srcSz != nil {
		*srcSz += int32(uintptr(unsafe.Pointer(v73)) - uintptr(unsafe.Pointer(v5)))
	}
	return 1
}
