...
void __cdecl sub_4EF2E0_exp_level(int a1) {
	...
	if ((nox_xxx_gameGet_4DB1B0() != 1 || !sub_4DB1C0()) &&
		nox_xxx_loadFloatVar_419D70(getMemAt(0x587000, 206192), *(char*)(v1 + 3684) + 1) <= *(float*)(a1 + 28)) {
		++*(_BYTE*)(v1 + 3684);
		...
		if (nox_common_gameFlags_check_40A5C0(2048)) {
			...
			v2 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 206244), 0, "C:\\NoxPost\\src\\Server\\GameMech\\explevel.c",
									   253);
...
void __cdecl nox_xxx_plyrGiveExp_4EF3A0_exp_level(int a1, float a2) {
	...
	*(float*)(a1 + 28) = a2 + *(float*)(a1 + 28);
	...
	sub_4D81A0(a1);
	v3 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 206296), 0, "C:\\NoxPost\\src\\Server\\GameMech\\explevel.c", 381);
