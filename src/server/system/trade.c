...
float* __cdecl sub_5100C0_trade(int a1, _DWORD* a2, int a3)
{
    ...
    if (result)
    {
        ...
        if (*(_DWORD*)result)
        {
            ...
            if (nox_common_gameFlags_check_40A5C0(4096) && (sub_5105D0(v6) || *(unsigned __int16*)(v6 + 4) == *(_DWORD*)& byte_5D4594[2386548]))
...
float* __cdecl sub_510640_trade(int a1, int a2, int a3, float* a4)
{
    ...
    if (a4)
    {
        while (1)
        {
            ...
            if (nox_common_gameFlags_check_40A5C0(4096) && (sub_5105D0(v7) || *(unsigned __int16*)(v7 + 4) == *(_DWORD*)& byte_5D4594[2386552]))
