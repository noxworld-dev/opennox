...
int nox_xxx_mapExitAndCheckNext_4D1860_server() {
	...
	*getMemU32Ptr(0x5D4594, 1548528) = 0;
	...
	if (!v22) {
		v24 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 196580), 0, "C:\\NoxPost\\src\\Server\\System\\server.c", 792);
	...
	if (nox_common_gameFlags_check_40A5C0(96) && v19 < 2) {
		v24 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 196644), 0, "C:\\NoxPost\\src\\Server\\System\\server.c", 799);
		nox_xxx_printToAll_4D9FD0(0, v24);
		return 0;
	}
	if (nox_common_gameFlags_check_40A5C0(64) && v21 < 1) {
		v24 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 196700), 0, "C:\\NoxPost\\src\\Server\\System\\server.c", 806);
		nox_xxx_printToAll_4D9FD0(0, v24);
		return 0;
	}
...
int nox_xxx_gameTick_4D2580_server() {
	...
	if (nox_common_gameFlags_check_40A5C0(8)) {
		...
		nox_xxx_unitsNewAddToList_4DAC00();
		if (nox_xxx_checkKeybTimeout_4160F0(0x10u, 10 * *(_DWORD *) getMemAt(0x5D4594, 2649704))) {
		...
		if (nox_common_gameFlags_check_40A5C0(0x2000) && sub_43AF70() == 1 && !nox_common_gameFlags_check_40A5C0(128) &&
			nox_xxx_checkKeybTimeout_4160F0(0xFu, 60 * *(_DWORD *) getMemAt(0x5D4594, 2649704))) {
			nox_xxx_net_4263C0();
		...
		if (!v13) {
			...
			v14 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 196928), 0,
										"C:\\NoxPost\\src\\Server\\System\\server.c", 1702);
			nox_xxx_printToAll_4D9FD0(0, v14, v37);
			v36 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 196984), 0,
			...
			if (*((_DWORD*)v20 + 514) && sub_4DCC10(*((_DWORD*)v20 + 514)) == 1) {
				...
				if (!v24) {
					...
					if (!v23 && nox_common_gameFlags_check_40A5C0(2)) {
						v35 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 197104), 0,
													"C:\\NoxPost\\src\\Server\\System\\server.c", 1931);
						v27 = nox_xxx_loadString_40F1D0((char*)getMemAt(0x587000, 197172), 0,
