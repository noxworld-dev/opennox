...
void sub_4DBA30(int a1) {
	...
	result = nox_common_playerInfoGetXXX_417090(31);
	v2 = result;
	v3 = 0;
	v24 = result;
	if (result) {
...
int sub_4D2580_server() {
	...
	if (nox_common_gameFlags_check_40A5C0(8)) {
		if (!*getMemU64Ptr(0x5D4594, 1548676)) {
			*getMemU64Ptr(0x5D4594, 1548676) = sub_416BB0() + 10000;
			sub_4597E0(0);
			if (sub_43AF70() == 1) {
				if (!nox_common_gameFlags_check_40A5C0(128)) {
					sub_4263C0();
		...
		sub_4DEB30();
		sub_4DEB50();
		if ((unsigned __int64)sub_416BB0() > *getMemU64Ptr(0x5D4594, 1548676) && !v2) {
	...
	if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_22 | NOX_ENGINE_FLAG_23))
		sub_4E76C0();
	if (sub_4DB1B0()) {
		v20 = nox_common_playerInfoGetXXX_417090(31);
		v21 = v20;
		if (v20) {
	...
	sub_4FC600();
	sub_4FC680();
	v33 = nox_common_playerInfoGetXXX_417090(31);
	if (v33) {
		v34 = *((_DWORD*)v33 + 514);
		if (v34)
			sub_5003B0(v34);
