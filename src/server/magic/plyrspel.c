...
//----- (004FB2A0) --------------------------------------------------------
int __cdecl sub_4FB2A0_magic_plyrspel(int a1)
{
    _DWORD* v1; // edi
    int v2; // ebp
    int v3; // esi
...
//----- (004FB550) --------------------------------------------------------
int __cdecl sub_4FB550_magic_plyrspel(int a1, int a2, int a3, int a4, int a5)
{
    int v5; // ebp
    int v6; // esi
    int v7; // ebx
    ...
    v7 = *(_DWORD*)(a1 + 748);
    if (nox_common_mapflags_check(6144) && *(_DWORD*)(*(_DWORD*)(v7 + 276) + 4 * a2 + 3696) == 3
    ...
    if (a3)
    {
        ...
        if (nox_common_mapflags_check(2048) && (v6 == 34 || sub_424A50(v6, 86016)))
            v15 = 0;
        if (!nox_common_mapflags_check(4096) || *(_DWORD*)(*(_DWORD*)(v7 + 276) + 4792))
        {
            if (v15)
            {
    ...
    if (nox_common_mapflags_check(2048) && a3 == 1 && a4 == 1)
    {
        v18 = *(_DWORD * *)(v7 + 280);
        if (v18)
            sub_50F4C0(v18);
