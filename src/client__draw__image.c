...
void sub_4C6A00() {
	...
	if (*getMemU32Ptr(0x5D4594, 3799456)) {
		...
		v8 = *getMemU32Ptr(0x5D4594, 3799456);
		do {
...
void sub_4C6C60() {
	...
	if (*getMemU32Ptr(0x5D4594, 3799456)) {
		...
		v2 = *(unsigned char**)&dword_5d4594_3799540;
		v11 = v9;
		v10 = *getMemU32Ptr(0x5D4594, 3799456);
		while (1) {
...
void sub_4C6DE0() {
	...
	v1 = nox_video_cur_pixdata_3799444;
	v2 = *(unsigned char**)&dword_5d4594_3799540;
	v3 = 32 * (*(unsigned char*)&obj_5D4594_3800716.data[76 + 12 * (*getMemU32Ptr(0x5D4594, 3799428) >> 4)]) + dword_5d4594_810636;
	v4 = 0;
	do {
		LOBYTE(v4) = *v1++;
...
void sub_4C6E40() {
	...
	v9 = *(unsigned char*)(48 * (*getMemU32Ptr(0x5D4594, 3799428) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[76]));
	if (*getMemU32Ptr(0x5D4594, 3799456)) {
		v1 = 32 * v9;
		v8 = *(unsigned char*)(&ptr_5D4594_3799572->data[259]);
		v2 = *(unsigned char**)&dword_5d4594_3799540;
...
void sub_4C6FD0() {
	...
	result = (unsigned char*)(*getMemU32Ptr(0x5D4594, 3799456) - 1);
	v2 = *(unsigned char*)(48 * (*getMemU32Ptr(0x5D4594, 3799428) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[76]));
	if (*getMemU32Ptr(0x5D4594, 3799456)) {
		v1 = *getMemU32Ptr(0x5D4594, 3799456);
...
void sub_4C7060() {
	...
	result = *getMemU32Ptr(0x5D4594, 3799428) >> 4;
	LOBYTE(result) = *(unsigned char*)(48 * (*getMemU32Ptr(0x5D4594, 3799428) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[76]));
	if (*getMemU32Ptr(0x5D4594, 3799456)) {
		result = 32 * *(unsigned char*)(48 * (*getMemU32Ptr(0x5D4594, 3799428) >> 4) +
...
unsigned int sub_4C7110() {
	...
	result = *getMemU32Ptr(0x5D4594, 3799456) - 1;
	if (*getMemU32Ptr(0x5D4594, 3799456)) {
		HIWORD(result) = *getMemU16Ptr(0x5D4594, 3799458);
		v1 = *(unsigned char**)&dword_5d4594_3799540;
		v5 = *getMemU32Ptr(0x5D4594, 3799456);
		do {
						...
						if (v13 < v4) {
							...
							if (v30 > v4) {
								if (v30 <= v44)
									...
									v31 = v44 - v4;
								*getMemU32Ptr(0x5D4594, 3799456) = v31;
								nox_video_cur_pixdata_3799444 = &result[v4 - v13];
								dword_5d4594_3799540 = v4 - v13 + v21;
								goto LABEL_52;
							}
						...
						if (v13 < v4) {
							...
							if (v32 > v4) {
								if (v32 <= v44)
									...
									v33 = v44 - v4;
								*getMemU32Ptr(0x5D4594, 3799456) = v33;
								dword_5d4594_3799540 = v4 - v13 + v21;
...
int  sub_4C6260(int a1, int a2, int a3) {
	...
	if (result) {
		...
		*getMemU32Ptr(0x5D4594, 3799520) = v8;
		*getMemU32Ptr(0x5D4594, 3799512) = v10;
		*getMemU32Ptr(0x5D4594, 3799516) = v4;
		*getMemU32Ptr(0x5D4594, 3799504) = v5;
		if (!ptr_5D4594_3799572->data[0])
			goto LABEL_30;
			...
			if (v12) {
				...
				do {
					...
					if (dword_5d4594_3799552 && (dword_5d4594_3799508 ^= 1u) != 0) {
						...
						while (2) {
							*getMemU32Ptr(0x5D4594, 3799428) = nox_video_cur_pixdata_3799444[0];
							++nox_video_cur_pixdata_3799444;
							v17 = nox_video_cur_pixdata_3799444[0];
							result = (getMemByte(0x5D4594, 3799428) & 0xF) - 1;
							*getMemU32Ptr(0x5D4594, 3799456) = nox_video_cur_pixdata_3799444[0];
							++nox_video_cur_pixdata_3799444;
							switch (getMemByte(0x5D4594, 3799428) & 0xF) {
							case 1:
							...
							case 6:
								func_type6_3799488();
							LABEL_26:
								v15 -= *getMemU32Ptr(0x5D4594, 3799456);
								if (v15 <= 0)
									break;
								continue;
							default:
...
void sub_4C69A0() {
	...
	v0 = nox_video_cur_pixdata_3799444;
	v1 = *(unsigned char**)&dword_5d4594_3799540;
	v2 = getMemByte(0x5D4594, 3799456);
	v3 = *getMemU32Ptr(0x5D4594, 3799456) >> 2;
	if (*getMemU32Ptr(0x5D4594, 3799456) >> 2) {
		do {
			v4 = *(unsigned int*)v0;
			v0 += 4;
			*(unsigned int*)v1 = v4;
...
void sub_4C9B20() {
	...
	v9 = *getMemU32Ptr(0x5D4594, 3799456);
	do {
		...
		*v1 = result;
		++v1;
	} while ((*getMemU32Ptr(0x5D4594, 3799456))-- > 1);
	*getMemU32Ptr(0x5D4594, 3799456) = v9;
	nox_video_cur_pixdata_3799444 = v0;
	dword_5d4594_3799540 = v1;
}
...
void sub_4C8EC0() {
	...
	memcpy(v7, (const void*)(48 * (*getMemU32Ptr(0x5D4594, 3799428) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[66])),
			sizeof(v7));
	result = *getMemU32Ptr(0x5D4594, 3799456) - 1;
	if (*getMemU32Ptr(0x5D4594, 3799456)) {
		v1 = *(unsigned short**)&dword_5d4594_3799540;
		v2 = v3;
		v4 = *getMemU32Ptr(0x5D4594, 3799456);
		do {
...
void sub_4C9050() {
	...
	result = *getMemU32Ptr(0x5D4594, 3799456) - 1;
	memcpy(v5, (const void*)(48 * (*getMemU32Ptr(0x5D4594, 3799428) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[66])),
			sizeof(v5));
	if (*getMemU32Ptr(0x5D4594, 3799456)) {
		v1 = *(unsigned short**)&dword_5d4594_3799540;
		v4 = *getMemU32Ptr(0x5D4594, 3799456);
...
void sub_4C92F0() {
	...
	memcpy(v12, (const void*)(48 * (*getMemU32Ptr(0x5D4594, 3799428) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[66])),
			sizeof(v12));
	result = *getMemU32Ptr(0x5D4594, 3799456) - 1;
	if (*getMemU32Ptr(0x5D4594, 3799456)) {
		v1 = *(unsigned short**)&dword_5d4594_3799540;
...
void sub_4C94D0() {
	...
	memcpy(v9, (const void*)(48 * (*getMemU32Ptr(0x5D4594, 3799428) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[66])),
			sizeof(v9));
	result = *getMemU32Ptr(0x5D4594, 3799456) - 1;
	if (*getMemU32Ptr(0x5D4594, 3799456)) {
...
void sub_4C97F0() {
	...
	if (*getMemU32Ptr(0x5D4594, 3799456)) {
		...
		v7 = *getMemU32Ptr(0x5D4594, 3799456);
		while (1) {
			HIWORD(v3) = *getMemU16Ptr(0x5D4594, 3799446);
...
void sub_4C8D60() {
	...
	*getMemU32Ptr(0x5D4594, 3799456) = v6;
	nox_video_cur_pixdata_3799444 = v0;
	dword_5d4594_3799540 = v1;
}
...
//----- (004C80E0) --------------------------------------------------------
void sub_4C80E0() {
	memcpy(*(unsigned short**)&dword_5d4594_3799540, nox_video_cur_pixdata_3799444, *getMemU32Ptr(0x5D4594, 3799456) << 1);
	nox_video_cur_pixdata_3799444 += *getMemU32Ptr(0x5D4594, 3799456) << 1;
	dword_5d4594_3799540 += *getMemU32Ptr(0x5D4594, 3799456) << 1;
}
...
void nox_client_drawImg_aaa_4C79F0(nox_video_bag_image_t* img, int x, int y) {
	...
	*getMemU32Ptr(0x5D4594, 3799520) = x;
	*getMemU32Ptr(0x5D4594, 3799512) = y;
	*getMemU32Ptr(0x5D4594, 3799516) = width;
	*getMemU32Ptr(0x5D4594, 3799504) = height;
	if (ptr_5D4594_3799572->data[0]) {
		RECT rc;
		int4 a1a;
	...
	for (int i = 0; i < height; i++) {
		...
		if (dword_5d4594_3799552 && (dword_5d4594_3799508 ^= 1u) != 0) {
			...
			for (int j = width; j > 0; j -= *getMemU32Ptr(0x5D4594, 3799456)) {
				int a = nox_video_cur_pixdata_3799444[0];
				nox_video_cur_pixdata_3799444++;
				*getMemU32Ptr(0x5D4594, 3799428) = a;

				int b = nox_video_cur_pixdata_3799444[0];
				nox_video_cur_pixdata_3799444++;
				*getMemU32Ptr(0x5D4594, 3799456) = b;
...
void sub_4C8130() {
	...
	if (*getMemU32Ptr(0x5D4594, 3799456)) {
		v1 = *(unsigned char*)(&ptr_5D4594_3799572->data[259]);
		v2 = *(unsigned short**)&dword_5d4594_3799540;
		v3 = *getMemU32Ptr(0x5D4594, 3799456);
		do {
...
void sub_4C8A30() {
	...
	v8 = *(unsigned char*)(&ptr_5D4594_3799572->data[24]);
	v1 = *(unsigned short**)&dword_5d4594_3799540;
	for (v5 = *getMemU32Ptr(0x5D4594, 3799456); v5 > 0; --v5) {
...
void sub_4C86B0() {
	...
	*getMemU32Ptr(0x5D4594, 3799456) = v5;
	nox_video_cur_pixdata_3799444 = v0;
	dword_5d4594_3799540 = v1;
}
...
void  nox_client_xxxDraw16_4C7440(nox_video_bag_image_t* img, int x, int y) {
    ...
    if (img->typ & 0xff != 8)
    {
        dprintf("%x %x %x", img, x, y);
        dprintf("\t%d", img->typ & 0xff);
    }
#endif
	if (!img) {
		return;
