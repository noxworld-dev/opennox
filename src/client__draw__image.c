...
extern unsigned int dword_5d4594_3804656;
extern unsigned int dword_5d4594_3804664;
extern unsigned int dword_5d4594_3804668;
extern unsigned int dword_5d4594_3804672;
...
unsigned int dword_5d4594_3799540 = 0;
...
void  sub_4C60D0(nox_video_bag_image_t* img, int x, int y) {
	...
	*getMemU32Ptr(0x8529A0, 1185236) = v8 + x;
	nox_video_cur_pixdata_3799444 = (char*)result + 1;
	*getMemU32Ptr(0x8529A0, 1185228) = v10;
	*getMemU32Ptr(0x8529A0, 1185232) = width;
	*getMemU32Ptr(0x8529A0, 1185220) = v6;
	int v7 = width;
	...
	*getMemU32Ptr(0x8529A0, 1185172) = v7;
	if (result) {
		v15 = 4 * v10;
		v16 = v14 + 1;
		do {
			v15 += 4;
			dword_5d4594_3799540 = v9 + *(unsigned int*)(v15 + (unsigned int)nox_pixbuffer_rows_3798784 - 4);
			func_type27_3799536();
			--v16;
...
unsigned char sub_4C73A0() {
	...
	v7 = *getMemU32Ptr(0x8529A0, 1185172);
	do {
		v2 = getMemAt(0x8529A0, 1189024 + 4 * *v1);
		v3 = *v0;
		...
		//                  char)(getMemByte(0x8529A0, 1189026 + 4 * *v1) + 8 * (v3 & 0x1F))) >> 3) | (4 * (((unsigned
...
void sub_4C6A00() {
	...
	result = *getMemU32Ptr(0x8529A0, 1185172) - 1;
	if (*getMemU32Ptr(0x8529A0, 1185172)) {
		v1 = *(unsigned char*)(&ptr_5D4594_3799572->data[259]);
		v2 = *(unsigned char**)&dword_5d4594_3799540;
		v8 = *getMemU32Ptr(0x8529A0, 1185172);
		do {
			v7 = nox_video_cur_pixdata_3799444[0];
			++nox_video_cur_pixdata_3799444;
			v3 = 4 * v7;
			v4 = getMemByte(0x8529A0, 1189024 + v3);
			v10 = getMemByte(0x8529A0, 1189026 + v3);
			v9 = getMemByte(0x8529A0, 1189025 + v3);
			v5 = 4 * (unsigned char)*v2;
			*v2 = *(unsigned char*)((((unsigned char)(getMemByte(0x8529A0, 1189026 + v5) +
												((unsigned short)(v1 * (v10 - getMemByte(0x8529A0, 1189026 + v5))) >> 8)) >>
							  3) |
							 (4 * ((getMemByte(0x8529A0, 1189025 + v5) +
									((unsigned short)(v1 * (v9 - getMemByte(0x8529A0, 1189025 + v5))) >> 8)) &
									   0xF8 |
								   (32 * ((getMemByte(0x8529A0, 1189024 + v5) +
										   ((unsigned short)(v1 * (v4 - getMemByte(0x8529A0, 1189024 + v5))) >> 8)) &
										  0xF8))))) +
							dword_5d4594_810640);
...
void sub_4C6B50() {
	...
	v0 = *getMemU32Ptr(0x8529A0, 1185172);
...
void sub_4C6C60() {
	...
	if (*getMemU32Ptr(0x8529A0, 1185172)) {
		...
		v2 = *(unsigned char**)&dword_5d4594_3799540;
		v11 = v9;
		v10 = *getMemU32Ptr(0x8529A0, 1185172);
		while (1) {
			v3 = *(unsigned char*)(v1 + 32 * nox_video_cur_pixdata_3799444[0] + dword_5d4594_810636);
			++nox_video_cur_pixdata_3799444;
			v4 = 4 * v3;
			v5 = getMemByte(0x8529A0, 1189024 + v4);
			v13 = getMemByte(0x8529A0, 1189026 + v4);
			v12 = getMemByte(0x8529A0, 1189025 + v4);
			v6 = 4 * (unsigned char)*v2;
			*v2 = *(unsigned char*)((((unsigned char)(getMemByte(0x8529A0, 1189026 + v6) +
												((unsigned short)(v8 * (v13 - getMemByte(0x8529A0, 1189026 + v6))) >> 8)) >>
							  3) |
							 (4 * ((getMemByte(0x8529A0, 1189025 + v6) +
									((unsigned short)(v8 * (v12 - getMemByte(0x8529A0, 1189025 + v6))) >> 8)) &
									   0xF8 |
								   (32 * ((getMemByte(0x8529A0, 1189024 + v6) +
										   ((unsigned short)(v8 * (v5 - getMemByte(0x8529A0, 1189024 + v6))) >> 8)) &
										  0xF8))))) +
							dword_5d4594_810640);
			v2 = (unsigned char*)(dword_5d4594_3799540 + 1);
			result = v10 - 1;
...
void sub_4C6DE0() {
	...
	v1 = nox_video_cur_pixdata_3799444;
	v2 = *(unsigned char**)&dword_5d4594_3799540;
	v3 = 32 * (*(unsigned char*)&obj_5D4594_3800716.data[76 + 12 * (*getMemU32Ptr(0x8529A0, 1185144) >> 4)]) + dword_5d4594_810636;
	v4 = 0;
	do {
		LOBYTE(v4) = *v1++;
...
void sub_4C6E40() {
	...
	v9 = *(unsigned char*)(48 * (*getMemU32Ptr(0x8529A0, 1185144) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[76]));
	if (*getMemU32Ptr(0x8529A0, 1185172)) {
		v1 = 32 * v9;
		v8 = *(unsigned char*)(&ptr_5D4594_3799572->data[259]);
		v2 = *(unsigned char**)&dword_5d4594_3799540;
...
void sub_4C6FD0() {
	...
	result = (unsigned char*)(*getMemU32Ptr(0x8529A0, 1185172) - 1);
	v2 = *(unsigned char*)(48 * (*getMemU32Ptr(0x8529A0, 1185144) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[76]));
	if (*getMemU32Ptr(0x8529A0, 1185172)) {
		v1 = *getMemU32Ptr(0x8529A0, 1185172);
		result = *(unsigned char**)&dword_5d4594_3799540;
		do {
			*result = *(unsigned char*)(((unsigned char)*result << 8) +
								*(unsigned char*)(32 * v2 + nox_video_cur_pixdata_3799444[0] +
													dword_5d4594_810636) +
								dword_5d4594_810632);
			result = (unsigned char*)(dword_5d4594_3799540 + 1);
			--v1;
			++nox_video_cur_pixdata_3799444;
			++dword_5d4594_3799540;
		} while (v1);
...
void sub_4C7060() {
	...
	result = *getMemU32Ptr(0x8529A0, 1185144) >> 4;
	LOBYTE(result) = *(unsigned char*)(48 * (*getMemU32Ptr(0x8529A0, 1185144) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[76]));
	if (*getMemU32Ptr(0x8529A0, 1185172)) {
		result = 32 * *(unsigned char*)(48 * (*getMemU32Ptr(0x8529A0, 1185144) >> 4) +
										  (unsigned int)(&ptr_5D4594_3799572->data[76]));
		v1 = (unsigned char)(obj_5D4594_3800716.data[258] >> 3);
		v2 = *getMemU32Ptr(0x8529A0, 1185172);
		do {
			v3 = *(unsigned char*)(result + nox_video_cur_pixdata_3799444[0] + dword_5d4594_810636);
			++nox_video_cur_pixdata_3799444;
			**(unsigned char**)&dword_5d4594_3799540 = *(unsigned char*)(v1 + 32 * v3 + dword_5d4594_810636);
			--v2;
			++dword_5d4594_3799540;
		} while (v2);
	}
...
unsigned int sub_4C7110() {
	...
	result = *getMemU32Ptr(0x8529A0, 1185172) - 1;
	if (*getMemU32Ptr(0x8529A0, 1185172)) {
		HIWORD(result) = *getMemU16Ptr(0x8529A0, 1185174);
		v1 = *(unsigned char**)&dword_5d4594_3799540;
		v5 = *getMemU32Ptr(0x8529A0, 1185172);
		do {
			...
			v3 = getMemByte(0x8529A0, 1189025 + v2);
			v7 = getMemByte(0x8529A0, 1189024 + v2);
			v4 = getMemByte(0x8529A0, 1189026 + v2);
			nox_video_cur_pixdata_3799444 += 2;
			*v1 = *(
				unsigned char*)((((unsigned char)(v4 + ((unsigned short)(v6 * ((result & 0xF0) - v4)) >> 8)) >> 3) |
						 (unsigned short)(4 * ((v3 + ((unsigned short)(v6 * (((result >> 4) & 0xF0) - v3)) >> 8)) &
													 0xF8 |
												 (32 * ((v7 + ((unsigned short)(v6 * ((BYTE1(result) & 0xF0) - v7)) >>
															   8)) &
														0xF8))))) +
						dword_5d4594_810640);
			v1 = (unsigned char*)(dword_5d4594_3799540 + 1);
			result = v5 - 1;
			++dword_5d4594_3799540;
			v5 = result;
		} while (result);
...
unsigned int sub_4C7240() {
	...
	if (*getMemU32Ptr(0x8529A0, 1185172)) {
		...
		while (1) {
			...
			v5 = 4 * v4;
			*v2 = *(
				unsigned char*)((((unsigned char)(getMemByte(0x8529A0, 1189026 + v5) +
											((unsigned short)(BYTE1(v3) *
																((result & 0xF0) - getMemByte(0x8529A0, 1189026 + v5))) >>
											 8)) >>
						  3) |
						 (unsigned short)(4 * ((getMemByte(0x8529A0, 1189025 + v5) +
												  ((unsigned short)(BYTE1(v3) * (((result >> 4) & 0xF0) -
																				   getMemByte(0x8529A0, 1189025 + v5))) >>
												   8)) &
													 0xF8 |
												 (32 * ((getMemByte(0x8529A0, 1189024 + v5) +
														 ((unsigned short)(BYTE1(v3) * ((BYTE1(result) & 0xF0) -
																						  getMemByte(0x8529A0, 1189024 + v5))) >>
														  8)) &
														0xF8))))) +
						dword_5d4594_810640);
			v2 = (unsigned char*)(dword_5d4594_3799540 + 1);
	...
	if (result) {
		...
		do {
			...
			if (!dword_5d4594_3799552 || (dword_5d4594_3799508 ^= 1u) == 0) {
				...
				dword_5d4594_3799540 = a1 + (unsigned int)nox_pixbuffer_rows_3798784[v11/4];
				if (a3 <= 0)
					goto LABEL_85;
				while (1) {
					v38 = v21;
					v22 = *result;
					v23 = result + 1;
					*getMemU32Ptr(0x8529A0, 1185144) = v22;
					nox_video_cur_pixdata_3799444 = v23;
					v24 = *v23;
					result = v23 + 1;
					*getMemU32Ptr(0x8529A0, 1185172) = v24;
					nox_video_cur_pixdata_3799444 = result;
					v37 = result;
					v43 = v24;
					switch (getMemByte(0x8529A0, 1185144) & 0xF) {
					case 1:
						v21 += v24;
					...
					case 2:
						...
						if (v13 < v4) {
							...
							if (v25 > v4) {
								if (v25 <= v44)
									...
									v26 = v44 - v4;
								*getMemU32Ptr(0x8529A0, 1185172) = v26;
						...
						if (v13 < v5 && v25 > v5) {
							*getMemU32Ptr(0x8529A0, 1185172) = v5 - v13;
						LABEL_28:
							func_type27_3799536();
						}
						v27 = v43;
						...
						if (v13 < v4) {
							...
							if (v30 > v4) {
								if (v30 <= v44)
									...
									v31 = v44 - v4;
								*getMemU32Ptr(0x8529A0, 1185172) = v31;
								nox_video_cur_pixdata_3799444 = &result[v4 - v13];
								dword_5d4594_3799540 = v4 - v13 + v21;
								goto LABEL_52;
							}
						...
						if (v13 < v4) {
							...
							if (v32 > v4) {
								if (v32 <= v44)
									...
									v33 = v44 - v4;
								*getMemU32Ptr(0x8529A0, 1185172) = v33;
								dword_5d4594_3799540 = v4 - v13 + v21;
						...
						if (v13 < v4) {
							...
							if (v34 > v4) {
								if (v34 <= v44)
									...
									v35 = v44 - v4;
								*getMemU32Ptr(0x8529A0, 1185172) = v35;
								dword_5d4594_3799540 = v4 - v13 + v21;
								nox_video_cur_pixdata_3799444 = &result[2 * (v4 - v13)];
								goto LABEL_78;
							}
						...
						if (v13 < v4) {
							...
							if (v28 > v4) {
								if (v28 <= v44)
									...
									v29 = v44 - v4;
								*getMemU32Ptr(0x8529A0, 1185172) = v29;
								dword_5d4594_3799540 = v4 - v13 + v21;
								nox_video_cur_pixdata_3799444 = &result[2 * (v4 - v13)];
								func_type27_3799536();
								goto LABEL_79;
...
int  sub_4C6260(int a1, int a2, int a3) {
	...
	if (result) {
		...
		*getMemU32Ptr(0x8529A0, 1185236) = v8;
		*getMemU32Ptr(0x8529A0, 1185228) = v10;
		*getMemU32Ptr(0x8529A0, 1185232) = v4;
		*getMemU32Ptr(0x8529A0, 1185220) = v5;
		if (!ptr_5D4594_3799572->data[0])
			goto LABEL_30;
		...
		LABEL_30:
			...
			if (v12) {
				...
				do {
					...
					dword_5d4594_3799540 = (unsigned int)nox_pixbuffer_rows_3798784[v14/4] + v8;
					if (dword_5d4594_3799552 && (dword_5d4594_3799508 ^= 1u) != 0) {
						if (v20) {
							memcpy(v16, (const void*)(v8 + *(unsigned int*)(v14 + (unsigned int)nox_pixbuffer_rows_3798784 - 4)), v4);
							v13 = v22;
						}
						sub_4C6900(v4, 1);
					} else if (v4 > 0) {
						while (2) {
							*getMemU32Ptr(0x8529A0, 1185144) = nox_video_cur_pixdata_3799444[0];
							++nox_video_cur_pixdata_3799444;
							v17 = nox_video_cur_pixdata_3799444[0];
							result = (getMemByte(0x8529A0, 1185144) & 0xF) - 1;
							*getMemU32Ptr(0x8529A0, 1185172) = nox_video_cur_pixdata_3799444[0];
							++nox_video_cur_pixdata_3799444;
							switch (getMemByte(0x8529A0, 1185144) & 0xF) {
							case 1:
							...
							case 6:
								func_type6_3799488();
							LABEL_26:
								v15 -= *getMemU32Ptr(0x8529A0, 1185172);
								if (v15 <= 0)
									break;
								continue;
							default:
...
void sub_4C69A0() {
	...
	v0 = nox_video_cur_pixdata_3799444;
	v1 = *(unsigned char**)&dword_5d4594_3799540;
	v2 = getMemByte(0x8529A0, 1185172);
	v3 = *getMemU32Ptr(0x8529A0, 1185172) >> 2;
	if (*getMemU32Ptr(0x8529A0, 1185172) >> 2) {
		do {
			v4 = *(unsigned int*)v0;
			v0 += 4;
			*(unsigned int*)v1 = v4;
...
void sub_4C9B20() {
	...
	v9 = *getMemU32Ptr(0x8529A0, 1185172);
	do {
		...
		v4 = (*((unsigned int*)((unsigned char*)byte_5D4594_3804364 + 4)) & v2) >> *((unsigned char*)byte_5D4594_3804364 + 16);
		v5 = (*((unsigned int*)((unsigned char*)byte_5D4594_3804364 + 8)) & v2) << *((unsigned char*)byte_5D4594_3804364 + 20);
		v6 = *v0;
		++v0;
		...
		result = *(unsigned int*)(dword_5d4594_3804664 + 2 * v5) | *(unsigned int*)(dword_5d4594_3804656 + 2 * v4) |
				 *(unsigned int*)(dword_5d4594_3804672 + 2 * v3);
		*v1 = result;
		++v1;
	} while ((*getMemU32Ptr(0x8529A0, 1185172))-- > 1);
	*getMemU32Ptr(0x8529A0, 1185172) = v9;
	nox_video_cur_pixdata_3799444 = v0;
	dword_5d4594_3799540 = v1;
}
...
void sub_4C8EC0() {
	...
	memcpy(v7, (const void*)(48 * (*getMemU32Ptr(0x8529A0, 1185144) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[66])),
			sizeof(v7));
	result = *getMemU32Ptr(0x8529A0, 1185172) - 1;
	if (*getMemU32Ptr(0x8529A0, 1185172)) {
		v1 = *(unsigned short**)&dword_5d4594_3799540;
		v2 = v3;
		v4 = *getMemU32Ptr(0x8529A0, 1185172);
		do {
			v5 = nox_video_cur_pixdata_3799444[0];
			++nox_video_cur_pixdata_3799444;
			v6 = (unsigned short)(*((unsigned short*)((unsigned char*)byte_5D4594_3804364 + 4)) & *v1) >> *((unsigned char*)byte_5D4594_3804364 + 16);
			**(unsigned short**)&dword_5d4594_3799540 =
				*(unsigned short*)(dword_5d4594_3804672 +
						  2 * (unsigned char)(((unsigned short)(*((unsigned short*)((unsigned char*)byte_5D4594_3804364 + 0)) & *v1) >>
												...
												((unsigned short)(v2 *
																	((unsigned char)((unsigned short)(*(unsigned short*)&v7
																										  ...
																										  v5) >>
																					   8) -
																	 (unsigned char)((unsigned short)(*((unsigned short*)((unsigned char*)byte_5D4594_3804364 + 0)) &
																										  *v1) >>
																					   *((unsigned char*)byte_5D4594_3804364 + 12)))) >>
												 8))) |
				*(unsigned short*)(dword_5d4594_3804656 +
						  2 * (unsigned char)(v6 +
												((unsigned short)(v2 *
																	((unsigned char)((unsigned short)(*(unsigned short*)&v7
																											  [28] *
				...
				*(unsigned short*)(dword_5d4594_3804664 +
						  2 * (unsigned char)(((*(unsigned char*)v1 & *((unsigned char*)byte_5D4594_3804364 + 8)) << *((unsigned char*)byte_5D4594_3804364 + 20)) +
												((unsigned short)(v2 *
												 ...
												 8)));
			v1 = (unsigned short*)(dword_5d4594_3799540 + 2);
			result = v4 - 1;
...
void sub_4C9050() {
	...
	result = *getMemU32Ptr(0x8529A0, 1185172) - 1;
	memcpy(v5, (const void*)(48 * (*getMemU32Ptr(0x8529A0, 1185144) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[66])),
			sizeof(v5));
	if (*getMemU32Ptr(0x8529A0, 1185172)) {
		v1 = *(unsigned short**)&dword_5d4594_3799540;
		v4 = *getMemU32Ptr(0x8529A0, 1185172);
		do {
			...
			*v1 = *(unsigned short*)(dword_5d4594_3804672 +
							2 * (unsigned char)(((*((unsigned int*)((unsigned char*)byte_5D4594_3804364 + 0)) & v3) >> *((unsigned char*)byte_5D4594_3804364 + 12)) +
												  ((int)((((*(unsigned int*)&v5[24] * (unsigned int)v2) >> 8) & 0xFF) -
														 (unsigned char)((*((unsigned int*)((unsigned char*)byte_5D4594_3804364 + 0)) & v3) >>
																		   *((unsigned char*)byte_5D4594_3804364 + 12))) >>
												   1))) |
				  *(unsigned short*)(dword_5d4594_3804656 +
							2 * (unsigned char)(((*((unsigned int*)((unsigned char*)byte_5D4594_3804364 + 4)) & v3) >> *((unsigned char*)byte_5D4594_3804364 + 16)) +
												  ((int)((((*(unsigned int*)&v5[28] * (unsigned int)v2) >> 8) & 0xFF) -
...
void sub_4C92F0() {
	...
	v9 = *(unsigned char*)(&ptr_5D4594_3799572->data[259]);
	...
	memcpy(v12, (const void*)(48 * (*getMemU32Ptr(0x8529A0, 1185144) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[66])),
			sizeof(v12));
	result = *getMemU32Ptr(0x8529A0, 1185172) - 1;
	if (*getMemU32Ptr(0x8529A0, 1185172)) {
		v1 = *(unsigned short**)&dword_5d4594_3799540;
		v11 = v5;
		v6 = *getMemU32Ptr(0x8529A0, 1185172);
		do {
			v2 = nox_video_cur_pixdata_3799444[0];
			++nox_video_cur_pixdata_3799444;
			v3 = (unsigned short)(*((unsigned short*)((unsigned char*)byte_5D4594_3804364 + 0)) & *v1) >> *((unsigned char*)byte_5D4594_3804364 + 12);
			...
			**(unsigned short**)&dword_5d4594_3799540 =
				*(unsigned short*)(dword_5d4594_3804664 +
						  2 * (unsigned char)(((*(unsigned char*)v1 & *((unsigned char*)byte_5D4594_3804364 + 8)) << *((unsigned char*)byte_5D4594_3804364 + 20)) +
												((unsigned short)(v9 *
																	(((int)(v11 *
																			(((*(unsigned int*)&v12[32] * (unsigned int)v2) >>
																			  8) &
																			 0xFF)) >>
																	  8) -
																	 (unsigned char)((*(unsigned char*)v1 &
												 ...
												 8))) |
				*(unsigned short*)(dword_5d4594_3804656 +
						  2 * (unsigned char)(v10 + ((unsigned short)(v9 * (((int)(v7 * (((*(unsigned int*)&v12[28] *
																							   (unsigned int)v2) >>
																							  8) &
																							 0xFF)) >>
																				 8) -
													   ...
													   8))) |
				*(unsigned short*)(dword_5d4594_3804672 +
						  2 * (unsigned char)(v3 + ((unsigned short)(v9 * (((int)(v8 * (((*(unsigned int*)&v12[24] *
																							  (unsigned int)v2) >>
																							 8) &
																							0xFF)) >>
																				8) -
			...
			*v1 =
				...
				*(unsigned short*)(dword_5d4594_3804656 +
						  2 * (unsigned char)(v9 +
												((unsigned short)(v7 *
																	(((v8 *
																	   (unsigned char)((unsigned short)(*((unsigned short*)((unsigned char*)byte_5D4594_3804364 + 4)) &
																											*(unsigned short*)(&nox_video_cur_pixdata_3799444[0])) >>
																						 *((unsigned char*)byte_5D4594_3804364 + 16))) >>
																	  8) -
																	 v9)) >>
												 8))) |
...
void sub_4C94D0() {
	...
	memcpy(v9, (const void*)(48 * (*getMemU32Ptr(0x8529A0, 1185144) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[66])),
			sizeof(v9));
	result = *getMemU32Ptr(0x8529A0, 1185172) - 1;
	if (*getMemU32Ptr(0x8529A0, 1185172)) {
		...
		do {
			...
			++nox_video_cur_pixdata_3799444;
			v3 = (unsigned short)(*((unsigned short*)((unsigned char*)byte_5D4594_3804364 + 0)) & *v2) >> *((unsigned char*)byte_5D4594_3804364 + 12);
			v5 = (unsigned short)(*((unsigned short*)((unsigned char*)byte_5D4594_3804364 + 4)) & *v2) >> *((unsigned char*)byte_5D4594_3804364 + 16);
			*v2 =
				*(unsigned short*)(dword_5d4594_3804672 +
						  2 * (((v0 *
								 (unsigned char)(v3 + ((int)((((*(unsigned int*)&v9[24] * (unsigned int)v6) >> 8) & 0xFF) -
															   (unsigned char)v3) >>
														 1))) >>
								8) &
							   0xFF)) |
				...
				*(unsigned short*)(dword_5d4594_3804656 +
						  2 * (((v7 *
								 (unsigned char)(v5 + ((int)((((*(unsigned int*)&v9[28] * (unsigned int)v6) >> 8) & 0xFF) -
															   v5) >>
														 1))) >>
								8) &
							   0xFF));
			v2 = (unsigned short*)(dword_5d4594_3799540 + 2);
			result = v4 - 1;
			dword_5d4594_3799540 += 2;
			v4 = result;
		} while (result);
...
void sub_4C97F0() {
	...
	if (*getMemU32Ptr(0x8529A0, 1185172)) {
		...
		v7 = *getMemU32Ptr(0x8529A0, 1185172);
		while (1) {
			HIWORD(v3) = *getMemU16Ptr(0x8529A0, 1185162);
				...
				*(unsigned short*)(dword_5d4594_3804664 +
						  2 * (unsigned char)(((*(unsigned char*)v2 & *((unsigned char*)byte_5D4594_3804364 + 8)) << *((unsigned char*)byte_5D4594_3804364 + 20)) +
												((unsigned short)(BYTE1(v5) *
												 ...
												 8))) |
				*(unsigned short*)(dword_5d4594_3804672 +
						  2 * (unsigned char)(((*((unsigned int*)((unsigned char*)byte_5D4594_3804364 + 0)) & v4) >> *((unsigned char*)byte_5D4594_3804364 + 12)) +
												((unsigned short)(BYTE1(v5) *
																	(((*(unsigned short*)(&nox_video_cur_pixdata_3799444[0]) >> 8) & 0xF0) -
																	 (unsigned char)((*((unsigned int*)((unsigned char*)byte_5D4594_3804364 + 0)) &
																						v4) >>
																					   *((unsigned char*)byte_5D4594_3804364 + 12)))) >>
												 8))) |
				*(unsigned short*)(dword_5d4594_3804656 +
						  2 * (unsigned char)(((*((unsigned int*)((unsigned char*)byte_5D4594_3804364 + 4)) & v4) >> *((unsigned char*)byte_5D4594_3804364 + 16)) +
												((unsigned short)(BYTE1(v5) *
																	(((v3 >> 4) & 0xF0) -
																	 (unsigned char)((*((unsigned int*)((unsigned char*)byte_5D4594_3804364 + 4)) &
																						v4) >>
																					   *((unsigned char*)byte_5D4594_3804364 + 16)))) >>
												 8)));
			v2 = (unsigned short*)(dword_5d4594_3799540 + 2);
...
void sub_4C8DF0() {
	...
	if (*getMemU32Ptr(0x8529A0, 1185172)) {
		...
		do {
			v6 = nox_video_cur_pixdata_3799444[0];
			++nox_video_cur_pixdata_3799444;
			**(unsigned short**)&dword_5d4594_3799540 = *(unsigned short*)(dword_5d4594_3804672 + 2 * ((v3 * (unsigned int)v6) >> 8)) |
											   *(unsigned short*)(dword_5d4594_3804656 + 2 * ((v2 * (unsigned int)v6) >> 8)) |
...
void sub_4C8D60() {
	...
	do {
		...
		result =
			*(unsigned int*)(dword_5d4594_3804672 +
					   2 * ((unsigned int)(*(unsigned int*)(&obj_5D4594_3800716.data[24]) * v3) >> 8)) |
			*(unsigned int*)(dword_5d4594_3804656 +
	...
	*getMemU32Ptr(0x8529A0, 1185172) = v6;
	nox_video_cur_pixdata_3799444 = v0;
	dword_5d4594_3799540 = v1;
}
	...
	if (*getMemU32Ptr(0x8529A0, 1185172)) {
		...
		do {
			...
			**(unsigned short**)&dword_5d4594_3799540 =
				...
				*(unsigned short*)(dword_5d4594_3804672 +
						  2 * (((int)(v2 * (((*(unsigned int*)&v9[24] * (unsigned int)v8) >> 8) & 0xFF)) >> 8) & 0xFF));
			result = v5 - 1;
			v3 = v5 == 1;
			dword_5d4594_3799540 += 2;
			--v5;
	...
	if (*getMemU32Ptr(0x8529A0, 1185172)) {
		...
		do {
			...
			*v2 = *(unsigned short*)(dword_5d4594_3804664 +
				  ...
				  *(unsigned short*)(dword_5d4594_3804656 +
							2 * (unsigned char)(v4 +
												  ((unsigned short)(v3 * (((int)(v1 * ((result >> 4) & 0xF0)) >> 8) -
																			v4)) >>
												   8))) |
				  *(unsigned short*)(dword_5d4594_3804672 +
							2 * (unsigned char)(v7 +
												  ((unsigned short)(v3 *
																	  (((v5 * ((*(unsigned short*)(&nox_video_cur_pixdata_3799444[0]) >> 8) &
																			   0xF0)) >>
																		8) -
																	   v7)) >>
												   8)));
	...
	if (*getMemU32Ptr(0x8529A0, 1185172)) {
		...
		do {
			...
			*v1 = *(unsigned short*)(dword_5d4594_3804664 +
				  ...
				  *(unsigned short*)(dword_5d4594_3804672 +
							2 * (unsigned char)(v5 +
												  ((unsigned short)(v2 * (((*(unsigned short*)(&nox_video_cur_pixdata_3799444[0]) >> 8) &
																			 0xF0) -
																			v5)) >>
												   8))) |
				  *(unsigned short*)(dword_5d4594_3804656 +
							2 * (unsigned char)(v3 + ((unsigned short)(v2 * (((result >> 4) & 0xF0) - v3)) >> 8)));
			v1 = (unsigned short*)(dword_5d4594_3799540 + 2);
			result = v4 - 1;
			nox_video_cur_pixdata_3799444 += 2;
			dword_5d4594_3799540 += 2;
...
//----- (004C80E0) --------------------------------------------------------
void sub_4C80E0() {
	memcpy(*(unsigned short**)&dword_5d4594_3799540, nox_video_cur_pixdata_3799444, *getMemU32Ptr(0x8529A0, 1185172) << 1);
	nox_video_cur_pixdata_3799444 += *getMemU32Ptr(0x8529A0, 1185172) << 1;
	dword_5d4594_3799540 += *getMemU32Ptr(0x8529A0, 1185172) << 1;
}
...
void  sub_4C7860(int a1, int a2, int a3) {
	...
	*getMemU32Ptr(0x8529A0, 1185236) = v8 + a2;
	nox_video_cur_pixdata_3799444 = (char*)result + 1;
	*getMemU32Ptr(0x8529A0, 1185228) = v10;
	*getMemU32Ptr(0x8529A0, 1185232) = v4;
	*getMemU32Ptr(0x8529A0, 1185220) = v6;
...
void nox_client_drawXxx_4C7C80(int x, int y, int width, int4* a4) {
	...
	do {
		...
		int v42 = width;
		if (!dword_5d4594_3799552 || (dword_5d4594_3799508 ^= 1u) == 0) {
			int v21 = (unsigned int)nox_pixbuffer_rows_3798784[v11/4] + 2 * x;
			dword_5d4594_3799540 = (unsigned int)nox_pixbuffer_rows_3798784[v11/4] + 2 * x;
			if (width <= 0)
				goto LABEL_72;
			int v30;
			while (1) {
					...
					if (v13 < v4) {
						...
						if (v31 > v4) {
							...
							if (v31 <= v45)
								...
								v32 = v45 - v4;
							*getMemU32Ptr(0x8529A0, 1185172) = v32;
							int v33 = 2 * (v4 - v13);
...
void nox_client_drawImg_aaa_4C79F0(nox_video_bag_image_t* img, int x, int y) {
	...
	*getMemU32Ptr(0x8529A0, 1185236) = x;
	*getMemU32Ptr(0x8529A0, 1185228) = y;
	*getMemU32Ptr(0x8529A0, 1185232) = width;
	*getMemU32Ptr(0x8529A0, 1185220) = height;
	if (ptr_5D4594_3799572->data[0]) {
		RECT rc;
		int4 a1a;
	...
	for (int i = 0; i < height; i++) {
		...
		if (dword_5d4594_3799552 && (dword_5d4594_3799508 ^= 1u) != 0) {
			...
			for (int j = width; j > 0; j -= *getMemU32Ptr(0x8529A0, 1185172)) {
				int a = nox_video_cur_pixdata_3799444[0];
				nox_video_cur_pixdata_3799444++;
				*getMemU32Ptr(0x8529A0, 1185144) = a;

				int b = nox_video_cur_pixdata_3799444[0];
				nox_video_cur_pixdata_3799444++;
				*getMemU32Ptr(0x8529A0, 1185172) = b;

				switch (a & 0xF) {
				case 1:
					dword_5d4594_3799540 = &row[2 * b];
					break;
				case 2:
				case 7:
					func_type27_3799536();
...
void sub_4C8130() {
	...
	if (*getMemU32Ptr(0x8529A0, 1185172)) {
		v1 = *(unsigned char*)(&ptr_5D4594_3799572->data[259]);
		v2 = *(unsigned short**)&dword_5d4594_3799540;
		v3 = *getMemU32Ptr(0x8529A0, 1185172);
		do {
...
void sub_4C8A30() {
	...
	unsigned short* add1 = dword_5d4594_3804672;
	unsigned short* add2 = dword_5d4594_3804664;
	unsigned short* add3 = dword_5d4594_3804656;

	unsigned short* px = nox_video_cur_pixdata_3799444;

	v7 = *(unsigned char*)(&ptr_5D4594_3799572->data[26]);
	v6 = *(unsigned char*)(&ptr_5D4594_3799572->data[25]);
	v8 = *(unsigned char*)(&ptr_5D4594_3799572->data[24]);
	v1 = *(unsigned short**)&dword_5d4594_3799540;
	for (v5 = *getMemU32Ptr(0x8529A0, 1185172); v5 > 0; --v5) {
	...
	*(unsigned short**)&dword_5d4594_3799540 = v1;
}
...
void sub_4C86B0() {
	...
	do {
		v2 = *v0;
		++v0;
		result = *(unsigned int*)(dword_5d4594_3804672 +
							2 * ((unsigned int)(*(unsigned int*)(&obj_5D4594_3800716.data[24]) *
												((unsigned short)(*((unsigned short*)((unsigned char*)byte_5D4594_3804364 + 0)) & v2) >>
												 *((unsigned char*)byte_5D4594_3804364 + 12))) >>
								 8)) |
				 *(unsigned int*)(dword_5d4594_3804656 +
							2 * ((unsigned int)(*(unsigned int*)(&obj_5D4594_3800716.data[25]) *
	...
	*getMemU32Ptr(0x8529A0, 1185172) = v5;
	nox_video_cur_pixdata_3799444 = v0;
	dword_5d4594_3799540 = v1;
}
