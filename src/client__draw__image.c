...
//----- (004C80E0) --------------------------------------------------------
void sub_4C80E0() {
	memcpy(nox_draw_sprite_dstPtr_3799540, nox_video_cur_pixdata_3799444, *getMemU32Ptr(0x973F18, 28) << 1);
	nox_video_cur_pixdata_3799444 += *getMemU32Ptr(0x973F18, 28) << 1;
	nox_draw_sprite_dstPtr_3799540 = (unsigned int)nox_draw_sprite_dstPtr_3799540 + *getMemU32Ptr(0x973F18, 28) << 1;
}
