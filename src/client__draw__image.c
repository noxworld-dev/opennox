...
void  sub_4C60D0(nox_video_bag_image_t* img, int x, int y) {
	...
	*getMemU32Ptr(0x8531A0, 1183188) = v8 + x;
	nox_video_cur_pixdata_3799444 = (char*)result + 1;
	*getMemU32Ptr(0x8531A0, 1183180) = v10;
	*getMemU32Ptr(0x8531A0, 1183184) = width;
	*getMemU32Ptr(0x8531A0, 1183172) = v6;
	int v7 = width;
	...
	*getMemU32Ptr(0x8531A0, 1183124) = v7;
	if (result) {
		v15 = 4 * v10;
		v16 = v14 + 1;
		do {
...
unsigned char sub_4C73A0() {
	...
	v7 = *getMemU32Ptr(0x8531A0, 1183124);
	do {
		v2 = getMemAt(0x8531A0, 1186976 + 4 * *v1);
		v3 = *v0;
		...
		//                  char)(getMemByte(0x8531A0, 1186978 + 4 * *v1) + 8 * (v3 & 0x1F))) >> 3) | (4 * (((unsigned
...
void sub_4C6A00() {
	...
	result = *getMemU32Ptr(0x8531A0, 1183124) - 1;
	if (*getMemU32Ptr(0x8531A0, 1183124)) {
		v1 = *(unsigned char*)(&ptr_5D4594_3799572->data[259]);
		v2 = *(unsigned char**)&dword_5d4594_3799540;
		v8 = *getMemU32Ptr(0x8531A0, 1183124);
		do {
			v7 = nox_video_cur_pixdata_3799444[0];
			++nox_video_cur_pixdata_3799444;
			v3 = 4 * v7;
			v4 = getMemByte(0x8531A0, 1186976 + v3);
			v10 = getMemByte(0x8531A0, 1186978 + v3);
			v9 = getMemByte(0x8531A0, 1186977 + v3);
			v5 = 4 * (unsigned char)*v2;
			*v2 = *(unsigned char*)((((unsigned char)(getMemByte(0x8531A0, 1186978 + v5) +
												((unsigned short)(v1 * (v10 - getMemByte(0x8531A0, 1186978 + v5))) >> 8)) >>
							  3) |
							 (4 * ((getMemByte(0x8531A0, 1186977 + v5) +
									((unsigned short)(v1 * (v9 - getMemByte(0x8531A0, 1186977 + v5))) >> 8)) &
									   0xF8 |
								   (32 * ((getMemByte(0x8531A0, 1186976 + v5) +
										   ((unsigned short)(v1 * (v4 - getMemByte(0x8531A0, 1186976 + v5))) >> 8)) &
										  0xF8))))) +
							dword_5d4594_810640);
...
void sub_4C6B50() {
	...
	v0 = *getMemU32Ptr(0x8531A0, 1183124);
...
void sub_4C6C60() {
	...
	if (*getMemU32Ptr(0x8531A0, 1183124)) {
		...
		v2 = *(unsigned char**)&dword_5d4594_3799540;
		v11 = v9;
		v10 = *getMemU32Ptr(0x8531A0, 1183124);
		while (1) {
			v3 = *(unsigned char*)(v1 + 32 * nox_video_cur_pixdata_3799444[0] + dword_5d4594_810636);
			++nox_video_cur_pixdata_3799444;
			v4 = 4 * v3;
			v5 = getMemByte(0x8531A0, 1186976 + v4);
			v13 = getMemByte(0x8531A0, 1186978 + v4);
			v12 = getMemByte(0x8531A0, 1186977 + v4);
			v6 = 4 * (unsigned char)*v2;
			*v2 = *(unsigned char*)((((unsigned char)(getMemByte(0x8531A0, 1186978 + v6) +
												((unsigned short)(v8 * (v13 - getMemByte(0x8531A0, 1186978 + v6))) >> 8)) >>
							  3) |
							 (4 * ((getMemByte(0x8531A0, 1186977 + v6) +
									((unsigned short)(v8 * (v12 - getMemByte(0x8531A0, 1186977 + v6))) >> 8)) &
									   0xF8 |
								   (32 * ((getMemByte(0x8531A0, 1186976 + v6) +
										   ((unsigned short)(v8 * (v5 - getMemByte(0x8531A0, 1186976 + v6))) >> 8)) &
										  0xF8))))) +
							dword_5d4594_810640);
			v2 = (unsigned char*)(dword_5d4594_3799540 + 1);
			result = v10 - 1;
...
void sub_4C6DE0() {
	...
	v1 = nox_video_cur_pixdata_3799444;
	v2 = *(unsigned char**)&dword_5d4594_3799540;
	v3 = 32 * (*(unsigned char*)&obj_5D4594_3800716.data[76 + 12 * (*getMemU32Ptr(0x8531A0, 1183096) >> 4)]) + dword_5d4594_810636;
	v4 = 0;
	do {
		LOBYTE(v4) = *v1++;
...
void sub_4C6E40() {
	...
	v9 = *(unsigned char*)(48 * (*getMemU32Ptr(0x8531A0, 1183096) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[76]));
	if (*getMemU32Ptr(0x8531A0, 1183124)) {
		v1 = 32 * v9;
		v8 = *(unsigned char*)(&ptr_5D4594_3799572->data[259]);
		v2 = *(unsigned char**)&dword_5d4594_3799540;
...
void sub_4C6FD0() {
	...
	result = (unsigned char*)(*getMemU32Ptr(0x8531A0, 1183124) - 1);
	v2 = *(unsigned char*)(48 * (*getMemU32Ptr(0x8531A0, 1183096) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[76]));
	if (*getMemU32Ptr(0x8531A0, 1183124)) {
		v1 = *getMemU32Ptr(0x8531A0, 1183124);
...
void sub_4C7060() {
	...
	result = *getMemU32Ptr(0x8531A0, 1183096) >> 4;
	LOBYTE(result) = *(unsigned char*)(48 * (*getMemU32Ptr(0x8531A0, 1183096) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[76]));
	if (*getMemU32Ptr(0x8531A0, 1183124)) {
		result = 32 * *(unsigned char*)(48 * (*getMemU32Ptr(0x8531A0, 1183096) >> 4) +
										  (unsigned int)(&ptr_5D4594_3799572->data[76]));
		v1 = (unsigned char)(obj_5D4594_3800716.data[258] >> 3);
		v2 = *getMemU32Ptr(0x8531A0, 1183124);
		do {
...
unsigned int sub_4C7110() {
	...
	result = *getMemU32Ptr(0x8531A0, 1183124) - 1;
	if (*getMemU32Ptr(0x8531A0, 1183124)) {
		HIWORD(result) = *getMemU16Ptr(0x8531A0, 1183126);
		v1 = *(unsigned char**)&dword_5d4594_3799540;
		v5 = *getMemU32Ptr(0x8531A0, 1183124);
		do {
			...
			v3 = getMemByte(0x8531A0, 1186977 + v2);
			v7 = getMemByte(0x8531A0, 1186976 + v2);
			v4 = getMemByte(0x8531A0, 1186978 + v2);
...
unsigned int sub_4C7240() {
	...
	if (*getMemU32Ptr(0x8531A0, 1183124)) {
		...
		while (1) {
			...
			v5 = 4 * v4;
			*v2 = *(
				unsigned char*)((((unsigned char)(getMemByte(0x8531A0, 1186978 + v5) +
											((unsigned short)(BYTE1(v3) *
																((result & 0xF0) - getMemByte(0x8531A0, 1186978 + v5))) >>
											 8)) >>
						  3) |
						 (unsigned short)(4 * ((getMemByte(0x8531A0, 1186977 + v5) +
												  ((unsigned short)(BYTE1(v3) * (((result >> 4) & 0xF0) -
																				   getMemByte(0x8531A0, 1186977 + v5))) >>
												   8)) &
													 0xF8 |
												 (32 * ((getMemByte(0x8531A0, 1186976 + v5) +
														 ((unsigned short)(BYTE1(v3) * ((BYTE1(result) & 0xF0) -
																						  getMemByte(0x8531A0, 1186976 + v5))) >>
														  8)) &
														0xF8))))) +
						dword_5d4594_810640);
			v2 = (unsigned char*)(dword_5d4594_3799540 + 1);
		...
		do {
			...
			if (!dword_5d4594_3799552 || (dword_5d4594_3799508 ^= 1u) == 0) {
				...
				while (1) {
					...
					v22 = *result;
					v23 = result + 1;
					*getMemU32Ptr(0x8531A0, 1183096) = v22;
					nox_video_cur_pixdata_3799444 = v23;
					v24 = *v23;
					result = v23 + 1;
					*getMemU32Ptr(0x8531A0, 1183124) = v24;
					nox_video_cur_pixdata_3799444 = result;
					v37 = result;
					v43 = v24;
					switch (getMemByte(0x8531A0, 1183096) & 0xF) {
					case 1:
						v21 += v24;
					...
					case 2:
						...
						if (v13 < v4) {
							...
							if (v25 > v4) {
								if (v25 <= v44)
									...
									v26 = v44 - v4;
								*getMemU32Ptr(0x8531A0, 1183124) = v26;
						...
						if (v13 < v5 && v25 > v5) {
							*getMemU32Ptr(0x8531A0, 1183124) = v5 - v13;
						LABEL_28:
							func_type27_3799536();
						}
						v27 = v43;
						...
						if (v13 < v4) {
							...
							if (v30 > v4) {
								if (v30 <= v44)
									...
									v31 = v44 - v4;
								*getMemU32Ptr(0x8531A0, 1183124) = v31;
								nox_video_cur_pixdata_3799444 = &result[v4 - v13];
								dword_5d4594_3799540 = v4 - v13 + v21;
								goto LABEL_52;
							}
						...
						if (v13 < v4) {
							...
							if (v32 > v4) {
								if (v32 <= v44)
									...
									v33 = v44 - v4;
								*getMemU32Ptr(0x8531A0, 1183124) = v33;
								dword_5d4594_3799540 = v4 - v13 + v21;
						...
						if (v13 < v4) {
							...
							if (v34 > v4) {
								if (v34 <= v44)
									...
									v35 = v44 - v4;
								*getMemU32Ptr(0x8531A0, 1183124) = v35;
								dword_5d4594_3799540 = v4 - v13 + v21;
								nox_video_cur_pixdata_3799444 = &result[2 * (v4 - v13)];
								goto LABEL_78;
							}
						...
						if (v13 < v4) {
							...
							if (v28 > v4) {
								if (v28 <= v44)
									...
									v29 = v44 - v4;
								*getMemU32Ptr(0x8531A0, 1183124) = v29;
								dword_5d4594_3799540 = v4 - v13 + v21;
								nox_video_cur_pixdata_3799444 = &result[2 * (v4 - v13)];
								func_type27_3799536();
								goto LABEL_79;
...
int  sub_4C6260(int a1, int a2, int a3) {
	...
	if (result) {
		...
		*getMemU32Ptr(0x8531A0, 1183188) = v8;
		*getMemU32Ptr(0x8531A0, 1183180) = v10;
		*getMemU32Ptr(0x8531A0, 1183184) = v4;
		*getMemU32Ptr(0x8531A0, 1183172) = v5;
		if (!ptr_5D4594_3799572->data[0])
			goto LABEL_30;
			...
			if (v12) {
				...
				do {
					...
					if (dword_5d4594_3799552 && (dword_5d4594_3799508 ^= 1u) != 0) {
						...
						while (2) {
							*getMemU32Ptr(0x8531A0, 1183096) = nox_video_cur_pixdata_3799444[0];
							++nox_video_cur_pixdata_3799444;
							v17 = nox_video_cur_pixdata_3799444[0];
							result = (getMemByte(0x8531A0, 1183096) & 0xF) - 1;
							*getMemU32Ptr(0x8531A0, 1183124) = nox_video_cur_pixdata_3799444[0];
							++nox_video_cur_pixdata_3799444;
							switch (getMemByte(0x8531A0, 1183096) & 0xF) {
							case 1:
							...
							case 6:
								func_type6_3799488();
							LABEL_26:
								v15 -= *getMemU32Ptr(0x8531A0, 1183124);
								if (v15 <= 0)
									break;
								continue;
							default:
...
void sub_4C69A0() {
	...
	v0 = nox_video_cur_pixdata_3799444;
	v1 = *(unsigned char**)&dword_5d4594_3799540;
	v2 = getMemByte(0x8531A0, 1183124);
	v3 = *getMemU32Ptr(0x8531A0, 1183124) >> 2;
	if (*getMemU32Ptr(0x8531A0, 1183124) >> 2) {
		do {
			v4 = *(unsigned int*)v0;
			v0 += 4;
			*(unsigned int*)v1 = v4;
...
void sub_4C9B20() {
	...
	v9 = *getMemU32Ptr(0x8531A0, 1183124);
	do {
		...
		*v1 = result;
		++v1;
	} while ((*getMemU32Ptr(0x8531A0, 1183124))-- > 1);
	*getMemU32Ptr(0x8531A0, 1183124) = v9;
	nox_video_cur_pixdata_3799444 = v0;
	dword_5d4594_3799540 = v1;
}
...
void sub_4C8EC0() {
	...
	memcpy(v7, (const void*)(48 * (*getMemU32Ptr(0x8531A0, 1183096) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[66])),
			sizeof(v7));
	result = *getMemU32Ptr(0x8531A0, 1183124) - 1;
	if (*getMemU32Ptr(0x8531A0, 1183124)) {
		v1 = *(unsigned short**)&dword_5d4594_3799540;
		v2 = v3;
		v4 = *getMemU32Ptr(0x8531A0, 1183124);
		do {
...
void sub_4C9050() {
	...
	result = *getMemU32Ptr(0x8531A0, 1183124) - 1;
	memcpy(v5, (const void*)(48 * (*getMemU32Ptr(0x8531A0, 1183096) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[66])),
			sizeof(v5));
	if (*getMemU32Ptr(0x8531A0, 1183124)) {
		v1 = *(unsigned short**)&dword_5d4594_3799540;
		v4 = *getMemU32Ptr(0x8531A0, 1183124);
...
void sub_4C92F0() {
	...
	memcpy(v12, (const void*)(48 * (*getMemU32Ptr(0x8531A0, 1183096) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[66])),
			sizeof(v12));
	result = *getMemU32Ptr(0x8531A0, 1183124) - 1;
	if (*getMemU32Ptr(0x8531A0, 1183124)) {
		v1 = *(unsigned short**)&dword_5d4594_3799540;
		v11 = v5;
		v6 = *getMemU32Ptr(0x8531A0, 1183124);
		do {
			v2 = nox_video_cur_pixdata_3799444[0];
			++nox_video_cur_pixdata_3799444;
			v3 = (unsigned short)(*((unsigned short*)((unsigned char*)byte_5D4594_3804364 + 0)) & *v1) >> *((unsigned char*)byte_5D4594_3804364 + 12);
...
void sub_4C94D0() {
	...
	memcpy(v9, (const void*)(48 * (*getMemU32Ptr(0x8531A0, 1183096) >> 4) + (unsigned int)(&ptr_5D4594_3799572->data[66])),
			sizeof(v9));
	result = *getMemU32Ptr(0x8531A0, 1183124) - 1;
	if (*getMemU32Ptr(0x8531A0, 1183124)) {
...
void sub_4C97F0() {
	...
	if (*getMemU32Ptr(0x8531A0, 1183124)) {
		...
		v7 = *getMemU32Ptr(0x8531A0, 1183124);
		while (1) {
			HIWORD(v3) = *getMemU16Ptr(0x8531A0, 1183114);
...
void sub_4C8D60() {
	...
	*getMemU32Ptr(0x8531A0, 1183124) = v6;
	nox_video_cur_pixdata_3799444 = v0;
	dword_5d4594_3799540 = v1;
}
...
//----- (004C80E0) --------------------------------------------------------
void sub_4C80E0() {
	memcpy(*(unsigned short**)&dword_5d4594_3799540, nox_video_cur_pixdata_3799444, *getMemU32Ptr(0x8531A0, 1183124) << 1);
	nox_video_cur_pixdata_3799444 += *getMemU32Ptr(0x8531A0, 1183124) << 1;
	dword_5d4594_3799540 += *getMemU32Ptr(0x8531A0, 1183124) << 1;
}
...
void  sub_4C7860(int a1, int a2, int a3) {
	...
	*getMemU32Ptr(0x8531A0, 1183188) = v8 + a2;
	nox_video_cur_pixdata_3799444 = (char*)result + 1;
	*getMemU32Ptr(0x8531A0, 1183180) = v10;
	*getMemU32Ptr(0x8531A0, 1183184) = v4;
	*getMemU32Ptr(0x8531A0, 1183172) = v6;
					...
					if (v13 < v4) {
						...
						if (v31 > v4) {
							...
							if (v31 <= v45)
								...
								v32 = v45 - v4;
							*getMemU32Ptr(0x8531A0, 1183124) = v32;
							int v33 = 2 * (v4 - v13);
...
void nox_client_drawImg_aaa_4C79F0(nox_video_bag_image_t* img, int x, int y) {
	...
	*getMemU32Ptr(0x8531A0, 1183188) = x;
	*getMemU32Ptr(0x8531A0, 1183180) = y;
	*getMemU32Ptr(0x8531A0, 1183184) = width;
	*getMemU32Ptr(0x8531A0, 1183172) = height;
	if (ptr_5D4594_3799572->data[0]) {
		RECT rc;
		int4 a1a;
	...
	for (int i = 0; i < height; i++) {
		...
		if (dword_5d4594_3799552 && (dword_5d4594_3799508 ^= 1u) != 0) {
			...
			for (int j = width; j > 0; j -= *getMemU32Ptr(0x8531A0, 1183124)) {
				int a = nox_video_cur_pixdata_3799444[0];
				nox_video_cur_pixdata_3799444++;
				*getMemU32Ptr(0x8531A0, 1183096) = a;

				int b = nox_video_cur_pixdata_3799444[0];
				nox_video_cur_pixdata_3799444++;
				*getMemU32Ptr(0x8531A0, 1183124) = b;
...
void sub_4C8130() {
	...
	if (*getMemU32Ptr(0x8531A0, 1183124)) {
		v1 = *(unsigned char*)(&ptr_5D4594_3799572->data[259]);
		v2 = *(unsigned short**)&dword_5d4594_3799540;
		v3 = *getMemU32Ptr(0x8531A0, 1183124);
		do {
...
void sub_4C8A30() {
	...
	v8 = *(unsigned char*)(&ptr_5D4594_3799572->data[24]);
	v1 = *(unsigned short**)&dword_5d4594_3799540;
	for (v5 = *getMemU32Ptr(0x8531A0, 1183124); v5 > 0; --v5) {
...
void sub_4C86B0() {
	...
	*getMemU32Ptr(0x8531A0, 1183124) = v5;
	nox_video_cur_pixdata_3799444 = v0;
	dword_5d4594_3799540 = v1;
}
