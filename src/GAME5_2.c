	...
	*(_DWORD*)&v74[4] = *(_DWORD*)(a4 + 4);
	...
	while (2) {
		...
		case 7:
			...
			*(_DWORD*)(out + 1) = v32;
			if (ns1->id == -1)
				ns1->func_yyy(v6, out, 5, ns4->data_3);
			else
		...
		case 10:
			...
			if (ns6->field_38 == 1)
				return 0;
			_BYTE a2b2 = 34;
			ns1->func_yyy(v6, &a2b2, 1, ns6->data_3);
			memset(getMemAt(0x5D4594, 32 * id + 2508788), 0, 0x20u);
		...
		case 11:
			...
			_BYTE a2b = 33;
			ns1->func_yyy(v6, &a2b, 1, ns7->data_3);
			sub_554A50(id);
			return 0;
			}
		case 14:
		...
		case 31:
			...
			if (v14 != v15) {
				...
				*(_BYTE*)(out + 1) = ns8->field_28_1;
				ns1->func_yyy(v6, out, 2, ns8->data_3);
			}
			if ((unsigned int)a2p >= a2end) {
				return 0;
			}
