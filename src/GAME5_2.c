...
int  nox_xxx_netBigSwitch_553210(unsigned int id, unsigned char* packet, int packetSz, int a4) {
	...
	*(_DWORD*)&v74[4] = *(_DWORD*)(a4 + 4);
	...
	while (2) {
		...
		case 6:
			{
			if (pid > NOX_NET_STRUCT_MAX) {
				printf("nox_net_struct_arr overflow (2): %d\n", (int)(pid));
				abort();
			}
			ns3 = nox_net_struct_arr[pid];
			_BYTE a2b3 = 37;
		...
		case 7:
			...
			*(_DWORD*)(out + 1) = v32;
			if (ns1->id == -1)
				ns1->func_yyy(pid, out, 5, ns3->data_3);
			else
		...
		case 8:
			...
			ns3 = nox_net_struct_arr[pid];
			if (*(_DWORD*)packetCur != ns3->field_22)
				return 0;
		...
		case 10:
			...
			if (pid == 255)
				return 0;
			nox_net_struct_t* ns4 = nox_net_struct_arr[pid];
			if (ns4->field_38 == 1)
				return 0;
			_BYTE a2b2 = 34;
			ns1->func_yyy(pid, &a2b2, 1, ns4->data_3);
		...
		case 11:
			{
			nox_net_struct_t* ns5 = nox_net_struct_arr[pid];
			_BYTE a2b = 33;
			ns1->func_yyy(pid, &a2b, 1, ns5->data_3);
			sub_554A50(id);
			return 0;
			}
		...
		case 31:
			...
			if (v14 != v15) {
				...
				*(_BYTE*)(out + 1) = ns3->field_28_1;
				ns1->func_yyy(pid, out, 2, ns3->data_3);
			}
			if ((unsigned int)packetCur >= packetEnd) {
				return 0;
			}
	...
	while (*(_DWORD*)v5) {
		if (a3) {
			...
			LABEL_17:
				...
				*(_DWORD*)v5 = **(_DWORD**)v5;
				*(_DWORD*)v6 = 0;
				nox_alloc_class_free_obj_414330(nox_alloc_gQueue_3844300, v6);
				continue;
			}
		} else if (*(_BYTE*)(*(_DWORD*)v5 + 21) == a2) {
			goto LABEL_17;
...
int  sub_57C130(_DWORD* a1, int a2) {
	...
	if (result) {
		if (v4 && v4 != 1 && v4 != 3) {
			if (v4 != 2) {
				nox_alloc_class_free_obj_414330(*(unsigned int**)&nox_alloc_itemGroupElem_2523896, (_QWORD*)result);
				return 0;
			}
			*(_DWORD*)result = *a1;
...
//----- (0057C370) --------------------------------------------------------
void  sub_57C370(_QWORD* a1) { nox_alloc_class_free_obj_414330(*(unsigned int**)&nox_alloc_groupInfo_2523892, a1); }

//----- (0057C390) --------------------------------------------------------
void  sub_57C390(_QWORD* a1) { nox_alloc_class_free_obj_414330(*(unsigned int**)&nox_alloc_itemGroupElem_2523896, a1); }
...
void  sub_57C5A0(const char* a1) {
	...
	if (dword_5d4594_2523912) {
		...
		nox_alloc_class_free_obj_414330(*(unsigned int**)&nox_alloc_debugData_2523908, (_QWORD*)v1);
	}
}
