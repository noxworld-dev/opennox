	...
	*(_DWORD*)&v74[4] = *(_DWORD*)(a4 + 4);
	...
	while (2) {
		...
		case 7:
			...
			*(_DWORD*)(v4 + 1) = v32;
			if (ns1->id == -1)
				ns1->func_yyy(v6, v4, 5, ns4->data_3);
			else
		...
		case 8:
			...
			*(_BYTE*)v4 = ns1->data_2_base[0];
			v20 = ns5->data_2_base[1];
			*(_BYTE*)(v4 + 2) = 9;
			*(_BYTE*)(v4 + 1) = v20;
		...
		case 10:
			...
			if (ns6->field_38 == 1)
				return 0;
			LOBYTE(a2) = 34;
			ns1->func_yyy(v6, &a2, 1, ns6->data_3);
			memset(getMemAt(0x5D4594, 32 * id + 2508788), 0, 0x20u);
		...
		case 11:
			...
			LOBYTE(a2) = 33;
			ns1->func_yyy(v6, &a2, 1, ns7->data_3);
			sub_554A50(id);
			return 0;
			}
		case 14:
		...
		case 31:
			...
			if (v14 != v15) {
				...
				*(_BYTE*)(v4 + 1) = ns8->field_28_1;
				ns1->func_yyy(v6, v4, 2, ns8->data_3);
			}
		LABEL_9:
