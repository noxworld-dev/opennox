...
int  nox_xxx_XFerSpellReward_4F5F30(int* a1) {
	...
	if (result) {
		...
		nox_xxx_fileReadWrite_426AC0_file3_fread(v14, (unsigned char)v7);
	LABEL_28:
		if (!a1[34] || *getMemU32Ptr(0x973F18, 3872) != 1 || (result = nox_xxx_xfer_4F3E30(v10, (int)a1, a1[34])) != 0) {
			a1[34] = v13;
			result = 1;
		}
	}
	...
	if (result) {
		...
		if ((unsigned char)v3 < 0x80u) {
			...
			*v1 = nox_xxx_abilityNameToN_424D80(v6);
			if (!a1[34] || *getMemU32Ptr(0x973F18, 3872) != 1 || (result = nox_xxx_xfer_4F3E30(v4, (int)a1, a1[34])) != 0) {
				a1[34] = v5;
				result = 1;
			}
		} else {
...
int  nox_xxx_XFerFieldGuide_4F6390(int* a1) {
	...
	if (result) {
		...
		if (!v1[34] || *getMemU32Ptr(0x973F18, 3872) != 1 || (result = nox_xxx_xfer_4F3E30(v5, (int)v1, v1[34])) != 0) {
			v1[34] = v3;
			result = 1;
		}
	}
...
int  nox_xxx_XFerWeapon_4F64A0(int a1) {
	...
	if (!result)
		return result;
	if ((short)v17 < 11 && *getMemU32Ptr(0x973F18, 3872) == 1) {
		*(uint32_t*)v20 = 0;
		*(uint32_t*)&v20[4] = 0;
		*(uint32_t*)&v20[8] = 0;
		*(uint32_t*)&v20[12] = 0;
...
LABEL_37:
	...
	if (*(uint32_t*)(a1 + 136) && *getMemU32Ptr(0x973F18, 3872) == 1 && !nox_xxx_xfer_4F3E30(v17, a1, *(uint32_t*)(a1 + 136)))
		return 0;
	*(uint32_t*)(a1 + 136) = v19;
	return 1;
}
...
int  nox_xxx_XFerArmor_4F6860(int a1) {
	...
	if (result) {
		if ((short)v10 < 11 && *getMemU32Ptr(0x973F18, 3872) == 1) {
			*(uint32_t*)v15 = 0;
			*(uint32_t*)&v15[4] = 0;
			*(uint32_t*)&v15[8] = 0;
			*(uint32_t*)&v15[12] = 0;
	...
	LABEL_18:
		...
		if ((short)v10 >= 62)
			nox_xxx_fileReadWrite_426AC0_file3_fread((uint8_t*)(*(uint32_t*)(a1 + 748) + 4), 4u);
		if (*(uint32_t*)(a1 + 136) && *getMemU32Ptr(0x973F18, 3872) == 1 && !nox_xxx_xfer_4F3E30(v10, a1, *(uint32_t*)(a1 + 136)))
			return 0;
		*(uint32_t*)(a1 + 136) = v14;
		result = 1;
	}
...
int  nox_xxx_XFerAmmo_4F6B20(int* a1) {
	...
	LABEL_17:
		if (a1[34] && *getMemU32Ptr(0x973F18, 3872) == 1 && !nox_xxx_xfer_4F3E30(v16, (int)a1, a1[34]))
			return 0;
		a1[34] = v17;
		result = 1;
	}
...
int  nox_xxx_XFerTeam_4F6D20(int* a1) {
	...
	if (result) {
		...
		if (!a1[34] || *getMemU32Ptr(0x973F18, 3872) != 1 || (result = nox_xxx_xfer_4F3E30(v9, (int)a1, a1[34])) != 0) {
			a1[34] = v10;
			result = 1;
		}
	}
...
int  nox_xxx_XFerObelisk_4F6F60(int* a1) {
	...
	if (result) {
		...
		if (!v1[34] || *getMemU32Ptr(0x973F18, 3872) != 1 || (result = nox_xxx_xfer_4F3E30(v8, (int)v1, v1[34])) != 0) {
			v1[34] = v3;
			result = 1;
		}
	}
...
int  nox_xxx_XFerToxicCloud_4F70A0(int a1) {
	...
	nox_xxx_fileReadWrite_426AC0_file3_fread(v2, 4u);
	if (v1[34]) {
		if (*getMemU32Ptr(0x973F18, 3872) == 1 && !nox_xxx_xfer_4F3E30(a1, (int)v1, v1[34]))
			return 0;
	}
	v1[34] = v3;
	return 1;
...
int  nox_xxx_XFerMonsterGen_4F7130(int* a1) {
	...
	LABEL_37:
		...
		if (!a1[34] || *getMemU32Ptr(0x973F18, 3872) != 1 || nox_xxx_xfer_4F3E30(v29, (int)a1, a1[34])) {
			a1[34] = v33;
			return 1;
		}
	}
	...
	if ((short)v23 <= 63) {
		...
		if ((short)v23 > 0) {
			if (nox_xxx_mapReadWriteObjData_4F4530(a1, (short)v23)) {
				...
				if (!a1[34] || *getMemU32Ptr(0x973F18, 3872) != 1 || nox_xxx_xfer_4F3E30(v23, (int)a1, a1[34])) {
					a1[34] = v24;
					return 1;
				}
			}
...
void  nox_xxx_playerSetCustomWP_4F79A0(int a1, int a2, int a3) {
	...
	if (!(*(uint8_t*)(*(uint32_t*)(v3 + 276) + 3680) & 3)) {
		...
		if (v4) {
			...
			*(uint32_t*)(v3 + 4 * *(unsigned char*)(v3 + 180) + 168) = nox_xxx_newObjectByTypeID_4E3810("PlayerWaypoint");
			nox_xxx_createAt_4DAA50(*(uint32_t*)(v3 + 4 * *(unsigned char*)(v3 + 180) + 168), a1, *(float*)&a2, *(float*)&a3);
		}
	}
}
...
int  sub_4F7CE0(int a1, int a2) {
	return *(uint32_t*)(a1 + 16) & 0x1000000 && (!a2 || !nox_xxx_servObjectHasTeam_419130(a1 + 48) || nox_xxx_teamCompare2_419180(a1 + 48, a2));
}
		...
		if (!nox_common_gameFlags_check_40A5C0(4096) || (v1 = (char*)v3[137]) == 0) {
			...
			if (nox_common_gameFlags_check_40A5C0(16)) {
				if (nox_xxx_CheckGameplayFlags_417DA0(4)) {
					v7 = *((uint32_t*)nox_xxx_clientGetTeamColor_418AB0(*(unsigned char*)(*(uint32_t*)(v4 + 2056) + 52)) + 19);
					if (v7) {
						if (!*(uint32_t*)(v7 + 492))
...
void  nox_xxx_unitUpdatePlayerImpl_4F8460(int a1) {
	...
	case 5u:
		if (!nox_xxx_playerCanMove_4F9BC0(v1))
			goto LABEL_10;
		v20 = *(uint32_t*)(*(uint32_t*)(v1 + 748) + 276);
	...
	LABEL_10:
		...
		*(uint32_t*)(v2 + 240) &= 0xFFFFFFE1;
		if (*(uint8_t*)(v4 + 3680) & 3 ||
			(v69 = sub_4FEE50(31, v1), (v5 = nox_xxx_playerControlBufferFirst_51AB50(*(unsigned char*)(*(uint32_t*)(v2 + 276) + 2064))) == 0)) {
		LABEL_247:
			if (v68) {
				v66 = *(uint8_t*)(v2 + 88);
				if (v66) {
		...
		while (1) {
			if (!v69 || *((uint32_t*)v5 + 2) == 1) {
				...
				case 1:
					if (!nox_xxx_testUnitBuffs_4FF350(v1, 25) && (!nox_common_gameFlags_check_40A5C0(4096) || !*(uint32_t*)(v2 + 280)) &&
	...
	case 0xDu:
		*(uint32_t*)(v1 + 16) &= 0xFFFFBFFE;
		...
		if (nox_common_gameFlags_check_40A5C0(128) || !(**(uint32_t**)(v2 + 276) & 0x3000000) ||
			!nox_xxx_monsterTestBlockShield_533E70(v1) && (unsigned int)(nox_frame_xxx_2598000 - *(uint32_t*)(v1 + 136)) <=
								   (int)nox_gameFPS >> 2) {
			goto LABEL_10;
		}
...
int  nox_xxx_playerAimsAtEnemy_4F9DC0(int a1) {
	...
	if (!a1)
		return 0;
	if (!*(uint32_t*)(*(uint32_t*)(a1 + 748) + 288) || nox_xxx_unitIsEnemyTo_5330C0(a1, *(uint32_t*)(*(uint32_t*)(a1 + 748) + 288)) ||
...
void  sub_4F9E70(int a1) {
	...
	if ((v2 & 0x8000) == 0 && v3 && *v3 &&
		!(nox_frame_xxx_2598000 %
		  (v1 * nox_gameFPS / (unsigned int)(unsigned short)v3[2]))) {
...
void  sub_4F9ED0(uint32_t* a1) {
	...
	if ((unsigned int)(nox_frame_xxx_2598000 - a1[134]) > (int)nox_gameFPS) {
		v5 = v3[2];
		if (*v3 < v5 && v5 &&
			!(nox_frame_xxx_2598000 % (300 * nox_gameFPS / (unsigned int)v3[2]))) {
...
int  nox_xxx_respawnPlayerBot_4FAC70(int a1) {
	...
	v2 = sub_416640();
	if (!**(uint16_t**)(a1 + 556)) {
		if (nox_frame_xxx_2598000 - *(uint32_t*)(v1 + 548) <
		...
		if (*(uint8_t*)(a1 + 8) & 4) {
			if (a2) {
				...
				if ((uint8_t)v4 != 1 && (unsigned char)(v4 - 1) <= 0x30u) {
					...
					v5[1] = 33;
					strcpy(&v5[2], a2);
					nox_xxx_netSendPacket0_4E5420(*(unsigned char*)(*(uint32_t*)(*(uint32_t*)(a1 + 748) + 276) + 2064), v5, 52, 0, 1);
				}
			}
		}
	}
...
int  sub_4FB000(int a1, int a2) {
	...
	if (a1 && a2 && *(uint8_t*)(a1 + 8) & 4 && *(uint8_t*)(a2 + 8) & 2 &&
		(v2 = *(uint32_t*)(a1 + 748), v3 = (const char*)nox_xxx_getUnitName_4E39D0(a2), (v4 = nox_xxx_guide_427010(v3)) != 0)) {
				...
				if (*getMemU32Ptr(0x5D4594, 1569648)) {
					do {
						...
						if (v4 == a1 && *(uint32_t*)v3 == a2) {
							...
							nox_alloc_class_free_obj(*(unsigned int**)&nox_alloc_execAbil_1569644, (uint64_t*)v3);
						}
						v3 = v5;
					} while (v5);
				}
				...
				if (*getMemU32Ptr(0x5D4594, 1569648)) {
					do {
						...
						if (v5 == a1) {
							...
							nox_alloc_class_free_obj(*(unsigned int**)&nox_alloc_execAbil_1569644, (uint64_t*)v4);
						}
						v4 = v6;
					} while (v6);
				}
		...
		if (*getMemU32Ptr(0x5D4594, 1569648)) {
			do {
				...
				if (*(uint32_t**)(v2 + 4) == a1 && *(uint32_t*)v2 == a2) {
					...
					nox_alloc_class_free_obj(*(unsigned int**)&nox_alloc_execAbil_1569644, (uint64_t*)v2);
				}
				v2 = v3;
			} while (v3);
		}
...
int  nox_xxx_Fn_4FCAC0(int a1, int a2) {
	...
	sub_4FE8A0(a1);
	nox_alloc_class_yyy_4144D0(*(uint32_t**)&nox_alloc_magicEnt_1569668);
	dword_5d4594_1569672 = 0;
	...
	if (dword_5d4594_1569672) {
		while (1) {
			...
			if (v7 != v24) {
				v19 = sub_416640();
				LOBYTE(v27) =
					nox_xxx_spellPhonemes_424A20(*(uint32_t*)(v0 + 4 * *(unsigned char*)(v0 + 28) + 8))[*(unsigned char*)(v0 + 36)];
				v20 = v27;
		...
		LABEL_40:
			v18 = *(uint32_t*)(v0 + 52);
			nox_alloc_class_free_obj(*(unsigned int**)&nox_alloc_magicEnt_1569668, (uint64_t*)v0);
			v0 = v18;
		LABEL_48:
			if (!v0)
				return;
...
int  sub_4FD0E0(int a1, int a2) {
	...
	if (!nox_xxx_spellIsEnabled_424B70(a2))
		return 10;
	if (*(uint8_t*)(a1 + 8) & 4)
		return nox_xxx_playerCheckSpellClass_57AEA0(*(unsigned char*)(*(uint32_t*)(*(uint32_t*)(a1 + 748) + 276) + 2251), a2);
	v4 = -sub_57AEE0(a2, v2);
	LOBYTE(v4) = v4 & 0xF6;
	return v4 + 10;
}
...
int  nox_xxx_spellAccept_4FD400(int a1, int a2, uint32_t* a3, int a4, int* a5, int a6) {
	...
	if (!*a5 || nox_xxx_gameCaptureMagic_4FDC10(a1, *a5)) {
		...
		case 50:
			...
			goto LABEL_95;
		case 51:
			return nox_xxx_spellDurationBased_4FEBA0(a1, a2, (uint32_t*)*a5, a4, a5, a6, nox_xxx_castShield1_52F5A0, sub_52F650, sub_52F670, 0);
		case 52:
		...
		case 53:
			...
			goto LABEL_95;
		case 54:
			return nox_xxx_spellDurationBased_4FEBA0(a1, a2, (uint32_t*)*a5, a4, a5, a6, nox_xxx_spellCreateMoonglow_531A00, 0, sub_531AF0, 0);
		case 55:
			v7 = sub_52C230;
			goto LABEL_95;
		case 56:
		...
		case 59:
			...
			return nox_xxx_spellDurationBased_4FEBA0(a1, a2, a3, a4, a5, a6, nox_xxx_plasmaSmth_531580, nox_xxx_plasmaShot_531600, sub_5319E0, (long long)v8);
		case 60:
		...
		case 66:
			...
			goto LABEL_95;
		case 67:
			return nox_xxx_spellDurationBased_4FEBA0(a1, a2, (uint32_t*)*a5, a4, a5, a6, sub_531490, sub_5314F0, sub_531560, 0);
		case 68:
		case 133:
...
int  nox_xxx_gameCaptureMagic_4FDC10(int a1, int a2) {
	...
	if (nox_xxx_spellHasFlags_424A50(a1, 0x80000) && *(uint8_t*)(a2 + 8) & 4) {
		...
		if (nox_common_gameFlags_check_40A5C0(32)) {
			...
			v5 = *(uint32_t*)(a2 + 516);
			if (v5) {
				while (*(unsigned short*)(v5 + 4) != *getMemU32Ptr(0x5D4594, 1569716) || !nox_xxx_servObjectHasTeam_419130(a2 + 48)) {
					v5 = *(uint32_t*)(v5 + 512);
					if (!v5)
						return 1;
				}
...
void  nox_xxx_collide_4FDF90(int a1, int a2) {
	...
	if (nox_xxx_testUnitBuffs_4FF350(a1, 22) && !(*(uint32_t*)(a2 + 16) & 0x8008) && *(uint8_t*)(a2 + 8) & 6 && nox_xxx_unitIsEnemyTo_5330C0(a1, a2)) {
	...
	if (dword_5d4594_1569672) {
		...
		do {
			...
			if (((*(uint8_t*)(v4 + 8) & 4) != 4 || !nox_xxx_servCompareTeams_419150(v3 + 48, v4 + 48)) &&
				...
				v12 = *(uint32_t*)(v2 + 52);
				nox_alloc_class_free_obj(*(unsigned int**)&nox_alloc_magicEnt_1569668, (uint64_t*)v2);
				v2 = v12;
			} else {
				v2 = *(uint32_t*)(v2 + 52);
			}
...
void  sub_4FE8A0(int a1) {
	...
	if (a1) {
		...
		nox_alloc_class_yyy_4144D0(*(uint32_t**)&nox_alloc_spellDur_1569724);
		dword_5d4594_1569728 = 0;
	}
}
...
void  sub_4FE980(int a1) {
	...
	nox_alloc_class_free_obj(*(unsigned int**)&nox_alloc_spellDur_1569724, (uint64_t*)a1);
}
...
//----- (004FEBA0) --------------------------------------------------------
int  nox_xxx_spellDurationBased_4FEBA0(int a1, int a2, uint32_t* a3, int a4, uint32_t* a5, int a6, int(* a7)(uint16_t*), int a8, int a9,
					   int a10) {
	int v10;    // eax
	uint16_t* v12; // esi
	int v13;    // edx
...
int  sub_4FEE50(int a1, int a2) {
	...
	if (!dword_5d4594_1569728)
		return 0;
	result = 1;
	while (*(uint32_t*)(v2 + 20) || *(uint32_t*)(v2 + 4) != a1 || *(uint32_t*)(v2 + 16) != a2 || *(uint8_t*)(v2 + 88) & 1) {
		v2 = *(uint32_t*)(v2 + 116);
		if (!v2)
			return 0;
	}
...
void nox_xxx_spellCastByPlayer_4FEEF0() {
	...
	for (int v0 = dword_5d4594_1569728; v0; v0 = v1) {
		...
		v5 = *(uint32_t*)(v0 + 68);
		if (v5 != *(uint32_t*)(v0 + 60) && v5 <= nox_frame_xxx_2598000 || (v6 = *(int(**)(int))(v0 + 96)) != 0 && v6(v0)) {
			nox_xxx_spellCancelSpellDo_4FE9D0(v0);
		}
	}
}
...
void nox_xxx_buffApplyTo_4FF380(nox_object_t* unit, int a2, short a3, char a4) {
	...
	if (nox_common_gameFlags_check_40A5C0(4096) && *(unsigned short*)(a1 + 4) == *getMemU32Ptr(0x5D4594, 1569740) && a2 == 3) {
		nox_xxx_aud_501960(582, unit, 0, 0);
		return;
	}
	int v4 = nox_common_gameFlags_check_40A5C0(4096);
	if (v4 && (LOWORD(v4) = *getMemU16Ptr(0x5D4594, 1569744), *(unsigned short*)(a1 + 4) == *getMemU32Ptr(0x5D4594, 1569744)) && a2 == 3) {
		nox_xxx_aud_501960(595, unit, 0, 0);
	} else if (*(uint8_t*)(a1 + 8) & 2 && (v4 = *(uint32_t*)(a1 + 12), BYTE1(v4) & 0x10) && a2 == 11 && (v4 = nox_common_gameFlags_check_40A5C0(2048)) == 0) {
		v4 = *(uint16_t*)(a1 + 4);
	...
	if (*(uint32_t*)(a1 + 340)) {
		...
		do {
			if ((1 << v1) & *(uint32_t*)(a1 + 340)) {
				if (v1 == 16 && (unsigned int)*(unsigned short*)(a1 + 376) % nox_gameFPS ==
									nox_gameFPS - 1) {
...
void nox_xxx_mapWall_4FF790() {
	nox_alloc_class_yyy_4144D0(*(uint32_t**)&nox_alloc_magicWall_1569748);
	dword_5d4594_1569752 = 0;
}
...
void  nox_xxx_wallDestroy_4FF870(int a1) {
	...
	nox_alloc_class_free_obj(*(unsigned int**)&nox_alloc_magicWall_1569748, (uint64_t*)a1);
}
...
char*  nox_xxx_scriptGetJournal_5005E0(char* a1) {
	...
	if (strchr(a1, 58)) {
		...
		*getMemU16Ptr(0x5D4594, 1570140 + strlen((const char*)getMemAt(0x5D4594, 1570140))) = *getMemU16Ptr(0x587000, 217952);
		v1 = strlen(a1) + 1;
...
unsigned int  sub_5009B0(char* a1) {
	...
	if (strchr(a1, 58)) {
		...
		result = 0;
		memcpy(v3, v4, v1 & 3);
		*getMemU16Ptr(0x5D4594, 1570140 + strlen((const char*)getMemAt(0x5D4594, 1570140))) = *getMemU16Ptr(0x587000, 217960);
...
int  nox_xxx_creatureIsMonitored_500CC0(int a1, int a2) {
	...
	if ((*(uint8_t*)(a2 + 8) & 2 && (v2 = *(uint32_t*)(a2 + 16), (v2 & 0x8000) == 0) || nox_xxx_unitIsZombie_534A40(a2)) &&
...
int  nox_xxx_summonFinish_5010D0(int a1) {
	...
	if (v5) {
	LABEL_17:
		v6 = nox_xxx_unitDoSummonAt_5016C0(*(unsigned short*)(a1 + 72), (int*)(a1 + 74), *(uint32_t*)(a1 + 16), *(uint8_t*)(a1 + 82));
		if (v6)
...
//----- (00502670) --------------------------------------------------------
void  nox_server_scriptExecuteFnForEachGroupObj_502670(unsigned char* groupPtr, int expectedType,
						...
						if (result) {
							...
							if (dword_5d4594_1599644) {
								...
								if (*getMemU32Ptr(0x5D4594, 1599580)) {
									...
									rename((const char*)getMemAt(0x973F18, 38056), (const char*)getMemAt(0x973F18, 36008));
									nox_script_readWriteZzz_541670((const char*)getMemAt(0x973F18, 36008), (const char*)getMemAt(0x973F18, 30760),
											   (const char*)getMemAt(0x973F18, 38056));
								} else {
									*getMemU32Ptr(0x5D4594, 1599580) = 1;
									rename((const char*)getMemAt(0x973F18, 30760), (const char*)getMemAt(0x973F18, 38056));
								}
							}
...
int  nox_server_mapRWWaypoints_506260(uint32_t* a1) {
	...
	if (v2) {
		do {
			v3 = a1;
			if (!a1 || (v26.field_0 = (long long)v2[2], v26.field_4 = (long long)v2[3], nox_xxx_wallMath_427F30(&v26, a1)))
				++v19;
...
//----- (00506700) --------------------------------------------------------
void sub_506700() {
	nox_alloc_class_yyy_4144D0(*(uint32_t**)&nox_alloc_vote_1599652);
	dword_5d4594_1599656 = 0;
}
...
void  sub_5067B0(int a1) {
	...
	if (a1) {
		...
		sub_506810(a1);
		nox_alloc_class_free_obj(*(unsigned int**)&nox_alloc_vote_1599652, (uint64_t*)a1);
		if (!dword_5d4594_1599656)
			sub_507190(255, 0);
	}
}
				...
				if (v2) {
					...
					if (v2[2064] != 31) {
						...
						if (v3) {
							...
							v5 = 1 << *(uint8_t*)(*(uint32_t*)(*(uint32_t*)(a1 + 748) + 276) + 2064);
							if (dword_5d4594_1599656) {
								while (*(uint32_t*)v4 != 3 || *(uint32_t*)(v4 + 28) != v3 || !(v5 & *(uint32_t*)(v4 + 8))) {
									v4 = *(uint32_t*)(v4 + 44);
									if (!v4)
										return;
								}
