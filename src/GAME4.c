...
int  nox_xxx_XFerWeapon_4F64A0(int a1) {
	...
	if (!result)
		return result;
	if ((__int16)v17 < 11 && *getMemU32Ptr(0x973F18, 3872) == 1) {
		*(_DWORD*)v20 = 0;
		*(_DWORD*)&v20[4] = 0;
		*(_DWORD*)&v20[8] = 0;
		*(_DWORD*)&v20[12] = 0;
...
LABEL_37:
	...
	if (*(_DWORD*)(a1 + 136) && *getMemU32Ptr(0x973F18, 3872) == 1 && !nox_xxx_xfer_4F3E30(v17, a1, *(_DWORD*)(a1 + 136)))
		return 0;
	*(_DWORD*)(a1 + 136) = v19;
	return 1;
}
...
int  nox_xxx_XFerArmor_4F6860(int a1) {
	...
	if (result) {
		if ((__int16)v10 < 11 && *getMemU32Ptr(0x973F18, 3872) == 1) {
			*(_DWORD*)v15 = 0;
			*(_DWORD*)&v15[4] = 0;
			*(_DWORD*)&v15[8] = 0;
			*(_DWORD*)&v15[12] = 0;
	...
	LABEL_18:
		...
		if ((__int16)v10 >= 62)
			nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(*(_DWORD*)(a1 + 748) + 4), 4u);
		if (*(_DWORD*)(a1 + 136) && *getMemU32Ptr(0x973F18, 3872) == 1 && !nox_xxx_xfer_4F3E30(v10, a1, *(_DWORD*)(a1 + 136)))
			return 0;
		*(_DWORD*)(a1 + 136) = v14;
		result = 1;
	}
					...
					if (result) {
						...
						if (result) {
							...
							if (dword_5d4594_1599644) {
								...
								v16.field_0 = v8;
								v16.field_4 = v9;
								sub_543110((LPCSTR)getMemAt(0x973F18, 30760), &v16);
								if (*getMemU32Ptr(0x5D4594, 1599580)) {
									remove((LPCSTR)getMemAt(0x973F18, 36008));
									rename((LPCSTR)getMemAt(0x973F18, 38056), (LPCSTR)getMemAt(0x973F18, 36008));
									...
									*getMemU32Ptr(0x5D4594, 1599580) = 1;
									rename((LPCSTR)getMemAt(0x973F18, 30760), (LPCSTR)getMemAt(0x973F18, 38056));
								}
							}
