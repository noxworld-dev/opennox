...
LABEL_25:
    ...
    v9 = *(_DWORD*)(v4 + 276);
    if ((!nox_common_gameFlags_check_40A5C0(0x2000) || nox_common_gameFlags_check_40A5C0(4096)) && !*(_DWORD*)(v9 + 4 * v3 + 3696))
    {
        a1 = 3;
        goto LABEL_48;
    }
...
__int16 __cdecl sub_4FF380(int a1, int a2, __int16 a3, char a4)
{
    ...
    if (a1)
    {
        ...
        {
            if (nox_common_gameFlags_check_40A5C0(4096) && *(unsigned __int16*)(a1 + 4) == *(_DWORD*)& byte_5D4594[1569740] && a2 == 3)
            {
    ...
    if (result != (_DWORD*)1)
    {
        if (a2)
        {
            if (a1)
            {
                ...
                if ((int)result > 0)
                {
                    if (!nox_common_gameFlags_check_40A5C0(4096) || !(*(_BYTE*)(a2 + 8) & 4) || (result = (_DWORD*)sub_419E60(a2)) == 0)
                    {
...
int __cdecl sub_504CF0(_DWORD* a2)
{
    ...
    if (nox_common_gameFlags_check_40A5C0(0x200000) || !nox_common_gameFlags_check_40A5C0(1) || nox_common_gameFlags_check_40A5C0(0x400000) || (result = sub_51DED0()) != 0)
    {
        v14 = 0;
...
int sub_504F90()
{
    ...
    if ((__int16)v2 > 1)
        return 0;
    v1 = 0;
    if (*(_DWORD*)& byte_5D4594[1599636] && nox_common_gameFlags_check_40A5C0(1) && !nox_common_gameFlags_check_40A5C0(0x400000))
        v1 = 1;
