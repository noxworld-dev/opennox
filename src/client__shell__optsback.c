	...
	if (a2 == 21 && a3 == 1) {
		...
		if (!sub_44A4A0()) {
			if (nox_game_getStateCode_43BE10() == 10000) {
				...
				nox_xxx_dialogMsgBoxCreate_449A10(dword_5d4594_1307292, (int)v5, (int)v6, 56, sub_4A19D0, 0);
			} else {
			...
			if (v3) {
				if (v3 == 1) {
					if (nox_game_getStateCode_43BE10() == 100) {
						...
						nox_xxx_dialogMsgBoxCreate_449A10(dword_5d4594_1307292, (int)v4, (int)v6, 56,
														  sub_4A19D0, 0);
					} else {
						if (sub_4D6F30()) {
							sub_4D6F90(2);
