...
void nox_xxx_fnPickEnemyAggro_533460(nox_object_t* a1, nox_object_t* a2);
int sub_533570(nox_object_t* a1);
...
int nox_xxx_mapCheck_537110(nox_object_t* a1, int a2);
...
short nox_xxx_pixieIdleAnimate_53CF90(nox_object_t* a1, float2* a2, short a3);
