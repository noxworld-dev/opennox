...
func recreateRenderTarget() error {
	...
	*memmap.PtrUint32(0x973CE0, 6628) = uint32(nox_backbuffer_pitch_3801808 * int(nox_getBackbufHeight()))
	*memmap.PtrUint32(0x973CE0, 8264) = uint32(bool2int(C.dword_5d4594_3801780 == 1))
...
func nox_client_drawXxx_444AC0(w, h, depth int, flags int) error {
	...
	nox_mutex_initP(memmap.PtrOff(0x973CE0, 736))
	...
	*memmap.PtrUint32(0x973CE0, 2936) = 0
	...
	if v9 == 0 {
		...
		*memmap.PtrUint32(0x973CE0, 2916) = uint32(v8) >> 2
	...
	*memmap.PtrUint32(0x973CE0, 2916) = uint32(v8) >> 1
...
func nox_video_cursorDrawImpl_477A30(inp *input.Handler, a2, a3 int) {
	v18 := memmap.Uint32(0x973CE0, 636)
	v3 := a2 - 64
	v4 := a3 - 64
	*memmap.PtrUint32(0x973CE0, 636) = 0
	...
	if C.nox_xxx_guiSpell_460650() != 0 || C.sub_4611A0() != 0 {
		...
		*memmap.PtrUint32(0x973CE0, 636) = v18
		return
	}
	...
	case 14:
		...
		if v19.X*v19.X+v19.Y*v19.Y > 100*100 || memmap.Uint32(0x5D4594, 2614252) != 0 && *(*uint32)(unsafe.Pointer(uintptr(*memmap.PtrPtr(0x5D4594, 2614252)) + 276)) == 6 {
			v15 += 32
		}
...
func nox_client_drawCursorAndTooltips_477830(inp *input.Handler) {
	...
	if nox_client_spellDragnDrop_1097192 != 0 { // Player is dragging spell or ability
		pl := getPlayerByID(int(memmap.Int32(0x8529A0, 2044)))
...
func sub_444C50() {
	if C.dword_5d4594_823776 != 0 {
		...
		if memmap.Uint32(0x5D4594, 823780) != 0 {
			nox_mutex_freeP(memmap.PtrOff(0x973CE0, 736))
