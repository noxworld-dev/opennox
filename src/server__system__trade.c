...
int  sub_50F0F0(int a1, int a2) {
	...
	*(uint16_t*)&v6[2] = *(uint16_t*)(v2 + 4);
	return nox_xxx_netSendPacket1_4E5390(*(unsigned char*)(*(uint32_t*)(*(uint32_t*)(v3 + 748) + 276) + 2064), (int)v6, 86, 0, 1);
}
	...
	if (v2) {
		...
		if (v3) {
			if (*(uint32_t*)(v3 + 12) != a2) {
				v4 = nox_strman_loadString_40F1D0("StarterAlreadyTrading", 0, "C:\\NoxPost\\src\\Server\\System\\Trade.c",
										   1836);
	...
	if (v5) {
		...
		*(uint32_t*)(a1 + 28) = 0;
		...
		if (!(*(uint8_t*)(*(uint32_t*)(a1 + 12) + 8) & 4))
			return 0;
		v8 = nox_strman_loadString_40F1D0("TradeMaxObjectsReached", 0, "C:\\NoxPost\\src\\Server\\System\\Trade.c", 2490);
	...
	*(uint16_t*)&v8[2] = (uint16_t)a3;
	if (v4) {
		...
		if (nox_xxx_ItemIsDroppable_53EBF0(v4) == 1) {
			v6 = nox_strman_loadString_40F1D0("CantSellQuestItem", 0, "C:\\NoxPost\\src\\Server\\System\\Trade.c",
									   3298);
			...
			v7 = nox_strman_loadString_40F1D0("CantSellItem", 0, "C:\\NoxPost\\src\\Server\\System\\Trade.c",
									   3308);
			nox_xxx_netSendLineMessage_4D9EB0((int)a1, v7);
			result = nox_xxx_aud_501960(925, (int)a1, 2, a1[9]);
		} else {
			*(uint32_t*)&v8[4] = nox_xxx_shopGetItemCost_50E3D0(0, a2, *(float*)&v4);
			result = (uint32_t*)nox_xxx_netSendPacket0_4E5420(*(unsigned char*)(*(uint32_t*)(v3 + 276) + 2064), v8, 8, 0, 1);
		}
	}
	return result;
}
