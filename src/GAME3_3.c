...
int __cdecl nox_server_handler_PlayerDamage_4E17B0(int a1, int a2, int a3, int a4, int a5) {
	...
	v9 = a2;
	if (v8) {
		if (nox_xxx_findParentChainPlayer_4EC580(a2) == v5 && *(_BYTE*)(v5 + 8) & 4 && LODWORD(a5) != 15)
			return 0;
	}
	if (a3)
		v9 = a3;
	...
	if (*(_BYTE*)(v5 + 8) & 4 && nox_xxx_playerGetPossess_4DDF30(v5))
	...
	if (a2) {
		...
		if (!(LODWORD(a5) == 15 || !v21 ||
			...
			int c1 = *(_BYTE *) (v5 + 8) & 4;
			if (((c1 && *(_BYTE *) (v12 + 88) != 16) || (!c1 && nox_xxx_mobActionGet_50A020(v5) != 21) ) || !(armorrFlags & 0x3000000)) {
				v27 = LODWORD(a5);
				if (weaponFlags2 & 0x400) {
					...
					if (*(_BYTE *) (v9 + 8) & 1 || a5 == 0.0 || LODWORD(a5) == 11) {
						...
						if (*(_BYTE *) (v5 + 8) & 4) {
							...
							nox_xxx_playerSetState_4FA020((_DWORD *) v5, v29);
						} else {
...
//----- (004E20F0) --------------------------------------------------------
void __cdecl nox_xxx_playerDecrementHPMana_4E20F0(int a1, int a2, float a3) {
	int v3;    // esi
	int v4;    // eax
	double v5; // st7
	int v6;    // eax
...
//----- (004E2180) --------------------------------------------------------
void __cdecl nox_xxx_playerDamageItems_4E2180(int a1, int a2, int a3, int a4, float a5) {
	int v5;     // edi
	int v6;     // eax
	_DWORD* v7; // esi
	int v8;     // ebx
...
int __cdecl sub_4E23C0(int a1, int a2, int a3, int a4, int a5) {
	...
	if (nox_xxx_testUnitBuffs_4FF350(a1, 23)) {
		...
		result = 1;
			   ...
			   (!a3 ? (v7 = *(float*)(a2 + 76), a3a.field_0 = *(float*)(a2 + 72), a3a.field_4 = v7)
				...
				nox_server_testTwoPointsAndDirection_4E6E50((float2*)(a1 + 56), *(__int16*)(a1 + 124), &a3a) & 1 &&
					(v8 = *(_DWORD*)(a1 + 748), nox_xxx_mobActionGet_50A020(a1) == 21) &&
...
//----- (004E24B0) --------------------------------------------------------
int __cdecl sub_4E24B0(int a1, int a2, int a3, int a4, int a5) { return nox_xxx_damageDefaultProc_4E0B30(a1, a2, a3, a4, a5); }
...
//----- (004E2520) --------------------------------------------------------
int __cdecl nox_xxx_damageFlammable_4E2520(int a1, int a2, int a3, int a4, int a5) {
	int v5; // eax
...
//----- (004E2560) --------------------------------------------------------
int __cdecl nox_xxx_damageBlackPowder_4E2560(int a1, int a2, int a3, int a4, int a5) {
	int result; // eax
...
//----- (004E25A0) --------------------------------------------------------
int __cdecl nox_xxx_gameSetWallsDamage_4E25A0(int a1) {
	int result; // eax
...
//----- (004E25B0) --------------------------------------------------------
bool __cdecl nox_xxx_mapDamageUnitsAround_4E25B0(int a1, float a2, float a3, int a4, int a5, int a6, int a7) {
	bool result; // al
...
//----- (004E2700) --------------------------------------------------------
void __cdecl nox_xxx_damageFn_4E2700(float* a1, int a2) {
	int v2;         // esi
	float* v3;      // ecx
	double v4;      // st7
	double v5;      // st6
	...
	if ((a1 != *(float**)(a2 + 20) || *getMemU32Ptr(0x587000, 201112)) && *(float**)(a2 + 24) != a1) {
		...
		if (v6 <= *(float*)(v2 + 4)) {
			...
			if (nox_xxx_mapTraceRay_535250(&v10, 0, 0, 1)) {
				...
				(*((void(__cdecl**)(float*, _DWORD, _DWORD, _DWORD, _DWORD))a1 + 179))(a1, *(_DWORD*)(v2 + 20), 0, v9,
																					   *(_DWORD*)(v2 + 16));
			}
		}
	}
...
//----- (004E27D0) --------------------------------------------------------
int __cdecl nox_xxx_damageMonsterGen_4E27D0(int a1, int a2, int a3, int a4, int a5) {
	int v5;               // ebp
	int v7;               // edi
	int v8;               // eax
	...
	if (*(_DWORD*)(a1 + 16) & 0x8020)
		return 0;
	if ((unsigned int)(*getMemU32Ptr(0x5D4594, 2598000) - *(_DWORD*)(a1 + 536)) > 0x14 ||
		!(*getMemU32Ptr(0x5D4594, 2598000) % 0x1Eu)) {
		if (a3) {
...
//----- (004E31A0) --------------------------------------------------------
int __cdecl nox_xxx_unitDefProtectMB_4E31A0(int a1) {
	int result; // eax
	int v2;     // esi
	int v3;     // esi
...
//----- (004E3360) --------------------------------------------------------
int __cdecl nox_xxx_allocClassArrayObjects_4E3360(unsigned int a1) {
	_DWORD* v1; // esi
	int v2;     // edi
	int result; // eax
	_DWORD* v4; // eax
	...
	if (result) {
		if (a1) {
			while (1) {
				...
				if (v2 - 1 >= a1) {
					do {
						...
						v1 = (_DWORD*)v1[111];
						v6 = v5[9];
						nox_xxx_memDeleteAdv_414330(*(unsigned int**)&nox_alloc_objMem_1563344, v5);
						v5[9] = v6;
					} while (v1);
			...
			while (v1) {
				v7 = v1;
				v1 = (_DWORD*)v1[111];
				nox_xxx_memDeleteAdv_414330(*(unsigned int**)&nox_alloc_objMem_1563344, v7);
			}
			result = 0;
		} else {
		LABEL_9:
...
_DWORD* __cdecl nox_new_objMem_2_4E3450(int a1) {
	return nox_new_objMem_4E3470(*(_DWORD*)(*getMemU32Ptr(0x5D4594, 1563456) + 4 * a1));
}
...
_DWORD* __cdecl nox_new_objMem_4E3470(int a1) {
	...
	_DWORD* obj = nox_alloc_class_new_obj(nox_alloc_objMem_1563344);
	if (!obj) {
		return 0;
	}
	v9 = obj[9];
	...
	*((_WORD*)obj + 2) = *(_WORD*)a1;
	...
	if (nox_common_gameFlags_check_40A5C0(6291456) &&
		(obj[2] & 0x20A02 || (int(__cdecl*)(int*))obj[176] == nox_xxx_XFerInvLight_4F5AA0 || *((char*)obj + 488) != -1) &&
...
//----- (004E3810) --------------------------------------------------------
_DWORD* __cdecl nox_xxx_objectCreateByName_4E3810(CHAR* a1) {
	int v1 = nox_xxx_unitDefByName_4E3830(a1);
	if (!v1)
		return 0;
...
//----- (004E3830) --------------------------------------------------------
int __cdecl nox_xxx_unitDefByName_4E3830(CHAR* a1) {
	int v1;         // eax
	signed int v2;  // ecx
	const void* v3; // eax
	int* v4;        // eax
...
//----- (004E3880) --------------------------------------------------------
int __cdecl nox_xxx_objBsearchFn_4E3880(const void* a1, const void* a2) {
	return _strcmpi((const char*)a1, *(const char**)(*(_DWORD*)a2 + 4));
}

//----- (004E38A0) --------------------------------------------------------
int __cdecl nox_xxx_objectFreeMem_4E38A0(int a1) {
	int* v1; // esi
	int v2;  // ebp
	int v3;  // edi
	int v4;  // eax
...
//----- (004E39D0) --------------------------------------------------------
int __cdecl nox_xxx_getUnitName_4E39D0(int a1) {
	return *(_DWORD*)(*(_DWORD*)(*getMemU32Ptr(0x5D4594, 1563456) + 4 * *(unsigned __int16*)(a1 + 4)) + 4);
}

//----- (004E3A80) --------------------------------------------------------
int __cdecl nox_xxx_getUnitNameByThingType_4E3A80(int a1) {
	int result; // eax

	result = a1;
	if (a1)
		result = *(_DWORD*)(*(_DWORD*)(*getMemU32Ptr(0x5D4594, 1563456) + 4 * a1) + 4);
	return result;
}

//----- (004E3AA0) --------------------------------------------------------
int __cdecl nox_xxx_getNameId_4E3AA0(CHAR* a1) {
	unsigned __int16* v1; // eax
	int result;           // eax

	v1 = (unsigned __int16*)nox_xxx_unitDefByName_4E3830(a1);
	if (v1)
		result = *v1;
	else
		result = 0;
...
BOOL __cdecl sub_4E3AD0(int a1) {
	...
	if (!*getMemU32Ptr(0x5D4594, 1563904))
		*getMemU32Ptr(0x5D4594, 1563904) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 202016));
	v1 = *(_DWORD*)(*getMemU32Ptr(0x5D4594, 1563456) + 4 * a1);
	v2 = *(_DWORD*)(v1 + 24);
	result = 1;
	if (!(v2 & 1)) {
		if (v2 & 0x400000) {
...
//----- (004E3B60) --------------------------------------------------------
int __cdecl nox_xxx_utilThingDefByName_4E3B60(CHAR* a1) { return nox_xxx_unitDefByName_4E3830(a1); }

//----- (004E3B70) --------------------------------------------------------
int __cdecl nox_xxx_unitDefGet_4E3B70(int a1) { return *(_DWORD*)(*getMemU32Ptr(0x5D4594, 1563456) + 4 * a1); }

//----- (004E3B80) --------------------------------------------------------
BOOL __cdecl sub_4E3B80(int a1) { return *(int*)(*(_DWORD*)(*getMemU32Ptr(0x5D4594, 1563456) + 4 * a1) + 12) != -1; }

//----- (004E3BA0) --------------------------------------------------------
int __cdecl nox_xxx_getUnitDefDd10_4E3BA0(int a1) { return *(_DWORD*)(*(_DWORD*)(*getMemU32Ptr(0x5D4594, 1563456) + 4 * a1) + 16); }
...
//----- (004E3C60) --------------------------------------------------------
int __cdecl nox_xxx_cliSetPlrGuid_4E3C60(int a1) {
	int result; // eax
		...
		do {
			...
			if (v0 & 0x20000 && (v3 = *(_DWORD*)(v1 + 16), (v3 & 0x8000) == 0)) {
				...
				if (v4) {
					...
					if ((_WORD)v0) {
						if ((_WORD)v0 == v4) {
							v5 = nox_xxx_unitDefGet_4E3B70(*(unsigned __int16*)(v1 + 4));
				...
				if ((v0 & 0x8000) == 0) {
					...
					if (v8) {
						...
						if ((_WORD)v0) {
							if ((_WORD)v0 == v8) {
								v0 = nox_xxx_unitDefGet_4E3B70(*(unsigned __int16*)(v1 + 4));
								v9 = *(_DWORD*)(v1 + 748);
								v10 = *(_DWORD*)(v9 + 484);
...
//----- (004E44F0) --------------------------------------------------------
int __cdecl nox_xxx_unitNeedSync_4E44F0(int a1) {
	int result; // eax
...
//----- (004E4560) --------------------------------------------------------
int __cdecl nox_xxx_unitSetHP_4E4560(int a1, unsigned __int16 a2) {
	int result; // eax
	int v3;     // eax
	int v4;     // eax
	int* v5;    // eax
		...
		**(_WORD**)(a1 + 556) = a2;
		...
		if (v4 & 2 && (*(_BYTE*)(a1 + 12) & 0x80)) {
			if (v4 & 0x20400004) {
				...
				nox_xxx_unitDefGet_4E3B70(*(unsigned __int16*)(a1 + 4));
				v8 = sub_4E4C90(a1, 2u);
...
//----- (004E4670) --------------------------------------------------------
int* __cdecl nox_xxx_unitSetOnOff_4E4670(int a1, int a2) {
	int v2;          // eax
	unsigned int v3; // eax
	int* result;     // eax
	int v5;          // ecx
...
//----- (004E46F0) --------------------------------------------------------
void __cdecl nox_xxx_unitRaise_4E46F0(int a1, float a2) {
	int* v2; // eax
	int v3;  // ecx
	int v4;  // edx
	int v5;  // eax
...
//----- (004E4780) --------------------------------------------------------
int* __cdecl nox_xxx_unitUnsetXStatus_4E4780(int a1, int a2) {
	int* result; // eax
	int v3;      // ecx
	int v4;      // edx
	int v5;      // eax
...
//----- (004E4800) --------------------------------------------------------
int* __cdecl nox_xxx_unitSetXStatus_4E4800(int a1, int* a2) {
	int* result; // eax
	int v3;      // ecx
	int v4;      // edx
	int v5;      // eax
...
//----- (004E4880) --------------------------------------------------------
int* __cdecl nox_xxx_servMarkObjAnimFrame_4E4880(int a1, int a2) {
	int* result; // eax
	int v3;      // ecx
	int v4;      // edx
	int v5;      // eax
...
//----- (004E48F0) --------------------------------------------------------
int* __cdecl nox_xxx_setUnitBuffFlags_4E48F0(int a1, int a2) {
	char v2;     // cl
	int* result; // eax
	int v4;      // ecx
	int v5;      // edx
	...
	*(_DWORD*)(a1 + 340) = a2;
	if (v2 & 4)
		nox_xxx_playerUpdateNetBuffs_56F7D0(*(_DWORD*)(*(_DWORD*)(*(_DWORD*)(a1 + 748) + 276) + 4612), a2);
	if (*(_DWORD*)(a1 + 8) & 0x20400004) {
		result = (int*)(a1 + 560);
		v4 = 32;
		do {
...
//----- (004E4990) --------------------------------------------------------
int* __cdecl nox_xxx_modifSetItemAttrs_4E4990(int a1, int* a2) {
	int v2;      // eax
	int v3;      // edx
	int* result; // eax
	int v5;      // ecx
	...
	LABEL_19:
		...
		if (!*getMemU32Ptr(0x5D4594, 1564960)) {
			result = (int*)nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 202316));
...
//----- (004E4A70) --------------------------------------------------------
double __cdecl nox_xxx_objectGetMass_4E4A70(int a1) { return *(float*)(a1 + 120); }

//----- (004E4A80) --------------------------------------------------------
int __cdecl sub_4E4A80(int a1) { return *(_DWORD*)(a1 + 340); }

//----- (004E4A90) --------------------------------------------------------
int* __cdecl nox_xxx_setNPCColor_4E4A90(int a1, unsigned __int8 a2, int a3) {
	int v3;      // edi
	int v4;      // eax
	int* result; // eax
	int v6;      // ecx
...
//----- (004E4B20) --------------------------------------------------------
int* __cdecl nox_xxx_npcSetItemEquipFlags_4E4B20(int a1, int a2, int a3) {
	int v3;      // esi
	int v4;      // ecx
	int v5;      // ecx
	int* result; // eax
...
int __cdecl sub_4E4C50(int a1) {
	...
	if (a1 && (v1 = nox_xxx_unitDefGet_4E3B70(*(unsigned __int16*)(a1 + 4))) != 0)
...
BOOL __cdecl sub_4E4C90(int a1, unsigned int a2) {
	...
	v2 = (_DWORD*)nox_xxx_unitDefGet_4E3B70(*(unsigned __int16*)(a1 + 4));
	if (a2 > 0x20) {
		if (a2 > 0x200) {
...
int sub_4E4DE0() {
	...
	if (*getMemU32Ptr(0x5D4594, 1565508))
		nox_free_alloc_class(*(LPVOID*)getMemAt(0x5D4594, 1565508));
...
int __cdecl sub_4E4E50(int a1) {
	...
	if (v2 > 2u)
		...
		*((_DWORD*)v3 + 2) = 0;
	result = v2 * *v3 * (*getMemU32Ptr(0x5D4594, 2649704) / v1);
	*((_DWORD*)v3 + 1) = result;
	return result;
}
...
//----- (004E4F40) --------------------------------------------------------
int __cdecl nox_xxx_playerResetImportantCtr_4E4F40(int a1) {
	int v1; // esi

	v1 = 12 * a1;
	*getMemU8Ptr(0x5D4594, 1565124 + 1 + v1) = 2;
	*getMemU8Ptr(0x5D4594, 1565124 + v1) = 1;
	*getMemU8Ptr(0x5D4594, 1565124 + 2 + v1) = nox_xxx_rateGet_40A6C0();
...
void __cdecl sub_4E4FC0(int a1) {
	...
	if (v1)
		*(_DWORD*)(v1 + 408) = *(_DWORD*)(a1 + 408);
		...
		dword_5d4594_1565512 = *(_DWORD*)(a1 + 408);
	v2 = *(_DWORD*)(a1 + 408);
	if (v2)
		*(_DWORD*)(v2 + 412) = *(_DWORD*)(a1 + 412);
	else
		dword_5d4594_1565516 = *(_DWORD*)(a1 + 412);
	nox_xxx_memDeleteAdv_414330(*(unsigned int**)getMemAt(0x5D4594, 1565508), (_QWORD*)a1);
}

//----- (004E5030) --------------------------------------------------------
int __cdecl nox_xxx_netSendPacket_4E5030(int a1, const void* a2, signed int a3, int a4, int a5, char a6) {
	char* v7;             // eax
	char* v8;             // edx
	_WORD* v9;            // esi
	char v10;             // cl
	...
	if (a1 == 255 || (a1 & 0x80u) == 0 || dword_5d4594_2649712 & ~(1 << (a1 & 0x7F))) {
		...
		if (!v8) {
			if (nox_xxx_importantCheckRate_4E52B0() != 1)
				return 0;
			v8 = (char*)nox_alloc_class_new_obj_zero(*(_DWORD**)getMemAt(0x5D4594, 1565508));
			if (!v8)
				return 0;
		}
		memcpy(v8 + 251, a2, a3);
		...
		*((_DWORD*)v8 + 44) = dword_5d4594_2649712;
		memset(v8 + 4, 0, 0x80u);
		v9 = v8 + 186;
		*(_DWORD*)v8 = *getMemU32Ptr(0x5D4594, 2598000);
		...
		*((_DWORD*)v8 + 103) = 0;
		*((_DWORD*)v8 + 102) = dword_5d4594_1565512;
		if (dword_5d4594_1565512) {
			*(_DWORD*)(dword_5d4594_1565512 + 412) = v8;
...
//----- (004E5360) --------------------------------------------------------
char* __cdecl nox_xxx_playerKickDueToRate_4E5360(int a1) {
	char* result; // eax
	char* v2;     // esi
...
//----- (004E5390) --------------------------------------------------------
int __cdecl nox_xxx_netSendPacket1_4E5390(int a1, int a2, int a3, int a4, int a5) {
...
//----- (004E5420) --------------------------------------------------------
int __cdecl nox_xxx_netSendPacket0_4E5420(int a1, const void* a2, signed int a3, int a4, int a5) {
...
//----- (004E5670) --------------------------------------------------------
unsigned int __cdecl nox_xxx_importantCheckRate2_4E5670(unsigned __int8 a1) {
	int v1;              // ebp
	int v2;              // eax
	int v3;              // ecx
	char v4;             // al
...
//----- (004E5770) --------------------------------------------------------
void __cdecl nox_xxx_netImportant_4E5770(unsigned __int8 a1, int a2) {
	int v2;                                         // edi
	char* v3;                                       // esi
	int v4;                                         // ebp
	int v5;                                         // eax
	...
	if (!v3 || !nox_common_gameFlags_check_40A5C0(1) || v3[3680] & 0x10) {
		...
		if (dword_5d4594_1565516) {
			while (1) {
				...
				v7 = *(_DWORD*)(v4 + 404);
				if (v7 && !(v2 & *(_DWORD*)(v7 + 148)) || *(_DWORD*)(v4 + 180) && !(v2 & dword_5d4594_2649712)) {
					sub_4E54D0(v2, v4, a1);
					return;
				}
				if (!(v2 & *(_DWORD*)(v4 + 172)))
		...
		LABEL_24:
			if (v15) {
				if (a2 && a1 != 31) {
					...
					v18[0] = -86;
					*(_DWORD*)&v18[1] = *getMemU32Ptr(0x5D4594, 2598000);
					if (!v13(a1, a2, v18, 5))
						return;
				}
				v15 = 0;
			...
			LABEL_36:
				if (v11) {
					*(_DWORD*)(v4 + 172) |= v2;
					*(_BYTE*)(a1 + v4 + 132) =
						*getMemU32Ptr(0x5D4594, 2649704) * (unsigned int)getMemByte(0x5D4594, 1565124 + 1 + 12 * a1) / nox_xxx_rateGet_40A6C0();
...
//----- (004E5B50) --------------------------------------------------------
BOOL __cdecl nox_xxx_isUnit_4E5B50(int a1) {
	int v1;      // ecx
	BOOL result; // eax
...
BOOL __cdecl sub_4E5B80(int a1) {
	...
	if (!*getMemU32Ptr(0x5D4594, 1565592))
		*getMemU32Ptr(0x5D4594, 1565592) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 202376));
	result = 0;
	if (a1) {
		if (*(_BYTE*)(a1 + 8) & 1) {
			if (nox_common_gameFlags_check_40A5C0(2048)) {
				if (*(unsigned __int16*)(a1 + 4) == *getMemU32Ptr(0x5D4594, 1565592)) {
...
void __cdecl sub_4E5BF0(int a1) {
	...
	if (!*getMemU32Ptr(0x5D4594, 1565596))
		*getMemU32Ptr(0x5D4594, 1565596) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 202384));
	v1 = nox_server_getFirstObject_4DA790();
	if (v1) {
		do {
			v2 = nox_server_getNextObject_4DA7A0(v1);
			if (!a1 || !(*(_BYTE*)(v1 + 8) & 4) && ((v3 = *(_DWORD*)(v1 + 492)) == 0 || !(*(_BYTE*)(v3 + 8) & 4)) &&
						   (*(unsigned __int16*)(v1 + 4) != *getMemU32Ptr(0x5D4594, 1565596) ||
							(v4 = *(_DWORD*)(v1 + 508)) == 0 || !(*(_BYTE*)(v4 + 8) & 4)) &&
...
//----- (004E5CC0) --------------------------------------------------------
void __cdecl nox_xxx_delayedDeleteObject_4E5CC0(int a1) {
	int v1; // eax
	int v2; // eax
	...
	if (a1 && !(*(_BYTE*)(a1 + 16) & 0x20)) {
		...
		*(_DWORD*)(a1 + 456) = *getMemU32Ptr(0x5D4594, 2598000);
...
//----- (004E5E80) --------------------------------------------------------
int __cdecl nox_xxx_unitDeleteFinish_4E5E80(_DWORD* a1) {
...
//----- (004E5EC0) --------------------------------------------------------
_DWORD* nox_xxx_finalizeDeletingUnits_4E5EC0() {
	_DWORD* result; // eax
	_DWORD* v1;     // esi
...
void __cdecl sub_4E5F00(int(__cdecl* a1)(int, int), int a2) {
	...
	for (i = *getMemU32Ptr(0x5D4594, 1565588); i; i = *(_DWORD*)(i + 452)) {
		if (*(_DWORD*)(i + 456) != *getMemU32Ptr(0x5D4594, 2598000))
			a1(i, a2);
	}
}
...
int __cdecl sub_4E5F40(int a1) {
	...
	if (!*getMemU32Ptr(0x5D4594, 1565600))
		*getMemU32Ptr(0x5D4594, 1565600) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 202396));
	result = nox_server_getFirstObject_4DA790();
	for (i = result; result; i = result) {
		if (nox_xxx_unitHasThatParent_4EC4F0(i, a1) && *(unsigned __int16*)(i + 4) == *getMemU32Ptr(0x5D4594, 1565600) &&
			!(*(_BYTE*)(i + 16) & 0x20)) {
...
//----- (004E6040) --------------------------------------------------------
int __cdecl nox_xxx_playerCameraUnlock_4E6040(int a1) {
	int result; // eax
...
//----- (004E6060) --------------------------------------------------------
int __cdecl nox_xxx_playerCameraFollow_4E6060(int a1, int a2) {
	int result; // eax
...
//----- (004E60A0) --------------------------------------------------------
char* __cdecl nox_xxx_playerLeaveObsByObserved_4E60A0(int a1) {
	char* result; // eax
	int i;        // esi
...
//----- (004E60E0) --------------------------------------------------------
int __cdecl nox_xxx_playerLeaveMonsterObserver_4E60E0(int a1) {
	int result; // eax
	int v2;     // edi

	result = *(_DWORD*)(a1 + 2056);
	if (result) {
		if (nox_xxx_playerGetPossess_4DDF30(*(_DWORD*)(a1 + 2056))) {
			v2 = nox_xxx_playerObserverFindGoodSlave0_4E6280(a1);
			if (!v2)
				return nox_xxx_playerObserveClear_4DDEF0(*(_DWORD*)(a1 + 2056));
		} else {
			v2 = sub_4E6150(a1);
		}
		nox_xxx_playerCameraUnlock_4E6040(*(_DWORD*)(a1 + 2056));
		result = nox_xxx_playerCameraFollow_4E6060(*(_DWORD*)(a1 + 2056), v2);
	}
	return result;
}
...
int __cdecl sub_4E6150(int a1) {
	...
	if (!dword_5d4594_1565616)
		dword_5d4594_1565616 = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 202408));
	v1 = *(_DWORD*)(a1 + 3628);
	if (v1) {
		if (*(_BYTE*)(v1 + 8) & 4) {
			v2 = nox_xxx_getNextPlayerUnit_4DA7F0(*(_DWORD*)(a1 + 3628));
			goto LABEL_7;
		}
...
LABEL_7:
	...
	if (*(_BYTE*)(v2 + 8) & 4) {
		while (1) {
			v4 = nox_common_playerInfoGetByID_417040(*(_DWORD*)(i + 36));
	...
	LABEL_16:
		...
		for (i = nox_xxx_getFirstPlayerUnit_4DA7C0(); i; i = nox_xxx_getNextPlayerUnit_4DA7F0(i)) {
			v6 = nox_common_playerInfoGetByID_417040(*(_DWORD*)(i + 36));
...
int sub_4E6230() {
	...
	if (!dword_5d4594_1565616)
		dword_5d4594_1565616 = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 202420));
	result = nox_server_getFirstObject_4DA790();
	if (!result)
		return 0;
...
//----- (004E6280) --------------------------------------------------------
int __cdecl nox_xxx_playerObserverFindGoodSlave0_4E6280(int a1) {
	int result; // eax

	if (*(_DWORD*)(a1 + 3628))
		result = nox_xxx_playerObserverFindGoodSlave_4EC420(*(_DWORD*)(a1 + 3628));
	else
		result = nox_xxx_playerObserverFindGoodSlave2_4EC3E0(*(_DWORD*)(a1 + 2056));
	if (result) {
	...
	LABEL_9:
		for (result = nox_xxx_playerObserverFindGoodSlave2_4EC3E0(*(_DWORD*)(a1 + 2056)); result; result = nox_xxx_playerObserverFindGoodSlave_4EC420(result)) {
...
//----- (004E62F0) --------------------------------------------------------
unsigned __int8* __cdecl nox_xxx_updatePlayerObserver_4E62F0(int a1) {
	int v1;                  // edi
	int v2;                  // edx
	_DWORD* v3;              // eax
	int v4;                  // esi
	...
	result = nox_xxx_playerControlBufferFirst_51AB50(*(unsigned __int8*)(v4 + 2064));
	if (result) {
		*(_DWORD*)(v4 + 3688) = 0;
		result = nox_xxx_playerControlBufferFirst_51AB50(*(unsigned __int8*)(v4 + 2064));
		v9 = (int)result;
		if (result) {
			while (1) {
				...
				if (*(_DWORD*)(v9 + 8) != 6) {
					...
					if (!nox_xxx_playerGetPossess_4DDF30(v1) && !nox_common_gameFlags_check_40A5C0(4096)) {
						...
						*getMemU32Ptr(0x5D4594, 1565604) = v1;
						...
						if (dword_5d4594_1565612 && dword_5d4594_1565612 != *(_DWORD*)(v4 + 3628)) {
							nox_xxx_playerCameraFollow_4E6060(*(_DWORD*)(v4 + 2056), *(int*)&dword_5d4594_1565612);
							*(_DWORD*)(v4 + 3672) = 0;
						} else {
							nox_xxx_playerCameraUnlock_4E6040(*(_DWORD*)(v4 + 2056));
							*(_DWORD*)(v4 + 3672) = 1;
						}
						goto LABEL_72;
					}
				...
				if (dword_5d4594_2650652 && nox_common_gameFlags_check_40A5C0(49152) &&
					...
					nox_xxx_netInformTextMsg_4DA0F0(*(unsigned __int8*)(v4 + 2064), 17, 0);
					*(_DWORD*)(v9 + 16) = 0;
					goto LABEL_72;
				}
				...
				if (sub_40A740() || nox_common_gameFlags_check_40A5C0(0x8000) ||
					(v12 = *(_DWORD*)(v4 + 3680), BYTE1(v12) & 1) && (v13 = nox_xxx_gamePlayIsAnyPlayers_40A8A0(), v13)) {
					v11 = sub_40AA70(v4) == 0;
				LABEL_44:
					if (v11) {
					LABEL_45:
				...
				if (!nox_xxx_playerGetPossess_4DDF30(v1)) {
					...
					if (!nox_common_gameFlags_check_40A5C0(4096)) {
						nox_xxx_mapFindPlayerStart_4F7AB0(&v22, *(_DWORD*)(v4 + 2056));
						nox_xxx_unitMove_4E7010(*(_DWORD*)(v4 + 2056), &v22);
					}
				LABEL_52:
					*(_DWORD*)(v9 + 16) = 0;
					goto LABEL_72;
				...
				*(_DWORD*)(v9 + 16) = 0;
			LABEL_72:
				result = nox_xxx_playerGetControlBufferNext_51ABC0(*(unsigned __int8*)(v4 + 2064));
				v9 = (int)result;
				if (!result)
					goto LABEL_73;
			}
...
//----- (004E6860) --------------------------------------------------------
int __cdecl nox_xxx_playerGoObserver_4E6860(int a1, int a2, int a3) {
	int v3;          // edi
	int v4;          // eax
	int v5;          // ebp
	int i;           // esi
	...
	if (a1) {
		...
		if (v4) {
			...
			if (!a3 && nox_xxx_playerIsExecutingAbility_4FC2B0(v5) == 1)
				return 0;
			if (*(int(__cdecl**)(_DWORD*))(v5 + 744) == nox_xxx_updatePlayerMonsterBot_4FAB20)
				return 0;
			if (nox_common_gameFlags_check_40A5C0(112)) {
				if (!*getMemU32Ptr(0x5D4594, 1565620))
					*getMemU32Ptr(0x5D4594, 1565620) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 202480));
				if (!dword_5d4594_1565616)
					dword_5d4594_1565616 = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 202488));
...
//----- (004E6AA0) --------------------------------------------------------
void __cdecl nox_xxx_playerLeaveObserver_0_4E6AA0(int a1) {
	int v1;    // esi
	int v2;    // edx
	int v3;    // eax
	_DWORD* i; // esi
	...
	if (a1) {
		v1 = *(_DWORD*)(a1 + 2056);
		if (v1) {
			if (*(int(__cdecl**)(_DWORD*))(v1 + 744) != nox_xxx_updatePlayerMonsterBot_4FAB20) {
				nox_xxx_playerUnsetStatus_417530(a1, 289);
				nox_xxx_spellBuffOff_4FF5B0(v1, 0);
				v2 = *(_DWORD*)(v1 + 16);
				*(_DWORD*)(v1 + 744) = nox_xxx_updatePlayer_4F8100;
				*(_DWORD*)(v1 + 16) = v2 & 0xFFFFFFBF;
				nox_xxx_monsterMarkUpdate_4E8020(*(_DWORD*)(a1 + 2056));
				if (nox_common_gameFlags_check_40A5C0(16)) {
					if (nox_xxx_CheckGameplayFlags_417DA0(4)) {
						v3 = *((_DWORD*)nox_xxx_clientGetTeamColor_418AB0(*(unsigned __int8*)(*(_DWORD*)(a1 + 2056) + 52)) + 19);
						if (v3) {
							if (!*(_DWORD*)(v3 + 492))
				...
				if (nox_common_gameFlags_check_40A5C0(4096)) {
					for (i = (_DWORD*)nox_xxx_getFirstPlayerUnit_4DA7C0(); i; i = (_DWORD*)nox_xxx_getNextPlayerUnit_4DA7F0((int)i)) {
						if (*(_DWORD*)(*(_DWORD*)(i[187] + 276) + 4792) == 1)
							nox_xxx_netReportEnchant_4D8F90(*(unsigned __int8*)(a1 + 2064), i);
					}
				}
			}
		}
...
BOOL __cdecl sub_4E6BD0(int a1) {
	return *(_DWORD*)(a1 + 556) && (unsigned int)(*getMemU32Ptr(0x5D4594, 2598000) - *(_DWORD*)(a1 + 536)) <= 1;
}

//----- (004E6C00) --------------------------------------------------------
long double __cdecl nox_xxx_calcDistance_4E6C00(int a1, int a2) {
	double v2;          // st7
	double v3;          // st6
	int v4;             // edx
	long double v5;     // st5
...
int __cdecl nox_server_testTwoPointsAndDirection_4E6E50(float2* a1, int a2, float2* a3) {
	...
	return *getMemU32Ptr(0x587000, 4 * (sub_4E6CE0(a1, a3) + 16 * v3) + 202504);
}
...
void __cdecl sub_4E6EF0(int a1, _DWORD* a2) {
	...
	if (!(*(_BYTE*)(a1 + 16) & 0x20) && !nox_xxx_unitsHaveSameTeam_4EC520(a1, a2[9]) &&
		(!(*(_BYTE*)(a1 + 8) & 4) || !(*(_BYTE*)(*(_DWORD*)(*(_DWORD*)(a1 + 748) + 276) + 3680) & 1)) &&
		(!a2[2] || nox_xxx_unitIsEnemyTo_5330C0(a2[9], a1))) {
		if (nox_server_testTwoPointsAndDirection_4E6E50((float2*)(a2[9] + 56), *(__int16*)(a2[9] + 124),
														(float2*)(a1 + 56)) &
			*a2) {
			v2 = a2[9];
...
//----- (004E7010) --------------------------------------------------------
void __cdecl nox_xxx_unitMove_4E7010(int a1, float2* a2) {
	int v2;     // edi
	int v3;     // ecx
	int v4;     // eax
	...
	if (a1 && !(*(_DWORD*)(a1 + 8) & 0x400000)) {
		...
		*(float2*)(a1 + 72) = *a2;
		...
		if (*(_BYTE*)(a1 + 8) & 4 && nox_common_gameFlags_check_40A5C0(0x2000)) {
			v2 = *(_DWORD*)(a1 + 748);
			v3 = *(_DWORD*)(v2 + 276);
			*(_DWORD*)(v2 + 272) = *getMemU32Ptr(0x5D4594, 2598000);
			sub_4DE4D0(*(_BYTE*)(v3 + 2064));
			v5[0] = -22;
			*(_DWORD*)&v5[1] = *getMemU32Ptr(0x5D4594, 2598000);
			nox_xxx_netSendPacket1_4E5390(*(unsigned __int8*)(*(_DWORD*)(v2 + 276) + 2064), (int)v5, 5, 0, 0);
		}
		if (*(_BYTE*)(a1 + 8) & 4) {
...
//----- (004E7190) --------------------------------------------------------
void __cdecl nox_xxx_teleportToMB_4E7190(_BYTE* a1, float* a2) {
...
void __cdecl sub_4E71F0(int a1) {
	...
	if (v2) {
		v3 = v1[4];
		v4[0] = v2;
		nox_xxx_spellAccept_4FD400(v1[3], v1[2], (_DWORD*)*v1, *v1, v4, v3);
	}
	nox_xxx_delayedDeleteObject_4E5CC0(a1);
}

//----- (004E7290) --------------------------------------------------------
int __cdecl nox_xxx_objectUnkUpdateCoords_4E7290(int a1) {
	int result; // eax
	int v2;     // ecx
	int v3;     // edx
	int v4;     // ecx
...
//----- (004E7410) --------------------------------------------------------
BOOL __cdecl nox_xxx_unused_4E7410(int a1) {
	if (*(_BYTE*)(a1 + 16) & 0x40)
		return 1;
...
//----- (004E7470) --------------------------------------------------------
void __cdecl nox_xxx_spawnSomeBarrel_4E7470(int a1, int a2) {
	const char* v2;      // eax
	...
	if (a1) {
		if (a2) {
			if (*(_BYTE*)(a1 + 8) & 4 && *(_BYTE*)(a2 + 8) & 4 && a1 != a2) {
				v3 = *(_DWORD*)(a2 + 748);
				*(_DWORD*)(*(_DWORD*)(v3 + 276) + 3604) =
					*(unsigned __int8*)(*(_DWORD*)(*(_DWORD*)(a1 + 748) + 276) + 2064);
				*(_DWORD*)(*(_DWORD*)(v3 + 276) + 3608) = *getMemU32Ptr(0x5D4594, 2598000);
...
//----- (004E75B0) --------------------------------------------------------
char __cdecl nox_xxx_objectSetOn_4E75B0(int a1) {
	int v1; // eax
	int v2; // eax
...
//----- (004E7600) --------------------------------------------------------
int __cdecl nox_xxx_objectSetOff_4E7600(int a1) {
	int v1;     // eax
	int result; // eax
...
//----- (004E7650) --------------------------------------------------------
char __cdecl nox_xxx_objectToggle_4E7650(int a1) {
	char result; // al
...
int __cdecl sub_4E7700(int a1) {
	...
	result = *(_DWORD*)(a1 + 340) ^ *(_DWORD*)(a1 + 248) ^ *(_DWORD*)(a1 + 120) ^ *(_DWORD*)(a1 + 128) ^
			 *(_DWORD*)(a1 + 132) ^ *(_DWORD*)(a1 + 136) ^ *(_DWORD*)(a1 + 148) ^ *(_DWORD*)(a1 + 152) ^
			 *(__int16*)(a1 + 124) ^ *(__int16*)(a1 + 126) ^ *(_DWORD*)(a1 + 108) ^ *(_DWORD*)(a1 + 104) ^
			 *(_DWORD*)(a1 + 100) ^ *(_DWORD*)(a1 + 96) ^ *(_DWORD*)(a1 + 92) ^ *(_DWORD*)(a1 + 88) ^
			 *(_DWORD*)(a1 + 84) ^ *(_DWORD*)(a1 + 80) ^ *(_DWORD*)(a1 + 76) ^ *(_DWORD*)(a1 + 72) ^
			 *(_DWORD*)(a1 + 68) ^ *(_DWORD*)(a1 + 64) ^ *(_DWORD*)(a1 + 60) ^ *(_DWORD*)(a1 + 16) ^
			 *(_DWORD*)(a1 + 20) ^ *(_DWORD*)(a1 + 36) ^ *(_DWORD*)(a1 + 40) ^ *(_DWORD*)(a1 + 44) ^
			 *(_DWORD*)(a1 + 56) ^ *(unsigned __int16*)(a1 + 4) ^ *(unsigned __int8*)(a1 + 52);
	if (v1)
		result ^= *v1 ^ v1[1] ^ v1[2];
	return result;
}
...
//----- (004E7980) --------------------------------------------------------
int __cdecl nox_xxx_inventoryGetFirst_4E7980(int a1) { return *(_DWORD*)(a1 + 504); }

//----- (004E7990) --------------------------------------------------------
int __cdecl nox_xxx_inventoryGetNext_4E7990(int a1) {
	int result; // eax
...
//----- (004E79C0) --------------------------------------------------------
char __cdecl nox_xxx_unitFreeze_4E79C0(int a1, int a2) {
	int v2; // eax
	int i;  // esi
...
//----- (004E7A60) --------------------------------------------------------
char __cdecl nox_xxx_unitUnFreeze_4E7A60(int a1, int a2) {
	int v2; // eax
	int i;  // esi
...
//----- (004E7B00) --------------------------------------------------------
void __cdecl nox_xxx_unitBecomePet_4E7B00(int a1, int a2) {
	int v2; // ecx
	int v3; // edi
	...
	if (a1) {
		if (a2) {
			...
			LOBYTE(v2) = v2 | 0x80;
			*(_DWORD*)(a2 + 12) = v2;
			nox_xxx_netMonitorCreature_4D9250(*(unsigned __int8*)(*(_DWORD*)(v3 + 276) + 2064), a2);
			nox_xxx_netMarkMinimapObject_417190(*(unsigned __int8*)(*(_DWORD*)(v3 + 276) + 2064), a2, 1);
...
//----- (004E7B60) --------------------------------------------------------
void __cdecl nox_xxx_monsterRemoveMonitors_4E7B60(int a1, _DWORD* a2) {
	int v2; // edi
	int v3; // edx
	...
	if (a1) {
		if (a2) {
			...
			LOBYTE(v3) = v3 & 0x7F;
			a2[3] = v3;
			nox_xxx_netSendUnMonitorCrea_4D92A0(*(unsigned __int8*)(*(_DWORD*)(v2 + 276) + 2064), a2);
			nox_xxx_netUnmarkMinimapObj_417300(*(unsigned __int8*)(*(_DWORD*)(v2 + 276) + 2064), (int)a2, 1);
...
//----- (004E7BE0) --------------------------------------------------------
int __cdecl nox_xxx_unitIsCrown_4E7BE0(int a1) {
	int v1; // eax
	int v2; // ecx

	v1 = *getMemU32Ptr(0x5D4594, 1567716);
	if (!*getMemU32Ptr(0x5D4594, 1567716)) {
		v1 = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 203892));
...
//----- (004E7C30) --------------------------------------------------------
int __cdecl nox_xxx_unitIsGameball_4E7C30(int a1) {
	int v1; // eax
	int v2; // ecx

	v1 = *getMemU32Ptr(0x5D4594, 1567720);
	if (!*getMemU32Ptr(0x5D4594, 1567720)) {
		v1 = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 203900));
...
//----- (004E7C80) --------------------------------------------------------
int __cdecl nox_xxx_unitIsUnitTT_4E7C80(int a1, int a2) {
	int result; // eax
	int i;      // ecx
...
//----- (004E7CF0) --------------------------------------------------------
int __cdecl nox_xxx_unitCountSlaves_4E7CF0(int a1, int a2, int a3) {
	int result; // eax
	_DWORD* i;  // ecx
...
//----- (004E7D30) --------------------------------------------------------
int __cdecl nox_xxx_inventoryCountObjects_4E7D30(int a1, int a2) {
	int result; // eax
	int i;      // ecx
...
//----- (004E7F10) --------------------------------------------------------
char* __cdecl nox_xxx_unitPostCreateNotify_4E7F10(int a1) {
	char* result; // eax
	int i;        // edi
	int v3;       // eax
	int v4;       // esi
...
//----- (004E7F90) --------------------------------------------------------
int __cdecl nox_xxx_unitIsHostileMimic_4E7F90(int a1, int a2) {
	int v2; // ebx

	v2 = 0;
	if (!*getMemU32Ptr(0x5D4594, 1567724))
		*getMemU32Ptr(0x5D4594, 1567724) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 203912));
	if (!a1 || !a2)
		return 0;
	if (!nox_xxx_unitIsEnemyTo_5330C0(a1, a2))
		v2 = 1;
	if (nox_common_gameFlags_check_40A5C0(4096) && *(unsigned __int16*)(a2 + 4) == *getMemU32Ptr(0x5D4594, 1567724) &&
		*(_BYTE*)(a1 + 8) & 4 && !*(_DWORD*)(a2 + 508)) {
		v2 = 0;
	}
	return v2;
}
...
//----- (004E8020) --------------------------------------------------------
char* __cdecl nox_xxx_monsterMarkUpdate_4E8020(int a1) {
	char* result; // eax
	int v2;       // ebx
	int v3;       // eax
	int v4;       // edi
...
int __cdecl sub_4E81D0(int a1) {
	...
	if (!*getMemU32Ptr(0x5D4594, 1567728)) {
		result = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 203920));
...
//----- (004E8320) --------------------------------------------------------
unsigned __int8* __cdecl sub_4E8320(unsigned __int8 a1) { return getMemAt(0x5D4594, 6 * a1 + 1567740); }

//----- (004E8340) --------------------------------------------------------
void __cdecl nox_xxx_fnFindCloseDoors_4E8340(float* a1, int a2) {
	int v2; // eax
...
//----- (004E83B0) --------------------------------------------------------
unsigned __int8* __cdecl nox_xxx_collideMonsterEventProc_4E83B0(int a1, int a2) { return nox_xxx_scriptCallByEventBlock_502490((int*)(*(_DWORD*)(a1 + 748) + 1272), a2, a1); }

//----- (004E83D0) --------------------------------------------------------
unsigned __int8* __cdecl nox_xxx_collideMimic_4E83D0(int a1, int a2) {
	int v2;  // eax
	int* v3; // eax
	int* v4; // eax
	...
	if (a2) {
		v2 = *(_DWORD*)(a2 + 16);
		if ((v2 & 0x8000) == 0 && *(_BYTE*)(a2 + 8) & 6 && nox_xxx_unitIsEnemyTo_5330C0(a1, a2) && !nox_xxx_monsterIsActionScheduled_50A090(a1, 15)) {
			...
			if (v4) {
				v4[1] = *(_DWORD*)(a2 + 56);
				v4[2] = *(_DWORD*)(a2 + 60);
				v4[3] = *getMemU32Ptr(0x5D4594, 2598000);
			}
		}
	}
...
//----- (004E8460) --------------------------------------------------------
void __cdecl nox_xxx_collidePlayer_4E8460(int a1, int a2) {
	int v2;     // ecx
	_WORD* v3;  // eax
	int v4;     // ebx
	int v5;     // eax
	...
	if (nox_common_playerIsAbilityActive_4FC250(a1, 1)) {
		...
		if (!(v2 & 6) || (v3 = *(_WORD**)(a2 + 556), !*v3) && v3[2]) {
			if (!(v2 & 0x400000) && (signed char)*(_BYTE*)(a2 + 16) >= 0 &&
		...
		if ((v2 & 0x80u) == 0) {
			...
			LABEL_14:
				...
				if (a2) {
					...
					if (v7 && !(getMemByte(0x5D4594, 12332 * *(unsigned __int8*)(v7 + 1) + 2692780) & 5)) {
					LABEL_25:
		...
		if (*(_BYTE*)(a2 + 8) & 4) {
			...
			if ((v11 & 0x8000) == 0) {
				if (nox_xxx_testUnitBuffs_4FF350(a1, 16)) {
					if (nox_xxx_unitGetBuffTimer_4FF550(a1, 16) < (unsigned int)(14 * *getMemU32Ptr(0x5D4594, 2649704))) {
						v12 = nox_xxx_buffGetPower_4FF570(a1, 16);
						nox_xxx_buffApplyTo_4FF380(a2, 16, 15 * *getMemU16Ptr(0x5D4594, 2649704), v12);
...
//----- (004E87B0) --------------------------------------------------------
void __cdecl nox_xxx_collideProjectileGeneric_4E87B0(int a1, int a2) {
	int* v2;   // edi
	int v3;    // eax
	double v4; // st7
	int v5;    // ebx
	...
	if (!*getMemU32Ptr(0x5D4594, 1567948)) {
		*getMemU32Ptr(0x5D4594, 1567948) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 204012));
		*getMemU32Ptr(0x5D4594, 1567952) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 204028));
	}
...
//----- (004E8880) --------------------------------------------------------
void __cdecl nox_xxx_collideProjectileSpark_4E8880(int a1, int a2) {
	int* v2;  // eax
	int v3;   // eax
	int v4;   // eax
...
//----- (004E8910) --------------------------------------------------------
int __cdecl nox_xxx_doorGetSomeKey_4E8910(int a1, int a2) {
	int v2;         // ebx
	int v4;         // ebp
	const char* v5; // esi
...
LABEL_16:
	if (*(_BYTE*)(a1 + 8) & 4 && !v4 && nox_common_gameFlags_check_40A5C0(4096) && sub_4D72C0() == 1 &&
		*(_BYTE*)(v2 + 1) == 1)
		v4 = sub_4E8A10();
	return v4;
}
...
int sub_4E8A10() {
	...
	if (!dword_5d4594_1567956)
		dword_5d4594_1567956 = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 204112));
	for (i = nox_xxx_getFirstPlayerUnit_4DA7C0(); i; i = nox_xxx_getNextPlayerUnit_4DA7F0(i)) {
		v2 = 0;
		v3 = nox_xxx_inventoryGetFirst_4E7980(i);
		if (v3) {
			do {
				if (*(unsigned __int16*)(v3 + 4) == dword_5d4594_1567956)
					++v2;
	...
	if (v0) {
		for (result = nox_xxx_inventoryGetFirst_4E7980(v0); result; result = nox_xxx_inventoryGetNext_4E7990(result)) {
			if (*(unsigned __int16*)(result + 4) == dword_5d4594_1567956)
				break;
		}
	}
	return result;
...
//----- (004E8AC0) --------------------------------------------------------
void __cdecl nox_xxx_collideDoor_4E8AC0(int a2, int a3) {
	int v2;               // edi
	int v3;               // esi
	int v4;               // eax
	...
	if (a3 && *(_DWORD*)(v3 + 12) == *(_DWORD*)(v3 + 4)) {
		...
		*(_BYTE*)(v3 + 1) = 0;
		...
		if (v16 && a3 != v16 && *(_BYTE*)(v16 + 8) & 4 && nox_common_gameFlags_check_40A5C0(4096) && sub_4D72C0() == 1)
			nox_xxx_netPriMsgToPlayer_4DA2C0(*(_DWORD*)(v8 + 492), "GeneralPrint:KeyShared1", 0);
		nox_xxx_delayedDeleteObject_4E5CC0(v8);
	}
}

//----- (004E8DF0) --------------------------------------------------------
int __cdecl nox_xxx_collidePickup_4E8DF0(int a1, int a2) {
	int result; // eax
	int v3;     // ecx
	...
	if (a2) {
		v3 = *(_DWORD*)(a2 + 8);
		if (!(v3 & 2) &&
			(unsigned int)(*getMemU32Ptr(0x5D4594, 2598000) - *(_DWORD*)(a1 + 128)) >= *getMemIntPtr(0x5D4594, 2649704) >>
				1 &&
...
//----- (004E8E50) --------------------------------------------------------
unsigned __int8* sub_4E8E50() { return getMemAt(0x5D4594, 1567844); }
...
//----- (004E9090) --------------------------------------------------------
char* __cdecl nox_xxx_collideExit_4E9090(int a1, int a2, int a3) {
	char* result;     // eax
	int v4;           // ebp
	int v5;           // esi
	_BYTE* v6;        // edi
	...
	result = *(char**)&dword_5d4594_1567960;
	if (!dword_5d4594_1567960) {
		result = (char*)nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 204360));
		dword_5d4594_1567960 = result;
	}
	v4 = a2;
	if (a2) {
		if (!(*(_BYTE*)(a2 + 8) & 4)) {
		...
		if (!nox_common_gameFlags_check_40A5C0(4096) ||
			(result = *(char**)(v5 + 312)) == 0 && (result = *(char**)(v5 + 316)) == 0) {
							...
							if (*v6 || (result = (char*)nox_common_gameFlags_check_40A5C0(4096)) != 0) {
								if (*(_BYTE*)(*(_DWORD*)(v5 + 276) + 2251) == 1) {
									for (i = *(_DWORD*)(v4 + 516); i; i = *(_DWORD*)(i + 512)) {
										if (*(unsigned __int16*)(i + 4) == dword_5d4594_1567960 &&
											!*(_DWORD*)(i + 492)) {
											nox_xxx_delayedDeleteObject_4E5CC0(i);
											v8 = *(_BYTE*)(v5 + 244);
											if (v8)
								...
								if (v13 & 1) {
									...
									if (*(_DWORD*)(v15 + 4696) < v14) {
										*(_DWORD*)(v15 + 4696) = v14;
										sub_4D7450(*(unsigned __int8*)(*(_DWORD*)(v5 + 276) + 2064),
												   *(_DWORD*)(*(_DWORD*)(v5 + 276) + 4696));
									}
									*(_DWORD*)(v5 + 312) = a1;
									*(_DWORD*)(v5 + 316) = 0;
									nox_xxx_playerSetState_4FA020((_DWORD*)v4, 13);
									nox_xxx_playerGoObserver_4E6860(*(_DWORD*)(v5 + 276), 0, 0);
									nox_xxx_netInformTextMsg2_4DA180(18, (_BYTE*)(v4 + 36));
									v12 = a1;
									v9 = sub_4E9010();
								} else if (v13 & 2) {
									*(_DWORD*)(v5 + 312) = 0;
									*(_DWORD*)(v5 + 316) = a1;
									sub_4D75F0(*getMemIntPtr(0x5D4594, 2598000));
									nox_xxx_playerSetState_4FA020((_DWORD*)v4, 13);
									nox_xxx_playerGoObserver_4E6860(*(_DWORD*)(v5 + 276), 0, 0);
									for (j = nox_xxx_getFirstPlayerUnit_4DA7C0(); j; j = nox_xxx_getNextPlayerUnit_4DA7F0(j)) {
										if (j != v4)
											nox_xxx_netInformTextMsg_4DA0F0(
												*(unsigned __int8*)(*(_DWORD*)(*(_DWORD*)(j + 748) + 276) + 2064), 19,
												(int*)(v4 + 36));
									}
...
//----- (004E9430) --------------------------------------------------------
void __cdecl nox_xxx_collideDamage_4E9430(int a1, int a2) {
	...
	if (a2 && *(_DWORD*)(a2 + 556)) {
		if (*v2 == 1 && getMemByte(0x5D4594, 2598000) & 1)
			v3 = 1;
		else
			v3 = *v2 >> 1;
		v6 = *((_DWORD*)v2 + 1);
...
//----- (004E9490) --------------------------------------------------------
_DWORD* __cdecl nox_xxx_collideManadrain_4E9490(int a1, int a2) {
	_DWORD* result; // eax

	result = (_DWORD*)a2;
	if (a2 && *(_BYTE*)(a2 + 8) & 4 && *(_WORD*)(*(_DWORD*)(a2 + 748) + 4)) {
		nox_xxx_playerManaSub_4EEBF0(a2, **(unsigned __int8**)(a1 + 700));
		result = (_DWORD*)(*getMemU32Ptr(0x5D4594, 2598000) - *(__int16*)(a1 + 542));
		if ((unsigned int)result > *getMemIntPtr(0x5D4594, 2649704) >> 1) {
			result = nox_xxx_aud_501960(228, a1, 0, 0);
			*(_WORD*)(a1 + 542) = *getMemU16Ptr(0x5D4594, 2598000);
		}
	}
	return result;
}
...
/*void __cdecl nox_xxx_spellFlyCollide_4E9500(int a1, int a2, float *a3)
{
  int v3; // esi
  float2 *v4; // edi
  int v5; // ebx
  ...
  if ( a2 )
  {
	...
	if ( !(*(_BYTE *)(a2 + 8) & 4) )
	  goto LABEL_23;
	v6 = *(_DWORD *)(a2 + 748);
	if ( *(_BYTE *)(v6 + 88) == 16 && nox_xxx_checkReflectShield_4E6E50((float2 *)(a2 + 56), *(__int16 *)(a2 + 124), (float2 *)(a1 + 72)) & 1 )
	{
	...
	if ( *(_BYTE *)(v6 + 88) == 13 || (!*(_BYTE *)(v6 + 88) && dword_980858[0] & 0x40000 ) )
	{
	  ...
	  if ( v7 & 0x400 )
	  {
	if ( nox_xxx_checkReflectShield_4E6E50((float2 *)(v3 + 56), *(__int16 *)(v3 + 124), v4 + 9) & 1 )
	{
	  v8 = nox_xxx_randInt_415FA0(18, 20);
	  nox_xxx_aud_501960(890, v3, 0, 0);
	  nox_xxx_projectileReflect_4E0A70((int)v4, v3);
	  nox_xxx_changeOwner_52BE40((int)v4, v3);
	  nox_xxx_playerSetState_4FA020((_DWORD *)v3, v8);
...
M_LABEL_13:
	...
	if ( nox_xxx_testUnitBuffs_4FF350(v3, 27) && nox_xxx_checkReflectShield_4E6E50((float2 *)(v3 + 56), *(__int16 *)(v3 + 124), v4 + 7) & 1 )
	{
	  nox_xxx_changeOwner_52BE40((int)v4, v3);
...
LABEL_23:
	  ...
	  {
	v11[0] = v3;
	nox_xxx_spellAccept_4FD400(*(_DWORD *)(v5 + 12), *(_DWORD *)(v5 + 8), *(_DWORD **)v5, (int)v4, v11, *(_DWORD *)(v5 + 16));
...
void __cdecl nox_xxx_spellFlyCollide_4E9500(int a1, int a2, float* a3) {
	...
	if (*(_BYTE*)(a2 + 8) & 4) {
		v6 = *(_DWORD*)(a2 + 748);
		if (*(_BYTE*)(v6 + 88) != 16) {
			if (*(_BYTE*)(v6 + 88) != 1 || nox_common_mapPlrActionToStateId_4FA2B0(a2) != 45 ||
			...
			LABEL_22:
					...
					!*(_BYTE*)(v6 + 88) && mix_dword_980858[0] & 0x40000) // GREAT_SWORD_BLOKING_WALK
				{
					v7 = *(_DWORD*)(*(_DWORD*)(v6 + 276) + 4);
					if (v7 & 0x400 &&
						nox_server_testTwoPointsAndDirection_4E6E50((float2*)(v3 + 56), *(__int16*)(v3 + 124), v4 + 9) &
							1) {
			...
			LABEL_13:
				...
				if (nox_xxx_testUnitBuffs_4FF350(v3, 27) &&
					nox_server_testTwoPointsAndDirection_4E6E50((float2*)(v3 + 56), *(__int16*)(v3 + 124), v4 + 7) &
						1) {
					nox_xxx_changeOwner_52BE40((int)v4, v3);
					nox_xxx_aud_501960(122, v3, 0, 0);
					return;
...
LABEL_18:
	if (*(_DWORD*)(v5 + 4) == v3) {
		v12[0] = v3;
		nox_xxx_spellAccept_4FD400(*(_DWORD*)(v5 + 12), *(_DWORD*)(v5 + 8), *(_DWORD**)v5, (int)v4, v12, *(_DWORD*)(v5 + 16));
		nox_xxx_delayedDeleteObject_4E5CC0((int)v4);
	} else {
		nox_xxx_projectileReflect_4E0A70((int)v4, v3);
	}
...
//----- (004E96F0) --------------------------------------------------------
void __cdecl nox_xxx_collideBomb_4E96F0(int a1, int a2) {
	int v2; // ebx
	int v3; // eax
...
//----- (004E9770) --------------------------------------------------------
void __cdecl nox_xxx_collideBoom_4E9770(int a1, int a2, float* a3) {
	int v3;     // eax
	float v4;   // edx
	__int16 v5; // ax
	double v6;  // st7
	...
	if (!nox_common_gameFlags_check_40A5C0(4096) || (v3 = nox_xxx_findParentChainPlayer_4EC580(a1)) == 0 || !a2 || !(*(_BYTE*)(v3 + 8) & 4) ||
		!(*(_BYTE*)(a2 + 8) & 4) || nox_xxx_unitIsEnemyTo_5330C0(v3, a2)) {
		if (a1)
		...
		if (a2) {
			if (*(_BYTE*)(a2 + 8) & 4) {
				...
				if (nox_xxx_testUnitBuffs_4FF350(a2, 27) && nox_server_testTwoPointsAndDirection_4E6E50(
		...
		nox_xxx_mapDamageUnitsAround_4E25B0(a1 + 56, *getMemFloatPtr(0x5D4594, 1567976), 5.0, *getMemIntPtr(0x5D4594, 1567972), 7, a1, 0);
...
//----- (004E99B0) --------------------------------------------------------
void __cdecl nox_xxx_collideDie_4E99B0(int a1, int a2) {
	int v2;                  // edx
...
//----- (004E9A00) --------------------------------------------------------
char __cdecl nox_xxx_collideGlyph_4E9A00(int a1, int a2) {
	int v2; // eax
...
BOOL __cdecl sub_4E9A30(int a1, int a2) {
	...
	v5 = 1;
	if (a2) {
		if (nox_xxx_unitsHaveSameTeam_4EC520(a1, a2) || nox_common_gameFlags_check_40A5C0(512) &&
									  (v3 = nox_xxx_findParentChainPlayer_4EC580(a1), v4 = nox_xxx_findParentChainPlayer_4EC580(a2), *(_BYTE*)(v3 + 8) & 4) &&
									  *(_BYTE*)(v4 + 8) & 4) {
			v5 = 0;
		}
	}
...
//----- (004E9AC0) --------------------------------------------------------
void __cdecl nox_xxx_fireballCollide_4E9AC0(int a1, int a2) {
	int v2;           // esi
	char* v3;         // ebp
	int v4;           // ebx
	int v5;           // eax
	...
	if (a2 && nox_xxx_testUnitBuffs_4FF350(a2, 27) &&
		nox_server_testTwoPointsAndDirection_4E6E50((float2*)(a2 + 56), *(__int16*)(a2 + 124), (float2*)(a1 + 56)) &
			1) {
	...
	if (!nox_common_gameFlags_check_40A5C0(4096) || (v5 = nox_xxx_findParentChainPlayer_4EC580(a1)) == 0 || !a2 || !(*(_BYTE*)(v5 + 8) & 4) ||
		!(*(_BYTE*)(a2 + 8) & 4) || nox_xxx_unitIsEnemyTo_5330C0(v5, a2)) {
		if (v4) {
...
//----- (004E9C40) --------------------------------------------------------
void __cdecl nox_xxx_collideChest_4E9C40(_DWORD* a1, int a2) {
	int v2;                      // esi
	int v3;                      // eax
	int v4;                      // eax
	int i;                       // ebp
...
//----- (004E9D80) --------------------------------------------------------
void __cdecl nox_xxx_collideSulphurShot2_4E9D80(int a1, int a2, float* a3) {
	int* v3;  // edi
	int v4;   // eax
	int v5;   // edi
	int v6;   // eax
	...
	if (a2) {
		if (!nox_xxx_unitsHaveSameTeam_4EC520(a1, a2)) {
			if (nox_common_gameFlags_check_40A5C0(4096) && *(void(__cdecl**)(int, int, int))(a1 + 696) == nox_xxx_collideSulphurShot_4E9E50)
				v5 = 3 * *v3;
			else
				v5 = *v3;
			v6 = nox_xxx_findParentChainPlayer_4EC580(a1);
...
//----- (004E9E50) --------------------------------------------------------
void __cdecl nox_xxx_collideSulphurShot_4E9E50(int a1, int a2, int a3) {
...
//----- (004E9E90) --------------------------------------------------------
int* __cdecl nox_xxx_collideDeathBall_4E9E90(int a1, int a2, float* a3) {
	int* result; // eax
	int* v4;     // esi
	int v5;      // eax
	int v6;      // eax
	...
	if (a2) {
		if ((signed char)*(_BYTE*)(a2 + 8) >= 0) {
			...
			*(_DWORD*)(a1 + 68) = v7;
			...
			a2a.field_0 = -(double)*getMemIntPtr(0x587000, 8 * *(_DWORD*)(v6 + 12) + 196188);
			v10 = (double)*getMemIntPtr(0x587000, 8 * *(_DWORD*)(v6 + 12) + 196184);
			a2a.field_4 = v10;
...
//----- (004E9FE0) --------------------------------------------------------
void __cdecl nox_xxx_collideDeathBallFragment_4E9FE0(int a1, int a2, float* a3) {
	int v3;   // eax
	int v4;   // eax
	float v5; // [esp+0h] [ebp-1Ch]
	float v6; // [esp+4h] [ebp-18h]
...
//----- (004EA080) --------------------------------------------------------
void __cdecl nox_xxx_collidePixie_4EA080(int a1, int a2, float* a3) {
	int* v3;    // ebp
	__int16 v4; // ax
	double v5;  // st7
	double v6;  // st7
...
//----- (004EA200) --------------------------------------------------------
void __cdecl nox_xxx_collideWallReflectSpark_4EA200(int a1, int a2, float2* a3) {
	int* v3;   // ecx
	double v5; // st7
	int v8;    // eax
	int v9;    // eax
...
//----- (004EA300) --------------------------------------------------------
void __cdecl nox_xxx_collideSpark_4EA300(int a1, int a2, float* a3) {
	char v3; // al
...
//----- (004EA380) --------------------------------------------------------
void __cdecl nox_xxx_collideWebbing_4EA380(int a1, int a2) {
	int v2; // eax
	...
	if (a2) {
		...
		if ((*(int(__cdecl**)(int, int, int, _DWORD, int))(a2 + 716))(a2, v2, a1, 0, 2)) {
			if (*(_BYTE*)(a2 + 8) & 6)
				nox_xxx_buffApplyTo_4FF380(a2, 4, 4 * *getMemU16Ptr(0x5D4594, 2649704), 3);
			if (*(_BYTE*)(a2 + 8) & 4)
				nox_xxx_netPriMsgToPlayer_4DA2C0(a2, "objcoll.c:WebbingSlow", 0);
		}
	}
		...
		if ((v2 & 0x8000) == 0) {
			if (nox_common_gameFlags_check_40A5C0(32)) {
				...
				if (!*getMemU32Ptr(0x5D4594, 1567996)) {
					v3 = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 204700));
...
//----- (004EA490) --------------------------------------------------------
void __cdecl nox_xxx_pickupFlagCtf_4EA490(int a1, int a2) {
	int v2;              // esi
	int v3;              // edi
	char v4;             // bp
	int v5;              // ebx
	...
	if (nox_xxx_servCompareTeams_419150(v3 + 48, a1 + 48)) {
				...
				while (1) {
					if (*(_DWORD*)(v6 + 8) & 0x10000000) {
						...
						if (nox_xxx_servObjectHasTeam_419130(v3 + 48)) {
							v10 = nox_xxx_clientGetTeamColor_418AB0(*(unsigned __int8*)(v3 + 52));
							nox_xxx_netChangeTeamID_419090((int)v10, *((_DWORD*)v10 + 13) + 1);
		...
		v20 = *(_DWORD*)(a1 + 748);
		if (!*(_DWORD*)(v2 + 492)) {
			v12 = nox_xxx_clientGetTeamColor_418AB0(*(unsigned __int8*)(v2 + 52));
...
__int16 __cdecl sub_4EA800(int a1, int a2) {
	...
	if (!*getMemU32Ptr(0x5D4594, 1567992)) {
		v2 = (char*)nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 204736));
	...
	if (*(_BYTE*)(a2 + 8) & 4) {
		...
		if (!v3)
			return (__int16)v2;
		LOWORD(v2) = *getMemU16Ptr(0x5D4594, 1567992);
		while (*(unsigned __int16*)(v3 + 4) != *getMemU32Ptr(0x5D4594, 1567992)) {
			v3 = *(_DWORD*)(v3 + 512);
			if (!v3)
				return (__int16)v2;
		}
	...
	if (v3) {
		...
		if (v7) {
			...
			if (v2 == (char*)*(unsigned __int8*)(v6 + 57)) {
				v8 = (unsigned __int16)nox_xxx_servGamedataGet_40A020(64);
				nox_xxx_changeScore_4D8E90(v7, 1);
				nox_xxx_netReportLesson_4D8EF0(v7);
				nox_xxx_netChangeTeamID_419090(v6, *(_DWORD*)(v6 + 52) + 1);
				if (dword_5d4594_2650652) {
					v9 = *(_DWORD*)(v7 + 748);
					if (v9)
			...
			LABEL_27:
				if (!dword_5d4594_1567988)
					dword_5d4594_1567988 = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 204748));
				v11 = 0;
...
_DWORD* __cdecl sub_4EAAA0(int a1) {
	...
	result = (_DWORD*)a1;
	if (*getMemU32Ptr(0x5D4594, 2598000) > (unsigned int)(*(_DWORD*)(a1 + 136) + 3)) {
		*(_DWORD*)(a1 + 136) = *getMemU32Ptr(0x5D4594, 2598000);
...
_DWORD* __cdecl sub_4EAAD0(int a1, int a2) {
	...
	if (a2 && *(_BYTE*)(a2 + 8) & 4) {
		result = (_DWORD*)a1;
		if (*getMemU32Ptr(0x5D4594, 2598000) > (unsigned int)(*(_DWORD*)(a1 + 136) + 30)) {
			*(_DWORD*)(a1 + 136) = *getMemU32Ptr(0x5D4594, 2598000);
			result = nox_xxx_aud_501960(**(_DWORD**)(a1 + 700), a1, 0, 0);
		}
	}
	return result;
}
...
//----- (004EAB20) --------------------------------------------------------
int __cdecl nox_xxx_collidePentagram_4EAB20(int a1) {
	int result; // eax
...
//----- (004EAB40) --------------------------------------------------------
void __cdecl nox_xxx_collideSign_4EAB40(int a1, int a2) {
...
//----- (004EAB60) --------------------------------------------------------
void __cdecl nox_xxx_collideTrapDoor_4EAB60(int a1, int a2) {
	int v2;    // ebx
	int v3;    // eax
	int v4;    // eax
	double v5; // st7
	...
	if (a2) {
		...
		if ((v3 & 0x80u) == 0) {
			if (*(_DWORD*)(a1 + 16) & 0x1000000) {
				...
				if (*(_WORD*)(v2 + 20))
					*(_DWORD*)(v2 + 16) = *getMemU32Ptr(0x5D4594, 2598000) + *(unsigned __int16*)(v2 + 20);
	...
	if (a2) {
		if ((signed char)*(_BYTE*)(a2 + 8) >= 0) {
			...
			*(float*)(a2 + 168) = (double)v3[1];
			nox_xxx_teleportToMB_4E7190((_BYTE*)a2, (float*)(a2 + 164));
...
//----- (004EAD20) --------------------------------------------------------
int __cdecl nox_xxx_collideSpellPedestal_4EAD20(int a1, int a2) {
	int result; // eax

	result = a2;
	if (a2)
		result = nox_xxx_spellGrantToPlayer_4FB550_magic_plyrspel(a2, **(_DWORD**)(a1 + 700), 1, 0, 0);
	return result;
}

//----- (004EAD50) --------------------------------------------------------
void __cdecl nox_xxx_unused_4EAD50(int a1, int a2) {
	_DWORD* v2; // edi
	char* v3;   // eax
	...
	if (a2) {
		if (*(_BYTE*)(a2 + 8) & 4) {
			...
			if (*(_WORD*)(*(_DWORD*)(a2 + 748) + 4) < *(_WORD*)(*(_DWORD*)(a2 + 748) + 8) && *v2 > 0) {
				if (!nox_xxx_servObjectHasTeam_419130(a1 + 48) || nox_xxx_servObjectHasTeam_419130(a2 + 48) &&
												(v3 = nox_xxx_clientGetTeamColor_418AB0(*(unsigned __int8*)(a2 + 52))) != 0 &&
...
//----- (004EADF0) --------------------------------------------------------
void __cdecl nox_xxx_collideFist_4EADF0(int a1, int a2) {
	int v2; // eax
...
//----- (004EAE30) --------------------------------------------------------
void __cdecl nox_xxx_collideTeleportWake_4EAE30(int a1, int a2) {
	float* v2; // ebx
	int v3;    // eax
			...
			if (!nox_common_gameFlags_check_40A5C0(4096) || (v3 = *(_DWORD*)(a1 + 508)) == 0 || *(_BYTE*)(v3 + 8) & 4) {
				if (*(_DWORD*)(a2 + 8) & 0x3001016) {
					if (!nox_xxx_testUnitBuffs_4FF350(a2, 0))
						nox_xxx_netSendPointFx_522FF0(138, (float2*)(a2 + 56));
					nox_xxx_aud_501960(147, a2, 0, 0);
					nox_xxx_teleportToMB_4E7190((_BYTE*)a2, v2);
					if (!nox_xxx_testUnitBuffs_4FF350(a2, 0))
						nox_xxx_netSendPointFx_522FF0(137, (float2*)(a2 + 56));
					nox_xxx_aud_501960(147, a2, 0, 0);
				}
...
//----- (004EAF00) --------------------------------------------------------
void __cdecl nox_xxx_collideChakram_4EAF00(int a1, int a2, float* a3) {
	int v3;      // esi
	int v4;      // ebx
	int v5;      // eax
	int* v6;     // ebp
	...
	if (!v5 || *(_BYTE*)(v5 + 16) & 0x20) {
		...
		if (a2 == *(_DWORD*)(v3 + 508)) {
			sub_4ED0C0(v3, v6);
			nox_xxx_inventoryPutImpl_4F3070(*(_DWORD*)(v3 + 508), (int)v6, 1);
			v10 = *(_DWORD*)(v3 + 508);
			if (v10 && *(_BYTE*)(v10 + 8) & 4 && !*(_DWORD*)(*(_DWORD*)(v10 + 748) + 104))
				nox_xxx_playerEquipWeapon_53A420((_DWORD*)v10, (int)v6, 1, 1);
			...
			if (nox_xxx_unitsHaveSameTeam_4EC520(v3, a2))
				return;
			v11 = *(_DWORD*)(v3 + 508);
			v12 = nox_xxx_getProjectileClassById_413250(*(unsigned __int16*)(v3 + 4));
			v24 = (int)v12;
...
int __cdecl sub_4EB250(int a1) {
	...
	*getMemU32Ptr(0x5D4594, 1567932) = *(_DWORD*)(v2 + 12);
	*getMemU32Ptr(0x5D4594, 1567840) = *(_DWORD*)(a1 + 508);
...
void __cdecl sub_4EB340(float* a1, int a2) {
	...
	if ((_DWORD)a1[2] & 0x20006) {
		if (!((_DWORD)a1[4] & 0x8020) && !nox_xxx_testUnitBuffs_4FF350((int)a1, 0) && a1 != *(float**)getMemAt(0x5D4594, 1567840) &&
			a1 != *(float**)getMemAt(0x5D4594, 1567932)) {
...
void __cdecl sub_4EB3E0(int a1) {
	...
	v5 = *(_DWORD*)(v1 + 76);
	*v2 = v9 * *getMemFloatPtr(0x587000, 8 * v4 + 194136);
	v6 = v9 * *getMemFloatPtr(0x587000, 8 * v4 + 194140);
	v7 = *(_DWORD*)(v1 + 72);
	*(_DWORD*)(v1 + 68) = v5;
	*(_DWORD*)(v1 + 64) = v7;
	*(_DWORD*)(v1 + 56) = v7;
...
//----- (004EB490) --------------------------------------------------------
void __cdecl nox_xxx_collideArrow_4EB490(int a1, int a2) {
	int v2;     // esi
	_DWORD* v3; // ebp
	int v4;     // eax
	int v5;     // ebx
	...
	if (v4)
		v5 = nox_xxx_unitGetStrength_4F9FD0(*(_DWORD*)(v2 + 508));
	else
		v5 = 30;
	if (nox_common_gameFlags_check_40A5C0(4096)) {
		...
		if (v6) {
			if (!a2)
				goto LABEL_24;
			if (*(_BYTE*)(v6 + 8) & 4 && *(_BYTE*)(a2 + 8) & 4 && !nox_xxx_unitIsEnemyTo_5330C0(v6, a2))
				return;
		}
	}
	if (!a2) {
	LABEL_24:
		...
		if (v16) {
			...
			nox_xxx_damageToMap_534BC0(*v16, v16[1], (__int64)v17, 11, v2);
			nox_xxx_delayedDeleteObject_4E5CC0(v2);
			return;
		}
		goto LABEL_27;
	}
	nox_xxx_unitGetStrength_4F9FD0(*(_DWORD*)(v2 + 508));
	if (!*getMemU32Ptr(0x5D4594, 1568000))
		*getMemU32Ptr(0x5D4594, 1568000) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 204860));
	v7 = *(_DWORD*)(a2 + 16);
	if ((v7 & 0x8000) == 0) {
		v8 = *(_DWORD*)(v2 + 56);
		v9 = *(_DWORD*)(v2 + 60);
		...
		*(float*)v21 = v10;
		...
		if (*(_DWORD*)(v2 + 508) != a2)
			nox_xxx_playerPreAttackEffects_538290(a2, *(_DWORD*)(v22 + 4), v2, (int)v21);
		v20 = LOBYTE(v21[1]);
		...
		if (*(unsigned __int16*)(v2 + 4) == *getMemU32Ptr(0x5D4594, 1568000)) {
			v15 = *(_WORD**)(a2 + 556);
			if (v15 && !*v15) {
				if (!v15[2])
					nox_xxx_delayedDeleteObject_4E5CC0(v2);
...
//----- (004EB6A0) --------------------------------------------------------
void __cdecl nox_xxx_collideHarpoon_4EB6A0(int a1, int a2) {
	int v2;     // eax
	_DWORD* v3; // ebp
	_DWORD* v4; // ebx
	int v5;     // eax
	...
	if (!(*(_DWORD*)(a2 + 16) & 0x8020) && (_DWORD*)a2 != v3) {
		...
		if ((*(int(__cdecl**)(int, int, int, int, int))(a2 + 716))(a2, v5, a1, v11, 11) &&
			(nox_xxx_unitIsEnemyTo_5330C0((int)v3, a2) || nox_xxx_CheckGameplayFlags_417DA0(1) && *(_BYTE*)(a2 + 8) & 6)) {
			v4[33] = a2;
			v4[36] = *(_DWORD*)(a2 + 56);
			v4[37] = *(_DWORD*)(a2 + 60);
			v4[38] = *getMemU32Ptr(0x5D4594, 2598000);
			v12 = *(_DWORD*)(a1 + 508);
			*(_DWORD*)(a1 + 16) |= 0x40u;
			sub_4E7540(v12, a2);
...
//----- (004EB800) --------------------------------------------------------
void __cdecl nox_xxx_collideMonsterArrow_4EB800(int a1, int a2) {
	int* v2; // esi
	int v3;  // edi
	int v4;  // eax
	int v5;  // eax
...
//----- (004EB890) --------------------------------------------------------
void __cdecl nox_xxx_collideBearTrap_4EB890(int* a1, int a2) {
	_DWORD* v2; // eax
...
//----- (004EB910) --------------------------------------------------------
void __cdecl nox_xxx_collidePoisonGasTrap_4EB910(int* a1, int a2) {
	_DWORD* v2; // edi
	_DWORD* v3; // edi
	...
	if (a2 && sub_4E9A30((int)a1, a2)) {
		...
		if (v2) {
			nox_xxx_createAt_4DAA50((int)v2, a1[127], *((float*)a1 + 14), *((float*)a1 + 15));
			v3 = (_DWORD*)v2[187];
			v4 = nox_xxx_gamedataGetFloat_419D40(getMemAt(0x587000, 204916)) * (double)*getMemIntPtr(0x5D4594, 2649704);
			*v3 = nox_float2int(v4);
...
int __cdecl sub_4EB9B0(int a1, int a2) {
	...
	v2 = *(_DWORD**)(a1 + 748);
	result = a2;
	if (a2 && (result = nox_xxx_findParentChainPlayer_4EC580(a2)) != 0 && *(_BYTE*)(result + 8) & 4) {
		*v2 = result;
		v2[1] = *(unsigned __int8*)(result + 52);
		v2[4] = *getMemU32Ptr(0x5D4594, 2598000);
	} else {
		*v2 = 0;
		v2[1] = 0;
	}
...
//----- (004EBA00) --------------------------------------------------------
_DWORD* __cdecl nox_xxx_collideBall_4EBA00(int a1, int a2) {
	char* v2;       // ebp
	_DWORD* v3;     // ebx
	_DWORD* result; // eax
	...
	v3 = *(_DWORD**)(a1 + 748);
	if (a2) {
		v2 = nox_xxx_clientGetTeamColor_418AB0(*(unsigned __int8*)(a2 + 52));
		if (*v3 == a2 && v2 && sub_418BC0((int)v2) > 1) {
			if ((unsigned int)(*getMemU32Ptr(0x5D4594, 2598000) - *getMemU32Ptr(0x5D4594, 1568008)) > 0x2D) {
				nox_xxx_netPriMsgToPlayer_4DA2C0(a2, "objcoll.c:CantPickupBall", 0);
				*getMemU32Ptr(0x5D4594, 1568008) = *getMemU32Ptr(0x5D4594, 2598000);
			}
	...
	LABEL_17:
		...
		if (nox_xxx_servObjectHasTeam_419130(a1 + 48)) {
			...
			nox_xxx_createAtImpl_4191D0(*(_BYTE*)(a2 + 52), a1 + 48, 1, *(_DWORD*)(a1 + 36), 0);
		}
		if (v2) {
			if (v2[56] == 2)
...
//----- (004EBB80) --------------------------------------------------------
__int16 __cdecl nox_xxx_collideHomeBase_4EBB80(int a1, int a2) {
	int v2;   // esi
	int v3;   // eax
	int* v4;  // edi
	char* v5; // esi
	...
	v2 = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 204964));
	v3 = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 204976));
	v14 = v3;
	if (a2) {
		...
		if ((unsigned __int16)v3 == v2) {
			...
			if (*v4 && nox_xxx_servObjectHasTeam_419130(*v4 + 48))
				v6 = nox_xxx_clientGetTeamColor_418AB0(*(unsigned __int8*)(*v4 + 52));
			if (v5 == v6) {
...
//----- (004EBD40) --------------------------------------------------------
void __cdecl nox_xxx_collideUndeadKiller_4EBD40(int a1, int a2, int a3) {
	int v3;              // ebx
	int* v4;             // esi
...
//----- (004EBE10) --------------------------------------------------------
void __cdecl nox_xxx_collideMonsterGen_4EBE10(int a1, int a2) {
	if (a2) {
		if (*(_BYTE*)(a2 + 8) & 4)
...
void __cdecl sub_4EBE40(int a1, int a2) {
	...
	if (nox_common_gameFlags_check_40A5C0(4096) && a2 && *(_BYTE*)(a2 + 8) & 4) {
		...
		v6 = *(_DWORD*)(a2 + 748);
		if (*(float2**)(v6 + 308) != v2 ||
			(unsigned int)(*getMemU32Ptr(0x5D4594, 2598000) - *v7) > *getMemIntPtr(0x5D4594, 2649704)) {
		...
		*(_DWORD*)(v6 + 308) = v2;
		*v7 = *getMemU32Ptr(0x5D4594, 2598000);
	}
}

//----- (004EBF40) --------------------------------------------------------
void __cdecl nox_xxx_collideAnkhQuest_4EBF40(int a1, int a2) {
	int v2;              // esi
	int v3;              // ebp
	int v4;              // ebx
	int v5;              // ecx
	...
	LABEL_8:
		...
		v7 = v3 + 50;
		do {
			if (*getMemU32Ptr(0x5D4594, 2598000) - *(_DWORD*)(v7 + 26) >
				(unsigned int)(240 * *getMemU32Ptr(0x5D4594, 2649704))) {
				nox_wcscpy((wchar_t*)(v7 - 50), (const wchar_t*)getMemAt(0x5D4594, 1568012));
				*(_BYTE*)(v7 + 1) = getMemByte(0x5D4594, 1568016);
				*(_BYTE*)v7 = 0;
				*(_DWORD*)(v7 + 26) = 0;
			}
			v8 = *(_DWORD*)(v4 + 276);
			if (*(_BYTE*)v7 == *(_BYTE*)(v8 + 2251) &&
		...
		LABEL_35:
			nox_wcscpy((wchar_t*)(v3 + 80 * *(unsigned __int8*)(v3 + 5120)),
					   (const wchar_t*)(*(_DWORD*)(v4 + 276) + 2185));
			...
			*(_DWORD*)(80 * *(unsigned __int8*)(v3 + 5120) + v3 + 76) = *getMemU32Ptr(0x5D4594, 2598000);
			v16 = *(_BYTE*)(v3 + 5120) + 1;
			*(_BYTE*)(v3 + 5120) = v16;
			if (v16 >= 0x40u)
				*(_BYTE*)(v3 + 5120) = 0;
...
//----- (004EC300) --------------------------------------------------------
void __cdecl nox_xxx_unitClearOwner_4EC300(int a1) {
	int v1;  // eax
	int v2;  // edx
	int v3;  // edi
	int v4;  // edx
	...
	if (a1) {
		v1 = *(_DWORD*)(a1 + 508);
		if (v1) {
			if (*(_BYTE*)(v1 + 8) & 4 && nox_xxx_creatureIsMonitored_500CC0(v1, a1)) {
				v2 = *(_DWORD*)(a1 + 12);
				LOBYTE(v2) = v2 & 0x7F;
				v3 = *(_DWORD*)(*(_DWORD*)(a1 + 508) + 748);
				*(_DWORD*)(a1 + 12) = v2;
				nox_xxx_netFxShield_0_4D9200(*(unsigned __int8*)(*(_DWORD*)(v3 + 276) + 2064), a1);
				nox_xxx_netUnmarkMinimapObj_417300(*(unsigned __int8*)(*(_DWORD*)(v3 + 276) + 2064), a1, 1);
			}
			v4 = *(_DWORD*)(a1 + 508);
			v5 = 0;
			v6 = *(_DWORD*)(v4 + 516);
...
//----- (004EC3E0) --------------------------------------------------------
int __cdecl nox_xxx_playerObserverFindGoodSlave2_4EC3E0(int a1) {
	int result; // eax
...
//----- (004EC420) --------------------------------------------------------
int __cdecl nox_xxx_playerObserverFindGoodSlave_4EC420(int a1) {
	int result; // eax
...
//----- (004EC470) --------------------------------------------------------
void __cdecl nox_xxx_unitRemoveChild_4EC470(int a1) {
	int v1; // eax
	int v2; // ecx
...
//----- (004EC4B0) --------------------------------------------------------
void __cdecl nox_xxx_unitTransferSlaves_4EC4B0(int a1) {
	int v1; // eax
	int v2; // esi
	...
	if (a1) {
		...
		if (v1) {
			do {
				v2 = *(_DWORD*)(v1 + 512);
				nox_xxx_unitSetOwner_4EC290(*(_DWORD*)(a1 + 508), v1);
				v1 = v2;
			} while (v2);
		}
	}
...
//----- (004EC4F0) --------------------------------------------------------
int __cdecl nox_xxx_unitHasThatParent_4EC4F0(int a1, int a2) {
	int v2; // eax
...
//----- (004EC520) --------------------------------------------------------
int __cdecl nox_xxx_unitsHaveSameTeam_4EC520(int a1, int a2) {
	int v2; // edi
	int v3; // esi
...
//----- (004EC580) --------------------------------------------------------
int __cdecl nox_xxx_findParentChainPlayer_4EC580(int a1) {
	int result; // eax
	int i;      // ecx
...
//----- (004EC5E0) --------------------------------------------------------
_DWORD* __cdecl nox_xxx_respawnAdd_4EC5E0(int a1) {
	_DWORD* result;      // eax
	_DWORD* v2;          // ebx
	...
	if (nox_xxx_respawnAllow_587000_205200) {
		...
		if (result) {
			...
			*((_WORD*)result + 8) = *(_WORD*)(a1 + 124);
			...
			result = *(_DWORD**)&dword_5d4594_1568024;
			if (dword_5d4594_1568024)
				*(_DWORD*)(dword_5d4594_1568024 + 56) = v2;
...
void __cdecl sub_4EC6A0(int a1) {
	...
	if (*(_DWORD*)(dword_5d4594_1568024 + 4) == a1) {
		v2 = *(_QWORD**)&dword_5d4594_1568024;
		dword_5d4594_1568024 = *(_DWORD*)(dword_5d4594_1568024 + 52);
		v3 = *(_DWORD*)(v1 + 52);
		if (v3)
			*(_DWORD*)(v3 + 56) = 0;
		nox_xxx_memDeleteAdv_414330(*(unsigned int**)&nox_alloc_respawn_1568020, v2);
		...
		nox_xxx_memDeleteAdv_414330(*(unsigned int**)&nox_alloc_respawn_1568020, (_QWORD*)v1);
	}
}

//----- (004ECA60) --------------------------------------------------------
BOOL nox_xxx_allocItemRespawnArray_4ECA60() {
...
char* __cdecl sub_4ECAA0(char a1) {
	...
	if (a1 <= 16)
		result = *(char**)getMemAt(0x587000, 4 * a1 + 205304);
	else
...
unsigned __int8 __cdecl sub_4ECAC0(const char* a1) {
	...
	result = 0;
	v2 = 0;
	while (strcmp(a1, *(const char**)getMemAt(0x587000, 4 * v2 + 205304))) {
		v2 = ++result;
		if (result > 0x10u)
			return 0;
	}
...
char* __cdecl sub_4ECB20(char* a1) {
	...
	return *(char**)getMemAt(0x587000, 8 * v2 + 205224);
}
...
int __cdecl sub_4ECB60(const char* a1) {
	...
	return *getMemU32Ptr(0x587000, 8 * v2 + 205228);
}
...
int __cdecl sub_4ECC70(int a1) {
	...
	v1 = *getMemU32Ptr(0x5D4594, 1568032); // FIXME: could be part of netCodeCache struct, but there are no references to
										  // this function at all
	if (!*getMemU32Ptr(0x5D4594, 1568032)) {
		v1 = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 205684));
...
//----- (004ED020) --------------------------------------------------------
int __cdecl nox_xxx_netGetUnitByExtent_4ED020(int a1) {
	int result; // eax
...
void __cdecl sub_4ED050(int a1, int a2) {
	...
	if (!*getMemU32Ptr(0x5D4594, 1568248)) {
		v2 = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 205744));
		*getMemU32Ptr(0x5D4594, 1568248) = v2;
	}
	for (i = *(_DWORD*)(a1 + 516); i; i = *(_DWORD*)(i + 512)) {
		LOWORD(v2) = *(_WORD*)(i + 4);
		if ((unsigned __int16)v2 == *getMemU32Ptr(0x5D4594, 1568248)) {
			v4 = *(_DWORD*)(i + 748);
...
//----- (004ED290) --------------------------------------------------------
int __cdecl nox_xxx_dropDefault_4ED290(int a1, int a2, float2* a3) {
	int v3;              // ebp
	int result;          // eax
	int* v5;             // edi
	int v6;              // eax
	...
	if (*(_DWORD*)(a2 + 492) != a1)
		return 0;
	if (*(_BYTE*)(a1 + 8) & 4 && nox_xxx_ItemIsDroppable_53EBF0(a2) && sub_53EC80(a2, 1)) {
		if (!(*(_DWORD*)(a1 + 16) & 0x8020)) {
	...
	LABEL_19:
		if (*(_DWORD*)(a2 + 8) & 0x10000000) {
			...
			*(_DWORD*)(v7 + 8) = *getMemU32Ptr(0x5D4594, 2598000);
			sub_4E82C0(v14, 2, v9, 0);
		}
		if (!*getMemU32Ptr(0x5D4594, 1568252))
			*getMemU32Ptr(0x5D4594, 1568252) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 205772));
		if (!nox_common_gameFlags_check_40A5C0(2048) && !nox_common_gameFlags_check_40A5C0(4096) &&
			!(*(_DWORD*)(a2 + 16) & 0x80000) && !(*(_DWORD*)(a2 + 8) & 0x10000000) &&
			*(unsigned __int16*)(a2 + 4) != *getMemU32Ptr(0x5D4594, 1568252)) {
			nox_xxx_unitSetDecayTime_511660((_DWORD*)a2, 10 * *getMemU32Ptr(0x5D4594, 2649704));
		}
		...
		if (!*getMemU32Ptr(0x5D4594, 1568256)) {
			*getMemU32Ptr(0x5D4594, 1568256) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 205780));
			*getMemU32Ptr(0x5D4594, 1568244) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 205788));
		}
		v12 = *(unsigned __int16*)(a2 + 4);
		if ((unsigned __int16)v12 == *getMemU32Ptr(0x5D4594, 1568256) || v12 == *getMemU32Ptr(0x5D4594, 1568244))
...
//----- (004ED580) --------------------------------------------------------
int __cdecl nox_xxx_dropTrap_4ED580(int a1, int a2, float2* a3) {
...
//----- (004ED5E0) --------------------------------------------------------
int __cdecl nox_xxx_dropCrown_4ED5E0(int a1, int a2, int* a3) {
	int v3;       // edi
	int v4;       // ebx
	int v5;       // ebp
	int v6;       // esi
	...
	if (v6) {
		do {
			v7 = *(_DWORD*)(v6 + 748);
			if (nox_xxx_teamCompare2_419180(v6 + 48, *(_BYTE*)(a2 + 52)) && *(_DWORD*)(v7 + 264) < v4) {
				v4 = *(_DWORD*)(v7 + 264);
				v5 = v6;
			}
			v6 = nox_xxx_getNextPlayerUnit_4DA7F0(v6);
...
//----- (004ED710) --------------------------------------------------------
int __cdecl nox_xxx_dropTreasure_4ED710(int a1, int a2, int* a3) {
	int v3; // edi
	...
	if (*(_BYTE*)(a1 + 8) & 4) {
		if (nox_common_gameFlags_check_40A5C0(64)) {
			...
			*(_DWORD*)(*(_DWORD*)(v3 + 276) + 2156) = nox_xxx_scavengerTreasureMax_4D1600();
...
//----- (004ED790) --------------------------------------------------------
int __cdecl nox_xxx_drop_4ED790(int a1, _DWORD* a2, float2* a3) {
	int result;                               // eax
...
//----- (004ED810) --------------------------------------------------------
int __cdecl nox_xxx_drop_4ED810(int a1, int a2, float* a3) {
	int v3;         // esi
	float v4;       // ecx
	float v5;       // eax
	double v6;      // st7
	...
	if (nox_xxx_mapTraceRay_535250(&v11, 0, 0, 0)) {
		...
		if (!*getMemU32Ptr(0x5D4594, 1568248)) {
			v10 = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 205820));
		...
		LABEL_13:
			result = nox_xxx_drop_4ED790(v3, (_DWORD*)a2, (float2*)&v11.field_8);
	} else {
		nox_xxx_netPriMsgToPlayer_4DA2C0(v3, "drop.c:DropNotAllowed", 0);
		nox_xxx_aud_501960(925, v3, 2, *(_DWORD*)(v3 + 36));
		result = 0;
	}
	return result;
}
...
//----- (004ED930) --------------------------------------------------------
int __cdecl nox_xxx_invForceDropItem_4ED930(int a1, _DWORD* a2) {
...
//----- (004EDA40) --------------------------------------------------------
_DWORD* __cdecl nox_xxx_dropAllItems_4EDA40(_DWORD* a1) {
	float2* v1;     // ebp
	int v2;         // edi
	int v3;         // esi
	_DWORD* result; // eax
	...
	while (1) {
		v11 = (_DWORD*)v10[124];
		result = (_DWORD*)nox_xxx_unitDropCheckSome_4EDCD0((int)v1, (int)v10);
		if (result)
			result = (_DWORD*)nox_xxx_drop_4ED790((int)v1, v10, v1 + 7);
		if (!v11)
			break;
		v10 = v11;
	}
...
//----- (004EDCD0) --------------------------------------------------------
BOOL __cdecl nox_xxx_unitDropCheckSome_4EDCD0(int a1, int a2) {
	int v2; // eax
...
int __cdecl sub_4EDDE0(int a1, _DWORD* a2, int* a3) {
	...
	if (!nox_common_gameFlags_check_40A5C0(2048) && !nox_common_gameFlags_check_40A5C0(4096))
		nox_xxx_unitSetDecayTime_511660(a2, 25 * *getMemU32Ptr(0x5D4594, 2649704));
	return 1;
}

//----- (004EDE50) --------------------------------------------------------
int __cdecl nox_xxx_dropFood_4EDE50(int a1, int a2, int* a3) {
	int v3;              // edi
	unsigned __int8* v4; // eax
	...
	if (v3) {
		if (!nox_common_gameFlags_check_40A5C0(2048))
			nox_xxx_unitSetDecayTime_511660((_DWORD*)a2, 25 * *getMemU32Ptr(0x5D4594, 2649704));
		...
		if (*getMemU16Ptr(0x587000, 205710)) {
			...
			nox_xxx_aud_501960(*((unsigned __int16*)v4 + 3), a1, 0, 0);
		}
	}
	return v3;
}
...
//----- (004EDF00) --------------------------------------------------------
void __cdecl nox_xxx_chest_4EDF00(int a1, int a2) {
	int v2;       // eax
	double v3;    // st7
	double v4;    // st7
	double v5;    // st7
						...
						do {
							...
							if (*(char*)(v25 + 488) != -1 && !(*(_BYTE*)(v25 + 8) & 2)) {
								*(_DWORD*)(v25 + 16) |= 0x40u;
								...
								nox_xxx_drop_4ED790(a1, (_DWORD*)v25, &a3[v26++]);
								if (v26 >= 3)
									v26 = 0;
							}
							v25 = v32;
...
int __cdecl sub_4EE2F0(int a1, int a2, int* a3) {
	...
	if (v3) {
		...
		if (*getMemI16Ptr(0x5D4594, 3815180) != -1) {
			...
			nox_xxx_aud_501960(*((unsigned __int16*)v5 + 1), a1, 0, 0);
		}
	}
	return v3;
}
...
//----- (004EE370) --------------------------------------------------------
int __cdecl nox_xxx_dropAnkhTradable_4EE370(int a1, int a2, int* a3) { return nox_xxx_dropDefault_4ED290(a1, a2, (float2*)a3); }

//----- (004EE390) --------------------------------------------------------
int __cdecl nox_xxx_unused_4EE390(int a1) {
	int result; // eax
	int v2;     // ecx
	...
	if (a1) {
		...
		if (v2) {
			...
			*(_DWORD*)0xC = 0;
			*(_DWORD*)(*(_DWORD*)(a1 + 556) + 8) = dword_5d4594_1568260;
			if (dword_5d4594_1568260)
				*(_DWORD*)(dword_5d4594_1568260 + 448) = a1;
...
//----- (004EE3E0) --------------------------------------------------------
void __cdecl nox_xxx_unused_4EE3E0(int a1) {
	int v1; // eax
	int v2; // ecx
	int v3; // eax
	int v4; // ecx
		...
		if (v1) {
			...
			if (v4)
				*(_DWORD*)(*(_DWORD*)(v4 + 556) + 8) = *(_DWORD*)(v3 + 8);
				...
				dword_5d4594_1568260 = *(_DWORD*)(v3 + 8);
		}
	}
}
...
//----- (004EE460) --------------------------------------------------------
void __cdecl nox_xxx_unitAdjustHP_4EE460(int a1, int a2) {
...
//----- (004EE4C0) --------------------------------------------------------
void __cdecl nox_xxx_mobInformOwnerHP_4EE4C0(_DWORD* a1) {
	int v1; // eax
	...
	if (a1) {
		...
		if (v1) {
			if (*(_BYTE*)(v1 + 8) & 4)
				nox_xxx_netReportUnitCurrentHP_4D8620(*(unsigned __int8*)(*(_DWORD*)(*(_DWORD*)(v1 + 748) + 276) + 2064), a1);
		}
	}
}

//----- (004EE5E0) --------------------------------------------------------
void __cdecl nox_xxx_unitDamageClear_4EE5E0(int a1, int a2) {
	int v2;                  // eax
	int v3;                  // eax
	int v4;                  // eax
...
//----- (004EE6F0) --------------------------------------------------------
void __cdecl nox_xxx_unitHPsetOnMax_4EE6F0(int a1) {
	int v1; // eax
...
//----- (004EE730) --------------------------------------------------------
void __cdecl nox_xxx_playerHP_4EE730(int a1) {
	int v1; // esi
	int v2; // eax
	int v3; // edx
...
//----- (004EE780) --------------------------------------------------------
__int16 __cdecl nox_xxx_unitGetHP_4EE780(int a1) {
	__int16* v1;    // eax
	__int16 result; // ax
...
//----- (004EE7A0) --------------------------------------------------------
__int16 __cdecl nox_xxx_unitGetMaxHP_4EE7A0(int a1) {
	int v1;         // eax
	__int16 result; // ax
...
//----- (004EE7C0) --------------------------------------------------------
int __cdecl nox_xxx_unitSetMaxHP_4EE7C0(int a1, __int16 a2) {
	int result; // eax
...
//----- (004EE7E0) --------------------------------------------------------
int __cdecl nox_xxx_activatePoison_4EE7E0(int a1, int a2, int a3) {
	int v3;    // ebx
	int v5;    // eax
	int v6;    // eax
	int v7;    // edi
	...
	v10 = nox_xxx_getPoisonDmg_4E0040((_DWORD*)a1) * 100.0;
...
LABEL_21:
	if (!v3 && v8 > 0) {
		v9 = *(_DWORD*)(a1 + 556);
		if (v9)
			*(_DWORD*)(v9 + 16) = *getMemU32Ptr(0x5D4594, 2598000);
	}
	return 1;
}

//----- (004EE8F0) --------------------------------------------------------
void __cdecl nox_xxx_updatePoison_4EE8F0(int a1, int a2) {
	int v2;   // eax
	int v3;   // eax
	char* v4; // eax
	int v5;   // eax
	...
	if (a1) {
		if (*(unsigned __int8*)(a1 + 540) > a2) {
			...
			*(_BYTE*)(a1 + 540) = 0;
			...
			v3 = *(_DWORD*)(a1 + 8);
			if (v3 & 4) {
				nox_xxx_playerUnsetStatus_417530(*(_DWORD*)(*(_DWORD*)(a1 + 748) + 276), 1024);
				...
				if (nox_common_gameFlags_check_40A5C0(2048) && *(_BYTE*)(a1 + 12) & 0x10) {
					...
					if (v4) {
						v5 = *((_DWORD*)v4 + 514);
						if (v5)
							nox_xxx_netReportObjectPoison_4D7F40(v5, (_DWORD*)a1, 0);
					}
				} else if (*(_BYTE*)(a1 + 12) & 0x80) {
					v6 = *(_DWORD*)(a1 + 508);
					if (v6)
						nox_xxx_netReportObjectPoison_4D7F40(v6, (_DWORD*)a1, 0);
				}
			}
		}
	}
...
//----- (004EE9D0) --------------------------------------------------------
void __cdecl nox_xxx_removePoison_4EE9D0(int a1) {
	int v1;   // eax
	int v2;   // eax
	char* v3; // eax
	int v4;   // eax
		...
		if (v2 & 4) {
			...
			if (nox_common_gameFlags_check_40A5C0(2048) && *(_BYTE*)(a1 + 12) & 0x10) {
				...
				if (v3) {
					v4 = *((_DWORD*)v3 + 514);
					if (v4)
						nox_xxx_netReportObjectPoison_4D7F40(v4, (_DWORD*)a1, 0);
				}
			} else if (*(_BYTE*)(a1 + 12) & 0x80) {
				v5 = *(_DWORD*)(a1 + 508);
				if (v5)
...
//----- (004EEA90) --------------------------------------------------------
void __cdecl nox_xxx_setSomePoisonData_4EEA90(int a1, int a2) {
	int v2;   // eax
	int v3;   // eax
	int v4;   // eax
	char* v5; // eax
	...
	if (a1) {
		if (!*(_BYTE*)(a1 + 540) && a2 > 0) {
			v2 = *(_DWORD*)(a1 + 556);
			if (v2)
				*(_DWORD*)(v2 + 16) = *getMemU32Ptr(0x5D4594, 2598000);
		}
		v3 = *(_DWORD*)(a1 + 8);
		*(_BYTE*)(a1 + 540) = a2;
		if (v3 & 4) {
			v4 = *(_DWORD*)(a1 + 748);
			if (a2 != 0)
				nox_xxx_netNeedTimestampStatus_4174F0(*(_DWORD*)(v4 + 276), 1024);
			else
				nox_xxx_playerUnsetStatus_417530(*(_DWORD*)(v4 + 276), 1024);
		} else if (v3 & 2) {
			if (nox_common_gameFlags_check_40A5C0(2048) && *(_BYTE*)(a1 + 12) & 0x10) {
			...
			nox_xxx_netReportObjectPoison_4D7F40(v6, (_DWORD*)a1, a2 != 0);
		}
	LABEL_19:
		if (a2)
			*(_WORD*)(a1 + 542) = 1000;
...
//----- (004EEB80) --------------------------------------------------------
unsigned __int16 __cdecl nox_xxx_playerManaAdd_4EEB80(int a1, __int16 a2) {
...
//----- (004EEBF0) --------------------------------------------------------
_DWORD* __cdecl nox_xxx_playerManaSub_4EEBF0(int a1, int a2) {
	_DWORD* result;      // eax
	unsigned __int16 v3; // cx
...
//----- (004EEC80) --------------------------------------------------------
__int16 __cdecl nox_xxx_unitGetOldMana_4EEC80(int a1) {
	int v1;         // eax
	__int16 result; // ax
...
//----- (004EECB0) --------------------------------------------------------
__int16 __cdecl nox_xxx_playerGetMaxMana_4EECB0(int a1) {
	__int16 result; // ax
...
//----- (004EECD0) --------------------------------------------------------
int __cdecl nox_xxx_playerSetMaxMana_4EECD0(int a1, __int16 a2) {
	int result; // eax
...
//----- (004EECF0) --------------------------------------------------------
_DWORD* __cdecl nox_xxx_playerManaRefresh_4EECF0(int a1) {
	_DWORD* result; // eax
	int v2;         // eax
	int v3;         // edx
	__int16 v4;     // cx
...
//----- (004EEDC0) --------------------------------------------------------
int __cdecl nox_xxx_plrReadVals_4EEDC0(int a1, int a2) {
	int v2;     // ebx
	int v3;     // edi
	int v4;     // esi
	float* v5;  // ebp
	...
	v4 = *(_DWORD*)(v3 + 276);
	v26 = sub_57B350();
	v5 = nox_xxx_plrGetMaxVarsPtr_57B360(*(unsigned __int8*)(v4 + 2251));
	...
	*(_WORD*)(*(_DWORD*)(v3 + 276) + 3652) =
		(__int64)(((double)*(int*)(v4 + 2239) / v25[3] * 1250.0 + 750.0) * *getMemDoublePtr(0x581450, 10216));
	*(_WORD*)(v2 + 490) = *(_WORD*)(*(_DWORD*)(v3 + 276) + 3652);
	...
	nox_xxx_protectPlayerHPMana_56F870(*(_DWORD*)(*(_DWORD*)(v3 + 276) + 4600), *(_WORD*)(v3 + 8));
	nox_xxx_protectPlayerHPMana_56F870(*(_DWORD*)(*(_DWORD*)(v3 + 276) + 4592), *(_WORD*)(*(_DWORD*)(v2 + 556) + 4));
...
double __cdecl nox_xxx_calcBoltDamage_4EF1E0(int a1, int a2) {
	...
	if (!*getMemU32Ptr(0x5D4594, 1568264))
		*getMemU32Ptr(0x5D4594, 1568264) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 206160));
	if (!nox_common_gameFlags_check_40A5C0(2048) || *(_DWORD*)(a2 + 4) != *getMemU32Ptr(0x5D4594, 1568264))
		result =
...
int __cdecl sub_4EF6F0(int a1) {
	...
	if (!*getMemU32Ptr(0x5D4594, 1568268))
		*getMemU32Ptr(0x5D4594, 1568268) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 206368));
	v1 = 0;
	for (i = nox_xxx_inventoryGetFirst_4E7980(a1); i; i = nox_xxx_inventoryGetNext_4E7990(i)) {
		if (*(unsigned __int16*)(i + 4) == *getMemU32Ptr(0x5D4594, 1568268))
			++v1;
	}
	return v1;
}
...
//----- (004EF750) --------------------------------------------------------
_DWORD* __cdecl nox_xxx_playerRespawnItem_4EF750(int a1, CHAR* a2, int* a3, int a4, int a5) {
	_DWORD* v5;                          // eax
	_DWORD* v6;                          // esi
...
//----- (004EF7D0) --------------------------------------------------------
char __cdecl nox_xxx_playerMakeDefItems_4EF7D0(int a1, int a2, int a3) {
	int v3;                  // esi
	int v4;                  // edi
	int v5;                  // eax
	int v6;                  // ecx
	...
	*(_DWORD*)(v3 + 16) &= 0xFFEB3FE7;
	nox_xxx_playerSetState_4FA020((_DWORD*)v3, 13);
	...
	*(_DWORD*)(v3 + 520) = 0;
	...
	if (v7 && !*(_DWORD*)(v7 + 4700)) {
		nox_xxx_netReportTotalHealth_4D85C0(*(unsigned __int8*)(v7 + 2064), (_DWORD*)v3);
		nox_xxx_netReportTotalMana_4D88C0(*(unsigned __int8*)(*(_DWORD*)(v4 + 276) + 2064), v3);
		if (a3) {
			...
			if (nox_common_gameFlags_check_40A5C0(2048)) {
				...
				*(_DWORD*)v18 = nox_xxx_modifGetDescById_413330(v13);
				*(_DWORD*)&v18[8] = 0;
				*(_DWORD*)&v18[12] = 0;
				if (*(_BYTE*)(*(_DWORD*)(v4 + 276) + 2251)) {
					...
					*(_DWORD*)&v18[4] = nox_xxx_modifGetDescById_413330(v14);
				}
				LOBYTE(v7) = (unsigned int)nox_xxx_playerRespawnItem_4EF750(
					v3, *(CHAR**)getMemAt(0x587000, 4 * *(unsigned __int8*)(*(_DWORD*)(v4 + 276) + 2251) + 206376), (int*)v18,
					1, 0);
				...
				*(_DWORD*)&v18[12] = 0;
				if (*(_BYTE*)(*(_DWORD*)(v4 + 276) + 2251) == 1) {
					...
					*(_DWORD*)&v18[8] = nox_xxx_modifGetDescById_413330(v15);
				}
				LOBYTE(v7) = (unsigned int)nox_xxx_playerRespawnItem_4EF750(
					v3, *(CHAR**)getMemAt(0x587000, 4 * *(unsigned __int8*)(*(_DWORD*)(v4 + 276) + 2251) + 206388), (int*)v18,
					1, 0);
			} else {
...
//----- (004EFC30) --------------------------------------------------------
int __cdecl nox_xxx_netSendPlayerRespawn_4EFC30(int a1, char a2) {
	char v3[9]; // [esp+0h] [ebp-Ch]

	v3[0] = -23;
	*(_DWORD*)&v3[3] = *getMemU32Ptr(0x5D4594, 2598000);
...
//----- (004EFC80) --------------------------------------------------------
int __cdecl nox_xxx_spellAdward_4EFC80(int a1) {
	int v1;     // edi
	_DWORD* v2; // ebx
	char v3;    // al
	...
	if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_5)) {
		...
		do {
			*v2 = 0;
			nox_xxx_playerAwardSpellProtection_56FCE0(*(_DWORD*)(a1 + 4636), v1++, 0);
			++v2;
		} while (v1 < 137);
		if (nox_common_gameFlags_check_40A5C0(4096)) {
			v3 = *(_BYTE*)(a1 + 2251);
			if (v3 == 1) {
				nox_xxx_spellGrantToPlayer_4FB550_magic_plyrspel(*(_DWORD*)(a1 + 2056), 27, 1, 1, 1);
			} else if (v3 == 2) {
				nox_xxx_spellGrantToPlayer_4FB550_magic_plyrspel(*(_DWORD*)(a1 + 2056), 9, 1, 1, 1);
				nox_xxx_spellGrantToPlayer_4FB550_magic_plyrspel(*(_DWORD*)(a1 + 2056), 41, 1, 1, 1);
			}
		}
	}
...
//----- (004EFD80) --------------------------------------------------------
int __cdecl nox_xxx_spellAdward_4EFD80(int a1) {
	int v1;     // esi
	_DWORD* v2; // ebx
	...
	if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_5)) {
		...
		do {
			*v2 = 0;
			nox_xxx_playerAwardSpellProtection_56FCE0(*(_DWORD*)(a1 + 4640), v1++, 0);
			++v2;
		} while (v1 < 41);
	}
...
//----- (004EFE10) --------------------------------------------------------
char __cdecl nox_xxx_spellAdward_4EFE10(int a1) {
	char result; // al
	int v2;      // esi
	_DWORD* v3;  // ebx
...
//----- (004EFE80) --------------------------------------------------------
char __cdecl nox_xxx_unitInitPlayer_4EFE80(int a1) {
	int v1;   // edi
	int v2;   // eax
...
int __cdecl sub_4EFF10(int a1) {
	...
	*(_WORD*)(v1 + 4) = v2;
	*(_WORD*)(v1 + 6) = v2;
	nox_xxx_protectPlayerHPMana_56F870(*(_DWORD*)(v3 + 4596), v2);
	*(_DWORD*)(v1 + 192) = 0;
	*(_DWORD*)(v1 + 196) = 0;
	*(_DWORD*)(v1 + 200) = 0;
	*(_DWORD*)(v1 + 204) = 0;
	...
	*(_DWORD*)(a1 + 16) = v4;
	...
	sub_4F7950(a1);
	nox_xxx_netReportTotalHealth_4D85C0(*(unsigned __int8*)(*(_DWORD*)(v1 + 276) + 2064), (_DWORD*)a1);
	nox_xxx_netReportTotalMana_4D88C0(*(unsigned __int8*)(*(_DWORD*)(v1 + 276) + 2064), a1);
	*(_DWORD*)(a1 + 520) = 0;
	result = -559023410;
...
//----- (004F0040) --------------------------------------------------------
int __cdecl nox_xxx_unitMonsterInit_4F0040(int a1) {
	int v1;     // eax
	int v2;     // edi
	int v3;     // edx
	int* v4;    // eax
	...
	if (!*getMemU32Ptr(0x5D4594, 1568272)) {
		v1 = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 206628));
...
LABEL_15:
	...
	case 0xF:
		...
		if (v6) {
			v6[1] = *(_DWORD*)(a1 + 56);
			v6[2] = *(_DWORD*)(a1 + 60);
			v6[3] = *getMemU32Ptr(0x5D4594, 2598000);
		}
		break;
	case 0x26:
		break;
	...
	*(_DWORD*)(v2 + 384) = *(_DWORD*)(a1 + 60);
	v10 = *(_WORD**)(a1 + 556);
	if (*v10 == v10[2])
		nox_xxx_unitSetHP_4E4560(a1, (__int64)((double)(unsigned __int16)v10[2] * *(float*)(v2 + 1352)));
	*(_WORD*)(*(_DWORD*)(a1 + 556) + 2) = **(_WORD**)(a1 + 556);
	v11 = v2 + 412;
	v12 = 32;
	do {
...
//----- (004F0390) --------------------------------------------------------
_DWORD* __cdecl nox_xxx_unitSparkInit_4F0390(int a1) {
	_DWORD* result; // eax
...
//----- (004F03B0) --------------------------------------------------------
int __cdecl nox_xxx_initFrog_4F03B0(int a1) {
	_BYTE* v1;  // esi
	int result; // eax
...
//----- (004F0400) --------------------------------------------------------
int* __cdecl nox_xxx_initChest_4F0400(int a1) {
	int* result; // eax
...
//----- (004F0420) --------------------------------------------------------
_DWORD* __cdecl nox_xxx_unitBoulderInit_4F0420(_DWORD* a1) {
	_DWORD* result; // eax
	int v2;         // edx
...
int __cdecl sub_4F0450(int a1) {
	...
	v1 = *(_DWORD*)(a1 + 748);
	v2 = nox_xxx_xferDirectionToAngle_509E00(*(_DWORD**)(a1 + 692));
	*(_WORD*)(a1 + 126) = v2;
	*(_WORD*)(a1 + 124) = v2;
...
int __cdecl sub_4F0490(int a1) {
	...
	result = nox_xxx_xferDirectionToAngle_509E00(*(_DWORD**)(a1 + 692));
	*(_WORD*)(a1 + 126) = result;
	*(_WORD*)(a1 + 124) = result;
	return result;
}
...
//----- (004F04B0) --------------------------------------------------------
int __cdecl nox_xxx_unitInitGold_4F04B0(int a1) {
	int result; // eax
	_DWORD* v2; // edi
	char* v3;   // eax
	int v4;     // esi
	...
	if (!*v2) {
		...
		v6 = nox_common_randomInt_415FA0((__int64)(v9 * *(double*)&qword_581450_10256),
										 (__int64)(v9 * *getMemDoublePtr(0x581450, 10264))) -
			 (unsigned __int64)(__int64)(v9 * *getMemDoublePtr(0x581450, 10248));
...
//----- (004F0570) --------------------------------------------------------
int* __cdecl nox_xxx_breakInit_4F0570(int a1) {
	int* result; // eax
...
//----- (004F0590) --------------------------------------------------------
int __cdecl nox_xxx_unitInitGenerator_4F0590(int a1) {
	int v1;     // esi
	double v2;  // st7
	int result; // eax
...
_DWORD* __cdecl nox_server_rewardgen_activateMarker_4F0720(int a1, unsigned int a2) {
	...
	if (!*getMemU32Ptr(0x5D4594, 1568276)) {
		v2 = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 212928));
	...
	LABEL_14:
		...
		if (v6) {
			...
			case 4u:
				...
				break;
			case 8u:
				result = (_DWORD*)nox_xxx_rewardMakeWeapon_4F14E0(v3, a2);
				break;
			case 0x10u:
...
//----- (004F09F0) --------------------------------------------------------
_DWORD* __cdecl nox_xxx_rewardSpellBook_4F09F0(int a1, unsigned int a2) {
	int v2;               // esi
	int v3;               // ecx
	int i;                // eax
	int v5;               // eax
	...
	v9 = *getMemU32Ptr(0x587000, 12 * v16 + 207108);
LABEL_27:
	if (!v9)
		return 0;
...
//----- (004F0C70) --------------------------------------------------------
_DWORD* __cdecl nox_xxx_rewardAbilityBook_4F0C70(int a1) {
	int v1;         // esi
	int v2;         // ecx
	int i;          // eax
	_DWORD* result; // eax
...
//----- (004F0D20) --------------------------------------------------------
_DWORD* __cdecl nox_xxx_rewardFieldGuide_4F0D20(int a1, unsigned int a2) {
	int v2;               // esi
	int v3;               // ecx
	int i;                // eax
	_DWORD* result;       // eax
...
//----- (004F0E80) --------------------------------------------------------
_DWORD* __cdecl nox_xxx_rewardMakeArmor_4F0E80(int a1, unsigned int a2) {
	int v2;                  // ebx
	int v3;                  // edi
	...
	do {
		if (*(v4 - 4) & 2 && v2 & *(_DWORD*)v4 && nox_xxx_getUnitDefDd10_4E3BA0(*((_DWORD*)v4 - 2)))
			v3 += *(v4 - 16);
		v5 = *((_DWORD*)v4 + 2);
		v4 += 20;
	} while (v5);
	...
	for (i = getMemAt(0x587000, 208192);; i += 20) {
		if (*(i - 4) & 2) {
			if (v64 & *(_DWORD*)i) {
				if (nox_xxx_getUnitDefDd10_4E3BA0(*((_DWORD*)i - 2))) {
					v8 += *(i - 16);
					if (v7 < v8)
						break;
				}
	...
	v12 = *getMemU32Ptr(0x587000, 20 * v9 + 208184);
	if (!v12)
		return 0;
	v13 = sub_415D10(*(char**)getMemAt(0x587000, 20 * v9 + 208184));
	...
	LABEL_27:
		...
		*(_WORD*)&v67[18] = 0;
		...
		if (v17 & 4) {
			...
			do {
				if (v64 & *((_DWORD*)v26 + 2) && v13 & *(_DWORD*)(*(_DWORD*)v26 + 32) && !(v13 & *((_DWORD*)v26 + 3)) &&
	...
	*(_DWORD*)v67 = *getMemU32Ptr(0x587000, 24 * v33 + 210852);
LABEL_103:
	if (v17 & 2) {
		v36 = 0;
		if (*getMemU32Ptr(0x587000, 211000)) {
			...
			if (v36) {
				...
				if (*getMemU32Ptr(0x587000, 211000)) {
					...
					do {
						if (v64 & *((_DWORD*)v42 + 2) && v13 & *(_DWORD*)(*(_DWORD*)v42 + 32) &&
							!(v13 & *((_DWORD*)v42 + 3))) {
							if (v40 == v39) {
								*(_DWORD*)&v67[4] = *getMemU32Ptr(0x587000, 24 * v41 + 210996);
								break;
							}
							++v40;
						}
	...
	if (v17 & 4) {
		...
		if (*getMemU32Ptr(0x587000, 209344)) {
			...
			do {
				if (v64 & *((_DWORD*)v45 + 2) && v13 & *(_DWORD*)(*(_DWORD*)v45 + 32) && !(v13 & *((_DWORD*)v45 + 3)) &&
			...
			if (v44) {
				...
				if (*getMemU32Ptr(0x587000, 209344)) {
					...
					do {
						if (v64 & *((_DWORD*)v50 + 2) && v13 & *(_DWORD*)(*(_DWORD*)v50 + 32) &&
							!(v13 & *((_DWORD*)v50 + 3)) && *(_BYTE*)(*(_DWORD*)v50 + 36) & 1) {
							if (v48 == v47) {
								v65 = v49;
								*(_DWORD*)&v67[8] = *getMemU32Ptr(0x587000, 24 * v49 + 209340);
								break;
							}
							++v48;
						}
	...
	if (v17 & 8) {
		...
		if (*getMemU32Ptr(0x587000, 209344)) {
			...
			do {
				if (v55 & *((_DWORD*)v57 + 2) && v13 & *(_DWORD*)(*(_DWORD*)v57 + 32) && !(v13 & *((_DWORD*)v57 + 3)) &&
			...
			if (v56) {
				...
				if (*getMemU32Ptr(0x587000, 209344)) {
					...
					do {
						if (v55 & *((_DWORD*)v62 + 2) && v13 & *(_DWORD*)(*(_DWORD*)v62 + 32) &&
							!(v13 & *((_DWORD*)v62 + 3)) && *(_BYTE*)(*(_DWORD*)v62 + 36) & 2) {
							if (v60 == v59) {
								if (getMemByte(0x587000, 24 * v65 + 209336) != getMemByte(0x587000, 24 * v61 + 209336))
									*(_DWORD*)&v67[12] = *getMemU32Ptr(0x587000, 24 * v61 + 209340);
								break;
							}
							++v60;
						}
...
//----- (004F14E0) --------------------------------------------------------
int __cdecl nox_xxx_rewardMakeWeapon_4F14E0(int a1, unsigned int a2) {
	int v2;                  // ebx
	int v3;                  // edi
	unsigned __int8* v4;     // esi
	int v5;                  // eax
	...
	v4 = getMemAt(0x587000, 208192);
	do {
		if (*(v4 - 4) & 1 && v2 & *(_DWORD*)v4 && nox_xxx_getUnitDefDd10_4E3BA0(*((_DWORD*)v4 - 2)))
			v3 += *(v4 - 16);
		v5 = *((_DWORD*)v4 + 2);
		v4 += 20;
	} while (v5);
	...
	if (*getMemU32Ptr(0x587000, 208180)) {
		...
		while (1) {
			if (*(v10 - 4) & 1) {
				if (v72 & *(_DWORD*)v10) {
					if (nox_xxx_getUnitDefDd10_4E3BA0(*((_DWORD*)v10 - 2))) {
						v8 += *(v10 - 16);
						if (v7 < v8)
							break;
					}
		...
		v12 = *(char**)getMemAt(0x587000, 20 * v9 + 208184);
	} else {
	LABEL_17:
		v12 = (char*)a2;
	}
	...
	if (v15 & 0x1000 && *(_DWORD*)(v14 + 12) & 0x47F0000) {
		if (**(_BYTE**)getMemAt(0x587000, 20 * v9 + 208180) == 35) {
			*(_DWORD*)v76 = 0;
			*(_DWORD*)&v76[4] = 0;
			v16 = nox_xxx_modifGetIdByName_413290("Replenishment1");
			*(_DWORD*)&v76[8] = nox_xxx_modifGetDescById_413330(v16);
			*(_DWORD*)&v76[12] = 0;
			*(_WORD*)&v76[16] = 0;
			*(_WORD*)&v76[18] = 0;
	...
	LABEL_67:
		...
		if (v19 & 4) {
			...
			do {
				if (v72 & *((_DWORD*)v29 + 2) && v22 & *(_DWORD*)(*(_DWORD*)v29 + 28) && !(v22 & *((_DWORD*)v29 + 4)) &&
		...
		if (v19 & 1) {
			...
			if (*getMemU32Ptr(0x587000, 210712)) {
				...
				do {
					if (*((_DWORD*)v32 + 2) & v72 && v22 & *(_DWORD*)(*(_DWORD*)v32 + 28) &&
						!(v22 & *((_DWORD*)v32 + 4)))
						++v31;
					v33 = *((_DWORD*)v32 + 7);
					v32 += 24;
				...
				if (v31) {
					...
					if (*getMemU32Ptr(0x587000, 210712)) {
						...
						do {
							if (v72 & *((_DWORD*)v37 + 2) && v22 & *(_DWORD*)(*(_DWORD*)v37 + 28) &&
								!(v22 & *((_DWORD*)v37 + 4))) {
								if (v35 == v34) {
									*(_DWORD*)v76 = *getMemU32Ptr(0x587000, 24 * v36 + 210708);
									break;
								}
								++v35;
							}
		...
		if (v19 & 2) {
			...
			if (*getMemU32Ptr(0x587000, 211000)) {
				...
				do {
					if (v72 & *((_DWORD*)v40 + 2) && v22 & *(_DWORD*)(*(_DWORD*)v40 + 28) &&
						!(v22 & *((_DWORD*)v40 + 4)))
						++v39;
					v41 = *((_DWORD*)v40 + 7);
					v40 += 24;
				...
				if (v39) {
					...
					if (*getMemU32Ptr(0x587000, 211000)) {
						...
						do {
							if (v72 & *((_DWORD*)v45 + 2) && v22 & *(_DWORD*)(*(_DWORD*)v45 + 28) &&
								!(v22 & *((_DWORD*)v45 + 4))) {
								if (v43 == v42) {
									*(_DWORD*)&v76[4] = *getMemU32Ptr(0x587000, 24 * v44 + 210996);
									break;
								}
								++v43;
							}
		...
		if (v19 & 4) {
			...
			if (*getMemU32Ptr(0x587000, 209344)) {
				...
				do {
					if (v50 & *((_DWORD*)v52 + 2) && v73 & *(_DWORD*)(*(_DWORD*)v52 + 28) &&
						!(v73 & *((_DWORD*)v52 + 4)) && *(_BYTE*)(*(_DWORD*)v52 + 36) & 1) {
						++v51;
					}
					v53 = *((_DWORD*)v52 + 7);
					v52 += 24;
				...
				if (v51) {
					...
					if (*getMemU32Ptr(0x587000, 209344)) {
						...
						do {
							if (v50 & *((_DWORD*)v57 + 2)) {
								if (v73 & *(_DWORD*)(*(_DWORD*)v57 + 28) && !(v73 & *((_DWORD*)v57 + 4)) &&
									*(_BYTE*)(*(_DWORD*)v57 + 36) & 1) {
									if (v55 == v54) {
										LOBYTE(v19) = v71;
										v74 = v56;
										*(_DWORD*)&v76[8] = *getMemU32Ptr(0x587000, 24 * v56 + 209340);
										break;
									}
									++v55;
								}
		...
		if (v19 & 8) {
			...
			if (*getMemU32Ptr(0x587000, 209344)) {
				...
				do {
					if (v62 & *((_DWORD*)v64 + 2) && v73 & *(_DWORD*)(*(_DWORD*)v64 + 28) &&
						!(v73 & *((_DWORD*)v64 + 4)) && *(_BYTE*)(*(_DWORD*)v64 + 36) & 2) {
						++v63;
					}
					v65 = *((_DWORD*)v64 + 7);
					v64 += 24;
				...
				if (v63) {
					...
					if (*getMemU32Ptr(0x587000, 209344)) {
						...
						do {
							if (v62 & *((_DWORD*)v69 + 2) && v73 & *(_DWORD*)(*(_DWORD*)v69 + 28) &&
								!(v73 & *((_DWORD*)v69 + 4)) && *(_BYTE*)(*(_DWORD*)v69 + 36) & 2) {
								if (v67 == v66) {
									if (getMemByte(0x587000, 24 * v74 + 209336) != getMemByte(0x587000, 24 * v68 + 209336))
										*(_DWORD*)&v76[12] = *getMemU32Ptr(0x587000, 24 * v68 + 209340);
									break;
								}
								++v67;
							}
...
//----- (004F1C40) --------------------------------------------------------
_DWORD* __cdecl nox_xxx_rewardMakePotion_4F1C40(int a1, unsigned int a2) {
	int v2;              // ebx
	int v3;              // edi
	unsigned __int8* v4; // esi
	int v5;              // eax
	...
	v4 = getMemAt(0x587000, 208192);
	do {
		if (*(v4 - 4) & 4 && v2 & *(_DWORD*)v4 && nox_xxx_getUnitDefDd10_4E3BA0(*((_DWORD*)v4 - 2)))
			v3 += *(v4 - 16);
		v5 = *((_DWORD*)v4 + 2);
		v4 += 20;
	} while (v5);
	...
	if (*getMemU32Ptr(0x587000, 20 * v9 + 208184))
		result = nox_new_objMem_2_4E3450(*getMemU32Ptr(0x587000, 20 * v9 + 208184));
	else
	LABEL_24:
		result = 0;
	return result;
...
//----- (004F1D30) --------------------------------------------------------
_DWORD* __cdecl nox_xxx_createGem_4F1D30(int a1, unsigned int a2) {
	unsigned int v2; // ebx
	int v3;          // eax
	_DWORD* result;  // eax
	_DWORD* v5;      // edi
...
//----- (004F1F00) --------------------------------------------------------
_DWORD* __cdecl nox_xxx_createGem2_4F1F00(int a1, unsigned int a2) { return nox_xxx_createGem_4F1D30(a1, a2); }
...
void sub_4F2110() {
	...
	if (!dword_5d4594_1568280) {
		dword_5d4594_1568280 = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 214996));
		*getMemU32Ptr(0x5D4594, 1568284) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215012));
	}
	for (i = nox_server_getFirstObject_4DA790(); i; i = nox_server_getNextObject_4DA7A0(i)) {
		v2 = *(unsigned __int16*)(i + 4);
		if (((unsigned __int16)v2 == dword_5d4594_1568280 || v2 == *getMemU32Ptr(0x5D4594, 1568284)) &&
			(**(_BYTE**)(i + 692) & 0x80)) {
			++v0;
		}
	}
...
int sub_4F2210() {
	...
	if (!dword_5d4594_1568288) {
		dword_5d4594_1568288 = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215080));
		*getMemU32Ptr(0x5D4594, 1568292) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215096));
		*getMemU32Ptr(0x5D4594, 1568296) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215116));
	}
	if (v1 == 1) {
		v28 = 0.5;
	} else {
...
BOOL __cdecl sub_4F2530(int a1) {
	...
	if (!*getMemU32Ptr(0x587000, 207796))
		return 0;
	for (i = getMemAt(0x587000, 207796); v1 != a1 || !*((_DWORD*)i + 1); i += 12) {
		v1 = *((_DWORD*)i + 3);
		if (!v1)
			return 0;
	}
...
//----- (004F2570) --------------------------------------------------------
BOOL __cdecl sub_4F2570(int a1) { return a1 > 0 && a1 < 6; }
...
int __cdecl sub_4F2590(int a1) {
	...
	if (!*getMemU32Ptr(0x5D4594, 1568328)) {
		*getMemU32Ptr(0x5D4594, 1568328) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215208));
		*getMemU32Ptr(0x5D4594, 1568332) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215216));
		*getMemU32Ptr(0x5D4594, 1568336) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215224));
		*getMemU32Ptr(0x5D4594, 1568340) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215232));
		*getMemU32Ptr(0x5D4594, 1568344) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215252));
		*getMemU32Ptr(0x5D4594, 1568352) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215268));
		*getMemU32Ptr(0x5D4594, 1568348) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215280));
	}
	v1 = *(_DWORD*)(a1 + 8);
	if (v1 & 0x40)
		return 0;
	...
	v3 = *(unsigned __int16*)(a1 + 4);
	if ((unsigned __int16)v3 != *getMemU32Ptr(0x5D4594, 1568328) && v3 != *getMemU32Ptr(0x5D4594, 1568332) &&
...
int __cdecl sub_4F2700(int a1) {
	...
	if (v1 & 1) {
		if (*getMemU32Ptr(0x587000, 207108)) {
			...
			for (i = getMemAt(0x587000, 207108); v2 != **(unsigned __int8**)(a1 + 736) || !*((_DWORD*)i + 1); i += 12) {
				v2 = *((_DWORD*)i + 3);
				if (!v2)
					return 0;
			}
	...
	if (v1 & 2) {
		...
		if (*getMemU32Ptr(0x587000, 207796)) {
			for (j = getMemAt(0x587000, 207796); v6 != v5 || !*((_DWORD*)j + 1); j += 12) {
				v6 = *((_DWORD*)j + 3);
				if (!v6)
					return 0;
			}
...
int __cdecl sub_4F27E0(int a1) {
	...
	if (v3) {
		v4 = 0;
		if (*getMemU32Ptr(0x587000, 210712)) {
			for (i = getMemAt(0x587000, 210712); *((_DWORD*)i - 1) != v1; i += 24) {
				v6 = *((_DWORD*)i + 6);
				++v4;
				if (!v6)
					return 0;
			}
			v8 = getMemAt(0x587000, 24 * v4 + 210704);
			goto LABEL_18;
		}
		return 0;
	}
	...
	if (!*getMemU32Ptr(0x587000, 210856))
		return 0;
	for (j = getMemAt(0x587000, 210856); *((_DWORD*)j - 1) != v1; j += 24) {
		v11 = *((_DWORD*)j + 6);
		++v9;
		if (!v11)
			return 0;
	}
	v8 = getMemAt(0x587000, 24 * v9 + 210848);
LABEL_18:
	if (!v8)
		return 0;
	if (v3) {
...
int __cdecl sub_4F28C0(int a1) {
	...
	if (v1) {
		...
		if (!*getMemU32Ptr(0x587000, 211000))
			return 0;
		for (i = getMemAt(0x587000, 211000); *((_DWORD*)i - 1) != v1; i += 24) {
			v5 = *((_DWORD*)i + 6);
			++v3;
			if (!v5)
				return 0;
		}
		v7 = getMemAt(0x587000, 24 * v3 + 210992);
		if (!v7)
			return 0;
		if (*(_DWORD*)(a1 + 8) & 0x1000000) {
...
int __cdecl sub_4F2960(int a1) {
	...
	while (1) {
		...
		v9 = getMemAt(0x587000, 24 * v10 + 209336);
		if (!v9) {
		LABEL_18:
	...
	v12 = 0;
	if (*getMemU32Ptr(0x587000, 208180)) {
		v13 = *(_BYTE**)getMemAt(0x587000, 208180);
...
BOOL __cdecl sub_4F2C30(int a1) {
	...
	if (!*getMemU32Ptr(0x5D4594, 1568356)) {
		*getMemU32Ptr(0x5D4594, 1568356) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215384));
		*getMemU32Ptr(0x5D4594, 1568360) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215396));
		*getMemU32Ptr(0x5D4594, 1568364) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215408));
		*getMemU32Ptr(0x5D4594, 1568368) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215428));
		*getMemU32Ptr(0x5D4594, 1568372) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215440));
		*getMemU32Ptr(0x5D4594, 1568376) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215460));
		*getMemU32Ptr(0x5D4594, 1568380) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215476));
		*getMemU32Ptr(0x5D4594, 1568384) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215492));
		*getMemU32Ptr(0x5D4594, 1568388) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215512));
		*getMemU32Ptr(0x5D4594, 1568392) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215532));
		*getMemU32Ptr(0x5D4594, 1568396) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215552));
		*getMemU32Ptr(0x5D4594, 1568400) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215576));
		*getMemU32Ptr(0x5D4594, 1568404) = nox_xxx_getNameId_4E3AA0((CHAR*)getMemAt(0x587000, 215596));
	}
	if (!a1 || !(*(_BYTE*)(a1 + 8) & 4))
		return 1;
	if (nox_xxx_inventoryCountObjects_4E7D30(a1, *getMemIntPtr(0x5D4594, 1568356)) > 9 || nox_xxx_inventoryCountObjects_4E7D30(a1, *getMemIntPtr(0x5D4594, 1568360)) > 9 ||
		nox_xxx_inventoryCountObjects_4E7D30(a1, *getMemIntPtr(0x5D4594, 1568364)) > 9 || nox_xxx_inventoryCountObjects_4E7D30(a1, *getMemIntPtr(0x5D4594, 1568368)) > 9 ||
		nox_xxx_inventoryCountObjects_4E7D30(a1, *getMemIntPtr(0x5D4594, 1568372)) > 9 || nox_xxx_inventoryCountObjects_4E7D30(a1, *getMemIntPtr(0x5D4594, 1568376)) > 9 ||
		nox_xxx_inventoryCountObjects_4E7D30(a1, *getMemIntPtr(0x5D4594, 1568380)) > 9 || nox_xxx_inventoryCountObjects_4E7D30(a1, *getMemIntPtr(0x5D4594, 1568384)) > 9 ||
		nox_xxx_inventoryCountObjects_4E7D30(a1, *getMemIntPtr(0x5D4594, 1568388)) > 9 || nox_xxx_inventoryCountObjects_4E7D30(a1, *getMemIntPtr(0x5D4594, 1568392)) > 9 ||
...
//----- (004F2E70) --------------------------------------------------------
BOOL __cdecl nox_xxx_spell_4F2E70(int a1) {
	int v1;              // eax
	int v2;              // esi
	unsigned __int8* v3; // ecx
...
//----- (004F2F70) --------------------------------------------------------
int __cdecl nox_xxx_playerTryEquip_4F2F70(_DWORD* a1, int a2) {
	int result; // eax
...
//----- (004F2FB0) --------------------------------------------------------
int __cdecl nox_xxx_playerTryDequip_4F2FB0(_DWORD* a1, int a2) {
	int result; // eax

	if (nox_xxx_playerDequipWeapon_53A140(a1, a2, 1, 1) || (result = sub_53E430(a1, a2, 1, 1)) != 0)
		result = 1;
	return result;
}

//----- (004F2FF0) --------------------------------------------------------
int __cdecl nox_xxx_itemApplyEngageEffect_4F2FF0(int a1, int a2) {
	int v2;                           // ebp
	int* v3;                          // esi
	int result;                       // eax
...
//----- (004F3030) --------------------------------------------------------
int __cdecl nox_xxx_itemApplyDisengageEffect_4F3030(int a1, int a2) {
	int v2;                           // ebp
	int* v3;                          // esi
	int result;                       // eax
	int(__cdecl * v5)(int, int, int); // ecx
...
//----- (004F3070) --------------------------------------------------------
void __cdecl nox_xxx_inventoryPutImpl_4F3070(int a1, int a2, int a3) {
	int v3; // ebp
	int v4; // eax
	int v5; // ebx
	int i;  // eax
...
//----- (004F3180) --------------------------------------------------------
bool __cdecl nox_xxx_playerCheckStrength_4F3180(int a1, int a2) {
	int v2;      // esi
	_DWORD* v3;  // eax
	bool result; // al
...
//----- (004F31E0) --------------------------------------------------------
int __cdecl nox_xxx_pickupDefault_4F31E0(int a1, int a2, int a3) {
	BOOL v3;    // eax
	int v4;     // edi
	int v5;     // ebp
	char* v6;   // eax
	...
	if (v3 || !nox_xxx_servObjectHasTeam_419130(a2 + 48) || nox_xxx_servCompareTeams_419150(v4 + 48, v5 + 48) ||
		...
		if (*(_BYTE*)(v4 + 8) & 4) {
			...
			nox_xxx_netInformTextMsg_4DA0F0(*(unsigned __int8*)(*(_DWORD*)(v7 + 276) + 2064), 16, &a1);
		}
		result = 0;
	}
	return result;
...
//----- (004F3350) --------------------------------------------------------
int __cdecl nox_xxx_pickupFood_4F3350(int a1, int a2, int a3) {
	int v4;              // ebx
	unsigned __int8* v5; // eax
	...
	if (v4) {
		...
		if (*getMemU16Ptr(0x587000, 215646)) {
			...
			nox_xxx_aud_501960(*((unsigned __int16*)v5 + 3), a1, 0, 0);
		}
	}
	return v4;
}
...
int __cdecl sub_4F3400(int a1, int a2, int a3) {
	...
	if (v5) {
		*(_DWORD*)(*(_DWORD*)(a1 + 748) + 264) = *getMemU32Ptr(0x5D4594, 2598000);
		nox_xxx_unitSetOwner_4EC290(a1, a2);
...
//----- (004F34D0) --------------------------------------------------------
int __cdecl nox_xxx_pickupUse_4F34D0(int a1, int a2, int a3) {
	int result; // eax
...
//----- (004F3510) --------------------------------------------------------
int __cdecl nox_xxx_pickupTrap_4F3510(int a1, int a2, int a3) {
	int v3;     // edi
	int result; // eax
...
//----- (004F3580) --------------------------------------------------------
int __cdecl nox_xxx_pickupTreasure_4F3580(int a1, int a2, int a3) {
	int v3;   // edi
	int v4;   // edi
	char* v5; // ebx
	int j;    // esi
	...
	*(_DWORD*)(*(_DWORD*)(v3 + 276) + 2156) = nox_xxx_scavengerTreasureMax_4D1600();
	nox_xxx_scavengerHuntReport_4D8CD0(a1);
	if (!nox_xxx_servObjectHasTeam_419130(a1 + 48)) {
		if (*(_DWORD*)(*(_DWORD*)(v3 + 276) + 2152) == nox_xxx_scavengerTreasureMax_4D1600()) {
			nox_xxx_setGameFlags_40A4D0(8);
...
//----- (004F36F0) --------------------------------------------------------
int __cdecl nox_xxx_inventoryServPlace_4F36F0(int a1, int a2, int a3, int a4) {
	int v4;                                // eax
	...
	if (*(_BYTE*)(a2 + 16) & 0x20)
		return 0;
	v4 = *(_DWORD*)(a1 + 16);
	if ((v4 & 0x8000) != 0 || !nox_xxx_getUnitDefDd10_4E3BA0(*(unsigned __int16*)(a2 + 4)) || !(*(_BYTE*)(a1 + 8) & 6))
		return 0;
...
//----- (004F37D0) --------------------------------------------------------
int __cdecl nox_xxx_pickupPotion_4F37D0(int a1, int a2, int a3) {
	int v3;     // ebx
	int* v4;    // eax
	int v5;     // edi
	char v7;    // al
	...
	if (nox_common_gameFlags_check_40A5C0(0x2000) && !nox_common_gameFlags_check_40A5C0(4096) &&
		*(_BYTE*)(a1 + 8) & 4 && !nox_xxx_playerClassCanUseItem_57B3D0(v3, *(_BYTE*)(*(_DWORD*)(*(_DWORD*)(a1 + 748) + 276) + 2251))) {
...
//----- (004F3B00) --------------------------------------------------------
int __cdecl nox_xxx_pickupAmmo_4F3B00(int a1, int a2, int a3, int a4) {
	int v4;               // ebp
	int v5;               // eax
	int v6;               // ebx
	int v7;               // esi
...
//----- (004F3C60) --------------------------------------------------------
int __cdecl nox_xxx_pickupSpellbook_4F3C60(int a1, int a2, int a3) {
	int v4; // ebx
...
//----- (004F3CE0) --------------------------------------------------------
int __cdecl nox_xxx_pickupAbilitybook_4F3CE0(int a1, int a2, int a3) {
	int v4; // esi
...
//----- (004F3F50) --------------------------------------------------------
int __cdecl nox_xxx_servMapLoadPlaceObj_4F3F50(int a1, int a2, int* a3) {
	int v3;     // eax
	int v4;     // edi
	int result; // eax
	char* v6;   // eax
	...
	if (nox_common_gameFlags_check_40A5C0(0x400000) || nox_xxx_getUnitDefDd10_4E3BA0(*(unsigned __int16*)(a1 + 4))) {
		if (a3) {
...
char __cdecl sub_4F40A0(int a1) {
	...
	if (a1) {
		...
		if (*(_BYTE*)(a1 + 52))
			return -1;
		v2 = nox_xxx_unitDefGet_4E3B70(*(unsigned __int16*)(a1 + 4));
...
//----- (004F4170) --------------------------------------------------------
int __cdecl nox_xxx_readObjectOldVer_4F4170(int a1, int a2, int a3) {
	_BYTE** v3;           // esi
	_BYTE* v4;            // ebx
	unsigned int v5;      // edx
	_BYTE* v6;            // eax
	...
	if (*getMemU32Ptr(0x5D4594, 3803300) == 1)
		*(_DWORD*)(a1 + 136) = 0;
	nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)v3 + 40, 4u);
	v4 = v3[4];
	...
	if (*getMemU32Ptr(0x5D4594, 3803300)) {
		if (a3 < 40 || a2 < 4) {
			...
			*((float*)v3 + 15) = (double)v23[1];
			...
			v10 = v3 + 14;
			nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)v3 + 56, 4u);
			nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)v3 + 60, 4u);
		}
		v11 = (_BYTE*)v10[1];
		v3[16] = (_BYTE*)*v10;
		v3[17] = v11;
	...
	if (v8 >= 10) {
		...
		nox_xxx_fileReadWrite_426AC0_file3_fread(*v3, (unsigned __int8)v19);
		if (*v3)
			(*v3)[(unsigned __int8)v19] = 0;
	}
	if (v8 >= 20)
		nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)v3 + 52, 1u);
	if (v8 >= 30) {
		v13 = v3[126];
	...
	if (v8 >= 40) {
		...
		if (!v3[11] && *getMemU32Ptr(0x5D4594, 3803300) == 1 && !nox_common_gameFlags_check_40A5C0(0x200000) &&
...
//----- (004F4530) --------------------------------------------------------
int __cdecl nox_xxx_mapReadWriteObjData_4F4530(int* a1, int a2) {
	int* v2;          // esi
	int v3;           // edi
	int v4;           // ecx
	__int16 v5;       // ax
	...
	v18 = 0;
	v23 = v4;
	if (a2 >= 40 || !*getMemU32Ptr(0x5D4594, 3803300)) {
		v18 = 64;
	...
	if (*getMemU32Ptr(0x5D4594, 3803300) == 1)
		v2[34] = 0;
	nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)v2 + 40, 4u);
	v7 = v2 + 11;
	nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)v2 + 44, 4u);
	if (!v2[11] && *getMemU32Ptr(0x5D4594, 3803300) == 1 && !nox_common_gameFlags_check_40A5C0(0x200000) &&
		!nox_common_gameFlags_check_40A5C0(0x400000))
	...
	if (*getMemU32Ptr(0x5D4594, 3803300)) {
		if ((__int16)v18 < 4) {
			...
			*((float*)v2 + 15) = (double)v22[1];
			...
			v8 = v2 + 14;
			nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)v2 + 56, 4u);
			nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)v2 + 60, 4u);
		}
		v9 = v8[1];
		v2[16] = *v8;
		v2[17] = v9;
	...
	if (*getMemU32Ptr(0x5D4594, 3803300) != 1 || !(_BYTE)a2 ||
		(result = (int)malloc((unsigned __int8)a2 + 1), (*v2 = result) != 0)) {
		nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)*v2, (unsigned __int8)a2);
		if (*v2)
			*(_BYTE*)((unsigned __int8)a2 + *v2) = 0;
		nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)v2 + 52, 1u);
		v14 = v2[126];
		...
		if (*getMemU32Ptr(0x5D4594, 3803300)) {
			...
			for (k = v2[129]; k; k = *(_DWORD*)(k + 512)) {
				if (!(*(_BYTE*)(k + 16) & 0x20) && sub_4E3B80(*(unsigned __int16*)(k + 4)))
					nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(k + 44), 4u);
			}
		}
		v21 = v2[5] & 0x5E;
		nox_xxx_fileReadWrite_426AC0_file3_fread(&v21, 4u);
		...
		if ((__int16)v18 < 63 || (result = nox_xxx_xferReadScriptHandler_4F5580((int)(v2 + 191), (char*)v2[189])) != 0) {
			if ((__int16)v18 >= 64) {
				v22[0] = v23 - *getMemU32Ptr(0x5D4594, 2598000);
				nox_xxx_fileReadWrite_426AC0_file3_fread(v22, 4u);
				if (v22[0] > 0 && *getMemU32Ptr(0x5D4594, 3803300) == 1) {
					if (v2[4] & 0x400000)
						v2[32] = v22[0];
				}
			}
...
//----- (004F49A0) --------------------------------------------------------
int __cdecl nox_xxx_XFerDefault_4F49A0(int a1) {
	int* v1;    // esi
	int v2;     // edi
	int result; // eax
...
//----- (004F4A20) --------------------------------------------------------
int __cdecl nox_xxx_XFerSpellPagePedistal_4F4A20(int a1) {
	int v1;     // esi
	int v2;     // edi
	int result; // eax
	...
	if ((__int16)a1 > 60)
		return 0;
	result = nox_xxx_mapReadWriteObjData_4F4530((int*)v1, (__int16)a1);
	if (result) {
		nox_xxx_fileReadWrite_426AC0_file3_fread(*(_BYTE**)(v1 + 700), 4u);
		if (!*(_DWORD*)(v1 + 136) || *getMemU32Ptr(0x5D4594, 3803300) != 1 ||
			(result = nox_xxx_xfer_4F3E30(a1, v1, *(_DWORD*)(v1 + 136))) != 0) {
			*(_DWORD*)(v1 + 136) = v2;
			result = 1;
		}
	}
...
//----- (004F4AB0) --------------------------------------------------------
int __cdecl nox_xxx_XFerReadable_4F4AB0(int a1) {
	int* v1;    // esi
	int v2;     // ebx
	int v3;     // edi
	int result; // eax
	...
	if (result) {
		if ((__int16)a1 >= 2) {
			...
			nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)v2, v5);
		} else {
			nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)v2, v5);
		}
		if (*getMemU32Ptr(0x5D4594, 3803300) != 1 || (*(_DWORD*)(v2 + 256) = 0, !v1[34]) ||
...
//----- (004F4B90) --------------------------------------------------------
int __cdecl nox_xxx_XFerExit_4F4B90(int a1) {
	int* v1;    // ebp
	_BYTE* v2;  // ebx
	int v3;     // edi
	int result; // eax
...
//----- (004F4CB0) --------------------------------------------------------
int __cdecl nox_xxx_XFerDoor_4F4CB0(int a1) {
	int v1;     // edi
	int v2;     // esi
	int result; // eax
	int v4;     // ebx
	...
	if ((__int16)v7 > 60)
		return 0;
	result = nox_xxx_mapReadWriteObjData_4F4530((int*)v1, (__int16)v7);
	if (result) {
		if (!*getMemU32Ptr(0x5D4594, 3803300)) {
			a1 = *(_DWORD*)(v2 + 12);
		...
		if (*getMemU32Ptr(0x5D4594, 3803300) == 1) {
			...
			*(_DWORD*)(v2 + 4) = v6;
			*(_DWORD*)(v2 + 8) = a1;
			v9 = *getMemIntPtr(0x587000, 8 * v6 + 196184) / 2;
			v4 = (__int64)(((double)v9 + *(float*)(v1 + 56)) * 0.043478262);
			v9 = *getMemIntPtr(0x587000, 8 * v6 + 196188) / 2;
		...
		if (!*(_DWORD*)(v1 + 136) || *getMemU32Ptr(0x5D4594, 3803300) != 1 ||
			(result = nox_xxx_xfer_4F3E30(v7, v1, *(_DWORD*)(v1 + 136))) != 0) {
			*(_DWORD*)(v1 + 136) = v10;
			result = 1;
		}
	}
...
//----- (004F4E50) --------------------------------------------------------
int __cdecl nox_xxx_unitTriggerXfer_4F4E50(float a1) {
	int v1;     // edi
	_BYTE* v2;  // esi
	int result; // eax
	double v4;  // st7
	...
	if (result) {
		...
		if (*getMemU32Ptr(0x5D4594, 3803300) == 1 && (__int16)v11 < 31) {
			nox_xxx_fileReadWrite_426AC0_file3_fread(&a1, 1u);
		...
		if (!*getMemU32Ptr(0x5D4594, 3803300) || (__int16)v11 >= 21) {
		...
		if ((__int16)v11 >= 61) {
			...
			nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v1 + 132), 4u);
			if (*getMemU32Ptr(0x5D4594, 3803300) == 1)
...
//----- (004F51D0) --------------------------------------------------------
int __cdecl nox_xxx_XFerHole_4F51D0(int a1) {
	int* v1;    // edi
	int v2;     // ebx
	int v3;     // esi
	int result; // eax
	...
	if (result) {
		if ((__int16)a1 < 42)
			*(_DWORD*)(v3 + 24) = 0;
			...
			nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v3 + 24), 4u);
		if ((__int16)a1 < 41) {
			nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v3 + 8), 8u);
			*(_DWORD*)(v3 + 4) = -1;
			*(_DWORD*)v3 = 0;
			*(_DWORD*)(v3 + 16) = 0;
			*(_WORD*)(v3 + 20) = 0;
			...
			nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v3 + 8), 8u);
			nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v3 + 16), 4u);
			nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v3 + 20), 2u);
		}
		if (!v1[34] || *getMemU32Ptr(0x5D4594, 3803300) != 1 || (result = nox_xxx_xfer_4F3E30(a1, (int)v1, v1[34])) != 0) {
			result = 1;
			v1[34] = v6;
...
//----- (004F5300) --------------------------------------------------------
int __cdecl nox_xxx_XFerTransporter_4F5300(int a1) {
	int* v1;    // esi
	int v2;     // edi
	int v3;     // ebx
	int result; // eax
	...
	if (result) {
		if (*getMemU32Ptr(0x5D4594, 3803300)) {
			nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 16), 4u);
		} else {
			if (*(_DWORD*)(v2 + 12))
				v5 = *(_DWORD*)(v2 + 16);
			else
...
//----- (004F53D0) --------------------------------------------------------
int __cdecl nox_xxx_XFerElevator_4F53D0(int a1) {
	int* v1;    // esi
	_BYTE* v2;  // edi
	int v3;     // ebx
	int result; // eax
...
//----- (004F54A0) --------------------------------------------------------
int __cdecl nox_xxx_XFerElevatorShaft_4F54A0(int a1) {
	int* v1;    // esi
	int v2;     // edi
	int v3;     // ebx
	int result; // eax
	...
	result = nox_xxx_mapReadWriteObjData_4F4530(v1, (__int16)a1);
	if (result) {
		nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 8), 4u);
		if (!v1[34] || *getMemU32Ptr(0x5D4594, 3803300) != 1 || (result = nox_xxx_xfer_4F3E30(a1, (int)v1, v1[34])) != 0) {
			v1[34] = v3;
			result = 1;
		}
...
int __cdecl sub_4F5540(int a1) {
	...
	result = *getMemU32Ptr(0x5D4594, 3803300);
	if (*getMemU32Ptr(0x5D4594, 3803300) == 1) {
...
//----- (004F5580) --------------------------------------------------------
int __cdecl nox_xxx_xferReadScriptHandler_4F5580(int a1, char* a2) {
	bool v3;       // zf
	int v4;        // eax
	...
	if (*getMemU32Ptr(0x5D4594, 3803300) == 1) {
		...
		if (!v3) {
			if (nox_common_gameFlags_check_40A5C0(6291456))
				...
				*(_DWORD*)(a1 + 4) = nox_xxx_scriptByNameMB_5071D0(v7);
		}
	} else {
		if (nox_common_gameFlags_check_40A5C0(6291456)) {
			if (a2) {
			...
			if (v4 != -1) {
				...
				nox_xxx_fileReadWrite_426AC0_file3_fread(&v5, 4u);
				nox_xxx_fileReadWrite_426AC0_file3_fread(*(_BYTE**)(48 * *(_DWORD*)(a1 + 4) + dword_5d4594_1599636), v5);
				goto LABEL_16;
			}
		}
		v5 = 0;
...
//----- (004F5730) --------------------------------------------------------
int __cdecl nox_xxx_XFerMover_4F5730(int a1) {
	int v1;     // edi
	int v2;     // esi
	int v3;     // ebp
	int result; // eax
	...
	result = nox_xxx_mapReadWriteObjData_4F4530((int*)v1, (__int16)v7);
	if (result) {
		nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 4), 4u);
		nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 8), 4u);
		nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 32), 4u);
		if ((__int16)v7 >= 41) {
			nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)v2, 1u);
			if (*getMemU32Ptr(0x5D4594, 3803300)) {
				nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 16), 4u);
				nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 24), 4u);
			} else {
				v5 = *(int**)(v2 + 12);
				a1 = 0;
				if (v5)
		...
		if ((__int16)v7 >= 42) {
			...
			nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v1 + 544), 4u);
		}
		if (!*(_DWORD*)(v1 + 136) || *getMemU32Ptr(0x5D4594, 3803300) != 1 ||
			(result = nox_xxx_xfer_4F3E30(v7, v1, *(_DWORD*)(v1 + 136))) != 0) {
			*(_DWORD*)(v1 + 136) = v3;
...
//----- (004F5890) --------------------------------------------------------
int __cdecl nox_xxx_XFerGlyph_4F5890(int a1) {
	int v1;        // edi
	int v2;        // ebp
	int v3;        // eax
	int result;    // eax
	...
	if ((__int16)v12 > 60)
		return 0;
	result = nox_xxx_mapReadWriteObjData_4F4530((int*)a1, (__int16)v12);
	if (result) {
		if ((__int16)v12 < 41)
			nox_xxx_fileReadWrite_426AC0_file3_fread(&v15, 4u);
		nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(a1 + 124), 1u);
		nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 28), 4u);
		nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 32), 4u);
		v5 = (_BYTE*)(v2 + 20);
		nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)(v2 + 20), 1u);
		if (*getMemU32Ptr(0x5D4594, 3803300) == 1) {
			if ((__int16)v12 < 31) {
				nox_xxx_fileReadWrite_426AC0_file3_fread((_BYTE*)v2, 0x14u);
				goto LABEL_16;
			}
			v6 = 0;
			if (!*v5) {
			...
			if (!*v5)
				goto LABEL_16;
			do {
				LOBYTE(v11) = strlen(nox_xxx_spellNameByN_424870(*(_DWORD*)v2));
				nox_xxx_fileReadWrite_426AC0_file3_fread(&v11, 1u);
				v10 = (unsigned __int8)v11;
				v9 = nox_xxx_spellNameByN_424870(*(_DWORD*)v2);
	...
	LABEL_16:
		...
		LABEL_20:
			if (!*(_DWORD*)(v1 + 136) || *getMemU32Ptr(0x5D4594, 3803300) != 1 ||
				(result = nox_xxx_xfer_4F3E30(v12, v1, *(_DWORD*)(v1 + 136))) != 0) {
				result = 1;
				*(_DWORD*)(v1 + 136) = v14;
			}
			return result;
...
//----- (004F5AA0) --------------------------------------------------------
int __cdecl nox_xxx_XFerInvLight_4F5AA0(int* a1) {
	int result;   // eax
	_DWORD* v2;   // eax
	...
	if ((__int16)v3 > 60)
		return 0;
	result = nox_xxx_mapReadWriteObjData_4F4530(a1, (__int16)v3);
	if (result) {
		if (*getMemU32Ptr(0x5D4594, 3803300))
			goto LABEL_14;
		if (nox_common_gameFlags_check_40A5C0(6291456)) {
		...
		if ((__int16)v3 >= 2) {
			...
			LABEL_19:
				if (*getMemU32Ptr(0x5D4594, 3803300) == 1)
					goto LABEL_20;
			LABEL_22:
				if (!a1[34] || *getMemU32Ptr(0x5D4594, 3803300) != 1 ||
...
//----- (004F5E50) --------------------------------------------------------
int __cdecl nox_xxx_XFerSentry_4F5E50(int a1) {
	int* v1;    // edi
	_BYTE* v2;  // esi
	int v3;     // ebp
	int result; // eax
	...
	if (result) {
		...
		nox_xxx_fileReadWrite_426AC0_file3_fread(v2 + 8, 4u);
		if (*getMemU32Ptr(0x5D4594, 3803300) == 1 || nox_common_gameFlags_check_40A5C0(0x200000))
