...
LABEL_120:
	...
	if (v33 > 0 && !a1)
		a1 = 1;
	if (nox_common_getEngineFlag(1u << 5u) && *(_BYTE*)(v5 + 8) & 4)
		return 1;
...
_DWORD* __cdecl nox_new_objMem_4E3470(int a1) {
	...
	*((_WORD*)obj + 2) = *(_WORD*)a1;
	...
	if (!nox_common_gameFlags_check_40A5C0(0x200000))
		obj[11] = (*(_DWORD*)&byte_587000[201376])++;
	v7 = obj[2];
	if (v7 & 0x100000) {
		...
		*(_DWORD*)(v4 + 3688) = 0;
		...
		if (result) {
			while (1) {
				...
				if (nox_common_getEngineFlag(1u << 18u) && v1 == dword_5d4594_3843628)
					goto LABEL_52;
				if (!sub_4DDF30(v1)) {
					sub_4DF3C0(v4);
					sub_4E6AA0(v4);
...
void __cdecl sub_4EE5E0(int a1, int a2) {
	...
	if (a1) {
		v2 = *(_DWORD*)(a1 + 556);
		if (v2) {
			if (*(_WORD*)(v2 + 4) && (!nox_common_getEngineFlag(1u << 5u) || !(*(_BYTE*)(a1 + 8) & 4))) {
				if (*(_BYTE*)(a1 + 8) & 4) {
					v3 = *(_DWORD*)(a1 + 748);
					if (v3) {
...
char* __cdecl sub_4EF500(int a1) {
	...
	if (result) {
		if (a1 == 1) {
			nox_common_setEngineFlag(1u << 4u | 1u << 5u);
		} else {
...
int __cdecl sub_4EFC80(int a1) {
	...
	v1 = 1;
	v2 = (_DWORD*)(a1 + 3700);
	if (nox_common_getEngineFlag(1u << 4u)) {
		do {
			*v2 = 3;
