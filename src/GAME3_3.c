		...
		if ((v2 & 0x80u) == 0) {
			...
			LABEL_14:
				...
				if (a2) {
					...
					if (v7 && !(getMemByte(0x85B3FC, 43076 + 12332 * *(unsigned __int8*)(v7 + 1)) & 5)) {
					LABEL_25:
...
//----- (004F2FB0) --------------------------------------------------------
int  nox_xxx_playerTryDequip_4F2FB0(_DWORD* a1, const nox_object_t* object) {
	int a2 = object;
	int result; // eax
...
int  nox_xxx_mapReadWriteObjData_4F4530(int* a1, int a2) {
	...
	v18 = 0;
	v23 = v4;
	if (a2 >= 40 || !*getMemU32Ptr(0x973F18, 3872)) {
		v18 = 64;
	...
	if (*getMemU32Ptr(0x973F18, 3872) != 1 || !(_BYTE)a2 ||
		...
		if ((__int16)v18 < 63 || (result = nox_xxx_xferReadScriptHandler_4F5580((int)(v2 + 191), (char*)v2[189])) != 0) {
			if ((__int16)v18 >= 64) {
				...
				nox_xxx_fileReadWrite_426AC0_file3_fread(v22, 4u);
				if (v22[0] > 0 && *getMemU32Ptr(0x973F18, 3872) == 1) {
					if (v2[4] & 0x400000)
						v2[32] = v22[0];
				}
			}
...
int  nox_xxx_XFerDefault_4F49A0(int a1) {
	...
	if (result) {
		if (!v1[34] || *getMemU32Ptr(0x973F18, 3872) != 1 || (result = nox_xxx_xfer_4F3E30(a1, (int)v1, v1[34])) != 0) {
			v1[34] = v2;
			result = 1;
		}
	}
...
int  nox_xxx_XFerSpellPagePedistal_4F4A20(int a1) {
	...
	if (result) {
		...
		if (!*(_DWORD*)(v1 + 136) || *getMemU32Ptr(0x973F18, 3872) != 1 ||
...
int  nox_xxx_XFerReadable_4F4AB0(int a1) {
	...
	if (result) {
		...
		if (*getMemU32Ptr(0x973F18, 3872) != 1 || (*(_DWORD*)(v2 + 256) = 0, !v1[34]) ||
...
int  nox_xxx_unitTriggerXfer_4F4E50(float a1) {
	...
	if (result) {
		...
		if (*getMemU32Ptr(0x973F18, 3872) == 1 && (__int16)v11 < 31) {
			nox_xxx_fileReadWrite_426AC0_file3_fread(&a1, 1u);
		...
		if (!*getMemU32Ptr(0x973F18, 3872) || (__int16)v11 >= 21) {
...
int  sub_4F5540(int a1) {
	...
	result = *getMemU32Ptr(0x973F18, 3872);
	if (*getMemU32Ptr(0x973F18, 3872) == 1) {
		...
		if ((__int16)v3 >= 2) {
			...
			LABEL_19:
				if (*getMemU32Ptr(0x973F18, 3872) == 1)
					goto LABEL_20;
			LABEL_22:
				if (!a1[34] || *getMemU32Ptr(0x973F18, 3872) != 1 ||
...
int  nox_xxx_XFerSentry_4F5E50(int a1) {
	...
	if (result) {
		...
		nox_xxx_fileReadWrite_426AC0_file3_fread(v2 + 8, 4u);
		if (*getMemU32Ptr(0x973F18, 3872) == 1 || nox_common_gameFlags_check_40A5C0(0x200000))
