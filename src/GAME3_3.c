...
int  nox_xxx_damageMonsterGen_4E27D0(int a1, int a2, int a3, int a4, int a5) {
	...
	if (*(_DWORD*)(a1 + 16) & 0x8020)
		return 0;
	if ((unsigned int)(nox_frame_xxx_2598000 - *(_DWORD*)(a1 + 536)) > 0x14 ||
		!(nox_frame_xxx_2598000 % 0x1Eu)) {
		if (a3) {
...
int  nox_xxx_netSendPacket_4E5030(int a1, const void* a2, signed int a3, int a4, int a5, char a6) {
	...
	if (a1 == 255 || (a1 & 0x80u) == 0 || dword_5d4594_2649712 & ~(1 << (a1 & 0x7F))) {
		...
		*((_DWORD*)v8 + 44) = dword_5d4594_2649712;
		memset(v8 + 4, 0, 0x80u);
		v9 = v8 + 186;
		*(_DWORD*)v8 = nox_frame_xxx_2598000;
		...
		LABEL_24:
			if (v15) {
				if (a2 && a1 != 31) {
					...
					v18[0] = -86;
					*(_DWORD*)&v18[1] = nox_frame_xxx_2598000;
					if (!v13(a1, a2, v18, 5))
						return;
				}
				v15 = 0;
...
void  sub_4E5F00(int(* a1)(int, int), int a2) {
	...
	for (i = *getMemU32Ptr(0x5D4594, 1565588); i; i = *(_DWORD*)(i + 452)) {
		if (*(_DWORD*)(i + 456) != nox_frame_xxx_2598000)
			a1(i, a2);
	}
}
...
BOOL  sub_4E6BD0(int a1) {
	return *(_DWORD*)(a1 + 556) && (unsigned int)(nox_frame_xxx_2598000 - *(_DWORD*)(a1 + 536)) <= 1;
}
	...
	if (a1 && !(*(_DWORD*)(a1 + 8) & 0x400000)) {
		...
		*(float2*)(a1 + 72) = *a2;
		...
		if (*(_BYTE*)(a1 + 8) & 4 && nox_common_gameFlags_check_40A5C0(0x2000)) {
			v2 = *(_DWORD*)(a1 + 748);
			v3 = *(_DWORD*)(v2 + 276);
			*(_DWORD*)(v2 + 272) = nox_frame_xxx_2598000;
	...
	if (a1) {
		if (a2) {
			if (*(_BYTE*)(a1 + 8) & 4 && *(_BYTE*)(a2 + 8) & 4 && a1 != a2) {
				...
				*(_DWORD*)(*(_DWORD*)(v3 + 276) + 3608) = nox_frame_xxx_2598000;
...
void  nox_xxx_collideDoor_4E8AC0(int a2, int a3) {
	...
	if (a3 && *(_DWORD*)(v3 + 12) == *(_DWORD*)(v3 + 4)) {
		v4 = *(_DWORD*)(a2 + 508);
		if (v4) {
			if (*(_DWORD*)(a2 + 136) <= nox_frame_xxx_2598000) {
				*(_DWORD*)(a2 + 508) = 0;
			} else if (v4 != a3) {
...
int  nox_xxx_collidePickup_4E8DF0(int a1, int a2) {
	...
	if (a2) {
		v3 = *(_DWORD*)(a2 + 8);
		if (!(v3 & 2) &&
			(unsigned int)(nox_frame_xxx_2598000 - *(_DWORD*)(a1 + 128)) >= (int)nox_gameFPS >>
				1 &&
...
_DWORD*  nox_xxx_collideManadrain_4E9490(int a1, int a2) {
	...
	if (a2 && *(_BYTE*)(a2 + 8) & 4 && *(_WORD*)(*(_DWORD*)(a2 + 748) + 4)) {
		...
		result = (_DWORD*)(nox_frame_xxx_2598000 - *(__int16*)(a1 + 542));
		if ((unsigned int)result > (int)nox_gameFPS >> 1) {
			result = nox_xxx_aud_501960(228, a1, 0, 0);
			*(_WORD*)(a1 + 542) = (unsigned short)nox_frame_xxx_2598000;
		}
	}
	return result;
}
...
_DWORD*  sub_4EAAA0(int a1) {
	...
	result = (_DWORD*)a1;
	if (nox_frame_xxx_2598000 > (unsigned int)(*(_DWORD*)(a1 + 136) + 3)) {
		*(_DWORD*)(a1 + 136) = nox_frame_xxx_2598000;
...
_DWORD*  sub_4EAAD0(int a1, int a2) {
	...
	if (a2 && *(_BYTE*)(a2 + 8) & 4) {
		result = (_DWORD*)a1;
		if (nox_frame_xxx_2598000 > (unsigned int)(*(_DWORD*)(a1 + 136) + 30)) {
			*(_DWORD*)(a1 + 136) = nox_frame_xxx_2598000;
...
void  sub_4EBE40(int a1, int a2) {
	...
	if (nox_common_gameFlags_check_40A5C0(4096) && a2 && *(_BYTE*)(a2 + 8) & 4) {
		...
		v6 = *(_DWORD*)(a2 + 748);
		if (*(float2**)(v6 + 308) != v2 ||
			(unsigned int)(nox_frame_xxx_2598000 - *v7) > (int)nox_gameFPS) {
...
void  nox_xxx_collideAnkhQuest_4EBF40(int a1, int a2) {
	...
	LABEL_8:
		...
		v7 = v3 + 50;
		do {
			if (nox_frame_xxx_2598000 - *(_DWORD*)(v7 + 26) >
		...
		LABEL_35:
			...
			*(_DWORD*)(80 * *(unsigned __int8*)(v3 + 5120) + v3 + 76) = nox_frame_xxx_2598000;
			v16 = *(_BYTE*)(v3 + 5120) + 1;
			*(_BYTE*)(v3 + 5120) = v16;
			if (v16 >= 0x40u)
				*(_BYTE*)(v3 + 5120) = 0;
...
int  nox_xxx_dropDefault_4ED290(int a1, int a2, float2* a3) {
	...
	LABEL_19:
		if (*(_DWORD*)(a2 + 8) & 0x10000000) {
			...
			*(_DWORD*)(v7 + 8) = nox_frame_xxx_2598000;
...
LABEL_21:
	if (!v3 && v8 > 0) {
		v9 = *(_DWORD*)(a1 + 556);
		if (v9)
			*(_DWORD*)(v9 + 16) = nox_frame_xxx_2598000;
	}
	return 1;
}
...
void  nox_xxx_setSomePoisonData_4EEA90(int a1, int a2) {
	...
	if (a1) {
		if (!*(_BYTE*)(a1 + 540) && a2 > 0) {
			v2 = *(_DWORD*)(a1 + 556);
			if (v2)
				*(_DWORD*)(v2 + 16) = nox_frame_xxx_2598000;
		}
		v3 = *(_DWORD*)(a1 + 8);
		*(_BYTE*)(a1 + 540) = a2;
		if (v3 & 4) {
...
int  nox_xxx_netSendPlayerRespawn_4EFC30(int a1, char a2) {
	...
	v3[0] = -23;
	*(_DWORD*)&v3[3] = nox_frame_xxx_2598000;
...
int  sub_4F3400(int a1, int a2, int a3) {
	...
	if (v5) {
		*(_DWORD*)(*(_DWORD*)(a1 + 748) + 264) = nox_frame_xxx_2598000;
		nox_xxx_unitSetOwner_4EC290(a1, a2);
