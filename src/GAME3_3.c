	...
	LABEL_40:
		if (nox_common_gameFlags_check_40A5C0(1) &&
			!(nox_frame_xxx_2598000 %
			  (nox_gameFPS * (unsigned int)getMemByte(0x5D4594, 1565125 + 12 * a1)))) {
...
//----- (004E8320) --------------------------------------------------------
unsigned __int8*  sub_4E8320(unsigned __int8 a1) { return getMemAt(0x5D4594, 1567740 + 6 * a1); }
		...
		if ((v2 & 0x80u) == 0) {
			...
			LABEL_14:
				...
				if (a2) {
					...
					if (v7 && !(getMemByte(0x8529A0, 78496 + 12332 * *(unsigned __int8*)(v7 + 1)) & 5)) {
					LABEL_25:
	...
	if (a2) {
		if ((signed char)*(_BYTE*)(a2 + 8) >= 0) {
			...
			*(_DWORD*)(a1 + 68) = v7;
			...
			a2a.field_0 = -(double)*getMemIntPtr(0x587000, 196188 + 8 * *(_DWORD*)(v6 + 12));
			v10 = (double)*getMemIntPtr(0x587000, 196184 + 8 * *(_DWORD*)(v6 + 12));
			a2a.field_4 = v10;
...
int  sub_4EE2F0(int a1, int a2, int* a3) {
	...
	v3 = nox_xxx_dropDefault_4ED290(a1, a2, (float2*)a3);
	if (v3) {
		v4 = *getMemU16Ptr(0x8529A0, 1200896);
		v5 = getMemAt(0x8529A0, 1200896);
		if (*getMemI16Ptr(0x8529A0, 1200896) != -1) {
			while (v4 != *(_WORD*)(a2 + 4)) {
				v4 = *((_WORD*)v5 + 2);
				v5 += 4;
				if (v4 == -1)
			...
			if (nox_common_gameFlags_check_40A5C0(2048)) {
				...
				*(_DWORD*)&v18[12] = 0;
				...
				LOBYTE(v7) = (unsigned int)nox_xxx_playerRespawnItem_4EF750(
					v3, *(CHAR**)getMemAt(0x587000, 206376 + 4 * *(unsigned __int8*)(*(_DWORD*)(v4 + 276) + 2251)), (int*)v18,
					1, 0);
				...
				*(_DWORD*)&v18[12] = 0;
				...
				LOBYTE(v7) = (unsigned int)nox_xxx_playerRespawnItem_4EF750(
					v3, *(CHAR**)getMemAt(0x587000, 206388 + 4 * *(unsigned __int8*)(*(_DWORD*)(v4 + 276) + 2251)), (int*)v18,
					1, 0);
			} else {
...
_DWORD*  nox_xxx_rewardMakeArmor_4F0E80(int a1, unsigned int a2) {
	...
	*(_DWORD*)v67 = *getMemU32Ptr(0x587000, 210852 + 24 * v33);
LABEL_103:
	if (v17 & 2) {
		v36 = 0;
		if (*getMemU32Ptr(0x587000, 211000)) {
				...
				if (*getMemU32Ptr(0x587000, 211000)) {
					...
					do {
						if (v64 & *((_DWORD*)v42 + 2) && v13 & *(_DWORD*)(*(_DWORD*)v42 + 32) &&
							!(v13 & *((_DWORD*)v42 + 3))) {
							if (v40 == v39) {
								*(_DWORD*)&v67[4] = *getMemU32Ptr(0x587000, 210996 + 24 * v41);
								break;
							}
							++v40;
						}
				...
				if (*getMemU32Ptr(0x587000, 209344)) {
					...
					do {
						if (v64 & *((_DWORD*)v50 + 2) && v13 & *(_DWORD*)(*(_DWORD*)v50 + 32) &&
							...
							if (v48 == v47) {
								v65 = v49;
								*(_DWORD*)&v67[8] = *getMemU32Ptr(0x587000, 209340 + 24 * v49);
								break;
							}
							++v48;
						}
				...
				if (*getMemU32Ptr(0x587000, 209344)) {
					...
					do {
						if (v55 & *((_DWORD*)v62 + 2) && v13 & *(_DWORD*)(*(_DWORD*)v62 + 32) &&
							...
							if (v60 == v59) {
								if (getMemByte(0x587000, 209336 + 24 * v65) != getMemByte(0x587000, 209336 + 24 * v61))
									*(_DWORD*)&v67[12] = *getMemU32Ptr(0x587000, 209340 + 24 * v61);
								break;
							}
							++v60;
						}
...
int  nox_xxx_rewardMakeWeapon_4F14E0(int a1, unsigned int a2) {
	...
	if (v15 & 0x1000 && *(_DWORD*)(v14 + 12) & 0x47F0000) {
		if (**(_BYTE**)getMemAt(0x587000, 208180 + 20 * v9) == 35) {
			*(_DWORD*)v76 = 0;
			*(_DWORD*)&v76[4] = 0;
					...
					if (*getMemU32Ptr(0x587000, 210712)) {
						...
						do {
							if (v72 & *((_DWORD*)v37 + 2) && v22 & *(_DWORD*)(*(_DWORD*)v37 + 28) &&
								!(v22 & *((_DWORD*)v37 + 4))) {
								if (v35 == v34) {
									*(_DWORD*)v76 = *getMemU32Ptr(0x587000, 210708 + 24 * v36);
									break;
								}
								++v35;
							}
					...
					if (*getMemU32Ptr(0x587000, 211000)) {
						...
						do {
							if (v72 & *((_DWORD*)v45 + 2) && v22 & *(_DWORD*)(*(_DWORD*)v45 + 28) &&
								!(v22 & *((_DWORD*)v45 + 4))) {
								if (v43 == v42) {
									*(_DWORD*)&v76[4] = *getMemU32Ptr(0x587000, 210996 + 24 * v44);
									break;
								}
								++v43;
							}
								...
								if (v73 & *(_DWORD*)(*(_DWORD*)v57 + 28) && !(v73 & *((_DWORD*)v57 + 4)) &&
									*(_BYTE*)(*(_DWORD*)v57 + 36) & 1) {
									if (v55 == v54) {
										LOBYTE(v19) = v71;
										v74 = v56;
										*(_DWORD*)&v76[8] = *getMemU32Ptr(0x587000, 209340 + 24 * v56);
										break;
									}
									++v55;
								}
					...
					if (*getMemU32Ptr(0x587000, 209344)) {
						...
						do {
							if (v62 & *((_DWORD*)v69 + 2) && v73 & *(_DWORD*)(*(_DWORD*)v69 + 28) &&
								...
								if (v67 == v66) {
									if (getMemByte(0x587000, 209336 + 24 * v74) != getMemByte(0x587000, 209336 + 24 * v68))
										*(_DWORD*)&v76[12] = *getMemU32Ptr(0x587000, 209340 + 24 * v68);
									break;
								}
								++v67;
							}
...
int  sub_4F3D50(int a1, int a2, int a3) {
	...
	v3 = nox_xxx_pickupDefault_4F31E0(a1, a2, a3);
	if (v3) {
		v4 = *getMemU16Ptr(0x8529A0, 1201120);
		v5 = getMemAt(0x8529A0, 1201120);
		if (*getMemI16Ptr(0x8529A0, 1201120) != -1) {
			while (v4 != *(_WORD*)(a2 + 4)) {
				v4 = *((_WORD*)v5 + 2);
				v5 += 4;
				if (v4 == -1)
...
int  nox_xxx_readObjectOldVer_4F4170(int a1, int a2, int a3) {
	...
	if (v8 >= 40) {
		...
		if (!v3[11] && *getMemU32Ptr(0x8529A0, 1189016) == 1 && !nox_common_gameFlags_check_40A5C0(0x200000) &&
...
int  nox_xxx_mapReadWriteObjData_4F4530(int* a1, int a2) {
	...
	v18 = 0;
	v23 = v4;
	if (a2 >= 40 || !*getMemU32Ptr(0x8529A0, 1189016)) {
		v18 = 64;
	...
	if (!v2[11] && *getMemU32Ptr(0x8529A0, 1189016) == 1 && !nox_common_gameFlags_check_40A5C0(0x200000) &&
		!nox_common_gameFlags_check_40A5C0(0x400000))
	...
	if (*getMemU32Ptr(0x8529A0, 1189016) != 1 || !(_BYTE)a2 ||
		...
		if ((__int16)v18 < 63 || (result = nox_xxx_xferReadScriptHandler_4F5580((int)(v2 + 191), (char*)v2[189])) != 0) {
			if ((__int16)v18 >= 64) {
				...
				nox_xxx_fileReadWrite_426AC0_file3_fread(v22, 4u);
				if (v22[0] > 0 && *getMemU32Ptr(0x8529A0, 1189016) == 1) {
					if (v2[4] & 0x400000)
						v2[32] = v22[0];
				}
			}
...
int  nox_xxx_XFerDefault_4F49A0(int a1) {
	...
	if (result) {
		if (!v1[34] || *getMemU32Ptr(0x8529A0, 1189016) != 1 || (result = nox_xxx_xfer_4F3E30(a1, (int)v1, v1[34])) != 0) {
			v1[34] = v2;
			result = 1;
		}
	}
...
int  nox_xxx_XFerSpellPagePedistal_4F4A20(int a1) {
	...
	if (result) {
		...
		if (!*(_DWORD*)(v1 + 136) || *getMemU32Ptr(0x8529A0, 1189016) != 1 ||
...
int  nox_xxx_XFerReadable_4F4AB0(int a1) {
	...
	if (result) {
		...
		if (*getMemU32Ptr(0x8529A0, 1189016) != 1 || (*(_DWORD*)(v2 + 256) = 0, !v1[34]) ||
...
int  nox_xxx_XFerExit_4F4B90(int a1) {
	...
	if (result) {
		...
		} else if (*getMemU32Ptr(0x8529A0, 1189016) == 1) {
			for (i = v2;; ++i) {
...
int  nox_xxx_unitTriggerXfer_4F4E50(float a1) {
	...
	if (result) {
		...
		if (*getMemU32Ptr(0x8529A0, 1189016) == 1 && (__int16)v11 < 31) {
			nox_xxx_fileReadWrite_426AC0_file3_fread(&a1, 1u);
		...
		if (!*getMemU32Ptr(0x8529A0, 1189016) || (__int16)v11 >= 21) {
...
int  sub_4F5540(int a1) {
	...
	result = *getMemU32Ptr(0x8529A0, 1189016);
	if (*getMemU32Ptr(0x8529A0, 1189016) == 1) {
		...
		if ((__int16)v3 >= 2) {
			...
			LABEL_19:
				if (*getMemU32Ptr(0x8529A0, 1189016) == 1)
					goto LABEL_20;
			LABEL_22:
				if (!a1[34] || *getMemU32Ptr(0x8529A0, 1189016) != 1 ||
...
int  nox_xxx_XFerSentry_4F5E50(int a1) {
	...
	if (result) {
		...
		nox_xxx_fileReadWrite_426AC0_file3_fread(v2 + 8, 4u);
		if (*getMemU32Ptr(0x8529A0, 1189016) == 1 || nox_common_gameFlags_check_40A5C0(0x200000))
