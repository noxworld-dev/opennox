...
int  sub_4EE2F0(int a1, int a2, int* a3) {
	...
	v3 = nox_xxx_dropDefault_4ED290(a1, a2, (float2*)a3);
	if (v3) {
		v4 = *getMemU16Ptr(0x973CE0, 16320);
		v5 = getMemAt(0x973CE0, 16320);
		if (*getMemI16Ptr(0x973CE0, 16320) != -1) {
			while (v4 != *(_WORD*)(a2 + 4)) {
				v4 = *((_WORD*)v5 + 2);
				v5 += 4;
				if (v4 == -1)
...
int  sub_4F3D50(int a1, int a2, int a3) {
	...
	v3 = nox_xxx_pickupDefault_4F31E0(a1, a2, a3);
	if (v3) {
		v4 = *getMemU16Ptr(0x973CE0, 16544);
		v5 = getMemAt(0x973CE0, 16544);
		if (*getMemI16Ptr(0x973CE0, 16544) != -1) {
			while (v4 != *(_WORD*)(a2 + 4)) {
				v4 = *((_WORD*)v5 + 2);
				v5 += 4;
				if (v4 == -1)
...
int  nox_xxx_readObjectOldVer_4F4170(int a1, int a2, int a3) {
	...
	if (v8 >= 40) {
		...
		if (!v3[11] && *getMemU32Ptr(0x973CE0, 4440) == 1 && !nox_common_gameFlags_check_40A5C0(0x200000) &&
...
int  nox_xxx_mapReadWriteObjData_4F4530(int* a1, int a2) {
	...
	v18 = 0;
	v23 = v4;
	if (a2 >= 40 || !*getMemU32Ptr(0x973CE0, 4440)) {
		v18 = 64;
	...
	if (!v2[11] && *getMemU32Ptr(0x973CE0, 4440) == 1 && !nox_common_gameFlags_check_40A5C0(0x200000) &&
		!nox_common_gameFlags_check_40A5C0(0x400000))
	...
	if (*getMemU32Ptr(0x973CE0, 4440) != 1 || !(_BYTE)a2 ||
		...
		if ((__int16)v18 < 63 || (result = nox_xxx_xferReadScriptHandler_4F5580((int)(v2 + 191), (char*)v2[189])) != 0) {
			if ((__int16)v18 >= 64) {
				...
				nox_xxx_fileReadWrite_426AC0_file3_fread(v22, 4u);
				if (v22[0] > 0 && *getMemU32Ptr(0x973CE0, 4440) == 1) {
					if (v2[4] & 0x400000)
						v2[32] = v22[0];
				}
			}
...
int  nox_xxx_XFerDefault_4F49A0(int a1) {
	...
	if (result) {
		if (!v1[34] || *getMemU32Ptr(0x973CE0, 4440) != 1 || (result = nox_xxx_xfer_4F3E30(a1, (int)v1, v1[34])) != 0) {
			v1[34] = v2;
			result = 1;
		}
	}
...
int  nox_xxx_XFerSpellPagePedistal_4F4A20(int a1) {
	...
	if (result) {
		...
		if (!*(_DWORD*)(v1 + 136) || *getMemU32Ptr(0x973CE0, 4440) != 1 ||
...
int  nox_xxx_XFerReadable_4F4AB0(int a1) {
	...
	if (result) {
		...
		if (*getMemU32Ptr(0x973CE0, 4440) != 1 || (*(_DWORD*)(v2 + 256) = 0, !v1[34]) ||
...
int  nox_xxx_XFerExit_4F4B90(int a1) {
	...
	if (result) {
		...
		} else if (*getMemU32Ptr(0x973CE0, 4440) == 1) {
			for (i = v2;; ++i) {
...
int  nox_xxx_unitTriggerXfer_4F4E50(float a1) {
	...
	if (result) {
		...
		if (*getMemU32Ptr(0x973CE0, 4440) == 1 && (__int16)v11 < 31) {
			nox_xxx_fileReadWrite_426AC0_file3_fread(&a1, 1u);
		...
		if (!*getMemU32Ptr(0x973CE0, 4440) || (__int16)v11 >= 21) {
...
int  sub_4F5540(int a1) {
	...
	result = *getMemU32Ptr(0x973CE0, 4440);
	if (*getMemU32Ptr(0x973CE0, 4440) == 1) {
		...
		if ((__int16)v3 >= 2) {
			...
			LABEL_19:
				if (*getMemU32Ptr(0x973CE0, 4440) == 1)
					goto LABEL_20;
			LABEL_22:
				if (!a1[34] || *getMemU32Ptr(0x973CE0, 4440) != 1 ||
...
int  nox_xxx_XFerSentry_4F5E50(int a1) {
	...
	if (result) {
		...
		nox_xxx_fileReadWrite_426AC0_file3_fread(v2 + 8, 4u);
		if (*getMemU32Ptr(0x973CE0, 4440) == 1 || nox_common_gameFlags_check_40A5C0(0x200000))
