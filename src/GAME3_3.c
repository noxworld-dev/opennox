...
int  nox_server_handler_PlayerDamage_4E17B0(int a1, int a2, int a3, int a4, int a5) {
	...
	if (a2) {
		...
		if (!(LODWORD(a5) == 15 || !v21 ||
			...
			if (((c1 && *(uint8_t *) (v12 + 88) != 16) || (!c1 && nox_xxx_mobActionGet_50A020(v5) != 21) ) || !(armorrFlags & 0x3000000)) {
				v27 = LODWORD(a5);
	...
	if ((a1 != *(float**)(a2 + 20) || *getMemU32Ptr(0x587000, 201112)) && *(float**)(a2 + 24) != a1) {
		...
		if (v6 <= *(float*)(v2 + 4)) {
			...
			if (nox_xxx_mapTraceRay_535250(&v10, 0, 0, 1)) {
				...
				(*((void(**)(float*, uint32_t, uint32_t, uint32_t, uint32_t))a1 + 179))(a1, *(uint32_t*)(v2 + 20), 0, v9,
																					   *(uint32_t*)(v2 + 16));
			}
		}
	}
...
int  nox_xxx_damageMonsterGen_4E27D0(int a1, int a2, int a3, int a4, int a5) {
	...
	if (*(uint32_t*)(a1 + 16) & 0x8020)
		return 0;
	if ((unsigned int)(nox_frame_xxx_2598000 - *(uint32_t*)(a1 + 536)) > 0x14 ||
...
//----- (004E3B70) --------------------------------------------------------
nox_objectType_t* nox_xxx_objectTypeByInd_4E3B70(int ind) { return *(uint32_t*)(*getMemU32Ptr(0x5D4594, 1563456) + 4 * ind); }

//----- (004E3B80) --------------------------------------------------------
int  sub_4E3B80(int a1) { return *(int*)(*(uint32_t*)(*getMemU32Ptr(0x5D4594, 1563456) + 4 * a1) + 12) != -1; }

//----- (004E3BA0) --------------------------------------------------------
int  nox_xxx_getUnitDefDd10_4E3BA0(int a1) { return *(uint32_t*)(*(uint32_t*)(*getMemU32Ptr(0x5D4594, 1563456) + 4 * a1) + 16); }
...
int  nox_xxx_unitSetHP_4E4560(nox_object_t* obj, unsigned short amount) {
	...
	if (healthData) {
		...
		if (otherHealthData && *(uint8_t*)(otherHealthData + 8) & 4)
			nox_xxx_protect_56FC50(*(uint32_t*)(*(uint32_t*)(*(uint32_t*)(otherHealthData + 748) + 276) + 4632), (int*)unit);

		**(uint16_t**)(unit + 556) = amount;

		if (*(uint8_t*)(unit + 8) & 4) // Is player and is local?
			nox_xxx_protectPlayerHPMana_56F870(*(uint32_t*)(*(uint32_t*)(*(uint32_t*)(unit + 748) + 276) + 4584), amount);
		...
		if (healthData) {
			if (*(uint8_t*)(healthData + 8) & 4)
				healthData = nox_xxx_protect_56FBF0(*(uint32_t*)(*(uint32_t*)(*(uint32_t*)(healthData + 748) + 276) + 4632), (int*)unit);
		}
	}
	return healthData;
}
...
void  sub_4E5BF0(int a1) {
	...
	if (v1) {
		do {
			v2 = nox_server_getNextObject_4DA7A0(v1);
			if (!a1 || !(*(uint8_t*)(v1 + 8) & 4) && ((v3 = *(uint32_t*)(v1 + 492)) == 0 || !(*(uint8_t*)(v3 + 8) & 4)) &&
...
void  nox_xxx_delayedDeleteObject_4E5CC0(nox_object_t* obj) {
	...
	if (object && !(*(uint8_t*)(object + 16) & 0x20)) {
		...
		if (v1 && *(uint8_t*)(v1 + 8) & 4 && *(uint8_t*)(object + 8) & 2 && !nox_xxx_creatureIsMonitored_500CC0(v1, object) && (*(uint8_t*)(object + 12) & 0x80))
...
int  nox_xxx_playerObserverFindGoodSlave0_4E6280(int a1) {
	...
	LABEL_9:
		for (result = nox_xxx_playerObserverFindGoodSlave2_4EC3E0(*(uint32_t*)(a1 + 2056)); result; result = nox_xxx_playerObserverFindGoodSlave_4EC420(result)) {
		...
		if (result) {
			while (1) {
				...
				if (sub_40A740() || nox_common_gameFlags_check_40A5C0(0x8000) ||
					(v12 = *(uint32_t*)(v4 + 3680), BYTE1(v12) & 1) && (v13 = nox_xxx_gamePlayIsAnyPlayers_40A8A0(), v13)) {
					v11 = sub_40AA70(v4) == 0;
				LABEL_44:
					if (v11) {
					LABEL_45:
				...
				*(uint32_t*)(v1 + 16) = v2 & 0xFFFFFFBF;
				...
				if (nox_common_gameFlags_check_40A5C0(16)) {
					if (nox_xxx_CheckGameplayFlags_417DA0(4)) {
						v3 = *((uint32_t*)nox_xxx_clientGetTeamColor_418AB0(*(unsigned char*)(*(uint32_t*)(a1 + 2056) + 52)) + 19);
						if (v3) {
							if (!*(uint32_t*)(v3 + 492))
...
void  nox_xxx_unitMove_4E7010(nox_object_t* obj, float2* a2) {
	...
	if (a1 && !(*(uint32_t*)(a1 + 8) & 0x400000)) {
		if ((long long)*(float*)(a1 + 56) != (long long)a2->field_0 || (long long)*(float*)(a1 + 60) != (long long)a2->field_4)
			nox_xxx_unitNeedSync_4E44F0(a1);
		*(float2*)(a1 + 64) = *a2;
		*(float2*)(a1 + 56) = *a2;
		*(float2*)(a1 + 72) = *a2;
...
//----- (004E83B0) --------------------------------------------------------
unsigned char*  nox_xxx_collideMonsterEventProc_4E83B0(int a1, int a2) { return nox_xxx_scriptCallByEventBlock_502490((int*)(*(uint32_t*)(a1 + 748) + 1272), a2, a1, 22); }
...
unsigned char*  nox_xxx_collideMimic_4E83D0(int a1, int a2) {
	...
	if (a2) {
		v2 = *(uint32_t*)(a2 + 16);
		if ((v2 & 0x8000) == 0 && *(uint8_t*)(a2 + 8) & 6 && nox_xxx_unitIsEnemyTo_5330C0(a1, a2) && !nox_xxx_monsterIsActionScheduled_50A090(a1, 15)) {
...
void  nox_xxx_collideDoor_4E8AC0(int a2, int a3) {
	...
	if (a3 && *(uint32_t*)(v3 + 12) == *(uint32_t*)(v3 + 4)) {
		...
		*(uint8_t*)(v3 + 1) = 0;
		...
		v16 = *(uint32_t*)(v8 + 492);
		if (v16 && a3 != v16 && *(uint8_t*)(v16 + 8) & 4 && nox_common_gameFlags_check_40A5C0(4096) && sub_4D72C0() == 1)
...
int  nox_xxx_collidePickup_4E8DF0(int a1, int a2) {
	...
	if (a2) {
		v3 = *(uint32_t*)(a2 + 8);
		if (!(v3 & 2) &&
			(unsigned int)(nox_frame_xxx_2598000 - *(uint32_t*)(a1 + 128)) >= (int)nox_gameFPS >>
				1 &&
...
char*  nox_xxx_collideExit_4E9090(int a1, int a2, int a3) {
	...
	if (a2) {
		...
		if (!nox_common_gameFlags_check_40A5C0(4096) ||
			...
			if (!(*(uint8_t*)(a1 + 12) & 2) || (result = (char*)sub_4D75E0()) != 0) {
...
/*void  nox_xxx_spellFlyCollide_4E9500(int a1, int a2, float *a3)
{
  ...
  if ( a2 )
  {
	...
	if ( !(*(uint8_t *)(a2 + 8) & 4) )
	  goto LABEL_23;
	v6 = *(uint32_t *)(a2 + 748);
	if ( *(uint8_t *)(v6 + 88) == 16 && nox_xxx_checkReflectShield_4E6E50((float2 *)(a2 + 56), *(short *)(a2 + 124), (float2 *)(a1 + 72)) & 1 )
	{
...
M_LABEL_13:
	...
	if ( nox_xxx_testUnitBuffs_4FF350(v3, 27) && nox_xxx_checkReflectShield_4E6E50((float2 *)(v3 + 56), *(short *)(v3 + 124), v4 + 7) & 1 )
	{
	  nox_xxx_changeOwner_52BE40((int)v4, v3);
...
LABEL_23:
	  ...
	  {
	v11[0] = v3;
	nox_xxx_spellAccept_4FD400(*(uint32_t *)(v5 + 12), *(uint32_t *)(v5 + 8), *(uint32_t **)v5, (int)v4, v11, *(uint32_t *)(v5 + 16));
		...
		if (*(uint8_t*)(v6 + 88) != 16) {
			...
			LABEL_13:
				...
				if (nox_xxx_testUnitBuffs_4FF350(v3, 27) &&
					nox_server_testTwoPointsAndDirection_4E6E50((float2*)(v3 + 56), *(short*)(v3 + 124), v4 + 7) &
						1) {
					nox_xxx_changeOwner_52BE40((int)v4, v3);
					nox_xxx_aud_501960(122, v3, 0, 0);
					return;
...
LABEL_18:
	if (*(uint32_t*)(v5 + 4) == v3) {
		v12[0] = v3;
		nox_xxx_spellAccept_4FD400(*(uint32_t*)(v5 + 12), *(uint32_t*)(v5 + 8), *(uint32_t**)v5, (int)v4, v12, *(uint32_t*)(v5 + 16));
		nox_xxx_delayedDeleteObject_4E5CC0((int)v4);
	} else {
		nox_xxx_projectileReflect_4E0A70((int)v4, v3);
	}
...
void  nox_xxx_collideBomb_4E96F0(int a1, int a2) {
	...
	v2 = *(uint32_t*)(a1 + 748);
	if (!nox_common_gameFlags_check_40A5C0(2048) || (*(uint8_t*)((int)nox_xxx_getFirstPlayerUnit_4DA7C0() + 16) & 2) != 2) {
...
void  nox_xxx_collideBoom_4E9770(int a1, int a2, float* a3) {
	...
	if (!nox_common_gameFlags_check_40A5C0(4096) || (v3 = nox_xxx_findParentChainPlayer_4EC580(a1)) == 0 || !a2 || !(*(uint8_t*)(v3 + 8) & 4) ||
		!(*(uint8_t*)(a2 + 8) & 4) || nox_xxx_unitIsEnemyTo_5330C0(v3, a2)) {
		if (a1)
		...
		if (a2) {
			if (*(uint8_t*)(a2 + 8) & 4) {
				...
				if (nox_xxx_testUnitBuffs_4FF350(a2, 27) && nox_server_testTwoPointsAndDirection_4E6E50(
											  (float2*)(a2 + 56), *(short*)(a2 + 124), (float2*)(a1 + 56)) &
											  1) {
					nox_xxx_changeOwner_52BE40(a1, a2);
...
int  sub_4E9A30(int a1, int a2) {
	...
	if (a2) {
		if (nox_xxx_unitsHaveSameTeam_4EC520(a1, a2) || nox_common_gameFlags_check_40A5C0(512) &&
									  (v3 = nox_xxx_findParentChainPlayer_4EC580(a1), v4 = nox_xxx_findParentChainPlayer_4EC580(a2), *(uint8_t*)(v3 + 8) & 4) &&
									  *(uint8_t*)(v4 + 8) & 4) {
			v5 = 0;
		}
	}
...
void  nox_xxx_fireballCollide_4E9AC0(int a1, int a2) {
	...
	if (a2 && nox_xxx_testUnitBuffs_4FF350(a2, 27) &&
		nox_server_testTwoPointsAndDirection_4E6E50((float2*)(a2 + 56), *(short*)(a2 + 124), (float2*)(a1 + 56)) &
			1) {
	...
	if (!nox_common_gameFlags_check_40A5C0(4096) || (v5 = nox_xxx_findParentChainPlayer_4EC580(a1)) == 0 || !a2 || !(*(uint8_t*)(v5 + 8) & 4) ||
		!(*(uint8_t*)(a2 + 8) & 4) || nox_xxx_unitIsEnemyTo_5330C0(v5, a2)) {
		if (v4) {
...
void  nox_xxx_collideTeleportWake_4EAE30(int a1, int a2) {
	...
	if (a2) {
		if (!nox_xxx_testUnitBuffs_4FF350(a2, 14)) {
			if (!nox_common_gameFlags_check_40A5C0(4096) || (v3 = *(uint32_t*)(a1 + 508)) == 0 || *(uint8_t*)(v3 + 8) & 4) {
...
void  sub_4EB340(float* a1, int a2) {
	...
	if ((uint32_t)a1[2] & 0x20006) {
		if (!((uint32_t)a1[4] & 0x8020) && !nox_xxx_testUnitBuffs_4FF350((int)a1, 0) && a1 != *(float**)getMemAt(0x5D4594, 1567840) &&
...
void  nox_xxx_collideHarpoon_4EB6A0(int a1, int a2) {
	...
	if (!(*(uint32_t*)(a2 + 16) & 0x8020) && (uint32_t*)a2 != v3) {
		...
		if ((*(int(**)(int, int, int, int, int))(a2 + 716))(a2, v5, a1, v11, 11) &&
			(nox_xxx_unitIsEnemyTo_5330C0((int)v3, a2) || nox_xxx_CheckGameplayFlags_417DA0(1) && *(uint8_t*)(a2 + 8) & 6)) {
			v4[33] = a2;
...
void  nox_xxx_collideAnkhQuest_4EBF40(int a1, int a2) {
	...
	LABEL_8:
		...
		v7 = v3 + 50;
		do {
			if (nox_frame_xxx_2598000 - *(uint32_t*)(v7 + 26) >
...
int nox_server_netCodeCache_nextUnused_4ECEF0() {
	...
	if (!nox_server_netCodeCache.firstFreeObject)
		return 0;
	nox_server_netCodeCache.firstFreeObject = nox_server_netCodeCache.firstFreeObject->prev; //*(uint32_t*)(*(uint32_t*)&netCodeCache.firstFreeObject + 8);
	return result;
}
...
int sub_4ECF10(int a1) {
	...
	nox_object_t* obj = nox_xxx_getFirstUpdatable2Object_4DA840();
	while (obj) {
		if (!(*(uint8_t*)&obj->field_4 & 0x20) && obj->script_id == a1) {
			return obj;
		}
...
void  sub_4ED0C0(int a1, nox_object_t* object) {
	...
	if (a1 && object) {
		...
		if (v3 & 4) {
			...
			if (*(uint8_t*)(a1 + 12) & 0x10 && object->obj_class & 0x10000000 && nox_common_gameFlags_check_40A5C0(32))
...
void  nox_xxx_mobInformOwnerHP_4EE4C0(nox_object_t* obj) {
	...
	if (a1) {
		...
		if (v1) {
			if (*(uint8_t*)(v1 + 8) & 4)
				nox_xxx_netReportUnitCurrentHP_4D8620(*(unsigned char*)(*(uint32_t*)(*(uint32_t*)(v1 + 748) + 276) + 2064), a1);
		}
	}
}
...
void  nox_xxx_unitDamageClear_4EE5E0(int unit, int damageAmount) {
	...
	if (unit) {
		healthData = *(uint32_t*)(unit + 556);
		if (healthData) {
			if (*(uint16_t*)(healthData + 4) && (!nox_common_getEngineFlag(NOX_ENGINE_FLAG_GODMODE) || !(*(uint8_t*)(unit + 8) & 4))) {
				if (*(uint8_t*)(unit + 8) & 4) {
	...
	if (unit && *(uint8_t*)(unit + 8) & 4) { // is player
		...
		*(uint16_t*)(manaData + 4) = newAmount;
		...
		if (*(uint16_t*)(manaData + 4) > result)
			result = (unsigned int)nox_xxx_protectPlayerHPMana_56F870(*(uint32_t*)(*(uint32_t*)(manaData + 276) + 4596), result);
	}
	return result;
}
...
int  nox_xxx_plrReadVals_4EEDC0(int a1, int a2) {
	...
	*(uint16_t*)(v2 + 490) = *(uint16_t*)(*(uint32_t*)(v3 + 276) + 3652);
	...
	nox_xxx_protectPlayerHPMana_56F870(*(uint32_t*)(*(uint32_t*)(v3 + 276) + 4592), *(uint16_t*)(*(uint32_t*)(v2 + 556) + 4));
...
double  nox_xxx_calcBoltDamage_4EF1E0(int a1, int a2) {
	...
	if (!nox_common_gameFlags_check_40A5C0(2048) || *(uint32_t*)(a2 + 4) != *getMemU32Ptr(0x5D4594, 1568264))
		result =
			(double)(a1 - *(unsigned short*)(a2 + 60)) * *(float*)(a2 + 64) + (double)*(unsigned short*)(a2 + 72);
	else
		result = nox_xxx_gamedataGetFloat_419D40("BoltSoloDamageMin") + (double)(a1 - *(unsigned short*)(a2 + 60)) * *(float*)(a2 + 64);
	return result;
}
			...
			if (nox_common_gameFlags_check_40A5C0(2048)) {
				...
				*(uint32_t*)&v18[12] = 0;
				...
				LOBYTE(v7) = (unsigned int)nox_xxx_playerRespawnItem_4EF750(
					v3, *(char**)getMemAt(0x587000, 206376 + 4 * *(unsigned char*)(*(uint32_t*)(v4 + 276) + 2251)), (int*)v18,
					1, 0);
				...
				*(uint32_t*)&v18[12] = 0;
				...
				LOBYTE(v7) = (unsigned int)nox_xxx_playerRespawnItem_4EF750(
					v3, *(char**)getMemAt(0x587000, 206388 + 4 * *(unsigned char*)(*(uint32_t*)(v4 + 276) + 2251)), (int*)v18,
					1, 0);
			} else {
...
uint32_t*  nox_xxx_rewardMakeArmor_4F0E80(int a1, unsigned int a2) {
	...
	LABEL_27:
		...
		*(uint16_t*)&v67[18] = 0;
		...
		if (v17 & 1) {
			...
			do {
				if (v64 & *((uint32_t*)v20 + 2) && v13 & *(uint32_t*)(*(uint32_t*)v20 + 32) && !(v13 & *((uint32_t*)v20 + 3)))
					++v19;
				v21 = *((uint32_t*)v20 + 7);
				v20 += 24;
			} while (v21);
		...
		if (v17 & 2) {
			...
			do {
				if (v64 & *((uint32_t*)v23 + 2) && v13 & *(uint32_t*)(*(uint32_t*)v23 + 32) && !(v13 & *((uint32_t*)v23 + 3)))
					++v22;
				v24 = *((uint32_t*)v23 + 7);
				v23 += 24;
			} while (v24);
		...
		if (v17 & 4) {
			...
			do {
				if (v64 & *((uint32_t*)v26 + 2) && v13 & *(uint32_t*)(*(uint32_t*)v26 + 32) && !(v13 & *((uint32_t*)v26 + 3)) &&
					*(uint8_t*)(*(uint32_t*)v26 + 36) & 1) {
					++v25;
				}
				v27 = *((uint32_t*)v26 + 7);
				v26 += 24;
		...
		do {
			if (*((uint32_t*)v29 + 2) & v64 && v13 & *(uint32_t*)(*(uint32_t*)v29 + 32) && !(v13 & *((uint32_t*)v29 + 3)))
				++v28;
			v30 = *((uint32_t*)v29 + 7);
			v29 += 24;
		} while (v30);
	...
	while (1) {
		if (!(v64 & *((uint32_t*)v34 + 2)) || !(v13 & *(uint32_t*)(*(uint32_t*)v34 + 32)) || v13 & *((uint32_t*)v34 + 3))
			goto LABEL_100;
		if (v32 == v31)
			break;
		++v32;
...
LABEL_103:
	if (v17 & 2) {
		...
		if (*getMemU32Ptr(0x587000, 211000)) {
			...
			do {
				if (v64 & *((uint32_t*)v37 + 2) && v13 & *(uint32_t*)(*(uint32_t*)v37 + 32) && !(v13 & *((uint32_t*)v37 + 3)))
					++v36;
				v38 = *((uint32_t*)v37 + 7);
				v37 += 24;
			} while (v38);
	...
	if (v17 & 4) {
		...
		if (*getMemU32Ptr(0x587000, 209344)) {
			...
			do {
				if (v64 & *((uint32_t*)v45 + 2) && v13 & *(uint32_t*)(*(uint32_t*)v45 + 32) && !(v13 & *((uint32_t*)v45 + 3)) &&
					*(uint8_t*)(*(uint32_t*)v45 + 36) & 1) {
					++v44;
				}
				v46 = *((uint32_t*)v45 + 7);
				v45 += 24;
	...
	if (v17 & 8) {
		...
		if (*getMemU32Ptr(0x587000, 209344)) {
			...
			do {
				if (v55 & *((uint32_t*)v57 + 2) && v13 & *(uint32_t*)(*(uint32_t*)v57 + 32) && !(v13 & *((uint32_t*)v57 + 3)) &&
					*(uint8_t*)(*(uint32_t*)v57 + 36) & 2) {
					++v56;
				}
				v58 = *((uint32_t*)v57 + 7);
				v57 += 24;
...
int  nox_xxx_rewardMakeWeapon_4F14E0(int a1, unsigned int a2) {
	...
	LABEL_33:
		...
		*(uint16_t*)&v76[18] = 0;
		...
		do {
			if (v72 & *((uint32_t*)v23 + 2) && v73 & *(uint32_t*)(*(uint32_t*)v23 + 28) && !(v73 & *((uint32_t*)v23 + 4)))
				++v21;
			v24 = *((uint32_t*)v23 + 7);
			v23 += 24;
		} while (v24);
	...
	LABEL_67:
		if (v19 & 2) {
			...
			do {
				if (v72 & *((uint32_t*)v26 + 2) && v22 & *(uint32_t*)(*(uint32_t*)v26 + 28) && !(v22 & *((uint32_t*)v26 + 4)))
					++v25;
				v27 = *((uint32_t*)v26 + 7);
				v26 += 24;
			} while (v27);
		...
		if (v19 & 4) {
			...
			do {
				if (v72 & *((uint32_t*)v29 + 2) && v22 & *(uint32_t*)(*(uint32_t*)v29 + 28) && !(v22 & *((uint32_t*)v29 + 4)) &&
					*(uint8_t*)(*(uint32_t*)v29 + 36) & 1) {
					++v28;
				}
				v30 = *((uint32_t*)v29 + 7);
				v29 += 24;
...
void  nox_xxx_inventoryPutImpl_4F3070(int a1, nox_object_t* item, int a3) {
	...
	v3 = 0;
	if (a1 && item && !(*(uint8_t*)(a1 + 16) & 0x20) && !(*(uint8_t*)&item->field_4 & 0x20)) {
...
bool nox_xxx_playerCheckStrength_4F3180(int a1, nox_object_t* item) {
	...
	if (*(uint8_t*)(a1 + 8) & 4 &&
			((v2 = nox_xxx_unitGetStrength_4F9FD0(
					a1), !(*(uint32_t*)&item->obj_class & 0x2000000)) ? (v3 = nox_xxx_getProjectileClassById_413250(
					*(unsigned short*)&item->typ_ind))
		...
		if (*(uint32_t*)&item->field_123) {
			...
			if (2 * *(unsigned short*)(v4 + 490) - i >= *(unsigned char*)&item->field_122_0) {
				if ((*(uint8_t*)&item->obj_class & 0x10) != 16 ||
					((v12 = nox_xxx_inventoryCountObjects_4E7D30(v4, *(unsigned short*)&item->typ_ind), !nox_common_gameFlags_check_40A5C0(6144))
						 ? (v13 = v12 - 3)
						 : (v13 = v12 - 9),
					 v13 < 0)) {
...
int  nox_xxx_inventoryServPlace_4F36F0(int a1, int a2, int a3, int a4) {
	...
	if (*(uint8_t*)(a2 + 16) & 0x20)
		return 0;
	v4 = *(uint32_t*)(a1 + 16);
	if ((v4 & 0x8000) != 0 || !nox_xxx_getUnitDefDd10_4E3BA0(*(unsigned short*)(a2 + 4)) || !(*(uint8_t*)(a1 + 8) & 6))
		return 0;
...
int  nox_xxx_pickupPotion_4F37D0(int a1, int a2, int a3) {
	...
	if (nox_common_gameFlags_check_40A5C0(0x2000) && !nox_common_gameFlags_check_40A5C0(4096) &&
		*(uint8_t*)(a1 + 8) & 4 && !nox_xxx_playerClassCanUseItem_57B3D0(v3, *(uint8_t*)(*(uint32_t*)(*(uint32_t*)(a1 + 748) + 276) + 2251))) {
...
int  nox_xxx_pickupAmmo_4F3B00(int a1, nox_object_t* item, int a3, int a4) {
	...
	if (!v7)
		return sub_53A720(v6, item, a3, a4);
	while (1) {
		if (*(uint16_t*)(v7 + 4) != *(uint16_t*)&item->typ_ind || !(*(uint32_t*)(v7 + 8) & 0x1000000) || !(nox_xxx_weaponInventoryEquipFlags_415820(v7) & v18))
			goto LABEL_15;
		v9 = *(char**)(v7 + 736);
		v10 = v8;
...
int  nox_xxx_mapReadWriteObjData_4F4530(int* a1, int a2) {
	...
	if (*getMemU32Ptr(0x973F18, 3872) != 1 || !(uint8_t)a2 ||
...
int  nox_xxx_XFerSpellPagePedistal_4F4A20(int a1) {
	...
	if (result) {
		...
		if (!*(uint32_t*)(v1 + 136) || *getMemU32Ptr(0x973F18, 3872) != 1 ||
...
int  nox_xxx_XFerReadable_4F4AB0(int a1) {
	...
	if (result) {
		...
		if (*getMemU32Ptr(0x973F18, 3872) != 1 || (*(uint32_t*)(v2 + 256) = 0, !v1[34]) ||
...
int  nox_xxx_unitTriggerXfer_4F4E50(float a1) {
	...
	if (result) {
		...
		if (*getMemU32Ptr(0x973F18, 3872) == 1 && (short)v11 < 31) {
			nox_xxx_fileReadWrite_426AC0_file3_fread(&a1, 1u);
		...
		if (!*getMemU32Ptr(0x973F18, 3872) || (short)v11 >= 21) {
