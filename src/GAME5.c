        ...
        if (*(_DWORD*)(v1 + 1196))
        {
            if (sub_4FF350(a1, 29) || (v2 = (int*)sub_541050(a1)) == 0)
            {
                ...
                if (v3)
                    ...
                    + nox_common_randomInt_415FA0(4 * *(_DWORD*)& byte_5D4594[2649704], 6 * *(_DWORD*)& byte_5D4594[2649704]);
                v2 = sub_50A260(a1, 24);
                if (v2)
                {
                    v4 = *(_DWORD*)(v1 + 1196);
...
char __cdecl sub_5457E0(int* a1)
{
    ...
    if (*(_DWORD*)(v2 + 1440) & 0x20000
        ...
        && nox_common_randomInt_415FA0(0, 100) < 10)
    {
        ...
        if (v3)
        {
            v3 = (int*)(*(_DWORD*)& byte_5D4594[2598000] + *(_DWORD*)& byte_5D4594[2649704] * nox_common_randomInt_415FA0(3, 10));
            v6[1] = (int)v3;
        }
        return (char)v3;
    }
        ...
        if (!sub_534390(a1) && !*(_DWORD*)(v1 + 1196) && *(float*)(v1 + 524) <= 300.0)
        {
            ...
            if ((!v2 || v2 == 4) && *(_DWORD*)& byte_5D4594[2598000] >= *(int*)(v1 + 528))
            {
                *(_DWORD*)(v1 + 528) = *(_DWORD*)& byte_5D4594[2598000]
                    + nox_common_randomInt_415FA0(20 * *(_DWORD*)& byte_5D4594[2649704], 60 * *(_DWORD*)& byte_5D4594[2649704]);
                v3 = sub_424300(a1);
                if (v3)
        ...
        if (sub_4FF350(v1, 29) || (v3 = (int*)sub_5408D0(v1)) == 0)
        {
                                    ...
                                    if (*(_DWORD*)(v2 + 1504))
                                    {
                                        if (!sub_4FF350(v1, 29) && *(_DWORD*)& byte_5D4594[2598000] >= *(int*)(v2 + 1484))
                                        {
                                            ...
                                            if (*(float*)(v2 + 1356) * 0.5 > v41)
                                            {
                                                ...
                                                v3 = (int*)(*(_DWORD*)& byte_5D4594[2598000]
                                                    + nox_common_randomInt_415FA0(*(unsigned __int16*)(v2 + 1480), *(unsigned __int16*)(v2 + 1482)));
                                                *(_DWORD*)(v2 + 1484) = v3;
                                                return (char)v3;
                                            }
                                        }
                ...
                && !sub_50A0D0(v1, 14))
            {
                ...
                if (v42 <= (double) * (float*)(v2 + 1336) || v28)
                {
                    sub_5471B0(v1);
                    sub_50A260(v1, 68);
                    if (((*(_BYTE*)(v2 + 1440) & 0x80) || *(_BYTE*)(v1 + 12) & 0x80) && nox_common_gameFlags_check_40A5C0(2048))
                        sub_50A260(v1, 14);
                    else
                        sub_50A260(v1, 6);
                    if (v44)
    ...
    if (v11 > 0)
    {
        ...
        do
        {
            ...
            *((_DWORD*)v4 + 4) |= 0x800000;
            ...
            v6 = nox_common_gameFlags_check_40A5C0(2048) ? nox_common_randomInt_415FA0(10, 20) : nox_common_randomInt_415FA0(5, 10);
        ...
        if (v6 > 0)
        {
            ...
            do
            {
                ...
                *((_DWORD*)v9 + 4) = 0x800000 | v11;
                ...
                v12 = nox_common_gameFlags_check_40A5C0(2048) ? nox_common_randomInt_415FA0(10, 20) : nox_common_randomInt_415FA0(2, 5);
...
void __cdecl sub_54AFB0(int a1, float* a2)
{
        ...
        && (*(_DWORD*)(a1 + 8) & 0x80000206 || *(unsigned __int16*)(a1 + 4) == *(_DWORD*)& byte_5D4594[2491604]))
    {
        ...
        {
            if (!(*(_BYTE*)(a1 + 8) & 4)
                || (*(_DWORD*)(a1 + 36) != *(_DWORD*)& byte_5D4594[2616328] || !(*(_DWORD*)& nox_common_engineFlags & 0x40000))
        ...
        if (!((_DWORD)v3[4] & 0x8020))
        {
            ...
            if (!(*(_BYTE*)(v5 + 3680) & 1))
            {
                ...
                else
                {
                    if (!(v6 & 2))
                        return 0;
                    v14 = nox_double2float(sqrt((double)(*(unsigned __int16*)(v5 + 12) * *(unsigned __int16*)(v5 + 12)
...
int __cdecl sub_551EB0(int a1, unsigned int a2, unsigned __int8 a3, int a4, int a5)
{
    ...
    // fprintf(stderr, "551EB0: %d %d %d %d %d %d %d %d %d\n", v5, *(_DWORD *)(v5 + 152), *(_BYTE *)(v5 + 156), a1, a3, *(_BYTE *)(a4 + 4), a5,  *(_DWORD *)(*(_DWORD *)&byte_5D4594[4 * a1 + 3843788] + 84), sub_409FA0());
