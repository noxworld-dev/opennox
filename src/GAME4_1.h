...
int nox_script_activatorCancel_51AD60(int a1);
nox_script_activator_t* nox_script_activatorDoneNext_51AD90(nox_script_activator_t* a1);
void nox_script_activatorClearObj_51AE60(nox_object_t* a1);
