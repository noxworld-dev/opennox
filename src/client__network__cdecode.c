...
int  nox_xxx_netOnPacketRecvCli_48EA70(int a1, unsigned char* data, int sz) {
	...
	while (data < end) {
		...
		case 49:
			...
			if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ADDITIONAL_NETWORK_TEST))
				nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1));
			LODWORD(v5) = nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1)) ? nox_xxx_netSpriteByCodeStatic_45A720(v45) : nox_xxx_netSpriteByCodeDynamic_45A6F0(v45);
			v46 = v5;
			if (!(uint32_t)v5) {
				data += 3;
				break;
		...
		case 50:
			...
			if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ADDITIONAL_NETWORK_TEST))
				nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1));
			LODWORD(v5) = nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1)) ? nox_xxx_netSpriteByCodeStatic_45A720(v50) : nox_xxx_netSpriteByCodeDynamic_45A6F0(v50);
			v51 = v5;
			if (!(uint32_t)v5) {
				data += 3;
				break;
		...
		case 51:
			...
			if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_NET_DEBUG))
				nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1));
			LODWORD(v5) = nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1)) ? nox_xxx_netSpriteByCodeStatic_45A720(v55) : nox_xxx_netSpriteByCodeDynamic_45A6F0(v55);
			v51 = v5;
			if (!(uint32_t)v5) {
				data += 3;
				break;
		...
		case 57:
			...
			if (!nox_client_isConnected_43C700())
				goto LABEL_764;
			LODWORD(v5) = nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1)) ? nox_xxx_netSpriteByCodeStatic_45A720(v17) : nox_xxx_netSpriteByCodeDynamic_45A6F0(v17);
			if (!(uint32_t)v5)
				goto LABEL_764;
		...
		case 62:
			if (nox_client_isConnected_43C700()) {
				LODWORD(v5) =
					nox_server_getWallAtGrid_410580(*(unsigned char*)(data + 1), *(unsigned char*)(data + 2));
				if ((uint32_t)v5)
		...
		case 80:
			...
			*(uint16_t*)(data + 1) = v5 & 0x7FFF;
			if ((((unsigned int)v5 >> 15) & 1) == 1) {
				nox_xxx_clientEquipWeaponArmor_417AA0(*(uint8_t*)data, *(unsigned short*)(data + 1), *(uint32_t*)(data + 3), (int)&v367);
			} else {
				nox_xxx_clientEquip_49A3D0(*(uint8_t*)data, *(unsigned short*)(data + 1), *(uint32_t*)(data + 3), (int)&v367);
			}
			data += 7;
			break;
		case 81:
		...
		case 85:
			...
			if (nox_client_isConnected_43C700()) {
				...
				if (v142) {
					if (!nox_common_gameFlags_check_40A5C0(1) &&
						nox_frame_xxx_2598000 > *((uint32_t*)v142 + 540)) {
						HIWORD(v5) = 0;
		...
		case 90:
			...
			if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_NET_DEBUG))
				nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1));
			LODWORD(v5) = nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1)) ? nox_xxx_netSpriteByCodeStatic_45A720(v133) : nox_xxx_netSpriteByCodeDynamic_45A6F0(v133);
			v134 = v5;
			if (!(uint32_t)v5)
				goto LABEL_1149;
		...
		case 92:
			...
			if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_NET_DEBUG))
				nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1));
			LODWORD(v5) = nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1)) ? nox_xxx_netSpriteByCodeStatic_45A720(v89) : nox_xxx_netSpriteByCodeDynamic_45A6F0(v89);
			if ((uint32_t)v5) {
				nox_xxx_spriteChangeLightColor_484BE0((uint32_t*)(v5 + 136), *(unsigned char*)(data + 3), *(unsigned char*)(data + 4),
		...
		case 93:
			...
			if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_NET_DEBUG))
				nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1));
			LODWORD(v5) = nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1)) ? nox_xxx_netSpriteByCodeStatic_45A720(v85) : nox_xxx_netSpriteByCodeDynamic_45A6F0(v85);
			if (!(uint32_t)v5)
				goto LABEL_948;
		...
		case 94:
			...
			v179 = v178;
			if (nox_client_isConnected_43C700()) {
				LODWORD(v5) = nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1)) ? nox_xxx_netSpriteByCodeStatic_45A720(v179) : nox_xxx_netSpriteByCodeDynamic_45A6F0(v179);
				if ((uint32_t)v5) {
		...
		case 95:
			...
			v181 = v180;
			if (nox_client_isConnected_43C700()) {
				LODWORD(v5) = nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1)) ? nox_xxx_netSpriteByCodeStatic_45A720(v181) : nox_xxx_netSpriteByCodeDynamic_45A6F0(v181);
				if ((uint32_t)v5) {
					WORD2(v5) = *(unsigned char*)(data + 3);
		...
		case 107:
			...
			if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_ENABLE_NET_DEBUG))
				nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1));
			LODWORD(v5) = nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1)) ? nox_xxx_netSpriteByCodeStatic_45A720(v70) : nox_xxx_netSpriteByCodeDynamic_45A6F0(v70);
			if (!(uint32_t)v5)
				goto LABEL_948;
		...
		case 111:
			...
			if (nox_client_isConnected_43C700()) {
				if (*(uint8_t*)(data + 3) & 0x80)
					v139 = 1;
				nox_xxx_netSpellRewardCli_45CFE0(*(unsigned char*)(data + 1), *(unsigned char*)(data + 2), *(uint8_t*)(data + 3) & 0x7F, v139);
			}
			data += 4;
			break;
		case 112:
		...
		case 142:
			...
			if (*(uint8_t*)data == 140 || (uint8_t)v5 == 142) {
				...
				nox_xxx_drawEnergyBolt_499710(*(unsigned short*)(data + 5), *(unsigned short*)(data + 7), 10, *(int*)&dword_5d4594_1200776);
			}
		LABEL_732:
			data += 9;
			break;
		case 0x7Eu:
			if (nox_client_isConnected_43C700()) {
				nox_xxx_netHandleSummonPacket_4B7C40(*(uint16_t*)(data + 5), (unsigned short*)(data + 1), *(uint16_t*)(data + 7), *(uint8_t*)(data + 9), *(uint16_t*)(data + 10));
			}
		LABEL_1130:
			data += 12;
			break;
		...
		case 0x81u:
			if (!nox_client_isConnected_43C700())
				goto LABEL_797;
			nox_xxx_makePointFxCli_499610(*(int*)&dword_5d4594_1200776, 50, 1000, 30, *(short*)(data + 1), *(short*)(data + 3));
			data += 5;
			break;
		case 0x82u:
			if (!nox_client_isConnected_43C700())
				goto LABEL_797;
			nox_xxx_makePointFxCli_499610(*getMemIntPtr(0x5D4594, 1200780), 25, 500, 25, *(short*)(data + 1), *(short*)(data + 3));
			data += 5;
			break;
		case 0x83u:
			if (!nox_client_isConnected_43C700())
				goto LABEL_797;
			nox_xxx_makePointFxCli_499610(*getMemIntPtr(0x5D4594, 1200784), 25, 500, 25, *(short*)(data + 1), *(short*)(data + 3));
			data += 5;
			break;
		case 0x84u:
			if (nox_client_isConnected_43C700())
				nox_xxx_makePointFxCli_499610(*(int*)&dword_5d4594_1200796, 25, 500, 25, *(short*)(data + 1), *(short*)(data + 3));
		LABEL_797:
			data += 5;
			break;
		case 0x85u:
		...
		case 0xA3u:
			if (nox_client_isConnected_43C700()) {
				...
				case 138:
					...
					v259 = nox_xxx_spriteLoadAdd_45A360_drawable(*getMemIntPtr(0x5D4594, 1200900), *(short*)(data + 1), *(short*)(data + 3));
					if (v259) {
					...
					do {
						...
						v262 = nox_xxx_spriteLoadAdd_45A360_drawable(*getMemIntPtr(0x5D4594, 1200896), *(short*)(data + 1) + v261, v341);
						if (v262) {
							*(uint16_t*)(v262 + 104) =
			...
			if (nox_client_isConnected_43C700()) {
				...
				if (!nox_xxx_checkGameFlagPause_413A50()) {
					...
					if ((uint32_t)v5) {
						...
						*(uint8_t*)(v234 + 296) = nox_common_randomIntMinMax_415FF0(-4, 4, "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 5037);
		...
		case 0x96u:
			if (nox_client_isConnected_43C700()) {
				...
				do {
					LODWORD(v5) =
						nox_xxx_spriteLoadAdd_45A360_drawable(*getMemIntPtr(0x5D4594, 1200860), *(short*)(data + 1), *(short*)(data + 3));
					v240 = v5;
					if ((uint32_t)v5) {
						if ((uint32_t)v5 != (uint32_t)-432) {
							*(uint32_t*)(v5 + 432) = *(uint32_t*)(v5 + 12) << 12;
						...
						*(uint8_t*)(v240 + 296) = nox_common_randomIntMinMax_415FF0(-5, 5, "C:\\NoxPost\\src\\Client\\Network\\cdecode.c", 5351);
		...
		case 0x9Fu:
			...
			v298 = v297;
			if (nox_client_isConnected_43C700()) {
				LODWORD(v5) = nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1)) ? nox_xxx_netSpriteByCodeStatic_45A720(v298) : nox_xxx_netSpriteByCodeDynamic_45A6F0(v298);
				if ((uint32_t)v5) {
					LODWORD(v5) = v5 + 432;
		...
		case 0xA2u:
			...
			break;
		case 0xA4u:
			v15 = (unsigned char*)(nox_xxx_netCliProcUpdateStream_494A60((unsigned char*)(data + 1), a1, v384) + data + 1);
		...
		case 0xB2u:
			...
			v19 = v18;
			if (nox_client_isConnected_43C700()) {
				LODWORD(v5) = nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1)) ? nox_xxx_netSpriteByCodeStatic_45A720(v19) : nox_xxx_netSpriteByCodeDynamic_45A6F0(v19);
				if ((uint32_t)v5)
		...
		case 0xB3u:
			...
			v21 = v20;
			if (nox_client_isConnected_43C700()) {
				LODWORD(v5) = nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1)) ? nox_xxx_netSpriteByCodeStatic_45A720(v21) : nox_xxx_netSpriteByCodeDynamic_45A6F0(v21);
				v22 = v5;
				if ((uint32_t)v5) {
		...
		case 0xB4u:
			...
			v25 = v24;
			if (nox_client_isConnected_43C700()) {
				LODWORD(v5) = nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1)) ? nox_xxx_netSpriteByCodeStatic_45A720(v25) : nox_xxx_netSpriteByCodeDynamic_45A6F0(v25);
				v26 = v5;
				if ((uint32_t)v5) {
					if (*(uint8_t*)(data + 3)) {
		...
		case 0xB5u:
			if (nox_client_isConnected_43C700() &&
				(v329 = *(unsigned short*)(data + 7), v320 = *(unsigned short*)(data + 5),
				 ...
				 LODWORD(v5) = nox_xxx_spriteCreate_48E970(*(unsigned short*)(data + 3), v31, v320, v329), (uint32_t)v5)) {
		...
		case 0xC4u:
			...
			case 7u:
				...
				break;
			case 8u:
				if (nox_client_isConnected_43C700() && (LODWORD(v5) = nox_xxx_clientGetTeamColor_418AB0(*(uint32_t*)(data + 2)), (uint32_t)v5)) {
		...
		case 0xC9u:
			...
			case 0xDu:
				if (nox_client_isConnected_43C700())
					nox_xxx_cliStartShopDlg_478FD0((const wchar_t*)(data + 4), (char*)(data + 54), *(unsigned short*)(data + 2));
				data += 86;
				break;
			case 0x1Bu:
				if (!nox_client_isConnected_43C700())
		...
		case 0xD0u:
			if (*(uint8_t*)(data + 1) == 3) {
				if (nox_client_isConnected_43C700()) {
					sub_479D30((wchar_t*)(data + 34), *(uint32_t*)(data + 98), (char*)(data + 2), (const char*)(data + 102),
							   *(uint8_t*)(data + 134));
					if (*getMemU32Ptr(0x8531A0, 2576))
		...
		case 0xD2u:
			...
			if (*(uint8_t*)(data + 5) == 1) {
				if ((uint32_t)v5 || (LODWORD(v5) = nox_xxx_spriteCreate_48E970(*(unsigned short*)(data + 3), v282, 0, 0), (uint32_t)v5)) {
		...
		case 0xE2u:
			...
			if ((uint32_t)v5 || (LODWORD(v5) = sub_4676D0(v295), (uint32_t)v5) ||
				(!nox_xxx_netTestHighBit_578B70(*(unsigned short*)(data + 1)) ? (LODWORD(v5) = nox_xxx_netSpriteByCodeDynamic_45A6F0(v295))
		...
		case 0xE4: // fade
			if (nox_client_isConnected_43C700()) {
				if (*(uint8_t*)(data + 1) == 1) {
					...
					#endif // NOX_CGO
						sub_413A00(1);
						nox_client_screenFadeXxx_44DB30(nox_client_getFadeDuration(), *(uint8_t*)(data + 2) == 1, sub_44E020);
					}
				} else if (!nox_common_getEngineFlag(NOX_ENGINE_FLAG_DISABLE_GRAPHICS_RENDERING)) {
					nox_client_screenFadeTimeout_44DAB0(nox_client_getFadeDuration(), *(uint8_t*)(data + 2) == 1, sub_44E000);
				}
			}
			data += 3;
			break;
		...
		case 0xF0u:
			...
			case 0x10u:
				...
				if (nox_client_isConnected_43C700()) {
					v301 = nox_xxx_spriteLoadAdd_45A360_drawable(*getMemIntPtr(0x5D4594, 1200904), *(unsigned short*)(data + 6),
			...
			case 0x19u:
				...
				v302 = (uint32_t*)nox_xxx_spriteLoadAdd_45A360_drawable(*getMemIntPtr(0x5D4594, 1200912), *(short*)(data + 2),
													*(short*)(data + 4));
				if (v302)
			...
			case 0x1Au:
				if (nox_client_isConnected_43C700())
					nox_xxx_makePointFxCli_499610(*getMemIntPtr(0x5D4594, 1200788), 25, 500, 25, *(short*)(data + 2), *(short*)(data + 4));
				data += 6;
				break;
			case 0x1Cu:
				if (nox_client_isConnected_43C700())
