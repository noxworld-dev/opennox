...
char sub_509A60()
{
    ...
    {
        v0 = (char*)nox_common_mapflags_check(512);
        if (!v0)
        {
            v1 = sub_40A5B0();
...
int __cdecl sub_50A3D0(_DWORD* a1)
{
    ...
    if (!result)
    {
        ...
        if (!(v10 & 0x2000))
            sub_4EDA40(a1);
        if (!nox_common_mapflags_check(2048) && *(_DWORD*)(v1 + 2188) == 2 && *(_DWORD*)(v1 + 2184) == 2)
        {
            if (a1[130])
            {
...
int __cdecl sub_50E3D0(int a1, int a2, float a3)
{
    ...
    if (v4 && !a1)
    {
        v22 = nox_common_mapflags_check(4096) ? sub_419D40(&byte_587000[235736]) : *(float*)(v4 + 1720);
...
void __cdecl sub_511020(int a1, int a2)
{
    ...
    v2 = *(_DWORD*)(a1 + 16);
    if (!(v2 & 0x41)
        && (!(v2 & 0x10) || nox_common_mapflags_check(4096) && *(_BYTE*)(a1 + 8) & 2 && (*(_DWORD*)(a1 + 16) & 0x8000) != 0x8000)
        && *(_DWORD*)(a1 + 556)
...
char __cdecl sub_519410(int a1, int a2)
{
    ...
    if (!(v4 & 0x20) && !(*(_DWORD*)(a2 + 8) & 0x40000000))
    {
        ...
        {
            v7 = *(_DWORD*)(a2 + 16);
            if (!(v7 & 0x800) || sub_4EC4F0(a2, a1) || (v4 = nox_common_mapflags_check(512)) != 0)
            {
                v8 = *(_DWORD*)(v13 + 276);
