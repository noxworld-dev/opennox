...
void nox_xxx_unitListenRoutine_50CDD0(int unitA) {
	...
	do {
		...
		if (nox_frame_xxx_2598000 < monsterListenFlags || nox_frame_xxx_2598000 - monsterListenFlags > 2) {
			...
			nox_alloc_class_free_obj_first(*(unsigned int**)&nox_alloc_monsterListen_2386188, (uint64_t*)monsterListen);
		} else {
...
//----- (0050D1C0) --------------------------------------------------------
void sub_50D1C0() {
	nox_alloc_class_free_all(nox_alloc_monsterListen_2386188);
