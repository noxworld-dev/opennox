	...
	LABEL_19:
		if (v9 <= 0) {
			if (v9 < 0) {
				if (v11 > 0) {
					a2 = *v7;
					*(float*)(*(_DWORD*)&byte_5D4594[2386176] + 8 * v8) =
			...
			if (v11 <= 0) {
				if (v11 < 0) {
					...
					*(float*)(*(_DWORD*)&byte_5D4594[2386176] + 8 * v8) = (double)a2 * 23.0 + 2.3;
					...
					v18 = (double)a2;
				LABEL_37:
					*(float*)(*(_DWORD*)&byte_5D4594[2386176] + 8 * v8 + 4) =
					    v18 * 23.0 + 23.0 - 2.3;
					goto LABEL_38;
				}
				a2 = *v7;
...
//----- (0050CAF0) --------------------------------------------------------
int sub_50CAF0() { return *(_DWORD*)&byte_5D4594[1599712]; }

//----- (0050CB00) --------------------------------------------------------
int sub_50CB00() { return *(_DWORD*)&byte_5D4594[2386180]; }

//----- (0050CB10) --------------------------------------------------------
LPVOID sub_50CB10() { return *(LPVOID*)&byte_5D4594[2386176]; }
...
char* __cdecl sub_50CD40(int a1, int a2, _DWORD* a3) {
	...
	if (result) {
		if (*(_DWORD*)&byte_5D4594[2386188] || (result = nox_new_alloc_class("MonsterListen", 24, 128),
							    ...
							    *(_DWORD*)&byte_5D4594[2598000] - v5 > 2) {
								if (v2)
									...
									*(_DWORD*)&byte_5D4594[2386192] =
									    *(_DWORD*)(v4 + 20);
								sub_414330(*(unsigned int**)&byte_5D4594[2386188],
									   (_QWORD*)v4);
							} else {
								v7 = *(_DWORD*)(v4 + 4);
...
//----- (00510E50) --------------------------------------------------------
void sub_510E50() { *(_DWORD*)&byte_5D4594[2386564] = 0; }
	...
	if (a1) {
		...
		if (a1 == 1) {
			...
			if (v5 < 4u) {
				...
				*(_DWORD*)(result + 8) = 0;
				*(_DWORD*)(result + 4) =
				    *(_DWORD*)(*(_DWORD*)(*(_DWORD*)&byte_5D4594[2386940] + 4 * a2) + 16 * a3 + 4);
	...
	if (a1) {
		...
		if (a1 == 1) {
			...
			if (v3)
				...
				*(_DWORD*)(*(_DWORD*)(*(_DWORD*)&byte_5D4594[2386940] + 4 * *a2) + 16 * a2[1] + 4) =
				    *((_DWORD*)a2 + 1);
			v4 = *((_DWORD*)a2 + 1);
			if (v4)
		...
		if (v5)
			...
			*(_DWORD*)(*(_DWORD*)(*(_DWORD*)&byte_5D4594[2386940] + 4 * *a2) + 16 * a2[1]) =
			    *((_DWORD*)a2 + 1);
		v6 = *((_DWORD*)a2 + 1);
		if (v6)
...
LABEL_7:
	...
	v7 = v4;
LABEL_12:
	for (i = *(_DWORD*)(*(_DWORD*)(*(_DWORD*)&byte_5D4594[2386940] + 4 * v3) + 16 * v4 + 4); i;
	     i = *(_DWORD*)(i + 4))
		a2(*(_DWORD*)(i + 12), a3);
}
			...
			if (v11 <= v23) {
				...
				do {
					...
					if (v9 <= v10) {
						...
						v28 = v15;
						do {
							v16 = *(_DWORD*)(*(_DWORD*)(*(_DWORD*)&byte_5D4594[2386940] +
										    4 * v14) +
									 v15 + 4);
							if (v16) {
								do {
		...
		if (v7 <= v21) {
			...
			do {
				if (v5 <= v6) {
					...
					v26 = 16 * v9;
					do {
						v12 = *(_DWORD*)(*(_DWORD*)(*(_DWORD*)&byte_5D4594[2386940] + 4 * v5) +
								 v11);
						if (v12) {
							do {
								v13 = *(_DWORD*)(v12 + 12);
			...
			if (*v4 <= v4[2]) {
				do {
					...
					if (*(_DWORD*)(v11 + 12) != *(_DWORD*)&byte_5D4594[2386960]) {
						...
						*(_DWORD*)(*(_DWORD*)(*(_DWORD*)&byte_5D4594[2386940] + 4 * v10) + v9 +
