...
int nox_get_audio_subsystem_ready() { return 0; }

DXDEC HSAMPLE AILCALL AIL_allocate_sample_handle(HDIGDRIVER dig) { return NULL; }
...
DXDEC HSTREAM AILCALL AIL_open_stream(HDIGDRIVER dig, char const FAR* filename, S32 stream_mem) { return NULL; }
...
DXDEC HTIMER AILCALL AIL_register_timer(AILTIMERCB fn) { return NULL; }
