...
int nox_xxx_parseWeapDescription_411B90(const char* a1, char* a2, obj_412ae0_t* obj) {
	...
	const wchar_t* str2 =
		nox_strman_loadString_40F1D0(stringName, 0, "C:\\NoxPost\\src\\common\\Object\\Modifier.c", 426);
...
int nox_xxx_parseEnchDesc_412100_parse_desc(const char* a1, char* a2, obj_412ae0_t* obj) {
	...
	const wchar_t* str2 =
		nox_strman_loadString_40F1D0(stringName, 0, "C:\\NoxPost\\src\\common\\Object\\Modifier.c", 741);
	nox_wcsncpy(obj->field_2, str2, str1len);
	obj->field_2[str1len] = 0;
...
int nox_xxx_parseEnchDescSecondary_4121B0_parse_second_desc(const char* a1, char* a2, obj_412ae0_t* obj) {
	...
	const wchar_t* str2 =
		nox_strman_loadString_40F1D0(stringName, 0, "C:\\NoxPost\\src\\common\\Object\\Modifier.c", 775);
...
int nox_xxx_parseIdentifyDesc_412260_parse_ident_desc(const char* a1, char* a2, obj_412ae0_t* obj) {
	...
	const wchar_t* str2 =
		nox_strman_loadString_40F1D0(stringName, 0, "C:\\NoxPost\\src\\common\\Object\\Modifier.c", 809);
