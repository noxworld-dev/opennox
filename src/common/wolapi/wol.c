		...
		case 14:
			...
			if (v3) {
				...
				if (!strncmp("Official Nox Games for New Players", (const char*)(v5 + v4 + 25), 0x22u)) {
					v1 = loadString_sub_40F1D0((char*)&byte_587000[57804], 0, "C:\\NoxPost\\src\\common\\WolAPI\\wol.c",
											   96);
					v2 = loadString_sub_40F1D0((char*)&byte_587000[57860], 0, "C:\\NoxPost\\src\\common\\WolAPI\\wol.c",
											   97);
				} else {
					v2 = loadString_sub_40F1D0((char*)&byte_587000[57908], 0, "C:\\NoxPost\\src\\common\\WolAPI\\wol.c",
											   101);
				}
			} else {
				v2 = loadString_sub_40F1D0((char*)&byte_587000[57952], 0, "C:\\NoxPost\\src\\common\\WolAPI\\wol.c",
										   106);
			}
			break;
		case 16:
