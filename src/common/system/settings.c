	...
	if (*(_WORD*)&byte_5D4594[2 * v2 + 3488] != a2) {
		...
		*(_DWORD*)&nox_server_gameSettingsUpdated = 1;
		if (nox_client_isConnected_43C700()) {
			v4 = loadString_sub_40F1D0((char*)&byte_587000[4804], 0,
...
void __cdecl sub_40A040_settings(__int16 a1, unsigned __int8 a2) {
	...
	if (byte_5D4594[v2 + 3500] != a2) {
		if (!nox_common_gameFlags_check_40A5C0(0x4000000) && !dword_5d4594_3592) {
			*(_DWORD*)&nox_server_gameSettingsUpdated = 1;
			if (nox_client_isConnected_43C700()) {
				...
				v3 = loadString_sub_40F1D0((char*)&byte_587000[4928], 0,
							   "C:\\NoxPost\\src\\Common\\System\\settings.c", 423);
				sub_440A20(v3, a2);
		...
		v6 = loadString_sub_40F1D0((char*)&byte_587000[4868], 0, "C:\\NoxPost\\src\\Common\\System\\settings.c",
					   414);
		sub_445490(v6);
	}
}
