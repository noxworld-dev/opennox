...
void nox_xxx_clientDrawAll_436100_draw() {
	...
	*getMemU32Ptr(0x5D4594, 811916) = nox_frame_xxx_2598000;
	...
	if (*getMemU32Ptr(0x8529A0, 2044))
		*getMemU32Ptr(0x5D4594, 2614252) = nox_xxx_netSpriteByCodeDynamic_45A6F0(*getMemIntPtr(0x8529A0, 2044));
	...
	if (nox_common_gameFlags_check_40A5C0(8)) {
		...
		v15 = getMemIntPtr(0x5D4594, 811888 + 4 * *getMemU32Ptr(0x5D4594, 811060));
		v16 = (nox_win_height - 200) / 2;
		if (!*getMemU32Ptr(0x5D4594, 811888 + 4 * *getMemU32Ptr(0x5D4594, 811060))) {
			v15 = getMemIntPtr(0x5D4594, 811888 + 4 * *getMemU32Ptr(0x5D4594, 811060));
...
int sub_4365C0() {
	...
	if (dword_5d4594_805836) {
		...
		nox_xxx_drawSetTextColor_434390(*getMemIntPtr(0x853BC0, 31720));
		v23 = v1;
		v18 = v0;
	...
	nox_xxx_drawString_43F6E0(0, getMemI16Ptr(0x5D4594, 810900), v0, v5);
	v5 += 10;
	v26 = *getMemU32Ptr(0x853BC0, 30900);
	...
	*getMemU32Ptr(0x5D4594, 812968) = v6 % 128;
	...
	do {
		...
		if (v10 >= 10) {
			...
			v11 = *getMemU32Ptr(0x853BC0, 31720);
		}
	...
	*getMemU32Ptr(0x5D4594, 814512) = (v3 + 1) % 128;
	...
	do {
		...
		if (v8 >= 100) {
			...
			if (!v10)
				v9 = *getMemU32Ptr(0x853BC0, 31720);
		} else {
