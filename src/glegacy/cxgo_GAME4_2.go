		...
		if (func() int32 {
			...
			if ((v4&1) == 0 || a2 != 1) && ((a3&2) == 0 || a1 != 1) {
				...
				if *(*int32)(unsafe.Pointer(&dword_5d4594_2487248)) > 0 {
					...
					for {
						if *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v6))), -int(4*1)))) == uint32(a1) && *(*uint32)(unsafe.Pointer(v6)) == uint32(a2) && *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v6))), 4*1))) == uint32(v4) {
							return
						}
						v5++
				...
				if dword_5d4594_2487248 >= 500 {
					...
					*memmap.PtrUint32(0x973F18, uint32(v7+16204)) = uint32(a2)
					*memmap.PtrUint32(0x973F18, uint32(v7+16208)) = uint32(v4)
				}
			}
		}
	}
...
func sub_51DED0() int32 {
	...
	for {
		if sub_4E3AD0(*(*int32)(unsafe.Add(unsafe.Pointer(v0), 4*27))) == 0 && sub_4E3B80(*(*int32)(unsafe.Add(unsafe.Pointer(v0), 4*27))) != 0 {
			...
			v4 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v3))), 4*9))))
			...
			*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v3))), 4*10))) = uint32(v5)
			*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v3))), 4*11))) = uint32(v5)
			*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v3))), 4*9))) = uint32(v5)
			*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v3))), 4*4))) = uint32(*(*int32)(unsafe.Add(unsafe.Pointer(v0), 4*30)))
			*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v3))), 4*5))) = uint32(*(*int32)(unsafe.Add(unsafe.Pointer(v0), 4*70)))
			nox_xxx_xfer_saveObj_51DF90((*nox_object_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v3)))))))
			*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v3))), 4*9))) = uint32(v4)
			nox_xxx_objectFreeMem_4E38A0((*nox_object_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v3)))))))
		}
		v0 = (*int32)(unsafe.Pointer(nox_drawable_next_45A070((*nox_drawable)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v0)))))))))
		if v0 == nil {
			break
		}
	}
...
func nox_xxx_mapSaveMap_51E010(a1 *byte, a2 int32) int32 {
	...
	*(*byte)(unsafe.Add(unsafe.Pointer(v2), 4)) = byte(v3)
	...
	if result != 0 {
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v7)), 4, internCStr(__FILE__), __LINE__)
		v5 = nox_xxx_cryptFlush_4268E0()
		if nox_xxx_map_51E140() != 0 {
			sub_4268F0(v5)
			nox_xxx_cryptClose_4269F0()
			if a2 == 0 || (func() int32 {
				result = nox_xxx_nxzCompressFile_57BDD0(&Mem[0], (*byte)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(&v8[0])))))))
				return result
			}()) != 0 {
				result = 1
			}
...
func nox_xxx_map_51E140() int32 {
	...
	*memmap.PtrUint32(0x5D4594, 2487256) = 256
	nox_xxx_wallForeachFn_410640(unsafe.Pointer(funAddr(nox_xxx_mapCountWallsMB_51DEA0)), nil)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(memmap.PtrOff(0x5D4594, 2487252)), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(memmap.PtrOff(0x5D4594, 2487256)), 4, internCStr(__FILE__), __LINE__)
	...
	if nox_xxx_mapWriteSectionsMB_426E20(nil) != 0 {
		nox_xxx_map_5004F0()
		v2 = 0
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v2)), 1, internCStr(__FILE__), __LINE__)
		result = 1
	} else {
		nox_xxx_cryptClose_4269F0()
		result = 0
																				...
																				if nox_strcmpi(internCStr("skeleton"), (*byte)(memmap.PtrOff(0x5D4594, 2487264))) == 0 {
																					...
																					if *memmap.PtrUint32(0x587000, 253244) != 0 {
																						...
																						for {
																							...
																							v5 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v4))), 4*1))))
																					...
																					if *memmap.PtrUint32(0x587000, uint32(v2*4)+253244) != 0 {
...
func nox_xxx_genReadSpellSet_51EFB0(a1 int32, a2 *File) int32 {
	...
	for {
		...
		if nox_strcmpi(internCStr("END"), (*byte)(memmap.PtrOff(0x5D4594, 2487264))) == 0 || *(*uint32)(unsafe.Pointer(uintptr(a1 + 1096))) >= 137 {
			break
		}
...
func nox_xxx_genReadWeaponSet_51F030(a1 int32, a2 *File) int32 {
	...
	for {
		...
		if nox_strcmpi(internCStr("WEAPON"), (*byte)(memmap.PtrOff(0x5D4594, 2487264))) == 0 {
			...
			if nox_strcmpi(internCStr("TEMPLATE"), (*byte)(unsafe.Add(unsafe.Pointer(v2), 60))) != 0 {
				*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v2))), 4*38))) = 0
...
func nox_xxx_genReadExit_51F800(a1 int32, a2 *File) int32 {
	for {
		...
		if nox_strcmpi(internCStr("OBJECT"), (*byte)(memmap.PtrOff(0x5D4594, 2487264))) != 0 {
			...
			libc.StrCpy((*byte)(unsafe.Pointer(uintptr(a1+476))), (*byte)(memmap.PtrOff(0x5D4594, 2487264)))
		} else {
			if nox_xxx_mapGenReadLine_51E540(a2, (*uint8)(memmap.PtrOff(0x5D4594, 2487264))) == 0 {
				return 0
			}
			libc.StrCpy((*byte)(unsafe.Pointer(uintptr(uint32(a1+216)+(*(*uint32)(unsafe.Pointer(uintptr(a1 + 472)))<<6)))), (*byte)(memmap.PtrOff(0x5D4594, 2487264)))
			if nox_xxx_mapGenReadLine_51E540(a2, (*uint8)(memmap.PtrOff(0x5D4594, 2487264))) == 0 {
				return 0
			}
...
func nox_xxx_genReadDecor_51F9F0(a1 *uint32, a2 *File) int32 {
	...
	*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v2))), 4*18))) = 1000
	*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v2))), 4*19))) = 0
	*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v2))), 4*20))) = 999999
	if nox_xxx_mapGenReadLine_51E540(a2, (*uint8)(memmap.PtrOff(0x5D4594, 2487264))) == 0 {
		return 0
	}
	...
	for {
		...
		if nox_strcmpi(internCStr("END"), (*byte)(memmap.PtrOff(0x5D4594, 2487264))) == 0 {
			...
			case 0:
				*(*uint32)(unsafe.Pointer(uintptr(v3 + 220))) = *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*22))
				...
				*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*23)) = uint32(v10 + 1)
				result = 1
			case 1:
				*(*uint32)(unsafe.Pointer(uintptr(v3 + 220))) = *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*30))
				...
				*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*31)) = uint32(v12 + 1)
				result = 1
			case 2:
				*(*uint32)(unsafe.Pointer(uintptr(v3 + 220))) = *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*38))
				...
				*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*39)) = uint32(v13 + 1)
				result = 1
			case 3:
				*(*uint32)(unsafe.Pointer(uintptr(v3 + 220))) = *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*46))
	...
	if result != nil {
		...
		if result != nil {
			...
			if result != nil {
				...
				*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v3))), 4*31))) = *(*uint32)(unsafe.Pointer(uintptr(a1 + 84)))
...
func sub_51FEC0(a1 int32, a2 int32, a3 *File) int32 {
	...
	if result != 0 {
		*(*uint32)(unsafe.Pointer(uintptr(result))) = uint32(a2)
		...
		if result != 0 {
			libc.StrCpy((*byte)(unsafe.Pointer(uintptr(v4+4))), (*byte)(memmap.PtrOff(0x5D4594, 2487264)))
			result = nox_xxx_mapGenReadLine_51E540(a3, (*uint8)(memmap.PtrOff(0x5D4594, 2487264)))
			if result != 0 {
				libc.StrCpy((*byte)(unsafe.Pointer(uintptr(v4+64))), (*byte)(memmap.PtrOff(0x5D4594, 2487264)))
	...
	*(*int32)(unsafe.Add(unsafe.Pointer(v4), 4*1)) = int32(libc.Atoi(libc.GoString((*byte)(memmap.PtrOff(0x5D4594, 2487264)))))
	for {
		for {
			...
			*(*uint32)(unsafe.Add(unsafe.Pointer(v5), 4*2)) = *(*uint32)(unsafe.Pointer(uintptr(v2 + 84)))
		...
		*v7 = 0
		if *memmap.PtrUint32(0x587000, 253216) != 0 {
			for {
				...
				*(*uint32)(unsafe.Pointer(uintptr(v2))) = uint32(v8)
				if *memmap.PtrUint32(0x587000, uint32(v8*4)+253216) == 0 {
					break
				}
			}
		}
		...
		case 1:
			...
			*(*uint32)(unsafe.Pointer(uintptr(v2 + 64))) = 1
			if nox_xxx_mapGenReadLine_51E540(a2, (*uint8)(memmap.PtrOff(0x5D4594, 2487264))) != 0 {
				*(*float32)(unsafe.Pointer(uintptr(v2 + 76))) = float32(libc.Atof(libc.GoString((*byte)(memmap.PtrOff(0x5D4594, 2487264)))))
				if nox_xxx_mapGenReadLine_51E540(a2, (*uint8)(memmap.PtrOff(0x5D4594, 2487264))) != 0 {
					...
					if nox_xxx_mapGenReadLine_51E540(a2, (*uint8)(memmap.PtrOff(0x5D4594, 2487264))) != 0 {
						if libc.StrCmp(internCStr("*"), (*byte)(memmap.PtrOff(0x5D4594, 2487264))) == 0 {
							*(*uint32)(unsafe.Pointer(uintptr(v2 + 72))) = 999999
						} else {
							*(*uint32)(unsafe.Pointer(uintptr(v2 + 72))) = uint32(libc.Atoi(libc.GoString((*byte)(memmap.PtrOff(0x5D4594, 2487264)))))
						}
						v4 = (*int32)(unsafe.Pointer(uintptr(v12)))
	...
	LABEL_39:
		*(*uint32)(unsafe.Pointer(uintptr(v2 + 88))) = uint32(*(*int32)(unsafe.Add(unsafe.Pointer(v4), 4*2)))
...
LABEL_2:
	...
	if v2 != nil && nox_xxx_mapGenReadLine_51E540(a1, (*uint8)(memmap.PtrOff(0x5D4594, 2487264))) != 0 {
		...
		for nox_xxx_mapGenReadLine_51E540(a1, (*uint8)(memmap.PtrOff(0x5D4594, 2487264))) != 0 {
			...
			if v1 != nil {
				v9 = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v1), 4*514)))))
				for i = v1; v9 != nil; v9 = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v9), 4*514))))) {
					i = v9
				}
			...
			if v17 != 0 {
				if v15 != 0 {
					...
					for {
						...
						v11 = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v11), 4*514)))))
						if v11 == nil {
							break
						}
					}
		...
		LABEL_A:
			...
			if *memmap.PtrUint32(0x587000, 253216) != 0 {
				...
				for {
					...
					v7 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v6))), 4*1))))
			...
			if *memmap.PtrUint32(0x587000, uint32(v4*4)+253216) == 0 {
			...
			*(*uint32)(unsafe.Add(unsafe.Pointer(v2), 4*uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v2), 4*513))*16+1))) = uint32(v4)
			if nox_xxx_mapGenReadLine_51E540(a1, (*uint8)(unsafe.Pointer((*uint32)(unsafe.Add(unsafe.Pointer(v2), 4*uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v2), 4*513))*16+2)))))) == 0 {
				break
			}
...
func nox_xxx_genDecorReadCopy_520660(a1 *uint32, a2 *byte, a3 *File) int32 {
	...
	v4 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a2))), 4*15))))
	if v4 != 0 {
		v5 = v4 - 1
		if v5 != 0 {
			if v5 == 1 {
				v6 = (*byte)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*38)))))
			} else {
				v6 = a2
			}
		} else {
			v6 = (*byte)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*30)))))
		}
	} else {
		v6 = (*byte)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*22)))))
	}
	v7 = v6
	if v6 != nil {
		for libc.StrCmp(v7, (*byte)(memmap.PtrOff(0x5D4594, 2487264))) != 0 {
			v7 = (*byte)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v7))), 4*55))))))
			if v7 == nil {
				break
			}
		}
	...
	if v7 == nil {
		v7 = (*byte)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*38)))))
		if v7 == nil {
			return 0
		}
		for libc.StrCmp(v7, (*byte)(memmap.PtrOff(0x5D4594, 2487264))) != 0 {
	...
	for i = (*uint32)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v7))), 4*21)))))); i != nil; i = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(i), 4*31))))) {
		...
		*(*uint32)(unsafe.Add(unsafe.Pointer(v9), 4*31)) = *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a2))), 4*21)))
		v10 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a2))), 4*22))) + 1)
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a2))), 4*21))) = uint32(uintptr(unsafe.Pointer(v9)))
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a2))), 4*22))) = uint32(v10)
	}
	v11 = (*uint32)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a2))), 4*23))))))
	if v11 != nil {
		for j = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v11), 4*5))))); j != nil; j = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(j), 4*5))))) {
			v11 = j
		}
	}
		...
		*(*uint32)(unsafe.Add(unsafe.Pointer(v14), 4*5)) = 0
		if v11 != nil {
			*(*uint32)(unsafe.Add(unsafe.Pointer(v11), 4*5)) = uint32(uintptr(unsafe.Pointer(v14)))
			v15 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a2))), 4*24))) + 1)
		} else {
			*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a2))), 4*23))) = uint32(uintptr(unsafe.Pointer(v14)))
		}
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a2))), 4*24))) = uint32(v15)
		k = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(k), 4*5)))))
	}
	return 1
}
	...
	if nox_strcmpi(internCStr("NONE"), (*byte)(memmap.PtrOff(0x5D4594, 2487264))) != 0 {
		...
		if v3 != nil {
			for {
				...
				if *memmap.PtrUint32(0x587000, uint32(v4*4)+253144) == 0 {
					break
				}
...
func nox_xxx_genDecorReadOccurLimit_5208D0(a1 int32, a2 *File) int32 {
	...
	result = nox_xxx_mapGenReadLine_51E540(a2, (*uint8)(memmap.PtrOff(0x5D4594, 2487264)))
	if result != 0 {
		*(*uint8)(unsafe.Pointer(uintptr(a1 + 65))) = uint8(int8(libc.Atoi(libc.GoString((*byte)(memmap.PtrOff(0x5D4594, 2487264))))))
		result = 1
	}
	return result
}
...
func nox_xxx_genDecorReadRoomSizeCon_5209F0(a1 int32, a2 *File) int32 {
	...
	if result != 0 {
		if nox_strcmpi(internCStr("*"), (*byte)(memmap.PtrOff(0x5D4594, 2487264))) != 0 {
			*(*uint32)(unsafe.Pointer(uintptr(a1 + 76))) = uint32(libc.Atoi(libc.GoString((*byte)(memmap.PtrOff(0x5D4594, 2487264)))))
		} else {
		...
		if result != 0 {
			if nox_strcmpi(internCStr("*"), (*byte)(memmap.PtrOff(0x5D4594, 2487264))) != 0 {
				*(*uint32)(unsafe.Pointer(uintptr(a1 + 80))) = uint32(libc.Atoi(libc.GoString((*byte)(memmap.PtrOff(0x5D4594, 2487264)))))
			} else {
				*(*uint32)(unsafe.Pointer(uintptr(a1 + 80))) = 999999
			}
			result = 1
		}
	}
...
func nox_xxx_mapgenCheckSettings_520AD0(a1 *int32) int32 {
	...
	*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*6)) = 0
	for *(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*7)) = 0; v1 != 0; v1 = int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 220)))) {
		if int32(*(*uint8)(unsafe.Pointer(uintptr(v1 + 64)))) == 0 {
			*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*2)) += int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 72))))
			*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*3)) += int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 72))))
			*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*4)) += int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 72))))
			*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*5)) += int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 72))))
			*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*6)) += int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 72))))
			*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*7)) += int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 72))))
		}
		...
		if int32(*(*uint8)(unsafe.Pointer(uintptr(v1 + 64))))&0x10 != 0 {
			*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*6)) += int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 72))))
		}
		if int32(*(*uint8)(unsafe.Pointer(uintptr(v1 + 64))))&0x20 != 0 {
			*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*7)) += int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 72))))
		}
	}
		...
		if nox_strcmpi(internCStr("AREAMAP"), (*byte)(memmap.PtrOff(0x5D4594, 2487264))) != 0 {
			if nox_strcmpi(internCStr("MUST_OCCUR"), (*byte)(memmap.PtrOff(0x5D4594, 2487264))) != 0 {
				if nox_strcmpi(internCStr("FOREACH"), (*byte)(memmap.PtrOff(0x5D4594, 2487264))) == 0 {
					...
					*(*uint32)(unsafe.Add(unsafe.Pointer(v5), 4*2)) = *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v2))), 4*38)))
					*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v2))), 4*38))) = uint32(uintptr(unsafe.Pointer(v5)))
				}
			} else {
				v3 = 1
			}
			...
			if v3 != 0 {
				*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v4))), 4*18))) = 1
				v3 = 0
			}
		}
	}
...
func sub_520D50(a1 *uint32) *uint32 {
	...
	v1 = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*22)))))
	if v1 != nil {
		for {
	...
	v3 = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*30)))))
	if v3 != nil {
		for {
	...
	v5 = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*275)))))
	if v5 != nil {
		for {
			v6 = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v5), 4*38)))))
	...
	v7 = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*277)))))
	if v7 != nil {
		for {
			v8 = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v7), 4*38)))))
	...
	result = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*20)))))
	if result != nil {
		for {
...
func nox_xxx_mapGenSetRoomPos_521880(a1 *uint32, a2 *float2) int32 {
	*(*float2)(unsafe.Pointer((*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*5)))) = *a2
...
func sub_5218B0(a1 int32, a2 int32) int32 {
	...
	for i = (*uint32)(unsafe.Pointer(uintptr(a2*32 + a1 + 88))); *i == 0 || *(*uint32)(unsafe.Pointer(uintptr(*i))) != 1; i = (*uint32)(unsafe.Add(unsafe.Pointer(i), 4*1)) {
		if func() int32 {
			p := &v2
			*p++
			return *p
...
func sub_521A10(lpMem unsafe.Pointer) {
	...
	v1 = (*uint32)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(lpMem)), 4*92))))))
	if v1 != nil {
		for {
...
func nox_xxx_mapGenFreeTopRoom_521A40() *uint32 {
	...
	if dword_5d4594_2487560 != 0 {
		for {
			v1 = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(result), 4*14)))))
...
func sub_521C10(a1 int32) *uint32 {
	...
	if result != nil {
		for {
			v3 = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(result), 4*6)))))
			if *result == 1 {
				if v1 != nil {
...
func nox_xxx_mapgen_521C60(a1 int32, a2 int32) int32 {
	...
	for i = result; result != 0; i = result {
		...
		if a2 != 0 {
			for {
				if uint32(*(*uint16)(unsafe.Pointer(uintptr(i + 4)))) == *(*uint32)(unsafe.Pointer(uintptr(v4))) {
...
func sub_521CB0(a1 int32, a2 int32, a3 int32, a4 int32) int32 {
	...
	if v7 >= 0 && v8 >= 0 {
		...
		v9 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v17))), 4*15))))
		if v9&1 != 0 {
			v20.field_4 = *(*float32)(unsafe.Pointer(uintptr(a2 + 40)))
		} else if v9&2 != 0 {
			v20.field_4 = *(*float32)(unsafe.Pointer(uintptr(a2 + 48))) - v16
		}
		v10 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v17))), 4*15))))
		if v10&4 != 0 {
		...
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v4))), 4*5))) = uint32(a4)
...
func nox_xxx_mapgen_521FE0(a1 int32, a2 int32, a3 *uint32) {
	...
	if a3 != nil {
		...
		for {
			...
			v3 = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*514)))))
			if v3 == nil {
				return
			}
		}
		if v3 != nil {
			...
			if *(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*513)) > 0 {
				v5 = nil
				v6 = (*byte)(unsafe.Pointer((*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*2))))
				for {
					switch *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v6))), -int(4*1)))) {
					case 0:
...
func nox_xxx_mapGenMakeEnchantedItem_5221A0(a1 *byte, a2 *byte, a3 int32) *uint32 {
	...
	if libc.StrCmp(internCStr("*"), a1) == 0 {
		...
		for i = 0; v4 != nil; i++ {
			...
			v4 = (*byte)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v4))), 4*38))))))
		}
	...
	if v7 != nil && v4 != nil {
		...
		*(*uint32)(unsafe.Pointer(&v13[12])) = 0
		for {
			if *v8 != 0 {
				if uint32(nox_xxx_mapGenRandFunc_526AC0(1, 100)) <= *memmap.PtrUint32(0x587000, uint32(v9)+254688) {
...
func sub_522300(a1 int32, a2 *uint32) *uint32 {
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(a2), 4*124)) = *(*uint32)(unsafe.Pointer(uintptr(a1 + 504)))
...
func nox_xxx_mapgen_522340(a1 int32, a2 int32) {
	var i *int32
	for i = *(**int32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(a2 + 372))) + 92))); i != nil; i = (*int32)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(i), 4*5))))) {
...
func nox_xxx_mapgen_522370(a1 int32, a2 int32, a3 *int32) {
	...
	if *(*int32)(unsafe.Add(unsafe.Pointer(a3), 4*2)) != 0 {
		...
		*(*uint32)(unsafe.Pointer(uintptr(v6 + 96))) = 0
		v8 = *(**uint32)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(v3), 4*2)) + 88)))
			...
			for {
				if nox_xxx_mapGenRandFunc_526AC0(1, 100) >= 50 {
					...
					if v9 != 0 {
						...
						*(*uint32)(unsafe.Add(unsafe.Pointer(v8), 4*23)) = *(*uint32)(unsafe.Pointer(uintptr(v6 + 92)))
					} else {
						*(*uint32)(unsafe.Add(unsafe.Pointer(v8), 4*24)) = uint32(v6)
						*(*uint32)(unsafe.Add(unsafe.Pointer(v8), 4*23)) = *(*uint32)(unsafe.Pointer(uintptr(v6 + 92)))
						v7 = v8
				...
				v8 = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v8), 4*22)))))
				v12++
...
func sub_522CA0(a1 int32, a2 *float32) int8 {
	...
	*((*uint8)(unsafe.Pointer(&v2))) = *(*uint8)(unsafe.Pointer(uintptr(a1 + 352)))
	if int32(uint8(int8(v2))) < 0x10 {
		...
		*((*uint8)(unsafe.Pointer(&v2))) = uint8(int8(int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 352)))) + 1))
...
func nox_xxx_netSendPointFx_522FF0(a1 int8, a2 *float2) int32 {
	...
	a2a[0] = byte(a1)
	v2 = int16(nox_float2int(a2.field_0))
	v3 = a2.field_4
	*(*uint16)(unsafe.Pointer(&a2a[1])) = uint16(v2)
	*(*uint16)(unsafe.Pointer(&a2a[3])) = uint16(int16(nox_float2int(v3)))
...
func sub_523150(a1 int8, a2 int8, a3 *float32) int32 {
	...
	v4[0] = byte(a1)
	v4[1] = byte(a2)
	*(*uint16)(unsafe.Pointer(&v4[2])) = uint16(int16(nox_float2int(*a3)))
	*(*uint16)(unsafe.Pointer(&v4[4])) = uint16(int16(nox_float2int(*(*float32)(unsafe.Add(unsafe.Pointer(a3), unsafe.Sizeof(float32(0))*1)))))
...
func nox_xxx_sendGeneratorBreakFX_523200(a1 *float32, a2 int8) {
	...
	*(*uint16)(unsafe.Pointer(&v5[4])) = uint16(int16(nox_float2int(v3)))
	v5[6] = byte(a2)
...
func nox_xxx_mapGenSetFlags_5235F0(a1 int8) {
	...
	if !nox_common_gameFlags_check_40A5C0(0x200000) {
		...
		if dword_5d4594_2487564-dword_5d4594_2487568 > uint32(*memmap.PtrInt32(0x587000, 254948)) {
			*(*uint16)(unsafe.Pointer((*byte)(unsafe.Add(unsafe.Pointer((*byte)(unsafe.Pointer(&v3))), 1)))) = *memmap.PtrUint16(0x5D4594, 2487572)
...
func sub_523960(a1 int32) int32 {
	return int32(*memmap.PtrUint32(0x587000, uint32(a1*4)+254952))
}
...
func sub_523D30(a1 *float32, a2 *float32) *float32 {
	...
	if *(*uint32)(unsafe.Pointer(a1)) == 2 || v3 == 3 {
		v7 = (*uint32)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a1))), 4*22))))))
		if v7 != nil {
			v8 = (*uint32)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a1))), 4*30))))))
			if v8 != nil {
				if *v7 == 1 && *v8 == 1 {
		...
		v4 = (*uint32)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a1))), 4*38))))))
		if v4 != nil {
			v5 = (*uint32)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a1))), 4*46))))))
			if v5 != nil {
				if *v4 == 1 && *v5 == 1 {
					v6 = float64(*(*float32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(float32(0))*11))+*(*float32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(float32(0))*9))) * 0.5
					*a2 = float32(v6)
	...
	if result != nil {
		*(*uint32)(unsafe.Pointer(result)) = uint32(a1)
		...
		case 5:
			...
			*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(result))), 4*4))) = uint32(a2)
			if a2 < 1 {
				*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(result))), 4*4))) = 1
			}
		default:
		}
		*(*float32)(unsafe.Add(unsafe.Pointer(result), unsafe.Sizeof(float32(0))*7)) = float32(float64(*((*int32)(unsafe.Add(unsafe.Pointer((*int32)(unsafe.Pointer(result))), 4*3)))) * 32.526913)
		*(*float32)(unsafe.Add(unsafe.Pointer(result), unsafe.Sizeof(float32(0))*8)) = float32(float64(*((*int32)(unsafe.Add(unsafe.Pointer((*int32)(unsafe.Pointer(result))), 4*4)))) * 32.526913)
	}
	return result
}
...
func nox_xxx_mapGenDecorChkConstaint_5241C0(a1 int32, a2 int32) int32 {
	...
	return bool2int32(int32(*(*uint8)(unsafe.Pointer(uintptr(a2 + 364))))&int32(v2) != 0 || int32(v2) == 0)
}
func nox_xxx_mapGenChkDecorFillsRoom_5241F0(a1 int32, a2 int32) int32 {
	...
	return bool2int32(v2 >= *(*int32)(unsafe.Pointer(uintptr(a1 + 76))) && v2 <= *(*int32)(unsafe.Pointer(uintptr(a1 + 80))))
}
func nox_xxx_mapGenDecorChkLimit_524220(a1 *int32, a2 int32) int8 {
	...
	*((*uint8)(unsafe.Pointer(&i))) = *(*uint8)(unsafe.Pointer(uintptr(a2 + 65)))
		...
		*(*uint8)(unsafe.Pointer(uintptr(a2 + 65))) = uint8(int8(i))
		if int32(uint8(int8(i))) == 0 {
			if int32(*(*uint8)(unsafe.Pointer(uintptr(a2 + 64))))&2 != 0 {
				*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*3)) -= int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 72))))
			}
			if int32(*(*uint8)(unsafe.Pointer(uintptr(a2 + 64))))&4 != 0 {
				*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*4)) -= int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 72))))
			}
			if int32(*(*uint8)(unsafe.Pointer(uintptr(a2 + 64))))&8 != 0 {
				*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*5)) -= int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 72))))
			}
			if int32(*(*uint8)(unsafe.Pointer(uintptr(a2 + 64))))&0x10 != 0 {
				*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*6)) -= int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 72))))
			}
			i = *a1
			v3 = 0
			if *a1 != 0 {
	...
	if *v12 != 0 {
		for {
			...
			if int32(*(*uint8)(unsafe.Pointer(uintptr(v2 + 67)))) != 0 && int32(*(*uint8)(unsafe.Pointer(uintptr(v2 + 68)))) == 0 {
				...
				for *(*int32)(unsafe.Add(unsafe.Pointer(v4), 4*93)) != 0 || nox_xxx_mapGenCheckRoomType_5238F0(v4) != 0 || nox_xxx_mapGenDecorChkConstaint_5241C0(v2, int32(uintptr(unsafe.Pointer(v4)))) == 0 || nox_xxx_mapGenChkDecorFillsRoom_5241F0(v2, int32(uintptr(unsafe.Pointer(v4)))) == 0 || int32(*(*uint8)(unsafe.Pointer(uintptr(v2 + 66)))) != 0 {
	...
	if v5 != 0 {
		for {
			...
			if int32(*(*uint8)(unsafe.Pointer(uintptr(v5 + 67)))) != 0 && int32(*(*uint8)(unsafe.Pointer(uintptr(v5 + 68)))) == 0 {
				...
				for *(*int32)(unsafe.Add(unsafe.Pointer(v8), 4*93)) != 0 || nox_xxx_mapGenCheckRoomType_5238F0(v8) == 0 || nox_xxx_mapGenDecorChkConstaint_5241C0(v5, int32(uintptr(unsafe.Pointer(v8)))) == 0 || nox_xxx_mapGenChkDecorFillsRoom_5241F0(v5, int32(uintptr(unsafe.Pointer(v8)))) == 0 || int32(*(*uint8)(unsafe.Pointer(uintptr(v5 + 66)))) != 0 {
...
func nox_xxx_gen_524680(a1 int32, a2 int32, a3 int32) int32 {
	...
	for i = *(**uint32)(unsafe.Pointer(uintptr(a3 + 120))); i != nil; i = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(i), 4*31))))) {
		if result <= 0 || v6 <= 0 {
			break
		}
		if *i == 1 {
...
func sub_525C90() *float32 {
	...
	for i = result; result != nil; i = result {
		...
		if dword_5d4594_2487584 != 0 {
			v3 = 0
			for {
				if float64(*(*float32)(unsafe.Add(unsafe.Pointer(i), unsafe.Sizeof(float32(0))*89))) < float64(*(*float32)(unsafe.Pointer(uintptr(v2 + 356)))) {
					...
					*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), 4*16))) = uint32(v2)
					*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), 4*17))) = uint32(v5)
			...
			if v2 == 0 {
				*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), 4*17))) = uint32(v3)
...
func nox_xxx_mapGen_InPrefab1_525D20(a1 int32) int32 {
	...
	for i = *(**uint32)(unsafe.Pointer(uintptr(a1 + 80))); i != nil; i = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(i), 4*39))))) {
	...
	for j = *(**uint32)(unsafe.Pointer(uintptr(a1 + 80))); j != nil; j = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(j), 4*39))))) {
...
func sub_525DF0(a1 float32) {
	...
	v1 = float64(*(*float32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 64)))) * 0.5
	*memmap.PtrUint32(0x5D4594, 2487608) = 0
	v2 = int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 84))))
	v16 = float32(v1)
	if v2 >= 5 {
		v2 = 5
	...
	if v2 > 0 {
		for {
			...
			v7 = int32(*memmap.PtrUint32(0x5D4594, uint32(v6*4)+2487588))
			*memmap.PtrUint32(0x5D4594, uint32(v6*4)+2487588) = *memmap.PtrUint32(0x5D4594, uint32(v6*4)+2487592)
			*memmap.PtrUint32(0x5D4594, uint32(v6*4)+2487592) = uint32(v7)
			v2 = int32(dword_5d4594_2487652)
			v5++
			...
			*(*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(a2 + 148))) + 52))) |= 2
			...
			for {
				if *(*uint32)(unsafe.Add(unsafe.Pointer(v8), 4*3)) != 0 {
					...
					*(*uint32)(unsafe.Add(unsafe.Pointer(v8), 4*1)) += uint32(v7) + *(*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(a2 + 148))) + 8)))
				}
	...
	if v4 > 0 {
		...
		for {
			...
			*(*uint32)(unsafe.Pointer(uintptr(*v20 + 72))) = 0
			if (*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v19))), 4*1))) != 0 {
				*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v19))), 4*1))) + 72))) = uint32(v21)
			} else {
				*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v19))), 4*0)) = uint32(v21)
			}
			v20 = (*int32)(unsafe.Add(unsafe.Pointer(v20), 4*1))
			v4--
			*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v19))), 4*1)) = uint32(v21)
			if v4 == 0 {
				break
			}
		}
...
func nox_xxx_mapGen_InPrefab2_5266F0(a1 int32) int32 {
	...
	for {
		if *(*uint32)(unsafe.Pointer(uintptr(v1 + 76))) != 0 {
			...
			for {
				if *v4 != 0 {
					...
					for sub_54B2D0((*int32)(unsafe.Pointer(uintptr(v1))), v5, v6) == 0 {
						v6 = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v6), 4*18)))))
						if v6 == nil {
							return 0
						}
					}
...
func nox_xxx_mapGenPlacePrefabs_526830(a1 int32) int32 {
	...
	for {
		if *(*int32)(unsafe.Add(unsafe.Pointer(v1), 4*19)) != 0 {
			...
			sub_503B30((*float2)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(v1), 4*37)) + 20))))
		}
		v1 = (*int32)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(v1), 4*39)))))
		if v1 == nil {
			break
		}
	}
			...
			for {
				...
				if v4 != nil {
					...
					if int32(*memmap.PtrUint8(0x587000, 255032)) != 0 {
						for {
							if libc.StrChr(v4, byte(int8(*memmap.PtrUint8(0x587000, uint32(v5)+255032)))) != nil {
								*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v3))), 4*15))) |= uint32(1 << v5)
							}
...
func sub_527380(a1 *float32) int32 {
	...
	if v2 > 0 && v2 < math.MaxUint8 && int32(v3) > 0 && int32(v3) < math.MaxUint8 {
		...
		*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v3))), 4*0)) = uint32(v9)
		v2 = v8
	}
	v4 = v2 - 1
	v8 = v4
...
func sub_527450(a1 *uint32) int32 {
	...
	for v6 <= v5 {
		...
		for v7 <= v2+4 {
			...
			v9 = v8
			if v8 != 0 && (int32(*(*uint8)(unsafe.Pointer(uintptr(v8 + 4))))&0x8C) == 0 {
	...
	for {
		...
		v12 = int64(v10)
		v13 = int32(v12)
		result = int32(v12 - int64(*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v12))), 4*1))))
		v14 = v13 / 2
		if v2 > v11 {
			goto LABEL_72
		}
		for {
			...
			if v14 < 128 {
				...
				if *memmap.PtrUint32(0x587000, uint32(v15*4)+255052) != math.MaxUint8 {
					...
					if v18 != nil {
						...
						if uint32(*v18) == *memmap.PtrUint32(0x587000, uint32(v15*4)+255052) {
							goto LABEL_45
						}
						...
						v21 = *memmap.PtrUint8(0x587000, uint32(v15*4)+255052)
						...
						*v18 = v21
						...
						v24 = *memmap.PtrUint8(0x587000, uint32(v15*4)+255052)
		...
		LABEL_45:
			if v14 < 128 {
				...
				if *memmap.PtrUint32(0x587000, uint32(v39*4)+255052) != math.MaxUint8 {
					v28 = (*uint8)(nox_server_getWallAtGrid_410580(v34-1, v35-1))
					v29 = v28
					if v28 != nil {
						if (int32(*(*uint8)(unsafe.Add(unsafe.Pointer(v28), 4)))&0x8C) == 0 && uint32(*v28) != *memmap.PtrUint32(0x587000, uint32(v39*4)+255052) {
							v30 = int32(*(*uint8)(unsafe.Add(unsafe.Pointer(v28), 1)))
							if uint32(v30) != *memmap.PtrUint32(0x973F18, 35948) {
								v31 = *memmap.PtrUint8(0x587000, uint32(v39*4)+255052)
						...
						if v29 != nil {
							v33 = *memmap.PtrUint8(0x587000, uint32(v39*4)+255052)
...
func nox_xxx_mapGenMoveObject_527A10(a1 *float32, a2 *float2) *float32 {
	...
	*(*float32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(float32(0))*15)) = v3
	v5 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a1))), 4*4))) | 0x1000000)
	*(*float32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(float32(0))*14)) = v4
	*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a1))), 4*4))) = uint32(v5)
	v6 = nox_xxx_getUnitName_4E39D0((*nox_object_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1)))))))
	if funAddr(asFunc(nox_objectTypeGetXfer(v6), (*func(a1 int32) int32)(nil)).(func(a1 int32) int32)) == funAddr(nox_xxx_XFerDoor_4F4CB0) {
...
func nox_xxx_mapGenOrientObj_527C60(a1 int32, a2 int32) int32 {
	...
	if (*(*uint32)(unsafe.Pointer(uintptr(a1 + 8))) & 0x80) == 0 {
		return 0
	}
...
func nox_xxx_mapGenFinishSpellbook_527DB0(a1 int32, a2 int8) int32 {
	...
	if funAddr(asFunc(nox_objectTypeGetXfer(v3), (*func(a1 *int32) int32)(nil)).(func(a1 *int32) int32)) != funAddr(nox_xxx_XFerSpellReward_4F5F30) {
		return 0
	}
	**(**uint8)(unsafe.Pointer(uintptr(a1 + 736))) = uint8(a2)
	return 1
}
func sub_527E00(a1 *nox_object_t) *int32 {
	var (
		v1     int32
		result *int32
		v3     int32
	...
	v1 = 32
	result = (*int32)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1))) + 560)))
	for {
		v3 = *result
...
func nox_xxx_netUpdateObjectSpecial_527E50(a1p *nox_object_t, a2p *nox_object_t) int32 {
	var (
	...
	if a2 != nil && v2 < 0x20 {
		...
		if (*(*uint32)(unsafe.Add(unsafe.Pointer(a2), 4*uintptr(v2+140))) & 0x400000) == 0x400000 {
			nox_xxx_netReportUnitHeight_4D9020(int32(v2), (*nox_object_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a2)))))))
...
func sub_528030(a1 int32) int16 {
	...
	if int32(*(*uint16)(unsafe.Pointer(uintptr(v2 + 10)))) == int32(*v3) {
		v5 = int32(gameFrame())
		v7 = gameFPS()
	} else if cmath.Abs(int64(int32(*v3)-int32(*(*uint16)(unsafe.Pointer(uintptr(v2 + 10)))))) >= int64(int32(*(*uint16)(unsafe.Add(unsafe.Pointer(v3), unsafe.Sizeof(uint16(0))*2)))/10) || (func() bool {
		v5 = int32(gameFrame())
		...
		*(*uint32)(unsafe.Pointer(uintptr(v8 + 2176))) = gameFrame()
		v5 = int32(gameFrame())
		v7 = gameFPS()
	}
	...
	if int32(*(*uint16)(unsafe.Pointer(uintptr(v2 + 6)))) != int32(result) {
		...
		if cmath.Abs(int64(int32(*(*uint16)(unsafe.Pointer(uintptr(v2 + 4))))-int32(*(*uint16)(unsafe.Pointer(uintptr(v2 + 6)))))) >= int64(int32(*(*uint16)(unsafe.Pointer(uintptr(v2 + 8))))/10) || uint32(v5)-*(*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v2 + 276))) + 2180))) > v7>>2 {
			...
			*(*uint32)(unsafe.Pointer(uintptr(v10 + 2180))) = gameFrame()
		}
	}
	return result
}
func nox_xxx_checkIsKillable_528190(a1p *nox_object_t) int32 {
	var (
		a1 int32 = int32(uintptr(unsafe.Pointer(a1p)))
		v1 *uint16
		v2 bool
...
func nox_xxx_unitUpdateSightMB_5281F0(a1p *nox_object_t) {
	var (
		a1  uint32 = uint32(uintptr(unsafe.Pointer(a1p)))
		v1  uint32
		v2  int32
		v3  int32
		v4  float64
	...
	if (v2&0x8000) != 0 && nox_xxx_unitIsZombie_534A40(int32(a1)) == 0 {
		return
	}
	...
	if gameFrame()-*(*uint32)(unsafe.Pointer(uintptr(v3 + 1212))) <= (gameFPS() * 2) {
		v19 = 0
	} else {
		v19 = 1
		*(*uint32)(unsafe.Pointer(uintptr(v3 + 1212))) = gameFrame()
	}
	v5 = 0
	if int32(*(*uint8)(unsafe.Pointer(uintptr(v3 + 1129)))) != 0 {
		v6 = (*int32)(unsafe.Pointer(uintptr(v3 + 1132)))
		for {
			if *(*uint32)(unsafe.Pointer(uintptr(*v6 + 16)))&0x8020 != 0 || nox_xxx_unitCanSee_536FB0((*nox_object_t)(unsafe.Pointer(uintptr(v1))), (*nox_object_t)(unsafe.Pointer(uintptr(*v6))), 0) == 0 || (func() bool {
				v7 = float64(*(*float32)(unsafe.Pointer(uintptr(v1 + 56))) - *(*float32)(unsafe.Pointer(uintptr(*v6 + 56))))
				v8 = float64(*(*float32)(unsafe.Pointer(uintptr(v1 + 60))) - *(*float32)(unsafe.Pointer(uintptr(*v6 + 60))))
				v20 = float32((float64(v21) + 30.0) * (float64(v21) + 30.0))
				return v8*v8+v7*v7 > float64(v20)
			}()) || (func() bool {
				v9 = float64(*(*float32)(unsafe.Pointer(uintptr(v1 + 56))) - *(*float32)(unsafe.Pointer(uintptr(v1 + 72))))
				v10 = float64(*(*float32)(unsafe.Pointer(uintptr(v1 + 60))) - *(*float32)(unsafe.Pointer(uintptr(v1 + 76))))
				return v10*v10+v9*v9 > 1000.0
			}()) || v19 != 0 && nox_xxx_unitCanInteractWith_5370E0((*nox_object_t)(unsafe.Pointer(uintptr(v1))), (*nox_object_t)(unsafe.Pointer(uintptr(*v6))), 0) == 0 {
				nox_xxx_aiLostSight_528560(int32(v1), func() int32 {
					p := &v5
					x := *p
					*p--
					return x
	...
	if (*(*uint32)(unsafe.Pointer(uintptr(v3 + 1196))) == 0 || gameFrame()-*(*uint32)(unsafe.Pointer(uintptr(v3 + 1204))) > (gameFPS()*2)) && (*(*uint32)(unsafe.Pointer(uintptr(v3 + 1208))) <= gameFrame() || gameFrame() == *memmap.PtrUint32(0x5D4594, 2487684)) {
		nox_xxx_unitsGetInCircle_517F90((*float2)(unsafe.Pointer(uintptr(v1+56))), v21, unsafe.Pointer(funAddr(nox_xxx_monsterUpdateSeenEnemies_5286D0)), unsafe.Pointer(uintptr(v1)))
		*(*uint32)(unsafe.Pointer(uintptr(v3 + 1204))) = gameFrame()
		*(*uint32)(unsafe.Pointer(uintptr(v3 + 1212))) = gameFrame()
		v17 = 1
	}
	if v17 != 0 {
	...
	if *(*uint32)(unsafe.Pointer(uintptr(v3 + 1204))) == gameFrame() {
		v15 = int32(*(*uint32)(unsafe.Pointer(uintptr(v3 + 1440))))
		if v15&0x400 != 0 || nox_common_gameFlags_check_40A5C0(0x2000) || *(*uint32)(unsafe.Pointer(uintptr(v3 + 1196))) != 0 {
			*(*uint32)(unsafe.Pointer(uintptr(v3 + 1208))) = gameFrame() + uint32(nox_common_randomInt_415FA0(5, 10))
		} else {
			v16 = int32(gameFPS() * 5)
			v18 = float32(sub_5336D0((*nox_object_t)(unsafe.Pointer(uintptr(v1)))))
			*(*float32)(unsafe.Pointer(uintptr(v3 + 524))) = v18
			if float64(v18) < 0.0 {
				*(*uint32)(unsafe.Pointer(uintptr(v3 + 1208))) = uint32(v16) + gameFrame()
			} else if float64(v18) > float64(v21) {
				*(*uint32)(unsafe.Pointer(uintptr(v3 + 1208))) = uint32(uint64(int64(float64(v18-v21)*float64(v16)/(1000.0-float64(v21)))) + 10 + uint64(gameFrame()))
			} else {
				*(*uint32)(unsafe.Pointer(uintptr(v3 + 1208))) = uint32(nox_common_randomInt_415FA0(5, 10)) + gameFrame()
			}
		}
	}
}
func nox_xxx_aiLostSight_528560(a1 int32, a2 int32) int32 {
	...
	v5 = int32(uintptr(unsafe.Pointer(nox_xxx_getUnitName_4E39D0((*nox_object_t)(unsafe.Pointer(uintptr(v3)))))))
	nox_ai_debug_printf_5341A0(internCStr("%d: Lost sight of %s(#%d)\n"), gameFrame(), v5, v10)
	nox_xxx_scriptCallByEventBlock_502490(unsafe.Pointer(uintptr(v2+1296)), unsafe.Pointer(uintptr(*v4)), unsafe.Pointer(uintptr(a1)), 15)
	...
	v8 = a2
	*((*uint8)(unsafe.Pointer(&result))) = uint8(int8(int32(*(*uint8)(unsafe.Pointer(uintptr(v2 + 1129)))) - 1))
...
func sub_528610(a1 int32) {
	...
	*(*uint32)(unsafe.Pointer(uintptr(v2 + 1196))) = 0
	if int32(v4) != 0 {
		for i = (*int32)(unsafe.Pointer(uintptr(v2 + 1132))); uint32(*i) != *(*uint32)(unsafe.Pointer(uintptr(v2 + 1216))); i = (*int32)(unsafe.Add(unsafe.Pointer(i), 4*1)) {
			if nox_xxx_unitIsEnemyTo_5330C0((*nox_object_t)(unsafe.Pointer(uintptr(v1))), (*nox_object_t)(unsafe.Pointer(uintptr(*i)))) != 0 && nox_xxx_checkIsKillable_528190((*nox_object_t)(unsafe.Pointer(uintptr(*i)))) != 0 {
	...
	if a2 != a1 {
		if int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 8))))&6 != 0 {
			if (*(*uint32)(unsafe.Pointer(uintptr(a1 + 16))) & 0x8020) == 0 {
				...
				if (v4&0x400 != 0 || nox_xxx_unitIsEnemyTo_5330C0((*nox_object_t)(unsafe.Pointer(uintptr(a2))), (*nox_object_t)(unsafe.Pointer(uintptr(a1)))) != 0) && sub_528950(a2, a1) == 0 {
					...
					if v5&0x100 != 0 || (func() bool {
						...
						v9 = float32(v7)
						v8 = mem_getFloatPtr(0x587000, uint32(int32(*(*int16)(unsafe.Pointer(uintptr(a2 + 124))))*8)+194136)
	...
	if gameFrame() > v15 {
		if nox_xxx_unitIsEnemyTo_5330C0((*nox_object_t)(unsafe.Pointer(uintptr(v2))), (*nox_object_t)(unsafe.Pointer(uintptr(v11)))) != 0 {
			if nox_xxx_unitIsZombie_534A40(v2) == 0 || (func() bool {
				...
				v17 = int32(uintptr(nox_xxx_monsterGetSoundSet_424300((*nox_object_t)(unsafe.Pointer(uintptr(v2))))))
				if v17 != 0 {
					nox_xxx_aud_501960(int32(*(*uint32)(unsafe.Pointer(uintptr(v17 + 68)))), (*nox_object_t)(unsafe.Pointer(uintptr(v2))), 0, 0)
				}
				*(*uint32)(unsafe.Pointer(uintptr(v4 + 536))) = gameFrame() + uint32(nox_common_randomInt_415FA0(int32(gameFPS()*2), int32(gameFPS()*4)))
			}
		}
	}
	nox_xxx_scriptCallByEventBlock_502490(unsafe.Pointer(uintptr(v4+1232)), unsafe.Pointer(uintptr(v11)), unsafe.Pointer(uintptr(v2)), 14)
}
func sub_528910(a1 int32, a2 int32) int32 {
	...
	if v4 > 0 {
		for i = (*uint32)(unsafe.Pointer(uintptr(v3 + 1132))); *i != uint32(a2); i = (*uint32)(unsafe.Add(unsafe.Pointer(i), 4*1)) {
			if func() int32 {
				p := &result
				*p++
				return *p
...
func sub_528950(a1 int32, a2 int32) int32 {
	...
	for i = (*uint32)(unsafe.Pointer(uintptr(v2 + 1132))); *i != uint32(a2); i = (*uint32)(unsafe.Add(unsafe.Pointer(i), 4*1)) {
		if func() int32 {
			p := &v3
			*p++
			return *p
...
func sub_528990(a1 *nox_object_t) int32 {
	var (
		result int32
		i      int32
	)
	...
	for i = result; result != 0; i = result {
		if int32(*(*uint8)(unsafe.Pointer(uintptr(i + 8))))&2 != 0 {
			if (int32(*(*uint8)(unsafe.Pointer(uintptr(i + 16)))) & 0x20) == 0 {
...
func nox_xxx_netReportDestroyObject_5289D0(a1p *nox_object_t) {
	var (
		a1     int32 = int32(uintptr(unsafe.Pointer(a1p)))
		result *byte
		i      int32
	...
	for i = int32(uintptr(unsafe.Pointer(result))); result != nil; i = int32(uintptr(unsafe.Pointer(result))) {
		if uint32(1<<int32(*(*uint8)(unsafe.Pointer(uintptr(i + 2064)))))&*(*uint32)(unsafe.Pointer(uintptr(a1 + 148))) != 0 {
			*((*uint8)(unsafe.Pointer(&v4))) = uint8(int8((int32(uint8(*(*uint32)(unsafe.Pointer(uintptr(a1 + 20))))) >> 6) | 0x31))
...
func nox_xxx_XFerMonster_528DB0(a1 int32) int32 {
	...
	v45 = 64
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v45)), 2, internCStr(__FILE__), __LINE__)
	...
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v52[0])), 8, internCStr(__FILE__), __LINE__)
	if int32(int16(v45)) >= 3 {
		...
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1220))), 2, internCStr(__FILE__), __LINE__)
		if v3 != nil {
	...
	if nox_crypt_IsReadOnly() != 1 || (func() bool {
		...
		*(*uint16)(unsafe.Pointer(uintptr(a1 + 124))) = uint16(v15)
		...
		if v14 == 0 {
			v46 = 0
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v46)), 4, internCStr(__FILE__), __LINE__)
		}
	...
	if int32(int16(v45)) >= 31 {
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1332))), 1, internCStr(__FILE__), __LINE__)
		if int32(int16(v45)) < 51 {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v46)), 2, internCStr(__FILE__), __LINE__)
			*(*uint32)(unsafe.Pointer(uintptr(v1 + 1440))) = uint32(uint16(int16(v46)))
		} else {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1440))), 4, internCStr(__FILE__), __LINE__)
		}
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1352))), 4, internCStr(__FILE__), __LINE__)
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1336))), 4, internCStr(__FILE__), __LINE__)
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1344))), 4, internCStr(__FILE__), __LINE__)
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1312))), 4, internCStr(__FILE__), __LINE__)
		if int32(int16(v45)) < 33 {
			nox_xxx_cryptSeekCur_40E0A0(2)
		}
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1304))), 4, internCStr(__FILE__), __LINE__)
		*(*uint32)(unsafe.Pointer(uintptr(v1 + 1308))) = *(*uint32)(unsafe.Pointer(uintptr(v1 + 1304)))
		if int32(int16(v45)) < 34 {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1360))), 4, internCStr(__FILE__), __LINE__)
		}
		*((*uint8)(unsafe.Pointer(&v48))) = uint8(int8(libc.StrLen((*byte)(unsafe.Pointer(uintptr(v1 + 1364))))))
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v48)), 1, internCStr(__FILE__), __LINE__)
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1364))), uint32(uint8(int8(v48))), internCStr(__FILE__), __LINE__)
		*(*uint8)(unsafe.Pointer(uintptr(int32(uint8(int8(v48))) + v1 + 1364))) = 0
		if int32(int16(v45)) >= 34 {
			if nox_crypt_IsReadOnly() != 0 {
				libc.MemSet(unsafe.Pointer(uintptr(v1+1488)), 0, 0x224)
				nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v44)), 4, internCStr(__FILE__), __LINE__)
				for i = 0; i < v44; i++ {
					nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v48)), 1, internCStr(__FILE__), __LINE__)
					nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v53[0])), uint32(uint8(int8(v48))), internCStr(__FILE__), __LINE__)
					v53[uint8(int8(v48))] = 0
					v23 = nox_xxx_spellNameToN_4243F0(&v53[0])
					nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+v23*4+1488))), 4, internCStr(__FILE__), __LINE__)
				}
			} else {
				v16 = 0
				...
				for {
					if *v17 != 0 {
						...
						*((*uint8)(unsafe.Pointer(&v46))) = uint8(int8(libc.StrLen(v21)))
						nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v46)), 1, internCStr(__FILE__), __LINE__)
						nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(v21)), uint32(uint8(int8(v46))), internCStr(__FILE__), __LINE__)
						nox_xxx_fileReadWrite_426AC0_file3_fread_impl(v47, 4, internCStr(__FILE__), __LINE__)
					}
					v20++
			...
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1488))), 0x224, internCStr(__FILE__), __LINE__)
		}
		if int32(int16(v45)) < 46 {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v44)), 1, internCStr(__FILE__), __LINE__)
			*(*uint16)(unsafe.Pointer(uintptr(v1 + 1448))) = uint16(uint8(int8(v44)))
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v44)), 1, internCStr(__FILE__), __LINE__)
			*(*uint16)(unsafe.Pointer(uintptr(v1 + 1450))) = uint16(uint8(int8(v44)))
		} else {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1448))), 2, internCStr(__FILE__), __LINE__)
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1450))), 2, internCStr(__FILE__), __LINE__)
		}
		if int32(int16(v45)) <= 32 {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v49)), 4, internCStr(__FILE__), __LINE__)
		}
		if int32(int16(v45)) < 46 {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v44)), 1, internCStr(__FILE__), __LINE__)
			...
			*(*uint16)(unsafe.Pointer(uintptr(v1 + 1458))) = uint16(uint8(int8(v44)))
			...
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1456))), 2, internCStr(__FILE__), __LINE__)
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1458))), 2, internCStr(__FILE__), __LINE__)
		}
		if int32(int16(v45)) <= 32 {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v49)), 4, internCStr(__FILE__), __LINE__)
		}
		if int32(int16(v45)) < 46 {
			...
			*(*uint16)(unsafe.Pointer(uintptr(v1 + 1466))) = uint16(uint8(int8(v44)))
			...
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1464))), 2, internCStr(__FILE__), __LINE__)
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1466))), 2, internCStr(__FILE__), __LINE__)
		}
		if int32(int16(v45)) <= 32 {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v49)), 4, internCStr(__FILE__), __LINE__)
		}
		if int32(int16(v45)) < 46 {
			...
			*(*uint16)(unsafe.Pointer(uintptr(v1 + 1474))) = uint16(uint8(int8(v44)))
			...
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1472))), 2, internCStr(__FILE__), __LINE__)
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1474))), 2, internCStr(__FILE__), __LINE__)
		}
		if int32(int16(v45)) <= 32 {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v49)), 4, internCStr(__FILE__), __LINE__)
		}
		if int32(int16(v45)) < 46 {
			...
			*(*uint16)(unsafe.Pointer(uintptr(v1 + 1482))) = uint16(uint8(int8(v44)))
			...
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1480))), 2, internCStr(__FILE__), __LINE__)
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1482))), 2, internCStr(__FILE__), __LINE__)
		}
		if int32(int16(v45)) > 32 || (func() bool {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v49)), 4, internCStr(__FILE__), __LINE__)
			return int32(int16(v45)) >= 32
		}()) {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1316))), 4, internCStr(__FILE__), __LINE__)
		}
		if int32(int16(v45)) >= 33 {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+2040))), 4, internCStr(__FILE__), __LINE__)
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1320))), 4, internCStr(__FILE__), __LINE__)
			if int32(int16(v45)) < 42 {
				nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v44)), 2, internCStr(__FILE__), __LINE__)
				if int32(uint16(int16(v44))) == 0 {
					*(*uint8)(unsafe.Pointer(uintptr(v1 + 1445))) = 1
				}
			}
			if int32(int16(v45)) < 53 {
				nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+2044))), 4, internCStr(__FILE__), __LINE__)
				nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+2048))), 4, internCStr(__FILE__), __LINE__)
				nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+2052))), 4, internCStr(__FILE__), __LINE__)
			} else {
				...
				for {
					if nox_crypt_IsReadOnly() == 1 {
						nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v44)), 1, internCStr(__FILE__), __LINE__)
						nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v53[0])), uint32(uint8(int8(v44))), internCStr(__FILE__), __LINE__)
						...
						*((*uint8)(unsafe.Pointer(&v44))) = uint8(int8(libc.StrLen(v25)))
						nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v44)), 1, internCStr(__FILE__), __LINE__)
						nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(v25)), uint32(uint8(int8(v44))), internCStr(__FILE__), __LINE__)
					}
		...
		if int32(int16(v45)) >= 34 {
			if nox_crypt_IsReadOnly() != 0 {
				...
				*((*uint8)(unsafe.Pointer(&v44))) = uint8(int8(libc.StrLen(v26)))
				nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v44)), 1, internCStr(__FILE__), __LINE__)
				nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(v26)), uint32(uint8(int8(v44))), internCStr(__FILE__), __LINE__)
			}
		}
	}
	...
	if int32(int16(v45)) >= 42 {
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1445))), 1, internCStr(__FILE__), __LINE__)
	}
	if int32(int16(v45)) >= 43 && int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 12))))&8 != 0 {
		*((*uint8)(unsafe.Pointer(&v44))) = 0
		...
		if int32(int16(v45)) >= 50 {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v27+1716))), 4, internCStr(__FILE__), __LINE__)
		}
		if int32(int16(v45)) >= 61 {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v27+1720))), 4, internCStr(__FILE__), __LINE__)
		}
		if int32(int16(v45)) >= 48 {
			*((*uint8)(unsafe.Pointer(&v47))) = uint8(int8(libc.StrLen((*byte)(unsafe.Pointer(uintptr(v27 + 1684))))))
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v47)), 1, internCStr(__FILE__), __LINE__)
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v27+1684))), uint32(uint8(uintptr(unsafe.Pointer(v47)))), internCStr(__FILE__), __LINE__)
		...
		if nox_crypt_IsReadOnly() == 1 {
			...
			*(*uint8)(unsafe.Pointer(uintptr(v27))) = uint8(int8(v44))
			...
			if v27 != 0 {
				*((*uint8)(unsafe.Pointer(&v44))) = *(*uint8)(unsafe.Pointer(uintptr(v27)))
			}
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v44)), 1, internCStr(__FILE__), __LINE__)
		}
		if v27 != 0 {
			*((*uint8)(unsafe.Pointer(&v44))) = 0
			if int32(*(*uint8)(unsafe.Pointer(uintptr(v27)))) != 0 {
				for {
					if nox_crypt_IsReadOnly() == 1 {
						nox_xxx_XFer_ReadShopItem_52A840(unsafe.Pointer(uintptr(v27+int32(uint8(int8(v44)))*28+4)), int32(int16(v45)))
					} else {
						nox_xxx_XFer_WriteShopItem_52A5F0(unsafe.Pointer(uintptr(v27 + int32(uint8(int8(v44)))*28 + 4)))
					}
...
LABEL_137:
	if int32(int16(v45)) >= 44 {
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1))), 4, internCStr(__FILE__), __LINE__)
	}
	if int32(int16(v45)) >= 45 {
		v50 = int32(*(*uint32)(unsafe.Pointer(uintptr(a1 + 12))) & 0x180)
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v50)), 4, internCStr(__FILE__), __LINE__)
		*(*uint32)(unsafe.Pointer(uintptr(a1 + 12))) |= uint32(v50)
	}
	if int32(int16(v45)) >= 49 {
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl(*(**uint8)(unsafe.Pointer(uintptr(a1 + 556))), 2, internCStr(__FILE__), __LINE__)
	}
	if int32(int16(v45)) >= 51 {
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1348))), 1, internCStr(__FILE__), __LINE__)
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1340))), 1, internCStr(__FILE__), __LINE__)
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1444))), 1, internCStr(__FILE__), __LINE__)
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+2036))), 1, internCStr(__FILE__), __LINE__)
	}
	if int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 12))))&0x20 != 0 && int32(int16(v45)) >= 54 {
		v28 = 0
		v29 = (*uint8)(unsafe.Pointer(uintptr(v1 + 2076)))
		*((*uint8)(unsafe.Pointer(&v46))) = 0
		for {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl(v29, 3, internCStr(__FILE__), __LINE__)
			if nox_crypt_IsReadOnly() == 1 {
				nox_xxx_setNPCColor_4E4A90((*nox_object_t)(unsafe.Pointer(uintptr(a1))), uint8(int8(v46)), unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v29))))))
			}
			v28++
	...
	if int32(int16(v45)) >= 55 && int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 12))))&0x20 != 0 {
	...
	if int32(int16(v45)) >= 64 {
		*((*uint8)(unsafe.Pointer(&v47))) = *(*uint8)(unsafe.Pointer(uintptr(a1 + 540)))
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v47)), 1, internCStr(__FILE__), __LINE__)
		if nox_crypt_IsReadOnly() != 1 {
			goto LABEL_171
		}
...
LABEL_171:
	...
	if nox_crypt_IsReadOnly() == 1 {
		if nox_common_gameFlags_check_40A5C0(0x200000) || nox_xxx_gameIsSwitchToSolo_4DB240() == 0 {
		...
		if nox_crypt_IsReadOnly() == 1 {
			if int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 8))))&2 != 0 {
				...
				if v31&0x2000 != 0 {
					v32 = 0
					v33 = 0
					for j = nox_xxx_inventoryGetFirst_4E7980(a1); j != 0; j = nox_xxx_inventoryGetNext_4E7990(j) {
						if uint32(*(*uint16)(unsafe.Pointer(uintptr(j + 4)))) == *memmap.PtrUint32(0x5D4594, 2487692) {
							v32 = 1
						}
					}
					v35 = v1 + 2044
					...
					if v32 == 0 && v33 != 0 {
						...
						if v38 != nil {
							...
							if v33 > 0 {
								...
								v41 = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v38), 4*173)))))
								v42 = v33
								for {
									v43 = *v40
						...
						nox_xxx_inventoryPutImpl_4F3070((*nox_object_t)(unsafe.Pointer(uintptr(a1))), (*nox_object_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v38)))))), 1)
					}
				}
			}
		}
...
func nox_xxx_monsterOnSpawnSpellcaster_529BC0(a1 int32) {
	...
	if a1 != 0 {
		v1 = int32(*(*uint32)(unsafe.Pointer(uintptr(a1 + 748))))
		v2 = (*uint32)(nox_xxx_monsterDefByTT_517560(int32(*(*uint16)(unsafe.Pointer(uintptr(a1 + 4))))))
		if v2 != nil {
			if int32(*(*uint8)(unsafe.Pointer(uintptr(v1 + 1445)))) == 0 {
			...
			if int32(*(*uint8)(unsafe.Pointer(uintptr(v1 + 1444)))) == 1 {
				*(*uint32)(unsafe.Pointer(uintptr(v1 + 1440))) = *(*uint32)(unsafe.Add(unsafe.Pointer(v2), 4*23))
			} else {
				for i = 0; i < 22; i++ {
					v4 = 1 << i
			...
			if (v7 & 0x20) == 0 {
				*(*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(&v7))), 1)) &= 0xE7
				*(*uint32)(unsafe.Pointer(uintptr(v1 + 1440))) = uint32(v7)
			}
			if int32(*(*uint8)(unsafe.Pointer(uintptr(v1 + 1340)))) == 1 {
				*(*uint32)(unsafe.Pointer(uintptr(v1 + 1336))) = *(*uint32)(unsafe.Add(unsafe.Pointer(v2), 4*20))
			}
			if int32(*(*uint8)(unsafe.Pointer(uintptr(v1 + 1348)))) == 1 {
				*(*uint32)(unsafe.Pointer(uintptr(v1 + 1344))) = *(*uint32)(unsafe.Add(unsafe.Pointer(v2), 4*21))
			}
			if int32(*(*uint8)(unsafe.Pointer(uintptr(v1 + 2036)))) == 1 {
				nox_xxx_monsterAutoSpells_54C0C0((*nox_object_t)(unsafe.Pointer(uintptr(a1))))
			}
		}
	}
}
func nox_xxx_XFer_ActionData_529CE0(a1 int32) int32 {
	...
	v1 = int32(*(*uint32)(unsafe.Pointer(uintptr(a1 + 748))))
	v21 = 4
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v21)), 2, internCStr(__FILE__), __LINE__)
...
LABEL_67:
	...
	v18 = 0
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v18)), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+8))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+12))), *(*uint32)(unsafe.Pointer(uintptr(v1 + 8)))*8, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+268))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+272))), 8, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+280))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+284))), 1, internCStr(__FILE__), __LINE__)
	if nox_crypt_IsReadOnly() == 1 {
		nox_xxx_AssignIfGreater_52A420((*int32)(unsafe.Pointer(uintptr(v1+280))), v3)
	}
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+296))), 4, internCStr(__FILE__), __LINE__)
	...
	if !v4 {
		...
		for {
			if nox_crypt_IsReadOnly() != 0 {
				nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v22)), 4, internCStr(__FILE__), __LINE__)
				*v5 = (*uint8)(unsafe.Pointer(sub_579C80(v22)))
			} else {
				nox_xxx_fileReadWrite_426AC0_file3_fread_impl(*v5, 4, internCStr(__FILE__), __LINE__)
			}
	...
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+364))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+368))), 8, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+376))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+380))), 8, internCStr(__FILE__), __LINE__)
	...
	*((*uint8)(unsafe.Pointer(&v20))) = uint8(int8(libc.StrLen(&v24[0])))
	...
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v24[0])), uint32(uint8(int8(v20))), internCStr(__FILE__), __LINE__)
	v24[uint8(int8(v20))] = 0
	*(*uint32)(unsafe.Pointer(uintptr(v1 + 388))) = uint32(nox_xxx_utilFindSound_40AF50(&v24[0]))
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+396))), 8, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+404))), 4, internCStr(__FILE__), __LINE__)
	if nox_crypt_IsReadOnly() == 1 {
		nox_xxx_AssignIfGreater_52A420((*int32)(unsafe.Pointer(uintptr(v1+404))), v3)
	}
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+481))), 1, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+482))), 1, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+483))), 1, internCStr(__FILE__), __LINE__)
	if int32(int16(v21)) < 3 {
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v18)), 4, internCStr(__FILE__), __LINE__)
	}
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+496))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+500))), 8, internCStr(__FILE__), __LINE__)
	if nox_crypt_IsReadOnly() == 1 {
		nox_xxx_AssignIfGreater_52A420((*int32)(unsafe.Pointer(uintptr(v1+496))), v3)
	}
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v18)), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+536))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+540))), 4, internCStr(__FILE__), __LINE__)
	...
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+544))), 1, internCStr(__FILE__), __LINE__)
	v6 = 0
	...
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1129))), 1, internCStr(__FILE__), __LINE__)
	...
	if !v7 {
		...
		for {
			if nox_crypt_IsReadOnly() != 0 {
				nox_xxx_fileReadWrite_426AC0_file3_fread_impl(v8, 4, internCStr(__FILE__), __LINE__)
			} else {
				...
				nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(v8))+44))), 4, internCStr(__FILE__), __LINE__)
			}
	...
	if nox_crypt_IsReadOnly() != 0 {
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1196))), 4, internCStr(__FILE__), __LINE__)
	} else {
	...
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1204))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_AssignIfGreater_52A420((*int32)(unsafe.Pointer(uintptr(v1+1204))), v3)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+2096))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+2100))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+2104))), 1, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+2105))), 1, internCStr(__FILE__), __LINE__)
	*((*uint8)(unsafe.Pointer(&v20))) = uint8(int8(libc.StrLen((*byte)(unsafe.Pointer(uintptr(v1 + 2106))))))
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v20)), 1, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+2106))), uint32(uint8(int8(v20))), internCStr(__FILE__), __LINE__)
	*(*uint8)(unsafe.Pointer(uintptr(int32(uint8(int8(v20))) + v1 + 2106))) = 0
	if int32(int16(v21)) < 4 {
		return 1
	}
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+4))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+288))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+292))), 4, internCStr(__FILE__), __LINE__)
	v11 = int32(uintptr(unsafe.Pointer(nox_server_getObjectFromNetCode_4ECCB0(int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 392))))))))
	if v11 != 0 {
	...
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+492))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+508))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_AssignIfGreater_52A420((*int32)(unsafe.Pointer(uintptr(v1+508))), v3)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+512))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_AssignIfGreater_52A420((*int32)(unsafe.Pointer(uintptr(v1+512))), v3)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+516))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_AssignIfGreater_52A420((*int32)(unsafe.Pointer(uintptr(v1+516))), v3)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+520))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_AssignIfGreater_52A420((*int32)(unsafe.Pointer(uintptr(v1+520))), v3)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+528))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_AssignIfGreater_52A420((*int32)(unsafe.Pointer(uintptr(v1+528))), v3)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+532))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_AssignIfGreater_52A420((*int32)(unsafe.Pointer(uintptr(v1+532))), v3)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+524))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+548))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_AssignIfGreater_52A420((*int32)(unsafe.Pointer(uintptr(v1+548))), v3)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1128))), 1, internCStr(__FILE__), __LINE__)
	v12 = int32(uintptr(unsafe.Pointer(nox_server_getObjectFromNetCode_4ECCB0(int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 1200))))))))
	if v12 != 0 {
	...
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1208))), 4, internCStr(__FILE__), __LINE__)
	nox_xxx_AssignIfGreater_52A420((*int32)(unsafe.Pointer(uintptr(v1+1208))), v3)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1212))), 4, internCStr(__FILE__), __LINE__)
	...
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+2172))), 1, internCStr(__FILE__), __LINE__)
...
func sub_52A440(a1 int32, a2 int32, a3 int32) int32 {
	...
	*((*uint8)(unsafe.Pointer(&v10))) = uint8(int8(libc.StrLen(&v11[0])))
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v10)), 1, internCStr(__FILE__), __LINE__)
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v11[0])), uint32(uint8(int8(v10))), internCStr(__FILE__), __LINE__)
	v11[uint8(int8(v10))] = 0
	v3 = nox_xxx_actionByName_534670(&v11[0])
	*(*uint32)(unsafe.Pointer(uintptr(a2))) = uint32(v3)
	*((*uint8)(unsafe.Pointer(&v8))) = *memmap.PtrUint8(0x587000, uint32(v3*16)+255604)
	...
	if int32(uint8(int8(v8))) > 0 {
		...
		for {
			...
			case 0:
				v7 = 8
				nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(v5)), v7, internCStr(__FILE__), __LINE__)
			case 1:
				if nox_crypt_IsReadOnly() != 0 {
					v7 = 4
					nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(v5)), v7, internCStr(__FILE__), __LINE__)
				...
				if *v5 != 0 {
					nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(*v5+44))), 4, internCStr(__FILE__), __LINE__)
				} else {
					v9 = 0
					nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v9)), 4, internCStr(__FILE__), __LINE__)
				}
			case 2:
				if nox_crypt_IsReadOnly() != 0 {
					v7 = 4
				...
				if *v5 != 0 {
					nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(*v5))), 4, internCStr(__FILE__), __LINE__)
				} else {
					v9 = 0
					nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v9)), 4, internCStr(__FILE__), __LINE__)
				}
			...
			if v4 >= int32(uint8(int8(v8))) {
				return int32(nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(a2+20))), 4, internCStr(__FILE__), __LINE__))
			}
		}
	}
	return int32(nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(a2+20))), 4, internCStr(__FILE__), __LINE__))
...
func nox_xxx_XFer_ReadMonsterBuffs_52AAB0(a1 *uint32) int32 {
	...
	v13 = 2
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v13)), 2, internCStr(__FILE__), __LINE__)
	...
	*((*uint8)(unsafe.Pointer(&v16))) = uint8(sub_424CB0(int32(uintptr(unsafe.Pointer(a1)))))
	...
	if nox_crypt_IsReadOnly() != 0 {
		...
		for {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v11)), 1, internCStr(__FILE__), __LINE__)
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v20[0])), uint32(uint8(int8(v11))), internCStr(__FILE__), __LINE__)
			...
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v14)), 4, internCStr(__FILE__), __LINE__)
			...
			nox_xxx_spellAccept_4FD400(v8, (*nox_object_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1)))))), (*nox_object_t)(unsafe.Pointer(a1)), (*nox_object_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1)))))), unsafe.Pointer(&v17[0]), v10)
			*((*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(a1))), unsafe.Sizeof(uint16(0))*uintptr(v6)))), unsafe.Sizeof(uint16(0))*172))) = uint16(int16(v14))
			if v6 == 26 && int32(int16(v13)) >= 2 {
				nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v12)), 4, internCStr(__FILE__), __LINE__)
	...
	for {
		if nox_xxx_testUnitBuffs_4FF350((*nox_object_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1)))))), int8(v1)) != 0 {
			...
			*((*uint8)(unsafe.Pointer(&v11))) = uint8(int8(libc.StrLen(v2)))
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v11)), 1, internCStr(__FILE__), __LINE__)
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(v2)), uint32(uint8(int8(v11))), internCStr(__FILE__), __LINE__)
			*((*uint8)(unsafe.Pointer(&v15))) = uint8(nox_xxx_buffGetPower_4FF570((*nox_object_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1)))))), v1))
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v15)), 1, internCStr(__FILE__), __LINE__)
			v14 = nox_xxx_unitGetBuffTimer_4FF550((*nox_object_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1)))))), v1)
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v14)), 4, internCStr(__FILE__), __LINE__)
			if v1 == 26 {
...
func nox_xxx_readNPCVoiceSet_52AD10(a1 int32) uint32 {
	...
	if nox_crypt_IsReadOnly() != 0 {
		...
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v6[0])), uint32(uint8(int8(v5))), internCStr(__FILE__), __LINE__)
		v6[uint8(int8(v5))] = 0
		v4 = nox_xxx_getDefaultSoundSet_424350(&v6[0])
		result = uint32(nox_xxx_setNPCVoiceSet_424320(a1, int32(uintptr(unsafe.Pointer(v4)))))
	} else {
		v1 = (**byte)(nox_xxx_monsterGetSoundSet_424300((*nox_object_t)(unsafe.Pointer(uintptr(a1)))))
		v2 = v1
		if v1 != nil {
			*((*uint8)(unsafe.Pointer(&v5))) = uint8(int8(libc.StrLen(*v1)))
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v5)), 1, internCStr(__FILE__), __LINE__)
			result = nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(*v2)), uint32(uint8(int8(v5))), internCStr(__FILE__), __LINE__)
		} else {
			*((*uint8)(unsafe.Pointer(&v5))) = 0
			result = nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v5)), 1, internCStr(__FILE__), __LINE__)
		}
	}
	return result
}
func nox_xxx_XFerNPC_52ADE0(a1 int32) int32 {
	...
	if nox_crypt_IsReadOnly() == 1 {
		v4 = (*uint32)(nox_xxx_monsterDefByTT_517560(int32(*(*uint16)(unsafe.Pointer(uintptr(a1 + 4))))))
		*(*uint32)(unsafe.Pointer(uintptr(v1 + 484))) = uint32(uintptr(unsafe.Pointer(v4)))
		if v4 != nil {
			*(*uint32)(unsafe.Pointer(uintptr(v1 + 1440))) = *(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*23))
		}
	}
	...
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v55[0])), 8, internCStr(__FILE__), __LINE__)
	if v2 != nil {
	...
	if nox_crypt_IsReadOnly() != 1 || (func() bool {
		...
		*(*uint16)(unsafe.Pointer(uintptr(a1 + 124))) = uint16(v16)
		...
		if v15 == 0 {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v47)), 4, internCStr(__FILE__), __LINE__)
		}
	} else {
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v47)), 4, internCStr(__FILE__), __LINE__)
	}
	if nox_crypt_IsReadOnly() == 1 {
		...
		*((*uint8)(unsafe.Pointer(&v48))) = 0
		for {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v53[0])), 3, internCStr(__FILE__), __LINE__)
			nox_xxx_setNPCColor_4E4A90((*nox_object_t)(unsafe.Pointer(uintptr(a1))), uint8(int8(v48)), unsafe.Pointer(&v53[0]))
		...
		v19 = 6
		for {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl(v18, 3, internCStr(__FILE__), __LINE__)
	...
	if nox_crypt_IsReadOnly() == 1 && int32(uint16(int16(v44))) == 31 {
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v49)), 2, internCStr(__FILE__), __LINE__)
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl(&v46, 1, internCStr(__FILE__), __LINE__)
		for i = 0; int32(i) < int32(v46); i++ {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v50)), 1, internCStr(__FILE__), __LINE__)
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v56[0])), uint32(uint8(int8(v50))), internCStr(__FILE__), __LINE__)
			v56[uint8(int8(v50))] = 0
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v43)), 1, internCStr(__FILE__), __LINE__)
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v43)), 1, internCStr(__FILE__), __LINE__)
		}
	}
	if int32(int16(v44)) >= 32 {
		...
		if int32(int16(v44)) < 49 {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v47)), 2, internCStr(__FILE__), __LINE__)
		...
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v43)), 2, internCStr(__FILE__), __LINE__)
		...
		*((*uint8)(unsafe.Pointer(&v49))) = uint8(int8(libc.StrLen((*byte)(unsafe.Pointer(uintptr(v1 + 1364))))))
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v49)), 1, internCStr(__FILE__), __LINE__)
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1364))), uint32(uint8(int8(v49))), internCStr(__FILE__), __LINE__)
		*(*uint8)(unsafe.Pointer(uintptr(int32(uint8(int8(v49))) + v1 + 1364))) = 0
		if int32(int16(v44)) >= 34 {
			if nox_crypt_IsReadOnly() != 0 {
				libc.MemSet(unsafe.Pointer(uintptr(v1+1488)), 0, 0x224)
				nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v43)), 4, internCStr(__FILE__), __LINE__)
				for j = 0; int32(j) < v43; *((*uint8)(unsafe.Pointer(&v48))) = j {
					nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v49)), 1, internCStr(__FILE__), __LINE__)
					nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v56[0])), uint32(uint8(int8(v49))), internCStr(__FILE__), __LINE__)
					v56[uint8(int8(v49))] = 0
					v31 = nox_xxx_spellNameToN_4243F0(&v56[0])
					nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+v31*4+1488))), 4, internCStr(__FILE__), __LINE__)
					j++
				}
			} else {
				v24 = 0
				...
				for {
					if *(*uint32)(unsafe.Pointer(v25)) != 0 {
						...
						*((*uint8)(unsafe.Pointer(&v52))) = uint8(int8(libc.StrLen(v28)))
						nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v52)), 1, internCStr(__FILE__), __LINE__)
						nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(v28)), uint32(uint8(int8(v52))), internCStr(__FILE__), __LINE__)
						nox_xxx_fileReadWrite_426AC0_file3_fread_impl(v25, 4, internCStr(__FILE__), __LINE__)
					}
		...
		if int32(int16(v44)) < 34 {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v45)), 4, internCStr(__FILE__), __LINE__)
		}
		if int32(int16(v44)) < 47 {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v43)), 1, internCStr(__FILE__), __LINE__)
		...
		if int32(int16(v44)) >= 34 {
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+2040))), 4, internCStr(__FILE__), __LINE__)
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1324))), 1, internCStr(__FILE__), __LINE__)
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1328))), 4, internCStr(__FILE__), __LINE__)
			nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v1+1320))), 4, internCStr(__FILE__), __LINE__)
			...
			for {
				if nox_crypt_IsReadOnly() == 1 {
					nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v43)), 1, internCStr(__FILE__), __LINE__)
					nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v56[0])), uint32(uint8(int8(v43))), internCStr(__FILE__), __LINE__)
					...
					*((*uint8)(unsafe.Pointer(&v43))) = uint8(int8(libc.StrLen(v33)))
					nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v43)), 1, internCStr(__FILE__), __LINE__)
					nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(v33)), uint32(uint8(int8(v43))), internCStr(__FILE__), __LINE__)
				}
		...
		if int32(int16(v44)) >= 35 {
			if nox_crypt_IsReadOnly() != 0 {
				nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v43)), 1, internCStr(__FILE__), __LINE__)
				nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v57[0])), uint32(uint8(int8(v43))), internCStr(__FILE__), __LINE__)
				...
				*((*uint8)(unsafe.Pointer(&v43))) = uint8(int8(libc.StrLen(v34)))
				nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v43)), 1, internCStr(__FILE__), __LINE__)
				nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(v34)), uint32(uint8(int8(v43))), internCStr(__FILE__), __LINE__)
			}
		}
	}
	...
	if int32(int16(v44)) >= 46 {
		v51 = int32(*(*uint32)(unsafe.Pointer(uintptr(v35 + 12))) & 0x180)
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v51)), 4, internCStr(__FILE__), __LINE__)
		*(*uint32)(unsafe.Pointer(uintptr(v35 + 12))) |= uint32(v51)
	}
	if int32(int16(v44)) >= 48 {
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl(*(**uint8)(unsafe.Pointer(uintptr(v35 + 556))), 2, internCStr(__FILE__), __LINE__)
	}
	if int32(int16(v44)) >= 51 {
		nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(uintptr(v35+28))), 4, internCStr(__FILE__), __LINE__)
	}
	...
	*((*uint8)(unsafe.Pointer(&v45))) = *(*uint8)(unsafe.Pointer(uintptr(v35 + 540)))
	nox_xxx_fileReadWrite_426AC0_file3_fread_impl((*uint8)(unsafe.Pointer(&v45)), 1, internCStr(__FILE__), __LINE__)
	if nox_crypt_IsReadOnly() != 1 {
		goto LABEL_156
	}
...
LABEL_156:
	if *(*uint32)(unsafe.Pointer(uintptr(v35 + 136))) == 0 || nox_crypt_IsReadOnly() != 1 || (func() int32 {
		...
		if nox_crypt_IsReadOnly() == 1 {
			if nox_common_gameFlags_check_40A5C0(1) {
				for k = *(**uint32)(unsafe.Pointer(uintptr(v35 + 504))); k != nil; k = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(k), 4*124))))) {
		...
		for result = int32(*(*uint32)(unsafe.Pointer(uintptr(a1 + 504)))); result != 0; result = int32(*(*uint32)(unsafe.Pointer(uintptr(result + 496)))) {
			...
			if v4&0x100 != 0 {
				...
				if uint32(v5)&0x1001000 != 0 && *(*uint32)(unsafe.Pointer(uintptr(result + 12)))&0x7FFE40C != 0 {
					if v3 == 1 {
						*(*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(&v4))), 1)) &= 0xFE
...
func sub_52BAF0(a1 int32) int32 {
	...
	v7 = result
	if int32(*(*uint8)(unsafe.Pointer(uintptr(result + 544))))&0x80 != 0 {
		return result
	}
...
func nox_xxx_castCounterSpell_52BBB0(a1 int32, a2 int32, a3 int32, a4 int32) int32 {
	...
	nox_xxx_getMissilesInCircle_518170((*float2)(unsafe.Pointer(uintptr(a4+56))), v10, unsafe.Pointer(funAddr(nox_xxx_cspellRemoveSpell_52BC90)), nil)
	for i = int32(uintptr(nox_xxx_spellCastedFirst_4FE930())); i != 0; i = int32(uintptr(nox_xxx_spellCastedNext_4FE940(unsafe.Pointer(uintptr(i))))) {
		if nox_xxx_spellHasFlags_424A50(int32(*(*uint32)(unsafe.Pointer(uintptr(i + 4)))), 0x40000) && ((int32(*(*uint8)(unsafe.Pointer(uintptr(i + 88))))&2) == 0 || *(*uint32)(unsafe.Pointer(uintptr(i + 4))) == 43) {
			...
			if float64(v10*v10) >= v7*v7+v6*v6 {
				nox_xxx_spellCancelSpellDo_4FE9D0(unsafe.Pointer(uintptr(i)))
			}
		}
	}
	nox_xxx_unitsGetInCircle_517F90(v4, v10, unsafe.Pointer(funAddr(sub_52BDB0)), unsafe.Pointer(uintptr(a4)))
...
func nox_xxx_cspellRemoveSpell_52BC90(a1 int32) {
	...
	if int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 12))))&1 != 0 && (int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 16))))&0x20) == 0 {
		...
		(*(*func(int32, uint32, uint32))(unsafe.Pointer(uintptr(a1 + 696))))(a1, 0, 0)
...
func nox_xxx_deathBallCreateFragments_52BD30(a1 *int32) int32 {
	...
	for {
		...
		if result != 0 {
			nox_xxx_createAt_4DAA50((*nox_object_t)(unsafe.Pointer(uintptr(result))), (*nox_object_t)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*math.MaxInt8))))), *((*float32)(unsafe.Add(unsafe.Pointer((*float32)(unsafe.Pointer(a1))), unsafe.Sizeof(float32(0))*14))), *((*float32)(unsafe.Add(unsafe.Pointer((*float32)(unsafe.Pointer(a1))), unsafe.Sizeof(float32(0))*15))))
...
func sub_52BDB0(a1 int32, a2 int32) int32 {
	...
	result = a2
	v3 = 0
	if a1 != a2 && (*(*uint32)(unsafe.Pointer(uintptr(a1 + 16)))&0x8020) == 0 {
		for i = 0; i < 32; i++ {
			result = nox_xxx_testUnitBuffs_4FF350((*nox_object_t)(unsafe.Pointer(uintptr(a1))), int8(i))
			if result != 0 {
				result = nox_xxx_unitGetBuffTimer_4FF550((*nox_object_t)(unsafe.Pointer(uintptr(a1))), i)
				if result != 0 {
...
func nox_xxx_changeOwner_52BE40(a1 int32, a2 int32) {
	...
	if int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 8))))&1 != 0 && int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 12))))&2 != 0 {
		...
		if *(*int32)(unsafe.Add(unsafe.Pointer(v2), 4*3)) == 115 {
		...
		} else if *(*int32)(unsafe.Add(unsafe.Pointer(v2), 4*1)) == a2 {
			...
			*(*uint32)(unsafe.Pointer(uintptr(a1 + 128))) = gameFrame()
...
func sub_52BEB0(a1 int32, a2 int32, a3 int32, a4 int32) int32 {
	...
	nox_xxx_getMissilesInCircle_518170((*float2)(unsafe.Pointer(uintptr(a4+56))), v6, unsafe.Pointer(funAddr(nox_xxx_changeOwner_52BE40)), (*nox_object_t)(unsafe.Pointer(uintptr(a3))))
...
func nox_xxx_castPull_52BFA0(a1 int32, a2 int32, a3 int32, a4 int32, a5 int32, a6 int32) int32 {
	...
	nox_xxx_mapPushUnitsAround_52E040(unsafe.Pointer(uintptr(a4+56)), 600.0, 10.0, v8, nil, 0, 0)
...
func nox_xxx_castFumble_52C060(a1 int32, a2 int32, a3 int32, a4 int32, a5 *int32) int32 {
	...
	if *a5 != 0 {
		if *(*uint32)(unsafe.Pointer(uintptr(result + 8)))&4 != 0 || (func() int32 {
			...
			return v6
		}()) != 0 && int32(*(*uint8)(unsafe.Pointer(uintptr(result + 12))))&0x10 != 0 {
...
func nox_xxx_useShock_52C5A0(a1 int32, a2 int32, a3 int32, a4 int32, a5 *int32, a6 int32) int32 {
	...
	if a4 != 0 && int32(*(*uint16)(unsafe.Pointer(uintptr(a4 + 4)))) == v7 {
		...
		(*(*func(int32, int32, int32, int32, int32))(unsafe.Pointer(uintptr(*a5 + 716))))(*a5, a3, a3, v8, 9)
		result = 1
	} else {
		v11 = float32(nox_xxx_gamedataGetFloat_419D40(internCStr("ShockEnchantDuration")))
		v9 = int16(nox_float2int(v11))
...
func nox_xxx_castFireball_52C790(a1 int32, a2 int32, a3 int32, a4 int32, a5 int32, a6 int32) int32 {
	...
	v6 = a6
	v7 = (*float32)(unsafe.Pointer(nox_xxx_newObjectByTypeID_4E3810(*(**byte)(memmap.PtrOff(0x587000, uint32(a6*4)+258864)))))
	if v7 == nil {
		return 1
	}
	v8 = a4
...
func sub_52CA80(a1 int32, a2 int32, a3 int32, a4 int32) int32 {
	...
	if int32(*(*uint8)(unsafe.Pointer(uintptr(v5 + 8))))&4 != 0 {
		...
		if v13 != 0 {
			...
			*(*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v7 + v8*4 + 116))) + 136))) = gameFrame()
		} else {
...
func sub_52CBD0(a1 int32, a2 int32, a3 int32, a4 int32) int32 {
	...
	if int32(*(*uint8)(unsafe.Pointer(uintptr(a3 + 8))))&4 != 0 {
		...
		if v7 != 0 {
			...
			*(*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v6 + a1*4 - 68))) + 136))) = gameFrame()
		} else {
			v17[0] = internCStr("TeleportGlyph1")
			v17[1] = internCStr("TeleportGlyph2")
			v17[2] = internCStr("TeleportGlyph3")
...
func sub_52CCD0(a1 int32, a2 int32, a3 int32) int32 {
	...
	for {
		if nox_xxx_unitHasThatParent_4EC4F0((*nox_object_t)(unsafe.Pointer(uintptr(v3))), (*nox_object_t)(unsafe.Pointer(uintptr(a3)))) != 0 && libc.StrCmp(nox_xxx_getUnitName_4E39D0((*nox_object_t)(unsafe.Pointer(uintptr(v3)))), internCStr("Glyph")) == 0 {
	...
	nox_xxx_dieGlyph_54DF30((*nox_object_t)(unsafe.Pointer(Tm)))
	return 1
}
	...
	if *a5 != 0 {
		if int32(*(*uint8)(unsafe.Pointer(uintptr(result + 540)))) != 0 {
			if int32(*(*uint8)(unsafe.Pointer(uintptr(result + 540)))) > a6 {
				nox_xxx_updatePoison_4EE8F0((*nox_object_t)(unsafe.Pointer(uintptr(result))), a6)
				nox_xxx_netPriMsgToPlayer_4DA2C0((*nox_object_t)(unsafe.Pointer(uintptr(*a5))), internCStr("ExecSpel.c:PoisonCure"), 0)
			} else {
				nox_xxx_removePoison_4EE9D0(*a5)
				nox_xxx_netPriMsgToPlayer_4DA2C0((*nox_object_t)(unsafe.Pointer(uintptr(*a5))), internCStr("ExecSpel.c:PoisonClean"), 0)
			}
			v9 = *a5
...
func sub_52CE60(a1 int32) {
	if int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 8))))&0x80 != 0 {
		*(*uint32)(unsafe.Pointer(uintptr(a1 + 508))) = *memmap.PtrUint32(0x5D4594, 2487716)
...
func nox_xxx_castLock_52CE90(a1 int32, a2 int32, a3 int32, a4 int32) int32 {
	...
	*memmap.PtrUint32(0x5D4594, 2487704) = 1287568416
	nox_xxx_getUnitsInRect_517C10(&v9, unsafe.Pointer(funAddr(sub_52CF90)), unsafe.Pointer(uintptr(a4)))
	if dword_5d4594_2487708 == 0 {
		return 0
	}
	v5 = int32(*(*uint32)(unsafe.Pointer(uintptr(dword_5d4594_2487708 + 508))))
	if v5 != 0 && v5 != a3 {
		nox_xxx_netPriMsgToPlayer_4DA2C0((*nox_object_t)(unsafe.Pointer(uintptr(a3))), internCStr("ExecSpel.c:DoorAlreadyLocked"), 0)
		return 0
	}
	*(*uint32)(unsafe.Pointer(uintptr(dword_5d4594_2487708 + 508))) = uint32(a3)
	*(*uint32)(unsafe.Pointer(uintptr(dword_5d4594_2487708 + 136))) = gameFrame() + gameFPS()*60
...
func sub_52D060(a1 int32, a2 int32) {
	...
	*memmap.PtrUint32(0x5D4594, 2487716) = uint32(a2)
	...
	nox_xxx_getUnitsInRect_517C10(&v5, unsafe.Pointer(funAddr(sub_52CE60)), nil)
	...
	if *a5 != 0 {
		if int32(*(*uint8)(unsafe.Pointer(uintptr(result + 8))))&4 != 0 {
			...
			if v7 != nil {
				...
				nox_xxx_buffApplyTo_4FF380((*nox_object_t)(unsafe.Pointer(uintptr(*a5))), 24, int16(int32(uint16(gameFPS()))*20), a6)
...
func nox_xxx_castFist_52D3C0(a1 int32, a2 int32, a3 int32, a4 int32, a5 int32, a6 int32) int32 {
		...
		for 2 != 0 {
			...
			for {
				if uint32(*(*uint16)(unsafe.Pointer(uintptr(v6 + 4)))) == *(*uint32)(unsafe.Pointer(v7)) {
					nox_xxx_netPriMsgToPlayer_4DA2C0((*nox_object_t)(unsafe.Pointer(uintptr(a3))), internCStr("ExecSpel.c:TooManyFists"), 0)
					return 0
				}
	...
	v21.field_8 = v9
	v21.field_C = v10
	v11 = bool2int32(nox_common_gameFlags_check_40A5C0(2048))
	if nox_xxx_mapTraceRay_535250(&v21, nil, nil, int8(func() int32 {
		...
		v14 = (*uint32)(unsafe.Pointer(nox_xxx_newObjectWithTypeInd_4E3450(int32(*memmap.PtrUint32(0x5D4594, uint32(a6*4)+2487736)))))
		v15 = int32(uintptr(unsafe.Pointer(v14)))
		if v14 != nil {
			v16 = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v14), 4*187)))))
			v20 = float32(nox_xxx_gamedataGetFloatTable_419D70(internCStr("FistOfVengeanceDamage"), a6-1))
			*v16 = uint32(nox_float2int(v20))
			...
			*(*uint32)(unsafe.Pointer(uintptr(v15 + 20))) |= 0x20
			...
			*(*uint32)(unsafe.Pointer(uintptr(v15 + 116))) = 1091567616
...
func nox_xxx_spellCastCleansingFlame_52D5C0(a1 int32, a2p *nox_object_t, a3p *nox_object_t, a4p *nox_object_t, a5p unsafe.Pointer, a6 int32) int32 {
	var (
	...
	if a2 != 0 {
		...
		if v6 != 0 {
			for 2 != 0 {
				...
				for {
					if uint32(*(*uint16)(unsafe.Pointer(uintptr(v6 + 4)))) == *(*uint32)(unsafe.Pointer(v7)) {
						nox_xxx_netPriMsgToPlayer_4DA2C0((*nox_object_t)(unsafe.Pointer(uintptr(a3))), internCStr("plyrspel.c:TooManySpells"), 0)
						return 0
					}
					v7 = (*uint8)(unsafe.Add(unsafe.Pointer(v7), 4))
	...
	for {
		...
		if v8 >= 1 {
			v9 = (*float32)(unsafe.Pointer(nox_xxx_newObjectWithTypeInd_4E3450(int32(*memmap.PtrUint32(0x5D4594, uint32(((func() int32 {
				if a1 != 10 {
					return 5
				}
				return 0
			...
			if v9 != nil {
				...
				*((*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(v9))), unsafe.Sizeof(uint16(0))*62))) = uint16(v10)
				...
				if nox_xxx_mapTraceRay_535250(&v20, nil, nil, 65) != 0 {
					...
					*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v9))), 4*34))) = gameFrame() + uint32(nox_common_randomInt_415FA0(int32(gameFPS()*3), int32(gameFPS()*6)))
					...
					*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v9))), 4*186))) = uint32(funAddr(nox_xxx_updateFlameCleanse_53D510))
					nox_xxx_unitAddToUpdatable_4DA8D0((*nox_object_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v9)))))))
					v17 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v9))), 4*2))) | 0x40000000)
					*(*float32)(unsafe.Add(unsafe.Pointer(v9), unsafe.Sizeof(float32(0))*28)) = 0.0
					*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v9))), 4*2))) = uint32(v17)
...
func nox_xxx_castMeteor_52D9D0(a1 int32, a2 int32, a3 int32, a4 int32, a5 int32, a6 int32) int32 {
	...
	if dword_5d4594_2487804 == 0 {
		v6 = nox_xxx_getNameId_4E3AA0(internCStr("Meteor"))
	...
	if v7 != 0 {
		...
		nox_xxx_netPriMsgToPlayer_4DA2C0((*nox_object_t)(unsafe.Pointer(uintptr(a3))), internCStr("ExecSpel.c:TooManyMeteors"), 0)
		return 0
	}
LABEL_6:
	v8 = a4
	...
	v24.field_8 = v11
	v24.field_C = v13
	v14 = bool2int32(nox_common_gameFlags_check_40A5C0(2048))
	if nox_xxx_mapTraceRay_535250(&v24, nil, nil, int8(func() int32 {
		...
		if v17 != nil {
			v19 = (*int32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v17), 4*187)))))
			v23 = float32(nox_xxx_gamedataGetFloatTable_419D70(internCStr("MeteorDamage"), a6-1))
			...
			*(*uint32)(unsafe.Pointer(uintptr(v18 + 20))) |= 0x20
			nox_xxx_unitRaise_4E46F0((*nox_object_t)(unsafe.Pointer(uintptr(v18))), 255.0)
			*(*float32)(unsafe.Pointer(uintptr(v18 + 108))) = float32(-nox_xxx_gamedataGetFloat_419D40(internCStr("MeteorSpeed")))
...
func nox_xxx_castToxicCloud_52DB60(a1 int32, a2 int32, a3 int32, a4 int32, a5 int32) int32 {
	...
	if int32(uint8(int8(nox_xxx_traceRay_5374B0(&v16)))) != 0 {
		...
		if v12 != nil {
			v13 = (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v12), 4*187)))))
...
func nox_xxx_castEquake_52DE40(a1 int32, a2 int32, a3 int32, a4 int32, a5 int32, a6 int32) int32 {
	...
	*memmap.PtrUint32(0x5D4594, 2487700) = uint32(a6)
	...
	nox_xxx_unitsGetInCircle_517F90((*float2)(unsafe.Pointer(uintptr(a4+56))), v9, unsafe.Pointer(funAddr(nox_xxx_equakeDamage_52DEC0)), unsafe.Pointer(uintptr(a4)))
	v6 = nox_xxx_spellGetAud44_424800(a1, 0)
		...
		if (v3 & 0x4000) == 0 {
			*(*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(&v3))), unsafe.Sizeof(uint16(0))*0)) = uint16(nox_xxx_unitGetHP_4EE780((*nox_object_t)(unsafe.Pointer(uintptr(a1)))))
			if int32(uint16(int16(v3))) != 0 {
				...
				*(*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(&v3))), unsafe.Sizeof(uint16(0))*0)) = uint16(int16((*(*func(int32, int32, int32, uint32, int32) int32)(unsafe.Pointer(uintptr(a1 + 716))))(a1, v4, v2, uint32(int32(int64(v5))), 11)))
			}
		}
	}
	return int16(v3)
...
func nox_xxx_mapPushUnitsAround_52E040(a1p unsafe.Pointer, a2 float32, a3p float32, a4 float32, a5p *nox_object_t, a6 int32, a7 int32) {
	var (
		a1  int32 = int32(uintptr(a1p))
		a3  int32 = *(*int32)(unsafe.Pointer(&a3p))
	...
	*(*float32)(unsafe.Pointer(&a3a[3])) = float32(float64(a4) * 10.0)
	...
	nox_xxx_getUnitsInRectAdv_517ED0(&a1a, unsafe.Pointer(funAddr(nox_xxx_unitPushAroundFn_52E0E0)), unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(&a3a[0]))))))
}
func nox_xxx_unitPushAroundFn_52E0E0(a1 int32, a2 **int32) {
	...
	if nox_xxx_isObjectMovable_52E020(a1) != 0 {
		v3 = a2
		v4 = *a2
		*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v15.field_0))), 4*0)) = uint32(**a2)
...
func nox_xxx_spellDrainMana_52E210(a1 float32) int32 {
	...
	if *(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 20))) != 0 {
		v3 = int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 16))))
		if v3 != 0 {
			v19.field_0 = *(*float32)(unsafe.Pointer(uintptr(v3 + 56)))
			v4 = *(*float32)(unsafe.Pointer(uintptr(v3 + 60)))
		} else {
			v4 = *(*float32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 32)))
			v19.field_0 = *(*float32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 28)))
		}
		v19.field_4 = v4
	...
	v7 = int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 16))))
	if int32(*(*uint8)(unsafe.Pointer(uintptr(v7 + 8))))&4 != 0 {
	...
	v9 = int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 16))))
	if int32(*(*uint8)(unsafe.Pointer(uintptr(v9 + 8))))&2 != 0 {
		if sub_4FEA70(v9, (*float2)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0)))+28)))) != 0 {
			return 1
		}
	}
	v10 = int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 16))))
	v11 = float64(*(*float32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 28))) - *(*float32)(unsafe.Pointer(uintptr(v10 + 56))))
	if v11 < 0.0 {
		v11 = -v11
	}
	v19.field_0 = float32(v11)
	v12 = float64(*(*float32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 32))) - *(*float32)(unsafe.Pointer(uintptr(v10 + 60))))
	if v12 < 0.0 {
		v12 = -v12
	}
	...
	v13 = sub_52E610((*int32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 16)))+56))), int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 16)))))
	*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 48))) = uint32(v13)
	if v13 == 0 {
		if *(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 36))) != 0 {
			nox_xxx_netStopRaySpell_4FEF90(*(*int32)(unsafe.Add(unsafe.Pointer((*int32)(unsafe.Pointer(&a1))), 4*0)), *(**uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 36))))
		}
		return 1
	}
	v21 = *(*float32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 72)))
	v22 = float32(nox_xxx_gamedataGetFloatTable_419D70(internCStr("ManaDrainCoeff"), int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 8)))-1)) + float64(v21))
	*(*float32)(unsafe.Pointer(&v14)) = COERCE_FLOAT(uint32(nox_float2int(v22)))
	...
	*(*float32)(unsafe.Pointer(uintptr(v1 + 72))) = float32(float64(v22) - v16)
	...
	if sub_52E450(int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 16)))), int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 48)))), v18) != 0 && (gameFrame()%(gameFPS()>>1)) == 0 {
...
func sub_52E450(a1 int32, a2 int32, a3 int32) int32 {
	...
	if uint32(v4)&0x400000 != 0 && int32(*(*uint8)(unsafe.Pointer(uintptr(a2 + 12))))&0x18 != 0 {
		...
		if !nox_common_gameFlags_check_40A5C0(4096) {
			nox_xxx_unitNeedSync_4E44F0((*nox_object_t)(unsafe.Pointer(uintptr(a2))))
		}
		if v6 > 0 {
			goto LABEL_24
		}
	...
	if v4&2 != 0 {
		if int32(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(a2 + 748))) + 1440))))&0x20 != 0 {
...
LABEL_24:
	if !nox_common_gameFlags_check_40A5C0(4096) || (int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 8))))&4) == 0 {
	...
	v11 = float32(v9)
	*(*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(&v6))), unsafe.Sizeof(uint16(0))*0)) = uint16(int16(nox_float2int(v11)))
	nox_xxx_playerManaAdd_4EEB80((*nox_object_t)(unsafe.Pointer(uintptr(a1))), int16(v6))
	return 1
}
func sub_52E610(a1 *int32, a2 int32) int32 {
	...
	*memmap.PtrUint32(0x5D4594, 2487840) = uint32(*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*1)))
	...
	nox_xxx_unitsGetInCircle_517F90((*float2)(unsafe.Pointer(a1)), v3, unsafe.Pointer(funAddr(sub_52E660)), unsafe.Pointer(uintptr(a2)))
	return int32(*memmap.PtrUint32(0x5D4594, 2487828))
}
func sub_52E660(a1 int32, a2 int32) {
	...
	if a1 == a2 || sub_52E7C0(a1) == 0 || *(*uint32)(unsafe.Pointer(uintptr(a1 + 16)))&0x8020 != 0 {
		return
	}
	v2 = int32(*(*uint32)(unsafe.Pointer(uintptr(a1 + 8))))
	if (v2 & 2) == 0 {
		if uint32(v2)&0x400000 != 0 && int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 12))))&0x18 != 0 {
			v4 = 1.0
		} else {
			if (v2 & 4) == 0 {
				return
			...
			if nox_xxx_unitsHaveSameTeam_4EC520((*nox_object_t)(unsafe.Pointer(uintptr(a1))), (*nox_object_t)(unsafe.Pointer(uintptr(a2)))) != 0 || int32(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v5 + 276))) + 3680))))&1 != 0 {
				return
			}
			v4 = 0.5
		}
	...
	v3 = int32(*(*uint32)(unsafe.Pointer(uintptr(a1 + 748))))
	if a2 != 0 && nox_xxx_unitIsEnemyTo_5330C0((*nox_object_t)(unsafe.Pointer(uintptr(a2))), (*nox_object_t)(unsafe.Pointer(uintptr(a1)))) == 0 || int32(*(*uint8)(unsafe.Pointer(uintptr(v3 + 1440))))&0x20 == 0 {
		return
	}
	v4 = 1.0
LABEL_18:
	v6 = float64(*mem_getFloatPtr(0x5D4594, 2487836) - *(*float32)(unsafe.Pointer(uintptr(a1 + 56))))
	v7 = float64(*mem_getFloatPtr(0x5D4594, 2487840) - *(*float32)(unsafe.Pointer(uintptr(a1 + 60))))
	v8 = v4 * (v7*v7 + v6*v6)
	if v8 < float64(*mem_getFloatPtr(0x5D4594, 2487876)) {
		...
		if nox_xxx_mapTraceRay_535250(&v11, nil, nil, 5) != 0 {
			*memmap.PtrUint32(0x5D4594, 2487828) = uint32(a1)
			v12 = float32(v8)
...
func sub_52E7C0(a1 int32) int32 {
	...
	if uint32(v1)&0x400000 != 0 && int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 12))))&0x18 != 0 {
		if **(**uint32)(unsafe.Pointer(uintptr(a1 + 748))) > 0 {
			return 1
		}
	} else if v1&2 != 0 {
		if int32(*(*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(a1 + 748))) + 1440))))&0x20 != 0 {
			return 1
		}
...
func nox_xxx_spellEnergyBoltTick_52E850(a1 float32) int32 {
	...
	if *(*uint32)(unsafe.Pointer(uintptr(v1 + 20))) == 0 {
		...
		if (gameFrame()-*(*uint32)(unsafe.Pointer(uintptr(v1 + 60)))) > 2 && sub_4E6BD0(int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 16))))) != 0 {
			return 1
		}
		v10 = int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 48))))
		if v10 != 0 {
			if (*(*uint32)(unsafe.Pointer(uintptr(v10 + 16)))&0x8020) == 0 && nox_server_testTwoPointsAndDirection_4E6E50((*float2)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v1 + 16)))+56))), int32(*(*int16)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v1 + 16))) + 124)))), (*float2)(unsafe.Pointer(uintptr(v10+56))))&1 != 0 && nox_xxx_calcDistance_4E6C00((*nox_object_t)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v1 + 48)))))), (*nox_object_t)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v1 + 16))))))) <= float64(v31) && nox_xxx_unitCanInteractWith_5370E0((*nox_object_t)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v1 + 16)))))), (*nox_object_t)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v1 + 48)))))), 0) != 0 {
				goto LABEL_31
			}
		...
		*mem_getFloatPtr(0x5D4594, 2487868) = *(*float32)(unsafe.Pointer(uintptr(v14 + 56)))
		*mem_getFloatPtr(0x5D4594, 2487872) = *(*float32)(unsafe.Pointer(uintptr(v14 + 60)))
		*(*float32)(unsafe.Pointer(&dword_5d4594_2487884)) = v31 * v31
		nox_xxx_unitsGetInCircle_517F90((*float2)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v1 + 16)))+56))), v31, unsafe.Pointer(funAddr(nox_xxx_spellEnergyBoltSetTarget_52EC60)), unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v1 + 16))))))
	...
	LABEL_32:
		...
		v33 = float32(nox_xxx_gamedataGetFloatTable_419D70(internCStr("EnergyBoltDamage"), int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 8)))-1)) + float64(v32))
		v16 = v33
		...
		*(*float32)(unsafe.Pointer(uintptr(v1 + 72))) = float32(float64(v33) - v19)
		...
		(*(*func(uint32, uint32, uint32, int32, int32))(unsafe.Pointer(uintptr(v34 + 716))))(*(*uint32)(unsafe.Pointer(uintptr(v1 + 48))), *(*uint32)(unsafe.Pointer(uintptr(v1 + 16))), 0, v21, 17)
		v22 = int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 48))))
		if *(*uint32)(unsafe.Pointer(uintptr(v22 + 16)))&0x8020 != 0 {
		...
		*(*uint32)(unsafe.Pointer(uintptr(v1 + 68))) = gameFrame() + uint32(nox_float2int(v28))
		...
		if (v25 & 0x8000) != 0 {
			result = 0
			*(*uint32)(unsafe.Pointer(uintptr(v1 + 68))) = gameFrame() + 1
			return result
		}
		return 0
	}
	...
	*mem_getFloatPtr(0x5D4594, 2487868) = v29.field_0
	*mem_getFloatPtr(0x5D4594, 2487872) = v29.field_4
	nox_xxx_energyBoltTarget_5d4594_2487880 = 0
	*(*float32)(unsafe.Pointer(&dword_5d4594_2487884)) = v31 * v31
	*memmap.PtrUint32(0x5D4594, 2487832) = 1
	v5 = int32(*(*uint32)(unsafe.Pointer(uintptr(v1 + 16))))
	nox_xxx_unitsGetInCircle_517F90(&v29, v31, unsafe.Pointer(funAddr(nox_xxx_spellEnergyBoltSetTarget_52EC60)), unsafe.Pointer(uintptr(v5)))
...
func nox_xxx_spellEnergyBoltSetTarget_52EC60(target int32, source int32) {
	...
	if uint32(v2)&0x20006 != 0 {
		if (*(*uint32)(unsafe.Pointer(uintptr(target + 16)))&0x8020) == 0 && target != source {
			if (v2&2) == 0 || (func() bool {
				v3 = int32(*(*uint32)(unsafe.Pointer(uintptr(target + 12))))
				return (v3 & 0x8000) == 0
			}()) {
				if source == 0 || nox_xxx_unitIsEnemyTo_5330C0((*nox_object_t)(unsafe.Pointer(uintptr(source))), (*nox_object_t)(unsafe.Pointer(uintptr(target)))) != 0 && (*memmap.PtrUint32(0x5D4594, 2487832) != 0 || nox_server_testTwoPointsAndDirection_4E6E50((*float2)(unsafe.Pointer(uintptr(source+56))), int32(*(*int16)(unsafe.Pointer(uintptr(source + 124)))), (*float2)(unsafe.Pointer(uintptr(target+56))))&1 != 0 && nox_xxx_unitCanInteractWith_5370E0((*nox_object_t)(unsafe.Pointer(uintptr(source))), (*nox_object_t)(unsafe.Pointer(uintptr(target))), 0) != 0) {
					v4 = float64(*(*float32)(unsafe.Pointer(uintptr(target + 56))) - *mem_getFloatPtr(0x5D4594, 2487868))
					v5 = float64(*(*float32)(unsafe.Pointer(uintptr(target + 60))) - *mem_getFloatPtr(0x5D4594, 2487872))
					v6 = v5*v5 + v4*v4
...
func nox_xxx_firewalkTick_52ED40(a1 *float32) int32 {
	...
	v1 = a1
	v2 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a1))), 4*12))))
	if v2 == 0 {
		return 1
	}
	...
	if *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a1))), 4*15))) == *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a1))), 4*16))) {
		v4 = int32(*(*uint32)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a1))), 4*12))) + 56))))
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a1))), 4*18))) = uint32(v4)
		*(*float32)(unsafe.Add(unsafe.Pointer(a1), unsafe.Sizeof(float32(0))*19)) = *(*float32)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a1))), 4*12))) + 60)))
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a1))), 4*20))) = uint32(v4)
		...
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a1))), 4*16)))++
		result = 0
	} else {
		v5 = (*float32)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a1))), 4*12))))))
		...
		if v9-float64(*(*float32)(unsafe.Add(unsafe.Pointer(v5), unsafe.Sizeof(float32(0))*44))) > 15.0 {
			...
			for {
				...
				v14 = (*uint32)(unsafe.Pointer(nox_xxx_newObjectWithTypeInd_4E3450(int32(*memmap.PtrUint32(0x5D4594, uint32(v13*4)+2487888)))))
				v15 = v14
				if v14 != nil {
					...
					nox_xxx_unitSetDecayTime_511660((*nox_object_t)(unsafe.Pointer(v15)), int32(gameFPS()*25))
				}
			...
			*(*float32)(unsafe.Add(unsafe.Pointer(v1), unsafe.Sizeof(float32(0))*21)) = *(*float32)(unsafe.Add(unsafe.Pointer(v1), unsafe.Sizeof(float32(0))*19))
			v16 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v1))), 4*12))))
...
func sub_52EFD0(a1 int32) int32 {
	...
	if *(*uint32)(unsafe.Pointer(uintptr(a1 + 68)))-7 == gameFrame() && *(*uint32)(unsafe.Pointer(uintptr(a1 + 76))) != 0 {
...
func sub_52F220(a1 *int32) int32 {
	...
	if *(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*4)) == 0 {
		...
		v4 = int32(uintptr(unsafe.Pointer(nox_xxx_spellFlySearchTarget_540610((*float2)(unsafe.Pointer((*int32)(unsafe.Add(unsafe.Pointer(a1), 4*13)))), nil, v3, 400.0, 1, nil))))
		if v4 != 0 {
	...
	v6 = int32(uintptr(unsafe.Pointer(nox_xxx_spellFlySearchTarget_540610((*float2)(unsafe.Pointer((*int32)(unsafe.Add(unsafe.Pointer(a1), 4*13)))), (*nox_object_t)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*4))))), v5, 400.0, 1, (*nox_object_t)(unsafe.Pointer(uintptr(v7)))))))
	*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*12)) = v6
	if v6 != 0 {
		result = nox_xxx_unitIsEnemyTo_5330C0((*nox_object_t)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*4))))), (*nox_object_t)(unsafe.Pointer(uintptr(v6))))
		if result == 0 {
			nox_xxx_netStartDurationRaySpell_4FF130(int32(uintptr(unsafe.Pointer(a1))))
			result = 0
		}
	} else {
		nox_xxx_netPriMsgToPlayer_4DA2C0((*nox_object_t)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*4))))), internCStr("ExecDur.c:GreaterHealNoTarget"), 0)
		result = 1
	}
	return result
}
func sub_52F2E0(a1 float32) int32 {
	...
	v1 = a1
	v2 = int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 48))))
	if v2 == 0 {
		return 1
	}
	if *(*uint32)(unsafe.Pointer(uintptr(v2 + 16)))&0x8020 != 0 {
	...
	v4 = int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 16))))
	if v4 != 0 && nox_xxx_testUnitBuffs_4FF350((*nox_object_t)(unsafe.Pointer(uintptr(v4))), 8) != 0 {
		return 1
	}
	if nox_xxx_unitCanInteractWith_5370E0((*nox_object_t)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 16)))))), (*nox_object_t)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 48)))))), 0) == 0 {
		return 1
	}
	if int32(nox_xxx_unitGetOldMana_4EEC80(int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 16)))))) == 0 {
		return 1
	}
	v5 = int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 16))))
	if int32(*(*uint8)(unsafe.Pointer(uintptr(v5 + 8))))&2 != 0 && sub_4FEA70(v5, (*float2)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0)))+28)))) != 0 {
		return 1
	}
	if sub_4E6BD0(int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 16))))) != 0 {
		return 1
	}
	v6 = nox_xxx_unitGetMaxHP_4EE7A0(int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 48)))))
	if int32(v6) == int32(nox_xxx_unitGetHP_4EE780((*nox_object_t)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 48)))))))) {
		return 1
	}
	v7 = int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 16))))
	v11 = *(*float32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 72))) + *mem_getFloatPtr(0x587000, *(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 8)))*4+260360)
	...
	*(*float32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v1))), 4*0))) + 72))) = float32(float64(v11) - float64(nox_float2int(v11)))
	v10 = nox_float2int(v11)
	nox_xxx_unitAdjustHP_4EE460((*nox_object_t)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v1))), 4*0))) + 48)))))), v10)
	nox_xxx_playerManaSub_4EEBF0(int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v1))), 4*0))) + 16)))), 1)
	return 0
}
func sub_52F460(a1 float32) int32 {
	...
	if *(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 20))) != 0 {
		...
		nox_xxx_unitDamageClear_4EE5E0((*nox_object_t)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 48)))))), 20)
		result = 1
	} else {
		v4 = int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 16))))
		if v4 != 0 && nox_xxx_testUnitBuffs_4FF350((*nox_object_t)(unsafe.Pointer(uintptr(v4))), 8) != 0 {
			...
			v5 = int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 48))))
			if int32(*(*uint8)(unsafe.Pointer(uintptr(v5 + 8))))&2 != 0 && sub_4FEA70(v5, (*float2)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0)))+28)))) != 0 {
				result = 1
			} else {
				v6 = nox_xxx_playerGetMaxMana_4EECB0(int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 48)))))
				if int32(v6) == int32(nox_xxx_unitGetOldMana_4EEC80(int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 48)))))) {
					result = 1
				} else if int32(uint16(nox_xxx_unitGetHP_4EE780((*nox_object_t)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 16))))))))) > 1 {
					if int32(nox_xxx_unitGetHP_4EE780((*nox_object_t)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 16)))))))) != 0 {
						v8 = *(*float32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&a1))), 4*0))) + 72)))
						v9 = float32(nox_xxx_gamedataGetFloatTable_419D70(internCStr("ChannelLifeCoeff"), int32(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v1))), 4*0))) + 8)))-1)) + float64(v8))
						*(*float32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v1))), 4*0))) + 72))) = float32(float64(v9) - float64(nox_float2int(v9)))
						v7 = int16(nox_float2int(v9))
						nox_xxx_playerManaAdd_4EEB80((*nox_object_t)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v1))), 4*0))) + 48)))))), v7)
						nox_xxx_unitDamageClear_4EE5E0((*nox_object_t)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr((*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v1))), 4*0))) + 16)))))), 1)
					}
					result = 0
				} else {
					result = 1
...
func nox_xxx_castShield1_52F5A0(a1 *uint32) int32 {
	...
	v3 = nox_float2int(v5)
	nox_xxx_buffApplyTo_4FF380((*nox_object_t)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*12))))), 26, int16(v3), int8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*2)))))
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*18)) = uint32(nox_float2int(v6))
	return 0
}
func sub_52F650(a1 int32) int32 {
	...
	if v1 != 0 {
		result = bool2int32((*(*uint32)(unsafe.Pointer(uintptr(v1 + 16))) & 0x8020) != 0)
	} else {
		result = 1
	}
	return result
...
func nox_xxx_unitShield_52F690(a1 int32, a2 int32) int8 {
	...
	if v2 != nil {
		for *(*uint32)(unsafe.Add(unsafe.Pointer(v2), 4*12)) != uint32(a1) || *(*uint32)(unsafe.Add(unsafe.Pointer(v2), 4*1)) != 51 {
			v2 = (*uint32)(nox_xxx_spellCastedNext_4FE940(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v2)))))))
			if v2 == nil {
				*((*uint8)(unsafe.Pointer(&v2))) = uint8(int8(nox_xxx_spellBuffOff_4FF5B0((*nox_object_t)(unsafe.Pointer(uintptr(a1))), 26)))
		...
		if v3 != 0 {
			if *(*uint32)(unsafe.Pointer(uintptr(v3 + 16)))&0x8020 != 0 {
				*((*uint8)(unsafe.Pointer(&v2))) = uint8(nox_xxx_spellCancelSpellDo_4FE9D0(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v2)))))))
