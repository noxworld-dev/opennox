...
func nox_thing_harpoon_rope_draw(a1 *int32, dr *nox_drawable) int32 {
	...
	if v10 != nil && v11 != nil {
		...
		a1a.field_0 += int32(*memmap.PtrUint32(0x587000, uint32(int32(*((*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(v10))), 297))))*8)+175864))
		a1a.field_4 += int32(*memmap.PtrUint32(0x587000, uint32(int32(*((*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(v10))), 297))))*8)+175868))
		a2a.field_4 -= 8
		*memmap.PtrUint32(0x5D4594, 1312492) = nox_color_rgb_4344A0(144, 104, 64)
		*memmap.PtrUint32(0x5D4594, 1312496) = nox_color_rgb_4344A0(24, 16, 0)
		sub_4B63B0(&a1a, &a2a)
