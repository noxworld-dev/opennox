...
func sub_4BE2C0(a1 int32) int32 {
	...
	*(*uint32)(unsafe.Pointer(uintptr(uint32(uintptr(sub_416640())) + 74))) = uint32(a1)
	...
	return nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v2)))))), 16385, int32(uintptr(memmap.PtrOff(0x5D4594, 1316716))), -1, internCStr(__FILE__), __LINE__)
}
