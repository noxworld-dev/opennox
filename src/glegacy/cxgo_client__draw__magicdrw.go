...
func nox_thing_magic_draw(a1 *int32, dr *nox_drawable) int32 {
	...
	v4 = int32(uint32(*a1) + *(*uint32)(unsafe.Pointer(uintptr(a2 + 12))) - uint32(*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*4))))
	v5 = int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 16))) - uint32(*(*int16)(unsafe.Pointer(uintptr(a2 + 106)))) - uint32(*(*int16)(unsafe.Pointer(uintptr(a2 + 104)))) - uint32(*(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*5))))
	v10.field_0 = v4
	v6 = v3 + v5
	v10.field_4 = v6
...
func nox_thing_magic_missle_tail_link_draw(a1 *uint32, dr *nox_drawable) int32 {
	...
	v4 = int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 16))) + *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*1)) - uint32(*(*int16)(unsafe.Pointer(uintptr(a2 + 106)))) - uint32(*(*int16)(unsafe.Pointer(uintptr(a2 + 104)))) - *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*5)))
	v12 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*1)) - uint32(*(*int16)(unsafe.Pointer(uintptr(a2 + 106)))) - uint32(*(*int16)(unsafe.Pointer(uintptr(a2 + 104)))) - *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*5)) + *(*uint32)(unsafe.Pointer(uintptr(a2 + 436))))
	v5 = int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 356))) - gameFrame())
	v11 = int32(*a1 - *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*4)) + *(*uint32)(unsafe.Pointer(uintptr(a2 + 432))))
	v14 = v5
	if v5 > 0 {
...
func nox_thing_magic_tail_link_draw(a1 *uint32, dr *nox_drawable) int32 {
	...
	v3 = int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 12))) + *a1 - *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*4)))
	v4 = int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 16))) + *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*1)) - uint32(*(*int16)(unsafe.Pointer(uintptr(a2 + 106)))) - uint32(*(*int16)(unsafe.Pointer(uintptr(a2 + 104)))) - *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*5)))
	v13 = int32(*a1 - *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*4)) + *(*uint32)(unsafe.Pointer(uintptr(a2 + 432))))
	v5 = int32(*(*uint32)(unsafe.Pointer(uintptr(a2 + 356))) - gameFrame())
	v6 = *(*uint32)(unsafe.Pointer(uintptr(a2 + 356))) == gameFrame()
	v14 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*1)) - uint32(*(*int16)(unsafe.Pointer(uintptr(a2 + 106)))) - uint32(*(*int16)(unsafe.Pointer(uintptr(a2 + 104)))) - *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*5)) + *(*uint32)(unsafe.Pointer(uintptr(a2 + 436))))
	v15 = v5
	if v5 >= 0 && !v6 {
		v8 = uint32(v5 << 6)
