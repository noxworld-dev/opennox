...
func nox_xxx_objectApplyForce_52DF80(vec *float, obj *nox_object_t, force float) {
...
func Get_nox_xxx___mkgmtime_538280() unsafe.Pointer {
	return nox_xxx___mkgmtime_538280
}
...
func Nox_call_objectType_parseUpdate_go(a1 unsafe.Pointer, a2 string, a3 unsafe.Pointer) int {
	cstr := CString(a2)
	defer StrFree(cstr)
	return int(nox_call_objectType_parseUpdate_go((*[0]byte)(a1), cstr, a3))
}
...
func Nox_xxx_playerSubStamina_4F7D30(a1 *server.Object, a2 int) int {
	return int(nox_xxx_playerSubStamina_4F7D30(asObjectC(a1), int(a2)))
}
...
func Nox_xxx_unitDamageClear_4EE5E0(a1 *server.Object, a2 int) {
	nox_xxx_unitDamageClear_4EE5E0(asObjectC(a1), int(a2))
}
func Nox_xxx_unitAdjustHP_4EE460(a1 *server.Object, a2 int) {
	nox_xxx_unitAdjustHP_4EE460(asObjectC(a1), int(a2))
}
func Sub_509CF0(a1 *byte, a2 player.Class, a3 uint32) int {
	return int(sub_509CF0((*char)(unsafe.Pointer(a1)), char(a2), int(a3)))
}
