...
func nox_xxx_gui_4AD320(a1 int32) int32 {
	...
	v3 = (*uint32)(unsafe.Pointer(nox_new_window_from_file(*(**byte)(memmap.PtrOff(0x587000, uintptr(v1*4)+173556)), unsafe.Pointer(funAddr(nox_xxx_windowServerOptionsGeneralProc_4AD5D0)))))
	...
	nox_xxx_wndSetDrawFn_46B340(*(*int32)(unsafe.Pointer(&dword_5d4594_1309812)), func(arg1 int32, arg2 int32) int32 {
		return sub_4AD570()
	})
	...
	if false {
		...
		nox_xxx_wndSetProc_46B2C0(int32(uintptr(unsafe.Pointer(v5))), func(arg1 int32, arg2 int32, arg3 int32, arg4 int32) int32 {
		...
		v9 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1309812)))), 10319)))
	...
	if nox_common_getEngineFlag(nox_engine_flag(NOX_ENGINE_FLAG_DISABLE_GRAPHICS_RENDERING)) {
		v10 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1309812)))), 10304)))
...
func sub_4AD4B0() int32 {
	...
	v0 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1309812)))), 10317)))
	v1 = v0
...
func sub_4AD840() int32 {
	...
	if dword_5d4594_1309812 != 0 {
		if nox_server_doPlayersAutoRespawn_40A5F0() != 0 {
			v1 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1309812)))), 10301)))
		...
		if nox_server_sendMotd_108752 != 0 {
			v2 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1309812)))), 10302)))
			*(*uint32)(unsafe.Add(unsafe.Pointer(v2), 4*9)) |= 4
		}
		if sub_4D0D70() != 0 {
			v3 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1309812)))), 10304)))
			*(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*9)) |= 4
		}
		if sub_409F40(2) != 0 {
			v4 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1309812)))), 10305)))
			*(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*9)) |= 4
		}
		if sub_409F40(0x2000) != 0 {
			v5 = (*uint32)(unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1309812)))), 10306)))
