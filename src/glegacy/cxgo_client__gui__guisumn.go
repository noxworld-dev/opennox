...
func nox_xxx_guiSummonCreatureLoad_4C1D80() int32 {
	...
	*memmap.PtrUint32(0x5D4594, 1321000) = 4294967151
	...
	nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1321032)))), funAddrP(sub_4C2BD0), funAddrP(sub_4C24A0), nil)
	...
	*memmap.PtrUint32(0x5D4594, 1320996) = uint32(uintptr(unsafe.Pointer(nox_xxx_gLoadImg_42F970(internCStr("CreatureCageBottom")))))
	...
	nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(v3)), funAddrP(sub_4C2BE0), funAddrP(sub_4C24A0), nil)
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*11)) = uint32(v5)
	nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1321040)))), funAddrP(nox_xxx_wndSummonBigButtonProc_4C24B0), nil, funAddrP(sub_4C2CE0))
...
LABEL_16:
	...
	nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1321044)))), nil, funAddrP(sub_4C26F0), nil)
	...
	for i = 0; i < 6; i++ {
		if i != 2 {
			...
			nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(v10)), funAddrP(nox_xxx_clientOrderCreature_4C2A60), funAddrP(sub_4C27F0), nil)
