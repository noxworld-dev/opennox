...
func nox_xxx_guiSummonCreatureLoad_4C1D80() int32 {
	...
	*memmap.PtrUint32(0x5D4594, 1321000) = 4294967151
	...
	dword_5d4594_1321032 = uint32(uintptr(unsafe.Pointer(nox_window_new(nil, 8, nox_win_width-95, -145, 87, 115, funAddrP(nil)))))
	nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1321032)))), funAddrP(sub_4C2BD0), funAddrP(sub_4C24A0), funAddrP(nil))
	dword_5d4594_1321036 = uint32(uintptr(unsafe.Pointer(nox_window_new((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321032))))), 136, 5, 38, 76, 76, funAddrP(nil)))))
	nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1321036)))), funAddrP(nox_xxx_wndSummonProc_4C2B10), funAddrP(nox_xxx_guiDrawSummonBox_4C1FE0), funAddrP(sub_4C2C20))
	...
	*memmap.PtrUint32(0x5D4594, 1320996) = uint32(uintptr(unsafe.Pointer(nox_xxx_gLoadImg_42F970(internCStr("CreatureCageBottom")))))
	v1 = (*uint32)(unsafe.Pointer(nox_window_new((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321036))))), 160, 0, 0, 1, 1, funAddrP(nil))))
	...
	v3 = (*uint32)(unsafe.Pointer(nox_window_new((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321032))))), 8, 19, 0, 48, 39, funAddrP(nil))))
	nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(v3)), funAddrP(sub_4C2BE0), funAddrP(sub_4C24A0), funAddrP(nil))
	...
	*memmap.PtrUint32(0x5D4594, 1321028) = uint32(uintptr(unsafe.Pointer(nox_xxx_gLoadImg_42F970(internCStr("CreatureCageEscortButton")))))
	v4 = (*uint32)(unsafe.Pointer(nox_window_new(nil, 168, int32(dword_5d4594_1320988+27), int32(dword_5d4594_1320992+12), 34, 34, funAddrP(nil))))
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(v4), 4*11)) = uint32(v5)
	nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1321040)))), funAddrP(nox_xxx_wndSummonBigButtonProc_4C24B0), funAddrP(nil), funAddrP(sub_4C2CE0))
...
LABEL_16:
	dword_5d4594_1321044 = uint32(uintptr(unsafe.Pointer(nox_window_new(nil, 40, v5, v7, *(*int32)(unsafe.Pointer(&nox_xxx_screenWidth_587000_184452)), v3*5+12, funAddrP(nil)))))
	nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1321044)))), funAddrP(nil), funAddrP(sub_4C26F0), funAddrP(nil))
	nox_xxx_wndShowModalMB_46A8C0((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321044))))))
	v8 = 0
	for i = 0; i < 6; i++ {
		if i != 2 {
			v10 = (*uint32)(unsafe.Pointer(nox_window_new((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321044))))), 8, 0, v8, *(*int32)(unsafe.Pointer(&nox_xxx_screenWidth_587000_184452)), v3+1, funAddrP(nil))))
			nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(v10)), funAddrP(nox_xxx_clientOrderCreature_4C2A60), funAddrP(sub_4C27F0), funAddrP(nil))
...
func sub_4C27F0(a1 *uint32) int32 {
	...
	if dword_5d4594_1321204 != 0 || (func() bool {
		...
		v2 = (*uint16)(unsafe.Pointer(nox_strman_loadString_40F1D0(*(**byte)(memmap.PtrOff(0x587000, uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*8)))*4+184344)), nil, internCStr("C:\\NoxPost\\src\\Client\\Gui\\guisumn.c"), 446)))
