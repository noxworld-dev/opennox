...
func sub_48CB10(a1 int32) *uint32 {
	...
	v25 = 0
	nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1197316))))), 16399, 0, 0, internCStr(__FILE__), __LINE__)
	nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1197320))))), 16399, 0, 0, internCStr(__FILE__), __LINE__)
	...
	case 4:
		...
		nox_wcscat(&v27[0], v6)
		nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1197320))))), 16397, int32(uintptr(unsafe.Pointer(&v27[0]))), 4, internCStr(__FILE__), __LINE__)
	...
	case 2:
		...
		nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1197320))))), 16397, int32(uintptr(unsafe.Pointer(v11))), 4, internCStr(__FILE__), __LINE__)
		v12 = nox_strman_loadString_40F1D0(internCStr("WindowDir:No"), nil, internCStr("C:\\NoxPost\\src\\client\\Gui\\GUIVote.c"), 498)
		nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1197320))))), 16397, int32(uintptr(unsafe.Pointer(v12))), 4, internCStr(__FILE__), __LINE__)
		if dword_5d4594_1197332 == 1 {
			nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1197320))))), 16403, 0, 0, internCStr(__FILE__), __LINE__)
		} else {
			nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1197320))))), 16403, 1, 0, internCStr(__FILE__), __LINE__)
		}
		return (*uint32)(unsafe.Pointer(uintptr(nox_xxx_wndShowModalMB_46A8C0((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1197312)))))))))
	case 0:
		fallthrough
		...
		if int32(nox_xxx_getTeamCounter_417DD0()) != 0 {
					...
					if i != *(**byte)(memmap.PtrOff(0x8531A0, 2576)) {
						...
						if v18 != nil {
							if nox_xxx_teamCompare2_419180(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v18))))), uint8(*(*byte)(unsafe.Add(unsafe.Pointer(v16), 57)))) != 0 {
								nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1197316))))), 16397, int32(uintptr(unsafe.Pointer((*byte)(unsafe.Add(unsafe.Pointer(i), 4704))))), int32(*memmap.PtrUint32(0x587000, uint32((int32(uint8(*(*byte)(unsafe.Add(unsafe.Pointer(v16), 57))))%10)*8)+156400)), internCStr(__FILE__), __LINE__)
								v19 = 0
								if dword_5d4594_1197324 > 0 {
									...
									for {
										if nox_wcscmp(v20, (*wchar2_t)(unsafe.Add(unsafe.Pointer((*wchar2_t)(unsafe.Pointer(i))), unsafe.Sizeof(wchar2_t(0))*2352))) == 0 {
											nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1197316))))), 16405, v25, 0, internCStr(__FILE__), __LINE__)
										}
										v19++
			...
			for j = (*byte)(unsafe.Pointer(nox_common_playerInfoGetFirst_416EA0())); j != nil; j = (*byte)(unsafe.Pointer(nox_common_playerInfoGetNext_416EE0((*nox_playerInfo)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(j))))))))) {
				if j != *(**byte)(memmap.PtrOff(0x8531A0, 2576)) {
					nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1197316))))), 16397, int32(uintptr(unsafe.Pointer((*byte)(unsafe.Add(unsafe.Pointer(j), 4704))))), 4, internCStr(__FILE__), __LINE__)
					v22 = 0
					if dword_5d4594_1197324 > 0 {
