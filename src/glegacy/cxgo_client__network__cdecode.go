...
func nox_xxx_netOnPacketRecvCli_48EA70_switch(a1 int32, op int32, data *uint8, sz int32) int32 {
	...
	case 49:
		...
		*(*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(&v5))), 4*0)) = uint32(uintptr(unsafe.Pointer(func() *nox_drawable {
		...
		if funAddr(*(*func(*int32, int32) int32)(unsafe.Pointer(uintptr(v5 + 300)))) == funAddr(nox_thing_animate_draw) {
	...
	case 51:
		...
		*(*uint32)(unsafe.Pointer(uintptr(v5 + 488))) = 1
		...
		} else if funAddr(*(*func(*int32, int32) int32)(unsafe.Pointer(uintptr(v5 + 300)))) != funAddr(nox_thing_animate_draw) || (func() int32 {
