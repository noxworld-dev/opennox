...
func sub_4761B0(a1p *nox_drawable) int32 {
	...
	if *memmap.PtrUint32(0x852978, 8) == 0 {
		return int32(*(*uint32)(unsafe.Pointer(uintptr(a1 + 16))) + uint32(*memmap.PtrInt32(0x587000, uint32(int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 299))))*8)+196188)/2))
	}
	result = int32(*(*uint32)(unsafe.Pointer(uintptr(a1 + 16))))
	v2 = int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 299)))) * 8
	v3 = int32((*(*uint32)(unsafe.Pointer(uintptr(*memmap.PtrUint32(0x852978, 8) + 16)))-uint32(result))*uint32(*memmap.PtrInt32(0x587000, uint32(v2)+196184)) - (*(*uint32)(unsafe.Pointer(uintptr(*memmap.PtrUint32(0x852978, 8) + 12)))-*(*uint32)(unsafe.Pointer(uintptr(a1 + 12))))*uint32(*memmap.PtrInt32(0x587000, uint32(v2)+196188)))
	if *memmap.PtrInt32(0x587000, uint32(v2)+196184) < 0 {
	...
	v4 = result + *memmap.PtrInt32(0x587000, uint32(int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 299))))*8)+196188)
	if v3 >= 0 {
		if v4 <= result {
			result += *memmap.PtrInt32(0x587000, uint32(int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 299))))*8)+196188)
		}
	} else if v4 > result {
		result += *memmap.PtrInt32(0x587000, uint32(int32(*(*uint8)(unsafe.Pointer(uintptr(a1 + 299))))*8)+196188)
	}
...
func sub_476AE0(vp *nox_draw_viewport_t, dr *nox_drawable) unsafe.Pointer {
	...
	v2 = a2
	result2 = asFunc(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a2))), 4*75))), (*func(*int32, int32) int32)(nil)).(func(*int32, int32) int32)
	if funAddr(result2) == funAddr(nox_thing_static_draw) {
		if *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a2))), 4*28)))&0x40000 != 0 && (*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a2))), 4*30)))&0x1000000) == 0 {
			return unsafe.Pointer(funAddr(result2))
		}
...
func nox_client_setPhonemeFrame_476E00(a1 int32) int32 {
	var result int32
	result = a1
	*memmap.PtrUint32(0x5D4594, uint32(a1*4)+1096596) = gameFrame()
	return result
}
func sub_476E20() *uint32 {
	...
	v0 = 0
	for {
		v1 = (*byte)(unsafe.Pointer(nox_xxx_gLoadImg_42F970(*(**byte)(memmap.PtrOff(0x587000, uint32(v0)+151272)))))
		*memmap.PtrUint32(0x5D4594, uint32(v0)+1096564) = uint32(uintptr(unsafe.Pointer(v1)))
		if v1 == nil {
			break
		}
		v0 += 4
...
func sub_476E90() int32 {
	...
	v1 = 0
	for {
		if *memmap.PtrUint32(0x5D4594, uint32(v1)+1096596) != 0 {
			nox_client_drawImageAt_47D2C0((*nox_video_bag_image_t)(unsafe.Pointer(uintptr(*memmap.PtrUint32(0x5D4594, uint32(v1)+1096564)))), int32(uint32(nox_win_width/2)+*(*uint32)(unsafe.Pointer(v0))-16), int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v0))), 4*1)))+uint32(nox_win_height/2)-41))
			if (gameFrame() - *memmap.PtrUint32(0x5D4594, uint32(v1)+1096596)) > 3 {
				*memmap.PtrUint32(0x5D4594, uint32(v1)+1096596) = 0
			}
		}
...
func nox_xxx_clientEnumHover_476FA0() {
	...
	*memmap.PtrUint32(0x5D4594, 1096628) = 0
	...
	nox_xxx_forEachSprite_49AB00(&v2, unsafe.Pointer(funAddr(nox_xxx_clientOnCursorHover_477050)), int32(uintptr(unsafe.Pointer(&mpos))))
}
	...
	for {
		...
		for {
			if *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v4))), -int(4*1)))) != 0 {
				...
				return (*byte)(memmap.PtrOff(0x5D4594, uint32((v1+v3*10)*140)+1098636))
			}
		LABEL_7:
			v3++
...
func sub_478110() int32 {
	...
	*memmap.PtrUint32(0x5D4594, 1098512) = 0
	v0 = (*uint32)(unsafe.Pointer(nox_new_window_from_file(internCStr("Shop.wnd"), unsafe.Pointer(funAddr(sub_478480)))))
	...
	nox_gui_winSetFunc96_46B070((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v2)))))), unsafe.Pointer(funAddr(sub_478E50)))
...
func sub_478480(a1 int32, a2 int32, a3 *int32, a4 int32) int32 {
	...
	case 3808:
		...
		nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1098580))))), 16394, int32(dword_5d4594_1098592-uint32(v8)), 0, internCStr(__FILE__), __LINE__)
		result = 0
	case 3809:
		...
		nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1098580))))), 16394, int32(dword_5d4594_1098592-uint32(v7)), 0, internCStr(__FILE__), __LINE__)
		result = 0
	default:
		return 0
	}
...
func sub_478650(a1 int32, a2 int32, a3 uint32) int32 {
	...
	if sub_45D9B0() == 0 {
		...
		case 19:
			if dword_5d4594_1098628 == 2 {
				nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1098576))))), 16391, *memmap.PtrInt32(0x5D4594, 1098584), 0, internCStr(__FILE__), __LINE__)
				return 1
			}
		case 20:
			if dword_5d4594_1098628 == 2 {
				nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1098576))))), 16391, *memmap.PtrInt32(0x5D4594, 1098588), 0, internCStr(__FILE__), __LINE__)
				return 1
			}
		default:
			return 0
...
func sub_478C80() int32 {
	...
	for {
		if v1 > *memmap.PtrInt32(0x5D4594, 1098384)-50 {
			nox_client_drawImageAt_47D2C0((*nox_video_bag_image_t)(unsafe.Pointer(uintptr(*memmap.PtrUint32(0x5D4594, uint32((v6%2)*4)+1098424)))), v0, v1)
			v3 = v0 + 5
			v4 = 6
			for {
...
func sub_478E50(a1 int32, a2 int32, a3 uint32) int32 {
	...
	if dword_5d4594_1098628 == 2 {
		...
		v5 = (v4 + v3*10) * 35
		v6 = (**wchar2_t)(memmap.PtrOff(0x5D4594, uint32(v5*4)+1098636))
		if *memmap.PtrUint32(0x5D4594, uint32(v5*4)+1098640) != 0 {
	...
	for {
		...
		for {
			if *(*uint32)(unsafe.Pointer(v3)) == 0 {
				return (*byte)(memmap.PtrOff(0x5D4594, uint32((v0+v2*10)*140)+1098636))
			}
			v2++
...
func sub_4798A0(a1 *uint32) int32 {
	...
	v4 = (v3 + v2*10) * 35
	v5 = (*uint8)(memmap.PtrOff(0x5D4594, uint32(v4*4)+1098636))
	if *memmap.PtrUint32(0x5D4594, uint32(v4*4)+1098640) == 0 {
		return 0
	}
...
func sub_4799A0() int32 {
	...
	*memmap.PtrUint32(0x5D4594, 1107052) = nox_color_rgb_4344A0(240, 128, 64)
	result = int32(uintptr(unsafe.Pointer(nox_new_window_from_file(internCStr("Dialog.wnd"), unsafe.Pointer(funAddr(nox_xxx_guiDialog_479B00))))))
	...
	if result != 0 {
		...
		nox_xxx_wndSetDrawFn_46B340(*(*int32)(unsafe.Pointer(&dword_5d4594_1123524)), sub_479CB0)
		nox_gui_winSetFunc96_46B070((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1123524))))), unsafe.Pointer(funAddr(sub_479D00)))
...
LABEL_8:
	...
	*memmap.PtrUint32(0x973F18, uint32(v4+6088)) = *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*3))
	*memmap.PtrUint32(0x973F18, uint32(v4+6092)) = *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*2))
	*memmap.PtrUint32(0x973F18, uint32(v4+6096)) = *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*21))
	*memmap.PtrUint32(0x973F18, uint32(v4+6100)) = *(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*26))
...
func nox_xxx_drawTexEdgesProbably_481900(a1 *uint32, a2 *uint32) int8 {
	...
	addr = (*int32)(unsafe.Pointer(uintptr(*memmap.PtrUint32(0x85B3FC, uint32(v4*60+28676)) + (*(*uint32)(unsafe.Add(unsafe.Pointer(a2), 4*3))+uint32(*memmap.PtrUint16(0x85B3FC, uint32(v4*60+28690))))*4)))
	v6 = int32(*(*uint32)(unsafe.Pointer(addr)))
	v7 = int32(dword_5d4594_3798840)
	*memmap.PtrUint32(0x5D4594, uint32(v4*4)+2523980) = 1
...
func nox_thing_read_edge_485D40(f *nox_memfile, a2 *byte) int32 {
	...
	*(*uint32)(unsafe.Pointer(uintptr(v2 + 8))) = uint32(v12 + 1)
	...
	v24 = v7 * 15
	*memmap.PtrUint32(0x85B3FC, uint32(v7*60+28676)) = uint32(result)
	if result != 0 {
		v15 = 0
		for i = 0; v15 < v14; *(*uint32)(unsafe.Pointer(uintptr(*memmap.PtrUint32(0x85B3FC, uint32(v24*4+28676)) + uint32(v15*4) - 4))) = uint32(uintptr(unsafe.Pointer(nox_xxx_readImgMB_42FAA0(v17, int8(uint8(v25)), a2)))) {
...
func nox_xxx_wndEditProc_487D70_key(a1 *uint32, v4 int32, a3 int32, a4 int32) int32 {
	...
	case 156:
		...
		nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*13))))), 16415, int32(uintptr(unsafe.Pointer(a1))), 0, internCStr(__FILE__), __LINE__)
		return 1
	case 200:
		fallthrough
	case 203:
...
func nox_xxx_wndEditProc_487D70(a1p *nox_window, a2 int32, a3 int32, a4 int32) int32 {
	...
	case 17:
		...
		*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*9)) |= 2
		nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(v16))), 16389, int32(uintptr(unsafe.Pointer(a1))), 0, internCStr(__FILE__), __LINE__)
		nox_xxx_windowFocus_46B500((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1)))))))
		return 1
	case 18:
		...
		if v13&0x100 != 0 {
			...
			*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*9)) = uint32(v14)
			nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(v17))), 16390, int32(uintptr(unsafe.Pointer(a1))), 0, internCStr(__FILE__), __LINE__)
		}
		return 1
	case 21:
...
func nox_gui_newEntryField_488500(a1p *nox_window, a2 int32, a3 int32, a4 int32, a5 int32, a6 int32, a7 int32, a8 *wchar2_t) *nox_window {
	var (
		a1     int32 = int32(uintptr(unsafe.Pointer(a1p)))
		v8     *uint32
		v9     bool
	...
	if int32(*(*uint8)(unsafe.Pointer(uintptr(a7 + 8))))&0x80 != 0 {
		v8 = (*uint32)(unsafe.Pointer(nox_window_new((*nox_window)(unsafe.Pointer(uintptr(a1))), a2, a3, a4, a5, a6, func(arg1 int32, arg2 int32, arg3 int32, arg4 int32) int32 {
			return nox_xxx_wndEditProcPre_488710(arg1, uint32(arg2), (*wchar2_t)(unsafe.Pointer(uintptr(arg3))), arg4)
		})))
...
func nox_xxx_wndEditProcPre_488710(a1 int32, a2 uint32, a3 *wchar2_t, a4 int32) int32 {
	...
	nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(a1 + 52)))))), 16387, int32(uintptr(unsafe.Pointer(a3))), v7, internCStr(__FILE__), __LINE__)
	return 1
}
...
func sub_489870() int32 {
	...
	v0 = 0
	v1 = (*uint8)(memmap.PtrOff(0x5D4594, uint32(v0*44)+1193388))
	if *memmap.PtrUint32(0x5D4594, uint32(v0*4)+1193372) == 2 {
		*(*uint32)(unsafe.Pointer(v1)) = (nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1193380)))), 10028).draw_data.field_0 >> 2) & 1
		...
		v3 = (*wchar2_t)(unsafe.Pointer(uintptr(nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v2)))))), 16413, 0, 0, internCStr(__FILE__), __LINE__))))
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v1))), 4*4))) = uint32(nox_wcstol(v3, nil, 10))
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v1))), 4*1))) = (nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1193380)))), 10029).draw_data.field_0 >> 2) & 1
		v4 = nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1193380)))), 10030).draw_data.field_0
		...
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v1))), 4*2))) = (v4 >> 2) & 1
		if nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1193380)))), 10015).draw_data.field_0&4 != 0 {
			...
			*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v1))), 4*3))) = uint32(v5)
			v6 = int8(*((*uint8)(unsafe.Pointer(&nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1193380)))), 10016).draw_data.field_0))))
		...
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v1))), 4*5))) = (nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1193380)))), 10014).draw_data.field_0 >> 2) & 1
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v1))), 4*10))) = (nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1193380)))), 10018).draw_data.field_0 >> 2) & 1
	}
...
func nox_xxx_checkSomeFlagsOnJoin_4899C0(srv *nox_gui_server_ent_t) int32 {
	...
	v1 = 0
	v2 = v1 * 11
	v3 = int32(*memmap.PtrUint32(0x5D4594, uint32(v1*4)+1193372))
	v4 = (*uint8)(memmap.PtrOff(0x5D4594, uint32(v2*4)+1193388))
	if v3 == 0 {
		return 1
	}
	v5 = v3 - 1
...
func sub_489B80(a1 int32) *uint32 {
	...
	result = (*uint32)(unsafe.Pointer(nox_new_window_from_file(internCStr("filter.wnd"), unsafe.Pointer(funAddr(nox_xxx_windowMplayFilterProc_489E70)))))
	...
	if result != nil {
		...
		v2 = 0
		v3 = (*uint8)(memmap.PtrOff(0x5D4594, uint32(v2*44)+1193388))
		...
		nox_xxx_wndSetProc_46B2C0(*(*int32)(unsafe.Pointer(&dword_5d4594_1193384)), func(arg1 int32, arg2 int32, arg3 int32, arg4 int32) int32 {
		...
		nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v5)))))), 16414, int32(uintptr(unsafe.Pointer(&v13[0]))), -1, internCStr(__FILE__), __LINE__)
		...
		*(*uint32)(unsafe.Add(unsafe.Pointer(v9), 4*9)) |= 4
		...
		v11 = int32(*memmap.PtrUint32(0x5D4594, uint32(v2*4)+1193372))
		if v11 != 0 {
			v12 = v11 - 1
			if v12 != 0 {
				if v12 == 1 {
...
func sub_489DC0() {
	...
	if nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1193384)))), 10028).draw_data.field_0&4 != 0 {
	...
	if nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1193384)))), 10015).draw_data.field_0&4 != 0 {
...
func sub_489FF0(a1 int32, a2 int32, a3 unsafe.Pointer) int32 {
	var result int32
	*memmap.PtrUint32(0x5D4594, uint32(a1*4)+1193372) = uint32(a2)
	result = a1 * 11
	alloc.Memcpy(memmap.PtrOff(0x5D4594, uint32(a1*44)+1193388), a3, 0x2C)
	return result
}
