...
func sub_436F50() int32 {
	...
	if *memmap.PtrUint32(0x852978, 8) != 0 {
		if *memmap.PtrUint32(0x8531A0, 2576) != 0 {
			...
			v9 = nox_strman_loadString_40F1D0(*(**byte)(memmap.PtrOff(0x587000, uint32(int32(*(*uint8)(unsafe.Pointer(uintptr(*memmap.PtrUint32(0x8531A0, 2576) + 2251))))*4+29456))), nil, internCStr("C:\\NoxPost\\src\\client\\System\\client.c"), 1357)
