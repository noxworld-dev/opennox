...
func nox_xxx_guiServerPlayersLoad_456270(a1 int32) int32 {
	...
	*(*uint32)(unsafe.Add(unsafe.Pointer(v7), 4*8)) = uint32(uintptr(unsafe.Pointer(v12)))
	...
	if nox_common_gameFlags_check_40A5C0(128) {
		...
		nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v9)))))), 16385, int32(uintptr(unsafe.Pointer(v10))), -1)
	}
...
func sub_4567C0(a1 int32, a2 int32, a3 *int32, a4 int32) int32 {
	...
	if a2 != 16391 {
		...
		if nox_xxx_wndGetID_46B0A0((*nox_window)(unsafe.Pointer(a3))) == 10502 {
			v3 = sub_4165B0()
			if nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a3)))))), 16404, 0, 0) < 0 {
	...
	if v4 == 10507 {
		...
		v25 = nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v24)))))), 16404, 0, 0)
	...
	if v4 == 4001 {
		...
		v21 = nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v20)))))), 16404, 0, 0)
	...
	v6 = nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v5)))))), 16404, 0, 0)
	if v6 >= 0 {
		sub_456D00(v6, &v30[0])
		...
		if v29 != nil {
			...
			v9 = (*int32)(unsafe.Pointer(uintptr(nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v7)))))), 16404, 0, 0))))
			v10 = v9
			for i = *v9; i >= 0; v10 = (*int32)(unsafe.Add(unsafe.Pointer(v10), 4*1)) {
				v12 = (*wchar2_t)(unsafe.Pointer(uintptr(nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(v8))), 16406, i, 0))))
	...
	nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v17)))))), 16403, -1, 0)
	...
	nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v18)))))), 16403, -1, 0)
	return 0
}
func sub_457010(a1 int32, a2 *wchar2_t) int32 {
	...
	if dword_5d4594_1045684 != 0 {
		...
		nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v4)))))), 16398, v5, 0)
		nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v4)))))), 16402, v5, 0)
		v7 = sub_457120(a1)
		nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v4)))))), 16397, int32(uintptr(unsafe.Pointer(&v9[0]))), int32(v7))
		result = nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v4)))))), 16403, v5, 0)
	}
	return result
}
	...
	if dword_5d4594_1045684 != 0 {
		...
		if result != nil {
			...
			*((*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(v3))), 64))) = sub_457120(int32(uintptr(unsafe.Pointer(result))))
			...
			result = (*byte)(unsafe.Pointer(uintptr(nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v6)))))), 16397, int32(uintptr(unsafe.Pointer(&v8[0]))), int32(*((*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(v3))), 64))))))))
		}
	}
	return result
}
