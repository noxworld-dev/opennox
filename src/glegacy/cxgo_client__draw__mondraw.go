...
func sub_4BC490(a1 int32) int8 {
	...
	*((*uint8)(unsafe.Pointer(&v1))) = uint8(gameFrame())
	if (int32(uint8(gameFrame()))&3) == 0 && *(*uint32)(unsafe.Pointer(uintptr(a1 + 276))) == 8 && *(*uint32)(unsafe.Pointer(uintptr(a1 + 116)))&0x40000 != 0 {
		...
		if v3 != 0 {
			...
			if v4 != 0 {
				if v4 == 2 {
					...
					*((*uint8)(unsafe.Pointer(&v1))) = *(*uint8)(unsafe.Pointer(uintptr(a1 + 299)))
...
func nox_thing_monster_draw(a1 *int32, dr *nox_drawable) int32 {
	...
	if !nox_common_gameFlags_check_40A5C0(0x200000) {
		...
		if int32(*(*uint8)(unsafe.Pointer(uintptr(v2 + 297)))) != int32(v4) {
			...
			if v5 != 1 && v5 != 3 && v5 != 5 {
				if (gameFrame() - *(*uint32)(unsafe.Pointer(uintptr(v2 + 436)))) >= uint32(int32(gameFPS())>>2) {
					*(*uint32)(unsafe.Pointer(uintptr(v2 + 436))) = gameFrame()
