...
func nox_netlist_addToMsgListCli_40EBC0(ind1, ind2 int, buf *uchar, sz int) int {
...
func nox_netlist_clientSendWrap_40ECA0(ind1, ind2 int, buf *uchar, sz int) int {
...
func nox_netlist_addToMsgListSrv_40EF40(ind int, buf *uchar, sz int) bool {
...
func Nox_xxx_netImportant_4E5770(a1 byte, a2 int) {
	nox_xxx_netImportant_4E5770(uchar(a1), int(a2))
}
