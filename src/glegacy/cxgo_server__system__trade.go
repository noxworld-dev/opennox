...
func sub_50F0F0(a1 int32, a2 int32) int32 {
	...
	*(*uint16)(unsafe.Pointer(&v6[0])) = 3529
	...
	v4 = sub_4E39F0_obj_db((*nox_object_t)(unsafe.Pointer(uintptr(v2))))
...
func sub_50F1A0(a1 int32, a2 int32) int32 {
	...
	*(*uint16)(unsafe.Pointer(&v8[0])) = 3273
	...
	if a1 != v2 {
		...
		v6 = sub_4E39F0_obj_db((*nox_object_t)(unsafe.Pointer(*(***byte)(unsafe.Pointer(uintptr(a2 + 12))))))
	} else {
		...
		v6 = sub_4E39F0_obj_db((*nox_object_t)(unsafe.Pointer(uintptr(v4))))
	}
	...
	if result != nil {
		...
		if *(*uint32)(unsafe.Pointer(result)) != 0 {
			...
			if *(*uint32)(unsafe.Add(unsafe.Pointer(v13), 4*2))&0x110 != 0 || (func() func(int32, *uint32, int32, int32) {
				v14 = asFunc(*(*uint32)(unsafe.Add(unsafe.Pointer(v13), 4*177)), (*func(int32, *uint32, int32, int32))(nil)).(func(int32, *uint32, int32, int32))
				return v14
			}()) == nil {
...
func sub_510640_trade(a1 int32, a2 int32, a3 int32, a4 *float32) *float32 {
	...
	if a4 != nil {
		for {
			...
			v13 = asFunc(*(*uint32)(unsafe.Add(unsafe.Pointer(v12), 4*177)), (*func(int32, *uint32, int32, int32))(nil)).(func(int32, *uint32, int32, int32))
			if v13 != nil {
				v13(v4, v12, 1, 1)
			} else {
				nox_xxx_inventoryPutImpl_4F3070((*nox_object_t)(unsafe.Pointer(uintptr(v4))), (*nox_object_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v12)))))), 1)
			}
		...
		nox_xxx_netPriMsgToPlayer_4DA2C0((*nox_object_t)(unsafe.Pointer(uintptr(v4))), internCStr("pickup.c:MaxTradableAnkhsReached"), 0)
	LABEL_36:
		nox_xxx_aud_501960(925, (*nox_object_t)(unsafe.Pointer(uintptr(v4))), 0, 0)
	}
	return result
}
...
func sub_510BE0_trade(a1 *int32, a2 int32, a3 *uint32) *uint32 {
	...
	if v5 != 0 {
		...
		if nox_xxx_ItemIsDroppable_53EBF0(v5) == 1 {
			...
			nox_xxx_aud_501960(307, (*nox_object_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(a1)))))), 2, *(*int32)(unsafe.Add(unsafe.Pointer(a1), 4*9)))
		}
	}
	return result
}
