	...
	*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a8))), 4*10))) = 0
	if v11 != 0 {
		...
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a8))), 4*12))) = uint32(uintptr(v12))
		if v12 == nil {
			alloc.Free(*((*unsafe.Pointer)(unsafe.Add(unsafe.Pointer((*unsafe.Pointer)(unsafe.Pointer(a8))), unsafe.Sizeof(unsafe.Pointer(nil))*6))))
			return nil
		}
	...
	if *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a8))), 4*3))) != 0 {
		...
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a8))), 4*7))) = uint32(uintptr(unsafe.Pointer(nox_gui_newButtonOrCheckbox_4A91A0((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v8)))))), int32(v26|9), a5-10, v22, 10, v23, (*nox_window_data)(unsafe.Pointer(&v25[0]))))))
		*(*[332]byte)(unsafe.Pointer(&v25[0])) = [332]byte{}
		if int32(int8(*((*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(v8))), 4))))) >= 0 {
			*(*uint32)(unsafe.Pointer(&v25[20])) = nox_color_black_2650656
			*(*uint32)(unsafe.Pointer(&v25[44])) = nox_color_black_2650656
		...
		*(*uint32)(unsafe.Pointer(&v25[8])) = 1
		*(*uint32)(unsafe.Pointer(&v25[16])) = uint32(uintptr(unsafe.Pointer(v8)))
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a8))), 4*8))) = uint32(uintptr(unsafe.Pointer(nox_gui_newButtonOrCheckbox_4A91A0((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v8)))))), v17, a5-10, v22+v10-v23, 10, v23, (*nox_window_data)(unsafe.Pointer(&v25[0]))))))
		*(*[332]byte)(unsafe.Pointer(&v25[0])) = [332]byte{}
		if int32(int8(*((*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(v8))), 4))))) >= 0 {
			*(*uint32)(unsafe.Pointer(&v25[20])) = nox_color_black_2650656
			*(*uint32)(unsafe.Pointer(&v25[44])) = nox_color_black_2650656
		...
		*(*uint32)(unsafe.Pointer(&v25[8])) = 8
		v24[3] = 0
		*(*uint32)(unsafe.Pointer(&v25[16])) = uint32(uintptr(unsafe.Pointer(v8)))
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a8))), 4*9))) = uint32(uintptr(unsafe.Pointer(nox_gui_newSlider_4B4EE0(int32(uintptr(unsafe.Pointer(v8))), v17, a5-v19, v22+v23, v19, v10-v23*2, (*uint32)(unsafe.Pointer(&v25[0])), (*float32)(unsafe.Pointer(&v24[0]))))))
	}
	v20 = (*int16)(unsafe.Pointer(new(nox_scrollListBox_data)))
	alloc.Memcpy(unsafe.Pointer(v20), unsafe.Pointer(opts), int(unsafe.Sizeof(nox_scrollListBox_data{})))
