...
func sub_4C3620() *byte {
	...
	for i = 0; i < int32(*(*int16)(unsafe.Pointer(uintptr(v0 + 44)))); i++ {
		v2 = (*wchar2_t)(unsafe.Pointer(uintptr(nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321240))))), 16406, i, 0, internCStr(__FILE__), __LINE__))))
		v3 = int32(uintptr(unsafe.Pointer(nox_xxx_bindevent_bindNameByTitle_42EA40(v2))))
		v4 = (*wchar2_t)(unsafe.Pointer(uintptr(nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321244))))), 16406, i, 0, internCStr(__FILE__), __LINE__))))
		v5 = nox_xxx_keybind_nameByTitle_42E960(v4)
		v6 = (*wchar2_t)(unsafe.Pointer(uintptr(nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321248))))), 16406, i, 0, internCStr(__FILE__), __LINE__))))
...
func sub_4C3760() int32 {
	...
	_ = v11
	result = int32(uintptr(unsafe.Pointer(nox_new_window_from_file(internCStr("InputCfg.wnd"), unsafe.Pointer(funAddr(sub_4C3A90))))))
	...
	if result != 0 {
		...
		if dword_5d4594_1321236 != nil {
			...
			**(**uint32)(unsafe.Add(unsafe.Pointer(v1), unsafe.Sizeof((*uint32)(nil))*9)) = 920
			nox_xxx_wndSetProc_46B2C0(*(*int32)(unsafe.Pointer(&dword_5d4594_1321236)), func(arg1 int32, arg2 int32, arg3 int32, arg4 int32) int32 {
			...
			nox_xxx_wndSetWindowProc_46B300(*(*int32)(unsafe.Pointer(&dword_5d4594_1321244)), func(arg1 int32, arg2 int32, arg3 int32, arg4 int32) int32 {
				return sub_4C3A60((*uint32)(unsafe.Pointer(uintptr(arg1))), uint32(arg2), uint32(arg3), arg4)
			})
			nox_xxx_wndSetWindowProc_46B300(*(*int32)(unsafe.Pointer(&dword_5d4594_1321248)), func(arg1 int32, arg2 int32, arg3 int32, arg4 int32) int32 {
				return sub_4C3A60((*uint32)(unsafe.Pointer(uintptr(arg1))), uint32(arg2), uint32(arg3), arg4)
			})
			...
			nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321240))))), 16408, int32(uintptr(unsafe.Pointer(v2))), 0, internCStr(__FILE__), __LINE__)
			nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321244))))), 16408, int32(uintptr(unsafe.Pointer(v2))), 0, internCStr(__FILE__), __LINE__)
			nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321248))))), 16408, int32(uintptr(unsafe.Pointer(v2))), 0, internCStr(__FILE__), __LINE__)
			...
			nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321240))))), 16409, int32(uintptr(unsafe.Pointer(v3))), 0, internCStr(__FILE__), __LINE__)
			nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321244))))), 16409, int32(uintptr(unsafe.Pointer(v3))), 0, internCStr(__FILE__), __LINE__)
			nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321248))))), 16409, int32(uintptr(unsafe.Pointer(v3))), 0, internCStr(__FILE__), __LINE__)
			v4 = 971
			...
			nox_xxx_wndSetProc_46B2C0(*(*int32)(unsafe.Pointer(&dword_5d4594_1321232)), func(arg1 int32, arg2 int32, arg3 int32, arg4 int32) int32 {
				return sub_4C3A90(arg1, arg2, (*int32)(unsafe.Pointer(uintptr(arg3))), arg4)
			})
			nox_xxx_wndSetWindowProc_46B300(*(*int32)(unsafe.Pointer(&dword_5d4594_1321232)), func(arg1 int32, arg2 int32, arg3 int32, arg4 int32) int32 {
...
func sub_4C3CD0(a1 int32, a2 uint32, a3 int32, a4 int32) int32 {
	...
	if a2 > 0x4007 {
		if a2 == 16393 {
			...
			v8 = sub_4A4800(v7)
			nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321240))))), 16412, v8, 0, internCStr(__FILE__), __LINE__)
			nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321244))))), 16412, v8, 0, internCStr(__FILE__), __LINE__)
			nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321248))))), 16412, v8, 0, internCStr(__FILE__), __LINE__)
		} else if a2 == 16400 {
			v5 = int32(*(*uint32)(unsafe.Pointer(uintptr(a3 + 32))))
			if int32(*(*uint32)(unsafe.Pointer(uintptr(v5 + 48)))) >= 0 {
				dword_5d4594_1321252 = uint32(a3)
				v9 = nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321240))))), 16406, int32(*(*uint32)(unsafe.Pointer(uintptr(v5 + 48)))), 0, internCStr(__FILE__), __LINE__)
		...
		if unsafe.Pointer((*uint32)(unsafe.Pointer(uintptr(a3)))) == unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1321228)))), 921)) || unsafe.Pointer((*uint32)(unsafe.Pointer(uintptr(a3)))) == unsafe.Pointer(nox_xxx_wndGetChildByID_46B0C0((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1321228)))), 922)) {
			nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321240))))), int32(a2), a3, 0, internCStr(__FILE__), __LINE__)
			nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321244))))), int32(a2), a3, 0, internCStr(__FILE__), __LINE__)
			nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1321248))))), int32(a2), a3, 0, internCStr(__FILE__), __LINE__)
			return nox_xxx_wndListboxProcPre_4A30D0((*nox_window)(unsafe.Pointer(uintptr(a1))), a2, uint32(uintptr(unsafe.Pointer((*wchar2_t)(unsafe.Pointer(uintptr(a3)))))), a4)
		}
	}
	return nox_xxx_wndListboxProcPre_4A30D0((*nox_window)(unsafe.Pointer(uintptr(a1))), a2, uint32(uintptr(unsafe.Pointer((*wchar2_t)(unsafe.Pointer(uintptr(a3)))))), a4)
