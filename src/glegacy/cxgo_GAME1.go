...
func sub_409B50(a1 *byte) uint32 {
	...
	alloc.Memcpy(memmap.PtrOff(0x5D4594, 3452), unsafe.Pointer(a1), int(result))
	return result
}
...
func nox_xxx_servGamedataGet_40A020(a1 int16) int16 {
	return int16(*memmap.PtrUint16(0x5D4594, uint32(sub_409A70(a1)*2+3488)))
}
func sub_40A180(a1 int16) uint8 {
	return *memmap.PtrUint8(0x5D4594, uint32(sub_409A70(a1)+3500))
}
...
func sub_40A250() int64 {
	...
	result = int64(int32(*memmap.PtrUint8(0x5D4594, uint32(v1+3500))) * 60000)
...
func nox_xxx_rateUpdate_40A6D0(a1 int32) int32 {
	...
	if uint32(a1) != *memmap.PtrUint32(0x587000, 4728) {
		result = bool2int32(nox_common_gameFlags_check_40A5C0(0x20000))
		if result == 1 {
...
func sub_40A740() int32 {
	var v0 *byte
	v0 = sub_4165B0()
	return bool2int32(nox_common_gameFlags_check_40A5C0(128) && *(*byte)(unsafe.Add(unsafe.Pointer(v0), 53)) < 0)
}
...
func nox_xxx_countNonEliminatedPlayersInTeam_40A830(a1p *nox_team_t) int32 {
	...
	for {
		if nox_xxx_teamCompare2_419180(unsafe.Pointer(uintptr(v2+48)), *(*uint8)(unsafe.Pointer(uintptr(a1 + 57)))) != 0 {
			v3 = int32(*(*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v2 + 748))) + 276))))
			if (int32(*(*uint8)(unsafe.Pointer(uintptr(v3 + 3680))))&1) == 0 && (int32(*(*uint8)(unsafe.Pointer(uintptr(v3 + 2064)))) != 31 || !nox_common_getEngineFlag(nox_engine_flag(NOX_ENGINE_FLAG_DISABLE_GRAPHICS_RENDERING))) {
				v1++
			}
...
func nox_xxx_gamePlayIsAnyPlayers_40A8A0() int32 {
	...
	if !nox_xxx_CheckGameplayFlags_417DA0(4) {
		for i = (*byte)(unsafe.Pointer(nox_common_playerInfoGetFirst_416EA0())); i != nil; i = (*byte)(unsafe.Pointer(nox_common_playerInfoGetNext_416EE0((*nox_playerInfo)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(i))))))))) {
			if *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), 4*514))) != 0 {
				v6 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), 4*920))))
				if (v6&1) == 0 || v6&0x20 != 0 {
					v0++
				}
			}
	...
	for {
		...
		if v2 != 0 {
			for {
				if nox_xxx_teamCompare2_419180(unsafe.Pointer(uintptr(v2+48)), uint8(*(*byte)(unsafe.Add(unsafe.Pointer(v1), 57)))) != 0 {
...
func sub_40AA70(pl *nox_playerInfo) int32 {
	...
	if sub_40A740() == 0 && !nox_common_gameFlags_check_40A5C0(0x8000) {
		goto LABEL_31
	}
...
LABEL_31:
	...
	for *((*int32)(unsafe.Add(unsafe.Pointer((*int32)(unsafe.Pointer(v6))), 4*535))) <= 0 {
...
func nox_xxx_doorAttachWall_410360(a1 int32, a2 int32, a3 int32) *uint8 {
	...
	if result != nil {
		...
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(result))), 4*7))) = uint32(a1)
...
func sub_410390(a1 int32, a2 int32, a3 int32) *uint32 {
	...
	if v3 != nil || (func() bool {
		...
		*(*uint32)(unsafe.Add(unsafe.Pointer(v3), 4*8)) = uint32(a1)
		v7[1] = v5
		*((*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(v3))), 4))) = uint8(int8(int32(v6) | 0x10))
...
func nox_xxx_wallDestroyedByWallid_410520(a1 int16) *int32 {
	...
	if result != nil {
		...
		*(*uint8)(unsafe.Pointer(uintptr(v2 + 4))) |= 0x20
	}
	return result
}
func sub_410550(a1 int16) int32 {
	...
	for int32(*(*uint16)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(v1), 4*3)) + 10)))) != int32(a1) {
...
func nox_xxx_checkFacade_4117E0(tile *nox_tileDef_t) int32 {
	...
	for libc.StrCmp(v1, &tile.name[0]) != 0 {
		v1 = (*byte)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v2))), 4*1))))))
		v2 = (*uint8)(unsafe.Add(unsafe.Pointer(v2), 4))
		if v1 == nil {
			return 0
		}
...
func nox_thing_read_EDGE_411850(f *nox_memfile, a2 *uint8) int32 {
	...
	v29[v30] = 0
	libc.StrCpy((*byte)(memmap.PtrOff(0x85B3FC, uint32(v5*20+28644))), &v29[0])
	...
	*memmap.PtrUint8(0x85B3FC, uint32(v12+28698)) = uint8(int8(v9))
	*memmap.PtrUint16(0x85B3FC, uint32(v12+28690)) = 0
	*((*uint8)(unsafe.Pointer(&v9))) = nox_memfile_read_u8(f)
	v14 = int32(dword_5d4594_251572 * 60)
	*memmap.PtrUint8(0x85B3FC, uint32(v14+28699)) = uint8(int8(v9))
	...
	*memmap.PtrUint8(0x85B3FC, uint32(v20+28696)) = v19
	*memmap.PtrUint16(0x85B3FC, uint32(v20+28688)) = uint16(int16((int32(v17) + int32(v19)) * 2))
	*memmap.PtrUint32(0x85B3FC, uint32(v20+28676)) = 0
...
func sub_4133D0(a1 int32) int32 {
	...
	return bool2int32(*(*uint32)(unsafe.Pointer(uintptr(a1 + 8)))&0x13001000 != 0 && *(*uint32)(unsafe.Pointer(uintptr(v2 + 4))) == uint32(v1))
}
func sub_413420(a1 int8) int32 {
	...
	if *memmap.PtrUint32(0x5D4594, 251624) == 0 {
		...
		for {
			*(*uint32)(unsafe.Pointer(v1)) = uint32(uintptr(unsafe.Pointer(nox_xxx_gLoadImg_42F970(*((**byte)(unsafe.Add(unsafe.Pointer((**byte)(unsafe.Pointer(v1))), -int(unsafe.Sizeof((*byte)(nil))*1))))))))
...
func sub_413890() *byte {
	...
	*memmap.PtrUint8(0x5D4594, 251637) = 0
	...
	v0 = (*uint8)(memmap.PtrOff(0x5D4594, uint32(libc.StrLen((*byte)(memmap.PtrOff(0x5D4594, 251636)))+251637)))
...
func nox_xxx_checkGameFlagPause_413A50() int32 {
	return bool2int32(nox_common_gameFlags_check_40A5C0(0x40000))
}
	...
	if *memmap.PtrUint32(0x5D4594, 338304) != 0 {
		for {
			...
			if v0 > 0 {
				...
				v0 = v9
				*memmap.PtrUint32(0x5D4594, uint32(v4*84)+252364) += *(*uint32)(unsafe.Pointer(uintptr(v3 + 16)))
			}
		LABEL_10:
			if v4 == v0 {
				*memmap.PtrUint32(0x5D4594, uint32(v4*84)+252364) = *(*uint32)(unsafe.Pointer(uintptr(v3 + 16)))
				libc.StrCpy((*byte)(memmap.PtrOff(0x5D4594, uint32(v4*84)+252284)), (*byte)(unsafe.Pointer(uintptr(v3+20))))
				v9 = func() int32 {
					p := &v0
					*p++
					return *p
...
func sub_414BD0(a1 int32) int32 {
	...
	return int32(*memmap.PtrUint32(0x85B3FC, uint32(((v1<<12)/25736)*4+12260)))
}
...
func nox_thing_read_FLOR_414DB0(f *nox_memfile) int32 {
	...
	v12 = *v11
	f.cur = (*byte)(unsafe.Pointer((*int32)(unsafe.Add(unsafe.Pointer(v11), 4*1))))
...
func nox_thing_read_WALL_414F60(f *nox_memfile, a2 unsafe.Pointer) int32 {
	var (
	...
	v3 = a2
	v20 = a1
	v4 = (*uint8)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(a1), 4*2)) + 4)))
	...
	for {
		...
		if int32(uint8(int8(v21))) > 0 {
			...
			for {
				v12 = 4
				for {
					v13 = (*int32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v2), 4*2)) + 8)))
...
func nox_thing_skip_spells_415100(f *nox_memfile) int32 {
	...
	v2 = *v1
	*(*uint32)(unsafe.Pointer(uintptr(a1 + 8))) = uint32(uintptr(unsafe.Pointer((*int32)(unsafe.Add(unsafe.Pointer(v1), 4*1)))))
	if v2 <= 0 {
		return 1
	}
	v3 = v2
...
func nox_thing_read_image_415240(f *nox_memfile) int32 {
	...
	v3 = *v2
	*(*uint32)(unsafe.Pointer(uintptr(a1 + 8))) = uint32(uintptr(unsafe.Pointer((*int32)(unsafe.Add(unsafe.Pointer(v2), 4*1)))))
	if v3 <= 0 {
		return 1
	}
	for v4 = v3; v4 != 0; v4-- {
...
func nox_thing_read_audio_415660(a1p *nox_memfile, a2 *byte) int32 {
	...
	v4 = *v3
	*(*uint32)(unsafe.Pointer(uintptr(a1 + 8))) = uint32(uintptr(unsafe.Pointer((*int32)(unsafe.Add(unsafe.Pointer(v3), 4*1)))))
	if v4 <= 0 {
		return 1
	}
...
func sub_415840(a1 int32) int32 {
	...
	for i = (*uint8)(memmap.PtrOff(0x587000, 33064)); unsafe.Pointer(*((**byte)(unsafe.Add(unsafe.Pointer((**byte)(unsafe.Pointer(i))), unsafe.Sizeof((*byte)(nil))*2)))) != unsafe.Pointer(uintptr(a1)); i = (*uint8)(unsafe.Add(unsafe.Pointer(i), 12)) {
		v3 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), 4*3))))
		v1++
		if v3 == 0 {
			return 0
		}
	}
	return int32(*memmap.PtrUint32(0x587000, uint32(v1*12+33068)))
}
func nox_xxx_ammoCheck_415880(typ_ind uint16) int32 {
	...
	return int32(*memmap.PtrUint32(0x587000, uint32(v1*12+33072)))
}
...
func sub_4159B0(a1 *byte) *byte {
	...
	return *(**byte)(memmap.PtrOff(0x587000, uint32(v1*12+33064)))
}
func sub_4159F0(a1 int32) int32 {
	...
	for i = (*uint8)(memmap.PtrOff(0x587000, 33392)); *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), 4*2))) != uint32(a1); i = (*uint8)(unsafe.Add(unsafe.Pointer(i), 12)) {
		v3 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), 4*3))))
		v1++
		if v3 == 0 {
			return 0
	...
	return int32(*memmap.PtrUint32(0x587000, uint32(v1*12+33392)))
}
func sub_415BD0(a1 int32) float64 {
	...
	if *(*uint32)(unsafe.Pointer(uintptr(a1 + 8)))&0x2000000 != 0 && (func() *float32 {
		v1 = (*float32)(nox_xxx_equipClothFindDefByTT_413270(int32(*(*uint16)(unsafe.Pointer(uintptr(a1 + 4))))))
		return v1
	}()) != nil {
...
func nox_xxx_itemApplyDefendEffect_415C00(a1 int32) float64 {
	...
	v4 = *v1
	if *v1 != 0 {
		v5 = *(*func(int32, int32, uint32, int32, uint32, *float32))(unsafe.Pointer(uintptr(v4 + 76)))
		if v5 != nil {
			v5(v4, a1, 0, a1, 0, &v6)
		}
	}
	...
	*(*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(&v2))), unsafe.Sizeof(uint16(0))*1)) = 0
	for i = (*uint8)(memmap.PtrOff(0x587000, 34848)); ; i = (*uint8)(unsafe.Add(unsafe.Pointer(i), 24)) {
		*(*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(&v2))), unsafe.Sizeof(uint16(0))*0)) = item.typ_ind
		if uint32(v2) == *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), 4*2))) {
			break
		}
		v4 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), 4*6))))
		result++
		if v4 == 0 {
			return -1
		}
...
func sub_415CD0(a1 int32) int32 {
	...
	for i = (*uint8)(memmap.PtrOff(0x587000, 34848)); unsafe.Pointer(uintptr(a1)) != unsafe.Pointer(*((**byte)(unsafe.Add(unsafe.Pointer((**byte)(unsafe.Pointer(i))), unsafe.Sizeof((*byte)(nil))*3)))); i = (*uint8)(unsafe.Add(unsafe.Pointer(i), 24)) {
		v3 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), 4*6))))
		v1++
		if v3 == 0 {
			return 0
		}
	}
	return int32(*memmap.PtrUint32(0x587000, uint32(v1*24+34856)))
}
...
func sub_415DA0(a1 *wchar2_t) int32 {
	...
	return int32(*memmap.PtrUint32(0x587000, uint32(v1*12+35504)))
}
func sub_415DF0(a1 *byte) int32 {
	...
	for nox_strcmpi(a1, *v2) != 0 {
		v4 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v3))), 4*6))))
...
func sub_415E40(a1 *byte) *byte {
	...
	return *(**byte)(memmap.PtrOff(0x587000, uint32(v1*24+34848)))
}
func sub_415E80(a1 int32) int32 {
	...
	for i = (*uint8)(memmap.PtrOff(0x587000, 35496)); *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), 4*2))) != uint32(a1); i = (*uint8)(unsafe.Add(unsafe.Pointer(i), 12)) {
		v3 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), 4*3))))
		v1++
		if v3 == 0 {
			return 0
	...
	return int32(*memmap.PtrUint32(0x587000, uint32(v1*12+35496)))
}
func sub_4161E0() int32 {
	...
	v9 = 0
	for {
		if *memmap.PtrUint32(0x5D4594, uint32(int32(v9)*4+(371380+24))) != uint32(v15[v9]) {
			break
		}
		v9 = func() uint8 {
			p := &v6
	...
	v10 = 0
	for {
		if (*memmap.PtrUint8(0x5D4594, uint32(int32(v10)+(371380+44)))) != uint8(v11[v10]) {
			break
		}
		v10 = func() uint8 {
			p := &v7
...
func nox_xxx_cliGamedataGet_416590(a1 int32) *byte {
	return (*byte)(memmap.PtrOff(0x5D4594, uint32(a1*58)+371380))
}
func sub_4165B0() *byte {
	return (*byte)(memmap.PtrOff(0x5D4594, *memmap.PtrUint32(0x5D4594, 371688)*58+371380))
}
...
func sub_4165F0(a1 int32, a2 int32) int32 {
	var result int32
	result = a2
	alloc.Memcpy(memmap.PtrOff(0x5D4594, uint32(a2*58)+371380), memmap.PtrOff(0x5D4594, uint32(a1*58)+371380), 0x3A)
	return result
}
...
func sub_416690() {
	...
	if false {
		...
		if nox_xxx_isQuest_4D6F50() != 0 {
			...
			*(*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(&v2))), unsafe.Sizeof(int16(0))-1)) |= 0x10
...
func sub_416720() {
	...
	for v2 != 0 {
		...
		if *(*uint32)(unsafe.Pointer(uintptr(v2 + 68))) != 0 || (*(*uint32)(unsafe.Pointer(uintptr(v2 + 64)))) != 0 {
			if uint64(nox_platform_get_ticks()) > *(*uint64)(unsafe.Pointer(uintptr(v2 + 64))) {
				sub_416820(v0)
			}
		}
		v0++
...
func sub_416770(a1 int32, a2 *wchar2_t, a3 *byte) *int32 {
	...
	nox_common_list_append_4258E0((*nox_list_item_t)(unsafe.Pointer(uintptr(int32(uintptr(memmap.PtrOff(0x5D4594, 371500)))))), (*nox_list_item_t)(unsafe.Pointer(v3)))
	if a1 != 0 {
		*((*uint64)(unsafe.Add(unsafe.Pointer((*uint64)(unsafe.Pointer(v3))), unsafe.Sizeof(uint64(0))*8))) = uint64(uint32(a1*60000) + nox_platform_get_ticks())
	} else {
		...
		*(*int32)(unsafe.Add(unsafe.Pointer(i), 4*535)) = 0
		if a1 != 0 {
			if *(*int32)(unsafe.Add(unsafe.Pointer(i), 4*514)) != 0 {
				nox_xxx_netReportLesson_4D8EF0((*nox_object_t)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(i), 4*514))))))
			}
		}
...
func nox_xxx_playerByName_4170D0(a1 *wchar2_t) *byte {
	...
	for _nox_wcsicmp((*wchar2_t)(unsafe.Add(unsafe.Pointer((*wchar2_t)(unsafe.Pointer(v1))), unsafe.Sizeof(wchar2_t(0))*2352)), a1) != 0 {
...
func nox_xxx_netMarkMinimapObject_417190(a1 int32, a2p *nox_object_t, a3 int32) int32 {
	var (
	...
	*v8 = uint32(a3)
	v9 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v5))), 4*1145))))
	if v9 != 0 {
		*(*uint32)(unsafe.Add(unsafe.Pointer(v8), 4*2)) = uint32(v9)
		v10 = int32(*(*uint32)(unsafe.Add(unsafe.Pointer(v8), 4*2)))
		*(*uint32)(unsafe.Add(unsafe.Pointer(v8), 4*3)) = *(*uint32)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v5))), 4*1145))) + 12)))
		*(*uint32)(unsafe.Pointer(uintptr(v10 + 12))) = uint32(uintptr(unsafe.Pointer(v8)))
		*(*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v8), 4*3)) + 8))) = uint32(uintptr(unsafe.Pointer(v8)))
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v5))), 4*1145))) = uint32(uintptr(unsafe.Pointer(v8)))
	} else {
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v5))), 4*1145))) = uint32(uintptr(unsafe.Pointer(v8)))
	...
	nox_xxx_unitSetXStatus_4E4800((*nox_object_t)(unsafe.Pointer(uintptr(a2))), int32(uintptr(unsafe.Pointer((*int32)(unsafe.Pointer(uintptr(1)))))))
	v3 = 1
	return v3
}
func sub_417270(a1 int32) int32 {
	...
	if a1 >= 0 && a1 < NOX_PLAYERINFO_MAX {
		var pl *nox_playerInfo = nox_common_playerInfoFromNumRaw(a1)
		v2 = int32(uintptr(pl.field_4580))
		if v2 != 0 {
...
func nox_xxx_netUnmarkMinimapObj_417300(a1 int32, a2p *nox_object_t, a3 int32) int32 {
	var (
		a2     int32 = int32(uintptr(unsafe.Pointer(a2p)))
		result int32
		v4     *uint8
		...
		if a2 != 0 {
			...
			if v5 != nil {
				for {
					...
					if unsafe.Pointer(uintptr(v6)) != pl.field_4580 {
				...
				*v5 &= uint32(^a3)
				if v7 {
					v8 = (*uint32)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v4))), 4*1145))))))
					if (*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Add(unsafe.Pointer(v8), 4*2))))) == v8 {
						*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v4))), 4*1145))) = 0
					} else {
						if v8 == v5 {
							*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v4))), 4*1145))) = *(*uint32)(unsafe.Add(unsafe.Pointer(v5), 4*2))
						}
...
func nox_xxx_playerMapTracksObj_4173D0(a1 int32, a2p *nox_object_t) int32 {
	var (
		a2     int32 = int32(uintptr(unsafe.Pointer(a2p)))
		result int32
		v3     int32
	...
	if a1 >= 0 && a1 < NOX_PLAYERINFO_MAX {
		if a2 != 0 {
			var pl *nox_playerInfo = nox_common_playerInfoFromNumRaw(a1)
			v3 = int32(uintptr(pl.field_4580))
			if v3 != 0 {
				for *(*uint32)(unsafe.Pointer(uintptr(v3 + 4))) != uint32(a2) {
					v3 = int32(*(*uint32)(unsafe.Pointer(uintptr(v3 + 8))))
					if unsafe.Pointer(uintptr(v3)) == pl.field_4580 || v3 == 0 {
						return result
					}
				}
				result = 1
...
func nox_xxx_netUnmarkMinimapSpec_417470(a1 int32, a2 int32) *byte {
	...
	for i = int32(uintptr(unsafe.Pointer(result))); result != nil; i = int32(uintptr(unsafe.Pointer(result))) {
		nox_xxx_netUnmarkMinimapObj_417300(int32(*(*uint8)(unsafe.Pointer(uintptr(i + 2064)))), (*nox_object_t)(unsafe.Pointer(uintptr(a1))), a2)
...
func nox_xxx_netMarkMinimapForAll_4174B0(a1 int32, a2 int32) *byte {
	...
	result = (*byte)(unsafe.Pointer(nox_common_playerInfoGetFirst_416EA0()))
	for i = int32(uintptr(unsafe.Pointer(result))); result != nil; i = int32(uintptr(unsafe.Pointer(result))) {
		nox_xxx_netMarkMinimapObject_417190(int32(*(*uint8)(unsafe.Pointer(uintptr(i + 2064)))), (*nox_object_t)(unsafe.Pointer(uintptr(a1))), a2)
		result = (*byte)(unsafe.Pointer(nox_common_playerInfoGetNext_416EE0((*nox_playerInfo)(unsafe.Pointer(uintptr(i))))))
	}
	return result
}
func nox_xxx_netNeedTimestampStatus_4174F0(a1p *nox_playerInfo, a2 int32) int32 {
	var (
		a1     int32 = int32(uintptr(unsafe.Pointer(a1p)))
		result int32
	)
...
func nox_xxx_playerUnsetStatus_417530(a1p *nox_playerInfo, a2 int32) int8 {
	...
	*(*uint32)(unsafe.Pointer(uintptr(a1 + 3680))) &= uint32(^a2)
	...
	if v2 != 0 {
		if a2&1 != 0 {
			v2 = bool2int32(nox_common_gameFlags_check_40A5C0(128))
			if v2 == 0 {
		...
		if a2&0x423 != 0 {
			*((*uint8)(unsafe.Pointer(&v2))) = uint8(int8(nox_xxx_netReportPlayerStatus_417630((*nox_playerInfo)(unsafe.Pointer(uintptr(a1))))))
		}
	}
	return int8(v2)
}
func nox_xxx_sendAllClientStatus_4175C0(a1 int32) *byte {
	...
	for i = int32(uintptr(unsafe.Pointer(result))); result != nil; i = int32(uintptr(unsafe.Pointer(result))) {
		...
		*(*uint32)(unsafe.Pointer(&v4[3])) = *(*uint32)(unsafe.Pointer(uintptr(i + 3680))) & 0x423
...
func nox_xxx_netReportPlayerStatus_417630(pl *nox_playerInfo) int32 {
	...
	v2 = int32(*(*uint32)(unsafe.Pointer(uintptr(a1 + 3680))) & 0x423)
	v4[0] = 106
...
func nox_xxx_cliPlayerRespawn_417680(a1 int32, a2 int8) {
	...
	if int32(*(*uint8)(unsafe.Pointer(uintptr(v2 + 2251)))) != 0 || nox_common_gameFlags_check_40A5C0(2048) {
		*((*uint8)(unsafe.Pointer(&a1))) = math.MaxUint8
		v11 = int32(uintptr(nox_xxx_modifGetDescById_413330(int32(*(*uint32)(unsafe.Pointer(uintptr(v10 + 4))) + uint32(*(*uint8)(unsafe.Pointer(uintptr(v2 + 2269))))))))
		...
		*(*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(&a1))), 2)) = *((*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(nox_xxx_modifGetDescById_413330(int32(*(*uint32)(unsafe.Pointer(uintptr(v10 + 4)))+uint32(v12))))), 4)))
		*(*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(&a1))), 4-1)) = math.MaxUint8
		if int32(a2)&1 != 0 {
	...
	*((*uint8)(unsafe.Pointer(&a1))) = math.MaxUint8
	*(*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(&a1))), 1)) = *((*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(nox_xxx_modifGetDescById_413330(int32(*(*uint32)(unsafe.Pointer(uintptr(v10 + 4)))+uint32(*(*uint8)(unsafe.Pointer(uintptr(v2 + 2268)))))))), 4)))
	*(*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(&a1))), unsafe.Sizeof(uint16(0))*1)) = math.MaxUint16
	...
	v13 = int8(*((*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(nox_xxx_modifGetDescById_413330(int32(*(*uint32)(unsafe.Pointer(uintptr(v10 + 4)))+uint32(*(*uint8)(unsafe.Pointer(uintptr(v2 + 2272)))))))), 4))))
	v14 = int32(*(*uint8)(unsafe.Pointer(uintptr(v2 + 2271))))
	*((*uint8)(unsafe.Pointer(&a1))) = uint8(v13)
	*(*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(&a1))), 1)) = *((*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(nox_xxx_modifGetDescById_413330(int32(*(*uint32)(unsafe.Pointer(uintptr(v10 + 4)))+uint32(v14))))), 4)))
	*(*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(&a1))), unsafe.Sizeof(uint16(0))*1)) = math.MaxUint16
	if int32(a2)&4 != 0 {
	...
	if int32(v15) == 1 {
		if nox_common_gameFlags_check_40A5C0(2048) {
			...
			*(*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(unsafe.Pointer(&a1))), 2)) = *((*uint8)(unsafe.Add(unsafe.Pointer((*uint8)(nox_xxx_modifGetDescById_413330(v17))), 4)))
...
func nox_xxx_clientEquipWeaponArmor_417AA0(a1 int8, a2 int32, a3 int32, a4 int32) *byte {
	...
	if result != nil {
		if int32(a1) == 81 || int32(a1) == 80 {
			...
			*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(result))), 4*1))) |= uint32(a3)
			v10 = 0
			...
			*(*uint32)(unsafe.Add(unsafe.Pointer(result), v10*24+2324)) = uint32(a3)
			...
			for {
				result = (*byte)(nox_xxx_modifGetDescById_413330(int32(*(*uint8)(unsafe.Pointer(uintptr(v11 + a4))))))
			...
			*(*uint32)(unsafe.Add(unsafe.Pointer(result), v6*24+2972)) = uint32(a3)
			...
			for {
				result = (*byte)(nox_xxx_modifGetDescById_413330(int32(*(*uint8)(unsafe.Pointer(uintptr(v7 + a4))))))
...
func sub_417B80(a1 int8, a2 int32, a3 int32) *byte {
	...
	if result != nil {
		v4 = ^a3
		if int32(a1) == 84 {
			v5 = int32(uint32(v4) & *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(result))), 4*1))))
			v6 = 0
			*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(result))), 4*1))) = uint32(v5)
...
func sub_417DE0() int8 {
	...
	for i = (*byte)(unsafe.Pointer(nox_server_teamFirst_418B10())); i != nil; i = (*byte)(unsafe.Pointer(nox_server_teamNext_418B60((*nox_team_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(i))))))))) {
		if *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), 4*15))) != 0 {
			v0++
		}
	}
	return v0
...
func nox_xxx_mapInfoSetFlagball_417F30() int8 {
	...
	*((*uint8)(unsafe.Pointer(&v0))) = uint8(int8(bool2int32(sub_417EC0())))
	if v0 != 0 {
		sub_455F60()
		*((*uint8)(unsafe.Pointer(&v0))) = uint8(int8(sub_417F50(0)))
	}
	return int8(v0)
}
func sub_417F50(a1 int32) int32 {
	...
	for {
		if uint32(*(*uint16)(unsafe.Pointer(uintptr(v4 + 4)))) == dword_5d4594_527656 {
			if v3 == 0 {
				break
			}
			v3--
		}
		v4 = int32(uintptr(unsafe.Pointer(nox_server_getNextObject_4DA7A0((*nox_object_t)(unsafe.Pointer(uintptr(v4)))))))
		if v4 == 0 {
			return 0
		}
	}
	...
	if a1 != 0 {
		for i = int32(uintptr(unsafe.Pointer(nox_xxx_getFirstPlayerUnit_4DA7C0()))); i != 0; i = int32(uintptr(unsafe.Pointer(nox_xxx_getNextPlayerUnit_4DA7F0((*nox_object_t)(unsafe.Pointer(uintptr(i))))))) {
			if *(*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(i + 748))) + 276))) + 3628))) == uint32(a1) {
				nox_xxx_playerCameraUnlock_4E6040((*nox_object_t)(unsafe.Pointer(uintptr(i))))
				nox_xxx_playerCameraFollow_4E6060((*nox_object_t)(unsafe.Pointer(uintptr(i))), (*nox_object_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v7)))))))
			}
		}
...
func nox_xxx_mapInfoSetKotr_4180D0() int32 {
	...
	if v0 != 0 {
		for {
			v1 = int32(uintptr(unsafe.Pointer(nox_server_getNextObject_4DA7A0((*nox_object_t)(unsafe.Pointer(uintptr(v0)))))))
	...
	for i = (*byte)(unsafe.Pointer(nox_server_teamFirst_418B10())); i != nil; i = (*byte)(unsafe.Pointer(nox_server_teamNext_418B60((*nox_team_t)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(i))))))))) {
		*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), 4*19))) = 0
	}
	v3 = 0
	v4 = int32(uintptr(unsafe.Pointer(nox_server_getFirstObject_4DA790())))
	if v4 == 0 {
	...
	for {
		v5 = int32(uintptr(unsafe.Pointer(nox_server_getNextObject_4DA7A0((*nox_object_t)(unsafe.Pointer(uintptr(v4)))))))
		if uint32(*(*uint16)(unsafe.Pointer(uintptr(v4 + 4)))) != *memmap.PtrUint32(0x5D4594, 527652) {
			v4 = v5
			continue
		}
		v3++
		*(*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v4 + 748))) + 4))) = 0
		...
		v8 = (*byte)(unsafe.Pointer(nox_xxx_getTeamByID_418AB0(int32(*(*uint8)(unsafe.Pointer(uintptr(v4 + 52)))))))
		if v8 != nil {
			*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v8))), 4*19))) = uint32(v4)
			nox_xxx_netMarkMinimapForAll_4174B0(v4, 1)
		}
		v4 = v5
		if v5 == 0 {
...
func sub_4181F0(a1 int32) {
	...
	for {
		...
		if v5 != 0 && (*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v4))), 4*515))) != nox_player_netCode_85319C || !nox_common_getEngineFlag(nox_engine_flag(NOX_ENGINE_FLAG_DISABLE_GRAPHICS_RENDERING))) {
			v6 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v4))), 4*920))))
			if ((v6&1) == 0 || v6&0x20 != 0) && nox_xxx_servObjectHasTeam_419130(v5+48) == 0 {
				v7 = int32(v19)
				v19 = func() uint8 {
					p := &v1
					*p++
				...
				v22[v7] = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v4))), 4*514))))
			}
		}
...
func sub_4183C0() int32 {
	...
	for i = result; result != 0; i = result {
		...
		if v2 == 0 || ((func() bool {
			...
			v5 = (*byte)(unsafe.Pointer(nox_xxx_getTeamByID_418AB0(int32(*(*uint8)(unsafe.Pointer(uintptr(i + 52)))))))
			v6 = 0
			v12 = 1e+09
			v7 = (*byte)(unsafe.Pointer(nox_server_teamFirst_418B10()))
			if v7 != nil {
				for {
					v8 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v7))), 4*18))))
					if v8 != 0 {
				...
				if v6 != 0 {
					if v5 != nil {
						if (*byte)(unsafe.Pointer(uintptr(v6))) != v5 {
							sub_4196D0(unsafe.Pointer(uintptr(i+48)), unsafe.Pointer(uintptr(v6)), int32(*(*uint32)(unsafe.Pointer(uintptr(i + 36)))), 0)
						}
					} else {
...
func sub_4184D0(a1p *nox_team_t) {
	...
	if a1 != nil {
		sub_457230(a1)
		*(*uint32)(unsafe.Pointer(&v3[6])) = *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a1))), 4*15)))
		...
		*(*uint32)(unsafe.Pointer(&v3[10])) = *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(a1))), 4*13)))
		v3[14] = 0
		...
		*((*uint16)(unsafe.Add(unsafe.Pointer((*uint16)(unsafe.Pointer(v2))), unsafe.Sizeof(uint16(0))*8))) = *(*uint16)(unsafe.Pointer(&v3[16]))
		alloc.Memcpy(unsafe.Add(unsafe.Pointer((*byte)(unsafe.Pointer(v2))), 18), unsafe.Pointer(a1), int(int32(uint8(v3[15]))*2))
...
func nox_xxx_wndGuiTeamCreate_4185B0() int32 {
	...
	for i = result; result != 0; i = result {
		if *(*uint32)(unsafe.Pointer(uintptr(i + 8)))&0x10000000 != 0 {
			v2 = (*byte)(unsafe.Pointer(nox_xxx_getTeamByID_418AB0(int32(*(*uint8)(unsafe.Pointer(uintptr(i + 52)))))))
			if v2 != nil {
				v3 = sub_4ECBD0(i)
				v4 = int8(v3)
				...
				*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v2))), 4*18))) = uint32(i)
			}
		}
...
func nox_xxx_teamAssignFlags_418640() int32 {
	...
	for i = result; result != 0; i = result {
		if *(*uint32)(unsafe.Pointer(uintptr(i + 8)))&0x10000000 != 0 {
			...
			v3 = (*byte)(unsafe.Pointer(nox_xxx_getTeamByID_418AB0(int32(*(*uint8)(unsafe.Pointer(uintptr(i + 52)))))))
			if v3 != nil {
				*(*byte)(unsafe.Add(unsafe.Pointer(v3), 56)) = byte(v2)
				*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v3))), 4*18))) = uint32(i)
			}
		}
		result = int32(uintptr(unsafe.Pointer(nox_server_getNextObject_4DA7A0((*nox_object_t)(unsafe.Pointer(uintptr(i)))))))
	}
...
func nox_xxx_toggleAllTeamFlags_418690(a1 int32) *byte {
	...
	for i = result; result != nil; i = result {
		if *((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), 4*18))) != 0 {
			v3 = int32(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(i))), 4*18))))
			if a1 != 0 {
