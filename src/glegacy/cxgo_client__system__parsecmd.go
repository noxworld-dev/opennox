...
func nox_cmd_set_name(tokInd int32, tokCnt int32, tokens **wchar2_t) int32 {
	...
	v13[0] = 0
	if tokInd < tokCnt {
		v12 = (*uint32)(unsafe.Pointer((**wchar2_t)(unsafe.Add(unsafe.Pointer(tokens), unsafe.Sizeof((*wchar2_t)(nil))*uintptr(tokInd)))))
		for {
...
func nox_cmd_list_users(tokInd int32, tokCnt int32, tokens **wchar2_t) int32 {
	...
	for i = (*byte)(unsafe.Pointer(nox_common_playerInfoGetFirst_416EA0())); i != nil; i = (*byte)(unsafe.Pointer(nox_common_playerInfoGetNext_416EE0((*nox_playerInfo)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(i))))))))) {
		...
		nox_gui_console_Printf_450C00(uint8(int8(NOX_CONSOLE_RED)), (*wchar2_t)(memmap.PtrOff(0x587000, 106604)), &v5[0])
	}
	return 1
}
	...
	if true {
		...
		if *memmap.PtrUint32(0x587000, 94400) != 0 {
			...
			for _nox_wcsicmp(v5, *(**wchar2_t)(unsafe.Add(unsafe.Pointer(tokens), unsafe.Sizeof((*wchar2_t)(nil))*uintptr(tokInd)))) != 0 {
				v5 = (*wchar2_t)(unsafe.Pointer(uintptr(*((*uint32)(unsafe.Add(unsafe.Pointer((*uint32)(unsafe.Pointer(v7))), 4*2))))))
...
func nox_cmd_list_maps(tokInd int32, tokCnt int32, tokens **wchar2_t) int32 {
	...
	for i = 1; v0 != nil; i++ {
		sub_4417E0((*wchar2_t)(memmap.PtrOff(0x5D4594, 822404)), (*byte)(unsafe.Add(unsafe.Pointer((*byte)(unsafe.Pointer(v0))), 12)))
		if (i % 4) == 0 {
	...
	if !v2 {
		nox_gui_console_Printf_450C00(uint8(int8(NOX_CONSOLE_RED)), (*wchar2_t)(memmap.PtrOff(0x587000, 103284)), memmap.PtrOff(0x5D4594, 822404))
	}
	return 1
}
