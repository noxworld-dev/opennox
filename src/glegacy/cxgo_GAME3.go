...
func nox_xxx_wndListboxProcPre_4A30D0(win *nox_window, ev uint32, a3 uint32, a4 int32) int32 {
	...
	if ev > 0x4007 {
		...
		case 0x400E:
			...
			for i := int32(ind); i < v12-1; i++ {
				alloc.Memcpy(unsafe.Pointer((*nox_scrollListBox_item)(unsafe.Add(unsafe.Pointer(sdata.items), unsafe.Sizeof(nox_scrollListBox_item{})*uintptr(i)))), unsafe.Pointer((*nox_scrollListBox_item)(unsafe.Add(unsafe.Pointer(sdata.items), unsafe.Sizeof(nox_scrollListBox_item{})*uintptr(i+1)))), unsafe.Sizeof(nox_scrollListBox_item{}))
			}
	...
	if ev == 23 {
		...
		nox_window_call_field_94_fnc(win.DrawData().Window, 16387, int32(a3), v7)
		return 1
	}
	return 0
}
...
func nox_xxx_wndListBoxAddLine_4A3AC0(a1 *wchar2_t, a2 int32, a3 *uint32) int32 {
	...
	if a2 >= 17 || a2 < 0 {
		...
		*(*uint32)(unsafe.Pointer(uintptr(*(*uint32)(unsafe.Pointer(uintptr(v4 + 24))) + uint32(int32(*(*int16)(unsafe.Pointer(uintptr(v4 + 46))))*524) + 516))) = **(**uint32)(memmap.PtrOff(0x85B3FC, uintptr(a2*4+132)))
	}
...
func nox_xxx_wndListboxInit_4A3C00(a1 int32, a2 int32) {
	if a1 != 0 {
		if int32(int8(*(*uint8)(unsafe.Pointer(uintptr(a1 + 4))))) >= 0 {
			nox_xxx_wndSetDrawFn_46B340(a1, funAddrP(nox_xxx_wndListboxDrawNoImage_4A3C50))
		} else {
			nox_xxx_wndSetDrawFn_46B340(a1, funAddrP(nox_xxx_wndListboxDrawWithImage_4A3FC0))
		}
		if *(*uint32)(unsafe.Pointer(uintptr(a2 + 16))) != 0 {
			nox_xxx_wndSetWindowProc_46B300(a1, funAddrP(nox_xxx_wndListboxProcWithData10_4A2DE0))
		} else {
			nox_xxx_wndSetWindowProc_46B300(a1, funAddrP(nox_xxx_wndListboxProcWithoutData10_4A28E0))
		}
	}
}
...
func nox_game_showSelClass_4A4840() int32 {
	...
	result = int32(uintptr(unsafe.Pointer(nox_new_window_from_file(internCStr("SelClass.wnd"), funAddrP(sub_4A4A20)))))
	...
	if result != 0 {
		...
		if result != 0 {
			...
			nox_wnd_xxx_1307732.Func12Ptr = funAddrP(sub_4A4970)
			nox_wnd_xxx_1307732.FncDoneOutPtr = funAddrP(sub_4A49A0)
			...
			nox_xxx_wndSetDrawFn_46B340(int32(uintptr(unsafe.Pointer(v1))), funAddrP(sub_4A49D0))
			...
			nox_xxx_wndSetDrawFn_46B340(int32(uintptr(unsafe.Pointer(v2))), funAddrP(sub_4A49D0))
			...
			nox_xxx_wndSetDrawFn_46B340(int32(uintptr(unsafe.Pointer(v3))), funAddrP(sub_4A49D0))
	...
	*((*uint8)(unsafe.Pointer(&v5))) = *memmap.PtrUint8(0x5D4594, uintptr(v5*3)+1307796)
	...
	if int32(*(*uint8)(unsafe.Pointer(uintptr(dword_5d4594_1308144 + 4))))&8 != 0 {
		...
		*((*uint8)(unsafe.Pointer(&v9))) = *memmap.PtrUint8(0x5D4594, uintptr(v11*3)+1307797)
		v12 = int32(nox_color_rgb_4344A0(int32(*memmap.PtrUint8(0x5D4594, uintptr(v11*3)+1307796)), v9, int32(*memmap.PtrUint8(0x5D4594, uintptr((v10+int32(*(*uint16)(unsafe.Pointer(uintptr(dword_5d4594_1308108 + 32))))*32)*3)+1307798))))
	...
	if int32(*(*uint8)(unsafe.Pointer(uintptr(dword_5d4594_1308148 + 4))))&8 != 0 {
		...
		*((*uint8)(unsafe.Pointer(&v15))) = *memmap.PtrUint8(0x5D4594, uintptr(v15*3)+1307796)
		v16 = int32(nox_color_rgb_4344A0(v15, v13, int32(*memmap.PtrUint8(0x5D4594, uintptr((v14+int32(*(*uint16)(unsafe.Pointer(uintptr(dword_5d4594_1308112 + 32))))*32)*3)+1307798))))
	...
	if int32(*(*uint8)(unsafe.Pointer(uintptr(dword_5d4594_1308140 + 4))))&8 != 0 {
		...
		*((*uint8)(unsafe.Pointer(&v19))) = *memmap.PtrUint8(0x5D4594, uintptr(v19*3)+1307796)
		v20 = int32(nox_color_rgb_4344A0(v19, v17, int32(*memmap.PtrUint8(0x5D4594, uintptr((v18+int32(*(*uint16)(unsafe.Pointer(uintptr(dword_5d4594_1308104 + 32))))*32)*3)+1307798))))
	...
	if int32(*(*uint8)(unsafe.Pointer(uintptr(dword_5d4594_1308136 + 4))))&8 != 0 {
		nox_client_drawImageAt_47D2C0((*nox_video_bag_image_t)(unsafe.Pointer(uintptr(*memmap.PtrUint32(0x973A20, uintptr(int32(*(*uint8)(unsafe.Pointer(uintptr(dword_5d4594_1307784 + 67))))*4+16))))), v54, v55)
	} else {
		nox_client_drawImageAt_47D2C0((*nox_video_bag_image_t)(unsafe.Pointer(uintptr(*memmap.PtrUint32(0x973A20, uintptr(int32(*(*uint8)(unsafe.Pointer(uintptr(dword_5d4594_1307784 + 67))))*4+24))))), v54, v55)
	}
	v21 = 0
...
func nox_gui_newButtonOrCheckbox_4A91A0(parent *nox_window, a2 nox_window_flags, a3 int32, a4 int32, a5 int32, a6 int32, draw *nox_window_data) *nox_window {
	if draw.Style&1 != 0 {
		var btn *nox_window = nox_window_new(parent, a2, a3, a4, a5, a6, funAddrP(nox_xxx_wndButtonProcPre_4A9250))
		if btn == nil {
			return nil
		}
	...
	if draw.Style&4 != 0 {
		var btn *nox_window = nox_window_new(parent, a2, a3, a4, a5, a6, funAddrP(nox_xxx_wndCheckboxProcMB_4A92C0))
		if btn == nil {
			return nil
		}
...
func nox_game_showOptions_4AA6B0() int32 {
	...
	dword_5d4594_1309720 = unsafe.Pointer(nox_new_window_from_file(internCStr("Options.wnd"), funAddrP(sub_4AABE0)))
	...
	nox_xxx_wndSetWindowProc_46B300(*(*int32)(unsafe.Pointer(&dword_5d4594_1309720)), funAddrP(sub_4A18E0))
	...
	nox_wnd_xxx_1309740.Func12Ptr = funAddrP(sub_4AA9C0)
	nox_wnd_xxx_1309740.FncDoneOutPtr = funAddrP(sub_4AAA10)
...
func sub_4AABE0(a1 int32, a2 int32, a3 *int32, a4 int32) int32 {
	...
	case 16391:
		...
		if v4 > 341 {
			...
			sub_4AA9C0()
			nox_wnd_xxx_1309740.FncDoneOutPtr = funAddrP(sub_4AB0C0)
			nox_wnd_xxx_1309740.Func13Ptr = funAddrP(sub_4CB880)
		} else {
			switch v4 {
			case 311:
...
func nox_game_initOptionsInGame_4ADAD0() int32 {
	...
	var v31 int32
	_ = v31
	dword_5d4594_1309820 = uint32(uintptr(unsafe.Pointer(nox_new_window_from_file(internCStr("Options.wnd"), funAddrP(nox_xxx_windowOptionsProc_4ADF30)))))
...
func nox_gui_newSlider_4B4EE0(a1 int32, a2 nox_window_flags, a3 int32, a4 int32, a5 int32, a6 int32, a7 *uint32, a8 *float32) *nox_window {
	var (
		v8  int32
		v9  int32
		v10 *uint32
	...
	if v8&0x10 != 0 {
		v9 = a6
		v10 = (*uint32)(unsafe.Pointer(nox_window_new((*nox_window)(unsafe.Pointer(uintptr(a1))), a2|0x100, a3, a4, a5, a6, funAddrP(sub_4B5010))))
		...
		v9 = a6
		v10 = (*uint32)(unsafe.Pointer(nox_window_new((*nox_window)(unsafe.Pointer(uintptr(a1))), a2|0x100, a3, a4, a5, a6, funAddrP(nox_xxx_wndScrollBoxProc_4B5320))))
...
func nox_xxx_wndScrollBoxButtonCreate_4B5640(a1 int32, a2 nox_window_flags, a3 int32) int32 {
	var (
		v3     int32
		result int32
		v6     [332]byte
...
func sub_4B6970(a1 *uint32, dr *nox_drawable, a3 int32, a4 int32) int32 {
	...
	*(*uint32)(unsafe.Pointer(uintptr(a2 + 432))) += uint32(v4 * *memmap.PtrInt32(0x587000, uintptr(int32(*(*uint8)(unsafe.Pointer(uintptr(a2 + 299))))*8)+192088))
	v5 = int32(uint32(v4**memmap.PtrInt32(0x587000, uintptr(int32(*(*uint8)(unsafe.Pointer(uintptr(a2 + 299))))*8)+192092)) + *(*uint32)(unsafe.Pointer(uintptr(a2 + 436))))
...
func nox_xxx_fxShield_4B8090(a1 uint32, a2 int32) *uint32 {
	...
	if result != nil {
		...
		nox_xxx_forEachSprite_49AB00(&v7, funAddrP(nox_xxx_spriteScanForShield_4B81E0), int32(uintptr(unsafe.Pointer(&a1))))
