	...
	if *memmap.PtrUint32(0x587000, 190108) > 0 {
		for {
			...
			if v9 != 0 {
				...
				*(*uint8)(unsafe.Pointer(uintptr(v9 + 299))) = uint8(int8(nox_common_randomIntMinMax_415FF0(0, math.MaxUint8, internCStr("C:\\NoxPost\\src\\Client\\Drawable\\Update\\mmislup.c"), 52)))
				*(*uint32)(unsafe.Pointer(uintptr(v10 + 440))) = 0
				*(*uint32)(unsafe.Pointer(uintptr(v10 + 448))) = gameFrame() + uint32(nox_common_randomIntMinMax_415FF0(3, 10, internCStr("C:\\NoxPost\\src\\Client\\Drawable\\Update\\mmislup.c"), 59))
				*(*uint32)(unsafe.Pointer(uintptr(v10 + 444))) = gameFrame()
				*(*uint16)(unsafe.Pointer(uintptr(v10 + 104))) = 20
				*(*uint8)(unsafe.Pointer(uintptr(v10 + 296))) = uint8(int8(nox_common_randomIntMinMax_415FF0(0, 6, internCStr("C:\\NoxPost\\src\\Client\\Drawable\\Update\\mmislup.c"), 65)))
