	...
	if result != 0 {
		...
		if result != 0 {
			...
			if dword_587000_171388 != 0 {
				...
				nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1308152))))), 16414, int32(uintptr(unsafe.Pointer(v6))), 0, internCStr(__FILE__), __LINE__)
			}
...
func sub_4A68C0() *wchar2_t {
	...
	v0 = (*wchar2_t)(unsafe.Pointer(uintptr(nox_window_call_field_94_fnc((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1308152))))), 16413, 0, 0, internCStr(__FILE__), __LINE__))))
	if *v0 == 0 {
