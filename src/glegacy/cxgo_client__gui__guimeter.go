...
func sub_471160(a1 int32, a2 int32, a3 int32, a4 int32, a5 int32) int32 {
	...
	nox_windows_arr_1093036[5].win = nox_window_new((*nox_window)(unsafe.Pointer(uintptr(a1))), 1032, a2, a3, a4, a5, funAddrP(nil))
	nox_windows_arr_1093036[6].win = nox_window_new((*nox_window)(unsafe.Pointer(uintptr(a1))), 1032, a2-17, a3-15, 15, 15, funAddrP(nil))
	nox_window_set_all_funcs(nox_windows_arr_1093036[5].win, funAddrP(nil), funAddrP(sub_471250), funAddrP(nil))
	v5 = nox_strman_loadString_40F1D0(internCStr("ToolTipCharges"), nil, internCStr("C:\\NoxPost\\src\\Client\\Gui\\guimeter.c"), 921)
	nox_xxx_wndWddSetTooltip_46B000((*nox_window_data)(unsafe.Pointer((*wchar2_t)(unsafe.Pointer(&nox_windows_arr_1093036[5].win.DrawData())))), v5)
	nox_window_set_all_funcs(nox_windows_arr_1093036[6].win, funAddrP(nil), funAddrP(sub_471450), funAddrP(nil))
	v6 = nox_strman_loadString_40F1D0(internCStr("ToolTipCharges"), nil, internCStr("C:\\NoxPost\\src\\Client\\Gui\\guimeter.c"), 925)
	nox_xxx_wndWddSetTooltip_46B000((*nox_window_data)(unsafe.Pointer((*wchar2_t)(unsafe.Pointer(&nox_windows_arr_1093036[6].win.DrawData())))), v6)
...
func nox_xxx_guiHealthManaInit_4714E0() int32 {
	...
	*memmap.PtrUint32(0x5D4594, 1091928) = 0
	...
	dword_5d4594_1090276 = uint32(uintptr(unsafe.Pointer(nox_window_new(nil, 136, nox_win_width-91, nox_win_height-201, 91, 201, funAddrP(nil)))))
	nox_xxx_wndSetIcon_46AE60(*(*int32)(unsafe.Pointer(&dword_5d4594_1090276)), *memmap.PtrInt32(0x5D4594, 1092996))
	dword_5d4594_1091364 = uint32(uintptr(unsafe.Pointer(nox_window_new((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1090276))))), 8, 6, 166, 28, 30, funAddrP(nil)))))
	nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1091364)))), funAddrP(nox_xxx_guiBottleSlotProc_471B90), funAddrP(nox_xxx_guiBottleSlotDrawFn_471A80), funAddrP(nil))
	...
	*memmap.PtrUint32(0x5D4594, 1091380) = dword_5d4594_1096276
	dword_5d4594_1090292 = uint32(uintptr(unsafe.Pointer(nox_window_new((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1090276))))), 8, 34, 166, 28, 30, funAddrP(nil)))))
	nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1090292)))), funAddrP(nox_xxx_guiBottleSlotProc_471B90), funAddrP(nox_xxx_guiBottleSlotDrawFn_471A80), funAddrP(nil))
	...
	*memmap.PtrUint32(0x5D4594, 1090308) = 0
	if int32(*(*uint8)(unsafe.Pointer(uintptr(*memmap.PtrUint32(0x8531A0, 2576) + 2251)))) != 0 {
		dword_5d4594_1090828 = uint32(uintptr(unsafe.Pointer(nox_window_new((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1090276))))), 8, 62, 166, 28, 30, funAddrP(nil)))))
		nox_window_set_all_funcs((*nox_window)(unsafe.Pointer(*(**uint32)(unsafe.Pointer(&dword_5d4594_1090828)))), funAddrP(nox_xxx_guiBottleSlotProc_471B90), funAddrP(nox_xxx_guiBottleSlotDrawFn_471A80), funAddrP(nil))
		...
		*memmap.PtrUint32(0x5D4594, 1091900) = uint32(uintptr(unsafe.Pointer(nox_xxx_gLoadImg_42F970(internCStr("PoisonTube")))))
		v8 = (*uint32)(unsafe.Pointer(nox_window_new((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1090276))))), 136, 0, 0, 91, 159, funAddrP(nil))))
		...
		nox_windows_arr_1093036[1].win = nox_window_new((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v8)))))), 8, 60, 34, 25, 125, funAddrP(nil))
		nox_window_set_all_funcs(nox_windows_arr_1093036[1].win, funAddrP(nox_xxx_guiHealthManaTubeProc_472100), funAddrP(nox_xxx_guiHealthManaTubeDraw_471D10), funAddrP(nil))
		v10 = nox_strman_loadString_40F1D0(internCStr("ToolTipMana"), nil, internCStr("C:\\NoxPost\\src\\Client\\Gui\\guimeter.c"), 1122)
		nox_xxx_wndWddSetTooltip_46B000((*nox_window_data)(unsafe.Pointer((*wchar2_t)(unsafe.Pointer(&nox_windows_arr_1093036[1].win.DrawData())))), v10)
		nox_windows_arr_1093036[1].win.widget_data = unsafe.Pointer(uintptr(1))
		nox_windows_arr_1093036[0].win = nox_window_new((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v8)))))), 8, 34, 34, 25, 125, funAddrP(nil))
		nox_window_set_all_funcs(nox_windows_arr_1093036[0].win, funAddrP(nox_xxx_guiHealthManaTubeProc_472100), funAddrP(nox_xxx_guiHealthManaTubeDraw_471D10), funAddrP(nil))
		v11 = nox_strman_loadString_40F1D0(internCStr("ToolTipHealth"), nil, internCStr("C:\\NoxPost\\src\\Client\\Gui\\guimeter.c"), 1135)
		nox_xxx_wndWddSetTooltip_46B000((*nox_window_data)(unsafe.Pointer((*wchar2_t)(unsafe.Pointer(&nox_windows_arr_1093036[0].win.DrawData())))), v11)
		nox_windows_arr_1093036[0].win.widget_data = nil
		nox_windows_arr_1093036[2].win = nox_window_new(nil, 8, 0, 0, 0, 0, funAddrP(nil))
		nox_window_set_all_funcs(nox_windows_arr_1093036[2].win, funAddrP(nil), funAddrP(nox_xxx_drawHealthManaBar_471C00), funAddrP(nil))
		nox_windows_arr_1093036[2].win.widget_data = nil
		nox_windows_arr_1093036[3].win = nox_window_new(nil, 8, 0, 0, 0, 0, funAddrP(nil))
		nox_window_set_all_funcs(nox_windows_arr_1093036[3].win, funAddrP(nil), funAddrP(nox_xxx_drawHealthManaBar_471C00), funAddrP(nil))
		...
		*memmap.PtrUint32(0x5D4594, 1091900) = uint32(uintptr(unsafe.Pointer(nox_xxx_gLoadImg_42F970(internCStr("WarriorPoisonTube")))))
		v12 = (*uint32)(unsafe.Pointer(nox_window_new((*nox_window)(unsafe.Pointer(uintptr(*(*int32)(unsafe.Pointer(&dword_5d4594_1090276))))), 136, 0, 0, 91, 159, funAddrP(nil))))
		...
		nox_windows_arr_1093036[0].win = nox_window_new((*nox_window)(unsafe.Pointer(uintptr(int32(uintptr(unsafe.Pointer(v12)))))), 8, 34, 34, 25, 125, funAddrP(nil))
		nox_window_set_all_funcs(nox_windows_arr_1093036[0].win, funAddrP(nox_xxx_guiHealthManaTubeProc_472100), funAddrP(nox_xxx_guiHealthManaTubeDraw_471D10), funAddrP(nil))
		v14 = nox_strman_loadString_40F1D0(internCStr("ToolTipHealth"), nil, internCStr("C:\\NoxPost\\src\\Client\\Gui\\guimeter.c"), 1173)
		nox_xxx_wndWddSetTooltip_46B000((*nox_window_data)(unsafe.Pointer((*wchar2_t)(unsafe.Pointer(&nox_windows_arr_1093036[0].win.DrawData())))), v14)
		nox_windows_arr_1093036[0].win.widget_data = nil
		nox_windows_arr_1093036[2].win = nox_window_new(nil, 24, 0, 0, 0, 0, funAddrP(nil))
		nox_window_set_all_funcs(nox_windows_arr_1093036[2].win, funAddrP(nil), funAddrP(nox_xxx_drawHealthManaBar_471C00), funAddrP(nil))
		nox_windows_arr_1093036[2].win.widget_data = nil
	}
	sub_472280()
