...
int cmain(int argc, const char* argv[]) {
	...
	*getMemU32Ptr(0x852978, 16) = nox_gameFPS >> 1;
...
//----- (00410E00) --------------------------------------------------------
unsigned __int8  nox_xxx_map_410E00(int a1) { return getMemByte(0x85B3FC, 43793 + 12332 * a1); }

//----- (00410E20) --------------------------------------------------------
unsigned __int8  nox_xxx_mapWallGetHpByTile_410E20(int a1) { return getMemByte(0x85B3FC, 43085 + 12332 * a1); }

//----- (00410E40) --------------------------------------------------------
unsigned __int8  nox_xxx_wallGetBrickTypeMB_410E40(int a1) { return getMemByte(0x85B3FC, 43086 + 12332 * a1); }
	...
	for (int i = 0; i < ptr_5D4594_2650668_cap; i++) {
		for (int j = 0; j < ptr_5D4594_2650668_cap; j++) {
			...
			if (v3 & 1) {
				...
				if (obj->field_2 >= (int)*getMemU16Ptr(0x85B3FC, 32528 + 60 * obj->field_1)) {
					v0 = 1;
					obj->field_2 = 0;
				}
				v5 = obj->field_5;
				while (v5) {
					...
					if (v6 >= *(int*)&dword_5d4594_251572 ||
						v5[3] >= (int)*getMemU16Ptr(0x85B3FC, 28688 + 60 * v6)) {
						v0 = 1;
						obj->field_5 = v5[4];
			...
			if (v3 & 2) {
				...
				if (obj->field_7 >= (int)*getMemU16Ptr(0x85B3FC, 32528 + 60 * obj->field_6)) {
					v0 = 1;
					obj->field_7 = 0;
				}
				v7 = obj->field_10;
				while (v7) {
					...
					if (v8 >= *(int*)&dword_5d4594_251572 ||
						v7[3] >= (int)*getMemU16Ptr(0x85B3FC, 28688 + 60 * v8)) {
						v0 = 1;
						obj->field_10 = v7[4];
...
int  nox_thing_read_FLOR_411540(nox_memfile* f, _BYTE* a2) {
	...
	v29[2] = v9;
	if (v7 != -1 || v29[1] || v9 != -1) {
		*getMemU32Ptr(0x85B3FC, 32532 + 60 * dword_5d4594_251568) = nox_color_rgb_4344A0(*(int*)v29, *(int*)&v29[1], *(int*)&v29[2]);
	} else {
	...
	*getMemU16Ptr(0x85B3FC, 32528 + 60 * dword_5d4594_251568) = getMemByte(0x85B3FC, 32536 + 60 * dword_5d4594_251568) * getMemByte(0x85B3FC, 32537 + 60 * dword_5d4594_251568);
	v22 = getMemByte(0x85B3FC, 32537 + 60 * dword_5d4594_251568) * getMemByte(0x85B3FC, 32538 + 60 * dword_5d4594_251568);
