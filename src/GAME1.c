...
int __cdecl sub_408D40(FILE* f, int a2) {
	...
	if (a2 == -1)
		...
		sub_409580(getMemIntPtr(0x587000, 28 * a2 + 3744), 56);
	return 1;
}
...
BOOL __cdecl sub_40EB60(int a1, int a2, int a3) {
	...
	v3 = getMemIntPtr(0x5D4594, 4 * (a1 + 32 * a2) + 210036);
	v4 = sub_420BD0(*v3);
	...
	for (int i = 0; i < ptr_5D4594_2650668_cap; i++) {
		for (int j = 0; j < ptr_5D4594_2650668_cap; j++) {
			...
			if (v3 & 1) {
				...
				if (obj->field_2 >= (int)*getMemU16Ptr(0x5D4594, 60 * obj->field_1 + 2682232)) {
					v0 = 1;
					obj->field_2 = 0;
				}
				v5 = obj->field_5;
				while (v5) {
					...
					if (v6 >= *(int*)&dword_5d4594_251572 ||
						v5[3] >= (int)*getMemU16Ptr(0x5D4594, 60 * v6 + 2678392)) {
						v0 = 1;
						obj->field_5 = v5[4];
						sub_4221E0((int)v5);
						v5 = obj->field_5;
			...
			if (v3 & 2) {
				...
				if (obj->field_7 >= (int)*getMemU16Ptr(0x5D4594, 60 * obj->field_6 + 2682232)) {
					v0 = 1;
					obj->field_7 = 0;
				}
				v7 = obj->field_10;
				while (v7) {
					...
					if (v8 >= *(int*)&dword_5d4594_251572 ||
						v7[3] >= (int)*getMemU16Ptr(0x5D4594, 60 * v8 + 2678392)) {
						v0 = 1;
						obj->field_10 = v7[4];
						sub_4221E0((int)v7);
						v7 = obj->field_10;
...
int sub_4161E0() {
	...
	if (*getMemU16Ptr(0x5D4594, 371380 + 54) != sub_40A020(v4)) {
		*getMemU16Ptr(0x5D4594, 371380 + 54) = sub_40A020(*getMemI16Ptr(0x5D4594, 371380 + 52));
		dword_5d4594_371692 = 1;
	}
	...
	if (v7 == 4)
		return dword_5d4594_371692;
	*getMemU32Ptr(0x5D4594, 371380 + 44) = *(_DWORD*)v11;
	result = 1;
	dword_5d4594_371692 = 1;
	return result;
}
...
int sub_416500() {
	...
	*getMemU16Ptr(0x5D4594, 371516 + 105) = -1;
	*getMemU16Ptr(0x5D4594, 371516 + 107) = -1;
	result = 0;
	*getMemU32Ptr(0x5D4594, 371688) = 0;
	*getMemU8Ptr(0x5D4594, 371516 + 101) = -1;
	*getMemU8Ptr(0x5D4594, 371516 + 52) = 32;
	*getMemU8Ptr(0x5D4594, 371516 + 53) = 32;
	*getMemU32Ptr(0x5D4594, 371516 + 62) = 1;
	*getMemU32Ptr(0x5D4594, 371516 + 58) = 0;
	*getMemU32Ptr(0x5D4594, 371516 + 66) = 0;
	*getMemU32Ptr(0x5D4594, 371516 + 70) = 0;
	*getMemU32Ptr(0x5D4594, 371516 + 74) = 20;
...
//----- (00416590) --------------------------------------------------------
char* __cdecl sub_416590(int a1) { return (char*)getMemAt(0x5D4594, 371380 + 58 * a1); }
...
int __cdecl sub_416670(int a1) {
	...
	*getMemU32Ptr(0x5D4594, 371516 + 40) = a1;
	return result;
}
...
//----- (004168E0) --------------------------------------------------------
int* sub_4168E0() { return sub_425890(getMemIntPtr(0x5D4594, 371364)); }

//----- (004168F0) --------------------------------------------------------
int* __cdecl sub_4168F0(int* a1) { return sub_4258A0(a1); }

//----- (00416900) --------------------------------------------------------
int* sub_416900() { return sub_425890(getMemIntPtr(0x5D4594, 371500)); }
...
char* nox_common_playerInfoGetFirst_416EA0() {
	...
	v0 = 0;
	v1 = getMemAt(0x5D4594, 371780 + 2092);
	while (!*(_DWORD*)v1) {
		v1 += sizeof(nox_playerInfo);
		++v0;
		if ((int)v1 >= (int)getMemAt(0x5D4594, 528368))
			return 0;
	}
	return (char*)getMemAt(0x5D4594, 371780 + sizeof(nox_playerInfo)*v0);
}
...
char* __cdecl nox_common_playerInfoGetNext_416EE0(int a1) {
	...
	if (v1 >= 32)
		return 0;
	v2 = getMemAt(0x5D4594, 371780 + 2092 + sizeof(nox_playerInfo)*v1);
	while (!*(_DWORD*)v2) {
		v2 += sizeof(nox_playerInfo);
		++v1;
		if ((int)v2 >= (int)getMemAt(0x5D4594, 528368))
			return 0;
	}
	return (char*)getMemAt(0x5D4594, 371780 + sizeof(nox_playerInfo)*v1);
}
...
char* __cdecl sub_416F60(int a1) {
	...
	if (!result) {
		v2 = 0;
		v3 = getMemAt(0x5D4594, 371780 + 2092);
		while (*(_DWORD*)v3) {
			v3 += sizeof(nox_playerInfo);
			++v2;
			if ((int)v3 >= (int)getMemAt(0x5D4594, 528368))
				return 0;
		}
		sub_416FD0(getMemAt(0x5D4594, 371780 + sizeof(nox_playerInfo)*v2));
		*getMemU8Ptr(0x5D4594, 371780 + 2064 + sizeof(nox_playerInfo)*v2) = v2;
		result = (char*)getMemAt(0x5D4594, 371780 + sizeof(nox_playerInfo)*v2);
		*getMemU32Ptr(0x5D4594, 371780 + 2060 + sizeof(nox_playerInfo)*v2) = a1;
	}
	return result;
}
...
void sub_416FD0(_DWORD* a1) {
	memset(a1, 0, sizeof(nox_playerInfo));
	a1[523] = 1;
	a1[912] = 4;
}
...
char* __cdecl sub_417000(int a1) {
	...
	sub_416FD0(getMemAt(0x5D4594, 371780 + sizeof(nox_playerInfo)*a1));
	result = (char*)getMemAt(0x5D4594, 371780 + sizeof(nox_playerInfo)*a1);
	*getMemU8Ptr(0x5D4594, 371780 + 2064 + sizeof(nox_playerInfo)*a1) = a1;
	return result;
}
...
char* __cdecl sub_417040(int a1) {
	...
	v1 = 0;
	v2 = getMemAt(0x5D4594, 371780 + 2060);
	...
	*getMemU8Ptr(0x5D4594, 371780 + 2064 + sizeof(nox_playerInfo)*v1) = v1;
	return (char*)getMemAt(0x5D4594, 371780 + sizeof(nox_playerInfo)*v1);
}

//----- (00417090) --------------------------------------------------------
char* __cdecl sub_417090(int a1) {
	if (!*getMemU32Ptr(0x5D4594, 371780 + 2092 + sizeof(nox_playerInfo)*a1))
		return 0;
	*getMemU8Ptr(0x5D4594, 371780 + 2064 + sizeof(nox_playerInfo)*a1) = a1;
	return (char*)getMemAt(0x5D4594, 371780 + sizeof(nox_playerInfo)*a1);
}
...
int __cdecl sub_417190(int a1, int a2, int a3) {
	...
	v3 = 0;
	if (a1 >= 0 && a1 < 32 && a2) {
		v4 = *(_DWORD**)getMemAt(0x5D4594, 371780 + 4580 + sizeof(nox_playerInfo)*a1);
		v5 = getMemAt(0x5D4594, 371780 + sizeof(nox_playerInfo)*a1);
		if (v4) {
			if (v4[1] == a2) {
				v6 = *(_DWORD**)getMemAt(0x5D4594, 371780 + 4580 + sizeof(nox_playerInfo)*a1);
			LABEL_7:
				*v6 |= a3;
				return 1;
			}
...
int __cdecl sub_417270(int a1) {
	...
	result = 0;
	if (a1 >= 0 && a1 < 32) {
		v2 = *getMemU32Ptr(0x5D4594, 371780 + 4580 + sizeof(nox_playerInfo)*a1);
		if (v2) {
			v3 = *(_DWORD*)(v2 + 8);
...
int __cdecl sub_4172C0(int a1) {
	...
	if (a1 >= 0 && a1 < 32) {
		...
		if (v2) {
			result = *(_DWORD*)(v2 + 4);
			*getMemU32Ptr(0x5D4594, 371780 + 4580 + sizeof(nox_playerInfo)*a1) = *(_DWORD*)(v2 + 8);
		}
	}
	return result;
}
...
int __cdecl sub_417300(int a1, int a2, int a3) {
	...
	if (a1 >= 0 && a1 < 32) {
		if (a2) {
			v4 = getMemAt(0x5D4594, 371780 + sizeof(nox_playerInfo)*a1);
			v5 = *(_DWORD**)getMemAt(0x5D4594, 371780 + 4580 + sizeof(nox_playerInfo)*a1);
			if (v5) {
				while (1) {
					v6 = v5[2];
					if (v5[1] == a2)
						break;
					if (v6 != *getMemU32Ptr(0x5D4594, 371780 + 4580 + sizeof(nox_playerInfo)*a1)) {
						v5 = (_DWORD*)v5[2];
						if (v6)
							continue;
					}
...
int __cdecl sub_4173D0(int a1, int a2) {
	...
	if (a1 >= 0 && a1 < 32) {
		if (a2) {
			v3 = *getMemU32Ptr(0x5D4594, 371780 + 4580 + sizeof(nox_playerInfo)*a1);
			if (v3) {
				while (*(_DWORD*)(v3 + 4) != a2) {
					v3 = *(_DWORD*)(v3 + 8);
					if (v3 == *getMemU32Ptr(0x5D4594, 371780 + 4580 + sizeof(nox_playerInfo)*a1) || !v3)
						return result;
				}
				result = 1;
			}
