...
int nox_xxx_updDrawSparkleTrail_4CDBF0(int a1, uint32_t* a2) {
	...
	do {
		v3 = v2[8] + v12 / 5 +
			 nox_common_randomIntMinMax_415FF0(-3, 3, "C:\\NoxPost\\src\\Client\\Drawable\\Update\\sparklup.c", 28);
		v4 = v2[9] +
			 nox_common_randomIntMinMax_415FF0(-3, 3, "C:\\NoxPost\\src\\Client\\Drawable\\Update\\sparklup.c", 29) +
			 v8 / 5;
