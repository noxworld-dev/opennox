...
//----- (004B7060) --------------------------------------------------------
int  nox_thing_blue_rain_spark_draw(_DWORD* a1, nox_drawable* dr) {
	int result; // eax
	int v3;     // eax
	int v4;     // eax
	int v5;     // edi
...
//----- (004B7310) --------------------------------------------------------
int  nox_thing_rain_orb_draw(_DWORD* a1, nox_drawable* dr) {
	int* v2;        // esi
	__int16 v3;     // cx
	int v4;         // edi
	int v5;         // eax
