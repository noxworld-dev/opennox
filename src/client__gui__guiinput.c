	...
	if (result) {
		...
		if (dword_5d4594_1321236) {
			...
			*v1[9] = 920;
			...
			nox_window_setPos_46A9B0(*(_DWORD**)&dword_5d4594_1321228,
			...
			nox_window_setPos_46A9B0(*(_DWORD**)&dword_5d4594_1321232,
			...
			v11 =
				nox_strman_loadString_40F1D0("WindowDir:Back", 0, "C:\\NoxPost\\src\\client\\Gui\\GuiInput.c", 603);
