...
int  nox_xxx_spellDurationBased_4FEBA0(int a1, int a2, _DWORD* a3, int a4, _DWORD* a5, int a6, int(* a7)(_WORD*), int a8, int a9, int a10);
void  nox_server_scriptExecuteFnForEachGroupObj_502670(unsigned __int8* groupPtr, int expectedType, void(* a3)(int, int), int a4);
