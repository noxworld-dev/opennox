...
int  nox_thing_player_draw(_DWORD* a1, nox_drawable* dr) {
	...
	if (!nox_xxx_spriteTestBuf_4356C0(dr, 23)) {
		if (!nox_xxx_spriteTestBuf_4356C0(dr, 25)) {
			*getMemU32Ptr(0x956A00, 119328) = *((_DWORD*)v3 + 574);
			...
			v16 = *((_DWORD*)v3 + 920);
			if (v16 & 0x400) {
				v17 = getMemIntPtr(0x956A00, 119328);
				do {
					int a2 = 0;
					...
					*v17 = nox_color_rgb_4344A0(v33, a2, a1);
					++v17;
				} while ((int)v17 < (int)getMemAt(0x956A00, 119352));
				v12 = 0;
			}
			goto LABEL_37;
		}
	...
	if (!((unsigned char)nox_frame_xxx_2598000 & 1)) {
		LABEL_29:
		*getMemU32Ptr(0x956A00, 119328) = *getMemU32Ptr(0x85B3FC, 980);
	...
	*getMemU32Ptr(0x956A00, 119328) = *getMemU32Ptr(0x5D4594, 2523948);
	...
	LABEL_37:
	nox_xxx_drawPlayer_4341D0(1, *getMemIntPtr(0x956A00, 119328));
