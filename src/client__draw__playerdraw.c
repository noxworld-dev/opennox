...
int  nox_thing_player_draw(_DWORD* a1, nox_drawable* dr) {
	...
	if (!nox_xxx_spriteTestBuf_4356C0(dr, 23)) {
		if (!nox_xxx_spriteTestBuf_4356C0(dr, 25)) {
			*getMemU32Ptr(0x85B3FC, 1148964) = *((_DWORD*)v3 + 574);
			...
			v16 = *((_DWORD*)v3 + 920);
			if (v16 & 0x400) {
				v17 = getMemIntPtr(0x85B3FC, 1148964);
				do {
					int a2 = 0;
					...
					*v17 = nox_color_rgb_4344A0(v33, a2, a1);
					++v17;
				} while ((int)v17 < (int)getMemAt(0x85B3FC, 1148988));
				v12 = 0;
			}
			goto LABEL_37;
		}
	...
	if (!((unsigned char)nox_frame_xxx_2598000 & 1)) {
		LABEL_29:
		*getMemU32Ptr(0x85B3FC, 1148964) = *getMemU32Ptr(0x85B3FC, 980);
	...
	*getMemU32Ptr(0x85B3FC, 1148964) = *getMemU32Ptr(0x5D4594, 2523948);
	...
	LABEL_37:
	nox_xxx_drawPlayer_4341D0(1, *getMemIntPtr(0x85B3FC, 1148964));
	...
	if (v30 || !nox_xxx_spriteTestBuf_4356C0(dr, 0) || dr->field_32 == *getMemU32Ptr(0x8529A0, 2044) ||
	    *getMemU32Ptr(0x84EB20, 15968) && (nox_xxx_spriteTestBuf_4356C0(*getMemIntPtr(0x84EB20, 15968), 21) || v31)) {
		...
		if (!sub_48D830(dr) && !nox_common_gameFlags_check_40A5C0(2048)) {
			...
			nox_xxx_drawSetTextColor_434390(*getMemIntPtr(0x84EB20, 15964));
		...
		while (v12 < 6);
		if (dr != *getMemU32Ptr(0x84EB20, 15968) && nox_xxx_playerGet_470A90()) {
