...
int  nox_client_drawXxx_444AC0(int w, int h, int depth, int flags) {
	...
	nox_mutex_init(getMemAt(0x973CE0, 736));
	...
	*getMemU32Ptr(0x973CE0, 2936) = 0;
	...
	if (!v9) {
		...
		*getMemU32Ptr(0x973CE0, 2916) = v8 >> 2;
	...
	*getMemU32Ptr(0x973CE0, 2916) = v8 >> 1;
...
BOOL  sub_4347F0(char* a1, int a2) {
	if (a2 <= 256) {
		sub_435120(getMemAt(0x973CE0, 4448), a1);
		sub_4353F0();
		sub_435040();
		sub_434F00();
	}
...
void sub_444C50() {
	if (dword_5d4594_823776) {
		...
		if (*getMemU32Ptr(0x5D4594, 823780)) {
			nox_mutex_free(getMemAt(0x973CE0, 736));
	...
	if (result) {
		...
		if (result) {
			...
			*getMemU32Ptr(0x5D4594, 809596) = 0;
			...
			if (dword_5d4594_823772) {
				sub_435150(v2, (char*)getMemAt(0x973CE0, 4448));
