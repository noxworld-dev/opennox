...
int __cdecl sub_423AD0(shape*, char*);
int sub_423BB0();
BOOL sub_423C60();
...
int __cdecl sub_44D0C0(float, int); // idb
void sub_44D2C0();
...
int __cdecl nox_window_set_visible(nox_window* win, int visible);
...
int __cdecl nox_window_set_all_funcs(nox_window* win, int (*a2)(int, int, int, int), int (*a3)(int, int), int a4);
...
int __cdecl sub_470F40_draw(_DWORD* a1);
int sub_4710B0();
...
void __cdecl sub_49AB00(int4*, void(__cdecl*)(int, int), int);
...
int sub_4E76C0();
void __cdecl nullsub_25(_DWORD); // weak
...
int __cdecl sub_50F820(int, int, float); // idb
