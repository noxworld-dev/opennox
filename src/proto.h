...
void nox_common_list_clear_425760(nox_list_item_t* a1);
...
nox_list_item_t* nox_common_list_getFirstSafe_425890(nox_list_item_t* a1);
nox_list_item_t* nox_common_list_getNextSafe_4258A0(nox_list_item_t* a1);
_DWORD*  sub_4258C0(_DWORD** a1, int a2);
void nox_common_list_append_4258E0(nox_list_item_t* head, nox_list_item_t* cur);
