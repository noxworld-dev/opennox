...
char* sub_42E600();
void sub_42E620();
void  nox_xxx_clientTalk_42E7B0(nox_drawable* a1);
void  nox_xxx_clientCollideOrUse_42E810(nox_drawable* a1);
void  nox_xxx_clientTrade_42E850(nox_drawable* a1);
...
#else // NOX_CGO
void nox_game_SetCliDrawFunc(int (*a1)(void));
...
nox_window* sub_46B630(nox_window* a1, int a2, int a3);
void nox_xxx_cursorUpdate_46B740();
int  nox_xxx_wnd_46C2A0(nox_window* a1);
int sub_46C610();
...
void sub_476270(nox_draw_viewport_t* a1);
int  sub_4765F0(nox_draw_viewport_t* a1);
int sub_476680();
...
int  nox_xxx_tileDrawMB_481C20(nox_draw_viewport_t* a1);
...
int  sub_48B3F0(void* a1, int a2, int a3);
...
unsigned __int8*  sub_48C200(void* a1, int a2, int a3);
unsigned __int8*  sub_48C320(void* a1, int a2, int a3);
char sub_48C420();
__int16 sub_48C480();
int sub_48C4D0();
int sub_48C560();
...
int sub_4960B0();
int sub_496120();
int  nox_xxx_drawBlack_496150(nox_draw_viewport_t* a1);
...
void sub_49BD70(nox_draw_viewport_t* a1);
...
void sub_4C5050();
int  sub_4C5060(nox_draw_viewport_t* a1);
...
int sub_4C54E0();
void sub_4C5500(nox_draw_viewport_t* a1);
...
int  nox_xxx_netReportLesson_4D8EF0(nox_object_t* a1);
...
void nox_xxx_createAt_4DAA50(nox_object_t* obj, int a2, float a3, float a4); // idb
...
int  sub_4DCC10(nox_object_t* a1);
...
int*  nox_xxx_setNPCColor_4E4A90(nox_object_t* a1, unsigned __int8 a2, int a3);
...
BOOL  nox_xxx_isUnit_4E5B50(nox_object_t* a1);
BOOL  sub_4E5B80(nox_object_t* a1);
...
int  nox_xxx_playerCameraFollow_4E6060(int player, int unit);
...
void  nox_xxx_unitMove_4E7010(nox_object_t* obj, float2* pt);
...
int  sub_4E81D0(nox_object_t* a1);
...
void nox_xxx_mapFindPlayerStart_4F7AB0(float2* a1, nox_object_t* a2); // idb
...
char  nox_xxx_monsterPopAction_50A160(nox_object_t* a1);
int*  nox_xxx_monsterPushAction_50A260(nox_object_t* a1, int a2);
...
void nox_xxx_unitListenRoutine_50CDD0(int a1);
BOOL  sub_nox_xxx_checkIfUnitShouldListenOther_50CF10(int a1, int a2);
int  sub_50D000(int a1, int a2);
int  sub_50D0C0(char a1, int a2);
unsigned __int8*  nox_xxx_unitEmitHearEvent_50D110(int a1, _DWORD* a2, int a3);
...
void  nox_xxx_enactUnitOrder_5339A0(int source, int unit, int orderType);
...
BOOL  sub_5341F0(nox_object_t* a1);
...
BOOL  sub_57B450(nox_drawable* a1);
