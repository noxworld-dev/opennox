...
int nox_script_pop();
int  nox_script_nextInt(int** a1);
double  nox_script_nextFloat(float** a1);
void nox_xxx_scriptRunFirst_507290();
void  nox_server_doMapScript_507310(int a1, int a2, int a3);
...
void sub_51AC60();
void  nox_xxx_script_51ACA0(int a1, int a2, int a3);
