...
void  nox_xxx_setPortParam_40A3E0(int);
...
BOOL  nox_common_gameFlags_check_40A5C0(int a1);
...
BOOL sub_40E0B0();
int sub_40E0C0();
int  nox_common_getInstallPath_40E0D0(int, LPCSTR lpSubKey, int); // idb
...
int  sub_40E9D0(int a1, int a2);
int  sub_40E9F0(int a1, int a2);
...
int  nox_xxx_tileNFromPoint_411160(float2*);
...
BOOL  nox_xxx_mapTileAllowTeleport_411A90(float2* a1); // idb
...
int  nox_xxx_parseEnchEffect_412380_parse_attack_effect(const char* a1, char* a2, obj_412ae0_t* a3);
int  nox_xxx_parseEnchDefend_412490_parse_defend_effect(const char* a1, char* a2, obj_412ae0_t* a3);
int  nox_xxx_parseEnchEngageOrDisEng_412580_parse_engage_effect(const char* a1, char* a2, obj_412ae0_t* a3);
int  nox_xxx_parseEnchUpdate_412670_parse_update_effect(const char* a1, char* a2, obj_412ae0_t* a3);
...
void  sub_4130C0(LPVOID lpMem); // idb
void  sub_413100(LPVOID lpMem); // idb
void  nox_xxx_modifFreeOne_413140(LPVOID lpMem); // idb
...
int  sub_4149A0(LPCSTR lpFileName, LPVOID lpBuffer, LPVOID, LPVOID); // idb
int  nox_common_getRegistryValue_414A40(LPCSTR lpSubKey, LPCSTR lpValueName);                // idb
int  nox_common_setRegistryValue_414A90(LPCSTR lpSubKey, LPCSTR lpValueName, BYTE* lpData);  // idb
...
_DWORD*  sub_418C70(_DWORD* a1);
_DWORD*  nox_xxx_objGetTeamByNetCode_418C80(int a1);
...
_DWORD*  sub_418E40(int a1, int a2);
...
BOOL  nox_xxx_servObjectHasTeam_419130(int a1);
BOOL  nox_xxx_servCompareTeams_419150(int a1, int a2);
int  nox_xxx_teamCompare2_419180(int a1, unsigned __int8 a2);
...
char  sub_419900(int a1, int a2, __int16 a3);
char  sub_419960(int a1, int a2, __int16 a3);
int  sub_4199C0(int a1);
double  sub_419A10(float a1); // idb
unsigned int  sub_419A30(float a1);
int  nox_float2int(float); // idb
__int16  nox_float2int16(float a1);
__int16  nox_float2int16_abs(float a1);
...
BOOL  sub_41AC30(_DWORD* a1);
int sub_41B3B0();
BOOL  sub_41B3E0(int a1);
BOOL  nox_xxx_guiFieldbook_41B420(int a1);
int  nox_xxx_guiSpellbook_41B660(int a1);
BOOL  nox_xxx_guiEnchantment_41B9C0(_DWORD* a1);
BOOL  sub_41BEC0(int a1);
...
int  nox_xxx_SavePlayerDataFromClient_41CD70(char* a1, _BYTE* a2, int a3);
...
int sub_41D650();
BOOL  sub_41D670(int a1);
int sub_41D6C0();
void* sub_41D9F0();
int  sub_41DA10(int a1);
LPVOID sub_41DA40();
int  sub_41DA70(int a1, __int16 a2);
int sub_41DB90();
...
int sub_41E4C0();
void  sub_41E4D0(_DWORD* a1);
int sub_41E520();
BOOL sub_41E540();
int  sub_41E560(int a1, int a2, int a3, int a4);
_DWORD*  sub_41E590(_DWORD* a1, _DWORD* a2, _DWORD* a3, _DWORD* a4);
int  sub_41E5C0(int a1);
_DWORD*  sub_41E6C0(char* a1);
void  sub_41E710(wchar_t* a1, int a2);
int  sub_41E750(wchar_t* a1);
_DWORD*  sub_41E7A0(const char* a1);
_DWORD* sub_41E810();
_DWORD*  sub_41E870(char* a1, _DWORD* a2);
int  sub_41E8D0(int a1, int a2);
char*  sub_41E910(char* a1);
_DWORD*  sub_41E940(int a1);
_DWORD*  sub_41E970(int a1);
LPVOID  sub_41E990(char* a1);
...
BOOL  nox_xxx_unused_41F160(const char* a1);
...
char* sub_41F780();
_DWORD*  sub_41F790(const char* a1);
int  sub_41F800(const char* a1);
void  sub_41F820(const char* a1);
_DWORD*  sub_41F840(const char* a1, int a2);
BOOL  sub_41F860(const char* a1, wchar_t* a2);
BOOL  sub_41F8F0(const char* a1, wchar_t* a2);
_DWORD*  sub_41F980(const char* a1, int a2);
int sub_41F9A0();
BOOL  sub_41F9E0(int a1);
char* sub_41FA40();
...
int  sub_41FB90(int a1, _DWORD* a2, _DWORD* a3);
int  sub_41FBE0(_DWORD* a1, _DWORD* a2);
...
int sub_41FF60();
BOOL  sub_41FF70(int a1);
int sub_41FF90();
BOOL  sub_41FFA0(int a1);
int sub_41FFC0();
BOOL  sub_41FFD0(int a1);
BOOL sub_41FFF0();
int sub_420020();
LSTATUS sub_420030();
int sub_4200E0();
...
int sub_420100();
char* sub_420110();
int  nox_xxx_regGetSerial_420120(LPBYTE lpData); // idb
void  sub_4201B0(_DWORD* a1);
LPVOID sub_420200();
int  sub_420230(char* a1, _WORD* a2);
int  sub_420360(char* a1, _WORD* a2);
_DWORD* sub_420580();
...
void  nox_xxx_net_420830(_DWORD* a1);
_DWORD*  nox_xxx_net_CreateMsgList_420890(int a1, int a2);
void  sub_4208F0(LPVOID lpMem); // idb
int  nox_xxx_net_420940(int a1, int a2, int a3, int a4);
void  nox_xxx_net_4209C0(int a1, _QWORD* a2);
void  sub_4209E0(int* a1, int a2);
_DWORD*  sub_420A60(_DWORD* a1, int(* a2)(_DWORD, int), int a3);
_DWORD*  nox_xxx_netlistGetList_420A90(int a1, int ListSizePtr);
...
int  sub_420BE0(int a1, _DWORD* a2);
int  sub_420C10(int a1, _DWORD* a2);
_DWORD*  sub_420C40(int a1, int a2);
_DWORD* sub_420C70();
char* nox_xxx_polygon_420CA0();
char*  nox_xxx_polygon_420CD0(_DWORD* a1);
int sub_420D10();
...
int  sub_420E80(float, float, float); // idb
int  sub_420EE0(int a1);
int  sub_420EF0(_DWORD* a1);
char* sub_421010();
...
unsigned __int8  nox_xxx_tileReadOne_422A40(int a1, _BYTE* a2);
int  nox_xxx_tile_422C10(int a1, int a2);
int  nox_xxx_effectFloatValueLoad_4235C0(const char* a1, char* a2, obj_412ae0_t* a3);
int  nox_xxx_effectLoadFloatParam_4235F0(const char* a1, float a2, obj_412ae0_t* a3); // idb
...
void  set_bitmask_flags_from_plus_separated_names_423930(const char* input, _DWORD* bitmask,
																const char** allowed_names);
int  set_one_bitmask_flag_by_name_4239C0(char* name, _DWORD* bitmask, const char** allowed_names);
void  set_bitmask_flags_from_plus_separated_names_multiple_423A10(const char* input, _DWORD* bitmask);
int  nox_parse_shape(nox_shape*, char*);
int sub_423BB0();
BOOL sub_423C60();
...
HANDLE  sub_423F80(LPCSTR lpFileName, int a2, int a3, int a4);
...
char*  nox_xxx_spellNameByN_424870(int a1);
...
char*  nox_xxx_spellGetPhonemeMB_424A20(int a1);
int  nox_xxx_spellGet_424A30(int a1);
BOOL  nox_xxx_spellDefHasFlags_424A50(int a1, int a2);
int  nox_xxx_spellGetFlags_424A70(int a1);
int  nox_xxx_spellGetIcon_424A90(int a1);
int  nox_xxx_spellGetIconHighlight_424AB0(int a1);
...
int  nox_xxx_spellGetAbilityIcon_425310(int a1, int a2);
...
BOOL  sub_425430(int a1, int a2);
int  sub_425450(int a1);
int  sub_425470(int a1);
int  sub_4254A0(int a1, _BYTE* a2);
bool  sub_4254C0(unsigned __int8** a1);
_BYTE*  sub_425500(int a1, _BYTE* a2, char a3);
char  sub_425520(int a1, char a2);
int  sub_425550(_BYTE* a1, _BYTE* a2, int a3);
unsigned int  sub_4255F0(_BYTE* a1, _BYTE* a2, int a3);
int  sub_425680(_BYTE* a1, _BYTE* a2);
int  sub_425710(int a1, int a2);
_DWORD*  sub_425760(_DWORD* a1);
_DWORD*  sub_425770(_DWORD* a1);
int  sub_425790(int* a1, _DWORD* a2);
...
char*  sub_425B60(LPVOID lpMem, int a2);
...
size_t  nox_xxx_fileReadWrite_426AC0_file3_fread(_BYTE* a1, size_t a2);
int  sub_426BD0(unsigned __int8* a1, int a2);
...
BOOL  nox_xxx_mapReadSection_426EA0(int a1, const char* a2, _DWORD* a3);
BOOL  sub_426F40(int a1, const char* a2, _DWORD* a3, int(* a4)(int));
...
BOOL  nox_xxx_unused_427380(int a1);
...
unsigned __int8  nox_xxx_guideGetUnitSize_427460(int a1);
_BYTE*  nox_xxx_journalEntryAdd_427490(int a1, char* a2, __int16 a3);
void  nox_xxx_comJournalEntryAdd_427500(int a1, char* a2, __int16 a3);
int  nox_xxx_comAddEntryAll_427550(char* a1, __int16 a2);
...
int  nox_xxx_journalUpdateEntry_4276B0(int a1, const char* a2, __int16 a3);
int  nox_xxx_comJournalEntryUpdate_427720(int a1, const char* a2, __int16 a3);
int  nox_xxx_comUpdateEntryAll_427770(const char* a1, __int16 a2);
int  sub_4277B0(int a1, unsigned __int16 a2);
_DWORD*  sub_427820(int a1);
_DWORD*  sub_427850(int a1);
BOOL  sub_427880(const char* a1);
int  sub_4278B0(float* a1, float* a2, float* a3);
int  sub_427980(float4* a1, float4* a2);    // idb
int  sub_427C80(int4* a1, int4* a2);        // idb
int  sub_427DF0(int a1, int* a2, float a3); // idb
int  nox_xxx_wallMath_427F30(int2*, int*);
int  sub_4280E0(int2* a1, _DWORD* a2); // idb
int  sub_428170(_DWORD*, int4*);
int  sub_4281F0(int2*, int4*);
BOOL  sub_428220(float2* a1, float4* a2); // idb
void  nox_shape_box_calc(nox_shape*);
...
unsigned __int8  nox_xxx_wall_42A6C0(unsigned __int8 a1, unsigned __int8 a2);
...
int  nox_video_parse_videobag(int a1);
...
void  nox_xxx_getSomeCoods_435670(int2*);
...
int  nox_game_SetCliDrawFunc(int (*a1)(void));
...
void sub_444D00();
void sub_444D30();
void  sub_444D50(obj_5D4594_3799572_t* a1);
void  sub_444D70(obj_5D4594_3799572_t* a1);
...
char*  nox_get_thing_name(int a1);
nox_thing*  nox_get_thing(int i);
wchar_t*  nox_get_thing_pretty_name(int a1);
wchar_t*  nox_get_thing_desc(int a1);
int  nox_get_thing_pretty_image(int a1);
int  nox_xxx_getTTByNameSpriteMB_44CFC0(CHAR* a1);
int  nox_xxx_getvalByName2Imp_44CFD0(CHAR* a1);
int  sub_44D020(const void*, const void*); // idb
int  sub_44D040(int a1);
BOOL  sub_44D060(int a1);
int  sub_44D090(int a1);
int  nox_drawable_link_thing(nox_drawable* d, int i); // idb
void sub_44D2C0();
...
int  nox_xxx_guiSpellSortFn_45ABC0(const void*, const void*); // idb
...
int*  nox_xxx_bookSetForward_45D200(int* a1, int a2, int2* a3); // idb
...
int  nox_xxx_quickBarDrawFn_45FBD0(int yTop); // idb
int  nox_xxx_quickBarWarriorDraw_45FDE0(int yTop); // idb
...
char*  sub_4610D0(unsigned __int8 a1);
char*  sub_461120(int a1, int a2);
BOOL  sub_461160(int a1);
int sub_4611A0();
int sub_4611B0();
...
void  nox_xxx_buttonSetImgMB_461320(int a1, _DWORD* a2);
...
BOOL  sub_464B40(int a1, int a2);
int  nox_xxx_clientDequip_464B70(int a1);
int nox_xxx_XorEaxEaxSub_464BA0();
BOOL  nox_xxx_inventoryWndProc_464BB0(int a1, int a2);
int  nox_xxx_trade_4657B0(__int16 a1);
char  nox_xxx_clientTradeMB_4657E0(_DWORD* a1);
int  nox_xxx_clientTrade_465870(__int16 a1);
void  sub_4658A0(int a1, int2* a2);
int  sub_465990(_DWORD* a1);
int  nox_xxx_clientDrop_465BE0(int2* a1); // idb
BOOL  nox_xxx_clientKeyEquip_465C30(int a1, int a2);
void nox_xxx_clientUse_465C70(int a1);
int sub_465CA0();
void  sub_465CD0(_DWORD* a1, int a2, int a3, int a4);
...
int  nox_xxx_inventoryDrawProc_466580(_DWORD* a1);
int  sub_466620(int a1, int a2, unsigned int a3);
wchar_t*  sub_466660(int a1, int2* a2); // idb
int  sub_466950(int a1);
int  sub_466BA0(_DWORD* a1, int a2, unsigned int a3, int a4);
int  sub_466BF0(int a1, int a2, unsigned int a3, int a4);
int  sub_466C40(int a1);
int  sub_466ED0(int a1);
int  sub_466F50(_DWORD* a1, int* a2);
...
__int16  sub_4675E0(int a1, __int16 a2, __int16 a3);
int sub_467650();
void sub_467680();
...
BOOL  nox_thing_read_wall_46A010(_DWORD* a1, char* a2);
...
int  sub_46A5D0(_DWORD* a1, int a2);
int sub_46A6A0();
_DWORD* sub_46A730();
int  sub_46A7E0(_DWORD* a1, int a2, int a3, int a4);
...
int  nox_wnd_nox_xxx_wndDraw_46A9B0(_DWORD* a1, int a2, int a3);
_DWORD*  nox_xxx_wndFixCoords_46A9F0(_DWORD* a1);
int  nox_xxx_wnd_46AA20(int a1, _DWORD* a2, _DWORD* a3);
int  nox_client_wndGetPosition_46AA60(nox_window* a1, _DWORD* a2, _DWORD* a3);
BOOL  nox_xxx_wndPointInWnd_46AAB0(_DWORD* a1, int a2, int a3);
int  sub_46AB20(_DWORD* a1, int a2, int a3);
...
void  sub_46AC60(int a1);
int  wndIsShown_nox_xxx_wndIsShown_46ACC0(int a1);
void  sub_46ACE0(_DWORD* a1, int a2, int a3, int a4);
void  sub_46AD20(_DWORD* a1, int a2, int a3, int a4);
...
void sub_46C200();
int  nox_xxx_wnd_46C2A0(int a1);
void mainloop_draw();
int  nox_window_draw_recursive(nox_window* a1);
nox_window*  nox_window_new(nox_window* a1, int flags, int a3, int a4, int w, int h,
								   int (*fnc)(int, int, int, int));
int  nox_xxx_windowDestroyMB_46C4E0(_DWORD* a1);
int sub_46C5D0();
int sub_46C610();
...
void  nox_xxx_screenshotCallback_46D950(_DWORD* a1);
FILE*  nox_xxx_saveBMP_46D9D0(int a1, int a2, LPVOID lpMem, int a4);
int nox_xxx_saveScreenshot_46DB00();
int sub_46DB80();
int  sub_46DC00(int a1, unsigned __int8 a2, int a3);
...
void sub_46FAE0();
unsigned __int8  sub_46FE60(int a1);
unsigned __int8  sub_46FEB0(unsigned __int8 a1);
char sub_46FEE0();
...
BOOL sub_470580();
int sub_4705B0();
char  sub_4705F0(char a1, char a2, __int16 a3);
char  sub_470650(char a1, __int16 a2);
int sub_470680();
BOOL sub_4706A0();
...
int  sub_470C20(_DWORD* a1, _DWORD* a2);
...
int  sub_471250(_DWORD* a1);
int  sub_471450(_DWORD* a1);
int  nox_xxx_guiBottleSlotDrawFn_471A80(_DWORD* a1);
int  nox_xxx_guiBottleSlotProc_471B90(int a1, int a2);
int  nox_xxx_drawHealthManaBar_471C00(int a1);
int  nox_xxx_guiHealthManaTubeDraw_471D10(int xLeft); // idb
int sub_472080();
int  sub_4720C0(int xLeft, int); // idb
...
int  sub_4730D0(int2* a1, unsigned __int8 a2, int a3); // idb
...
char* sub_473930();
int sub_473960();
void  sub_473970(int2*, int2*);
int  sub_4739A0(int2* a1, int2* a2); // idb
int  sub_4739D0(int a1);
int  sub_4739E0(_DWORD* a1, int2* a2, int2* a3); // idb
...
int  sub_476160(const void*, const void*); // idb
int  sub_4761B0(int a1);
int  sub_476240(const void*, const void*); // idb
...
void  nox_xxx_clientOnCursorHover_477050(int, int); // idb
...
int sub_478970();
int  sub_478A70(int2* a1);      // idb
wchar_t*  sub_478B10(int2* a1); // idb
int sub_478C80();
...
int  sub_484C60(float);      // idb
int  sub_484CE0(int, float); // idb
int  sub_484D20(int a1, float a2);
int  nox_xxx_spriteChangeIntensity_484D70_light_intensity(int, float);                     // idb
int  sub_484DC0(int2* a1, int2* a2, int* a3);                    // idb
int  sub_4854D0(int2* a1, int2* a2, int2* a3, int a4, float a5); // idb
int  sub_4855D0(int, int, int, float);                           // idb
...
void  sub_487030(LPVOID lpMem); // idb
_DWORD*  sub_487050(_DWORD* a1);
void  sub_487070(LPVOID lpMem); // idb
_DWORD**  sub_487090(_DWORD** a1);
void sub_4870A0();
...
void  sub_4872C0(LPVOID lpMem); // idb
...
void  sub_487680(LPVOID lpMem); // idb
void*  sub_4876A0(_DWORD** a1);
int sub_4876E0();
_DWORD*  sub_4876F0(int a1, int a2);
...
void  sub_487C10(LPVOID lpMem); // idb
_DWORD*  sub_487C30(_DWORD* a1);
int  sub_487C50(int a1, _DWORD* a2);
int  sub_487C80(int a1);
void  nullsub_9(_DWORD); // weak
int  sub_487CB0(int a1, int a2);
__int64  sub_487CD0(int a1, int a2);
void  nullsub_10(_DWORD); // weak
...
int  nox_xxx_wndStaticDrawNoImage_488D00(int, int xLeft); // idb
...
int  nox_client_winVerGetMajor_48C870(LPSTR); // idb
int  nox_xxx_msgError_48C940(LPCSTR lpText);               // idb
...
int  sub_498C20(int2* a1, int2* a2, int a3); // idb
char  sub_4990D0(_DWORD* a1, _DWORD* a2);
int  sub_499130(int* a1);
BOOL  sub_499160(int2* a1, int2* a2, int2* a3); // idb
...
int  nox_xxx_makeLightningParticles_4999D0(int a1, int2* a2, int2* a3); // idb
...
int  sub_49A150(int2* a1, int a2, unsigned __int8 a3); // idb
void nox_alloc_npcs();
void nox_xxx_j_resetNPCRenderData_49A2E0(void);           // weak
void  nox_alloc_npcs_2(); // weak
...
void  nox_xxx_spriteEnum_49AB00(int4*, void(*)(nox_drawable*, int), int);
...
int sub_4A4970();
int sub_4A49A0();
int  sub_4A49D0(int yTop, int a2);         // idb
int  sub_4A4CB0(const void*, const void*); // idb
int sub_4A50A0();
int sub_4A50D0();
...
int  nox_xxx_wndButtonProc_4A7F50(_DWORD* a1, int a2, int a3, int a4);
...
void sub_4B5BF0();
int sub_4B5CD0();
int  sub_4B63B0(int2* a1, int2* a2); // idb
int sub_4B64C0();
void  sub_4B6720(int2*, int, int, char);
...
void  nox_xxx_spriteScanForShield_4B81E0(int, int); // idb
...
int  sub_4BD010(nox_drawable* dr, int2* a2, int a3); // idb
_DWORD*  sub_4BD280(int a1, int a2);
void  sub_4BD2D0(LPVOID lpMem); // idb
...
void  sub_4BD3C0(LPVOID lpMem); // idb
...
void  sub_4BEAD0(int2*, int2*, int2*, int2*, int, int);
void  sub_4BEDE0(int2*, int2*, int2*, int2*, int, float, int, int);
...
int sub_4C03E0();
int  sub_4C0430(int a1, int a2, int a3, int a4, int a5, const void* a6, int a7, int a8, int a9, int a10);
...
int  sub_4C2C60(_DWORD* a1, int2* a2); // idb
char* sub_4C2D60();
...
BOOL  nox_xxx_sprite_4C3220(int a1);
...
char* sub_4C3B70();
char* sub_4C3CB0();
int  sub_4C3EB0(int a1, int a2, char* a3, int a4);
int  sub_4C3FC0(char* a1);
int  sub_4C4100(char* a1);
int sub_4C4220();
void sub_4C4260();
BOOL sub_4C4280();
int  sub_4C42A0(int2* a1, int2* a2, int* a3, int* a4); // idb
__int16  nox_xxx_drawObject_4C4770_draw(int* a1, nox_drawable* dr, int a3);
char  sub_4C4EC0(_DWORD* a1, int a2);
__int16  nox_xxx_drawShinySpot_4C4F40(_DWORD* a1, int a2);
int nox_xxx_colorInit_4C4FD0();
int  sub_4C5020(int a1);
void sub_4C5050();
int  sub_4C5060(_DWORD* a1);
int  sub_4C51D0(int2* a1, int2* a2); // idb
...
void  sub_4C5EB0(int a1, int a2, int a3);
...
void  sub_4CA960(_DWORD* a1, char a2, float4* a3, float2* a4);      // idb
void  sub_4CAA90(int2* a1, float4* a2, float2* a3, int a4, int a5); // idb
void  sub_4CAC30(int2* a1, float4* a2, float2* a3, int a4, int a5); // idb
int sub_4CADD0();
...
BOOL  sub_4CB230(const char* a1, char* lpFileName);
_DWORD* sub_4CB330();
...
int  sub_4CEA90(float* a1, int2* a2, int a3); // idb
...
int  nox_xxx_mapGetTypeMB_4CFFA0(int a1);
...
int  nox_xxx_mapGenFixCoords_4D3D90(float2* a1, float2* a2); // idb
int  sub_4D3E30(float2* a1, float2* a2); // idb
BOOL  sub_4D3ED0(float2* a1);            // idb
...
BOOL  nox_xxx_player_4D7980(char a1);
...
BOOL  nox_xxx_chkIsMsgTimestamp_4DF7F0(_BYTE* a1);
...
int  sub_4E22A0(int, int, int, int, float, int); // idb
int  sub_4E2330(int, int, int, int, float, int); // idb
...
void  nox_xxx_damageFn_4E2700(float*, int); // idb
...
void  nullsub_35(_DWORD, _DWORD); // weak
...
int  sub_4E6CE0(float2* a1, float2* a2);                                          // idb
int  nox_server_testTwoPointsAndDirection_4E6E50(float2* a1, int a2, float2* a3); // idb
int  sub_4E6EA0(int, float, int);                                                 // idb
void  sub_4E6EF0(int a1, _DWORD* a2);
void  nox_xxx_unitMove_4E7010(int, float2*);
...
char* sub_4E8310();
unsigned __int8*  sub_4E8320(unsigned __int8 a1);
void  nox_xxx_fnFindCloseDoors_4E8340(float*, int); // idb
int  sub_4E8390(int a1);
unsigned __int8*  nox_xxx_collideMonsterEventProc_4E83B0(int a1, int a2);
...
void  nullsub_34(_DWORD, _DWORD, _DWORD); // weak
...
void  nox_xxx_collideAnkhQuest_4EBF40(int, int);
...
int  nox_xxx_drop_4ED790(int a1, _DWORD* a2, float2* a3); // idb
int  nox_xxx_drop_4ED810(int a1, int a2, float* a3);
int  nox_xxx_invForceDropItem_4ED930(int a1, _DWORD* a2);
float2*  sub_4ED970(float a1, float2* a2, float2* a3); // idb
...
_DWORD*  nox_xxx_createGem2_4F1F00(int a1, unsigned int a2);
void sub_4F2110();
int sub_4F2210();
int  sub_4F24E0(int a1);
BOOL  sub_4F2530(int a1);
BOOL  sub_4F2570(int a1);
...
_DWORD*  nox_xxx_mapFindPlayerStart_4F7AB0(float2* a1, int a2); // idb
...
BOOL  sub_4F80C0(int a1, float2* a3); // idb
...
void  sub_500790(LPVOID lpMem); // idb
...
int  sub_501EF0(unsigned int a1);
...
_DWORD*  sub_5044B0(int a1, float a2, float a3); // idb
...
int  sub_5049F0(FILE* a1, int a2);
int  sub_504A10(int a1);
int  sub_504AB0(char* a1);
int  nox_server_mapRWObjectData_504CF0(_DWORD* a2); // idb
...
int  nox_server_doMapScript_507310(int a1, int a2, int a3);
...
int  nox_xxx_xferDirectionToAngle_509E00(_DWORD* a1);
int  nox_xxx_xferIndexedDirection_509E20(int a1, int2* a2); // idb
int  nox_xxx_mathDirection4ToAngle_509E90(int a1);
int  nox_xxx_math_509EA0(int a1);
int  nox_xxx_math_509ED0(float2*);
void  nox_xxx_utilNormalizeVector_509F20(float2* a1); // idb
...
int  nox_xxx_monsterCallDieFn_50A3D0(_DWORD* a1);
...
int  sub_50AA90(int a1);
int nox_xxx_minimapFirstMonster_50AAE0();
int nox_xxx_minimapNextMonster_50AB10();
__int16  sub_50AB50(int a1, int a2);
int nox_xxx_allocVisitNodesArray_50AB90();
void sub_50ABF0();
int  sub_50AC20(int a3, _WORD* a2); // idb
void  sub_50AE80(int a1, int a2);
int  sub_50AEA0(int a1, float2* a2, _DWORD* a3); // idb
int  nox_xxx_aiTestUnitDangerous_50B2C0(int a1);
void sub_50B500();
int sub_50B510();
int sub_50B520();
int  nox_xxx_mapTraceObstacles_50B580(int a1, float4* a3);       // idb
void  sub_50B600(float* arg0, float4* a1); // idb
BOOL  sub_50B810(int a1, float* a2);
BOOL  sub_50B870(int a1, int a2, int a3);
BOOL  nox_xxx_pathfind_preCheckWalls2_50B8A0(int a1, int a2, int a3);
...
LPVOID  nox_xxx_pathFind_50BA00(int a1, int a2, float* a3, float* a4, int(* a5)(int, int, int), int a6);
int  sub_50C320(int a1, int a2, _DWORD* a3);
int  sub_50C830(int a1, int a2, int a3);
void  nox_xxx_pathfind_preCheckWalls_50C8D0(int a1, int2* a2); // idb
...
BOOL  sub_50CA60(int a4, int a2, int a3); // idb
...
int sub_50D960();
int sub_50DE10();
_DWORD*  sub_50DE60(int a1);
int  sub_50DE80(int a1, float* a2);
void  sub_50DFB0(float*, int); // idb
int  sub_50E030(int a1, _DWORD* a2);
...
int sub_50E360();
int  nox_xxx_shopGetItemCost_50E3D0(int, int, float); // idb
...
int  sub_50EEC0(_DWORD* a1);
int  sub_50F2B0(int a1, _DWORD* a2);
void  sub_50F3A0(_DWORD* a1);
int  sub_50F450(int a1);
int  sub_50F490(_DWORD* a1, int a2);
void  nox_xxx_shopExit_50F4C0(_DWORD* a1);
...
int  sub_50F720(int a1, _DWORD* a2);
void  sub_50F790(int a1, int a2, int* a3);
_DWORD*  sub_50F7F0(int a1, int a2);
int  nox_xxx_tradeP2PUpdStuff_50FA00(int a1, _DWORD* a2);
_DWORD*  sub_50FB90(_DWORD* a1);
int  sub_50FD20(_DWORD* a1, int a2);
int  nox_xxx_tradeP2PAddOfferMB_50FE20(int a1, int a2);
int  sub_50FF90(int a1, int a2, int a3);
_DWORD*  sub_50FFE0(_DWORD* a1, int a2);
...
_DWORD*  sub_5108D0(int a1, int a2, int a3);
_DWORD*  sub_510AE0(int* a1, int a2, _DWORD* a3);
unsigned __int16  sub_510D10(int* a1, int a2, int a3, unsigned int a4);
void  nox_xxx_shopCancelSession_510DC0(_DWORD* a1);
int  sub_510DE0(int a1, int a2);
void  sub_510E20(int a1);
void sub_510E50();
signed int  nox_xxx_updateSentryGlobe_510E60(int a1);
_DWORD*  nox_xxx_sentryUpdateList_510FD0(_DWORD* a1);
...
int  nox_xxx_unitSetDecayTime_511660(_DWORD* a1, int a2);
...
int  nox_xxx_updateObjectsVelocity_5118A0(float); // idb
...
float*  nox_xxx_monsterLookAt_5125A0(int a1, int a2);
...
int sub_513070();
_DWORD*  sub_5130E0(int a1, _DWORD* a2);
int sub_513160();
...
void  nox_xxx_unitSetFollow_5158C0(int a1, int a2);
int sub_515910();
int nox_xxx_scriptAgresssionLevel_515950();
int  nox_xxx_monsterSetAgressiveness_515980(int a1, _DWORD* a2);
int sub_5159B0();
...
_DWORD*  sub_516F90(int a1, int a2);
void sub_516FC0();
int nox_xxx_loadMonsterBin_517010();
int  nox_xxx_readStr_517090(FILE* a1, _BYTE* a2);
...
_DWORD*  nox_xxx_monsterDefByTT_517560(int a1);
BOOL  sub_517590(float a1, float a2);
int  nox_xxx_roundCoord_5175E0(float, int); // idb
__int16  nox_xxx_unitCreateMissileSmth_517640(signed int a1);
int  nox_xxx_addObjToMapMB_517780(int a1, int a2, int a3, int a4);
__int16  sub_517870(int a1);
unsigned __int16*  sub_5178E0(int a1, unsigned __int16* a2);
void  nox_xxx_moveUpdateSpecial_517970(int a1);
void  nox_xxx_waypointMapRegister_5179B0(int a1);
int  sub_517A70(int a1);
int sub_517AE0();
void sub_517B30();
void  sub_517B70(float2* a1, void(* a2)(_DWORD, int), int a3); // idb
void  nox_xxx_getUnitsInRect_517C10(float4* a1, void(* a2)(float*, int), int a3); // idb
void  nox_xxx_getUnitsInRectAdvImpl_517DC0(float4* a1, void(* a2)(int, int), int a3);    // idb
void  nox_xxx_getUnitsInRectAdv_517ED0(float4* a1, void(* a2)(float*, int), int a3); // idb
int*  nox_xxx_secretWallCheckUnits_517F00(float* a1, int(* a2)(int*, int), int a3);
void  nox_xxx_unitsGetInCircle_517F90(float2* a1, float a2, int a3, int a4); // idb
void  nox_xxx_unitsGetInNotFarFn_518000(float*, int);                          // idb
int  sub_518040(int, float, int, int);                  // idb
...
int  sub_518440(int a1, unsigned __int8 a2);
int  sub_518460(float2* a1, unsigned __int8 a2, int a3); // idb
int  sub_518550(int* a1, int* a2, unsigned __int8 a3, int a4);
int  sub_518740(float2* a1, unsigned __int8 a2); // idb
int sub_518770();
int  nox_xxx_netSendPhantomPlrMb_5187E0(int a1, int a2);
int  nox_xxx_netSendSimpleObj_5188A0(int a1, int a2);
int  nox_xxx_netSendComplexObject_518960(int a1, _DWORD* a2, int a3);
int  nox_xxx_netSpriteUpdate_518AE0(int a1, int a2, _DWORD* a3);
int  nox_xxx_netPlayerObjSend_518C30(int a1, _DWORD* a2, int a3, signed int a4);
int  nox_xxx_netUpdate_518EE0(_DWORD* a1);
int  nox_xxx_netPlayerObjSendCamera_519330(int a1);
char  nox_xxx_unitAroundPlayerFn_5193B0(_DWORD* a1, int a2);
...
void  nox_xxx_mapSendCancelAll_5198B0(unsigned __int8 a1);
void  nullsub_27(_DWORD); // weak
int  sub_519930(int a1);
char*  nox_xxx_netMapSend_519D20(int a1);
_DWORD*  sub_519E80(int a1);
LPVOID sub_51A100();
int sub_51A130();
BOOL  sub_51A140(int a1);
int  sub_51A170(const char* a1);
char*  sub_51A1D0(int a1);
...
unsigned __int8*  nox_xxx_playerControlBufferFirst_51AB50(int a1);
unsigned __int8*  nox_xxx_playerGetControlBufferNext_51ABC0(int a1);
int  nox_xxx_playerCmd_51AC30(int a1);
BOOL  nox_xxx_playerCmdGet_51AC40(int a1);
void sub_51AC60();
int  nox_xxx_script_51ACA0(int a1, int a2, int a3);
...
_DWORD*  sub_51D120(float* a1);
float*  sub_51D1A0(float2* a1); // idb
int  sub_51D1E0(LPVOID lpMem);
float*  sub_51D270(float* a1);
int  sub_51D2C0(int a1, int a2);
int  sub_51D2E0(int a1, int a2);
int  sub_51D300(int a1, int a2, char a3);
int  sub_51D370(int a1, int a2, char a3);
float2*  sub_51D3F0(float2* a1, float2* a2); // idb
float*  sub_51D440(float* a1, float* a2);
int  sub_51D490(char* a1);
...
void  nox_xxx_mapGenFreeStr_51F1F0(LPVOID lpMem); // idb
...
__int64  nox_xxx_mapGenRoundFloatToPtr_520DF0(float2* a1, _DWORD* a2); // idb
int  sub_520E60(int2* a1);                   // idb
...
int  nox_xxx_mapGenSetRoomPos_521880(_DWORD* a1, float2* a2); // idb
...
void  sub_521A10(LPVOID lpMem); // idb
...
float*  sub_521BC0(int a1, float2* a2, float a3, float a4); // idb
...
int  sub_5226D0(int, float, int); // idb
...
int  nox_xxx_netSendPointFx_522FF0(char a1, float2* a2);                // idb
int  nox_xxx_netSendFxAllCli_523030(float2* a1, const void* a2, int a3); // idb
...
int  nox_xxx_netSendFxGreenBolt_523790(int4* a1, __int16 a2); // idb
...
int  sub_52DD50(int, int, int, int, void*); // idb
...
int  nox_xxx_spellDrainMana_52E210(float); // idb
...
int  nox_xxx_spellEnergyBoltTick_52E850(float); // idb
...
int  nox_xxx_onFrameLightning_52F8A0(float); // idb
...
int  nox_xxx_projAddVelocitySmth_533080(int, int, float, int); // idb
...
BOOL  sub_534120(int a1, float2* a2); // idb
...
bool  nox_xxx_mapDamageToWalls_534FC0(int4* a1, int a2, float a3, int a4, int a5, int a6); // idb
...
void  nox_xxx_lineCollisionChk_537230(float*, int); // idb
int  nox_xxx_traceRay_5374B0(float4* a1);   // idb
...
void  sub_5386A0(int a3, int a2); // idb
...
void  nox_xxx_fnPentagramTeleport_53C060(float*, int); // idb
int  nox_xxx_updateInvisiblePentagram_53C0C0(int a1);
void  sub_53C140(float*, int); // idb
void  nox_xxx_updateBlow_53C160(int a3);      // idb
void  sub_53C240(float*, int); // idb
...
void  nox_xxx_waterBarrel_53CC30(float*, int); // idb
...
__int16  nox_xxx_pixieIdleAnimate_53CF90(int a1, float2* a2, __int16 a3); // idb
...
void  nox_xxx_updateMeteorShower_53D5A0(float* a2); // idb
void  nox_xxx_meteorExplode_53D6E0(int a6);    // idb
...
int  nox_xxx_spellFlySearchTarget_540610(float2* a1, int a2, int a3, float a4, int a5, int a6); // idb
void  sub_540780(float*, int);                                         // idb
...
int  nox_xxx_mobHealSomeone_5411A0(int a3);       // idb
void  nox_xxx_mobMayHealThis_5412A0(float*, int); // idb
...
void  nox_xxx_mobCastRandomRecoil_541490(int a1, float* a2, float2* a3); // idb
...
int  sub_541670(LPCSTR, LPCSTR lpExistingFileName, LPCSTR lpFileName); // idb
...
size_t  sub_542BB0(char a1, FILE* a2);
size_t  sub_542BD0(char a1, FILE* a2);
char*  sub_542BF0(int a1, int a2, int a3);
int  sub_543110(LPCSTR lpExistingFileName, int2* a2); // idb
...
int  nox_xxx_tileSubtile_544310(float2* a1); // idb
...
int  nox_xxx_mobSearchEdible_544A00(int, float); // idb
...
BOOL  nox_xxx_monsterCanCast2_5455B0(int a1);
...
int  sub_547DB0(int a1, float2* a2); // idb
BOOL  sub_547EE0(int a1, unsigned __int8 a2);
int sub_547F10();
...
void  nullsub_30(_DWORD); // weak
void  sub_548600(int a1, float a2, float a3);
void  nox_xxx_collSysAddCollision_548630(int, unsigned int, float2*);
...
int  nox_xxx_strikeOgre_549220(float); // idb
void  sub_549270(int a1, int a2);
int  nox_xxx_strikeMonsterDefault_549380(float);          // idb
int  nox_xxx_monsterPickMeleeTarget_549440(int a3, int a2); // idb
void  sub_5494C0(float*, int);   // idb
int  nox_xxx_strikeScorpion_5495B0(float);          // idb
BOOL  sub_549690(int a1, int a2);
int  nox_xxx_strikeVileZombie_549700(float); // idb
int  nox_xxx_strikeStoneGolem_5497E0(float a1);
int  nox_xxx_sendEquakeAfterGolem_549800(float); // idb
void  nox_xxx_monsterAttackAreaDamage_549860(int a1, float a2);
int  nox_xxx_strikeMechGolem_549960(float); // idb
int  nox_xxx_strikeWasp_549980(float); // idb
int  nox_xxx_strikeGhost_549A60(float); // idb
int nox_xxx_strikeBomber_549BB0();
int  nox_xxx_strikeSpider_549BC0(float); // idb
int  nox_xxx_strikeSpittingSpider_549CA0(float); // idb
...
double  sub_54A990(float2* a1, float a2, int a3, float2* a4); // idb
...
int  sub_54B810(int a1, int a2, int* a3, int2* a4, int a5); // idb
...
int  sub_54E810(int a1, float2* a2, int a3); // idb
void  sub_54E850(int a1, int a2);
char  nox_xxx_updateMonsterGenerator_54E930(_DWORD* a1);
int  nox_xxx_mobGeneratorPick_54EBA0(_DWORD* a1, float2* a2, int a4);     // idb
int  nox_xxx_mgenSetCreaturePos_54ED50(int a1, float2* a2, int a3, int a4); // idb
int  sub_54EF00(float* a3);                          // idb
void  sub_54EF60(float*, int);                       // idb
int  sub_54EF90(float, int, int, int);               // idb
...
int  sub_54FBF0(int a3);    // idb
void  nox_xxx_unitIsAttackReachable_54FC50(int, int); // idb
void  nox_xxx_collideTrigger_54FCD0(int a1, int a2);
float*  nox_xxx_createSpark_54FD80(float a1, float a2, int a3, int a4, float a5, float a6, float a7, int a8); // idb
void  sub_54FEF0(int a2);                                                                     // idb
int  sub_54FFC0(int2* a1, int a2);                                                            // idb
int  sub_550280(int, float, float, int, int, int, int);                                       // idb
int  sub_5502F0(float2* a1, float a2, float a3, int a4, int a5, float2* a6, float2* a7);      // idb
int  sub_550380(int a1, int a2, float2* a3);                                                  // idb
BOOL  sub_550480(int a1);
void  sub_5504B0(int a2);                                                          // idb
int  sub_550580(int2* a1, float* a2);                                              // idb
int  sub_550760(int a1, float2* a2, float2* a3, float4* a4, float2* a5, float a6); // idb
int  sub_550A10(int a1, float2* a2, float2* a3, float4* a4, float2* a5, float a6); // idb
char  sub_550CB0(float2* a1, float2* a2);                                          // idb
void  nox_xxx_collisionCheckCircleCircle_550D00(int a1, int a2);                                                  // idb
void  sub_550F80(float* a1, int a2);
void  sub_551250(unsigned int a1, float* a2, int a3);
int  sub_5516A0(float4* a1, float4* a2, float2* a3, int a4, int a6);           // idb
int  sub_551780(float4* a1, float a2, float a3, float a4, float2* a5, int a6); // idb
int  sub_551870(float4* a1, float a2, float a3, float a4, float2* a5, int a6); // idb
int  sub_551960(float4* a1, float4* a2, float4* a3, float2* a4);               // idb
BOOL  sub_551A90(float2* a1, float4* a2);                                      // idb
...
int  sub_559E80(DWORD_PTR dwUser, int, int); // idb
...
// _DWORD  __dtoxmode(_DWORD, unsigned __int8 *); weak
...
// LPVOID lpBuffer, DWORD nNumberOfBytesToRead); int  wcscmp(const wchar_t *, const wchar_t *); int sscanf(const
// char *, const char *, ...); int  toupper(CHAR SrcStr); idb int  _access(LPCSTR lpFileName, char); idb
// int printf(const char *, ...);
// double __usercall _CIpow@<st0>(double x@<st0>, double y@<st1>); idb
// double  sub_567362(_DWORD, _DWORD, __int16, _DWORD, __int16); weak
...
// int  _fullpath(LPSTR lpBuffer, LPCSTR lpFileName, DWORD nBufferLength); idb
// int  _getdrive();
// int  _mbctolower(CHAR SrcStr); idb
// unsigned __int8 * _mbspbrk(const unsigned __int8 *, const unsigned __int8 *);
// void  terminate(); weak
// void __userpurge sub_569348(EXCEPTION_POINTERS *a1@<ecx>, int a2@<ebx>, int a3@<edi>, int a4@<esi>, int a5);
// _DWORD  __InternalCxxFrameHandler(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD); weak
// _DWORD __stdcall _CallSettingFrame(_DWORD, _DWORD, _DWORD); weak
// _DWORD  _fltin2(_DWORD, _DWORD); weak
// _DWORD  _checkTOS_withFB(_DWORD, _DWORD); weak
// int  _input(FILE *a1, unsigned __int8 *a2, int a3);
// int  _hextodec(WORD CharType); idb
// int  fgetc_0(FILE *);
// _DWORD  _un_inc(_DWORD, FILE *); weak
// _DWORD  _whiteout(_DWORD, FILE *); weak
// _DWORD  _ld12cvt(_DWORD, _DWORD, _DWORD); weak
// int  sub_56C0EA(int a1, int a2);
// int  sub_56C100(int a1, int a2);
// int  sub_56C116(int a1, int a2);
// int  sub_56C143(int a1, int a2);
...
// _DWORD  __strgtold12(_DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD); weak
// int  isspace(WORD CharType); idb
// int sub_56D9C4();
...
float*  nox_xxx_waypointNewNotMap_579970(int a1, float a2, float a3); // idb
char* nox_xxx_waypoint_5799C0();
char* sub_579A30();
float*  sub_579AD0(float a1, float a2);
void  sub_579B30(LPVOID lpMem); // idb
_DWORD* sub_579C00();
...
char  sub_57A1E0(int* a1, const char* a2, int* a3, char a4, __int16 a5); // idb
...
float2*  sub_57B770(float2* a1, float2* a2); // idb
int  nox_xxx_collideReflect_57B810(float* a1, int a2);
BOOL  nox_xxx_map_57B850(float2* a1, float* a2, float2* a3); // idb
...
void  sub_57C790(float4* a1, float2* a2, float2* a3, float a4);  // idb
BOOL  nox_xxx_mathPointOnTheLine_57C8A0(float4* a1, float2* a2, float2* a3);            // idb
char  nox_xxx_mapTraceRayImpl_57C9A0(int a1, int a2, float* a3, float* a4, char a5); // idb
float2*  sub_57CD30(float4* a1, float2* a2, float2* a3);         // idb
float2*  sub_57CD70(float4* a1, float2* a2, float2* a3);         // idb
int  sub_57CDB0(int2* a1, float* a2, float2* a3);                // idb
...
char  sub_57F1D0(float2* a1);                // idb
int  sub_57F2A0(float2* a1, int a2, int a3); // idb
...
// weak int unknown_libname_35(void); weak void *__thiscall sub_57F518(LPVOID lpMem, char a2); void
