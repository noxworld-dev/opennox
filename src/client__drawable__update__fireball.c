...
void sub_4CCEA0(uint32_t* a1, int a2) {
	...
	if (v6 / 7 > 0) {
		...
		while (1) {
			v8 =
				nox_common_randomIntMinMax_415FF0(0, 100, "C:\\NoxPost\\src\\client\\Drawable\\Update\\Fireball.c", 46);
			v9 = v2[8] + v4 * v8 / 100;
			v11 = v2[9] + (v3 * v8) / 100;
			...
			if (v12) {
				...
				*(uint32_t*)(v12 + 436) = v11 << 12;
				...
				v13 = nox_common_randomIntMinMax_415FF0(-25, 25,
														"C:\\NoxPost\\src\\client\\Drawable\\Update\\Fireball.c", 63);
				...
				*(uint8_t*)(v12 + 296) = nox_common_randomIntMinMax_415FF0(
					-2, 4, "C:\\NoxPost\\src\\client\\Drawable\\Update\\Fireball.c", 84);
