	...
	if (a2 != dword_5d4594_1062560 && a2 != *getMemU32Ptr(0x5D4594, 1049728) && a2 != *getMemU32Ptr(0x5D4594, 1049724) &&
		...
		if (v3) {
			...
			if (!sub_4617C0(a1, a2, a3, &a4)) {
				v4 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 136456), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c",
										   682);
				...
				*(_DWORD*)v9 = v10;
				if (v10) {
					...
					*((_DWORD*)v9 + 1) = a1;
					...
					v11 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 136508), 0,
...
int __cdecl nox_xxx_unused_461A30(int a1, int a2) {
	...
	v4 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 136564), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 1220);
	nox_xxx_printCentered_445490(v4);
		...
		*(_DWORD*)(*(_DWORD*)v2 + 132) = 0;
		...
		if (*getMemU32Ptr(0x5D4594, 1049848) && *(_DWORD*)(*getMemU32Ptr(0x5D4594, 1049848) + 128) == a1) {
			...
			*getMemU32Ptr(0x5D4594, 1049848) = 0;
			...
			v5 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 136616), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 1439);
...
void __cdecl sub_462040(int a1) {
	...
	if (v2) {
		...
		if (!*getMemU32Ptr(0x5D4594, 1049848) || *(_DWORD*)(*getMemU32Ptr(0x5D4594, 1049848) + 128) != a1) {
			v7 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 136668), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 1605);
			goto LABEL_36;
		}
	...
	v18 = *(_WORD*)(v3 + 292);
	if (v20 == 9) {
		v7 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 136780), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 1701);
		goto LABEL_36;
	}
	v5 = nox_new_drawable_for_thing(*(_DWORD*)(v3 + 108));
	v6 = v5;
	if (!v5) {
		v7 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 136724), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 1619);
	LABEL_36:
...
int sub_462740() {
	...
	v0 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 136832), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2361);
...
LABEL_14:
	...
	if (!dword_5d4594_1063116) {
		if (dword_5d4594_1063120) {
			dword_5d4594_1063120 = 0;
			v5 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 136900), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2529);
	...
	v7 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 136968), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2545);
	...
	if (nox_common_gameFlags_check_40A5C0(2048)) {
		if (*(_WORD*)(dword_5d4594_1063116 + 294)) {
			...
			v56 = (int)v71;
			v11 =
				nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 137028), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2575);
			nox_swprintf(v75, v11, v56, v63);
		} else {
			v12 =
				nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 137084), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2583);
			nox_wcscpy(v75, v12);
		}
	} else {
		...
		case 0:
			v13 =
				nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 137228), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2595);
			goto LABEL_30;
		case 1:
			v52 =
				nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 137292), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2599);
			nox_swprintf(v75, v52);
			break;
		case 2:
			v53 =
				nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 137356), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2603);
			nox_swprintf(v75, v53);
			break;
		case 3:
			v13 =
				nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 137420), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2607);
		LABEL_30:
			nox_swprintf(v75, v13);
			break;
		case 4:
			v51 =
				nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 137156), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2591);
	...
	v14 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 137484), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2620);
	...
	LABEL_51:
		...
		if (v33 & 0xC) {
			v34 =
				nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 137688), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2770);
			nox_swprintf(v75, v34);
		} else if (!(v33 & 2) || v2) {
			v58 = v70;
			v55 =
				nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 137812), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2776);
			nox_swprintf(v75, v55, v58);
		} else {
			v57 = v70;
			v54 =
				nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 137744), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2773);
			nox_swprintf(v75, v54, v57);
		}
		nox_window_call_field_94((int)v10, 16397, (int)v75, -1);
		nox_wcscpy(v75, L"  ");
		v59 = v68;
		v35 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 137876), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2785);
		nox_swprintf(v76, v35, v59);
		nox_wcscat(v75, v76);
		nox_window_call_field_94((int)v10, 16397, (int)v75, -1);
		nox_wcscpy(v75, L"  ");
		v60 = v69;
		v36 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 137936), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2792);
		...
		if (v72 > 0.0) {
			...
			v61 = v72;
			v37 =
				nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 138000), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2801);
		...
		if (v71 > 0.0) {
			...
			v62 = v71;
			v38 =
				nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 138060), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2811);
	...
	if (*(_BYTE*)(dword_5d4594_1063116 + 116) & 2) {
		v21 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 137536), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2647);
		nox_swprintf(v75, v21);
	} else {
		v66 = v20;
		v22 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 137592), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2649);
	...
	if (v39 & 0x13001000) {
		...
		if (v40) {
			...
			if (v44 && *(_DWORD*)(v44 + 16)) {
				v45 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 138236), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c",
											2851);
			...
			if (v47 && *(_DWORD*)(v47 + 16)) {
				if (v46 == 1) {
					v48 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 138308), 0,
			...
			v41 =
				nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 138120), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2835);
			nox_swprintf(v75, v41);
			nox_window_call_field_94((int)v10, 16397, (int)v75, -1);
			v42 =
				nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 138184), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2837);
...
int* __cdecl nox_xxx_makeStatsDlg_463880(int* a1) {
	...
	if (*getMemU32Ptr(0x5D4594, 2618908)) {
		...
		v11 = v9 + 2 * v1 + 3;
		v52 = *(char*)(v4 + 3684);
		v12 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 138392), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 1878);
		...
		if (nox_common_gameFlags_check_40A5C0(2048)) {
			...
			v14 =
				nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 138448), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 1886);
			nox_swprintf(v77, v14, v41, v53);
			nox_xxx_drawString_43FAF0(0, v77, v10, v13, 200, 0);
		}
		v15 = 2 * v1 + 2 + v13;
		v16 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 138496), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 1896);
		...
		v42 = *(_DWORD*)(v4 + 2247);
		v17 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 138544), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 1914);
		...
		if (*(_BYTE*)(v4 + 2251)) {
			...
			v20 =
				nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 138604), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 1941);
			...
			v43 = *(_DWORD*)(v4 + 2243);
			v21 =
				nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 138652), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 1952);
		...
		v23 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 138712), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 1975);
		...
		v44 = *(_DWORD*)(v4 + 2239);
		v24 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 138764), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 1982);
		...
		v26 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 138824), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2006);
		...
		*(float*)&v68 = v69 * 100.0 * 0.011111111;
		...
		v28 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 138872), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2045);
		...
		if (nox_strman_get_lang_code() == 6 || nox_strman_get_lang_code() == 8)
			v10 += 39;
		nox_xxx_drawSetTextColor_434390(v72);
		v31 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 138932), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2072);
		nox_wcscpy(v77, v31);
		...
		v32 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 138984), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2076);
		...
		nox_xxx_drawSetTextColor_434390(v72);
		v35 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 139036), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2098);
		nox_xxx_drawGetStringSize_43F840(0, v35, &v67, 0, 0);
		v36 = v74;
		v40 = v74;
		v39 = v10 + v75 - v67;
		v37 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 139084), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2099);
		...
		v38 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 139132), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 2107);
...
BOOL __cdecl sub_4649B0(int a1, int a2, int a3) {
	...
	if (!v5) {
		...
		*(_DWORD*)v4 = v6;
		if (!v6) {
			v7 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 139200), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c",
									   898);
			nox_xxx_printCentered_445490(v7);
			return 0;
		}
	...
	LABEL_53:
		...
		if (dword_5d4594_1049864 == 4) {
			...
			if (v28) {
				...
				v29 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 139256), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c",
											3858);
			} else {
				v29 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 139308), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c",
											3869);
			}
		...
		if (!nox_xxx_wndPointInWnd_46AAB0(*(_DWORD**)&dword_5d4594_1062456, v59.field_0, v59.field_4) ||
			...
			if (dword_5d4594_1049856 == 1) {
				...
				if (nox_obj_arr_1050020[v47].field_140) {
					...
					v51 = v58;
					v50 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 139356), 0,
		...
		*getMemU32Ptr(0x5D4594, 1049848) = v1;
		if (v1) {
			...
			*(_WORD*)(*getMemU32Ptr(0x5D4594, 1049848) + 294) = nox_obj_arr_1050020[v0].field_0->field_73_2;
			...
			v2 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 139404), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 1123);
...
int sub_466160() {
	...
	if (getMemByte(0x5D4594, 1049868) == 2)
		v0 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 139564), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 410);
	else
		v0 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 139620), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 414);
...
int sub_4661D0() {
	...
	if (dword_5d4594_1062480) {
		...
		v2 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 139672), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 3331);
...
wchar_t* __cdecl sub_466660(int a1, int2* a2) {
	...
	v3 = sub_465990(a2);
	if (v3 == -1)
		return nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 139728), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 3155);
	v5 = *(wchar_t**)&array_5D4594_1049872[v3];
	if (v5)
		result = nox_xxx_clientAskInfoMb_4BF050(v5);
	else
		result = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 139780), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 3159);
	return result;
}
//----- (004667E0) --------------------------------------------------------
int __cdecl nox_xxx_inventroryOnHovewerSub_4667E0(int a1, int a2, unsigned int a3) {
	...
	if (v11 == 1) {
		v12 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 139828), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 4385);
		nox_xxx_cursorSetTooltip_4776B0(v12);
		return 1;
	}
	v13 = sub_4281F0(&v15, (int4*)getMemAt(0x5D4594, 1049828));
	if (v13 == 1 && sub_4BFD30() == 1) {
		v14 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 139884), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 4388);
...
int __cdecl sub_466E20(_DWORD* a1) {
	...
	switch (*a1) {
	case 0x2391:
		v1 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 139948), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 424);
		goto LABEL_7;
	case 0x2392:
		v1 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 140000), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 428);
		goto LABEL_7;
	case 0x2393:
		v1 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 140052), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 432);
		goto LABEL_7;
	case 0x2394:
		v1 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 140100), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 436);
		goto LABEL_7;
	case 0x2397:
		v1 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 140152), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 440);
	LABEL_7:
...
int nox_xxx_inventoryNameSignInit_4671E0() {
	...
	if (v1) {
		...
		v2 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 140836), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 4761);
...
int __cdecl sub_467750(int a1, char a2) {
	...
	LABEL_8:
		if (a2) {
			if (a2 != 1)
				return 0;
			v5 = nox_strman_loadString_40F1D0((char*)getMemAt(0x587000, 140892), 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 5379);
			nox_xxx_printCentered_445490(v5);
