					...
					*((_DWORD*)v9 + 1) = a1;
					...
					if (sub_461930() && !dword_5d4594_1062480) {
						if ((v13 = *(_DWORD*)v9, v14 = *(_DWORD*)(*(_DWORD*)v9 + 112), v14 & 0x1000000) &&
							...
							if (!v15 || (unsigned __int8)(1 << *(_BYTE*)(*getMemU32Ptr(0x8529A0, 4624) + 2251)) &
											*((_BYTE*)v15 + 62)) {
								sub_461550((int)v9);
								*((_DWORD*)v9 + 34) = 1;
							}
...
LABEL_14:
	...
	if (!(v16 & 0x2000000)) {
		if (!(v16 & 0x1001000))
			goto LABEL_72;
		v23 = *getMemU32Ptr(0x8529A0, 4624);
		LODWORD(v68) = dword_5d4594_1063116 + 432;
		v69 = 1.0;
		v70 = *getMemFloatPtr(0x8529A0, 4624);
...
int*  nox_xxx_makeStatsDlg_463880(int* a1) {
	...
	if (*getMemU32Ptr(0x8529A0, 4624)) {
		...
		if (*(_BYTE*)(v4 + 2251)) {
			...
			nox_client_drawSetColor_434460(*getMemIntPtr(0x8529A0, 35536));
			nox_client_drawRectFilledOpaque_49CE30(v10 + 60, v19, v67, v1);
		...
		*(float*)&v68 = v69 * 100.0 * 0.011111111;
		...
		if (v34 > *(unsigned __int16*)(v4 + 3652))
			v72 = *getMemU32Ptr(0x8529A0, 36360);
		nox_xxx_drawSetTextColor_434390(v72);
		...
		*getMemU32Ptr(0x5D4594, 1049848) = v1;
		if (v1) {
			...
			*(_WORD*)(*getMemU32Ptr(0x5D4594, 1049848) + 294) = nox_obj_arr_1050020[v0].field_0->field_73_2;
			...
			v2 = nox_strman_loadString_40F1D0("DrawablesExhausted", 0, "C:\\NoxPost\\src\\Client\\Gui\\guiinv.c", 1123);
...
int nox_xxx_inventoryNameSignInit_4671E0() {
	...
	if (v1) {
		...
		v3 = *getMemU32Ptr(0x8529A0, 4624) + 4704;
