...
int  nox_xxx_windowArenaSub_4AA4D0(int a1, unsigned int a2, int* a3, int a4) {
	...
	// WOL selected
	if (!sub_41D440()) {
		wchar_t* v7 = nox_strman_loadString_40F1D0("WOLAPIINIT_Failed", 0, "C:\\NoxPost\\src\\client\\shell\\ArnaMain.c", 100);
	...
	if (sub_40D5B0((int)&a2) && a2 < 0x10009) {
		sub_41D4C0();
		wchar_t* v8 = nox_strman_loadString_40F1D0("Wol.c:RegistryHosed", 0, "C:\\NoxPost\\src\\client\\shell\\ArnaMain.c", 111);
