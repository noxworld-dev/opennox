...
int __cdecl sub_4761B0(int a1) {
	...
	v3 =
	    (*(_DWORD*)(*(_DWORD*)&byte_5D4594[2614252] + 16) - result) * *(int*)&byte_587000[v2 + 196184] -
	    (*(_DWORD*)(*(_DWORD*)&byte_5D4594[2614252] + 12) - *(_DWORD*)(a1 + 12)) * *(int*)&byte_587000[v2 + 196188];
		...
		if (v8 < *(int*)&byte_5D4594[3798820] ||
			...
			*((_DWORD*)a2 + 86) = 0;
			...
			if (v11 - *((int*)a2 + 86) > 1 || v11 <= 0) {
				...
				v25 = dword_5d4594_3798844 - *(_DWORD*)&byte_5D4594[3798796];
				v14 = v8 + *(_DWORD*)&byte_5D4594[3798796] + *(_DWORD*)&byte_5D4594[3798836] +
							...
							if (v18) {
								if (v18 == 1) {
									if ((unsigned int)v15 >= v12 ||
										...
										v22 = &v13[v19];
										v13 += v20 + v19;
										qmemcpy(*(void**)&byte_5D4594[3798796],
											v22, v20);
										v15 = (char*)(v20 + v21);
										v14 = v31;
										v12 = v28;
...
int(__cdecl* __cdecl sub_476AE0(int a1, unsigned __int8* a2))(int* a1, int a2) {
	...
	if (result) {
		...
		v8 = (char*)result + 16;
		result = (int)(*((_DWORD*)result + 3) + *((_DWORD*)v2 + 4) - *((__int16*)v2 + 53) -
			       *((__int16*)v2 + 52) - v2[1]);
		v31 = v5;
		if (v7 < *(int*)&byte_5D4594[3798820] ||
			...
			*((_DWORD*)v2 + 86) = 0;
			...
			if (v10 - *((int*)v2 + 86) > 1 || v10 <= 0) {
				...
				v26 = dword_5d4594_3798844 - *(_DWORD*)&byte_5D4594[3798796];
				v13 = *(_DWORD*)&byte_5D4594[3798804] *
				      ((_DWORD)result + *(_DWORD*)&byte_5D4594[3798840] - v9);
								...
								if (v19) {
									if (v19 == 1) {
										if (v16 >= v11 || v16 + v20 < v11) {
											...
											v22 = v29 - v16;
											v33(v16, v12, v29 - v16);
											v23 = *(_DWORD*)&byte_5D4594
												  [3798796];
											v24 = (int)&v12[v22];
											v33(*(_DWORD*)&byte_5D4594
												[3798796],
											    (_BYTE*)v24, v21);
											v12 = (_BYTE*)(v21 + v24);
											v16 = v21 + v23;
...
int sub_476E90() {
	...
	do {
		if (*(_DWORD*)&byte_5D4594[v1 + 1096596]) {
			nox_client_drawImageAt_47D2C0(*(_DWORD*)&byte_5D4594[v1 + 1096564], nox_win_width / 2 + *(_DWORD*)v0 - 16,
					...
					if (sub_4984B0_drawable(arg0)) {
						if (!(*(_BYTE*)(arg0 + 112) & 4) ||
							...
							if ((!(v7 & 0x400000) || (*(_BYTE*)(arg0 + 116) & 0x80)) &&
								...
								v23 = (double)*(int*)(arg0 + 16) -
								      *(float*)(arg0 + 100) -
								      (double)*(__int16*)(arg0 + 104);
								v29 = nox_float2int(v23);
								v24 = (double)*(int*)(v2 + 16) - *(float*)(v2 + 96) -
								      (double)*(__int16*)(v2 + 104);
								...
								if (*(_DWORD*)(v2 + 44) == 2) {
									...
									if (sub_57B850(&a1, (float*)(v2 + 44), &a3) ||
									    (a1.field_4 = (double)v29,
									     sub_57B850(&a1, (float*)(v2 + 44), &a3)) ||
									    (v9 = *(_DWORD*)(v2 + 12) +
										  nox_float2int(*(float*)(v2 + 72)),
									     v10 = v29 +
										   nox_float2int(*(float*)(v2 + 76)),
									     v11 = LODWORD(v8) +
										   nox_float2int(*(float*)(v2 + 76)),
									     *(_DWORD*)a2 > v9) &&
										*(_DWORD*)a2 < *(int*)(v2 + 12) &&
									...
									v13 = *(_DWORD*)(v2 + 12) +
									      nox_float2int(*(float*)(v2 + 80));
									v14 = v29 + nox_float2int(*(float*)(v2 + 84));
									LODWORD(v15) =
									    LODWORD(v8) +
									    nox_float2int(*(float*)(v2 + 84));
									if (*(int*)a2 < *(int*)(v2 + 12))
										return;
									if (*(int*)a2 >= v13)
										return;
...
//----- (00477600) --------------------------------------------------------
int sub_477600() { return *(_DWORD*)&byte_5D4594[1096672]; }
...
char* sub_477710() {
	...
	*(_DWORD*)&byte_5D4594[1097220] = sub_42FA20("CursorSelect");
	*(_DWORD*)&byte_5D4594[1097224] = sub_42FA20("CursorGrab");
	*(_DWORD*)&byte_5D4594[1097228] = sub_42FA20("CursorPickup");
	*(_DWORD*)&byte_5D4594[1097232] = sub_42FA20("CursorTrade");
	*(_DWORD*)&byte_5D4594[1097240] = sub_42FA20("CursorTarget");
	*(_DWORD*)&byte_5D4594[1097236] = sub_42FA20("CursorTalk");
	*(_DWORD*)&byte_5D4594[1097244] = sub_42FA20("CursorIdentify");
	*(_DWORD*)&byte_5D4594[1097248] = sub_42FA20("CursorIdentifyNo");
	*(_DWORD*)&byte_5D4594[1097252] = sub_42FA20("CursorRepair");
	*(_DWORD*)&byte_5D4594[1097256] = sub_42FA20("CursorCreateGame");
	*(_DWORD*)&byte_5D4594[1097260] = sub_42FA20("CursorBusy");
	*(_DWORD*)&byte_5D4594[1097264] = sub_42FA20("CursorBuy");
	*(_DWORD*)&byte_5D4594[1097268] = sub_42FA20("CursorSell");
	*(_DWORD*)&byte_5D4594[1097272] = sub_42FA20("CursorUse");
	*(_DWORD*)&byte_5D4594[1097276] = sub_42FA20("CursorMove");
	*(_DWORD*)&byte_5D4594[1097280] = sub_42FA20("CursorPickupFar");
...
//----- (00477FF0) --------------------------------------------------------
int sub_477FF0() { return sub_4BE7B0(*(int*)&byte_5D4594[1097260]); }
...
int sub_478110() {
	...
	*(_DWORD*)&byte_5D4594[1098500] = nox_win_width;
	*(_DWORD*)&byte_5D4594[1098504] = nox_win_height;
	*(_DWORD*)&byte_5D4594[1098524] = nox_win_width;
	*(_DWORD*)&byte_5D4594[1098492] = 0;
	*(_DWORD*)&byte_5D4594[1098496] = 0;
	*(_DWORD*)&byte_5D4594[1098528] = nox_win_height;
	...
	*(_DWORD*)&byte_5D4594[1098576] = v0;
	...
	sub_478F10();
	nox_window_get_size(*(int*)&byte_5D4594[1098576], &v8, &v7);
	sub_46A9B0(*(_DWORD**)&byte_5D4594[1098576], nox_win_width - v8, nox_win_height - v7);
	...
	*(_DWORD*)&byte_5D4594[1098404] = sub_42F970("ShopTradeMode");
	*(_DWORD*)&byte_5D4594[1098408] = sub_42F970("ShopIdentifyMode");
	*(_DWORD*)&byte_5D4594[1098412] = sub_42F970("ShopRepairMode");
	*(_DWORD*)&byte_5D4594[1098416] = sub_42F970("ShopRepairMode");
	*(_DWORD*)&byte_5D4594[1098420] = sub_42F970("ShopExitMode");
	*(_DWORD*)&byte_5D4594[1098424] = sub_42F970("ShopInventoryBar1");
	*(_DWORD*)&byte_5D4594[1098428] = sub_42F970("ShopInventoryBar2");
	*(_DWORD*)&byte_5D4594[1098432] = sub_42F970("ShopInventorySlider");
	*(_DWORD*)&byte_5D4594[1098436] = sub_42F970("ShopInventorySliderSelected");
	*(_DWORD*)&byte_5D4594[1098448] = sub_42F970("ShopInventoryUp");
	...
	*(_DWORD*)&byte_5D4594[1098588] = sub_46B0C0(*(_DWORD**)&byte_5D4594[1098576], 3809);
	...
	nox_client_wndGetPosition_46AA60(v6, &byte_5D4594[1098380], &byte_5D4594[1098384]);
...
int __cdecl sub_478480(int a1, int a2, int* a3, int a4) {
	...
	case 3809:
		if (*(int*)&byte_5D4594[1107036] + 50 <= *(int*)&byte_5D4594[1098592]) {
			...
			*(_DWORD*)&byte_5D4594[1107036] =
			    *(_DWORD*)&byte_5D4594[1107036] + 50 - (*(_DWORD*)&byte_5D4594[1107036] + 50) % 50;
		} else {
...
int __cdecl sub_478650(int a1, int a2, unsigned int a3) {
	...
	if (!sub_45D9B0()) {
		...
		case 19:
			if (*(_DWORD*)&byte_5D4594[1098628] == 2) {
				nox_window_call_field_94(*(int*)&byte_5D4594[1098576], 16391,
							 *(int*)&byte_5D4594[1098584], 0);
				return 1;
			}
			break;
		case 20:
...
int sub_478970() {
	...
	nox_client_drawImageAt_47D2C0(*(int*)&byte_5D4594[1098400], nox_win_width - NOX_DEFAULT_WIDTH,
		   nox_win_height - NOX_DEFAULT_HEIGHT);
	if (*(_DWORD*)&byte_5D4594[1098628] == 2) {
		nox_client_drawImageAt_47D2C0(*(int*)&byte_5D4594[1098404], a1.field_0, a1.field_4);
		sub_478C80();
		result = 1;
	} else if (*(_DWORD*)&byte_5D4594[1098628] == 3) {
		nox_client_drawImageAt_47D2C0(*(int*)&byte_5D4594[1098408], a1.field_0, a1.field_4);
		sub_478B10(&a1);
		result = 1;
	} else if (*(_DWORD*)&byte_5D4594[1098628] == 1) {
		nox_client_drawImageAt_47D2C0(*(int*)&byte_5D4594[1098412], a1.field_0, a1.field_4);
		sub_478A70(&a1);
		result = 1;
	} else {
		if (*(_DWORD*)&byte_5D4594[1098628] == 4) {
			nox_client_drawImageAt_47D2C0(*(int*)&byte_5D4594[1098416], a1.field_0, a1.field_4);
...
int sub_478C80() {
	...
	v8 = sub_4674A0();
	sub_49F7F0();
	nox_client_copyRect_49F6F0(*(int*)&byte_5D4594[1098380], *(int*)&byte_5D4594[1098384],
		   *(_DWORD*)&byte_5D4594[1098388] - *(_DWORD*)&byte_5D4594[1098380],
		   *(_DWORD*)&byte_5D4594[1098392] - *(_DWORD*)&byte_5D4594[1098384]);
	...
	do {
		if (v1 > *(int*)&byte_5D4594[1098384] - 50) {
			nox_client_drawImageAt_47D2C0(*(_DWORD*)&byte_5D4594[4 * (v6 % 2) + 1098424], v0, v1);
			v3 = v0 + 5;
			v4 = 6;
			do {
				if (*(_DWORD*)v2) {
					...
					*(_DWORD*)(*((_DWORD*)v2 - 1) + 16) = v1 + 25;
					(*(void(__cdecl**)(unsigned __int8*, _DWORD))(*((_DWORD*)v2 - 1) + 300))(
					    &byte_5D4594[1098492], *((_DWORD*)v2 - 1));
					if (v8 < *((_DWORD*)v2 + 33))
...
//----- (00479590) --------------------------------------------------------
int sub_479590() { return *(_DWORD*)&byte_5D4594[1098628]; }
...
//----- (00479810) --------------------------------------------------------
void sub_479810() { *(_DWORD*)&byte_5D4594[1098620] = 0; }
...
//----- (00479870) --------------------------------------------------------
BOOL sub_479870() { return *(_DWORD*)&byte_5D4594[1098628] == 2; }

//----- (00479880) --------------------------------------------------------
bool __cdecl sub_479880(_DWORD* a1) { return sub_4281F0((int2*)a1, (int4*)&byte_5D4594[1098380]); }
...
int sub_479950() {
	...
	if (wndIsShown_sub_46ACC0(*(int*)&byte_5D4594[1123524]) == 1)
		return 0;
...
int sub_4799A0() {
	...
	*(_DWORD*)&byte_5D4594[1123524] = result;
	if (result) {
		...
		nox_window_set_hidden(*(int*)&byte_5D4594[1123524], 1);
...
int __cdecl sub_479CB0(int a1, int a2) {
	...
	v2 = *(_DWORD*)(a2 + 24);
	nox_client_wndGetPosition_46AA60(*(_DWORD**)&byte_5D4594[1123524], &v4, &v5);
...
//----- (0047A260) --------------------------------------------------------
int sub_47A260() { return *(_DWORD*)&byte_5D4594[1123520]; }
				...
				if (*(_DWORD*)&byte_5D4594[3799624] == 2)
					v14 = 8 *
					      (*(_BYTE*)(*(_DWORD*)&byte_5D4594[1189588] + v10 + v9 + v12 - 409600) &
						   0xF8 |
					       (32 * (*(_BYTE*)(*(_DWORD*)&byte_5D4594[1189588] + v13 + v12 - 819200) &
						      0xF8)));
				else
					v14 = 4 *
					      (*(_BYTE*)(*(_DWORD*)&byte_5D4594[1189588] + v10 + v9 + v12 - 409600) &
	...
	do {
		...
		if (v18 > 0) {
			while (v86 == *(_BYTE*)(v19 + v17 + v14 - 819222) &&
			       v89 == *(_BYTE*)(v14 + v17 + v19 - 409622) && v90 == *(_BYTE*)(v14 + v17 + v19 - 22)) {
				if (++v19 >= v18)
					goto LABEL_26;
			}
			v78 = v14;
	...
	while (v23 <= 45) {
		...
		if (v23 > 0) {
			while (v86 == *(_BYTE*)(v24 + v22 + v21 - 819222) &&
			       v89 == *(_BYTE*)(v22 + v24 + v21 - 409622) && v90 == *(_BYTE*)(v22 + v24 + v21 - 22)) {
				if (++v24 >= v23) {
					v20 = v92;
					goto LABEL_36;
				}
			...
			if (v83 > 1) {
				do {
					...
					if (*(_DWORD*)&byte_5D4594[3799624] == 2)
						...
						v65 = 4 * (v64 | (32 * v63));
					v66 = (*(_BYTE*)(v97 + *(_DWORD*)&byte_5D4594[1189588] + v76 + v77 - 22) >> 3) |
					      v65;
					if (v66 == v81) {
						if (v95 == 1) {
							++v61;
...
int __cdecl sub_47B7F0(int a1, int a2, int a3, unsigned __int8 a4) {
	...
	do {
		...
		for (j = 0; j < a1; ++j) {
			...
			if (v6 > v15 + 5 || v6 < v15 - 5 ||
			    (v16 = *(unsigned __int8*)(v13 + j - 409600), v129 > v16 + 5) || v129 < v16 - 5 ||
			    (v17 = *(unsigned __int8*)(v13 + j), v130 > v17 + 5) || v130 < v17 - 5) {
				v6 = **(_BYTE**)&byte_5D4594[1189588];
				v123 = v12;
				v11 = 1;
				break;
	...
	do {
		...
		while (v20 <= v123) {
			v22 = *(v21 - 819200);
			if (v128 > v22 + 5 || v128 < v22 - 5 || (v23 = *(v21 - 409600), v129 > v23 + 5) ||
			    v129 < v23 - 5 || (v24 = *v21, v130 > v24 + 5) || v130 < v24 - 5) {
				v25 = 1;
				v18 = v19;
				v119 = 1;
				goto LABEL_40;
	...
	do {
		...
		while (v27 <= v123) {
			v29 = *(v28 - 819200);
			if (v128 > v29 + 5 || v128 < v29 - 5 || (v30 = *(v28 - 409600), v129 > v30 + 5) ||
			    v129 < v30 - 5 || (v31 = *v28, v130 > v31 + 5) || v130 < v31 - 5) {
				v32 = 1;
				v109 = v26;
				v120 = 1;
				goto LABEL_54;
	...
	while (1) {
		...
		case 0:
			...
			if (v128 > v110 + 5 || v128 < v110 - 5 ||
				...
				if (*(_DWORD*)&byte_5D4594[3799624] == 2)
					...
					v40 = 4 * ((32 * (v110 & 0xF8)) | *(_BYTE*)(*(_DWORD*)&byte_5D4594[1189588] +
										    ((5 * v37 + 3200) << 7) + v18) &
									      0xF8);
				v41 =
				    (*(_BYTE*)(*(_DWORD*)&byte_5D4594[1189588] + ((5 * v37 + 6400) << 7) + v18) >> 3) |
				    v40;
				*v34 = 2;
				v42 = v34 + 1;
				v35 += 4;
			...
			while (1) {
				...
				if (v129 > v43 + 5 || v129 < v43 - 5 ||
				    (v44 = *(unsigned __int8*)(*(_DWORD*)&byte_5D4594[1189588] + v104 + v143),
				     v130 > v44 + 5) ||
				    v130 < v44 - 5) {
					v39 = v139;
				LABEL_88:
		...
		case 1:
			...
			if (v128 > v111 + 5 || v128 < v111 - 5 ||
			    v129 >
				*(unsigned __int8*)(*(_DWORD*)&byte_5D4594[1189588] + ((5 * v37 + 3200) << 7) + v18) +
				    5 ||
			    v129 <
				*(unsigned __int8*)(*(_DWORD*)&byte_5D4594[1189588] + ((5 * v37 + 3200) << 7) + v18) -
				    5 ||
				...
				*(unsigned __int8*)(*(_DWORD*)&byte_5D4594[1189588] + ((5 * v37 + 6400) << 7) + v18) -
				...
				if (v52 == -1) {
					...
					if (*(_DWORD*)&byte_5D4594[3799624] == 2)
						...
						v56 = 4 * ((32 * (*(_BYTE*)(*(_DWORD*)&byte_5D4594[1189588] +
									    640 * v37 + v18) &
								  0xF8)) |
							   *(_BYTE*)(*(_DWORD*)&byte_5D4594[1189588] +
								     ((5 * v37 + 3200) << 7) + v18) &
							       0xF8);
					LOBYTE(v55) = *(_BYTE*)(*(_DWORD*)&byte_5D4594[1189588] +
								((5 * v37 + 6400) << 7) + v18) >>
						      3;
					v57 = v55 | v56;
					*v34 = 2;
			...
			do {
				...
				if (v128 <= v116 + 5 && v128 >= v116 - 5) {
					if (v129 <= *(unsigned __int8*)(*(_DWORD*)&byte_5D4594[1189588] +
									((5 * v37 + 3200) << 7) + v144) +
							5 &&
					    v129 >= *(unsigned __int8*)(*(_DWORD*)&byte_5D4594[1189588] +
									((5 * v37 + 3200) << 7) + v144) -
							5 &&
					    v130 <= *(unsigned __int8*)(*(_DWORD*)&byte_5D4594[1189588] +
									((5 * v37 + 6400) << 7) + v144) +
							5 &&
					    v130 >= *(unsigned __int8*)(*(_DWORD*)&byte_5D4594[1189588] +
									((5 * v37 + 6400) << 7) + v144) -
					...
					if (*(_DWORD*)&byte_5D4594[3799624] == 2)
						...
						v63 = 4 * ((32 * (v116 & 0xF8)) |
							   *(_BYTE*)(*(_DWORD*)&byte_5D4594[1189588] +
								     ((5 * v37 + 3200) << 7) + v144) &
							       0xF8);
					v64 = (*(_BYTE*)(*(_DWORD*)&byte_5D4594[1189588] + ((5 * v37 + 6400) << 7) +
							 v144) >>
					       3) |
					      v63;
					if (v148 != 2) {
			...
			if (v18 + 1 <= v109) {
				do {
					...
					if (v128 > v117 + 5 || v128 < v117 - 5 ||
					    (v70 = *(unsigned __int8*)(*(_DWORD*)&byte_5D4594[1189588] + v108 + v145),
					     v129 > v70 + 5) ||
					    v129 < v70 - 5 ||
					    (v71 = *(unsigned __int8*)(*(_DWORD*)&byte_5D4594[1189588] + v105 + v145),
					     v130 > v71 + 5) ||
					    v130 < v71 - 5) {
...
//----- (0047DBC0) --------------------------------------------------------
unsigned __int8 sub_47DBC0() { return byte_5D4594[1193128]; }
	...
	*(_WORD*)&byte_5D4594[1191918] = 0;
	...
	case 2:
		...
		*(_WORD*)&byte_5D4594[1191804] = 0;
		strcpy((char*)&byte_5D4594[1191872], "m");
		strcpy((char*)&byte_5D4594[1191874], "M");
		strcpy((char*)&byte_5D4594[1191876], "\xb5"); // µ
		strcpy((char*)&byte_5D4594[1191866], "n");
		strcpy((char*)&byte_5D4594[1191868], "N");
		*(_WORD*)&byte_5D4594[1191870] = 0;
		strcpy((char*)&byte_5D4594[1191716], "o");
		...
		*(_WORD*)&byte_5D4594[1191894] = 0;
		strcpy((char*)&byte_5D4594[1191728], "\xfc"); // ü
		strcpy((char*)&byte_5D4594[1191730], "\xdc"); // Ü
		*(_WORD*)&byte_5D4594[1191732] = 0;
		...
		*(_WORD*)&byte_5D4594[1191736] = *(_WORD*)&byte_5D4594[1191902];
		...
		strcpy((char*)&byte_5D4594[1191806], "\xf6"); // ö
		strcpy((char*)&byte_5D4594[1191808], "\xd6"); // Ö
		*(_WORD*)&byte_5D4594[1191810] = 0;
		strcpy((char*)&byte_5D4594[1191812], "\xe4"); // ä
		strcpy((char*)&byte_5D4594[1191814], "\xc4"); // Ä
		*(_WORD*)&byte_5D4594[1191816] = 0;
		strcpy((char*)&byte_5D4594[1191818], "^");
		strcpy((char*)&byte_5D4594[1191820], "\xb0"); // °
		*(_WORD*)&byte_5D4594[1191822] = 0;
		strcpy((char*)&byte_5D4594[1191830], "#");
		strcpy((char*)&byte_5D4594[1191832], "'");
		*(_WORD*)&byte_5D4594[1191834] = 0;
		strcpy((char*)&byte_5D4594[1191644], "\xdf"); // ß
	...
	case 3:
		...
		*(_WORD*)&byte_5D4594[1191588] = 0;
		strcpy((char*)&byte_5D4594[1191590], "\xe9"); // é
		...
		*(_WORD*)&byte_5D4594[1191810] = 0;
		strcpy((char*)&byte_5D4594[1191812], "\xf9"); // ù
		strcpy((char*)&byte_5D4594[1191814], "%");
		*(_WORD*)&byte_5D4594[1191816] = 0;
		...
		*(_WORD*)&byte_5D4594[1191830] = *(_WORD*)&byte_5D4594[1191902];
		strcpy((char*)&byte_5D4594[1191832], "\xb5"); // µ
		*(_WORD*)&byte_5D4594[1191834] = 0;
		strcpy((char*)&byte_5D4594[1191644], ")");
		strcpy((char*)&byte_5D4594[1191646], "\xb0"); // °
		strcpy((char*)&byte_5D4594[1191648], "]");
		strcpy((char*)&byte_5D4594[1191650], "=");
		*(_WORD*)&byte_5D4594[1191652] = *(_WORD*)&byte_5D4594[1192040];
	...
	case 5:
		...
		*(_WORD*)&byte_5D4594[1191890] = *(_WORD*)&byte_5D4594[1192016];
		strcpy((char*)&byte_5D4594[1191892], "_");
		*(_WORD*)&byte_5D4594[1191894] = 0;
		strcpy((char*)&byte_5D4594[1191728], "\xe8"); // è
		strcpy((char*)&byte_5D4594[1191730], "\xe9"); // é
		strcpy((char*)&byte_5D4594[1191732], "[");
		*(_WORD*)&byte_5D4594[1191734] = *(_WORD*)&byte_5D4594[1192040];
		*(_WORD*)&byte_5D4594[1191736] = *(_WORD*)&byte_5D4594[1191902];
		strcpy((char*)&byte_5D4594[1191738], "]");
		strcpy((char*)&byte_5D4594[1191806], "\xf2"); // ò
		strcpy((char*)&byte_5D4594[1191808], "\xe7"); // ç
		strcpy((char*)&byte_5D4594[1191810], "@");
		strcpy((char*)&byte_5D4594[1191812], "\xe0"); // à
		strcpy((char*)&byte_5D4594[1191814], "\xb0"); // °
		strcpy((char*)&byte_5D4594[1191816], "#");
		strcpy((char*)&byte_5D4594[1191818], "\\");
		strcpy((char*)&byte_5D4594[1191820], "|");
		*(_WORD*)&byte_5D4594[1191822] = 0;
		strcpy((char*)&byte_5D4594[1191830], "\xf9"); // ù
		*(_WORD*)&byte_5D4594[1191832] = 167;
		*(_WORD*)&byte_5D4594[1191834] = 0;
		strcpy((char*)&byte_5D4594[1191644], "'");
		strcpy((char*)&byte_5D4594[1191646], "?");
		*(_WORD*)&byte_5D4594[1191648] = 0;
		strcpy((char*)&byte_5D4594[1191650], "\xec"); // ì
		strcpy((char*)&byte_5D4594[1191652], "^");
		*(_WORD*)&byte_5D4594[1191654] = 0;
	LABEL_9:
		strcpy((char*)&byte_5D4594[1192088], "<");
    ...
    if (a5[2] | a5[1] | *a5)
    {
        ...
        while (1)
        {
            ...
            if ((int)v32 >= *(int*)& dword_5d4594_3798844)
                v32 = (__m64*)((char*)v32 + *(_DWORD*)& byte_5D4594[3798796] - *(_DWORD*)& dword_5d4594_3798844);
            ...
            *(__m64*)v26 = v38;
            ...
            if ((int)v6 >= *(int*)& dword_5d4594_3798844)
                v6 = (__m64*)((char*)v6 + *(_DWORD*)& byte_5D4594[3798796] - *(_DWORD*)& dword_5d4594_3798844);
    ...
    else
    {
        ...
        while (1)
        {
            ...
            if ((int)v48 >= *(int*)& dword_5d4594_3798844)
                v48 = (__m64*)((char*)v48 + *(_DWORD*)& byte_5D4594[3798796] - *(_DWORD*)& dword_5d4594_3798844);
            v26 += 8;
...
int __cdecl sub_480950(int* a1, int* a2, int a3, int a4, int a5) {
	...
	if (v7 >= 0 && result >= 0 && v7 < *(int*)&byte_5D4594[3798800] && result < *(int*)&byte_5D4594[3798808]) {
		v8 = *(_DWORD*)&byte_5D4594[3798804] * (*(_DWORD*)&byte_5D4594[3798840] + result) +
		     *(_DWORD*)&byte_5D4594[3798796] + 2 * (*(_DWORD*)&byte_5D4594[3798836] + v7);
		if (v8 >= *(int*)&dword_5d4594_3798844)
			v8 += *(_DWORD*)&byte_5D4594[3798796] - dword_5d4594_3798844;
		if (*(_WORD*)&nox_common_engineFlags & 0x800) {
			if (2 * a4 + v8 < *(int*)&dword_5d4594_3798844) {
				result =
				    (*(int(__cdecl**)(_DWORD, _DWORD, _DWORD)) & byte_5D4594[3807160])(a5, v8, 2 * a4);
			} else {
				v9 = dword_5d4594_3798844 - v8;
				(*(void(__cdecl**)(_DWORD, _DWORD, _DWORD)) &
				 byte_5D4594[3807160])(a5, v8, dword_5d4594_3798844 - v8);
				result = (*(int(__cdecl**)(_DWORD, _DWORD, _DWORD)) &
					  byte_5D4594[3807160])(a5 + v9, *(_DWORD*)&byte_5D4594[3798796], 2 * a4 - v9);
			}
		} else {
			v23 = (__m64*)v8;
			...
			v13 = *(_DWORD*)&byte_5D4594[4 * ((*(int*)&byte_5D4594[v11 + 2598568] -
							   *(int*)&byte_5D4594[v11 + 2598288]) >>
							  8) +
						     2615304];
			v22[0] = *(_DWORD*)&byte_5D4594[4 * ((*(int*)&byte_5D4594[v11 + 2598568] -
							      *(int*)&byte_5D4594[v11 + 2598288]) >>
							     8) +
							2615304];
			v14 = *(_DWORD*)&byte_5D4594[4 * ((*(int*)&byte_5D4594[v11 + 2598572] -
							   *(int*)&byte_5D4594[v11 + 2598292]) >>
							  8) +
						     2615304];
			v22[1] = *(_DWORD*)&byte_5D4594[4 * ((*(int*)&byte_5D4594[v11 + 2598572] -
							      *(int*)&byte_5D4594[v11 + 2598292]) >>
							     8) +
							2615304];
			v15 = *(_DWORD*)&byte_5D4594[4 * ((*(int*)&byte_5D4594[v11 + 2598576] -
							   *(int*)&byte_5D4594[v11 + 2598296]) >>
							  8) +
						     2615304];
			v22[2] = v15;
			v21[0] = *v12;
			...
			while (1) {
				...
				if ((unsigned int)v18 >= *(int*)&dword_5d4594_3798844)
					v18 = (__m64*)((char*)v18 - 2 * ((*(int*)&dword_5d4594_3798844 -
									  *(int*)&byte_5D4594[3798796]) >>
									 1));
				result = a4 - v17;
				a4 -= v17;
				if (a4 <= 0)
				...
				*a2 = v19;
				...
				v22[0] = *(_DWORD*)&byte_5D4594[4 * ((*(int*)&byte_5D4594[v20 + 2598568] -
								      *(int*)&byte_5D4594[v20 + 2598288]) >>
								     8) +
								2615304];
				v22[1] = *(_DWORD*)&byte_5D4594[4 * ((*(int*)&byte_5D4594[v20 + 2598572] -
								      *(int*)&byte_5D4594[v20 + 2598292]) >>
								     8) +
								2615304];
				v22[2] = *(_DWORD*)&byte_5D4594[4 * ((*(int*)&byte_5D4594[v20 + 2598576] -
								      *(int*)&byte_5D4594[v20 + 2598296]) >>
								     8) +
								2615304];
			}
		}
...
void __cdecl sub_480BE0(_DWORD* a1, int* a2, int a3, int a4, int a5) {
	...
	if (nox_common_engineFlags & 0x800) {
		if ((unsigned int)&v6[2 * a4] < x1) {
			...
			v7 = x1 - v6;
			(*(void(__cdecl**)(_DWORD, _DWORD, _DWORD)) & byte_5D4594[3807160])(a5, v6, x1 - v6);
			(*(int(__cdecl**)(_DWORD, _DWORD, _DWORD)) &
			 byte_5D4594[3807160])(a5 + v7, *(_DWORD*)&byte_5D4594[3798796], 2 * a4 - v7);
		}
	} else {
		...
		if (v9 <= 0) {
			...
			v12 += v9 *
			       *(_DWORD*)&byte_5D4594[4 * ((*(int*)&byte_5D4594[v10 + 2598572] - v12) >> 8) + 2615304];
			v11 += v9 * v22;
			v13 += v9 * v24;
			v25 = 23 - v9;
		}
...
char __cdecl sub_4815E0(_DWORD* a1, int a2) {
	...
	if (v2 >= *(int*)&dword_5d4594_3798844)
		v2 += *(_DWORD*)&byte_5D4594[3798796] - dword_5d4594_3798844;
	v3 = sub_42FB30(a2);
	v4 = (char*)v3;
	v14 = (char*)v3;
	if (v3) {
		v5 = dword_5d4594_3798844;
		if (v2 + *(int*)&byte_5D4594[3799236] >= *(int*)&dword_5d4594_3798844) {
			v6 = 0;
			for (i = 0;; v6 = i) {
...
char* __cdecl sub_481770(_DWORD* a1, int a2, unsigned __int16 a3) {
	...
	if (v6 >= *(int*)&dword_5d4594_3798844)
		v6 += *(_DWORD*)&byte_5D4594[3798796] - dword_5d4594_3798844;
		...
		while (1) {
			...
			if (v6 + v9 + v8 < v5) {
				...
				if (v10 <= 0) {
					...
					v7 = v12;
					result =
					    (char*)(*(_DWORD*)&byte_5D4594[3798796] - dword_5d4594_3798844);
					v6 += *(_DWORD*)&byte_5D4594[3798796] - dword_5d4594_3798844;
				}
			}
			v7 += 4;
	...
	if (v9) {
		...
		if (v9) {
			...
			if (v13 >= *(int*)&dword_5d4594_3798844) {
				v13 += *(_DWORD*)&byte_5D4594[3798796] - dword_5d4594_3798844;
				v31 = v13;
			}
			v28 = v32;
			v30 = v25;
			if (v32 <= (int)v25) {
				do {
					...
					v26 = v14;
					v15 = (char*)(v13 + (*(_DWORD*)&byte_5D4594[4 * v9 + 3799052]
							     << byte_5D4594[3807124]));
					if (v24 > 0) {
						do {
							LOBYTE(v9) = *v10;
...
LABEL_9:
	...
	if (v3 >= *(int*)&byte_5D4594[3798820] + 23) {
		...
		if (nox_backbuffer_width + v3 <= *(int*)&byte_5D4594[3798800] + *(_DWORD*)&byte_5D4594[3798820] - 46 ||
	...
	if (*(_DWORD*)&byte_587000[154956]) {
		...
		if (*(int*)&byte_5D4594[3679320] < *(int*)&byte_5D4594[3798156]) {
			...
			for (j = (int)&byte_5D4594[128 * *(_DWORD*)&byte_5D4594[3679320] + 3682956];;
				...
				v53 = (int*)v51;
				if (*(_DWORD*)&byte_587000[154952] || !(v67.field_4 & 1) ||
				    v51 == &byte_5D4594[3682956]) {
					if (v52 > 0) {
				...
				if (v36 > 0) {
					...
					do {
						...
						v71 = *(_DWORD*)&byte_5D4594[3798804] *
						      (v67.field_4 + *(_DWORD*)&byte_5D4594[3798840] -
				...
				do {
					...
					if (v12) {
						if (v12 & 2) {
							...
							v18 =
							    *(_DWORD*)(*(_DWORD*)&byte_5D4594[60 * v14 + 2682220] +
								       4 * (*(_DWORD*)(v13 + 28) +
									    *(unsigned __int16*)&byte_5D4594[60 * v14 +
													     2682234]));
							v24.field_0 = v8;
							v24.field_4 = v6 + 23;
						...
						if (*(_BYTE*)v13 & 1) {
							...
							v19 =
							    *(_DWORD*)(*(_DWORD*)&byte_5D4594[60 * v15 + 2682220] +
								       4 * (*(_DWORD*)(v13 + 8) +
									    *(unsigned __int16*)&byte_5D4594[60 * v15 +
													     2682234]));
							v24.field_0 = v8 + 23;
							v24.field_4 = v6;
							(*(void(__cdecl**)(int2*, _DWORD, _DWORD)) &
		...
		if (v5 < v6) {
			...
			do {
				...
				if (v12 < *v11) {
					...
					do {
						v16 = v14 / ((v13 * v13 + v10 * v10) * *(float*)&byte_587000[154984] *
								 *(float*)&byte_587000[154972] / *(float*)&v18 +
							     1.0);
...
int __cdecl sub_485B30(int a1, char* a2) {
	...
	*(_DWORD*)(v2 + 8) = v9 + 4;
	...
	v20 = 15 * v7;
	*(_DWORD*)&byte_5D4594[60 * v7 + 2682220] = nox_malloc(4 * v10);
	v11 = 0;
	for (i = 0; v11 < v10;
	     *(_DWORD*)(*(_DWORD*)&byte_5D4594[4 * v20 + 2682220] + 4 * v11 - 4) = sub_42FAA0(v13, v21, a2)) {
		v12 = *(int**)(v2 + 8);
		v13 = *v12;
		*(_DWORD*)(v2 + 8) = v12 + 1;
...
int __cdecl sub_485D40(int a1, char* a2) {
	...
	*(_DWORD*)&byte_5D4594[60 * v7 + 2678380] = result;
	if (result) {
		v15 = 0;
		for (i = 0; v15 < v14;
		     *(_DWORD*)(*(_DWORD*)&byte_5D4594[4 * v24 + 2678380] + 4 * v15 - 4) = sub_42FAA0(v17, v25, a2)) {
			v16 = *(int**)(v2 + 8);
			v17 = *v16;
			*(_DWORD*)(v2 + 8) = v16 + 1;
...
unsigned int __cdecl sub_486A10(int a1, void* a2) {
	...
	v2 = bsearch(a2, *(const void**)a1, *(_DWORD*)(a1 + 4), 0x24u,
...
//----- (004896C0) --------------------------------------------------------
int sub_4896C0() { return *(_DWORD*)&byte_5D4594[1193356]; }
...
int sub_489870() {
	...
	return nox_window_set_hidden(*(int*)&byte_5D4594[1193380], 1);
}
		...
		*(_DWORD*)&byte_5D4594[1193384] = sub_46B0C0(result, 10012);
		...
		if (v11) {
			...
			if (v12) {
				...
				nox_window_set_hidden(*(int*)&byte_5D4594[1193384], 1);
			}
		} else {
...
void sub_489DC0() {
	...
	nox_window_set_hidden(*(int*)&byte_5D4594[1193384], 0);
...
int nox_video_cursorThreadWorker_48BEB0() {
	...
	while (nox_video_allowCursorDrawThread) {
		...
		if (!nox_video_pauseThreadedDrawCursor && nox_video_drawCursorThreadOk &&
		    *(_DWORD*)&byte_5D4594[823776] && *(_DWORD*)&byte_5D4594[1193672] &&
		    *(_DWORD*)&byte_5D4594[1193108] && *(_DWORD*)&byte_5D4594[787144] && !sub_430890()) {
...
void __cdecl sub_48C170(int4* a1, int4* a2) {
	if (nox_video_renderTargetFlags & 0x10) {
		...
		a1->field_C = *(_DWORD*)&byte_5D4594[1193688] * a2->field_C / nox_backbuffer_height;
	} else {
