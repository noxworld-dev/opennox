...
int __cdecl sub_4765F0(int a1) {
	...
	*(_DWORD*)&byte_5D4594[1096440] = dword_587000_154952;
	result = *(_DWORD*)&byte_5D4594[2614252];
	*(_DWORD*)&byte_5D4594[1096444] = dword_587000_80820;
...
int sub_476680() {
	...
	dword_587000_154952 = *(_DWORD*)&byte_5D4594[1096440];
	dword_587000_80820 = *(_DWORD*)&byte_5D4594[1096444];
	return result;
}
							...
							if (v18) {
								if (v18 == 1) {
									if ((unsigned int)v15 >= v12 ||
										...
										v22 = &v13[v19];
										v13 += v20 + v19;
										qmemcpy(*(void**)&dword_5d4594_3798796,
											v22, v20);
										v15 = (char*)(v20 + v21);
										v14 = v31;
										v12 = v28;
			...
			*((_DWORD*)v2 + 86) = 0;
			...
			if (v10 - *((int*)v2 + 86) > 1 || v10 <= 0) {
				...
				v13 = dword_5d4594_3798804 *
				      ((_DWORD)result + dword_5d4594_3798840 - v9);
...
int __cdecl sub_478480(int a1, int a2, int* a3, int a4) {
	...
	if (a2 != 16391) {
		if (a2 == 16393) {
			dword_5d4594_1107036 = *(_DWORD*)&byte_5D4594[1098592] - a4;
			return 0;
		}
		return 0;
	}
	...
	case 3808:
		...
		break;
	case 3809:
		if (*(int*)&dword_5d4594_1107036 + 50 <= *(int*)&byte_5D4594[1098592]) {
			v7 = dword_5d4594_1107036 + 50 - (dword_5d4594_1107036 + 50) % 50;
			dword_5d4594_1107036 =
			    dword_5d4594_1107036 + 50 - (dword_5d4594_1107036 + 50) % 50;
		} else {
...
int __cdecl sub_478650(int a1, int a2, unsigned int a3) {
	...
	if (!sub_45D9B0()) {
		...
		case 19:
			if (dword_5d4594_1098628 == 2) {
				nox_window_call_field_94(*(int*)&dword_5d4594_1098576, 16391,
...
int sub_478C80() {
	...
	v1 = *(_DWORD*)&byte_5D4594[1098384] - dword_5d4594_1107036;
...
int __cdecl sub_478E50(int a1, int a2, unsigned int a3) {
	...
	if (dword_5d4594_1098628 == 2) {
		...
		v4 = (int)((a3 >> 16) - *(_DWORD*)&byte_5D4594[1098384] + dword_5d4594_1107036) / 50;
		if (v3 >= 6)
			v3 = 5;
		if (v4 >= 10)
			v4 = 9;
...
int sub_479280() {
	...
	if (*(_DWORD*)&byte_5D4594[1098624]) {
		...
		*(_DWORD*)&byte_5D4594[1098624] = 0;
		...
		if (!dword_587000_80828 && *(_DWORD*)&byte_5D4594[1098612] == 1)
			dword_587000_80828 = 1;
	}
	return result;
}
...
int __cdecl sub_4798A0(_DWORD* a1) {
	...
	v3 = (a1[1] - *(_DWORD*)&byte_5D4594[1098384] + dword_5d4594_1107036) / 50;
	if (v2 >= 6)
		v2 = 5;
	if (v3 >= 10)
		v3 = 9;
...
int sub_47A1F0() {
	...
	result = dword_587000_80828;
	*(_DWORD*)&byte_5D4594[1123520] = 0;
	if (!dword_587000_80828 && *(_DWORD*)&byte_587000[153436] == 1)
		dword_587000_80828 = 1;
	return result;
}
			...
			if (v5 != (HANDLE)-1) {
				if (dword_5d4594_1189584) {
					strcpy((char*)(dword_5d4594_1189584 +
						       336 * dword_5d4594_1123532),
					       v1);
					strcpy((char*)(336 * dword_5d4594_1123532 +
						       dword_5d4594_1189584 + 260),
					       FindFileData.cFileName);
					*(_DWORD*)(336 * dword_5d4594_1123532 +
		...
		if (*(_WORD*)&nox_common_engineFlags & 0x800) {
			if (2 * a4 + v8 < *(int*)&dword_5d4594_3798844) {
				...
				result = (*(int(__cdecl**)(_DWORD, _DWORD, _DWORD)) &
					  byte_5D4594[3807160])(a5 + v9, dword_5d4594_3798796, 2 * a4 - v9);
			}
		} else {
			v23 = (__m64*)v8;
...
int* __cdecl sub_480EF0(int a1, int a2, int a3, int* a4, int* a5, int a6, int a7, int a8, int a9, int a10) {
	...
	while (1) {
		...
		v54 = 0;
		v55 = 0;
		if (dword_587000_80820 || !(v45.field_4 & 1)) {
			if (v10 <= 0) {
				v35 = a1;
			} else {
				do {
...
char __cdecl sub_4815E0(_DWORD* a1, int a2) {
	...
	v2 = dword_5d4594_3798804 *
		 (dword_5d4594_3798840 + a1[1] - dword_5d4594_3798824) +
	     dword_5d4594_3798796 +
	     ((dword_5d4594_3798836 + *a1 - dword_5d4594_3798820) << byte_5D4594[3807124]);
		...
		while (1) {
			...
			if (v6 + v9 + v8 < v5) {
				...
				if (v10 <= 0) {
					...
					v7 = v12;
					result =
					    (char*)(dword_5d4594_3798796 - dword_5d4594_3798844);
					v6 += dword_5d4594_3798796 - dword_5d4594_3798844;
				}
			}
			v7 += 4;
...
char __cdecl sub_481900(_DWORD* a1, _DWORD* a2) {
	...
	*(_DWORD*)&byte_5D4594[4 * v4 + 2523980] = 1;
	v8 = dword_5d4594_3798804 * (v7 + a1[1] - v2) + dword_5d4594_3798796 +
	     ((v5 + *a1 - dword_5d4594_3798820) << byte_5D4594[3807124]);
	v9 = sub_42FB30(v6);
	if (v9) {
		v32 = *(_BYTE*)v9;
		v25 = *(_BYTE*)(v9 + 1);
...
LABEL_9:
	...
	if (*(int*)&dword_5d4594_3798832 < *(int*)&dword_5d4594_3798832 + *(int*)&byte_5D4594[3798816]) {
		...
		for (i = 44 * dword_5d4594_3798832;; v12 = i) {
			...
			v11 += 46;
			v18 = (int)++v74 < *(int*)&dword_5d4594_3798832 + *(_DWORD*)&byte_5D4594[3798816];
			i += 44;
			if (!v18)
				break;
		}
	...
	if (dword_587000_154956) {
		...
		if (*(int*)&dword_5d4594_3679320 < *(int*)&byte_5D4594[3798156]) {
			...
			for (j = (int)&byte_5D4594[128 * dword_5d4594_3679320 + 3682956];;
				...
				v53 = (int*)v51;
				if (dword_587000_154952 || !(v67.field_4 & 1) ||
			...
			do {
				...
				if (v36 > 0) {
					...
					do {
						...
						v71 = dword_5d4594_3798804 *
						      (v67.field_4 + dword_5d4594_3798840 -
						       dword_5d4594_3798824);
						v35 += 8;
						v39 = (char*)(dword_5d4594_3798804 *
								  (v67.field_4 + dword_5d4594_3798840 -
								   dword_5d4594_3798824) +
							      dword_5d4594_3798796 +
							      ((v37 + v72 + dword_5d4594_3798836 -
								dword_5d4594_3798820)
							       << byte_5D4594[3807124]));
						if ((unsigned int)v39 >= *(int*)&dword_5d4594_3798844)
							v39 += dword_5d4594_3798796 -
						...
						if ((unsigned int)&v39[v38 << byte_5D4594[3807124]] <
						    *(int*)&dword_5d4594_3798844) {
							...
							qmemcpy(v42, *(const void**)&dword_5d4594_3798796,
								4 * (v40 >> 2));
						}
						v44 = &v39[4 * (v40 >> 2)];
						v43 = &v42[4 * (v40 >> 2)];
