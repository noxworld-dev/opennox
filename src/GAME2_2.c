...
int  sub_4761B0(int a1) {
	...
	v3 = (*(_DWORD*)(*getMemU32Ptr(0x5D4594, 2614252) + 16) - result) * *getMemIntPtr(0x587000, 196184 + v2) -
		 (*(_DWORD*)(*getMemU32Ptr(0x5D4594, 2614252) + 12) - *(_DWORD*)(a1 + 12)) * *getMemIntPtr(0x587000, 196188 + v2);
	...
	if (v3 >= 0) {
		if (v4 <= result)
			result += *getMemIntPtr(0x587000, 196188 + 8 * *(unsigned __int8*)(a1 + 299));
	} else if (v4 > result) {
		result += *getMemIntPtr(0x587000, 196188 + 8 * *(unsigned __int8*)(a1 + 299));
	}
	return result;
...
void sub_476270(_DWORD* a1) {
	...
	if (v27 >= 2) {
		...
		for (i = 0;; v3 = i) {
			...
			nox_client_drawSetColor_434460(*getMemIntPtr(0x8529A0, 4620));
...
int(*  sub_476AE0(int a1, unsigned __int8* a2))(int* a1, int a2) {
	...
	void( * v33)(unsigned int, _BYTE*, int); // [esp+34h] [ebp+8h]

	v2 = a2;
	result2 = (int(*)(int*, int)) * ((_DWORD*)a2 + 75);
...
//----- (00476DA0) --------------------------------------------------------
void  sub_476DA0(unsigned int* a1, _DWORD* a2, unsigned int a3) {
	unsigned int* v3; // edi
	signed int v4;    // ecx
	_DWORD* v5;       // esi
...
int sub_476E90() {
	...
	do {
		if (*getMemU32Ptr(0x5D4594, 1096596 + v1)) {
			nox_client_drawImageAt_47D2C0(*getMemU32Ptr(0x5D4594, 1096564 + v1), nox_win_width / 2 + *(_DWORD*)v0 - 16,
...
int sub_476F60() {
	...
	if (dword_5d4594_1096640)
		result = *(_DWORD*)((_DWORD)dword_5d4594_1096640 + 128);
	else
		result = 0;
	return result;
}
...
LABEL_38:
	...
	if (v2 != *getMemU32Ptr(0x5D4594, 2614252) &&
		...
		if (*getMemU32Ptr(0x8529A0, 4624) &&
			*(_BYTE*)(*getMemU32Ptr(0x8529A0, 4624) + 2251) == 1 &&
...
//----- (00477470) --------------------------------------------------------
void  nox_video_drawCursorSelectCircle2_477470(_DWORD* a1, int a2, int a3) {
	int v3;   // ebx
	int v4;   // ebx
	int v5;   // esi
	int v6;   // edi
...
//----- (00477530) --------------------------------------------------------
unsigned __int8  sub_477530(int a1) {
...
void nox_xxx_cursorSetDraggedItem_477690(nox_drawable* a1) {
	nox_client_itemDragnDrop_1097188 = a1;
}
...
void nox_client_drawCursorAndTooltips_477830() {
	...
	*getMemU32Ptr(0x5D4594, 1097204) = 0;
	...
	{
		*(_DWORD*)((_DWORD)nox_client_itemDragnDrop_1097188 + 12) = mpos.x;
		*(_DWORD*)((_DWORD)nox_client_itemDragnDrop_1097188 + 16) = mpos.y;
		(*(void(**)(int*, _DWORD))((_DWORD)nox_client_itemDragnDrop_1097188 + 300))(v9, nox_client_itemDragnDrop_1097188);
	}
...
int sub_477EA0() {
	...
	int x = mpos.x;
	int y = mpos.y + 22;
	nox_video_cursorDrawImpl_477A30(*getMemIntPtr(0x8529A0, 36372), x, y);
...
int sub_478110() {
	...
	*getMemU32Ptr(0x5D4594, 1098480) = nox_xxx_gLoadImg_42F970("ShopkeeperMagicShopPic");
	dword_5d4594_1098580 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1098576, 3807);
	*getMemU32Ptr(0x5D4594, 1098584) = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1098576, 3808);
	*getMemU32Ptr(0x5D4594, 1098588) = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1098576, 3809);
	v6 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1098576, 3806);
	...
	*(_DWORD*)(*(_DWORD*)(dword_5d4594_1098580 + 400) + 12) = 12;
	nox_xxx_wndSetOffsetMB_46AE40(*(_DWORD*)(dword_5d4594_1098580 + 400), 0, -15);
...
int  sub_478A70(int2* a1) {
	...
	if (dword_5d4594_1098604)
		result = nox_xxx_drawString_43FAF0(0, *(_WORD**)&dword_5d4594_1098604, v5 + 8, v6 + 8, v4 - 16, v3 - 16);
	return result;
}
			...
			do {
				if (*(_DWORD*)v2) {
					...
					*(_DWORD*)(*((_DWORD*)v2 - 1) + 16) = v1 + 25;
					(*(void(**)(unsigned __int8*, _DWORD))(*((_DWORD*)v2 - 1) + 300))(getMemAt(0x5D4594, 1098492),
																							 *((_DWORD*)v2 - 1));
					if (v8 < *((_DWORD*)v2 + 33))
...
_DWORD* sub_478F10() {
	...
	do {
		...
		do {
			if (*(_DWORD*)v0)
				nox_xxx_spriteDelete_45A4B0(*(_QWORD**)v0);
			*(_DWORD*)v0 = 0;
			v2 = v0 + 8;
			*((_DWORD*)v0 + 1) = 0;
			v0 += 1400;
...
int sub_478F80() {
	...
	sub_478F10();
	sub_44D8F0();
	nox_xxx_windowDestroyMB_46C4E0(*(_DWORD**)&dword_5d4594_1098576);
	result = 0;
...
//----- (00479300) --------------------------------------------------------
_DWORD*  sub_479300(int a1, int a2, int a3, __int16 a4, int a5) {
	_DWORD* result; // eax
	_DWORD* v6;     // ebx
	int* v7;        // edi
	int i;          // esi
			...
			if (*(_DWORD*)(*v6 + 112) & 0x13001000) {
				...
				for (i = 0; i < 4; ++i) {
					if (*(char*)(i + a5) == -1)
						...
						*v7 = nox_xxx_modifGetDescById_413330(*(unsigned __int8*)(i + a5));
					++v7;
				}
			}
			v6[1] = 0;
...
char*  sub_479480(int a1) {
	...
	if (result) {
		...
		*((_DWORD*)v2 + 1) = result;
		if (!result) {
			result = (char*)nox_xxx_spriteDelete_45A4B0(*(_QWORD**)v2);
			*(_DWORD*)v2 = 0;
			*((_DWORD*)v2 + 34) = 0;
		}
	}
...
//----- (00479690) --------------------------------------------------------
int  sub_479690(int a1, __int16 a2, __int16 a3, int a4) {
	int result; // eax
...
//----- (00479700) --------------------------------------------------------
int  sub_479700(__int16 a1, char a2) {
...
//----- (00479820) --------------------------------------------------------
int  sub_479820(int a1, __int16 a2) {
	int result; // eax
...
//----- (00479880) --------------------------------------------------------
bool  sub_479880(_DWORD* a1) { return sub_4281F0((int2*)a1, (int4*)getMemAt(0x5D4594, 1098380)); }

//----- (004798A0) --------------------------------------------------------
int  sub_4798A0(_DWORD* a1) {
	int v1;              // eax
	int v2;              // ecx
	int v3;              // edx
	int v4;              // edx
...
int sub_4799A0() {
	...
	*getMemU32Ptr(0x5D4594, 1107052) = nox_color_rgb_4344A0(240, 128, 64);
	...
	if (result) {
		...
		v3 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1123524, 3901);
		v4 = (int)v3;
		v5 = (_DWORD*)v3[8];
		...
		v5[7] = v2;
		v5[8] = v10;
		v7 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1123524, 3906);
...
//----- (00479BE0) --------------------------------------------------------
int  sub_479BE0(_DWORD* a1, int a2, unsigned int a3, int a4) {
	switch (a2) {
	case 5:
	case 6:
	case 7:
	...
	case 14:
	case 15:
		nox_xxx_wndPointInWnd_46AAB0(a1, (unsigned __int16)a3, a3 >> 16);
		break;
	default:
		return 1;
	}
...
//----- (00479C40) --------------------------------------------------------
int  sub_479C40(_DWORD* a1, int a2) {
	char v2;   // bl
...
int sub_479D10() {
	...
	nox_xxx_windowDestroyMB_46C4E0(*(_DWORD**)&dword_5d4594_1123524);
	result = 0;
...
int sub_47A1F0() {
	...
	v0 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1123524, 3901);
...
//----- (0047A310) --------------------------------------------------------
DWORD  sub_47A310(LPCSTR lpPathName) {
	DWORD result;                          // eax
	char* v3;                              // edx
	const char* v4;                        // ebp
	HANDLE v5;                             // ebx
			...
			*((_WORD*)v3 + 2) = v2;
			...
			if (v5 != (HANDLE)-1) {
				if (dword_5d4594_1189584) {
					...
					strcpy((char*)(336 * dword_5d4594_1123532 + (char*)dword_5d4594_1189584 + 260), FindFileData.cFileName);
					*(_DWORD*)(336 * dword_5d4594_1123532 + (char*)dword_5d4594_1189584 + 324) = 0;
				}
...
//----- (0047AD60) --------------------------------------------------------
int  nox_xxx_videoBag_LoadTile_47AD60(int a1, int a2, _WORD* a3) {
	int v3;      // edi
	int v4;      // edx
	int i;       // esi
	int v6;      // ecx
...
//----- (0047AF30) --------------------------------------------------------
int  nox_xxx_videoBag_LoadEdge_47AF30(int a1, int a2, unsigned __int8* a3) {
	int v3;               // edx
	int v4;               // eax
	int v5;               // ecx
	int v6;               // eax
...
int sub_47D200() {
	...
	*getMemU32Ptr(0x8529A0, 1185196) = 0;
	*getMemU32Ptr(0x8529A0, 1185156) = 0;
	dword_5d4594_3799476 = 0;
	dword_5d4594_3799452 = 0;
	*getMemU32Ptr(0x8529A0, 1185188) = 0;
	*getMemU32Ptr(0x8529A0, 1185248) = 0;
	*getMemU32Ptr(0x8529A0, 1185152) = 0;
	*getMemU32Ptr(0x8529A0, 1185180) = 0;
	*getMemU32Ptr(0x8529A0, 1185176) = 0;
	*getMemU32Ptr(0x8529A0, 1185244) = 0;
	*getMemU32Ptr(0x8529A0, 1185164) = 0;
	*getMemU32Ptr(0x8529A0, 1185264) = 0;
...
void nox_client_drawImageAt_47D2C0(nox_video_bag_image_t* img, int x, int y) {
	if (dword_5d4594_3799452) {
		nox_xxx_wndDraw_49F7F0();
		sub_49F780(*getMemIntPtr(0x8529A0, 1185196), *getMemIntPtr(0x8529A0, 1185156));
		sub_49F6D0(1);
	}
	...
	dword_5d4594_3799484 = 0;
	*getMemU32Ptr(0x8529A0, 1185264) = 0;
	if (*getMemU32Ptr(0x8529A0, 1185212) && img) {
		if (*getMemU32Ptr(0x8529A0, 1185236) != img->field_1_0 || *getMemU32Ptr(0x8529A0, 1185228) != img->field_1_1) {
			dword_5d4594_3799524 = 1;
		}
		img->field_1_0 = *getMemU16Ptr(0x8529A0, 1185236);
		img->field_1_1 = *getMemU16Ptr(0x8529A0, 1185228);
	}
}
...
int  sub_47D380(int a1, int a2) {
	...
	if (v2 == v3)
		return 0;
	if (v2 != v4 || v3 != v5) {
		*getMemU32Ptr(0x8529A0, 1185196) = v2;
		*getMemU32Ptr(0x8529A0, 1185156) = v3;
...
int  sub_47D3F0(int a1) {
	...
	result = a1;
	*getMemU32Ptr(0x8529A0, 1185188) = a1;
	return result;
}
...
int  nox_xxx_unused_47D420(int a1, int a2, int a3, int a4, int a5, int a6) {
	...
	*getMemU32Ptr(0x8529A0, 1185264) = 1;
	*getMemU32Ptr(0x8529A0, 1185248) = a1 << 16;
	*getMemU32Ptr(0x8529A0, 1185152) = a2 << 16;
	*getMemU32Ptr(0x8529A0, 1185180) = a3 << 16;
	result = a4 << 16;
	*getMemU32Ptr(0x8529A0, 1185176) = a4 << 16;
	*getMemU32Ptr(0x8529A0, 1185244) = a5 << 16;
	*getMemU32Ptr(0x8529A0, 1185164) = a6 << 16;
	return result;
}
...
//----- (0047D4E0) --------------------------------------------------------
__int16  nox_xxx_video_ReadTile_Real_47D4E0(_DWORD* a1) {
	int v1;         // ecx
	_WORD* v2;      // edi
	__int16 result; // ax
...
int sub_47FCE0(_DWORD* a1, int a2) {
	...
	LABEL_8:
		...
		*getMemU32Ptr(0x8529A0, 1191232 + v4) = a1[3];
		*getMemU32Ptr(0x8529A0, 1191236 + v4) = a1[2];
		*getMemU32Ptr(0x8529A0, 1191240 + v4) = a1[21];
		*getMemU32Ptr(0x8529A0, 1191244 + v4) = a1[26];
		dword_5d4594_3804684 = v5;
	} else {
		v3 = getMemAt(0x8529A0, 1191236);
...
int nox_xxx_setupSomeVideo_47FEF0() {
	...
	if (dword_5d4594_3799624 == 2) {
		*getMemU32Ptr(0x8529A0, 1192860) = sub_480250;
		*getMemU32Ptr(0x8529A0, 1190392) = sub_480220;
		...
		*getMemU32Ptr(0x8529A0, 1192860) = sub_4801E0;
		*getMemU32Ptr(0x8529A0, 1190392) = sub_4801B0;
...
int nox_xxx_unused_4800F0() {
	...
	*getMemU32Ptr(0x8529A0, 1191204) = nox_backbuffer_pitch_3801808 * nox_backbuffer_height;
	*getMemU32Ptr(0x8529A0, 1192840) = dword_5d4594_3801780 == 1;
...
//----- (00480220) --------------------------------------------------------
_BYTE*  sub_480220(_BYTE* a1, _BYTE* a2) {
	unsigned int v2; // edx
	_BYTE* result;   // eax
	...
	if (v7 >= 0 && result >= 0 && v7 < *(int*)&dword_5d4594_3798800 && result < *(int*)&dword_5d4594_3798808) {
		...
		if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_12)) {
			if (2 * a4 + v8 < *(int*)&dword_5d4594_3798844) {
				...
				(*(void(**)(_DWORD, _DWORD, _DWORD)) & dword_5d4594_3807160)(a5, v8, dword_5d4594_3798844 - v8);
				result = (*(int(**)(_DWORD, _DWORD, _DWORD)) &
			...
			v13 = *getMemU32Ptr(0x8529A0, 1020 + 4 * ((*getMemIntPtr(0x5D4594, 2598568 + v11) - *getMemIntPtr(0x5D4594, 2598288 + v11)) >> 8));
			v22[0] = *getMemU32Ptr(0x8529A0, 1020 + 4 * ((*getMemIntPtr(0x5D4594, 2598568 + v11) - *getMemIntPtr(0x5D4594, 2598288 + v11)) >> 8));
			v14 = *getMemU32Ptr(0x8529A0, 1020 + 4 * ((*getMemIntPtr(0x5D4594, 2598572 + v11) - *getMemIntPtr(0x5D4594, 2598292 + v11)) >> 8));
			v22[1] = *getMemU32Ptr(0x8529A0, 1020 + 4 * ((*getMemIntPtr(0x5D4594, 2598572 + v11) - *getMemIntPtr(0x5D4594, 2598292 + v11)) >> 8));
			v15 = *getMemU32Ptr(0x8529A0, 1020 + 4 * ((*getMemIntPtr(0x5D4594, 2598576 + v11) - *getMemIntPtr(0x5D4594, 2598296 + v11)) >> 8));
			v22[2] = v15;
			v21[0] = *v12;
			v16 = v12[1];
			v21[1] = v12[1];
			...
			while (1) {
				...
				*a2 = v19;
				v20 = 12 * a3 + 280 * v19;
				v21[0] = *getMemU32Ptr(0x5D4594, 2598288 + v20);
				v21[1] = *getMemU32Ptr(0x5D4594, 2598292 + v20);
				v21[2] = *getMemU32Ptr(0x5D4594, 2598296 + v20);
				v22[0] = *getMemU32Ptr(0x8529A0, 1020 + 4 * ((*getMemIntPtr(0x5D4594, 2598568 + v20) - *getMemIntPtr(0x5D4594, 2598288 + v20)) >> 8));
				v22[1] = *getMemU32Ptr(0x8529A0, 1020 + 4 * ((*getMemIntPtr(0x5D4594, 2598572 + v20) - *getMemIntPtr(0x5D4594, 2598292 + v20)) >> 8));
				v22[2] = *getMemU32Ptr(0x8529A0, 1020 + 4 * ((*getMemIntPtr(0x5D4594, 2598576 + v20) - *getMemIntPtr(0x5D4594, 2598296 + v20)) >> 8));
			}
		}
	}
	return result;
...
void  sub_480BE0(_DWORD* a1, int* a2, int a3, int a4, int a5) {
	...
	if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_12)) {
		...
		v21 = 12 * a3;
		v10 = 12 * a3 + 280 * *a2;
		v11 = *getMemU32Ptr(0x5D4594, 2598288 + v10);
		v12 = *getMemU32Ptr(0x5D4594, 2598292 + v10);
		v13 = *getMemU32Ptr(0x5D4594, 2598296 + v10);
		v22 = *getMemU32Ptr(0x8529A0, 1020 + 4 * ((*getMemIntPtr(0x5D4594, 2598568 + v10) - v11) >> 8));
		v23 = *getMemU32Ptr(0x8529A0, 1020 + 4 * ((*getMemIntPtr(0x5D4594, 2598572 + v10) - v12) >> 8));
		v24 = *getMemU32Ptr(0x8529A0, 1020 + 4 * ((*getMemIntPtr(0x5D4594, 2598576 + v10) - v13) >> 8));
		if (v9 <= 0) {
			v25 = 23;
		} else {
			v12 += v9 * *getMemU32Ptr(0x8529A0, 1020 + 4 * ((*getMemIntPtr(0x5D4594, 2598572 + v10) - v12) >> 8));
			v11 += v9 * v22;
			v13 += v9 * v24;
			v25 = 23 - v9;
		}
		...
		while (1) {
			for (v26 = v25; v26; --v26) {
				...
				*(WORD*)a5 = x;
#endif
				// maprgb = *(void **)getMemAt(0x8529A0, 1192860);
				// maprgb(tmp, v20);
			...
			*a2 = v17;
			v18 = v21 + 280 * v17;
			v11 = *getMemU32Ptr(0x5D4594, 2598288 + v18);
			v12 = *getMemU32Ptr(0x5D4594, 2598292 + v18);
			v13 = *getMemU32Ptr(0x5D4594, 2598296 + v18);
			v22 = *getMemU32Ptr(0x8529A0, 1020 + 4 * ((*getMemIntPtr(0x5D4594, 2598568 + v18) - v11) >> 8));
			v23 = *getMemU32Ptr(0x8529A0, 1020 + 4 * ((*getMemIntPtr(0x5D4594, 2598572 + v18) - v12) >> 8));
			v24 = *getMemU32Ptr(0x8529A0, 1020 + 4 * ((*getMemIntPtr(0x5D4594, 2598576 + v18) - v13) >> 8));
		}
	}
}

//----- (00480EB0) --------------------------------------------------------
_WORD*  sub_480EB0(_WORD* a1, __int16* a2, int a3) {
	__int16* v3; // esi
	_WORD* v4;   // edi
	int v5;      // ecx
	__int16 v6;  // ax
...
int  sub_4814F0(int2* a1) {
	...
	v2 = *getMemU32Ptr(0x8529A0, 4640 + v1) >> 8;
	v3 = *getMemU32Ptr(0x8529A0, 4644 + v1) >> 8;
	v8 = *getMemU32Ptr(0x8529A0, 1020 + 4 * (((*getMemIntPtr(0x8529A0, 4652 + v1) >> 8) - v2) >> 8));
	v4 = *getMemU32Ptr(0x8529A0, 4648 + v1) >> 8;
	v9 = *getMemU32Ptr(0x8529A0, 1020 + 4 * (((*getMemIntPtr(0x8529A0, 4656 + v1) >> 8) - v3) >> 8));
	v10 = *getMemU32Ptr(0x8529A0, 1020 + 4 * (((*getMemIntPtr(0x8529A0, 4660 + v1) >> 8) - v4) >> 8));
	v5 = 0;
	do {
		v6 = getMemAt(0x5D4594, 2598288 + 280 * a1->field_0 + v5);
		v5 += 12;
		*(_DWORD*)v6 = v2;
		*((_DWORD*)v6 + 1) = v3;
		v3 += v9;
	...
	result = 7 * a1->field_0;
	*getMemU32Ptr(0x5D4594, 2598284 + 280 * a1->field_0) = a1->field_4;
	return result;
}
...
char  nox_xxx_tileDraw_4815E0(_DWORD* a1, int a2) {
	...
	v2 = dword_5d4594_3798804 * (dword_5d4594_3798840 + a1[1] - dword_5d4594_3798824) + dword_5d4594_3798796 +
		 ((dword_5d4594_3798836 + *a1 - dword_5d4594_3798820) << getMemByte(0x8529A0, 1192840));
	...
	if (v3) {
		...
		if (v2 + *getMemIntPtr(0x8529A0, 1184952) >= *(int*)&dword_5d4594_3798844) {
			v6 = 0;
			for (i = 0;; v6 = i) {
				v7 = *getMemU32Ptr(0x8529A0, 1184768 + v6) << getMemByte(0x8529A0, 1192840);
				v8 = *getMemU32Ptr(0x8529A0, 1184960 + v6) << getMemByte(0x8529A0, 1192840);
				if (v2 + v7 + v8 < v5) {
...
//----- (00481770) --------------------------------------------------------
char*  sub_481770(_DWORD* a1, int a2, unsigned __int16 a3) {
	int v3;             // ebp
	...
	if (!nox_client_texturedFloors_154956 && (getMemByte(0x8529A0, 67962 + 60 * a3) & 1) == 1)
		dword_5d4594_1193156 = 1;
	v3 = *getMemU32Ptr(0x8529A0, 67952 + 60 * a3);
	v4 = getMemByte(0x8529A0, 1192840);
	v5 = dword_5d4594_3798844;
	...
	if (v6 + *getMemU32Ptr(0x8529A0, 1184952) < *(int*)&dword_5d4594_3798844) {
		if (dword_5d4594_3799624)
		...
		v12 = 0;
		while (1) {
			v8 = *getMemU32Ptr(0x8529A0, 1184768 + v7) << v4;
			v9 = *getMemU32Ptr(0x8529A0, 1184960 + v7) << v4;
			if (v6 + v9 + v8 < v5) {
...
//----- (00481900) --------------------------------------------------------
char  nox_xxx_drawTexEdgesProbably_481900(_DWORD* a1, _DWORD* a2) {
	int v2;              // ebx
	int v3;              // esi
	int v4;              // edx
	int v5;              // ebp
	...
	v3 = *(_DWORD*)(*getMemU32Ptr(0x8529A0, 67936 + 60 * *a2) +
					4 * (a2[1] + *getMemU16Ptr(0x8529A0, 67950 + 60 * *a2)));
	v4 = a2[2];
	v5 = dword_5d4594_3798836;
	addr =
		(*getMemU32Ptr(0x8529A0, 64096 + 60 * v4) + 4 * (a2[3] + *getMemU16Ptr(0x8529A0, 64110 + 60 * v4)));
	v6 = *(_DWORD*)addr;
	v7 = dword_5d4594_3798840;
	*getMemU32Ptr(0x5D4594, 2523980 + 4 * v4) = 1;
	v8 = dword_5d4594_3798804 * (v7 + a1[1] - v2) + dword_5d4594_3798796 +
		 ((v5 + *a1 - dword_5d4594_3798820) << getMemByte(0x8529A0, 1192840));
	...
	if (v9) {
		...
		if (v9) {
			...
			v31 = v13;
			v14 = (char*)((*getMemU32Ptr(0x8529A0, 1184576 + 4 * v32) << getMemByte(0x8529A0, 1192840)) + v11);
			v27 = v14;
			...
			if (v32 <= (int)v25) {
				do {
					v24 = *getMemU32Ptr(0x8529A0, 1184960 + 4 * v9);
					v26 = v14;
					v15 = (char*)(v13 + (*getMemU32Ptr(0x8529A0, 1184768 + 4 * v9) << getMemByte(0x8529A0, 1192840)));
					if (v24 > 0) {
						do {
							LOBYTE(v9) = *v10;
							v29 = v10[1];
							v33 = v10 + 2;
							v16 = v29 << getMemByte(0x8529A0, 1192840);
							switch ((_BYTE)v9) {
							case 2:
								if ((unsigned int)&v15[v16] < v12) {
									v19 = v33;
									v18 = v29 << getMemByte(0x8529A0, 1192840);
									v17 = v15;
								} else {
					...
					v14 = &v27[*getMemU32Ptr(0x8529A0, 1184960 + 4 * v9) << getMemByte(0x8529A0, 1192840)];
					v13 += dword_5d4594_3798804;
					v27 += *getMemU32Ptr(0x8529A0, 1184960 + 4 * v9) << getMemByte(0x8529A0, 1192840);
					v31 = v13;
					if (v13 >= v12) {
...
LABEL_9:
	if (dword_5d4594_1193188) {
		nox_xxx_tileDrawImpl_4826A0(a1);
	...
	if (*(int*)&dword_5d4594_3798832 < *(int*)&dword_5d4594_3798832 + *(int*)&dword_5d4594_3798816) {
		...
		for (i = 44 * dword_5d4594_3798832;; v12 = i) {
			...
			if (*(_BYTE*)v14 & 2) {
				...
				v62 = *(_DWORD*)(*getMemU32Ptr(0x8529A0, 67936 + 60 * v15) +
								 4 * (*(_DWORD*)(v14 + 28) + *getMemU16Ptr(0x8529A0, 67950 + 60 * v15)));
				v68.field_0 = v76;
				v68.field_4 = v11 + 23;
				func_587000_154940(&v68, v62, v13);
				*getMemU32Ptr(0x8529A0, 35648 + 4 * v15) = 1;
				if (*(_DWORD*)(v14 + 40))
					nox_xxx_tileCallDrawEdges_481BF0((int)&v68, *(_DWORD*)(v14 + 40));
			}
			if (*(_BYTE*)v14 & 1) {
				LOWORD(v13) = *(_WORD*)(v14 + 4);
				v16 = *(unsigned __int16*)(v14 + 4);
				v63 = *(_DWORD*)(*getMemU32Ptr(0x8529A0, 67936 + 60 * v16) +
								 4 * (*(_DWORD*)(v14 + 8) + *getMemU16Ptr(0x8529A0, 67950 + 60 * v16)));
				v68.field_0 = v76 + 23;
				v68.field_4 = v11;
				func_587000_154940(&v68, v63, v13);
				*getMemU32Ptr(0x8529A0, 35648 + 4 * v16) = 1;
				v17 = *(_DWORD*)(v14 + 20);
				if (v17)
	...
	if (dword_5d4594_3798828 < j) {
		...
		while (1) {
			...
			if (v29 & 2) {
				...
				v64 = *(_DWORD*)(*getMemU32Ptr(0x8529A0, 67936 + 60 * v31) +
								 4 * (*(_DWORD*)(v30 + 28) + *getMemU16Ptr(0x8529A0, 67950 + 60 * v31)));
				v68.field_0 = v26;
				v68.field_4 = v76 + 23;
				func_587000_154940(&v68, v64, v27);
				*getMemU32Ptr(0x8529A0, 35648 + 4 * v31) = 1;
				if (*(_DWORD*)(v30 + 40))
					nox_xxx_tileCallDrawEdges_481BF0((int)&v68, *(_DWORD*)(v30 + 40));
			}
			if (*(_BYTE*)v30 & 1) {
				LOWORD(v27) = *(_WORD*)(v30 + 4);
				v32 = *(unsigned __int16*)(v30 + 4);
				v65 = *(_DWORD*)(*getMemU32Ptr(0x8529A0, 67936 + 60 * v32) +
								 4 * (*(_DWORD*)(v30 + 8) + *getMemU16Ptr(0x8529A0, 67950 + 60 * v32)));
				v68.field_0 = v26 + 23;
				v68.field_4 = v76;
				func_587000_154940(&v68, v65, v27);
				*getMemU32Ptr(0x8529A0, 35648 + 4 * v32) = 1;
				v33 = *(_DWORD*)(v30 + 20);
				if (v33)
...
LABEL_60:
	...
	if (nox_client_texturedFloors_154956) {
		...
		if (*(int*)&dword_5d4594_3679320 < *(int*)&dword_5d4594_3798156) {
			v51 = getMemAt(0x8529A0, 1068672 + 128 * dword_5d4594_3679320);
			v76 = 4 * dword_5d4594_3679320 - 4;
			for (j = (int)getMemAt(0x8529A0, 1068672 + 128 * dword_5d4594_3679320);; v51 = (unsigned __int8*)j) {
				i = (_DWORD)nox_pixbuffer_rows_3798784[v49];
				if (v50 == 23) {
					v78 = 0;
					++v66.field_4;
				}
				v52 = *getMemU32Ptr(0x8529A0, 1065060 + v76);
				v53 = (int*)v51;
				if (nox_client_highResFloors_154952 || !(v67.field_4 & 1) || v51 == getMemAt(0x8529A0, 1068672)) {
					if (v52 > 0) {
						...
						do {
							...
							v74 = v58 - v69;
							v75 = getMemAt(0x5D4594, 2598284 + 280 * v60);
							if (v61 < v58 + v72 + 23) {
								do {
									if (*(_DWORD*)v75 != v66.field_4) {
										(*(int(**)(int2*)) getMemAt(0x8529A0, 1192864))(&v66);
										v59 = v67.field_0;
										v60 = v66.field_0;
									}
									v61 += 23;
							...
							(*(void(**)(int2*, int*, _DWORD, _DWORD, _DWORD)) &
							 dword_5d4594_3805484)(&v67, &v66.field_0, v78, v74, i + (v69 << getMemByte(0x8529A0, 1192840)));
							--v71;
						} while (v71);
					}
				} else if (v52 > 0) {
					...
					do {
						...
						v55 = v53[1];
						v53 += 2;
						v56 = (v55 - v54) << getMemByte(0x8529A0, 1192840);
						v57 = v74;
						memcpy((void*)(i + (v54 << getMemByte(0x8529A0, 1192840))),
								(const void*)((v54 << getMemByte(0x8529A0, 1192840)) + (_DWORD)nox_pixbuffer_rows_3798784[v76/4]),
								v56);
						v74 = v57 - 1;
					} while (v57 != 1);
				}
		...
		if (*(int*)&dword_5d4594_3679320 < *(int*)&dword_5d4594_3798156) {
			v78 = getMemAt(0x8529A0, 1068672 + 128 * dword_5d4594_3679320);
			do {
				v35 = v78;
				v36 = *getMemU32Ptr(0x8529A0, 1065056 + 4 * v79);
						...
						v39 =
							(char*)(dword_5d4594_3798804 * (v67.field_4 + dword_5d4594_3798840 - dword_5d4594_3798824) +
									...
									((v37 + v72 + dword_5d4594_3798836 - dword_5d4594_3798820)
									 << getMemByte(0x8529A0, 1192840)));
						if ((unsigned int)v39 >= *(int*)&dword_5d4594_3798844)
							v39 += dword_5d4594_3798796 - dword_5d4594_3798844;
						v76 = i + (v37 << getMemByte(0x8529A0, 1192840));
						v40 = v38 << getMemByte(0x8529A0, 1192840);
						if ((unsigned int)&v39[v38 << getMemByte(0x8529A0, 1192840)] < *(int*)&dword_5d4594_3798844) {
							v42 = (char*)v76;
							...
							v42 = (char*)(v41 + v76);
							v40 = (v38 << getMemByte(0x8529A0, 1192840)) - v41;
...
int  nox_xxx_tileCheckRedrawMB_482570(_DWORD* a1) {
	...
	while (1) {
		v8 = i + *v7;
		if (*(_BYTE*)v8 & 1) {
			if ((getMemByte(0x8529A0, 67962 + 60 * *(_DWORD*)(v8 + 4)) & 1) == 1)
				return 1;
		}
		if (*(_BYTE*)v8 & 2 && (getMemByte(0x8529A0, 67962 + 60 * *(_DWORD*)(v8 + 24)) & 1) == 1)
			return 1;
		++v6;
		++v7;
		if (v6 >= v12) {
...
int  nox_xxx_tileDrawImpl_4826A0(_DWORD* a1) {
	...
	sub_481410();
	memset(getMemAt(0x8529A0, 35648), 0, 0x2C0u);
				...
				do {
					...
					if (v12) {
						if (v12 & 2) {
							...
							v18 = *(_DWORD*)(*getMemU32Ptr(0x8529A0, 67936 + 60 * v14) +
											 4 * (*(_DWORD*)(v13 + 28) +
												  *getMemU16Ptr(0x8529A0, 67950 + 60 * v14)));
							v24.field_0 = v8;
							v24.field_4 = v6 + 23;
							func_587000_154940(&v24, v18, v10);
							*getMemU32Ptr(0x8529A0, 35648 + 4 * v14) = 1;
							if (*(_DWORD*)(v13 + 40))
								nox_xxx_tileCallDrawEdges_481BF0((int)&v24, *(_DWORD*)(v13 + 40));
						}
						if (*(_BYTE*)v13 & 1) {
							LOWORD(v10) = *(_WORD*)(v13 + 4);
							v15 = *(unsigned __int16*)(v13 + 4);
							v19 = *(_DWORD*)(*getMemU32Ptr(0x8529A0, 67936 + 60 * v15) +
											 4 * (*(_DWORD*)(v13 + 8) +
												  *getMemU16Ptr(0x8529A0, 67950 + 60 * v15)));
							v24.field_0 = v8 + 23;
							v24.field_4 = v6;
...
//----- (00484BE0) --------------------------------------------------------
_DWORD*  nox_xxx_spriteChangeLightColor_484BE0(_DWORD* a1, int a2, int a3, int a4) {
	_DWORD* result; // eax
...
//----- (00484C00) --------------------------------------------------------
__int64  sub_484C00(int a1, int a2) {
	__int64 result; // rax
...
//----- (00484C30) --------------------------------------------------------
__int64  nox_xxx_spriteChangeLightSize_484C30(int a1, int a2) {
	__int64 result; // rax
		...
		if (v5 < v6) {
			...
			do {
				...
				if (v12 < *v11) {
					...
					v15 = getMemAt(0x8529A0, 2048 + 40 * v12 + 5 * v12 + v9);
					do {
...
int  nox_thing_read_floor_485B30(int a1, char* a2) {
	...
	*(_DWORD*)(v2 + 8) = v3 + 1;
	...
	LABEL_5:
		...
		v6 = (const char*)getMemAt(0x8529A0, 67904);
		while (strcmp(v6, v22)) {
			++v5;
			v6 += 60;
	...
	*(_DWORD*)(v2 + 8) = v9 + 4;
	...
	v20 = 15 * v7;
	*getMemU32Ptr(0x8529A0, 67936 + 60 * v7) = malloc(4 * v10);
	v11 = 0;
	for (i = 0; v11 < v10;
		 *(_DWORD*)(*getMemU32Ptr(0x8529A0, 67936 + 4 * v20) + 4 * v11 - 4) = nox_xxx_readImgMB_42FAA0(v13, v21, a2)) {
		v12 = *(int**)(v2 + 8);
		v13 = *v12;
		*(_DWORD*)(v2 + 8) = v12 + 1;
...
int  nox_thing_read_edge_485D40(int a1, char* a2) {
	...
	*(_DWORD*)(v2 + 8) = v3 + 1;
	...
	LABEL_5:
		...
		v6 = (const char*)getMemAt(0x8529A0, 64064);
		while (strcmp(v6, v26)) {
			++v5;
			v6 += 60;
	...
	*(_DWORD*)(v2 + 8) = v12 + 1;
	...
	v24 = 15 * v7;
	*getMemU32Ptr(0x8529A0, 64096 + 60 * v7) = result;
	if (result) {
		v15 = 0;
		for (i = 0; v15 < v14;
			 *(_DWORD*)(*getMemU32Ptr(0x8529A0, 64096 + 4 * v24) + 4 * v15 - 4) = nox_xxx_readImgMB_42FAA0(v17, v25, a2)) {
			v16 = *(int**)(v2 + 8);
			v17 = *v16;
			*(_DWORD*)(v2 + 8) = v16 + 1;
...
void nox_xxx_initSight_485F80() {
	...
	v2 = 1;
	for (i = 23; i > 0; --i) {
		*getMemU32Ptr(0x8529A0, 1184576 + 4 * v1) = v0;
		*getMemU32Ptr(0x8529A0, 1184768 + 4 * v1) = i;
		*getMemU32Ptr(0x8529A0, 1184960 + 4 * v1) = v2;
		v0 += v2;
		++v1;
		v2 += 2;
	}
	if (v1 < 46) {
		...
		v7 = 46 - v1;
		do {
			*getMemU32Ptr(0x8529A0, 1184576 + v6) = v0;
			*getMemU32Ptr(0x8529A0, 1184768 + v6) = v5;
			*getMemU32Ptr(0x8529A0, 1184960 + v6) = v4;
			v0 += v4;
			++v5;
			v4 -= 2;
			v6 += 4;
...
int nox_xxx_tile_486060() {
	...
	*getMemU32Ptr(0x8529A0, 1184952) = 45 * dword_5d4594_3798804 + (46 << getMemByte(0x8529A0, 1192840));
	return result;
}
...
//----- (00486320) --------------------------------------------------------
_DWORD*  sub_486320(_DWORD* a1, int a2) {
	_DWORD* result; // eax
...
//----- (00486380) --------------------------------------------------------
int  sub_486380(_DWORD* a1, unsigned int a2, int a3, int a4) {
	int result; // eax
...
//----- (00486550) --------------------------------------------------------
BOOL  sub_486550(_BYTE* a1) { return *a1 & 2 || a1[32] & 2 || a1[64] & 2; }

//----- (00486570) --------------------------------------------------------
int  sub_486570(unsigned int* a1, _DWORD* a2) {
	int v2; // eax
...
//----- (00486640) --------------------------------------------------------
int  sub_486640(int a1, int a2) { return a2 * (*(_DWORD*)(a1 + 36) >> 16) / 100; }
...
//----- (004866D0) --------------------------------------------------------
int  sub_4866D0(_DWORD* a1, int a2) { return *a1 + 36 * a2; }
...
unsigned int  sub_486A10(int a1, void* a2) {
	...
	v2 = bsearch(a2, *(const void**)a1, *(_DWORD*)(a1 + 4), 0x24u, (int(*)(const void*, const void*))_strcmpi);
	if (v2)
...
//----- (00486A50) --------------------------------------------------------
char*  sub_486A50(_DWORD* a1, int a2) {
	char* result; // eax
...
//----- (00486A80) --------------------------------------------------------
int  sub_486A80(_DWORD* a1, int a2) {
	int result; // eax
...
//----- (00486AA0) --------------------------------------------------------
int  sub_486AA0(_DWORD* a1, int a2, _DWORD* a3) {
	_DWORD* v3; // eax
	int result; // eax
...
//----- (00486B10) --------------------------------------------------------
int  sub_486B10(_DWORD* a1, int a2, _DWORD* a3) {
	int result; // eax
	int v4;     // edx
...
int  sub_486B60(int a1, int a2) {
	...
	*(_DWORD*)(a1 + 284) = *(_DWORD*)(v2 + 20);
	if (nox_fs_fseek_start(v3, *(_DWORD*)(v2 + 16)))
		v12 = 0;
	if (!*(_DWORD*)(v2 + 20))
		v12 = 0;
	if (!*(_DWORD*)(a1 + 276))
	...
	*(_DWORD*)(a1 + 272) = v6;
	...
	while (1) {
		if (*(_DWORD*)v13 == 544501094) {
			...
			nox_fs_fseek_cur(v7,  *(_DWORD*)&v13[4] - 16);
			goto LABEL_15;
		}
...
//----- (00486E30) --------------------------------------------------------
int  sub_486E30(int a1, _DWORD* a2) {
	int result; // eax
...
void* sub_486EF0() {
	...
	if (dword_5d4594_1193336) {
		...
		if (!*(_DWORD*)((_DWORD)dword_587000_155144 + 24)) {
			v1 = *(int**)((_DWORD)dword_587000_155144 + 12);
			for (i = (_DWORD)dword_587000_155144 + 12; v1 != (int*)i; v1 = (int*)*v1) {
				if (!(v1[3] & 2))
...
//----- (00487030) --------------------------------------------------------
void  sub_487030(LPVOID lpMem) {
	(*(void(**)(LPVOID))(*((_DWORD*)lpMem + 3) + 24))(lpMem);
...
//----- (00487090) --------------------------------------------------------
_DWORD**  sub_487090(_DWORD** a1) { return sub_425920(a1); }
...
//----- (00487150) --------------------------------------------------------
_DWORD*  sub_487150(int a1, const void* a2) {
	int v2;     // edi
	_DWORD* v3; // esi
	_DWORD* v4; // eax
...
//----- (004871C0) --------------------------------------------------------
_DWORD*  sub_4871C0(int a1, int a2, const void* a3) {
	int v3;     // ebp
	_DWORD* v4; // esi
...
//----- (004872C0) --------------------------------------------------------
void  sub_4872C0(LPVOID lpMem) {
	int v1; // eax
	int v2; // ecx

	sub_487910((int)lpMem, -1);
	(*(void(**)(LPVOID))(*(_DWORD*)(*((_DWORD*)lpMem + 5) + 12) + 32))(lpMem);
				...
				if (*(_BYTE*)(v12 + 124) & 1 && *(_DWORD*)(v12 + 288)) {
					if ((sub_486520((unsigned int*)(v12 + 16)), v17) || sub_486550((_BYTE*)(v12 + 16)) ||
						...
						*(_DWORD*)(v12 + 112) && sub_486550(*(_BYTE**)(v12 + 112))) {
						sub_4BD840(v12);
						(*(void(**)(int))(*(_DWORD*)(v12 + 172) + 32))(v12);
					}
				}
				v12 = v13;
			} while (v13 != v1 + 200);
...
//----- (00487680) --------------------------------------------------------
void  sub_487680(LPVOID lpMem) {
	sub_4876A0((_DWORD**)lpMem);
	sub_4872C0(lpMem);
}

//----- (004876A0) --------------------------------------------------------
void*  sub_4876A0(_DWORD** a1) {
	void* result; // eax

	++*(_DWORD*)((_DWORD)dword_587000_155144 + 24);
	sub_425920(a1);
	result = (void*)(*(_DWORD*)((_DWORD)dword_587000_155144 + 24) - 1);
	*(_DWORD*)((_DWORD)dword_587000_155144 + 24) = result;
	if ((int)result < 0) {
		result = *(void**)&dword_587000_155144;
		*(_DWORD*)((_DWORD)dword_587000_155144 + 24) = 0;
...
//----- (004876F0) --------------------------------------------------------
_DWORD*  sub_4876F0(int a1, int a2) { return sub_486320((_DWORD*)(a1 + 88), a2); }

//----- (00487710) --------------------------------------------------------
int  sub_487710(int a1, int a2) { return sub_486350(a1 + 88, a2); }

//----- (00487730) --------------------------------------------------------
int  sub_487730(int a1) { return *(_DWORD*)(a1 + 196); }

//----- (00487740) --------------------------------------------------------
int  sub_487740(int a1) { return *(_DWORD*)(a1 + 192); }

//----- (00487750) --------------------------------------------------------
_DWORD*  sub_487750(int a1) {
	_DWORD* v1; // eax
	_DWORD* v2; // esi
...
//----- (00487A70) --------------------------------------------------------
int  nox_xxx_unused_487A70(_DWORD* a1, int(* a2)(char*)) {
	int* v2;             // eax
	int i;               // edi
	...
	return ((int(*)(unsigned __int8*))a2)(getMemAt(0x587000, 155344));
}

//----- (00487BC0) --------------------------------------------------------
_DWORD*  sub_487BC0(size_t a1) {
	_DWORD* v1; // esi
	void* v2;   // eax
...
//----- (00487CD0) --------------------------------------------------------
__int64  sub_487CD0(int a1, int a2) { return 1000 * a2 / *(_DWORD*)(a1 + 20); }

//----- (00487D00) --------------------------------------------------------
int  sub_487D00(_DWORD* a1) {
	int v1;     // edx
	int result; // eax
...
//----- (00487D30) --------------------------------------------------------
_DWORD*  sub_487D30(_DWORD* a1, int a2, int a3) {
	_DWORD* result; // eax
...
int  nox_xxx_wndEditDrawNoImage_488160(int a1, int a2) {
	...
	*((_DWORD*)v23 + 261) = 0;
	...
	v4 = xLeft;
	v21 = *(_DWORD*)(a1 + 8);
	v5 = nox_xxx_guiFontHeightMB_43F320(*(_DWORD*)(a2 + 200));
	v6 = *(_DWORD*)(a1 + 12);
	v29 = v5;
	v7 = yTop + v6 / 2 - v5 / 2;
	...
	if (*(_WORD*)(a2 + 72)) {
		nox_xxx_drawGetStringSize_43F840(*(_DWORD*)(a2 + 200), (unsigned __int16*)(a2 + 72), &v22, 0, 0);
		nox_xxx_drawSetTextColor_434390(*(_DWORD*)(a2 + 68));
		nox_xxx_drawString_43FAF0(*(_DWORD*)(a2 + 200), (_WORD*)(a2 + 72), v4 + 2, v7, v21, 0);
		v4 += v22 + 6;
		v21 += -6 - v22;
	}
	v8 = v23;
	...
	if (*(_DWORD*)(a2 + 68) != 0x80000000) {
		...
		nox_xxx_drawGetStringSize_43F840(*(_DWORD*)(a2 + 200), (unsigned __int16*)v31, &v22, 0, 0);
		v19 = *(_DWORD*)(a2 + 200);
		v25 = v23 + 256;
		...
		if (((*(_DWORD*)(v2 + 4) >> 14) & 1) == 1 && v24 + v22 > 0 && v21 >= 10 && v24 + v22 + 10 > v21) {
			do {
				v20 = *(_DWORD*)(a2 + 200);
				++v26;
				nox_xxx_drawGetStringSize_43F840(v20, (unsigned __int16*)v26, &v22, 0, 0);
		...
		nox_xxx_drawString_43FAF0(*(_DWORD*)(a2 + 200), v25, v4 + v22 + 5, v7, 0, 0);
		v16 = v4 + v22 + v24 + 5;
	...
	if (*(_BYTE*)(a7 + 8) & 0x80) {
		...
		*(_DWORD*)&v15[8] = 288;
		...
		if (v12) {
			...
			nox_xxx_wndListboxInit_4A3C00(v10[262], *(_DWORD*)(v10[262] + 32));
...
int  nox_xxx_wndEditProcPre_488710(int a1, unsigned int a2, wchar_t* a3, int a4) {
	...
	if (a2 == 16413)
		return *(_DWORD*)(a1 + 32);
	if (a2 == 2) {
		nox_xxx_windowDestroyMB_46C4E0(*(_DWORD**)(v3 + 1048));
		free(*(LPVOID*)(a1 + 32));
		return 0;
	}
	if (a2 != 23)
...
int  nox_xxx_wndEdit_488830(int a1) {
	...
	if (a1) {
		if ((signed char)*(_BYTE*)(a1 + 4) >= 0)
			result = nox_window_set_all_funcs((_DWORD*)a1, nox_xxx_wndEditProc_487D70, nox_xxx_wndEditDrawNoImage_488160, 0);
		else
			result = nox_window_set_all_funcs((_DWORD*)a1, nox_xxx_wndEditProc_487D70, nox_xxx_wndEditDrawWithImage_488870, 0);
	}
	return result;
}
...
int  nox_xxx_wndEditDrawWithImage_488870(int a1, int a2) {
	...
	*((_DWORD*)v22 + 261) = 0;
	...
	v3 = *(_DWORD*)(a1 + 8);
	v4 = nox_xxx_guiFontHeightMB_43F320(*(_DWORD*)(a2 + 200));
	v5 = *(_DWORD*)(a1 + 12);
	v23 = v4;
	v6 = v21 + v5 / 2 - v4 / 2;
	if (((*(_DWORD*)(a1 + 4) >> 13) & 1) == 1)
	...
	nox_xxx_drawSetTextColor_434390(*(_DWORD*)(a2 + 68));
	if (*(_WORD*)(a2 + 72)) {
		nox_xxx_drawGetStringSize_43F840(*(_DWORD*)(a2 + 200), (unsigned __int16*)(a2 + 72), &v17, 0, 0);
		nox_xxx_drawString_43FAF0(*(_DWORD*)(a2 + 200), (_WORD*)(a2 + 72), xLeft + 2, v6, v3, 0);
		v3 += -6 - v17;
		xLeft += v17 + 6;
	}
	if (*(_DWORD*)(a2 + 68) != 0x80000000) {
		...
		nox_xxx_drawGetStringSize_43F840(*(_DWORD*)(a2 + 200), (unsigned __int16*)v24, &v17, 0, 0);
		v20 = v22 + 256;
		nox_xxx_drawGetStringSize_43F840(*(_DWORD*)(a2 + 200), v22 + 256, &v19, 0, 0);
		if (((*(_DWORD*)(v2 + 4) >> 14) & 1) == 1 && v17 + v19 > 0 && v17 + v19 + 10 > v3) {
			do {
				v15 = *(_DWORD*)(a2 + 200);
				++v18;
				nox_xxx_drawGetStringSize_43F840(v15, (unsigned __int16*)v18, &v17, 0, 0);
			} while (v19 + v17 + 10 > v3);
		}
		nox_xxx_drawSetTextColor_434390(*(_DWORD*)(a2 + 68));
		nox_xxx_drawString_43FAF0(*(_DWORD*)(a2 + 200), v18, xLeft + 5, v6, v3, 0);
		v12 = nox_color_rgb_4344A0(192, 0, 192);
		nox_xxx_drawSetTextColor_434390(v12);
		nox_xxx_drawString_43FAF0(*(_DWORD*)(a2 + 200), v20, v17 + xLeft + 5, v6, v3, 0);
		xLeft += v17 + v19 + 5;
		if (v2 == nox_xxx_wndGetFocus_46B4F0()) {
...
int  nox_xxx_wndStaticDrawNoImage_488D00(int a1, int xLeft) {
	...
	if (*v3 && *(_DWORD*)(v2 + 68) != 0x80000000) {
		nox_xxx_drawSetTextColor_434390(*(_DWORD*)(v2 + 68));
		nox_xxx_drawGetStringSize_43F840(*(_DWORD*)(v2 + 200), *v3, &v29, &v23, v5);
		v8 = v23 / -2 + v6;
		v9 = v3[1];
		v26 = v8;
		if (v9) {
			...
			if (v23 > *(int*)(v10 + 28)) {
				...
				if (dword_5d4594_1193360) {
					...
					while (1) {
						...
						LABEL_32:
							...
							*(_WORD*)(dword_5d4594_1193360 + 2 * v16) = 0;
							nox_xxx_drawGetStringSize_43F840(*(_DWORD*)(v2 + 200), *(unsigned __int16**)&dword_5d4594_1193360, 0, &v23, v5);
					...
					LABEL_40:
						...
						*(_WORD*)(dword_5d4594_1193360 + 2 * v18) = 0;
						nox_xxx_drawGetStringSize_43F840(*(_DWORD*)(v2 + 200), *(unsigned __int16**)&dword_5d4594_1193360, &v29, &v23, v5);
						xLeft = v32 + (v5 - v29) / 2;
						if (v33[2]) {
							nox_xxx_drawSetTextColor_434390(v27);
							v19 = v26;
							v20 = v26 - 1;
							nox_xxx_drawString_43FAF0(*(_DWORD*)(v2 + 200), *(_WORD**)&dword_5d4594_1193360, xLeft - 1, v26 - 1, v5,
									   0);
							nox_xxx_drawString_43FAF0(*(_DWORD*)(v2 + 200), *(_WORD**)&dword_5d4594_1193360, xLeft + 1, v20, v5, 0);
							nox_xxx_drawString_43FAF0(*(_DWORD*)(v2 + 200), *(_WORD**)&dword_5d4594_1193360, xLeft - 1, v19 + 1, v5,
									   0);
							nox_xxx_drawString_43FAF0(*(_DWORD*)(v2 + 200), *(_WORD**)&dword_5d4594_1193360, xLeft + 1, v19 + 1, v5,
									   0);
							nox_xxx_drawSetTextColor_434390(*(_DWORD*)(v2 + 68));
							nox_xxx_drawString_43FAF0(*(_DWORD*)(v2 + 200), *(_WORD**)&dword_5d4594_1193360, xLeft, v19, v5, 0);
						} else {
							nox_xxx_drawString_43FAF0(*(_DWORD*)(v2 + 200), *(_WORD**)&dword_5d4594_1193360, v32 + (v5 - v29) / 2, v26,
									   v5, 0);
							v19 = v26;
						}
						v26 = v23 + v19 + 1;
				...
				if (v3[2]) {
					nox_xxx_drawSetTextColor_434390(v27);
					nox_xxx_drawString_43FAF0(*(_DWORD*)(v2 + 200), *v3, xLeft - 1, v8 - 1, v5, 0);
					nox_xxx_drawString_43FAF0(*(_DWORD*)(v2 + 200), *v3, xLeft + 1, v8 - 1, v5, 0);
					nox_xxx_drawString_43FAF0(*(_DWORD*)(v2 + 200), *v3, xLeft - 1, v8 + 1, v5, 0);
					nox_xxx_drawString_43FAF0(*(_DWORD*)(v2 + 200), *v3, xLeft + 1, v8 + 1, v5, 0);
					nox_xxx_drawSetTextColor_434390(*(_DWORD*)(v2 + 68));
					nox_xxx_drawString_43FAF0(*(_DWORD*)(v2 + 200), *v3, xLeft, v8, v5, 0);
				} else {
			...
			nox_xxx_drawSetTextColor_434390(v27);
			nox_xxx_drawString_43FAF0(*(_DWORD*)(v2 + 200), *v3, xLeft + 1, v8 - 1, v5, 0);
			nox_xxx_drawString_43FAF0(*(_DWORD*)(v2 + 200), *v3, xLeft + 3, v8 - 1, v5, 0);
			nox_xxx_drawString_43FAF0(*(_DWORD*)(v2 + 200), *v3, xLeft + 1, v8 + 1, v5, 0);
			nox_xxx_drawString_43FAF0(*(_DWORD*)(v2 + 200), *v3, xLeft + 3, v8 + 1, v5, 0);
			nox_xxx_drawSetTextColor_434390(*(_DWORD*)(v2 + 68));
			nox_xxx_drawString_43FAF0(*(_DWORD*)(v2 + 200), *v3, xLeft + 2, v8, v5, 0);
		} else {
			nox_xxx_drawString_43FAF0(*(_DWORD*)(v2 + 200), *v3, xLeft + 2, v8, v5, 0);
		}
	}
...
//----- (00489300) --------------------------------------------------------
nox_window*  nox_gui_newStaticText_489300(int a1, int a2, int a3, int a4, int a5, int a6, _DWORD* a7, _DWORD* a8) {
	int v8;      // ecx
	_DWORD* v9;  // esi
	_DWORD* v10; // edx
...
int  nox_xxx_wndStatic_4893E0(int a1) {
	...
	if (a1) {
		if ((signed char)*(_BYTE*)(a1 + 4) >= 0)
			result = nox_window_set_all_funcs((_DWORD*)a1, nox_xxx_wndStaticProc_489420, nox_xxx_wndStaticDrawNoImage_488D00, 0);
		else
			result = nox_window_set_all_funcs((_DWORD*)a1, nox_xxx_wndStaticProc_489420, nox_xxx_wndStaticDrawWithImage_489550, 0);
	}
	return result;
}
...
//----- (00489550) --------------------------------------------------------
int  nox_xxx_wndStaticDrawWithImage_489550(_DWORD* a1, _DWORD* a2) {
	_DWORD* v2;            // esi
...
_DWORD*  sub_489B80(int a1) {
	...
	if (result) {
		...
		if (*(_DWORD*)v3) {
			v4 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1193380, 10028);
			v4[9] |= 4u;
		}
		nox_swprintf(v13, L"%d", *((_DWORD*)v3 + 4));
		v5 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1193380, 10031);
		nox_window_call_field_94((int)v5, 16414, (int)v13, -1);
		if (*((_DWORD*)v3 + 1)) {
			v6 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1193380, 10029);
			v6[9] |= 4u;
		}
		if (*((_DWORD*)v3 + 2)) {
			v7 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1193380, 10030);
			v7[9] |= 4u;
		}
		if (*((_DWORD*)v3 + 3)) {
			v8 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1193380, 10015);
			v8[9] |= 4u;
		}
		if (v3[12] & 2)
			v9 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1193380, 10017);
		else
			v9 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1193380, 10016);
		v10 = v9;
		v9[9] |= 4u;
		if (*((_DWORD*)v3 + 5)) {
			v10 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1193380, 10014);
			v10[9] |= 4u;
		}
		if (*((_DWORD*)v3 + 10)) {
			v10 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1193380, 10018);
			v10[9] |= 4u;
		}
		...
		if (v11) {
			...
			if (v12) {
				if (v12 == 1) {
					v10 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1193380, 10026);
					sub_489DC0();
				}
			} else {
				v10 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1193380, 10025);
				nox_window_set_hidden(*(int*)&dword_5d4594_1193384, 1);
			}
		} else {
			v10 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1193380, 10024);
			nox_window_set_hidden(*(int*)&dword_5d4594_1193384, 1);
		}
		v10[9] |= 4u;
...
int  nox_xxx_windowMplayFilterProc_489E70(int a1, int a2, int* a3, int a4) {
	...
	case 10026:
		*getMemU32Ptr(0x5D4594, 1193372 + 4 * v3) = 2;
		...
		break;
	case 10028:
		v6 = nox_xxx_wndGetChildByID_46B0C0(*(_DWORD**)&dword_5d4594_1193380, 10031);
...
int sub_489FB0() {
	...
	if (dword_5d4594_1193380) {
		...
		result = nox_xxx_windowDestroyMB_46C4E0(*(_DWORD**)&dword_5d4594_1193380);
...
//----- (0048A020) --------------------------------------------------------
int  sub_48A020(int a1, _DWORD* a2) {
...
//----- (0048C0C0) --------------------------------------------------------
int  sub_48C0C0(void* a1, _DWORD* a2, _DWORD* a3) {
	int result; // eax
	_DWORD* v4; // eax
	_DWORD* v5; // eax
