...
int sub_477EA0() {
	...
	int x = mpos.x;
	int y = mpos.y + 22;
	nox_video_cursorDrawImpl_477A30(*getMemIntPtr(0x8531A0, 34324), x, y);
...
int sub_47D200() {
	...
	*getMemU32Ptr(0x8531A0, 1183148) = 0;
	*getMemU32Ptr(0x8531A0, 1183108) = 0;
	dword_5d4594_3799476 = 0;
	dword_5d4594_3799452 = 0;
	*getMemU32Ptr(0x8531A0, 1183140) = 0;
	*getMemU32Ptr(0x8531A0, 1183200) = 0;
	*getMemU32Ptr(0x8531A0, 1183104) = 0;
	*getMemU32Ptr(0x8531A0, 1183132) = 0;
	*getMemU32Ptr(0x8531A0, 1183128) = 0;
	*getMemU32Ptr(0x8531A0, 1183196) = 0;
	*getMemU32Ptr(0x8531A0, 1183116) = 0;
	*getMemU32Ptr(0x8531A0, 1183216) = 0;
...
void nox_client_drawImageAt_47D2C0(nox_video_bag_image_t* img, int x, int y) {
	if (dword_5d4594_3799452) {
		nox_xxx_wndDraw_49F7F0();
		sub_49F780(*getMemIntPtr(0x8531A0, 1183148), *getMemIntPtr(0x8531A0, 1183108));
		sub_49F6D0(1);
	}
	...
	dword_5d4594_3799484 = 0;
	*getMemU32Ptr(0x8531A0, 1183216) = 0;
	if (*getMemU32Ptr(0x8531A0, 1183164) && img) {
		if (*getMemU32Ptr(0x8531A0, 1183188) != img->field_1_0 || *getMemU32Ptr(0x8531A0, 1183180) != img->field_1_1) {
			dword_5d4594_3799524 = 1;
		}
		img->field_1_0 = *getMemU16Ptr(0x8531A0, 1183188);
		img->field_1_1 = *getMemU16Ptr(0x8531A0, 1183180);
	}
}
...
int  sub_47D380(int a1, int a2) {
	...
	if (v2 == v3)
		return 0;
	if (v2 != v4 || v3 != v5) {
		*getMemU32Ptr(0x8531A0, 1183148) = v2;
		*getMemU32Ptr(0x8531A0, 1183108) = v3;
...
int  sub_47D3F0(int a1) {
	...
	result = a1;
	*getMemU32Ptr(0x8531A0, 1183140) = a1;
	return result;
}
...
int  nox_xxx_unused_47D420(int a1, int a2, int a3, int a4, int a5, int a6) {
	...
	*getMemU32Ptr(0x8531A0, 1183216) = 1;
	*getMemU32Ptr(0x8531A0, 1183200) = a1 << 16;
	*getMemU32Ptr(0x8531A0, 1183104) = a2 << 16;
	*getMemU32Ptr(0x8531A0, 1183132) = a3 << 16;
	result = a4 << 16;
	*getMemU32Ptr(0x8531A0, 1183128) = a4 << 16;
	*getMemU32Ptr(0x8531A0, 1183196) = a5 << 16;
	*getMemU32Ptr(0x8531A0, 1183116) = a6 << 16;
	return result;
}
...
int sub_47FCE0(_DWORD* a1, int a2) {
	...
	LABEL_8:
		...
		*getMemU32Ptr(0x8531A0, 1189184 + v4) = a1[3];
		*getMemU32Ptr(0x8531A0, 1189188 + v4) = a1[2];
		*getMemU32Ptr(0x8531A0, 1189192 + v4) = a1[21];
		*getMemU32Ptr(0x8531A0, 1189196 + v4) = a1[26];
		dword_5d4594_3804684 = v5;
	} else {
		v3 = getMemAt(0x8531A0, 1189188);
...
int nox_xxx_setupSomeVideo_47FEF0() {
	...
	if (dword_5d4594_3799624 == 2) {
		*getMemU32Ptr(0x8531A0, 1190812) = sub_480250;
		*getMemU32Ptr(0x8531A0, 1188344) = sub_480220;
		...
		*getMemU32Ptr(0x8531A0, 1190812) = sub_4801E0;
		*getMemU32Ptr(0x8531A0, 1188344) = sub_4801B0;
	...
	if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_12)) {
		...
		while (1) {
			for (v26 = v25; v26; --v26) {
				...
				*(WORD*)a5 = x;
#endif
				// maprgb = *(void **)getMemAt(0x8531A0, 1190812);
				// maprgb(tmp, v20);
...
int  sub_4814F0(int2* a1) {
	...
	v2 = *getMemU32Ptr(0x8531A0, 2592 + v1) >> 8;
	v3 = *getMemU32Ptr(0x8531A0, 2596 + v1) >> 8;
	v8 = *getMemU32Ptr(0x8529A0, 1020 + 4 * (((*getMemIntPtr(0x8531A0, 2604 + v1) >> 8) - v2) >> 8));
	v4 = *getMemU32Ptr(0x8531A0, 2600 + v1) >> 8;
	v9 = *getMemU32Ptr(0x8529A0, 1020 + 4 * (((*getMemIntPtr(0x8531A0, 2608 + v1) >> 8) - v3) >> 8));
	v10 = *getMemU32Ptr(0x8529A0, 1020 + 4 * (((*getMemIntPtr(0x8531A0, 2612 + v1) >> 8) - v4) >> 8));
	v5 = 0;
	do {
...
char  nox_xxx_tileDraw_4815E0(_DWORD* a1, int a2) {
	...
	v2 = dword_5d4594_3798804 * (dword_5d4594_3798840 + a1[1] - dword_5d4594_3798824) + dword_5d4594_3798796 +
		 ((dword_5d4594_3798836 + *a1 - dword_5d4594_3798820) << getMemByte(0x8531A0, 1190792));
	...
	if (v3) {
		...
		if (v2 + *getMemIntPtr(0x8531A0, 1182904) >= *(int*)&dword_5d4594_3798844) {
			v6 = 0;
			for (i = 0;; v6 = i) {
				v7 = *getMemU32Ptr(0x8531A0, 1182720 + v6) << getMemByte(0x8531A0, 1190792);
				v8 = *getMemU32Ptr(0x8531A0, 1182912 + v6) << getMemByte(0x8531A0, 1190792);
				if (v2 + v7 + v8 < v5) {
...
char*  sub_481770(_DWORD* a1, int a2, unsigned __int16 a3) {
	...
	if (!nox_client_texturedFloors_154956 && (getMemByte(0x8531A0, 65914 + 60 * a3) & 1) == 1)
		dword_5d4594_1193156 = 1;
	v3 = *getMemU32Ptr(0x8531A0, 65904 + 60 * a3);
	v4 = getMemByte(0x8531A0, 1190792);
	v5 = dword_5d4594_3798844;
	...
	if (v6 + *getMemU32Ptr(0x8531A0, 1182904) < *(int*)&dword_5d4594_3798844) {
		if (dword_5d4594_3799624)
		...
		v12 = 0;
		while (1) {
			v8 = *getMemU32Ptr(0x8531A0, 1182720 + v7) << v4;
			v9 = *getMemU32Ptr(0x8531A0, 1182912 + v7) << v4;
			if (v6 + v9 + v8 < v5) {
...
char  nox_xxx_drawTexEdgesProbably_481900(_DWORD* a1, _DWORD* a2) {
	...
	v3 = *(_DWORD*)(*getMemU32Ptr(0x8531A0, 65888 + 60 * *a2) +
					4 * (a2[1] + *getMemU16Ptr(0x8531A0, 65902 + 60 * *a2)));
	v4 = a2[2];
	v5 = dword_5d4594_3798836;
	addr =
		(*getMemU32Ptr(0x8531A0, 62048 + 60 * v4) + 4 * (a2[3] + *getMemU16Ptr(0x8531A0, 62062 + 60 * v4)));
	v6 = *(_DWORD*)addr;
	v7 = dword_5d4594_3798840;
	*getMemU32Ptr(0x5D4594, 2523980 + 4 * v4) = 1;
	v8 = dword_5d4594_3798804 * (v7 + a1[1] - v2) + dword_5d4594_3798796 +
		 ((v5 + *a1 - dword_5d4594_3798820) << getMemByte(0x8531A0, 1190792));
	...
	if (v9) {
		...
		if (v9) {
			...
			v31 = v13;
			v14 = (char*)((*getMemU32Ptr(0x8531A0, 1182528 + 4 * v32) << getMemByte(0x8531A0, 1190792)) + v11);
			v27 = v14;
			...
			if (v32 <= (int)v25) {
				do {
					v24 = *getMemU32Ptr(0x8531A0, 1182912 + 4 * v9);
					v26 = v14;
					v15 = (char*)(v13 + (*getMemU32Ptr(0x8531A0, 1182720 + 4 * v9) << getMemByte(0x8531A0, 1190792)));
					if (v24 > 0) {
						do {
							LOBYTE(v9) = *v10;
							v29 = v10[1];
							v33 = v10 + 2;
							v16 = v29 << getMemByte(0x8531A0, 1190792);
							switch ((_BYTE)v9) {
							case 2:
								if ((unsigned int)&v15[v16] < v12) {
									v19 = v33;
									v18 = v29 << getMemByte(0x8531A0, 1190792);
									v17 = v15;
								} else {
					...
					v14 = &v27[*getMemU32Ptr(0x8531A0, 1182912 + 4 * v9) << getMemByte(0x8531A0, 1190792)];
					v13 += dword_5d4594_3798804;
					v27 += *getMemU32Ptr(0x8531A0, 1182912 + 4 * v9) << getMemByte(0x8531A0, 1190792);
					v31 = v13;
					if (v13 >= v12) {
	...
	if (*(int*)&dword_5d4594_3798832 < *(int*)&dword_5d4594_3798832 + *(int*)&dword_5d4594_3798816) {
		...
		for (i = 44 * dword_5d4594_3798832;; v12 = i) {
			...
			if (*(_BYTE*)v14 & 2) {
				...
				v62 = *(_DWORD*)(*getMemU32Ptr(0x8531A0, 65888 + 60 * v15) +
								 4 * (*(_DWORD*)(v14 + 28) + *getMemU16Ptr(0x8531A0, 65902 + 60 * v15)));
				v68.field_0 = v76;
				v68.field_4 = v11 + 23;
				func_587000_154940(&v68, v62, v13);
				*getMemU32Ptr(0x8531A0, 33600 + 4 * v15) = 1;
				if (*(_DWORD*)(v14 + 40))
			...
			if (*(_BYTE*)v14 & 1) {
				...
				v63 = *(_DWORD*)(*getMemU32Ptr(0x8531A0, 65888 + 60 * v16) +
								 4 * (*(_DWORD*)(v14 + 8) + *getMemU16Ptr(0x8531A0, 65902 + 60 * v16)));
				v68.field_0 = v76 + 23;
				v68.field_4 = v11;
				func_587000_154940(&v68, v63, v13);
				*getMemU32Ptr(0x8531A0, 33600 + 4 * v16) = 1;
				v17 = *(_DWORD*)(v14 + 20);
				if (v17)
	...
	if (dword_5d4594_3798828 < j) {
		...
		while (1) {
			...
			if (v29 & 2) {
				...
				v64 = *(_DWORD*)(*getMemU32Ptr(0x8531A0, 65888 + 60 * v31) +
								 4 * (*(_DWORD*)(v30 + 28) + *getMemU16Ptr(0x8531A0, 65902 + 60 * v31)));
				v68.field_0 = v26;
				v68.field_4 = v76 + 23;
				func_587000_154940(&v68, v64, v27);
				*getMemU32Ptr(0x8531A0, 33600 + 4 * v31) = 1;
				if (*(_DWORD*)(v30 + 40))
			...
			if (*(_BYTE*)v30 & 1) {
				...
				v65 = *(_DWORD*)(*getMemU32Ptr(0x8531A0, 65888 + 60 * v32) +
								 4 * (*(_DWORD*)(v30 + 8) + *getMemU16Ptr(0x8531A0, 65902 + 60 * v32)));
				v68.field_0 = v26 + 23;
				v68.field_4 = v76;
				func_587000_154940(&v68, v65, v27);
				*getMemU32Ptr(0x8531A0, 33600 + 4 * v32) = 1;
				v33 = *(_DWORD*)(v30 + 20);
				if (v33)
...
LABEL_60:
	...
	if (nox_client_texturedFloors_154956) {
		...
		if (*(int*)&dword_5d4594_3679320 < *(int*)&dword_5d4594_3798156) {
			v51 = getMemAt(0x8531A0, 1066624 + 128 * dword_5d4594_3679320);
			v76 = 4 * dword_5d4594_3679320 - 4;
			for (j = (int)getMemAt(0x8531A0, 1066624 + 128 * dword_5d4594_3679320);; v51 = (unsigned __int8*)j) {
				i = (_DWORD)nox_pixbuffer_rows_3798784[v49];
				if (v50 == 23) {
					v78 = 0;
					++v66.field_4;
				}
				v52 = *getMemU32Ptr(0x8531A0, 1063012 + v76);
				v53 = (int*)v51;
				if (nox_client_highResFloors_154952 || !(v67.field_4 & 1) || v51 == getMemAt(0x8531A0, 1066624)) {
					if (v52 > 0) {
						...
						do {
							...
							if (v61 < v58 + v72 + 23) {
								do {
									if (*(_DWORD*)v75 != v66.field_4) {
										(*(int(**)(int2*)) getMemAt(0x8531A0, 1190816))(&v66);
										v59 = v67.field_0;
										v60 = v66.field_0;
									}
									v61 += 23;
							...
							(*(void(**)(int2*, int*, _DWORD, _DWORD, _DWORD)) &
							 dword_5d4594_3805484)(&v67, &v66.field_0, v78, v74, i + (v69 << getMemByte(0x8531A0, 1190792)));
							--v71;
						} while (v71);
					}
				} else if (v52 > 0) {
					...
					do {
						...
						v55 = v53[1];
						v53 += 2;
						v56 = (v55 - v54) << getMemByte(0x8531A0, 1190792);
						v57 = v74;
						memcpy((void*)(i + (v54 << getMemByte(0x8531A0, 1190792))),
								(const void*)((v54 << getMemByte(0x8531A0, 1190792)) + (_DWORD)nox_pixbuffer_rows_3798784[v76/4]),
								v56);
						v74 = v57 - 1;
					} while (v57 != 1);
				}
		...
		if (*(int*)&dword_5d4594_3679320 < *(int*)&dword_5d4594_3798156) {
			v78 = getMemAt(0x8531A0, 1066624 + 128 * dword_5d4594_3679320);
			do {
				v35 = v78;
				v36 = *getMemU32Ptr(0x8531A0, 1063008 + 4 * v79);
						...
						v39 =
							(char*)(dword_5d4594_3798804 * (v67.field_4 + dword_5d4594_3798840 - dword_5d4594_3798824) +
									...
									((v37 + v72 + dword_5d4594_3798836 - dword_5d4594_3798820)
									 << getMemByte(0x8531A0, 1190792)));
						if ((unsigned int)v39 >= *(int*)&dword_5d4594_3798844)
							v39 += dword_5d4594_3798796 - dword_5d4594_3798844;
						v76 = i + (v37 << getMemByte(0x8531A0, 1190792));
						v40 = v38 << getMemByte(0x8531A0, 1190792);
						if ((unsigned int)&v39[v38 << getMemByte(0x8531A0, 1190792)] < *(int*)&dword_5d4594_3798844) {
							v42 = (char*)v76;
							...
							v42 = (char*)(v41 + v76);
							v40 = (v38 << getMemByte(0x8531A0, 1190792)) - v41;
...
int  nox_xxx_tileCheckRedrawMB_482570(_DWORD* a1) {
	...
	while (1) {
		v8 = i + *v7;
		if (*(_BYTE*)v8 & 1) {
			if ((getMemByte(0x8531A0, 65914 + 60 * *(_DWORD*)(v8 + 4)) & 1) == 1)
				return 1;
		}
		if (*(_BYTE*)v8 & 2 && (getMemByte(0x8531A0, 65914 + 60 * *(_DWORD*)(v8 + 24)) & 1) == 1)
			return 1;
		++v6;
		++v7;
		if (v6 >= v12) {
...
int  nox_xxx_tileDrawImpl_4826A0(_DWORD* a1) {
	...
	sub_481410();
	memset(getMemAt(0x8531A0, 33600), 0, 0x2C0u);
				...
				do {
					...
					if (v12) {
						if (v12 & 2) {
							...
							v18 = *(_DWORD*)(*getMemU32Ptr(0x8531A0, 65888 + 60 * v14) +
											 4 * (*(_DWORD*)(v13 + 28) +
												  *getMemU16Ptr(0x8531A0, 65902 + 60 * v14)));
							v24.field_0 = v8;
							v24.field_4 = v6 + 23;
							func_587000_154940(&v24, v18, v10);
							*getMemU32Ptr(0x8531A0, 33600 + 4 * v14) = 1;
							if (*(_DWORD*)(v13 + 40))
						...
						if (*(_BYTE*)v13 & 1) {
							...
							v19 = *(_DWORD*)(*getMemU32Ptr(0x8531A0, 65888 + 60 * v15) +
											 4 * (*(_DWORD*)(v13 + 8) +
												  *getMemU16Ptr(0x8531A0, 65902 + 60 * v15)));
							v24.field_0 = v8 + 23;
							v24.field_4 = v6;
...
int  nox_thing_read_floor_485B30(int a1, char* a2) {
	...
	*(_DWORD*)(v2 + 8) = v3 + 1;
	...
	LABEL_5:
		...
		v6 = (const char*)getMemAt(0x8531A0, 65856);
		while (strcmp(v6, v22)) {
			++v5;
			v6 += 60;
	...
	*(_DWORD*)(v2 + 8) = v9 + 4;
	...
	v20 = 15 * v7;
	*getMemU32Ptr(0x8531A0, 65888 + 60 * v7) = malloc(4 * v10);
	v11 = 0;
	for (i = 0; v11 < v10;
		 *(_DWORD*)(*getMemU32Ptr(0x8531A0, 65888 + 4 * v20) + 4 * v11 - 4) = nox_xxx_readImgMB_42FAA0(v13, v21, a2)) {
		v12 = *(int**)(v2 + 8);
		v13 = *v12;
		*(_DWORD*)(v2 + 8) = v12 + 1;
...
int  nox_thing_read_edge_485D40(int a1, char* a2) {
	...
	*(_DWORD*)(v2 + 8) = v3 + 1;
	...
	LABEL_5:
		...
		v6 = (const char*)getMemAt(0x8531A0, 62016);
		while (strcmp(v6, v26)) {
			++v5;
			v6 += 60;
	...
	*(_DWORD*)(v2 + 8) = v12 + 1;
	...
	v24 = 15 * v7;
	*getMemU32Ptr(0x8531A0, 62048 + 60 * v7) = result;
	if (result) {
		v15 = 0;
		for (i = 0; v15 < v14;
			 *(_DWORD*)(*getMemU32Ptr(0x8531A0, 62048 + 4 * v24) + 4 * v15 - 4) = nox_xxx_readImgMB_42FAA0(v17, v25, a2)) {
			v16 = *(int**)(v2 + 8);
			v17 = *v16;
			*(_DWORD*)(v2 + 8) = v16 + 1;
...
void nox_xxx_initSight_485F80() {
	...
	v2 = 1;
	for (i = 23; i > 0; --i) {
		*getMemU32Ptr(0x8531A0, 1182528 + 4 * v1) = v0;
		*getMemU32Ptr(0x8531A0, 1182720 + 4 * v1) = i;
		*getMemU32Ptr(0x8531A0, 1182912 + 4 * v1) = v2;
		v0 += v2;
		++v1;
		v2 += 2;
	}
	if (v1 < 46) {
		...
		v7 = 46 - v1;
		do {
			*getMemU32Ptr(0x8531A0, 1182528 + v6) = v0;
			*getMemU32Ptr(0x8531A0, 1182720 + v6) = v5;
			*getMemU32Ptr(0x8531A0, 1182912 + v6) = v4;
			v0 += v4;
			++v5;
			v4 -= 2;
			v6 += 4;
...
int nox_xxx_tile_486060() {
	...
	*getMemU32Ptr(0x8531A0, 1182904) = 45 * dword_5d4594_3798804 + (46 << getMemByte(0x8531A0, 1190792));
	return result;
}
