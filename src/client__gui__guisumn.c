...
int  sub_4C27F0(_DWORD* a1) {
	...
	if (dword_5d4594_1321204 || (result = 1, a1[8] != 1)) {
		...
		if (nox_xxx_wndPointInWnd_46AAB0(a1, mpos.x, mpos.y)) {
			sub_4C2A00(v11 + v4, v10 + 3, *getMemIntPtr(0x5D4594, 2589772), *getMemIntPtr(0x8529A0, 36372), (__int16*)v2);
		...
		if (dword_5d4594_1321204) {
			if (sub_4C2DD0(*(int*)&dword_5d4594_1321204)) {
				sub_4C2A00(v11 + v4, v10 + 3, *getMemIntPtr(0x5D4594, 2523948), *getMemIntPtr(0x8529A0, 36372), (__int16*)v2);
				return 1;
			}
			v5 = a1[8];
			if (v5 != 4 && v5 != 5) {
			...
			v6 = *getMemU32Ptr(0x8529A0, 36376);
			v9 = (__int16*)v2;
			v8 = *getMemU32Ptr(0x8529A0, 36372);
		} else {
			v7 = a1[8];
			if (v7 != 4 && v7 != 5) {
				sub_4C2A00(v11 + v4, v10 + 3, *getMemIntPtr(0x8529A0, 36400), *getMemIntPtr(0x8529A0, 36372), (__int16*)v2);
				return 1;
			}
			v9 = (__int16*)v2;
			if (!sub_4C2E00()) {
				sub_4C2A00(v11 + v4, v10 + 3, *getMemIntPtr(0x8529A0, 36376), *getMemIntPtr(0x8529A0, 36372), (__int16*)v2);
				return 1;
			}
			v6 = *getMemU32Ptr(0x8529A0, 36400);
			v8 = *getMemU32Ptr(0x8529A0, 36372);
		}
