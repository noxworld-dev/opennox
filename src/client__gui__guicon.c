...
wchar_t*  sub_450C30(unsigned __int8 a1, int a2) {
	...
	result = nox_strman_loadString_40F1D0("InternalError", 0, "C:\\NoxPost\\src\\Client\\Gui\\guicon.c", 97);
	if (result)
	...
	if (!*(_DWORD*)(*(_DWORD*)(dword_5d4594_833716 + 32) + 1044)) {
		...
		if (dword_5d4594_833732 && *getMemU16Ptr(0x5D4594, 832552)) {
			if (_nox_wcsicmp(v0, (const wchar_t*)getMemAt(0x5D4594, 832552))) {
				v4 = nox_strman_loadString_40F1D0("INVALIDPASSWORD", 0, "C:\\NoxPost\\src\\Client\\Gui\\guicon.c",
										   124);
				sub_450C30(4u, (int)v4);
			} else {
				dword_5d4594_833732 = 0;
				v3 = nox_strman_loadString_40F1D0("ConsoleUnlocked", 0, "C:\\NoxPost\\src\\Client\\Gui\\guicon.c",
										   121);
	...
	if (!result) {
		...
		*(_DWORD*)(dword_5d4594_833716 + 4) |= 1u;
		...
		if (dword_5d4594_833728) {
			...
			v1 = nox_strman_loadString_40F1D0("ENTERPASSWORD", 0, "C:\\NoxPost\\src\\Client\\Gui\\guicon.c", 459);
