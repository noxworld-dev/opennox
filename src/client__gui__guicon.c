...
nox_window* nox_gui_console_Create_450C70(int win_width, int win_height) {
	int v0 = *getMemU32Ptr(0x853BC0, 31736);
	...
	*(_DWORD*)((char*)nox_gui_console_win + 56) = *getMemU32Ptr(0x853BC0, 31732);
...
void nox_gui_console_reloadColors_451100() {
	unsigned int color = *getMemU32Ptr(0x853BC0, 31736);
	unsigned int color2 = *getMemU32Ptr(0x853BC0, 31732);
