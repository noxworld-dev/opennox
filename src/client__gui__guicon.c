...
nox_window* nox_gui_console_Create_450C70(int win_width, int win_height) {
	int v0 = *getMemU32Ptr(0x5D4594, 2650660);
	...
	*(_DWORD*)((char*)nox_gui_console_win + 56) = *getMemU32Ptr(0x5D4594, 2650656);
...
void nox_gui_console_reloadColors_451100() {
	unsigned int color = *getMemU32Ptr(0x5D4594, 2650660);
	unsigned int color2 = *getMemU32Ptr(0x5D4594, 2650656);
