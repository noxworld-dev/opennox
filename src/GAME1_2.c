...
int nox_server_mapRWMapInfo_42A6E0() {
	...
	if (vers >= 1) {
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8531A0, 1185504), 64);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8531A0, 1185568), 512);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8531A0, 1186080), 16);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8531A0, 1186096), 64);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8531A0, 1186160), 64);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8531A0, 1186224), 128);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8531A0, 1186352), 128);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8531A0, 1186480), 256);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8531A0, 1186736), 128);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8531A0, 1186864), 32);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8531A0, 1186896), 4);
		if (vers == 2) {
			nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8531A0, 1186900), 1u);
			nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8531A0, 1186901), 1u);
		} else if (*getMemU32Ptr(0x8531A0, 1186968) == 1) {
			*getMemU8Ptr(0x8531A0, 1186900) = 2;
			*getMemU8Ptr(0x8531A0, 1186901) = 16;
		}
	}
	if (vers < 3) {
		*getMemU8Ptr(0x8531A0, 1186902) = getMemByte(0x5D4594, 741376);
		*getMemU8Ptr(0x8531A0, 1186934) = getMemByte(0x5D4594, 741380);
	} else {
		int v2 = strlen(getMemAt(0x8531A0, 1186902));
		nox_xxx_fileReadWrite_426AC0_file3_fread(&v2, 1);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8531A0, 1186902), v2);
		*getMemU8Ptr(0x8531A0, 1186902 + v2) = 0;

		v2 = strlen(getMemAt(0x8531A0, 1186934));
		nox_xxx_fileReadWrite_426AC0_file3_fread(&v2, 1);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x8531A0, 1186934), v2);
		*getMemU8Ptr(0x8531A0, 1186934 + v2) = 0;
	}
	return 1;
}
...
int  nox_video_read_videobag(int is16bit) {
	...
	*getMemU32Ptr(0x8531A0, 1190832) = getMemAt(0x5D4594, 754148);
...
char*  sub_430B80(_DWORD* a1) {
	*a1 = dword_5d4594_3804684;
	return (char*)getMemAt(0x8531A0, 1189184);
}
...
int  nox_xxx_tileInitBuf_430DB0(int a1, int a2) {
	...
	v2 = ((46 * dword_5d4594_3798812) << getMemByte(0x8531A0, 1190792)) * 46 * dword_5d4594_3798816;
	dword_5d4594_3798804 = (46 * dword_5d4594_3798812) << getMemByte(0x8531A0, 1190792);
...
unsigned __int8  sub_434630(unsigned __int8 a1, unsigned __int8 a2, unsigned __int8 a3) {
	...
	LABEL_6:
		...
		*getMemU8Ptr(0x8531A0, 1188192 + 4 * dword_5d4594_810628) = a1;
		v14 = getMemAt(0x8531A0, 1188192 + 4 * v13);
		v14[1] = a2;
		v14[2] = a3;
		v14[3] = v18;
...
char  sub_4347C0(char a1) {
	...
	do {
		--v2;
		*getMemU8Ptr(0x8531A0, 1186978) = a1;
		*getMemU8Ptr(0x8531A0, 1186977) = a1;
		*getMemU8Ptr(0x8531A0, 1186976) = a1;
		*getMemU8Ptr(0x8531A0, 1186979) = 0;
	} while (v2);
	return result;
}
...
int  sub_434820(int a1, char a2, char a3, char a4) {
	if (a1 < 0 || a1 >= 256)
		return 0;
	*getMemU8Ptr(0x8531A0, 1186976 + 4 * a1) = a2;
	*getMemU8Ptr(0x8531A0, 1186977 + 4 * a1) = a3;
	*getMemU8Ptr(0x8531A0, 1186978 + 4 * a1) = a4;
	*getMemU8Ptr(0x8531A0, 1186979 + 4 * a1) = 4;
	sub_435040();
	sub_434F00();
...
int  sub_434870(int a1, _BYTE* a2, _BYTE* a3, _BYTE* a4) {
	if (a1 < 0 || a1 >= 256)
		return 0;
	if (a2)
		*a2 = getMemByte(0x8531A0, 1186976 + 4 * a1);
	if (a3)
		*a3 = getMemByte(0x8531A0, 1186977 + 4 * a1);
	if (a4)
		*a4 = getMemByte(0x8531A0, 1186978 + 4 * a1);
	return 1;
}
...
int sub_434920() {
	...
	if (dword_5d4594_808564)
		return 0;
	result = 1;
	memcpy(getMemAt(0x5D4594, 808572), getMemAt(0x8531A0, 1186976), 0x400u);
...
int sub_434950() {
	...
	memcpy(getMemAt(0x8531A0, 1186976), getMemAt(0x5D4594, 808572), 0x400u);
	sub_435040();
	sub_434F00();
	return 1;
}
...
char  sub_434A60(int a1) {
	return *(_BYTE*)(dword_5d4594_3804668 + (((unsigned __int8)(getMemByte(0x8531A0, 1186978 + 4 * a1) & 0xF8) >> 3) |
											 (4 * (getMemByte(0x8531A0, 1186977 + 4 * a1) & 0xF8)) |
											 ((getMemByte(0x8531A0, 1186976 + 4 * a1) & 0xF8) << 7)));
}
...
void sub_435040() {
	...
	data = getMemAt(0x8531A0, 1186976);
	for (int i = 0; i < 256; ++i) {
		buf[i].field_0 = i;
...
void  sub_435240(unsigned __int8 a1, _BYTE* a2, _BYTE* a3, char* a4) {
	...
	v4 = 4 * a1;
	*a2 = getMemByte(0x8531A0, 1186976 + v4);
	*a3 = getMemByte(0x8531A0, 1186977 + v4);
	result = getMemByte(0x8531A0, 1186978 + v4);
	*a4 = result;
}
...
int  nox_xxx_whenServerHostServer_435A10(signed int* a1) {
	...
	nox_wcscpy((wchar_t*)v1, (const wchar_t*)getMemAt(0x8531A0, 45576));
	v1[66] = getMemByte(0x8531A0, 45626);
	*(_WORD*)(v1 + 71) = *getMemU16Ptr(0x8531A0, 45556);
	v1[73] = getMemByte(0x8531A0, 45558);
	*((_WORD*)v1 + 34) = *getMemU16Ptr(0x8531A0, 45559);
	v1[70] = getMemByte(0x8531A0, 45561);
	*((_WORD*)v1 + 37) = *getMemU16Ptr(0x8531A0, 45562);
	v1[76] = getMemByte(0x8531A0, 45564);
	*(_WORD*)(v1 + 77) = *getMemU16Ptr(0x8531A0, 45565);
	v1[79] = getMemByte(0x8531A0, 45567);
	*((_WORD*)v1 + 40) = *getMemU16Ptr(0x8531A0, 45568);
	v1[82] = getMemByte(0x8531A0, 45570);
	v1[83] = getMemByte(0x8531A0, 45571);
	v1[84] = getMemByte(0x8531A0, 45572);
	v1[85] = getMemByte(0x8531A0, 45573);
	v1[86] = getMemByte(0x8531A0, 45574);
	v1[87] = getMemByte(0x8531A0, 45575);
	v1[67] = getMemByte(0x8531A0, 45627);
	sub_48D740();
	*(_DWORD*)&Data[97] = v5;
	*(_DWORD*)&Data[101] = v4;
	...
	if (getMemByte(0x8531A0, 44352) & 4)
		Data[152] |= 0x80u;
	strcpy((char*)&Data[142], (const char*)getMemAt(0x8531A0, 43767));
...
int nox_client_joinGame_438A90() {
	...
	/*if (*/ nox_xxx_regGetSerial_420120((LPBYTE)&buf[56]); //)
	{
		...
		nox_wcscpy((wchar_t*)&buf[4], (const wchar_t*)getMemAt(0x8531A0, 45576));
		buf[54] = getMemByte(0x8531A0, 45626);
		buf[55] = getMemByte(0x8531A0, 45628);
		*(_DWORD*)&buf[80] = NOX_CLIENT_VERS_CODE;
		*(_DWORD*)&buf[84] = dword_5d4594_2660032;
		strcpy(&buf[88], (const char*)getMemAt(0x8531A0, 43716));
