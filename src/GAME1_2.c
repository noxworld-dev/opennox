		...
		if (result) {
			do {
				if (*((_DWORD*)v12 + 1198)) {
					...
					*(_DWORD*)(*((_DWORD*)v2 + 143) + 4 * v20++) =
					    sub_4D6540((unsigned __int8)v12[2064]);
				}
	...
	if (*(_DWORD*)&byte_5D4594[3803300]) {
		...
		if (v25 >= 1) {
			do {
				...
				if ((__int16)v26 >= 3 ||
				    (sub_426AC0_file3_fread(&v31, 4u), sub_426AC0_file3_fread(v32, 0xCu),
...
void __cdecl sub_429A60(int a1, _DWORD* a2) {
	...
	if (!a2 || (v2 = *(unsigned __int8*)(a1 + 6), v5.field_0 = 23 * *(unsigned __int8*)(a1 + 5),
		    v5.field_4 = 23 * v2, sub_427F30(&v5, a2))) {
		if (*(_BYTE*)(a1 + 4) & 4) {
			v3 = *(unsigned __int8*)(a1 + 6);
			v4 = *(_BYTE**)(a1 + 28);
...
int __cdecl nox_server_mapRWWallMap_429B20(_DWORD* a1) {
	...
	sub_426AC0_file3_fread(&byte_5D4594[741360], 4u);
	sub_426AC0_file3_fread(&byte_5D4594[741368], 4u);
	sub_426AC0_file3_fread(&v25, 4u);
					...
					if (v10) {
						if (v10[1] != byte_5D4594[741372]) {
							if (!v2 || (v32.field_0 = 23 * (unsigned __int8)v10[5],
								...
								if (v12 ||
								    (v12 = (struc_19*)sub_421990(&v32, 10.0, 0)) != 0)
...
int nox_server_mapRWMapInfo_42A6E0() {
	...
	if ((__int16)v3 > 3)
		return 0;
	if ((__int16)v3 >= 1) {
		sub_426AC0_file3_fread(&byte_5D4594[3801836], 0x40u);
		sub_426AC0_file3_fread(&byte_5D4594[3801900], 0x200u);
		sub_426AC0_file3_fread(&byte_5D4594[3802412], 0x10u);
		sub_426AC0_file3_fread(&byte_5D4594[3802428], 0x40u);
		sub_426AC0_file3_fread(&byte_5D4594[3802492], 0x40u);
		sub_426AC0_file3_fread(&byte_5D4594[3802556], 0x80u);
		sub_426AC0_file3_fread(&byte_5D4594[3802684], 0x80u);
		sub_426AC0_file3_fread(&byte_5D4594[3802812], 0x100u);
		sub_426AC0_file3_fread(&byte_5D4594[3803068], 0x80u);
		sub_426AC0_file3_fread(&byte_5D4594[3803196], 0x20u);
		sub_426AC0_file3_fread(&byte_5D4594[3803228], 4u);
		v0 = v3;
		if ((_WORD)v3 == 2) {
			sub_426AC0_file3_fread(&byte_5D4594[3803232], 1u);
			sub_426AC0_file3_fread(&byte_5D4594[3803233], 1u);
			v0 = v3;
	...
	if (v0 < 3) {
		...
		sub_426AC0_file3_fread(&byte_5D4594[3803234], (unsigned __int8)v2);
		byte_5D4594[(unsigned __int8)v2 + 3803234] = 0;
		LOBYTE(v2) = strlen((const char*)&byte_5D4594[3803266]);
		sub_426AC0_file3_fread(&v2, 1u);
		sub_426AC0_file3_fread(&byte_5D4594[3803266], (unsigned __int8)v2);
	...
	*(_DWORD*)&v118[4] = 0;
	...
	case 2:
		...
		*(_DWORD*)&byte_5D4594[741668] = v83;
		...
		sub_42C360(v118, v91);
		v92 = 0;
		for (*(_DWORD*)&byte_5D4594[741660] = 0; v92 < *(__int16*)(v4 + 6);
		     *(_DWORD*)&byte_5D4594[741660] = v92) {
...
u_short* __cdecl sub_42B810(__int16* a1, unsigned int* a2) {
	...
	*(_DWORD*)&v59[4] = 0;
	...
	for (*(_DWORD*)&byte_5D4594[741664] = 0; v27 < *v2; *(_DWORD*)&byte_5D4594[741664] = v27) {
		...
		sub_42BDC0(v59, (char*)&byte_587000[71624],
				...
				if (result == 1) {
					...
					if (!result) {
						...
						for (m = result; result; m = result) {
							if (!sub_4E3AD0(*(_DWORD*)(m + 108)) &&
							    sub_4E3B80(*(_DWORD*)(m + 108))) {
								v14 = (_WORD*)(*(_DWORD*)&byte_5D4594[741676] +
									       2 * *(_DWORD*)(m + 108));
								if (!*v14) {
									*v14 = v15;
									++*(_WORD*)&byte_5D4594[741684];
...
int __cdecl sub_42C210(int a1, _WORD* a2, _WORD* a3) {
	...
	do {
		...
		do {
			if (*(_DWORD*)v4) {
				v6 = (_WORD*)(*(_DWORD*)&byte_5D4594[741676] +
					      2 * *(unsigned __int16*)(*(_DWORD*)v4 + 4));
				if (!*v6) {
					*v6 = (*a2)++;
					++*a3;
				}
...
//----- (0042C300) --------------------------------------------------------
__int16 sub_42C300() { return *(_WORD*)&byte_5D4594[741684]; }
						...
						if (*v11 != 43) {
							...
							if (*(_DWORD*)&byte_587000[75880]) {
								...
								if (v15 == 8)
									goto LABEL_38;
								*(_DWORD*)(v17 + 4 * v15 + 36) =
								    *(_DWORD*)&byte_587000[12 * v13 + 75884];
								++*(_DWORD*)(v17 + 68);
							}
						LABEL_33:
		...
		while (1) {
			...
			if (v4 & 0x10000 && byte_5D4594[747848] != 2) {
				...
				LABEL_17:
				   ...
				   (byte_5D4594[750956] || !((1 << v4) & *(_DWORD*)&byte_5D4594[747844]))) {
				goto LABEL_33;
			}
		LABEL_32:
			++v3;
...
//----- (0042D440) --------------------------------------------------------
int __cdecl sub_42D440(int a1) { return *(_DWORD*)&byte_587000[12 * a1 + 72020]; }

//----- (0042D450) --------------------------------------------------------
unsigned __int8 __cdecl sub_42D450(int a1) { return byte_587000[12 * a1 + 72024]; }
		...
		if (*(_DWORD*)&byte_5D4594[754040] != *(_DWORD*)&byte_5D4594[754036]) {
			...
			do {
				...
				if (*(_DWORD*)&byte_5D4594[24 * v3 + 747900] == 1) {
					...
					byte_5D4594[*(_DWORD*)&byte_5D4594[747864] + 741692] =
					    byte_5D4594[24 * v3 + 747892];
					*(_DWORD*)&byte_5D4594[747864] = v5 + 4;
					result = sub_42D440(v6);
					if (result) {
						result = sub_42D450(*(_DWORD*)&byte_5D4594[24 * v3 + 747892]);
						qmemcpy(&byte_5D4594[*(_DWORD*)&byte_5D4594[747864] + 741692],
							&byte_5D4594[24 * v3 + 747896], result);
...
//----- (0042E620) --------------------------------------------------------
int sub_42E620() { return sub_413A00(0); }
...
//----- (0042EBA0) --------------------------------------------------------
int sub_42EBA0() { return *(_DWORD*)&byte_5D4594[754052]; }
	...
	*(_DWORD*)&byte_5D4594[787224] = 1;
	...
	if (v3[6] != -1) {
		if (v4) {
			...
			*(_DWORD*)(*(_DWORD*)(*(_DWORD*)&byte_5D4594[787148] + 36 * *(unsigned __int16*)(a1 + 8) + 28) +
				   32) =
			    *(_DWORD*)(*(_DWORD*)&byte_5D4594[787148] + 36 * *(unsigned __int16*)(a1 + 8) + 32);
			*(_DWORD*)(*(_DWORD*)(*(_DWORD*)&byte_5D4594[787148] + 36 * *(unsigned __int16*)(a1 + 8) + 32) +
				   28) =
			    *(_DWORD*)(*(_DWORD*)&byte_5D4594[787148] + 36 * *(unsigned __int16*)(a1 + 8) + 28);
		} else {
			if (!*(_DWORD*)&byte_5D4594[787188]) {
				...
				*v6 = 0;
				v5[8] = 0;
				*(_DWORD*)(*(_DWORD*)&byte_5D4594[787140] + 28) =
				    *(_DWORD*)&byte_5D4594[787148] + 36 * *(unsigned __int16*)(a1 + 8);
				*(_DWORD*)(*(_DWORD*)&byte_5D4594[787148] + 36 * *(unsigned __int16*)(a1 + 8) + 28) =
				    &byte_5D4594[787108];
				*(_DWORD*)(*(_DWORD*)&byte_5D4594[787148] + 36 * *(unsigned __int16*)(a1 + 8) + 32) =
				    *(_DWORD*)&byte_5D4594[787140];
				*(_DWORD*)&byte_5D4594[787140] =
				    *(_DWORD*)&byte_5D4594[787148] + 36 * *(unsigned __int16*)(a1 + 8);
				...
				*(_DWORD*)(*(_DWORD*)&byte_5D4594[787148] + 36 * *(unsigned __int16*)(a1 + 8) + 4) =
...
int __cdecl sub_42FE30(int a1) {
	...
	if (*(_DWORD*)(v1 + 12) == v2) {
		...
		if (sub_578C10(*(_DWORD**)&byte_5D4594[787212], &v4[*(_DWORD*)(v1 + 12) - v9], &v9,
			       (unsigned int)&v6[*(_DWORD*)(v1 + 16) - a1], &a1)) {
			while (a1 > 0 && sub_578C10(*(_DWORD**)&byte_5D4594[787212], &v4[*(_DWORD*)(v1 + 12) - v9], &v9,
						    (unsigned int)&v6[*(_DWORD*)(v1 + 16) - a1], &a1))
				;
		}
		if (v3)
...
void __cdecl sub_4302A0_process_events(int evNum, int a2) {
	...
	if (num <= 0) {
		...
		for (int i = 0; i < num; i++) {
			...
			// left mouse button
			if (ev->left_seq == 0) {
				if (nox_mouse.left_state &&
				    (nox_mouse_prev.field_6 == 5 || nox_mouse_prev.field_6 == 8)) {
					nox_mouse.field_6 = 8;
				}
				...
				if (ev->left_state) {
					if (nox_mouse.field_6 != 7) {
					   ...
					   (dx = nox_mouse.pos.x - nox_mouse_prev_left.x,
					    dy = nox_mouse.pos.y - nox_mouse_prev_left.y, dx * dx + dy * dy >= 100)) {
					nox_mouse.field_6 = 6;
			...
			// right mouse button
			if (ev->right_seq == 0) {
				if (nox_mouse.right_state &&
				    (nox_mouse_prev.field_9 == 9 || nox_mouse_prev.field_9 == 12)) {
					nox_mouse.field_9 = 12;
				}
			...
			// middle mouse button
			if (ev->middle_seq == 0) {
				if (nox_mouse.middle_state &&
				    (nox_mouse_prev.field_12 == 13 || nox_mouse_prev.field_12 == 16)) {
					nox_mouse.field_12 = 16;
				}
...
//----- (00430890) --------------------------------------------------------
int sub_430890() { return *(_DWORD*)&byte_5D4594[805808]; }
...
//----- (00430940) --------------------------------------------------------
char* sub_430940() { return (char*)&byte_5D4594[787228]; }

//----- (00430950) --------------------------------------------------------
unsigned __int8 __cdecl sub_430950(unsigned __int8 a1) { return byte_5D4594[8 * a1 + 789278]; }

//----- (00430970) --------------------------------------------------------
unsigned __int8 __cdecl sub_430970(unsigned __int8 a1) { return byte_5D4594[8 * a1 + 789277]; }

//----- (00430990) --------------------------------------------------------
int __cdecl sub_430990(unsigned __int8 a1) { return *(_DWORD*)&byte_5D4594[8 * a1 + 789280]; }
...
//----- (00430AF0) --------------------------------------------------------
int sub_430AF0() { return *(_DWORD*)&byte_5D4594[805820]; }
...
//----- (00430B30) --------------------------------------------------------
int sub_430B30() { return *(_DWORD*)&byte_5D4594[805804]; }
...
//----- (00431770) --------------------------------------------------------
char* sub_431770() { return (char*)&byte_5D4594[807172]; }

//----- (00431780) --------------------------------------------------------
char* sub_431780() { return (char*)&byte_5D4594[806060]; }
...
int __cdecl sub_4344D0(_BYTE* a1) {
	...
	if (a1) {
		if (*(_DWORD*)&byte_5D4594[3799624]) {
			...
			LOBYTE(v2) = 0;
			HIBYTE(v2) = *a1;
			result = (unsigned __int16)((unsigned __int8)*a1 | v2) |
				 ((unsigned __int16)((unsigned __int8)*a1 | v2) << 16);
		}
	}
	return result;
}
	...
	if (result) {
		...
		while (1) {
			*(_BYTE*)((char*)result + v3) =
			    (unsigned __int16)(28 * ((((unsigned __int16)v3 & *(_WORD*)&byte_5D4594[3804372])
						      << byte_5D4594[3804384]) |
						     7) +
					       150 * (v0 | ((v3 & *(_DWORD*)&byte_5D4594[3804368]) >>
							    byte_5D4594[3804380])) +
					       76 * (((v3 & *(_DWORD*)&byte_5D4594[3804364]) >> byte_5D4594[3804376]) |
						     7)) >>
			    8;
			if ((int)++v3 > v1)
				break;
...
//----- (00435590) --------------------------------------------------------
int sub_435590() { return *(_DWORD*)&byte_5D4594[811916]; }
...
//----- (00435670) --------------------------------------------------------
void __cdecl sub_435670(int2* a1) { *a1 = *(int2*)&byte_5D4594[811092]; }
...
//----- (004356E0) --------------------------------------------------------
void sub_4356E0() { *(_DWORD*)&byte_587000[85720] = 0; }

//----- (004356F0) --------------------------------------------------------
char* sub_4356F0() { return (char*)&byte_5D4594[811280]; }
...
//----- (00435720) --------------------------------------------------------
char* __cdecl sub_435720(char* a1) { return strncpy((char*)&byte_587000[85680], a1, 0x20u); }
...
int sub_435CC0() {
	...
	*(_DWORD*)&byte_5D4594[811116] = 0;
	...
	nox_server_parseCmdText_443C80((wchar_t*)&byte_587000[86380], 1);
	sub_4951C0();
	sub_465DE0(0);
	return 1;
}
...
//----- (00435EB0) --------------------------------------------------------
int sub_435EB0() {
	nox_common_writecfgfile((char*)&byte_587000[86424]);
	if (nox_common_gameFlags_check_40A5C0(1))
		sub_4DE530(31, 2);
	else
		sub_43CB50();
...
BOOL sub_436550() {
	...
	if (sub_459DA0() || sub_446360() || sub_49CB40() || sub_49C810() || sub_446950() || sub_4706A0() ||
	    sub_451410()) {
...
//----- (00437180) --------------------------------------------------------
int4* sub_437180() { return sub_48D990(&byte_5D4594[811068]); }
...
//----- (00437250) --------------------------------------------------------
char* sub_437250() { return (char*)&byte_5D4594[811068]; }
...
int __cdecl sub_4375F0(const char* a1, __int16 a2, char* a3, int a4) {
	...
	if (*(_DWORD*)&byte_5D4594[815088] < 0x9C4u && !*(_DWORD*)&byte_5D4594[815044] &&
		...
		if (memcmp(a1, &byte_5D4594[815108], 1u)) {
			if (*(_DWORD*)(a4 + 44) == *(_DWORD*)&byte_5D4594[814964]) {
				if (sub_4A0410(a1, a2)) {
					...
					*(_WORD*)&v13[165] = v10;
					if (*(int*)&byte_587000[87412] == -1 ||
					    sub_437860(*(__int16*)&v13[44], *(__int16*)&v13[46]) ==
						*(_DWORD*)&byte_587000[87412]) {
...
int __cdecl sub_437860(int a1, int a2) {
	...
	while (a1 <= *((__int16*)v3 - 2) || a1 >= *(__int16*)v3 || a2 <= *((__int16*)v3 - 1) ||
	       a2 >= *((__int16*)v3 + 1)) {
		v3 += 8;
		++result;
...
int sub_438480() {
	...
	sub_46B120(*(_DWORD**)&byte_5D4594[815016], *(int*)&dword_5d4594_815012);
	sub_46B300(*(int*)&byte_5D4594[815016], sub_438EF0);
	sub_46B120(*(_DWORD**)&byte_5D4594[815020], *(int*)&dword_5d4594_815012);
	sub_46B300(*(int*)&byte_5D4594[815020], sub_438EF0);
	sub_46B120(*(_DWORD**)&byte_5D4594[815024], *(int*)&dword_5d4594_815012);
	sub_46B300(*(int*)&byte_5D4594[815024], sub_438EF0);
	sub_46B120(*(_DWORD**)&byte_5D4594[815028], *(int*)&dword_5d4594_815012);
	sub_46B300(*(int*)&byte_5D4594[815028], sub_438EF0);
	sub_46B120(*(_DWORD**)&byte_5D4594[815032], *(int*)&dword_5d4594_815012);
	...
	**(_DWORD**)(*(_DWORD*)(dword_5d4594_815004 + 32) + 36) = 10032;
	nox_window_call_field_94(*(int*)&byte_5D4594[815016], 16408,
				 *(_DWORD*)(*(_DWORD*)(dword_5d4594_815012 + 32) + 28), 0);
	nox_window_call_field_94(*(int*)&byte_5D4594[815020], 16408,
				 *(_DWORD*)(*(_DWORD*)(dword_5d4594_815012 + 32) + 28), 0);
	nox_window_call_field_94(*(int*)&byte_5D4594[815024], 16408,
				 *(_DWORD*)(*(_DWORD*)(dword_5d4594_815012 + 32) + 28), 0);
	nox_window_call_field_94(*(int*)&byte_5D4594[815028], 16408,
				 *(_DWORD*)(*(_DWORD*)(dword_5d4594_815012 + 32) + 28), 0);
	nox_window_call_field_94(*(int*)&byte_5D4594[815032], 16408,
				 *(_DWORD*)(*(_DWORD*)(dword_5d4594_815012 + 32) + 28), 0);
	nox_window_call_field_94(*(int*)&byte_5D4594[815016], 16409,
				 *(_DWORD*)(*(_DWORD*)(dword_5d4594_815012 + 32) + 32), 0);
	nox_window_call_field_94(*(int*)&byte_5D4594[815020], 16409,
				 *(_DWORD*)(*(_DWORD*)(dword_5d4594_815012 + 32) + 32), 0);
	nox_window_call_field_94(*(int*)&byte_5D4594[815024], 16409,
				 *(_DWORD*)(*(_DWORD*)(dword_5d4594_815012 + 32) + 32), 0);
	nox_window_call_field_94(*(int*)&byte_5D4594[815028], 16409,
				 *(_DWORD*)(*(_DWORD*)(dword_5d4594_815012 + 32) + 32), 0);
	nox_window_call_field_94(*(int*)&byte_5D4594[815032], 16409,
				 *(_DWORD*)(*(_DWORD*)(dword_5d4594_815012 + 32) + 32), 0);
	nox_window_call_field_94(*(int*)&byte_5D4594[815016], 16410,
				 *(_DWORD*)(*(_DWORD*)(dword_5d4594_815012 + 32) + 36), 0);
	nox_window_call_field_94(*(int*)&byte_5D4594[815020], 16410,
				 *(_DWORD*)(*(_DWORD*)(dword_5d4594_815012 + 32) + 36), 0);
	nox_window_call_field_94(*(int*)&byte_5D4594[815024], 16410,
				 *(_DWORD*)(*(_DWORD*)(dword_5d4594_815012 + 32) + 36), 0);
	nox_window_call_field_94(*(int*)&byte_5D4594[815028], 16410,
				 *(_DWORD*)(*(_DWORD*)(dword_5d4594_815012 + 32) + 36), 0);
	return nox_window_call_field_94(*(int*)&byte_5D4594[815032], 16410,
					*(_DWORD*)(*(_DWORD*)(dword_5d4594_815012 + 32) + 36), 0);
}
...
int __cdecl sub_439D90(unsigned int a1, unsigned int a2) {
	...
	if (result) {
		...
		*(_WORD*)&byte_5D4594[814916] =
		    a1 + *(_WORD*)&byte_587000[8 * *(_DWORD*)&byte_587000[87412] + 87528] - 216;
					...
					if (*(_DWORD*)&byte_587000[87408] == 1) {
						if (sub_4899C0(v3)) {
							nox_swprintf((wchar_t*)&byte_5D4594[814756], L"%d",
								     *(_DWORD*)(v3 + 96));
							nox_window_call_field_94(*(int*)&byte_5D4594[815028], 16407,
										 (int)&byte_5D4594[814756], v5);
							if (sub_4A0560() == 6 || sub_4A0560() == 7) {
								sub_425920((_DWORD**)v3);
								v6 = sub_4A0030((const void*)v3);
								nox_window_call_field_94(*(int*)&dword_5d4594_815012,
											 16398, v5, 0);
								sub_43B2A0(v6);
								sub_43B7C0(v3);
							}
						} else {
							nox_window_call_field_94(*(int*)&dword_5d4594_815012, 16398, v5,
										 0);
							sub_4A0540((LPVOID)v3);
						}
					} else if (sub_4899C0(v3)) {
						if (*(_BYTE*)(v3 + 120)) {
							strncpy((char*)&byte_5D4594[814920], (const char*)(v3 + 120),
								0xFu);
							byte_5D4594[814935] = 0;
						} else {
							sub_43BC80(v3 + 12, *(_WORD*)(v3 + 109),
								   (char*)&byte_5D4594[814920]);
						}
						if (*(_DWORD*)(v3 + 96) == 9999)
							nox_swprintf((wchar_t*)&byte_5D4594[814628], L"%S -- ms",
								     &byte_5D4594[814920]);
						else
							nox_swprintf((wchar_t*)&byte_5D4594[814628], L"%S %dms",
								     &byte_5D4594[814920], *(_DWORD*)(v3 + 96));
						sub_46B000((wchar_t*)(*(_DWORD*)(v3 + 28) + 36),
