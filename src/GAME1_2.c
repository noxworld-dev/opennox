...
int __cdecl sub_42A150(__int16 a1, _DWORD* a2) {
	...
	v22 = (unsigned __int8*)nox_server_getWallAtPoint_410580(v17 + *(_DWORD*)&byte_5D4594[741360],
															 v4 + *(_DWORD*)&byte_5D4594[741368]);
	v21 = v22;
	if (v22) {
		if (v30 & 1) {
				...
				if (*(_DWORD*)&byte_5D4594[24 * v3 + 747900] == 1) {
					...
					*(_DWORD*)&byte_5D4594[747864] = v5 + 4;
					...
					if (result) {
						...
						qmemcpy(&byte_5D4594[*(_DWORD*)&byte_5D4594[747864] + 741692], &byte_5D4594[24 * v3 + 747896],
								result);
		...
		if (v4) {
			...
			*(_DWORD*)(*(_DWORD*)(dword_5d4594_787148 + 36 * *(unsigned __int16*)(a1 + 8) + 32) + 28) =
			...
			if (!dword_5d4594_787188) {
				...
				*(_DWORD*)(dword_5d4594_787148 + 36 * *(unsigned __int16*)(a1 + 8) + 28) = &byte_5D4594[787108];
				*(_DWORD*)(dword_5d4594_787148 + 36 * *(unsigned __int16*)(a1 + 8) + 32) =
			...
			*(_DWORD*)(dword_5d4594_787148 + 36 * *(unsigned __int16*)(a1 + 8)) =
				dword_5d4594_787200 + --dword_5d4594_787188 * *(_DWORD*)&byte_5D4594[787176];
			sub_42FE30(dword_5d4594_787148 + 36 * *(unsigned __int16*)(a1 + 8));
			*(_DWORD*)(dword_5d4594_787148 + 36 * *(unsigned __int16*)(a1 + 8) + 4) = *(_DWORD*)&byte_5D4594[2598000];
		}
		*(_DWORD*)(*(_DWORD*)&byte_5D4594[787140] + 28) = dword_5d4594_787148 + 36 * *(unsigned __int16*)(a1 + 8);
		*(_DWORD*)(dword_5d4594_787148 + 36 * *(unsigned __int16*)(a1 + 8) + 28) = &byte_5D4594[787108];
		*(_DWORD*)(dword_5d4594_787148 + 36 * *(unsigned __int16*)(a1 + 8) + 32) = *(_DWORD*)&byte_5D4594[787140];
		v2 = dword_5d4594_787148;
		*(_DWORD*)&byte_5D4594[787140] = dword_5d4594_787148 + 36 * *(unsigned __int16*)(a1 + 8);
		goto LABEL_19;
	}
...
char __cdecl sub_434A60(int a1) {
	return *(_BYTE*)(dword_5d4594_3804668 + (((unsigned __int8)(byte_5D4594[4 * a1 + 3803310] & 0xF8) >> 3) |
		...
		while (1) {
			*(_BYTE*)((char*)result + v3) =
				(unsigned __int16)(28 * ((((unsigned __int16)v3 & *(_WORD*)&byte_5D4594[3804372])
										  << byte_5D4594[3804384]) |
										 7) +
								   150 * (v0 | ((v3 & *(_DWORD*)&byte_5D4594[3804368]) >> byte_5D4594[3804380])) +
								   76 * (((v3 & *(_DWORD*)&byte_5D4594[3804364]) >> byte_5D4594[3804376]) | 7)) >>
				8;
			if ((int)++v3 > v1)
				break;
...
int sub_437100() {
	...
	if (*(_DWORD*)&byte_5D4594[811064] != dword_587000_80828 && !(*(_DWORD*)&nox_common_engineFlags & 0x40000)) {
		*(_DWORD*)&byte_5D4594[811064] = dword_587000_80828;
...
//----- (00437260) --------------------------------------------------------
int4* sub_437260() {
	return nox_client_copyRect_49F6F0(*(int*)&byte_5D4594[811068], *(int*)&dword_5d4594_811072,
...
int __cdecl sub_439D90(unsigned int a1, unsigned int a2) {
	...
	if (result) {
		...
		*(_WORD*)&byte_5D4594[814916] = a1 + *(_WORD*)&byte_587000[8 * dword_587000_87412 + 87528] - 216;
					...
					*(_DWORD*)(v3 + 96) = v4;
					...
					if (dword_587000_87408 == 1) {
						if (sub_4899C0(v3)) {
							...
							nox_window_call_field_94(*(int*)&dword_5d4594_815028, 16407, (int)&byte_5D4594[814756], v5);
						...
						if (*(_DWORD*)(v3 + 96) == 9999)
							...
							nox_swprintf((wchar_t*)&byte_5D4594[814628], L"%S %dms", &byte_5D4594[814920],
										 *(_DWORD*)(v3 + 96));
