...
int nox_server_mapRWMapInfo_42A6E0() {
	...
	if (vers >= 1) {
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x973CE0, 2976), 64);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x973CE0, 3040), 512);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x973CE0, 3552), 16);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x973CE0, 3568), 64);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x973CE0, 3632), 64);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x973CE0, 3696), 128);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x973CE0, 3824), 128);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x973CE0, 3952), 256);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x973CE0, 4208), 128);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x973CE0, 4336), 32);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x973CE0, 4368), 4);
		if (vers == 2) {
			nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x973CE0, 4372), 1u);
			nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x973CE0, 4373), 1u);
		} else if (*getMemU32Ptr(0x973CE0, 4440) == 1) {
			*getMemU8Ptr(0x973CE0, 4372) = 2;
			*getMemU8Ptr(0x973CE0, 4373) = 16;
		}
	}
	if (vers < 3) {
		*getMemU8Ptr(0x973CE0, 4374) = getMemByte(0x5D4594, 741376);
		*getMemU8Ptr(0x973CE0, 4406) = getMemByte(0x5D4594, 741380);
	} else {
		int v2 = strlen(getMemAt(0x973CE0, 4374));
		nox_xxx_fileReadWrite_426AC0_file3_fread(&v2, 1);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x973CE0, 4374), v2);
		*getMemU8Ptr(0x973CE0, 4374 + v2) = 0;

		v2 = strlen(getMemAt(0x973CE0, 4406));
		nox_xxx_fileReadWrite_426AC0_file3_fread(&v2, 1);
		nox_xxx_fileReadWrite_426AC0_file3_fread(getMemAt(0x973CE0, 4406), v2);
		*getMemU8Ptr(0x973CE0, 4406 + v2) = 0;
	}
	return 1;
}
...
int  nox_video_read_videobag(int is16bit) {
	...
	*getMemU32Ptr(0x973CE0, 8304) = getMemAt(0x5D4594, 754148);
...
char*  sub_430B80(_DWORD* a1) {
	*a1 = dword_5d4594_3804684;
	return (char*)getMemAt(0x973CE0, 6656);
}
...
int  nox_xxx_tileInitBuf_430DB0(int a1, int a2) {
	...
	v2 = ((46 * dword_5d4594_3798812) << getMemByte(0x973CE0, 8264)) * 46 * dword_5d4594_3798816;
	dword_5d4594_3798804 = (46 * dword_5d4594_3798812) << getMemByte(0x973CE0, 8264);
...
unsigned __int8  sub_434630(unsigned __int8 a1, unsigned __int8 a2, unsigned __int8 a3) {
	...
	LABEL_6:
		...
		*getMemU8Ptr(0x973CE0, 5664 + 4 * dword_5d4594_810628) = a1;
		v14 = getMemAt(0x973CE0, 5664 + 4 * v13);
		v14[1] = a2;
		v14[2] = a3;
		v14[3] = v18;
...
char  sub_4347C0(char a1) {
	...
	do {
		--v2;
		*getMemU8Ptr(0x973CE0, 4450) = a1;
		*getMemU8Ptr(0x973CE0, 4449) = a1;
		*getMemU8Ptr(0x973CE0, 4448) = a1;
		*getMemU8Ptr(0x973CE0, 4451) = 0;
	} while (v2);
	return result;
}
...
int  sub_434820(int a1, char a2, char a3, char a4) {
	if (a1 < 0 || a1 >= 256)
		return 0;
	*getMemU8Ptr(0x973CE0, 4448 + 4 * a1) = a2;
	*getMemU8Ptr(0x973CE0, 4449 + 4 * a1) = a3;
	*getMemU8Ptr(0x973CE0, 4450 + 4 * a1) = a4;
	*getMemU8Ptr(0x973CE0, 4451 + 4 * a1) = 4;
	sub_435040();
	sub_434F00();
...
int  sub_434870(int a1, _BYTE* a2, _BYTE* a3, _BYTE* a4) {
	if (a1 < 0 || a1 >= 256)
		return 0;
	if (a2)
		*a2 = getMemByte(0x973CE0, 4448 + 4 * a1);
	if (a3)
		*a3 = getMemByte(0x973CE0, 4449 + 4 * a1);
	if (a4)
		*a4 = getMemByte(0x973CE0, 4450 + 4 * a1);
	return 1;
}
...
int sub_434920() {
	...
	if (dword_5d4594_808564)
		return 0;
	result = 1;
	memcpy(getMemAt(0x5D4594, 808572), getMemAt(0x973CE0, 4448), 0x400u);
...
int sub_434950() {
	...
	memcpy(getMemAt(0x973CE0, 4448), getMemAt(0x5D4594, 808572), 0x400u);
	sub_435040();
	sub_434F00();
	return 1;
}
...
char  sub_434A60(int a1) {
	return *(_BYTE*)(dword_5d4594_3804668 + (((unsigned __int8)(getMemByte(0x973CE0, 4450 + 4 * a1) & 0xF8) >> 3) |
											 (4 * (getMemByte(0x973CE0, 4449 + 4 * a1) & 0xF8)) |
											 ((getMemByte(0x973CE0, 4448 + 4 * a1) & 0xF8) << 7)));
}
...
void  sub_435240(unsigned __int8 a1, _BYTE* a2, _BYTE* a3, char* a4) {
	...
	v4 = 4 * a1;
	*a2 = getMemByte(0x973CE0, 4448 + v4);
	*a3 = getMemByte(0x973CE0, 4449 + v4);
	result = getMemByte(0x973CE0, 4450 + v4);
	*a4 = result;
}
