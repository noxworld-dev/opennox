...
int __cdecl sub_4624D0(int a1) {
	...
	*(_DWORD*)(*v3 + 132) = 0;
	if (*(_DWORD*)&byte_5D4594[1062492] != v2) {
		if (sub_415880(*(char**)(v2 + 108)) & 0xC && *(_DWORD*)&byte_5D4594[1062480] &&
		...
		if (*(_DWORD*)&byte_5D4594[1062480] && **(_DWORD**)&byte_5D4594[1062480]) {
			...
			*(_DWORD*)(**(_DWORD**)&byte_5D4594[1062480] + 16) = v4 + v6 / 2;
			(*(void(__cdecl**)(unsigned __int8*, _DWORD))(**(_DWORD**)&byte_5D4594[1062480] + 300))(
			    &byte_5D4594[1049732], **(_DWORD**)&byte_5D4594[1062480]);
		}
		...
		*(_DWORD*)&byte_587000[136184] = v13 - 32;
		if (v13 - 32 <= -225) {
			...
			*(_DWORD*)&byte_5D4594[1062512] = *(_DWORD*)&byte_5D4594[1062516];
			...
			nox_window_call_field_94(*(int*)&byte_5D4594[1062508], 16394,
						 *(_DWORD*)(*(_DWORD*)(*(_DWORD*)&byte_5D4594[1062508] + 32) + 4) -
						     *(_DWORD*)&byte_5D4594[1062512],
						 0);
...
int __cdecl sub_4643B0(int a1, int a2) {
	...
	do {
		if (v5 > v2 - 50) {
			...
			nox_video_drawSetAlpha_434580(0x40u);
			...
			if (v10 != 0x80000000) {
				nox_video_drawSetColor_434460(v10);
		...
		LABEL_16:
			...
			if (*((_DWORD*)v4 - 2)) {
				...
				if (!**(_DWORD**)&byte_5D4594[1062480] || !(*(_DWORD*)(v12 + 112) & 0x1000000) ||
				    !(*(_BYTE*)(v12 + 116) & 0xC)) {
					goto LABEL_27;
				}
...
int __cdecl sub_464770(int a1, int a2, unsigned int a3) {
	...
	case 6:
		...
		if (*(_DWORD*)&byte_5D4594[1049856]) {
			...
			sub_4649B0(*(int*)&byte_5D4594[1049848], *(int*)&byte_5D4594[1049796],
				   *(int*)&byte_5D4594[1049800]);
			sub_461550((int)&byte_5D4594[148 * (*(_DWORD*)&byte_5D4594[1049800] +
							    14 * *(_DWORD*)&byte_5D4594[1049796] +
							    7 * *(_DWORD*)&byte_5D4594[1049796]) +
						     1050020]);
			*(_DWORD*)(*(_DWORD*)&byte_5D4594[1062480] + 136) = 1;
...
char __cdecl sub_4657E0(_DWORD* a1) {
	...
	if (v1) {
		LOBYTE(v1) = byte_5D4594[148 * ((a1[1] + *(_DWORD*)&byte_5D4594[1062512] - 13) / 50 +
						14 * ((*a1 - 314) / 50) + 7 * ((*a1 - 314) / 50)) +
					 1050160];
		if ((_BYTE)v1)
			LOBYTE(v1) =
			    sub_465870(*(_DWORD*)&byte_5D4594
					   [148 * ((a1[1] + *(_DWORD*)&byte_5D4594[1062512] - 13) / 50 +
						   14 * ((*a1 - 314) / 50) + 7 * ((*a1 - 314) / 50)) +
					    1050020 +
					    4 * byte_5D4594[148 * ((a1[1] + *(_DWORD*)&byte_5D4594[1062512] - 13) / 50 +
								   14 * ((*a1 - 314) / 50) + 7 * ((*a1 - 314) / 50)) +
							    1050160]]);
	}
	return v1;
			...
			*(_DWORD*)&byte_5D4594[1049856] = 0;
			if (sub_4281F0(a2, (int4*)&byte_587000[136368])) {
				...
				*(_DWORD*)&byte_5D4594[1049800] =
				    (a2->field_4 + *(int*)&byte_5D4594[1062512] - 13) / 50;
...
int __cdecl sub_466950(int a1) {
	...
	*(_DWORD*)(*(_DWORD*)(*(_DWORD*)&byte_5D4594[1062508] + 400) + 12) = 16;
	...
	sub_4B5700(*(int*)&byte_5D4594[1062508], 0, 0, *(int*)&byte_5D4594[1049956], *(int*)&byte_5D4594[1049960],
...
//----- (004675B0) --------------------------------------------------------
int sub_4675B0() { return *(_DWORD*)&byte_5D4594[1049864]; }
...
int sub_467980() {
	...
	*(_DWORD*)&byte_5D4594[1062512] = 0;
	...
	nox_window_call_field_94(
	    *(int*)&byte_5D4594[1062508], 16394,
	    *(_DWORD*)(*(_DWORD*)(*(_DWORD*)&byte_5D4594[1062508] + 32) + 4) - *(_DWORD*)&byte_5D4594[1062512], 0);
	sub_46AE60(*(int*)&byte_5D4594[1062528], 0);
	sub_46AEC0(*(int*)&byte_5D4594[1062528], *(int*)&byte_5D4594[1049976]);
	sub_46B080(*(_DWORD**)&byte_5D4594[1062528], 9105);
	byte_5D4594[1049870] = 0;
		...
		*(_DWORD*)&byte_5D4594[1062516] = 0;
		...
		if (*(_DWORD*)&byte_5D4594[1062508])
			result = nox_window_call_field_94(
			    *(int*)&byte_5D4594[1062508], 16394,
			    *(_DWORD*)(*(_DWORD*)(*(_DWORD*)&byte_5D4594[1062508] + 32) + 4), 0);
	}
	return result;
}
			...
			if (v17 + v12 >= 0) {
				...
				LABEL_41:
					...
					*(_DWORD*)(*(_DWORD*)&byte_5D4594[1064916] + 20) += v12;
					...
					v21[6] = v21[2] + v21[4];
					*(_DWORD*)(*(_DWORD*)&byte_5D4594[1064916] + 28) =
...
//----- (0046C720) --------------------------------------------------------
int sub_46C720() { return *(_DWORD*)&byte_5D4594[1064916]; }
...
//----- (004706A0) --------------------------------------------------------
BOOL sub_4706A0() { return *(_DWORD*)&byte_5D4594[1090048] && *(_DWORD*)&byte_5D4594[1090120]; }
...
int __cdecl sub_470770(int a1, int a2) {
	...
	*(_DWORD*)&byte_5D4594[1090252] = (*(_DWORD*)&byte_5D4594[1090252] + 1) % 3u;
	...
	sub_43F6E0(*(int*)&byte_5D4594[1090140], (__int16*)&byte_5D4594[1090144], xLeft + (*(int*)(v1 + 8) - a1) / 2,
		   yTop + 22);
	nox_video_drawSetColor_434460(*(int*)&byte_5D4594[2614248]);
...
int __cdecl sub_471250(_DWORD* a1) {
	...
	if (*((int*)v1 + 2) >= 1) {
		...
		nox_video_drawSetColor_434460(*((_DWORD*)v1 + 3));
		nox_video_drawEnableAlpha_434560(1);
...
int __cdecl sub_471C00(int a1) {
	...
	nox_video_drawSetColor_434460(*((_DWORD*)v2 + 3));
...
int __cdecl sub_472600(int a1, int a2) {
	...
	nox_video_drawEnableAlpha_434560(1);
	nox_video_drawSetColor_434460(*(int*)&byte_5D4594[2650656]);
	nox_video_drawSetAlpha_434580(0x5Au);
	sub_473510(-1, yTop - 1, v3 + 2, v3 + 2);
	nox_video_drawSetAlpha_434580(0x3Cu);
	sub_473510(-2, yTop - 2, v3 + 4, v3 + 4);
	nox_video_drawSetAlpha_434580(0x28u);
	...
	for (i = v9 / 23; i <= v78; ++i) {
		...
		while (v11) {
			...
			if (*(_BYTE*)(v11 + 4) & 0x10) {
				...
				while (1) {
					v17 = sub_410580(*((_DWORD*)v16 - 1) + *(unsigned __int8*)(v11 + 5),
							 *(_DWORD*)v16 + *(unsigned __int8*)(v11 + 6));
					if (v17) {
						if (*(_DWORD*)(v17 + 12))
							goto LABEL_28;
					} else {
						v18 = sub_410580(*((_DWORD*)v16 - 1) + *(unsigned __int8*)(v11 + 5),
								 *(unsigned __int8*)(v11 + 6));
						if (v18 && *(_DWORD*)(v18 + 12) ||
						    (v19 = sub_410580(*(unsigned __int8*)(v11 + 5),
								      *(_DWORD*)v16 + *(unsigned __int8*)(v11 + 6))) !=
							    0 &&
							*(_DWORD*)(v19 + 12)) {
						LABEL_28:
	...
	for (k = sub_459EB0(); k; k = sub_459EC0(k)) {
		...
		nox_video_drawSetColor_434460(v43);
		v44 = *(_DWORD*)(k + 108);
			...
			LABEL_64:
				...
				if (v46) {
					...
					if (v47) {
						...
						nox_video_drawSetColor_434460(*v48);
					}
				}
				sub_473420(&xLeft);
			} else {
		...
		if (v44 == *(int*)&byte_5D4594[1096308]) {
			...
			if (v49 && sub_419130((int)v49)) {
				...
				if (v51) {
					...
					nox_video_drawSetColor_434460(*v52);
				}
			} else {
				nox_video_drawSetColor_434460(*(int*)&byte_5D4594[2523948]);
			}
				...
				if (v81) {
					...
					if (v57) {
						...
						LABEL_88:
							...
							nox_video_drawSetColor_434460(*v58);
						}
					}
				LABEL_89:
					sub_4733B0(&xLeft);
		...
		LABEL_103:
			...
			if ((!v63 || BYTE2(v63->field_0[32]) == a2) && v75 && (v75[3680] & 1) != 1) {
				...
				if (l == *(_DWORD*)&byte_5D4594[2614252] || v76.field_0)
					nox_video_drawSetColor_434460(v79);
				else
					nox_video_drawSetColor_434460(*(int*)&byte_5D4594[2650644]);
				if (v77) {
					if (v81) {
						...
						if (v65) {
							...
							nox_video_drawSetColor_434460(*v66);
						}
					}
					sub_473420(&xLeft);
				} else {
...
int __cdecl sub_473380(int a1, int a2, int a3, int a4, int a5) {
	nox_video_drawSetColor_434460(a5);
	sub_49F500(a1, a2);
	sub_49F500(a3, a4);
	return sub_49E4B0();
}
...
//----- (004734F0) --------------------------------------------------------
int __cdecl sub_4734F0(int* a1) { return nox_video_drawCircle_4B0B90(*a1, a1[1], 3); }
...
int4* __cdecl sub_475810_draw(int* a1) {
	...
	*(_DWORD*)&byte_5D4594[1096516] = 0;
	...
	sub_475FE0(v1);
	nox_client_drawCursorSelectCircle_4773C0(v1);
