...
int* __cdecl sub_461970(int a1, int a2) {
	...
	if (!(nox_get_thing(a2)->pri_class & 0x4000000)) {
		v2 = getMemIntPtr(0x5D4594, 1050020);
		while (1) {
			v3 = 0;
			result = v2;
			do {
			...
			v2 += 37;
			if ((int)v2 < (int)getMemAt(0x5D4594, 1050020 + 2960))
				continue;
			break;
		}
	}
...
char* sub_4619F0() {
	...
	v0 = (char*)getMemAt(0x5D4594, 1050020 + 140);
	do {
		result = v0;
		v2 = 4;
		do {
		...
		v0 += 148;
	} while ((int)v0 <= (int)getMemAt(0x5D4594, 1050020 + 3100));
	return result;
}
...
unsigned __int8* sub_461B50() {
	...
	v0 = 0;
	result = getMemAt(0x5D4594, 1050020 + 136);
	v25 = 0;
	v26 = getMemIntPtr(0x5D4594, 1050020 + 136);
LABEL_2:
	v2 = 0;
	v24 = 0;
	v21 = (int*)(result - 136);
	...
	LABEL_35:
		...
		if (v2 >= 4) {
			...
			v25 = ++v0;
			v26 = (int*)result;
			if ((int)result >= (int)getMemAt(0x5D4594, 1050020 + 3096))
				return result;
			goto LABEL_2;
		}
	}
	...
	LABEL_5:
		...
		result = getMemAt(0x5D4594, 1050020 + 140 + 148 * (v3 + 14 * v4 + 7 * v4));
		while (!*result) {
			++v4;
			result += 3108;
			v22 = v4;
		...
		v5 = 7 * v4 + v3 + 14 * v4;
		v6 = 148 * v5;
		v7 = *getMemU32Ptr(0x5D4594, 1050020 + 148 * v5);
		v8 = getMemAt(0x5D4594, 1050020 + 148 * v5);
		v29 = getMemAt(0x5D4594, 1050020 + 148 * v5);
		v30 = *(_DWORD*)(v7 + 108);
		if (!(*(_DWORD*)(v7 + 112) & 0x4000000)) {
			v9 = getMemAt(0x5D4594, 1050020 + 140);
			v23 = 0;
			v28 = getMemAt(0x5D4594, 1050020 + 140);
			while (1) {
				v10 = 0;
				...
				v12 = getMemByte(0x5D4594, 1050020 + 140 + 148 * v11);
				for (i = getMemByte(0x5D4594, 1050020 + 140 + v6); i > 0; v6 = 148 * v5) {
					if (v12 == 32)
						break;
					--i;
					v14 = v12++ + v11;
					*getMemU32Ptr(0x5D4594, 1050020 + 4 + 4 * (v14 + 36 * v11)) =
						*getMemU32Ptr(0x5D4594, 1050020 + 4 + 4 * (i + v5 + 36 * v5));
					v4 = v22;
				}
				*getMemU8Ptr(0x5D4594, 1050020 + 140 + 148 * v11) = v12;
				if (i <= 0) {
					*getMemU8Ptr(0x5D4594, 1050020 + 140 + v6) = 0;
				...
				*getMemU8Ptr(0x5D4594, 1050020 + 140 + v6) = i;
			LABEL_28:
				v9 = v28 + 148;
				v15 = (int)(v28 + 148) < (int)getMemAt(0x5D4594, 1050020 + 3100);
				++v23;
				v28 += 148;
				if (v15)
					continue;
		...
		*getMemU8Ptr(0x5D4594, 1050020 + 140 + v6) = 0;
		*(_DWORD*)v8 = 0;
		*getMemU32Ptr(0x5D4594, 1050020 + 132 + v6) = 0;
		v0 = v25;
		goto LABEL_35;
	}
LABEL_38:
	for (j = v0; j < 20; ++j) {
		if (j == v0)
			...
			v17 = 0;
		v18 = 4 - v17;
		result = getMemAt(0x5D4594, 1050020 + 136 + 148 * (j + 14 * v17 + 7 * v17));
		do {
			*((_DWORD*)result - 1) = 0;
			*(_DWORD*)result = 0;
			result += 3108;
...
char* __cdecl sub_461EF0(int a1) {
	...
	v8 = 0;
	v1 = getMemAt(0x5D4594, 1050020 + 140);
	while (1) {
		v2 = 0;
		v3 = v1;
		do {
			...
			if (v5 > 0) {
				...
				*getMemU32Ptr(0x5D4594, 1049788) = getMemAt(0x5D4594, 1050020 + 148 * (v8 + 14 * v2 + 7 * v2));
				return result;
			}
		LABEL_7:
			++v2;
		...
		v1 += 148;
		++v8;
		if ((int)v1 <= (int)getMemAt(0x5D4594, 1050020 + 3100))
			continue;
		return 0;
	}
}
...
int __cdecl sub_463430(int a1) {
	...
	if (nox_common_gameFlags_check_40A5C0(4096) && dword_5d4594_1050008) {
		...
		sub_434390(*getMemIntPtr(0x5D4594, 2614244));
...
int __cdecl sub_4643B0(int a1, int a2) {
	...
	v3 = a1 + 60;
	v4 = getMemAt(0x5D4594, 1050020 + 140);
	v27 = a1 + 60;
	v5 = a2 - dword_5d4594_1062512;
	v20 = 0;
	v23 = getMemAt(0x5D4594, 1050020 + 140);
	do {
		if (v5 > v2 - 50) {
			v6 = v3;
	...
	LABEL_45:
		...
		++v20;
		v23 = v4;
	} while ((int)v4 < (int)getMemAt(0x5D4594, 1050020 + 3100));
	return result;
}
		...
		if (dword_5d4594_1049856) {
			if (*(_DWORD*)(*getMemU32Ptr(0x5D4594, 1049848) + 112) & 0x1001000) {
				if (dword_5d4594_1062480) {
				   ...
				   *getMemU32Ptr(0x5D4594, 1050020 + 132 + 148 * (dword_5d4594_1049800 + 14 * dword_5d4594_1049796 + 7 * dword_5d4594_1049796))) {
			...
			if (sub_415880(*(char**)(*getMemU32Ptr(0x5D4594, 1049848) + 108)) == 2) {
				...
				v6 = sub_461600(v5);
				if (!v4 && !v6) {
					sub_4649B0(*getMemIntPtr(0x5D4594, 1049848), *(int*)&dword_5d4594_1049796,
			...
			sub_4649B0(*getMemIntPtr(0x5D4594, 1049848), *(int*)&dword_5d4594_1049796, *(int*)&dword_5d4594_1049800);
			sub_461550(
				(int)getMemAt(0x5D4594, 1050020 + 148 * (dword_5d4594_1049800 + 14 * dword_5d4594_1049796 + 7 * dword_5d4594_1049796)));
			*(_DWORD*)(dword_5d4594_1062480 + 136) = 1;
		}
	LABEL_22:
		sub_4776A0();
...
char __cdecl sub_4657E0(_DWORD* a1) {
	...
	if (v1) {
		LOBYTE(v1) = getMemByte(0x5D4594, 1050020 + 140 + 148 * ((a1[1] + dword_5d4594_1062512 - 13) / 50 + 14 * ((*a1 - 314) / 50) + 7 * ((*a1 - 314) / 50)));
		if ((_BYTE)v1)
			LOBYTE(v1) = sub_465870(
				*getMemU32Ptr(0x5D4594, 1050020 + 148 * ((a1[1] + dword_5d4594_1062512 - 13) / 50 + 14 * ((*a1 - 314) / 50) + 7 * ((*a1 - 314) / 50)) + 4 * getMemByte(0x5D4594, 1050020 + 140 + 148 * ((a1[1] + dword_5d4594_1062512 - 13) / 50 + 14 * ((*a1 - 314) / 50) + 7 * ((*a1 - 314) / 50)))));
	}
	return v1;
}
...
int __cdecl sub_465BE0(int2* a1) {
	...
	if (*getMemU32Ptr(0x5D4594, 1049848)) {
		v3[0] = 114;
		*(_WORD*)&v3[1] = sub_578B00(*getMemIntPtr(0x5D4594, 1049848));
		v2 = a1->field_4;
...
BOOL __cdecl sub_465C30(int a1, int a2) {
	...
	sub_465A30();
	sub_4623B0(*getMemIntPtr(0x5D4594, 1049848));
...
int sub_465E00() {
	...
	*getMemU32Ptr(0x5D4594, 1050020 + 2960) = nox_new_drawable_for_thing(*(int*)&dword_5d4594_1062560);
	if (*getMemU32Ptr(0x5D4594, 1050020 + 2960))
		*getMemU8Ptr(0x5D4594, 1050020 + 3100) = 1;
	v6 = dword_5d4594_1062564;
	if (!dword_5d4594_1062564) {
		v6 = sub_44CFC0((CHAR*)getMemAt(0x587000, 139508));
		dword_5d4594_1062564 = v6;
	}
	*getMemU32Ptr(0x5D4594, 1050020 + 6068) = nox_new_drawable_for_thing(v6);
	if (*getMemU32Ptr(0x5D4594, 1050020 + 6068))
		*getMemU8Ptr(0x5D4594, 1050020 + 6208) = 1;
	v7 = dword_5d4594_1062556;
	if (!dword_5d4594_1062556) {
		v7 = sub_44CFC0((CHAR*)getMemAt(0x587000, 139520));
		dword_5d4594_1062556 = v7;
	}
	*getMemU32Ptr(0x5D4594, 1050020 + 9176) = nox_new_drawable_for_thing(v7);
	if (*getMemU32Ptr(0x5D4594, 1050020 + 9176))
		*getMemU8Ptr(0x5D4594, 1050020 + 9316) = 1;
	...
	if (a2 == 16391) {
		...
		case 9105:
			...
			*getMemU8Ptr(0x5D4594, 1049869) = 1;
			...
			nox_window_call_field_94(*(int*)&dword_5d4594_1062508, 16394,
									 *(_DWORD*)(*(_DWORD*)(dword_5d4594_1062508 + 32) + 4) - dword_5d4594_1062512, 0);
			sub_46AE60(*(int*)&dword_5d4594_1062528, *getMemIntPtr(0x5D4594, 1049980));
	...
	while (1) {
		...
		do {
			if (v4[140] && *(_DWORD*)(*(_DWORD*)v4 + 108) == a1)
				return (char*)getMemAt(0x5D4594, 1050020 + 148 * (v1 + 14 * v3 + 7 * v3));
			++v3;
			v4 += 3108;
		} while (v3 < 4);
		v2 += 148;
...
int __cdecl sub_467810(int a1, int a2) {
	...
	if (a1 < 0 || a2 < 0 || a1 >= 4 || a2 >= 20)
		...
		result = getMemByte(0x5D4594, 1050020 + 140 + 148 * (a2 + 14 * a1 + 7 * a1));
	return result;
}
...
char* __cdecl sub_467870(int a1, int a2) {
	...
	if (a1 < 0 || a2 < 0 || a1 >= 4 || a2 >= 20)
		...
		result = (char*)getMemAt(0x5D4594, 1050020 + 4 + 148 * (a2 + 14 * a1 + 7 * a1));
	return result;
}
...
int sub_467980() {
	...
	do {
		...
		v0 += 148;
	} while ((int)v0 <= (int)getMemAt(0x5D4594, 1050020 + 2960));
	sub_462740();
	dword_5d4594_1049864 = 0;
	sub_461550(0);
...
int __cdecl sub_467B00(int a1, int a2) {
	...
	do {
		...
		++v2;
		v9 += 148;
	} while ((int)v9 < (int)getMemAt(0x5D4594, 1050020 + 2960));
	return v8;
}
...
char* __cdecl sub_469920(_DWORD* a1) {
	...
	v16 = *getMemU32Ptr(0x5D4594, v6 + 2618924) +
		  v5 * (*getMemIntPtr(0x5D4594, v6 + 2619464) - *getMemIntPtr(0x5D4594, v6 + 2618924)) / 23;
	v17 = *getMemU32Ptr(0x5D4594, v6 + 2618928) +
		  v5 * (*getMemIntPtr(0x5D4594, v6 + 2619468) - *getMemIntPtr(0x5D4594, v6 + 2618928)) / 23;
	v18 = *getMemU32Ptr(0x5D4594, v6 + 2618932) +
		  v5 * (*getMemIntPtr(0x5D4594, v6 + 2619472) - *getMemIntPtr(0x5D4594, v6 + 2618932)) / 23;
	v10 = *getMemU32Ptr(0x5D4594, v6 + 2618936);
	v11 = v5 * (*getMemU32Ptr(0x5D4594, v6 + 2619476) - v10);
	v12 = v2 % 23 *
		  (*getMemU32Ptr(0x5D4594, v6 + 2618940) +
		   v5 * (*getMemIntPtr(0x5D4594, v6 + 2619480) - *getMemIntPtr(0x5D4594, v6 + 2618940)) / 23 - v17);
	v13 = v7 * (*getMemU32Ptr(0x5D4594, v6 + 2618944) +
				v5 * (*getMemIntPtr(0x5D4594, v6 + 2619484) - *getMemIntPtr(0x5D4594, v6 + 2618944)) / 23 - v18);
...
size_t __cdecl sub_46A4B0(wchar_t* a1, int a2) {
	...
	v2 = sub_45A6F0(*getMemIntPtr(0x5D4594, 2616328));
	v3 = nox_wcsspn(a1, L" ");
...
_DWORD* sub_46A730() {
	...
	*getMemU32Ptr(0x5D4594, 1064880) = 2 * nox_win_height / 3;
	...
	if (result) {
		nox_wnd_sub_46A9B0(result, *getMemIntPtr(0x5D4594, 1064876), *getMemIntPtr(0x5D4594, 1064880));
...
int __cdecl sub_46A820(int a1, int a2, int a3, int a4) {
	if (a2 == 16415) {
		if (*(_WORD*)(dword_5d4594_1064864 + 1052))
			sub_46A4B0(*(wchar_t**)&dword_5d4594_1064864, *getMemIntPtr(0x5D4594, 1064872));
		sub_46A6A0();
	}
	return 0;
}
	...
	*getMemU32Ptr(0x5D4594, 1090252) = (*getMemU32Ptr(0x5D4594, 1090252) + 1) % 3u;
	...
	if (dword_5d4594_2614264 / 0xFAu) {
		if (dword_5d4594_2614264 / 0xFAu == 1)
			...
			sub_434390(*getMemIntPtr(0x5D4594, 2650644));
	} else {
	...
	sub_43F6E0(*(int*)&dword_5d4594_1090140, getMemI16Ptr(0x5D4594, 1090144), xLeft + (*(int*)(v1 + 8) - a1) / 2,
			   yTop + 22);
	nox_client_drawSetColor_434460(*getMemIntPtr(0x5D4594, 2614248));
...
int __cdecl sub_470AA0(int a1) {
	...
	if (*getMemU32Ptr(0x5D4594, 1093176)) {
		if (a1) {
			nox_window_set_hidden(*getMemIntPtr(0x5D4594, 1093076), 0);
			result = nox_window_set_hidden(*getMemIntPtr(0x5D4594, 1093096), 0);
		} else {
			nox_window_set_hidden(*getMemIntPtr(0x5D4594, 1093076), 1);
			result = nox_window_set_hidden(*getMemIntPtr(0x5D4594, 1093096), 1);
		}
	}
	return result;
}
...
int sub_470DE0() {
	...
	if (*getMemU32Ptr(0x5D4594, 2616328)) {
		...
		if (*getMemIntPtr(0x5D4594, 1093040) >= 1) {
...
int sub_472080() {
	...
	result = *getMemIntPtr(0x5D4594, 1093120);
	if (*getMemIntPtr(0x5D4594, 1093120) != *getMemIntPtr(0x5D4594, 1093124)) {
		result = sub_416120(0x11u);
		if (result) {
			result = 0x64u / *getMemIntPtr(0x5D4594, 2649704);
			*getMemIntPtr(0x5D4594, 1093120) += 0x64u / *getMemIntPtr(0x5D4594, 2649704);
		}
	}
	return result;
}
...
int __cdecl sub_472100(int a1, int a2) {
	...
	case 7:
		...
		nox_window_set_hidden(*getMemIntPtr(0x5D4594, 1093076), v3);
		if (getMemByte(0x5D4594, 2661958))
			nox_window_set_hidden(*getMemIntPtr(0x5D4594, 1093096), dword_5d4594_1096252 == 0);
		sub_452D80(901, 100);
		goto LABEL_6;
	case 8:
	case 12:
...
void sub_472220() {
	if (!sub_477600()) {
		if (*getMemU32Ptr(0x5D4594, 1090308))
			sub_4674E0(*getMemIntPtr(0x5D4594, 1090308));
	}
}
...
void sub_472240() {
	if (!sub_477600()) {
		if (*getMemU32Ptr(0x5D4594, 1090844))
			sub_4674E0(*getMemIntPtr(0x5D4594, 1090844));
	}
}
...
void sub_472260() {
	if (!sub_477600()) {
		if (*getMemU32Ptr(0x5D4594, 1091380))
			sub_4674E0(*getMemIntPtr(0x5D4594, 1091380));
	}
}
...
unsigned __int8* sub_472310() {
	...
	*getMemU16Ptr(0x5D4594, 1090312) = sub_467850(*getMemIntPtr(0x5D4594, 1096268));
	if (*getMemU16Ptr(0x5D4594, 1090312)) {
		result = (unsigned __int8*)nox_get_thing(*getMemIntPtr(0x5D4594, 1096268));
		if (result) {
...
int __cdecl sub_472540(int a1) {
	...
	v2 = sub_421790(&a1a, *getMemIntPtr(0x5D4594, 1096312));
	if (v2)
...
int4* __cdecl sub_4725C0(int a1) {
	...
	result = (int4*)sub_4356C0(*getMemIntPtr(0x5D4594, 2614252), 2);
	if (!result) {
		sub_437260();
		*getMemU32Ptr(0x5D4594, 1096316) = sub_472540(a1);
		sub_472600(a1, *getMemIntPtr(0x5D4594, 1096316));
		result = sub_437290();
	}
	return result;
}
...
int __cdecl sub_472600(int a1, int a2) {
					...
					if (v17) {
						...
						LABEL_28:
							if (v69 < 4) {
								...
								v23 = 100 * *getMemIntPtr(0x587000, v21 + 196184) / v20;
								v24 = 100 * *getMemIntPtr(0x587000, v21 + 196188) / v20;
								nox_client_drawSetColor_434460(*getMemIntPtr(0x5D4594, 2650644));
	...
	v39 = sub_418C80(*getMemIntPtr(0x5D4594, 2616328));
	v70 = (int)v39;
	...
	for (k = sub_459EB0(); k; k = sub_459EC0(k)) {
		...
		if (v53 & 0x10000000) {
			...
			if (!nox_common_gameFlags_check_40A5C0(32)) {
				if (k == *getMemIntPtr(0x5D4594, 2614252))
...
int __cdecl sub_4730D0(int2* a1, unsigned __int8 a2, int a3) {
	...
	if (dword_587000_149232 <= 2000) {
		...
		case 0u:
			result =
				sub_473380(a1->field_0, a3 + a1->field_4, a1->field_0 + a3, a1->field_4, *getMemIntPtr(0x5D4594, 2650660));
			break;
		case 1u:
			result =
				sub_473380(a1->field_0, a1->field_4, a1->field_0 + a3, a1->field_4 + a3, *getMemIntPtr(0x5D4594, 2650660));
			break;
		case 2u:
			sub_473380(a1->field_0, a3 + a1->field_4, a1->field_0 + a3, a1->field_4, *getMemIntPtr(0x5D4594, 2650660));
			...
			break;
		case 3u:
			sub_473380(a1->field_0, a1->field_4, a1->field_0 + v5, a1->field_4 + v5, *getMemIntPtr(0x5D4594, 2650660));
...
int sub_4738E0() {
	...
	if (dword_5d4594_1556112 != 1) {
		if (getMemByte(0x5D4594, 1096424) & 1) {
			v1 = sub_45A6F0(*getMemIntPtr(0x5D4594, 2616328));
			sub_4725C0((int)v1);
		}
		result = sub_445530();
	}
...
int __cdecl sub_474BE0(_DWORD* a1, int* a2, int a3, int a4, int a5, int a6, int a7, int a8) {
	...
	LABEL_7:
		...
		if (!a5)
			v32 = 1.0;
		v25 = (double)(2 * *getMemIntPtr(0x587000, 8 * v9 + 192088)) * v32 + (double)*v8;
		v10 = nox_float2int(v25);
		v11 = *getMemIntPtr(0x587000, 8 * v9 + 192092);
		v30.field_0 = v10;
		v26 = (double)(2 * v11) * v32 + (double)v8[1];
		v30.field_4 = nox_float2int(v26);
		v12 = v9 - 6 + (v9 - 6 < 0 ? 0x100 : 0);
		v27 = (double)(2 * *getMemIntPtr(0x587000, 8 * v12 + 192088)) * v32 + (double)*v8;
		v13 = nox_float2int(v27);
		v14 = *getMemIntPtr(0x587000, 8 * v12 + 192092);
		v31.field_0 = v13;
...
void __cdecl sub_475560_draw(nox_drawable* dr, int a2) {
	...
	if (sub_475740_drawable(dr)) {
		...
		if ((dr->field_120 || dr->field_122) &&
			(unsigned int)(*getMemU32Ptr(0x5D4594, 2598000) - dr->field_85) > *getMemIntPtr(0x5D4594, 2649704)) {
			dr->field_120 = 0;
