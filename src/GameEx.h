...
// void  __security_check_cookie(char a1);
...
// errno_t  memcpy_s(void *Dst, rsize_t DstSize, const void *Src, rsize_t MaxCount);
// errno_t  memmove_s(void *Dst, rsize_t DstSize, const void *Src, rsize_t MaxCount);
// void  operator delete[](void *); idb
...
// void * operator new(size_t); idb
// void * operator new[](unsigned int); idb
// int  InitPointers_1(int a1);
...
// int  _onexit_nolock(int a1);
// _onexit_t  _onexit(_onexit_t);
// int  atexit(void ( *)());
// char * strstr(const char *, const char *);
// void  __noreturn _endthreadex(DWORD dwExitCode); idb
...
// *this, struct localeinfo_struct *a2); int  _mbstowcs_l_helper(LPWSTR lpWideCharStr, LPCSTR lpMultiByteStr, int
// cchWideChar, struct localeinfo_struct *); idb size_t  mbstowcs(wchar_t *, const char *, size_t); signed int
...
// errno_t  strcpy_s(char *Dst, rsize_t SizeInBytes, const char *Src);
// int  V6_HeapAlloc(unsigned int a1);
// void * malloc(size_t);
// size_t  strlen(const char *);
// void  free(void *);
// void * memset(void *, int, size_t);
// void * memcpy(void *, const void *, size_t);
// signed int  _get_errno_from_oserr(int a1);
// int * _errno();
// unsigned int * __doserrno();
// int * _dosmaperr(unsigned int a1);
// void * memcpy_0(void *, const void *, size_t);
// void  type_info::_Type_info_dtor(struct type_info *); idb
// int  strcmp(const char *, const char *);
// int  InitPointers(int a1);
// BOOL  _callnewh(int a1);
// void __stdcall __noreturn _CxxThrowException(int a1, _BYTE *a2);
// void InternalStateChanger();
// int  _encode_pointer(int a1);
// int _encoded_null(void); weak
// int  _decode_pointer(int a1);
...
// int  _initptd(int a1, int a2);
// DWORD *_getptd_noexit();
// DWORD *_getptd();
// void __stdcall _freefls(void *a1);
// DWORD  _freeptd(void *a1);
// signed int _mtinit();
// void * _malloc_crt(size_t a1);
// int  _calloc_crt(size_t a1, int a2);
// void * _realloc_crt(void *a1, size_t a2);
// size_t  _msize(void *);
// HMODULE  _crt_waiting_on_module_handle(LPCWSTR lpModuleName);
// int  _amsg_exit(int a1);
// HMODULE  __crtCorExitProcess(int a1);
// void  __noreturn __crtExitProcess(UINT uExitCode); idb
// int _lockexit(void); weak
// int _unlockexit();
// int (*__usercall _initterm(int (*result)(void), unsigned int a2))(void);
// int  _initterm_e(int (**a1)(void), unsigned int a2);
// int  _cinit(int a1);
// int (* doexit(UINT uExitCode, int a2, int a3))(void);
// void  __noreturn _exit(int);
// void  _cexit();
// void ( __noreturn *_init_pointers())(UINT uExitCode);
// void  _SEH_prolog4(int a1, int a2);
// int  SEH_10006CE0(int, PVOID TargetFrame, int); idb
// char * strchr(const char *, int);
// BOOL  _ValidateImageBase(int a1);
// int  _FindPESection(int a1, unsigned int a2);
// BOOL  _IsNonwritableInCurrentImage(int a1);
// int  nullsub_1(_DWORD); weak
// DWORD * _XcptFilter(int a1, DWORD a2);
// DWORD * __CppXcptFilter(int a1, DWORD a2);
...
// signed int  _setmbcp_nolock(int a1, _DWORD *a2);
// int  _setmbcp(int);
// int __initmbctable();
// void  __freetlocinfo(void *a1);
// LONG  __addlocaleref(volatile LONG *lpAddend);
// volatile LONG * __removelocaleref(volatile LONG *lpAddend);
...
// int (*CrtInit())(void);
// void  cLibInit(); idb
// HANDLE  _heap_init(int a1);
// BOOL _heap_term();
// DWORD __security_init_cookie();
// signed int _mtinitlocks();
// void _mtdeletelocks();
// void  _unlock(int a1);
// signed int  _mtinitlocknum(int a1);
// void  _lock(int a1);
// char * __sbh_find_block(int a1);
// _DWORD * __sbh_free_block(_DWORD *a1, int a2);
// _DWORD  __sbh_alloc_block(_DWORD); weak
// _DWORD  _NMSG_WRITE(_DWORD); weak
// int _FF_MSGBANNER(void); weak
// void * _VEC_memzero(void *arg0, int arg4, size_t arg8);
// int _get_sse2_info(void); weak
// int sse2StatusSetup();
// void * _VEC_memcpy(void *arg0, const void *arg4, size_t arg8);
...
// int  _calloc_impl(size_t, int, int); idb
// void * realloc(void *, size_t);
// int _initp_misc_cfltcvt_tab(void); weak
// void  __noreturn terminate(); idb
// int  _initp_eh_hooks(_DWORD); weak
// _DWORD  _initp_misc_winsig(_DWORD); weak
// int PointerDecoder();
// int  InitPointers_3(int a1);
// int  InitPointers_2(int a1);
// int  InitPointers_0(int a1);
// int  __crtInitCritSecAndSpinCount(LPCRITICAL_SECTION lpCriticalSection, DWORD dwSpinCount); idb
// int  __crtLCMapStringA(struct localeinfo_struct *, LCID Locale, DWORD dwMapFlags, LPCSTR lpMultiByteStr, char
// *cbMultiByte, LPWSTR lpDestStr, char *cchDest, UINT CodePage, int); idb int  __crtGetStringTypeA(struct
// localeinfo_struct *, DWORD dwInfoType, LPCSTR lpMultiByteStr, char *cbMultiByte, LPWORD lpCharType, UINT CodePage,
// LCID Locale, int); idb _DWORD  __free_lc_time(_DWORD); weak _DWORD  __free_lconv_num(_DWORD); weak
// _DWORD  __free_lconv_mon(_DWORD); weak
// int  _ismbblead(unsigned int);
// int  SomeWndPointerGetter(int a1, int a2, int a3);
...
// void  __noreturn StringExceptionCreator_0(int a1, int a2);
...
// _DWORD  sub_1000B1A6(_DWORD, _DWORD); weak
// _DWORD  __CxxFrameHandler3(struct EHExceptionRecord *, struct EHRegistrationNode *, struct _CONTEXT *, void
// *); weak std::exception *__thiscall BadException_0(std::exception *this, char *a2); void __thiscall
// ExceptionDestructor2(void *this); void *__thiscall BadException(void *this, char a2); void
// __DestructExceptionObject(_DWORD *a1); std::exception *__thiscall BadException_1(std::exception *this, struct
// std::exception *a2); int AllocAndDestructSet(); void  vectorDestructor(); idb void  BadAllocExcept();
