...
LABEL_44:
	...
	v23 = *getMemU32Ptr(0x956A00, + 4 * v15);
	v24 = 0;
	v25 = 1;
	if (v23 > 0) {
...
int  sub_4C52E0(int* a1, int a2) {
	...
	v2 = nox_win_height;
	memset(getMemAt(0x956A00, 0), 0, 4 * nox_win_height);
	result = a2;
	v4 = 0;
