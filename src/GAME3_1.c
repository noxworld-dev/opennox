			...
			if (*(_WORD*)(v36 + 264 * v18 + 44)) {
				...
				if (sub_4356C0(v4, 30)) {
					if (!*(_DWORD*)&byte_5D4594[1313800]) {
						...
						*(_DWORD*)&byte_5D4594[1313800] = nox_new_drawable_for_thing(v26);
						*(_DWORD*)(*(_DWORD*)&byte_5D4594[1313800] + 120) |= 0x1000000u;
					}
					*(_DWORD*)(*(_DWORD*)&byte_5D4594[1313800] + 12) =
					    *v21 + *(_DWORD*)(v4 + 12) - v21[4];
					*(_DWORD*)(*(_DWORD*)&byte_5D4594[1313800] + 16) =
					    v21[1] - v21[5] + *(_DWORD*)(v4 + 16) - 50;
...
//----- (004C12C0) --------------------------------------------------------
int sub_4C12C0() { return *(_DWORD*)&byte_5D4594[1320964]; }
		...
		do {
			if (*v1 != 44) {
				...
				if (v2 && *(_WORD*)v2)
					...
					nox_window_call_field_94(*(int*)&byte_5D4594[1321244], 16397,
								 (int)&byte_587000[185344], -1);
				if (v3 && *(_WORD*)v3 && v2 != v3)
					nox_window_call_field_94(*(int*)&byte_5D4594[1321248], 16397, (int)v3, -1);
				else
					nox_window_call_field_94(*(int*)&byte_5D4594[1321248], 16397,
...
int __cdecl sub_4C3FC0(char* a1) {
	...
	if (*(_DWORD*)&byte_5D4594[1321252]) {
		...
		if (*(_WORD*)(v8 + 44) > 0) {
			do {
				v9 = (const wchar_t*)nox_window_call_field_94(*(int*)&byte_5D4594[1321244], 16406, v7,
									      0);
				if (!nox_wcscmp(v9, v6))
					nox_window_call_field_94(*(int*)&byte_5D4594[1321244], 16407,
		...
		if (*(_WORD*)(v11 + 44) > 0) {
			do {
				v12 = (const wchar_t*)nox_window_call_field_94(*(int*)&byte_5D4594[1321248], 16406, v10,
									       0);
				if (!nox_wcscmp(v12, v6))
					nox_window_call_field_94(*(int*)&byte_5D4594[1321248], 16407,
	...
	if (*(_WORD*)(v3 + 44) > 0) {
		do {
			...
			if (!nox_wcscmp(v4, (const wchar_t*)v1))
				nox_window_call_field_94(*(int*)&byte_5D4594[1321244], 16407, (int)&byte_587000[185452],
							 v2);
			++v2;
	...
	if (*(_WORD*)(v6 + 44) > 0) {
		do {
			...
			if (!nox_wcscmp(v7, (const wchar_t*)v1))
				nox_window_call_field_94(*(int*)&byte_5D4594[1321248], 16407, (int)&byte_587000[185456],
							 v5);
			++v5;
...
//----- (004C4280) --------------------------------------------------------
BOOL sub_4C4280() { return wndIsShown_sub_46ACC0(*(int*)&byte_5D4594[1321228]) == 0; }
		...
		do {
			if (*v1 != 44) {
				...
				if (v2 && *(_WORD*)v2)
					...
					nox_window_call_field_94(*(int*)&byte_5D4594[1522624], 16397,
								 (int)&byte_587000[187548], -1);
				if (v3 && *(_WORD*)v3 && v2 != v3)
					nox_window_call_field_94(*(int*)&byte_5D4594[1522628], 16397, (int)v3, -1);
				else
					nox_window_call_field_94(*(int*)&byte_5D4594[1522628], 16397,
...
int __cdecl sub_4CC280(char* a1) {
	...
	if (*(_DWORD*)&byte_5D4594[1522632]) {
		...
		if (*(_WORD*)(v8 + 44) > 0) {
			do {
				v9 = (const wchar_t*)nox_window_call_field_94(*(int*)&byte_5D4594[1522624], 16406, v7,
									      0);
				if (!nox_wcscmp(v9, v6))
					nox_window_call_field_94(*(int*)&byte_5D4594[1522624], 16407,
		...
		if (*(_WORD*)(v11 + 44) > 0) {
			do {
				v12 = (const wchar_t*)nox_window_call_field_94(*(int*)&byte_5D4594[1522628], 16406, v10,
									       0);
				if (!nox_wcscmp(v12, v6))
					nox_window_call_field_94(*(int*)&byte_5D4594[1522628], 16407,
...
int __cdecl sub_4CC3C0(char* a1) {
	...
	if (*(_WORD*)(v3 + 44) > 0) {
		do {
			...
			if (!nox_wcscmp(v4, (const wchar_t*)v1))
				nox_window_call_field_94(*(int*)&byte_5D4594[1522624], 16407, (int)&byte_587000[187832],
							 v2);
			++v2;
		} while (v2 < *(__int16*)(v3 + 44));
	}
	...
	if (*(_WORD*)(v6 + 44) > 0) {
		do {
			...
			if (!nox_wcscmp(v7, (const wchar_t*)v1))
				nox_window_call_field_94(*(int*)&byte_5D4594[1522628], 16407, (int)&byte_587000[187836],
							 v5);
			++v5;
		} while (v5 < *(__int16*)(v6 + 44));
	}
