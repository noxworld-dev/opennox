...
nox_wnd_xxx* dword_5d4594_1522608 = 0;
...
int __cdecl sub_4C5500(int* a1) {
	...
	if (nox_common_getEngineFlag(NOX_ENGINE_FLAG_11))
		result = sub_498AE0();
	return result;
}
	...
	if (a2 == 16389) {
		...
		case 2010:
			...
			*(_DWORD*)(a1 + 36) = v7;
			...
			break;
		case 2012:
			nox_common_toggleEngineFlag(NOX_ENGINE_FLAG_11);
			result = 0;
			break;
		case 2014:
...
int sub_4CB880() {
	...
	if (result) {
		...
		if (result) {
			dword_5d4594_1522608->field_0 = 900;
			dword_5d4594_1522608->field_12 = sub_4CBB70;
			dword_5d4594_1522608->field_14 = sub_4CBBB0;
...
int sub_4CBB70() {
	...
	*(_BYTE*)(&dword_5d4594_1522608->field_16) = 2;
	sub_43BE40(2);
	sub_452D80(923, 100);
	return 1;
}
...
int sub_4CBBB0() {
	...
	v0 = dword_5d4594_1522608->field_13;
	sub_43C570(dword_5d4594_1522608);
