...
uint32_t* nox_xxx_spellTeleportCreateWake_530560(int a1, int* a2, uint32_t* a3) {
	...
	if (result) {
		...
		*v6 = *a3;
		...
		result = (uint32_t*)(gameFrame() + nox_gameFPS);
		v5[34] = gameFrame() + nox_gameFPS;
	}
	return result;
}
...
char nox_xxx_monsterShieldBlockStart_532070(int a1) {
	...
	if (nox_xxx_monsterTestBlockShield_533E70(a1)) {
		*(uint32_t*)(v1 + 4) = gameFrame() + (nox_gameFPS >> 1);
	}
	v2 = *(uint32_t*)(v1 + 4);
	if (gameFrame() > v2) {
		nox_xxx_monsterPopAction_50A160(a1);
		...
		*getMemFloatPtr(0x5D4594, 2487952) = *(float*)&dword_587000_261388 + 1.0;
		...
		if (dword_5d4594_2487948 && !nox_xxx_unitIsEnemyTo_5330C0(a1, *(int*)&dword_5d4594_2487948) &&
			*(uint8_t*)(a1 + 12) & 0x10 && (v6 = *(uint32_t*)(v1 + 2064)) != 0 &&
			...
			if (v10) {
				v10[1] = gameFrame() + nox_common_randomInt_415FA0(nox_gameFPS >> 2, nox_gameFPS >> 1);
			}
...
char nox_xxx_monsterPlayHurtSound_532800(int a1) {
	...
	if (v1 & 2) {
		...
		if (gameFrame() >= *(int*)(v2 + 532)) {
			*(uint32_t*)(v2 + 532) =
				gameFrame() + nox_common_randomInt_415FA0(2 * nox_gameFPS, 4 * nox_gameFPS);
...
int nox_xxx_mobGetMoveAttemptTime_534810(nox_object_t* a1) {
	return gameFrame() - *(uint32_t*)(*(uint32_t*)((int)a1 + 748) + 508) < (unsigned int)(3 * nox_gameFPS);
}
	...
	if (v2 && (v2 != 4 || (v4 = *(float*)(v3 + 4) - *(float*)(a1 + 56), v5 = *(float*)(v3 + 8) - *(float*)(a1 + 60),
		...
		if (v2 != 34 && *(uint32_t*)(v1 + 1440) & 0x40000) {
			...
			goto LABEL_10;
			   ...
			   (unsigned int)(gameFrame() - *(uint32_t*)(v1 + 548)) > (int)nox_gameFPS) {
		nox_xxx_monsterPushAction_50A260(a1, 61);
...
LABEL_24:
	...
	if (*(uint32_t*)(a1 + 16) & 0x1000000) {
		if ((unsigned int)(gameFrame() - v1[11]) > (int)nox_gameFPS >> 1) {
			v7 = v1[1];
			if (v6 != v7) {
...
void nox_xxx_updateElevator_53B5D0(uint32_t* a1) {
	...
	case 0u:
		if (a1[4] & 0x1000000) {
			if ((unsigned int)(gameFrame() - a1[34]) > (int)nox_gameFPS) {
				*(uint8_t*)(v1 + 12) = 3;
	...
	case 1u:
		...
		break;
	case 2u:
		if (a1[4] & 0x1000000 && (unsigned int)(gameFrame() - a1[34]) > (int)nox_gameFPS) {
			*(uint8_t*)(v1 + 12) = 1;
...
void nox_xxx_spellFlyUpdate_53B940(int a1) {
	...
	if (gameFrame() - *(uint32_t*)(a1 + 128) <= (unsigned int)nox_float2int(v15)) {
		...
		if (!v2[1]) {
			v7 = *(uint32_t*)(a1 + 136);
			if ((unsigned int)(gameFrame() - v7) > (int)nox_gameFPS >> 2 || v7 == *(uint32_t*)(a1 + 128)) {
				v16 = *v2;
...
void nox_xxx_updateAntiSpellProj_53BB00(int a1) {
	...
	v3 = *(uint32_t*)(a1 + 748);
	v4 = nox_gameFPS;
	if (gameFrame() - *(uint32_t*)(a1 + 128) <= (unsigned int)(5 * nox_gameFPS)) {
		v5 = *(uint32_t*)(v3 + 4);
...
int nox_xxx_updateMagicMissile_53BDA0(int a1) {
	...
	v1 = *(int**)(a1 + 748);
	v2 = *v1;
	if ((*(uint8_t*)(*v1 + 16) & 0x20) || (gameFrame() - *(uint32_t*)(a1 + 128) > (unsigned int)(3 * nox_gameFPS))) {
...
signed int nox_xxx_updateObelisk_53C580(int a1) {
	...
	LABEL_43:
		...
		if ((unsigned int)(gameFrame() - *(uint32_t*)(v1 + 136)) > (int)nox_gameFPS >> 1) {
			nox_xxx_aud_501960(230, v1, 0, 0);
	...
	if (v23) {
		v2 = v24;
	LABEL_50:
		result = gameFrame() / (nox_gameFPS >> 1);
		if (!(gameFrame() % (nox_gameFPS >> 1))) {
			result = *v2;
			if ((int)*v2 < 50) {
				if (!(result % 8)) {
...
void nox_xxx_updateBlackPowderBarrel_53C9A0(float* a1) {
	...
	} else if ((unsigned int)(gameFrame() - v3) >= (int)nox_gameFPS) {
...
void nox_xxx_updateOneSecondDie_53CB60(int a1) {
	if ((unsigned int)(gameFrame() - *(uint32_t*)(a1 + 128)) >= (int)nox_gameFPS) {
		nox_xxx_delayedDeleteObject_4E5CC0(a1);
	}
}
...
void nox_xxx_updateBlackPowderBurn_53CCB0(int a1) {
	...
	} else if (gameFrame() - v2 >= (unsigned int)(2 * nox_gameFPS)) {
		nox_xxx_delayedDeleteObject_4E5CC0(a1);
	}
}
...
void nox_xxx_updateMoonglow_53D270(int a1) {
	...
	if (v1) {
		if (*(uint8_t*)(v1 + 8) & 4) {
			v2 = *(uint32_t*)(v1 + 748);
			if (*(uint8_t*)(v1 + 16) & 0x20 ||
				gameFrame() - *(uint32_t*)(a1 + 128) > (unsigned int)(300 * nox_gameFPS)) {
				nox_xxx_delayedDeleteObject_4E5CC0(a1);
...
void nox_xxx_updateTelekinesis_53D330(int a1) {
	...
	v2 = *(uint32_t*)(v1 + 748);
	if (*(uint32_t*)(v1 + 16) & 0x8020 ||
		gameFrame() - *(uint32_t*)(a1 + 128) > (unsigned int)(20 * nox_gameFPS)) {
		v4 = *(uint32_t*)(a1 + 508);
...
void nox_xxx_updateFist_53D400(int a1) {
	...
	if (gameFrame() - *(uint32_t*)(a1 + 128) > (unsigned int)(3 * nox_gameFPS)) {
		nox_xxx_delayedDeleteObject_4E5CC0(a1);
	}
}
...
void nox_xxx_updateMeteorShower_53D5A0(float* a2) {
	...
	if (gameFrame() - *((uint32_t*)a2 + 32) < (unsigned int)(5 * nox_gameFPS)) {
...
LABEL_19:
	if (gameFrame() - *(uint32_t*)(v1 + 128) > (unsigned int)(5 * nox_gameFPS)) {
		*(uint8_t*)(v2 + 24) = 1;
		*(uint32_t*)(v2 + 8) = 0;
	}
}
...
int nox_xxx_updateFlag_53DDF0(int a1) {
	...
	if (result) {
		...
		if (gameFrame() - v5 > (unsigned int)(30 * nox_gameFPS)) {
...
int nox_xxx_usePotion_53EF70(int a1, int a2) {
	...
	if (!(*(uint32_t*)(a1 + 8) & 4) || (v5 = *(uint32_t*)(a1 + 16), (v5 & 0x8000) == 0)) {
		...
		LABEL_16:
			...
			if (v10) {
				if (v10 == 1) {
					v11 = (double)v25 * nox_xxx_wizardMaximumMana_587000_312820;
				} else {
					if (v10 != 2) {
					LABEL_26:
					...
					v11 = (double)v25 * nox_xxx_conjurerMaxMana_587000_312804;
				}
			} else {
				v11 = (double)v25 * nox_xxx_warriorMaxMana_587000_312788;
			}
			v24 = v11;
		...
		if (*(uint32_t*)(a1 + 8) & 4) {
			...
			switch (v7) {
			case 0:
				v8 = (double)v25 * nox_xxx_warriorMaxHealth_587000_312784;
			LABEL_13:
				v23 = v8;
				...
				break;
			case 1:
				v8 = (double)v25 * nox_xxx_wizardMaxHealth_587000_312816;
				goto LABEL_13;
			case 2:
				v8 = (double)v25 * nox_xxx_conjurerMaxHealth_587000_312800;
				goto LABEL_13;
			}
		}
...
int nox_xxx_useFireWand_53F670(int a1, int a2) {
	...
	if ((unsigned int)(gameFrame() - *(uint32_t*)(a2 + 136)) > (int)nox_gameFPS) {
...
int nox_xxx_useRead_53F7C0(int a1, int a2) {
	...
	if (*(uint8_t*)(a1 + 8) & 4) {
		v2 = *(uint32_t*)(a2 + 736);
		v3 = *(uint32_t*)(v2 + 256);
		if ((gameFrame() - v3 > (unsigned int)(3 * nox_gameFPS) || !v3) &&
...
int sub_53F830(int a1, int a2) {
	...
	if (*(uint8_t*)(a1 + 8) & 4) {
		...
		v4 = *(uint32_t*)(a2 + 736);
		v5 = *(uint32_t*)(v4 + 256);
		if ((gameFrame() - v5 > (unsigned int)(3 * nox_gameFPS) || !v5) &&
			nox_xxx_mapCheck_537110(a1, a2) == 1) {
			if (sub_4D75E0()) {
				...
				if (nox_xxx_mapTraceRay_535250(&v17, 0, 0, 5)) {
					...
					if (v13) {
						...
						*v14 = a3;
						...
						v14[5] = gameFrame() + nox_gameFPS * nox_common_randomInt_415FA0(30, 90);
						v14[6] = gameFrame();
					}
				}
				--v19;
...
char nox_xxx_mobActionMoveTo_5443F0(int a1) {
	...
	if (nox_xxx_creatureSetMovePath_50D5A0(v1) == 1) {
		v10 = *(uint8_t*)(v2 + 284);
		v11 = v10 == 2 || v10 == 1 && gameFrame() - *(uint32_t*)(v2 + 540) < (unsigned int)(5 * nox_gameFPS);
		if (v10 == 1) {
		...
		if (v11) {
			...
			if (v12) {
				v12[1] = gameFrame() + nox_common_randomInt_415FA0(2 * nox_gameFPS, 4 * nox_gameFPS);
			}
		...
		if (*(uint8_t*)(v2 + 284)) {
			...
			if (v13) {
				v13[1] = gameFrame() + nox_common_randomInt_415FA0(nox_gameFPS >> 1, (int)nox_gameFPS);
			}
		}
	}
...
char nox_xxx_mobActionFlee_544760(int a1) {
	...
	if (nox_xxx_monsterIsMoveing_534320(a1)) {
		...
		if (v4) {
			...
			*(uint32_t*)(v3 + 8) = *(uint32_t*)(v4 + 60);
			...
			if (*(float*)(v1 + 1356) * *(float*)(v1 + 1356) > v7 * v7 + v6 * v6 &&
				(unsigned int)(gameFrame() - *(uint32_t*)(v1 + 280)) > nox_gameFPS >> 1) {
				*(uint32_t*)(v1 + 8) = 0;
			}
		...
		v9 = gameFrame();
		if (*(uint32_t*)(v1 + 8) && gameFrame() - *(uint32_t*)(v1 + 280) > (unsigned int)(2 * nox_gameFPS)) {
			*(uint32_t*)(v1 + 8) = 0;
			v9 = gameFrame();
		}
