...
int __cdecl sub_4A28E0(_DWORD* a1, int a2, unsigned int a3, int a4) {
	...
	case 7:
		...
		*(_DWORD*)(v5 + 48) = -2;
		v16 = 0;
		while (2) {
			if (v16 > 0 && *(int*)(v16 + *(_DWORD*)(v5 + 24) - 524) >
					   *(__int16*)(v5 + 52) + *(__int16*)(v5 + 54) ||
			    v15 == *(__int16*)(v5 + 44)) {
				*(_DWORD*)(v5 + 48) = -1;
	...
	while (
	    (v21 <= 0 || *(_DWORD*)(v21 + *(_DWORD*)(v5 + 24) - 524) <= *(__int16*)(v5 + 52) + *(__int16*)(v5 + 54)) &&
	    v20 != *(__int16*)(v5 + 44)) {
...
int __cdecl sub_4A2D10(int a1, int a2, int a3) {
	...
	if (result) {
		...
		*(float*)(result + 8) = (double)(int)(*(_DWORD*)(*(_DWORD*)(v3 + 36) + 12) -
					...
					(double)*(int*)(result + 4);
		if (a3)
			result = nox_window_call_field_94(*(_DWORD*)(v3 + 36), 16394,
							  *(_DWORD*)(result + 4) - *(__int16*)(v3 + 54), 0);
	}
	return result;
}
...
int __cdecl sub_4A3AC0(wchar_t* a1, int a2, _DWORD* a3) {
	...
	if (a2 >= 17 || a2 < 0)
		...
		*(_DWORD*)(*(_DWORD*)(v4 + 24) + 524 * *(__int16*)(v4 + 46) + 516) =
		    **(_DWORD**)&byte_5D4594[4 * a2 + 2649836];
...
LABEL_13:
	...
	if (*(_DWORD*)(a2 + 68) != 0x80000000) {
		...
		v24 = 0;
		for (i = 0;; i = v9) {
			if (v9 > 0 && *(_DWORD*)(*(_DWORD*)(v2 + 24) + v9 - 524) >
					  *(__int16*)(v2 + 54) + *(__int16*)(v2 + 52) ||
			    v24 == *(__int16*)(v2 + 44)) {
				break;
			}
			v10 = *(_DWORD*)(v2 + 24) + v9;
		...
		LABEL_32:
			...
			if ((a1[1] & 0x4000) == 0x4000) {
				...
				sub_43FAF0(*(_DWORD*)(a2 + 200), (_WORD*)(*(_DWORD*)(v2 + 24) + v9 + 4), xLeft + 5,
					   v21 + 2, v22 - 7, v12);
			}
			v21 += v12;
		LABEL_38:
...
int __cdecl sub_4A3FC0(_DWORD* a1, int a2) {
	...
	if (v8 != 0x80000000) {
		...
		v26 = 0;
		for (i = 0;; i = v10) {
			if (v10 > 0 && *(_DWORD*)(*(_DWORD*)(v3 + 24) + v10 - 524) >
					   *(__int16*)(v3 + 54) + *(__int16*)(v3 + 52) ||
			    v26 == *(__int16*)(v3 + 44)) {
				break;
			}
		...
		LABEL_29:
			...
			if ((a1[1] & 0x4000) == 0x4000) {
				...
				sub_43FAF0(*(_DWORD*)(a2 + 200), (_WORD*)(v10 + *(_DWORD*)(v3 + 24) + 4), xLeft + 5,
					   v25 + 2, v22 - 7, v13);
			}
			v25 += v13;
		LABEL_35:
	...
	*(_DWORD*)&byte_5D4594[1308152] = sub_46B0C0(*(_DWORD**)&byte_5D4594[1308084], 751);
	...
	if (!*(_DWORD*)&byte_587000[171388]) {
		...
		*(_DWORD*)(*(_DWORD*)&byte_5D4594[1308116] + 32) =
		    *(unsigned __int8*)(*(_DWORD*)&byte_5D4594[1307784] + 83) << 16;
		*(_DWORD*)(*(_DWORD*)&byte_5D4594[1308120] + 32) =
		    *(unsigned __int8*)(*(_DWORD*)&byte_5D4594[1307784] + 84) << 16;
		*(_DWORD*)(*(_DWORD*)&byte_5D4594[1308124] + 32) =
		    *(unsigned __int8*)(*(_DWORD*)&byte_5D4594[1307784] + 85) << 16;
		*(_DWORD*)(*(_DWORD*)&byte_5D4594[1308128] + 32) =
		    *(unsigned __int8*)(*(_DWORD*)&byte_5D4594[1307784] + 86) << 16;
	...
	if (v4 >= 1) {
		...
		do {
			if (iswspace(*v1)) {
				...
				if (v3 == 1) {
					v6 = *v1;
					if (*v1 == 42 || v6 == 63 || v6 == 60 || v6 == 62 || v6 == 92 || v6 == 47 ||
					    v6 == 58 || v6 == 34 || v6 == 124) {
						*v1 = 45;
					}
				}
...
int __cdecl sub_4A7580(int a1, int a2) {
	...
	return sub_46A9B0(*(_DWORD**)&byte_5D4594[1308088], a1 - *(_DWORD*)(*(_DWORD*)&byte_5D4594[1308088] + 8),
		...
		if (v4) {
			...
			if (v4 > 4096) {
				...
				case 128:
					...
					v13 = a1;
					if (!v11) {
						sub_43F840(*(_DWORD*)(a2 + 200), (unsigned __int16*)(a2 + 72), &v18, 0,
							   0);
			...
			*(_DWORD*)&byte_5D4594[1309740] = result;
			if (result) {
				...
				*(_DWORD*)(v1[100] + 12) = 20;
				...
				nox_window_call_field_94((int)v1, 16394,
							 *(_DWORD*)(*(_DWORD*)&byte_587000[127004] + 4) >> 16, 0);
...
_DWORD* sub_4AAA70() {
	...
	nox_window_call_field_94(sub_46B0C0(*(_DWORD**)&byte_5D4594[1309820], 318), 16394,
	...
	case 16396:
		...
		if (v17) {
			...
			if (a4) {
				if (!sub_44D990()) {
					v12 = *(void**)&byte_5D4594[1309732];
					v13 = *(void(__cdecl**)(void*, int, int, int))(*(_DWORD*)&byte_5D4594[1309732] +
										       372);
					if (v13)
					LABEL_48:
						v13(v12, 21, 28, 2);
			...
			if (a4) {
				if (!sub_453070()) {
					v15 = *(_DWORD*)&byte_5D4594[1309728];
					v16 = *(void(__cdecl**)(int, int, int, int))(*(_DWORD*)&byte_5D4594[1309728] +
										     372);
					if (v16)
					LABEL_74:
						v16(v15, 21, 28, 2);
...
int sub_4AB260() {
	...
	*(_DWORD*)&byte_5D4594[1309748] = nox_new_window_from_file("discon.wnd", sub_4AB390);
	...
	sub_46A9B0(*(_DWORD**)&byte_5D4594[1309748],
...
void __cdecl sub_4AB7C0(unsigned __int16 a1, void* a2, size_t a3) {
	...
	if (a2 && a3) {
		...
		// fprintf(stderr, "foo %d %d %d\n", *(_DWORD *)&byte_5D4594[1309764], *(_DWORD *)&byte_5D4594[1309768],
		// *(_DWORD *)&byte_5D4594[1309772]);
		if (*(_DWORD*)&byte_5D4594[1309764] &&
		    *(unsigned int*)&byte_5D4594[1309768] >= *(unsigned int*)&byte_5D4594[1309772]) {
			sub_4AB580();
			sub_4AB560(0);
			sub_4AB570(1);
			sub_4CC900(0x64u);
		...
		*(_BYTE*)(v2 + 274) = -128;
		...
		LABEL_13:
			...
			*(_BYTE*)(v2 + 434) = 0;
			...
			a1 = *v4;
			*(_WORD*)(v2 + 268) =
			    (__int64)((double)a1 * *(double*)&byte_581450[9752] * *(double*)&byte_581450[9736]);
			goto LABEL_24;
		}
	...
	if (result) {
		...
		if (result) {
			...
			*(_DWORD*)(v1[100] + 12) = 20;
			...
			nox_window_call_field_94((int)v1, 16395, 0, 0x4000);
			nox_window_call_field_94((int)v1, 16394, *(_DWORD*)(*(_DWORD*)&byte_587000[127004] + 4) >> 16,
						 0);
			...
			*(_DWORD*)(*(_DWORD*)&byte_5D4594[1309832] + 36) = v15;
			...
			nox_window_call_field_94(sub_46B0C0(*(_DWORD**)&byte_5D4594[1309820], 316), 16394,
						 (draw_gamma - 0.5f) * 50, 0);
			nox_window_call_field_94(sub_46B0C0(*(_DWORD**)&byte_5D4594[1309820], 318), 16394,
						 (log10f(input_sensitivity) + 1.0f) * 50, 0);
			for (i = 320; i <= 332; ++i) {
			...
			*(_DWORD*)&byte_5D4594[1309824] = nox_window_new(0, 32, 0, 0, 1, 1, 0);
			...
			if (*(int*)&byte_587000[174072] != -1) {
				...
				do {
					v22 = nox_window_new(*(int*)&byte_5D4594[1309824], 0, v20, *(v21 - 1), *v21,
							     v21[1], 0);
	...
	case 16396:
		...
		if (v15) {
			...
			if (a4) {
				if (!sub_44D990()) {
					v10 = *(void**)&byte_5D4594[1309836];
					v11 = *(void(__cdecl**)(void*, int, int, int))(*(_DWORD*)&byte_5D4594[1309836] +
										       372);
					if (v11)
					LABEL_36:
						v11(v10, 21, 28, 2);
...
int sub_4AE420() {
	...
	if (*(_DWORD*)&byte_5D4594[3798692] >= 3)
		sub_49F500(*(_DWORD*)(*(_DWORD*)&byte_5D4594[3798696] + 8 * *(_DWORD*)&byte_5D4594[3798692] - 24),
	...
	if (result) {
		...
		if (result) {
			...
			if (result) {
				...
				for (result = *(_DWORD*)&byte_5D4594[3798640]; v1 <= *(int*)&byte_5D4594[3798640];
		...
		if (v4) {
			...
			if (v3 >= 2) {
				...
				do {
					...
					v6 += 4;
					(*(void(__cdecl**)(_DWORD, _DWORD, _DWORD)) &
					 byte_5D4594[3798720])(v8, *(_DWORD*)&byte_5D4594[3798636], v9);
					--v7;
				} while (v7);
				v1 = *(_DWORD*)&byte_5D4594[3798636];
			}
...
int sub_4AEBD0() {
	...
	*(_DWORD*)&byte_5D4594[3798640] = 0;
	for (*(_DWORD*)&byte_5D4594[3798636] = 0; *(_DWORD*)&byte_5D4594[3798636] < nox_backbuffer_height;
			...
			if (sub_49FC20(&v10, &v11, &v12, &v13)) {
				...
				if (v7 > 0) {
					do {
						...
						*(_DWORD*)(*(_DWORD*)&byte_5D4594[3798632] + 4 * v4) =
...
unsigned __int8* __cdecl sub_4AF890(unsigned __int8** a1) {
	...
	a1[4] = (unsigned __int8*)(*((_DWORD*)result + 4) - *((__int16*)result + 53) - *((__int16*)result + 52) -
				   result[1]);
	return result;
}
	...
	if (*(_DWORD*)&byte_5D4594[1312460]) {
		while (1) {
			...
			if (*result == v4 && result[1] == v3 && result[2] == a2 &&
			    result[12] == ptr_5D4594_3799572->data[54] && result[13] == ptr_5D4594_3799572->data[55] &&
		...
		do {
			...
			if (2 * v9) {
				...
				*v11 = 2 * v9;
				...
				v24 = v20 / v9;
				do {
					*(_WORD*)v6 = (v37 >> 19) & 0x1F |
						      (8 * (BYTE2(v13) & 0xFC | (32 * (HIWORD(v12) & 0xFFF8))));
					if (v14 >= 0) {
						v12 -= v21;
						v13 -= v22;
						v37 -= v24;
	...
	if (*(_DWORD*)&byte_5D4594[810632]) {
		...
		if (ptr_5D4594_3799572->data[0] && sub_49F8E0(a1, a2, a3)) {
			...
			*v11 = *(_BYTE*)(result + ((unsigned __int8)*v11 << 8) + *(_DWORD*)&byte_5D4594[810632]);
			v17 = 4 * (a2 - a3);
			*(_BYTE*)(v5 + *(_DWORD*)(v17 + *(_DWORD*)&byte_5D4594[3798784])) = *(
			    _BYTE*)(result +
			...
			*(_BYTE*)(v5 + *(_DWORD*)(4 * a2 + *(_DWORD*)&byte_5D4594[3798784]) - a3) = *(
			    _BYTE*)(result +
				    (*(unsigned __int8*)(v5 + *(_DWORD*)(4 * a2 + *(_DWORD*)&byte_5D4594[3798784]) - a3)
				     << 8) +
				    *(_DWORD*)&byte_5D4594[810632]);
			*(_BYTE*)(v5 + *(_DWORD*)(v15 + *(_DWORD*)&byte_5D4594[3798784])) = *(
			    _BYTE*)(result +
			...
			if (a3 > 0) {
				...
				do {
					...
					++v6;
					v14 += 4;
					*(_BYTE*)(v5 + v6 + *(_DWORD*)(v15 + *(_DWORD*)&byte_5D4594[3798784])) =
					    *(_BYTE*)(result +
						      (*(unsigned __int8*)(v5 + v6 +
						       ...
						       << 8) +
						      *(_DWORD*)&byte_5D4594[810632]);
					*(_BYTE*)(v5 + v7 + *(_DWORD*)(v14 + *(_DWORD*)&byte_5D4594[3798784])) =
					    *(_BYTE*)(result +
						      (*(unsigned __int8*)(v5 + v7 +
						       ...
						       << 8) +
						      *(_DWORD*)&byte_5D4594[810632]);
					*(_BYTE*)(v5 + v7 + *(_DWORD*)(v20 + *(_DWORD*)&byte_5D4594[3798784])) =
					    *(_BYTE*)(result +
						      (*(unsigned __int8*)(v5 + v7 +
									   *(_DWORD*)(v20 +
										      *(_DWORD*)&byte_5D4594[3798784]))
						       << 8) +
						      *(_DWORD*)&byte_5D4594[810632]);
					*(_BYTE*)(v5 + v6 + *(_DWORD*)(v19 + *(_DWORD*)&byte_5D4594[3798784])) =
					    *(_BYTE*)(result +
						      (*(unsigned __int8*)(v5 + v6 +
									   *(_DWORD*)(v19 +
										      *(_DWORD*)&byte_5D4594[3798784]))
						       << 8) +
						      *(_DWORD*)&byte_5D4594[810632]);
					*(_BYTE*)(v5 + *(_DWORD*)(v19 + *(_DWORD*)&byte_5D4594[3798784]) - v6) =
					    *(_BYTE*)(result +
						      (*(unsigned __int8*)(v5 +
									   *(_DWORD*)(v19 +
										      *(_DWORD*)&byte_5D4594[3798784]) -
						       ...
						       << 8) +
						      *(_DWORD*)&byte_5D4594[810632]);
					*(_BYTE*)(v5 + *(_DWORD*)(v20 + *(_DWORD*)&byte_5D4594[3798784]) - v7) =
					    *(_BYTE*)(result +
						      (*(unsigned __int8*)(v5 +
									   *(_DWORD*)(v20 +
										      *(_DWORD*)&byte_5D4594[3798784]) -
						       ...
						       << 8) +
						      *(_DWORD*)&byte_5D4594[810632]);
					*(_BYTE*)(v5 + *(_DWORD*)(v14 + *(_DWORD*)&byte_5D4594[3798784]) - v7) =
					    *(_BYTE*)(result +
						      (*(unsigned __int8*)(v5 +
									   *(_DWORD*)(v14 +
										      *(_DWORD*)&byte_5D4594[3798784]) -
						       ...
						       << 8) +
						      *(_DWORD*)&byte_5D4594[810632]);
					*(_BYTE*)(v5 + *(_DWORD*)(v15 + *(_DWORD*)&byte_5D4594[3798784]) - v6) =
					    *(_BYTE*)(result +
						      (*(unsigned __int8*)(v5 +
									   *(_DWORD*)(v15 +
										      *(_DWORD*)&byte_5D4594[3798784]) -
...
int __cdecl sub_4B1E30(int a1, int a2, int a3) {
	...
	if (*(_DWORD*)&byte_5D4594[810632]) {
		...
		if (!v7 && a1 < v5 && v9 >= ptr_5D4594_3799572->data[2] && v9 < v18) {
			v5 = ptr_5D4594_3799572->data[3];
			*(_BYTE*)(a1 + *(_DWORD*)(*(_DWORD*)&byte_5D4594[3798784] + 4 * (a2 + a3))) =
			    *(_BYTE*)(v23 +
				      (*(unsigned __int8*)(a1 +
							   *(_DWORD*)(*(_DWORD*)&byte_5D4594[3798784] + 4 * (a2 + a3)))
				       << 8) +
				      *(_DWORD*)&byte_5D4594[810632]);
		}
		v10 = a1 + a3;
		if (a1 + a3 >= v21) {
			if (v10 < v5 && a2 >= v20 && a2 < v18) {
				v5 = v19;
				*(_BYTE*)(a1 + a3 + *(_DWORD*)(*(_DWORD*)&byte_5D4594[3798784] + 4 * a2)) =
				    *(_BYTE*)(v23 +
					      (*(unsigned __int8*)(a1 + a3 +
								   *(_DWORD*)(*(_DWORD*)&byte_5D4594[3798784] + 4 * a2))
					       << 8) +
					      *(_DWORD*)&byte_5D4594[810632]);
				v10 = a1 + a3;
			}
			if (v10 >= v21 && v10 < v5 && a2 >= v20 && a2 < v18) {
				v5 = v19;
				*(_BYTE*)(v10 + *(_DWORD*)(*(_DWORD*)&byte_5D4594[3798784] + 4 * a2)) =
				    *(_BYTE*)(v23 +
					      (*(unsigned __int8*)(v10 +
								   *(_DWORD*)(*(_DWORD*)&byte_5D4594[3798784] + 4 * a2))
					       << 8) +
		...
		if (a1 >= v21) {
			if (a1 < v5 && v11 >= v20 && v11 < v18) {
				...
				*(_BYTE*)(a1 + *(_DWORD*)(*(_DWORD*)&byte_5D4594[3798784] + 4 * (a2 - a3))) =
				    *(_BYTE*)(v23 +
					      (*(unsigned __int8*)(a1 + *(_DWORD*)(*(_DWORD*)&byte_5D4594[3798784] +
										   4 * (a2 - a3)))
					       << 8) +
					      *(_DWORD*)&byte_5D4594[810632]);
				v11 = a2 - a3;
			...
			if (a1 >= v21 && a1 < v5 && v11 >= v20 && v11 < v18) {
				*(_BYTE*)(a1 + *(_DWORD*)(*(_DWORD*)&byte_5D4594[3798784] + 4 * v11)) =
				    *(_BYTE*)(v23 +
					      (*(unsigned __int8*)(a1 + *(_DWORD*)(*(_DWORD*)&byte_5D4594[3798784] +
										   4 * v11))
					       << 8) +
		...
		if (a1 - a3 >= v21) {
			if (v12 < v19 && a2 >= v20 && a2 < v18) {
				*(_BYTE*)(v12 + *(_DWORD*)(*(_DWORD*)&byte_5D4594[3798784] + 4 * a2)) =
				    *(_BYTE*)(v23 +
					      (*(unsigned __int8*)(v12 +
								   *(_DWORD*)(*(_DWORD*)&byte_5D4594[3798784] + 4 * a2))
					       << 8) +
		...
		if (a1 >= v21 && a1 < v19) {
			if (v30 >= v20 && v30 < v18) {
				*(_BYTE*)(a1 + *(_DWORD*)(*(_DWORD*)&byte_5D4594[3798784] + 4 * v30)) =
				    *(_BYTE*)(v8 +
					      (*(unsigned __int8*)(a1 + *(_DWORD*)(*(_DWORD*)&byte_5D4594[3798784] +
										   4 * v30))
					       << 8) +
		...
		if (a3 > 0) {
			...
			LABEL_55:
				if (v15 >= v21 && v15 < v19) {
					if (v14 + i >= v17 && v14 + i < v18) {
						v17 = v20;
						*(_BYTE*)(v15 + *(_DWORD*)(v27 + *(_DWORD*)&byte_5D4594[3798784])) = *(
						    _BYTE*)(v8 +
							    (*(unsigned __int8*)(*(_DWORD*)(v27 + *(_DWORD*)&byte_5D4594
												      [3798784]) +
										 v15)
							     << 8) +
							    *(_DWORD*)&byte_5D4594[810632]);
					...
					if (v15 < v19 && a2 >= v17 && a2 < v18) {
						*(_BYTE*)(v15 + *(_DWORD*)(v26 + *(_DWORD*)&byte_5D4594[3798784])) = *(
						    _BYTE*)(v8 +
							    (*(unsigned __int8*)(*(_DWORD*)(v26 + *(_DWORD*)&byte_5D4594
												      [3798784]) +
										 v15)
							     << 8) +
							    *(_DWORD*)&byte_5D4594[810632]);
				...
				if (v14 >= v21 && v14 < v19 && result + i >= v17 && result + i < v18) {
					*(_BYTE*)(v14 + *(_DWORD*)(v24 + *(_DWORD*)&byte_5D4594[3798784])) =
					    *(_BYTE*)(v8 +
				...
				if (v34 + a2 >= v21 && v34 + a2 < v19 && result + i >= v17 && result + i < v18) {
					*(_BYTE*)(v34 + a2 + *(_DWORD*)(v24 + *(_DWORD*)&byte_5D4594[3798784])) =
					    *(_BYTE*)(v8 +
						      (*(unsigned __int8*)(*(_DWORD*)(v24 +
										      *(_DWORD*)&byte_5D4594[3798784]) +
									   v34 + a2)
				...
				if (result >= v21 && result < v19) {
					if (a2 >= v17 && a2 < v18) {
						*(_BYTE*)(result + *(_DWORD*)(v26 + *(_DWORD*)&byte_5D4594[3798784])) =
						    *(_BYTE*)(v8 +
					...
					if (result < v19 && v14 + i >= v17 && v14 + i < v18)
						*(_BYTE*)(result + *(_DWORD*)(v27 + *(_DWORD*)&byte_5D4594[3798784])) =
						    *(_BYTE*)(v8 +
							      (*(unsigned __int8*)(result +
										   *(_DWORD*)(v27 +
											      *(_DWORD*)&byte_5D4594
			...
			*(_BYTE*)(v14 + *(_DWORD*)(v31 + *(_DWORD*)&byte_5D4594[3798784])) =
			    *(_BYTE*)(v8 +
				      (*(unsigned __int8*)(*(_DWORD*)(v31 + *(_DWORD*)&byte_5D4594[3798784]) + v14)
				       << 8) +
				      *(_DWORD*)&byte_5D4594[810632]);
			result = v36;
		LABEL_54:
...
int __cdecl sub_4B3450(int a1, int a2, int a3) {
	...
	if (v10 < v48) {
		if (a2 >= v49 && a2 < v50) {
			...
			*v40 =
			    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804672] +
				      2 * (unsigned __int8)(((*(_DWORD*)&byte_5D4594[3804364] & v52) >>
							     byte_5D4594[3804376]) +
							    ((v71 - (unsigned __int8)((*(_DWORD*)&byte_5D4594[3804364] &
										       v52) >>
										      byte_5D4594[3804376])) >>
							     2))) |
			    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804656] +
			    ...
			    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804664] +
				      2 * (unsigned __int8)(((*(_BYTE*)v40 & v5) << v8) +
							    ((v80 - (unsigned __int8)((*(_BYTE*)v40 & v5) << v8)) >>
							     2)));
			v8 = byte_5D4594[3804384];
			v5 = byte_5D4594[3804372];
		}
	...
	if (a1 - a3 >= v60) {
		if (v12 < v48) {
			if (a2 >= v49 && a2 < v50) {
				...
				*v44 =
				    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804672] +
					      2 * (unsigned __int8)(((*(_DWORD*)&byte_5D4594[3804364] & v56) >>
								     byte_5D4594[3804376]) +
								    ((v71 - (unsigned __int8)((*(_DWORD*)&byte_5D4594
												   [3804364] &
											       v56) >>
											      byte_5D4594[3804376])) >>
								     2))) |
				    ...
				    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804664] +
					      2 * (unsigned __int8)(((*(_BYTE*)v44 & v5) << v8) +
								    ((v80 -
								      (unsigned __int8)((*(_BYTE*)v44 & v5) << v8)) >>
								     2)));
				v8 = byte_5D4594[3804384];
				v5 = byte_5D4594[3804372];
			}
		...
		if (v12 >= v60 && v12 < v48 && a2 >= v49 && a2 < v50) {
			...
			*v45 =
			    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804672] +
				      2 * (unsigned __int8)(((*(_DWORD*)&byte_5D4594[3804364] & v57) >>
							     byte_5D4594[3804376]) +
							    ((v71 - (unsigned __int8)((*(_DWORD*)&byte_5D4594[3804364] &
										       v57) >>
										      byte_5D4594[3804376])) >>
			    ...
			    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804664] +
				      2 * (unsigned __int8)(((*(_BYTE*)v45 & v5) << v8) +
							    ((v80 - (unsigned __int8)((*(_BYTE*)v45 & v5) << v8)) >>
							     2)));
			v8 = byte_5D4594[3804384];
			v5 = byte_5D4594[3804372];
		}
	...
	if (a1 >= v60 && a1 < v48) {
		if (v73 >= v49 && v73 < v50) {
			...
			*v46 =
			    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804672] +
				      2 * (unsigned __int8)(((*(_DWORD*)&byte_5D4594[3804364] & v58) >>
							     byte_5D4594[3804376]) +
							    ((v71 - (unsigned __int8)((*(_DWORD*)&byte_5D4594[3804364] &
										       v58) >>
										      byte_5D4594[3804376])) >>
			    ...
			    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804664] +
				      2 * (unsigned __int8)(((*(_BYTE*)v46 & v5) << v8) +
							    ((v80 - (unsigned __int8)((*(_BYTE*)v46 & v5) << v8)) >>
							     2)));
		}
		v13 = a1;
	}
	...
	if (a3 > 0) {
		...
		for (i = v18;; v18 = i) {
			...
			if (v21 >= v60 && v21 < v48 && v19 >= v49 && v19 < v50) {
				...
				*v22 =
				    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804672] +
					      2 * (unsigned __int8)(((*(_DWORD*)&byte_5D4594[3804364] & v23) >>
								     byte_5D4594[3804376]) +
								    ((v4 - (unsigned __int8)((*(_DWORD*)&byte_5D4594
												  [3804364] &
											      v23) >>
											     byte_5D4594[3804376])) >>
								     2))) |
				    ...
				    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804664] +
					      2 * (unsigned __int8)((((unsigned __int8)*v22 & byte_5D4594[3804372])
								     << byte_5D4594[3804384]) +
								    ((v9 -
								      (unsigned __int8)(((unsigned __int8)*v22 &
											 byte_5D4594[3804372])
											<< byte_5D4594[3804384])) >>
								     2)));
				v21 = v77;
					    ...
					    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804656] +
						      2 * (unsigned __int8)(((*(_DWORD*)&byte_5D4594[3804368] & v26) >>
									    ...
									    ((v6 -
									     ...
									     2))) |
					    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804664] +
						      2 * (unsigned __int8)((((unsigned __int8)*v25 &
									      byte_5D4594[3804372])
									     << byte_5D4594[3804384]) +
									    ((v9 -
									      (unsigned __int8)(((unsigned __int8)*v25 &
												 byte_5D4594[3804372])
												<< byte_5D4594
												       [3804384])) >>
									     2)));
					    ...
					    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804656] +
						      2 * (unsigned __int8)(((*(_DWORD*)&byte_5D4594[3804368] & v28) >>
									    ...
									    ((v6 -
									     ...
									     2))) |
					    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804664] +
						      2 * (unsigned __int8)((((unsigned __int8)*v27 &
									      byte_5D4594[3804372])
									     << byte_5D4594[3804384]) +
									    ((v9 -
									      (unsigned __int8)(((unsigned __int8)*v27 &
												 byte_5D4594[3804372])
												<< byte_5D4594
												       [3804384])) >>
									     2)));
			...
			if (v21 >= v60 && v21 < v48 && v68 + v82 >= v49 && v68 + v82 < v50) {
				...
				*v29 =
				    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804672] +
					      2 * (unsigned __int8)(((*(_DWORD*)&byte_5D4594[3804364] & v30) >>
								     byte_5D4594[3804376]) +
								    ((v4 - (unsigned __int8)((*(_DWORD*)&byte_5D4594
												  [3804364] &
											      v30) >>
				    ...
				    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804664] +
					      2 * (unsigned __int8)((((unsigned __int8)*v29 & byte_5D4594[3804372])
								     << byte_5D4594[3804384]) +
								    ((v9 -
								      (unsigned __int8)(((unsigned __int8)*v29 &
											 byte_5D4594[3804372])
											<< byte_5D4594[3804384])) >>
								     2)));
			}
			if (v83 >= v60 && v83 < v48 && v68 + v82 >= v49 && v68 + v82 < v50) {
				...
				*v31 =
				    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804672] +
					      2 * (unsigned __int8)(((*(_DWORD*)&byte_5D4594[3804364] & v32) >>
								     byte_5D4594[3804376]) +
								    ((v4 - (unsigned __int8)((*(_DWORD*)&byte_5D4594
												  [3804364] &
											      v32) >>
				    ...
				    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804664] +
					      2 * (unsigned __int8)((((unsigned __int8)*v31 & byte_5D4594[3804372])
								     << byte_5D4594[3804384]) +
								    ((v9 -
								      (unsigned __int8)(((unsigned __int8)*v31 &
											 byte_5D4594[3804372])
											<< byte_5D4594[3804384])) >>
								     2)));
			}
					    ...
					    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804656] +
						      2 * (unsigned __int8)(((*(_DWORD*)&byte_5D4594[3804368] & v34) >>
									    ...
									    ((v6 -
									     ...
									     2))) |
					    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804664] +
						      2 * (unsigned __int8)((((unsigned __int8)*v33 &
									      byte_5D4594[3804372])
									     << byte_5D4594[3804384]) +
									    ((v9 -
									      (unsigned __int8)(((unsigned __int8)*v33 &
												 byte_5D4594[3804372])
												<< byte_5D4594
												       [3804384])) >>
									     2)));
					    ...
					    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804656] +
						      2 * (unsigned __int8)(((*(_DWORD*)&byte_5D4594[3804368] & v36) >>
									    ...
									    ((v6 -
									     ...
									     2))) |
					    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804664] +
						      2 * (unsigned __int8)((((unsigned __int8)*v35 &
									      byte_5D4594[3804372])
									     << byte_5D4594[3804384]) +
									    ((v9 -
									      (unsigned __int8)(((unsigned __int8)*v35 &
												 byte_5D4594[3804372])
												<< byte_5D4594
												       [3804384])) >>
									     2)));
			...
			if (v83 >= v60 && v83 < v48 && v59 >= v49 && v59 < v50) {
				...
				*v37 =
				    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804672] +
					      2 * (unsigned __int8)(((*(_DWORD*)&byte_5D4594[3804364] & v38) >>
								     byte_5D4594[3804376]) +
								    ((v4 - (unsigned __int8)((*(_DWORD*)&byte_5D4594
												  [3804364] &
											      v38) >>
				    ...
				    *(_WORD*)(*(_DWORD*)&byte_5D4594[3804664] +
					      2 * (unsigned __int8)((((unsigned __int8)*v37 & byte_5D4594[3804372])
								     << byte_5D4594[3804384]) +
								    ((v9 -
								      (unsigned __int8)(((unsigned __int8)*v37 &
											 byte_5D4594[3804372])
											<< byte_5D4594[3804384])) >>
								     2)));
			}
		...
		if (a2 == 16394) {
			if (a3 >= *(int*)v5) {
				...
				if (a3 <= v18) {
					...
					*(_DWORD*)(v5 + 12) = a3;
					a3 = v19;
					sub_46A9B0(*(_DWORD**)(v4 + 400), 0,
						   (__int64)((double)v19 * *(float*)(v5 + 8)));
				}
			}
		} else if (a2 == 16395) {
			v14 = a4;
...
int __cdecl sub_4B71A0(_DWORD* a1, int a2) {
	...
	*(_DWORD*)(a2 + 432) +=
	    *(_DWORD*)(a2 + 440) * *(_DWORD*)&byte_587000[8 * *(unsigned __int8*)(a2 + 299) + 192088];
...
//----- (004B7C20) --------------------------------------------------------
int __cdecl nox_thing_released_soul_draw(int* a1, int a2) { return nox_thing_vector_animate_draw(a1, a2); }
	...
	if (v7 < (unsigned int)(unsigned __int16)v8) {
		...
		do {
			if (v10 >= *(unsigned __int8*)(v5 + 8))
				v10 = 0;
			v12 = (v10 + *(_DWORD*)&byte_5D4594[2598000] + v2[32]) /
			      ((unsigned int)*(unsigned __int8*)(v5 + 9) + 1);
			v2[77] = v12;
		...
		if (sub_4356C0(dr, 30)) {
			...
			*(_DWORD*)(*(_DWORD*)&byte_5D4594[1313800] + 16) = v10[1] - v10[5] + dr->field_4 - 50;
			(*(void(__cdecl**)(int*, _DWORD))(*(_DWORD*)&byte_5D4594[1313800] + 300))(
			    v36, *(_DWORD*)&byte_5D4594[1313800]);
		}
		do
			...
			if (!(v14 & 0x3000000) || (v16 = v6[297], v16 != 3) && v16 && v16 != 6 && v16 != 7) {
				if (v14 & v8 && (!(v14 & 0xC00) || !(v8 & 0x4000))) {
					...
					if (*v29) {
						...
						sub_4C4770_draw(a1, v6,
								*(_DWORD*)(*(_DWORD*)(v17 + 4 * v6[297] + 4) + 4 * a6));
						if (v15)
							v31 = 1;
						v8 = a3;
					}
	...
	do {
		...
		if ((1 << v7) & a3) {
			...
			if (*v8) {
				...
				LOWORD(v9) =
				    sub_4C4770_draw(a1, v6, *(_DWORD*)(*(_DWORD*)(v10 + 4 * v6[297] + 4) + 4 * a6));
			}
		}
		++v7;
		++v8;
