...
int sub_4A5E90() {
	...
	*(_DWORD*)&byte_5D4594[1308136] = sub_46B0C0(*(_DWORD**)&dword_5d4594_1308084, 711);
	*(_DWORD*)&byte_5D4594[1308140] = sub_46B0C0(*(_DWORD**)&dword_5d4594_1308084, 712);
	*(_DWORD*)&byte_5D4594[1308144] = sub_46B0C0(*(_DWORD**)&dword_5d4594_1308084, 713);
	*(_DWORD*)&byte_5D4594[1308148] = sub_46B0C0(*(_DWORD**)&dword_5d4594_1308084, 714);
	*(_DWORD*)&byte_5D4594[1308152] = sub_46B0C0(*(_DWORD**)&dword_5d4594_1308084, 751);
	result = *(_DWORD*)&byte_587000[171388];
	if (!*(_DWORD*)&byte_587000[171388]) {
		nox_window_call_field_94(*(int*)&byte_5D4594[1308152], 16414, *(int*)&dword_5d4594_1307784, 0);
...
int __cdecl sub_4A6DC0(_DWORD* a1, int a2) {
	...
	if (*(_BYTE*)(*(_DWORD*)&byte_5D4594[1308136] + 4) & 8)
		nox_client_drawImageAt_47D2C0(
		    *(_DWORD*)&byte_5D4594[4 * *(unsigned __int8*)(dword_5d4594_1307784 + 67) + 3798172],
		    v54, v55);
	else
		nox_client_drawImageAt_47D2C0(
		    *(_DWORD*)&byte_5D4594[4 * *(unsigned __int8*)(dword_5d4594_1307784 + 67) + 3798180],
		    v54, v55);
	v21 = 0;
		...
		if (result) {
			...
			*(_DWORD*)&byte_5D4594[1309740] = result;
			if (result) {
				...
				*(_DWORD*)&byte_5D4594[1309728] = sub_46B0C0(*(_DWORD**)&dword_5d4594_1309720, 361);
				v3 = sub_453070();
				...
				*(_DWORD*)&byte_5D4594[1309732] = sub_46B0C0(*(_DWORD**)&dword_5d4594_1309720, 362);
				v8 = sub_44D990();
...
int sub_4AB260() {
	...
	*(_DWORD*)&byte_5D4594[1309756] = nox_window_new(0, 136, nox_win_width - 50, nox_win_height / 2 + 3, 50, 50, 0);
	...
	sub_46A9B0(*(_DWORD**)&dword_5d4594_1309748,
		   nox_win_width / 2 - *(_DWORD*)(dword_5d4594_1309748 + 24) / 2,
		...
		if (result) {
			...
			*(_DWORD*)(v6[100] + 12) = 20;
			...
			nox_window_call_field_94((int)v6, 16394, *(_DWORD*)(*(_DWORD*)&byte_587000[122852] + 4) >> 16,
						 0);
			*(_DWORD*)&byte_5D4594[1309836] = sub_46B0C0(*(_DWORD**)&dword_5d4594_1309820, 362);
			v8 = sub_44D990();
			...
			*(_DWORD*)(*(_DWORD*)&byte_5D4594[1309832] + 36) = v15;
			...
			nox_window_call_field_94(sub_46B0C0(*(_DWORD**)&dword_5d4594_1309820, 316), 16394,
...
int __cdecl sub_4AE6F0(int a1, int a2, int a3, int a4, int a5) {
	...
	LABEL_4:
		...
		while (1) {
			if (v38) {
				if (v12 < *(int*)&dword_5d4594_3798636 || v12 > *(int*)&byte_5D4594[3798640]) {
					if (v30 <= 0)
			...
			if (v35) {
				if (v40 < *(int*)&dword_5d4594_3798636 || v40 >= *(int*)&byte_5D4594[3798640]) {
					if (v30 <= 0)
			...
			if (v39 >= *(int*)&dword_5d4594_3798636 && v39 < *(int*)&byte_5D4594[3798640])
				break;
			if (v30 <= 0) {
				v29 = v13 + v11;
				v28 = v39;
		...
		LABEL_43:
			if (v38) {
				if (v11 < *(int*)&dword_5d4594_3798636 || v11 > *(int*)&byte_5D4594[3798640]) {
					if (v30 <= 0)
	...
	if (dword_5d4594_810632) {
		...
		if (ptr_5D4594_3799572->data[0] && sub_49F8E0(a1, a2, a3)) {
			...
			*(_BYTE*)(v5 + *(_DWORD*)(v17 + dword_5d4594_3798784)) = *(
			    _BYTE*)(result +
				    (*(unsigned __int8*)(*(_DWORD*)(v17 + dword_5d4594_3798784) + v5) << 8) +
				    dword_5d4594_810632);
			*(_BYTE*)(v5 + *(_DWORD*)(v17 + dword_5d4594_3798784)) = *(
			    _BYTE*)(result +
				    (*(unsigned __int8*)(v5 + *(_DWORD*)(v17 + dword_5d4594_3798784)) << 8) +
				    dword_5d4594_810632);
			...
			*(_BYTE*)(v5 + *(_DWORD*)(4 * a2 + dword_5d4594_3798784) - a3) = *(
			    _BYTE*)(result +
				    (*(unsigned __int8*)(v5 + *(_DWORD*)(4 * a2 + dword_5d4594_3798784) - a3)
				     << 8) +
				    dword_5d4594_810632);
			*(_BYTE*)(v5 + *(_DWORD*)(v15 + dword_5d4594_3798784)) = *(
			    _BYTE*)(result +
				    (*(unsigned __int8*)(*(_DWORD*)(v15 + dword_5d4594_3798784) + v5) << 8) +
				    dword_5d4594_810632);
			if (a3 > 0) {
				v20 = 4 * a2;
				v19 = 4 * (a2 - v4);
	...
	if (dword_5d4594_810632) {
		...
		if (!v7 && a1 < v5 && v9 >= ptr_5D4594_3799572->data[2] && v9 < v18) {
			...
			*(_BYTE*)(a1 + *(_DWORD*)(dword_5d4594_3798784 + 4 * (a2 + a3))) =
			    *(_BYTE*)(v23 +
				      (*(unsigned __int8*)(a1 +
							   *(_DWORD*)(dword_5d4594_3798784 + 4 * (a2 + a3)))
				       << 8) +
				      dword_5d4594_810632);
		}
		v10 = a1 + a3;
				...
				*(_BYTE*)(a1 + a3 + *(_DWORD*)(dword_5d4594_3798784 + 4 * a2)) =
				    *(_BYTE*)(v23 +
					      (*(unsigned __int8*)(a1 + a3 +
								   *(_DWORD*)(dword_5d4594_3798784 + 4 * a2))
					       << 8) +
					      dword_5d4594_810632);
				v10 = a1 + a3;
			}
		...
		if (a1 >= v21) {
			if (a1 < v5 && v11 >= v20 && v11 < v18) {
				...
				*(_BYTE*)(a1 + *(_DWORD*)(dword_5d4594_3798784 + 4 * (a2 - a3))) =
				    *(_BYTE*)(v23 +
					      (*(unsigned __int8*)(a1 + *(_DWORD*)(dword_5d4594_3798784 +
										   4 * (a2 - a3)))
					       << 8) +
					      dword_5d4594_810632);
				v11 = a2 - a3;
		...
		if (a3 > 0) {
				...
				if (v15 >= v21 && v15 < v19) {
					if (v14 + i >= v17 && v14 + i < v18) {
						...
						*(_BYTE*)(v15 + *(_DWORD*)(v27 + dword_5d4594_3798784)) = *(
						    _BYTE*)(v8 +
							    (*(unsigned __int8*)(*(_DWORD*)(v27 + dword_5d4594_3798784) +
										 v15)
							     << 8) +
							    dword_5d4594_810632);
						result = v36;
					...
					if (v15 < v19 && a2 >= v17 && a2 < v18) {
						*(_BYTE*)(v15 + *(_DWORD*)(v26 + dword_5d4594_3798784)) = *(
						    _BYTE*)(v8 +
							    (*(unsigned __int8*)(*(_DWORD*)(v26 + dword_5d4594_3798784) +
										 v15)
							     << 8) +
							    dword_5d4594_810632);
						result = v36;
			...
			*(_BYTE*)(v14 + *(_DWORD*)(v31 + dword_5d4594_3798784)) =
			    *(_BYTE*)(v8 +
				      (*(unsigned __int8*)(*(_DWORD*)(v31 + dword_5d4594_3798784) + v14)
				       << 8) +
				      dword_5d4594_810632);
			result = v36;
		LABEL_54:
	    ...
	    *(_DWORD*)&byte_5D4594[2614252] && (sub_4356C0(*(int*)&byte_5D4594[2614252], 21) || v31)) {
		...
		if (sub_4356C0(dr, 30)) {
			...
			*(_DWORD*)(dword_5d4594_1313800 + 16) = v10[1] - v10[5] + dr->field_4 - 50;
			(*(void(__cdecl**)(int*, _DWORD))(dword_5d4594_1313800 + 300))(
			    v36, dword_5d4594_1313800);
		}
		do
