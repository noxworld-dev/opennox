...
int  sub_4A6DC0(_DWORD* a1, int a2) {
	...
	if (*(_BYTE*)(dword_5d4594_1308136 + 4) & 8)
		nox_client_drawImageAt_47D2C0(
			*getMemU32Ptr(0x957820, 115216 + 4 * *(unsigned __int8*)(dword_5d4594_1307784 + 67)), v54, v55);
	else
		nox_client_drawImageAt_47D2C0(
			*getMemU32Ptr(0x957820, 115224 + 4 * *(unsigned __int8*)(dword_5d4594_1307784 + 67)), v54, v55);
	v21 = 0;
	v22 = *(unsigned __int8*)(dword_5d4594_1307784 + 67);
	v23 = 3 * v22;
	v24 = getMemIntPtr(0x957820, 115232 + 104 * v22);
	do {
		v25 = v21;
		v26 = 1 << v21;
		if (1 << v21 == 4) {
...
int sub_4AE420() {
	...
	if (*getMemU32Ptr(0x957820, 115736) >= 3)
		nox_client_drawAddPoint_49F500(*(_DWORD*)(dword_5d4594_3798696 + 8 * *getMemU32Ptr(0x957820, 115736) - 24),
									   *(_DWORD*)(dword_5d4594_3798696 + 8 * *getMemU32Ptr(0x957820, 115736) - 20));
...
int  sub_4AE580(int a1) {
	if (*getMemU32Ptr(0x957820, 115736) >= a1)
		nox_client_drawAddPoint_49F500(
			*(_DWORD*)(dword_5d4594_3798696 + 8 * (*getMemU32Ptr(0x957820, 115736) - a1)),
			*(_DWORD*)(dword_5d4594_3798696 + 8 * (*getMemU32Ptr(0x957820, 115736) - a1) + 4));
...
void  sub_4AF2D0(int* a1, int a2, int a3) {
	...
	if (v7) {
		nox_xxx_partfxLoadParticle_4AFE20(v7, *(CHAR**)getMemAt(0x957820, 115672));
...
int  sub_4AF4C0(int a1) {
	...
	if (!v5)
		return 0;
	nox_xxx_partfxLoadParticle_4AFE20(v5, *(CHAR**)getMemAt(0x957820, 115672));
...
int sub_4AF8D0() {
	...
	*getMemU32Ptr(0x957820, 115672) = getMemAt(0x587000, 174348);
