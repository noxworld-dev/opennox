...
int sub_4A4840() {
	...
	if (result) {
		...
		if (result) {
			*(_DWORD*)result = 600;
			*(_DWORD*)((_DWORD)dword_5d4594_1307732 + 48) = sub_4A4970;
			*(_DWORD*)((_DWORD)dword_5d4594_1307732 + 56) = sub_4A49A0;
...
//----- (004A4970) --------------------------------------------------------
int sub_4A4970() {
	*(_BYTE*)((_DWORD)dword_5d4594_1307732 + 64) = 2;
	sub_43BE40(2);
	sub_452D80(923, 100);
	return 1;
}
...
int sub_4A49A0() {
	...
	v0 = *(int (**)(void))((_DWORD)dword_5d4594_1307732 + 52);
