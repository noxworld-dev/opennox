...
extern unsigned char byte_957820[115200];
...
func init() {
	...
	memmap.RegisterBlobData(0x957820, "byte_957820", asByteSlice(unsafe.Pointer(&C.byte_957820[0]), int(unsafe.Sizeof(C.byte_957820))))
