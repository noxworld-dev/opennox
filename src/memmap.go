...
func init() {
	...
	memmap.RegisterBlobData(0x8529A0, "byte_8529A0", unsafe.Slice((*byte)(unsafe.Pointer(&C.byte_8529A0[0])), int(unsafe.Sizeof(C.byte_8529A0))))
	memmap.RegisterBlobData(0x8531A0, "byte_8531A0", unsafe.Slice((*byte)(unsafe.Pointer(&C.byte_8531A0[0])), int(unsafe.Sizeof(C.byte_8531A0))))
	...
	memmap.RegisterBlobData(0x85319C, "byte_85319C", unsafe.Slice((*byte)(unsafe.Pointer(&C.byte_85319C[0])), int(unsafe.Sizeof(C.byte_85319C))))
}
