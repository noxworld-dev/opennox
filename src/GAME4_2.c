            ...
            if (sub_5330C0(v2, v11))
            {
                if (!sub_534A40(v2) || (v16 = *(_DWORD*)(v2 + 16), (v16 & 0x8000) == 0))
                {
                    ...
                    *(_DWORD*)(v4 + 536) = *(_DWORD*)& byte_5D4594[2598000]
                                           + nox_common_randomInt_415FA0(2 * *(_DWORD*)& byte_5D4594[2649704], 4 * *(_DWORD*)& byte_5D4594[2649704]);
                }
            }
        }
...
int __cdecl sub_52A840(int a1, int a2)
{
    ...
    *(_DWORD*)(a1 + 20) = v9;
    ...
    result = v12;
    if ((_BYTE)v12
        && (sub_426AC0_file3_fread(v14, (unsigned __int8)v12), v14[(unsigned __int8)v12] = 0, result = sub_413290(v14), result != 255))
    {
                ...
                *((_WORD*)v9 + 62) = v10;
                ...
                if (sub_535250(&v20, 0, 0, 65))
                {
                    ...
                    *((_DWORD*)v9 + 34) = *(_DWORD*)& byte_5D4594[2598000]
                                          + nox_common_randomInt_415FA0(3 * *(_DWORD*)& byte_5D4594[2649704], 6 * *(_DWORD*)& byte_5D4594[2649704]);
                    v9[39] = *(float*)(a4 + 56);
                    v9[40] = *(float*)(a4 + 60);
