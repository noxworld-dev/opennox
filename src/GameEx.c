...
{
  return *(_BYTE *)(*(_DWORD *)(*(_DWORD *)(a1 + 748) + 276) + 2251);
}
                                                ...
                                                //  -- видимо микс вырезал функционал
  {
    ...
    case 265:
      ...
      if ( (unsigned __int8)vaArg2 == 2 && (_DWORD *)MEMACCESS(0x6D8555) == result )
      {
        if ( (MEMACCESS(0x98085A) >> 3) & 1 )
        {
          result = (_DWORD *)sub_40A5C0(516);
          if ( result )
          {
            result = (_DWORD *)sub_40A5C0(1);
            if ( result )
            {
      ...
      if ( (_BYTE)v7 == functionalKeyCodes[5] )
      {
        if ( (MEMACCESS(0x98085A) >> 3) & 1 )
        {
          ...
          if ( result )
          {
            if ( MEMACCESS(0x6D8538) || MEMACCESS(0x6D855D) )
              return result;
            if ( sub_40A5C0(1) )          // checkGameFlags isServer
            {
    ...
    case 418:
      ...
      if ( !result )
      {
        ...
        *(_DWORD *)&inputNewIpMsgBox[376] = inputNewIp_;
        result = sub_449A10(
                   (int)inputNewIpMsgBox,
                   (int)L"Ip Address",
                   (int)L"Enter address",
                   163,
                   (int (*)(void))startInvalidIpChecker,
                   0);
      }
      return result;
    case 420:
