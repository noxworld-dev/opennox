...
void sub_4D22B0() {
	...
	for (i = (int)result; result; i = (int)result) {
		...
		if (v2) {
			...
			*(_DWORD*)(*(_DWORD*)(i + 2056) + 136) = nox_frame_xxx_2598000;
		}
		result = nox_common_playerInfoGetNext_416EE0(i);
	}
}
...
void nox_server_updateRemotePlayers_4DEC80() {
	for (nox_playerInfo* pl = nox_common_playerInfoGetFirst_416EA0(); pl; pl = nox_common_playerInfoGetNext_416EE0(pl)) {
		if (!pl->playerUnit) {
			continue;
		}
		...
		} else if (!dword_5d4594_2650652 || (nox_frame_xxx_2598000 % nox_xxx_rateGet_40A6C0() == 0) || nox_common_gameFlags_check_40A5C0(8)) {
...
void sub_4EC720() {
	...
	for (int v0 = dword_5d4594_1568024; v0; v0 = *(_DWORD*)(v0 + 52)) {
		if (!*(_DWORD*)(v0 + 24)) {
			...
			if (!v1) {
				*(_DWORD *) (v0 + 24) = 1;
				*(_DWORD *) (v0 + 20) = nox_frame_xxx_2598000 + 30 * nox_gameFPS;
			} else {
				v3 = *(_DWORD *) (v1 + 8);
				if (v3 & 2) {
					v4 = *(_DWORD *) (v1 + 16);
					if (v4 & 0x20) {
						...
						*(_DWORD *) (v0 + 24) = 1;
						*(_DWORD *) (v0 + 20) =
								nox_frame_xxx_2598000 + 30 * nox_gameFPS;
					} else if ((v4 & 0x8000) != 0) {
						*(_DWORD *) (v0 + 24) = 1;
						*(_DWORD *) (v0 + 20) = nox_frame_xxx_2598000 + 30 * nox_gameFPS;
					}
...
//----- (00502100) --------------------------------------------------------
void sub_502100() {
	nox_alloc_class_yyy_4144D0(*(_DWORD**)getMemAt(0x5D4594, 1599056));
...
int nox_xxx_mapExitAndCheckNext_4D1860_server() {
	...
	for (k = nox_xxx_getFirstPlayerUnit_4DA7C0(); k; k = nox_xxx_getNextPlayerUnit_4DA7F0(k)) {
		...
		if (!nox_common_gameFlags_check_40A5C0(512)) {
			...
			*(_DWORD*)(*(_DWORD*)(v18 + 276) + 2144) = nox_frame_xxx_2598000;
