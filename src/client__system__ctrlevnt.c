...
//----- (0042D440) --------------------------------------------------------
int nox_ctrlevent_has_data_42D440(nox_ctrlevent_code code) { return nox_ctrlevent_code_infos[code].has_data; }
	...
	for (int i = a4; i; i = *(uint32_t*)(i + 84)) {
		for (int j = 0; j < *(int*)(i + 68); ++j) {
			...
			case 0x2D:
				...
				break;
			case 0x2E:
				if (nox_common_gameFlags_check_40A5C0(0x2000) && nox_xxx_checkKeybTimeout_4160F0(0x15u, nox_gameFPS)) {
			...
			case 0x2F:
				...
				break;
			case 0x30:
				if (nox_common_gameFlags_check_40A5C0(0x2000) && nox_xxx_checkKeybTimeout_4160F0(0x16u, nox_gameFPS)) {
...
void nox_xxx_clientControl_42D6B0_C() {
	if (nox_common_gameFlags_check_40A5C0(1)) {
		...
		if (dword_5d4594_754036 > 0) {
			...
			memcpy(nox_ctrlevent_buf_750964, nox_ctrlevent_buf_747884,
				   sizeof(nox_ctrlevent_xxx_t) * dword_5d4594_754036);
		}
...
//----- (0042E8C0) --------------------------------------------------------
void sub_42E8C0(int a1) { nullsub_33(a1, nox_ctrlevent_buf_747884, dword_5d4594_754036); }
