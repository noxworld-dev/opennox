...
char nox_xxx_mapReadSetFlags_4CF990() {
	...
	v0 = sub_4165B0();
	if (nox_common_gameFlags_check_40A5C0(1024) && (*getMemIntPtr(0x8531A0, 1186896) < 0 || !(v0[53] & 4)))
		nox_xxx_ruleSetNoRespawn_40A5E0(0);
	sub_455C10();
	sub_456050();
	if (nox_common_gameFlags_check_40A5C0(4096) && *getMemIntPtr(0x8531A0, 1186896) < 0) {
		sub_4D6B10(1);
		sub_419030(1);
	}
	v1 = nox_xxx_mapGetMapName_409B40();
	if (nox_common_checkMapFile_4CFE10(v1)) {
		v2 = nox_xxx_mapGetTypeMB_4CFFA0((int)getMemAt(0x8531A0, 1185504));
		if (getMemByte(0x8531A0, 1186896) & 1) {
			nox_common_gameFlags_unset_40A540(6128);
			nox_xxx_createCoopTeam_417E10();
			nox_xxx_setGameFlags_40A4D0(2048);
		} else if (getMemByte(0x8531A0, 1186896) & 2) {
			v4 = nox_common_gameFlags_check_40A5C0(128);
			nox_common_gameFlags_unset_40A540(6128);
			nox_xxx_setGameFlags_40A4D0(4096);
			if (v4)
				LOBYTE(v3) = nox_server_setupQuestGame_4D6C70();
		} else if ((int)*getMemU32Ptr(0x8531A0, 1186896) >= 0) {
			if (!(*((_WORD*)v0 + 26) & v2))
				*((_WORD*)v0 + 26) = sub_4CFC90((int)getMemAt(0x8531A0, 1185504)) | *((_WORD*)v0 + 26) & 0xE80F;
			if (!(v0[52] & 0x10))
...
void nox_common_scanAddMap(char* filename) {
	...
	map->field_6 = 1;
	map->field_7 = *getMemU32Ptr(0x8531A0, 1186896);
	map->field_8_0 = getMemByte(0x8531A0, 1186900);
	map->field_8_1 = getMemByte(0x8531A0, 1186901);
				...
				if (v10 < 0) {
					if (*getMemIntPtr(0x5D4594, 1548428 + 4 * v0) < 25 && v16[0]) {
						...
						if (nox_common_checkMapFile_4CFE10(v12)) {
							v13 = nox_xxx_mapGetTypeMB_4CFFA0((int)getMemAt(0x8531A0, 1185504));
							if (v13 & v11) {
...
char*  nox_xxx_mapLoad_4D2450(char* a1) {
	...
	memcpy(v5, getMemAt(0x8531A0, 1185504), sizeof(v5));
	strncpy(v4, a1, (strlen(a1) - 4 < 1024 ? strlen(a1) - 4 : 1024));
	v4[strlen(a1) - 4] = 0;
	nox_common_checkMapFile_4CFE10(v4);
	sub_4CFDF0(*getMemIntPtr(0x8531A0, 1186896));
	memcpy(getMemAt(0x8531A0, 1185504), v5, 0x5B8u);
...
int  sub_4D39F0(const char* a3) {
	...
	*getMemU64Ptr(0x5D4594, 1549772) = nox_platform_get_ticks();
	memset(getMemAt(0x8531A0, 1219008), 0, 0x48u);
	*getMemU32Ptr(0x8531A0, 1219008) = 0;
	*getMemU32Ptr(0x8531A0, 1219012) = 0;
	...
	*getMemU8Ptr(0x8531A0, 1219068) = 2;
	*getMemU32Ptr(0x8531A0, 1219072) = 0;
	*getMemU32Ptr(0x8531A0, 1219076) = 0;
	sub_51D0E0();
	if (a3) {
		v1 = strlen(a3) + 1;
		v2 = v1;
		v1 >>= 2;
		memcpy(getMemAt(0x8531A0, 1225248), a3, 4 * v1);
		v4 = &a3[4 * v1];
		v3 = getMemAt(0x8531A0, 1225248 + 4 * v1);
		LOBYTE(v1) = v2;
		v5 = *getMemU32Ptr(0x587000, 197560);
		memcpy(v3, v4, v1 & 3);
		strcpy((char*)getMemAt(0x8531A0, 1219104), a3);
		v6 = *getMemU32Ptr(0x587000, 197564);
		v7 = getMemAt(0x8531A0, 1219104 + strlen((const char*)getMemAt(0x8531A0, 1219104)));
		...
		*((_DWORD*)v7 + 2) = v6;
		...
		LOBYTE(v5) = v8;
		v8 >>= 2;
		memcpy(getMemAt(0x8531A0, 1221152), a3, 4 * v8);
		v10 = &a3[4 * v8];
		v9 = getMemAt(0x8531A0, 1221152 + 4 * v8);
		LOBYTE(v8) = v5;
		LOWORD(v5) = *getMemU16Ptr(0x587000, 197576);
		memcpy(v9, v10, v8 & 3);
		v11 = getMemAt(0x8531A0, 1221153 + strlen((const char*)getMemAt(0x8531A0, 1221152)));
		...
		*((_WORD*)v11 + 4) = v5;
		v11[10] = v6;
		nox_fs_remove((LPCSTR)getMemAt(0x8531A0, 1219104));
		nox_fs_remove((LPCSTR)getMemAt(0x8531A0, 1221152));
	} else {
		*getMemU8Ptr(0x8531A0, 1225248) = getMemByte(0x5D4594, 1549780);
		*getMemU8Ptr(0x8531A0, 1223200) = getMemByte(0x5D4594, 1549784);
		*getMemU8Ptr(0x8531A0, 1219104) = getMemByte(0x5D4594, 1549788);
		*getMemU8Ptr(0x8531A0, 1221152) = getMemByte(0x5D4594, 1549792);
	}
	...
	*getMemU32Ptr(0x8531A0, 1218976) = 0;
...
//----- (004D3C50) --------------------------------------------------------
void  nox_xxx_tileInitdataClear_4D3C50(const void* a1) { memcpy(getMemAt(0x8531A0, 1219008), a1, 0x48u); }

//----- (004D3C70) --------------------------------------------------------
unsigned __int8* sub_4D3C70() { return getMemAt(0x8531A0, 1219008); }
...
int  sub_4D3F60(int a1) {
	if (a1 != 1 && a1)
		return 0;
	*getMemU32Ptr(0x8531A0, 1219076) = 1;
	return 1;
}
...
BOOL nox_xxx_mapGenStart_4D4320() {
	...
	*getMemU32Ptr(0x5D4594, 1550924) = nox_get_and_zero_server_objects_4DA3C0();
	memset(getMemAt(0x8531A0, 1185504), 0, 0x5B8u);
	while (1) {
	...
	if (_access(FileName, 0) == -1 || (result = nox_fs_remove(FileName))) {
		if (_access(ExistingFileName, 0) == -1 || (result = nox_fs_move(ExistingFileName, FileName))) {
			for (i = nox_server_getFirstObject_4DA790(); i; i = nox_server_getNextObject_4DA7A0(i))
				*(_DWORD*)(i + 44) = 0;
			nox_xxx_mapGenMakeInfo_4D5DB0((int)getMemAt(0x8531A0, 1185504));
...
//----- (004D6940) --------------------------------------------------------
char* sub_4D6940() { return (char*)getMemAt(0x8531A0, 1186934); }

//----- (004D6950) --------------------------------------------------------
char* sub_4D6950() { return (char*)getMemAt(0x8531A0, 1186902); }
...
void nox_xxx_createAt_4DAA50(nox_object_t* obj, int a2, float a3, float a4) {
	...
	*(_DWORD*)(a1 + 16) |= 0x2000000u;
	if (v4b && (!(*(_DWORD*)(a1 + 8) & 0x10000000) || (int)*getMemU32Ptr(0x8531A0, 1186896) >= 0)) {
