	...
	if (!v1) {
		...
		if ((v2 & 0x80u) != 0) {
			...
			if ((_WORD)v1) {
				...
				v6 =
					(__int64)(((double)*(unsigned int*)&byte_5D4594[2598000] / (v5 / v3 * v4) -
...
FILE* sub_4D0A30() {
	...
	strcpy((char*)&byte_5D4594[1524108], nox_common_get_data_path_409E10());
...
//----- (004D0D70) --------------------------------------------------------
BOOL sub_4D0D70() { return *(_DWORD*)&byte_5D4594[1548484] || nox_common_getEngineFlag(1u << 18u); }
		...
		if (i[6]) {
			if (sub_4CFFC0((int)i) & 0x1000) {
				if (*(int*)&dword_5d4594_1548476 < 128) {
					...
					strcpy((char*)&byte_5D4594[32 * dword_5d4594_1548476 + 1525136], (const char*)i + 12);
...
char* sub_4D0F60() // quest setup 2
{
	...
	if (*(int*)&dword_5d4594_1548476 <= 0)
		return (char*)&byte_5D4594[32 * nox_common_randomInt_415FA0(0, dword_5d4594_1548476 - 1) + 1525136];
...
int __cdecl sub_4D3370(char* a1) {
	...
	if (*(int*)&dword_587000_197424 == -1)
		return 0;
	nox_common_setEngineFlag(1u << 21u);
	return 1;
}
...
unsigned int sub_4D33B0() {
	...
	nox_common_resetEngineFlag(1u << 21u);
...
int __cdecl sub_4D34C0(char* a1) {
	...
	*(_DWORD*)&byte_5D4594[1548728] = 0;
	...
	nox_common_setEngineFlag(1u << 22u);
	v2 = sub_417040(255);
...
void sub_4D3530() {
	...
	dword_5d4594_1548732 = 0;
	dword_5d4594_1548736 = 0;
	nox_common_resetEngineFlag(1u << 22u);
	v0 = sub_417040(255);
	sub_4E6AA0((int)v0);
}
...
void __cdecl sub_4D3860(void* a1) {
	if (nox_common_getEngineFlag(1u << 21u) && (*(int*)&dword_587000_197424 != -1)) {
		sub_415F30(*(int*)&dword_587000_197424);
		_write(*(int*)&dword_587000_197424, a1, 0x99u);
	} else if (nox_common_getEngineFlag(1u << 22u)) {
		if (*(int*)&dword_587000_197428 != -1) {
...
int sub_4D38D0() {
	...
	if (nox_common_getEngineFlag(1u << 21u) && *(int*)&dword_587000_197424 != -1) {
		...
		*(_DWORD*)&byte_5D4594[1549764] = nox_server_currentMapGetFilename_409B30();
		...
		result = 0;
	} else if (nox_common_getEngineFlag(1u << 22u) && *(int*)&dword_587000_197428 != -1) {
...
int __cdecl sub_4D72D0(int a1) {
	...
	*(_DWORD*)&byte_5D4594[1556132] = dword_5d4594_1556128;
...
int sub_4D7CC0() {
	...
	if (result) {
		if ((unsigned int)(*(_DWORD*)&byte_5D4594[2598000] - dword_5d4594_1556316) > *(int*)&byte_5D4594[1556312]) {
			for (i = sub_4DA7C0(); i; i = sub_4DA7F0(i)) {
			...
			dword_5d4594_1556316 = *(_DWORD*)&byte_5D4594[2598000];
		}
		result = sub_4DA7C0();
		for (j = result; result; j = result) {
			if (!(*(_DWORD*)(j + 16) & 0x8020)) {
				...
				if (!(*(_BYTE*)(v6[69] + 3680) & 1)) {
					v7 = v6[65];
					if ((unsigned int)(dword_5d4594_1556316 - v6[64]) > *(int*)&byte_5D4594[1556304]) {
						if (v7) {
							sub_4D7BE0(j);
							v6[65] = 0;
						}
...
void sub_4DAA50(int a1, int a2, float a3, float a4) {
	...
	*(_DWORD*)(a1 + 16) |= 0x2000000u;
	if (v4b && (!(*(_DWORD*)(a1 + 8) & 0x10000000) || (int)*(_DWORD*)&byte_5D4594[3803228] >= 0)) {
...
int __cdecl sub_4DCC10(int a1) {
	...
	if (dword_5d4594_1563092 &&
		(unsigned int)(dword_5d4594_1563092 + dword_5d4594_1563088) > *(int*)&byte_5D4594[2598000]) {
		v1 = 0;
	}
...
_DWORD* __cdecl sub_4DD320(int a1, int a2) {
	...
	*((_DWORD*)v8 + 1175) = 1;
	...
	if (nox_common_gameFlags_check_40A5C0(4096)) {
		...
		sub_417630((int)v8);
	} else if (v8[2064] == 31 && nox_common_getEngineFlag(1u << 18u)) {
		sub_4E6860((int)v8, 0, 1);
...
_DWORD* __cdecl sub_4DDE10(int a1, int a2) {
	...
	if (result) {
		if (!dword_5d4594_1563276)
			dword_5d4594_1563276 = sub_4E3AA0((CHAR*)&byte_587000[200132]);
		result = *(_DWORD**)(a2 + 2056);
...
char* __cdecl sub_4DE300(int a1) {
	...
	for (i = (int)result; result; i = (int)result) {
		if (*(unsigned __int8*)(i + 2064) != a1 &&
			(*(_BYTE*)(i + 2064) != 31 || !nox_common_getEngineFlag(1u << 18u))) {
			sub_4DDA90((int)v3, i);
