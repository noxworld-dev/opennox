...
void  nox_xxx_colorLightAlterB0ArrayColor_4CE440(int a1) {
	...
	if (v2 > 1 && *(uint16_t*)(a1 + 258)) {
		...
		nox_xxx_spriteChangeLightColor_484BE0(
			(uint32_t*)(v1 + 136),
			(long long)((double)(*(unsigned char*)(v9 + v1 + 2 * v9 + 178) - *(unsigned char*)(v11 + 178)) / v13 *
						  v10 +
					  (double)*(unsigned char*)(v11 + 178)),
			(long long)((double)(*(unsigned char*)(v9 + v1 + 2 * v9 + 179) - *(unsigned char*)(v11 + 179)) / v13 *
						  v10 +
...
//----- (004D0D70) --------------------------------------------------------
int sub_4D0D70() { return *getMemU32Ptr(0x5D4594, 1548484) || nox_common_getEngineFlag(NOX_ENGINE_FLAG_DISABLE_GRAPHICS_RENDERING); }
...
int  sub_4D5630(int a1, int a2, int a3, int a4, int a5) {
	...
	if (v6 != 2 && v6 != 8 && v6 != 32 && v6 != 64)
		goto LABEL_43;
	v13 = nox_xxx_mapGenMakeHall_523EC0((int)getMemAt(0x5D4594, 1549796), *getMemU32Ptr(0x587000, 197812 + 4 * *(uint32_t*)a1), a4);
	v14 = v13;
	if (!v13)
		return 0;
	switch (*(uint32_t*)a1) {
...
LABEL_43:
	if (v45 != 4 && v45 != 16 && v45 != 32 && v45 != 64)
		goto LABEL_71;
	v22 = nox_xxx_mapGenMakeHall_523EC0((int)getMemAt(0x5D4594, 1549796), *getMemU32Ptr(0x587000, 197836 + 4 * *(uint32_t*)v5), a4);
	if (!v22)
		return 0;
	switch (*(uint32_t*)v5) {
	case 2:
...
int sub_4D7A80() {
	...
	do {
		...
		if (v3 && *((uint32_t*)v3 + 523) && *((uint32_t*)v3 + 514) && *((uint32_t*)v3 + 1198) == 1)
			goto LABEL_12;
		if (*(uint32_t*)v0 &&
			nox_frame_xxx_2598000 - *(uint32_t*)v0 > (unsigned int)(30 * nox_gameFPS)) {
...
void  nox_xxx_playerReportAnything_4D9900(int a1) {
	...
	if (a1 && *(uint8_t*)(a1 + 8) & 4) {
		...
		if (*(uint8_t*)(v14 + 2184)) {
			...
			nox_xxx_servSendStats_4D8990(*(unsigned char*)(*(uint32_t*)(v2 + 276) + 2064), v1, *(uint8_t*)(*(uint32_t*)(v2 + 276) + 3684));
...
int nox_xxx_netSendLineMessage_4D9EB0(int a1, wchar_t* a2, ...) {
	...
	if (a1 && *(uint8_t*)(a1 + 8) & 4) {
		...
		*(wchar_t*)((char*)v6 + 1) = 0;
		...
		result = nox_netlist_addToMsgListCli_40EBC0(*(unsigned char*)(*(uint32_t*)(v3 + 276) + 2064), 1, v6, v5 * LOBYTE(v6[4]) + 11);
	}
	return result;
}
...
int nox_xxx_printToAll_4D9FD0(char a1, wchar_t* a2, ...) {
	...
	*(wchar_t*)((char*)v6 + 1) = 0;
	...
	result = nox_xxx_getFirstPlayerUnit_4DA7C0();
	for (i = result; result; i = result) {
		nox_netlist_addToMsgListCli_40EBC0(*(unsigned char*)(*(uint32_t*)(*(uint32_t*)(i + 748) + 276) + 2064), 1, v6, v3 * LOBYTE(v6[4]) + 11);
		result = nox_xxx_getNextPlayerUnit_4DA7F0(i);
	}
	return result;
}
...
int  nox_xxx_netInformTextMsg2_4DA180(int a1, uint8_t* a2) {
	...
	case 21:
		...
		*(uint32_t*)&v6[2] = *(uint32_t*)a2;
		result = nox_xxx_getFirstPlayerUnit_4DA7C0();
		for (i = result; result; i = result) {
			nox_netlist_addToMsgListCli_40EBC0(*(unsigned char*)(*(uint32_t*)(*(uint32_t*)(i + 748) + 276) + 2064), 1, v6, 6);
			result = nox_xxx_getNextPlayerUnit_4DA7F0(i);
		}
		break;
	case 5:
	...
	case 11:
		*a2 = -87;
		...
		result = nox_xxx_getFirstPlayerUnit_4DA7C0();
		for (j = result; result; j = result) {
			nox_netlist_addToMsgListCli_40EBC0(*(unsigned char*)(*(uint32_t*)(*(uint32_t*)(j + 748) + 276) + 2064), 1, a2, 10);
			result = nox_xxx_getNextPlayerUnit_4DA7F0(j);
		}
		break;
	case 14:
		*a2 = -87;
		...
		for (k = result; result; k = result) {
			nox_netlist_addToMsgListCli_40EBC0(*(unsigned char*)(*(uint32_t*)(*(uint32_t*)(k + 748) + 276) + 2064), 1, a2, 11);
...
#endif // NOX_CGO
uint32_t*  nox_xxx_playerNew_4DD320(int ind, void* data) {
	unsigned char v2 = *(uint8_t*)((int)data + 152);
	*(uint8_t*)((int)data + 152) &= 0x7F;
	int v3 = v2 >> 7;
	if (ind != 31) {
	...
	if (ind != 31) {
		if (v5[100]) {
			if ((unsigned char)(1 << *(uint8_t*)((int)data + 66)) & (unsigned char)v5[100])
				return 0;
		}
	}
	...
	char* v8 = pinfo;
	if ((int)v5[102] >= 0) {
		*((uint16_t*)v8 + 5) = *(uint32_t*)((int)data + 97) >> 1;
		*((uint16_t*)v8 + 6) = *(uint32_t*)((int)data + 101) >> 1;
	} else {
		unsigned int v9 = *(uint32_t*)((int)data + 97);
		if (nox_win_width >= (int)v9) {
			*((uint16_t*)v8 + 5) = v9 >> 1;
			*((uint16_t*)v8 + 6) = *(uint32_t*)((int)data + 101) >> 1;
		} else {
			*((uint16_t *) v8 + 5) = nox_win_width / 2;
			*((uint16_t*)v8 + 6) = nox_win_height / 2;
		}
	}
	strcpy(v8 + 2112, (const char*)((int)data + 105));
	v8[2135] = *(uint8_t*)((int)data + 152);
	nox_swprintf(pinfo->field_2072, L"%S", (int)data + 142);
	strcpy(pinfo->field_2096, (const char*)((int)data + 128));
	int v11 = *(uint32_t*)((int)data + 138);
	*((uint32_t*)v8 + 517) = v11;
	if (v11) {
		void* v12 = sub_425A70(v11);
		if (!v12)
			v12 = sub_425AD0(*((uint32_t*)v8 + 517), (wchar_t*)v8 + 1036);
		sub_425B30(v12, ind);
	}
	*((uint32_t*)v8 + 899) = nox_frame_xxx_2598000;
	v8[3676] = 2;
	*((uint32_t*)v8 + 920) = 0;
	...
	*((uint32_t*)v8 + 539) = nox_xxx_scavengerTreasureMax_4D1600();
	int v15 = punit->field_187;
	*(uint32_t*)(v15 + 276) = pinfo;
	*((uint32_t*)v8 + 1146) = nox_xxx_protectionCreateInt_56F400(*(unsigned short*)((int)punit->field_139 + 0));
	*((uint32_t*)v8 + 1148) = nox_xxx_protectionCreateInt_56F400(*(unsigned short*)((int)punit->field_139 + 4));
	*((uint32_t*)v8 + 1149) = nox_xxx_protectionCreateInt_56F400(*(unsigned short*)(v15 + 4));
	*((uint32_t*)v8 + 1150) = nox_xxx_protectionCreateInt_56F400(*(unsigned short*)(v15 + 8));
	*((uint32_t*)v8 + 1151) = nox_xxx_protectionCreateFloat_56F440(*(uint32_t*)(&punit->field_7));
	*((uint32_t*)v8 + 1152) = nox_xxx_protectionCreateFloat_56F440(*(uint32_t*)(&punit->float_30));
	*((uint32_t*)v8 + 1153) = nox_xxx_protectionCreateInt_56F400(*(uint32_t*)(&punit->field_85));
	*((uint32_t*)v8 + 1154) = nox_xxx_protectionCreateInt_56F400((unsigned char)v8[2251]);
	*((uint32_t*)v8 + 1155) = nox_xxx_protectionCreateInt_56F400(*(uint32_t*)(v8 + 2235));
	*((uint32_t*)v8 + 1156) = nox_xxx_protectionCreateInt_56F400(*(uint32_t*)(v8 + 2239));
	int v20 = nox_wcslen((const wchar_t*)(v8 + 2185));
	int v21 = nox_xxx_protectionStringCRCLen_56FAE0((int*)(v8 + 2185), 2 * v20);
	*((uint32_t*)v8 + 1157) = nox_xxx_protectionCreateInt_56F400(v21);
	*((uint32_t*)v8 + 1158) = nox_xxx_protectionCreateInt_56F400(0);
	*((uint32_t*)v8 + 1159) = nox_xxx_protectionCreateInt_56F400(0);
	*((uint32_t*)v8 + 1147) = nox_xxx_protectionCreateInt_56F400(*((uint32_t*)v8 + 541));
	*((uint32_t*)v8 + 1160) = nox_xxx_protectionCreateInt_56F400(0);
	*((uint32_t*)v8 + 1161) = nox_xxx_protectionCreateInt_56F400(v8[3684]); // level
	*((uint32_t*)v8 + 1162) = -1;
	*((uint32_t*)v8 + 1175) = 1;
...
uint32_t*  nox_xxx_servSendSettings_4DDB40(uint32_t* a1) {
	...
	*(uint32_t*)&v5[117] = nox_frame_xxx_2598000;
	nox_xxx_netSendSock_552640(*(unsigned char*)(*(uint32_t*)(v1 + 276) + 2064) + 1, &v5[80], 41, NOX_NET_SEND_NO_LOCK | NOX_NET_SEND_FLAG2);
			...
			if (v2 & 0x1000) {
				...
				*(uint8_t*)(v3 + 108) = v4;
				...
				if (v6 != v7) {
					...
					if (v8) {
						if (*(uint8_t*)(v8 + 8) & 4)
							nox_xxx_netReportCharges_4D82B0(*(unsigned char*)(*(uint32_t*)(*(uint32_t*)(v8 + 748) + 276) + 2064), a2, v7, v5);
					}
				}
			}
		}
...
int  nox_xxx_damageDefaultProc_4E0B30(int a1, int a2, int a3, int a4, int a5) {
	...
	if ((v8 & 0x8000) == 0) {
		...
		if (a2 && a3 && !nox_xxx_unitIsEnemyTo_5330C0(a1, a2) && *(uint8_t*)(a1 + 8) & 6 && sub_4E1400(a2, (uint32_t*)a3) &&
				!sub_4E1470(a3) ||
			*(uint8_t*)(a1 + 16) & 2) {
			return 1;
		}
						...
						*(uint32_t*)(a1 + 536) = nox_frame_xxx_2598000;
						...
						if (a1 != v19 || !(*(uint32_t*)(a1 + 8) & 0x1001000)) {
							if (!v10 || !(*(uint8_t*)(v10 + 8) & 2) || !*(uint32_t*)(v10 + 748) ||
								(v27 = nox_xxx_monsterGetSoundSet_424300(v10)) == 0 || (v28 = *(uint32_t*)(v27 + 32)) == 0 ||
		...
		*v6 = a5 - (double)v9;
		if (v9 > 0) {
			...
			if (*(uint8_t*)(a2 + 8) & 4) {
				v11 = **(uint16_t**)(a1 + 556);
				if (v10 != v11)
					nox_xxx_itemDestroyed_4E1650(*(unsigned char*)(*(uint32_t*)(*(uint32_t*)(a2 + 748) + 276) + 2064), (uint32_t*)a1, v10,
							   v11);
			}
		}
	}
