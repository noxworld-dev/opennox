...
int __cdecl sub_4CEED0(int a1, int a2)
{
    ...
    else
    {
        ...
        if (!(*(_BYTE*)(*(_DWORD*)& byte_5D4594[1523044] + 4) & 8) && !nox_common_gameFlags_check_40A5C0(49152))
...
BOOL sub_4D0D70()
{
    return *(_DWORD*)& byte_5D4594[1548484] || *(_DWORD*)& nox_common_engineFlags & 0x40000;
}
...
char* sub_4D0F60() //quest setup 2
{
    ...
    if (*(int*)& byte_5D4594[1548476] <= 0)
        return (char*)& byte_5D4594[32 * nox_common_randomInt_415FA0(0, *(_DWORD*)& byte_5D4594[1548476] - 1) + 1525136];
...
int __cdecl sub_4DDF60(int a1)
{
    ...
    *((_DWORD*)v2 + 1175) = 0;
    ...
    if (*(_DWORD*)& byte_587000[108752] && nox_common_gameFlags_check_40A5C0(0x2000) && !nox_common_gameFlags_check_40A5C0(4096))
        sub_4DD140(v1);
    for (i = sub_416EA0(); i; i = sub_416EE0((int)i))
    {
        v7 = *((_DWORD*)i + 514);
...
char __cdecl sub_4DF3C0(int a1)
{
    ...
    if ((int)v2 < v8)
    {
        if (!nox_common_gameFlags_check_40A5C0(96) || (v9 = (unsigned __int8)sub_417DE0(), v2 = (char*)sub_417DC0(), v9 < (int)v2))
        {
            v2 = sub_418A10();
            v5 = v2;
            if (v2)
...
int __cdecl sub_4E0B30(int a1, int a2, int a3, int a4, int a5)
{
    ...
    if ((v8 & 0x8000) == 0)
    {
        ...
        if (!sub_417DA0(1))
        {
            ...
            if (v11)
            {
                if (*(_BYTE*)(v11 + 8) & 6 && !sub_5330C0(a1, v11) && (a1 != v12 || nox_common_gameFlags_check_40A5C0(4096)))
                    return 1;
            }
        }
